...
static void _OnOKSelectFnc(CWnd *pWnd){
	CHMSChuyennguonTTbenhnhancovid19 *pVw = (CHMSChuyennguonTTbenhnhancovid19 *)pWnd;
	pVw->OnOKSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnListDeleteItem();
} 
static int _OnAddHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnAddHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnEditHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnEditHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnDeleteHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnDeleteHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnSaveHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnSaveHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnCancelHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnCancelHMSChuyennguonTTbenhnhancovid19();
}

static void _OnTatcaSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnTatcaSelect();
}
static void _OnPhikhamSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnPhikhamSelect();
}
static void _OnPhiCLSSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnPhiCLSSelect();
}
static void _OnPhithuocSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnPhithuocSelect();
}
static void _OnPhivattuSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnPhivattuSelect();
}
static void _OnTienanSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnTienanSelect();
}
static void _OnGoidichvuSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnGoidichvuSelect();
}
static void _OnTiengiuongSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnTiengiuongSelect();
}
static void _OnPhiPTTTSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnPhiPTTTSelect();
}
static void _OnChitinhmucphingansachttSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnChitinhmucphingansachttSelect();
}
...
static void _OnLocxncovid19SelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnLocxncovid19Select();
}
...
static void _OnLoccpbntraSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhancovid19*)pWnd)->OnLoccpbntraSelect();
}
...
CHMSChuyennguonTTbenhnhancovid19::CHMSChuyennguonTTbenhnhancovid19(CWnd *pParent):
	CGuiDialog(pParent)
{
	m_nDlgWidth = 605;
	m_nDlgHeight = 485;
...
CHMSChuyennguonTTbenhnhancovid19::~CHMSChuyennguonTTbenhnhancovid19()
{
}
void CHMSChuyennguonTTbenhnhancovid19::OnCreateComponents()
{	
...
void CHMSChuyennguonTTbenhnhancovid19::OnInitializeComponents(){
...
void CHMSChuyennguonTTbenhnhancovid19::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSChuyennguonTTbenhnhancovid19::OnDoDataExchange(CDataExchange* pDX)
...
void CHMSChuyennguonTTbenhnhancovid19::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSChuyennguonTTbenhnhancovid19::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CHMSChuyennguonTTbenhnhancovid19::SetDefaultValues()
{
	m_nTatca=0;
	m_nPhikham=1;
	m_nPhiCLS=1;
	...
	m_nTiengiuong=1;
	m_nPhiPTTT=1;
	m_bChitinhmucphingansachtt=TRUE;
	m_bLocxncovid19=FALSE;
	m_bLoccpbntra=FALSE;
}
int CHMSChuyennguonTTbenhnhancovid19::SetMode(int nMode)
{
...
void CHMSChuyennguonTTbenhnhancovid19::OnOKSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	...
	for (int i =0; i < m_wndList.GetItemCount(); i++)
	{
		...
		szSQL.Format(_T("HMS_FEE_CHANGE_PAYSOURCE_COVID(%ld, %ld, %ld, '%s', %d) "),
...
void CHMSChuyennguonTTbenhnhancovid19::OnTatcaSelect()
{
	UpdateData(TRUE);
	OnListLoadData();	
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhancovid19::OnPhikhamSelect()
{
	UpdateData(TRUE);
	OnListLoadData();	
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhancovid19::OnPhiCLSSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhancovid19::OnPhithuocSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhancovid19::OnPhivattuSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhancovid19::OnTienanSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhancovid19::OnGoidichvuSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhancovid19::OnTiengiuongSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhancovid19::OnPhiPTTTSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhancovid19::OnChitinhmucphingansachttSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhancovid19::OnLocxncovid19Select()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhancovid19::OnLoccpbntraSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhancovid19::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
void CHMSChuyennguonTTbenhnhancovid19::OnListDblClick()
{
...
void CHMSChuyennguonTTbenhnhancovid19::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CHMSChuyennguonTTbenhnhancovid19::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSChuyennguonTTbenhnhancovid19::OnListLoadData(){
	...
	_T("   OR hfe_type                   ='V')") \
	_T("   AND (hfe_patpaid + hfe_patdebt + hfe_discount + NVL(hfe_otherpaid,0)) > 0 %s ") \
	_T("   ) tbl") \
	_T(" GROUP BY idx,") \
	_T("   description,") \
	_T("   maphi,") \
...
int CHMSChuyennguonTTbenhnhancovid19::OnAddHMSChuyennguonTTbenhnhancovid19(){
...
int CHMSChuyennguonTTbenhnhancovid19::OnEditHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSChuyennguonTTbenhnhancovid19::OnDeleteHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CHMSChuyennguonTTbenhnhancovid19::OnSaveHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CHMSChuyennguonTTbenhnhancovid19::OnCancelHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSChuyennguonTTbenhnhancovid19::OnHMSChuyennguonTTbenhnhancovid19ListLoadData(){
	return 0;
}

int CHMSChuyennguonTTbenhnhancovid19::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
int CHMSChuyennguonTTbenhnhancovid19::OnUnMarkSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
int CHMSChuyennguonTTbenhnhancovid19::OnMarkFoodFeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CHMSChuyennguonTTbenhnhancovid19::OnUnMarkA4FeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
