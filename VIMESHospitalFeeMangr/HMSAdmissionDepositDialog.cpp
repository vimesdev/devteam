...
/*static void _OnYOBChangeFnc(CWnd *pWnd){
	((CHMSAdmissionDepositDialog *)pWnd)->OnYOBChange();
} */
/*static void _OnYOBSetfocusFnc(CWnd *pWnd){
	((CHMSAdmissionDepositDialog *)pWnd)->OnYOBSetfocus();} */ 
/*static void _OnYOBKillfocusFnc(CWnd *pWnd){
	((CHMSAdmissionDepositDialog *)pWnd)->OnYOBKillfocus();
} */
static int _OnYOBCheckValueFnc(CWnd *pWnd){
	return ((CHMSAdmissionDepositDialog *)pWnd)->OnYOBCheckValue();
} 
...
/*static void _OnReturnDateChangeFnc(CWnd *pWnd){
	((CHMSAdmissionDepositDialog *)pWnd)->OnReturnDateChange();
} */
/*static void _OnReturnDateSetfocusFnc(CWnd *pWnd){
	((CHMSAdmissionDepositDialog *)pWnd)->OnReturnDateSetfocus();} */ 
/*static void _OnReturnDateKillfocusFnc(CWnd *pWnd){
	((CHMSAdmissionDepositDialog *)pWnd)->OnReturnDateKillfocus();
} */
static int _OnReturnDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSAdmissionDepositDialog *)pWnd)->OnReturnDateCheckValue();
}
...
static int _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSAdmissionDepositDialog *)pWnd)->OnListLoadData();
}
...
CHMSAdmissionDepositDialog::CHMSAdmissionDepositDialog(CWnd *pParent, int nMode):
	CGuiDialog(pParent)
{
...
/*void CHMSAdmissionDepositDialog::OnYOBChange(){
	
} */
/*void CHMSAdmissionDepositDialog::OnYOBSetfocus(){
	
} */
/*void CHMSAdmissionDepositDialog::OnYOBKillfocus(){
	
} */
int CHMSAdmissionDepositDialog::OnYOBCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CHMSAdmissionDepositDialog::OnReturnDateChange(){
	
} */
/*void CHMSAdmissionDepositDialog::OnReturnDateSetfocus(){
	
} */
/*void CHMSAdmissionDepositDialog::OnReturnDateKillfocus(){
	
} */
int CHMSAdmissionDepositDialog::OnReturnDateCheckValue(){
	return 0;
}
void CHMSAdmissionDepositDialog::OnSaveSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveHMSAdmissionDepositDialog();
} 
...
int CHMSAdmissionDepositDialog::OnListLoadData(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr;
