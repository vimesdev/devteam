...
static void _OnOKSelectFnc(CWnd *pWnd){
	CHMSChuyennguonTTbenhnhanquanPKchitiet *pVw = (CHMSChuyennguonTTbenhnhanquanPKchitiet *)pWnd;
	pVw->OnOKSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnListDeleteItem();
} 
static int _OnAddHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnAddHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnEditHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnEditHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnDeleteHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnDeleteHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnSaveHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnSaveHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnCancelHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnCancelHMSChuyennguonTTbenhnhancovid19();
}

static void _OnTatcaSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnTatcaSelect();
}
static void _OnPhikhamSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnPhikhamSelect();
}
static void _OnPhiCLSSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnPhiCLSSelect();
}
static void _OnPhithuocSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnPhithuocSelect();
}
static void _OnPhivattuSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnPhivattuSelect();
}
static void _OnTienanSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnTienanSelect();
}
static void _OnGoidichvuSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnGoidichvuSelect();
}
static void _OnTiengiuongSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnTiengiuongSelect();
}
static void _OnPhiPTTTSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnPhiPTTTSelect();
}
static void _OnChitinhmucphingansachttSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnChitinhmucphingansachttSelect();
}
...
static void _OnLocxncovid19SelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnLocxncovid19Select();
}
...
static void _OnLoccpbntraSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnLoccpbntraSelect();
}

static int _OnUnMarkA4FeeSelectFnc(CWnd *pWnd){
	CHMSChuyennguonTTbenhnhanquanPKchitiet *pVw = (CHMSChuyennguonTTbenhnhanquanPKchitiet *)pWnd;
	pVw->OnUnMarkA4FeeSelect();
	return 0;
}


static void _OnBQPKhongttSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanPKchitiet*)pWnd)->OnBQPKhongttSelect();
}
CHMSChuyennguonTTbenhnhanquanPKchitiet::CHMSChuyennguonTTbenhnhanquanPKchitiet(CWnd *pParent):
	CGuiDialog(pParent)
{
	m_nDlgWidth = 605;
	m_nDlgHeight = 485;
...
CHMSChuyennguonTTbenhnhanquanPKchitiet::~CHMSChuyennguonTTbenhnhanquanPKchitiet()
{
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnCreateComponents()
{	
	m_wndPaymentSource.Create(this, _T("CHUYỂN NGUỒN THANH TOÁN BỆNH NHÂN QUÂN - CHI TIẾT THEO ĐỀ MỤC"), 5, 5, 959, 549);
	...
	m_wndBQPKhongtt.Create(this, _T("Mục phí BQP thanh toán"), 10, 646, 373, 671);
	m_wndLoccpbntra.Create(this, _T("Lọc chi phí BN phải trả"), 453, 646, 653, 671);

	m_wndChitinhmucphingansachtt.Create(this, _T(""), 0, 0, 0, 0);
	m_wndChitinhmucphingansachtt.ShowWindow(SW_HIDE);
	m_wndChitinhmucphingansachtt.EnableWindow(FALSE);
	m_wndLocxncovid19.Create(this, _T(""), 0, 0, 0, 0);
	m_wndLocxncovid19.ShowWindow(SW_HIDE);
	m_wndLocxncovid19.EnableWindow(FALSE);

}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnInitializeComponents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();


	m_wndList.InsertColumn(0, _T("STT"), CFMT_TEXT, 30);
	m_wndList.InsertColumn(1, _T("Mã phí"), CFMT_TEXT, 0);
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	m_wndList.AddEvent(4, _T("Bỏ chọn chi phí khoa A4"), _OnUnMarkA4FeeSelectFnc);
	...
	m_wndBQPKhongtt.SetEvent(WE_CLICK, _OnBQPKhongttSelectFnc);
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnDoDataExchange(CDataExchange* pDX)

{
	...
	DDX_Check(pDX, m_wndBQPKhongtt.GetDlgCtrlID(), m_bBQPKhongtt);

}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::SetDefaultValues()
{
	m_nTatca=0;
	m_nPhikham=1;
	m_nPhiCLS=1;
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::SetMode(int nMode)
{
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnOKSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	...
	for (int i =0; i < m_wndList.GetItemCount(); i++)
	{
		...
		nOderlineID = str2double(m_wndList.GetItemText(i, 1));
		tmpStr == m_wndList.GetItemText(i, 5);//Amount//
		if(tmpStr == _T("TTL"))
			continue;
		
		szSQL.Format(_T("HMS_FEE_CHANGE_PS_SOLDIER_E(%ld, %ld, %f, '%s', %d) "),
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnTatcaSelect()
{
	UpdateData(TRUE);
	OnListLoadData();	
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnPhikhamSelect()
{
	UpdateData(TRUE);
	OnListLoadData();	
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnPhiCLSSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnPhithuocSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnPhivattuSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnTienanSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnGoidichvuSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnTiengiuongSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnPhiPTTTSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnChitinhmucphingansachttSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnLocxncovid19Select()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnLoccpbntraSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnListDblClick()
{
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSChuyennguonTTbenhnhanquanPKchitiet::OnListLoadData(){

	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere, szngansach_paid, szxncovid;
	...
	{
		szWhere.AppendFormat(_T("AND (hfe_ngansach_paid='cov' OR NVL(HFL_XNCOVID19, 'X')='Y')"));
	}
	...
	if (m_bBQPKhongtt)
	{
		szWhere.AppendFormat(_T("  AND hft_id NOT IN (2002)") \
		_T("   AND NVL(hfl_categoryid, 0) <> '501'") \
		_T("   AND hfe_group NOT IN ('FF000')") \
		_T("   AND hfe_group NOT IN ('F0000')") \
		_T("   AND hfe_group NOT IN ('A1700', 'A1600', 'A1220')") \
		_T("   AND NVL(HFL_BHQUAN_KO_TT, 'N') NOT IN ('Y')") \
		_T("   AND hfe_itemid NOT IN (SELECT ss_code FROM sys_sel WHERE ss_id='hms_bqp_unpaid')"));
	}
	...
	szWhere.AppendFormat(
		_T(" and (select count(*) from hms_fee_discountline dl ") \
		_T("  where hfe_docno = %ld and hfe_refidx=%ld and dl.hfe_itemid = f.hfe_itemid) = 0 "), m_nDocumentNo, m_nInvoiceNo);
	szSQL.Format(_T(" SELECT idx,") \
	_T("   description,") \
	_T("   maphi,") \
	_T("   tenmucphi, ngansach_paid,") \
	_T("   SUM(amount) AS amount, tgchidinh, khoachidinh, manhom, xncovid") \
	_T(" FROM") \
	...
	_T("     hfe_desc as tenmucphi, NVL(hfe_ngansach_paid, 'N') as ngansach_paid, hfe_group AS manhom, NVL(HFL_XNCOVID19, 'X') as xncovid,") \
	_T("     CASE") \
	_T("       WHEN hfe_type='V'") \
	...
	_T("   OR hfe_type                   ='V')") \
	_T("   AND (hfe_patpaid + hfe_patdebt) > 0 %s ") \
	_T("   ) tbl") \
	_T(" GROUP BY idx,") \
	_T("   description,") \
	_T("   maphi,") \
	_T("   tenmucphi, khoachidinh, tgchidinh, ngansach_paid, manhom, xncovid") \
	...
	{ 
		...
		if (szngansach_paid == _T("cov") || szxncovid == _T("Y"))
		{
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnAddHMSChuyennguonTTbenhnhancovid19(){
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnEditHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnDeleteHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnSaveHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnCancelHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnHMSChuyennguonTTbenhnhancovid19ListLoadData(){
	return 0;
}

int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnUnMarkSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnMarkFoodFeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CHMSChuyennguonTTbenhnhanquanPKchitiet::OnUnMarkA4FeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
	{
		szItemText=m_wndList.GetItemText(i,3);//Mã nhóm phí//
		if ((_T("A4-C"))==szItemText || (_T("A4-A"))==szItemText)
		{
			m_wndList.SetCheck(i, false);
			nCheck++;
		}
...
void CHMSChuyennguonTTbenhnhanquanPKchitiet::OnBQPKhongttSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	OnListLoadData();	
