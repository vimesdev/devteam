#ifndef HMSFEEREFUNDINVOICEDIALOG_H
#define HMSFEEREFUNDINVOICEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSFeeRefundInvoiceDialog : public CGuiDialog
{
...
public:
	...
	CHMSFeeRefundInvoiceDialog(CWnd *pParent);
	~CHMSFeeRefundInvoiceDialog();
