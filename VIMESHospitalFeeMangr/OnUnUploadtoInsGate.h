#ifndef HMSONUNUPLOADTOINSGATEDIALOG_H
#define HMSONUNUPLOADTOINSGATEDIALOG_H
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSUnUpload2InsGate : public CGuiDialog
{
...
public:
	...
	CHMSUnUpload2InsGate(CWnd *pParent);
	~CHMSUnUpload2InsGate();
	...
	int			OnChuyennguonngansachTTbenhnhancovid19pkSelect();
	void			OnOnlyBQPSelect(); 
	
	int SetMode(int nMode);
	int OnAddHMSUnUpload2InsGate(); 
	int OnEditHMSUnUpload2InsGate(); 
	int OnDeleteHMSUnUpload2InsGate(); 
	int OnSaveHMSUnUpload2InsGate(); 
	int OnCancelHMSUnUpload2InsGate(); 
	int OnHMSUnUpload2InsGateListLoadData();
	void OnSearchFeeSelect();
};
#endif