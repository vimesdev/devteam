#ifndef HMSEDITCARDDATEDIALOG_H
#define HMSEDITCARDDATEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSEditCardDateDialog : public CGuiDialog{
protected:
public:
	...
	CHMSEditCardDateDialog(CWnd *pParent);
	~CHMSEditCardDateDialog();
	...
	int OnAddHMSEditCardDateDialog(); 
	int OnEditHMSEditCardDateDialog(); 
	int OnDeleteHMSEditCardDateDialog(); 
	int OnSaveHMSEditCardDateDialog(); 
	int OnCancelHMSEditCardDateDialog(); 
	int OnHMSEditCardDateDialogListLoadData(); 
};
#endif
