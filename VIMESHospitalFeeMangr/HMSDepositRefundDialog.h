#ifndef HMSDepositRefundDialog_H
#define HMSDepositRefundDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSDepositRefundDialog : public CGuiDialog{
protected:
...
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSDepositRefundDialog(CWnd *pParent, int nMode);
	~CHMSDepositRefundDialog();
	...
	int OnAddHMSDepositRefundDialog(); 
	int OnEditHMSDepositRefundDialog(); 
	int OnDeleteHMSDepositRefundDialog(); 
	int OnSaveHMSDepositRefundDialog(); 
	int OnCancelHMSDepositRefundDialog(); 
	int OnHMSDepositRefundDialogListLoadData(); 
};
#endif
