#ifndef HMSFEEDISCOUNTDIALOG_H
#define HMSFEEDISCOUNTDIALOG_H
...
class CHMSFeeDiscountDialog : public CGuiDialog
{
protected:
...
public:
	...
	CHMSFeeDiscountDialog(CWnd *pParent);
	~CHMSFeeDiscountDialog();
