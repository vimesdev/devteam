#include "rptBaocaonguonvonHemachitrangoaitru.h"
#include "../MainFrm.h"
#include "ReportDocument.h"
#include "Excel.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptBaocaonguonvonHemachitrangoaitru* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptBaocaonguonvonHemachitrangoaitru* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((rptBaocaonguonvonHemachitrangoaitru *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	rptBaocaonguonvonHemachitrangoaitru *pVw = (rptBaocaonguonvonHemachitrangoaitru *)pWnd;
...
static void _OnKhonglaybnccSelectFnc(CWnd *pWnd){
	 ((rptBaocaonguonvonHemachitrangoaitru*)pWnd)->OnKhonglaybnccSelect();
}
static void _OnLaybnccSelectFnc(CWnd *pWnd){
	 ((rptBaocaonguonvonHemachitrangoaitru*)pWnd)->OnLaybnccSelect();
}
static int _OnAddrptBaocaonguonvonHemachitrangoaitruFnc(CWnd *pWnd){
	 return ((rptBaocaonguonvonHemachitrangoaitru*)pWnd)->OnAddrptBaocaonguonvonHemachitrangoaitru();
} 
static int _OnEditrptBaocaonguonvonHemachitrangoaitruFnc(CWnd *pWnd){
	 return ((rptBaocaonguonvonHemachitrangoaitru*)pWnd)->OnEditrptBaocaonguonvonHemachitrangoaitru();
} 
static int _OnDeleterptBaocaonguonvonHemachitrangoaitruFnc(CWnd *pWnd){
	 return ((rptBaocaonguonvonHemachitrangoaitru*)pWnd)->OnDeleterptBaocaonguonvonHemachitrangoaitru();
} 
static int _OnSaverptBaocaonguonvonHemachitrangoaitruFnc(CWnd *pWnd){
	 return ((rptBaocaonguonvonHemachitrangoaitru*)pWnd)->OnSaverptBaocaonguonvonHemachitrangoaitru();
} 
static int _OnCancelrptBaocaonguonvonHemachitrangoaitruFnc(CWnd *pWnd){
	 return ((rptBaocaonguonvonHemachitrangoaitru*)pWnd)->OnCancelrptBaocaonguonvonHemachitrangoaitru();
} 
rptBaocaonguonvonHemachitrangoaitru::rptBaocaonguonvonHemachitrangoaitru(CWnd *pParent):
	CGuiDialog(pParent){

	m_nDlgWidth = 430;
	m_nDlgHeight = 225;
	SetDefaultValues();
	m_szTitle = _T("Bao cao nguon von Hema chi tra benh nhan ngoai tru");
}
rptBaocaonguonvonHemachitrangoaitru::~rptBaocaonguonvonHemachitrangoaitru(){
}
void rptBaocaonguonvonHemachitrangoaitru::OnCreateComponents(){
	m_wndReportFilter.Create(this, _T("Report Parameters"), 5, 5, 420, 120);
	...
	m_wndPrintPreview.Create(this, _T("Print Pre&view"), 85, 125, 164, 150);
	m_wndPrint.Create(this, _T("&Print"), 170, 125, 250, 150);
	m_wndExport.Create(this, _T("&Export"), 255, 125, 335, 150);
	m_wndClose.Create(this, _T("&Close"), 340, 125, 420, 150);
	
}
void rptBaocaonguonvonHemachitrangoaitru::OnInitializeComponents(){
...
void rptBaocaonguonvonHemachitrangoaitru::OnSetWindowEvents(){
...
void rptBaocaonguonvonHemachitrangoaitru::OnDoDataExchange(CDataExchange* pDX){
...
void rptBaocaonguonvonHemachitrangoaitru::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	

}
void rptBaocaonguonvonHemachitrangoaitru::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void rptBaocaonguonvonHemachitrangoaitru::SetDefaultValues(){
...
int rptBaocaonguonvonHemachitrangoaitru::SetMode(int nMode){
...
/*void rptBaocaonguonvonHemachitrangoaitru::OnYearChange(){
	
} */
/*void rptBaocaonguonvonHemachitrangoaitru::OnYearSetfocus(){
	
} */
/*void rptBaocaonguonvonHemachitrangoaitru::OnYearKillfocus(){
	
} */
int rptBaocaonguonvonHemachitrangoaitru::OnYearCheckValue(){
	return 0;
} 
void rptBaocaonguonvonHemachitrangoaitru::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptBaocaonguonvonHemachitrangoaitru::OnReportPeriodSelendok(){
...
/*void rptBaocaonguonvonHemachitrangoaitru::OnReportPeriodSetfocus(){
	
}*/
/*void rptBaocaonguonvonHemachitrangoaitru::OnReportPeriodKillfocus(){
	
}*/
long rptBaocaonguonvonHemachitrangoaitru::OnReportPeriodLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void rptBaocaonguonvonHemachitrangoaitru::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void rptBaocaonguonvonHemachitrangoaitru::OnFromDateChange(){
	
} */
/*void rptBaocaonguonvonHemachitrangoaitru::OnFromDateSetfocus(){
	
} */
/*void rptBaocaonguonvonHemachitrangoaitru::OnFromDateKillfocus(){
	
} */
int rptBaocaonguonvonHemachitrangoaitru::OnFromDateCheckValue(){
	return 0;
} 
/*void rptBaocaonguonvonHemachitrangoaitru::OnToDateChange(){
	
} */
/*void rptBaocaonguonvonHemachitrangoaitru::OnToDateSetfocus(){
	
} */
/*void rptBaocaonguonvonHemachitrangoaitru::OnToDateKillfocus(){
	
} */
int rptBaocaonguonvonHemachitrangoaitru::OnToDateCheckValue(){
	return 0;
} 
void rptBaocaonguonvonHemachitrangoaitru::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptBaocaonguonvonHemachitrangoaitru::OnClerkSelendok(){
	 
}
/*void rptBaocaonguonvonHemachitrangoaitru::OnClerkSetfocus(){
	
}*/
/*void rptBaocaonguonvonHemachitrangoaitru::OnClerkKillfocus(){
	
}*/
long rptBaocaonguonvonHemachitrangoaitru::OnClerkLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void rptBaocaonguonvonHemachitrangoaitru::OnClerkAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void rptBaocaonguonvonHemachitrangoaitru::OnPrintPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	PrintReport(m_szClerkKey,m_szFromDate,m_szToDate, true);		
	UpdateData(false);
} 
void rptBaocaonguonvonHemachitrangoaitru::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
	UpdateData(true);
	PrintReport(m_szClerkKey,m_szFromDate,m_szToDate, false);		
	UpdateData(false);
} 
void rptBaocaonguonvonHemachitrangoaitru::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
	UpdateData(true);
	ExportToExcellReport(m_szClerkKey,m_szFromDate,m_szToDate, true);	
	UpdateData(false);
} 
void rptBaocaonguonvonHemachitrangoaitru::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
} 
	void rptBaocaonguonvonHemachitrangoaitru::OnKhonglaybnccSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_bLaybncc=false;
	UpdateData(false);
	...
	void rptBaocaonguonvonHemachitrangoaitru::OnLaybnccSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_bKhonglaybncc=false;	
	UpdateData(false);
}
int rptBaocaonguonvonHemachitrangoaitru::OnAddrptBaocaonguonvonHemachitrangoaitru(){
...
int rptBaocaonguonvonHemachitrangoaitru::OnEditrptBaocaonguonvonHemachitrangoaitru(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int rptBaocaonguonvonHemachitrangoaitru::OnDeleterptBaocaonguonvonHemachitrangoaitru(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelrptBaocaonguonvonHemachitrangoaitru(); 
 	}
	return 0;
}
int rptBaocaonguonvonHemachitrangoaitru::OnSaverptBaocaonguonvonHemachitrangoaitru(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnrptBaocaonguonvonHemachitrangoaitruListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int rptBaocaonguonvonHemachitrangoaitru::OnCancelrptBaocaonguonvonHemachitrangoaitru(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int rptBaocaonguonvonHemachitrangoaitru::OnrptBaocaonguonvonHemachitrangoaitruListLoadData(){
	return 0;
}
void rptBaocaonguonvonHemachitrangoaitru::PrintReport(CString szReportPeriod, CString szFromDate, CString szToDate, bool bPreview)
{
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	if (pMF->m_szDiscountPrintReport !=_T("Y"))
	{
		...
		_T("  ORDER BY insline,insgroup,  invoiceno"), szFromDate, szToDate, szUserReceiver,szWhere);
	}
	else
	{
		szSQL.Format(_T(" SELECT  hd_docno as docno, max(hfi_invoiceno) as invoiceno, ") \
...
_fmsg(_T("%s"), szSQL);
	...
	if(!rpt.Init(_T("Reports/HMS/HF_BAOCAOCHIPHIKHAMCHUABENHNGOAITRU_HEMA.RPT")) )
		return;
...
void rptBaocaonguonvonHemachitrangoaitru::ExportToExcellReport(CString szReportPeriod, CString szFromDate, CString szToDate, bool bPreview){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	if (pMF->m_szDiscountPrintReport !=_T("Y"))
	{
		...
		_T("  LEFT JOIN hms_card ON(hc_patientno=hp_patientno AND hc_idx=hd_cardidx)") \
		_T("  LEFT JOIN hms_object ON(ho_id=hd_object)") \
		_T("  WHERE hd_xobject ='H' and ho_type in('I','C') and hd_status='T' and length(hc_cardno) > 1  %s ") \
		_T("  GROUP BY docno, pname, birthyear, sex, cardno, insline,insgroup,linename, regplace, icd10,  examdate") \
		_T("  HAVING sum(cost) > 0") \
		_T("  ORDER BY insline,insgroup,  invoiceno"), szFromDate, szToDate, szUserReceiver,szWhere);
	}
	...
	TranslateString(_T("Bao cao nguon von Hema chi tra benh nhan ngoai tru"), tmpStr);
	...
	TranslateString(_T("Dong chi tra 5%"), tmpStr);	
	...
	{		
		...
		if(szNewLine != szOldLine && !szNewLine.IsEmpty()){
			...
			nRow++;
			rs.GetValue(_T("linename"), szLineName);
			xls.SetCellMergedColumns(0,nRow,23);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\ChiphikhambenhngoaitruHema.xls"));
