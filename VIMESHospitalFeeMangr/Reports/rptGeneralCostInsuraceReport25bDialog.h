#ifndef rptGeneralCostInsuraceReport25bDialog_H
#define rptGeneralCostInsuraceReport25bDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptGeneralCostInsuraceReport25bDialog : public CGuiDialog{
protected:
public:
	...
	rptGeneralCostInsuraceReport25bDialog(CWnd *pParent);
	~rptGeneralCostInsuraceReport25bDialog();
	...
	int OnAddrptGeneralCostInsuraceReport25bDialog(); 
	int OnEditrptGeneralCostInsuraceReport25bDialog(); 
	int OnDeleterptGeneralCostInsuraceReport25bDialog(); 
	int OnSaverptGeneralCostInsuraceReport25bDialog(); 
	int OnCancelrptGeneralCostInsuraceReport25bDialog(); 
	int OnrptGeneralCostInsuraceReport25bDialogListLoadData(); 
};
#endif
