#ifndef rptDetailedlistofpatientcostoutpatientintreatment_H
#define rptDetailedlistofpatientcostoutpatientintreatment_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptDetailedlistofpatientcostoutpatientintreatment : public CGuiDialog{
protected:
public:	
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	rptDetailedlistofpatientcostoutpatientintreatment(CWnd *pParent);
	~rptDetailedlistofpatientcostoutpatientintreatment();
