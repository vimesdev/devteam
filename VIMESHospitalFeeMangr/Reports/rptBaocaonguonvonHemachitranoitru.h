#ifndef rptBaocaonguonvonHemachitranoitru_H
#define rptBaocaonguonvonHemachitranoitru_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptBaocaonguonvonHemachitranoitru : public CGuiDialog{
protected:
public:	
	...
	void		PrinReport(CString szReportPeriod, CString szFromDate, CString szToDate,  bool bPreview=true);
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	rptBaocaonguonvonHemachitranoitru(CWnd *pParent);
	~rptBaocaonguonvonHemachitranoitru();
