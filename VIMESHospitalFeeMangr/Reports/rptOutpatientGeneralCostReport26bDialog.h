#ifndef RPTOUTPATIENTGENERALCOSTREPORTDIALOG26B_H
#define RPTOUTPATIENTGENERALCOSTREPORTDIALOG26B_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptOutpatientGeneralCostReport26bDialog : public CGuiDialog{
protected:
public:	
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	rptOutpatientGeneralCostReport26bDialog(CWnd *pParent);
	~rptOutpatientGeneralCostReport26bDialog();
