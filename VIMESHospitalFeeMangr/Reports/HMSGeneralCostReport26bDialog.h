#ifndef HMSGENERALCOSTREPORTDIALOG26B_H
#define HMSGENERALCOSTREPORTDIALOG26B_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSGeneralCostReport26bDialog : public CGuiDialog{
protected:
public:	
	...
	void		PrintGeneralCost26bReport(CString szReportPeriod, CString szFromDate, CString szToDate,  bool bPreview=true);
	void		ExportToExcell26bReport();
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CHMSGeneralCostReport26bDialog(CWnd *pParent);
	~CHMSGeneralCostReport26bDialog();
