#ifndef rptGeneralExaminationCostsServiceReport25b_H
#define rptGeneralExaminationCostsServiceReport25b_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptGeneralExaminationCostsServiceReport25b : public CGuiDialog{
protected:
public:
	...
	rptGeneralExaminationCostsServiceReport25b(CWnd *pParent);
	~rptGeneralExaminationCostsServiceReport25b();
	...
	int OnAddrptGeneralExaminationCostsServiceReport25b(); 
	int OnEditrptGeneralExaminationCostsServiceReport25b(); 
	int OnDeleterptGeneralExaminationCostsServiceReport25b(); 
	int OnSaverptGeneralExaminationCostsServiceReport25b(); 
	int OnCancelrptGeneralExaminationCostsServiceReport25b(); 
	int OnrptGeneralExaminationCostsServiceReport25bListLoadData(); 
};
#endif
