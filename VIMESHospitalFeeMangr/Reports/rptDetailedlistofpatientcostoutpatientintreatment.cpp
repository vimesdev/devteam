#include "rptDetailedlistofpatientcostoutpatientintreatment.h"
#include "ReportDocument.h"
#include "Excel.h"
#include "../MainFrm.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptDetailedlistofpatientcostoutpatientintreatment * )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptDetailedlistofpatientcostoutpatientintreatment * )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnClerkAddNew();
}*/

static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnDeptLoadData();
}

static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnObjectLoadData();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	rptDetailedlistofpatientcostoutpatientintreatment *pVw = (rptDetailedlistofpatientcostoutpatientintreatment *)pWnd;
...
static int _OnAddHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnAddHMSGeneralCostReportDialog();
} 
static int _OnEditHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnEditHMSGeneralCostReportDialog();
} 
static int _OnDeleteHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnDeleteHMSGeneralCostReportDialog();
} 
static int _OnSaveHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnSaveHMSGeneralCostReportDialog();
} 
static int _OnCancelHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((rptDetailedlistofpatientcostoutpatientintreatment *)pWnd)->OnCancelHMSGeneralCostReportDialog();
} 
rptDetailedlistofpatientcostoutpatientintreatment ::rptDetailedlistofpatientcostoutpatientintreatment (CWnd *pParent):
	CGuiDialog(pParent){
...
rptDetailedlistofpatientcostoutpatientintreatment ::~rptDetailedlistofpatientcostoutpatientintreatment (){
}
void rptDetailedlistofpatientcostoutpatientintreatment ::OnCreateComponents(){
...
void rptDetailedlistofpatientcostoutpatientintreatment ::OnInitializeComponents(){
...
void rptDetailedlistofpatientcostoutpatientintreatment ::OnSetWindowEvents(){
...
void rptDetailedlistofpatientcostoutpatientintreatment ::OnDoDataExchange(CDataExchange* pDX){
...
void rptDetailedlistofpatientcostoutpatientintreatment ::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void rptDetailedlistofpatientcostoutpatientintreatment ::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void rptDetailedlistofpatientcostoutpatientintreatment ::SetDefaultValues(){
...
int rptDetailedlistofpatientcostoutpatientintreatment ::SetMode(int nMode){
...
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnYearChange(){
	
} */
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnYearSetfocus(){
	
} */
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnYearKillfocus(){
	
} */
int rptDetailedlistofpatientcostoutpatientintreatment ::OnYearCheckValue(){
	return 0;
} 
void rptDetailedlistofpatientcostoutpatientintreatment ::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptDetailedlistofpatientcostoutpatientintreatment ::OnReportPeriodSelendok(){
...
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnReportPeriodSetfocus(){
	
}*/
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnReportPeriodKillfocus(){
	
}*/
long rptDetailedlistofpatientcostoutpatientintreatment ::OnReportPeriodLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnFromDateChange(){
	
} */
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnFromDateSetfocus(){
	
} */
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnFromDateKillfocus(){
	
} */
int rptDetailedlistofpatientcostoutpatientintreatment ::OnFromDateCheckValue(){
	return 0;
} 
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnToDateChange(){
	
} */
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnToDateSetfocus(){
	
} */
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnToDateKillfocus(){
	
} */
int rptDetailedlistofpatientcostoutpatientintreatment ::OnToDateCheckValue(){
	return 0;
} 
void rptDetailedlistofpatientcostoutpatientintreatment ::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptDetailedlistofpatientcostoutpatientintreatment ::OnClerkSelendok(){
	 
}
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnClerkSetfocus(){
	
}*/
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnClerkKillfocus(){
	
}*/
long rptDetailedlistofpatientcostoutpatientintreatment ::OnClerkLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void rptDetailedlistofpatientcostoutpatientintreatment ::OnClerkAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

long rptDetailedlistofpatientcostoutpatientintreatment ::OnDeptLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
long rptDetailedlistofpatientcostoutpatientintreatment ::OnObjectLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void rptDetailedlistofpatientcostoutpatientintreatment ::OnPrintPreviewSelect(){	
	ExportToExcellReport();		
	UpdateData(false);
} 
void rptDetailedlistofpatientcostoutpatientintreatment ::OnPrintSelect(){	
	ExportToExcellReport();		
	UpdateData(false);
} 
void rptDetailedlistofpatientcostoutpatientintreatment ::OnExportSelect(){	
	//UpdateData(true);
	ExportToExcellReport();		
	UpdateData(false);
} 
void rptDetailedlistofpatientcostoutpatientintreatment ::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
} 
int rptDetailedlistofpatientcostoutpatientintreatment ::OnAddHMSGeneralCostReportDialog(){
...
int rptDetailedlistofpatientcostoutpatientintreatment ::OnEditHMSGeneralCostReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int rptDetailedlistofpatientcostoutpatientintreatment ::OnDeleteHMSGeneralCostReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int rptDetailedlistofpatientcostoutpatientintreatment ::OnSaveHMSGeneralCostReportDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int rptDetailedlistofpatientcostoutpatientintreatment ::OnCancelHMSGeneralCostReportDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int rptDetailedlistofpatientcostoutpatientintreatment ::OnHMSGeneralCostReportDialogListLoadData(){
	return 0;
}
//Bao cao chi phi benh nhan dich vu dieu tri ngoai tru trong khoa
void rptDetailedlistofpatientcostoutpatientintreatment::ExportToExcellReport(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	_T("  WHERE hcr_status ='T' and ho_type in('I','C') AND hd_disrate < 100 %s") \
	_T("  GROUP BY docno, pname, birthyear, sex, address,deptid, ho_type,disrate,") \
	...
	TranslateString(_T("\x42\x1EA2NG K\xCA \x43P \x42\x1EC6NH NH\xC2N \x43\xD9NG \x43HI TR\x1EA2 TRONG KHO\x41"), tmpStr);
	...
	TranslateString(_T("BHY(%)"), tmpStr);	
	xls.SetCellText(53, nRow, tmpStr, FMT_TEXT,true);	
	TranslateString(_T("BHYT Tra"), tmpStr);	
	xls.SetCellText(54, nRow, tmpStr, FMT_TEXT,true);	
	

	TranslateString(_T("Ho\xE0n \x1EE9ng"), tmpStr);	
	xls.SetCellText(57, nRow, tmpStr, FMT_TEXT,true);	
	xls.SetCellText(58, nRow, _T("User"), FMT_TEXT,true);	
	xls.SetCellText(59, nRow, _T("Ng\xE0y thu"), FMT_TEXT,true);	
	xls.SetCellText(60, nRow, _T("RecordNo"), FMT_TEXT,true);
	...
	xls.SetCellMergedColumns(55,nRow,2);
	TranslateString(_T("\x42\x1EC6NH NH\xC2N TR\x1EA2"), tmpStr); //BENH NHAN TRA
	...
	xls.SetCellMergedRows(59,nRow,2);
	xls.SetCellMergedRows(60,nRow,2);
	...
	// Benh nhan tra
	TranslateString(_T("T\x1EF1 t\xFA\x63"), tmpStr);	
	xls.SetCellText(55, nRow, tmpStr, FMT_TEXT,true);	
...
// CDHA
	...
	//---------------------------------------------------------------------
		...
		grpOfLine[54] += cost;
		tmpStr.Format(_T("%.2f"), cost);
		xls.SetCellText(54, nRow, tmpStr, FMT_NUMBER1,false);
		...
		grpOfLine[57] += cost;
		tmpStr.Format(_T("%.2f"), cost);
		xls.SetCellText(57, nRow, tmpStr, FMT_NUMBER1,false);
		
		rs.GetValue(_T("Userid"), tmpStr);
		xls.SetCellText(58, nRow, tmpStr, FMT_TEXT);		
		
		rs.GetValue(_T("recvdate"), tmpStr);
		xls.SetCellText(59, nRow, CDate::Convert(tmpStr, yyyymmdd,ddmmyyyy), FMT_DATE);	

		rs.GetValue(_T("recordno"), tmpStr);
		xls.SetCellText(60, nRow, tmpStr, FMT_INTEGER);
	...
	xls.Save(_T("Exports\\Chiphibenhnhancungchitratrongkhoa.xls"));
	EndWaitCursor();
