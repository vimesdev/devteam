#include "rptGeneralCostInsuraceReportOutpatient25aDialog.h"
#include "../MainFrm.h"
#include "ReportDocument.h"
#include "Excel.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptGeneralCostInsuraceReportOutpatient25aDialog* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptGeneralCostInsuraceReportOutpatient25aDialog* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	rptGeneralCostInsuraceReportOutpatient25aDialog *pVw = (rptGeneralCostInsuraceReportOutpatient25aDialog *)pWnd;
...
static void _OnKhonglayHEMASelectFnc(CWnd *pWnd){
	 ((rptGeneralCostInsuraceReportOutpatient25aDialog*)pWnd)->OnKhonglayHEMASelect();
}
static void _OnLaybnccSelectFnc(CWnd *pWnd){
	 ((rptGeneralCostInsuraceReportOutpatient25aDialog*)pWnd)->OnLaybnccSelect();
}
static int _OnAddrptGeneralCostInsuraceReportOutpatient25aDialogFnc(CWnd *pWnd){
	 return ((rptGeneralCostInsuraceReportOutpatient25aDialog*)pWnd)->OnAddrptGeneralCostInsuraceReportOutpatient25aDialog();
} 
static int _OnEditrptGeneralCostInsuraceReportOutpatient25aDialogFnc(CWnd *pWnd){
	 return ((rptGeneralCostInsuraceReportOutpatient25aDialog*)pWnd)->OnEditrptGeneralCostInsuraceReportOutpatient25aDialog();
} 
static int _OnDeleterptGeneralCostInsuraceReportOutpatient25aDialogFnc(CWnd *pWnd){
	 return ((rptGeneralCostInsuraceReportOutpatient25aDialog*)pWnd)->OnDeleterptGeneralCostInsuraceReportOutpatient25aDialog();
} 
static int _OnSaverptGeneralCostInsuraceReportOutpatient25aDialogFnc(CWnd *pWnd){
	 return ((rptGeneralCostInsuraceReportOutpatient25aDialog*)pWnd)->OnSaverptGeneralCostInsuraceReportOutpatient25aDialog();
} 
static int _OnCancelrptGeneralCostInsuraceReportOutpatient25aDialogFnc(CWnd *pWnd){
	 return ((rptGeneralCostInsuraceReportOutpatient25aDialog*)pWnd)->OnCancelrptGeneralCostInsuraceReportOutpatient25aDialog();
} 
rptGeneralCostInsuraceReportOutpatient25aDialog::rptGeneralCostInsuraceReportOutpatient25aDialog(CWnd *pParent):
	CGuiDialog(pParent){
...
rptGeneralCostInsuraceReportOutpatient25aDialog::~rptGeneralCostInsuraceReportOutpatient25aDialog(){
}
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnCreateComponents(){
	m_wndReportFilter.Create(this, _T("Report Parameters"), 5, 5, 420, 155);
	...
	//m_wndPrintPreview.Create(this, _T("Print Pre&view"), 85, 125, 165, 150);
	m_wndPrint.Create(this, _T("&Print"), 165, 125, 245, 150);
	m_wndExport.Create(this, _T("&Export"), 250, 125, 330, 150);
	m_wndClose.Create(this, _T("&Close"), 335, 125, 415, 150);
}
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnInitializeComponents(){
...
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnSetWindowEvents(){
	...
	/*m_wndKhonglayHEMA.SetEvent(WE_CLICK, _OnKhonglayHEMASelectFnc);
...
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnDoDataExchange(CDataExchange* pDX){
	DDX_Text(pDX, m_wndYear.GetDlgCtrlID(), m_nYear);
	DDX_TextEx(pDX, m_wndReportPeriod.GetDlgCtrlID(), m_szReportPeriodKey);
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);
	DDX_TextEx(pDX, m_wndClerk.GetDlgCtrlID(), m_szClerkKey);
	/*DDX_Check(pDX, m_wndKhonglayHEMA.GetDlgCtrlID(), m_bKhonglayHEMA);
	DDX_Check(pDX, m_wndLaybncc.GetDlgCtrlID(), m_bLaybncc);*/

}
void rptGeneralCostInsuraceReportOutpatient25aDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void rptGeneralCostInsuraceReportOutpatient25aDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void rptGeneralCostInsuraceReportOutpatient25aDialog::SetDefaultValues(){
	...
	m_szToDate.Empty();
	m_szClerkKey.Empty();
	/*m_bKhonglayHEMA=FALSE;
	m_bLaybncc=FALSE;*/

}
int rptGeneralCostInsuraceReportOutpatient25aDialog::SetMode(int nMode){
...
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnYearChange(){
	
} */
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnYearSetfocus(){
	
} */
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnYearKillfocus(){
	
} */
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnYearCheckValue(){
	return 0;
} 
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnReportPeriodSelendok(){
...
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnReportPeriodSetfocus(){
	
}*/
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnReportPeriodKillfocus(){
	
}*/
long rptGeneralCostInsuraceReportOutpatient25aDialog::OnReportPeriodLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnFromDateChange(){
	
} */
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnFromDateSetfocus(){
	
} */
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnFromDateKillfocus(){
	
} */
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnToDateChange(){
	
} */
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnToDateSetfocus(){
	
} */
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnToDateKillfocus(){
	
} */
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnToDateCheckValue(){
	return 0;
} 
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnClerkSelendok(){
	 
}
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnClerkSetfocus(){
	
}*/
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnClerkKillfocus(){
	
}*/
long rptGeneralCostInsuraceReportOutpatient25aDialog::OnClerkLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void rptGeneralCostInsuraceReportOutpatient25aDialog::OnClerkAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnPrintPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	PrintGeneralCostInsuranceOutpatient25AReport(m_szReportPeriodKey,m_szFromDate,m_szToDate, true);	
} 
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
	PrintGeneralCostInsuranceOutpatient25AReport(m_szReportPeriodKey,m_szFromDate,m_szToDate, false);	
} 
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szWhere;
	szWhere.Empty();
	UpdateData(true);
	ExportToExcellInsuranceOutpatient25AReport(m_szReportPeriodKey,m_szFromDate,m_szToDate, true);	
} 
void rptGeneralCostInsuraceReportOutpatient25aDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
} 
	void rptGeneralCostInsuraceReportOutpatient25aDialog::OnKhonglayHEMASelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	//m_bKhonglayHEMA=true;
	m_bLaybncc=false;
	UpdateData(false);
	
}
	void rptGeneralCostInsuraceReportOutpatient25aDialog::OnLaybnccSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_bKhonglayHEMA=false;
	//m_bLaybncc=true;
...
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnAddrptGeneralCostInsuraceReportOutpatient25aDialog(){
...
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnEditrptGeneralCostInsuraceReportOutpatient25aDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnDeleterptGeneralCostInsuraceReportOutpatient25aDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelrptGeneralCostInsuraceReportOutpatient25aDialog(); 
 	}
	return 0;
}
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnSaverptGeneralCostInsuraceReportOutpatient25aDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnrptGeneralCostInsuraceReportOutpatient25aDialogListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnCancelrptGeneralCostInsuraceReportOutpatient25aDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int rptGeneralCostInsuraceReportOutpatient25aDialog::OnrptGeneralCostInsuraceReportOutpatient25aDialogListLoadData(){
	return 0;
}
void rptGeneralCostInsuraceReportOutpatient25aDialog::PrintGeneralCostInsuranceOutpatient25AReport(CString szReportPeriod, CString szFromDate, CString szToDate, bool bPreview)
{
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	UpdateData(true);
	// Chi lay benh nhan HEMA vao bao cao
	//if (m_bKhonglayHEMA==1) szWhere.Format(_T(" and hd_xobject ='H' "));	
	...
	if (pMF->m_szDiscountPrintReport !=_T("Y"))
	{
		szSQL.Format(_T(" SELECT  hd_docno as docno, max(hfi_invoiceno) as invoiceno, ") \
			...
			_T("  WHERE ho_type in('I','C') and hd_status='T' and length(hc_cardno) > 1 and hd_suggestion not in('A') %s ") \
...
void rptGeneralCostInsuraceReportOutpatient25aDialog::ExportToExcellInsuranceOutpatient25AReport(CString szReportPeriod, CString szFromDate, CString szToDate, bool bPreview){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	
	UpdateData(true);
	CString tmpStr, szSQL,szFromDateToDate;
	CString szWhere,szInpatientCost;
	
	/*if (m_bLaybncc==1)
		szWhere.Format(_T(" and hd_emergency in('Y')"));
	else
		if (m_bKhonglayHEMA==1) szWhere.Format(_T(" and (hd_emergency not in('Y') or hd_emergency is null) "));
	*/
...
BeginWaitCursor();
	...
	TranslateString(_T("BAO CAO CP KHAM CHUA BENH NGOAI TRU BHYT"), tmpStr);
	...
	xls.SetCellMergedColumns(9,nRow,11);
	...
	xls.SetCellText(9, nRow, _T("XN,CDCN"), FMT_TEXT,true);	
	...
	xls.SetCellText(14, nRow, _T("VTYT"), FMT_TEXT,true);	
	xls.SetCellText(15, nRow, _T("DVKTC"), FMT_TEXT,true);	
	xls.SetCellText(16, nRow, _T("Thuoc K, Thai gep"), FMT_TEXT,true);
	TranslateString(_T("Examination Fee"), tmpStr);
	xls.SetCellText(17, nRow, tmpStr, FMT_TEXT,true);	;	
	xls.SetCellText(18, nRow, _T("PhiVC"), FMT_TEXT,true);	
	...
	{		
		...
		rs.GetValue(_T("docno"), tmpStr);
		xls.SetCellText(8, nRow, tmpStr, FMT_INTEGER,false);		
		...
		xls.SetCellText(9, nRow, tmpStr, FMT_NUMBER1,false);

		rs.GetValue(_T("pacsfee"), cost);
		grpCost[10] += cost;
		grpLine[10] += cost;
		tmpStr.Format(_T("%.2f"), cost);
		xls.SetCellText(10, nRow, tmpStr, FMT_NUMBER1,false);
		
		rs.GetValue(_T("drugfee"), cost);
		grpCost[11] += cost;
		grpLine[11] += cost;		
		tmpStr.Format(_T("%.2f"), cost);
		xls.SetCellText(11, nRow, tmpStr, FMT_NUMBER1,false);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\ChiphikhambenhngoaitruBHYT_25a.xls"));
