#ifndef Detailedlistofpatientcostinpatienttreatment_H
#define Detailedlistofpatientcostinpatienttreatment_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptDetailedlistofpatientcostinpatienttreatment : public CGuiDialog{
protected:
public:	
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	rptDetailedlistofpatientcostinpatienttreatment(CWnd *pParent);
	~rptDetailedlistofpatientcostinpatienttreatment();
