#include "HMSGeneralCostReport26bDialog.h"
#include "ReportDocument.h"
#include "Excel.h"
#include "../MainFrm.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSGeneralCostReport26bDialog * )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSGeneralCostReport26bDialog * )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CHMSGeneralCostReport26bDialog *)pWnd)->OnClerkAddNew();
}*/

static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnDeptLoadData();
}

static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CHMSGeneralCostReport26bDialog *pVw = (CHMSGeneralCostReport26bDialog *)pWnd;
...
static int _OnAddHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnAddHMSGeneralCostReportDialog();
} 
static int _OnEditHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnEditHMSGeneralCostReportDialog();
} 
static int _OnDeleteHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnDeleteHMSGeneralCostReportDialog();
} 
static int _OnSaveHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnSaveHMSGeneralCostReportDialog();
} 
static int _OnCancelHMSGeneralCostReportDialogFnc(CWnd *pWnd){
	 return ((CHMSGeneralCostReport26bDialog *)pWnd)->OnCancelHMSGeneralCostReportDialog();
} 
CHMSGeneralCostReport26bDialog ::CHMSGeneralCostReport26bDialog (CWnd *pParent):
	CGuiDialog(pParent){
...
CHMSGeneralCostReport26bDialog ::~CHMSGeneralCostReport26bDialog (){
}
void CHMSGeneralCostReport26bDialog ::OnCreateComponents(){
...
void CHMSGeneralCostReport26bDialog ::OnInitializeComponents(){
...
void CHMSGeneralCostReport26bDialog ::OnSetWindowEvents(){
...
void CHMSGeneralCostReport26bDialog ::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSGeneralCostReport26bDialog ::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSGeneralCostReport26bDialog ::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CHMSGeneralCostReport26bDialog ::SetDefaultValues(){
...
int CHMSGeneralCostReport26bDialog ::SetMode(int nMode){
...
/*void CHMSGeneralCostReport26bDialog ::OnYearChange(){
	
} */
/*void CHMSGeneralCostReport26bDialog ::OnYearSetfocus(){
	
} */
/*void CHMSGeneralCostReport26bDialog ::OnYearKillfocus(){
	
} */
int CHMSGeneralCostReport26bDialog ::OnYearCheckValue(){
	return 0;
} 
void CHMSGeneralCostReport26bDialog ::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSGeneralCostReport26bDialog ::OnReportPeriodSelendok(){
...
/*void CHMSGeneralCostReport26bDialog ::OnReportPeriodSetfocus(){
	
}*/
/*void CHMSGeneralCostReport26bDialog ::OnReportPeriodKillfocus(){
	
}*/
long CHMSGeneralCostReport26bDialog ::OnReportPeriodLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSGeneralCostReport26bDialog ::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSGeneralCostReport26bDialog ::OnFromDateChange(){
	
} */
/*void CHMSGeneralCostReport26bDialog ::OnFromDateSetfocus(){
	
} */
/*void CHMSGeneralCostReport26bDialog ::OnFromDateKillfocus(){
	
} */
int CHMSGeneralCostReport26bDialog ::OnFromDateCheckValue(){
	return 0;
} 
/*void CHMSGeneralCostReport26bDialog ::OnToDateChange(){
	
} */
/*void CHMSGeneralCostReport26bDialog ::OnToDateSetfocus(){
	
} */
/*void CHMSGeneralCostReport26bDialog ::OnToDateKillfocus(){
	
} */
int CHMSGeneralCostReport26bDialog ::OnToDateCheckValue(){
	return 0;
} 
void CHMSGeneralCostReport26bDialog ::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSGeneralCostReport26bDialog ::OnClerkSelendok(){
	 
}
/*void CHMSGeneralCostReport26bDialog ::OnClerkSetfocus(){
	
}*/
/*void CHMSGeneralCostReport26bDialog ::OnClerkKillfocus(){
	
}*/
long CHMSGeneralCostReport26bDialog ::OnClerkLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSGeneralCostReport26bDialog ::OnClerkAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

long CHMSGeneralCostReport26bDialog ::OnDeptLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CHMSGeneralCostReport26bDialog ::OnPrintPreviewSelect(){	
	//UpdateData(true);
	PrintGeneralCost26bReport(m_szReportPeriodKey,m_szFromDate,m_szToDate,true);
	UpdateData(false);
} 
void CHMSGeneralCostReport26bDialog ::OnPrintSelect(){	
	PrintGeneralCost26bReport(m_szReportPeriodKey,m_szFromDate,m_szToDate,false);	
} 
void CHMSGeneralCostReport26bDialog ::OnExportSelect(){	
	//UpdateData(true);
	ExportToExcell26bReport();		
	UpdateData(false);
} 
void CHMSGeneralCostReport26bDialog ::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
} 
int CHMSGeneralCostReport26bDialog ::OnAddHMSGeneralCostReportDialog(){
...
int CHMSGeneralCostReport26bDialog ::OnEditHMSGeneralCostReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHMSGeneralCostReport26bDialog ::OnDeleteHMSGeneralCostReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CHMSGeneralCostReport26bDialog ::OnSaveHMSGeneralCostReportDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CHMSGeneralCostReport26bDialog ::OnCancelHMSGeneralCostReportDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSGeneralCostReport26bDialog ::OnHMSGeneralCostReportDialogListLoadData(){
	return 0;
}
void CHMSGeneralCostReport26bDialog::PrintGeneralCost26bReport(CString szReportPeriod, CString szFromDate, CString szToDate, bool bPreview)
{	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	if (pMF->m_szDiscountPrintReport != _T("Y"))
	{
		...
		_T(" 	and hfi_class in('I') and hfe_discount > 0 %s %S ") \
		_T("  ) as tbl ") \
		...
		_T("  GROUP BY docno, pname, birthyear, sex, cardno,address, insline,insgroup,linename,hdline,regplace,deptid,regdate,expdate,recordno, icd10, admitdate, dischargedate, totaltreat,userid ") \
		_T("  HAVING sum(cost) > 0") \
		_T("  ORDER BY insline,insgroup,hdline,cardno,deptid,userid"), m_szFromDate, m_szToDate, szUserReceiver,szWhere);
	}
	else
	{
...
void CHMSGeneralCostReport26bDialog::ExportToExcell26bReport(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	xls.SetCellText(7, nRow, _T("Khoa"), FMT_TEXT,true);
	...
	//xls.SetCellMergedColumns(16,nRow,3);	
	...
	xls.SetCellText(29, nRow, _T("Do DL Xuong"), FMT_TEXT,true); // Luu huyet nao
	...
	{		
		...
		if(szNewDocno != szOldDocno && !szNewDocno.IsEmpty() && szNewDocno.GetLength() >0)
		{		
...
// CDHA
	...
	xls.Save(_T("Exports\\QuyettoanBHYT26b.xls"));
	EndWaitCursor();
