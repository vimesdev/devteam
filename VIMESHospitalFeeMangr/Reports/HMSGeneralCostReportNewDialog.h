#ifndef HMSGENERALCOSTREPORTDIALOGNEW_H
#define HMSGENERALCOSTREPORTDIALOGNEW_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSGeneralCostReportNewDialog : public CGuiDialog{
protected:
public:	
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CHMSGeneralCostReportNewDialog(CWnd *pParent);
	~CHMSGeneralCostReportNewDialog();
