#ifndef HMSHFPATIENTFEE_H
#define HMSHFPATIENTFEE_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSHFPatientFee : public CGuiView{
protected:
public:
	...
	int			OnInvoiceListPrintInvoice(); 
	int			OnInvoiceListPrintGeneralExaminationCost(); 
	int			OnInvoiceListPrintDischargePayment(); 
	...
	void OnCreateAdvanceReceipt();
	void OnCreateRefundReceipt();
	void OnCreateRemissionReceipt();
	void OnPayment();
	void OnPrintPaymentReceipt();
