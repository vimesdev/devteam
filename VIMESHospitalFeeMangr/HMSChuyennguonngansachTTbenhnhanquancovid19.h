#ifndef HMSCHUYENNGUONTTBENHNHANQUANCOVID19DIALOG_H
#define HMSCHUYENNGUONTTBENHNHANQUANCOVID19DIALOG_H
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSChuyennguonTTbenhnhanquancovid19 : public CGuiDialog
{
protected:
public:
	long	m_nDocumentNo;
	...
	CGuiLabel		m_wndNguonthantoanLabel;
	...
	CGuiComboBox	m_wndnguonthanhtoan;
	CString	m_sznguonthanhtoanKey;
	int	m_nTatca;
	int	m_nPhikham;
	int	m_nPhiCLS;
	int	m_nPhithuoc;
	...
	CHMSChuyennguonTTbenhnhanquancovid19(CWnd *pParent);
	~CHMSChuyennguonTTbenhnhanquancovid19();
