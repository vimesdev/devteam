...
/*static void _OnDepositChangeFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDepositChange();
} */
/*static void _OnDepositSetfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDepositSetfocus();} */ 
/*static void _OnDepositKillfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDepositKillfocus();
} */
static int _OnDepositCheckValueFnc(CWnd *pWnd){
	return ((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDepositCheckValue();
} 
static void _OnSerialNoSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSPaymentInvoiceDialog2* )pWnd)->OnSerialNoSelectChange(nOldItemSel, nNewItemSel);
} 
...
/*static void _OnSerialNoAddNewFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnSerialNoAddNew();
}*/
...
/*static void _OnRemissionChangeFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnRemissionChange();
} */
/*static void _OnRemissionSetfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnRemissionSetfocus();} */ 
/*static void _OnRemissionKillfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnRemissionKillfocus();
} */
static int _OnRemissionCheckValueFnc(CWnd *pWnd){
	return ((CHMSPaymentInvoiceDialog2 *)pWnd)->OnRemissionCheckValue();
} 
/*static void _OnFreeChangeFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnFreeChange();
} */
/*static void _OnFreeSetfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnFreeSetfocus();} */ 
/*static void _OnFreeKillfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnFreeKillfocus();
} */
static int _OnFreeCheckValueFnc(CWnd *pWnd){
	return ((CHMSPaymentInvoiceDialog2 *)pWnd)->OnFreeCheckValue();
} 
/*static void _OnReceiveNoChangeFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnReceiveNoChange();
} */
/*static void _OnReceiveNoSetfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnReceiveNoSetfocus();} */ 
/*static void _OnReceiveNoKillfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnReceiveNoKillfocus();
} */
static int _OnReceiveNoCheckValueFnc(CWnd *pWnd){
	return ((CHMSPaymentInvoiceDialog2 *)pWnd)->OnReceiveNoCheckValue();
} 
/*static void _OnDifferencePaidChangeFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDifferencePaidChange();
} */
/*static void _OnDifferencePaidSetfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDifferencePaidSetfocus();} */ 
/*static void _OnDifferencePaidKillfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDifferencePaidKillfocus();
} */
static int _OnDifferencePaidCheckValueFnc(CWnd *pWnd){
	return ((CHMSPaymentInvoiceDialog2 *)pWnd)->OnDifferencePaidCheckValue();
} 
/*static void _OnTotalPayableChangeFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnTotalPayableChange();
} */
/*static void _OnTotalPayableSetfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnTotalPayableSetfocus();} */ 
/*static void _OnTotalPayableKillfocusFnc(CWnd *pWnd){
	((CHMSPaymentInvoiceDialog2 *)pWnd)->OnTotalPayableKillfocus();
} */
static int _OnTotalPayableCheckValueFnc(CWnd *pWnd){
	return ((CHMSPaymentInvoiceDialog2 *)pWnd)->OnTotalPayableCheckValue();
} 
...
static void _OnInsuranceUnpaidFilterSelectFnc(CWnd *pWnd){
	 ((CHMSPaymentInvoiceDialog2*)pWnd)->OnInsuranceUnpaidFilterSelect();
}
...
static int _OnAddHMSPaymentInvoiceDialogFnc(CWnd *pWnd){
	 return ((CHMSPaymentInvoiceDialog2*)pWnd)->OnAddHMSPaymentInvoiceDialog();
} 
static int _OnEditHMSPaymentInvoiceDialogFnc(CWnd *pWnd){
	 return ((CHMSPaymentInvoiceDialog2*)pWnd)->OnEditHMSPaymentInvoiceDialog();
} 
static int _OnDeleteHMSPaymentInvoiceDialogFnc(CWnd *pWnd){
	 return ((CHMSPaymentInvoiceDialog2*)pWnd)->OnDeleteHMSPaymentInvoiceDialog();
} 
static int _OnSaveHMSPaymentInvoiceDialogFnc(CWnd *pWnd){
	 return ((CHMSPaymentInvoiceDialog2*)pWnd)->OnSaveHMSPaymentInvoiceDialog();
} 
static int _OnCancelHMSPaymentInvoiceDialogFnc(CWnd *pWnd){
	 return ((CHMSPaymentInvoiceDialog2*)pWnd)->OnCancelHMSPaymentInvoiceDialog();
} 
...
//	m_wndReceiveDate.SetCheckValue(true);
	...
	m_wndList.InsertColumn(3, _T("Quantity"), CFMT_MONEY, 70);
		...
		m_wndList.InsertColumn(12, _T("Type"), CFMT_NUMBER, 0);
		m_wndList.InsertColumn(13, _T("ITEM"), CFMT_TEXT, 0);
...
long CHMSPaymentInvoiceDialog2::OnListLoadData(){
	...
	szSQL.Format(_T(" SELECT") \
		...
		_T(" 		sum(hfe_cost-hfe_inspaid) as patdebt,") \
		_T(" 		sum(hfe_cost-hfe_discount) as payable,") \
				...
				if(!tmpStr.IsEmpty() && m_szDepartments.Find(tmpStr) == -1){
					...
					if(szParentGroup == szNewGroup.Left(szParentGroup.GetLength()))
					{
						...
						if(pMF->GetObjectType() == _T("I") || pMF->GetObjectType() == _T("C"))
						{
							...
							rs.GetValue(_T("patdebt"), dDifAmount);
							//if(dInsAmount == 0)
						...
						{
							rs.GetValue(_T("discount"), dInsAmount);
							dTotal[2] += dInsAmount;
							dGroup1[2] += dInsAmount;
							dGroup2[2] += dInsAmount;

							rs.GetValue(_T("payable"), dDifAmount);
							//if(dInsAmount == 0)
							//	dDifAmount = dAmount-dInsAmount;
							dTotal[3] += dDifAmount;
							dGroup1[3] += dDifAmount;
							...
							rs.GetValue(_T("unitprice")),
							rs.GetValue(_T("cost")),
							dAmount>0?rs.GetValue(_T("unitprice")):_T(""),
	...
	if(dTotal[0] > 0){
		...
		if(dTotal[2] > 0)
		{
			if(dDiscount == dTotal[2])
			{
				dFreeAmount = dDiscount;	
				m_bRemission100 = true;
			}
			else
				dFreeAmount = str2int(pMF->m_wndPatientFee.m_szCardDiscount)*dTotal[2]/100;
		}
		m_nTotalCost = dTotal[0];
		m_nDifferencePaid = dTotal[3];
		if(pMF->GetObjectType() == _T("D") )
...
/*void CHMSPaymentInvoiceDialog2::OnDepositChange(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnDepositSetfocus(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnDepositKillfocus(){
	
} */
int CHMSPaymentInvoiceDialog2::OnDepositCheckValue(){
	return 0;
} 
...
void CHMSPaymentInvoiceDialog2::OnSerialNoSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
long CHMSPaymentInvoiceDialog2::OnSerialNoLoadData(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSPaymentInvoiceDialog2::OnSerialNoAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSPaymentInvoiceDialog2::OnRemissionChange(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnRemissionSetfocus(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnRemissionKillfocus(){
	
} */
int CHMSPaymentInvoiceDialog2::OnRemissionCheckValue(){
	return 0;
} 
/*void CHMSPaymentInvoiceDialog2::OnFreeChange(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnFreeSetfocus(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnFreeKillfocus(){
	
} */
int CHMSPaymentInvoiceDialog2::OnFreeCheckValue(){
	return 0;
} 
/*void CHMSPaymentInvoiceDialog2::OnReceiveNoChange(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnReceiveNoSetfocus(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnReceiveNoKillfocus(){
	
} */
int CHMSPaymentInvoiceDialog2::OnReceiveNoCheckValue(){
	return 0;
} 
/*void CHMSPaymentInvoiceDialog2::OnDifferencePaidChange(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnDifferencePaidSetfocus(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnDifferencePaidKillfocus(){
	
} */
int CHMSPaymentInvoiceDialog2::OnDifferencePaidCheckValue(){
	return 0;
} 
/*void CHMSPaymentInvoiceDialog2::OnTotalPayableChange(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnTotalPayableSetfocus(){
	
} */
/*void CHMSPaymentInvoiceDialog2::OnTotalPayableKillfocus(){
	
} */
int CHMSPaymentInvoiceDialog2::OnTotalPayableCheckValue(){
	return 0;
} 
...
/*void CHMSPaymentInvoiceDialog2::OnDescriptionAddNew(){
	...
	void CHMSPaymentInvoiceDialog2::OnInsuranceUnpaidFilterSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	OnListLoadData();
...
//Neu truong hop benh nhan ngoai tru thanh toan ra vien
	if(pMF->IsFinishAndPaymentExaminationCost(pMF->m_nDocumentNo)){
...
//In bang ke chi phi kham chua benh		
		...
		szSQL.Format(_T("UPDATE hms_treatment_record SET htrf_invoicefee=%ld, htrf_acceptedfee='Y', htrf_accepteddate='%s' ")
			_T(" WHERE htr_docno=%ld and htrf_invoicefee=0 %s "), m_szReceiveDate,  pMF->m_nDocumentNo, szWhere);
		pMF->ExecSQL(szSQL);
...
bool CHMSPaymentInvoiceDialog2::OnPaymentFee2()
{
...
int CHMSPaymentInvoiceDialog2::OnAddHMSPaymentInvoiceDialog(){
...
int CHMSPaymentInvoiceDialog2::OnEditHMSPaymentInvoiceDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHMSPaymentInvoiceDialog2::OnDeleteHMSPaymentInvoiceDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CHMSPaymentInvoiceDialog2::OnSaveHMSPaymentInvoiceDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CHMSPaymentInvoiceDialog2::OnCancelHMSPaymentInvoiceDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSPaymentInvoiceDialog2::OnHMSPaymentInvoiceDialogListLoadData(){
	return 0;
}
...
void CHMSPaymentInvoiceDialog2::RecalcTotal(){
	...
	CRecord rs(&pMF->m_db);
	CString szSQL;
	m_nTotalCost = m_nInsurancePaid = m_nRemission = m_nPatientPaid =  m_nTotalPayable = m_nDifferencePaid = m_nDeposit = 0;
	m_nFree = 0;
	CString tmpStr;
	...
	for (int i =0; i < m_wndList.GetItemCount(); i++){
		...
		if(tmpStr == _T("X")){
			...
			if(pMF->GetObjectType() == _T("I") || pMF->GetObjectType() == _T("C"))
				nInspaid += ToDouble(m_wndList.GetItemText(i, 7));
			else
				m_nRemission += ToDouble(m_wndList.GetItemText(i, 7));
			m_nDifferencePaid += ToDouble(m_wndList.GetItemText(i, 8));
		}
	}
	double dFreeAmount = 0;
	if(m_bRemission100)
	{
		dFreeAmount = nInspaid;
	}
	else
		dFreeAmount = str2int(pMF->m_wndPatientFee.m_szCardDiscount)*nInspaid/100;
	...
	m_wndList.SetItemText(nLast, 7, nInspaid > 0? ToString(nInspaid): _T(""));
	m_wndList.SetItemText(nLast, 8, m_nDifferencePaid > 0? ToString(m_nDifferencePaid): _T(""));
