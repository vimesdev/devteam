#ifndef HMSDepositAdmissionDialog_H
#define HMSDepositAdmissionDialog_H
...
class CHMSDepositAdmissionDialog : public CGuiDialog{
protected:
	...
	int		SetDepositDefault(BOOL bReset=FALSE);
public:
	bool	m_bRefund;
	bool	m_bEnableRefund;
	CString	m_szStatus;
	...
	void			OnCloseSelect(); 
	void			OnCreateRefund();
	CHMSDepositAdmissionDialog(CWnd *pParent, int nMode);
	~CHMSDepositAdmissionDialog();
	...
	int OnAddHMSDepositAdmissionDialog(); 
	int OnEditHMSDepositAdmissionDialog(); 
	int OnDeleteHMSDepositAdmissionDialog(); 
	int OnSaveHMSDepositAdmissionDialog(); 
	int OnCancelHMSDepositAdmissionDialog(); 
	int OnHMSDepositAdmissionDialogListLoadData(); 
};
#endif
