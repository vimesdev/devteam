...
public:
	...
	int OnAddFMSummaryPaymentAndReceipt(); 
	int OnEditFMSummaryPaymentAndReceipt(); 
	int OnDeleteFMSummaryPaymentAndReceipt(); 
	int OnSaveFMSummaryPaymentAndReceipt(); 
	int OnCancelFMSummaryPaymentAndReceipt(); 
	int OnFMSummaryPaymentAndReceiptListLoadData(); 
};
#endif
