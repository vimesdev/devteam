#ifndef HMSOTHERREFUNDDIALOG_H
#define HMSOTHERREFUNDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSOtherRefundDialog : public CGuiDialog{
protected:
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CHMSOtherRefundDialog(CWnd *pParent);
	~CHMSOtherRefundDialog();
	...
	int OnAddHMSOtherRefundDialog(); 
	int OnEditHMSOtherRefundDialog(); 
	int OnDeleteHMSOtherRefundDialog(); 
	int OnSaveHMSOtherRefundDialog(); 
	int OnCancelHMSOtherRefundDialog(); 
	int OnHMSOtherRefundDialogListLoadData(); 
};
#endif
