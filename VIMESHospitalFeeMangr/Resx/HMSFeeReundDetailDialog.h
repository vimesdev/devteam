#ifndef HMSFEEREUNDDETAILDIALOG_H
#define HMSFEEREUNDDETAILDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSFeeReundDetailDialog : public CGuiDialog{
protected:
public:
	...
	void			OnRefundSelect(); 
	void			OnCloseSelect(); 
	CHMSFeeReundDetailDialog(CWnd *pParent);
	~CHMSFeeReundDetailDialog();
	...
	int OnAddHMSFeeReundDetailDialog(); 
	int OnEditHMSFeeReundDetailDialog(); 
	int OnDeleteHMSFeeReundDetailDialog(); 
	int OnSaveHMSFeeReundDetailDialog(); 
	int OnCancelHMSFeeReundDetailDialog(); 
	int OnHMSFeeReundDetailDialogListLoadData(); 
};
#endif
