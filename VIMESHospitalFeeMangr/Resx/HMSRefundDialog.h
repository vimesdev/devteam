#ifndef HMSREFUNDDIALOG_H
#define HMSREFUNDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSRefundDialog : public CGuiDialog{
protected:
public:
	...
	int OnAddHMSRefundDialog(); 
	int OnEditHMSRefundDialog(); 
	int OnDeleteHMSRefundDialog(); 
	int OnSaveHMSRefundDialog(); 
	int OnCancelHMSRefundDialog(); 
	int OnHMSRefundDialogListLoadData(); 
};
#endif
