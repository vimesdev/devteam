#ifndef HMSRECEIPTDIALOG_H
#define HMSRECEIPTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSReceiptDialog : public CGuiDialog{
protected:
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CHMSReceiptDialog(CWnd *pParent);
	~CHMSReceiptDialog();
	...
	int OnAddHMSReceiptDialog(); 
	int OnEditHMSReceiptDialog(); 
	int OnDeleteHMSReceiptDialog(); 
	int OnSaveHMSReceiptDialog(); 
	int OnCancelHMSReceiptDialog(); 
	int OnHMSReceiptDialogListLoadData(); 
};
#endif
