...
CHMSBankPaymentInfoDialog::CHMSBankPaymentInfoDialog(CWnd *pParent):
	CGuiDialog(pParent){
...
void CHMSBankPaymentInfoDialog::OnCreateComponents(){
	m_wndBankPaymentInformation.Create(this, _T("Bank Payment Information"), 5, 5, 490, 300);
	m_wndPOSLabel.Create(this, _T("POS#"), 10, 28, 130, 53);
	m_wndPOS.Create(this,135, 28, 255, 53); 
	m_wndMethodLabel.Create(this, _T("Pay Method"), 260, 29, 360, 54);
	m_wndMethod.Create(this,365, 29, 484, 54); 
	m_wndReceiptNoLabel.Create(this, _T("Receipt No"), 10, 58, 130, 83);
	...
	m_wndAccountNoLabel.Create(this, _T("Account No"), 10, 88, 130, 113);
	...
	m_wndAccountNameLabel.Create(this, _T("Account Name"), 10, 148, 130, 173);
...
void CHMSBankPaymentInfoDialog::OnDoDataExchange(CDataExchange* pDX){
	DDX_Text(pDX, m_wndPOS.GetDlgCtrlID(), m_szPOS);
...
void CHMSBankPaymentInfoDialog::UpdateJson(BOOL bSave){
	...
	m_jData[_T("POS")].GetValue(m_szPOS);
