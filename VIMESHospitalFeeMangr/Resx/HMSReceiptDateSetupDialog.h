#ifndef HMSRECEIPTDATESETUPDIALOG_H
#define HMSRECEIPTDATESETUPDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSReceiptDateSetupDialog : public CGuiDialog{
protected:
public:
	...
	void			OnCancelSelect(); 
	CHMSReceiptDateSetupDialog(CWnd *pParent);
	~CHMSReceiptDateSetupDialog();
	...
	int OnAddHMSReceiptDateSetupDialog(); 
	int OnEditHMSReceiptDateSetupDialog(); 
	int OnDeleteHMSReceiptDateSetupDialog(); 
	int OnSaveHMSReceiptDateSetupDialog(); 
	int OnCancelHMSReceiptDateSetupDialog(); 
	int OnHMSReceiptDateSetupDialogListLoadData(); 
};
#endif
