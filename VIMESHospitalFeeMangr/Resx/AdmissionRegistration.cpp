...
/*static void _OnFoodModeChangeFnc(CWnd *pWnd){
	((CAdmissionRegistration *)pWnd)->OnFoodModeChange();
} */
/*static void _OnFoodModeSetfocusFnc(CWnd *pWnd){
	((CAdmissionRegistration *)pWnd)->OnFoodModeSetfocus();} */ 
/*static void _OnFoodModeKillfocusFnc(CWnd *pWnd){
	((CAdmissionRegistration *)pWnd)->OnFoodModeKillfocus();
} */
static int _OnFoodModeCheckValueFnc(CWnd *pWnd){
	return ((CAdmissionRegistration *)pWnd)->OnFoodModeCheckValue();
} 
...
void CAdmissionRegistration::OnCreateComponents(){
	m_wndPatientInformation.Create(this, _T("Patient Information"), 295, 5, 1015, 570);
	...
	m_wndRankLabel.Create(this, _T("Rank"), 300, 270, 425, 295);
	m_wndRank.Create(this,430, 270, 656, 295); 
	m_wndPositionLabel.Create(this, _T("Position"), 660, 270, 785, 295);
	m_wndPosition.Create(this,790, 270, 1010, 295); 
	m_wndRelativeLabel.Create(this, _T("Relative"), 300, 300, 425, 325);
	m_wndRelative.Create(this,430, 300, 655, 325); 
	m_wndRelationLabel.Create(this, _T("Relation"), 660, 300, 785, 325);
	m_wndRelation.Create(this,790, 300, 1010, 325); 
	m_wndRelPhoneLabel.Create(this, _T("Rel Phone"), 300, 330, 425, 355);
	m_wndRelPhone.Create(this,430, 330, 656, 355); 
	m_wndRelAddressLabel.Create(this, _T("Rel Address"), 660, 330, 785, 355);
	m_wndRelAddress.Create(this,790, 330, 1010, 355); 
	m_wndTranferHospitalLabel.Create(this, _T("From Hospital"), 300, 360, 425, 385);
	m_wndTransferHospital.Create(this,430, 360, 1010, 385); 
	m_wndTransferDiagnosticLabel.Create(this, _T("Transfer Diagnostic"), 300, 390, 425, 415);
	m_wndTransferDiagnostic.Create(this,430, 390, 1010, 415); 
	m_wndFoodModeLabel.Create(this, _T(""), 0, 0, 25, 25);
	m_wndFoodMode.Create(this,0, 0, 25, 25); 
	m_wndICDDiagnosticLabel.Create(this, _T("ICD10 Diagnostic"), 300, 420, 425, 445);
	m_wndICDDiagnostic.Create(this,430, 420, 1010, 445); 
	m_wndConclusionLabel.Create(this, _T("Conclusion"), 300, 450, 425, 475);
	m_wndConclusion.Create(this,430, 450, 1010, 475); 
	m_wndObjectLabel.Create(this, _T("Object"), 10, 90, 65, 115);
	m_wndObject.Create(this,70, 90, 285, 115); 
	m_wndObjLabel.Create(this, _T("Object"), 300, 240, 425, 265);
	m_wndObj.Create(this,430, 240, 655, 265); 
	m_wndCardNoLabel.Create(this, _T("Card No"), 660, 240, 785, 265);
	m_wndCardNo.Create(this,790, 240, 1010, 265); 
	m_wndList.Create(this,5, 215, 290, 475); 
	m_wndLogList.Create(this,5, 480, 290, 600); 
	m_wndLunchLabel.Create(this, _T("Lunch"), 300, 480, 425, 505);
	m_wndLunch.Create(this,430, 480, 1010, 505); 
	m_wndDinnerLabel.Create(this, _T("Dinner"), 300, 509, 425, 534);
	m_wndDinner.Create(this,430, 510, 1010, 535); 
	m_wndEatingDateLabel.Create(this, _T("Eating Date"), 300, 539, 425, 564);
	m_wndEatingDate.Create(this,430, 539, 530, 564); 
	m_wndUpdate.Create(this, _T("&Update"), 344, 575, 439, 600);
	m_wndSave.Create(this, _T("&Save"), 444, 575, 539, 600);
	m_wndCancel.Create(this, _T("&Cancel"), 544, 575, 639, 600);
	m_wndPrintExmSheet.Create(this, _T("Print exm sheet"), 645, 575, 765, 600);
	m_wndPrintFiles.Create(this, _T("Print Files"), 770, 575, 890, 600);
	m_wndPrintFoodSheet.Create(this, _T("Print food sheet"), 895, 575, 1015, 600);
...
void CAdmissionRegistration::OnInitializeComponents(){
	...
	m_wndFoodMode.SetLimitText(1024);
...
/*void CAdmissionRegistration::OnFoodModeChange(){
	
} */
/*void CAdmissionRegistration::OnFoodModeSetfocus(){
	
} */
/*void CAdmissionRegistration::OnFoodModeKillfocus(){
	
} */
int CAdmissionRegistration::OnFoodModeCheckValue(){
	return 0;
} 
