#ifndef HMSFEEPAYMENTDIALOG_H
#define HMSFEEPAYMENTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSFeePaymentDialog : public CGuiDialog{
protected:
public:
	...
	void			OnCloseSelect(); 
	CHMSFeePaymentDialog(CWnd *pParent);
	~CHMSFeePaymentDialog();
	...
	int OnAddHMSFeePaymentDialog(); 
	int OnEditHMSFeePaymentDialog(); 
	int OnDeleteHMSFeePaymentDialog(); 
	int OnSaveHMSFeePaymentDialog(); 
	int OnCancelHMSFeePaymentDialog(); 
	int OnHMSFeePaymentDialogListLoadData(); 
};
#endif
