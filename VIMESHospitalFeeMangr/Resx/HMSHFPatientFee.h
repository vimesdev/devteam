...
public:
	...
	CGuiGroupBox	m_wndBillingInformation;
	...
	int OnAddHMSHFPatientFee(); 
	int OnEditHMSHFPatientFee(); 
	int OnDeleteHMSHFPatientFee(); 
	int OnSaveHMSHFPatientFee(); 
	int OnCancelHMSHFPatientFee(); 
	int OnHMSHFPatientFeeListLoadData(); 
};
#endif
