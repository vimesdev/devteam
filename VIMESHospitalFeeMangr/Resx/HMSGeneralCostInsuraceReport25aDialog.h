...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSGeneralCostInsuraceReport25aDialog : public CGuiDialog{
protected:
public:
	...
	CGuiCheckBox	m_wndNotIncludeEmergency;
	CGuiCheckBox	m_wndIncludeEmergency;
	...
	BOOL	m_bInline;
	BOOL	m_bOffline;
	BOOL	m_bNotIncludeEmergency;
	BOOL	m_bIncludeEmergency;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	void			OnNotIncludeEmergencySelect(); 
	void			OnIncludeEmergencySelect(); 
