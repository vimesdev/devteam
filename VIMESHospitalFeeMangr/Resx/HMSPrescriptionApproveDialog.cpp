...
void CHMSPrescriptionApproveDialog::OnCreateComponents(){
	...
	m_wndPrescriptionInformation.Create(this, _T("Prescription Information"), 375, 5, 1015, 315);
	...
	m_wndDocumentNoLabel.Create(this, _T("Document No"), 380, 30, 535, 55);
	m_wndDocumentNo.Create(this,540, 30, 690, 55); 
	m_wndPatientNameLabel.Create(this, _T("Patient Name"), 695, 30, 850, 55);
	m_wndPatientName.Create(this,855, 30, 1009, 55); 
	m_wndList.Create(this,380, 60, 1010, 250); 
	m_wndTotalCostLabel.Create(this, _T("Total Cost"), 380, 255, 540, 280);
	m_wndTotalCost.Create(this,545, 255, 695, 280); 
	m_wndDepositLabel.Create(this, _T("Deposit"), 700, 255, 855, 280);
	m_wndDeposit.Create(this,860, 255, 1010, 280); 
	m_wndTotalPayableLabel.Create(this, _T("Total Payable"), 380, 285, 540, 310);
	m_wndTotalPayable.Create(this,545, 285, 695, 310); 
	m_wndRemainLabel.Create(this, _T("Remain"), 700, 285, 855, 310);
	m_wndSoDu.Create(this,860, 285, 1010, 310); 
