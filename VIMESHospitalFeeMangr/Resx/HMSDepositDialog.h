#ifndef HMSDEPOSITDIALOG_H
#define HMSDEPOSITDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSDepositDialog : public CGuiDialog{
protected:
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CHMSDepositDialog(CWnd *pParent);
	~CHMSDepositDialog();
	...
	int OnAddHMSDepositDialog(); 
	int OnEditHMSDepositDialog(); 
	int OnDeleteHMSDepositDialog(); 
	int OnSaveHMSDepositDialog(); 
	int OnCancelHMSDepositDialog(); 
	int OnHMSDepositDialogListLoadData(); 
};
#endif
