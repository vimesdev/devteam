#ifndef HMSCARDVOUCHERDIALOG_H
#define HMSCARDVOUCHERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSCardVoucherDialog : public CGuiDialog{
protected:
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CHMSCardVoucherDialog(CWnd *pParent);
	~CHMSCardVoucherDialog();
	...
	int OnAddHMSCardVoucherDialog(); 
	int OnEditHMSCardVoucherDialog(); 
	int OnDeleteHMSCardVoucherDialog(); 
	int OnSaveHMSCardVoucherDialog(); 
	int OnCancelHMSCardVoucherDialog(); 
	int OnHMSCardVoucherDialogListLoadData(); 
};
#endif
