#ifndef HMSGENERALCOSTREPORTDIALOG_H
#define HMSGENERALCOSTREPORTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSGeneralCostReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnObjectAddNew(); 
	void			OnTUVaovienSelect(); 
	void			OnTURavienSelect(); 
	void			OnPrintPreviewSelect(); 
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	void			OnSelectAllSelect(); 
	CHMSGeneralCostReportDialog(CWnd *pParent);
	~CHMSGeneralCostReportDialog();
