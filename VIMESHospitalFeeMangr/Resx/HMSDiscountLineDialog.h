#ifndef HMSDISCOUNTLINEDIALOG_H
#define HMSDISCOUNTLINEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSDiscountLineDialog : public CGuiDialog{
protected:
public:
	CGuiGroupBox	m_wndDiscountInformation;
	...
	void			OnOKSelect(); 
	void			OnCloseSelect(); 
	CHMSDiscountLineDialog(CWnd *pParent);
	~CHMSDiscountLineDialog();
	...
	int OnAddHMSDiscountLineDialog(); 
	int OnEditHMSDiscountLineDialog(); 
	int OnDeleteHMSDiscountLineDialog(); 
	int OnSaveHMSDiscountLineDialog(); 
	int OnCancelHMSDiscountLineDialog(); 
	int OnHMSDiscountLineDialogListLoadData(); 
};
#endif
