#ifndef HMSGENERALCOSTREPORT26ADIALOG_H
#define HMSGENERALCOSTREPORT26ADIALOG_H
...
public:
	...
	int OnAddHMSGeneralCostReport26ADialog(); 
	int OnEditHMSGeneralCostReport26ADialog(); 
	int OnDeleteHMSGeneralCostReport26ADialog(); 
	int OnSaveHMSGeneralCostReport26ADialog(); 
	int OnCancelHMSGeneralCostReport26ADialog(); 
	int OnHMSGeneralCostReport26ADialogListLoadData(); 
};
#endif
