...
static void _OnOKSelectFnc(CWnd *pWnd){
	CHMSChuyennguonTTbenhnhanquanchitiet *pVw = (CHMSChuyennguonTTbenhnhanquanchitiet *)pWnd;
	pVw->OnOKSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnListDeleteItem();
} 
static int _OnAddHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnAddHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnEditHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnEditHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnDeleteHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnDeleteHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnSaveHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnSaveHMSChuyennguonTTbenhnhancovid19();
} 
static int _OnCancelHMSChuyennguonTTbenhnhancovid19Fnc(CWnd *pWnd){
	 return ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnCancelHMSChuyennguonTTbenhnhancovid19();
}

static void _OnTatcaSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnTatcaSelect();
}
static void _OnPhikhamSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnPhikhamSelect();
}
static void _OnPhiCLSSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnPhiCLSSelect();
}
static void _OnPhithuocSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnPhithuocSelect();
}
static void _OnPhivattuSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnPhivattuSelect();
}
static void _OnTienanSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnTienanSelect();
}
static void _OnGoidichvuSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnGoidichvuSelect();
}
static void _OnTiengiuongSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnTiengiuongSelect();
}
static void _OnPhiPTTTSelectFnc(CWnd *pWnd){
	  ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnPhiPTTTSelect();
}
static void _OnChitinhmucphingansachttSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnChitinhmucphingansachttSelect();
}
...
static void _OnLocxncovid19SelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnLocxncovid19Select();
}
...
static void _OnLoccpbntraSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnLoccpbntraSelect();
}
...
static void _OnBQPKhongttSelectFnc(CWnd *pWnd){
	 ((CHMSChuyennguonTTbenhnhanquanchitiet*)pWnd)->OnBQPKhongttSelect();
}

CHMSChuyennguonTTbenhnhanquanchitiet::CHMSChuyennguonTTbenhnhanquanchitiet(CWnd *pParent):
	CGuiDialog(pParent)
{
	m_nDlgWidth = 605;
	m_nDlgHeight = 485;
...
CHMSChuyennguonTTbenhnhanquanchitiet::~CHMSChuyennguonTTbenhnhanquanchitiet()
{
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnCreateComponents()
{	
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnInitializeComponents(){
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnDoDataExchange(CDataExchange* pDX)
...
void CHMSChuyennguonTTbenhnhanquanchitiet::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSChuyennguonTTbenhnhanquanchitiet::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CHMSChuyennguonTTbenhnhanquanchitiet::SetDefaultValues()
{
	m_nTatca=0;
	m_nPhikham=1;
	m_nPhiCLS=1;
...
int CHMSChuyennguonTTbenhnhanquanchitiet::SetMode(int nMode)
{
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnOKSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	...
	for (int i =0; i < m_wndList.GetItemCount(); i++)
	{
		...
		szSQL.Format(_T("FEE_CHANGE_PAYSOURCE_SOLDIER(%ld, %ld, %f, '%s', %d) "),
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnTatcaSelect()
{
	UpdateData(TRUE);
	OnListLoadData();	
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnPhikhamSelect()
{
	UpdateData(TRUE);
	OnListLoadData();	
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnPhiCLSSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnPhithuocSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnPhivattuSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnTienanSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnGoidichvuSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnTiengiuongSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);	
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnPhiPTTTSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
	UpdateData(FALSE);
}
void CHMSChuyennguonTTbenhnhanquanchitiet::OnChitinhmucphingansachttSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnLocxncovid19Select()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnLoccpbntraSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
void CHMSChuyennguonTTbenhnhanquanchitiet::OnListDblClick()
{
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CHMSChuyennguonTTbenhnhanquanchitiet::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSChuyennguonTTbenhnhanquanchitiet::OnListLoadData(){
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnAddHMSChuyennguonTTbenhnhancovid19(){
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnEditHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnDeleteHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnSaveHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnCancelHMSChuyennguonTTbenhnhancovid19(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnHMSChuyennguonTTbenhnhancovid19ListLoadData(){
	return 0;
}

int CHMSChuyennguonTTbenhnhanquanchitiet::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnUnMarkSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnMarkFoodFeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CHMSChuyennguonTTbenhnhanquanchitiet::OnUnMarkA4FeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
void CHMSChuyennguonTTbenhnhanquanchitiet::OnBQPKhongttSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	OnListLoadData();	
