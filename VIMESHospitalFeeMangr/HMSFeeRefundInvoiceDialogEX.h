#ifndef HMSFEEREFUNDINVOICEEXDIALOG_H
#define HMSFEEREFUNDINVOICEEXDIALOG_H
...
class CHMSFeeRefundInvoiceDialogEX : public CGuiDialog
{
protected:
...
public:
	...
	int			OnSelectListEditItem();
	CHMSFeeRefundInvoiceDialogEX(CWnd *pParent);
	~CHMSFeeRefundInvoiceDialogEX();
