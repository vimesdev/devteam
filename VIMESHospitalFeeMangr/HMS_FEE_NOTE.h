#ifndef HMS_FEE_NOTE_H
#define HMS_FEE_NOTE_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMS_Fee_Note : public CGuiDialog
{
protected:
public:
	...
	int OnAddCHMS_Fee_Note(); 
	int OnEditCHMS_Fee_Note(); 
	int OnDeleteCHMS_Fee_Note(); 
	int OnSaveCHMS_Fee_Note(); 
	int OnCancelCHMS_Fee_Note(); 
	int OnCHMS_Fee_NoteListLoadData();
