#include "HMSFeeReceiptDialog.h"
#include "MainFrm.h"
#include "ReportDocument.h"

static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSFeeReceiptDialog*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSFeeReceiptDialog*)pWnd)->OnListDeleteItem();
} 

static int _OnListInsuranceUnpaidItemFnc(CWnd *pWnd){
	 return ((CHMSFeeReceiptDialog*)pWnd)->OnInsuranceUnpaidItem();
} 

/*static void _OnTotalCostChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnTotalCostChange();
} */
/*static void _OnTotalCostSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnTotalCostSetfocus();} */ 
/*static void _OnTotalCostKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnTotalCostKillfocus();
} */
static int _OnTotalCostCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnTotalCostCheckValue();
} 
/*static void _OnPatientPaidChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnPatientPaidChange();
} */
/*static void _OnPatientPaidSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnPatientPaidSetfocus();} */ 
/*static void _OnPatientPaidKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnPatientPaidKillfocus();
} */
static int _OnPatientPaidCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnPatientPaidCheckValue();
} 
/*static void _OnReceiveDateChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnReceiveDateChange();
} */
/*static void _OnReceiveDateSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnReceiveDateSetfocus();} */ 
/*static void _OnReceiveDateKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnReceiveDateKillfocus();
} */
static int _OnReceiveDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnReceiveDateCheckValue();
} 
/*static void _OnInsurancePaidChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnInsurancePaidChange();
} */
/*static void _OnInsurancePaidSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnInsurancePaidSetfocus();} */ 
/*static void _OnInsurancePaidKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnInsurancePaidKillfocus();
} */
static int _OnInsurancePaidCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnInsurancePaidCheckValue();
} 
/*static void _OnDepositChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDepositChange();
} */
/*static void _OnDepositSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDepositSetfocus();} */ 
/*static void _OnDepositKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDepositKillfocus();
} */
static int _OnDepositCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnDepositCheckValue();
} 
static void _OnSerialNoSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSFeeReceiptDialog* )pWnd)->OnSerialNoSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSerialNoSelendokFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnSerialNoSelendok();
}
...
static long _OnSerialNoLoadDataFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnSerialNoLoadData();
}
/*static void _OnSerialNoAddNewFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnSerialNoAddNew();
}*/
...
/*static void _OnRemissionChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnRemissionChange();
} */
/*static void _OnRemissionSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnRemissionSetfocus();} */ 
/*static void _OnRemissionKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnRemissionKillfocus();
} */
static int _OnRemissionCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnRemissionCheckValue();
} 
/*static void _OnFreeChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnFreeChange();
} */
/*static void _OnFreeSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnFreeSetfocus();} */ 
/*static void _OnFreeKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnFreeKillfocus();
} */
static int _OnFreeCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnFreeCheckValue();
} 
...
/*static void _OnDifferencePaidChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDifferencePaidChange();
} */
/*static void _OnDifferencePaidSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDifferencePaidSetfocus();} */ 
/*static void _OnDifferencePaidKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDifferencePaidKillfocus();
} */
static int _OnDifferencePaidCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnDifferencePaidCheckValue();
} 
/*static void _OnTotalPayableChangeFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnTotalPayableChange();
} */
/*static void _OnTotalPayableSetfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnTotalPayableSetfocus();} */ 
/*static void _OnTotalPayableKillfocusFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnTotalPayableKillfocus();
} */
static int _OnTotalPayableCheckValueFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnTotalPayableCheckValue();
} 
static void _OnDescriptionSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSFeeReceiptDialog* )pWnd)->OnDescriptionSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDescriptionSelendokFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDescriptionSelendok();
}
...
static long _OnDescriptionLoadDataFnc(CWnd *pWnd){
	return ((CHMSFeeReceiptDialog *)pWnd)->OnDescriptionLoadData();
}
/*static void _OnDescriptionAddNewFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDescriptionAddNew();
}*/


static void _OnDescriptionCheckValueFnc(CWnd *pWnd){
	((CHMSFeeReceiptDialog *)pWnd)->OnDescriptionCheckValue();
}

static void _OnInsuranceUnpaidFilterSelectFnc(CWnd *pWnd){
	 ((CHMSFeeReceiptDialog*)pWnd)->OnInsuranceUnpaidFilterSelect();
}
static void _OnPrintDischargeReceiptSelectFnc(CWnd *pWnd){
	 ((CHMSFeeReceiptDialog*)pWnd)->OnPrintDischargeReceiptSelect();
}
static void _OnReceiptSelectFnc(CWnd *pWnd){
...
void CHMSFeeReceiptDialog::OnCreateComponents(){
	...
	m_wndReceiptNoLabel.Create(this, _T("Receipt No"), 530, 530, 660, 555);
	m_wndReceiptNo.Create(this,665, 530, 765, 555); 
	...
	m_wndPrintDischargeReceipt.Create(this, _T("Print Discharge Receipt"), 270, 595, 525, 620);
	m_wndReceipt.Create(this, _T("&Receipt"), 590, 595, 665, 620);
...
//	m_wndReceiveDate.SetCheckValue(true);
	...
	m_wndPrintDischargeReceipt.ModifyStyle(WS_TABSTOP, 0);
...
//	m_wndList.AddEvent(1, _T("Un Select "), _OnListDeleteItemFnc, 0, VK_DELETE, 0);
	...
	m_wndPrintDischargeReceipt.SetEvent(WE_CLICK, _OnPrintDischargeReceiptSelectFnc);
	m_wndReceipt.SetEvent(WE_CLICK, _OnReceiptSelectFnc);
	...
	if(GetMode() == VM_ADD)
	{
		...
		m_wndReceipt.SetFocus();
	}
	else
		GetDataToScreen();
	if(pMF->GetObjectType() != _T("S")){
		m_bInsuranceUnpaidFilter = FALSE;
		m_bPrintDischargeReceipt = TRUE;
	}
	else
	{
		m_wndInsuranceUnpaidFilter.EnableWindow(false);
		m_bInsuranceUnpaidFilter = FALSE;
		//m_wndPrintDischargeReceipt.EnableWindow(false);
		m_bPrintDischargeReceipt = FALSE;
	}
...
//		m_bPrintDischargeReceipt = TRUE;
	...
	if(m_nInvoiceNo > 0){
		m_wndReceipt.EnableWindow(false);
	}
...
void CHMSFeeReceiptDialog::OnDoDataExchange(CDataExchange* pDX){
	...
	if(!m_bEnterDescription)
	{
		DDX_TextEx(pDX, m_wndDescription.GetDlgCtrlID(), m_szDescription);
	}
	else
	{
		DDX_TextEx(pDX, m_wndDescription2.GetDlgCtrlID(), m_szDescription);
	}
	DDX_Check(pDX, m_wndInsuranceUnpaidFilter.GetDlgCtrlID(), m_bInsuranceUnpaidFilter);
	DDX_Check(pDX, m_wndPrintDischargeReceipt.GetDlgCtrlID(), m_bPrintDischargeReceipt);
...
void CHMSFeeReceiptDialog::OnListDblClick(){
...
void CHMSFeeReceiptDialog::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CHMSFeeReceiptDialog::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSFeeReceiptDialog::OnInsuranceUnpaidItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
long CHMSFeeReceiptDialog::OnListLoadData(){
	...
	if(m_wndList.GetItemCount() <= 0)
		...
		m_wndReceipt.EnableWindow(true);
...
/*void CHMSFeeReceiptDialog::OnTotalCostChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnTotalCostSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnTotalCostKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnTotalCostCheckValue(){
	return 0;
} 
/*void CHMSFeeReceiptDialog::OnPatientPaidChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnPatientPaidSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnPatientPaidKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnPatientPaidCheckValue(){
	return 0;
} 
/*void CHMSFeeReceiptDialog::OnReceiveDateChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnReceiveDateSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnReceiveDateKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnReceiveDateCheckValue(){
	return 0;
} 
/*void CHMSFeeReceiptDialog::OnInsurancePaidChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnInsurancePaidSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnInsurancePaidKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnInsurancePaidCheckValue(){
	return 0;
} 
/*void CHMSFeeReceiptDialog::OnDepositChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnDepositSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnDepositKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnDepositCheckValue(){
	return 0;
} 
...
void CHMSFeeReceiptDialog::OnSerialNoSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSFeeReceiptDialog::OnSerialNoSelendok(){
	UpdateData(true);
	m_szSerialNo = m_wndSerialNo.GetCurrent(0);
	m_szSerial = m_wndSerialNo.GetCurrent(1);
	m_nBookNo = ToLong(m_wndSerialNo.GetCurrent(2));
	m_nReceiptNo = ToInt(m_wndSerialNo.GetCurrent(3))+1;
	UpdateData(false);
}
/*void CHMSFeeReceiptDialog::OnSerialNoSetfocus(){
	
}*/
/*void CHMSFeeReceiptDialog::OnSerialNoKillfocus(){
	
}*/
long CHMSFeeReceiptDialog::OnSerialNoLoadData(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSFeeReceiptDialog::OnSerialNoAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSFeeReceiptDialog::OnRemissionChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnRemissionSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnRemissionKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnRemissionCheckValue(){
	return 0;
} 
/*void CHMSFeeReceiptDialog::OnFreeChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnFreeSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnFreeKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnFreeCheckValue(){
	return 0;
} 
...
/*void CHMSFeeReceiptDialog::OnDifferencePaidChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnDifferencePaidSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnDifferencePaidKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnDifferencePaidCheckValue(){
	return 0;
} 
/*void CHMSFeeReceiptDialog::OnTotalPayableChange(){
	
} */
/*void CHMSFeeReceiptDialog::OnTotalPayableSetfocus(){
	
} */
/*void CHMSFeeReceiptDialog::OnTotalPayableKillfocus(){
	
} */
int CHMSFeeReceiptDialog::OnTotalPayableCheckValue(){
	return 0;
} 
void CHMSFeeReceiptDialog::OnDescriptionSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSFeeReceiptDialog::OnDescriptionSelendok(){
...
long CHMSFeeReceiptDialog::OnDescriptionLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	return pMF->LoadSelectionList(&m_wndDescription, _T("hms_invoice_desc"), m_szDescription);
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	if(m_wndDescription.IsSearchKey() && !m_szDescription.IsEmpty()){
	};
...
/*void CHMSFeeReceiptDialog::OnDescriptionAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

void CHMSFeeReceiptDialog::OnDescriptionCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
}

void CHMSFeeReceiptDialog::OnInsuranceUnpaidFilterSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	OnListLoadData();
...
void CHMSFeeReceiptDialog::OnPrintDischargeReceiptSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}


void CHMSFeeReceiptDialog::OnReceiptSelect(){	
	if(OnReceiptFee())
		OnOK();	
} 

bool CHMSFeeReceiptDialog::OnReceiptFee()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
//Neu co muc phi nao chon khong thu thi tinh lai phi
	...
	if(m_bInsuranceUnpaidFilter || (pMF->m_nInpatient == 0 && (pMF->GetObjectType() == _T("S") || pMF->GetObjectType() == _T("X"))) )
	{
...
//In bang ke chi phi kham chua benh		
		...
		if( pMF->m_szAutoPrintDischargeVote == _T("Y")){
			pMF->PrintDischargeReceiptFromInvoice(nInvoiceNo);
		}
	}
...
bool CHMSFeeReceiptDialog::OnReceiptFee2()
{
	...
	//
	//if(!pMF->IsAllowPaymentFees(m_nDocumentNo))
	//{
...
//Ap dung cho tat ca cac truong hop
		...
		if(m_nTotalPayable > 0){
			CHMSReceiptDialog dlg(this, _T("A"));
		...
		else if(m_nTotalPayable < 0)
		{
			...
			{
				CHMSReceiptDialog dlg(this, _T("R"));
					dlg.m_nPID = pMF->m_nPID;
					dlg.m_nDocumentNo = m_nDocumentNo;
					dlg.m_nInvoiceNo = 0;
					dlg.m_szCategory = _T("D"); //Discharge 
		...
		if(m_bPrintDischargeReceipt){
			...
			if(ret > 0){
				if( pMF->m_szAutoPrintDischargeVote == _T("Y")){
					...
					{
						pMF->PrintDischargeReceiptFromInvoice_New(nInvoiceNo);
					}
				}
			}
		}
...
void CHMSFeeReceiptDialog::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
...
void CHMSFeeReceiptDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
...
int CHMSFeeReceiptDialog::OnSaveHMSFeeReceiptDialog(){
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnHMSFeeReceiptDialogListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
void CHMSFeeReceiptDialog::RecalcTotal(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
