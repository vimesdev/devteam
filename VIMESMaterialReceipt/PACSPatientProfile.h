...
protected:
	...
	bool	m_bInpatient;
	CString	m_szPacsHost;
	CString	m_szBirthDate;
	CString m_szDeptSelected;
	CString	m_szRoomSelected;
	CString m_szGroupSelected;
	CString	m_szOrderLineMaped;


public:
	CGuiGroupBox	m_wndPatientProfile;
	CGuiGroupBox	m_wndOrderGroup;
	CGuiGroupBox	m_wndInformationRoomGroup;
	...
	CGuiTextCtrl	m_wndPerformRoom;
	CGuiButton		m_wndAddMaterial;
	CGridListView	m_wndOrderList;
	CGridListView	m_wndAssignedList;
	...
	CGridListView	m_wndInformationRoomList;
	//CGuiButton		m_wndAddMaterial;
	//CPACSView		m_wndView;
	...
	long		OnAssignedListLoadData(); 
	void		OnAssignedListSelectChange(int nOldItem, int nNewItem); 
	void		OnAssignedListDblClick(); 
	int			OnAssignedListDeleteItem(); 
	...
	long			OnInformationRoomListLoadData(); 
	void			OnInformationRoomListSelectChange(int nOldItem, int nNewItem); 
	void			OnInformationRoomListDblClick(); 
	int			OnInformationRoomListDeleteItem(); 
	...
	bool	PostPACSWorklist(CString szPID, CString szPatientName, CString szBirthDate, CString szSex, 
			long nOrderLine,CString szRoomName,CString szItemName);

	void	OnReceive(char *buffer, int len);

	void	OnMapRoom();

	int		AddOrder(CString szDept, CString szRoom, long nOrderID, long nOrderLine);
	int		RemoveOrder(long nOrderID, long nOrderLine);
	bool	IsRequestApply();
