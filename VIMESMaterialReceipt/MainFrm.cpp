...
CMainFrame::CMainFrame()
{
	...
	SetLocalLang(1);
	m_szModuleName = _T("QUẢN LÝ LĨNH VẬT TƯ TIÊU HAO DÙNG CHUNG");
	m_szModuleID = _T("MATREC");
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CString tmpStr;
	TranslateString(_T("QUẢN LÝ LĨNH VẬT TƯ TIÊU HAO DÙNG CHUNG"), tmpStr);
...
void CMainFrame::OnDrugandmaterialordersheet()
{
	...
	{
		ShowMessageBox(_T("Liên hệ admin cấp quyền 01.01 để sử dụng chức năng này!"));
		return;
	}
