#ifndef TONGHOPQUANSOBAOANPTTYC_H
#define TONGHOPQUANSOBAOANPTTYC_H
...
#include "GuiView.h"
#include "DbField.h"
class CTonghopQuansoBaoanpttyc : public CGuiView
{
protected:
public:
	...
	CTonghopQuansoBaoanpttyc(CWnd *pParent);
	~CTonghopQuansoBaoanpttyc();
