#ifndef NTTTotalMilk_H
#define NTTTotalMilk_H
...
#include "GuiView.h"
#include "DbField.h"
class CNTTTotalMilk : public CGuiView{
protected:
...
public:
	...
	int OnAddNTTTotalMilk(); 
	int OnEditNTTTotalMilk(); 
	int OnDeleteNTTTotalMilk(); 
	int OnSaveNTTTotalMilk(); 
	int OnCancelNTTTotalMilk(); 
	int OnNTTTotalMilkListLoadData(); 
