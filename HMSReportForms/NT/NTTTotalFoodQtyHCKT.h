#ifndef NTTTotalFoodQtyHCKT_H
#define NTTTotalFoodQtyHCKT_H
...
#include "GuiView.h"
#include "DbField.h"
class CNTTTotalFoodQtyHCKT : public CGuiView
{
protected:
...
public:
	...
	void			OnDinnerSelect(); 
	void			OnExportSelect();
	void			OnExportBreakfastSelect();
	void			OnExportLunchSelect();
	void			OnExportDinnerSelect();
	CNTTTotalFoodQtyHCKT(CWnd *pParent);
	~CNTTTotalFoodQtyHCKT();
	...
	int OnAddNTTTotalFoodQty(); 
	int OnEditNTTTotalFoodQty(); 
	int OnDeleteNTTTotalFoodQty(); 
	int OnSaveNTTTotalFoodQty(); 
	int OnCancelNTTTotalFoodQty(); 
	int OnNTTTotalFoodQtyListLoadData(); 
	CString GetQueryStringTotalBreakfast();
	CString GetQueryStringTotalLunch();
	CString GetQueryStringTotalDinner();
};
#endif
