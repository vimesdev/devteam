#ifndef NTTTotalFoodAt10_H
#define NTTTotalFoodAt10_H
...
#include "GuiView.h"
#include "DbField.h"
class CNTTTotalFoodAt10 : public CGuiView
{
protected:
...
public:
	...
	void			OnDinnerSelect(); 
	void			OnExportSelect(); 
	CNTTTotalFoodAt10(CWnd *pParent);
	~CNTTTotalFoodAt10();
	...
	int OnAddNTTTotalFoodAt10(); 
	int OnEditNTTTotalFoodAt10(); 
	int OnDeleteNTTTotalFoodAt10(); 
	int OnSaveNTTTotalFoodAt10(); 
	int OnCancelNTTTotalFoodAt10(); 
	int OnNTTTotalFoodAt10ListLoadData(); 
