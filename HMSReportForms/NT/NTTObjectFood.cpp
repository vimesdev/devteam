#include "stdafx.h"
#include "NTTObjectFood.h"
#include "HMSMainFrame.h"
#include "Excel.h"
#include "StringToken.h"
/*static void _OnDateChangeFnc(CWnd *pWnd){
	((CNTTObjectFood *)pWnd)->OnDateChange();
} */
/*static void _OnDateSetfocusFnc(CWnd *pWnd){
	((CNTTObjectFood *)pWnd)->OnDateSetfocus();} */ 
/*static void _OnDateKillfocusFnc(CWnd *pWnd){
	((CNTTObjectFood *)pWnd)->OnDateKillfocus();
} */
static int _OnDateCheckValueFnc(CWnd *pWnd){
	return ((CNTTObjectFood *)pWnd)->OnDateCheckValue();
} 
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CNTTObjectFood* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CNTTObjectFood *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CNTTObjectFood *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CNTTObjectFood *)pWnd)->OnDepartmentKillfocus();
}*/
static double _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CNTTObjectFood *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CNTTObjectFood *)pWnd)->OnDepartmentAddNew();
}*/
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CNTTObjectFood*)pWnd)->OnAllSelect();
}
static void _OnBreakfastSelectFnc(CWnd *pWnd){
	  ((CNTTObjectFood*)pWnd)->OnBreakfastSelect();
}
static void _OnLunchSelectFnc(CWnd *pWnd){
	  ((CNTTObjectFood*)pWnd)->OnLunchSelect();
}
static void _OnDinnerSelectFnc(CWnd *pWnd){
	  ((CNTTObjectFood*)pWnd)->OnDinnerSelect();
}
static void _OnExportSelectFnc(CWnd *pWnd){
	CNTTObjectFood *pVw = (CNTTObjectFood *)pWnd;
	pVw->OnExportSelect();
} 
static int _OnAddNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CNTTObjectFood*)pWnd)->OnAddNTTObjectFood();
} 
static int _OnEditNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CNTTObjectFood*)pWnd)->OnEditNTTObjectFood();
} 
static int _OnDeleteNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CNTTObjectFood*)pWnd)->OnDeleteNTTObjectFood();
} 
static int _OnSaveNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CNTTObjectFood*)pWnd)->OnSaveNTTObjectFood();
} 
static int _OnCancelNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CNTTObjectFood*)pWnd)->OnCancelNTTObjectFood();
} 
CNTTObjectFood::CNTTObjectFood(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CNTTObjectFood::~CNTTObjectFood(){
}
void CNTTObjectFood::OnCreateComponents(){
...
void CNTTObjectFood::OnInitializeComponents(){
...
void CNTTObjectFood::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CNTTObjectFood::OnDoDataExchange(CDataExchange* pDX){
...
void CNTTObjectFood::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CNTTObjectFood::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CNTTObjectFood::SetDefaultValues(){
...
int CNTTObjectFood::SetMode(int nMode){
...
/*void CNTTObjectFood::OnDateChange(){
	
} */
/*void CNTTObjectFood::OnDateSetfocus(){
	
} */
/*void CNTTObjectFood::OnDateKillfocus(){
	
} */
int CNTTObjectFood::OnDateCheckValue(){
	return 0;
} 
void CNTTObjectFood::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CNTTObjectFood::OnDepartmentSelendok(){
	 
}
/*void CNTTObjectFood::OnDepartmentSetfocus(){
	
}*/
/*void CNTTObjectFood::OnDepartmentKillfocus(){
	
}*/
long CNTTObjectFood::OnDepartmentLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CNTTObjectFood::OnDepartmentAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CNTTObjectFood::OnAllSelect(){
	
}
void CNTTObjectFood::OnBreakfastSelect(){
	
}
void CNTTObjectFood::OnLunchSelect(){
	
}
void CNTTObjectFood::OnDinnerSelect(){
	
}
void CNTTObjectFood::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
CString CNTTObjectFood::GetQueryString()
{
	CString szSQL, szWhere;
	...
	szSQL.Format(_T(" SELECT") \
		...
		_T(" WHEN HFO_OBJECT_ID IN(1, 11, 13) THEN 1 ") \
		_T(" WHEN HFO_OBJECT_ID IN(2, 4, 5, 9, 10, 12) THEN 2 ") \
		_T(" WHEN HFO_OBJECT_ID = 7 THEN 3") \
		_T(" WHEN HFO_OBJECT_ID = 3 THEN 4") \
		_T(" WHEN HFO_OBJECT_ID = 8 THEN 5") \
		_T(" END AS pobject,") \
		...
		_T(" AND hfo_orderdate BETWEEN TO_TIMESTAMP('%s 00:00:00', 'YYYY-MM-DD HH24:MI:SS') ") \
		_T(" AND TO_TIMESTAMP('%s 23:59:59', 'YYYY-MM-DD HH24:MI:SS') AND hfo_deptid NOT IN ('PTTYC') %s") \
		_T(" )") \
		_T(" GROUP BY") \
		_T(" pobject,") \
		_T(" ptype,") \
		...
		_T(" pobject,") \
		_T(" ptype,") \
		_T(" unitprice"), m_szDate.Left(10), m_szDate.Left(10), szWhere);

	return szSQL;
}

int CNTTObjectFood::OnAddNTTObjectFood(){
...
int CNTTObjectFood::OnEditNTTObjectFood(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CNTTObjectFood::OnDeleteNTTObjectFood(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CNTTObjectFood::OnSaveNTTObjectFood(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CNTTObjectFood::OnCancelNTTObjectFood(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CNTTObjectFood::OnNTTObjectFoodListLoadData(){
	return 0;
}
