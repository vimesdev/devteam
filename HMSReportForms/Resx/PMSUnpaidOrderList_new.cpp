...
static void _OnContractSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSUnpaidOrderList* )pWnd)->OnContractSelectChange(nOldItemSel, nNewItemSel);
} 
...
void CPMSUnpaidOrderList::OnCreateComponents(){
	m_wndGeneralDepartmentUsage.Create(this, _T("Unpaid Order List"), 5, 5, 575, 180);
...
void CPMSUnpaidOrderList::OnContractSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
