...
static void _OnContractSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMConfirmLiabilities* )pWnd)->OnContractSelectChange(nOldItemSel, nNewItemSel);
} 
...
void CPMConfirmLiabilities::OnContractSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
