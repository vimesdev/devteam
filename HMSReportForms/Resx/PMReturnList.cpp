...
void CPMReturnList::OnCreateComponents(){
	...
	m_wndAll.Create(this, _T("All"), 5, 185, 80, 210);
	m_wndIsPaid.Create(this, _T("Is Paid"), 85, 185, 170, 210);
	m_wndNotPaid.Create(this, _T("Not paid"), 175, 185, 235, 210);
	m_wndPrintPreview.Create(this, _T("&Print Preview"), 396, 185, 491, 210);
	m_wndExport.Create(this, _T("&Export"), 495, 185, 575, 210);
	m_wndPaymentMethodLabel.Create(this, _T("Payment Method"), 10, 220, 160, 245);
	m_wndPaymentMethod.Create(this,165, 220, 365, 245); 
