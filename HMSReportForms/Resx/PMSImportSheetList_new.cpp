...
static void _OnContractsSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSImportSheetList* )pWnd)->OnContractsSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnContractsSelendokFnc(CWnd *pWnd){
	((CPMSImportSheetList *)pWnd)->OnContractsSelendok();
}
/*static void _OnContractsSetfocusFnc(CWnd *pWnd){
	((CPMSImportSheetList *)pWnd)->OnContractsKillfocus();
}*/
/*static void _OnContractsKillfocusFnc(CWnd *pWnd){
	((CPMSImportSheetList *)pWnd)->OnContractsKillfocus();
}*/
static long _OnContractsLoadDataFnc(CWnd *pWnd){
	return ((CPMSImportSheetList *)pWnd)->OnContractsLoadData();
}
/*static void _OnContractsAddNewFnc(CWnd *pWnd){
	((CPMSImportSheetList *)pWnd)->OnContractsAddNew();
}*/
...
void CPMSImportSheetList::OnCreateComponents(){
	m_wndGeneralDepartmentUsage.Create(this, _T("Import Sheet List"), 5, 5, 570, 150);
	...
	m_wndContractsLabel.Create(this, _T("Contracts"), 10, 120, 110, 145);
	m_wndContracts.Create(this,115, 120, 295, 145); 
...
void CPMSImportSheetList::OnInitializeComponents(){
	...
	m_wndContracts.SetCheckValue(true);
	m_wndContracts.LimitText(35);
	...
	m_wndContracts.InsertColumn(0, _T("ID"), CFMT_TEXT, 50);
	m_wndContracts.InsertColumn(1, _T("Name"), CFMT_TEXT, 150);
...
void CPMSImportSheetList::OnSetWindowEvents(){
	...
	m_wndContracts.SetEvent(WE_SELENDOK, _OnContractsSelendokFnc);
	//m_wndContracts.SetEvent(WE_SETFOCUS, _OnContractsSetfocusFnc);
	//m_wndContracts.SetEvent(WE_KILLFOCUS, _OnContractsKillfocusFnc);
	m_wndContracts.SetEvent(WE_SELCHANGE, _OnContractsSelectChangeFnc);
	m_wndContracts.SetEvent(WE_LOADDATA, _OnContractsLoadDataFnc);
	//m_wndContracts.SetEvent(WE_ADDNEW, _OnContractsAddNewFnc);
	SetMode(VM_NONE);
...
void CPMSImportSheetList::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_TextEx(pDX, m_wndContracts.GetDlgCtrlID(), m_szContractsKey);
...
void CPMSImportSheetList::UpdateJson(BOOL bSave){
	...
	m_jData[_T("Contracts")] =  m_szContractsKey;
	}
	else
	{
	...
	m_jData[_T("Contracts")].GetValue(m_szContractsKey);
	}
...
void CPMSImportSheetList::OnContractsSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CPMSImportSheetList::OnContractsSelendok(){
	 
}
/*void CPMSImportSheetList::OnContractsSetfocus(){
	
}*/
/*void CPMSImportSheetList::OnContractsKillfocus(){
	
}*/
long CPMSImportSheetList::OnContractsLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	if(m_wndContracts.IsSearchKey() && !m_szContractsKey.IsEmpty()){
	 szWhere.Format(_T(" and id='%s' "), m_szContractsKey
};
...
/*void CPMSImportSheetList::OnContractsAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
