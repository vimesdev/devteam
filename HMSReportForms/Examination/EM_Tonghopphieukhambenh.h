#ifndef EMTONGHOPPHIEUKHAMBENH_H
#define EMTONGHOPPHIEUKHAMBENH_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMTonghopphieukhambenh : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect(); 
	CEMTonghopphieukhambenh(CWnd* pParent);
	~CEMTonghopphieukhambenh();
