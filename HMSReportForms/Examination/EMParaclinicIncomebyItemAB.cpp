#include "stdafx.h"
#include "EMParaclinicIncomebyItemAB.h"
#include "HMSMainFrame.h"
#include "Excel.h"
#include "ReportDocument.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd)
{
	return ((CEMParaclinicIncomebyItemAB *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CEMParaclinicIncomebyItemAB *)pWnd)->OnToDateCheckValue();
} 
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMParaclinicIncomebyItemAB* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CEMParaclinicIncomebyItemAB *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnGroupAddNew();
}*/
static void _OnItemSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMParaclinicIncomebyItemAB* )pWnd)->OnItemSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemSelendokFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnItemSelendok();
}
/*static void _OnItemSetfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnItemKillfocus();
}*/
/*static void _OnItemKillfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnItemKillfocus();
}*/
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CEMParaclinicIncomebyItemAB *)pWnd)->OnItemLoadData();
}
/*static void _OnItemAddNewFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnItemAddNew();
}*/
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMParaclinicIncomebyItemAB* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CEMParaclinicIncomebyItemAB *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CEMParaclinicIncomebyItemAB *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CEMParaclinicIncomebyItemAB *pVw = (CEMParaclinicIncomebyItemAB *)pWnd;
...
static void _OnLockedSelectFnc(CWnd *pWnd){
	 ((CEMParaclinicIncomebyItemAB*)pWnd)->OnLockedSelect();
}
static int _OnAddFMTestPatientListFnc(CWnd *pWnd){
	 return ((CEMParaclinicIncomebyItemAB*)pWnd)->OnAddFMTestPatientList();
} 
static int _OnEditFMTestPatientListFnc(CWnd *pWnd){
	 return ((CEMParaclinicIncomebyItemAB*)pWnd)->OnEditFMTestPatientList();
} 
static int _OnDeleteFMTestPatientListFnc(CWnd *pWnd){
	 return ((CEMParaclinicIncomebyItemAB*)pWnd)->OnDeleteFMTestPatientList();
} 
static int _OnSaveFMTestPatientListFnc(CWnd *pWnd){
	 return ((CEMParaclinicIncomebyItemAB*)pWnd)->OnSaveFMTestPatientList();
} 
static int _OnCancelFMTestPatientListFnc(CWnd *pWnd){
	 return ((CEMParaclinicIncomebyItemAB*)pWnd)->OnCancelFMTestPatientList();
} 
CEMParaclinicIncomebyItemAB::CEMParaclinicIncomebyItemAB(CWnd *pParent)
{
	m_nDlgWidth = 500;
	m_nDlgHeight = 220;
	SetDefaultValues();
}
CEMParaclinicIncomebyItemAB::~CEMParaclinicIncomebyItemAB()
{
}
void CEMParaclinicIncomebyItemAB::OnCreateComponents()
{
...
void CEMParaclinicIncomebyItemAB::OnInitializeComponents()
{
...
void CEMParaclinicIncomebyItemAB::OnSetWindowEvents()
{
...
void CEMParaclinicIncomebyItemAB::OnDoDataExchange(CDataExchange* pDX)
{
...
void CEMParaclinicIncomebyItemAB::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CEMParaclinicIncomebyItemAB::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CEMParaclinicIncomebyItemAB::SetDefaultValues()
{
...
int CEMParaclinicIncomebyItemAB::SetMode(int nMode){
...
/*void CEMParaclinicIncomebyItemAB::OnFromDateChange(){
	
} */
/*void CEMParaclinicIncomebyItemAB::OnFromDateSetfocus(){
	
} */
/*void CEMParaclinicIncomebyItemAB::OnFromDateKillfocus(){
	
} */
int CEMParaclinicIncomebyItemAB::OnFromDateCheckValue(){
	return 0;
} 
/*void CEMParaclinicIncomebyItemAB::OnToDateChange(){
	
} */
/*void CEMParaclinicIncomebyItemAB::OnToDateSetfocus(){
	
} */
/*void CEMParaclinicIncomebyItemAB::OnToDateKillfocus(){
	
} */
int CEMParaclinicIncomebyItemAB::OnToDateCheckValue(){
	return 0;
} 
void CEMParaclinicIncomebyItemAB::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CEMParaclinicIncomebyItemAB::OnGroupSelendok(){
	 
}
/*void CEMParaclinicIncomebyItemAB::OnGroupSetfocus(){
	
}*/
/*void CEMParaclinicIncomebyItemAB::OnGroupKillfocus(){
	
}*/

long CEMParaclinicIncomebyItemAB::OnGroupLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CEMParaclinicIncomebyItemAB::OnGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

void CEMParaclinicIncomebyItemAB::OnItemSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CEMParaclinicIncomebyItemAB::OnItemSelendok(){
	 
}
/*void CEMParaclinicIncomebyItemAB::OnItemSetfocus(){
	
}*/
/*void CEMParaclinicIncomebyItemAB::OnItemKillfocus(){
	
}*/
long CEMParaclinicIncomebyItemAB::OnItemLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
/*void CEMParaclinicIncomebyItemAB::OnItemAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CEMParaclinicIncomebyItemAB::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CEMParaclinicIncomebyItemAB::OnClerkSelendok(){
	 
}
/*void CEMParaclinicIncomebyItemAB::OnClerkSetfocus(){
	
}*/
/*void CEMParaclinicIncomebyItemAB::OnClerkKillfocus(){
	
}*/
long CEMParaclinicIncomebyItemAB::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CEMParaclinicIncomebyItemAB::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CEMParaclinicIncomebyItemAB::OnLockedSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CEMParaclinicIncomebyItemAB::OnPrintPreviewSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	/*Declaration Section*/
...
void CEMParaclinicIncomebyItemAB::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
int CEMParaclinicIncomebyItemAB::OnAddFMTestPatientList(){
...
int CEMParaclinicIncomebyItemAB::OnEditFMTestPatientList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CEMParaclinicIncomebyItemAB::OnDeleteFMTestPatientList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CEMParaclinicIncomebyItemAB::OnSaveFMTestPatientList()
{
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
...
int CEMParaclinicIncomebyItemAB::OnCancelFMTestPatientList(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CEMParaclinicIncomebyItemAB::OnFMTestPatientListListLoadData(){
	return 0;
}

CString CEMParaclinicIncomebyItemAB::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
	CString szSQL, szWhere;
	szWhere.Empty();
	...
	szSQL.Format(_T(" SELECT fe.hfe_group item_group, fe.hfe_desc descr, ") \
				...
				_T("        AND fe.hfe_type IN('P','T') AND fi.hfe_status='P' AND fi.HFE_DEPTID='AB'") \
