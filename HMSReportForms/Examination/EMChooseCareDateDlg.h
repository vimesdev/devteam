#ifndef EMCHOOSECAREDATEDLG_H
#define EMCHOOSECAREDATEDLG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CEMChooseCareDateDlg : public CGuiDialog
{
protected:
public:
	...
	void			OnPrintSelect(); 
	CEMChooseCareDateDlg(CWnd *pParent);
	~CEMChooseCareDateDlg();
