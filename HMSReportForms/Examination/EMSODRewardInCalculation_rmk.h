#ifndef EMSODREWARDINCALCULATION_RMK_H
#define EMSODREWARDINCALCULATION_RMK_H
...
#include "Excel.h"
#include "../ReportBase.h"
class CEMSODRewardInCalculation_rmk : public CGuiView, CReportBase
	//, public CReportBase
{
protected:
...
public:
	...
	virtual void Export_Group(bool bFirst, CExcel* pXcel, int& nRow, CRecord* pRs, TCHAR* pcField, ...);
	void	Export_group_ext(CExcel* pXcel, int nRow, CRecord* pRs);
	...
	long			OnListLoadData();
	CEMSODRewardInCalculation_rmk(CWnd *pParent);
	~CEMSODRewardInCalculation_rmk();
