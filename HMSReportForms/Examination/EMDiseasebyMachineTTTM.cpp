#include "stdafx.h"
#include "EMDiseasebyMachineTTTM.h"
#include "MainFrame_E10.h"
#include "Excel.h"
#include "ReportDocument.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CEMDiseasebyMachineTTTM *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CEMDiseasebyMachineTTTM* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CEMDiseasebyMachineTTTM *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CEMDiseasebyMachineTTTM *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CEMDiseasebyMachineTTTM *)pWnd)->OnToDateCheckValue();
}
static long _OnRoomLoadDataFnc(CWnd *pWnd){
	return ((CEMDiseasebyMachineTTTM*)pWnd)->OnRoomLoadData();
} 
static void _OnRoomDblClickFnc(CWnd *pWnd){
	((CEMDiseasebyMachineTTTM*)pWnd)->OnRoomDblClick();
} 
static void _OnRoomSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CEMDiseasebyMachineTTTM*)pWnd)->OnRoomSelectChange(nOldItem, nNewItem);
} 
static int _OnRoomDeleteItemFnc(CWnd *pWnd){
	return ((CEMDiseasebyMachineTTTM*)pWnd)->OnRoomDeleteItem();
} 
static void _OnTheoBNSelectFnc(CWnd *pWnd){
	CEMDiseasebyMachineTTTM *pVw = (CEMDiseasebyMachineTTTM *)pWnd;
	pVw->OnTheoBNSelect();
} 
...
CEMDiseasebyMachineTTTM::CEMDiseasebyMachineTTTM(CWnd *pParent){

	m_nDlgWidth = 500;
	m_nDlgHeight = 130;
	SetDefaultValues();
}
CEMDiseasebyMachineTTTM::~CEMDiseasebyMachineTTTM(){
}
void CEMDiseasebyMachineTTTM::OnCreateComponents(){
...
void CEMDiseasebyMachineTTTM::OnInitializeComponents(){
...
void CEMDiseasebyMachineTTTM::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CEMDiseasebyMachineTTTM::OnDoDataExchange(CDataExchange* pDX){
...
void CEMDiseasebyMachineTTTM::SetDefaultValues(){
...
int CEMDiseasebyMachineTTTM::SetMode(int nMode){
...
/*void CEMDiseasebyMachineTTTM::OnYearChange(){
	
} */
/*void CEMDiseasebyMachineTTTM::OnYearSetfocus(){
	
} */
/*void CEMDiseasebyMachineTTTM::OnYearKillfocus(){
	
} */
int CEMDiseasebyMachineTTTM::OnYearCheckValue(){
	return 0;
} 
void CEMDiseasebyMachineTTTM::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

} 
void CEMDiseasebyMachineTTTM::OnReportPeriodSelendok(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	pMF->OnReportPeriodSelendok(&m_szFromDate, &m_szToDate, m_szReportPeriodKey);
	UpdateData(false);	 
}
/*void CEMDiseasebyMachineTTTM::OnReportPeriodSetfocus(){
	
}*/
/*void CEMDiseasebyMachineTTTM::OnReportPeriodKillfocus(){
	
}*/
long CEMDiseasebyMachineTTTM::OnReportPeriodLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CEMDiseasebyMachineTTTM::OnReportPeriodAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CEMDiseasebyMachineTTTM::OnFromDateChange(){
	
} */
/*void CEMDiseasebyMachineTTTM::OnFromDateSetfocus(){
	
} */
/*void CEMDiseasebyMachineTTTM::OnFromDateKillfocus(){
	
} */
int CEMDiseasebyMachineTTTM::OnFromDateCheckValue(){
	return 0;
} 
/*void CEMDiseasebyMachineTTTM::OnToDateChange(){
	
} */
/*void CEMDiseasebyMachineTTTM::OnToDateSetfocus(){
	
} */
/*void CEMDiseasebyMachineTTTM::OnToDateKillfocus(){
	
} */
int CEMDiseasebyMachineTTTM::OnToDateCheckValue(){
	return 0;
} 
void CEMDiseasebyMachineTTTM::OnRoomDblClick(){
	
} 
void CEMDiseasebyMachineTTTM::OnRoomSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CEMDiseasebyMachineTTTM::OnRoomDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 
long CEMDiseasebyMachineTTTM::OnRoomLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	m_wndRoom.BeginLoad(); 
...
void CEMDiseasebyMachineTTTM::OnTheoBNSelect(){
	UpdateData(TRUE);
	if(m_bTheoBN)
		m_bTheoVP = FALSE;
	UpdateData(FALSE);
}
void CEMDiseasebyMachineTTTM::OnTheoVPSelect(){
	UpdateData(TRUE);
	if(m_bTheoVP)
		m_bTheoBN = FALSE;
	UpdateData(FALSE);
}
void CEMDiseasebyMachineTTTM::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	...
	szSQL.Format(_T(" SELECT") \
		...
		_T(" WHERE  ho_pdeptid IN ('TMNT', 'TTTM')") \
		_T("        AND ho_recordno IS NOT NULL") \
		_T("        AND ho_payment='P'") \
...
void CEMDiseasebyMachineTTTM::OnExportSelect(){
	if(m_bTheoBN)
	{
		OnExport();
		return;
	...
	xls.Save(_T("Exports\\Bao cao mat benh theo may TTTM.xls"));
} 
void CEMDiseasebyMachineTTTM::OnExport(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CExcel xls;
	xls.CreateSheet(1);
	...
	szSQL.Format(_T(" SELECT ho_docno,") \
		...
		_T("     END AS TIEM") \
		_T("   FROM hms_operation") \
		_T("   WHERE ho_pdeptid IN ('TTTM', 'TMNT')") \
		_T("   AND ho_recordno IS NOT NULL") \
		_T("   AND ho_orderdate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
		_T("   AND ho_status <> 'O'") \
		_T("   AND ho_payment = 'P'") \
...
void CEMDiseasebyMachineTTTM::OnExport2()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CExcel xls;
	...
	xls.Save(_T("Exports\\Bao cao mat benh theo may theo TMNT.xls"));
} 