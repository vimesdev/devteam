#ifndef EMSUDUNGDVKTBENHNHANKSK_H
#define EMSUDUNGDVKTBENHNHANKSK_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMSuDungDVKT_BenhnhanKSK : public CGuiView
{
protected:
public:
	...
	CGuiRadioButton	m_wndChuaduyetphi;
	CGuiRadioButton	m_wndDaduyetphi;
	CGuiRadioButton	m_wndDanopquy;
	...
	void			OnChuaduyetphiSelect(); 
	void			OnDaduyetphiSelect();
	void			OnDanopquySelect(); 
	CEMSuDungDVKT_BenhnhanKSK(CWnd *pWnd);
	~CEMSuDungDVKT_BenhnhanKSK();
	...
	int OnAddTMSuDungDVKT(); 
	int OnEditTMSuDungDVKT(); 
	int OnDeleteTMSuDungDVKT(); 
	int OnSaveTMSuDungDVKT(); 
	int OnCancelTMSuDungDVKT(); 
	int OnTMSuDungDVKTListLoadData(); 
