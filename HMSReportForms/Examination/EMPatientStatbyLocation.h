#ifndef EMPATIENTSTATBYLOCATION_H
#define EMPATIENTSTATBYLOCATION_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMPatientStatbyLocation : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CEMPatientStatbyLocation(CWnd *pParent);
	~CEMPatientStatbyLocation();
