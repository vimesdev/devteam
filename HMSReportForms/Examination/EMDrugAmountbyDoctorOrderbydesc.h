#ifndef EMDRUGAMOUNTBYDOCTORORDERBYDESC_H
#define EMDRUGAMOUNTBYDOCTORORDERBYDESC_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMDrugAmountbyDoctorOrderbydesc : public CGuiView
{
...
public:
	...
	long			OnListLoadData();
	void			OnNoiTruSelect(); 
	CEMDrugAmountbyDoctorOrderbydesc(CWnd *pWnd);
	~CEMDrugAmountbyDoctorOrderbydesc();
