#ifndef EMTHUTHUATNOISOITYC_H
#define EMTHUTHUATNOISOITYC_H
...
class EMThuthuatnoisoityc : public CGuiView
{
...
public:
	...
	int OnAddEMThuthuatnoisoityc(); 
	int OnEditEMThuthuatnoisoityc(); 
	int OnDeleteEMThuthuatnoisoityc(); 
	int OnSaveEMThuthuatnoisoityc(); 
	int OnCancelEMThuthuatnoisoityc(); 
	int OnEMThuthuatnoisoitycListLoadData(); 
