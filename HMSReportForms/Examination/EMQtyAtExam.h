#ifndef EMQTYATEXAM_H
#define EMQTYATEXAM_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMQtyAtExam : public CGuiView{
protected:
public:
	...
	int OnAddEMQtyAtExam(); 
	int OnEditEMQtyAtExam(); 
	int OnDeleteEMQtyAtExam(); 
	int OnSaveEMQtyAtExam(); 
	int OnCancelEMQtyAtExam(); 
	int OnEMQtyAtExamListLoadData(); 
