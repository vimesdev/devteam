#ifndef EMDRUGAMOUNTBYDOCTOR_H
#define EMDRUGAMOUNTBYDOCTOR_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMDrugAmountbyDoctor : public CGuiView
{
...
public:
	...
	long			OnListLoadData();
	void			OnNoiTruSelect(); 
	CEMDrugAmountbyDoctor(CWnd *pWnd);
	~CEMDrugAmountbyDoctor();
