#ifndef EMPATIENTSTATBYROOM2_H
#define EMPATIENTSTATBYROOM2_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMPatientStatbyRoom2 : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CEMPatientStatbyRoom2(CWnd *pParent);
	~CEMPatientStatbyRoom2();
