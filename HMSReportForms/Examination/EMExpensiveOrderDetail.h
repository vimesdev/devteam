#ifndef EMEXPENSIVEORDERDETAIL_H
#define EMEXPENSIVEORDERDETAIL_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMExpensiveOrderDetail : public CGuiView{
protected:
public:
	...
	//void			OnRoomAddNew(); 
	void			OnExportSelect(); 
	CEMExpensiveOrderDetail(CWnd *pParent);
	~CEMExpensiveOrderDetail();
