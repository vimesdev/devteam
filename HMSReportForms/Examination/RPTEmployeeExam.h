#ifndef RPTEMPLOYEEEXAM_H
#define RPTEMPLOYEEEXAM_H
...
class CRPTEmployeeExam : public CGuiView
{
protected:
public:
	...
	int OnAddRPTEmployeeExam(); 
	int OnEditRPTEmployeeExam(); 
	int OnDeleteRPTEmployeeExam(); 
	int OnSaveRPTEmployeeExam(); 
	int OnCancelRPTEmployeeExam(); 
	int OnRPTEmployeeExamListLoadData(); 
	...
	CString GetQueryString(int nQuery);
