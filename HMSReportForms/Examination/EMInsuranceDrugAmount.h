#ifndef EMINSURANCEDRUGAMOUNT_H
#define EMINSURANCEDRUGAMOUNT_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMInsuranceDrugAmount : public CGuiView{
protected:
public:
	...
	//void			OnDoctorAddNew(); 
	void			OnExportSelect(); 
	CEMInsuranceDrugAmount(CWnd *pWnd);
	~CEMInsuranceDrugAmount();
