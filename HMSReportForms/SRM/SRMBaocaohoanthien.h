#ifndef SRMBAOCAOHOANTHIEN_H
#define SRMBAOCAOHOANTHIEN_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMBaocaohoanthien : public CGuiView{
protected:
public:
	...
	CSRMBaocaohoanthien(CWnd *pParent);
	~CSRMBaocaohoanthien();
	...
	int OnAddSRMBaocaohoanthien(); 
	int OnEditSRMBaocaohoanthien(); 
	int OnDeleteSRMBaocaohoanthien(); 
	int OnSaveSRMBaocaohoanthien(); 
	int OnCancelSRMBaocaohoanthien(); 
	int OnSRMBaocaohoanthienListLoadData(); 
};
#endif
