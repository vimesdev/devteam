#ifndef SRMQuanlythongtinluuluungBNkham_H
#define SRMQuanlythongtinluuluungBNkham_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMQuanlythongtinluuluungBNkham : public CGuiView{
protected:
public:
	...
	CSRMQuanlythongtinluuluungBNkham(CWnd *pParent);
	~CSRMQuanlythongtinluuluungBNkham();
