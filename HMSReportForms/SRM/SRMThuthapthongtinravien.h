#ifndef SRMThuthapthongtinravien_H
#define SRMThuthapthongtinravien_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMThuthapthongtinravien : public CGuiView{
protected:
public:
	...
	CSRMThuthapthongtinravien(CWnd *pParent);
	~CSRMThuthapthongtinravien();
	...
	int OnAddSRMThuthapthongtinravien(); 
	int OnEditSRMThuthapthongtinravien(); 
	int OnDeleteSRMThuthapthongtinravien(); 
	int OnSaveSRMThuthapthongtinravien(); 
	int OnCancelSRMThuthapthongtinravien(); 
	int OnSRMThuthapthongtinravienListLoadData(); 
