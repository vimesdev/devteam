#ifndef SRMBIENBANKIEMPHIEU_H
#define SRMBIENBANKIEMPHIEU_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMBienbankiemphieu : public CGuiView{
protected:
public:
	...
	CSRMBienbankiemphieu(CWnd *pParent);
	~CSRMBienbankiemphieu();
	...
	int OnAddSRMBienbankiemphieu(); 
	int OnEditSRMBienbankiemphieu(); 
	int OnDeleteSRMBienbankiemphieu(); 
	int OnSaveSRMBienbankiemphieu(); 
	int OnCancelSRMBienbankiemphieu(); 
	int OnSRMBienbankiemphieuListLoadData(); 
};
#endif
