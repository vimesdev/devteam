#include "stdafx.h"
#include "SRMThuthapthongtindieutribenhnhan.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtindieutribenhnhan *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CSRMThuthapthongtindieutribenhnhan *pVw = (CSRMThuthapthongtindieutribenhnhan *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnListDeleteItem();
} 
static int _OnAddBCQUANSOTHEONGAYFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnAddBCQUANSOTHEONGAY();
} 
static int _OnEditBCQUANSOTHEONGAYFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnEditBCQUANSOTHEONGAY();
} 
static int _OnDeleteBCQUANSOTHEONGAYFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnDeleteBCQUANSOTHEONGAY();
} 
static int _OnSaveBCQUANSOTHEONGAYFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnSaveBCQUANSOTHEONGAY();
} 
static int _OnCancelBCQUANSOTHEONGAYFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtindieutribenhnhan*)pWnd)->OnCancelBCQUANSOTHEONGAY();
} 
CSRMThuthapthongtindieutribenhnhan::CSRMThuthapthongtindieutribenhnhan(CWnd *pParent){

	m_nDlgWidth = 1021;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CSRMThuthapthongtindieutribenhnhan::~CSRMThuthapthongtindieutribenhnhan(){
}
void CSRMThuthapthongtindieutribenhnhan::OnCreateComponents(){
...
void CSRMThuthapthongtindieutribenhnhan::OnInitializeComponents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CSRMThuthapthongtindieutribenhnhan::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CSRMThuthapthongtindieutribenhnhan::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CSRMThuthapthongtindieutribenhnhan::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CSRMThuthapthongtindieutribenhnhan::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CSRMThuthapthongtindieutribenhnhan::SetDefaultValues(){

	m_szFromDate.Empty();
	m_szToDate.Empty();

}
int CSRMThuthapthongtindieutribenhnhan::SetMode(int nMode){
...
void CSRMThuthapthongtindieutribenhnhan::OnExportSelect(){
	...
	}	EndWaitCursor();	xls.Save(_T("Exports\\SRMThuthapthongtindieutribenhnhan.xls"));
} 
void CSRMThuthapthongtindieutribenhnhan::OnListDblClick(){
	
} 
void CSRMThuthapthongtindieutribenhnhan::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CSRMThuthapthongtindieutribenhnhan::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CSRMThuthapthongtindieutribenhnhan::OnListLoadData(){
	UpdateData(TRUE);
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	m_wndList.BeginLoad();
...
int CSRMThuthapthongtindieutribenhnhan::OnAddBCQUANSOTHEONGAY(){
...
int CSRMThuthapthongtindieutribenhnhan::OnEditBCQUANSOTHEONGAY(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CSRMThuthapthongtindieutribenhnhan::OnDeleteBCQUANSOTHEONGAY(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CSRMThuthapthongtindieutribenhnhan::OnSaveBCQUANSOTHEONGAY(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CSRMThuthapthongtindieutribenhnhan::OnCancelBCQUANSOTHEONGAY(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CSRMThuthapthongtindieutribenhnhan::OnBCQUANSOTHEONGAYListLoadData(){
	return 0;
}
CString CSRMThuthapthongtindieutribenhnhan::GetQueryString(){
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
