#ifndef SRMThuthapthongtinvaovien_H
#define SRMThuthapthongtinvaovien_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMThuthapthongtinvaovien : public CGuiView{
protected:
public:
	...
	CSRMThuthapthongtinvaovien(CWnd *pParent);
	~CSRMThuthapthongtinvaovien();
	...
	int OnAddSRMThuthapthongtinvaovien(); 
	int OnEditSRMThuthapthongtinvaovien(); 
	int OnDeleteSRMThuthapthongtinvaovien(); 
	int OnSaveSRMThuthapthongtinvaovien(); 
	int OnCancelSRMThuthapthongtinvaovien(); 
	int OnSRMThuthapthongtinvaovienListLoadData(); 
