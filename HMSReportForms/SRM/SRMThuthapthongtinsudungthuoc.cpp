#include "stdafx.h"
#include "SRMThuthapthongtinsudungthuoc.h"
...
static int _OnCheckAllFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnCheckAll();
} 
static int _OnUnCheckAllFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnUnCheckAll();
} 
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CSRMThuthapthongtinsudungthuoc* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CSRMThuthapthongtinsudungthuoc* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnTypeAddNew();
}*/

static void _OnOriginalSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CSRMThuthapthongtinsudungthuoc* )pWnd)->OnOriginalSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOriginalSelendokFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnOriginalSelendok();
}
/*static void _OnOriginalSetfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnOriginalKillfocus();
}*/
/*static void _OnOriginalKillfocusFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnOriginalKillfocus();
}*/
static long _OnOriginalLoadDataFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnOriginalLoadData();
}
/*static void _OnOriginalAddNewFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc *)pWnd)->OnOriginalAddNew();
}*/


static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CSRMThuthapthongtinsudungthuoc *pVw = (CSRMThuthapthongtinsudungthuoc *)pWnd;
...
static long _OnListFacLoadDataFnc(CWnd *pWnd){
	return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnListFacLoadData();
} 
static void _OnListFacDblClickFnc(CWnd *pWnd){
	((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnListFacDblClick();
} 
static void _OnListFacSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnListFacSelectChange(nOldItem, nNewItem);
} 
static int _OnListFacDeleteItemFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnListFacDeleteItem();
} 
static int _OnAddSRMThuthapthongtinsudungthuocFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnAddSRMThuthapthongtinsudungthuoc();
} 
static int _OnEditSRMThuthapthongtinsudungthuocFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnEditSRMThuthapthongtinsudungthuoc();
} 
static int _OnDeleteSRMThuthapthongtinsudungthuocFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnDeleteSRMThuthapthongtinsudungthuoc();
} 
static int _OnSaveSRMThuthapthongtinsudungthuocFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnSaveSRMThuthapthongtinsudungthuoc();
} 
static int _OnCancelSRMThuthapthongtinsudungthuocFnc(CWnd *pWnd){
	 return ((CSRMThuthapthongtinsudungthuoc*)pWnd)->OnCancelSRMThuthapthongtinsudungthuoc();
} 
CSRMThuthapthongtinsudungthuoc::CSRMThuthapthongtinsudungthuoc(CWnd *pParent)
	{
...
CSRMThuthapthongtinsudungthuoc::~CSRMThuthapthongtinsudungthuoc(){
}
void CSRMThuthapthongtinsudungthuoc::OnCreateComponents(){
...
void CSRMThuthapthongtinsudungthuoc::OnInitializeComponents(){
...
void CSRMThuthapthongtinsudungthuoc::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CSRMThuthapthongtinsudungthuoc::OnDoDataExchange(CDataExchange* pDX){
...
void CSRMThuthapthongtinsudungthuoc::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CSRMThuthapthongtinsudungthuoc::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CSRMThuthapthongtinsudungthuoc::SetDefaultValues(){
...
int CSRMThuthapthongtinsudungthuoc::SetMode(int nMode){
...
/*void CSRMThuthapthongtinsudungthuoc::OnFromDateChange(){
	
} */
/*void CSRMThuthapthongtinsudungthuoc::OnFromDateSetfocus(){
	
} */
/*void CSRMThuthapthongtinsudungthuoc::OnFromDateKillfocus(){
	
} */
int CSRMThuthapthongtinsudungthuoc::OnFromDateCheckValue(){
	return 0;
} 
/*void CSRMThuthapthongtinsudungthuoc::OnToDateChange(){
	
} */
/*void CSRMThuthapthongtinsudungthuoc::OnToDateSetfocus(){
	
} */
/*void CSRMThuthapthongtinsudungthuoc::OnToDateKillfocus(){
	
} */
int CSRMThuthapthongtinsudungthuoc::OnToDateCheckValue(){
	return 0;
} 
void CSRMThuthapthongtinsudungthuoc::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CSRMThuthapthongtinsudungthuoc::OnStockSelendok(){
	 
}
/*void CSRMThuthapthongtinsudungthuoc::OnStockSetfocus(){
	
}*/
/*void CSRMThuthapthongtinsudungthuoc::OnStockKillfocus(){
	
}*/
long CSRMThuthapthongtinsudungthuoc::OnStockLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CSRMThuthapthongtinsudungthuoc::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CSRMThuthapthongtinsudungthuoc::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CSRMThuthapthongtinsudungthuoc::OnTypeSelendok(){
	 
}
/*void CSRMThuthapthongtinsudungthuoc::OnTypeSetfocus(){
	
}*/
/*void CSRMThuthapthongtinsudungthuoc::OnTypeKillfocus(){
	
}*/
long CSRMThuthapthongtinsudungthuoc::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CSRMThuthapthongtinsudungthuoc::OnTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CSRMThuthapthongtinsudungthuoc::OnOriginalSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CSRMThuthapthongtinsudungthuoc::OnOriginalSelendok(){
	 
}
/*void CSRMThuthapthongtinsudungthuoc::OnOriginalSetfocus(){
	
}*/
/*void CSRMThuthapthongtinsudungthuoc::OnOriginalKillfocus(){
	
}*/
long CSRMThuthapthongtinsudungthuoc::OnOriginalLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*
void CSRMThuthapthongtinsudungthuoc::OnOriginalAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
*/
void CSRMThuthapthongtinsudungthuoc::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	//UpdateData(true);
	OnPrintBaocaoxuathuocchokhoatheodoituong();
	//UpdateData(false);
} 
void CSRMThuthapthongtinsudungthuoc::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	//UpdateData(true);
	OnExportBaocaoxuathuocchokhoatheodoituong();
	//UpdateData(false);
} 
void CSRMThuthapthongtinsudungthuoc::OnExportSelect(){
...
void CSRMThuthapthongtinsudungthuoc::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

} 

int CSRMThuthapthongtinsudungthuoc::OnCheckAll(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CSRMThuthapthongtinsudungthuoc::OnUnCheckAll(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	for (int i=0; i< m_wndListFac.GetItemCount(); i++){
...
void CSRMThuthapthongtinsudungthuoc::OnListFacDblClick(){
	
} 
void CSRMThuthapthongtinsudungthuoc::OnListFacSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CSRMThuthapthongtinsudungthuoc::OnListFacDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 

long CSRMThuthapthongtinsudungthuoc::OnListFacLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CSRMThuthapthongtinsudungthuoc::OnAddSRMThuthapthongtinsudungthuoc(){
...
int CSRMThuthapthongtinsudungthuoc::OnEditSRMThuthapthongtinsudungthuoc(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CSRMThuthapthongtinsudungthuoc::OnDeleteSRMThuthapthongtinsudungthuoc(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelSRMThuthapthongtinsudungthuoc(); 
 	}
	return 0;
}
int CSRMThuthapthongtinsudungthuoc::OnSaveSRMThuthapthongtinsudungthuoc(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnSRMThuthapthongtinsudungthuocListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CSRMThuthapthongtinsudungthuoc::OnCancelSRMThuthapthongtinsudungthuoc(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CSRMThuthapthongtinsudungthuoc::OnSRMThuthapthongtinsudungthuocListLoadData(){
	return 0;
}

void CSRMThuthapthongtinsudungthuoc::OnPrintBaocaoxuathuocchokhoatheodoituong(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
	...
	if(!rpt.Init(_T("Reports/HMS/THUTHAPTHONGTINSDTHUOC.RPT"),true) )
	{
		return;
	}
	szWhere.Empty();
...
void CSRMThuthapthongtinsudungthuoc::OnExportBaocaoxuathuocchokhoatheodoituong(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	TranslateString(_T("Thu th\x1EADp th\xF4ng tin s\x1EED \x64\x1EE5ng thu\x1ED1\x63"), szTemp);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\SRMThuthapthongtinsudungthuoc.xls"));
}
BEGIN_MESSAGE_MAP(CSRMThuthapthongtinsudungthuoc, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CSRMThuthapthongtinsudungthuoc::OnSetFocus(CWnd* pOldWnd)
{
