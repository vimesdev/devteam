#ifndef RPTTotalHealthStaff_H
#define RPTTotalHealthStaff_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTTotalHealthStaff : public CGuiView
{
protected:
public:
	...
	CRPTTotalHealthStaff(CWnd *pParent);
	~CRPTTotalHealthStaff();
