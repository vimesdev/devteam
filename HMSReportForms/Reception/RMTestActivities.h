#ifndef RMTestActivities_H
#define RMTestActivities_H
...
#include "GuiView.h"
#include "DbField.h"
class CRMTestActivities : public CGuiView{
protected:
...
public:
	...
	void			OnExportSelect();
	void			OnPrintSelect();
	CRMTestActivities(CWnd *pParent);
	~CRMTestActivities();
	...
	void ExportResultList();
	void ExportC3PatientList();
	void ExportC17PatientList();
};
#endif