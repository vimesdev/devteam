#ifndef BBOnHandList_H
#define BBOnHandList_H
...
#include "GuiView.h"
#include "DbField.h"
class CBBOnHandList : public CGuiView{
protected:
public:
	...
	int OnAddBBOnHandList(); 
	int OnEditBBOnHandList(); 
	int OnDeleteBBOnHandList(); 
	int OnSaveBBOnHandList(); 
	int OnCancelBBOnHandList(); 
	int OnBBOnHandListListLoadData();
