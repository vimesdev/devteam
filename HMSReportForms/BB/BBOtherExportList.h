#ifndef BBOTHEREXPORTLIST_H
#define BBOTHEREXPORTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CBBOtherExportList : public CGuiView{
protected:
public:
	...
	int OnAddBBOtherExportList(); 
	int OnEditBBOtherExportList(); 
	int OnDeleteBBOtherExportList(); 
	int OnSaveBBOtherExportList(); 
	int OnCancelBBOtherExportList(); 
	int OnBBOtherExportListListLoadData();
