#ifndef BLOODTESTACTIVITIES_H
#define BLOODESTACTIVITIES_H
...
#include "GuiView.h"
#include "DbField.h"
class CBLOODTestActitivities : public CGuiView{
protected:
...
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CBLOODTestActitivities(CWnd *pParent);
	~CBLOODTestActitivities();
