#ifndef BLOODBANKLISTSERVICEPOSTED_H
#define BLOODBANKLISTSERVICEPOSTED_H
...
#include "GuiView.h"
#include "DbField.h"
class CBloodBankListServicePosted : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CBloodBankListServicePosted(CWnd *pParent);
	~CBloodBankListServicePosted();
