#ifndef BLOODBANKLISTSERVICEPOSTEDEX_H
#define BLOODBANKLISTSERVICEPOSTEDEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CBloodBankListServicePostedEX : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect(); 
	CBloodBankListServicePostedEX(CWnd *pParent);
	~CBloodBankListServicePostedEX();
