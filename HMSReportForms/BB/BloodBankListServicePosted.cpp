#include "stdafx.h"
#include "BloodBankListServicePosted.h"
#include "HMSMainFrame.h"

static int _OnObjectCheckAllFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnObjectCheckAll();
}
static int _OnObjectUncheckAllFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnObjectUncheckAll();
}
//-----------------------------------------------------
static int _OnDeptCheckAllFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnDeptCheckAll();
}
static int _OnDeptUncheckAllFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnDeptUncheckAll();
}
//-----------------------------------------------------
static int _OnListCheckAllFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnListCheckAll();
}
static int _OnListUncheckAllFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnListUncheckAll();
}
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CBloodBankListServicePosted *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CBloodBankListServicePosted *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CBloodBankListServicePosted *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CBloodBankListServicePosted *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CBloodBankListServicePosted *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CBloodBankListServicePosted *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted *)pWnd)->OnToDateCheckValue();
} 
static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnObjectLoadData();
} 
static void _OnObjectDblClickFnc(CWnd *pWnd){
	((CBloodBankListServicePosted*)pWnd)->OnObjectDblClick();
} 
static void _OnObjectSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBloodBankListServicePosted*)pWnd)->OnObjectSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectDeleteItemFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnObjectDeleteItem();
} 
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnDepartmentLoadData();
} 
static void _OnDepartmentDblClickFnc(CWnd *pWnd){
	((CBloodBankListServicePosted*)pWnd)->OnDepartmentDblClick();
} 
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBloodBankListServicePosted*)pWnd)->OnDepartmentSelectChange(nOldItem, nNewItem);
} 
static int _OnDepartmentDeleteItemFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnDepartmentDeleteItem();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CBloodBankListServicePosted*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CBloodBankListServicePosted*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBloodBankListServicePosted*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnListDeleteItem();
} 
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CBloodBankListServicePosted *pVw = (CBloodBankListServicePosted *)pWnd;
...
static int _OnAddBloodBankListServiceFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnAddBloodBankListService();
} 
static int _OnEditBloodBankListServiceFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnEditBloodBankListService();
} 
static int _OnDeleteBloodBankListServiceFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnDeleteBloodBankListService();
} 
static int _OnSaveBloodBankListServiceFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnSaveBloodBankListService();
} 
static int _OnCancelBloodBankListServiceFnc(CWnd *pWnd){
	 return ((CBloodBankListServicePosted*)pWnd)->OnCancelBloodBankListService();
} 
CBloodBankListServicePosted::CBloodBankListServicePosted(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CBloodBankListServicePosted::~CBloodBankListServicePosted(){
}
void CBloodBankListServicePosted::OnCreateComponents(){
...
void CBloodBankListServicePosted::OnInitializeComponents(){
...
void CBloodBankListServicePosted::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CBloodBankListServicePosted::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CBloodBankListServicePosted::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CBloodBankListServicePosted::OnObjectCheckAll(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CBloodBankListServicePosted::OnObjectUncheckAll(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for (int i=0; i< m_wndObject.GetItemCount(); i++){
...
int CBloodBankListServicePosted::OnDeptCheckAll(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CBloodBankListServicePosted::OnDeptUncheckAll(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for (int i=0; i< m_wndDepartment.GetItemCount(); i++){
...
int CBloodBankListServicePosted::OnListCheckAll(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CBloodBankListServicePosted::OnListUncheckAll(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for (int i=0; i< m_wndList.GetItemCount(); i++){
...
void CBloodBankListServicePosted::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CBloodBankListServicePosted::SetDefaultValues(){

	m_szFromDate.Empty();
	m_szToDate.Empty();

}
int CBloodBankListServicePosted::SetMode(int nMode){
...
/*void CBloodBankListServicePosted::OnFromDateChange(){
	
} */
/*void CBloodBankListServicePosted::OnFromDateSetfocus(){
	
} */
/*void CBloodBankListServicePosted::OnFromDateKillfocus(){
	
} */
int CBloodBankListServicePosted::OnFromDateCheckValue(){
	return 0;
} 
/*void CBloodBankListServicePosted::OnToDateChange(){
	
} */
/*void CBloodBankListServicePosted::OnToDateSetfocus(){
	
} */
/*void CBloodBankListServicePosted::OnToDateKillfocus(){
	
} */
int CBloodBankListServicePosted::OnToDateCheckValue(){
	return 0;
} 
void CBloodBankListServicePosted::OnObjectDblClick(){
	
} 
void CBloodBankListServicePosted::OnObjectSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CBloodBankListServicePosted::OnObjectDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CBloodBankListServicePosted::OnObjectLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBloodBankListServicePosted::OnDepartmentDblClick(){
	
} 
void CBloodBankListServicePosted::OnDepartmentSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CBloodBankListServicePosted::OnDepartmentDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CBloodBankListServicePosted::OnDepartmentLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBloodBankListServicePosted::OnListDblClick(){
	
} 
void CBloodBankListServicePosted::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CBloodBankListServicePosted::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CBloodBankListServicePosted::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	m_wndList.BeginLoad(); 
...
void CBloodBankListServicePosted::OnPrintPreviewSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CBloodBankListServicePosted::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
szSQL.Format(_T(" SELECT ngay,posteddate,sohs,khoa,tenbn,doituong,") \
			_T("        dv150,dv250,dv350,tienmau,tienxn,") \
			_T("        tongtien") \
			_T(" FROM(SELECT ngay,posteddate,sohs,khoa,get_patientname(sohs) tenbn,get_objectname(doituong) doituong,") \
			_T("        sum(dv150) dv150,sum(dv250) dv250,sum(dv350) dv350,sum(tienmau) tienmau,sum(tienxn) tienxn,") \
			_T("        sum(tienmau+tienxn) tongtien") \
			_T(" FROM(SELECT ngay ngay,posteddate,khoa,sohs,doituong,") \
			_T("       sum(dv150) dv150,sum(dv250) dv250,sum(dv350) dv350,sum(tienmau) tienmau,0 tienxn") \
			_T(" FROM(SELECT hpo_orderdate ngay,posteddate,hpo_deptid khoa,hpol_docno sohs,doituong,") \
			...
			_T(" WHERE hpo_org_id='BB' and hpo_orderstatus='A' and fac_posted='Y' AND HPO_INVOICENO=HFE_INVOICENO and FAC_POSTEDDATE BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') %s ") \
			...
			_T(" WHERE hpo_org_id='BB' and hpo_orderstatus='A' and fac_posted='Y' AND HPO_INVOICENO=HFE_INVOICENO and FAC_POSTEDDATE BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') %s)) ") \
			//Add Mau C1.3 vao bao cao
			_T(" GROUP BY ngay,posteddate,khoa,sohs,doituong") \
			_T(" UNION ALL") \
			...
			_T(" WHERE hpo_org_id='BB' and hpo_orderstatus='A' AND fac_posted='Y' AND HPO_INVOICENO=HFE_INVOICENO and hpc_object in(7) and FAC_POSTEDDATE BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
			//Add tien XN dich vu
			_T(" UNION ALL") \
			_T(" SELECT hpo_approvedate ngay,") \
			_T("        FAC_POSTEDDATE posteddate,") \
			...
			_T(" LEFT JOIN VIMES.FA_CASH ON (VIMES.HMS_FEE_INVOICE.HFE_CASH_ID=VIMES.FA_CASH.FAC_CASH_ID)") \
			_T(" LEFT JOIN hms_fee_list ON(hpcl_itemid=hfl_feeid)") \
			_T(" WHERE hpo_org_id='BB' and hpo_orderstatus='A' AND fac_posted='Y' AND HPO_INVOICENO=HFE_INVOICENO and hpc_object in(1,3,8) and FAC_POSTEDDATE BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
			...
			_T(" LEFT JOIN VIMES.FA_CASH ON (VIMES.HMS_FEE_INVOICE.HFE_CASH_ID=VIMES.FA_CASH.FAC_CASH_ID)") \
			_T(" LEFT JOIN hms_fee_list ON(hpcl_itemid=hfl_feeid)") \
			_T(" WHERE hpo_org_id='BB' and hpo_orderstatus='A' AND fac_posted='Y' AND HPO_INVOICENO=HFE_INVOICENO and hpc_object not in(7,1,3,8) and FAC_POSTEDDATE BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
	...
	xls.SetCellText(0, 2, _T("\x44\x41NH S\xC1\x43H TI\x1EC0N M\xC1U \x44\x1ECA\x43H V\x1EE4 T\xC0I \x43H\xCDNH \x110\xC3 THU TI\x1EC0N "), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 11);
	...
	xls.SetCellText(12, 5, _T("S\x1ED1 HS"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 11);
	xls.SetMerge(5, 6, 12, 12);

	xls.SetCellText(13, 5, _T("Ng\xE0y Thu"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 11);
	xls.SetMerge(5, 6, 13, 14);
	...
	while(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("posteddate"), tmpStr);
	...
	xls.Save(_T("Exports\\DANHSACHTIENMAUDICHVUPOSTED.xls"));
}    
	
int CBloodBankListServicePosted::OnAddBloodBankListService(){
...
int CBloodBankListServicePosted::OnEditBloodBankListService(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CBloodBankListServicePosted::OnDeleteBloodBankListService(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CBloodBankListServicePosted::OnSaveBloodBankListService(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CBloodBankListServicePosted::OnCancelBloodBankListService(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CBloodBankListServicePosted::OnBloodBankListServiceListLoadData(){
	return 0;
}
CString CBloodBankListServicePosted::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
