#include "stdafx.h"
#include "BBStockCardReportDialog.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CBBStockCardReportDialog* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnStockAddNew();
}*/
/*static void _OnNameChangeFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnNameChange();
} */
/*static void _OnNameSetfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnNameSetfocus();} */ 
/*static void _OnNameKillfocusFnc(CWnd *pWnd){
	((CBBStockCardReportDialog *)pWnd)->OnNameKillfocus();
} */
static int _OnNameCheckValueFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog *)pWnd)->OnNameCheckValue();
} 


static int _OnListSelectAllFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog*)pWnd)->OnListSelectAll();
} 
static int _OnListUnselectAllFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog*)pWnd)->OnListUnselectAll();
} 
static void _OnByProductLineSelectFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog*)pWnd)->OnByProductLineSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CBBStockCardReportDialog*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CBBStockCardReportDialog*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBBStockCardReportDialog*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CBBStockCardReportDialog*)pWnd)->OnListDeleteItem();
} 
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CBBStockCardReportDialog *pVw = (CBBStockCardReportDialog *)pWnd;
...
static int _OnAddPMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CBBStockCardReportDialog*)pWnd)->OnAddPMSStockCardReportDialog();
} 
static int _OnEditPMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CBBStockCardReportDialog*)pWnd)->OnEditPMSStockCardReportDialog();
} 
static int _OnDeletePMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CBBStockCardReportDialog*)pWnd)->OnDeletePMSStockCardReportDialog();
} 
static int _OnSavePMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CBBStockCardReportDialog*)pWnd)->OnSavePMSStockCardReportDialog();
} 
static int _OnCancelPMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CBBStockCardReportDialog*)pWnd)->OnCancelPMSStockCardReportDialog();
} 
CBBStockCardReportDialog::CBBStockCardReportDialog(CWnd *pParent, int bDetail)
{
	m_nPrintID = bDetail;
	m_nDlgWidth = 585;
	m_nDlgHeight = 590;
...
CBBStockCardReportDialog::~CBBStockCardReportDialog(){
}
void CBBStockCardReportDialog::OnCreateComponents(){
...
void CBBStockCardReportDialog::OnInitializeComponents(){
...
void CBBStockCardReportDialog::OnSetWindowEvents(){
...
void CBBStockCardReportDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CBBStockCardReportDialog::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBBStockCardReportDialog::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CBBStockCardReportDialog::SetDefaultValues()
{
...
int CBBStockCardReportDialog::SetMode(int nMode)
{
...
/*void CBBStockCardReportDialog::OnFromDateChange(){
	
} */
/*void CBBStockCardReportDialog::OnFromDateSetfocus(){
	
} */
/*void CBBStockCardReportDialog::OnFromDateKillfocus(){
	
} */
int CBBStockCardReportDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void CBBStockCardReportDialog::OnToDateChange(){
	
} */
/*void CBBStockCardReportDialog::OnToDateSetfocus(){
	
} */
/*void CBBStockCardReportDialog::OnToDateKillfocus(){
	
} */
int CBBStockCardReportDialog::OnToDateCheckValue(){
	return 0;
} 
void CBBStockCardReportDialog::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CBBStockCardReportDialog::OnStockSelendok(){
	UpdateData(true);
	OnListLoadData();
	 
}
/*void CBBStockCardReportDialog::OnStockSetfocus(){
	
}*/
/*void CBBStockCardReportDialog::OnStockKillfocus(){
	
}*/
long CBBStockCardReportDialog::OnStockLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadStorageList(&m_wndStock, m_szStockKey);
}
/*void CBBStockCardReportDialog::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CBBStockCardReportDialog::OnNameChange(){
	
} */
/*void CBBStockCardReportDialog::OnNameSetfocus(){
	
} */
/*void CBBStockCardReportDialog::OnNameKillfocus(){
	
} */
int CBBStockCardReportDialog::OnNameCheckValue(){
	OnListLoadData();
	return 1;
}


int CBBStockCardReportDialog::OnListSelectAll(){
...
int CBBStockCardReportDialog::OnListUnselectAll(){
	for (int i =0; i < m_wndList.GetItemCount(); i++)
	{
...
void CBBStockCardReportDialog::OnListDblClick(){
	UpdateData(TRUE);
...
void CBBStockCardReportDialog::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CBBStockCardReportDialog::OnListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 
long CBBStockCardReportDialog::OnListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	if (!m_bByProductLine)
		szSQL.Format(_T(" SELECT DISTINCT product_code AS code, ") \
					...
					_T(" WHERE Product_Producttype='A2000' ") \
					_T(" %s ") \
					_T(" ORDER BY productname,unit "), szWhere);
	else
		szSQL.Format(_T(" SELECT product_code AS code, ") \
					...
					_T("         product_classname AS genericname, ") \
					_T("         product_countryname AS orgname, ") \
					_T("         product_item_id AS productid ") \
					...
					_T(" %s ") \
					_T(" ORDER BY productname,unit "), m_szStockKey, szWhere);
...
void CBBStockCardReportDialog::OnByProductLineSelect(){
	OnListLoadData();
}

void CBBStockCardReportDialog::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	switch (m_nPrintID)
	{
		case 1:
...
void CBBStockCardReportDialog::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	switch (m_nPrintID)
	{
		case 1:
...
void CBBStockCardReportDialog::OnExportSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	switch (m_nPrintID)
	{
	case 1:
...
void CBBStockCardReportDialog::OnExport(bool bPreview){
...
void CBBStockCardReportDialog::OnExport2(bool bPreview){
	_debug(_T("%s"), CString(typeid(this).name()));
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
...
void CBBStockCardReportDialog::OnOrderExport(bool bPreview){
	_debug(_T("%s"), CString(typeid(this).name()));
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CBBStockCardReportDialog::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CBBStockCardReportDialog::OnAddPMSStockCardReportDialog(){
...
int CBBStockCardReportDialog::OnEditPMSStockCardReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CBBStockCardReportDialog::OnDeletePMSStockCardReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CBBStockCardReportDialog::OnSavePMSStockCardReportDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CBBStockCardReportDialog::OnCancelPMSStockCardReportDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CBBStockCardReportDialog::OnPMSStockCardReportDialogListLoadData(){
	return 0;
}

void CBBStockCardReportDialog::OnPrint(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CReport rpt;
			...
			while(!rs.IsEOF()){
				...
				else
				{
					...
					else if(szType == _T("PPO") || szType == _T("M"))
					{
						CString szName;
						rs.GetValue(_T("invoiceno"), tmpStr);
						szSQL.Format(_T("select trim(hp_surname||' '||hp_midname||' '||hp_firstname) as pname, hpo_deptid deptid ") \
...
void CBBStockCardReportDialog::OnPrint2(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	UpdateData(true);
	BeginWaitCursor();
...
void CBBStockCardReportDialog::OnOrderPrint(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
...
void CBBStockCardReportDialog::OnOrderPrint2(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
...
CString CBBStockCardReportDialog::GetQueryString_FP(long nID){
	CString szSQL;
	
	return szSQL;
}

CString CBBStockCardReportDialog::GetQueryString_IO(long nID){
	CString szSQL;

	return szSQL;
}

BEGIN_MESSAGE_MAP(CBBStockCardReportDialog, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CBBStockCardReportDialog::OnSetFocus(CWnd* pOldWnd)
{
