#ifndef CLIMSTESTPATIENTLIST_H
#define CLIMSTESTPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CLIMSTestPatientList : public CGuiView
{
protected:
public:
	...
	CLIMSTestPatientList(CWnd *pParent);
	~CLIMSTestPatientList();
