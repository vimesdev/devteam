#ifndef BLOODBANKLISTSERVICEXUPDATE1_H
#define BLOODBANKLISTSERVICEXUPDATE1_H
...
#include "GuiView.h"
#include "DbField.h"
class CBloodBankListServicex_update1 : public CGuiView
{
protected:
public:
	...
	CBloodBankListServicex_update1(CWnd *pParent);
	~CBloodBankListServicex_update1();
