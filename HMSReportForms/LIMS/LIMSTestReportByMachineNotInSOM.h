#ifndef LIMSTESTREPORTBYMACHINENOTINSOM_H
#define LIMSTESTREPORTBYMACHINENOTINSOM_H
...
#include "GuiView.h"
#include "DbField.h"
class CLIMSTestReportByMachineNotInSOM : public CGuiView
{
protected:
public:
	...
	CLIMSTestReportByMachineNotInSOM(CWnd *pParent);
	~CLIMSTestReportByMachineNotInSOM();
