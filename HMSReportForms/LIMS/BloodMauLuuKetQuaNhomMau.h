#ifndef BloodMauLuuKetQuaNhomMau_H
#define BloodMauLuuKetQuaNhomMau_H
...
#include "GuiView.h"
#include "DbField.h"
class CBloodMauLuuKetQuaNhomMau : public CGuiView{
protected:
...
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CBloodMauLuuKetQuaNhomMau(CWnd *pParent);
	~CBloodMauLuuKetQuaNhomMau();
