#ifndef LIMSUPDATEBARCODETIME_H
#define LIMSUPDATEBARCODETIME_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CLIMSUpdateBarCodeTime : public CGuiDialog
...
public:
	...
	void			OnAllSelect();
	void			OnUpdateTimeSelect();
	int 			OnExport(); 
	CLIMSUpdateBarCodeTime(CWnd *pParent);

	~CLIMSUpdateBarCodeTime();
