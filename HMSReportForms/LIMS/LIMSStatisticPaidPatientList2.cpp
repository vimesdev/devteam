#include "stdafx.h"
#include "LIMSStatisticPaidPatientList2.h"
#include "HMSMainFrame.h"
#include "Excel.h"
#include "ReportDocument.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CLIMSStatisticPaidPatientList2 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CLIMSStatisticPaidPatientList2 *)pWnd)->OnToDateCheckValue();
} 
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnGroupLoadData();
} 
static void _OnGroupDblClickFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2*)pWnd)->OnGroupDblClick();
} 
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CLIMSStatisticPaidPatientList2*)pWnd)->OnGroupSelectChange(nOldItem, nNewItem);
} 
static int _OnGroupDeleteItemFnc(CWnd *pWnd){
	 return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnGroupDeleteItem();
} 
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnItemLoadData();
} 
static void _OnItemDblClickFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2*)pWnd)->OnItemDblClick();
} 
static void _OnItemSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CLIMSStatisticPaidPatientList2*)pWnd)->OnItemSelectChange(nOldItem, nNewItem);
} 
static int _OnItemDeleteItemFnc(CWnd *pWnd){
	 return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnItemDeleteItem();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CLIMSStatisticPaidPatientList2* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CLIMSStatisticPaidPatientList2 *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CLIMSStatisticPaidPatientList2 *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CLIMSStatisticPaidPatientList2 *pVw = (CLIMSStatisticPaidPatientList2 *)pWnd;
...
static void _OnLockedSelectFnc(CWnd *pWnd){
	 ((CLIMSStatisticPaidPatientList2*)pWnd)->OnLockedSelect();
}
static int _OnAddLIMSStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnAddLIMSStatisticPaidPatientList2();
} 
static int _OnEditLIMSStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnEditLIMSStatisticPaidPatientList2();
} 
static int _OnDeleteLIMSStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnDeleteLIMSStatisticPaidPatientList2();
} 
static int _OnSaveLIMSStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnSaveLIMSStatisticPaidPatientList2();
} 
static int _OnCancelLIMSStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CLIMSStatisticPaidPatientList2*)pWnd)->OnCancelLIMSStatisticPaidPatientList2();
} 
CLIMSStatisticPaidPatientList2::CLIMSStatisticPaidPatientList2(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CLIMSStatisticPaidPatientList2::~CLIMSStatisticPaidPatientList2(){
}
void CLIMSStatisticPaidPatientList2::OnCreateComponents(){
...
void CLIMSStatisticPaidPatientList2::OnInitializeComponents(){
...
void CLIMSStatisticPaidPatientList2::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CLIMSStatisticPaidPatientList2::OnDoDataExchange(CDataExchange* pDX){
...
void CLIMSStatisticPaidPatientList2::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CLIMSStatisticPaidPatientList2::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CLIMSStatisticPaidPatientList2::SetDefaultValues(){
...
int CLIMSStatisticPaidPatientList2::SetMode(int nMode){
...
/*void CLIMSStatisticPaidPatientList2::OnFromDateChange(){
	
} */
/*void CLIMSStatisticPaidPatientList2::OnFromDateSetfocus(){
	
} */
/*void CLIMSStatisticPaidPatientList2::OnFromDateKillfocus(){
	
} */
int CLIMSStatisticPaidPatientList2::OnFromDateCheckValue(){
	return 0;
} 
/*void CLIMSStatisticPaidPatientList2::OnToDateChange(){
	
} */
/*void CLIMSStatisticPaidPatientList2::OnToDateSetfocus(){
	
} */
/*void CLIMSStatisticPaidPatientList2::OnToDateKillfocus(){
	
} */
int CLIMSStatisticPaidPatientList2::OnToDateCheckValue(){
	return 0;
} 
void CLIMSStatisticPaidPatientList2::OnGroupDblClick(){
	
} 
void CLIMSStatisticPaidPatientList2::OnGroupSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnItemLoadData();

} 
int CLIMSStatisticPaidPatientList2::OnGroupDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CLIMSStatisticPaidPatientList2::OnGroupLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CLIMSStatisticPaidPatientList2::OnItemDblClick(){
	
} 
void CLIMSStatisticPaidPatientList2::OnItemSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CLIMSStatisticPaidPatientList2::OnItemDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CLIMSStatisticPaidPatientList2::OnItemLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CLIMSStatisticPaidPatientList2::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CLIMSStatisticPaidPatientList2::OnClerkSelendok(){
	 
}
/*void CLIMSStatisticPaidPatientList2::OnClerkSetfocus(){
	
}*/
/*void CLIMSStatisticPaidPatientList2::OnClerkKillfocus(){
	
}*/
long CLIMSStatisticPaidPatientList2::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CLIMSStatisticPaidPatientList2::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CLIMSStatisticPaidPatientList2::OnPrintPreviewSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CLIMSStatisticPaidPatientList2::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
	void CLIMSStatisticPaidPatientList2::OnLockedSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
int CLIMSStatisticPaidPatientList2::OnAddLIMSStatisticPaidPatientList2(){
...
int CLIMSStatisticPaidPatientList2::OnEditLIMSStatisticPaidPatientList2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CLIMSStatisticPaidPatientList2::OnDeleteLIMSStatisticPaidPatientList2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelLIMSStatisticPaidPatientList2();
 	}
	return 0;
}
int CLIMSStatisticPaidPatientList2::OnSaveLIMSStatisticPaidPatientList2(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnLIMSStatisticPaidPatientList2ListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CLIMSStatisticPaidPatientList2::OnCancelLIMSStatisticPaidPatientList2(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CLIMSStatisticPaidPatientList2::OnLIMSStatisticPaidPatientList2ListLoadData(){
	return 0;
}

CString CLIMSStatisticPaidPatientList2::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
