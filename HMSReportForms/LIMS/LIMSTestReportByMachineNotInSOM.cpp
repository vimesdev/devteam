#include "stdafx.h"
#include "LIMSTestReportByMachineNotInSOM.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd)
{
	return ((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnToDateCheckValue();
} 
static void _OnPerformDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CLIMSTestReportByMachineNotInSOM* )pWnd)->OnPerformDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPerformDeptSelendokFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnPerformDeptSelendok();
}
/*static void _OnPerformDeptSetfocusFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnPerformDeptKillfocus();
}*/
/*static void _OnPerformDeptKillfocusFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnPerformDeptKillfocus();
}*/
static long _OnPerformDeptLoadDataFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnPerformDeptLoadData();
}
/*static void _OnPerformDeptAddNewFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM *)pWnd)->OnPerformDeptAddNew();
}*/
static void _OnExportSelectFnc(CWnd *pWnd){
	CLIMSTestReportByMachineNotInSOM *pVw = (CLIMSTestReportByMachineNotInSOM *)pWnd;
	pVw->OnExportSelect();
}
static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnObjectLoadData();
} 
static void _OnObjectDblClickFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnObjectDblClick();
} 
static void _OnObjectSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnObjectSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectDeleteItemFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnObjectDeleteItem();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnListDeleteItem();
}
static void _OnSubItemSelectFnc(CWnd *pWnd){
	 ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnSubItemSelect();
}
static void _OnOutPatientSelectFnc(CWnd *pWnd){
	 ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnOutPatientSelect();
}
static void _OnInPatientSelectFnc(CWnd *pWnd){
	 ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnInPatientSelect();
}
static void _OnAllHospitalsSelectFnc(CWnd *pWnd){
	 ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnAllHospitalsSelect();
}
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnDepartmentLoadData();
} 
static void _OnDepartmentDblClickFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnDepartmentDblClick();
} 
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnDepartmentSelectChange(nOldItem, nNewItem);
} 
static int _OnDepartmentDeleteItemFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnDepartmentDeleteItem();
}
static long _OnTestGroupLoadDataFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnTestGroupLoadData();
} 
static void _OnTestGroupDblClickFnc(CWnd *pWnd){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnTestGroupDblClick();
} 
static void _OnTestGroupSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnTestGroupSelectChange(nOldItem, nNewItem);
} 
static int _OnTestGroupDeleteItemFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnTestGroupDeleteItem();
} 
static int _OnAddLIMSTestReportByMachineFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnAddLIMSTestReportByMachine();
} 
static int _OnEditLIMSTestReportByMachineFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnEditLIMSTestReportByMachine();
} 
static int _OnDeleteLIMSTestReportByMachineFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnDeleteLIMSTestReportByMachine();
} 
static int _OnSaveLIMSTestReportByMachineFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnSaveLIMSTestReportByMachine();
} 
static int _OnCancelLIMSTestReportByMachineFnc(CWnd *pWnd){
	 return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnCancelLIMSTestReportByMachine();
}
static int _OnMachineListCheckAllFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnMachineListCheckAll();
}
static int _OnMachineListUnCheckAllFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnMachineListUnCheckAll();
}
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CLIMSTestReportByMachineNotInSOM*)pWnd)->OnDeptListUnCheckAll();
}

CLIMSTestReportByMachineNotInSOM::CLIMSTestReportByMachineNotInSOM(CWnd *pParent)
{
...
CLIMSTestReportByMachineNotInSOM::~CLIMSTestReportByMachineNotInSOM()
{
}
void CLIMSTestReportByMachineNotInSOM::OnCreateComponents()
{
...
void CLIMSTestReportByMachineNotInSOM::OnInitializeComponents()
{
...
void CLIMSTestReportByMachineNotInSOM::OnSetWindowEvents()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CLIMSTestReportByMachineNotInSOM::OnDoDataExchange(CDataExchange* pDX){
...
void CLIMSTestReportByMachineNotInSOM::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CLIMSTestReportByMachineNotInSOM::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CLIMSTestReportByMachineNotInSOM::SetDefaultValues(){
...
int CLIMSTestReportByMachineNotInSOM::SetMode(int nMode){
...
/*void CLIMSTestReportByMachineNotInSOM::OnFromDateChange(){
	
} */
/*void CLIMSTestReportByMachineNotInSOM::OnFromDateSetfocus(){
	
} */
/*void CLIMSTestReportByMachineNotInSOM::OnFromDateKillfocus(){
	
} */
int CLIMSTestReportByMachineNotInSOM::OnFromDateCheckValue(){
	return 0;
} 
/*void CLIMSTestReportByMachineNotInSOM::OnToDateChange(){
	
} */
/*void CLIMSTestReportByMachineNotInSOM::OnToDateSetfocus(){
	
} */
/*void CLIMSTestReportByMachineNotInSOM::OnToDateKillfocus(){
	
} */
int CLIMSTestReportByMachineNotInSOM::OnToDateCheckValue(){
	return 0;
} 
void CLIMSTestReportByMachineNotInSOM::OnPerformDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CLIMSTestReportByMachineNotInSOM::OnPerformDeptSelendok(){
	 
}
/*void CLIMSTestReportByMachineNotInSOM::OnPerformDeptSetfocus(){
	
}*/
/*void CLIMSTestReportByMachineNotInSOM::OnPerformDeptKillfocus(){
	
}*/
long CLIMSTestReportByMachineNotInSOM::OnPerformDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CLIMSTestReportByMachineNotInSOM::OnPerformDeptAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CLIMSTestReportByMachineNotInSOM::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	CGuiMenu menu(this);
...
void CLIMSTestReportByMachineNotInSOM::OnExport1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere,szWhere1, tmpStr, szTemp;
	int nMachineID;
	...
	{
		{
			szWhere1.AppendFormat(_T(" AND hfl_servprice>0"));
		}
	...
	szSQL.Format(_T("SELECT") \
		...
		_T("   line,") \
		_T("   idx,") \
		_T("   sum(quan+bhytquan+bhytquandoi+bhytthannhansyquan+bhytkhac+bhytquannhan+bhytnothe+treem+treemcothe+chinhsach+dichvu+ban) as tongso,") \
		...
		_T("       case when hpc_object='7' then 1 else 0 end as dichvu,") \
		...
		_T("       case when hpc_object='7' then hfl_scale else 0 end as dichvutest,") \
		...
		_T("       AND hfl_report ='Y' AND hpc_deptid in ('TYC', 'PTTYC') AND hpcl_instid not in (47,48,49,50)") \
		...
		_T("       ORDER BY groupid, applydate, line, idx"), m_szFromDate, m_szToDate, szWhere1); \
		rs.ExecSQL(szSQL);
	//_msg(_T("%s"), szSQL);
	if (rs.IsEOF())
	{
	...
	xls.Save(_T("Exports\\BAO CAO CAN LAM SANG THEO MAY KHONG THUC HIEN TAI SOM.XLS"));


}
void CLIMSTestReportByMachineNotInSOM::OnExport2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CLIMSTestReportByMachineNotInSOM::OnObjectDblClick(){
	
} 
void CLIMSTestReportByMachineNotInSOM::OnObjectSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CLIMSTestReportByMachineNotInSOM::OnObjectDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CLIMSTestReportByMachineNotInSOM::OnObjectLoadData(){
...
void CLIMSTestReportByMachineNotInSOM::OnListDblClick(){
	
} 
void CLIMSTestReportByMachineNotInSOM::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CLIMSTestReportByMachineNotInSOM::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CLIMSTestReportByMachineNotInSOM::OnListLoadData(){
...
void CLIMSTestReportByMachineNotInSOM::OnSubItemSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CLIMSTestReportByMachineNotInSOM::OnOutPatientSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (m_bOutPatient)
	...
	void CLIMSTestReportByMachineNotInSOM::OnInPatientSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (m_bInPatient)
	...
	void CLIMSTestReportByMachineNotInSOM::OnAllHospitalsSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (m_bAllHospitals)
...
void CLIMSTestReportByMachineNotInSOM::OnDepartmentDblClick(){
	
} 
void CLIMSTestReportByMachineNotInSOM::OnDepartmentSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CLIMSTestReportByMachineNotInSOM::OnDepartmentDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CLIMSTestReportByMachineNotInSOM::OnDepartmentLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CLIMSTestReportByMachineNotInSOM::OnTestGroupDblClick(){
	
} 
void CLIMSTestReportByMachineNotInSOM::OnTestGroupSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CLIMSTestReportByMachineNotInSOM::OnTestGroupDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CLIMSTestReportByMachineNotInSOM::OnTestGroupLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CLIMSTestReportByMachineNotInSOM::OnAddLIMSTestReportByMachine(){
...
int CLIMSTestReportByMachineNotInSOM::OnEditLIMSTestReportByMachine(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CLIMSTestReportByMachineNotInSOM::OnDeleteLIMSTestReportByMachine(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CLIMSTestReportByMachineNotInSOM::OnSaveLIMSTestReportByMachine(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CLIMSTestReportByMachineNotInSOM::OnCancelLIMSTestReportByMachine(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CLIMSTestReportByMachineNotInSOM::OnLIMSTestReportByMachineListLoadData()
{
	return 0;
}
int CLIMSTestReportByMachineNotInSOM::OnMachineListCheckAll()
{
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (!m_wndList.GetCheck(i))
...
int CLIMSTestReportByMachineNotInSOM::OnMachineListUnCheckAll()
{
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (m_wndList.GetCheck(i))
...
int CLIMSTestReportByMachineNotInSOM::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObject.GetItemCount(); i++)
	{
		if (!m_wndObject.GetCheck(i))
...
int CLIMSTestReportByMachineNotInSOM::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObject.GetItemCount(); i++)
	{
		if (m_wndObject.GetCheck(i))
...
int CLIMSTestReportByMachineNotInSOM::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDepartment.GetItemCount(); i++)
	{
		if (!m_wndDepartment.GetCheck(i))
...
int CLIMSTestReportByMachineNotInSOM::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDepartment.GetItemCount(); i++)
	{
		if (m_wndDepartment.GetCheck(i))
