#include "stdafx.h"
#include "VPMBaocaotonghop2.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CVPMBaocaotonghop2 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CVPMBaocaotonghop2 *)pWnd)->OnToDateCheckValue();
} 
static void _OnPackageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CVPMBaocaotonghop2* )pWnd)->OnPackageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPackageSelendokFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnPackageSelendok();
}
/*static void _OnPackageSetfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnPackageKillfocus();
}*/
/*static void _OnPackageKillfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnPackageKillfocus();
}*/
static long _OnPackageLoadDataFnc(CWnd *pWnd){
	return ((CVPMBaocaotonghop2 *)pWnd)->OnPackageLoadData();
}
/*static void _OnPackageAddNewFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnPackageAddNew();
}*/
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CVPMBaocaotonghop2* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CVPMBaocaotonghop2 *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnDeptAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CVPMBaocaotonghop2* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CVPMBaocaotonghop2 *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2 *)pWnd)->OnStatusAddNew();
}*/
static void _OnTreatingSelectFnc(CWnd *pWnd){
	 ((CVPMBaocaotonghop2*)pWnd)->OnTreatingSelect();
}
static void _OnGetOutDeptSelectFnc(CWnd *pWnd){
	 ((CVPMBaocaotonghop2*)pWnd)->OnGetOutDeptSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CVPMBaocaotonghop2*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CVPMBaocaotonghop2*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CVPMBaocaotonghop2*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CVPMBaocaotonghop2*)pWnd)->OnListDeleteItem();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CVPMBaocaotonghop2 *pVw = (CVPMBaocaotonghop2 *)pWnd;
	pVw->OnLoadSelect();
} 
...
static int _OnAddVPMBaocaotonghop2Fnc(CWnd *pWnd){
	 return ((CVPMBaocaotonghop2*)pWnd)->OnAddVPMBaocaotonghop2();
} 
static int _OnEditVPMBaocaotonghop2Fnc(CWnd *pWnd){
	 return ((CVPMBaocaotonghop2*)pWnd)->OnEditVPMBaocaotonghop2();
} 
static int _OnDeleteVPMBaocaotonghop2Fnc(CWnd *pWnd){
	 return ((CVPMBaocaotonghop2*)pWnd)->OnDeleteVPMBaocaotonghop2();
} 
static int _OnSaveVPMBaocaotonghop2Fnc(CWnd *pWnd){
	 return ((CVPMBaocaotonghop2*)pWnd)->OnSaveVPMBaocaotonghop2();
} 
static int _OnCancelVPMBaocaotonghop2Fnc(CWnd *pWnd){
	 return ((CVPMBaocaotonghop2*)pWnd)->OnCancelVPMBaocaotonghop2();
} 
CVPMBaocaotonghop2::CVPMBaocaotonghop2(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CVPMBaocaotonghop2::~CVPMBaocaotonghop2(){
}
void CVPMBaocaotonghop2::OnCreateComponents(){
...
void CVPMBaocaotonghop2::OnInitializeComponents(){
...
void CVPMBaocaotonghop2::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CVPMBaocaotonghop2::OnDoDataExchange(CDataExchange* pDX){
...
void CVPMBaocaotonghop2::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CVPMBaocaotonghop2::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CVPMBaocaotonghop2::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CVPMBaocaotonghop2::SetDefaultValues(){
...
int CVPMBaocaotonghop2::SetMode(int nMode){
...
/*void CVPMBaocaotonghop2::OnFromDateChange(){
	
} */
/*void CVPMBaocaotonghop2::OnFromDateSetfocus(){
	
} */
/*void CVPMBaocaotonghop2::OnFromDateKillfocus(){
	
} */
int CVPMBaocaotonghop2::OnFromDateCheckValue(){
	return 0;
} 
/*void CVPMBaocaotonghop2::OnToDateChange(){
	
} */
/*void CVPMBaocaotonghop2::OnToDateSetfocus(){
	
} */
/*void CVPMBaocaotonghop2::OnToDateKillfocus(){
	
} */
int CVPMBaocaotonghop2::OnToDateCheckValue(){
	return 0;
} 
void CVPMBaocaotonghop2::OnPackageSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CVPMBaocaotonghop2::OnPackageSelendok(){
	 
}
/*void CVPMBaocaotonghop2::OnPackageSetfocus(){
	
}*/
/*void CVPMBaocaotonghop2::OnPackageKillfocus(){
	
}*/
long CVPMBaocaotonghop2::OnPackageLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CVPMBaocaotonghop2::OnPackageAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CVPMBaocaotonghop2::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CVPMBaocaotonghop2::OnDeptSelendok(){
	 
}
/*void CVPMBaocaotonghop2::OnDeptSetfocus(){
	
}*/
/*void CVPMBaocaotonghop2::OnDeptKillfocus(){
	
}*/
long CVPMBaocaotonghop2::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CVPMBaocaotonghop2::OnDeptAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CVPMBaocaotonghop2::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CVPMBaocaotonghop2::OnStatusSelendok(){
	 
}
/*void CVPMBaocaotonghop2::OnStatusSetfocus(){
	
}*/
/*void CVPMBaocaotonghop2::OnStatusKillfocus(){
	
}*/
long CVPMBaocaotonghop2::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CVPMBaocaotonghop2::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CVPMBaocaotonghop2::OnTreatingSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CVPMBaocaotonghop2::OnGetOutDeptSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CVPMBaocaotonghop2::OnListDblClick(){
	
} 
void CVPMBaocaotonghop2::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CVPMBaocaotonghop2::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CVPMBaocaotonghop2::OnListLoadData(){

	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere ,szOldLine ,szNewLine;
    UpdateData(TRUE);
...
void CVPMBaocaotonghop2::OnLoadSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
} 
void CVPMBaocaotonghop2::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	CRecord rs(&pMF->m_db);
    ...
    TCHAR *lpszChapter[] = {_T("I"), _T("II"), _T("III"), _T("IV"), _T("V"), _T("VI"), _T("VII"), _T("VIII"), _T("IX"), _T("X"), _T("XI")};
	CExcel xls;
	if (!xls.Load(_T("Exports\\BAOCAOTONGHOP2.xls"))) AfxMessageBox(_T("\x43h\x1B0\x61 \x63\xF3 \x66il\x65 trong th\x1B0 m\x1EE5\x63 Exports"));
	...
	xls.Save(_T("Exports\\BAOCAOTONGHOP21.xls.xls"));
} 
int CVPMBaocaotonghop2::OnAddVPMBaocaotonghop2(){
...
int CVPMBaocaotonghop2::OnEditVPMBaocaotonghop2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CVPMBaocaotonghop2::OnDeleteVPMBaocaotonghop2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelVPMBaocaotonghop2();
 	}
	return 0;
}
int CVPMBaocaotonghop2::OnSaveVPMBaocaotonghop2(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnVPMBaocaotonghop2ListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CVPMBaocaotonghop2::OnCancelVPMBaocaotonghop2(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CVPMBaocaotonghop2::OnVPMBaocaotonghop2ListLoadData(){
	return 0;
}
CString CVPMBaocaotonghop2::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
	CString szWhere;
	...
	szSQL.Format(_T(" SELECT  deptid,") \
				...
				_T("   WHERE  %s and nvl(hfel_status,'O') <> 'P' ") \
