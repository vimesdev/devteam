#ifndef CTXH_THONGKENGUOINHAOLAI_H
#define CTXH_THONGKENGUOINHAOLAI_H
...
#include "GuiView.h"
#include "DbField.h"
class CThongKeNguoiNhaOLai : public CGuiView
{
protected:
public:
	...
	CGuiRadioButton	m_wndDoi_Luu_Tru;
	CGuiRadioButton	m_wndDang_Luu_Tru;
	CGuiRadioButton	m_wndKetThuc_TraThe;
	CGuiRadioButton	m_wndAll;
	CGuiCheckBox	m_wndKhoa_Gui_Den;
	CGuiCheckBox	m_wndNgoai_Tru;
	CGuiRadioButton	m_wndDang_Ky_Ngoai_Gio;
	long	m_nYear;
	...
	int	m_nDoi_Luu_Tru;
	int	m_nDang_Luu_Tru;
	int	m_nKetThuc_TraThe;
	int	m_nAll;
	int	m_nDang_Ky_Ngoai_Gio;
	BOOL	m_bKhoa_Gui_Den;
	BOOL	m_bNgoai_Tru;
	...
	void			OnPostedSelect(); 
	CThongKeNguoiNhaOLai(CWnd *pParent);
	~CThongKeNguoiNhaOLai();
	...
	void			OnDoi_Luu_TruSelect(); 
	void			OnDang_Luu_TruSelect(); 
	void			OnKetThuc_TraTheSelect(); 
	void			OnAllSelect(); 
	void			OnKhoa_Gui_DenSelect(); 
	void			OnNgoai_TruSelect(); 
	void			OnDang_Ky_Ngoai_GioSelect(); 

		int OnAddDanhSachLuuTru(); 
	int OnEditDanhSachLuuTru(); 
	int OnDeleteDanhSachLuuTru(); 
	int OnSaveDanhSachLuuTru(); 
	int OnCancelDanhSachLuuTru(); 
	int OnDanhSachLuuTruListLoadData(); 
