#ifndef VPMBAOCAOTONGHOP1_H
#define VPMBAOCAOTONGHOP1_H
...
#include "GuiView.h"
#include "DbField.h"
class CVPMBaocaotonghop1 : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect();
	void			OnOtherSelect();
	CVPMBaocaotonghop1(CWnd *pParent);
	~CVPMBaocaotonghop1();
	...
	int OnAddVPMBaocaotonghop1(); 
	int OnEditVPMBaocaotonghop1(); 
	int OnDeleteVPMBaocaotonghop1(); 
	int OnSaveVPMBaocaotonghop1(); 
	int OnCancelVPMBaocaotonghop1(); 
	int OnVPMBaocaotonghop1ListLoadData();
