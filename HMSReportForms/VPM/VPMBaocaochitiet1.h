#ifndef VPMBAOCAOCHITIET1_H
#define VPMBAOCAOCHITIET1_H
...
#include "GuiView.h"
#include "DbField.h"
class CVPMBaocaochitiet1 : public CGuiView
{
...
public:
	...
	void			OnLoadSelect(); 
	void			OnExportSelect(); 
	CVPMBaocaochitiet1(CWnd *pParent);
	~CVPMBaocaochitiet1();
	...
	int OnAddVPMBaocaochitiet1(); 
	int OnEditVPMBaocaochitiet1(); 
	int OnDeleteVPMBaocaochitiet1(); 
	int OnSaveVPMBaocaochitiet1(); 
	int OnCancelVPMBaocaochitiet1(); 
	int OnVPMBaocaochitiet1ListLoadData();
