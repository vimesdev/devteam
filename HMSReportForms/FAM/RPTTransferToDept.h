#ifndef RPTTRANSFERTODEPT_H
#define RPTTRANSFERTODEPT_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTTransferToDept : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnPrintSelect(); 
	CRPTTransferToDept(CWnd *pParent);
	~CRPTTransferToDept();
	...
	int OnAddRPTTransferToDept(); 
	int OnEditRPTTransferToDept(); 
	int OnDeleteRPTTransferToDept(); 
	int OnSaveRPTTransferToDept(); 
	int OnCancelRPTTransferToDept(); 
	int OnRPTTransferToDeptListLoadData(); 
};
#endif
