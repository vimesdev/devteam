#ifndef RPTASSETSTATISTICLIST_H
#define RPTASSETSTATISTICLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTAssetStatisticList : public CGuiView{
protected:
public:
	...
	CRPTAssetStatisticList(CWnd *pParent);
	~CRPTAssetStatisticList();
	...
	int OnAddRPTAssetStatisticList(); 
	int OnEditRPTAssetStatisticList(); 
	int OnDeleteRPTAssetStatisticList(); 
	int OnSaveRPTAssetStatisticList(); 
	int OnCancelRPTAssetStatisticList(); 
	int OnRPTAssetStatisticListListLoadData(); 
};
#endif
