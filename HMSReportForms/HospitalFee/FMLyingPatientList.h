#ifndef FMLYINGPATIENTLIST_H
#define FMLYINGPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMLyingPatientList : public CGuiView
{
protected:
public:
	...
	CFMLyingPatientList(CWnd* pParent);
	~CFMLyingPatientList();
	...
	int OnAddFMLyingPatientList(); 
	int OnEditFMLyingPatientList(); 
	int OnDeleteFMLyingPatientList(); 
	int OnSaveFMLyingPatientList(); 
	int OnCancelFMLyingPatientList(); 
	int OnFMLyingPatientListListLoadData();
