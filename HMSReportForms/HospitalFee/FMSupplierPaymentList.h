#ifndef FMSupplierPaymentList_H
#define FMSupplierPaymentList_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMSupplierPaymentList : public CGuiView
{
...
public:
	...
	void			OnExportSelect(); 
	CFMSupplierPaymentList(CWnd *pParent);
	~CFMSupplierPaymentList();
