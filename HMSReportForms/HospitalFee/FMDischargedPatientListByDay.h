#ifndef FMDISCHARGEDPATIENTLISTBYDAY_H
#define FMDISCHARGEDPATIENTLISTBYDAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDischargedPatientListByDay : public CGuiView
{
protected:
public:
	...
	CFMDischargedPatientListByDay(CWnd* pParent);
	~CFMDischargedPatientListByDay();
	...
	int OnAddFMDischargedPatientListByDay(); 
	int OnEditFMDischargedPatientListByDay(); 
	int OnDeleteFMDischargedPatientListByDay(); 
	int OnSaveFMDischargedPatientListByDay(); 
	int OnCancelFMDischargedPatientListByDay(); 
	int OnFMDischargedPatientListByDayListLoadData();
