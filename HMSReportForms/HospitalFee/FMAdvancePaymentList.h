#ifndef FMADVANCEPAYMENTLIST_H
#define FMADVANCEPAYMENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMAdvancePaymentList : public CGuiView{
protected:
public:

	CGuiGroupBox	m_wndAdvancePaymentList;
	...
	CFMAdvancePaymentList(CWnd *pParent);
	~CFMAdvancePaymentList();
	...
	int OnAddFMAdvancePaymentList(); 
	int OnEditFMAdvancePaymentList(); 
	int OnDeleteFMAdvancePaymentList(); 
	int OnSaveFMAdvancePaymentList(); 
	int OnCancelFMAdvancePaymentList(); 
	int OnFMAdvancePaymentListListLoadData(); 
