#include "stdafx.h"
#include "FMServicePaidSummarybyDeptEX.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDeptEX* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDeptEX* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDeptEX* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDeptEX* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMServicePaidSummaryByDeptEX *pVw = (CFMServicePaidSummaryByDeptEX *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnSODSelect();
}
...
{
	 ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnATMSelect();
}
static void _OnAllZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnAllZoneSelect();
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnABZoneSelect();
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDeptEX*)pWnd)->OnListCheckAllRefund();
	return 0;
}

static void _OnServiceZoneSelectFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnServiceZoneSelect();
}
static void _OnInsuranceZoneSelectFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnInsuranceZoneSelect();
}

static void _OnGoiLuuTruLabelSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnGoiLuuTruLabelSelect();
}
static void _OnGoiDichVuLabelSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnGoiDichVuLabelSelect();
}
static void _OnAllLabelSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDeptEX*)pWnd)->OnAllLabelSelect();
}


CFMServicePaidSummaryByDeptEX::CFMServicePaidSummaryByDeptEX(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMServicePaidSummaryByDeptEX::~CFMServicePaidSummaryByDeptEX()
{

}
void CFMServicePaidSummaryByDeptEX::OnCreateComponents()
{
	...
	m_wndList.Create(this,10, 225, 476, 528); 
	m_wndWithoutGeneral.Create(this, _T("Without General"), 45, 34, 45, 34);
	...
	m_wndDeposit.Create(this, _T("Deposit"), 45, 34, 45, 34);
	m_wndCreateData.Create(this, _T("Create Data"), 401, 540, 481, 565);
	m_wndAllZone.Create(this, _T("All"), 316, 150, 474, 175);
	m_wndServiceZone.Create(this, _T("Service"), 8, 150, 138, 175);
	m_wndInsuranceZone.Create(this, _T("Insurance"), 162, 150, 292, 175);
	m_wndGoiLuuTruLabel.Create(this, _T("GoiLuuTru"), 8, 189, 138, 214);
	m_wndGoiDichVuLabel.Create(this, _T("GoiDichVu"), 162, 189, 292, 214);
	m_wndAllLabel.Create(this, _T("GoiLuuTru_DichVu"), 316, 189, 474, 214);
	m_wndCreateData.EnableWindow(FALSE);
}
void CFMServicePaidSummaryByDeptEX::OnInitializeComponents(){
...
void CFMServicePaidSummaryByDeptEX::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
//	m_wndList.AddEvent(1, _T("Delete"), _OnListDeleteItemFnc, 0, VK_DELETE, 0);
	...
	m_wndGoiLuuTruLabel.SetEvent(WE_CLICK, _OnGoiLuuTruLabelSelectFnc);
	m_wndGoiDichVuLabel.SetEvent(WE_CLICK, _OnGoiDichVuLabelSelectFnc);
	m_wndAllLabel.SetEvent(WE_CLICK, _OnAllLabelSelectFnc);


	m_wndServiceZone.SetEvent(WE_CLICK, _OnServiceZoneSelectFnc);	
	m_wndInsuranceZone.SetEvent(WE_CLICK, _OnInsuranceZoneSelectFnc);
...
void CFMServicePaidSummaryByDeptEX::OnDoDataExchange(CDataExchange* pDX){
	...
	*/
	DDX_Check(pDX, m_wndServiceZone.GetDlgCtrlID(), m_bServiceZone);
	DDX_Check(pDX, m_wndAllZone.GetDlgCtrlID(), m_bAllZone);
	DDX_Check(pDX, m_wndInsuranceZone.GetDlgCtrlID(), m_bInsuranceZone);

	DDX_Radio(pDX, m_wndGoiLuuTruLabel.GetDlgCtrlID(), m_nGoiLuuTruLabel);
	DDX_Radio(pDX, m_wndGoiDichVuLabel.GetDlgCtrlID(), m_nGoiDichVuLabel);
	DDX_Radio(pDX, m_wndAllLabel.GetDlgCtrlID(), m_nAllLabel);

}
void CFMServicePaidSummaryByDeptEX::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMServicePaidSummaryByDeptEX::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMServicePaidSummaryByDeptEX::SetDefaultValues(){
	...
	m_bServiceZone=FALSE;	
	m_bInsuranceZone=FALSE;
...
int CFMServicePaidSummaryByDeptEX::SetMode(int nMode){
...
/*void CFMServicePaidSummaryByDeptEX::OnYearChange(){
	
} */
/*void CFMServicePaidSummaryByDeptEX::OnYearSetfocus(){
	
} */
/*void CFMServicePaidSummaryByDeptEX::OnYearKillfocus(){
	
} */
int CFMServicePaidSummaryByDeptEX::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMServicePaidSummaryByDeptEX::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMServicePaidSummaryByDeptEX::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMServicePaidSummaryByDeptEX::OnReportPeriodSetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDeptEX::OnReportPeriodKillfocus(){
	
}*/

void CFMServicePaidSummaryByDeptEX::OnGoiLuuTruLabelSelect(){
	
}
void CFMServicePaidSummaryByDeptEX::OnGoiDichVuLabelSelect(){
	
}
void CFMServicePaidSummaryByDeptEX::OnAllLabelSelect(){
	
}
long CFMServicePaidSummaryByDeptEX::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMServicePaidSummaryByDeptEX::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMServicePaidSummaryByDeptEX::OnFromDateChange(){
	
} */
/*void CFMServicePaidSummaryByDeptEX::OnFromDateSetfocus(){
	
} */
/*void CFMServicePaidSummaryByDeptEX::OnFromDateKillfocus(){
	
} */
int CFMServicePaidSummaryByDeptEX::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMServicePaidSummaryByDeptEX::OnToDateChange(){
	
} */
/*void CFMServicePaidSummaryByDeptEX::OnToDateSetfocus(){
	
} */
/*void CFMServicePaidSummaryByDeptEX::OnToDateKillfocus(){
	
} */
int CFMServicePaidSummaryByDeptEX::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
void CFMServicePaidSummaryByDeptEX::OnATMSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
	
}
	void CFMServicePaidSummaryByDeptEX::OnAllZoneSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
	void CFMServicePaidSummaryByDeptEX::OnABZoneSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
...
void CFMServicePaidSummaryByDeptEX::OnServiceZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
	
}
	void CFMServicePaidSummaryByDeptEX::OnInsuranceZoneSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
...
void CFMServicePaidSummaryByDeptEX::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMServicePaidSummaryByDeptEX::OnClerkSelendok(){
	 
}
int CFMServicePaidSummaryByDeptEX::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMServicePaidSummaryByDeptEX::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMServicePaidSummaryByDeptEX::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMServicePaidSummaryByDeptEX::OnSODSelect()
{
	OnListLoadData();
}
void CFMServicePaidSummaryByDeptEX::OnCreateDataSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
int CFMServicePaidSummaryByDeptEX::OnDeleteDataBeforeInsert()
{
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL; 	
...
/*void CFMServicePaidSummaryByDeptEX::OnClerkSetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDeptEX::OnClerkKillfocus(){
	
}*/
long CFMServicePaidSummaryByDeptEX::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMServicePaidSummaryByDeptEX::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMServicePaidSummaryByDeptEX::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMServicePaidSummaryByDeptEX::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMServicePaidSummaryByDeptEX::OnStatusSetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDeptEX::OnStatusKillfocus(){
	
}*/
long CFMServicePaidSummaryByDeptEX::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMServicePaidSummaryByDeptEX::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMServicePaidSummaryByDeptEX::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMServicePaidSummaryByDeptEX::OnOrderBySelendok(){
	 
}
/*void CFMServicePaidSummaryByDeptEX::OnOrderBySetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDeptEX::OnOrderByKillfocus(){
	
}*/
long CFMServicePaidSummaryByDeptEX::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMServicePaidSummaryByDeptEX::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMServicePaidSummaryByDeptEX::OnDeptLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMServicePaidSummaryByDeptEX::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMServicePaidSummaryByDeptEX::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMServicePaidSummaryByDeptEX::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMServicePaidSummaryByDeptEX::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMServicePaidSummaryByDeptEX::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData();
	CRecord rs(&pMF->m_db);
	...
	else if (m_bInsuranceZone)

		szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('BH-NT','BH-NG','BHQUAN-NT', 'BHQUAN-NG','THE-BH', 'CK-BH')"));

	else if (m_bAllZone)

		szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('DV-AB', 'DV', 'THE-DV', 'CK-DV','BH-NT','BH-NG','BHQUAN-NT', 'BHQUAN-NG','THE-BH', 'CK-BH','QUAN-NT', 'QUAN-NG')"));
	else		
		szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('DV-AB', 'DV', 'THE-DV', 'CK-DV','BH-NT','BH-NG','BHQUAN-NT', 'BHQUAN-NG','THE-BH', 'CK-BH')"));
...
void CFMServicePaidSummaryByDeptEX::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMServicePaidSummaryByDeptEX::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMServicePaidSummaryByDeptEX::OnInpatientSelect(){
	
}
void CFMServicePaidSummaryByDeptEX::OnOutpatientSelect(){
	
}
void CFMServicePaidSummaryByDeptEX::OnDepositSelect(){
	
}
void CFMServicePaidSummaryByDeptEX::OnAllSelect(){
	
}
 
 
int CFMServicePaidSummaryByDeptEX::OnAddFMInsuranceReceiptSummary(){
...
int CFMServicePaidSummaryByDeptEX::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMServicePaidSummaryByDeptEX::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMServicePaidSummaryByDeptEX::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMServicePaidSummaryByDeptEX::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMServicePaidSummaryByDeptEX::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMServicePaidSummaryByDeptEX::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMServicePaidSummaryByDeptEX::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMServicePaidSummaryByDeptEX::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMServicePaidSummaryByDeptEX"));
...
void CFMServicePaidSummaryByDeptEX::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
...
void CFMServicePaidSummaryByDeptEX::OnExport(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMServicePaidSummaryByDeptEX::OnExport2(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
void CFMServicePaidSummaryByDeptEX::OnExport3()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDeptEX::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
//18.Phi thuoc trong goi, dung cho truong hop thu phi PTTT truoc sau do moi nhap thuoc trong goi o phong kham//
 szSQL20.Format(_T("     UNION ALL     ") \
				...
				_T("     ON (hpo_orderid = f.hfe_orderid)") \
				_T("     LEFT JOIN hms_operation ON (HPO_REFITEM_ID=ho_itemid AND HPO_REFERENCE_ID=ho_idx)") \
				_T("     LEFT JOIN HMS_FEE_INVOICE_VIEW_SERVICE_X iv ON (ho_docno = iv.hfe_docno AND ho_INVOICENO = iv.hfe_invoiceno)") \
				_T("     WHERE 1              =1 AND NVL(ho_deptid,NULL)<>'N' %s") \
...
CString CFMServicePaidSummaryByDeptEX::GetQueryString_v2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2, szWhere3,szWhere4;
...
rs.ExecSQL(szSQL);
   ...
   szSQL.Format(_T(" WITH tbl AS (%s)") \
				...
				_T(" ORDER BY dept_id, posted_date"),m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4, szWhere1);

	return szSQL;
}

CString CFMServicePaidSummaryByDeptEX::GetQueryString2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
...
CString CFMServicePaidSummaryByDeptEX::GetQueryString3()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szSQL21,szSQL22,szSQL23,szSQL24, szOrderBy, szReceiptStr;
...
int CFMServicePaidSummaryByDeptEX::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMServicePaidSummaryByDeptEX::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
void CFMServicePaidSummaryByDeptEX::OnExport4()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDeptEX::GetQueryString4()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szSQL21,szSQL22,szSQL23,szSQL24, szOrderBy, szReceiptStr;
...
CString CFMServicePaidSummaryByDeptEX::GetQueryString2_v2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2, szWhere3, szWhere4;
	CString szOrderBy, szReceiptStr, szSQL21,szSQL22, szSQL23, szSQL24, szSQL25;
	CRecord rs(&pMF->m_db);
	int nCount = 0;
...
rs.ExecSQL(szSQL);
   ...
   szSQL.Format(_T(" WITH tbl AS (%s)") \
				...
				_T(" dept_id") \
				_T(" HAVING SUM(TIEN_GOI + TIEN_VTHC + TIENAN_HC + TIENAN_NN)>0") \
				_T(" ORDER BY dept_id"),m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4,szWhere1);
		return szSQL;
}