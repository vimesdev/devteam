#include "stdafx.h"
#include "FMProcessedPatientListEX.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMProcessedPatientListEX *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMProcessedPatientListEX *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMProcessedPatientListEX* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMProcessedPatientListEX *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX *)pWnd)->OnClerkAddNew();
}*/
static void _OnServiceSelectFnc(CWnd *pWnd){
	 ((CFMProcessedPatientListEX*)pWnd)->OnServiceSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	 ((CFMProcessedPatientListEX*)pWnd)->OnInsuranceSelect();
}
static void _OnPaidSelectFnc(CWnd *pWnd){
	 ((CFMProcessedPatientListEX*)pWnd)->OnPaidSelect();
}
static void _OnUnpaidSelectFnc(CWnd *pWnd){
	 ((CFMProcessedPatientListEX*)pWnd)->OnUnpaidSelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMProcessedPatientListEX *pVw = (CFMProcessedPatientListEX *)pWnd;
...
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CFMProcessedPatientListEX*)pWnd)->OnDepartmentLoadData();
} 
static void _OnDepartmentDblClickFnc(CWnd *pWnd){
	((CFMProcessedPatientListEX*)pWnd)->OnDepartmentDblClick();
} 
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMProcessedPatientListEX*)pWnd)->OnDepartmentSelectChange(nOldItem, nNewItem);
} 
static int _OnDepartmentDeleteItemFnc(CWnd *pWnd){
	 return ((CFMProcessedPatientListEX*)pWnd)->OnDepartmentDeleteItem();
}
static long _OnStocklistLoadDataFnc(CWnd *pWnd)
{
	return ((CFMProcessedPatientListEX*)pWnd)->OnStocklistLoadData();
}
static void _OnDiffCostSelectFnc(CWnd *pWnd)
{
	 ((CFMProcessedPatientListEX*)pWnd)->OnDiffCostSelect();
}

CFMProcessedPatientListEX::CFMProcessedPatientListEX(CWnd *pParent)
{
...
CFMProcessedPatientListEX::~CFMProcessedPatientListEX(){
}
void CFMProcessedPatientListEX::OnCreateComponents(){
	...
	m_wndPreviewGeneralSheet.Create(this, _T("Preview General Sheet"), 225, 550, 375, 575);
	m_wndPrintPreview.Create(this, _T("&Print Preview"), 380, 550, 490, 575);
	m_wndDepartment.Create(this,5, 351, 490, 545); 
	m_wndStocklist.Create(this,5, 156, 490, 346); 
	m_wndDiffCost.Create(this, _T("DiffCost Label"), 5, 550, 120, 575);
	m_wndDepartment.SetCheckBox(true);
	m_wndStocklist.SetCheckBox(true);
}
void CFMProcessedPatientListEX::OnInitializeComponents(){
	...
	m_wndStocklist.InsertColumn(1, _T("Name"), CFMT_TEXT, 450);
	
}

void CFMProcessedPatientListEX::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMProcessedPatientListEX::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndDiffCost.GetDlgCtrlID(), m_bDiffCost);

}
void CFMProcessedPatientListEX::SetDefaultValues(){
...
int CFMProcessedPatientListEX::SetMode(int nMode){
...
/*void CFMProcessedPatientListEX::OnFromDateChange(){
	
} */
/*void CFMProcessedPatientListEX::OnFromDateSetfocus(){
	
} */
/*void CFMProcessedPatientListEX::OnFromDateKillfocus(){
	
} */
int CFMProcessedPatientListEX::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMProcessedPatientListEX::OnToDateChange(){
	
} */
/*void CFMProcessedPatientListEX::OnToDateSetfocus(){
	
} */
/*void CFMProcessedPatientListEX::OnToDateKillfocus(){
	
} */
int CFMProcessedPatientListEX::OnToDateCheckValue(){
	return 0;
}
 
void CFMProcessedPatientListEX::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMProcessedPatientListEX::OnClerkSelendok(){
	 
}

/*void CFMProcessedPatientListEX::OnClerkSetfocus(){
	
}*/
/*void CFMProcessedPatientListEX::OnClerkKillfocus(){
	
}*/
long CFMProcessedPatientListEX::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMProcessedPatientListEX::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
long CFMProcessedPatientListEX::OnStocklistLoadData()
{
    CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	int nCount = 0;
	szSQL.Format(_T("SELECT msl_storage_id as id, msl_name as name FROM m_storagelist WHERE msl_type='A' AND msl_isactive='Y' %s ORDER BY msl_storage_id"), szWhere);
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF()){ 
	...
	void CFMProcessedPatientListEX::OnDiffCostSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMProcessedPatientListEX::OnPrintPreviewSelect()
{
	return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
void CFMProcessedPatientListEX::OnPreviewGeneralSheet()
{
	/*CGuiMenu menu(this);
	CString tmpStr;
	CRect rect;
...
void CFMProcessedPatientListEX::OnPrintGeneralSheet()
{
	return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
void CFMProcessedPatientListEX::OnExportGeneralSheet()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	arrCol.Add(_T("Tiền VT điều trị"));
	arrCol.Add(_T("Tiền thuốc diều trị"));
	arrCol.Add(_T("Tiền VT phòng mổ"));
	arrCol.Add(_T("Tiền thuốc PM"));
	arrCol.Add(_T("Tiền VT_KTC"));
	arrCol.Add(_T("Tổng thanh toán"));
	arrCol.Add(_T("Tổng nợ"));
	...
	while (!rs.IsEOF())
	{
		...
		rs.GetValue(_T("phivattudt"), nTmp);
		nGrpCost[0] += nTmp;
		xls.SetCellText(5, nRow, double2str(nTmp), FMT_NUMBER1);
		rs.GetValue(_T("phithuocdt"), nTmp);
		nGrpCost[1] += nTmp;
		xls.SetCellText(6, nRow, double2str(nTmp), FMT_NUMBER1);
		rs.GetValue(_T("phivattupm"), nTmp);
		nGrpCost[2] += nTmp;
		xls.SetCellText(7, nRow, double2str(nTmp), FMT_NUMBER1);
		rs.GetValue(_T("phithuocpm"), nTmp);
		nGrpCost[3] += nTmp;
		xls.SetCellText(8, nRow, double2str(nTmp), FMT_NUMBER1);
		rs.GetValue(_T("phivattuktc"), nTmp);
		nGrpCost[4] += nTmp;
		xls.SetCellText(9, nRow, double2str(nTmp), FMT_NUMBER1);
		rs.GetValue(_T("tongthanhtoan"), nTmp);
		nGrpCost[5] += nTmp;
		xls.SetCellText(10, nRow, double2str(nTmp), FMT_NUMBER1);
		rs.GetValue(_T("tongno"), nTmp);
		nGrpCost[6] += nTmp;
		xls.SetCellText(11, nRow, double2str(nTmp), FMT_NUMBER1);
		xls.SetCellText(12, nRow, rs.GetValue(_T("ObjectName")), FMT_TEXT);
		xls.SetCellText(13, nRow, rs.GetValue(_T("ngayvaovien")), FMT_TEXT);
		xls.SetCellText(14, nRow, rs.GetValue(_T("ngayravien")), FMT_TEXT);
		nRow++;
		rs.MoveNext();
	}
	if ((nGrpCost[5] + nGrpCost[6]) > 0)
	...
	xls.Save(_T("Exports\\Bang quyet toan thuoc vat tu doi tuong BH.xls"));
}

void CFMProcessedPatientListEX::OnDepartmentDblClick()
{
	
} 
void CFMProcessedPatientListEX::OnDepartmentSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMProcessedPatientListEX::OnDepartmentDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMProcessedPatientListEX::OnDepartmentLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMProcessedPatientListEX::OnServiceSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (m_bService && m_bInsurance)
		m_wndInsurance.SetCheck(false);
}
void CFMProcessedPatientListEX::OnInsuranceSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (m_bInsurance && m_bService)
		m_wndService.SetCheck(false);
}
void CFMProcessedPatientListEX::OnPaidSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (m_bPaid && m_bUnpaid)
		m_wndUnpaid.SetCheck(false);
}
void CFMProcessedPatientListEX::OnUnpaidSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
CString CFMProcessedPatientListEX::GetQueryString(){
	...
	szSQL.Format(_T("SELECT tit, pname, ") \
				...
				_T("			   hpo_deptid					  dept,") \
				_T("               CASE ") \
				_T("                 WHEN product_org_id = 'PM' THEN hpol_qtyorder * product_saleprice1 ") \
				_T("                 ELSE 0 ") \
				_T("               END                            AS drugamt, ") \
				_T("               CASE ") \
				_T("                 WHEN product_org_id = 'MA' THEN hpol_qtyorder * product_saleprice1 ") \
				_T("                 ELSE 0 ") \
				_T("               END                            AS materialamt, ") \
				_T("               hpol_qtyorder * product_saleprice1 AS amount ") \
...
CString CFMProcessedPatientListEX::GetQueryString1()
{
	CString szSQL, szPharmaWhere, szPharmaWhere1, szTransactionWhere, tmpStr, szWhere;
	szPharmaWhere.Format(_T(" AND hpo_processeddate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);
	...
	szSQL.Format(_T("SELECT tit, docno, ") \
				...
				_T("           CASE WHEN product_org_id = 'PM' THEN hpol_qtyorder * product_saleprice1 ") \
				_T("           ELSE 0 ") \
				_T("           END          AS surgerydrugamt, ") \
				_T("           CASE WHEN product_org_id = 'MA' THEN hpol_qtyorder * product_saleprice1 ") \
				_T("           ELSE 0 ") \
				...
				_T(" WHERE hpo_ordertype IN ('D', 'M', 'C') AND (msl_category = 'S' OR msl_storage_id = 19)") \
				...
				_T("         CASE ") \
				_T("         WHEN product_org_id = 'PM' AND coalesce(hpo_reference_id, 0) = 0 THEN hpol_qtyreverse * product_saleprice1 ") \
				_T("         ELSE 0 ") \
				_T("         END AS treatdrugamt, ") \
				_T("         CASE ") \
				_T("         WHEN product_org_id = 'MA' AND coalesce(hpo_reference_id, 0) = 0 THEN hpol_qtyreverse * product_saleprice1 ") \
				_T("         ELSE 0 ") \
				_T("         END AS treatmaterialamt, ") \
				_T("         CASE ") \
				_T("         WHEN product_org_id = 'PM' AND hpo_reference_id > 0 THEN hpol_qtyreverse * product_saleprice1 ") \
				_T("         ELSE 0 ") \
				_T("         END AS surgerydrugamt, ") \
				_T("         CASE ") \
				_T("         WHEN product_org_id = 'MA' AND hpo_reference_id > 0 THEN hpol_qtyreverse * product_saleprice1 ") \
				_T("         ELSE 0 ") \
				_T("         END AS surgerymaterialamt, ") \
				_T("		 0,") \
				_T("		 0,") \
...
CString CFMProcessedPatientListEX::GetQueryString2()
{		
	CString szWhere, tmpStr, tmpStr1, szSQL;
	...
	for (int i = 0; i < m_wndStocklist.GetItemCount(); i++)
	{
		if (m_wndStocklist.GetCheck(i))
		{
			if (!tmpStr.IsEmpty())
				tmpStr += _T(", ");
			tmpStr.AppendFormat(_T("'%s'"), m_wndStocklist.GetItemText(i, 0));
		}
	}
	if(!tmpStr.IsEmpty())
	{
	
		szWhere.AppendFormat(_T("AND pv.hpo_storage_id IN (%s)"), tmpStr);
	}
	...
	for (int i = 0; i < m_wndDepartment.GetItemCount(); i++)
	{
		if (m_wndDepartment.GetCheck(i))
		{
			if (!tmpStr1.IsEmpty())
				tmpStr1 += _T(", ");
			tmpStr1.AppendFormat(_T("'%s'"), m_wndDepartment.GetItemText(i, 0));
		}
	}

	if (!tmpStr1.IsEmpty())
	{
		szWhere.AppendFormat(_T("AND fi.hfe_deptid IN (%s)"), tmpStr1);
	}

	if(m_bDiffCost)
		szWhere.AppendFormat(_T(" AND fe.hfe_diffcost>0"));
	...
	szSQL.Format(_T(" SELECT ") \
				...
				_T("     recordno, age, docno,tit, dept,") \
				_T("     SUM(phivattudt) AS phivattudt,") \
				_T("     SUM(phithuocdt) AS phithuocdt,") \
				_T("     0 as phivattupm,") \
				_T("     0 as phithuocpm,") \
				_T("     SUM(phivattuktc) as phivattuktc,") \
				_T("     SUM(phivattudt+phithuocdt+phivattuktc) as tongthanhtoan,") \
				_T("     0 as tongno, GET_OBJECTNAME(objectid) as ObjectName,") \
				_T("     ngaythu,") \
				_T("     CASE when classtype = 'E' THEN HD_ADMITDATE else ngayvao end as ngayvaovien,") \
				_T("     CASE when classtype = 'E' THEN HD_ENDDATE else ngayra end as ngayravien") \
				_T(" FROM") \
				_T(" (") \
				_T(" SELECT") \
				_T(" hcr_recordno AS recordno,") \
				_T(" Hms_getagebydoc(fe.hfe_docno) AS age,") \
				_T(" fe.hfe_docno AS docno,") \
				_T(" fi.hfe_patientno AS patientno,") \
				_T(" fi.hfe_objectid AS objectid,") \
				_T(" CASE WHEN fi.hfe_class='E' THEN 'BỆNH NHÂN NGOẠI TRÚ' ELSE 'BỆNH NHÂN NỘI TRÚ' END AS tit,") \
				_T(" fi.hfe_deptid as dept,") \
				_T(" fi.hfe_date as ngaythu,") \
				_T(" fi.HFE_ADMITDATE              AS ngayvao,") \
				_T(" fi.HFE_DISCHARGEDATE          AS ngayra,") \
				_T(" fi.hfe_class                  AS classtype,") \
				_T(" (CASE WHEN fe.hfe_group IN('A1500', 'A1600', 'A3000' , 'A4000', 'A5000', 'A5100', 'A7000' , 'A8000', 'A8100', 'A8200', 'A8300', 'A8400', 'A8500', 'A8600', 'A8700', 'A8800', 'A9000', 'A9001', 'A9002', 'A9003')") \
				_T(" AND fe.hfe_feegroup NOT IN ('OPT_L', 'OPT')") \
				_T(" THEN fe.hfe_patpaid ELSE 0 END) AS phivattudt,") \
				_T(" (CASE WHEN SUBSTR(fe.hfe_group,1,2) IN('A1','A6') AND fe.hfe_group NOT IN ('A1500', 'A1600') THEN fe.hfe_patpaid ELSE 0 END) AS phithuocdt,") \
				_T(" (CASE WHEN fe.hfe_group IN('A1500', 'A1600', 'A3000' , 'A4000', 'A5000', 'A5100', 'A7000' , 'A8000', 'A8100', 'A8200', 'A8300', 'A8400', 'A8500', 'A8600', 'A8700', 'A8800', 'A9000', 'A9001', 'A9002', 'A9003')") \
				_T(" AND fe.hfe_feegroup IN ('OPT_L', 'OPT')") \
				_T(" THEN fe.hfe_patpaid ELSE 0 END) AS phivattuktc") \
				_T(" from hms_fee fe") \
				_T(" LEFT JOIN hms_pharmaorder_view pv ON (fe.hfe_docno=pv.hpo_docno AND fe.hfe_orderid=pv.hpo_orderid)") \
				_T(" LEFT JOIN hms_fee_invoice fi ON (fe.hfe_docno=fi.hfe_docno AND fe.hfe_invoiceno=fi.hfe_invoiceno)") \
				_T(" LEFT JOIN hms_clinical_record ON (fi.hfe_docno=hcr_docno)") \
				_T(" where fe.hfe_category='N'") \
				_T(" AND fe.hfe_type in ('D', 'M')") \
				_T(" AND fi.hfe_status='P'") \
				_T(" %s") \
				_T(" )tbl") \
				_T(" LEFT JOIN hms_doc  ON(docno=hd_docno)") \
				_T(" LEFT JOIN hms_patient ON (patientno=hms_patient.hp_patientno)") \
				_T(" LEFT JOIN hms_object  ON(ho_id=objectid)") \
				_T(" WHERE 1=1") \
				_T(" AND ho_type IN ('I','C')") \
				_T(" GROUP BY hp_surname,hp_midname,hp_firstname,recordno, age, docno,ngaythu,classtype,ngayvao, ngayra, HD_ADMITDATE, HD_ENDDATE,  tit, dept,objectid") \
				_T(" HAVING SUM(phithuocdt+phivattudt+phivattuktc)           > 0") \
				_T(" ORDER BY tit, dept, ngaythu, docno"),szWhere);
	//_msg(_T("%s"), szSQL);
	return szSQL;
}