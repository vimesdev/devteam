#ifndef FMUNDISCHARGEDFOODSUMMARY_H
#define FMUNDISCHARGEDFOODSUMMARY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMUndischargedFoodSummary : public CGuiView
{
protected:
public:
	...
	CFMUndischargedFoodSummary(CWnd* pParent);
	~CFMUndischargedFoodSummary();
	...
	int OnAddFMFoodSummaryByDay(); 
	int OnEditFMFoodSummaryByDay(); 
	int OnDeleteFMFoodSummaryByDay(); 
	int OnSaveFMFoodSummaryByDay(); 
	int OnCancelFMFoodSummaryByDay(); 
	int OnFMFoodSummaryByDayListLoadData();
