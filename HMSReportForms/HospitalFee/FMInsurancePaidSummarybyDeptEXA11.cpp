#include "stdafx.h"
#include "FMInsurancePaidSummarybyDeptEXA11.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnYearKillfocus();
} */
static void _OnCreateDataSelectFnc(CWnd *pWnd)
{
	CFMInsurancePaidSummaryByDeptEXA11 *pVw = (CFMInsurancePaidSummaryByDeptEXA11 *)pWnd;
	pVw->OnCreateDataSelect();
} 

static void _OnObjectTypeSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnObjectTypeSelendok();
}

static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEXA11* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnReportPeriodSelendok();
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListCheckAllRefund();
	return 0;
}

/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEXA11* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEXA11* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEXA11* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListDeleteItem();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnSODSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static void _OnSoldierWCardSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnSoldierWCardSelect();
}

static long _OnObjectTypeLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsurancePaidSummaryByDeptEXA11 *)pWnd)->OnObjectTypeLoadData();
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnABZoneSelect();
}
static void _OnTCKTSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnTCKTSelect();
}
static void _OnDang_dieu_triSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnDang_dieu_triSelect();
}
static void _OnDa_ra_vien_chua_ttSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnDa_ra_vien_chua_ttSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnPolicySelect();
}
static void _OnAllObjectSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEXA11*)pWnd)->OnAllObjectSelect();
}

CFMInsurancePaidSummaryByDeptEXA11::CFMInsurancePaidSummaryByDeptEXA11(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
...
CFMInsurancePaidSummaryByDeptEXA11::~CFMInsurancePaidSummaryByDeptEXA11()
{
}
void CFMInsurancePaidSummaryByDeptEXA11::OnCreateComponents()
{
	m_wndReportCondition.Create(this, _T("Report Condition"), 6, 5, 480, 503);
	...
	m_wndList.Create(this,10, 181, 476, 407); 
	m_wndDang_dieu_tri.Create(this, _T("Đang điều trị"), 12, 412, 227, 437);
	m_wndDa_ra_vien_chua_tt.Create(this, _T("Ra viện chưa thanh toán"), 231, 412, 476, 437);
	m_wndSoldierWCard.Create(this, _T("Soldier w Card"), 231, 442, 476, 467);
	m_wndSOD.Create(this, _T("SOD"), 12, 443, 227, 468);
	m_wndInsurance.Create(this, _T("Insurance"), 12, 473, 115, 498);
	m_wndService.Create(this, _T("Service"), 120, 473, 226, 498);
	m_wndPolicy.Create(this, _T("Quân_CS"), 231, 473, 340, 498);
	m_wndAllObject.Create(this, _T("Tất cả"), 346, 472, 476, 497);
	m_wndMarkAll.Create(this, _T("Mark All"), 5, 509, 85, 534);
	m_wndUnMark.Create(this, _T("UnMark"), 90, 509, 170, 534);
	m_wndPrint.Create(this, _T("&Print"), 230, 509, 310, 534);
	m_wndExport.Create(this, _T("Export XLS"), 315, 509, 395, 534);
	m_wndCreateData.Create(this, _T("Create Data"), 400, 509, 480, 534);
	m_wndCreateData.EnableWindow(FALSE);
	m_wndMarkAll.EnableWindow(FALSE);
	m_wndUnMark.EnableWindow(FALSE);
	m_wndPrint.EnableWindow(FALSE);
	m_wndObjectType.EnableWindow(FALSE);
	m_wndABZone.EnableWindow(FALSE);
	m_wndTCKT.EnableWindow(FALSE);
	m_wndSoldierWCard.EnableWindow(FALSE);
	m_wndSOD.EnableWindow(FALSE);
	m_wndDang_dieu_tri.EnableWindow(FALSE);
	m_wndDa_ra_vien_chua_tt.EnableWindow(FALSE);
}
void CFMInsurancePaidSummaryByDeptEXA11::OnInitializeComponents(){
...
void CFMInsurancePaidSummaryByDeptEXA11::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
//	m_wndList.AddEvent(1, _T("Delete"), _OnListDeleteItemFnc, 0, VK_DELETE, 0);
	...
	m_wndDang_dieu_tri.SetEvent(WE_CLICK, _OnDang_dieu_triSelectFnc);
	m_wndDa_ra_vien_chua_tt.SetEvent(WE_CLICK, _OnDa_ra_vien_chua_ttSelectFnc);
...
void CFMInsurancePaidSummaryByDeptEXA11::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndDang_dieu_tri.GetDlgCtrlID(), m_bDang_dieu_tri);
	DDX_Check(pDX, m_wndDa_ra_vien_chua_tt.GetDlgCtrlID(), m_bDa_ra_vien_chua_tt);
...
void CFMInsurancePaidSummaryByDeptEXA11::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePaidSummaryByDeptEXA11::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePaidSummaryByDeptEXA11::SetDefaultValues(){
	...
	m_bABZone=FALSE;
	m_bTCKT=FALSE;
	m_bDang_dieu_tri=TRUE;
	m_bDa_ra_vien_chua_tt=FALSE;
	m_nInsurance=0;
	m_nService=1;
	m_nPolicy=1;
	m_nAllObject=1;
...
int CFMInsurancePaidSummaryByDeptEXA11::SetMode(int nMode){
...
/*void CFMInsurancePaidSummaryByDeptEXA11::OnYearChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEXA11::OnYearSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEXA11::OnYearKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptEXA11::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePaidSummaryByDeptEXA11::OnDang_dieu_triSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	if  (m_bDang_dieu_tri)
	...
	void CFMInsurancePaidSummaryByDeptEXA11::OnDa_ra_vien_chua_ttSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	if  (m_bDa_ra_vien_chua_tt)
		{
		m_bDang_dieu_tri = false;
		}
	UpdateData(FALSE);
}
void CFMInsurancePaidSummaryByDeptEXA11::OnInsuranceSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnServiceSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnPolicySelect(){
	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnAllObjectSelect(){
	
}
 
void CFMInsurancePaidSummaryByDeptEXA11::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMInsurancePaidSummaryByDeptEXA11::OnTCKTSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnCreateDataSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDeptEXA11::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePaidSummaryByDeptEXA11::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEXA11::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEXA11::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePaidSummaryByDeptEXA11::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePaidSummaryByDeptEXA11::OnFromDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEXA11::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEXA11::OnFromDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptEXA11::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePaidSummaryByDeptEXA11::OnToDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEXA11::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEXA11::OnToDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptEXA11::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePaidSummaryByDeptEXA11::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

long CFMInsurancePaidSummaryByDeptEXA11::OnObjectTypeLoadData()
{
	//m_wndObjectType.AddItems(_T("01"), _T("\x44\x1ECB\x63h v\x1EE5"), NULL);
	//m_wndObjectType.AddItems(_T("02"), _T("Bảo hiểm"), NULL);
	
	m_wndObjectType.AddItems(_T("BH"), _T("Đối tượng Bảo hiểm"), NULL);
	m_wndObjectType.AddItems(_T("DV"), _T("Đối tượng dịch vụ"), NULL);
	m_wndObjectType.AddItems(_T("QUAN"), _T("Đối tượng quân - chính sách"), NULL);
...
void CFMInsurancePaidSummaryByDeptEXA11::OnObjectTypeSelendok()
{
	OnListLoadData();
}
void CFMInsurancePaidSummaryByDeptEXA11::OnABZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
...
void CFMInsurancePaidSummaryByDeptEXA11::OnSoldierWCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMInsurancePaidSummaryByDeptEXA11::OnClerkSelendok(){
	 
}
int CFMInsurancePaidSummaryByDeptEXA11::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMInsurancePaidSummaryByDeptEXA11::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMInsurancePaidSummaryByDeptEXA11::OnSODSelect(){
	OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDeptEXA11::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEXA11::OnClerkKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEXA11::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePaidSummaryByDeptEXA11::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDeptEXA11::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDeptEXA11::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDeptEXA11::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEXA11::OnStatusKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEXA11::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummaryByDeptEXA11::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDeptEXA11::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDeptEXA11::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePaidSummaryByDeptEXA11::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEXA11::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEXA11::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
...
/*void CFMInsurancePaidSummaryByDeptEXA11::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMInsurancePaidSummaryByDeptEXA11::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePaidSummaryByDeptEXA11::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsurancePaidSummaryByDeptEXA11::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePaidSummaryByDeptEXA11::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsurancePaidSummaryByDeptEXA11::OnListLoadData()
{
	return 0;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	...
	/*else if (m_szObjectTypeKey == _T("BH-NT+BH-NG"))		
		...
		szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('BH-NT','BH-NG','BHQUAN-NT', 'BHQUAN-NG','THE-BH', 'CK-BH')"));
	else 
		//szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('BH-NT','BH-NG','BHQUAN-NT', 'BHQUAN-NG','QUAN-NT', 'QUAN-NG','THE-BH', 'CK-BH')"));
		szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('BH-NT','BH-NG','BHQUAN-NT', 'BHQUAN-NG','THE-BH', 'CK-BH', 'BH-NGAB','BH-NTAB')"));
...
void CFMInsurancePaidSummaryByDeptEXA11::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMInsurancePaidSummaryByDeptEXA11::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMInsurancePaidSummaryByDeptEXA11::OnInpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnOutpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnDepositSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEXA11::OnAllSelect(){
	
}
 
 
int CFMInsurancePaidSummaryByDeptEXA11::OnAddFMInsuranceReceiptSummary(){
...
int CFMInsurancePaidSummaryByDeptEXA11::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePaidSummaryByDeptEXA11::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsurancePaidSummaryByDeptEXA11::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsurancePaidSummaryByDeptEXA11::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePaidSummaryByDeptEXA11::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsurancePaidSummaryByDeptEXA11::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummaryByDeptEXA11::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDeptEXA11::OnPrint2ndver()
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMInsurancePaidSummaryByDeptEXA11"));
...
void CFMInsurancePaidSummaryByDeptEXA11::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	CGuiMenu menu(this);
	...
	TranslateString(_T("Export thuốc BN sử dụng tại A11"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 1, tmpStr);

	TranslateString(_T("Export thuốc BN sử dụng tại A11 (Theo số HS)"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 2, tmpStr);
	...
	switch (nPos)
	{
			...
			break;
			case 2:
			OnExportPatientListEX();
			break;
	}
}
void CFMInsurancePaidSummaryByDeptEXA11::OnExportPatientList()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\THONGKE_THUOC_SUDUNG_TAIA11.xls"))) AfxMessageBox(_T("Chưa có file này trong thư mục Exports"));

	xls.SetWorksheet(0);
	xls.SetCellText(0, 0, pMF->m_szHealthService, FMT_TEXT | FMT_CENTER, true, 10);
	xls.SetCellText(0, 1, pMF->m_szHospitalName, FMT_TEXT | FMT_CENTER, true, 10);	

	szSQL = GetQueryString_v2_1();
	rs.ExecSQL(szSQL);
	//_msg(_T("%s"),szSQL);
	...
	xls.Save(_T("Exports\\THONGKE_THUOC_SUDUNG_TAIA112.xls"));
}

void CFMInsurancePaidSummaryByDeptEXA11::OnExportDetailSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\Template\\TONGHOP_CHIPHI_BENHNHANTON_THEOKHOA_CHITIET.xls"))) AfxMessageBox(_T("Chưa có Files trong thư mục Exports\\Template"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOP_CHIPHI_BENHNHANTON_THEOKHOA_CHITIET.xls"));
}

void CFMInsurancePaidSummaryByDeptEXA11::OnExportTotalList(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\Template\\TONGHOP_CHIPHI_BENHNHANTON_THEOKHOA_TH.xls"))) AfxMessageBox(_T("Chưa có Files Excel ở đường dẫn Exports\\Template\\TONGHOP_CHIPHI_BENHNHANTON_THEOKHOA_TH.xls"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\Template\\TONGHOP_CHIPHI_BENHNHANTON_THEOKHOA_TH2.xls"));
}
void CFMInsurancePaidSummaryByDeptEXA11::OnExportTotalList1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString()
{
...
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString2()
{
...
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString_check()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
		int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptEXA11::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptEXA11::OnDeleteDataBeforeInsert()
{
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL; 	
...
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString3()
{
...
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString_v2()
{
	...
	if (m_bDang_dieu_tri)
	{
		szWhere1.AppendFormat(_T(" AND hcr_status = 'I'"));	
	}

	if (m_bDa_ra_vien_chua_tt)
	{
		szWhere1.AppendFormat(_T(" AND hcr_status = 'T' and HCRF_ACCEPTEDFEE <> 'P' AND HCR_DISCHARGEDATE between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);	
	}

	if(m_nInsurance == 0)
	{
		szWhere1.AppendFormat(_T(" AND ho_type in ('I', 'C') "));
	}
	else if(m_nService == 0)
	{
		szWhere1.AppendFormat(_T(" AND ho_type in ('S') "));
	}
	else if (m_nPolicy == 0) 
		szWhere1.AppendFormat(_T(" AND ho_type in ('D', 'P') "));
	else
		szWhere1.AppendFormat(_T(" AND ho_type in ('I', 'C','S','D', 'P') "));
  ...
  szSQL8.Format(_T("     UNION ALL     ") \
				...
				_T("     ON (hpo_orderid = f.hfe_orderid AND f.hfe_docno = hpo_docno)") \
				_T("     WHERE 1              =1 ") \
				_T("     AND f.hfe_status    IN ('O', 'A') AND HPO_STORAGE_ID=14") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
				_T("     AND product_org_id NOT IN ('MA','BB')") \
				_T("     AND f.hfe_category  NOT IN ('Y')"));
  ...
  szSQL10.Format(_T("     UNION ALL") \
				...
				_T("     ON (hpo_orderid = f.hfe_orderid AND f.hfe_docno = hpo_docno)") \
				_T("     WHERE 1              =1 ") \
				_T("     AND f.hfe_status    IN ('O', 'A') AND HPO_STORAGE_ID=15") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
				_T("     AND product_org_id NOT IN ('PM','BB')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
...
szSQL24.Format(_T("     UNION ALL") \
	...
	_T(" FROM") \
	_T(" (") \
	_T(" SELECT Get_patientname(hd_docno) AS HO_TEN,") \
	...
	_T(" ORDER BY dept_id"),szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20,szSQL21, szSQL22,szSQL23,szSQL24, szSQL25 ,szWhere1, szWhere);	
	return szSQL;
}

CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString_check_v2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19, szSQL20,szSQL21,szSQL22,szSQL23,szSQL24,szSQL25, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
...
szSQL24.Format(_T("     UNION ALL") \
	...
	_T(" GROUP BY ") \
	_T(" docno,HO_TEN") \
	_T(" HAVING SUM(TIEN_KHAM+TIEN_GIUONG+TIEN_CLS+TIEN_PTTT+TIEN_THUOC_CH_NGOAITRU+TIEN_THUOC_CH_NOITRU+TIEN_VAT_TU_CH_NGOAITRU+TIEN_VAT_TU_CH_NOITRU+TIEN_THUOC_PM+TIEN_VAT_TU_PM+TIEN_MAU+THU_KHAC+THU_GOI)>0") \
	_T(" ORDER BY docno"),
...
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString_v3()
{
	...
	if (m_bDa_ra_vien_chua_tt)
	{
		szWhere1.AppendFormat(_T(" AND hcr_status = 'T' and NVL(HCRF_ACCEPTEDFEE,'X') <> 'P' AND HCR_DISCHARGEDATE between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);	
	}
...
void CFMInsurancePaidSummaryByDeptEXA11::OnExportBriefSelect()
{
...
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString_v2_1()
{
	...
	szWhere1.AppendFormat(_T(" fi.hfe_date between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);	
	...
	_T(" dongia_vienphi,") \
	_T(" SUM(thanhtien_vienphi) as tongtien_vienphi,") \
	_T(" dongia_duoc,") \
	_T(" SUM(thanhtien_duoc) as tongtien_duoc") \
	_T(" FROM") \
	_T(" (") \
	_T(" SELECT") \
	_T(" fe.hfe_desc as drugname,") \
	_T(" fe.hfe_unit as donvi,") \
	_T(" fe.HFE_QUANTITY as soluong,") \
	_T(" fe.HFE_UNITPRICE as dongia_vienphi,") \
	//_T(" case when ho_type='S' THEN fe.HFE_UNITPRICE else fe.hfe_insprice end as dongia_vienphi,") \//
	_T(" hpol_UNITPRICE as dongia_duoc,") \
	_T(" fe.HFE_QUANTITY * fe.HFE_UNITPRICE as thanhtien_vienphi,") \
	//_T(" case when ho_type='S' THEN fe.HFE_QUANTITY * fe.HFE_UNITPRICE *fe.hfe_payrate/100 else fe.HFE_QUANTITY * fe.hfe_insprice *fe.hfe_payrate/100 end as thanhtien_vienphi,") \//
	_T(" fe.HFE_QUANTITY * hpol_UNITPRICE as thanhtien_duoc") \
	_T(" FROM hms_fee fe") \
	...
	_T(" ON (fe.hfe_docno=hpol_docno AND fe.HFE_ORDERID=hpol_orderid AND fe.hfe_orderline=hpol_orderlineid)") \
	_T(" WHERE %s ") \
	_T(" AND fe.hfe_type in ('D', 'M')") \
	_T(" AND NVL(fe.HFE_CATEGORY,'XX') <> 'Y'") \
	_T(" AND fi.hfe_status='P'") \
	_T(" AND MPI_ORG_ID IN ('PM')") \
	/*_T(" --AND ho_type ='S'") \
	_T(" --AND fe.hfe_desc ='Ropegold 1500mg'") \
	_T(" --GROUP BY fe.hfe_desc, fe.HFE_QUANTITY, fe.HFE_UNITPRICE, fe.hfe_payrate, hpol_UNITPRICE,fe.hfe_unit") \*/
	_T(" )") \
	_T(" GROUP BY drugname,donvi, dongia_vienphi, dongia_duoc") \
	_T(" ORDER BY drugname"), szWhere1);
	return szSQL;
}
void CFMInsurancePaidSummaryByDeptEXA11::OnExportPatientListEX()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDay, szNewDay;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\THONGKE_THUOC_SUDUNG_TAIA11_DOCNO.xls"))) AfxMessageBox(_T("Chưa có file này trong thư mục Exports"));

	xls.SetWorksheet(0);
	xls.SetCellText(0, 0, pMF->m_szHealthService, FMT_TEXT | FMT_CENTER, true, 10);
	xls.SetCellText(0, 1, pMF->m_szHospitalName, FMT_TEXT | FMT_CENTER, true, 10);	

	szSQL = GetQueryString_v2_1_docno();
	rs.ExecSQL(szSQL);
	//_msg(_T("%s"),szSQL);
	...
	xls.Save(_T("Exports\\THONGKE_THUOC_SUDUNG_TAIA11_Docno2.xls"));
}
CString CFMInsurancePaidSummaryByDeptEXA11::GetQueryString_v2_1_docno()
{
	...
	_T(" --GROUP BY fe.hfe_desc, fe.HFE_QUANTITY, fe.HFE_UNITPRICE, fe.hfe_payrate, hpol_UNITPRICE,fe.hfe_unit") \*/
	_T(" )") \
	_T(" GROUP BY docno,drugname,donvi, dongia_vienphi, dongia_duoc") \
	_T(" ORDER BY drugname"), szWhere1);
	return szSQL;
}