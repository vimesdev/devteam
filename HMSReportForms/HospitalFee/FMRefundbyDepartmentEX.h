#ifndef FMREFUNDBYDEPARTMENTEX_H
#define FMREFUNDBYDEPARTMENTEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMRefundbyDepartmentEX : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect(); 
	CFMRefundbyDepartmentEX(CWnd *pParent);
	~CFMRefundbyDepartmentEX();
