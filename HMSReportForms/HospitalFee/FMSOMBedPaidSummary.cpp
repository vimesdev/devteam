#include "stdafx.h"
#include "FMSOMBedPaidSummary.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSOMBedPaidSummary* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSOMBedPaidSummary* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSOMBedPaidSummary* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSOMBedPaidSummary* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMSOMBedPaidSummary*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMSOMBedPaidSummary*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMSOMBedPaidSummary*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMSOMBedPaidSummary*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMSOMBedPaidSummary*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMSOMBedPaidSummary *pVw = (CFMSOMBedPaidSummary *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMSOMBedPaidSummary*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMSOMBedPaidSummary*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMSOMBedPaidSummary*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMSOMBedPaidSummary*)pWnd)->OnAllSelect();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMSOMBedPaidSummary*)pWnd)->OnSODSelect();
}
static int _OnAddFMSOMFoodPaidSummaryFnc(CWnd *pWnd){
	 return ((CFMSOMBedPaidSummary*)pWnd)->OnAddFMSOMFoodPaidSummary();
} 
static int _OnEditFMSOMFoodPaidSummaryFnc(CWnd *pWnd){
	 return ((CFMSOMBedPaidSummary*)pWnd)->OnEditFMSOMFoodPaidSummary();
} 
static int _OnDeleteFMSOMFoodPaidSummaryFnc(CWnd *pWnd){
	 return ((CFMSOMBedPaidSummary*)pWnd)->OnDeleteFMSOMFoodPaidSummary();
} 
static int _OnSaveFMSOMFoodPaidSummaryFnc(CWnd *pWnd){
	 return ((CFMSOMBedPaidSummary*)pWnd)->OnSaveFMSOMFoodPaidSummary();
} 
static int _OnCancelFMSOMFoodPaidSummaryFnc(CWnd *pWnd){
	 return ((CFMSOMBedPaidSummary*)pWnd)->OnCancelFMSOMFoodPaidSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMSOMBedPaidSummary*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMSOMBedPaidSummary*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}
static int _OnListCheckAllBHPTTYCFnc(CWnd *pWnd)
{
	((CFMSOMBedPaidSummary*)pWnd)->OnListCheckAllBHPTTYC();
	return 0;
}
static int _OnListCheckAllDVPTTYCFnc(CWnd *pWnd)
{
	((CFMSOMBedPaidSummary*)pWnd)->OnListCheckAllDVPTTYC();
	return 0;
}
...
{
	((CFMSOMBedPaidSummary*)pWnd)->OnListCheckAllTYC();
	return 0;
}
CFMSOMBedPaidSummary::CFMSOMBedPaidSummary(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMSOMBedPaidSummary::~CFMSOMBedPaidSummary(){
}
void CFMSOMBedPaidSummary::OnCreateComponents()
{	
...
void CFMSOMBedPaidSummary::OnInitializeComponents(){
...
void CFMSOMBedPaidSummary::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMSOMBedPaidSummary::OnDoDataExchange(CDataExchange* pDX){
...
void CFMSOMBedPaidSummary::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMSOMBedPaidSummary::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMSOMBedPaidSummary::SetDefaultValues(){
...
int CFMSOMBedPaidSummary::SetMode(int nMode){
...
/*void CFMSOMBedPaidSummary::OnYearChange(){
	
} */
/*void CFMSOMBedPaidSummary::OnYearSetfocus(){
	
} */
/*void CFMSOMBedPaidSummary::OnYearKillfocus(){
	
} */
int CFMSOMBedPaidSummary::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMSOMBedPaidSummary::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMSOMBedPaidSummary::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMSOMBedPaidSummary::OnReportPeriodSetfocus(){
	
}*/
/*void CFMSOMBedPaidSummary::OnReportPeriodKillfocus(){
	
}*/
long CFMSOMBedPaidSummary::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMSOMBedPaidSummary::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMSOMBedPaidSummary::OnFromDateChange(){
	
} */
/*void CFMSOMBedPaidSummary::OnFromDateSetfocus(){
	
} */
/*void CFMSOMBedPaidSummary::OnFromDateKillfocus(){
	
} */
int CFMSOMBedPaidSummary::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMSOMBedPaidSummary::OnToDateChange(){
	
} */
/*void CFMSOMBedPaidSummary::OnToDateSetfocus(){
	
} */
/*void CFMSOMBedPaidSummary::OnToDateKillfocus(){
	
} */
int CFMSOMBedPaidSummary::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMSOMBedPaidSummary::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSOMBedPaidSummary::OnClerkSelendok(){
	 
}
int CFMSOMBedPaidSummary::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMSOMBedPaidSummary::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMSOMBedPaidSummary::OnListCheckAllDVPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMSOMBedPaidSummary::OnListCheckAllBHPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMSOMBedPaidSummary::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}

/*void CFMSOMBedPaidSummary::OnClerkSetfocus(){
	
}*/
/*void CFMSOMBedPaidSummary::OnClerkKillfocus(){
	
}*/
long CFMSOMBedPaidSummary::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMSOMBedPaidSummary::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSOMBedPaidSummary::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSOMBedPaidSummary::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMSOMBedPaidSummary::OnStatusSetfocus(){
	
}*/
/*void CFMSOMBedPaidSummary::OnStatusKillfocus(){
	
}*/
long CFMSOMBedPaidSummary::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMSOMBedPaidSummary::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSOMBedPaidSummary::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSOMBedPaidSummary::OnOrderBySelendok(){
	 
}
/*void CFMSOMBedPaidSummary::OnOrderBySetfocus(){
	
}*/
/*void CFMSOMBedPaidSummary::OnOrderByKillfocus(){
	
}*/
long CFMSOMBedPaidSummary::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMSOMBedPaidSummary::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMSOMBedPaidSummary::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMSOMBedPaidSummary::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMSOMBedPaidSummary::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMSOMBedPaidSummary::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMSOMBedPaidSummary::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMSOMBedPaidSummary::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMSOMBedPaidSummary::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, TRUE);
	
} 
void CFMSOMBedPaidSummary::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, FALSE);
}

void CFMSOMBedPaidSummary::OnInpatientSelect(){
	
}
void CFMSOMBedPaidSummary::OnOutpatientSelect(){
	
}
void CFMSOMBedPaidSummary::OnDepositSelect(){
	
}
void CFMSOMBedPaidSummary::OnAllSelect(){
	
}
 
void CFMSOMBedPaidSummary::OnSODSelect(){
	OnListLoadData();
}
 
int CFMSOMBedPaidSummary::OnAddFMSOMFoodPaidSummary(){
...
int CFMSOMBedPaidSummary::OnEditFMSOMFoodPaidSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMSOMBedPaidSummary::OnDeleteFMSOMFoodPaidSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMSOMBedPaidSummary::OnSaveFMSOMFoodPaidSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMSOMBedPaidSummary::OnCancelFMSOMFoodPaidSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMSOMBedPaidSummary::OnFMSOMFoodPaidSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMSOMBedPaidSummary::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMSOMBedPaidSummary::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMSOMBedPaidSummary::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);	
	OnPrintDetail();		
}
void CFMSOMBedPaidSummary::OnPrintDetail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
void CFMSOMBedPaidSummary::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\Danhsach_tiengiuong_benhnhan_pttyc.xls"))) AfxMessageBox(_T("Chưa có file này trong thư mục Exports"));
	...
	while(!rs.IsEOF())
	{
		rs.GetValue(_T("ngay_giuong"), szNewDay);
...
void CFMSOMBedPaidSummary::OnPrint2ndver_(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
int CFMSOMBedPaidSummary::OnCheckBeforePrint(CReport* rpt, CRecord& rs){
	CString szSQL;
	szSQL = GetQueryString();
...
void CFMSOMBedPaidSummary::OnPrintOther(CReport* rpt){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMSOMBedPaidSummary::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	//return;
...
void CFMSOMBedPaidSummary::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept)
{
	//return;
	CString tmpStr, szLabel;
	rs->GetValue(_T("posted_date"), tmpStr);
...
void CFMSOMBedPaidSummary::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept, CReportSection* pDateGroup, CReportSection* pDeptGroup){
	//return;
...
void CFMSOMBedPaidSummary::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept){
	//return;
	CReportSection* rptGrp = NULL;
	CString szPos;
	if (bNewDept && m_nDeptSum[12] > 0)
...
void CFMSOMBedPaidSummary::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMSOMBedPaidSummary::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReportSection* rptGroup = NULL;
	CString tmpStr;
	if (bNewDate){
...
void CFMSOMBedPaidSummary::OnPrintDetail(CReport* rpt, CRecord* rs){
...
void CFMSOMBedPaidSummary::OnPrintDetail(CReport* rpt, CReportSection* ppDetail, CRecord* rs){
...
void CFMSOMBedPaidSummary::OnCalcData(CRecord* rs, bool& bNewDate, bool& bNewDept){
	double nTmp = 0;
	for (int i = 0; i < 18; i++){
...
void CFMSOMBedPaidSummary::ResetVar(){
	for (int i = 0; i < 18; i++){
		m_nTotal[i] = 0;
		m_nDeptSum[i] = 0;
		m_nDaySum[i] = 0;
...
CString CFMSOMBedPaidSummary::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT ngay_giuong, col_1, songay_noitru, dongia_noitru,") \
				_T(" thanhtien_noitru, songay_nn, dongia_nn, tien_nn") \
				_T(" FROM") \
				_T(" (") \
				_T(" SELECT trunc(i.HFE_POSTEDDATE) AS ngay_giuong,") \
				_T(" f.hfe_deptid AS khoa, '['||f.hfe_docno||'] '||get_patientname(f.hfe_docno) AS col_1, ") \
				_T(" SUM(CASE WHEN f.hfe_type = 'B' AND f.hfe_quantity>0 THEN f.hfe_quantity ELSE 0 END) AS songay_noitru,") \
				_T(" CASE WHEN f.hfe_type = 'B' AND f.hfe_unitprice>0 THEN f.hfe_unitprice ELSE 0 END AS dongia_noitru,") \
				_T(" SUM(CASE WHEN f.hfe_type ='B' THEN f.hfe_quantity*f.hfe_unitprice ELSE 0 END) AS thanhtien_noitru,") \
				_T(" SUM(CASE WHEN f.hfe_type = 'X' AND f.hfe_itemid in ('F0000069') AND f.hfe_unitprice=200000 THEN f.hfe_quantity ELSE 0 END) songay_nn,") \
				_T(" CASE WHEN f.hfe_type = 'X' AND f.hfe_unitprice>0 AND f.hfe_itemid in ('F0000069') AND f.hfe_unitprice=200000 THEN f.hfe_unitprice ELSE 0 END AS dongia_nn,") \
				_T(" SUM(CASE WHEN f.hfe_type = 'X' AND f.hfe_itemid in ('F0000069') AND f.hfe_unitprice=200000 THEN f.hfe_quantity*f.hfe_unitprice ELSE 0 END) tien_nn ") \
				_T(" FROM hms_fee f ") \
				_T(" LEFT JOIN HMS_FEE_INVOICE_VIEW_V2 i ") \
				_T(" ON (f.hfe_docno=i.hfe_docno AND f.hfe_invoiceno=i.hfe_invoiceno) ") \
				_T(" AND f.HFE_STATUS IN( 'P', 'R' ) ") \
				_T(" AND f.hfe_type in ('B','X') ") \
				_T(" AND NVL(f.hfe_category, 'N') NOT IN( 'Y', 'BQP', 'BBV') ") \
				_T(" WHERE  %s ") \
				_T(" AND f.hfe_deptid='PTTYC' ") \
				_T(" AND f.hfe_type in ('B','X')") \
				_T(" GROUP BY F.Hfe_Deptid, f.hfe_unitprice,f.hfe_type, f.hfe_itemid,trunc(i.HFE_POSTEDDATE), f.hfe_docno ") \
				_T(" ORDER BY trunc(i.HFE_POSTEDDATE),f.hfe_deptid") \
				_T(" )") \
				_T(" WHERE (thanhtien_noitru+tien_nn)>0"), szWhere);
	return szSQL;
}

double CFMSOMBedPaidSummary::OnRound(double nToRound){
	nToRound += 0.5;
