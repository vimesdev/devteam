#include "stdafx.h"
#include "FMInsurancePaidSummarybyDeptByDate.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptByDate* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnReportPeriodSelendok();
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListCheckAllRefund();
	return 0;
}

/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptByDate* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptByDate* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptByDate* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMInsurancePaidSummaryByDeptByDate *pVw = (CFMInsurancePaidSummaryByDeptByDate *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnSODSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static void _OnSoldierWCardSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummaryByDeptByDate*)pWnd)->OnSoldierWCardSelect();
}

static long _OnObjectTypeLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsurancePaidSummaryByDeptByDate *)pWnd)->OnObjectTypeLoadData();
}

CFMInsurancePaidSummaryByDeptByDate::CFMInsurancePaidSummaryByDeptByDate(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMInsurancePaidSummaryByDeptByDate::~CFMInsurancePaidSummaryByDeptByDate(){
}
void CFMInsurancePaidSummaryByDeptByDate::OnCreateComponents()
{
...
void CFMInsurancePaidSummaryByDeptByDate::OnInitializeComponents(){
...
void CFMInsurancePaidSummaryByDeptByDate::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummaryByDeptByDate::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsurancePaidSummaryByDeptByDate::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePaidSummaryByDeptByDate::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePaidSummaryByDeptByDate::SetDefaultValues(){
...
int CFMInsurancePaidSummaryByDeptByDate::SetMode(int nMode){
...
/*void CFMInsurancePaidSummaryByDeptByDate::OnYearChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptByDate::OnYearSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptByDate::OnYearKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptByDate::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePaidSummaryByDeptByDate::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMInsurancePaidSummaryByDeptByDate::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePaidSummaryByDeptByDate::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptByDate::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptByDate::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePaidSummaryByDeptByDate::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePaidSummaryByDeptByDate::OnFromDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptByDate::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptByDate::OnFromDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptByDate::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePaidSummaryByDeptByDate::OnToDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptByDate::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptByDate::OnToDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptByDate::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePaidSummaryByDeptByDate::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

long CFMInsurancePaidSummaryByDeptByDate::OnObjectTypeLoadData()
{
...
void CFMInsurancePaidSummaryByDeptByDate::OnSoldierWCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMInsurancePaidSummaryByDeptByDate::OnClerkSelendok(){
	 
}
int CFMInsurancePaidSummaryByDeptByDate::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMInsurancePaidSummaryByDeptByDate::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMInsurancePaidSummaryByDeptByDate::OnSODSelect(){
	OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDeptByDate::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptByDate::OnClerkKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptByDate::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePaidSummaryByDeptByDate::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDeptByDate::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDeptByDate::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDeptByDate::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptByDate::OnStatusKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptByDate::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummaryByDeptByDate::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDeptByDate::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDeptByDate::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePaidSummaryByDeptByDate::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptByDate::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptByDate::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummaryByDeptByDate::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMInsurancePaidSummaryByDeptByDate::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePaidSummaryByDeptByDate::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsurancePaidSummaryByDeptByDate::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsurancePaidSummaryByDeptByDate::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePaidSummaryByDeptByDate::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsurancePaidSummaryByDeptByDate::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	szWhere.Format(_T(" and iv.FAC_LOCKED='Y' "));
	...
	{
		szWhere.AppendFormat(_T(" and iv.FAC_POSTEDDATE between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') "),m_szFromDate, m_szToDate);
		szWhere.AppendFormat(_T(" and iv.FAC_POSTED ='Y' "));
		if(!m_szClerkKey.IsEmpty())
		{
			szWhere.AppendFormat(_T(" and fac_user_id='%s' "), m_szClerkKey);
		}
...
void CFMInsurancePaidSummaryByDeptByDate::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMInsurancePaidSummaryByDeptByDate::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMInsurancePaidSummaryByDeptByDate::OnInpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDeptByDate::OnOutpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDeptByDate::OnDepositSelect(){
	
}
void CFMInsurancePaidSummaryByDeptByDate::OnAllSelect(){
	
}
 
 
int CFMInsurancePaidSummaryByDeptByDate::OnAddFMInsuranceReceiptSummary(){
...
int CFMInsurancePaidSummaryByDeptByDate::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePaidSummaryByDeptByDate::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsurancePaidSummaryByDeptByDate::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsurancePaidSummaryByDeptByDate::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePaidSummaryByDeptByDate::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsurancePaidSummaryByDeptByDate::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummaryByDeptByDate::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDeptByDate::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMInsurancePaidSummaryByDeptByDate"));
...
void CFMInsurancePaidSummaryByDeptByDate::OnExportSelect()
{
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
...
void CFMInsurancePaidSummaryByDeptByDate::OnExportPatientList()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDeptByDate::OnExportDetailSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\TONGHOP_CHIPHI_NGOAITRU_NOITRU_THEOKHOA.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOP_CHIPHI_NGOAITRU_NOITRU_THEOKHOA2.xls"));
}

CString CFMInsurancePaidSummaryByDeptByDate::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
rs.ExecSQL(szSQL);	
   ...
   szSQL.Format(_T(" SELECT") \
				...
				_T("   WHERE 1=1 AND (TIEN_KHAM+TIEN_GIUONG+TIEN_CLS+TIEN_PTTT+TIEN_THUOC_CH+TIEN_VAT_TU_CH+TIEN_THUOC_PM+TIEN_VAT_TU_PM+TIEN_MAU+THU_KHAC+THU_GOI+TIEN_AN+TIEN_THUOC_TG+TIEN_VAT_TU_TG+TIEN_THUOC_TG_O+TIEN_VAT_TU_TG_O)>0 %s") \
				_T("   )") \
				_T(" GROUP BY ") \
				_T(" HO_TEN, docno, NGAY_VAO, NGAY_RA,CHINDEX, posted_date,dept_id") \
				_T(" ORDER BY dept_id, posted_date"),szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20,szWhere1); \
	return szSQL;
}
CString CFMInsurancePaidSummaryByDeptByDate::GetQueryString_check()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19, szSQL20, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
...
int CFMInsurancePaidSummaryByDeptByDate::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptByDate::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
