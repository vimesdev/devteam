#ifndef FMServicePaidSummaryByDept_H
#define FMServicePaidSummaryByDept_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServicePaidSummaryByDept : public CGuiView
{
protected:
...
public:
	...
	CFMServicePaidSummaryByDept(CWnd *pWnd);
	~CFMServicePaidSummaryByDept();
