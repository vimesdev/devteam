#ifndef FMInsuranceIncomeListSOM_H
#define FMInsuranceIncomeListSOM_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceIncomeListSOM : public CGuiView
{
protected:
public:
	CString		m_szCashIDS;
	...
	CFMInsuranceIncomeListSOM(CWnd *pWnd);
	~CFMInsuranceIncomeListSOM();
