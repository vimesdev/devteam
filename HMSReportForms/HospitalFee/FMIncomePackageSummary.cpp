#include "stdafx.h"
#include "FMIncomePackageSummary.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMIncomePackageSummary* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummary *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMIncomePackageSummary *pVw = (CFMIncomePackageSummary *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummary*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummary*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummary*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummary*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummary*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummary*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummary*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMIncomePackageSummary*)pWnd)->OnPackageListLoadData();
}
static void _OnNotIncludeHomeStaySelectFnc(CWnd *pWnd){
	 ((CFMIncomePackageSummary*)pWnd)->OnNotIncludeHomeStaySelect();
}

static void _OnNotDiscountSelectFnc(CWnd *pWnd){
	 ((CFMIncomePackageSummary*)pWnd)->OnNotDiscountSelect();
}
static void _OnNotincludeTYCSelectFnc(CWnd *pWnd){
	 ((CFMIncomePackageSummary*)pWnd)->OnNotincludeTYCSelect();
}
static void _OnOnlyTYCSelectFnc(CWnd *pWnd){
	 ((CFMIncomePackageSummary*)pWnd)->OnOnlyTYCSelect();
}
static void _OnKotinhgnnolSelectFnc(CWnd *pWnd){
	 ((CFMIncomePackageSummary*)pWnd)->OnKotinhgnnolSelect();
}

CFMIncomePackageSummary::CFMIncomePackageSummary(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMIncomePackageSummary::~CFMIncomePackageSummary()
{
}
void CFMIncomePackageSummary::OnCreateComponents()
{
	/*m_wndReportCondition.Create(this, _T("Report Condition"), 6, 5, 480, 487);
	...
	m_wndByDate.Create(this, _T("By Date"), 5, 523, 85, 548);
	m_wndByDept.Create(this, _T("By Dept"), 90, 523, 170, 548);
	m_wndInsurance.Create(this, _T("Insurance"), 175, 523, 255, 548);
	m_wndPrint.Create(this, _T("&Print"), 310, 523, 390, 548);
	m_wndExport.Create(this, _T("&Export"), 394, 523, 474, 548);
	m_wndObjectList.Create(this,10, 90, 476, 202); 
	m_wndDeptList.Create(this,11, 206, 477, 338); 
	m_wndPackageList.Create(this,12, 343, 478, 488); 
	m_wndNotIncludeHomeStay.Create(this, _T("Khong tinh nha luu tru"), 5, 493, 161, 518);
	m_wndNotDiscount.Create(this, _T("Ko tính Miễn giảm"), 166, 493, 279, 518);
	m_wndNotincludeTYC.Create(this, _T("Bỏ TYC"), 284, 493, 364, 518);
	m_wndOnlyTYC.Create(this, _T("Chỉ tính TYC"), 369, 493, 474, 518);*/
	
	m_wndReportCondition.Create(this, _T("Report Condition"), 6, 5, 480, 457);
	m_wndYearLabel.Create(this, _T("Year"), 10, 30, 90, 55);
	m_wndYear.Create(this,95, 30, 240, 55); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 250, 30, 330, 55);
	m_wndReportPeriod.Create(this,335, 30, 476, 55); 
	...
	m_wndObjectList.Create(this,10, 90, 476, 202); 
	m_wndDeptList.Create(this,11, 206, 477, 338); 
	m_wndPackageList.Create(this,12, 343, 478, 452); 
	m_wndNotIncludeHomeStay.Create(this, _T("Khong tinh nha luu tru"), 5, 463, 161, 488);
	m_wndNotDiscount.Create(this, _T("Ko tính Miễn giảm"), 166, 462, 279, 487);
	m_wndNotincludeTYC.Create(this, _T("Bỏ TYC"), 5, 493, 85, 518);
	m_wndOnlyTYC.Create(this, _T("Chỉ tính TYC"), 91, 493, 196, 518);
	m_wndKotinhgnnol.Create(this, _T("Không tính gói NNOLPB"), 285, 463, 474, 488);


}
void CFMIncomePackageSummary::OnInitializeComponents(){
...
void CFMIncomePackageSummary::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	m_wndNotIncludeHomeStay.SetEvent(WE_CLICK, _OnNotIncludeHomeStaySelectFnc);
	m_wndNotDiscount.SetEvent(WE_CLICK, _OnNotDiscountSelectFnc);

	m_wndNotincludeTYC.SetEvent(WE_CLICK, _OnNotincludeTYCSelectFnc);
	m_wndOnlyTYC.SetEvent(WE_CLICK, _OnOnlyTYCSelectFnc);
	m_wndKotinhgnnol.SetEvent(WE_CLICK, _OnKotinhgnnolSelectFnc);
...
void CFMIncomePackageSummary::OnDoDataExchange(CDataExchange* pDX){
	DDX_Text(pDX, m_wndYear.GetDlgCtrlID(), m_nYear);
	DDX_TextEx(pDX, m_wndReportPeriod.GetDlgCtrlID(), m_szReportPeriodKey);
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);
	DDX_Check(pDX, m_wndInsurance.GetDlgCtrlID(), m_bInsurance);
	DDX_Check(pDX, m_wndNotIncludeHomeStay.GetDlgCtrlID(), m_bNotIncludeHomeStay);
	DDX_Check(pDX, m_wndNotDiscount.GetDlgCtrlID(), m_bNotDiscount);
	DDX_Check(pDX, m_wndNotincludeTYC.GetDlgCtrlID(), m_bNotincludeTYC);
	DDX_Check(pDX, m_wndOnlyTYC.GetDlgCtrlID(), m_bOnlyTYC);
	DDX_Check(pDX, m_wndKotinhgnnol.GetDlgCtrlID(), m_bKotinhgnnol);
}
void CFMIncomePackageSummary::SetDefaultValues(){
	...
	m_szCondition.Empty();
	m_bInsurance = FALSE;
	m_bNotIncludeHomeStay=FALSE;
	m_bNotDiscount=TRUE;
	m_bNotincludeTYC=TRUE;
	m_bOnlyTYC=FALSE;
	m_bKotinhgnnol=TRUE;

}

int CFMIncomePackageSummary::SetMode(int nMode){
...
/*void CFMIncomePackageSummary::OnYearChange(){
	
} */
/*void CFMIncomePackageSummary::OnYearSetfocus(){
	
} */
/*void CFMIncomePackageSummary::OnYearKillfocus(){
	
} */
int CFMIncomePackageSummary::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMIncomePackageSummary::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMIncomePackageSummary::OnNotIncludeHomeStaySelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMIncomePackageSummary::OnNotDiscountSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

void CFMIncomePackageSummary::OnNotincludeTYCSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMIncomePackageSummary::OnOnlyTYCSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

	void CFMIncomePackageSummary::OnKotinhgnnolSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMIncomePackageSummary::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMIncomePackageSummary::OnReportPeriodSetfocus(){
	
}*/
/*void CFMIncomePackageSummary::OnReportPeriodKillfocus(){
	
}*/
long CFMIncomePackageSummary::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMIncomePackageSummary::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMIncomePackageSummary::OnFromDateChange(){
	
} */
/*void CFMIncomePackageSummary::OnFromDateSetfocus(){
	
} */
/*void CFMIncomePackageSummary::OnFromDateKillfocus(){
	
} */
int CFMIncomePackageSummary::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMIncomePackageSummary::OnToDateChange(){
	
} */
/*void CFMIncomePackageSummary::OnToDateSetfocus(){
	
} */
/*void CFMIncomePackageSummary::OnToDateKillfocus(){
	
} */
int CFMIncomePackageSummary::OnToDateCheckValue(){
	return 0;
}
long CFMIncomePackageSummary::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	szSQL.Format(_T("SELECT ss_code AS ID, ") \
		         _T("ss_desc AS Name ") \
		         _T("FROM sys_sel ") \
				 _T("WHERE ss_id ='HMS_SERVICE_PACKAGE' %s ") \
...
void CFMIncomePackageSummary::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMIncomePackageSummary::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMIncomePackageSummary::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
void CFMIncomePackageSummary::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_THUGOI_TH.RPT")))
		return;
	...
	while (!rs.IsEOF())
	{
		...
		rs.GetValue(_T("totalqty"), tmpStr);
		rptDetail->SetValue(_T("3"), tmpStr);			

		rs.GetValue(_T("totalincomeamount"), nCost);
		nGroupTotal += nCost;
	...
	if (nGroupTotal > 0)
	{
		...
		rptDetail->SetValue(_T("TotalGroup"), _T("Tổng gói"));
...
void CFMIncomePackageSummary::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummary::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummary::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\DANHSACHBENHNHAN_THUGOI_TH.xls"))) AfxMessageBox(_T("Trên máy chưa có file này"));
	...
	while(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("totalincomeamount"), nTemp);
		nGroupTotal[3] += nTemp;
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\DANHSACHBENHNHAN_THUGOI_TH2.xls"));
}
void CFMIncomePackageSummary::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummary::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackageSummary::OnObjectListDblClick(){
	
}
 
void CFMIncomePackageSummary::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummary::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummary::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummary::OnDeptListDblClick(){
	
}
 
void CFMIncomePackageSummary::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummary::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummary::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMIncomePackageSummary::GetQueryString()
{
	...
	if (m_bNotIncludeHomeStay)
	{
	
		szWhere.AppendFormat(_T(" and fe.hfe_itemid in (SELECT ss_code FROM sys_sel WHERE ss_id ='HMS_SERVICE_PACKAGE' and NVL(ss_vndesc,'XXXX') <> 'GNLT') "), szPackages);
	
	}

	if (m_bKotinhgnnol)
	{
		szWhere.AppendFormat(_T(" and fe.hfe_itemid in (SELECT ss_code FROM sys_sel WHERE ss_id ='HMS_SERVICE_PACKAGE' and NVL(ss_vndesc,'XXXX') <> 'GNNOLPB') "), szPackages);
	}

	if (m_bNotDiscount)
	{
	
		szWhere.AppendFormat(_T(" AND fe.Hfe_itemid NOT IN (SELECT Hfe_itemid FROM Hms_Fee_Discountline WHERE hfe_docno =ivf.hfe_docno AND Hfe_Refidx  =ivf.hfe_invoiceno) "));
	...
	if (m_bNotincludeTYC)
	{
		...
		szWhere.AppendFormat(_T(" AND fe.hfe_deptid NOT IN ('PTTYC') AND fac_cashbook_id not in ('BHYC','BH-PTTYC', 'THE-BH-YC','THE-BH-PTTYC', 'DVYC','DV-PTTYC', 'THE-DV-YC','THE-DV-PTTYC') "));
	...
	if (m_bOnlyTYC)
	{
		...
		szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('BHYC','BH-PTTYC', 'THE-BH-YC','THE-BH-PTTYC', 'DVYC','DV-PTTYC', 'THE-DV-YC','THE-DV-PTTYC') "));
	...
	if (!szPackages.IsEmpty())
	{
		szWhere.AppendFormat(_T(" and fe.hfe_itemid in(%s) "), szPackages);
	}

	if (!szObjects.IsEmpty())
	{
		szWhere.AppendFormat(_T(" and ivf.HFE_OBJECTID in(%s) "), szObjects);
	}
	...
	_T(" AND fe.hfe_status     IN ('P', 'R') %s") \
	_T(" AND fe.hfe_status IN ('P', 'R')") \
	_T(" AND fac_posted     = 'Y'") \
	//_T(" AND fac_cashbook_id not in ('BHYC','BH-PTTYC', 'THE-BH-YC','THE-BH-PTTYC', 'DVYC','DV-PTTYC', 'THE-DV-YC','THE-DV-PTTYC')") \//
	...
	_T("   fe.hfe_quantity,") \
	_T("   fe.hfe_cost") \
	_T(" ORDER BY fe.hfe_itemid )") \
	_T(" GROUP BY itemid, hfe_desc") \
	_T(" ORDER BY itemid"), m_szFromDate, m_szToDate, szWhere);
	return szSQL;
}

CString CFMIncomePackageSummary::GetQueryString1()
{
...
int CFMIncomePackageSummary::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummary::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummary::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMIncomePackageSummary::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
