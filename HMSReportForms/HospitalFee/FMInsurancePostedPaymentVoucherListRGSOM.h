#ifndef FMInsurancePostedPaymentVoucherListRGSOM_H
#define FMInsurancePostedPaymentVoucherListRGSOM_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsurancePostedPaymentVoucherListRGSOM : public CGuiView
{
protected:
...
public:
	...
	CFMInsurancePostedPaymentVoucherListRGSOM(CWnd *pWnd);
	~CFMInsurancePostedPaymentVoucherListRGSOM();
