#ifndef FMTOTALINCOME108HOSPITAL_H
#define FMTOTALINCOME108HOSPITAL_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTotalIncome108Hospital : public CGuiView
{
...
public:
	...
	CGuiRadioButton	m_wndServIncome;
	CGuiRadioButton	m_wndInsIncome;
	CGuiRadioButton	m_wndTYCIncome;
	CGuiRadioButton	m_wndOtherIncome;
	long	m_nYear;
	...
	void			OnPrint2ndver();
	void			OnTCKTSelect();
	void			OnServIncomeSelect(); 
	void			OnInsIncomeSelect(); 
	void			OnTYCIncomeSelect(); 
	void			OnOtherIncomeSelect(); 
	...
	CFMTotalIncome108Hospital(CWnd *pWnd);
	~CFMTotalIncome108Hospital();
	...
	int OnAddFMTotalIncome108Hospital(); 
	int OnEditFMTotalIncome108Hospital(); 
	int OnDeleteFMTotalIncome108Hospital(); 
	int OnSaveFMTotalIncome108Hospital(); 
	int OnCancelFMTotalIncome108Hospital(); 
	int OnFMTotalIncome108HospitalListLoadData();
