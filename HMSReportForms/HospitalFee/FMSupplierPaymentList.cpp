#include "stdafx.h"
#include "FMSupplierPaymentList.h"
...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSupplierPaymentList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSupplierPaymentList *)pWnd)->OnToDateCheckValue();
} 
static long _OnSupplierLoadDataFnc(CWnd *pWnd){
	return ((CFMSupplierPaymentList *)pWnd)->OnSupplierLoadData();
}
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSupplierPaymentList* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CFMSupplierPaymentList *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnStorageAddNew();
}*/
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSupplierPaymentList* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CFMSupplierPaymentList *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSupplierPaymentList* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CFMSupplierPaymentList *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CFMSupplierPaymentList *)pWnd)->OnSourceAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMSupplierPaymentList *pVw = (CFMSupplierPaymentList *)pWnd;
...
CFMSupplierPaymentList::CFMSupplierPaymentList(CWnd *pParent)
{
...
CFMSupplierPaymentList::~CFMSupplierPaymentList(){
}
void CFMSupplierPaymentList::OnCreateComponents()
{
	...
	m_wndSourceLabel.Create(this, _T("Source"), 295, 120, 375, 145);
	m_wndSource.Create(this,380, 120, 570, 145); 
	m_wndPrintPreview.Create(this, _T("&Print Preview"), 5, 156, 100, 181);
	m_wndExport.Create(this, _T("&Export"), 105, 156, 185, 181);
}
void CFMSupplierPaymentList::OnInitializeComponents(){
...
void CFMSupplierPaymentList::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CFMSupplierPaymentList::OnDoDataExchange(CDataExchange* pDX){
...
void CFMSupplierPaymentList::SetDefaultValues(){
...
int CFMSupplierPaymentList::SetMode(int nMode){
...
/*void CFMSupplierPaymentList::OnFromDateChange(){
	
} */
/*void CFMSupplierPaymentList::OnFromDateSetfocus(){
	
} */
/*void CFMSupplierPaymentList::OnFromDateKillfocus(){
	
} */
int CFMSupplierPaymentList::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMSupplierPaymentList::OnToDateChange(){
	
} */
/*void CFMSupplierPaymentList::OnToDateSetfocus(){
	
} */
/*void CFMSupplierPaymentList::OnToDateKillfocus(){
	
} */
int CFMSupplierPaymentList::OnToDateCheckValue(){
	return 0;
} 
long CFMSupplierPaymentList::OnSupplierLoadData()
{
	//CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CFMSupplierPaymentList::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CFMSupplierPaymentList::OnStorageSelendok(){
	 
}
long CFMSupplierPaymentList::OnStorageLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();	
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSupplierPaymentList::OnStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CFMSupplierPaymentList::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CFMSupplierPaymentList::OnItemGroupSelendok(){
	 
}
/*void CFMSupplierPaymentList::OnItemGroupSetfocus(){
	
}*/
/*void CFMSupplierPaymentList::OnItemGroupKillfocus(){
	
}*/
long CFMSupplierPaymentList::OnItemGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSupplierPaymentList::OnItemGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CFMSupplierPaymentList::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CFMSupplierPaymentList::OnSourceSelendok(){
	 
}
/*void CFMSupplierPaymentList::OnSourceSetfocus(){
	
}*/
/*void CFMSupplierPaymentList::OnSourceKillfocus(){
	
}*/
long CFMSupplierPaymentList::OnSourceLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CFMSupplierPaymentList::OnSourceAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CFMSupplierPaymentList::OnPrintPreviewSelect()
{
	return;
	/*
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	*/
	...
	double nTmp = 0;
	int nIdx = 1, nIdx2 = 0;
	CString szSQL, tmpStr, szReportName, szDate, szOldLev1, szNewLev1, szField, szTemp, szStorages, szSources;
...
void CFMSupplierPaymentList::OnExportSelect(){
...
CString CFMSupplierPaymentList::GetQueryString1(){
	CString szSQL, szWhere, szStorages, szSources;
	szWhere.Format(_T("AND pp_acctdate BETWEEN to_date('%s', 'yyyy/mm/dd hh24:mi:ss') AND to_date('%s', 'yyyy/mm/dd hh24:mi:ss')"), m_szFromDate, m_szToDate);
	...
	szSQL.Format(_T(" SELECT po_purchase_order_id as id,") \
				...
				_T("		  po_orderno, po_approveddate, po_partner_id, product_name") \
				_T(" ORDER  BY po_partner_id "), szWhere);
	return szSQL;
}

CString CFMSupplierPaymentList::GetQueryString2(){
	CString szSQL, szWhere, szStorages, szSources;
	szWhere.Format(_T("AND pp_acctdate BETWEEN to_date('%s', 'yyyy/mm/dd hh24:mi:ss') AND to_date('%s', 'yyyy/mm/dd hh24:mi:ss')"), m_szFromDate, m_szToDate);
	if(!m_szSupplierKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND po_partner_id = '%s'"), m_szSupplierKey);
...
BEGIN_MESSAGE_MAP(CFMSupplierPaymentList, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CFMSupplierPaymentList::OnSetFocus(CWnd* pOldWnd)
{
