#include "stdafx.h"
#include "FMPolicyPostedReceiptListbyDay.h"
#include "HMSMainFrame.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptListbyDay* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptListbyDay* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptListbyDay* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnStatusAddNew();
}*/
static void _OnGroupBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptListbyDay* )pWnd)->OnGroupBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupBySelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnGroupBySelendok();
}
/*static void _OnGroupBySetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnGroupByKillfocus();
}*/
/*static void _OnGroupByKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnGroupByKillfocus();
}*/
static long _OnGroupByLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnGroupByLoadData();
}
/*static void _OnGroupByAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay *)pWnd)->OnGroupByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMPolicyPostedReceiptListbyDay *pVw = (CFMPolicyPostedReceiptListbyDay *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static int _OnAddFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnAddFMInsurancePostedPaymentVoucherList();
} 
static int _OnEditFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnEditFMInsurancePostedPaymentVoucherList();
} 
static int _OnDeleteFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnDeleteFMInsurancePostedPaymentVoucherList();
} 
static int _OnSaveFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnSaveFMInsurancePostedPaymentVoucherList();
} 
static int _OnCancelFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptListbyDay*)pWnd)->OnCancelFMInsurancePostedPaymentVoucherList();
} 
CFMPolicyPostedReceiptListbyDay::CFMPolicyPostedReceiptListbyDay(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMPolicyPostedReceiptListbyDay::~CFMPolicyPostedReceiptListbyDay(){
}
void CFMPolicyPostedReceiptListbyDay::OnCreateComponents(){
...
void CFMPolicyPostedReceiptListbyDay::OnInitializeComponents(){
...
void CFMPolicyPostedReceiptListbyDay::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPostedReceiptListbyDay::OnDoDataExchange(CDataExchange* pDX){
...
void CFMPolicyPostedReceiptListbyDay::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMPolicyPostedReceiptListbyDay::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMPolicyPostedReceiptListbyDay::SetDefaultValues(){
...
int CFMPolicyPostedReceiptListbyDay::SetMode(int nMode){
...
/*void CFMPolicyPostedReceiptListbyDay::OnYearChange(){
	
} */
/*void CFMPolicyPostedReceiptListbyDay::OnYearSetfocus(){
	
} */
/*void CFMPolicyPostedReceiptListbyDay::OnYearKillfocus(){
	
} */
int CFMPolicyPostedReceiptListbyDay::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMPolicyPostedReceiptListbyDay::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMPolicyPostedReceiptListbyDay::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMPolicyPostedReceiptListbyDay::OnReportPeriodSetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptListbyDay::OnReportPeriodKillfocus(){
	
}*/
long CFMPolicyPostedReceiptListbyDay::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMPolicyPostedReceiptListbyDay::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMPolicyPostedReceiptListbyDay::OnFromDateChange(){
	
} */
/*void CFMPolicyPostedReceiptListbyDay::OnFromDateSetfocus(){
	
} */
/*void CFMPolicyPostedReceiptListbyDay::OnFromDateKillfocus(){
	
} */
int CFMPolicyPostedReceiptListbyDay::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMPolicyPostedReceiptListbyDay::OnToDateChange(){
	
} */
/*void CFMPolicyPostedReceiptListbyDay::OnToDateSetfocus(){
	
} */
/*void CFMPolicyPostedReceiptListbyDay::OnToDateKillfocus(){
	
} */
int CFMPolicyPostedReceiptListbyDay::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMPolicyPostedReceiptListbyDay::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedReceiptListbyDay::OnClerkSelendok(){
	 
}
/*void CFMPolicyPostedReceiptListbyDay::OnClerkSetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptListbyDay::OnClerkKillfocus(){
	
}*/
long CFMPolicyPostedReceiptListbyDay::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMPolicyPostedReceiptListbyDay::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedReceiptListbyDay::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedReceiptListbyDay::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMPolicyPostedReceiptListbyDay::OnStatusSetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptListbyDay::OnStatusKillfocus(){
	
}*/
long CFMPolicyPostedReceiptListbyDay::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedReceiptListbyDay::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedReceiptListbyDay::OnGroupBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedReceiptListbyDay::OnGroupBySelendok(){
	 
}
/*void CFMPolicyPostedReceiptListbyDay::OnGroupBySetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptListbyDay::OnGroupByKillfocus(){
	
}*/
long CFMPolicyPostedReceiptListbyDay::OnGroupByLoadData(){
	return 0;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedReceiptListbyDay::OnGroupByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMPolicyPostedReceiptListbyDay::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPostedReceiptListbyDay::OnListDblClick(){
...
void CFMPolicyPostedReceiptListbyDay::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMPolicyPostedReceiptListbyDay::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMPolicyPostedReceiptListbyDay::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	szWhere.AppendFormat(_T(" AND (substr(fac_cashbook_id, 1, 2) in ('QU') OR substr(fac_cashbook_id, 1, 6) in ('BHQUAN')) AND  fac_cashbook_id <> 'BH-PTTYC'"));
...
void CFMPolicyPostedReceiptListbyDay::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPostedReceiptListbyDay::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMPolicyPostedReceiptListbyDay::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMPolicyPostedReceiptListbyDay::OnAddFMInsurancePostedPaymentVoucherList(){
...
int CFMPolicyPostedReceiptListbyDay::OnEditFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMPolicyPostedReceiptListbyDay::OnDeleteFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMPolicyPostedReceiptListbyDay::OnSaveFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMPolicyPostedReceiptListbyDay::OnCancelFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMPolicyPostedReceiptListbyDay::OnFMInsurancePostedPaymentVoucherListListLoadData(){
	return 0;
}


void CFMPolicyPostedReceiptListbyDay::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	/*Declaration Section*/
	...
	long double nTotal[11], nGroupTotal1[11], nGroupTotal2[11], nGroupTotal3[11];
	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOTHUBNBDCSTHEONGAY.RPT");
	...
	TCHAR *dat[] = {_T("trich_tam_gui"), _T("phi_an"), _T("thu_khac"),_T("thu_goidv"), _T("phai_thu_"), 
...
void CFMPolicyPostedReceiptListbyDay::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
// S? d?ng d?n ngày 15/09/2018 thì thay d?i do quy trình
/*CString CFMPolicyPostedReceiptListbyDay::GetQueryString()
{
	CString szSQL, szWhere, szSubFee, szGroupBy, szReceiptStr;
	szWhere.AppendFormat(_T(" AND fac_posted = 'Y' AND substr(fac_cashbook_id, 1, 2) in ('QU')") \
	...
	_T("           SUM(thu_chenh + 0 - trich_tam_gui + tam_gui + 0) tong_thu_, ") \
	...
	_T("					  DECODE('S', hfe_type, hfe_amount, hfe_diffcost) thu_chenh,") \
	_T("					  i.hfe_patpaid - i.hfe_otherpaid - i.hfe_freeamount phai_thu,") \
	//_T("                      (select coalesce(sum(hfe_patpaid), 0) from hms_fee f where f.hfe_docno = i.hfe_docno and f.hfe_invoiceno = i.hfe_invoiceno and f.hfe_type = 'F' AND NVL(f.hfe_category, 'N') = 'N' AND f.hfe_status NOT IN ('O', 'C')) ") \//
	_T("                      (select coalesce(sum(hfe_patpaid), 0) from hms_fee f where f.hfe_docno = i.hfe_docno and f.hfe_invoiceno = i.hfe_invoiceno ") \
	_T("                       AND f.hfe_type = 'F' AND NVL(f.hfe_category, 'N') NOT IN ('Y', 'BQP', 'BBV') AND f.hfe_fee_id NOT IN ") \
	_T("                       (SELECT hfe_invoiceline_id FROM hms_fee_discountline d WHERE d.hfe_docno = f.hfe_docno AND f.hfe_invoiceno = d.hfe_refidx) AND f.hfe_status NOT IN ('O', 'C'))") \
	_T("						phi_an, ") \
	...
	_T("					   phi_ranggia, ") \
	_T("					  0 tam_gui, 0 thu_khac_, hfe_freeamount ") \
	...
	_T("					  0 phi_ranggia, ") \
	_T("					  0 tam_gui, ") \
	_T("					  hfe_amount thu_khac_, 0 hfe_freeamount") \
	_T("		  FROM hms_fee_invoice WHERE hfe_type = 'O' AND hfe_status NOT IN ('O', 'C') AND hfe_cash_id > 0 AND hfe_payment > 0 AND hfe_objectid in (1,3,8,11,13)") \
	_T("		  UNION ALL") \
	...
	_T("				   0 ngay_dt,") \
	_T("                   0 phi_ranggia, ") \
	_T("                   d.hfe_amount tam_gui, 0 thu_khac_, 0 hfe_freeamount") \
...
CString CFMPolicyPostedReceiptListbyDay::GetQueryString()
{
	...
	_T("                      hfe_docno, ") \
	_T("					  CASE WHEN hfe_class = 'I' THEN 'III' ELSE 'II' END invoice_class,") \
	_T("					  CASE WHEN hfe_class = 'I' THEN CASE WHEN hfe_objectid in (3,8,13) THEN 0 ELSE 1 END ELSE NULL END obj_class,") \
	_T("                      hfe_deposit trich_tam_gui, ") \
	_T("					  DECODE('S', hfe_type, hfe_amount, hfe_diffcost) thu_chenh,") \
	_T("					  i.hfe_patpaid - i.hfe_otherpaid - i.hfe_freeamount phai_thu,") \
	//_T("                      (select coalesce(sum(hfe_patpaid), 0) from hms_fee f where f.hfe_docno = i.hfe_docno and f.hfe_invoiceno = i.hfe_invoiceno and f.hfe_type = 'F' AND NVL(f.hfe_category, 'N') = 'N' AND f.hfe_status NOT IN ('O', 'C')) ") \//
	...
	_T("					  0 tam_gui, 0 thu_khac_, hfe_freeamount ") \
	_T("            FROM      hms_fee_invoice i ") \
	_T("            WHERE     hfe_type <> 'O' AND hfe_status NOT IN ('O', 'C') AND hfe_cash_id > 0 AND hfe_objectid in (3,8,13) ") \
	_T("			AND hfe_payment > 0") \
	_T("		  UNION ALL") \
	_T("			  SELECT hfe_cash_id cash_id, hfe_staff staff, hfe_deptid dept_id,") \
	_T("					  (select NVL(hd_outpatient, 'N') from hms_doc where hd_docno = hfe_docno) patient_type,") \
	...
	_T("					  0 tam_gui, ") \
	_T("					  hfe_amount thu_khac_, 0 hfe_freeamount") \
	_T("		  FROM hms_fee_invoice WHERE hfe_type = 'O' AND hfe_status NOT IN ('O', 'C') AND hfe_cash_id > 0 AND hfe_payment > 0 AND hfe_objectid in (3,8,13)") \
	_T("		  UNION ALL") \
	_T("		  SELECT   d.hfe_cash_id, d.hfe_staff staff, hfe_deptid dept_id,") \
	_T("				   (select NVL(hd_outpatient, 'N') from hms_doc where hd_docno = d.hfe_docno) patient_type,") \
	_T("				   d.hfe_treattime treattime,") \
	...
	_T("                   d.hfe_amount tam_gui, 0 thu_khac_, 0 hfe_freeamount") \
	_T("            FROM   hms_fee_deposit d") \
	_T("            WHERE  d.hfe_cash_id > 0 AND d.hfe_objectid in (3,8,13)") \
	_T("			AND d.hfe_status NOT IN ('O', 'C')) tbl ") \
	_T("	LEFT JOIN fa_cash ON ( fac_cash_id = cash_id ) ") \
	_T(" WHERE     1 = 1 %s") \
	_T(" GROUP BY trunc(fac_posteddate)") \
...
CString CFMPolicyPostedReceiptListbyDay::GetQueryString2(){
