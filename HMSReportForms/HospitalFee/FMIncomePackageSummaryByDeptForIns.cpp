#include "stdafx.h"
#include "FMIncomePackageSummaryByDeptForIns.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMIncomePackageSummaryByDeptForIns* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMIncomePackageSummaryByDeptForIns *pVw = (CFMIncomePackageSummaryByDeptForIns *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMIncomePackageSummaryByDeptForIns*)pWnd)->OnPackageListLoadData();
}

CFMIncomePackageSummaryByDeptForIns::CFMIncomePackageSummaryByDeptForIns(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMIncomePackageSummaryByDeptForIns::~CFMIncomePackageSummaryByDeptForIns()
{
}
void CFMIncomePackageSummaryByDeptForIns::OnCreateComponents()
{
	...
	m_wndByDate.Create(this, _T("By Date"), 5, 555, 85, 580);
	m_wndByDept.Create(this, _T("By Dept"), 90, 555, 170, 580);
...
void CFMIncomePackageSummaryByDeptForIns::OnInitializeComponents(){
...
void CFMIncomePackageSummaryByDeptForIns::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryByDeptForIns::OnDoDataExchange(CDataExchange* pDX){
...
void CFMIncomePackageSummaryByDeptForIns::SetDefaultValues(){
...
int CFMIncomePackageSummaryByDeptForIns::SetMode(int nMode){
...
/*void CFMIncomePackageSummaryByDeptForIns::OnYearChange(){
	
} */
/*void CFMIncomePackageSummaryByDeptForIns::OnYearSetfocus(){
	
} */
/*void CFMIncomePackageSummaryByDeptForIns::OnYearKillfocus(){
	
} */
int CFMIncomePackageSummaryByDeptForIns::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMIncomePackageSummaryByDeptForIns::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMIncomePackageSummaryByDeptForIns::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMIncomePackageSummaryByDeptForIns::OnReportPeriodSetfocus(){
	
}*/
/*void CFMIncomePackageSummaryByDeptForIns::OnReportPeriodKillfocus(){
	
}*/
long CFMIncomePackageSummaryByDeptForIns::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMIncomePackageSummaryByDeptForIns::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMIncomePackageSummaryByDeptForIns::OnFromDateChange(){
	
} */
/*void CFMIncomePackageSummaryByDeptForIns::OnFromDateSetfocus(){
	
} */
/*void CFMIncomePackageSummaryByDeptForIns::OnFromDateKillfocus(){
	
} */
int CFMIncomePackageSummaryByDeptForIns::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMIncomePackageSummaryByDeptForIns::OnToDateChange(){
	
} */
/*void CFMIncomePackageSummaryByDeptForIns::OnToDateSetfocus(){
	
} */
/*void CFMIncomePackageSummaryByDeptForIns::OnToDateKillfocus(){
	
} */
int CFMIncomePackageSummaryByDeptForIns::OnToDateCheckValue(){
	return 0;
}
long CFMIncomePackageSummaryByDeptForIns::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummaryByDeptForIns::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMIncomePackageSummaryByDeptForIns::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMIncomePackageSummaryByDeptForIns::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
void CFMIncomePackageSummaryByDeptForIns::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_THUGOI_TH_THEOKHOA.RPT")))
		return;
...
void CFMIncomePackageSummaryByDeptForIns::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryByDeptForIns::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryByDeptForIns::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\TONGHOPTHUGOI_THEOKHOA.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOPTHUGOI_THEOKHOA2.xls"));
	
}
void CFMIncomePackageSummaryByDeptForIns::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummaryByDeptForIns::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackageSummaryByDeptForIns::OnObjectListDblClick(){
	
}
 
void CFMIncomePackageSummaryByDeptForIns::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummaryByDeptForIns::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummaryByDeptForIns::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummaryByDeptForIns::OnDeptListDblClick(){
	
}
 
void CFMIncomePackageSummaryByDeptForIns::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummaryByDeptForIns::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummaryByDeptForIns::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMIncomePackageSummaryByDeptForIns::GetQueryString()
{
	...
	/*szSQL.Format(_T(" SELECT Get_patientname(ivf.hfe_docno) AS pname,") \
	_T("   ivf.hfe_docno                       AS docno,") \
	_T("   Hms_Getobjectname(fe.hfe_object) AS ObjectName,") \
	_T("   fe.hfe_deptid dept,") \
	_T("   ivf.hfe_date receiptdate,") \
	_T("   fe.hfe_itemid as itemid, fe.hfe_desc  AS hfe_desc,fe.hfe_quantity as qty,") \
	...
	_T(" AND fe.hfe_category            <> 'Y' and fe.hfe_deptid <> 'PTTYC'") \
	_T(" AND fe.hfe_itemid IN (select ss_code from sys_sel where ss_id ='HMS_SERVICE_PACKAGE') ") \
	...
	_T(" AND fac_posted         = 'Y'") \
	_T(" GROUP BY ivf.hfe_docno, fe.hfe_object, fe.hfe_deptid, ivf.hfe_date, fe.hfe_itemid,fe.hfe_desc,fe.hfe_quantity, fe.hfe_cost") \
	_T(" ORDER BY fe.hfe_deptid,ivf.hfe_date "), m_szFromDate, m_szToDate, szWhere);*/

	szSQL.Format(_T(" SELECT") \
	_T(" itemid, hfe_desc,dept,") \
	...
	//_T("   fe.hfe_deptid AS dept,") \//
	_T("   Get_departmentname(fe.hfe_deptid) as dept,") \
	...
	_T(" GROUP BY") \
	_T("   fe.hfe_itemid,") \
	_T("   fe.hfe_desc,fe.hfe_deptid,") \
	_T("   fe.hfe_quantity,") \
	_T("   fe.hfe_cost") \
	_T(" ORDER BY fe.hfe_itemid )") \
	_T(" GROUP BY dept, itemid, hfe_desc") \
	_T(" ORDER BY dept, itemid"), m_szFromDate, m_szToDate, szWhere);
	return szSQL;
}

CString CFMIncomePackageSummaryByDeptForIns::GetQueryString1()
{
...
int CFMIncomePackageSummaryByDeptForIns::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummaryByDeptForIns::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummaryByDeptForIns::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMIncomePackageSummaryByDeptForIns::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
