#ifndef FMOUTPATIENTINSURANCEREPORT19A_H
#define FMOUTPATIENTINSURANCEREPORT19A_H
...
class CFMOutpatientInsuranceReport19A : public CGuiView
{
...
public:
	...
	CFMOutpatientInsuranceReport19A(CWnd *pParent);
	~CFMOutpatientInsuranceReport19A();
