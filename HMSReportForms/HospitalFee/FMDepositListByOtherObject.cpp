#include "stdafx.h"
#include "FMDepositListByOtherObject.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDepositListByOtherObject* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject *)pWnd)->OnToDateCheckValue();
} 
static void _OnStaffSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDepositListByOtherObject* )pWnd)->OnStaffSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStaffSelendokFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnStaffSelendok();
}
/*static void _OnStaffSetfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnStaffKillfocus();
}*/
/*static void _OnStaffKillfocusFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnStaffKillfocus();
}*/
static long _OnStaffLoadDataFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject *)pWnd)->OnStaffLoadData();
}
/*static void _OnStaffAddNewFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject *)pWnd)->OnStaffAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMDepositListByOtherObject *pVw = (CFMDepositListByOtherObject *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMDepositListByOtherObject*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDepositListByOtherObject*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDepositListByOtherObject*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDepositListByOtherObject*)pWnd)->OnDeptListUnCheckAll();
}
CFMDepositListByOtherObject::CFMDepositListByOtherObject(CWnd *pParent){

	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMDepositListByOtherObject::~CFMDepositListByOtherObject(){
}
void CFMDepositListByOtherObject::OnCreateComponents(){
...
void CFMDepositListByOtherObject::OnInitializeComponents(){
...
void CFMDepositListByOtherObject::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDepositListByOtherObject::OnDoDataExchange(CDataExchange* pDX){
...
void CFMDepositListByOtherObject::SetDefaultValues(){
...
int CFMDepositListByOtherObject::SetMode(int nMode){
...
/*void CFMDepositListByOtherObject::OnYearChange(){
	
} */
/*void CFMDepositListByOtherObject::OnYearSetfocus(){
	
} */
/*void CFMDepositListByOtherObject::OnYearKillfocus(){
	
} */
int CFMDepositListByOtherObject::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMDepositListByOtherObject::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMDepositListByOtherObject::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMDepositListByOtherObject::OnReportPeriodSetfocus(){
	
}*/
/*void CFMDepositListByOtherObject::OnReportPeriodKillfocus(){
	
}*/
long CFMDepositListByOtherObject::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMDepositListByOtherObject::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMDepositListByOtherObject::OnFromDateChange(){
	
} */
/*void CFMDepositListByOtherObject::OnFromDateSetfocus(){
	
} */
/*void CFMDepositListByOtherObject::OnFromDateKillfocus(){
	
} */
int CFMDepositListByOtherObject::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMDepositListByOtherObject::OnToDateChange(){
	
} */
/*void CFMDepositListByOtherObject::OnToDateSetfocus(){
	
} */
/*void CFMDepositListByOtherObject::OnToDateKillfocus(){
	
} */
int CFMDepositListByOtherObject::OnToDateCheckValue(){
	return 0;
}
void CFMDepositListByOtherObject::OnStaffSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMDepositListByOtherObject::OnStaffSelendok(){
	 
}
/*void CFMDepositListByOtherObject::OnStaffSetfocus(){
	
}*/
/*void CFMDepositListByOtherObject::OnStaffKillfocus(){
	
}*/
long CFMDepositListByOtherObject::OnStaffLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMDepositListByOtherObject::OnStaffAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CFMDepositListByOtherObject::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDepositListByOtherObject::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDepositListByOtherObject::OnDeptListDblClick(){
	
}
 
void CFMDepositListByOtherObject::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMDepositListByOtherObject::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMDepositListByOtherObject::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMDepositListByOtherObject::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT    Get_patientname(d.hfe_docno) pname, ") \
				_T("			d.hfe_docno as docno, ") \
				_T("            d.hfe_deptid dept, ") \
				_T("           hcr_recordno                     recordno, ") \
				_T("           fac_posteddate                       receiptdate, ") \
				_T("           d.hfe_amount                     deposit, ") \
				_T("           d.Hfe_Staff staff ") \
				_T(" FROM      hms_fee_deposit d") \
				_T(" LEFT JOIN hms_fee_invoice i ON (d.hfe_docno=i.hfe_docno AND i.hfe_objectid <> d.hfe_objectid and d.hfe_objectid>0 AND d.Hfe_Deptid not in ('TYC','PTTYC'))") \
				_T(" LEFT JOIN hms_doc ON (hd_docno = d.hfe_docno)") \
				_T(" LEFT JOIN hms_clinical_record ON ( hcr_docno = d.hfe_docno ) ") \
				_T(" LEFT JOIN fa_cash ON(d.hfe_cash_id = fac_cash_id)")
				_T(" WHERE     fac_posteddate BETWEEN to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss') %s ") \
				_T("       AND d.hfe_status IN ('P') AND fac_posted = 'Y'") \
				_T("       AND i.hfe_objectid <> d.hfe_objectid") \
				_T("       AND i.hfe_objectid=7 AND I.Hfe_Deposit >0") \
				_T("       AND d.Hfe_Deptid not in ('TYC','PTTYC') AND I.Hfe_Deptid not in ('TYC','PTTYC')") \
				_T("       AND i.hfe_class ='E' AND d.hfe_class ='E'") \
				_T("       AND d.hfe_status IN ('P') AND i.hfe_status in 'P'") \
				_T(" ORDER     BY fac_posteddate "), m_szFromDate, m_szToDate, szWhere);
	return szSQL;
}

int CFMDepositListByOtherObject::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMDepositListByOtherObject::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
