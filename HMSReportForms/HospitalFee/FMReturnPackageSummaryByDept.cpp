#include "stdafx.h"
#include "FMReturnPackageSummaryByDept.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDeptByDept *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDeptByDept *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMReturnPackageSummaryByDept* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMReturnPackageSummaryByDept *pVw = (CFMReturnPackageSummaryByDept *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMReturnPackageSummaryByDept*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMReturnPackageSummaryByDept*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryByDept*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMReturnPackageSummaryByDept*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMReturnPackageSummaryByDept*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryByDept*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMReturnPackageSummaryByDept*)pWnd)->OnPackageListLoadData();
}

CFMReturnPackageSummaryByDept::CFMReturnPackageSummaryByDept(CWnd *pParent)
{
...
CFMReturnPackageSummaryByDept::~CFMReturnPackageSummaryByDept()
{
}
void CFMReturnPackageSummaryByDept::OnCreateComponents()
{
...
void CFMReturnPackageSummaryByDept::OnInitializeComponents(){
...
void CFMReturnPackageSummaryByDept::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummaryByDept::OnDoDataExchange(CDataExchange* pDX){
...
void CFMReturnPackageSummaryByDept::SetDefaultValues(){
...
int CFMReturnPackageSummaryByDept::SetMode(int nMode){
...
/*void CFMReturnPackageSummaryByDept::OnYearChange(){
	
} */
/*void CFMReturnPackageSummaryByDept::OnYearSetfocus(){
	
} */
/*void CFMReturnPackageSummaryByDept::OnYearKillfocus(){
	
} */
int CFMReturnPackageSummaryByDept::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMReturnPackageSummaryByDept::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMReturnPackageSummaryByDept::OnReportPeriodSelendok()
{
...
/*void CFMReturnPackageSummaryByDept::OnReportPeriodSetfocus(){
	
}*/
/*void CFMReturnPackageSummaryByDept::OnReportPeriodKillfocus(){
	
}*/
long CFMReturnPackageSummaryByDept::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMReturnPackageSummaryByDept::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMReturnPackageSummaryByDept::OnFromDateChange(){
	
} */
/*void CFMReturnPackageSummaryByDept::OnFromDateSetfocus(){
	
} */
/*void CFMReturnPackageSummaryByDept::OnFromDateKillfocus(){
	
} */
int CFMReturnPackageSummaryByDept::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMReturnPackageSummaryByDept::OnToDateChange(){
	
} */
/*void CFMReturnPackageSummaryByDept::OnToDateSetfocus(){
	
} */
/*void CFMReturnPackageSummaryByDept::OnToDateKillfocus(){
	
} */
int CFMReturnPackageSummaryByDept::OnToDateCheckValue(){
	return 0;
}
 
void CFMReturnPackageSummaryByDept::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMReturnPackageSummaryByDept::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMReturnPackageSummaryByDept::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
long CFMReturnPackageSummaryByDept::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	_T("   100 as ss_index") \
	_T(" FROM sys_sel") \
	_T(" WHERE ss_id  ='CA_PAYMENT_REASON'") \
	_T(" AND ss_code IN('18','19','20')")\
	_T(" )") \
...
void CFMReturnPackageSummaryByDept::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_CHIGOI_TH_THEOKHOA.RPT")))
		return;
...
void CFMReturnPackageSummaryByDept::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummaryByDept::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummaryByDept::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\TONGHOPCHIGOI_THEOKHOA.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOPCHIGOI_THEOKHOA2.xls"));
}
void CFMReturnPackageSummaryByDept::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMReturnPackageSummaryByDept::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMReturnPackageSummaryByDept::OnObjectListDblClick(){
	
}
 
void CFMReturnPackageSummaryByDept::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMReturnPackageSummaryByDept::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMReturnPackageSummaryByDept::OnObjectListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CFMReturnPackageSummaryByDept::OnDeptListDblClick(){
	
}
 
void CFMReturnPackageSummaryByDept::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMReturnPackageSummaryByDept::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMReturnPackageSummaryByDept::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMReturnPackageSummaryByDept::GetQueryString()
{
	...
	if (!szPackages.IsEmpty())
	{
		szWhere.AppendFormat(_T(" and rfl.hfe_itemid in(%s) "), szPackages);
	}
	...
	/*szSQL.Format(_T(" SELECT Get_patientname(rf.hfe_docno) AS pname,") \
	_T("   rf.hfe_docno                       AS docno,") \
	_T("   Hms_Getobjectname(rf.hfe_objectid) AS ObjectName,") \
	_T("   Get_departmentname(rf.hfe_deptid) dept,") \
	_T("   rf.hfe_date receiptdate,") \
	_T("   rfl.hfe_desc  AS hfe_desc,rfl.hfe_quantity as qty,") \
	_T("   rf.hfe_amount AS refundamount") \
	_T(" FROM Hms_Fee_Refund rf") \
	_T(" LEFT JOIN Hms_Fee_Refundline rfl") \
	_T(" ON (rf.hfe_docno    =rfl.hfe_docno") \
	_T(" AND rf.hfe_invoiceno=rfl.hfe_invoiceno)") \
	_T(" LEFT JOIN fa_cash") \
	_T(" ON (rf.hfe_cash_id  =fac_cash_id)") \
	_T(" WHERE rf.hfe_type   ='V'") \
	_T(" AND rfl.hfe_itemid IN ('18','19','20')") \
	_T(" AND FAC_POSTEDDATE between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
	_T(" AND rf.hfe_status   IN ('P', 'R') %s ") \
	_T(" UNION ALL") \
	_T(" SELECT Get_patientname(rf.hfe_docno) AS pname,") \
	_T("   rf.hfe_docno                       AS docno,") \
	_T("   Hms_Getobjectname(rf.hfe_objectid) AS ObjectName,") \
	_T("   Get_departmentname(rf.hfe_deptid) dept,") \
	_T("   rf.hfe_date receiptdate,") \
	...
	_T(" LEFT JOIN fa_cash") \
	_T(" ON (rf.hfe_cash_id  =fac_cash_id)") \
	_T(" WHERE rfl.hfe_itemid IN (select ss_code from sys_sel where ss_id='HMS_SERVICE_PACKAGE')") \
	_T(" AND FAC_POSTEDDATE between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
	_T(" AND rf.hfe_status   IN ('P', 'R') %s ") \
	_T(" ORDER BY dept, receiptdate"), m_szFromDate, m_szToDate, szWhere, m_szFromDate, m_szToDate, szWhere);*/
	szSQL.Format(_T(" SELECT ") \
	_T(" itemid, hfe_desc,dept,") \
	_T(" SUM(qty) AS totalqty,") \
	_T(" SUM(refundamount) AS totalincomeamount") \
	_T(" FROM") \
	_T(" (") \
	_T(" SELECT ") \
	_T("  rfl.hfe_itemid AS itemid,") \
	_T("   rfl.hfe_desc     AS hfe_desc,") \
	_T("   rf.hfe_deptid AS dept,") \
	_T("   rfl.hfe_quantity AS qty,") \
	_T("   rf.hfe_amount    AS refundamount") \
	_T(" FROM Hms_Fee_Refund rf") \
	_T(" LEFT JOIN Hms_Fee_Refundline rfl") \
	_T(" ON (rf.hfe_docno    =rfl.hfe_docno") \
	...
	_T("   rfl.hfe_desc     AS hfe_desc,") \
	//_T("   rf.hfe_deptid AS dept,") \//
	_T("   CASE WHEN rfl.hfe_itemid in (SELECT ss_code FROM sys_sel WHERE ss_id='HMS_SERVICE_PACKAGE' and ss_vndesc='GNLT') then CAST(('Nhà lưu trú') as NVARCHAR2(20)) ELSE Get_departmentname(rf.hfe_deptid) END as dept,") \
	_T("   rfl.hfe_quantity AS qty,") \
	_T("   rf.hfe_amount    AS refundamount") \
	_T(" FROM Hms_Fee_Refund rf") \
	_T(" LEFT JOIN Hms_Fee_Refundline rfl") \
	...
	_T(" ORDER BY dept,itemid"), m_szFromDate, m_szToDate, szWhere, m_szFromDate, m_szToDate, szWhere);
	return szSQL;
}

CString CFMReturnPackageSummaryByDept::GetQueryString1()
{
...
int CFMReturnPackageSummaryByDept::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMReturnPackageSummaryByDept::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMReturnPackageSummaryByDept::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMReturnPackageSummaryByDept::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
