#ifndef FMINSURANCEINCOMEOUTLAY_H
#define FMINSURANCEINCOMEOUTLAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceIncomeOutlay : public CGuiView
{
protected:
...
public:
	...
	CFMInsuranceIncomeOutlay(CWnd *pParent);
	~CFMInsuranceIncomeOutlay();
