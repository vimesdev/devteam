#include "stdafx.h"
#include "FMFeeLossByObjectReport.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReport *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMFeeLossByObjectReport* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReport *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReport *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReport *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReport *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMFeeLossByObjectReport *pVw = (CFMFeeLossByObjectReport *)pWnd;
	pVw->OnPrintSelect();
} 
...
static int _OnAddFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReport*)pWnd)->OnAddFMInsuranceFeeLossReport();
} 
static int _OnEditFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReport*)pWnd)->OnEditFMInsuranceFeeLossReport();
} 
static int _OnDeleteFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReport*)pWnd)->OnDeleteFMInsuranceFeeLossReport();
} 
static int _OnSaveFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReport*)pWnd)->OnSaveFMInsuranceFeeLossReport();
} 
static int _OnCancelFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReport*)pWnd)->OnCancelFMInsuranceFeeLossReport();
} 

static void _OnInsuranceSelectFnc(CWnd *pWnd){
	  ((CFMFeeLossByObjectReport*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	  ((CFMFeeLossByObjectReport*)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd){
	  ((CFMFeeLossByObjectReport*)pWnd)->OnPolicySelect();
}
static void _OnThatthuSelectFnc(CWnd *pWnd){
	 ((CFMFeeLossByObjectReport*)pWnd)->OnThatthuSelect();
}

CFMFeeLossByObjectReport::CFMFeeLossByObjectReport(CWnd* pParent)
{
	m_nDlgWidth = 475;
	m_nDlgHeight = 130;
	SetDefaultValues();
}
CFMFeeLossByObjectReport::~CFMFeeLossByObjectReport()
{
}
void CFMFeeLossByObjectReport::OnCreateComponents()
{
...
void CFMFeeLossByObjectReport::OnInitializeComponents()
{
...
void CFMFeeLossByObjectReport::OnSetWindowEvents(){
...
void CFMFeeLossByObjectReport::OnDoDataExchange(CDataExchange* pDX){
...
void CFMFeeLossByObjectReport::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMFeeLossByObjectReport::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMFeeLossByObjectReport::SetDefaultValues(){
...
int CFMFeeLossByObjectReport::SetMode(int nMode){
...
/*void CFMFeeLossByObjectReport::OnYearChange(){
	
} */
/*void CFMFeeLossByObjectReport::OnYearSetfocus(){
	
} */
/*void CFMFeeLossByObjectReport::OnYearKillfocus(){
	
} */

void CFMFeeLossByObjectReport::OnThatthuSelect(){
	
	
}

void CFMFeeLossByObjectReport::OnInsuranceSelect()
{
		
}
void CFMFeeLossByObjectReport::OnServiceSelect(){
	
}
void CFMFeeLossByObjectReport::OnPolicySelect(){
	
}

int CFMFeeLossByObjectReport::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CFMFeeLossByObjectReport::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMFeeLossByObjectReport::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMFeeLossByObjectReport::OnReportPeriodSetfocus(){
	
}*/
/*void CFMFeeLossByObjectReport::OnReportPeriodKillfocus(){
	
}*/
long CFMFeeLossByObjectReport::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMFeeLossByObjectReport::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMFeeLossByObjectReport::OnFromDateChange(){
	
} */
/*void CFMFeeLossByObjectReport::OnFromDateSetfocus(){
	
} */
/*void CFMFeeLossByObjectReport::OnFromDateKillfocus(){
	
} */
int CFMFeeLossByObjectReport::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMFeeLossByObjectReport::OnToDateChange(){
	
} */
/*void CFMFeeLossByObjectReport::OnToDateSetfocus(){
	
} */
/*void CFMFeeLossByObjectReport::OnToDateKillfocus(){
	
} */
int CFMFeeLossByObjectReport::OnToDateCheckValue()
{
	return 0;
} 
void CFMFeeLossByObjectReport::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMFeeLossByObjectReport::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CFMFeeLossByObjectReport::OnAddFMInsuranceFeeLossReport(){
...
int CFMFeeLossByObjectReport::OnEditFMInsuranceFeeLossReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CFMFeeLossByObjectReport::OnDeleteFMInsuranceFeeLossReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CFMFeeLossByObjectReport::OnSaveFMInsuranceFeeLossReport(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CFMFeeLossByObjectReport::OnCancelFMInsuranceFeeLossReport(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CFMFeeLossByObjectReport::OnFMInsuranceFeeLossReportListLoadData(){
	return 0;
}
