#include "stdafx.h"
#include "FMInsuranceOutlayListSOM.h"
#include "HMSMainFrame.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsuranceOutlayListSOM *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceOutlayListSOM* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceOutlayListSOM *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsuranceOutlayListSOM *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsuranceOutlayListSOM *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceOutlayListSOM* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceOutlayListSOM *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceOutlayListSOM* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceOutlayListSOM *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceOutlayListSOM* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnOrderByKillfocus();
}*/
...
{
	return ((CFMInsuranceOutlayListSOM *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsuranceOutlayListSOM*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceOutlayListSOM*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsuranceOutlayListSOM*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsuranceOutlayListSOM*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsuranceOutlayListSOM*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMInsuranceOutlayListSOM *pVw = (CFMInsuranceOutlayListSOM *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
{
	 ((CFMInsuranceOutlayListSOM*)pWnd)->OnOtherFeeSelect();
}
static int _OnAddFMInsuranceOutlayListFnc(CWnd *pWnd){
	 return ((CFMInsuranceOutlayListSOM*)pWnd)->OnAddFMInsuranceOutlayList();
} 
static int _OnEditFMInsuranceOutlayListFnc(CWnd *pWnd){
	 return ((CFMInsuranceOutlayListSOM*)pWnd)->OnEditFMInsuranceOutlayList();
} 
static int _OnDeleteFMInsuranceOutlayListFnc(CWnd *pWnd){
	 return ((CFMInsuranceOutlayListSOM*)pWnd)->OnDeleteFMInsuranceOutlayList();
} 
static int _OnSaveFMInsuranceOutlayListFnc(CWnd *pWnd){
	 return ((CFMInsuranceOutlayListSOM*)pWnd)->OnSaveFMInsuranceOutlayList();
} 
static int _OnCancelFMInsuranceOutlayListFnc(CWnd *pWnd){
	 return ((CFMInsuranceOutlayListSOM*)pWnd)->OnCancelFMInsuranceOutlayList();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	 ((CFMInsuranceOutlayListSOM*)pWnd)->OnSODSelect();
}

CFMInsuranceOutlayListSOM::CFMInsuranceOutlayListSOM(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMInsuranceOutlayListSOM::~CFMInsuranceOutlayListSOM(){
}
void CFMInsuranceOutlayListSOM::OnCreateComponents()
/*{
	m_wndObjectLabel.Create(this, _T(""), 0, 0, 25, 25);
	m_wndObject.Create(this,0, 0, 25, 25); 
	...
	m_wndPaymentSheet.Create(this, _T(""), 0, 0, 25, 25);
	...
	m_wndSoldierWCard.Create(this, _T("Soldier W Card"), 125, 475, 325, 500);
	m_wndFree.Create(this, _T("Free"), 330, 475, 425, 500);
	m_wndInpatient.Create(this, _T("Inpatient"), 10, 505, 120, 530);
	m_wndOutpatient.Create(this, _T("Outpatient"), 125, 505, 225, 530);
	m_wndDeposit.Create(this, _T("Deposit"), 230, 505, 325, 530);
	...
	m_wndList.Create(this,10, 150, 425, 469);
	m_wndOtherFee.Create(this, _T("OtherFee"), 330, 505, 425, 530);
}*/
{
	m_wndReportCondition.Create(this, _T("Report Condition"), 5, 5, 480, 535);
	m_wndYearLabel.Create(this, _T("Year"), 10, 30, 90, 55);
	m_wndYear.Create(this,95, 30, 230, 55); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 240, 30, 330, 55);
	m_wndReportPeriod.Create(this,335, 30, 470, 55); 
	m_wndFromDateLabel.Create(this, _T("From Date"), 10, 60, 90, 85);
	m_wndFromDate.Create(this,95, 60, 230, 85); 
	m_wndToDate.Create(this,335, 60, 470, 85); 
	m_wndToDateLabel.Create(this, _T("To Date"), 240, 60, 330, 85);
	m_wndClerkLabel.Create(this, _T("Clerk"), 10, 90, 90, 115);
	m_wndClerk.Create(this,95, 90, 230, 115); 
	m_wndOrderByLabel.Create(this, _T("Order By"), 10, 120, 90, 145);
	m_wndOrderBy.Create(this,95, 120, 230, 145); 
	m_wndStatusLabel.Create(this, _T("Status"), 240, 90, 330, 115);
	m_wndStatus.Create(this,335, 90, 470, 115); 
	m_wndList.Create(this,9, 150, 470, 469); 
	m_wndWithoutGeneral.Create(this, _T("Without General"), 10, 475, 120, 500);
	m_wndMarkAll.Create(this, _T("Mark All"), 5, 540, 85, 565);
	m_wndUnMark.Create(this, _T("UnMark"), 90, 540, 170, 565);
	...
	m_wndInpatient.Create(this, _T("Inpatient"), 10, 505, 120, 530);
	m_wndOutpatient.Create(this, _T("Outpatient"), 140, 505, 240, 530);
	m_wndDeposit.Create(this, _T("Deposit"), 245, 505, 340, 530);
	m_wndSoldierWCard.Create(this, _T("Soldier W Card"), 140, 475, 340, 500);
	m_wndFree.Create(this, _T("Free"), 360, 475, 455, 500);
	m_wndOtherFee.Create(this, _T("OtherFee"), 360, 505, 455, 530);
	m_wndSOD.Create(this, _T("SOD"), 240, 120, 470, 145);
}

void CFMInsuranceOutlayListSOM::OnInitializeComponents(){
...
void CFMInsuranceOutlayListSOM::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsuranceOutlayListSOM::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsuranceOutlayListSOM::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsuranceOutlayListSOM::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsuranceOutlayListSOM::SetDefaultValues(){
...
int CFMInsuranceOutlayListSOM::SetMode(int nMode){
...
/*void CFMInsuranceOutlayListSOM::OnYearChange(){
	
} */
/*void CFMInsuranceOutlayListSOM::OnYearSetfocus(){
	
} */
/*void CFMInsuranceOutlayListSOM::OnYearKillfocus(){
	
} */
int CFMInsuranceOutlayListSOM::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsuranceOutlayListSOM::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMInsuranceOutlayListSOM::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsuranceOutlayListSOM::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsuranceOutlayListSOM::OnReportPeriodKillfocus(){
	
}*/
void CFMInsuranceOutlayListSOM::OnOtherFeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
long CFMInsuranceOutlayListSOM::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsuranceOutlayListSOM::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsuranceOutlayListSOM::OnFromDateChange(){
	
} */
/*void CFMInsuranceOutlayListSOM::OnFromDateSetfocus(){
	
} */
/*void CFMInsuranceOutlayListSOM::OnFromDateKillfocus(){
	
} */
int CFMInsuranceOutlayListSOM::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsuranceOutlayListSOM::OnToDateChange(){
	
} */
/*void CFMInsuranceOutlayListSOM::OnToDateSetfocus(){
	
} */
/*void CFMInsuranceOutlayListSOM::OnToDateKillfocus(){
	
} */
int CFMInsuranceOutlayListSOM::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsuranceOutlayListSOM::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsuranceOutlayListSOM::OnClerkSelendok(){
	 
}
/*void CFMInsuranceOutlayListSOM::OnClerkSetfocus(){
	
}*/
/*void CFMInsuranceOutlayListSOM::OnClerkKillfocus(){
	
}*/
long CFMInsuranceOutlayListSOM::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsuranceOutlayListSOM::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsuranceOutlayListSOM::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsuranceOutlayListSOM::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsuranceOutlayListSOM::OnStatusSetfocus(){
	
}*/
/*void CFMInsuranceOutlayListSOM::OnStatusKillfocus(){
	
}*/
long CFMInsuranceOutlayListSOM::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsuranceOutlayListSOM::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsuranceOutlayListSOM::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsuranceOutlayListSOM::OnOrderBySelendok(){
	 
}
/*void CFMInsuranceOutlayListSOM::OnOrderBySetfocus(){
	
}*/
/*void CFMInsuranceOutlayListSOM::OnOrderByKillfocus(){
	
}*/
long CFMInsuranceOutlayListSOM::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsuranceOutlayListSOM::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMInsuranceOutlayListSOM::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
	void CFMInsuranceOutlayListSOM::OnSODSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
void CFMInsuranceOutlayListSOM::OnListDblClick(){
...
void CFMInsuranceOutlayListSOM::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsuranceOutlayListSOM::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsuranceOutlayListSOM::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsuranceOutlayListSOM::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsuranceOutlayListSOM::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMInsuranceOutlayListSOM::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnPrint3rdver();
	return;
...
void CFMInsuranceOutlayListSOM::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	data_name.Add(_T("pol_payment_payment"));
...
int CFMInsuranceOutlayListSOM::OnAddFMInsuranceOutlayList(){
...
int CFMInsuranceOutlayListSOM::OnEditFMInsuranceOutlayList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsuranceOutlayListSOM::OnDeleteFMInsuranceOutlayList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsuranceOutlayListSOM::OnSaveFMInsuranceOutlayList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsuranceOutlayListSOM::OnCancelFMInsuranceOutlayList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsuranceOutlayListSOM::OnFMInsuranceOutlayListListLoadData(){
	return 0;
}



void CFMInsuranceOutlayListSOM::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
...
void CFMInsuranceOutlayListSOM::OnPrint2ndver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsuranceOutlayListSOM::OnPrint3rdver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, tmpStr2, szTemp, szPos;
	CString szSysDate;
	...
	if (!rpt.Init(_T("Reports/HMS/HF_BANGKETHANHTOANCHIBENHNHANBHYT_1PTTYC.RPT")))
		return;
	StringUpper(pMF->m_szHealthService, tmpStr);
	rpt.GetReportHeader()->SetValue(_T("HEALTHSERVICE"), tmpStr);
	...
	CString szOldLine, szNewLine;
	CStringArray data_name;
	double nTotal[20], nGrpTotal[20], nTotalFa = 0, nTotalOtherpayment = 0, nGrpFa = 0, nGrpOtherpayment = 0;
	double nCost = 0, nOther_payment = 0, nFa = 0;
	int nIndex = 1;
//_tprintf(_T("Init"));
	for (int i = 0; i < 20; i++)
...
//_tprintf(_T("Footer"));
	...
	if (tmpStr2.Find(',') != -1) 
		szSysDate.Format(tmpStr2, tmpStr.Mid(11, 5), tmpStr.Mid(8, 2), tmpStr.Mid(5,2), tmpStr.Left(4));
	else
		szSysDate.Format(tmpStr2, tmpStr.Mid(8, 2), tmpStr.Mid(5,2), tmpStr.Left(4));
	rpt.GetReportFooter()->SetValue(_T("PrintDate"), szSysDate);
	tmpStr.Format(_T("%.3f"), nTotal[sum_pos]);
	rpt.GetReportFooter()->SetValue(_T("TT13"), tmpStr);
...
CString CFMInsuranceOutlayListSOM::GetQueryString(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL, szWhere;
...
CString CFMInsuranceOutlayListSOM::GetQueryString2(){
	CString szSQL, szWhere;
...
CString CFMInsuranceOutlayListSOM::GetQueryString3(){
	CString szSQL, szWhere;
	...
	if (m_bOtherFee) szWhere.AppendFormat(_T(" HAVING SUM(chi_vienphi + chi_vattu + chi_maycnc + chi_thuoc)>0"));
	//Update 20/04/2017
	...
	_T("   SUM(hfe_examfee)               AS phi_kham,") \
	_T("   SUM(hfe_bedfee)                AS phi_giuong,") \
	_T("   SUM(hfe_operation)             AS phi_pttt,") \
	_T("   SUM(hfe_lis)                   AS phi_xetnghiem,") \
	_T("   SUM(hfe_pacs)                  AS phi_cdha,") \
	_T("   SUM(hfe_hitechmachine) thu_maycnc,") \
	_T("   SUM(hfe_miengiam)              AS fa,") \
	_T("   SUM(hfe_drugfee)               AS phi_thuoc,") \
	_T("   SUM(hfe_materialfee)           AS phi_vtth,") \
	_T("   SUM(hfe_foodamount)            AS fee_food,") \
	_T("   SUM(hfe_otherfeeatdept)        AS phi_khac,") \
	...
	_T("             WHERE f.hfe_docno                 = i.hfe_docno") \
	_T("             AND f.hfe_invoiceno               = i.hfe_invoiceno") \
	_T("             AND F.HFE_ITEMID = HFL_FEEID AND hfl_hitechmachine <> 'Y'") \
	_T("             AND f.hfe_type                    ='O'") \
	_T("             AND f.hfe_status                 IN( 'P', 'R' )") \
	_T("             AND NVL(f.hfe_category, 'N') NOT IN( 'Y' )") \
	_T("             )") \
	...
	_T("           WHEN i.hfe_class = 'I'") \
	_T("           THEN") \
	_T("             (SELECT Coalesce(SUM(f.hfe_patpaid-(f.hfe_inspaid-f.hfe_discount)), 0) FROM   HMS_FEE F, ") \
	_T("             m_product_item, m_product, hms_pharmaorder_view pv ") \
	_T("             WHERE pv.hpo_docno = f.hfe_docno AND pv.hpo_orderid = f.hfe_orderid") \
	_T("             AND F.HFE_DOCNO = I.HFE_DOCNO AND F.HFE_INVOICENO = I.HFE_INVOICENO             ") \
	_T("             AND F.HFE_STATUS IN( 'P', 'R' ) ") \
