#ifndef FMTESTCOVID19NGUOINHA_H
#define FMTESTCOVID19NGUOINHA_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTestCovid19NguoinhaReport : public CGuiView
{
...
public:
	...
	void			OnNoitruSelect(); 
	CFMTestCovid19NguoinhaReport(CWnd* pParent);
	~CFMTestCovid19NguoinhaReport();
