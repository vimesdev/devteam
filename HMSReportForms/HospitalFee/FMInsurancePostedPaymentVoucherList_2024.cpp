#include "stdafx.h"
#include "FMInsurancePostedPaymentVoucherList_2024.h"
#include "HMSMainFrame.h"
#include "StringToken.h"
#include "FMFinancialDocumentPrinter.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherList_2024* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherList_2024* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherList_2024* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherList_2024* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMInsurancePostedPaymentVoucherList_2024 *pVw = (CFMInsurancePostedPaymentVoucherList_2024 *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static int _OnAddFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnAddFMInsurancePostedPaymentVoucherList();
} 
static int _OnEditFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnEditFMInsurancePostedPaymentVoucherList();
} 
static int _OnDeleteFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnDeleteFMInsurancePostedPaymentVoucherList();
} 
static int _OnSaveFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnSaveFMInsurancePostedPaymentVoucherList();
} 
static int _OnCancelFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnCancelFMInsurancePostedPaymentVoucherList();
} 
static void _OnSODSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnSODSelect();
}
static void _OnServicePackageSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnServicePackageSelect();
}
static void _OnBHKhacSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnBHKhacSelect();
}
static void _OnBHQuanSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnBHQuanSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnABZoneSelect();
}
static void _OnATMCardSelectFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnATMCardSelect();
}

static int _OnListCheckAllCardTYCFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllCardTYC();
	return 0;
}
static void _OnAllInsSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnAllInsSelect();
}
static void _OnByMoneyTransferSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnByMoneyTransferSelect();
}
static void _OnTCKTSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnTCKTSelect();
}

static int _OnListCheckAllCKTYCFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllCKTYC();
	return 0;
}

static int _OnListCheckAllPTTYCTYCFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllPTTYCTYC();
	return 0;
}

static int _OnListCheckAllTTTMFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllTTTM();
	return 0;
}

static int _OnListCheckAllKBA16Fnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListCheckAllKBA16();
	return 0;
}

static int _OnListUnCheckAllTYC_PTTYC_KBA16Fnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListUnCheckAllTYC_PTTYC_KBA16();
	return 0;
}

static int _OnListUnCheckAllATMCKTYCFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnListUnCheckAllATMCKTYC();
	return 0;
}
static long _OnDeptListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnDeptListLoadData();
}

static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnAllObjSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnServiceSelect();
}

static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnDeptListUnCheckAll();
}

static void _OnQrOnlineSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnQrOnlineSelect();
}

static long _OnhtttLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnhtttLoadData();
}

static void _OnhtttSelendokFnc(CWnd *pWnd)
{
	((CFMInsurancePostedPaymentVoucherList_2024 *)pWnd)->OnhtttSelendok();
}

static void _OnOtherObjSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherList_2024*)pWnd)->OnOtherObjSelect();
}

CFMInsurancePostedPaymentVoucherList_2024::CFMInsurancePostedPaymentVoucherList_2024(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
...
CFMInsurancePostedPaymentVoucherList_2024::~CFMInsurancePostedPaymentVoucherList_2024()
{
}
void CFMInsurancePostedPaymentVoucherList_2024::OnCreateComponents()
	{
...
void CFMInsurancePostedPaymentVoucherList_2024::OnInitializeComponents(){
	...
	m_wndList.InsertColumn(1, _T("Payment No"), CFMT_TEXT, 100);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
*/
	...
	m_mIndex[_T("XXIII")] = _T("Dịch vụ ngoại trú");
	m_mIndex[_T("XXIV")] = _T("Dịch vụ nội trú");
...
void CFMInsurancePostedPaymentVoucherList_2024::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsurancePostedPaymentVoucherList_2024::GetDataToScreen()
{
...
void CFMInsurancePostedPaymentVoucherList_2024::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePostedPaymentVoucherList_2024::SetDefaultValues(){
...
int CFMInsurancePostedPaymentVoucherList_2024::SetMode(int nMode){
...
/*void CFMInsurancePostedPaymentVoucherList_2024::OnYearChange(){
	
} */
/*void CFMInsurancePostedPaymentVoucherList_2024::OnYearSetfocus(){
	
} */
/*void CFMInsurancePostedPaymentVoucherList_2024::OnYearKillfocus(){
	
} */
int CFMInsurancePostedPaymentVoucherList_2024::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
void CFMInsurancePostedPaymentVoucherList_2024::OnServicePackageSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();		
}

void CFMInsurancePostedPaymentVoucherList_2024::OnTCKTSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
 
void CFMInsurancePostedPaymentVoucherList_2024::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePostedPaymentVoucherList_2024::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherList_2024::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherList_2024::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePostedPaymentVoucherList_2024::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePostedPaymentVoucherList_2024::OnFromDateChange(){
	
} */
/*void CFMInsurancePostedPaymentVoucherList_2024::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePostedPaymentVoucherList_2024::OnFromDateKillfocus(){
	
} */
int CFMInsurancePostedPaymentVoucherList_2024::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePostedPaymentVoucherList_2024::OnToDateChange(){
	
} */
/*void CFMInsurancePostedPaymentVoucherList_2024::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePostedPaymentVoucherList_2024::OnToDateKillfocus(){
	
} */
int CFMInsurancePostedPaymentVoucherList_2024::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePostedPaymentVoucherList_2024::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedPaymentVoucherList_2024::OnClerkSelendok(){
	 
}

void CFMInsurancePostedPaymentVoucherList_2024::OnhtttSelendok()
{
	 OnListLoadData();
}
/*void CFMInsurancePostedPaymentVoucherList_2024::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherList_2024::OnClerkKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherList_2024::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePostedPaymentVoucherList_2024::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePostedPaymentVoucherList_2024::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedPaymentVoucherList_2024::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePostedPaymentVoucherList_2024::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherList_2024::OnStatusKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherList_2024::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePostedPaymentVoucherList_2024::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePostedPaymentVoucherList_2024::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedPaymentVoucherList_2024::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePostedPaymentVoucherList_2024::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherList_2024::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherList_2024::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePostedPaymentVoucherList_2024::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePostedPaymentVoucherList_2024::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsurancePostedPaymentVoucherList_2024::OnListDblClick(){
...
void CFMInsurancePostedPaymentVoucherList_2024::OnListSelectChange(int nOldItem, int nNewItem)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePostedPaymentVoucherList_2024::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
void CFMInsurancePostedPaymentVoucherList_2024::OnSODSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	//OnListLoadData();
}

void CFMInsurancePostedPaymentVoucherList_2024::OnABZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	OnListLoadData();
}

void CFMInsurancePostedPaymentVoucherList_2024::OnATMCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	OnListLoadData();
}
void CFMInsurancePostedPaymentVoucherList_2024::OnBHKhacSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsurancePostedPaymentVoucherList_2024::OnAllInsSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
	void CFMInsurancePostedPaymentVoucherList_2024::OnBHQuanSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsurancePostedPaymentVoucherList_2024::OnByMoneyTransferSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
    }

void CFMInsurancePostedPaymentVoucherList_2024::OnQrOnlineSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}

long CFMInsurancePostedPaymentVoucherList_2024::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);	
	CGuiMenu menu(this);
...
int CFMInsurancePostedPaymentVoucherList_2024::OnAddFMInsurancePostedPaymentVoucherList(){
...
int CFMInsurancePostedPaymentVoucherList_2024::OnEditFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePostedPaymentVoucherList_2024::OnDeleteFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsurancePostedPaymentVoucherList_2024::OnSaveFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsurancePostedPaymentVoucherList_2024::OnCancelFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePostedPaymentVoucherList_2024::OnFMInsurancePostedPaymentVoucherListListLoadData(){
	return 0;
}

void CFMInsurancePostedPaymentVoucherList_2024::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrint3rdver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrintATM()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrint4rdver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnExportSelect()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	HMENU hSubMenu = NULL;
	...
	TranslateString(_T("Export chi tiết bảng kê theo số HS 2024"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 3, tmpStr);	
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString3()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;

	CString szOrderBy;
	CString szPaymentStr = _T("-1");
	int nCount = 0;
	for (int i = 0 ; i < m_wndList.GetItemCount(); i++)
	{
	...
	m_szCashIDS = szPaymentStr;
	m_szCashIDS.Replace(_T("-1,"), _T(""));
	if (nCount <1000)
		szWhere.Format(_T(" and cash_id in(%s) "), szPaymentStr);
	else
	{
		CStringToken tok_id(szPaymentStr);
		int nCount = 0;
		long nTemp = 0;
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString4()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString()
{
	...
	szSQL.Format(_T(" SELECT    NVL(trim(get_username(fac_user_id)), fac_user_id) user_name, ") \
				...
				_T("           SUM(hfe_amount+hfe_otherPayment) tong_vien_phi, ") \
				...
				_T("           SUM(hfe_otherPayment) thu_khac, ") \
				_T("           round(SUM( hfe_patpaid1 +  hfe_diffcost +hfe_foodamount ") \
				_T("             + hfe_otherPayment)) AS cong, ") \
				_T("           SUM(hfe_tamgui) tam_gui, ") \
				_T("           SUM(hfe_ngoaitru) ngoai_tru, ") \
				_T("           round(SUM( hfe_patpaid1 +  hfe_diffcost + hfe_foodamount ") \
				_T("             + hfe_otherPayment + hfe_tamgui  - hfe_deposit )) AS cong_thu ") \
				_T(" FROM      fa_cash ") \
				_T(" LEFT JOIN ") \
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString2(){
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrintFooterUser(CReportSection* rptFooter)
{
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrintSummaryReceipt(double nTotalAmount)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	...
	if (m_nAllObj == 0)
		{
			tmpStr += _T("- Tất cả các đối tượng");
		}
		else if (m_nService == 0)
		{
			tmpStr += _T("- Dịch vụ y tế");
		}
		else if (m_nOtherObj == 0)
		{
			tmpStr += _T("- Quân, chính sách");
		}

		else if (m_nInsurance == 0)
		{
			tmpStr += _T("- Bảo hiểm y tế");
		}
		else
		{
			tmpStr += _T(" ");
		...
		if (m_bSOD)
		{
			tmpStr += _T("- Khám bệnh theo yêu cầu");
		}
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllCardTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllCKTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListUnCheckAllATMCKTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrint3rdver_2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::PrintFinancialDocument()
{
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString3_2()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString_check()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrint5rdver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString5()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrint3rdver_Detail(bool bmau1, bool bmau2, bool bmau3, bool bmau4, bool bmau5)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString3_detail(bool str1, bool str2, bool str3, bool str4, bool str5)
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
void CFMInsurancePostedPaymentVoucherList_2024::PrintFinancialDocument_Detail(bool bmau1, bool bmau2, bool bmau3, bool bmau4, bool bmau5)
{
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnPrint3rdver_2024()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n1"));
	...
	data_name.Add(_T("tong_cong_thu_chi"));
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString3_2024()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType, szDepts, szIndex;
	CString szOrderBy;
	...
	/*	szSQL.Format(_T("SELECT * ") \
		_T(" FROM V_INSPOSTPAYMENTSUMMARY_VL2_L5 ") \
	...
	else
	{
		...
		_T("   SUM(TL_HFE_PHIKHAM)       AS TL_HFE_PHIKHAM,") \
		_T("   SUM(TL_HFE_PHIGIUONG)     AS TL_HFE_PHIGIUONG,") \
		_T("   SUM(TL_HFE_PHICLS)        AS TL_HFE_PHICLS,") \
		_T("   SUM(TL_HFE_PHIPTTT)       AS TL_HFE_PHIPTTT,") \
		_T("   SUM(TL_DRUG_FEE)          AS TL_DRUG_FEE,") \
		_T("   SUM(TL_MAT_FEE)           AS TL_MAT_FEE,") \
		_T("   SUM(TL_DRUG_FEE_B5)       AS TL_DRUG_FEE_B5,") \
		_T("   SUM(TL_MAT_FEE_B5)        AS TL_MAT_FEE_B5,") \
		_T("   SUM(TL_PHI_MAU)           AS TL_PHI_MAU,") \
		_T("   SUM(TL_TIEN_AN)           AS TL_TIEN_AN,") \
		_T("   SUM(TL_THU_GOIDV)         AS TL_THU_GOIDV,") \
		_T("   SUM(TL_HFE_PHI_CHONBS)    AS TL_HFE_PHI_CHONBS,") \
		_T("   SUM(TL_HFE_PHI_KHAC)      AS TL_HFE_PHI_KHAC,") \
		_T("   SUM(TL_TAMGUI)            AS TL_TAMGUI,") \
		_T("   SUM(tran_bao_viet)        AS tran_bao_viet,") \
		_T("   SUM(TONG_CHI_TOTAL)       AS cong_chi,") \
		_T("   SUM(TONG_CHI_DETAIL)      AS cong_chi_chitiet, ") \
		_T("   SUM(TONG_CHI_TOTAL + tong_vien_phi) AS tong_cong_thu_chi ") \
		_T(" FROM V_INSPOSTPAYMENTSUMMARY_VL2_L5") \
		_T(" WHERE fac_cash_id > 0 %s ")
		_T(" GROUP BY user_name,") \
		_T("   fac_cash_id,") \
		_T("   fac_invoiceno,") \
		_T("   hfe_index ORDER BY hfe_index, user_name, fac_cash_id "), szWhere );
		//_msg(_T("%s"), szSQL);
	return szSQL;
}
void CFMInsurancePostedPaymentVoucherList_2024::OnExportSelect_V1()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherList_2024::OnExportSelect_V2()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDay, szNewDay;
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString_check_V2()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
long CFMInsurancePostedPaymentVoucherList_2024::OnDeptListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnAllObjSelect()
{
	UpdateData(true);
	m_nAllObj = 0;
	m_nService =1;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnInsuranceSelect()
{
	UpdateData(true);
	m_nAllObj = 1;
	m_nService =1;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnServiceSelect()
{
	UpdateData(true);
	m_nAllObj = 1;
	m_nService =0;
...
void CFMInsurancePostedPaymentVoucherList_2024::OnOtherObjSelect()
{
...
int CFMInsurancePostedPaymentVoucherList_2024::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMInsurancePostedPaymentVoucherList_2024::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
long CFMInsurancePostedPaymentVoucherList_2024::OnhtttLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllPTTYCTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllTTTM()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListCheckAllKBA16()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePostedPaymentVoucherList_2024::OnListUnCheckAllTYC_PTTYC_KBA16()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
	...
	{
		szItemText=m_wndDeptList.GetItemText(i,0);
	if ((_T("KB_A16"))==szItemText || (_T("PTTYC"))==szItemText || (_T("TYC"))==szItemText 
		|| (_T("TMNT"))==szItemText || (_T("TTTM"))==szItemText || (_T("KSK"))==szItemText)
	{
		m_wndDeptList.SetCheck(i, false);
		nCheck++;		
	}	
...
void CFMInsurancePostedPaymentVoucherList_2024::OnExportSelect_V3()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\Template\\BANGKECHI_THEO_DOITUONG_2024.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	while(!rs.IsEOF())
	{
		...
		{
			if (nGroupTotal[36] + nGroupTotal[3] > 0)
			{
		...
		rs.GetValue(_T("TL_TAMGUI"), nTemp);
		...
		rs.GetValue(_T("cong_chi_chitiet"), nTemp);
		nGroupTotal[37] += nTemp;
		xls.SetCellText(nCol+37, nRow, double2str(nTemp), FMT_NUMBER1);		
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANGKECHI_THEO_DOITUONG_2024_2.xls"));
}

void CFMInsurancePostedPaymentVoucherList_2024::OnExportSelect_V4()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\Template\\BANGKECHI_THEO_DOITUONG_CHITIET_2024.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	xls.SetActiveSheet(0);
	EndWaitCursor();
	xls.Save(_T("Exports\\BANGKECHI_THEO_DOITUONG_CHITIET_2024_2.xls"));
}

CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString3_2024_ct()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType, szDepts, szIndex;
	CString szOrderBy;
	...
	else
	{
		...
		_T("   SUM(tran_bao_viet)        AS tran_bao_viet,") \
		_T("   SUM(TONG_CHI_TOTAL)       AS cong_chi,") \
		_T("   SUM(TONG_CHI_DETAIL-TL_TAMGUI)       AS cong_chi_chitiet") \
		_T(" FROM V_INSPOSTPAYMENTSUMMARY_VL2_CT") \
		_T(" WHERE fac_cash_id > 0 %s ")
		_T(" GROUP BY user_name,") \
		_T("   fac_cash_id,") \
		_T("   fac_invoiceno,docno, ") \
		_T("   hfe_index ORDER BY hfe_index, docno "), szWhere );
		//_msg(_T("%s"), szSQL);
	return szSQL;
}
...
void CFMInsurancePostedPaymentVoucherList_2024::OnExportSelect_V5()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	szSQL = GetQueryString3_2024_ct_hoso();	
	_msg(_T("Chi tiết theo số hồ sơ"));
	rs.ExecSQL(szSQL);	
...
CString CFMInsurancePostedPaymentVoucherList_2024::GetQueryString3_2024_ct_hoso()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType, szDepts, szIndex;
	CString szOrderBy;
	...
	else
	{
		...
		_T("   SUM(TONG_CHI_DETAIL-TL_TAMGUI)       AS cong_chi_chitiet") \
		_T(" FROM V_INSPOSTPAYMENTSUMMARY_VL2_CT") \
		_T(" WHERE fac_cash_id > 0 %s AND (TONG_CHI_DETAIL-TL_TAMGUI) > 0 ")
		_T(" GROUP BY docno ") \
