#include "stdafx.h"
#include "FMApprovedDischargedInsPatient.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMApprovedDischargedInsPatient *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMApprovedDischargedInsPatient* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMApprovedDischargedInsPatient *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMApprovedDischargedInsPatient *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMApprovedDischargedInsPatient *)pWnd)->OnToDateCheckValue();
} 
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMApprovedDischargedInsPatient* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMApprovedDischargedInsPatient *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CFMApprovedDischargedInsPatient *)pWnd)->OnDeptAddNew();
}*/
static long _OnSuggestionLoadDataFnc(CWnd *pWnd){
	return ((CFMApprovedDischargedInsPatient*)pWnd)->OnSuggestionLoadData();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMApprovedDischargedInsPatient *pVw = (CFMApprovedDischargedInsPatient *)pWnd;
	pVw->OnPrintSelect();
} 
...
static void _OnExamSelectFnc(CWnd *pWnd){
	 ((CFMApprovedDischargedInsPatient*)pWnd)->OnExamSelect();
}
static void _OnInwardSelectFnc(CWnd *pWnd){
	 ((CFMApprovedDischargedInsPatient*)pWnd)->OnInwardSelect();
}
CFMApprovedDischargedInsPatient::CFMApprovedDischargedInsPatient(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMApprovedDischargedInsPatient::~CFMApprovedDischargedInsPatient(){
}
void CFMApprovedDischargedInsPatient::OnCreateComponents(){
...
void CFMApprovedDischargedInsPatient::OnInitializeComponents(){
...
void CFMApprovedDischargedInsPatient::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMApprovedDischargedInsPatient::OnDoDataExchange(CDataExchange* pDX){
...
void CFMApprovedDischargedInsPatient::SetDefaultValues(){
...
int CFMApprovedDischargedInsPatient::SetMode(int nMode){
...
/*void CFMApprovedDischargedInsPatient::OnYearChange(){
	
} */
/*void CFMApprovedDischargedInsPatient::OnYearSetfocus(){
	
} */
/*void CFMApprovedDischargedInsPatient::OnYearKillfocus(){
	
} */
int CFMApprovedDischargedInsPatient::OnYearCheckValue(){
	return 0;
} 
void CFMApprovedDischargedInsPatient::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMApprovedDischargedInsPatient::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMApprovedDischargedInsPatient::OnReportPeriodSetfocus(){
	
}*/
/*void CFMApprovedDischargedInsPatient::OnReportPeriodKillfocus(){
	
}*/
long CFMApprovedDischargedInsPatient::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMApprovedDischargedInsPatient::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMApprovedDischargedInsPatient::OnFromDateChange(){
	
} */
/*void CFMApprovedDischargedInsPatient::OnFromDateSetfocus(){
	
} */
/*void CFMApprovedDischargedInsPatient::OnFromDateKillfocus(){
	
} */
int CFMApprovedDischargedInsPatient::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMApprovedDischargedInsPatient::OnToDateChange(){
	
} */
/*void CFMApprovedDischargedInsPatient::OnToDateSetfocus(){
	
} */
/*void CFMApprovedDischargedInsPatient::OnToDateKillfocus(){
	
} */
int CFMApprovedDischargedInsPatient::OnToDateCheckValue(){
	return 0;
} 
void CFMApprovedDischargedInsPatient::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMApprovedDischargedInsPatient::OnDeptSelendok(){
	 
}
/*void CFMApprovedDischargedInsPatient::OnDeptSetfocus(){
	
}*/
/*void CFMApprovedDischargedInsPatient::OnDeptKillfocus(){
	
}*/
long CFMApprovedDischargedInsPatient::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMApprovedDischargedInsPatient::OnDeptAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMApprovedDischargedInsPatient::OnSuggestionLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMApprovedDischargedInsPatient::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMApprovedDischargedInsPatient::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CExcel xls;
	...
	tmpStr = _T("\x44\x41NH S\xC1\x43H \x42N \x42H R\x41 VI\x1EC6N \x43H\x1AF\x41 TH\x41NH TO\xC1N");
	...
	xls.Save(_T("Exports\\Danh sach BN BH ra vien chua thanh toan.xls"));
	
} 
void CFMApprovedDischargedInsPatient::OnExamSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
}
void CFMApprovedDischargedInsPatient::OnInwardSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_wndSuggestion.EnableWindow(m_bInward);
}

CString CFMApprovedDischargedInsPatient::GetQueryString(){
	...
	szIESQL.Format(_T(" SELECT    Get_patientname(hfe_docno) patient_name, ") \
				...
				_T(" WHERE     hcr_status = 'T' AND hfe_status = 'A' AND hfe_discount > 0  ") \
