...
{	
	...
	m_wndList.Create(this,10, 150, 425, 439); 
	...
	m_wndOutpatient.Create(this, _T("Outpatient"), 125, 475, 225, 500);
	m_wndDeposit.Create(this, _T("Deposit"), 230, 476, 325, 501);
	m_wndSoldierWCard.Create(this, _T("Soldier W Card"), 125, 445, 325, 470);
	m_wndFree.Create(this, _T("Free"), 330, 446, 425, 471);
	m_wndOtherFee.Create(this, _T("OtherFee"), 330, 476, 425, 501);
	m_wndIncomePackage.Create(this, _T("IncomePackage"), 11, 506, 121, 531);
	m_wndOutLayPackage.Create(this, _T("OutLayPackage"), 125, 506, 225, 531);
	m_wndSOD.Create(this, _T("SOD"), 240, 120, 470, 145);
}
...
long CFMInsuranceOutlayList::OnListLoadData()
{
	...
	szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('BH-NT','BH-NG', 'QUAN-NT', 'QUAN-NG')"));
...
//_tprintf(_T("Init"));
	...
	//7.data_name.Add(_T("inspaid"));
	//8.data_name.Add(_T("pat_paid"));
	//9.data_name.Add(_T("diff_cost"));
...
CString CFMInsuranceOutlayList::GetQueryString3()
{
	...
	_T("   SUM(hfe_otherpayment) AS other_payment,") \
	_T("   SUM(hfe_miengiam) AS fa,") \
	_T("   SUM(hfe_patpaid - hfe_foodamount - hfe_hitechmachine - hfe_policyamount - hfe_miengiam-hfe_packageamount) vien_phi,") \
	...
	_T("		chi_de_muc,") \
	_T("	   (SELECT coalesce(sum(r.hfe_cost), 0) FROM hms_fee_refundline r WHERE r.hfe_invoiceno = i.hfe_invoiceno AND r.hfe_docno = i.hfe_docno AND r.hfe_itemid IN ('16','17','18','19')) ") \
	_T("		chi_khac,") \
