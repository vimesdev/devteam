#include "stdafx.h"
#include "FMInsurancePostedPaymentVoucherListRGSOM.h"
#include "HMSMainFrame.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherListRGSOM* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherListRGSOM* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherListRGSOM* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedPaymentVoucherListRGSOM* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMInsurancePostedPaymentVoucherListRGSOM *pVw = (CFMInsurancePostedPaymentVoucherListRGSOM *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnAddFMInsuranceIncomeList();
} 
static int _OnEditFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnEditFMInsuranceIncomeList();
} 
static int _OnDeleteFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnDeleteFMInsuranceIncomeList();
} 
static int _OnSaveFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnSaveFMInsuranceIncomeList();
} 
static int _OnCancelFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnCancelFMInsuranceIncomeList();
}
static void _OnSODSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePostedPaymentVoucherListRGSOM*)pWnd)->OnSODSelect();
}

CFMInsurancePostedPaymentVoucherListRGSOM::CFMInsurancePostedPaymentVoucherListRGSOM(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMInsurancePostedPaymentVoucherListRGSOM::~CFMInsurancePostedPaymentVoucherListRGSOM()
{
}
void CFMInsurancePostedPaymentVoucherListRGSOM::OnCreateComponents(){
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnInitializeComponents(){
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsurancePostedPaymentVoucherListRGSOM::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePostedPaymentVoucherListRGSOM::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePostedPaymentVoucherListRGSOM::SetDefaultValues(){
...
int CFMInsurancePostedPaymentVoucherListRGSOM::SetMode(int nMode){
...
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnYearChange(){
	
} */
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnYearSetfocus(){
	
} */
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnYearKillfocus(){
	
} */
int CFMInsurancePostedPaymentVoucherListRGSOM::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMInsurancePostedPaymentVoucherListRGSOM::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherListRGSOM::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnFromDateChange(){
	
} */
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnFromDateKillfocus(){
	
} */
int CFMInsurancePostedPaymentVoucherListRGSOM::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnToDateChange(){
	
} */
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnToDateKillfocus(){
	
} */
int CFMInsurancePostedPaymentVoucherListRGSOM::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePostedPaymentVoucherListRGSOM::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedPaymentVoucherListRGSOM::OnClerkSelendok(){
	 
}
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnClerkKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherListRGSOM::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePostedPaymentVoucherListRGSOM::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedPaymentVoucherListRGSOM::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnStatusKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherListRGSOM::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePostedPaymentVoucherListRGSOM::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedPaymentVoucherListRGSOM::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePostedPaymentVoucherListRGSOM::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return 0;
...
/*void CFMInsurancePostedPaymentVoucherListRGSOM::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMInsurancePostedPaymentVoucherListRGSOM::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
	void CFMInsurancePostedPaymentVoucherListRGSOM::OnSODSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
void CFMInsurancePostedPaymentVoucherListRGSOM::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsurancePostedPaymentVoucherListRGSOM::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePostedPaymentVoucherListRGSOM::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsurancePostedPaymentVoucherListRGSOM::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnInpatientSelect(){
	
}
void CFMInsurancePostedPaymentVoucherListRGSOM::OnOutpatientSelect(){
	
}
void CFMInsurancePostedPaymentVoucherListRGSOM::OnDepositSelect(){
	
}
void CFMInsurancePostedPaymentVoucherListRGSOM::OnAllSelect(){
	
}
 
 
int CFMInsurancePostedPaymentVoucherListRGSOM::OnAddFMInsuranceIncomeList(){
...
int CFMInsurancePostedPaymentVoucherListRGSOM::OnEditFMInsuranceIncomeList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePostedPaymentVoucherListRGSOM::OnDeleteFMInsuranceIncomeList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsurancePostedPaymentVoucherListRGSOM::OnSaveFMInsuranceIncomeList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsurancePostedPaymentVoucherListRGSOM::OnCancelFMInsuranceIncomeList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePostedPaymentVoucherListRGSOM::OnFMInsuranceIncomeListListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsurancePostedPaymentVoucherListRGSOM::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnPrint3rdver();
	return;
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnPrint2ndver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnPrint3rdver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CReport rpt;
	...
	CStringArray data_name;
	long double nTotal[13], nGroupTotal1[13];
	for (int i = 0; i < 13; i++)
	{
		nGroupTotal1[i] = 0;
		nTotal[i] = 0;
	}
	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOCHI_BHYT_RG_1PTTYC.RPT");
	if (!rpt.Init(szReportName))
		return;
...
void CFMInsurancePostedPaymentVoucherListRGSOM::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMInsurancePostedPaymentVoucherListRGSOM::GetQueryString3(){
	...
	_T("     i.hfe_discount,") \
	_T("	 i.hfe_patpaid,") \
	_T("       CASE WHEN i.hfe_class = 'I' THEN (SELECT COALESCE(SUM(f.hfe_patpaid-(f.hfe_inspaid-f.hfe_discount)), 0) FROM hms_fee f WHERE f.hfe_docno = i.hfe_docno AND f.hfe_invoiceno = i.hfe_invoiceno AND f.hfe_type = 'F' AND SUBSTR(f.hfe_group, 1,2)='FF' AND f.hfe_status IN( 'P', 'R' ) AND NVL(f.hfe_category, 'N') NOT IN( 'Y', 'BBV', 'BQP' ) ) ELSE 0 END ") \
...
//Convert from D.III.4.1
	...
	_T("     THEN SUM(hfe_deposit  + ref_deposit+hfe_otherpayment +hfe_miengiam - (hfe_patpaid - (hfe_policyamount+ chi_vienphi+chi_khac + chi_maycnc + chi_tienan)))") \
	_T("     ELSE SUM(chi_vienphi + chi_khac + chi_maycnc + chi_tienan)") \
	_T("   END cong_chi,") \
	_T("   SUM(hfe_hitechmachine) thu_maycnc,") \
	_T("   SUM(chi_vienphi) chi_vienphi, ") \
	_T("   SUM(chi_tienan) chi_tienan,") \
	_T("   SUM(chi_maycnc) chi_maycnc,    ") \
	...
	_T("     AND r.hfe_docno       = i.hfe_docno") \
	_T("     AND r.hfe_itemid     IN ('10','12','13','14','16')") \
	_T("     ) chi_vienphi,") \
	_T("     (SELECT COALESCE(SUM(r.hfe_cost), 0)") \
	_T("     FROM hms_fee_refundline r") \
	_T("     WHERE r.hfe_invoiceno = i.hfe_invoiceno") \
	...
	_T("     THEN SUM(hfe_patpaid +hfe_otherpayment- (chi_vienphi + chi_maycnc + chi_tienan))") \
	_T("     ELSE SUM(chi_vienphi + chi_maycnc + chi_tienan)") \
	_T("   END cong,") \
	_T("   CASE") \
	_T("     WHEN SUM(hfe_deposit + ref_deposit+hfe_otherpayment+hfe_miengiam) > 0") \
...
CString CFMInsurancePostedPaymentVoucherListRGSOM::GetQueryString(){
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
	CString szOrderBy;
	CString szReceiptStr = _T("-1");
	for (int i = 0 ; i < m_wndList.GetItemCount(); i++)
...
CString CFMInsurancePostedPaymentVoucherListRGSOM::GetQueryString2(){
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
	CString szOrderBy;
	CString szReceiptStr = _T("-1");
	for (int i = 0 ; i < m_wndList.GetItemCount(); i++)
	...
	_T("       CASE WHEN i.hfe_class = 'I' THEN (SELECT COALESCE(SUM(hfe_patpaid), 0) FROM hms_fee f WHERE f.hfe_docno = i.hfe_docno AND f.hfe_invoiceno = i.hfe_invoiceno AND f.hfe_status IN( 'P', 'R' ) AND NVL(f.hfe_category, 'N') IN( 'BQP', 'BBV' )) ELSE 0 END ") \
	_T("		AS hfe_policyamount,") \
	_T("	   CASE WHEN i.hfe_class = 'I' THEN (SELECT COALESCE(SUM(hfe_patpaid), 0) FROM hms_fee f, hms_fee_list WHERE f.hfe_docno = i.hfe_docno AND f.hfe_invoiceno = i.hfe_invoiceno AND f.hfe_itemid = hfl_feeid AND f.hfe_status IN( 'P', 'R' ) AND NVL(f.hfe_category, 'N') NOT IN ('Y', 'BQP', 'BBV') AND hfl_hitechmachine = 'Y') ELSE 0 END ") \
