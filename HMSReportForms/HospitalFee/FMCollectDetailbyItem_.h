#ifndef FMCollectDetailbyItem__H
#define FMCollectDetailbyItem__H
...
#include "GuiView.h"
#include "DbField.h"
class CFMCollectDetailByItem_ : public CGuiView
{
protected:
...
public:
	...
	CString			GetQueryString(),GetQueryString1();
	...
	CFMCollectDetailByItem_(CWnd *pWnd);
	~CFMCollectDetailByItem_();
