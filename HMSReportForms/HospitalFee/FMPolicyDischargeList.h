#ifndef FMPOLICYDISCHARGELIST_H
#define FMPOLICYDISCHARGELIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyDischargeList : public CGuiView{
protected:
public:
	...
	CFMPolicyDischargeList(CWnd *pParent);
	~CFMPolicyDischargeList();
