#ifndef FMDETAILINSURANCE21AREPORT_H
#define FMDETAILINSURANCE21AREPORT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDetailInsurance21aReport : public CGuiView{
protected:
public:
	...
	CFMDetailInsurance21aReport(CWnd *pParent);
	~CFMDetailInsurance21aReport();
	...
	int OnAddCFMDetailInsurance21aReport(); 
	int OnEditCFMDetailInsurance21aReport(); 
	int OnDeleteCFMDetailInsurance21aReport(); 
	int OnSaveCFMDetailInsurance21aReport(); 
	int OnCancelCFMDetailInsurance21aReport(); 
	int OnCFMDetailInsurance21aReportListLoadData(); 
