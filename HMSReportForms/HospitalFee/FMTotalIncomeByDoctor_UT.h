#ifndef FMTotalInComeByDoctorUT_H
#define FMTotalInComeByDoctorUT_H
...
class CFMTotalInComeByDoctorUT : public CGuiView
{
protected:
...
public:
	...
	CFMTotalInComeByDoctorUT(CWnd *pWnd);
	~CFMTotalInComeByDoctorUT();
