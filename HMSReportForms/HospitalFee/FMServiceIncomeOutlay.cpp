#include "stdafx.h"
#include "FMServiceIncomeOutlay.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServiceIncomeOutlay* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServiceIncomeOutlay* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServiceIncomeOutlay* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnStatusAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnDeptLoadData();
}
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServiceIncomeOutlay* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnOrderByAddNew();
}*/
static long _OnObjectTypeLoadDataFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay *)pWnd)->OnObjectTypeLoadData();
}
static void _OnObjectTypeSelendokFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay *)pWnd)->OnObjectTypeSelendok();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMServiceIncomeOutlay*)pWnd)->OnWithoutGeneralSelect();
}
static void _OnHitechMachineSelectFnc(CWnd *pWnd){
	 ((CFMServiceIncomeOutlay*)pWnd)->OnHitechMachineSelect();
}
static void _OnDetailSelectFnc(CWnd *pWnd){
	 ((CFMServiceIncomeOutlay*)pWnd)->OnDetailSelect();
}
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMServiceIncomeOutlay *pVw = (CFMServiceIncomeOutlay *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMServiceIncomeOutlay*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMServiceIncomeOutlay*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMServiceIncomeOutlay*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMServiceIncomeOutlay*)pWnd)->OnListDeleteItem();
} 
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMServiceIncomeOutlay*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMServiceIncomeOutlay*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMServiceIncomeOutlay*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMServiceIncomeOutlay*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMServiceIncomeOutlay*)pWnd)->OnListCheckAllRefund();
	return 0;
}

static void _OnSODSelectFnc(CWnd *pWnd)
{
	  ((CFMServiceIncomeOutlay*)pWnd)->OnSODSelect();
}
static int _OnListCheckAllDVABFnc(CWnd *pWnd)
{
	((CFMServiceIncomeOutlay*)pWnd)->OnListCheckAllDVAB();
	return 0;
}
static int _OnListUnCheckAllDVABFnc(CWnd *pWnd)
{
	((CFMServiceIncomeOutlay*)pWnd)->OnListUnCheckAllDVAB();
	return 0;
}

CFMServiceIncomeOutlay::CFMServiceIncomeOutlay(CWnd *pWnd){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMServiceIncomeOutlay::~CFMServiceIncomeOutlay(){
}
void CFMServiceIncomeOutlay::OnCreateComponents()
{	
...
void CFMServiceIncomeOutlay::OnInitializeComponents(){
...
void CFMServiceIncomeOutlay::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	m_wndList.AddEvent(5, _T("\x43h\x1ECDn phi\x1EBFu thu/chi AB"), _OnListCheckAllDVABFnc);
	m_wndList.AddEvent(6, _T("\x42\x1ECF \x63h\x1ECDn phi\x1EBFu thu/chi AB"), _OnListUnCheckAllDVABFnc);
...
void CFMServiceIncomeOutlay::OnDoDataExchange(CDataExchange* pDX){
...
void CFMServiceIncomeOutlay::SetDefaultValues(){
...
int CFMServiceIncomeOutlay::SetMode(int nMode){
...
/*void CFMServiceIncomeOutlay::OnYearChange(){
	
} */
/*void CFMServiceIncomeOutlay::OnYearSetfocus(){
	
} */
/*void CFMServiceIncomeOutlay::OnYearKillfocus(){
	
} */
int CFMServiceIncomeOutlay::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMServiceIncomeOutlay::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMServiceIncomeOutlay::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMServiceIncomeOutlay::OnReportPeriodSetfocus(){
	
}*/
/*void CFMServiceIncomeOutlay::OnReportPeriodKillfocus(){
	
}*/
long CFMServiceIncomeOutlay::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMServiceIncomeOutlay::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMServiceIncomeOutlay::OnFromDateChange(){
	
} */
/*void CFMServiceIncomeOutlay::OnFromDateSetfocus(){
	
} */
/*void CFMServiceIncomeOutlay::OnFromDateKillfocus(){
	
} */
int CFMServiceIncomeOutlay::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMServiceIncomeOutlay::OnToDateChange(){
	
} */
/*void CFMServiceIncomeOutlay::OnToDateSetfocus(){
	
} */
/*void CFMServiceIncomeOutlay::OnToDateKillfocus(){
	
} */
int CFMServiceIncomeOutlay::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMServiceIncomeOutlay::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMServiceIncomeOutlay::OnClerkSelendok(){
	 
}

/*void CFMServiceIncomeOutlay::OnClerkSetfocus(){
	
}*/
/*void CFMServiceIncomeOutlay::OnClerkKillfocus(){
	
}*/
long CFMServiceIncomeOutlay::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMServiceIncomeOutlay::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMServiceIncomeOutlay::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMServiceIncomeOutlay::OnStatusSelendok(){
	 OnListLoadData();
}
int CFMServiceIncomeOutlay::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMServiceIncomeOutlay::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMServiceIncomeOutlay::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMServiceIncomeOutlay::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMServiceIncomeOutlay::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMServiceIncomeOutlay::OnSODSelect(){
	OnListLoadData();
}

/*void CFMServiceIncomeOutlay::OnStatusSetfocus(){
	
}*/
/*void CFMServiceIncomeOutlay::OnStatusKillfocus(){
	
}*/
long CFMServiceIncomeOutlay::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
long CFMServiceIncomeOutlay::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMServiceIncomeOutlay::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMServiceIncomeOutlay::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMServiceIncomeOutlay::OnOrderBySelendok(){
	 
}

/*void CFMServiceIncomeOutlay::OnOrderBySetfocus(){
	
}*/
/*void CFMServiceIncomeOutlay::OnOrderByKillfocus(){
	
}*/
long CFMServiceIncomeOutlay::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
long CFMServiceIncomeOutlay::OnObjectTypeLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMServiceIncomeOutlay::OnObjectTypeSelendok(){
	OnListLoadData();	
}

/*void CFMServiceIncomeOutlay::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMServiceIncomeOutlay::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

	void CFMServiceIncomeOutlay::OnHitechMachineSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMServiceIncomeOutlay::OnDetailSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMServiceIncomeOutlay::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMServiceIncomeOutlay::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMServiceIncomeOutlay::OnPrintSelect(){
...
void CFMServiceIncomeOutlay::OnExportSelect()
{
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
...
void CFMServiceIncomeOutlay::OnExportReport()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMServiceIncomeOutlay::OnExportPatientList()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\DANHSACH_BENHNHAN_THEOKHOA.xls"))) AfxMessageBox(_T("\x43h\x1B0\x61 \x63\xF3 \x66il\x65 trong th\x1B0 m\x1EE5\x63 Exports"));
	...
	xls.Save(_T("Exports\\DANHSACH_BENHNHAN_THEOKHOA2.xls"));
}

 
void CFMServiceIncomeOutlay::OnListDblClick(){
...
void CFMServiceIncomeOutlay::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMServiceIncomeOutlay::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMServiceIncomeOutlay::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('DV-AB','DV','THE-DV') AND fac_cashbook_id  not in ('DVYC','DV-PTTYC')"));
...
//CString CFMServiceIncomeOutlay::GetQueryString(){
...
CString CFMServiceIncomeOutlay::GetQueryString()
{
	...
	else
	{
		...
		//Update ngay 09/06, co 1 so muc phi bi xoa di trong table hms_pacsorder nhung van co trong hms_fee//
		_T("  UNION ALL") \
		_T(" SELECT f.hfe_docno,") \
		_T("       f.hfe_type,") \
		_T("       iv.hfe_class,") \
		_T("       f.hfe_invoiceno,") \
		_T("       CASE WHEN f.hfe_type IN ('P') AND f.hfe_status='R' AND F.Hfe_Group NOT IN ('B1B00','B1G00','B1800','B2500') AND Hpc_Practitioner IS NULL THEN Fl.Hfl_Deptid  END khoa_thuchien,") \
		_T("       f.hfe_itemid,      ") \
		_T("       f.hfe_patpaid tong_tien,") \
		_T("       f.hfe_category") \
		_T("     FROM hms_fee f  ") \
		...
		_T("     LEFT JOIN Hms_Pacsorder") \
		_T("     ON ( f.hfe_docno = hpc_docno  AND f.hfe_orderid  = hpc_orderid    AND f.hfe_type  IN ('P'))    ") \
		_T("     LEFT JOIN HMS_FEE_INVOICE_VIEW_V3 iv") \
		_T("     ON (iv.hfe_invoiceno  = f.hfe_invoiceno  AND iv.hfe_docno      = f.hfe_docno)") \
		_T("     WHERE 1=1 %s    ") \
		_T("     AND f.hfe_status in ('R') AND Hpc_Practitioner IS NULL AND F.Hfe_Group NOT IN ('B1B00','B1G00','B1800','B2500')") \
...
CString CFMServiceIncomeOutlay::GetQueryString_check()
{
...
int CFMServiceIncomeOutlay::OnListCheckAllDVAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMServiceIncomeOutlay::OnListUnCheckAllDVAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
