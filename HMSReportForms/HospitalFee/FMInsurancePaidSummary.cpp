#include "stdafx.h"
#include "FMInsurancePaidSummary.h"
#include "HMSMainFrame.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummary* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummary* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummary* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummary* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummary*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummary*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePaidSummary*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePaidSummary*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummary*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMInsurancePaidSummary *pVw = (CFMInsurancePaidSummary *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummary*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummary*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummary*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummary*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsurancePaidSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummary*)pWnd)->OnAddFMInsurancePaidSummary();
} 
static int _OnEditFMInsurancePaidSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummary*)pWnd)->OnEditFMInsurancePaidSummary();
} 
static int _OnDeleteFMInsurancePaidSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummary*)pWnd)->OnDeleteFMInsurancePaidSummary();
} 
static int _OnSaveFMInsurancePaidSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummary*)pWnd)->OnSaveFMInsurancePaidSummary();
} 
static int _OnCancelFMInsurancePaidSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummary*)pWnd)->OnCancelFMInsurancePaidSummary();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummary*)pWnd)->OnSODSelect();
}
static void _OnServicePackageSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummary*)pWnd)->OnServicePackageSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummary*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummary*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummary*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummary*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummary*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummary*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}

static void _OnSoldierWCardSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummary*)pWnd)->OnSoldierWCardSelect();
}
static long _OnObjectTypeLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsurancePaidSummary *)pWnd)->OnObjectTypeLoadData();
}
static void _OnObjectTypeSelendokFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummary *)pWnd)->OnObjectTypeSelendok();
}


CFMInsurancePaidSummary::CFMInsurancePaidSummary(CWnd *pParent)
{
	m_szWhere.Empty();
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
...
CFMInsurancePaidSummary::~CFMInsurancePaidSummary(){
}
void CFMInsurancePaidSummary::OnCreateComponents(){
	...
	m_wndStatus.Create(this,331, 89, 476, 114); 
	m_wndList.Create(this,10, 150, 476, 469); 
	m_wndWithoutGeneral.Create(this, _T("Without General"), 300, 473, 381, 498);
	m_wndHitechMachine.Create(this, _T("Hitech Machine"), 206, 473, 295, 498);
	...
	m_wndInpatient.Create(this, _T("Inpatient"), 9, 505, 103, 530);
	m_wndOutpatient.Create(this, _T("Outpatient"), 109, 505, 199, 530);
	m_wndDeposit.Create(this, _T("Deposit"), 206, 505, 295, 530);
	m_wndAll.Create(this, _T("All"), 300, 505, 381, 530);
	m_wndSOD.Create(this, _T("SOD"), 9, 473, 103, 498);
	m_wndServicePackage.Create(this, _T("ServicePackage"), 109, 473, 199, 498);
	m_wndSoldierWCard.Create(this, _T("Soldier w Card"), 386, 473, 475, 498);
	m_wndObjectTypeLabel.Create(this, _T("Object Type"), 246, 120, 327, 145);
	m_wndObjectType.Create(this,332, 120, 477, 145); 

}
void CFMInsurancePaidSummary::OnInitializeComponents(){
...
void CFMInsurancePaidSummary::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
//	m_wndList.AddEvent(1, _T("Delete"), _OnListDeleteItemFnc, 0, VK_DELETE, 0);
	...
	/*
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddFMInsurancePaidSummaryFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditFMInsurancePaidSummaryFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteFMInsurancePaidSummaryFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveFMInsurancePaidSummaryFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelFMInsurancePaidSummaryFnc, 0, 'T', VK_CONTROL);
	*/
...
void CFMInsurancePaidSummary::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsurancePaidSummary::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePaidSummary::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePaidSummary::SetDefaultValues(){
...
int CFMInsurancePaidSummary::SetMode(int nMode){
...
/*void CFMInsurancePaidSummary::OnYearChange(){
	
} */
/*void CFMInsurancePaidSummary::OnYearSetfocus(){
	
} */
/*void CFMInsurancePaidSummary::OnYearKillfocus(){
	
} */
int CFMInsurancePaidSummary::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePaidSummary::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMInsurancePaidSummary::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePaidSummary::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePaidSummary::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePaidSummary::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePaidSummary::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePaidSummary::OnFromDateChange(){
	
} */
/*void CFMInsurancePaidSummary::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummary::OnFromDateKillfocus(){
	
} */
int CFMInsurancePaidSummary::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePaidSummary::OnToDateChange(){
	
} */
/*void CFMInsurancePaidSummary::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummary::OnToDateKillfocus(){
	
} */
int CFMInsurancePaidSummary::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePaidSummary::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummary::OnClerkSelendok(){
	 
}
/*void CFMInsurancePaidSummary::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePaidSummary::OnClerkKillfocus(){
	
}*/
long CFMInsurancePaidSummary::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePaidSummary::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummary::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummary::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePaidSummary::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePaidSummary::OnStatusKillfocus(){
	
}*/
long CFMInsurancePaidSummary::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummary::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMInsurancePaidSummary::OnObjectTypeLoadData()
{
...
void CFMInsurancePaidSummary::OnObjectTypeSelendok()
{
	OnListLoadData();
}


void CFMInsurancePaidSummary::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummary::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePaidSummary::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePaidSummary::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePaidSummary::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummary::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMInsurancePaidSummary::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

	void CFMInsurancePaidSummary::OnSoldierWCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

	void CFMInsurancePaidSummary::OnSODSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
	void CFMInsurancePaidSummary::OnServicePackageSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

void CFMInsurancePaidSummary::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsurancePaidSummary::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePaidSummary::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsurancePaidSummary::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePaidSummary::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMInsurancePaidSummary::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummary::OnInpatientSelect(){
	
}
void CFMInsurancePaidSummary::OnOutpatientSelect(){
	
}
void CFMInsurancePaidSummary::OnDepositSelect(){
	
}
void CFMInsurancePaidSummary::OnAllSelect(){
	
}
 
 
int CFMInsurancePaidSummary::OnAddFMInsurancePaidSummary(){
...
int CFMInsurancePaidSummary::OnEditFMInsurancePaidSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePaidSummary::OnDeleteFMInsurancePaidSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelFMInsurancePaidSummary();
 	}
	return 0;
}
int CFMInsurancePaidSummary::OnSaveFMInsurancePaidSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnFMInsurancePaidSummaryListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CFMInsurancePaidSummary::OnCancelFMInsurancePaidSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePaidSummary::OnFMInsurancePaidSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsurancePaidSummary::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummary::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummary::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	double nTotal[23], GrandAmt[23], nTotalClass[23];
	for (int i = 0; i < 23; i++)
	{
		GrandAmt[i] = 0;
		nTotal[i] = 0;
	...
	szReportName = _T("Reports\\HMS\\HF_FMINSURANCEPAIDSUMMARY.RPT");
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMInsurancePaidSummary"));
...
void CFMInsurancePaidSummary::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANGTONGHOPPHANTICHTONGTHUBAOHIEMYTE_BHTT.xls"))) AfxMessageBox(_T("Load fail!"));
...
CString CFMInsurancePaidSummary::GetQueryString(){
	...
	szView = _T("HF_INSURANCEPAIDSUMMARY_VIEW");
	if (m_bHitechMachine)
		szView = _T("HF_HMINSURANCEPAIDSUMMARY_VIEW");
...
int CFMInsurancePaidSummary::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummary::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummary::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummary::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummary::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummary::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
