#ifndef FMKetQuaHoatDongThuChiPhauThuThuat_H
#define FMKetQuaHoatDongThuChiPhauThuThuat_H
...
class CFMKetQuaHoatDongThuChiPhauThuThuat : public CGuiView
{
...
public:
	...
	CFMKetQuaHoatDongThuChiPhauThuThuat(CWnd *pWnd);
	~CFMKetQuaHoatDongThuChiPhauThuThuat();
	...
	int OnListCheckAllBH();
	int OnListCheckAllDV();
	int OnListCheckAllQUAN();
