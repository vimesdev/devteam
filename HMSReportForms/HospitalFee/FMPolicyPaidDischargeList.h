#ifndef FMPOLICYPAIDDISCHARGELIST_H
#define FMPOLICYPAIDDISCHARGELIST_H
...
#include "DbField.h"
#include "Excel.h"
class CFMPolicyPaidDischargeList : public CGuiView
{
protected:
public:
	...
	CFMPolicyPaidDischargeList(CWnd* pParent);
	~CFMPolicyPaidDischargeList();
	...
	void OnCreateHeader(CExcel *xls, TCHAR fmtstr[], TCHAR *colstr[], int nColQty, int nRow);
};
#endif
