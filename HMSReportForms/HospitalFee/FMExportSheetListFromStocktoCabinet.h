#ifndef FMEXPORTSHEETLISTFROMSTOCKTOCABINET_H
#define FMEXPORTSHEETLISTFROMSTOCKTOCABINET_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMExportSheetListFromStocktoCabinet : public CGuiView
{
protected:
public:
	...
	CGuiListCtrl	m_wndStock;
	CGuiLabel		m_wndTypeLabel;
	CGuiComboBox	m_wndType;
	CGuiCheckBox	m_wndByServPrice;
	CGuiButton		m_wndPrintPreview;
	CGuiButton		m_wndExport;
	CGuiListCtrl	m_wndCabinet;
	...
	void			OnExport_1();
	void			OnExport_2();
	CFMExportSheetListFromStocktoCabinet(CWnd *pParent);
	~CFMExportSheetListFromStocktoCabinet();
	...
	void OnStockSearchItem();
	void OnCabinetSearchItem();
	int OnStockListCheckAll();
	int OnStockListUnCheckAll();
	int OnCabinetListCheckAll();
	int OnCabinetListUnCheckAll();
