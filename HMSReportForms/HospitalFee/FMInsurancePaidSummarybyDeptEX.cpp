#include "stdafx.h"
#include "FMInsurancePaidSummarybyDeptEX.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnYearKillfocus();
} */
static void _OnCreateDataSelectFnc(CWnd *pWnd)
{
	CFMInsurancePaidSummaryByDeptEX *pVw = (CFMInsurancePaidSummaryByDeptEX *)pWnd;
	pVw->OnCreateDataSelect();
} 

static void _OnObjectTypeSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnObjectTypeSelendok();
}

static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEX* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnReportPeriodSelendok();
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListCheckAllRefund();
	return 0;
}

/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEX* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEX* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDeptEX* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListDeleteItem();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnSODSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static void _OnSoldierWCardSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnSoldierWCardSelect();
}

static long _OnObjectTypeLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsurancePaidSummaryByDeptEX *)pWnd)->OnObjectTypeLoadData();
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnABZoneSelect();
}
static void _OnTCKTSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnTCKTSelect();
}
static void _OnDang_dieu_triSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnDang_dieu_triSelect();
}
static void _OnDa_ra_vien_chua_ttSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnDa_ra_vien_chua_ttSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnPolicySelect();
}
static void _OnAllObjectSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDeptEX*)pWnd)->OnAllObjectSelect();
}

CFMInsurancePaidSummaryByDeptEX::CFMInsurancePaidSummaryByDeptEX(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
...
CFMInsurancePaidSummaryByDeptEX::~CFMInsurancePaidSummaryByDeptEX()
{
}
void CFMInsurancePaidSummaryByDeptEX::OnCreateComponents()
{
	...
	m_wndStatusLabel.Create(this, _T("Status"), 240, 90, 331, 115);
	m_wndStatus.Create(this,346, 90, 476, 115); 
	m_wndDeptLabel.Create(this, _T("Dept"), 10, 121, 90, 146);
	m_wndDept.Create(this,95, 121, 476, 146); 
	m_wndObjectTypeLabel.Create(this, _T("Object Type"), 10, 150, 90, 175);
	m_wndObjectType.Create(this,95, 150, 225, 175); 
	m_wndABZone.Create(this, _T("AB Zone"), 240, 150, 331, 175);
	m_wndTCKT.Create(this, _T("TCKT"), 346, 150, 476, 175);
	m_wndOrderByLabel.Create(this, _T("Order By"), 10, 182, 90, 207);
	m_wndOrderBy.Create(this,95, 182, 225, 207); 
	m_wndList.Create(this,10, 212, 476, 406); 
	m_wndDang_dieu_tri.Create(this, _T("Đang điều trị"), 12, 412, 227, 437);
	m_wndDa_ra_vien_chua_tt.Create(this, _T("Ra viện chưa thanh toán"), 231, 412, 476, 437);
	m_wndSoldierWCard.Create(this, _T("Soldier w Card"), 231, 442, 476, 467);
	m_wndSOD.Create(this, _T("SOD"), 12, 443, 227, 468);
...
void CFMInsurancePaidSummaryByDeptEX::OnInitializeComponents(){
...
void CFMInsurancePaidSummaryByDeptEX::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
//	m_wndList.AddEvent(1, _T("Delete"), _OnListDeleteItemFnc, 0, VK_DELETE, 0);
	...
	*/
	...
	m_szToDate += _T("23:59");
	m_szDeptKey = pMF->GetCurrentDepartmentID();
	UpdateData(FALSE);
	//SetMode(VM_EDIT);


}
void CFMInsurancePaidSummaryByDeptEX::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsurancePaidSummaryByDeptEX::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePaidSummaryByDeptEX::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePaidSummaryByDeptEX::SetDefaultValues(){
...
int CFMInsurancePaidSummaryByDeptEX::SetMode(int nMode){
...
/*void CFMInsurancePaidSummaryByDeptEX::OnYearChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEX::OnYearSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEX::OnYearKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptEX::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePaidSummaryByDeptEX::OnDang_dieu_triSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	if  (m_bDang_dieu_tri)
	...
	void CFMInsurancePaidSummaryByDeptEX::OnDa_ra_vien_chua_ttSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
...
void CFMInsurancePaidSummaryByDeptEX::OnInsuranceSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEX::OnServiceSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEX::OnPolicySelect(){
	
}
void CFMInsurancePaidSummaryByDeptEX::OnAllObjectSelect(){
	
}
 
void CFMInsurancePaidSummaryByDeptEX::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMInsurancePaidSummaryByDeptEX::OnTCKTSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
void CFMInsurancePaidSummaryByDeptEX::OnCreateDataSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDeptEX::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePaidSummaryByDeptEX::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEX::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEX::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePaidSummaryByDeptEX::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePaidSummaryByDeptEX::OnFromDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEX::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEX::OnFromDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptEX::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePaidSummaryByDeptEX::OnToDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEX::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDeptEX::OnToDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDeptEX::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePaidSummaryByDeptEX::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

long CFMInsurancePaidSummaryByDeptEX::OnObjectTypeLoadData()
{
...
void CFMInsurancePaidSummaryByDeptEX::OnObjectTypeSelendok()
{
	OnListLoadData();
}
void CFMInsurancePaidSummaryByDeptEX::OnABZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
...
void CFMInsurancePaidSummaryByDeptEX::OnSoldierWCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMInsurancePaidSummaryByDeptEX::OnClerkSelendok(){
	 
}
int CFMInsurancePaidSummaryByDeptEX::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMInsurancePaidSummaryByDeptEX::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMInsurancePaidSummaryByDeptEX::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMInsurancePaidSummaryByDeptEX::OnSODSelect(){
	OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDeptEX::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEX::OnClerkKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEX::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePaidSummaryByDeptEX::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDeptEX::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDeptEX::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDeptEX::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEX::OnStatusKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEX::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummaryByDeptEX::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDeptEX::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDeptEX::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePaidSummaryByDeptEX::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDeptEX::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDeptEX::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
...
/*void CFMInsurancePaidSummaryByDeptEX::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMInsurancePaidSummaryByDeptEX::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePaidSummaryByDeptEX::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsurancePaidSummaryByDeptEX::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsurancePaidSummaryByDeptEX::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePaidSummaryByDeptEX::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsurancePaidSummaryByDeptEX::OnListLoadData()
{
	return 0;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
void CFMInsurancePaidSummaryByDeptEX::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMInsurancePaidSummaryByDeptEX::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMInsurancePaidSummaryByDeptEX::OnInpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEX::OnOutpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEX::OnDepositSelect(){
	
}
void CFMInsurancePaidSummaryByDeptEX::OnAllSelect(){
	
}
 
 
int CFMInsurancePaidSummaryByDeptEX::OnAddFMInsuranceReceiptSummary(){
...
int CFMInsurancePaidSummaryByDeptEX::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePaidSummaryByDeptEX::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsurancePaidSummaryByDeptEX::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsurancePaidSummaryByDeptEX::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePaidSummaryByDeptEX::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsurancePaidSummaryByDeptEX::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummaryByDeptEX::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDeptEX::OnPrint2ndver()
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMInsurancePaidSummaryByDeptEX"));
...
void CFMInsurancePaidSummaryByDeptEX::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	CGuiMenu menu(this);
	...
	_debug(_T("right: %d|top: %d"), rect.right, rect.top);
	menu.CreatePopupMenu();
	TranslateString(_T("Xuất ra Excel danh sách bệnh nhân"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 1, tmpStr);
	/*TranslateString(_T("Xuất danh sách BN so sánh"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 2, tmpStr);	
	TranslateString(_T("Xuất tổng hợp theo khoa"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 3, tmpStr);*/
	if (pMF->GetCurrentDepartmentID() == _T("PTC"))
	{
		TranslateString(_T("Xuất tổng hợp theo khoa"), tmpStr);
	...
	//TranslateString(_T("Xuất theo tên 1 bệnh nhân"), tmpStr);
...
void CFMInsurancePaidSummaryByDeptEX::OnExportPatientList()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDeptEX::OnExportDetailSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\Template\\TONGHOP_CHIPHI_NGOAITRU_NOITRU_THEOKHOA_TOANVIEN108.xls"))) AfxMessageBox(_T("Chưa có Files trong thư mục Exports\\Template"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOP_CHIPHI_NGOAITRU_NOITRU_THEOKHOA_TOANVIEN108OK.xls"));
}

void CFMInsurancePaidSummaryByDeptEX::OnExportTotalList(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
void CFMInsurancePaidSummaryByDeptEX::OnExportTotalList1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMInsurancePaidSummaryByDeptEX::GetQueryString()
{
...
CString CFMInsurancePaidSummaryByDeptEX::GetQueryString2()
{
...
CString CFMInsurancePaidSummaryByDeptEX::GetQueryString_check()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMInsurancePaidSummaryByDeptEX::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEX::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEX::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
		int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEX::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptEX::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEX::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDeptEX::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptEX::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDeptEX::OnDeleteDataBeforeInsert()
{
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL; 	
...
CString CFMInsurancePaidSummaryByDeptEX::GetQueryString3()
{
...
CString CFMInsurancePaidSummaryByDeptEX::GetQueryString_v2()
{
	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19, szSQL20,szSQL21,szSQL22,szSQL23,szSQL24,szSQL25,szSQL26, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	int nCount = 0;
	CRecord rs(&pMF->m_db);	
	szReceiptStr = _T("-1");
  ...
  szSQL8.Format(_T("     UNION ALL     ") \
				...
				_T("     ON (hpo_orderid = f.hfe_orderid)") \
				_T("     WHERE 1              =1 ") \
				_T("     AND f.hfe_status    IN ('O','A') AND (f.hfe_class='E' OR (f.hfe_class='I' AND f.hfe_deptid='TTDTHM') )") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
  ...
  szSQL9.Format(_T("     UNION ALL") \
				...
				_T("     ON (hpo_orderid = f.hfe_orderid)") \
				_T("     WHERE 1              =1 ") \
				_T("     AND f.hfe_status    IN ('O','A') AND f.hfe_class='I' AND f.hfe_deptid<>'TTDTHM'") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
				_T("     AND product_org_id NOT IN ('MA','BB', 'PĐD', 'HC')") \
				_T("     AND (f.hfe_category   NOT IN ('Y') OR (f.hfe_category='Y' AND HFE_TREAT_INPACKAGE='Y'))"));
	//9.Phi khoa trang bi ngoai tru//
  szSQL10.Format(_T("     UNION ALL") \
				_T("     SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
				...
				_T("     WHERE 1              =1 ") \
				_T("     AND f.hfe_status    IN ('O','A') AND f.hfe_class='E'") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
				_T("     AND product_org_id NOT IN ('PM','BB')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
...
//9.1 Phi vat tu noi tru
	szSQL11.Format(_T("     UNION ALL") \
				...
				_T("     WHERE 1              =1 ") \
				_T("     AND f.hfe_status    IN ('O','A') AND f.hfe_class='I'") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
				_T("     AND product_org_id NOT IN ('PM','BB')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
...
//15. Phi an khoa dinh duong ne//
 ...
 szSQL18.Format(_T("     UNION ALL     ") \
				...
				_T("     WHERE 1              =1 AND coalesce(ho_deptid, cast('N' as nvarchar2(1)))<>'N'") \
				_T("     AND f.hfe_status    IN ('A','O')") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
...
szSQL19.Format(_T("     UNION ALL") \
				...
				_T("     WHERE 1              =1 AND coalesce(hpc_deptid, cast('N' as nvarchar2(1)))<>'N' ") \
				_T("     AND f.hfe_status    IN ('A', 'O')") \
				_T("     AND f.hfe_type      IN ('D', 'M', 'R')") \
				_T("     AND product_org_id NOT IN ('PM','BB')") \
				_T("     AND hfe_category     ='Y'"));
...
szSQL24.Format(_T("     UNION ALL") \
	...
	_T(" SUM(TIEN_KHAM+TIEN_GIUONG+TIEN_CLS+TIEN_PTTT+TIEN_THUOC_CH_NGOAITRU+TIEN_THUOC_CH_NOITRU+TIEN_VAT_TU_CH_NGOAITRU+TIEN_VAT_TU_CH_NOITRU+TIEN_THUOC_PM+TIEN_VAT_TU_PM+TIEN_MAU+THU_KHAC+THU_GOI) as TONG_THU,") \
	_T(" SUM(TIEN_KHAM+TIEN_GIUONG+TIEN_CLS+TIEN_PTTT+TIEN_THUOC_CH_NGOAITRU+TIEN_THUOC_CH_NOITRU+TIEN_VAT_TU_CH_NGOAITRU+TIEN_VAT_TU_CH_NOITRU+TIEN_THUOC_PM+TIEN_VAT_TU_PM+TIEN_MAU+THU_KHAC+THU_GOI+TIEN_AN+TIEN_AN_HC+TIEN_THUOC_TG+TIEN_VAT_TU_TG+TIEN_THUOC_TG_O+TIEN_VAT_TU_TG_O) as TONG_THU1") \
	_T(" FROM") \
	_T(" (") \
	...
	_T(" ORDER BY dept_id"),szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20,szSQL21, szSQL22,szSQL23,szSQL24, szSQL25 ,szSQL26, szWhere1, szWhere);	
	return szSQL;
}

CString CFMInsurancePaidSummaryByDeptEX::GetQueryString_check_v2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
CString CFMInsurancePaidSummaryByDeptEX::GetQueryString_v3()
{
...
void CFMInsurancePaidSummaryByDeptEX::OnExportBriefSelect()
{
	...
	while(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("totaldeposit"), nTemp);
		nGroupTotal[26] += nTemp;
		xls.SetCellText(nCol+26, nRow, double2str(nTemp), FMT_NUMBER1);	
	...
	xls.SetActiveSheet(0);
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOP_CHIPHI_BENHNHANTON_THEOKHOA_CHITIET2.xls"));
}
CString CFMInsurancePaidSummaryByDeptEX::GetQueryString_v2_1()
{
...
szSQL24.Format(_T("     UNION ALL") \
	...
	_T(" posted_date,") \
	_T(" dept_id,") \
	_T(" COALESCE(deposit,0) as totaldeposit,") \
	_T(" SUM(SO_NGAY_DT) as SO_NGAY_DT,") \
	_T(" SUM(TIEN_KHAM) as TIEN_KHAM,") \
	_T(" SUM(TIEN_GIUONG) as TIEN_GIUONG,") \
	_T(" SUM(TIEN_CLS) as TIEN_CLS,") \
	...
	_T("     ''       AS invoice_date,") \
	_T("     ''       AS posted_date,") \
	_T("     HCR_DISCHARGEDEPT         AS dept_id,") \
	_T("     hfe_quantity          AS SO_NGAY_DT,") \
	_T("     TIEN_KHAM,") \
	_T("     TIEN_GIUONG,") \
	_T("     TIEN_CLS,    ") \
	...
	_T("     MIEN_GIAM,") \
	_T("     hfe_itemid,") \
	_T("     (SELECT sum(COALESCE(hfe_amount,0)) FROM hms_fee_deposit where hfe_status='P' AND hfe_patpaid=0 AND hfe_docno=d.HD_DOCNO AND HFE_OBJECTID=cast(HD_OBJECT as INTEGER) ) as deposit ") \
	_T("  FROM HMS_DOC d") \
	_T("   LEFT JOIN HMS_CLINICAL_RECORD cr") \
	_T("   ON (cr.HCR_DOCNO=d.HD_DOCNO)") \
	_T("   LEFT JOIN hms_object ON (HD_OBJECT=HO_ID) ") \
	...
	_T("  )") \
	_T(" GROUP BY ") \
	_T(" HO_TEN, docno, deposit, NGAY_VAO, NGAY_RA,CHINDEX, posted_date,dept_id") \
