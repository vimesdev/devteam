#ifndef FMNTTObjectFood_H
#define FMNTTObjectFood_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMNTTObjectFood : public CGuiView
{
protected:
...
public:
	...
	int OnAddNTTObjectFood(); 
	int OnEditNTTObjectFood(); 
	int OnDeleteNTTObjectFood(); 
	int OnSaveNTTObjectFood(); 
	int OnCancelNTTObjectFood(); 
	int OnNTTObjectFoodListLoadData(); 
