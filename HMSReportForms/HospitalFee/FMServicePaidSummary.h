#ifndef FMServicePaidSummary_H
#define FMServicePaidSummary_H
...
class CFMServicePaidSummary : public CGuiView
{
...
public:
	...
	CGuiCheckBox	m_wndPolicyObjList;
	CGuiCheckBox	m_wndPolicyObjectFilter;
	long	m_nYear;
	...
	int		m_nPatientType;
	BOOL	m_bSOD;
	BOOL	m_bPolicyObjList;
	BOOL	m_bPolicyObjectFilter;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	void			OnExport1();
	void			OnExport2();
	void			OnExport1_ByDept();
	void			OnExport1_ByDate();
	...
	void			OnPolicyObjListSelect();
	void			OnPolicyObjectFilterSelect();
	void			OnPrint1stver();
	void			OnPrint2ndver();
	void			OnPrint2ndver_();
	...
	CFMServicePaidSummary(CWnd *pWnd);
	~CFMServicePaidSummary();
