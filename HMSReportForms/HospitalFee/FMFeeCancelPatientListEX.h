#ifndef FMFEECANCELPATIENTLISTEX_H
#define FMFEECANCELPATIENTLISTEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFeeCancelPatientListEX : public CGuiView
{
protected:
public:
	...
	CFMFeeCancelPatientListEX(CWnd* pParent);
	~CFMFeeCancelPatientListEX();
	...
	int OnAddFMFeeCancelPatientList(); 
	int OnEditFMFeeCancelPatientList(); 
	int OnDeleteFMFeeCancelPatientList(); 
	int OnSaveFMFeeCancelPatientList(); 
	int OnCancelFMFeeCancelPatientList(); 
	int OnFMFeeCancelPatientListListLoadData();
