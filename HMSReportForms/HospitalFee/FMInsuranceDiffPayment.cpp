#include "stdafx.h"
#include "FMInsuranceDiffPayment.h"
#include "HMSMainFrame.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceDiffPayment* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceDiffPayment* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceDiffPayment* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsuranceDiffPayment* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsuranceDiffPayment*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsuranceDiffPayment*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsuranceDiffPayment*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsuranceDiffPayment*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsuranceDiffPayment*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMInsuranceDiffPayment *pVw = (CFMInsuranceDiffPayment *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsuranceDiffPayment*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsuranceDiffPayment*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsuranceDiffPayment*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsuranceDiffPayment*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceDiffPaymentFnc(CWnd *pWnd){
	 return ((CFMInsuranceDiffPayment*)pWnd)->OnAddFMInsuranceDiffPayment();
} 
static int _OnEditFMInsuranceDiffPaymentFnc(CWnd *pWnd){
	 return ((CFMInsuranceDiffPayment*)pWnd)->OnEditFMInsuranceDiffPayment();
} 
static int _OnDeleteFMInsuranceDiffPaymentFnc(CWnd *pWnd){
	 return ((CFMInsuranceDiffPayment*)pWnd)->OnDeleteFMInsuranceDiffPayment();
} 
static int _OnSaveFMInsuranceDiffPaymentFnc(CWnd *pWnd){
	 return ((CFMInsuranceDiffPayment*)pWnd)->OnSaveFMInsuranceDiffPayment();
} 
static int _OnCancelFMInsuranceDiffPaymentFnc(CWnd *pWnd){
	 return ((CFMInsuranceDiffPayment*)pWnd)->OnCancelFMInsuranceDiffPayment();
}
static void _OnSODSelectFnc(CWnd *pWnd)
{
	 ((CFMInsuranceDiffPayment*)pWnd)->OnSODSelect();
}
static void _OnServicePackageSelectFnc(CWnd *pWnd)
{
	 ((CFMInsuranceDiffPayment*)pWnd)->OnServicePackageSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsuranceDiffPayment*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsuranceDiffPayment*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsuranceDiffPayment*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsuranceDiffPayment*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsuranceDiffPayment*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsuranceDiffPayment*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static long _OnObjectTypeLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsuranceDiffPayment *)pWnd)->OnObjectTypeLoadData();
}
static void _OnObjectTypeSelendokFnc(CWnd *pWnd)
{
	((CFMInsuranceDiffPayment *)pWnd)->OnObjectTypeSelendok();
}


CFMInsuranceDiffPayment::CFMInsuranceDiffPayment(CWnd *pParent)
{
	m_szWhere.Empty();
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
...
CFMInsuranceDiffPayment::~CFMInsuranceDiffPayment(){
}
void CFMInsuranceDiffPayment::OnCreateComponents()
{
	/*m_wndReportCondition.Create(this, _T("Report Condition"), 5, 5, 480, 535);
	m_wndYearLabel.Create(this, _T("Year"), 10, 30, 90, 55);
	m_wndYear.Create(this,96, 30, 240, 55); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 249, 30, 329, 55);
	m_wndReportPeriod.Create(this,334, 30, 478, 55); 
	m_wndFromDateLabel.Create(this, _T("From Date"), 10, 60, 90, 85);
	m_wndFromDate.Create(this,96, 60, 240, 85); 
	m_wndToDate.Create(this,334, 60, 478, 85); 
	m_wndToDateLabel.Create(this, _T("To Date"), 249, 60, 329, 85);
	m_wndClerkLabel.Create(this, _T("Clerk"), 10, 90, 90, 115);
	m_wndClerk.Create(this,96, 90, 240, 115); 
	m_wndOrderByLabel.Create(this, _T("Order By"), 10, 120, 90, 145);
	m_wndOrderBy.Create(this,96, 120, 240, 145); 
	m_wndStatusLabel.Create(this, _T("Status"), 249, 90, 330, 115);
	m_wndStatus.Create(this,334, 90, 478, 115); 
	m_wndList.Create(this,10, 150, 478, 471); 
	m_wndWithoutGeneral.Create(this, _T("Without General"), 10, 475, 115, 500);
	m_wndHitechMachine.Create(this, _T("Hitech Machine"), 121, 475, 239, 500);
	...
	m_wndOutpatient.Create(this, _T("Outpatient"), 121, 505, 238, 530);
	m_wndDeposit.Create(this, _T("Deposit"), 245, 505, 344, 530);
	m_wndAll.Create(this, _T("All"), 350, 505, 465, 530);
	m_wndSoldierWCard.Create(this, _T("Soldier w Card"), 350, 475, 465, 500);
	m_wndSOD.Create(this, _T("SOD"), 249, 120, 478, 145);
	m_wndServicePackage.Create(this, _T("ServicePackage"), 245, 475, 344, 500);*/

	m_wndReportCondition.Create(this, _T("Report Condition"), 5, 5, 480, 535);
	m_wndYearLabel.Create(this, _T("Year"), 10, 30, 90, 55);
	m_wndYear.Create(this,96, 30, 240, 55); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 249, 30, 330, 55);
	m_wndReportPeriod.Create(this,334, 30, 478, 55); 
	m_wndFromDateLabel.Create(this, _T("From Date"), 10, 60, 90, 85);
	m_wndFromDate.Create(this,96, 60, 240, 85); 
	m_wndToDate.Create(this,334, 60, 478, 85); 
	m_wndToDateLabel.Create(this, _T("To Date"), 249, 60, 330, 85);
	m_wndClerkLabel.Create(this, _T("Clerk"), 10, 90, 90, 115);
	m_wndClerk.Create(this,96, 90, 240, 115); 
	m_wndOrderByLabel.Create(this, _T("Order By"), 249, 120, 330, 145);
	m_wndOrderBy.Create(this,334, 120, 478, 145); 
	m_wndStatusLabel.Create(this, _T("Status"), 249, 90, 330, 115);
	m_wndStatus.Create(this,334, 90, 478, 115); 
	m_wndList.Create(this,10, 150, 478, 439); 
	m_wndWithoutGeneral.Create(this, _T("Without General"), 10, 475, 115, 500);
	m_wndHitechMachine.Create(this, _T("Hitech Machine"), 121, 475, 239, 500);
	m_wndMarkAll.Create(this, _T("Mark All"), 5, 540, 85, 565);
	m_wndUnMark.Create(this, _T("UnMark"), 90, 540, 170, 565);
	...
	m_wndAll.Create(this, _T("All"), 350, 505, 465, 530);
	m_wndSoldierWCard.Create(this, _T("Soldier w Card"), 350, 475, 465, 500);
	m_wndSOD.Create(this, _T("SOD"), 10, 444, 465, 469);
	m_wndServicePackage.Create(this, _T("ServicePackage"), 245, 475, 344, 500);
	m_wndObjectTypeLabel.Create(this, _T("Object Type"), 10, 120, 90, 145);
	m_wndObjectType.Create(this,95, 120, 240, 145); 
}
void CFMInsuranceDiffPayment::OnInitializeComponents(){
...
void CFMInsuranceDiffPayment::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
//	m_wndList.AddEvent(1, _T("Delete"), _OnListDeleteItemFnc, 0, VK_DELETE, 0);
	...
	/*
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddFMInsuranceDiffPaymentFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditFMInsuranceDiffPaymentFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteFMInsuranceDiffPaymentFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveFMInsuranceDiffPaymentFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelFMInsuranceDiffPaymentFnc, 0, 'T', VK_CONTROL);
	*/
...
void CFMInsuranceDiffPayment::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsuranceDiffPayment::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsuranceDiffPayment::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsuranceDiffPayment::SetDefaultValues(){
...
int CFMInsuranceDiffPayment::SetMode(int nMode){
...
/*void CFMInsuranceDiffPayment::OnYearChange(){
	
} */
/*void CFMInsuranceDiffPayment::OnYearSetfocus(){
	
} */
/*void CFMInsuranceDiffPayment::OnYearKillfocus(){
	
} */
int CFMInsuranceDiffPayment::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsuranceDiffPayment::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMInsuranceDiffPayment::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsuranceDiffPayment::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsuranceDiffPayment::OnReportPeriodKillfocus(){
	
}*/
long CFMInsuranceDiffPayment::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsuranceDiffPayment::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsuranceDiffPayment::OnFromDateChange(){
	
} */
/*void CFMInsuranceDiffPayment::OnFromDateSetfocus(){
	
} */
/*void CFMInsuranceDiffPayment::OnFromDateKillfocus(){
	
} */
int CFMInsuranceDiffPayment::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsuranceDiffPayment::OnToDateChange(){
	
} */
/*void CFMInsuranceDiffPayment::OnToDateSetfocus(){
	
} */
/*void CFMInsuranceDiffPayment::OnToDateKillfocus(){
	
} */
int CFMInsuranceDiffPayment::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsuranceDiffPayment::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsuranceDiffPayment::OnClerkSelendok(){
	 
}
/*void CFMInsuranceDiffPayment::OnClerkSetfocus(){
	
}*/
/*void CFMInsuranceDiffPayment::OnClerkKillfocus(){
	
}*/
long CFMInsuranceDiffPayment::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsuranceDiffPayment::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsuranceDiffPayment::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsuranceDiffPayment::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsuranceDiffPayment::OnStatusSetfocus(){
	
}*/
/*void CFMInsuranceDiffPayment::OnStatusKillfocus(){
	
}*/
long CFMInsuranceDiffPayment::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsuranceDiffPayment::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsuranceDiffPayment::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsuranceDiffPayment::OnOrderBySelendok(){
	 
}
/*void CFMInsuranceDiffPayment::OnOrderBySetfocus(){
	
}*/
/*void CFMInsuranceDiffPayment::OnOrderByKillfocus(){
	
}*/
long CFMInsuranceDiffPayment::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
long CFMInsuranceDiffPayment::OnObjectTypeLoadData()
{
...
void CFMInsuranceDiffPayment::OnObjectTypeSelendok()
{
	OnListLoadData();
}


/*void CFMInsuranceDiffPayment::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMInsuranceDiffPayment::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

	void CFMInsuranceDiffPayment::OnSODSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
void CFMInsuranceDiffPayment::OnServicePackageSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsuranceDiffPayment::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsuranceDiffPayment::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsuranceDiffPayment::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsuranceDiffPayment::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsuranceDiffPayment::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMInsuranceDiffPayment::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsuranceDiffPayment::OnInpatientSelect(){
	
}
void CFMInsuranceDiffPayment::OnOutpatientSelect(){
	
}
void CFMInsuranceDiffPayment::OnDepositSelect(){
	
}
void CFMInsuranceDiffPayment::OnAllSelect()
{
	
}
 
 
int CFMInsuranceDiffPayment::OnAddFMInsuranceDiffPayment(){
...
int CFMInsuranceDiffPayment::OnEditFMInsuranceDiffPayment(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsuranceDiffPayment::OnDeleteFMInsuranceDiffPayment(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelFMInsuranceDiffPayment();
 	}
	return 0;
}
int CFMInsuranceDiffPayment::OnSaveFMInsuranceDiffPayment(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnFMInsuranceDiffPaymentListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CFMInsuranceDiffPayment::OnCancelFMInsuranceDiffPayment(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsuranceDiffPayment::OnFMInsuranceDiffPaymentListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsuranceDiffPayment::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsuranceDiffPayment::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsuranceDiffPayment::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	szReportName = _T("Reports\\HMS\\HF_FMINSURANCEDIFFPAYMENT.RPT");
...
_tprintf(_T("\r\n1"));
	...
	data_name.Add(_T("ttl_fee"));
	data_name.Add(_T("co_payment"));
	data_name.Add(_T("patpaid"));
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMInsuranceDiffPayment"));
...
void CFMInsuranceDiffPayment::OnExportSelect()
{
	return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
CString CFMInsuranceDiffPayment::GetQueryString(){
	...
	if (m_bSoldierWCard) szWhere.AppendFormat(_T(" AND HFE_OBJECTID=11"));
	if(m_bServicePackage) szWhere.AppendFormat(_T(" HAVING SUM(hfe_packageamount)>0"));

	szView = _T("HF_INSURANCEDIFFPAID_VIEW");
	if (m_bHitechMachine)
		szView = _T("HF_HMINSURANCEDIFFPAID_VIEW");
...
_T("   SUM(mat_fee+mat_fee_ex)    AS mat_fee,") \
_T("   SUM(opt_fee) AS opt_fee,") \
_T("   SUM(dm_fee) as dm_fee, ") \
_T("   SUM(food_fee)              AS food_fee,") \
_T("   SUM(blood_fee) as blood_fee, ") \
_T("   SUM(bed_fee) as bed_fee, ") \
_T("   SUM(other_fee)             AS other_fee,") \
_T("   SUM(hfe_packageamount)     AS thu_goidv,") \
_T("   SUM(ROUND(test_fee+pacs_fee+ctscan_fee+mri_fee+pet_fee+cyberknife_fee+ik90_fee+drug_fee+mat_fee+mat_fee_ex+opt_fee+food_fee+other_fee+hfe_packageamount+dm_fee+blood_fee+bed_fee)) AS ttl_fee, ") \
_T("   SUM(ROUND(co_payment)) AS co_payment,") \
_T("   SUM (ROUND((patpaid)))    AS patpaid ") \
_T(" FROM %s ") \
_T(" WHERE 1=1 %s ") \
_T(" GROUP BY pname,") \
_T("   firstname,") \
...
int CFMInsuranceDiffPayment::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsuranceDiffPayment::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsuranceDiffPayment::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsuranceDiffPayment::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsuranceDiffPayment::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsuranceDiffPayment::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
