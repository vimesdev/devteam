#ifndef FMPAIDPATIENTLISTR5X_H
#define FMPAIDPATIENTLISTR5X_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPaidPatientListR5x : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CFMPaidPatientListR5x(CWnd *pParent);
	~CFMPaidPatientListR5x();
