#include "stdafx.h"
#include "FMInsurancePostedReceiptVoucherListRGSOM.h"
#include "HMSMainFrame.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedReceiptVoucherListRGSOM* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedReceiptVoucherListRGSOM* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedReceiptVoucherListRGSOM* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePostedReceiptVoucherListRGSOM* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMInsurancePostedReceiptVoucherListRGSOM *pVw = (CFMInsurancePostedReceiptVoucherListRGSOM *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnAddFMInsuranceIncomeList();
} 
static int _OnEditFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnEditFMInsuranceIncomeList();
} 
static int _OnDeleteFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnDeleteFMInsuranceIncomeList();
} 
static int _OnSaveFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnSaveFMInsuranceIncomeList();
} 
static int _OnCancelFMInsuranceIncomeListFnc(CWnd *pWnd){
	 return ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnCancelFMInsuranceIncomeList();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePostedReceiptVoucherListRGSOM*)pWnd)->OnSODSelect();
}

CFMInsurancePostedReceiptVoucherListRGSOM::CFMInsurancePostedReceiptVoucherListRGSOM(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMInsurancePostedReceiptVoucherListRGSOM::~CFMInsurancePostedReceiptVoucherListRGSOM(){
}
void CFMInsurancePostedReceiptVoucherListRGSOM::OnCreateComponents()
/*{
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnInitializeComponents(){
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsurancePostedReceiptVoucherListRGSOM::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePostedReceiptVoucherListRGSOM::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePostedReceiptVoucherListRGSOM::SetDefaultValues(){
...
int CFMInsurancePostedReceiptVoucherListRGSOM::SetMode(int nMode){
...
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnYearChange(){
	
} */
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnYearSetfocus(){
	
} */
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnYearKillfocus(){
	
} */
int CFMInsurancePostedReceiptVoucherListRGSOM::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMInsurancePostedReceiptVoucherListRGSOM::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePostedReceiptVoucherListRGSOM::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnFromDateChange(){
	
} */
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnFromDateKillfocus(){
	
} */
int CFMInsurancePostedReceiptVoucherListRGSOM::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnToDateChange(){
	
} */
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnToDateKillfocus(){
	
} */
int CFMInsurancePostedReceiptVoucherListRGSOM::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePostedReceiptVoucherListRGSOM::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedReceiptVoucherListRGSOM::OnClerkSelendok(){
	 
}
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnClerkKillfocus(){
	
}*/
long CFMInsurancePostedReceiptVoucherListRGSOM::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePostedReceiptVoucherListRGSOM::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedReceiptVoucherListRGSOM::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnStatusKillfocus(){
	
}*/
long CFMInsurancePostedReceiptVoucherListRGSOM::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePostedReceiptVoucherListRGSOM::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePostedReceiptVoucherListRGSOM::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePostedReceiptVoucherListRGSOM::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return 0;
...
/*void CFMInsurancePostedReceiptVoucherListRGSOM::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMInsurancePostedReceiptVoucherListRGSOM::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
	void CFMInsurancePostedReceiptVoucherListRGSOM::OnSODSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}

void CFMInsurancePostedReceiptVoucherListRGSOM::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsurancePostedReceiptVoucherListRGSOM::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePostedReceiptVoucherListRGSOM::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsurancePostedReceiptVoucherListRGSOM::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnInpatientSelect(){
	
}
void CFMInsurancePostedReceiptVoucherListRGSOM::OnOutpatientSelect(){
	
}
void CFMInsurancePostedReceiptVoucherListRGSOM::OnDepositSelect(){
	
}
void CFMInsurancePostedReceiptVoucherListRGSOM::OnAllSelect(){
	
}
 
 
int CFMInsurancePostedReceiptVoucherListRGSOM::OnAddFMInsuranceIncomeList(){
...
int CFMInsurancePostedReceiptVoucherListRGSOM::OnEditFMInsuranceIncomeList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePostedReceiptVoucherListRGSOM::OnDeleteFMInsuranceIncomeList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsurancePostedReceiptVoucherListRGSOM::OnSaveFMInsuranceIncomeList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsurancePostedReceiptVoucherListRGSOM::OnCancelFMInsuranceIncomeList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePostedReceiptVoucherListRGSOM::OnFMInsuranceIncomeListListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsurancePostedReceiptVoucherListRGSOM::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnPrint3rdver();
	return;
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnPrint2ndver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnPrint3rdver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CReport rpt;
	...
	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOTHU_BHYT_RG_1PTTYC.RPT");
	if (!rpt.Init(szReportName))
		return;
...
void CFMInsurancePostedReceiptVoucherListRGSOM::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMInsurancePostedReceiptVoucherListRGSOM::GetQueryString2(){
	return _T("");
}

CString CFMInsurancePostedReceiptVoucherListRGSOM::GetQueryString3(){
...
CString CFMInsurancePostedReceiptVoucherListRGSOM::GetQueryString(){
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
