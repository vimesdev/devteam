#ifndef FMPolicyPaidSummaryByDept_H
#define FMPolicyPaidSummaryByDept_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyPaidSummaryByDept : public CGuiView
{
    protected:
...
public:
	...
	CFMPolicyPaidSummaryByDept(CWnd *pWnd);
	~CFMPolicyPaidSummaryByDept();
