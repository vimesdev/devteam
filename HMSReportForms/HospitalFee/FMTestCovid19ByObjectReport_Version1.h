#ifndef FMTESTCOVID19BYOBJECTREPORTVER1_H
#define FMTESTCOVID19BYOBJECTREPORTVER1_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTestCovid19ByObjectReport_Ver1 : public CGuiView
{
...
public:
	...
	void			OnNoitruSelect(); 
	CFMTestCovid19ByObjectReport_Ver1(CWnd* pParent);
	~CFMTestCovid19ByObjectReport_Ver1();
