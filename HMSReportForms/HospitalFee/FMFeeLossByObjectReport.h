#ifndef FMFEELOSSBYOBJECTREPORT_H
#define FMFEELOSSBYOBJECTREPORT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFeeLossByObjectReport : public CGuiView
{
protected:
public:
	...
	void			OnPolicySelect(); 
	CFMFeeLossByObjectReport(CWnd* pParent);
	~CFMFeeLossByObjectReport();
