#include "stdafx.h"
#include "FMTotalRefundByFeeTypeAB.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd)
{
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel)
{
	((CFMTotalRefundByFeeTypeAB* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalRefundByFeeTypeAB* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalRefundByFeeTypeAB* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalRefundByFeeTypeAB* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMTotalRefundByFeeTypeAB *pVw = (CFMTotalRefundByFeeTypeAB *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnAllSelect();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnSODSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListCheckAllTYC();
	return 0;
}

static long _OnDoctorLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnDoctorLoadData();
}
static long _OnRoomLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalRefundByFeeTypeAB *)pWnd)->OnRoomLoadData();
}
static int _OnListCheckAllBHABFnc(CWnd *pWnd)
{
	((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListCheckAllBHAB();
	return 0;
}
static int _OnListCheckAllDVABFnc(CWnd *pWnd)
{
	((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListCheckAllDVAB();
	return 0;
}
static void _OnSoldierSelectFnc(CWnd *pWnd)
	{
		 ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnSoldierSelect();
	}

static int _OnListCheckAllQUANABFnc(CWnd *pWnd)
{
	((CFMTotalRefundByFeeTypeAB*)pWnd)->OnListCheckAllQUANAB();
	return 0;
}

static void _OnLoadAllSelectFnc(CWnd *pWnd)
{
	 ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnLoadAllSelect();
}

static void _OnLoadCLCzoneSelectFnc(CWnd *pWnd)
{
	 ((CFMTotalRefundByFeeTypeAB*)pWnd)->OnLoadCLCzoneSelect();
}



CFMTotalRefundByFeeTypeAB::CFMTotalRefundByFeeTypeAB(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMTotalRefundByFeeTypeAB::~CFMTotalRefundByFeeTypeAB(){
}
void CFMTotalRefundByFeeTypeAB::OnCreateComponents()
{
...
void CFMTotalRefundByFeeTypeAB::OnInitializeComponents(){
...
void CFMTotalRefundByFeeTypeAB::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalRefundByFeeTypeAB::OnDoDataExchange(CDataExchange* pDX){
...
void CFMTotalRefundByFeeTypeAB::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMTotalRefundByFeeTypeAB::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMTotalRefundByFeeTypeAB::SetDefaultValues(){
...
int CFMTotalRefundByFeeTypeAB::SetMode(int nMode){
...
/*void CFMTotalRefundByFeeTypeAB::OnYearChange(){
	
} */
/*void CFMTotalRefundByFeeTypeAB::OnYearSetfocus(){
	
} */
/*void CFMTotalRefundByFeeTypeAB::OnYearKillfocus(){
	
} */
int CFMTotalRefundByFeeTypeAB::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMTotalRefundByFeeTypeAB::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMTotalRefundByFeeTypeAB::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
void CFMTotalRefundByFeeTypeAB::OnLoadAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	OnListLoadData();
}

	void CFMTotalRefundByFeeTypeAB::OnLoadCLCzoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}

/*void CFMTotalRefundByFeeTypeAB::OnReportPeriodSetfocus(){
	
}*/
/*void CFMTotalRefundByFeeTypeAB::OnReportPeriodKillfocus(){
	
}*/
long CFMTotalRefundByFeeTypeAB::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMTotalRefundByFeeTypeAB::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMTotalRefundByFeeTypeAB::OnFromDateChange(){
	
} */
/*void CFMTotalRefundByFeeTypeAB::OnFromDateSetfocus(){
	
} */
/*void CFMTotalRefundByFeeTypeAB::OnFromDateKillfocus(){
	
} */
int CFMTotalRefundByFeeTypeAB::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMTotalRefundByFeeTypeAB::OnToDateChange(){
	
} */
/*void CFMTotalRefundByFeeTypeAB::OnToDateSetfocus(){
	
} */
/*void CFMTotalRefundByFeeTypeAB::OnToDateKillfocus(){
	
} */
int CFMTotalRefundByFeeTypeAB::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMTotalRefundByFeeTypeAB::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalRefundByFeeTypeAB::OnClerkSelendok(){
	 
}
int CFMTotalRefundByFeeTypeAB::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMTotalRefundByFeeTypeAB::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalRefundByFeeTypeAB::OnListCheckAllBHAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalRefundByFeeTypeAB::OnListCheckAllDVAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMTotalRefundByFeeTypeAB::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}

/*void CFMTotalRefundByFeeTypeAB::OnClerkSetfocus(){
	
}*/
/*void CFMTotalRefundByFeeTypeAB::OnClerkKillfocus(){
	
}*/
long CFMTotalRefundByFeeTypeAB::OnDoctorLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
long CFMTotalRefundByFeeTypeAB::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return 0;
}

/*void CFMTotalRefundByFeeTypeAB::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalRefundByFeeTypeAB::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalRefundByFeeTypeAB::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMTotalRefundByFeeTypeAB::OnStatusSetfocus(){
	
}*/
/*void CFMTotalRefundByFeeTypeAB::OnStatusKillfocus(){
	
}*/
long CFMTotalRefundByFeeTypeAB::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalRefundByFeeTypeAB::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalRefundByFeeTypeAB::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalRefundByFeeTypeAB::OnOrderBySelendok(){
	 
}
/*void CFMTotalRefundByFeeTypeAB::OnOrderBySetfocus(){
	
}*/
/*void CFMTotalRefundByFeeTypeAB::OnOrderByKillfocus(){
	
}*/
long CFMTotalRefundByFeeTypeAB::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalRefundByFeeTypeAB::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
long CFMTotalRefundByFeeTypeAB::OnRoomLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
long CFMTotalRefundByFeeTypeAB::OnDeptLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMTotalRefundByFeeTypeAB::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMTotalRefundByFeeTypeAB::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMTotalRefundByFeeTypeAB::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMTotalRefundByFeeTypeAB::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMTotalRefundByFeeTypeAB::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	//szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('DV-AB','BH-NGAB')"));//
	szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('DV-AB','BH-NGAB') OR (fac_cashbook_id in ('BHQUAN-NT', 'BHQUAN-NG') AND fac_invoicetype in('P') and FAC_POSTED ='Y' AND fac_user_id in (select su_userid from sys_user where su_deptid='AB' and su_groupid='F'))"));
	szWhere.AppendFormat(_T(" and FAC_POSTEDDATE between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') "),m_szFromDate, m_szToDate);
...
void CFMTotalRefundByFeeTypeAB::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, TRUE);
	
} 
void CFMTotalRefundByFeeTypeAB::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, FALSE);
}

void CFMTotalRefundByFeeTypeAB::OnInpatientSelect(){
	
}
void CFMTotalRefundByFeeTypeAB::OnOutpatientSelect(){
	
}
void CFMTotalRefundByFeeTypeAB::OnDepositSelect(){
	
}
void CFMTotalRefundByFeeTypeAB::OnAllSelect(){
	
}
 
void CFMTotalRefundByFeeTypeAB::OnSODSelect(){
	OnListLoadData();
}
void CFMTotalRefundByFeeTypeAB::OnSoldierSelect()
{
	OnListLoadData();
}
 
int CFMTotalRefundByFeeTypeAB::OnAddFMInsuranceReceiptSummary(){
...
int CFMTotalRefundByFeeTypeAB::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMTotalRefundByFeeTypeAB::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMTotalRefundByFeeTypeAB::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMTotalRefundByFeeTypeAB::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMTotalRefundByFeeTypeAB::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMTotalRefundByFeeTypeAB::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return;
	UpdateData(TRUE);
...
void CFMTotalRefundByFeeTypeAB::OnPrint1stver()
{
	return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
...
void CFMTotalRefundByFeeTypeAB::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMTotalRefundByFeeTypeAB"));
...
void CFMTotalRefundByFeeTypeAB::OnExportSelect()
{
	...
	TranslateString(_T("Export tổng hợp chi trả dịch vụ"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 1, tmpStr);
	TranslateString(_T("Export tổng hợp chi trả bảo hiểm"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 2, tmpStr);
...
void CFMTotalRefundByFeeTypeAB::OnExportDetail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_CHI_BN_DICHVU_KHU_AB.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_CHI_BN_DICHVU_KHU_AB2.xls"));
}
void CFMTotalRefundByFeeTypeAB::OnExportTotal()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_CHITRA_BN_BHYT_KHU_AB.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_CHITRA_BN_BHYT_KHU_AB2.xls"));
}
void CFMTotalRefundByFeeTypeAB::OnExportTotalAll()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
void CFMTotalRefundByFeeTypeAB::OnPrint2ndver_(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
int CFMTotalRefundByFeeTypeAB::OnCheckBeforePrint(CReport* rpt, CRecord& rs){
	CString szSQL;
	szSQL = GetQueryString();
...
void CFMTotalRefundByFeeTypeAB::OnPrintOther(CReport* rpt){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalRefundByFeeTypeAB::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	//return;
...
void CFMTotalRefundByFeeTypeAB::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept){
	//return;
	CString tmpStr, szLabel;
	rs->GetValue(_T("posted_date"), tmpStr);
	bNewDate = tmpStr==m_szPrevDate?false:true;
...
void CFMTotalRefundByFeeTypeAB::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept, CReportSection* pDateGroup, CReportSection* pDeptGroup){
	//return;
...
void CFMTotalRefundByFeeTypeAB::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept){
	//return;
	CReportSection* rptGrp = NULL;
	CString szPos;
	if (bNewDept && m_nDeptSum[12] > 0){
...
void CFMTotalRefundByFeeTypeAB::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalRefundByFeeTypeAB::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReportSection* rptGroup = NULL;
	CString tmpStr;
	if (bNewDate){
...
void CFMTotalRefundByFeeTypeAB::OnPrintDetail(CReport* rpt, CRecord* rs)
{
...
void CFMTotalRefundByFeeTypeAB::OnPrintDetail(CReport* rpt, CReportSection* ppDetail, CRecord* rs){
...
void CFMTotalRefundByFeeTypeAB::OnCalcData(CRecord* rs, bool& bNewDate, bool& bNewDept)
{
	double nTmp = 0;
	for (int i = 0; i < 18; i++){
...
void CFMTotalRefundByFeeTypeAB::ResetVar(){
	for (int i = 0; i < 18; i++){
		m_nTotal[i] = 0;
		m_nDeptSum[i] = 0;
		m_nDaySum[i] = 0;
...
CString CFMTotalRefundByFeeTypeAB::GetQueryStringDetail()
{
	...
	if (!m_szDeptKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND dept_id = '%s'"), m_szDeptKey);
			...
			szSQL.Format(_T(" SELECT feetype,") \
					...
					_T("   ||']'AS roomid,") \
					_T("   deptid,") \
					_T("   SUM(sl_dichvu+sl_dichvu1)    AS total_sl_dichvu,") \
					_T("   SUM(tt_sl_dichvu+tt_sl_dichvu1) AS total_tt_sl_dichvu") \
					_T(" FROM") \
					_T("   (SELECT feetype,") \
					_T("     feename,") \
					_T("     feeindex,") \
					...
					_T("       f.hfe_type      AS feetype,") \
					_T("       hfg_fee_index AS feeindex,") \
					_T("       hfg_fee_name  AS feename,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type IN ('D','M')") \
					_T("         THEN hfg_name") \
					_T("         ELSE NULL") \
					_T("       END AS roomid,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type IN ('D','M')") \
					_T("         AND r.Hfe_Objectid =7") \
					...
					_T("     AND product_org_id     IN ('PM' ,'MA','BB')") \
					...
					_T("         THEN rl.Hfe_cost") \
					_T("         ELSE 0") \
					_T("       END tt_sl_dichvu1") \
					_T("     FROM hms_fee f") \
					_T("     LEFT JOIN hms_fee_group") \
					_T("     ON (f.hfe_group=hfg_id)") \
					_T("     LEFT JOIN Hms_Fee_Refundline rl") \
					...
					_T("   feetype,") \
					_T("   deptid"), szWhere, szWhere);
			return szSQL;	
}
double CFMTotalRefundByFeeTypeAB::OnRound(double nToRound){
	nToRound += 0.5;
	return floor(nToRound);
}

CString CFMTotalRefundByFeeTypeAB::GetQueryStringTotal()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	if (!m_szDeptKey.IsEmpty())
		...
		szSQL.Format(_T(" SELECT feetype,") \
					...
					_T("   ||']'AS roomid,") \
					_T("   deptid,") \
					_T("   SUM(sl_bhyt_quan+sl_bhyt_quan1)                             AS total_sl_bhyt_quan,") \
					_T("   SUM(tt_bhyt_quan+tt_bhyt_quan1)                               AS total_tt_bhyt_quan,") \
					_T("   SUM(sl_bhyt_quanhuu+sl_bhyt_quanhuu1)                 AS total_sl_bhyt_quanhuu,") \
					_T("   SUM(tt_bhyt_quanhuu+tt_bhyt_quanhuu1)                   AS total_tt_bhyt_quanhuu,") \
					_T("   SUM(sl_bhyt_khac+sl_bhyt_khac1)                              AS sl_bhyt_khac,") \
					_T("   SUM(tt_bhyt_khac+tt_bhyt_khac1)                               AS total_tt_bhyt_khac,") \
					_T("   SUM(tt_bhyt_quan+tt_bhyt_quanhuu+tt_bhyt_khac+tt_bhyt_quan1+tt_bhyt_quanhuu1+tt_bhyt_khac1) AS total") \
					_T(" FROM") \
					_T("   (SELECT feetype,") \
					_T("     feename,") \
					_T("     feeindex,") \
					...
					_T("       CASE") \
					_T("         WHEN f.hfe_type IN ('D','M')") \
					_T("         AND r.Hfe_Objectid =2") \
					_T("         THEN rl.Hfe_Quantity") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_quanhuu,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type      IN ('D','M')") \
					_T("         AND r.Hfe_Objectid NOT IN (1,3,7,8,2,11)") \
					_T("         THEN rl.Hfe_Quantity") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_khac,") \
					_T("       CASE") \
					...
					_T("       END tt_bhyt_khac,") \
					_T("     0 sl_bhyt_quan1,") \
					_T("     0 sl_bhyt_quanhuu1,") \
					_T("     0 sl_bhyt_khac1,") \
					_T("     0 tt_bhyt_quan1,") \
					_T("     0 tt_bhyt_quanhuu1,") \
					_T("     0 tt_bhyt_khac1") \
					_T("     FROM hms_fee f") \
					_T("     LEFT JOIN hms_fee_group") \
					_T("     ON (hfe_group=hfg_id)") \
					...
					_T("       END AS roomid,") \
					_T("         0 sl_bhyt_quan,") \
					_T("         0 sl_bhyt_quanhuu,") \
					_T("         0 sl_bhyt_khac,") \
					_T("         0 tt_bhyt_quan,") \
					_T("         0 tt_bhyt_quanhuu,") \
					_T("         0 tt_bhyt_khac,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type IN ('D','M')") \
					_T("         AND rl.Hfe_Objectid =11") \
					_T("         THEN rl.Hfe_Quantity") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_quan1,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type IN ('D','M')") \
					_T("         AND rl.Hfe_Objectid =2") \
					_T("         THEN rl.Hfe_Quantity") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_quanhuu1,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type      IN ('D','M')") \
					_T("         AND rl.Hfe_Objectid NOT IN (1,3,7,8,2,11)") \
					_T("         THEN rl.Hfe_Quantity") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_khac1,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type IN ('D','M')") \
					_T("         AND rl.Hfe_Objectid =11") \
					_T("         THEN rl.Hfe_cost") \
					_T("         ELSE 0") \
					_T("       END tt_bhyt_quan1,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type IN ('D','M')") \
					_T("         AND rl.Hfe_Objectid =2") \
					_T("         THEN rl.Hfe_cost") \
					_T("         ELSE 0") \
					_T("       END tt_bhyt_quanhuu1,") \
					_T("       CASE") \
					_T("         WHEN f.hfe_type      IN ('D','M')") \
					_T("         AND rl.Hfe_Objectid NOT IN (1,3,7,8,2,11)") \
					_T("         THEN rl.Hfe_cost") \
					_T("         ELSE 0") \
					_T("       END tt_bhyt_khac1") \
					_T("      FROM hms_fee f") \
					_T("     LEFT JOIN hms_fee_group") \
					_T("     ON (f.hfe_group=hfg_id)") \
					_T("     LEFT JOIN Hms_Fee_Refundline rl") \
...
CString CFMTotalRefundByFeeTypeAB::GetQueryString()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	return szSQL;	
}
CString CFMTotalRefundByFeeTypeAB::GetQueryStringTotalAll()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
...
int CFMTotalRefundByFeeTypeAB::OnListCheckAllQUANAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
