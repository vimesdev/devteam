#ifndef FMFoodPolicyPostedReceiptList_H
#define FMFoodPolicyPostedReceiptList_H
...
class CFMFoodPolicyPostedReceiptList : public CGuiView
{
...
public:
	...
	CFMFoodPolicyPostedReceiptList(CWnd *pWnd);
	~CFMFoodPolicyPostedReceiptList();
