#include "stdafx.h"
#include "FMObjectFood.h"
#include "HMSMainFrame.h"
#include "Excel.h"
#include "StringToken.h"
/*static void _OnDateChangeFnc(CWnd *pWnd){
	((CFMObjectFood *)pWnd)->OnDateChange();
} */
/*static void _OnDateSetfocusFnc(CWnd *pWnd){
	((CFMObjectFood *)pWnd)->OnDateSetfocus();} */ 
/*static void _OnDateKillfocusFnc(CWnd *pWnd){
	((CFMObjectFood *)pWnd)->OnDateKillfocus();
} */
static int _OnDateCheckValueFnc(CWnd *pWnd){
	return ((CFMObjectFood *)pWnd)->OnDateCheckValue();
} 
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMObjectFood* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CFMObjectFood *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CFMObjectFood *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CFMObjectFood *)pWnd)->OnDepartmentKillfocus();
}*/
static double _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CFMObjectFood *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CFMObjectFood *)pWnd)->OnDepartmentAddNew();
}*/
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMObjectFood*)pWnd)->OnAllSelect();
}
static void _OnBreakfastSelectFnc(CWnd *pWnd){
	  ((CFMObjectFood*)pWnd)->OnBreakfastSelect();
}
static void _OnLunchSelectFnc(CWnd *pWnd){
	  ((CFMObjectFood*)pWnd)->OnLunchSelect();
}
static void _OnDinnerSelectFnc(CWnd *pWnd){
	  ((CFMObjectFood*)pWnd)->OnDinnerSelect();
}
static void _OnExportSelectFnc(CWnd *pWnd){
	CFMObjectFood *pVw = (CFMObjectFood *)pWnd;
	pVw->OnExportSelect();
} 
static int _OnAddNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CFMObjectFood*)pWnd)->OnAddNTTObjectFood();
} 
static int _OnEditNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CFMObjectFood*)pWnd)->OnEditNTTObjectFood();
} 
static int _OnDeleteNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CFMObjectFood*)pWnd)->OnDeleteNTTObjectFood();
} 
static int _OnSaveNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CFMObjectFood*)pWnd)->OnSaveNTTObjectFood();
} 
static int _OnCancelNTTObjectFoodFnc(CWnd *pWnd){
	 return ((CFMObjectFood*)pWnd)->OnCancelNTTObjectFood();
} 
CFMObjectFood::CFMObjectFood(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMObjectFood::~CFMObjectFood(){
}
void CFMObjectFood::OnCreateComponents(){
...
void CFMObjectFood::OnInitializeComponents(){
...
void CFMObjectFood::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMObjectFood::OnDoDataExchange(CDataExchange* pDX){
...
void CFMObjectFood::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMObjectFood::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMObjectFood::SetDefaultValues(){
...
int CFMObjectFood::SetMode(int nMode){
...
/*void CFMObjectFood::OnDateChange(){
	
} */
/*void CFMObjectFood::OnDateSetfocus(){
	
} */
/*void CFMObjectFood::OnDateKillfocus(){
	
} */
int CFMObjectFood::OnDateCheckValue(){
	return 0;
} 
void CFMObjectFood::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMObjectFood::OnDepartmentSelendok(){
	 
}
/*void CFMObjectFood::OnDepartmentSetfocus(){
	
}*/
/*void CFMObjectFood::OnDepartmentKillfocus(){
	
}*/
long CFMObjectFood::OnDepartmentLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMObjectFood::OnDepartmentAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMObjectFood::OnAllSelect(){
	
}
void CFMObjectFood::OnBreakfastSelect(){
	
}
void CFMObjectFood::OnLunchSelect(){
	
}
void CFMObjectFood::OnDinnerSelect(){
	
}
void CFMObjectFood::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
CString CFMObjectFood::GetQueryString()
{
	CString szSQL, szWhere;
...
int CFMObjectFood::OnAddNTTObjectFood(){
...
int CFMObjectFood::OnEditNTTObjectFood(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMObjectFood::OnDeleteNTTObjectFood(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMObjectFood::OnSaveNTTObjectFood(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMObjectFood::OnCancelNTTObjectFood(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMObjectFood::OnNTTObjectFoodListLoadData(){
	return 0;
}
