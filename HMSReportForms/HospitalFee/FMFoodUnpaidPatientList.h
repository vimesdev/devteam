#ifndef FMFOODUNPAIDPATIENTLIST_H
#define FMFOODUNPAIDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFoodUnpaidPatientList : public CGuiView{
protected:
public:
	...
	CGuiRadioButton	m_wndIndischarge;
	...
	CFMFoodUnpaidPatientList(CWnd* pParent);
	~CFMFoodUnpaidPatientList();
	...
	int OnAddFMFoodUnpaidPatientList(); 
	int OnEditFMFoodUnpaidPatientList(); 
	int OnDeleteFMFoodUnpaidPatientList(); 
	int OnSaveFMFoodUnpaidPatientList(); 
	int OnCancelFMFoodUnpaidPatientList(); 
	int OnFMFoodUnpaidPatientListListLoadData();
