#ifndef FMServiceRefundSummaryByDept_H
#define FMServiceRefundSummaryByDept_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceRefundSummaryByDept : public CGuiView
{
protected:
...
public:
	...
	CFMServiceRefundSummaryByDept(CWnd *pWnd);
	~CFMServiceRefundSummaryByDept();
