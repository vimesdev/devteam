#ifndef FMPAIDDISCHARGEDINSPATIENT_H
#define FMPAIDDISCHARGEDINSPATIENT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPaidDischargedInsPatient : public CGuiView{
protected:
public:
	...
	void			OnExamSelect(); 
	void			OnInwardSelect(); 
	CFMPaidDischargedInsPatient(CWnd *pParent);
	~CFMPaidDischargedInsPatient();
