#ifndef FMSERVICEINCOMELIST_V2_H
#define FMSERVICEINCOMELIST_V2_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceIncomeList_v2 : public CGuiView{
protected:
...
public:
	...
	CFMServiceIncomeList_v2(CWnd *pWnd);
	~CFMServiceIncomeList_v2();
