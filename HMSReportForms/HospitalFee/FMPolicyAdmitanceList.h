#ifndef FMPOLICYADMITANCELIST_H
#define FMPOLICYADMITANCELIST_H
...
#include "DbField.h"
#include "Excel.h"
class CFMPolicyAdmitanceList : public CGuiView
{
...
public:
	...
	CFMPolicyAdmitanceList(CWnd* pParent);
	~CFMPolicyAdmitanceList();
