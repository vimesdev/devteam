#ifndef FMFOODORDERBYDAYSUMMARY_H
#define FMFOODORDERBYDAYSUMMARY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFoodOrderByDaySummary : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndFoodOrderByDay;
	...
	void			OnPrintDetail();
	void			OnExportSelect(); 
	CFMFoodOrderByDaySummary(CWnd *pWnd);
	~CFMFoodOrderByDaySummary();
