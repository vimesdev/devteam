#include "stdafx.h"
#include "FMPolicyPostedPaymentVoucherList.h"
#include "HMSMainFrame.h"
#include "StringToken.h"
#include "FMFinancialDocumentPrinter.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentVoucherList* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentVoucherList* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentVoucherList* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentVoucherList* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMPolicyPostedPaymentVoucherList *pVw = (CFMPolicyPostedPaymentVoucherList *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static int _OnAddFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnAddFMInsurancePostedPaymentVoucherList();
} 
static int _OnEditFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnEditFMInsurancePostedPaymentVoucherList();
} 
static int _OnDeleteFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnDeleteFMInsurancePostedPaymentVoucherList();
} 
static int _OnSaveFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnSaveFMInsurancePostedPaymentVoucherList();
} 
static int _OnCancelFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnCancelFMInsurancePostedPaymentVoucherList();
}
static void _OnSODSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnSODSelect();
}

static void _OnIncomePackageSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnIncomePackageSelect();
}
static void _OnOutlayPackageSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnOutlayPackageSelect();
}
static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}

static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnABZoneSelect();
}
static void _OnAllInsSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnAllInsSelect();
}

static void _OnTCKTSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedPaymentVoucherList*)pWnd)->OnTCKTSelect();
}

CFMPolicyPostedPaymentVoucherList::CFMPolicyPostedPaymentVoucherList(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMPolicyPostedPaymentVoucherList::~CFMPolicyPostedPaymentVoucherList()
{
}
void CFMPolicyPostedPaymentVoucherList::OnCreateComponents()
{
...
void CFMPolicyPostedPaymentVoucherList::OnInitializeComponents(){
...
void CFMPolicyPostedPaymentVoucherList::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPostedPaymentVoucherList::OnDoDataExchange(CDataExchange* pDX){
...
void CFMPolicyPostedPaymentVoucherList::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMPolicyPostedPaymentVoucherList::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMPolicyPostedPaymentVoucherList::SetDefaultValues(){
...
int CFMPolicyPostedPaymentVoucherList::SetMode(int nMode){
...
/*void CFMPolicyPostedPaymentVoucherList::OnYearChange(){
	
} */
/*void CFMPolicyPostedPaymentVoucherList::OnYearSetfocus(){
	
} */
/*void CFMPolicyPostedPaymentVoucherList::OnYearKillfocus(){
	
} */
int CFMPolicyPostedPaymentVoucherList::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMPolicyPostedPaymentVoucherList::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPostedPaymentVoucherList::OnTCKTSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
	
}
 
void CFMPolicyPostedPaymentVoucherList::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMPolicyPostedPaymentVoucherList::OnReportPeriodSetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentVoucherList::OnReportPeriodKillfocus(){
	
}*/
void CFMPolicyPostedPaymentVoucherList::OnABZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
	
}
long CFMPolicyPostedPaymentVoucherList::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMPolicyPostedPaymentVoucherList::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMPolicyPostedPaymentVoucherList::OnFromDateChange(){
	
} */
/*void CFMPolicyPostedPaymentVoucherList::OnFromDateSetfocus(){
	
} */
/*void CFMPolicyPostedPaymentVoucherList::OnFromDateKillfocus(){
	
} */
int CFMPolicyPostedPaymentVoucherList::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMPolicyPostedPaymentVoucherList::OnToDateChange(){
	
} */
/*void CFMPolicyPostedPaymentVoucherList::OnToDateSetfocus(){
	
} */
/*void CFMPolicyPostedPaymentVoucherList::OnToDateKillfocus(){
	
} */
int CFMPolicyPostedPaymentVoucherList::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMPolicyPostedPaymentVoucherList::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedPaymentVoucherList::OnClerkSelendok(){
	 
}
/*void CFMPolicyPostedPaymentVoucherList::OnClerkSetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentVoucherList::OnClerkKillfocus(){
	
}*/
long CFMPolicyPostedPaymentVoucherList::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMPolicyPostedPaymentVoucherList::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedPaymentVoucherList::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedPaymentVoucherList::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMPolicyPostedPaymentVoucherList::OnStatusSetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentVoucherList::OnStatusKillfocus(){
	
}*/
long CFMPolicyPostedPaymentVoucherList::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedPaymentVoucherList::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedPaymentVoucherList::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedPaymentVoucherList::OnOrderBySelendok(){
	 
}
/*void CFMPolicyPostedPaymentVoucherList::OnOrderBySetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentVoucherList::OnOrderByKillfocus(){
	
}*/
long CFMPolicyPostedPaymentVoucherList::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedPaymentVoucherList::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMPolicyPostedPaymentVoucherList::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
	void CFMPolicyPostedPaymentVoucherList::OnSODSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
	
}
	void CFMPolicyPostedPaymentVoucherList::OnIncomePackageSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMPolicyPostedPaymentVoucherList::OnOutlayPackageSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPostedPaymentVoucherList::OnListDblClick(){
...
void CFMPolicyPostedPaymentVoucherList::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMPolicyPostedPaymentVoucherList::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
void CFMPolicyPostedPaymentVoucherList::OnAllInsSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
	
}
long CFMPolicyPostedPaymentVoucherList::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMPolicyPostedPaymentVoucherList::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMPolicyPostedPaymentVoucherList::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPostedPaymentVoucherList::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);	
	CGuiMenu menu(this);
	CString tmpStr;
...
int CFMPolicyPostedPaymentVoucherList::OnAddFMInsurancePostedPaymentVoucherList(){
...
int CFMPolicyPostedPaymentVoucherList::OnEditFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMPolicyPostedPaymentVoucherList::OnDeleteFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMPolicyPostedPaymentVoucherList::OnSaveFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMPolicyPostedPaymentVoucherList::OnCancelFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMPolicyPostedPaymentVoucherList::OnFMInsurancePostedPaymentVoucherListListLoadData(){
	return 0;
}


void CFMPolicyPostedPaymentVoucherList::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportFooter()->SetValue(_T("ClassName"), _T("CFMPolicyPostedPaymentVoucherList"));
	rpt.PrintPreview();
}

void CFMPolicyPostedPaymentVoucherList::OnPrint3rdver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	CStringArray data_name;
	long double nTotal[22], nGroupTotal1[22];
	for (int i = 0; i < 22; i++)
	{
		nGroupTotal1[i] = 0;
		nTotal[i] = 0;
	}
	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOCHI_QUANCHINHSACH_1.RPT");
	if (!rpt.Init(szReportName))
		return;
...
void CFMPolicyPostedPaymentVoucherList::OnExportSelect()
{
	/*return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
CString CFMPolicyPostedPaymentVoucherList::GetQueryString3()
{
	...
	_T("   ROUND(SUM(hfe_miengiamE)) AS mien_giamI,") \
...
CString CFMPolicyPostedPaymentVoucherList::GetQueryString(){
...
CString CFMPolicyPostedPaymentVoucherList::GetQueryString2(){
...
void CFMPolicyPostedPaymentVoucherList::OnPrintSummaryReceipt(double nTotalAmount)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
...
void CFMPolicyPostedPaymentVoucherList::OnPrintFooterUser(CReportSection* rptFooter){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
int CFMPolicyPostedPaymentVoucherList::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedPaymentVoucherList::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedPaymentVoucherList::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedPaymentVoucherList::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedPaymentVoucherList::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedPaymentVoucherList::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMPolicyPostedPaymentVoucherList::OnPrint3rdver_2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPostedPaymentVoucherList::PrintFinancialDocument()
{
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	szSQL.Format(_T(" SELECT posted_date,") \
	_T("        ROUND(SUM(hfe_patpaid-thu_chinh_sach-mien_giam)) AS vien_phi,") \
	...
	_T("		ROUND(SUM(cong_chi-chi_doituong-chi_maycnc-chi_de_muc-chi_khac-chi_goidv)) AS chi_tra_BHYT") \
	_T(" FROM   (%s)") \
...
CString CFMPolicyPostedPaymentVoucherList::GetQueryString3_2()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
	CString szOrderBy;
	CString szReceiptStr = _T("-1");
...
CString CFMPolicyPostedPaymentVoucherList::GetQueryString_check()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
