#include "stdafx.h"
#include "FMOutpatientInsuranceReport19A_TrangBi.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnYearKillfocus();

} */
static void _OnSoldierPatientSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnSoldierPatientSelect();
}
static void _OnNotinSoldierPatientSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnNotinSoldierPatientSelect();
}
static void _OnCheckCategorySelectFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnCheckCategorySelect();
}
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMOutpatientInsuranceReport19A_TrangBi* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnToDateCheckValue();
} 
static void _OnPatientLineSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMOutpatientInsuranceReport19A_TrangBi* )pWnd)->OnPatientLineSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPatientLineSelendokFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnPatientLineSelendok();
}
/*static void _OnPatientLineSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnPatientLineKillfocus();
}*/
...
{
	return ((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnPatientLineLoadData();
}
/*static void _OnPatientLineAddNewFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi *)pWnd)->OnPatientLineAddNew();
}*/
static void _OnDrugPTTTSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnDrugPTTTSelect();
}
static void _OnByDischargedDateSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnByDischargedDateSelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMOutpatientInsuranceReport19A_TrangBi *pVw = (CFMOutpatientInsuranceReport19A_TrangBi *)pWnd;
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMOutpatientInsuranceReport19A_TrangBi*)pWnd)->OnListDeleteItem();
} 
CFMOutpatientInsuranceReport19A_TrangBi::CFMOutpatientInsuranceReport19A_TrangBi(CWnd *pParent)
{
	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMOutpatientInsuranceReport19A_TrangBi::~CFMOutpatientInsuranceReport19A_TrangBi(){
}
void CFMOutpatientInsuranceReport19A_TrangBi::OnCreateComponents(){	
	...
	m_wndCheckCategory.Create(this, _T("Check trong gói"), 10, 521, 190, 546);

}
void CFMOutpatientInsuranceReport19A_TrangBi::OnInitializeComponents(){
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	m_wndCheckCategory.SetEvent(WE_CLICK, _OnCheckCategorySelectFnc);
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndCheckCategory.GetDlgCtrlID(), m_bCheckCategory);
}
void CFMOutpatientInsuranceReport19A_TrangBi::SetDefaultValues(){
	...
	m_bCheckCategory = FALSE;

}

int CFMOutpatientInsuranceReport19A_TrangBi::SetMode(int nMode){
...
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnYearChange(){
	
} */
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnYearSetfocus(){
	
} */
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnYearKillfocus(){
	
} */
int CFMOutpatientInsuranceReport19A_TrangBi::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMOutpatientInsuranceReport19A_TrangBi::OnSoldierPatientSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMOutpatientInsuranceReport19A_TrangBi::OnNotinSoldierPatientSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMOutpatientInsuranceReport19A_TrangBi::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnReportPeriodSetfocus(){
	
}*/
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnReportPeriodKillfocus(){
	
}*/
long CFMOutpatientInsuranceReport19A_TrangBi::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnFromDateChange(){
	
} */
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnFromDateSetfocus(){
	
} */
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnFromDateKillfocus(){
	
} */
int CFMOutpatientInsuranceReport19A_TrangBi::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnToDateChange(){
	
} */
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnToDateSetfocus(){
	
} */
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnToDateKillfocus(){
	
} */
int CFMOutpatientInsuranceReport19A_TrangBi::OnToDateCheckValue(){
	return 0;
}
 
void CFMOutpatientInsuranceReport19A_TrangBi::OnPatientLineSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMOutpatientInsuranceReport19A_TrangBi::OnPatientLineSelendok(){
	 
}
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnPatientLineSetfocus(){
	
}*/
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnPatientLineKillfocus(){
	
}*/
long CFMOutpatientInsuranceReport19A_TrangBi::OnPatientLineLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMOutpatientInsuranceReport19A_TrangBi::OnPatientLineAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMOutpatientInsuranceReport19A_TrangBi::OnDrugPTTTSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

void CFMOutpatientInsuranceReport19A_TrangBi::OnByDischargedDateSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMOutpatientInsuranceReport19A_TrangBi::OnCheckCategorySelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMOutpatientInsuranceReport19A_TrangBi::OnPrintPreviewSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
	CRect rect;
	...
	TranslateString(_T("Export 19A Format"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 1, tmpStr);
	
	TranslateString(_T("Export Detail Format"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 2, tmpStr);

	TranslateString(_T("Export 19A lên cổng bảo hiểm"), tmpStr);
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnExport(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	...
	tmpStr.Format(_T("%s"),pMF->m_CompanyInfo.sc_pname);
	xls.SetCellText(nCol, nRow, tmpStr, FMT_TEXT | FMT_CENTER, true, 10);
	tmpStr.Format(_T("%s"),pMF->m_CompanyInfo.sc_name);
	xls.SetCellText(nCol, nRow + 1, tmpStr, FMT_TEXT | FMT_CENTER, true, 10);
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnExportDetail(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnListDblClick(){
	
}
 
void CFMOutpatientInsuranceReport19A_TrangBi::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMOutpatientInsuranceReport19A_TrangBi::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMOutpatientInsuranceReport19A_TrangBi::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	m_wndList.BeginLoad(); 
...
int CFMOutpatientInsuranceReport19A_TrangBi::OnListCheckAll(){
...
int CFMOutpatientInsuranceReport19A_TrangBi::OnListUnCheckAll(){
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (m_wndList.GetCheck(i))
		{
...
CString CFMOutpatientInsuranceReport19A_TrangBi::GetQueryString(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
			
	CString szSQL, szSubSQL, szWhere, szSubWhere, szHospitalID;
	CString szLineWhere, szDept, szTable, szFeeCondition;
	szHospitalID.Format(_T("%s"), pMF->m_CompanyInfo.sc_id);
	...
	szWhere.AppendFormat(_T(" AND i.hfe_class IN ('E', 'I')"));
	...
	if(m_bCheckCategory)
		szWhere.AppendFormat(_T(" AND hfe_category in ('Y') "));
	else
		szWhere.AppendFormat(_T(" AND hfe_category in ('N','BQP') "));
...
CString CFMOutpatientInsuranceReport19A_TrangBi::GetQueryString1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMOutpatientInsuranceReport19A_TrangBi::OnExport_1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	...
	while (!rs.IsEOF())
	{
		...
		xls.SetCellText(8, nRow, rs.GetValue(_T("qty")), FMT_NUMBER1);
		rs.GetValue(_T("amount"), nCost);
		nGroupCost += nCost;
		xls.SetCellText(9, nRow, double2str(nCost), FMT_NUMBER1);
		xls.SetCellText(10, nRow, rs.GetValue(_T("org_price")), FMT_NUMBER1);
		nRow++;
		rs.MoveNext();
	}
	
	EndWaitCursor();
	xls.Save(_T("Exports\\Thong Ke Vat Tu Theo Quy_ngoaitru_chuyen bao hiem.xls"));

}
CString CFMOutpatientInsuranceReport19A_TrangBi::GetQueryString2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL, szSubSQL, szWhere, szSubWhere, szHospitalID;
	CString szLineWhere, szDept, szTable, szFeeCondition;
	/*
	...
	*/	
	...
	szSubSQL.AppendFormat(		
		...
		_T("				   Cast ('E' AS NVARCHAR2(1)) chapter, ") \
		_T("                   hfe_group                        group_id, ") \
		_T("                   Get_feegroupname(hfe_group)      group_name, mp_atccode, ") \
		_T("                   f.hfe_desc                       item_name, 0 org_price,f.hfe_unit don_vi,") \
		_T("                   hfe_quantity                qty, ") \
		_T("                   CASE WHEN f.hfe_feegroup = 'OPT' THEN ROUND(f.hfe_unitprice, 2) ELSE ROUND(f.hfe_insprice, 2) END unit_price, ") \
		_T("                   CASE WHEN f.hfe_feegroup = 'OPT' THEN ROUND(f.hfe_cost, 2) ELSE ROUND(f.hfe_inspaid, 2) END amount ") \
		_T("         FROM      hms_fee f ") \
		_T("		 LEFT JOIN hms_doc ON (hd_docno = hfe_docno) ") \
		_T("		 %s") \
		_T("         LEFT JOIN hms_fee_invoice i ON ( f.hfe_docno = i.hfe_docno ") \
	...
	szSQL.Format(_T(" SELECT mp_atccode, item_name AS ten_vattu, item_name, '' AS quy_cach, don_vi, sum(qty) AS qty, unit_price AS unit_price, org_price, sum(amount) AS amount ") \
				_T(" FROM   (") \
				_T(" %s) ") \
				_T(" GROUP BY chapter, group_id, group_name, mp_atccode, item_name, don_vi, unit_price,org_price") \
				_T(" ORDER  BY chapter, ") \
				_T("           group_id, ") \
				_T("           item_name "), szSubSQL);
	_fmsg(_T("%s"), szSQL);
