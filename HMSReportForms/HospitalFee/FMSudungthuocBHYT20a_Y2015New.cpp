#include "stdafx.h"
#include "FMSudungthuocBHYT20a_Y2015New.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015New* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015New* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnTypeAddNew();
}*/
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015New* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015New* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnSourceAddNew();
}*/
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New *)pWnd)->OnItemLoadData();
}
static void _OnDrugPTTTSelectFnc(CWnd *pWnd){
	 ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnDrugPTTTSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnAllSelect();
}
static void _OnInPatientSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnInPatientSelect();
}
static void _OnOutPatientSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnOutPatientSelect();
}
static void _OnOutInDeptSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnOutInDeptSelect();
}
static void _OnOrderBySelectFnc(CWnd *pWnd){
	 ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnOrderBySelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMSudungthuocBHYT20a_Y2015New *pVw = (CFMSudungthuocBHYT20a_Y2015New *)pWnd;
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnListDeleteItem();
}
static int _OnAddFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnAddFMSudungthuocBHYT20a();
} 
static int _OnEditFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnEditFMSudungthuocBHYT20a();
} 
static int _OnDeleteFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnDeleteFMSudungthuocBHYT20a();
} 
static int _OnSaveFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnSaveFMSudungthuocBHYT20a();
} 
static int _OnCancelFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnCancelFMSudungthuocBHYT20a();
}

static int _OnListCheckAllFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnListCheckAll();
}
static int _OnListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015New*)pWnd)->OnListUnCheckAll();
}

CFMSudungthuocBHYT20a_Y2015New::CFMSudungthuocBHYT20a_Y2015New(CWnd *pParent)
{
	m_nDlgWidth = 460;
	m_nDlgHeight = 495;
	SetDefaultValues();
}
CFMSudungthuocBHYT20a_Y2015New::~CFMSudungthuocBHYT20a_Y2015New()
{
}
void CFMSudungthuocBHYT20a_Y2015New::OnCreateComponents()
{
...
void CFMSudungthuocBHYT20a_Y2015New::OnInitializeComponents()
{
...
void CFMSudungthuocBHYT20a_Y2015New::OnSetWindowEvents()
{
...
void CFMSudungthuocBHYT20a_Y2015New::OnDoDataExchange(CDataExchange* pDX)
{
...
void CFMSudungthuocBHYT20a_Y2015New::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMSudungthuocBHYT20a_Y2015New::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMSudungthuocBHYT20a_Y2015New::SetDefaultValues()
{
	m_szFromDate.Empty();
	m_szToDate.Empty();
	m_szStockKey.Empty();
...
int CFMSudungthuocBHYT20a_Y2015New::SetMode(int nMode)
{
...
/*void CFMSudungthuocBHYT20a_Y2015New::OnFromDateChange(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015New::OnFromDateSetfocus(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015New::OnFromDateKillfocus(){
	
} */
int CFMSudungthuocBHYT20a_Y2015New::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMSudungthuocBHYT20a_Y2015New::OnToDateChange(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015New::OnToDateSetfocus(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015New::OnToDateKillfocus(){
	
} */
int CFMSudungthuocBHYT20a_Y2015New::OnToDateCheckValue(){
	return 0;
} 
void CFMSudungthuocBHYT20a_Y2015New::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015New::OnStockSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015New::OnStockSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015New::OnStockKillfocus(){
	
}*/

long CFMSudungthuocBHYT20a_Y2015New::OnStockLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMSudungthuocBHYT20a_Y2015New::OnStockAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungthuocBHYT20a_Y2015New::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015New::OnTypeSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015New::OnTypeSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015New::OnTypeKillfocus(){
	
}*/
long CFMSudungthuocBHYT20a_Y2015New::OnTypeLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungthuocBHYT20a_Y2015New::OnTypeAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungthuocBHYT20a_Y2015New::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015New::OnGroupSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015New::OnGroupSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015New::OnGroupKillfocus(){
	
}*/
long CFMSudungthuocBHYT20a_Y2015New::OnGroupLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungthuocBHYT20a_Y2015New::OnGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungthuocBHYT20a_Y2015New::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015New::OnSourceSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015New::OnSourceSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015New::OnSourceKillfocus(){
	
}*/
long CFMSudungthuocBHYT20a_Y2015New::OnSourceLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungthuocBHYT20a_Y2015New::OnSourceAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMSudungthuocBHYT20a_Y2015New::OnItemLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	void CFMSudungthuocBHYT20a_Y2015New::OnDrugPTTTSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMSudungthuocBHYT20a_Y2015New::OnAllSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
	void CFMSudungthuocBHYT20a_Y2015New::OnInPatientSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
	void CFMSudungthuocBHYT20a_Y2015New::OnOutPatientSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
	void CFMSudungthuocBHYT20a_Y2015New::OnOutInDeptSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
void CFMSudungthuocBHYT20a_Y2015New::OnOrderBySelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

void CFMSudungthuocBHYT20a_Y2015New::OnPrintPreviewSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CFMSudungthuocBHYT20a_Y2015New::OnPrintDetail(){

}

void CFMSudungthuocBHYT20a_Y2015New::OnExportSelect()
{
	CGuiMenu menu(this);
	CString tmpStr;
...
void CFMSudungthuocBHYT20a_Y2015New::OnExport(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CExcel xls;
	CRecord rs(&pMF->m_db);
...
void CFMSudungthuocBHYT20a_Y2015New::OnExportDetail(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CExcel xls;
...
void CFMSudungthuocBHYT20a_Y2015New::OnExport2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMSudungthuocBHYT20a_Y2015New::OnExport3(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldGroup, szNewGroup;
...
void CFMSudungthuocBHYT20a_Y2015New::OnListDblClick(){
	
} 
void CFMSudungthuocBHYT20a_Y2015New::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMSudungthuocBHYT20a_Y2015New::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMSudungthuocBHYT20a_Y2015New::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
int CFMSudungthuocBHYT20a_Y2015New::OnAddFMSudungthuocBHYT20a(){
...
int CFMSudungthuocBHYT20a_Y2015New::OnEditFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CFMSudungthuocBHYT20a_Y2015New::OnDeleteFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CFMSudungthuocBHYT20a_Y2015New::OnSaveFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CFMSudungthuocBHYT20a_Y2015New::OnCancelFMSudungthuocBHYT20a(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CFMSudungthuocBHYT20a_Y2015New::OnFMSudungthuocBHYT20aListLoadData(){
	return 0;
}

CString CFMSudungthuocBHYT20a_Y2015New::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
	CString szSQL, szWhere, szOrderBy, szWhere1, szWhere2;
	CString szDept, szCondition1, szCondition2, szCondition3, szCondition4, szDiscount;

	szWhere1.Format(_T(" AND fi.hfe_status = 'P' ") \
		_T("  AND fi.hfe_date BETWEEN to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss')"), m_szFromDate, m_szToDate);
	szWhere2.Format(_T(" AND fi.hfe_status = 'P' ") \
		_T("  AND fi.hfe_date BETWEEN to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss')"), m_szFromDate, m_szToDate);

	if (m_bByDischargedDate)
	{
		szWhere1.Format(_T(" AND hcrf_acceptedfee IN ('Y', 'P') ") \
			_T("  AND hcr_dischargedate BETWEEN to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss')"), m_szFromDate, m_szToDate);
		szWhere2.Format(_T(" AND hdf_acceptedfee IN ('Y', 'P') ") \
			_T("  AND fi.hfe_date BETWEEN to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss')"), m_szFromDate, m_szToDate);
	}
	else if (m_bInsuranceApproval)
	{
		szWhere1.Format(_T(" AND fi.hfe_approved IN ('Y', 'P') ") \
			_T("  AND fi.hfe_approveddate BETWEEN to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss')"), m_szFromDate, m_szToDate);
		szWhere2.Format(_T(" AND fi.hfe_approved IN ('Y', 'P') ") \
			_T("  AND fi.hfe_approveddate BETWEEN to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd|hh24:mi:ss')"), m_szFromDate, m_szToDate);
	}
	...
	if (!m_szTypeKey.IsEmpty())
		{
			szWhere1.AppendFormat(_T(" AND product_producttype = '%s'"), m_szTypeKey);
			szWhere2.AppendFormat(_T(" AND product_producttype = '%s'"), m_szTypeKey);
		}

	if (!m_szGroupKey.IsEmpty())
		{
			szWhere1.AppendFormat(_T(" AND product_categoryid = '%s'"), m_wndGroup.GetCurrent(2));
			szWhere2.AppendFormat(_T(" AND product_categoryid = '%s'"), m_wndGroup.GetCurrent(2));
		}

	if (m_bDrugPTTT)
		{
			szWhere1.AppendFormat(_T(" AND NVL(hpo_feetype, 'X') <> 'PT'"));
			szWhere2.AppendFormat(_T(" AND NVL(hpo_feetype, 'X') <> 'PT'"));
		}
	...
	if (!szDept.IsEmpty())
		{
			szWhere1.AppendFormat(_T(" AND fi.hfe_deptid IN(%s) "), szDept);
			szWhere2.AppendFormat(_T(" AND fi.hfe_deptid IN(%s) "), szDept);
		}

	if (m_bOnlyCommander)
		{
			szWhere1.AppendFormat(_T(" AND hd_rank IN (15, 16, 17, 18, 21, 22, 23, 24)"));
			szWhere2.AppendFormat(_T(" AND hd_rank IN (15, 16, 17, 18, 21, 22, 23, 24)"));
		}

	if(m_bInsuranceUnpaid)
		{
			szWhere1.AppendFormat(_T(" AND fe.hfe_discount = 0 AND msl_category = 'I'"));
			szWhere2.AppendFormat(_T(" AND fe.hfe_discount = 0 AND msl_category = 'I'"));
		}
	else
		{
			szWhere1.AppendFormat(_T(" AND fe.hfe_discount > 0"));
			szWhere2.AppendFormat(_T(" AND fe.hfe_discount > 0"));
		}

	if(m_nOutPatient == 0)
		{
			szCondition1.Format(_T("WHERE fi.hfe_class = 'E'"));
			szCondition2.Format(_T("WHERE fi.hfe_class = 'E'"));
			szCondition3.Format(_T("WHERE 0 = 1"));
			szCondition4.Format(_T("WHERE 0 = 1"));
		}
	if(m_nInPatient == 0)
		{
			szCondition1.Format(_T("WHERE fi.hfe_class = 'I'"));
			szCondition2.Format(_T("WHERE fi.hfe_class = 'I'"));
			szCondition3.Format(_T("WHERE 0 = 1"));
			szCondition4.Format(_T("WHERE 0 = 1"));
		}
	if(m_nOutInDept == 0)
		{
			szCondition1.Format(_T("WHERE 0 = 1"));
			szCondition2.Format(_T("WHERE 0 = 1"));
			szCondition3.Format(_T("WHERE fi.hfe_class = 'I'"));
			szCondition4.Format(_T("WHERE fi.hfe_class = 'I'"));
		}
	if(m_nAll == 0)
		{
			szCondition1.Format(_T("WHERE 1 = 1"));
			szCondition2.Format(_T("WHERE 1 = 1"));
			szCondition3.Format(_T("WHERE 1 = 1"));
			szCondition4.Format(_T("WHERE 1 = 1"));
		}
	...
	szSQL.Format(_T(" SELECT patient_line,") \
		...
		_T("   unit,") \
		_T("   countryname,") \
		_T("   pspecification AS specification,") \
		_T("   ins_price AS price,") \
		_T("   SUM(inward_qty) inward_qty,") \
		_T("   SUM(exam_qty) exam_qty,") \
		_T("   SUM(amount) amount") \
		_T(" FROM") \
		_T("   (SELECT hms_getpatientline(hpo_docno)      AS patient_line,") \
		_T("     hpo_docno                                AS doc_no,") \
		_T("     hfg_index                                AS idx,") \
		...
		_T("     product_specification                                         AS pspecification,") \
		_T("     CASE WHEN fi.hfe_class = 'I' THEN hfe_quantity ELSE 0 END     AS inward_qty,") \
		_T("     0                                                             AS exam_qty,") \
		_T("     DECODE(fe.hfe_insprice, 0, fe.hfe_unitprice, fe.hfe_insprice) AS ins_price,") \
		_T("     CASE WHEN fi.hfe_class = 'I' THEN fe.hfe_inspaid ELSE 0 END   AS amount,") \
		_T("     NVL(hpo_feetype, 'X')                                         AS fee_type") \
		...
		_T("     product_specification                                         AS pspecification,") \
		_T("     0															   AS inward_qty,") \
		_T("     CASE WHEN fi.hfe_class <> 'I' THEN hfe_quantity ELSE 0 END    AS exam_qty,") \
		_T("     DECODE(fe.hfe_insprice, 0, fe.hfe_unitprice, fe.hfe_insprice) AS ins_price,") \
		_T("     CASE WHEN fi.hfe_class <> 'I' THEN fe.hfe_inspaid ELSE 0 END  AS amount,") \
		_T("     NVL(hpo_feetype, 'X')                                         AS fee_type") \
		_T("   FROM hms_pharmaorder_view") \
		...
		_T("   LEFT JOIN hms_treatment_record") \
		_T("   ON (htr_docno        = hcr_docno") \
		_T("   AND fi.hfe_treattime = htr_treattime)") \
		_T("   LEFT JOIN hms_object") \
		_T("   ON( hd_object = ho_id )") \
		_T("   LEFT JOIN m_product_view") \
		_T("   ON ( product_id = hpol_product_id )") \
		...
		_T("   AND hd_status                = 'T' %s") \
		_T("   )") \
		_T(" HAVING SUM(inward_qty + exam_qty) > 0 ") \
		...
		_T("   pspecification,") \
		_T("   ins_price") \
		_T(" ORDER BY %s patient_line,") \
		_T("   idx,") \
		_T("   drugname,") \
		_T("   unit"), szCondition1, szWhere1, szCondition2, szWhere2, szCondition3, szWhere1, szCondition4, szWhere2, szOrderBy);

		_fmsg(_T("%s"), szSQL);
		return szSQL;
}

CString CFMSudungthuocBHYT20a_Y2015New::GetQueryString1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
...
CString CFMSudungthuocBHYT20a_Y2015New::GetQueryString2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
	CString szSQL, szWhere, szOrderBy;
	CString szDept, szFeeCondition;
...
CString CFMSudungthuocBHYT20a_Y2015New::GetQueryString3(){
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
	CString szSQL, szWhere, szOrderBy;
	CString szDept, szFeeCondition;
...
int CFMSudungthuocBHYT20a_Y2015New::OnListCheckAll()
{
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (!m_wndList.GetCheck(i))
...
int CFMSudungthuocBHYT20a_Y2015New::OnListUnCheckAll()
{
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (m_wndList.GetCheck(i))
