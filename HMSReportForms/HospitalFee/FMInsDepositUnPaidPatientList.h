#ifndef INSDEPOSITUNPAIDPATIENTLIST_H
#define INSDEPOSITUNPAIDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsDepositUnPaidPatientList : public CGuiView{
protected:
public:
	...
	CFMInsDepositUnPaidPatientList(CWnd *pParent);
	~CFMInsDepositUnPaidPatientList();
