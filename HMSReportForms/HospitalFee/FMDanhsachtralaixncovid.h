#ifndef FMDANHSACHTRALAIXNCOVID_H
#define FMDANHSACHTRALAIXNCOVID_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDanhsachtralaixncovid : public CGuiView
{
...
public:
	...
	CFMDanhsachtralaixncovid(CWnd* pParent);
	~CFMDanhsachtralaixncovid();
