#ifndef FMEXPORTSHEETLISTFORINSURANCE_H
#define FMEXPORTSHEETLISTFORINSURANCE_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMExportSheetListForInsurance : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect(); 
	CFMExportSheetListForInsurance(CWnd *pParent);
	~CFMExportSheetListForInsurance();
