#include "stdafx.h"
#include "FMInsurancePaidSummarybyDept.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnYearKillfocus();
} */
static void _OnCreateDataSelectFnc(CWnd *pWnd)
{
	CFMInsurancePaidSummaryByDept *pVw = (CFMInsurancePaidSummaryByDept *)pWnd;
	pVw->OnCreateDataSelect();
} 

static void _OnObjectTypeSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnObjectTypeSelendok();
}

static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDept* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnReportPeriodSelendok();
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListCheckAllRefund();
	return 0;
}

/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDept* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDept* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMInsurancePaidSummaryByDept* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDept*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMInsurancePaidSummaryByDept*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDept*)pWnd)->OnListDeleteItem();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDept*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDept*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDept*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDept*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDept*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDept*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDept*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDept*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMInsurancePaidSummaryByDept*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDept*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMInsurancePaidSummaryByDept*)pWnd)->OnSODSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMInsurancePaidSummaryByDept*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static void _OnSoldierWCardSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummaryByDept*)pWnd)->OnSoldierWCardSelect();
}

static long _OnObjectTypeLoadDataFnc(CWnd *pWnd)
{
	return ((CFMInsurancePaidSummaryByDept *)pWnd)->OnObjectTypeLoadData();
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMInsurancePaidSummaryByDept*)pWnd)->OnABZoneSelect();
}
static void _OnTCKTSelectFnc(CWnd *pWnd){
	 ((CFMInsurancePaidSummaryByDept*)pWnd)->OnTCKTSelect();
}



CFMInsurancePaidSummaryByDept::CFMInsurancePaidSummaryByDept(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
...
CFMInsurancePaidSummaryByDept::~CFMInsurancePaidSummaryByDept()
{
}
void CFMInsurancePaidSummaryByDept::OnCreateComponents()
{
...
void CFMInsurancePaidSummaryByDept::OnInitializeComponents(){
...
void CFMInsurancePaidSummaryByDept::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummaryByDept::OnDoDataExchange(CDataExchange* pDX){
...
void CFMInsurancePaidSummaryByDept::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMInsurancePaidSummaryByDept::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMInsurancePaidSummaryByDept::SetDefaultValues(){
...
int CFMInsurancePaidSummaryByDept::SetMode(int nMode){
...
/*void CFMInsurancePaidSummaryByDept::OnYearChange(){
	
} */
/*void CFMInsurancePaidSummaryByDept::OnYearSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDept::OnYearKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDept::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMInsurancePaidSummaryByDept::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMInsurancePaidSummaryByDept::OnTCKTSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
void CFMInsurancePaidSummaryByDept::OnCreateDataSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDept::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMInsurancePaidSummaryByDept::OnReportPeriodSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDept::OnReportPeriodKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDept::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMInsurancePaidSummaryByDept::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMInsurancePaidSummaryByDept::OnFromDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDept::OnFromDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDept::OnFromDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDept::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMInsurancePaidSummaryByDept::OnToDateChange(){
	
} */
/*void CFMInsurancePaidSummaryByDept::OnToDateSetfocus(){
	
} */
/*void CFMInsurancePaidSummaryByDept::OnToDateKillfocus(){
	
} */
int CFMInsurancePaidSummaryByDept::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMInsurancePaidSummaryByDept::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

long CFMInsurancePaidSummaryByDept::OnObjectTypeLoadData()
{
...
void CFMInsurancePaidSummaryByDept::OnObjectTypeSelendok()
{
	OnListLoadData();
}
void CFMInsurancePaidSummaryByDept::OnABZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
...
void CFMInsurancePaidSummaryByDept::OnSoldierWCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMInsurancePaidSummaryByDept::OnClerkSelendok(){
	 
}
int CFMInsurancePaidSummaryByDept::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMInsurancePaidSummaryByDept::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMInsurancePaidSummaryByDept::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMInsurancePaidSummaryByDept::OnSODSelect(){
	OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDept::OnClerkSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDept::OnClerkKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDept::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMInsurancePaidSummaryByDept::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDept::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDept::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMInsurancePaidSummaryByDept::OnStatusSetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDept::OnStatusKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDept::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummaryByDept::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMInsurancePaidSummaryByDept::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMInsurancePaidSummaryByDept::OnOrderBySelendok(){
	 
}
/*void CFMInsurancePaidSummaryByDept::OnOrderBySetfocus(){
	
}*/
/*void CFMInsurancePaidSummaryByDept::OnOrderByKillfocus(){
	
}*/
long CFMInsurancePaidSummaryByDept::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMInsurancePaidSummaryByDept::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMInsurancePaidSummaryByDept::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMInsurancePaidSummaryByDept::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMInsurancePaidSummaryByDept::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMInsurancePaidSummaryByDept::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMInsurancePaidSummaryByDept::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMInsurancePaidSummaryByDept::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDept::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMInsurancePaidSummaryByDept::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMInsurancePaidSummaryByDept::OnInpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDept::OnOutpatientSelect(){
	
}
void CFMInsurancePaidSummaryByDept::OnDepositSelect(){
	
}
void CFMInsurancePaidSummaryByDept::OnAllSelect(){
	
}
 
 
int CFMInsurancePaidSummaryByDept::OnAddFMInsuranceReceiptSummary(){
...
int CFMInsurancePaidSummaryByDept::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMInsurancePaidSummaryByDept::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMInsurancePaidSummaryByDept::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMInsurancePaidSummaryByDept::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMInsurancePaidSummaryByDept::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMInsurancePaidSummaryByDept::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummaryByDept::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDept::OnPrint2ndver()
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMInsurancePaidSummaryByDept"));
...
void CFMInsurancePaidSummaryByDept::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	CGuiMenu menu(this);
	...
	TranslateString(_T("Xuất tổng hợp theo khoa version 4.0"), tmpStr);
...
void CFMInsurancePaidSummaryByDept::OnExportPatientList()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDept::OnExportDetailSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMInsurancePaidSummaryByDept::OnExportTotalList(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOP_CHIPHI_NGOAITRU_NOITRU_THEOKHOA_BH_TH2.xls"));
}
void CFMInsurancePaidSummaryByDept::OnExportTotalList1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMInsurancePaidSummaryByDept::GetQueryString()
{
...
CString CFMInsurancePaidSummaryByDept::GetQueryString2()
{
...
CString CFMInsurancePaidSummaryByDept::GetQueryString_check()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMInsurancePaidSummaryByDept::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDept::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDept::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
		int nCheck = 0;
...
int CFMInsurancePaidSummaryByDept::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDept::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDept::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMInsurancePaidSummaryByDept::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDept::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMInsurancePaidSummaryByDept::OnDeleteDataBeforeInsert()
{
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL; 	
...
CString CFMInsurancePaidSummaryByDept::GetQueryString3()
{
...
CString CFMInsurancePaidSummaryByDept::GetQueryString_v2()
{
...
CString CFMInsurancePaidSummaryByDept::GetQueryString_check_v2()
{
  ...
  szSQL7.Format(_T("     UNION ALL") \
				...
				_T("     AND f.hfe_status    IN ('P','R')") \
				_T("     AND F.Hfe_type       ='O'") \
				_T("     AND f.hfe_category  NOT IN ('Y', 'P')"));
  }
  else
  {
  szSQL7.Format(_T("     UNION ALL") \
...
//9.1 Phi vat tu noi tru
	szSQL11.Format(_T("     UNION ALL") \
				...
				_T("     AND product_org_id NOT IN ('PM','BB')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
				_T("     AND (hfe_category NOT IN ('Y', 'P') OR (hfe_category='Y' AND HFE_TREAT_INPACKAGE='Y'))"));
//10. Thuoc phong mo//
 szSQL12.Format(_T("     UNION ALL") \
				_T(" SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
...
CString CFMInsurancePaidSummaryByDept::GetQueryString_v3()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
szSQL24.Format(_T("     UNION ALL") \
		...
		szSQL26.Format(_T("  UNION ALL") \
				...
				_T("       fi.hfe_date,") \
				_T("       0 AS hfe_quantity,") \
				_T("       CAST ('C10' AS NVARCHAR2(15)) khoa_thuchien,") \
				_T("       NULL,") \
				_T("       0             AS TIEN_KHAM,") \
				_T("       0             AS TIEN_GIUONG,") \
				_T("       0             AS TIEN_CLS,") \
				...
				_T("  case when fi.hfe_docno=24691483 and fi.hfe_invoiceno = 20605296 ") \
				_T("           then 13944000") \
				_T("           when fi.hfe_docno=24704188 and fi.hfe_invoiceno = 20605296") \
				_T("           then 9276000 else 0  end  AS THU_KHAC,") \
				...
				_T("     FROM hms_fee_invoice fi") \
				_T("     WHERE 1             =1 ") \
				_T("  and fi.hfe_docno IN (24691483, 24704188)") \
				_T("         and fi.hfe_invoiceno IN (20605296, 20627198)") \
				_T("     AND fi.hfe_status  IN ('P','R')"));
	...
	_T(" ORDER BY dept_id"),
	m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,
	szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20,szSQL21, szSQL22,szSQL23,szSQL24, szSQL25 ,szSQL26, szWhere1, szWhere);
	//szSQL.Format(_T("WITH tbl") \
	//_T("     AS (%s)") \
	//_T(" SELECT") \
	//_T(" dept_id,") \
...
void CFMInsurancePaidSummaryByDept::OnExportTotalListEX()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMInsurancePaidSummaryByDept::GetQueryString_v5()
{
...
void CFMInsurancePaidSummaryByDept::OnExportTotalList5()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMInsurancePaidSummaryByDept::GetQueryString_v55()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMInsurancePaidSummaryByDept::OnExportTotalList_V2(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\TONGHOP_CHIPHI_NGOAITRU_NOITRU_THEOKHOA_BH_TH_V4.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TONGHOP_CHIPHI_NGOAITRU_NOITRU_THEOKHOA_BH_TH_V4xx.xls"));
}
CString CFMInsurancePaidSummaryByDept::GetQueryString_v4()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19, szSQL20,szSQL21,szSQL22,szSQL23,szSQL24,szSQL25, szSQL27, szSQL28, szSQL29, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	int nCount = 0;
	CRecord rs(&pMF->m_db);	
	szReceiptStr = _T("-1");
...
//Tách phần chọn BS ra
	...
	_T(" SUM(TIEN_KHAM+TIEN_GIUONG+TIEN_CLS+TIEN_PTTT+TIEN_THUOC_CH_NGOAITRU+TIEN_THUOC_CH_NOITRU+TIEN_VAT_TU_CH_NGOAITRU+TIEN_VAT_TU_CH_NOITRU+TIEN_THUOC_PM+TIEN_VAT_TU_PM+TIEN_MAU+THU_KHAC+THU_GOI+TIEN_AN+TIEN_THUOC_TG+TIEN_VAT_TU_TG+TIEN_THUOC_TG_O+TIEN_VAT_TU_TG_O+CHON_BS) as TONG_THU1") \
	_T(" FROM") \
	_T(" (") \
	_T(" SELECT") \
	_T("   Get_patientname(iv.hfe_docno) as HO_TEN,") \
	...
	_T("   LEFT JOIN  (") \
	//_T("    %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s ") \//
	_T("    %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s ") \
	//_T("    %s %s ") \//
	_T("   )tbl1 ON (iv.hfe_invoiceno = tbl1.hfe_invoiceno AND iv.hfe_docno = tbl1.hfe_docno )") \
	_T("   LEFT JOIN HMS_DOC d  ON ( d.HD_DOCNO=tbl1.HFE_DOCNO)") \
	_T("   LEFT JOIN HMS_CLINICAL_RECORD cr   ON ( cr.HCR_DOCNO=tbl1.HFE_DOCNO)") \
	...
	_T(" GROUP BY ") \
	_T(" dept_id") \
	_T(" HAVING SUM(TIEN_KHAM+TIEN_GIUONG+TIEN_CLS+TIEN_PTTT+TIEN_THUOC_CH_NGOAITRU+TIEN_THUOC_CH_NOITRU+TIEN_VAT_TU_CH_NGOAITRU+TIEN_VAT_TU_CH_NOITRU+TIEN_THUOC_PM+TIEN_VAT_TU_PM+TIEN_MAU+THU_KHAC+THU_GOI+TIEN_THUOC_TG_O+TIEN_VAT_TU_TG_O+TIEN_AN+TIEN_THUOC_TG+TIEN_VAT_TU_TG+CHON_BS)>0") \
	_T(" ORDER BY dept_id"),
	m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,
	szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20,szSQL21, szSQL22,szSQL23,szSQL24, szSQL25 , szSQL27, szSQL28, szSQL29,szWhere1, szWhere);
	//szSQL.Format(_T("WITH tbl") \
	//_T("     AS (%s)") \
	//_T(" SELECT") \
	//_T(" dept_id,") \
...
void CFMInsurancePaidSummaryByDept::OnExportv2(int nVersion)
...
CString CFMInsurancePaidSummaryByDept::GetQueryString_v10()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
  ...
  szSQL2.Format(_T("     UNION ALL     ") \
				...
				_T("     AND f.hfe_deptid <> 'B5'") \
				_T("     AND product_org_id NOT IN ('MA','BB', 'PĐD', 'HC')") \
				_T("     AND (f.hfe_category   NOT IN ('Y') OR (f.hfe_category='Y' AND HFE_TREAT_INPACKAGE='Y'))"), szWhere);
  ...
  szSQL3.Format(_T("     UNION ALL") \
				...
				_T("     AND product_org_id NOT IN ('PM','BB', 'PĐD')") \
				_T("     AND f.hfe_deptid <> 'B5'") \
				_T("     AND f.hfe_category    NOT IN ('Y', 'P')"), szWhere);
...
rs.ExecSQL(szSQL);
   szSQL.Format(_T(" WITH tbl AS (%s)") \
				...
				_T(" %s") \
				_T(" ORDER BY dept_id,posted_date"),m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4, szWhere1, szWherebed);			
