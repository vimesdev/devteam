#ifndef FMTotalRefundByDoctorAB_H
#define FMTotalRefundByDoctorAB_H
...
class CFMTotalRefundByDoctorAB : public CGuiView
{
protected:
...
public:
	...
	CFMTotalRefundByDoctorAB(CWnd *pWnd);
	~CFMTotalRefundByDoctorAB();
