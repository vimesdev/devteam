#ifndef FMAPPROVEDDISCHARGEDINSPATIENT_H
#define FMAPPROVEDDISCHARGEDINSPATIENT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMApprovedDischargedInsPatient : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndPaidDischargedInsurancePatient;
	...
	void			OnExamSelect(); 
	void			OnInwardSelect(); 
	CFMApprovedDischargedInsPatient(CWnd *pParent);
	~CFMApprovedDischargedInsPatient();
