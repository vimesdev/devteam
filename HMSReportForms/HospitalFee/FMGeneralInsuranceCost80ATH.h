#ifndef FMGENERALINSURANCECOST80ATH_H
#define FMGENERALINSURANCECOST80ATH_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMGeneralInsuranceCost80ATH : public CGuiView{
protected:
public:
	...
	CFMGeneralInsuranceCost80ATH(CWnd* pParent);
	~CFMGeneralInsuranceCost80ATH();
	...
	int OnAddFMGeneralInsuranceCost80ATH(); 
	int OnEditFMGeneralInsuranceCost80ATH(); 
	int OnDeleteFMGeneralInsuranceCost80ATH(); 
	int OnSaveFMGeneralInsuranceCost80ATH(); 
	int OnCancelFMGeneralInsuranceCost80ATH(); 
	int OnFMGeneralInsuranceCost80ATHListLoadData();
