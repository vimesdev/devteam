#ifndef FMSERVICEINCOMEOUTLAYWITHFREE_H
#define FMSERVICEINCOMEOUTLAYWITHFREE_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceIncomeOutlayWithFree : public CGuiView{
protected:
	CString		m_szWhere;
public:
	CString		m_szCashIDS;
	...
	CFMServiceIncomeOutlayWithFree(CWnd *pParent);
	~CFMServiceIncomeOutlayWithFree();
