#include "stdafx.h"
#include "FMTotalIncomeByFeeTypeAB.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd)
{
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel)
{
	((CFMTotalInComeByFeeTypeAB* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByFeeTypeAB* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByFeeTypeAB* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByFeeTypeAB* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMTotalInComeByFeeTypeAB *pVw = (CFMTotalInComeByFeeTypeAB *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnAllSelect();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnSODSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListCheckAllTYC();
	return 0;
}

static long _OnDoctorLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnDoctorLoadData();
}
static long _OnRoomLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalInComeByFeeTypeAB *)pWnd)->OnRoomLoadData();
}
static int _OnListCheckAllBHABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListCheckAllBHAB();
	return 0;
}
static int _OnListCheckAllDVABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListCheckAllDVAB();
	return 0;
}
static void _OnSoldierSelectFnc(CWnd *pWnd)
	{
		 ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnSoldierSelect();
	}
static int _OnListCheckAllQUANABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByFeeTypeAB*)pWnd)->OnListCheckAllQUANAB();
	return 0;
}
static void _OnLoadAllSelectFnc(CWnd *pWnd)
{
	 ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnLoadAllSelect();
}
static void _OnLoadCLCzoneSelectFnc(CWnd *pWnd)
{
	 ((CFMTotalInComeByFeeTypeAB*)pWnd)->OnLoadCLCzoneSelect();
}


CFMTotalInComeByFeeTypeAB::CFMTotalInComeByFeeTypeAB(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMTotalInComeByFeeTypeAB::~CFMTotalInComeByFeeTypeAB(){
}
void CFMTotalInComeByFeeTypeAB::OnCreateComponents()
{
...
void CFMTotalInComeByFeeTypeAB::OnInitializeComponents(){
...
void CFMTotalInComeByFeeTypeAB::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByFeeTypeAB::OnDoDataExchange(CDataExchange* pDX){
...
void CFMTotalInComeByFeeTypeAB::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMTotalInComeByFeeTypeAB::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMTotalInComeByFeeTypeAB::SetDefaultValues(){
...
int CFMTotalInComeByFeeTypeAB::SetMode(int nMode){
...
/*void CFMTotalInComeByFeeTypeAB::OnYearChange(){
	
} */
/*void CFMTotalInComeByFeeTypeAB::OnYearSetfocus(){
	
} */
/*void CFMTotalInComeByFeeTypeAB::OnYearKillfocus(){
	
} */
int CFMTotalInComeByFeeTypeAB::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMTotalInComeByFeeTypeAB::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

	void CFMTotalInComeByFeeTypeAB::OnLoadAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	OnListLoadData();
}
void CFMTotalInComeByFeeTypeAB::OnLoadCLCzoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
 
void CFMTotalInComeByFeeTypeAB::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMTotalInComeByFeeTypeAB::OnReportPeriodSetfocus(){
	
}*/
/*void CFMTotalInComeByFeeTypeAB::OnReportPeriodKillfocus(){
	
}*/
long CFMTotalInComeByFeeTypeAB::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMTotalInComeByFeeTypeAB::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMTotalInComeByFeeTypeAB::OnFromDateChange(){
	
} */
/*void CFMTotalInComeByFeeTypeAB::OnFromDateSetfocus(){
	
} */
/*void CFMTotalInComeByFeeTypeAB::OnFromDateKillfocus(){
	
} */
int CFMTotalInComeByFeeTypeAB::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMTotalInComeByFeeTypeAB::OnToDateChange(){
	
} */
/*void CFMTotalInComeByFeeTypeAB::OnToDateSetfocus(){
	
} */
/*void CFMTotalInComeByFeeTypeAB::OnToDateKillfocus(){
	
} */
int CFMTotalInComeByFeeTypeAB::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMTotalInComeByFeeTypeAB::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByFeeTypeAB::OnClerkSelendok(){
	 
}
int CFMTotalInComeByFeeTypeAB::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMTotalInComeByFeeTypeAB::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByFeeTypeAB::OnListCheckAllBHAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByFeeTypeAB::OnListCheckAllDVAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMTotalInComeByFeeTypeAB::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}

/*void CFMTotalInComeByFeeTypeAB::OnClerkSetfocus(){
	
}*/
/*void CFMTotalInComeByFeeTypeAB::OnClerkKillfocus(){
	
}*/
long CFMTotalInComeByFeeTypeAB::OnDoctorLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
long CFMTotalInComeByFeeTypeAB::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return 0;
}

/*void CFMTotalInComeByFeeTypeAB::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalInComeByFeeTypeAB::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByFeeTypeAB::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMTotalInComeByFeeTypeAB::OnStatusSetfocus(){
	
}*/
/*void CFMTotalInComeByFeeTypeAB::OnStatusKillfocus(){
	
}*/
long CFMTotalInComeByFeeTypeAB::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalInComeByFeeTypeAB::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalInComeByFeeTypeAB::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByFeeTypeAB::OnOrderBySelendok(){
	 
}
/*void CFMTotalInComeByFeeTypeAB::OnOrderBySetfocus(){
	
}*/
/*void CFMTotalInComeByFeeTypeAB::OnOrderByKillfocus(){
	
}*/
long CFMTotalInComeByFeeTypeAB::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalInComeByFeeTypeAB::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
long CFMTotalInComeByFeeTypeAB::OnRoomLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
long CFMTotalInComeByFeeTypeAB::OnDeptLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMTotalInComeByFeeTypeAB::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMTotalInComeByFeeTypeAB::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMTotalInComeByFeeTypeAB::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMTotalInComeByFeeTypeAB::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMTotalInComeByFeeTypeAB::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	szWhere.AppendFormat(_T(" AND fac_cashbook_id in ('DV-AB','BH-NGAB') OR (fac_cashbook_id in ('BHQUAN-NT', 'BHQUAN-NG') and FAC_POSTED ='Y' AND fac_invoicetype IN('R') AND fac_user_id in (select su_userid from sys_user where su_deptid='AB' and su_groupid='F'))"));
	szWhere.AppendFormat(_T(" and FAC_POSTEDDATE between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') "),m_szFromDate, m_szToDate);
	...
	szSQL.Format(_T("SELECT fac_cash_id as idx, fac_invoiceno descr, fac_user_id as user_id, fac_posted as  stt, fac_invoicedate, fac_approveddate, fac_posteddate ") \
		_T(" FROM fa_cash WHERE fac_invoicetype in('R','P') %s ORDER BY fac_cash_id"), szWhere);
...
void CFMTotalInComeByFeeTypeAB::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMTotalInComeByFeeTypeAB::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, FALSE);
}

void CFMTotalInComeByFeeTypeAB::OnInpatientSelect(){
	
}
void CFMTotalInComeByFeeTypeAB::OnOutpatientSelect(){
	
}
void CFMTotalInComeByFeeTypeAB::OnDepositSelect(){
	
}
void CFMTotalInComeByFeeTypeAB::OnAllSelect(){
	
}
 
void CFMTotalInComeByFeeTypeAB::OnSODSelect(){
	OnListLoadData();
}
void CFMTotalInComeByFeeTypeAB::OnSoldierSelect()
{
	OnListLoadData();
}

 
int CFMTotalInComeByFeeTypeAB::OnAddFMInsuranceReceiptSummary(){
...
int CFMTotalInComeByFeeTypeAB::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMTotalInComeByFeeTypeAB::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMTotalInComeByFeeTypeAB::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMTotalInComeByFeeTypeAB::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMTotalInComeByFeeTypeAB::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMTotalInComeByFeeTypeAB::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return;
	UpdateData(TRUE);
...
void CFMTotalInComeByFeeTypeAB::OnPrint1stver()
{
	return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
...
void CFMTotalInComeByFeeTypeAB::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMTotalInComeByFeeTypeAB"));
...
void CFMTotalInComeByFeeTypeAB::OnExportSelect()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	HMENU hSubMenu = NULL;
	...
	TranslateString(_T("Export danh sách so sánh với bảng kê"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 4, tmpStr);

	TranslateString(_T("Export Bảng tổng hợp doanh thu mới***"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 5, tmpStr);

	TranslateString(_T("Export danh sách BN theo khoa"), tmpStr);
	...
	switch (nPos)
	{
		...
		case 5:
			...
			break;
		case 6:
			OnExportTotalAll_V2_Detail();
			break;
	}	
}
void CFMTotalInComeByFeeTypeAB::OnExportDetail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_BN_DICHVU_KHU_AB.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_BN_DICHVU_KHU_AB2.xls"));
}
void CFMTotalInComeByFeeTypeAB::OnExportTotal()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_BN_BHYT_KHU_AB.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_BN_BHYT_KHU_AB2.xls"));
}
void CFMTotalInComeByFeeTypeAB::OnExportTotalAll()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	UpdateData(TRUE);
	BeginWaitCursor();
	MessageBox(_T("Thay đổi cách tính khoa thực hiện với khối CLS, cần test lại, nếu ko đáp ứng được thì lấy khoa thực hiện theo các báo cáo tổng hợp theo khoa của dịch vụ/bảo hiểm!"));
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_TONGHOP_KHU_AB.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_TONGHOP_KHU_AB2.xls"));
}

void CFMTotalInComeByFeeTypeAB::OnPrint2ndver_(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
int CFMTotalInComeByFeeTypeAB::OnCheckBeforePrint(CReport* rpt, CRecord& rs){
	CString szSQL;
	szSQL = GetQueryString();
...
void CFMTotalInComeByFeeTypeAB::OnPrintOther(CReport* rpt){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByFeeTypeAB::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	//return;
...
void CFMTotalInComeByFeeTypeAB::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept){
	//return;
	CString tmpStr, szLabel;
	rs->GetValue(_T("posted_date"), tmpStr);
	bNewDate = tmpStr==m_szPrevDate?false:true;
...
void CFMTotalInComeByFeeTypeAB::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept, CReportSection* pDateGroup, CReportSection* pDeptGroup){
	//return;
...
void CFMTotalInComeByFeeTypeAB::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept){
	//return;
	CReportSection* rptGrp = NULL;
	CString szPos;
	if (bNewDept && m_nDeptSum[12] > 0){
...
void CFMTotalInComeByFeeTypeAB::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByFeeTypeAB::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReportSection* rptGroup = NULL;
	CString tmpStr;
	if (bNewDate){
...
void CFMTotalInComeByFeeTypeAB::OnPrintDetail(CReport* rpt, CRecord* rs)
{
...
void CFMTotalInComeByFeeTypeAB::OnPrintDetail(CReport* rpt, CReportSection* ppDetail, CRecord* rs){
...
void CFMTotalInComeByFeeTypeAB::OnCalcData(CRecord* rs, bool& bNewDate, bool& bNewDept)
{
	double nTmp = 0;
	for (int i = 0; i < 18; i++){
...
void CFMTotalInComeByFeeTypeAB::ResetVar(){
	for (int i = 0; i < 18; i++){
		m_nTotal[i] = 0;
		m_nDeptSum[i] = 0;
		m_nDaySum[i] = 0;
...
CString CFMTotalInComeByFeeTypeAB::GetQueryStringDetail()
{
	...
	if (!m_szDeptKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND dept_id = '%s'"), m_szDeptKey);
			...
			szSQL.Format(_T(" SELECT feetype,") \
						...
						_T("     sl_dichvu,") \
						_T("     tt_sl_dichvu    ") \
						_T("   FROM HMS_FEE_INVOICE_VIEW_AB i") \
						_T("   INNER JOIN") \
						_T("     (SELECT hfe_docno,") \
						_T("       hfe_invoiceno,") \
						...
						_T("     AND mp_org_id        IN ('PM' ,'MA','BB','PĐD', 'HC')") \
...
double CFMTotalInComeByFeeTypeAB::OnRound(double nToRound){
	nToRound += 0.5;
	return floor(nToRound);
}

CString CFMTotalInComeByFeeTypeAB::GetQueryStringTotal()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	if (!m_szDeptKey.IsEmpty())
		...
		szSQL.Format(_T(" SELECT ") \
					...
					_T("       hfg_fee_index as feeindex,") \
					_T("       hfg_fee_name as feename,") \
					_T("       CASE WHEN hfe_type in ('P','T','F')") \
					_T("       THEN hfg_name ELSE NULL end as roomid,") \
					_T("        CASE") \
					_T("         WHEN hfe_type in ('P', 'T', 'F')") \
					_T("         AND Hfe_Object=11") \
					_T("         THEN Hfe_Quantity") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_quan,") \
					...
					_T("       NULL  AS roomid,") \
					_T("       CASE ") \
					_T("         WHEN hfe_type in ('O','S') AND Hfe_Serialno='PC'") \
					_T("         AND Hfe_Objectid =11") \
					_T("         THEN 1") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_quan,") \
					_T("       CASE") \
					_T("         WHEN hfe_type in ('O','S') AND Hfe_Serialno='PC'") \
					_T("         AND Hfe_Objectid =2") \
					_T("         THEN 1") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_quanhuu,") \
					_T("       CASE") \
					_T("         WHEN hfe_type in ('O','S') AND Hfe_Serialno='PC'") \
					_T("         AND Hfe_Objectid NOT IN (1,3,7,8,2,11)") \
					_T("         THEN 1") \
					_T("         ELSE 0") \
					_T("       END sl_bhyt_khac,") \
					_T("       CASE") \
					...
					_T("     WHERE hfe_type in ('O','S') AND Hfe_Serialno='PC'") \
					_T("     AND hfe_status NOT IN ('O', 'C')  ") \
...
CString CFMTotalInComeByFeeTypeAB::GetQueryString()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	return szSQL;	
}
CString CFMTotalInComeByFeeTypeAB::GetQueryStringTotalAll()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	else
	{
		...
		for (int i = 0; i < tok_id.GetSize(); i++)
		{
			...
			if (bBreak)
			{
				...
				szIds.AppendFormat(_T(" iab.HFE_CASH_ID IN (%s) "), tmpStr);
				_tprintf(_T("\nszIds: %s\n"), szIds);
				tmpStr.Empty();
				nCount = 0;
				bBreak = false;
	...
	if (!m_szDeptKey.IsEmpty())
		...
		szSQL.Format(_T(" SELECT feetype,") \
					...
					_T("     sl_bhyt,tt_bhyt,") \
					_T("     sl_ban,tt_ban    ") \
					_T("   FROM HMS_FEE_INVOICE_VIEW_AB iab") \
					_T("   INNER JOIN") \
					...
					_T(" CASE WHEN HPC_PDEPTID IS NOT NULL THEN HPC_PDEPTID") \
					_T("       ELSE hfg_deptid END AS deptid,") \

					_T("       fe.hfe_type      AS feetype,") \
					_T("       hfg_fee_index AS feeindex,") \
					_T("       hfg_fee_name  AS feename,") \
					_T("       CASE") \
					_T("         WHEN fe.hfe_type IN ('P','T', 'F')") \
					_T("         THEN hfg_name3") \
					_T("         ELSE NULL") \
					_T("       END AS roomid,") \
...
int CFMTotalInComeByFeeTypeAB::OnListCheckAllQUANAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMTotalInComeByFeeTypeAB::OnExportDetailPatientList()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\DANHSACHTINHDOANHTHU_KHUAB.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	szSQL = GetQueryStringDetailByPatient();
	rs.ExecSQL(szSQL);
	//_msg(_T("%s"),szSQL);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\DANHSACHTINHDOANHTHU_KHUAB2.xls"));
}

CString CFMTotalInComeByFeeTypeAB::GetQueryStringDetailByPatient()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	if (!m_szDeptKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND dept_id = '%s'"), m_szDeptKey);
			...
			szSQL.Format(_T(" SELECT ") \
					_T(" docno,") \
					_T(" patname,") \
					_T(" SUM(totalall) as tongtien") \
					_T(" FROM") \
					_T(" (") \
					_T(" SELECT ") \
					_T("   tbl.hfe_docno as docno,") \
					_T("   GET_PATIENTNAME(tbl.hfe_docno) as patname,") \
					_T("   SUM(tt_dichvu+tt_bhyt+tt_ban) AS totalall") \
					_T(" FROM") \
					_T("   (SELECT feetype,") \
					_T("     feename,") \
					...
					_T("   deptid") \
					_T("   )") \
					_T(" GROUP BY  docno, patname") \
					_T(" order by docno"), szWhere);

			return szSQL;	
}
void CFMTotalInComeByFeeTypeAB::OnExportTotalAll_V2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	UpdateData(TRUE);
	BeginWaitCursor();
	MessageBox(_T("Thay đổi cách tính khoa thực hiện với khối CLS, vui lòng test lại!"));
	...
	szSQL = GetQueryStringTotalAll_V2();
	rs.ExecSQL(szSQL);
	//_msg(_T("%s"),szSQL);
	//AfxMessageBox(szSQL);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_TONGHOP_KHU_ABV2.xls"));
}

CString CFMTotalInComeByFeeTypeAB::GetQueryStringTotalAll_V2()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	if (!m_szDeptKey.IsEmpty())
		...
		szSQL.Format(_T(" SELECT feetype,") \
					...
					_T("     AND fe.hfe_status NOT IN ('O', 'C')") \
					_T("     AND fe.hfe_category    <>'Y'") \
					//Tính theo khoa thực hiện -> chỉ để lại phí ăn 
					_T("     UNION ALL") \
					_T("     SELECT fe.hfe_docno,") \
					_T("       fe.hfe_invoiceno,") \
					_T("       fe.hfe_deptid dept_id,") \
					...
					_T("    ON (fe.hfe_docno = i.hfe_docno  AND fe.hfe_invoiceno   = i.hfe_invoiceno)    ") \
					_T("     LEFT JOIN hmsv_paraclinic") \
					_T("     ON (fe.hfe_type   IN ('F')") \
					_T("     AND hpc_docno   = fe.hfe_docno") \
					_T("     AND hpc_orderid = fe.hfe_orderid)") \
					_T("     LEFT JOIN hms_fee_group") \
					_T("     ON (hfe_group       =hfg_id)") \
					_T("     WHERE fe.hfe_type     IN ('F')") \
					_T("     AND fe.hfe_status NOT IN ('O', 'C')") \
					_T("     AND fe.hfe_category    <>'Y'") \
					_T("     UNION ALL") \
					_T("     SELECT fe.hfe_docno,") \
					...
					//Tách đoạn tính theo khoa thực hiện ra đây
					//L1
					_T("     UNION ALL    ") \
					_T("     SELECT fe.hfe_docno,") \
					_T("       fe.hfe_invoiceno,") \
					...
					_T("         AND Fe.Hfe_Group NOT IN ('B1B00','B1G00','B1800','B2500', 'B1E00')") \
					...
					_T("     ON (fe.hfe_itemid  =fl.hfl_feeid") \
					...
					_T("     AND fe.hfe_category   NOT IN ('Y')") \
					//L2
					_T(" UNION ALL") \
					_T("     SELECT fe.hfe_docno,") \
					_T("       fe.hfe_invoiceno,") \
					...
					_T("        CASE") \
					_T("         WHEN fe.hfe_type IN ('P','T')") \
					_T("         AND Fe.Hfe_Group IN ('B1B00','B1G00','B1800','B2500', 'B1E00')") \
					_T("         THEN CAST(DECODE(fe.Hfe_Group, 'B1B00', 'C17', 'B1G00', 'C16', 'B1800','C16','B2500','A20', 'B1E00', 'C5') AS NVARCHAR2(3))") \
					_T("       END deptid,      ") \
					_T("       fe.hfe_type   AS feetype,") \
					_T("       hfg_fee_index AS feeindex,") \
					_T("       hfg_fee_name  AS feename,") \
					...
					_T("       fe.hfe_deptid dept_id,     ") \
					_T("        CASE") \
					_T("         WHEN fe.hfe_type      IN ('P')") \
					_T("         AND Fe.hfe_status      ='R'") \
					_T("         AND Hpc_Practitioner IS NULL") \
					_T("         THEN Fl.Hfl_Deptid") \
					_T("       END deptid,     ") \
					_T("       fe.hfe_type   AS feetype,") \
					...
					_T("     ON (hfe_group          =hfg_id)") \
					_T("     WHERE 1                 =1") \
					_T("     AND fe.hfe_status       IN ('R')") \
					_T("     AND Hpc_Practitioner   IS NULL") \
					_T("     AND fe.hfe_type         IN ('P')") \
					...
					_T("     AND hpc_status         <> 'T'") \
					_T("     AND Fe.Hfe_Group        IN ('B3100')") \
					_T("     AND fe.hfe_category NOT IN ('Y') AND 0>1  ") \
					_T("     ) f ON (f.hfe_docno = iab.hfe_docno") \
					_T("   AND f.hfe_invoiceno   = iab.hfe_invoiceno)") \
					_T("%s") \
					_T("   )tbl") \
...
void CFMTotalInComeByFeeTypeAB::OnExportTotalAll_V2_Detail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\DANHSACHBENHNHANTHEOKHOA.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	szSQL = GetQueryStringTotalAll_V2_Detail();
	rs.ExecSQL(szSQL);
	//AfxMessageBox(szSQL);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\DANHSACHBENHNHANTHEOKHOA2.xls"));
}
CString CFMTotalInComeByFeeTypeAB::GetQueryStringTotalAll_V2_Detail()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	if (!m_szDeptKey.IsEmpty())
		...
		szSQL.Format(_T(" SELECT ") \
					...
					_T("   SUM(tt_dichvu+tt_bhyt+tt_ban) AS totalall") \
					_T(" FROM") \
					_T("   (SELECT feetype, iab.hfe_docno as docno,") \
					_T("     feename,") \
					_T("     feeindex,") \
					_T("     deptid,") \
					_T("     roomid,") \
