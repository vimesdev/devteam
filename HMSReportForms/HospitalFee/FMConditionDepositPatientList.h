#ifndef FMCONDITIONDEPOSITPATIENTLIST_H
#define FMCONDITIONDEPOSITPATIENTLIST_H
...
class CFMConditionDepositPatientList : public CGuiView
{
protected:
public:
	...
	CGuiCheckBox	m_wndDischarge;
	CGuiCheckBox	m_wndIndischarge;
	CGuiCheckBox	m_wndPaided;
	CGuiCheckBox	m_wndUnpaided;
	...
	void			OnIndischargeSelect(); 
	void			OnPaidedSelect();
	void			OnUnpaidedSelect();
	void			OnLockedSelect();
	CFMConditionDepositPatientList(CWnd* pParent);
	~CFMConditionDepositPatientList();
	...
	int OnAddFMConditionDepositPatientList(); 
	int OnEditFMConditionDepositPatientList(); 
	int OnDeleteFMConditionDepositPatientList(); 
	int OnSaveFMConditionDepositPatientList(); 
	int OnCancelFMConditionDepositPatientList(); 
	int OnFMConditionDepositPatientListListLoadData();
