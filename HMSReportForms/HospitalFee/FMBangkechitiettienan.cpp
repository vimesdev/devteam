#include "stdafx.h"
#include "FMBangkechitiettienan.h"
#include "HMSMainFrame.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMBangkechitiettienan *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMBangkechitiettienan *)pWnd)->OnToDateCheckValue();
} 
static void _OnObjectSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMBangkechitiettienan* )pWnd)->OnObjectSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnObjectSelendokFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnObjectSelendok();
}
/*static void _OnObjectSetfocusFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnObjectKillfocus();
}*/
/*static void _OnObjectKillfocusFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnObjectKillfocus();
}*/
static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((CFMBangkechitiettienan *)pWnd)->OnObjectLoadData();
}
/*static void _OnObjectAddNewFnc(CWnd *pWnd){
	((CFMBangkechitiettienan *)pWnd)->OnObjectAddNew();
}*/
static void _OnExportSelectFnc(CWnd *pWnd){
	CFMBangkechitiettienan *pVw = (CFMBangkechitiettienan *)pWnd;
	pVw->OnExportSelect();
}

static void _OnChedoanSelectFnc(CWnd *pWnd)
{
	 ((CFMBangkechitiettienan*)pWnd)->OnChedoanSelect();
}

static long _OnObjectListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMBangkechitiettienan*)pWnd)->OnObjectListLoadData();
}

static void _OnInsuranceSelectFnc(CWnd *pWnd){
	  ((CFMBangkechitiettienan*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	  ((CFMBangkechitiettienan*)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd){
	  ((CFMBangkechitiettienan*)pWnd)->OnPolicySelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMBangkechitiettienan*)pWnd)->OnAllSelect();
}
...
{
	 ((CFMBangkechitiettienan*)pWnd)->OnOtherFoodLevelSelect();
}
static void _OnOtherFeeSelectFnc(CWnd *pWnd){
	 ((CFMBangkechitiettienan*)pWnd)->OnOtherFeeSelect();
}

CFMBangkechitiettienan::CFMBangkechitiettienan()
{
	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
...
void CFMBangkechitiettienan::OnCreateComponents()
{
...
void CFMBangkechitiettienan::OnInitializeComponents(){
...
void CFMBangkechitiettienan::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMBangkechitiettienan::OnDoDataExchange(CDataExchange* pDX){
...
void CFMBangkechitiettienan::SetDefaultValues()
{
...
int CFMBangkechitiettienan::SetMode(int nMode){
...
/*void CFMBangkechitiettienan::OnFromDateChange(){
	
} */
/*void CFMBangkechitiettienan::OnFromDateSetfocus(){
	
} */
/*void CFMBangkechitiettienan::OnFromDateKillfocus(){
	
} */
int CFMBangkechitiettienan::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMBangkechitiettienan::OnToDateChange(){
	
} */
/*void CFMBangkechitiettienan::OnToDateSetfocus(){
	
} */
/*void CFMBangkechitiettienan::OnToDateKillfocus(){
	
} */
int CFMBangkechitiettienan::OnToDateCheckValue(){
	return 0;
} 
void CFMBangkechitiettienan::OnObjectSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMBangkechitiettienan::OnObjectSelendok(){
	 
}
/*void CFMBangkechitiettienan::OnObjectSetfocus(){
	
}*/
/*void CFMBangkechitiettienan::OnObjectKillfocus(){
	
}*/

void CFMBangkechitiettienan::OnInsuranceSelect(){
	
}
void CFMBangkechitiettienan::OnServiceSelect(){
	
}
void CFMBangkechitiettienan::OnPolicySelect(){
	
}
void CFMBangkechitiettienan::OnAllSelect(){
	
}

void CFMBangkechitiettienan::OnChedoanSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMBangkechitiettienan::OnOtherFoodLevelSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMBangkechitiettienan::OnOtherFeeSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

long CFMBangkechitiettienan::OnObjectLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
long CFMBangkechitiettienan::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMBangkechitiettienan::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	BeginWaitCursor();
	CReport rpt;
...
void CFMBangkechitiettienan::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	CGuiMenu menu(this);
...
void CFMBangkechitiettienan::OnExporttotal()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	AfxMessageBox(_T("Báo cáo chỉ tính suất ăn 24K (Quân / HT) và 48K (các đối tượng còn lại). Bạn có thể lọc chế độ ăn sond, các chế độ ăn bổ sung, bữa phụ. Báo cáo lấy theo thời gian post quỹ!"));	
	CExcel xls;
	if (!xls.Load(_T("Exports\\Bangkechitiettienan.xls"))) AfxMessageBox(_T("Chưa có File Bangkechitiettienan.xls trong thư mục Export!"));	
	xls.SetWorksheet(0);
...
void CFMBangkechitiettienan::OnExportdetail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
int CFMBangkechitiettienan::OnCheckBeforeExport(CExcel* xls, CRecord* rs){
	BeginWaitCursor();
...
CString CFMBangkechitiettienan::GetQueryString()
{
	...
	szWhere.AppendFormat(_T(" AND (iv.HFE_DEPTID NOT IN ('PTTYC', 'TYC') OR (iv.HFE_DEPTID IN ('PTTYC', 'TYC') and fe.hfe_deptid NOT IN ('TYC', 'PTTYC'))) "));
...
CString CFMBangkechitiettienan::GetQueryString1()
{
	CString szSQL, szWhere, szObjectFilter, szObjects;
...
void CFMBangkechitiettienan::OnExporttotalall()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	AfxMessageBox(_T("Báo cáo chỉ tính suất ăn 24K (Quân / HT) và 48K (các đối tượng còn lại). Bạn có thể lọc chế độ ăn sond, các chế độ ăn bổ sung, bữa phụ. Báo cáo lấy theo thời gian post quỹ!"));	
	CExcel xls;
	if (!xls.Load(_T("Exports\\Bangkechitiettienantheokhoath.xls"))) AfxMessageBox(_T("Chưa có File Bangkechitiettienan.xls trong thư mục Export!"));	
	xls.SetWorksheet(0);
...
CString CFMBangkechitiettienan::GetQueryStringall()
{
...
CString CFMBangkechitiettienan::GetQueryStringallforfrint()
{
