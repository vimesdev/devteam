...
void CFMSudungthuocBHYT20a::OnCreateComponents()
{
	...
	m_wndReportCondition.Create(this, _T("Report Condition"), 5, 5, 468, 490);
	m_wndDeptInfo.Create(this, _T("Dept"), 10, 150, 463, 485);
	m_wndFromDateLabel.Create(this, _T("From Date"), 10, 30, 90, 55);
	...
	m_wndDrugPTTT.Create(this, _T("Without Operation Material"), 5, 495, 172, 520);
	m_wndExam.Create(this, _T("Non-Resident"), 258, 495, 352, 520);
	m_wndInPatient.Create(this, _T("InPatient"), 178, 495, 252, 520);
	m_wndAllHospitals.Create(this, _T("All Hospitals"), 358, 495, 458, 520);
	m_wndOrderBy.Create(this, _T("Sort by Category"), 5, 555, 125, 580);
	m_wndByDischargedDate.Create(this, _T("By Discharged Date"), 5, 525, 172, 550);
	m_wndOnlyCommander.Create(this, _T("Only Commander"), 178, 525, 310, 550);
	m_wndPrintPreview.Create(this, _T("Print Pre&view"), 248, 555, 348, 580);
	m_wndExport.Create(this, _T("&Export"), 353, 555, 453, 580);
	m_wndList.Create(this,15, 175, 458, 480); 
	m_wndSoldierPatient.Create(this, _T("SoldierPatient"), 316, 525, 458, 550);
}
