#include "stdafx.h"
#include "FMFeeLossByObjectReport_Ver2.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReportVer2 *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMFeeLossByObjectReportVer2* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReportVer2 *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReportVer2 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMFeeLossByObjectReportVer2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMFeeLossByObjectReportVer2 *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMFeeLossByObjectReportVer2 *pVw = (CFMFeeLossByObjectReportVer2 *)pWnd;
	pVw->OnPrintSelect();
} 
...
static int _OnAddFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReportVer2*)pWnd)->OnAddFMInsuranceFeeLossReport();
} 
static int _OnEditFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReportVer2*)pWnd)->OnEditFMInsuranceFeeLossReport();
} 
static int _OnDeleteFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReportVer2*)pWnd)->OnDeleteFMInsuranceFeeLossReport();
} 
static int _OnSaveFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReportVer2*)pWnd)->OnSaveFMInsuranceFeeLossReport();
} 
static int _OnCancelFMInsuranceFeeLossReportFnc(CWnd *pWnd){
	 return ((CFMFeeLossByObjectReportVer2*)pWnd)->OnCancelFMInsuranceFeeLossReport();
} 

static void _OnInsuranceSelectFnc(CWnd *pWnd){
	  ((CFMFeeLossByObjectReportVer2*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	  ((CFMFeeLossByObjectReportVer2*)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd){
	  ((CFMFeeLossByObjectReportVer2*)pWnd)->OnPolicySelect();
}
static void _OnThatthuSelectFnc(CWnd *pWnd){
	 ((CFMFeeLossByObjectReportVer2*)pWnd)->OnThatthuSelect();
}
static long _OnConditionListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMFeeLossByObjectReportVer2*)pWnd)->OnConditionListLoadData();
} 

CFMFeeLossByObjectReportVer2::CFMFeeLossByObjectReportVer2(CWnd* pParent)
{
	m_nDlgWidth = 475;
	m_nDlgHeight = 130;
	SetDefaultValues();
}
CFMFeeLossByObjectReportVer2::~CFMFeeLossByObjectReportVer2()
{
}
void CFMFeeLossByObjectReportVer2::OnCreateComponents()
{
	...
	m_wndToDateLabel.Create(this, _T("To Date"), 220, 61, 300, 86);
	m_wndToDate.Create(this,305, 61, 425, 86); 
	m_wndInsurance.Create(this, _T("Insurance"), 10, 401, 101, 426);
	m_wndService.Create(this, _T("Service"), 106, 401, 197, 426);
	m_wndPolicy.Create(this, _T("Quân_CS"), 203, 401, 294, 426);
	m_wndExport.Create(this, _T("&ExportXLS"), 330, 401, 430, 426);
	m_wndThatthu.Create(this, _T("BN yêu cầu"), 10, 431, 197, 456);
	m_wndConditionList.Create(this,10, 97, 425, 395);
	
}
void CFMFeeLossByObjectReportVer2::OnInitializeComponents()
{
	...
	m_wndConditionList.InsertColumn(0, _T("ID"), CFMT_TEXT, 50);
	m_wndConditionList.InsertColumn(1, _T("Description"), CFMT_TEXT, 450);
}
void CFMFeeLossByObjectReportVer2::OnSetWindowEvents(){
	...
	m_wndConditionList.SetEvent(WE_LOADDATA, _OnConditionListLoadDataFnc);
...
void CFMFeeLossByObjectReportVer2::OnDoDataExchange(CDataExchange* pDX)
{
...
void CFMFeeLossByObjectReportVer2::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMFeeLossByObjectReportVer2::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMFeeLossByObjectReportVer2::SetDefaultValues(){
...
int CFMFeeLossByObjectReportVer2::SetMode(int nMode){
...
/*void CFMFeeLossByObjectReportVer2::OnYearChange(){
	
} */
/*void CFMFeeLossByObjectReportVer2::OnYearSetfocus(){
	
} */
/*void CFMFeeLossByObjectReportVer2::OnYearKillfocus(){
	
} */
long CFMFeeLossByObjectReportVer2::OnConditionListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	m_wndConditionList.BeginLoad(); 
	m_wndConditionList.DeleteAllItems(); 
	int nCount = 0;

	szSQL.Format(_T(" SELECT ss_code as ID,") \
				_T(" ss_code as dieukien") \
				_T(" from sys_sel") \
				_T(" WHERE SS_ID='Baocao_BN_treo'"));
	//MessageBox(szSQL);

	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF())
	{ 
		m_wndConditionList.AddItems(
			rs.GetValue(_T("ID")), 
			rs.GetValue(_T("dieukien")), NULL);
		rs.MoveNext();
	}
	m_wndConditionList.EndLoad(); 
	return nCount;
}

void CFMFeeLossByObjectReportVer2::OnThatthuSelect(){
	
	
}

void CFMFeeLossByObjectReportVer2::OnInsuranceSelect()
{
		
}
void CFMFeeLossByObjectReportVer2::OnServiceSelect(){
	
}
void CFMFeeLossByObjectReportVer2::OnPolicySelect(){
	
}

int CFMFeeLossByObjectReportVer2::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CFMFeeLossByObjectReportVer2::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMFeeLossByObjectReportVer2::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMFeeLossByObjectReportVer2::OnReportPeriodSetfocus(){
	
}*/
/*void CFMFeeLossByObjectReportVer2::OnReportPeriodKillfocus(){
	
}*/
long CFMFeeLossByObjectReportVer2::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMFeeLossByObjectReportVer2::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMFeeLossByObjectReportVer2::OnFromDateChange(){
	
} */
/*void CFMFeeLossByObjectReportVer2::OnFromDateSetfocus(){
	
} */
/*void CFMFeeLossByObjectReportVer2::OnFromDateKillfocus(){
	
} */
int CFMFeeLossByObjectReportVer2::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMFeeLossByObjectReportVer2::OnToDateChange(){
	
} */
/*void CFMFeeLossByObjectReportVer2::OnToDateSetfocus(){
	
} */
/*void CFMFeeLossByObjectReportVer2::OnToDateKillfocus(){
	
} */
int CFMFeeLossByObjectReportVer2::OnToDateCheckValue()
{
	return 0;
} 
void CFMFeeLossByObjectReportVer2::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMFeeLossByObjectReportVer2::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	int ret = ShowMessageBox(_T(" Bạn có muốn tính lại chi phí của bệnh nhân sau đó mới xuất ra Excel, Nếu chọn YES, sẽ mất thời gian để tạo lập lại phí theo khoảng thời gian đã chọn? OK? "),MB_YESNO);
		...
		{	
			...
			else if (m_nPolicy == 0)
			{
				...
				szWhere.AppendFormat(_T(" AND 1=1 AND f.hfe_type IN ('D', 'M')"));
			...
			if (m_bThatthu)
				...
				_T("       f.hfe_itemid,") \
				_T("       f.hfe_desc,") \
				_T("       f.hfe_orderid, he_status, hpo_transaction_id,hpo_docno, hpo_orderid ") \


				_T("   ) Tbl") \
				_T(" WHERE 1=1 ") \
				_T(" AND (phithuoc+phivattu)>0") \
				_T(" GROUP BY docno,") \
				_T("   obj_name,") \
				_T("   card_no,") \
				_T("   pname,") \
				...
				_T("   deptid,") \
				_T("   workplace,") \
				_T("   address, sheetidx, approvedate ") \
				_T("   )temp") \
...
int CFMFeeLossByObjectReportVer2::OnAddFMInsuranceFeeLossReport(){
...
int CFMFeeLossByObjectReportVer2::OnEditFMInsuranceFeeLossReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CFMFeeLossByObjectReportVer2::OnDeleteFMInsuranceFeeLossReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CFMFeeLossByObjectReportVer2::OnSaveFMInsuranceFeeLossReport(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CFMFeeLossByObjectReportVer2::OnCancelFMInsuranceFeeLossReport(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CFMFeeLossByObjectReportVer2::OnFMInsuranceFeeLossReportListLoadData(){
	return 0;
}
