#ifndef FMSOMFoodPaidSummary1_H
#define FMSOMFoodPaidSummary1_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFoodOrderByReqDept : public CGuiView
{
protected:
public:
	...
	void			OnPrintDetail();
	void			OnExportSelect(); 
	CFMFoodOrderByReqDept(CWnd *pWnd);
	~CFMFoodOrderByReqDept();
