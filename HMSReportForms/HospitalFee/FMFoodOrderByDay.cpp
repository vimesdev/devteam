#include "stdafx.h"
#include "FMFoodOrderByDay.h"
#include "HMSMainFrame.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMFoodOrderByDay *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMFoodOrderByDay *)pWnd)->OnToDateCheckValue();
} 
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMFoodOrderByDay* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMFoodOrderByDay *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CFMFoodOrderByDay *)pWnd)->OnDeptAddNew();
}*/
static void _OnByDeptSelectFnc(CWnd *pWnd){
	 ((CFMFoodOrderByDay*)pWnd)->OnByDeptSelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMFoodOrderByDay *pVw = (CFMFoodOrderByDay *)pWnd;
...
CFMFoodOrderByDay::CFMFoodOrderByDay(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMFoodOrderByDay::~CFMFoodOrderByDay(){
}
void CFMFoodOrderByDay::OnCreateComponents(){
...
void CFMFoodOrderByDay::OnInitializeComponents(){
...
void CFMFoodOrderByDay::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMFoodOrderByDay::OnDoDataExchange(CDataExchange* pDX){
...
void CFMFoodOrderByDay::SetDefaultValues(){
...
int CFMFoodOrderByDay::SetMode(int nMode){
...
/*void CFMFoodOrderByDay::OnFromDateChange(){
	
} */
/*void CFMFoodOrderByDay::OnFromDateSetfocus(){
	
} */
/*void CFMFoodOrderByDay::OnFromDateKillfocus(){
	
} */
int CFMFoodOrderByDay::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMFoodOrderByDay::OnToDateChange(){
	
} */
/*void CFMFoodOrderByDay::OnToDateSetfocus(){
	
} */
/*void CFMFoodOrderByDay::OnToDateKillfocus(){
	
} */
int CFMFoodOrderByDay::OnToDateCheckValue(){
	return 0;
} 
void CFMFoodOrderByDay::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMFoodOrderByDay::OnDeptSelendok(){
	 
}
/*void CFMFoodOrderByDay::OnDeptSetfocus(){
	
}*/
/*void CFMFoodOrderByDay::OnDeptKillfocus(){
	
}*/
long CFMFoodOrderByDay::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMFoodOrderByDay::OnDeptAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMFoodOrderByDay::OnByDeptSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMFoodOrderByDay::OnPrintPreviewSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (m_bByDept)
...
void CFMFoodOrderByDay::OnPrintDetail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
void CFMFoodOrderByDay::OnPrintSynthesis(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
	CReportSection* rptDetail = NULL,* rptHeader = NULL, * rptGroup = NULL;
...
void CFMFoodOrderByDay::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 

CString CFMFoodOrderByDay::GetQueryString()
{
	CString szSQL, szWhere;
	szWhere.Format(_T(" AND hd_object = 7 AND hfo_approvedate BETWEEN to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss')"), m_szFromDate, m_szToDate);
	if (m_nOutPatient == 0)
