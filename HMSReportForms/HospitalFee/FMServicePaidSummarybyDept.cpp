#include "stdafx.h"
#include "FMServicePaidSummarybyDept.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDept* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDept* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDept* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMServicePaidSummaryByDept* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMServicePaidSummaryByDept*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMServicePaidSummaryByDept*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDept*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMServicePaidSummaryByDept *pVw = (CFMServicePaidSummaryByDept *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDept*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDept*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDept*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDept*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDept*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDept*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDept*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDept*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMServicePaidSummaryByDept*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllDVPTTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllDVPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMServicePaidSummaryByDept*)pWnd)->OnSODSelect();
}
...
{
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnATMSelect();
}
static void _OnAllZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnAllZoneSelect();
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnABZoneSelect();
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllRefund();
	return 0;
}
static void _OnBEDSelectFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnBEDSelect();
}

static int _OnListCheckAllInvoiceTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllInvoiceTYC();
	return 0;
}
static int _OnListCheckAllRefundTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllRefundTYC();
	return 0;
}

static int _OnListCheckAllInvoiceBHTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllInvoiceBHTYC();
	return 0;
}
static int _OnListCheckAllRefundBHTYCFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListCheckAllRefundBHTYC();
	return 0;
}

static void _OnCLCzoneSelectFnc(CWnd *pWnd)
{
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnCLCzoneSelect();
}

static void _OnQrOnlineSelectFnc(CWnd *pWnd){
	 ((CFMServicePaidSummaryByDept*)pWnd)->OnQrOnlineSelect();
}


static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept*)pWnd)->OnDeptListUnCheckAll();
}

static int _OnDeptListCheckAllTYCFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept*)pWnd)->OnDeptListCheckAllTYC();
}

static int _OnDeptListCheckAllDVFnc(CWnd *pWnd){
	return ((CFMServicePaidSummaryByDept*)pWnd)->OnDeptListCheckAllDV();
}

static long _OnDeptListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMServicePaidSummaryByDept*)pWnd)->OnDeptListLoadData();
}

static int _OnListUnCheckQRFnc(CWnd *pWnd)
{
	((CFMServicePaidSummaryByDept*)pWnd)->OnListUnCheckQR();
	return 0;
}


CFMServicePaidSummaryByDept::CFMServicePaidSummaryByDept(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMServicePaidSummaryByDept::~CFMServicePaidSummaryByDept()
{

}
void CFMServicePaidSummaryByDept::OnCreateComponents()
{
	...
	m_wndAll.Create(this, _T("All"), 231, 505, 294, 530);
	...
	m_wndDeptList.Create(this,10, 330, 476, 500); 

	m_wndCreateData.EnableWindow(FALSE);

}
void CFMServicePaidSummaryByDept::OnInitializeComponents(){
...
void CFMServicePaidSummaryByDept::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMServicePaidSummaryByDept::OnDoDataExchange(CDataExchange* pDX){
...
void CFMServicePaidSummaryByDept::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMServicePaidSummaryByDept::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMServicePaidSummaryByDept::SetDefaultValues(){
...
int CFMServicePaidSummaryByDept::SetMode(int nMode){
...
/*void CFMServicePaidSummaryByDept::OnYearChange(){
	
} */
/*void CFMServicePaidSummaryByDept::OnYearSetfocus(){
	
} */
/*void CFMServicePaidSummaryByDept::OnYearKillfocus(){
	
} */
int CFMServicePaidSummaryByDept::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMServicePaidSummaryByDept::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

	void CFMServicePaidSummaryByDept::OnCLCzoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
...
void CFMServicePaidSummaryByDept::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMServicePaidSummaryByDept::OnReportPeriodSetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDept::OnReportPeriodKillfocus(){
	
}*/
long CFMServicePaidSummaryByDept::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMServicePaidSummaryByDept::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMServicePaidSummaryByDept::OnFromDateChange(){
	
} */
/*void CFMServicePaidSummaryByDept::OnFromDateSetfocus(){
	
} */
/*void CFMServicePaidSummaryByDept::OnFromDateKillfocus(){
	
} */
int CFMServicePaidSummaryByDept::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
void CFMServicePaidSummaryByDept::OnBEDSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
/*void CFMServicePaidSummaryByDept::OnToDateChange(){
	
} */
/*void CFMServicePaidSummaryByDept::OnToDateSetfocus(){
	
} */
/*void CFMServicePaidSummaryByDept::OnToDateKillfocus(){
	
} */
int CFMServicePaidSummaryByDept::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
void CFMServicePaidSummaryByDept::OnATMSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
	
}
	void CFMServicePaidSummaryByDept::OnAllZoneSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
	void CFMServicePaidSummaryByDept::OnABZoneSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
 
void CFMServicePaidSummaryByDept::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMServicePaidSummaryByDept::OnClerkSelendok(){
	 
}
int CFMServicePaidSummaryByDept::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMServicePaidSummaryByDept::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMServicePaidSummaryByDept::OnListCheckAllDVPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMServicePaidSummaryByDept::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMServicePaidSummaryByDept::OnSODSelect()
{
	OnListLoadData();
}
void CFMServicePaidSummaryByDept::OnCreateDataSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
int CFMServicePaidSummaryByDept::OnDeleteDataBeforeInsert()
{
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL; 	
...
/*void CFMServicePaidSummaryByDept::OnClerkSetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDept::OnClerkKillfocus(){
	
}*/
long CFMServicePaidSummaryByDept::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMServicePaidSummaryByDept::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMServicePaidSummaryByDept::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMServicePaidSummaryByDept::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMServicePaidSummaryByDept::OnStatusSetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDept::OnStatusKillfocus(){
	
}*/
long CFMServicePaidSummaryByDept::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMServicePaidSummaryByDept::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMServicePaidSummaryByDept::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMServicePaidSummaryByDept::OnOrderBySelendok(){
	 
}
/*void CFMServicePaidSummaryByDept::OnOrderBySetfocus(){
	
}*/
/*void CFMServicePaidSummaryByDept::OnOrderByKillfocus(){
	
}*/
long CFMServicePaidSummaryByDept::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMServicePaidSummaryByDept::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMServicePaidSummaryByDept::OnDeptLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMServicePaidSummaryByDept::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMServicePaidSummaryByDept::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMServicePaidSummaryByDept::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMServicePaidSummaryByDept::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMServicePaidSummaryByDept::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData();
	CRecord rs(&pMF->m_db);
...
void CFMServicePaidSummaryByDept::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMServicePaidSummaryByDept::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMServicePaidSummaryByDept::OnInpatientSelect(){
	
}
void CFMServicePaidSummaryByDept::OnOutpatientSelect(){
	
}
void CFMServicePaidSummaryByDept::OnDepositSelect(){
	
}
void CFMServicePaidSummaryByDept::OnAllSelect(){
	
}
 
 
int CFMServicePaidSummaryByDept::OnAddFMInsuranceReceiptSummary(){
...
int CFMServicePaidSummaryByDept::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMServicePaidSummaryByDept::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMServicePaidSummaryByDept::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMServicePaidSummaryByDept::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMServicePaidSummaryByDept::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMServicePaidSummaryByDept::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMServicePaidSummaryByDept::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMServicePaidSummaryByDept::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMServicePaidSummaryByDept"));
...
void CFMServicePaidSummaryByDept::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
	...
	menu.AppendMenu(MF_BYPOSITION, 15, _T("Tổng hợp(phiên bản 3 - 2024)"));

	menu.AppendMenu(MF_BYPOSITION, 16, _T("Phân tích thuốc, vật tư B5"));

	menu.AppendMenu(MF_BYPOSITION, 17, _T("Phân tích chi tiết theo danh mục"));

	menu.AppendMenu(MF_BYPOSITION, 18, _T("Bồi dưỡng theo danh mục"));
...
void CFMServicePaidSummaryByDept::OnExport(int nVersion)
...
void CFMServicePaidSummaryByDept::OnExport2(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
void CFMServicePaidSummaryByDept::OnExport3()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDept::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
CString CFMServicePaidSummaryByDept::GetQueryString_v2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
...
CString CFMServicePaidSummaryByDept::GetQueryString2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
...
CString CFMServicePaidSummaryByDept::GetQueryString3()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szSQL21,szSQL22,szSQL23,szSQL24, szOrderBy, szReceiptStr;
...
int CFMServicePaidSummaryByDept::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
int CFMServicePaidSummaryByDept::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	int nCheck = 0;
...
void CFMServicePaidSummaryByDept::OnExport4()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDept::GetQueryString4()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szSQL21,szSQL22,szSQL23,szSQL24, szOrderBy, szReceiptStr;
...
CString CFMServicePaidSummaryByDept::GetQueryString2_v2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
...
void CFMServicePaidSummaryByDept::OnExport7()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDept::GetQueryString_v7()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szSQL21,szSQL22,szSQL23,szSQL24,szSQL25, szOrderBy, szReceiptStr, szWherebed;
...
void CFMServicePaidSummaryByDept::OnExportv1(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	{
		szSQL = GetQueryString_v2_A11();
		//MessageBox(GetQueryString_v2_A11());
	}
	rs.ExecSQL(szSQL);
	//_msg(_T("%s"), szSQL);
	//MessageBox(GetQueryString());
...
CString CFMServicePaidSummaryByDept::GetQueryString_v2_A11()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szSQL21,szSQL22,szSQL23,szSQL24,szSQL25, szOrderBy, szReceiptStr, szWherebed;
...
int CFMServicePaidSummaryByDept::OnListCheckAllInvoiceTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
...
int CFMServicePaidSummaryByDept::OnListCheckAllRefundTYC()
{
	CString szItemText, szItemTextEX;
	int nCheck = 0;
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMServicePaidSummaryByDept::OnListCheckAllInvoiceBHTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText, szItemTextEX;
	int nCheck = 0;
...
int CFMServicePaidSummaryByDept::OnListCheckAllRefundBHTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText, szItemTextEX;
	int nCheck = 0;
...
void CFMServicePaidSummaryByDept::OnExportv2(int nVersion)
...
CString CFMServicePaidSummaryByDept::GetQueryString_v10()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
  ...
  szSQL1.Format(_T("     SELECT f.hfe_docno,") \
				...
				_T("       f.hfe_itemid,") \
				_T("       ") \
				_T("       CASE WHEN f.hfe_group<>'A1700' and f.hfe_cost>0 THEN f.hfe_cost ELSE NVL(f.hfe_cost, 0) END as TIEN_THUOC_CH_NGOAITRU,") \
  ...
  szSQL2.Format(_T("     UNION ALL     ") \
				...
				_T("       CASE WHEN f.hfe_group<>'A1700' and f.hfe_cost>0 THEN f.hfe_cost ELSE NVL(f.hfe_cost, 0) END as TIEN_THUOC_CH_NOITRU,") \
  ...
  szSQL3.Format(_T("     UNION ALL") \
				...
				_T("       CASE WHEN f.hfe_cost>0 THEN f.hfe_cost ELSE NVL(f.hfe_cost, 0) END as TIEN_VAT_TU_CH_NGOAITRU,") \
...
//4 Phi vat tu noi tru
	szSQL4.Format(_T("     UNION ALL") \
				...
				_T("       CASE WHEN f.hfe_cost>0 THEN f.hfe_cost ELSE NVL(f.hfe_cost, 0) END as TIEN_VAT_TU_CH_NOITRU,") \
	...
	else
	{
		szSQL1.Format(_T("     SELECT f.hfe_docno,") \
				...
				_T("       f.hfe_itemid,") \
				_T("       ") \
				_T("       CASE WHEN f.hfe_group<>'A1700' and f.hfe_patpaid>0 THEN f.hfe_patpaid ELSE NVL(f.hfe_otherpaid, 0) END as TIEN_THUOC_CH_NGOAITRU,") \
				_T("       case when f.hfe_group='A1700' then f.hfe_patpaid else 0 end as TIEN_TPCN_CH_NGOAITRU,") \
				_T("       case when f.hfe_group<>'A1700' and msl_type <> 'C' then f.hfe_patpaid else 0 end as TIEN_THUOC_CH_NGOAITRU_KHO,") \
				_T("       case when f.hfe_group<>'A1700' and msl_type = 'C' then f.hfe_patpaid else 0 end as TIEN_THUOC_CH_NGOAITRU_TT,") \
  ...
  szSQL2.Format(_T("     UNION ALL     ") \
				...
				_T("       CASE WHEN f.hfe_group<>'A1700' and f.hfe_patpaid>0 THEN f.hfe_patpaid ELSE NVL(f.hfe_otherpaid, 0) END as TIEN_THUOC_CH_NOITRU,") \
				_T("       case when f.hfe_group='A1700' then f.hfe_patpaid else 0 end as TIEN_TPCN_CH_NOITRU,") \
				_T("       case when f.hfe_group<>'A1700' and msl_type <> 'C' then f.hfe_patpaid else 0 end as TIEN_THUOC_CH_NOITRU_KHO,") \
				_T("       case when f.hfe_group<>'A1700' and msl_type = 'C' then f.hfe_patpaid else 0 end as TIEN_THUOC_CH_NOITRU_TT,") \
  ...
  szSQL3.Format(_T("     UNION ALL") \
				...
				_T("       CASE WHEN f.hfe_patpaid>0 THEN f.hfe_patpaid ELSE NVL(f.hfe_otherpaid, 0) END as TIEN_VAT_TU_CH_NGOAITRU,") \
				_T("       case when msl_type <> 'C' then f.hfe_patpaid else 0 end as TIEN_VAT_TU_CH_NGOAITRU_KHO,") \
				_T("       case when msl_type = 'C' then f.hfe_patpaid else 0 end as TIEN_VAT_TU_CH_NGOAITRU_TT,") \
...
//4 Phi vat tu noi tru
	szSQL4.Format(_T("     UNION ALL") \
				...
				_T("       CASE WHEN f.hfe_patpaid>0 THEN f.hfe_patpaid ELSE NVL(f.hfe_otherpaid, 0) END as TIEN_VAT_TU_CH_NOITRU,") \
				_T("       case when msl_type <> 'C' then f.hfe_patpaid else 0 end as TIEN_VAT_TU_CH_NOITRU_KHO,") \
				_T("       case when msl_type = 'C' then f.hfe_patpaid else 0 end as TIEN_VAT_TU_CH_NOITRU_TT,") \
...
rs.ExecSQL(szSQL);
   szSQL.Format(_T(" WITH tbl AS (%s)") \
				...
				_T(" CHINDEX, ") \
				_T(" to_char (posted_date,'DD/MM/YYYY') as posted_date,") \
				_T(" dept_id, SD_MAKHOA_TAICHINH, khoatt, ") \
				_T(" SUM(SO_NGAY_DT) as SO_NGAY_DT,") \
				...
				_T(" GROUP BY ") \
				_T(" HO_TEN, docno, NGAY_VAO, NGAY_RA,CHINDEX, posted_date,dept_id, SD_MAKHOA_TAICHINH, khoatt") \
...
void CFMServicePaidSummaryByDept::OnExport15(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDept::GetQueryString2_v15()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMServicePaidSummaryByDept::OnExportv16(int nVersion)
...
CString CFMServicePaidSummaryByDept::GetQueryString_v16()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMServicePaidSummaryByDept::OnExport2xxx(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDept::GetQueryString2_v2xxx()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr, szSQL21,szSQL22, szSQL23, szSQL24, szSQL25, szSQL26, szSQL27, szSQL28, szSQL29;
...
rs.ExecSQL(szSQL);
   ...
   szSQL.Format(_T(" WITH tbl AS (%s)") \
				...
				_T(" GROUP BY ") \
				_T(" dept_id, SD_MAKHOA_TAICHINH, nhomphi, tenmucphi, dongia ") \
				_T(" HAVING SUM(TIEN_KHAM+TIEN_GIUONG+TIEN_CLS+TIEN_PTTT+TIEN_THUOC_CH_NGOAITRU+TIEN_THUOC_CH_NOITRU+") \
				_T("	TIEN_VAT_TU_CH_NGOAITRU+TIEN_VAT_TU_CH_NOITRU+TIEN_THUOC_PM+TIEN_VAT_TU_PM+TIEN_MAU+THU_KHAC+THU_GOI+") \
				_T("	TIEN_AN+TIEN_AN_HC+TIEN_THUOC_TG+TIEN_VAT_TU_TG+TIEN_THUOC_TG_O+TIEN_VAT_TU_TG_O+CHON_BS)>0") \
				_T(" ORDER BY dept_id"),m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20,szSQL21,szSQL22,szSQL23, szSQL24,szSQL25, szSQL26, szSQL27, szSQL28, szSQL29, szWhere1);
				//_T(" ORDER BY dept_id"),m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL21,szSQL22,szSQL23, szSQL24,szSQL25, szWhere1);
	return szSQL;
}

void CFMServicePaidSummaryByDept::OnExport3xxx(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMServicePaidSummaryByDept::GetQueryString3_v2xxx()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL,szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL19,szSQL20, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr, szSQL21,szSQL22, szSQL23, szSQL24, szSQL25, szSQL26, szSQL27, szSQL28, szSQL29;
...
szSQL2.Format(_T("     UNION ALL") \
				...
				_T(" where hpcl_docno = f.hfe_docno") \
				_T(" and hpcl_orderid = f.hfe_orderid") \
				_T(" and hpcl_itemid = f.hfe_itemid) AS bsphauthuat,") \
...
rs.ExecSQL(szSQL);
   ...
   szSQL.Format(_T(" WITH tbl AS (%s)") \
				...
				_T("   )") \
				_T(" left join sys_dept on (sd_id = dept_id) ") \
				_T(" WHERE NVL(sd_type, 'CHUA_THUC_HIEN') NOT IN ('XN') ") \
				_T(" GROUP BY ") \
				_T(" dept_id, SD_MAKHOA_TAICHINH, nhomphi, tenmucphi, dongia, ") \
				_T("  tgthuchien,") \
				_T("   bsphauthuat,") \
				...
				_T(" ORDER BY dept_id"), m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL10,szSQL11,szSQL12,szSQL13,szWhere1);
				//_T(" ORDER BY dept_id"),m_szCashQuery, szSQL1,szSQL2,szSQL3,szSQL4,szSQL5,szSQL6,szSQL7,szSQL8,szSQL9,szSQL10,szSQL11,szSQL12,szSQL13,szSQL14,szSQL15,szSQL16,szSQL17,szSQL18,szSQL21,szSQL22,szSQL23, szSQL24,szSQL25, szWhere1);
	return szSQL;
}

void CFMServicePaidSummaryByDept::OnQrOnlineSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
int CFMServicePaidSummaryByDept::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMServicePaidSummaryByDept::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMServicePaidSummaryByDept::OnDeptListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMServicePaidSummaryByDept::OnDeptListCheckAllDV()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;
	int nCheck = 0;
...
int CFMServicePaidSummaryByDept::OnDeptListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CFMServicePaidSummaryByDept::OnListUnCheckQR()
