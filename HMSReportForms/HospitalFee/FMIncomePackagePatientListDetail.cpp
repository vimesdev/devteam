#include "stdafx.h"
#include "FMIncomePackagePatientListDetail.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMIncomePackagePatientListDetail* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMIncomePackagePatientListDetail *pVw = (CFMIncomePackagePatientListDetail *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackagePatientListDetail*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackagePatientListDetail*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackagePatientListDetail*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackagePatientListDetail*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackagePatientListDetail*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientListDetail*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMIncomePackagePatientListDetail*)pWnd)->OnPackageListLoadData();
}

CFMIncomePackagePatientListDetail::CFMIncomePackagePatientListDetail(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMIncomePackagePatientListDetail::~CFMIncomePackagePatientListDetail()
{
}
void CFMIncomePackagePatientListDetail::OnCreateComponents()
{
...
void CFMIncomePackagePatientListDetail::OnInitializeComponents(){
...
void CFMIncomePackagePatientListDetail::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackagePatientListDetail::OnDoDataExchange(CDataExchange* pDX){
...
void CFMIncomePackagePatientListDetail::SetDefaultValues(){
...
int CFMIncomePackagePatientListDetail::SetMode(int nMode){
...
/*void CFMIncomePackagePatientListDetail::OnYearChange(){
	
} */
/*void CFMIncomePackagePatientListDetail::OnYearSetfocus(){
	
} */
/*void CFMIncomePackagePatientListDetail::OnYearKillfocus(){
	
} */
int CFMIncomePackagePatientListDetail::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMIncomePackagePatientListDetail::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMIncomePackagePatientListDetail::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMIncomePackagePatientListDetail::OnReportPeriodSetfocus(){
	
}*/
/*void CFMIncomePackagePatientListDetail::OnReportPeriodKillfocus(){
	
}*/
long CFMIncomePackagePatientListDetail::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMIncomePackagePatientListDetail::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMIncomePackagePatientListDetail::OnFromDateChange(){
	
} */
/*void CFMIncomePackagePatientListDetail::OnFromDateSetfocus(){
	
} */
/*void CFMIncomePackagePatientListDetail::OnFromDateKillfocus(){
	
} */
int CFMIncomePackagePatientListDetail::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMIncomePackagePatientListDetail::OnToDateChange(){
	
} */
/*void CFMIncomePackagePatientListDetail::OnToDateSetfocus(){
	
} */
/*void CFMIncomePackagePatientListDetail::OnToDateKillfocus(){
	
} */
int CFMIncomePackagePatientListDetail::OnToDateCheckValue(){
	return 0;
}
long CFMIncomePackagePatientListDetail::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackagePatientListDetail::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMIncomePackagePatientListDetail::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMIncomePackagePatientListDetail::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
void CFMIncomePackagePatientListDetail::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackagePatientListDetail::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackagePatientListDetail::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackagePatientListDetail::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	xls.SetCellMergedColumns(6, 1, 6);
	xls.SetCellMergedColumns(6, 2, 6);
	...
	xls.SetCellText(nCol, nRow + 3, _T("Danh sách bệnh nhân chi trả lại gói dịch vụ bằng nghiệp vụ chi khác"),
	...
	xls.SetCellText(nCol + 2, nRow + 5, _T("S\x1ED1 HS"), FMT_TEXT | FMT_CENTER | FMT_VCENTER | FMT_WRAPING, true, 11);	
	...
	TranslateString(_T("Diễn giải"), tmpStr);
	xls.SetCellText(nCol + 6, nRow + 5, tmpStr, FMT_TEXT | FMT_CENTER | FMT_VCENTER | FMT_WRAPING, true, 11);

	xls.SetCellText(nCol + 7, nRow + 5, _T("Số tiền chi"), FMT_TEXT | FMT_CENTER | FMT_VCENTER | FMT_WRAPING, true, 11);
	nRow = 6;
	while (!rs.IsEOF())
	{
		rs.GetValue(_T("dept"), szNewLine);
		...
		rs.GetValue(_T("refundamount"), nCost);
		nGroupTotal += nCost;
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\Danhsachbenhnhanchitralaigoi.xls"));
	return;
...
void CFMIncomePackagePatientListDetail::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackagePatientListDetail::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackagePatientListDetail::OnObjectListDblClick(){
	
}
 
void CFMIncomePackagePatientListDetail::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackagePatientListDetail::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackagePatientListDetail::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackagePatientListDetail::OnDeptListDblClick(){
	
}
 
void CFMIncomePackagePatientListDetail::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackagePatientListDetail::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackagePatientListDetail::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMIncomePackagePatientListDetail::GetQueryString()
{
	...
	_T("   CASE WHEN fe.hfe_itemid in (SELECT ss_code FROM sys_sel WHERE ss_id='HMS_SERVICE_PACKAGE' and ss_vndesc='GNLT') then CAST(('Nhà lưu trú') as NVARCHAR2(20)) ELSE fe.hfe_deptid END as dept,") \
...
CString CFMIncomePackagePatientListDetail::GetQueryString1()
{
...
int CFMIncomePackagePatientListDetail::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMIncomePackagePatientListDetail::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMIncomePackagePatientListDetail::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMIncomePackagePatientListDetail::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
