#include "stdafx.h"
#include "FMReturnPackageSummaryEX.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMReturnPackageSummaryEX* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMReturnPackageSummaryEX *pVw = (CFMReturnPackageSummaryEX *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMReturnPackageSummaryEX*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMReturnPackageSummaryEX*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMReturnPackageSummaryEX*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMReturnPackageSummaryEX*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMReturnPackageSummaryEX*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummaryEX*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMReturnPackageSummaryEX*)pWnd)->OnPackageListLoadData();
}

CFMReturnPackageSummaryEX::CFMReturnPackageSummaryEX(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMReturnPackageSummaryEX::~CFMReturnPackageSummaryEX()
{
}
void CFMReturnPackageSummaryEX::OnCreateComponents()
{
...
void CFMReturnPackageSummaryEX::OnInitializeComponents(){
...
void CFMReturnPackageSummaryEX::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummaryEX::OnDoDataExchange(CDataExchange* pDX){
...
void CFMReturnPackageSummaryEX::SetDefaultValues(){
...
int CFMReturnPackageSummaryEX::SetMode(int nMode){
...
/*void CFMReturnPackageSummaryEX::OnYearChange(){
	
} */
/*void CFMReturnPackageSummaryEX::OnYearSetfocus(){
	
} */
/*void CFMReturnPackageSummaryEX::OnYearKillfocus(){
	
} */
int CFMReturnPackageSummaryEX::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMReturnPackageSummaryEX::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMReturnPackageSummaryEX::OnReportPeriodSelendok()
{
...
/*void CFMReturnPackageSummaryEX::OnReportPeriodSetfocus(){
	
}*/
/*void CFMReturnPackageSummaryEX::OnReportPeriodKillfocus(){
	
}*/
long CFMReturnPackageSummaryEX::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMReturnPackageSummaryEX::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMReturnPackageSummaryEX::OnFromDateChange(){
	
} */
/*void CFMReturnPackageSummaryEX::OnFromDateSetfocus(){
	
} */
/*void CFMReturnPackageSummaryEX::OnFromDateKillfocus(){
	
} */
int CFMReturnPackageSummaryEX::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMReturnPackageSummaryEX::OnToDateChange(){
	
} */
/*void CFMReturnPackageSummaryEX::OnToDateSetfocus(){
	
} */
/*void CFMReturnPackageSummaryEX::OnToDateKillfocus(){
	
} */
int CFMReturnPackageSummaryEX::OnToDateCheckValue(){
	return 0;
}
 
void CFMReturnPackageSummaryEX::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMReturnPackageSummaryEX::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMReturnPackageSummaryEX::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
long CFMReturnPackageSummaryEX::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	_T(" ss_index") \
	_T(" FROM sys_sel") \
	_T(" WHERE ss_id ='HMS_SERVICE_PACKAGE' and ss_vndesc='GNLT'") \
	_T(" UNION ALL") \
	_T(" SELECT ss_code AS ID,") \
	_T("   ss_desc      AS Name,") \
	_T("   100 as ss_index") \
	...
	_T(" AND ss_code IN('18','19','20') AND 0>1")\
	_T(" )") \
...
void CFMReturnPackageSummaryEX::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_CHIGOI_NHALUUTRU_TH.RPT")))
		return;
...
void CFMReturnPackageSummaryEX::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummaryEX::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummaryEX::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMReturnPackageSummaryEX::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMReturnPackageSummaryEX::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMReturnPackageSummaryEX::OnObjectListDblClick(){
	
}
 
void CFMReturnPackageSummaryEX::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMReturnPackageSummaryEX::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMReturnPackageSummaryEX::OnObjectListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CFMReturnPackageSummaryEX::OnDeptListDblClick(){
	
}
 
void CFMReturnPackageSummaryEX::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMReturnPackageSummaryEX::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMReturnPackageSummaryEX::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMReturnPackageSummaryEX::GetQueryString()
{
	...
	_T(" ON (rf.hfe_cash_id  =fac_cash_id)") \
	_T(" WHERE rf.hfe_type   ='V'") \
	_T(" AND rfl.hfe_itemid IN ('18','19','20') AND 0>1") \
	_T(" AND FAC_POSTEDDATE BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
	_T(" AND rf.hfe_status IN ('P', 'R') %s") \
	_T(" UNION ALL") \
	_T(" SELECT") \
	...
	_T("   (SELECT ss_code FROM sys_sel WHERE ss_id='HMS_SERVICE_PACKAGE' and ss_vndesc='GNLT'") \
	_T("   )") \
	_T(" AND FAC_POSTEDDATE BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
	_T(" AND rf.hfe_status IN ('P', 'R') %s") \
	_T(" ORDER BY itemid") \
...
CString CFMReturnPackageSummaryEX::GetQueryString1()
{
...
int CFMReturnPackageSummaryEX::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMReturnPackageSummaryEX::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMReturnPackageSummaryEX::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMReturnPackageSummaryEX::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
