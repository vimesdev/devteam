#ifndef FMSOMOtherFee_H
#define FMSOMOtherFee_H
...
class CFMSOMOtherFee : public CGuiView
{
protected:
...
public:
	...
	int OnAddFMSOMOtherFee(); 
	int OnEditFMSOMOtherFee(); 
	int OnDeleteFMSOMOtherFee(); 
	int OnSaveFMSOMOtherFee(); 
	int OnCancelFMSOMOtherFee(); 
	int OnFMSOMOtherFeeListLoadData(); 
