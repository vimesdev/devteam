#ifndef FMDanhSachLinhTienBoiDuongPTTT_H
#define FMDanhSachLinhTienBoiDuongPTTT_H
...
class CFMDanhSachLinhTienBoiDuongPTTT : public CGuiView
{
...
public:
	...
	CFMDanhSachLinhTienBoiDuongPTTT(CWnd *pWnd);
	~CFMDanhSachLinhTienBoiDuongPTTT();
