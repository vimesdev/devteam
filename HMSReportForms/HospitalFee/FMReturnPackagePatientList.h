#ifndef FMRETURNPACKAGEPATIENTLIST_H
#define FMRETURNPACKAGEPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMReturnPackagePatientList : public CGuiView
{
protected:
...
public:
	...
	CFMReturnPackagePatientList(CWnd *pParent);
	~CFMReturnPackagePatientList();
