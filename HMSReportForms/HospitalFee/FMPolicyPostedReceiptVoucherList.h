#ifndef FMPolycyPostedReceiptVoucherList_H
#define FMPolycyPostedReceiptVoucherList_H
...
class CFMPolicyPostedReceiptVoucherList : public CGuiView
{
protected:
...
public:
	...
	CFMPolicyPostedReceiptVoucherList(CWnd *pWnd);
	~CFMPolicyPostedReceiptVoucherList();
