#include "stdafx.h"
#include "FMOutpatientInsuranceReport19A.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnYearKillfocus();

} */
static void _OnSoldierPatientSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A*)pWnd)->OnSoldierPatientSelect();
}
static void _OnNotinSoldierPatientSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A*)pWnd)->OnNotinSoldierPatientSelect();
}

static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMOutpatientInsuranceReport19A* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A *)pWnd)->OnToDateCheckValue();
} 
static void _OnPatientLineSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMOutpatientInsuranceReport19A* )pWnd)->OnPatientLineSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPatientLineSelendokFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnPatientLineSelendok();
}
/*static void _OnPatientLineSetfocusFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnPatientLineKillfocus();
}*/
...
{
	return ((CFMOutpatientInsuranceReport19A *)pWnd)->OnPatientLineLoadData();
}
/*static void _OnPatientLineAddNewFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A *)pWnd)->OnPatientLineAddNew();
}*/
static void _OnDrugPTTTSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A*)pWnd)->OnDrugPTTTSelect();
}
static void _OnByDischargedDateSelectFnc(CWnd *pWnd){
	 ((CFMOutpatientInsuranceReport19A*)pWnd)->OnByDischargedDateSelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMOutpatientInsuranceReport19A *pVw = (CFMOutpatientInsuranceReport19A *)pWnd;
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMOutpatientInsuranceReport19A*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMOutpatientInsuranceReport19A*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMOutpatientInsuranceReport19A*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMOutpatientInsuranceReport19A*)pWnd)->OnListDeleteItem();
}
static long _OnphanloaibhLoadDataFnc(CWnd *pWnd)
{
	return ((CFMOutpatientInsuranceReport19A *)pWnd)->OnphanloaibhLoadData();
}

CFMOutpatientInsuranceReport19A::CFMOutpatientInsuranceReport19A(CWnd *pParent)
{
	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMOutpatientInsuranceReport19A::~CFMOutpatientInsuranceReport19A(){
}
void CFMOutpatientInsuranceReport19A::OnCreateComponents(){	
...
void CFMOutpatientInsuranceReport19A::OnInitializeComponents(){
...
void CFMOutpatientInsuranceReport19A::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMOutpatientInsuranceReport19A::OnDoDataExchange(CDataExchange* pDX){
...
void CFMOutpatientInsuranceReport19A::SetDefaultValues(){
...
int CFMOutpatientInsuranceReport19A::SetMode(int nMode){
...
/*void CFMOutpatientInsuranceReport19A::OnYearChange(){
	
} */
/*void CFMOutpatientInsuranceReport19A::OnYearSetfocus(){
	
} */
/*void CFMOutpatientInsuranceReport19A::OnYearKillfocus(){
	
} */
long CFMOutpatientInsuranceReport19A::OnphanloaibhLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMOutpatientInsuranceReport19A::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMOutpatientInsuranceReport19A::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMOutpatientInsuranceReport19A::OnSoldierPatientSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMOutpatientInsuranceReport19A::OnNotinSoldierPatientSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMOutpatientInsuranceReport19A::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMOutpatientInsuranceReport19A::OnReportPeriodSetfocus(){
	
}*/
/*void CFMOutpatientInsuranceReport19A::OnReportPeriodKillfocus(){
	
}*/
long CFMOutpatientInsuranceReport19A::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMOutpatientInsuranceReport19A::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMOutpatientInsuranceReport19A::OnFromDateChange(){
	
} */
/*void CFMOutpatientInsuranceReport19A::OnFromDateSetfocus(){
	
} */
/*void CFMOutpatientInsuranceReport19A::OnFromDateKillfocus(){
	
} */
int CFMOutpatientInsuranceReport19A::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMOutpatientInsuranceReport19A::OnToDateChange(){
	
} */
/*void CFMOutpatientInsuranceReport19A::OnToDateSetfocus(){
	
} */
/*void CFMOutpatientInsuranceReport19A::OnToDateKillfocus(){
	
} */
int CFMOutpatientInsuranceReport19A::OnToDateCheckValue(){
	return 0;
}
 
void CFMOutpatientInsuranceReport19A::OnPatientLineSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMOutpatientInsuranceReport19A::OnPatientLineSelendok(){
	 
}
/*void CFMOutpatientInsuranceReport19A::OnPatientLineSetfocus(){
	
}*/
/*void CFMOutpatientInsuranceReport19A::OnPatientLineKillfocus(){
	
}*/
long CFMOutpatientInsuranceReport19A::OnPatientLineLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMOutpatientInsuranceReport19A::OnPatientLineAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMOutpatientInsuranceReport19A::OnDrugPTTTSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

void CFMOutpatientInsuranceReport19A::OnByDischargedDateSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMOutpatientInsuranceReport19A::OnPrintPreviewSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMOutpatientInsuranceReport19A::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
	CRect rect;
	...
	TranslateString(_T("Export 19A Format (Update24/08/2018) ***"), tmpStr);
...
void CFMOutpatientInsuranceReport19A::OnExport()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\Thong Ke Tien Vat Tu Theo Quy Moi_ngoai tru.xls"));

}

void CFMOutpatientInsuranceReport19A::OnExportDetail(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
void CFMOutpatientInsuranceReport19A::OnListDblClick(){
	
}
 
void CFMOutpatientInsuranceReport19A::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMOutpatientInsuranceReport19A::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMOutpatientInsuranceReport19A::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	m_wndList.BeginLoad(); 
...
int CFMOutpatientInsuranceReport19A::OnListCheckAll(){
...
int CFMOutpatientInsuranceReport19A::OnListUnCheckAll(){
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (m_wndList.GetCheck(i))
		{
...
CString CFMOutpatientInsuranceReport19A::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	szSQL.Format(_T(" SELECT mp_atccode,patient_line, chapter, group_id, group_name, item_name, sum(qty) qty, unit_price, sum(amount) amount ") \
				_T(" FROM   (") \
				_T(" %s) ") \
				_T(" GROUP BY mp_atccode,patient_line, chapter, group_id, group_name, item_name, unit_price") \
...
CString CFMOutpatientInsuranceReport19A::GetQueryString1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMOutpatientInsuranceReport19A::OnExport_1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	...
	TranslateString(_T("BÁO CÁO 19A NGOẠI TRÚ CHUYỂN CỔNG BẢO HIỂM"), szTemp);
	StringUpper(szTemp, tmpStr);
	xls.SetCellText(nCol, nRow + 2, tmpStr, FMT_TEXT | FMT_CENTER, true, 11);	
	tmpStr.Format(_T("T\x1EEB ng\xE0y %s \x111\x1EBFn ng\xE0y %s"),
		          CDateTime::Convert(m_szFromDate, yyyymmdd | hhmm, ddmmyyyy | hhmm),
...
CString CFMOutpatientInsuranceReport19A::GetQueryString2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL, szSubSQL, szWhere, szSubWhere, szHospitalID;
	CString szLineWhere, szDept, szTable, szFeeCondition;
	szHospitalID = pMF->m_CompanyInfo.sc_id;
...
void CFMOutpatientInsuranceReport19A::OnExport_2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
CString CFMOutpatientInsuranceReport19A::GetQueryString3()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL, szSubSQL, szWhere, szSubWhere, szHospitalID;
	CString szLineWhere, szDept, szTable, szFeeCondition;
