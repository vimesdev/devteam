#include "stdafx.h"
#include "FMIncomePackageSummaryEX1.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1 *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMIncomePackageSummaryEX1* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1 *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1 *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMIncomePackageSummaryEX1 *pVw = (CFMIncomePackageSummaryEX1 *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummaryEX1*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummaryEX1*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX1*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummaryEX1*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummaryEX1*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX1*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMIncomePackageSummaryEX1*)pWnd)->OnPackageListLoadData();
}

CFMIncomePackageSummaryEX1::CFMIncomePackageSummaryEX1(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMIncomePackageSummaryEX1::~CFMIncomePackageSummaryEX1()
{
}
void CFMIncomePackageSummaryEX1::OnCreateComponents()
{
...
void CFMIncomePackageSummaryEX1::OnInitializeComponents(){
...
void CFMIncomePackageSummaryEX1::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryEX1::OnDoDataExchange(CDataExchange* pDX){
	DDX_Text(pDX, m_wndYear.GetDlgCtrlID(), m_nYear);
	DDX_TextEx(pDX, m_wndReportPeriod.GetDlgCtrlID(), m_szReportPeriodKey);
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);
	DDX_Check(pDX, m_wndInsurance.GetDlgCtrlID(), m_bInsurance);
	DDX_Radio(pDX, m_wndByDate.GetDlgCtrlID(), m_nByDate);
	DDX_Radio(pDX, m_wndByDept.GetDlgCtrlID(), m_nByDept);

}
void CFMIncomePackageSummaryEX1::SetDefaultValues(){
...
int CFMIncomePackageSummaryEX1::SetMode(int nMode){
...
/*void CFMIncomePackageSummaryEX1::OnYearChange(){
	
} */
/*void CFMIncomePackageSummaryEX1::OnYearSetfocus(){
	
} */
/*void CFMIncomePackageSummaryEX1::OnYearKillfocus(){
	
} */
int CFMIncomePackageSummaryEX1::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMIncomePackageSummaryEX1::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMIncomePackageSummaryEX1::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMIncomePackageSummaryEX1::OnReportPeriodSetfocus(){
	
}*/
/*void CFMIncomePackageSummaryEX1::OnReportPeriodKillfocus(){
	
}*/
long CFMIncomePackageSummaryEX1::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMIncomePackageSummaryEX1::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMIncomePackageSummaryEX1::OnFromDateChange(){
	
} */
/*void CFMIncomePackageSummaryEX1::OnFromDateSetfocus(){
	
} */
/*void CFMIncomePackageSummaryEX1::OnFromDateKillfocus(){
	
} */
int CFMIncomePackageSummaryEX1::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMIncomePackageSummaryEX1::OnToDateChange(){
	
} */
/*void CFMIncomePackageSummaryEX1::OnToDateSetfocus(){
	
} */
/*void CFMIncomePackageSummaryEX1::OnToDateKillfocus(){
	
} */
int CFMIncomePackageSummaryEX1::OnToDateCheckValue(){
	return 0;
}
long CFMIncomePackageSummaryEX1::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	szSQL.Format(_T("SELECT ss_code AS ID, ") \
		         _T("ss_desc AS Name ") \
		         _T("FROM sys_sel ") \
				 _T("WHERE ss_id ='HMS_SERVICE_PACKAGE' and ss_vndesc='GNNOLPB' %s ") \
...
void CFMIncomePackageSummaryEX1::OnByDateSelect()
{
	//m_szCondition = _T("hfe_date");
}
void CFMIncomePackageSummaryEX1::OnByDeptSelect()
{
	//m_szCondition = _T("hfe_deptid");
}

void CFMIncomePackageSummaryEX1::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
void CFMIncomePackageSummaryEX1::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_THUGOI_NGUOINHAOLAI_TH.RPT")))
		return;
...
void CFMIncomePackageSummaryEX1::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryEX1::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryEX1::OnExportSelect()
{
	UpdateData(true);
...
void CFMIncomePackageSummaryEX1::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummaryEX1::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackageSummaryEX1::OnObjectListDblClick(){
	
}
 
void CFMIncomePackageSummaryEX1::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummaryEX1::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummaryEX1::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummaryEX1::OnDeptListDblClick(){
	
}
 
void CFMIncomePackageSummaryEX1::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummaryEX1::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummaryEX1::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMIncomePackageSummaryEX1::GetQueryString()
{
	
	CString szSQL, szWhere, szObjects, szDepts,szPackages, szOrderBy;
	
	AfxMessageBox(_T("Bổ sung thêm phần miễn giảm vào báo cáo này!"));
	...
	_T("   (SELECT ss_code FROM sys_sel WHERE ss_id ='HMS_SERVICE_PACKAGE' and ss_vndesc='GNNOLPB'") \
	_T("   )") \
	...
	//_T(" AND fac_posted     = 'Y' AND fac_cashbook_id not in ('BHYC','BH-PTTYC', 'THE-BH-YC','THE-BH-PTTYC') ") \//
	_T(" AND fac_posted     = 'Y' AND fac_cashbook_id not in ('BHYC','BH-PTTYC', 'THE-BH-YC','THE-BH-PTTYC', 'DVYC','DV-PTTYC', 'THE-DV-YC','THE-DV-PTTYC')") \
...
CString CFMIncomePackageSummaryEX1::GetQueryString1()
{
...
int CFMIncomePackageSummaryEX1::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummaryEX1::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummaryEX1::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMIncomePackageSummaryEX1::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
void CFMIncomePackageSummaryEX1::OnExportByDate()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMIncomePackageSummaryEX1::OnExportByDept()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMIncomePackageSummaryEX1::GetQueryStringbydept()
{
	CString szSQL, szWhere, szObjects, szDepts,szPackages, szOrderBy;
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
	...
	szSQL.Format(_T(" SELECT") \
	_T(" itemid, deptid, hfe_desc,") \
	_T(" SUM(qty) AS totalqty,") \
	_T(" SUM(incomeamount) AS totalincomeamount") \
	_T(" FROM") \
	_T(" (") \
	_T(" SELECT   ") \
	_T("   fe.hfe_itemid    AS itemid, fe.hfe_deptid as deptid,") \
	_T("   fe.hfe_desc      AS hfe_desc,") \
	_T("   SUM(fe.hfe_quantity)  AS qty,") \
	_T("   SUM(fe.hfe_cost) AS incomeamount") \
	_T(" FROM Hms_Fee fe") \
	...
	_T(" AND fe.hfe_cost>0") \
	_T(" GROUP BY") \
	_T("   fe.hfe_itemid, fe.hfe_deptid,") \
	_T("   fe.hfe_desc,") \
	_T("   fe.hfe_quantity,") \
	_T("   fe.hfe_cost") \
	_T(" ORDER BY fe.hfe_itemid )") \
	_T(" GROUP BY itemid, hfe_desc, deptid") \
	_T(" ORDER BY deptid,itemid"), m_szFromDate, m_szToDate, szWhere);
	return szSQL;
}