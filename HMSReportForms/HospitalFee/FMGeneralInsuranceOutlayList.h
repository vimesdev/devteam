#ifndef FMGENERALINSURANCEOUTLAYLIST_H
#define FMGENERALINSURANCEOUTLAYLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMGeneralInsuranceOutlayList : public CGuiView{
protected:
public:
	...
	void			OnLockedSelect(); 
	CFMGeneralInsuranceOutlayList(CWnd *pParent);
	~CFMGeneralInsuranceOutlayList();
