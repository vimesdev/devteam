#ifndef FMDoanhThuHauCan_2024_H
#define FMDoanhThuHauCan_2024_H
...
class CFMDoanhThuHauCan_2024 : public CGuiView
{

protected:
	CMap<CString, LPCTSTR, CString, LPCTSTR> m_mIndex;
	CString		m_szCashQuery;
	void		InitGroupInfo(CRecord* pRs, GROUP_INFO4 (*grp_info)[2], int& nDepth, int& nColNum);
public:
	CString		m_szCashIDS;
	...
	CFMDoanhThuHauCan_2024(CWnd *pWnd);
	~CFMDoanhThuHauCan_2024();
