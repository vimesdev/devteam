#include "stdafx.h"
#include "FMSudungvattuBHYT19_Y2015.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungvattuBHYT19_Y2015* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungvattuBHYT19_Y2015* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnTypeAddNew();
}*/
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungvattuBHYT19_Y2015* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungvattuBHYT19_Y2015* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnSourceAddNew();
}*/
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015 *)pWnd)->OnItemLoadData();
}
static void _OnDrugPTTTSelectFnc(CWnd *pWnd){
	 ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnDrugPTTTSelect();
}
static void _OnExamSelectFnc(CWnd *pWnd){
	  ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnExamSelect();
}
static void _OnInPatientSelectFnc(CWnd *pWnd){
	  ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnInPatientSelect();
}
static void _OnAllHospitalsSelectFnc(CWnd *pWnd){
	  ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnAllHospitalsSelect();
}
static void _OnOrderBySelectFnc(CWnd *pWnd){
	 ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnOrderBySelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMSudungvattuBHYT19_Y2015 *pVw = (CFMSudungvattuBHYT19_Y2015 *)pWnd;
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnListDeleteItem();
}
static int _OnAddFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnAddFMSudungthuocBHYT20a();
} 
static int _OnEditFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnEditFMSudungthuocBHYT20a();
} 
static int _OnDeleteFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnDeleteFMSudungthuocBHYT20a();
} 
static int _OnSaveFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnSaveFMSudungthuocBHYT20a();
} 
static int _OnCancelFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnCancelFMSudungthuocBHYT20a();
}

static int _OnListCheckAllFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnListCheckAll();
}
static int _OnListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMSudungvattuBHYT19_Y2015*)pWnd)->OnListUnCheckAll();
}

CFMSudungvattuBHYT19_Y2015::CFMSudungvattuBHYT19_Y2015(CWnd *pParent)
{
	m_nDlgWidth = 460;
	m_nDlgHeight = 495;
	SetDefaultValues();
}
CFMSudungvattuBHYT19_Y2015::~CFMSudungvattuBHYT19_Y2015()
{
}
void CFMSudungvattuBHYT19_Y2015::OnCreateComponents()
{
	...
	m_wndList.Create(this,15, 205, 420, 450); 

	m_wndAllHospitals.Create(this, L"", 0, 0, 0, 0);
	m_wndAllHospitals.ShowWindow(SW_HIDE);
	m_wndAllHospitals.EnableWindow(FALSE);
}

void CFMSudungvattuBHYT19_Y2015::OnInitializeComponents()
{
...
void CFMSudungvattuBHYT19_Y2015::OnSetWindowEvents()
{
...
void CFMSudungvattuBHYT19_Y2015::OnDoDataExchange(CDataExchange* pDX)
{
...
void CFMSudungvattuBHYT19_Y2015::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMSudungvattuBHYT19_Y2015::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMSudungvattuBHYT19_Y2015::SetDefaultValues()
{
	m_szFromDate.Empty();
	m_szToDate.Empty();
	m_szStockKey.Empty();
...
int CFMSudungvattuBHYT19_Y2015::SetMode(int nMode)
{
...
/*void CFMSudungvattuBHYT19_Y2015::OnFromDateChange(){
	
} */
/*void CFMSudungvattuBHYT19_Y2015::OnFromDateSetfocus(){
	
} */
/*void CFMSudungvattuBHYT19_Y2015::OnFromDateKillfocus(){
	
} */
int CFMSudungvattuBHYT19_Y2015::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMSudungvattuBHYT19_Y2015::OnToDateChange(){
	
} */
/*void CFMSudungvattuBHYT19_Y2015::OnToDateSetfocus(){
	
} */
/*void CFMSudungvattuBHYT19_Y2015::OnToDateKillfocus(){
	
} */
int CFMSudungvattuBHYT19_Y2015::OnToDateCheckValue(){
	return 0;
} 
void CFMSudungvattuBHYT19_Y2015::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungvattuBHYT19_Y2015::OnStockSelendok(){
	 
}
/*void CFMSudungvattuBHYT19_Y2015::OnStockSetfocus(){
	
}*/
/*void CFMSudungvattuBHYT19_Y2015::OnStockKillfocus(){
	
}*/

long CFMSudungvattuBHYT19_Y2015::OnStockLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMSudungvattuBHYT19_Y2015::OnStockAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungvattuBHYT19_Y2015::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungvattuBHYT19_Y2015::OnTypeSelendok(){
	 
}
/*void CFMSudungvattuBHYT19_Y2015::OnTypeSetfocus(){
	
}*/
/*void CFMSudungvattuBHYT19_Y2015::OnTypeKillfocus(){
	
}*/
long CFMSudungvattuBHYT19_Y2015::OnTypeLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungvattuBHYT19_Y2015::OnTypeAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungvattuBHYT19_Y2015::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungvattuBHYT19_Y2015::OnGroupSelendok(){
	 
}
/*void CFMSudungvattuBHYT19_Y2015::OnGroupSetfocus(){
	
}*/
/*void CFMSudungvattuBHYT19_Y2015::OnGroupKillfocus(){
	
}*/
long CFMSudungvattuBHYT19_Y2015::OnGroupLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungvattuBHYT19_Y2015::OnGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungvattuBHYT19_Y2015::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungvattuBHYT19_Y2015::OnSourceSelendok(){
	 
}
/*void CFMSudungvattuBHYT19_Y2015::OnSourceSetfocus(){
	
}*/
/*void CFMSudungvattuBHYT19_Y2015::OnSourceKillfocus(){
	
}*/
long CFMSudungvattuBHYT19_Y2015::OnSourceLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungvattuBHYT19_Y2015::OnSourceAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMSudungvattuBHYT19_Y2015::OnItemLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	void CFMSudungvattuBHYT19_Y2015::OnDrugPTTTSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMSudungvattuBHYT19_Y2015::OnExamSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
}
void CFMSudungvattuBHYT19_Y2015::OnInPatientSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
}
void CFMSudungvattuBHYT19_Y2015::OnAllHospitalsSelect()
{
	UpdateData(TRUE);
	OnListLoadData();
}
void CFMSudungvattuBHYT19_Y2015::OnOrderBySelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

void CFMSudungvattuBHYT19_Y2015::OnPrintPreviewSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CFMSudungvattuBHYT19_Y2015::OnPrintDetail(){

}

void CFMSudungvattuBHYT19_Y2015::OnExportSelect()
{
	OnExport();
	return;
...
void CFMSudungvattuBHYT19_Y2015::OnExport(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CExcel xls;
	CRecord rs(&pMF->m_db);
...
void CFMSudungvattuBHYT19_Y2015::OnExportDetail(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CExcel xls;
...
void CFMSudungvattuBHYT19_Y2015::OnListDblClick(){
	
} 
void CFMSudungvattuBHYT19_Y2015::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMSudungvattuBHYT19_Y2015::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMSudungvattuBHYT19_Y2015::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
int CFMSudungvattuBHYT19_Y2015::OnAddFMSudungthuocBHYT20a(){
...
int CFMSudungvattuBHYT19_Y2015::OnEditFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CFMSudungvattuBHYT19_Y2015::OnDeleteFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CFMSudungvattuBHYT19_Y2015::OnSaveFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CFMSudungvattuBHYT19_Y2015::OnCancelFMSudungthuocBHYT20a(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CFMSudungvattuBHYT19_Y2015::OnFMSudungthuocBHYT20aListLoadData(){
	return 0;
}

CString CFMSudungvattuBHYT19_Y2015::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
	...
	szSQL.Format(_T(" SELECT patient_line, ") \
				...
				_T("         WHERE     (product_org_id = 'MA' OR product_org_id = 'BB' OR (product_org_id = 'PM' AND product_producttype IN ('A1500', 'A1600'))) AND doc_status = 'T' ") \
				_T("			%s %s) ") \
...
CString CFMSudungvattuBHYT19_Y2015::GetQueryString1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
	CString szSQL, szWhere, szOrderBy;
	CString szDept, szFeeCondition;
	...
	szSQL.Format(_T(" SELECT    product_producttype, ") \
				...
				_T(" WHERE     (product_org_id = 'MA' OR product_org_id = 'BB' OR (product_org_id = 'PM' AND product_producttype IN ('A1500', 'A1600')))") \
...
int CFMSudungvattuBHYT19_Y2015::OnListCheckAll()
{
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (!m_wndList.GetCheck(i))
...
int CFMSudungvattuBHYT19_Y2015::OnListUnCheckAll()
{
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (m_wndList.GetCheck(i))
