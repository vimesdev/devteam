...
void CTMOperationList::OnCreateComponents(){
	...
	m_wndKPL.Create(this, _T("Không phân loại"), 0, 0, 0, 0);
	...
	m_wndDept.Create(this,10, 91, 505, 372);
	m_wndDept.SetCheckBox(true);
	m_wndInsurance.Create(this, _T("Insurance"), 9, 377, 99, 402);
	m_wndService.Create(this, _T("Service"), 104, 377, 194, 402);
	m_wndPolicy.Create(this, _T("Policies"), 199, 377, 279, 402);
	m_wndPayment.Create(this, _T("Chưa nộp quỹ"), 284, 377, 394, 402);
	m_wndPayment2.Create(this, _T("Ðã nộp quỹ"), 399, 377, 504, 402);
	m_wndSurgery.Create(this, _T("Surgery"), 9, 407, 99, 432);
	m_wndOperation.Create(this, _T("Operation"), 104, 407, 194, 432);
	m_wndParaclinical.Create(this, _T("Paraclinical"), 199, 407, 319, 432);
	//m_wndKPL.Create(this, _T("Không phân loại"), 33, 29, 33, 29);
	m_wndAll.Create(this, _T("All"), 9, 436, 99, 461);
	m_wndInpatient.Create(this, _T("InPatient"), 104, 436, 194, 461);
	m_wndOutpatient.Create(this, _T("OutPatient"), 199, 436, 319, 461);
	m_wndFromExam.Create(this, _T("Từ phòng khám"), 324, 436, 444, 461);
	m_wndBNTYC.Create(this, _T("BN TYC"), 9, 467, 99, 492);
	m_wndKBNTYC.Create(this, _T("Bỏ BN TYC"), 104, 467, 194, 492);
	m_wndGiamDau.Create(this, _T("Gói giảm đau"), 199, 467, 319, 492);
	m_wndExport.Create(this, _T("&ExportXLS"), 404, 497, 504, 522);
	m_wndDichvu_TYC.Create(this, _T("Dichvu_TYC"), 9, 497, 319, 522);
