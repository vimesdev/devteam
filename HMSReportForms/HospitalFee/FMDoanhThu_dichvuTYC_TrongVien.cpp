#include "stdafx.h"
#include "FMDoanhThu_dichvuTYC_TrongVien.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDoanhThudicvuTYCTrongVien* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMDoanhThudicvuTYCTrongVien *pVw = (CFMDoanhThudicvuTYCTrongVien *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMDoanhThudicvuTYCTrongVien*)pWnd)->OnDeptListUnCheckAll();
}
CFMDoanhThudicvuTYCTrongVien::CFMDoanhThudicvuTYCTrongVien(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMDoanhThudicvuTYCTrongVien::~CFMDoanhThudicvuTYCTrongVien(){
}
void CFMDoanhThudicvuTYCTrongVien::OnCreateComponents(){
...
void CFMDoanhThudicvuTYCTrongVien::OnInitializeComponents(){
...
void CFMDoanhThudicvuTYCTrongVien::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDoanhThudicvuTYCTrongVien::OnDoDataExchange(CDataExchange* pDX){
...
void CFMDoanhThudicvuTYCTrongVien::SetDefaultValues(){
...
int CFMDoanhThudicvuTYCTrongVien::SetMode(int nMode){
...
/*void CFMDoanhThudicvuTYCTrongVien::OnYearChange(){
	
} */
/*void CFMDoanhThudicvuTYCTrongVien::OnYearSetfocus(){
	
} */
/*void CFMDoanhThudicvuTYCTrongVien::OnYearKillfocus(){
	
} */
int CFMDoanhThudicvuTYCTrongVien::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMDoanhThudicvuTYCTrongVien::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMDoanhThudicvuTYCTrongVien::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMDoanhThudicvuTYCTrongVien::OnReportPeriodSetfocus(){
	
}*/
/*void CFMDoanhThudicvuTYCTrongVien::OnReportPeriodKillfocus(){
	
}*/
long CFMDoanhThudicvuTYCTrongVien::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMDoanhThudicvuTYCTrongVien::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMDoanhThudicvuTYCTrongVien::OnFromDateChange(){
	
} */
/*void CFMDoanhThudicvuTYCTrongVien::OnFromDateSetfocus(){
	
} */
/*void CFMDoanhThudicvuTYCTrongVien::OnFromDateKillfocus(){
	
} */
int CFMDoanhThudicvuTYCTrongVien::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMDoanhThudicvuTYCTrongVien::OnToDateChange(){
	
} */
/*void CFMDoanhThudicvuTYCTrongVien::OnToDateSetfocus(){
	
} */
/*void CFMDoanhThudicvuTYCTrongVien::OnToDateKillfocus(){
	
} */
int CFMDoanhThudicvuTYCTrongVien::OnToDateCheckValue(){
	return 0;
}
 
void CFMDoanhThudicvuTYCTrongVien::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMDoanhThudicvuTYCTrongVien::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMDoanhThudicvuTYCTrongVien::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
void CFMDoanhThudicvuTYCTrongVien::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDoanhThudicvuTYCTrongVien::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDoanhThudicvuTYCTrongVien::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMDoanhThudicvuTYCTrongVien::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMDoanhThudicvuTYCTrongVien::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMDoanhThudicvuTYCTrongVien::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMDoanhThudicvuTYCTrongVien::OnObjectListDblClick(){
	
}
 
void CFMDoanhThudicvuTYCTrongVien::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMDoanhThudicvuTYCTrongVien::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMDoanhThudicvuTYCTrongVien::OnObjectListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CFMDoanhThudicvuTYCTrongVien::OnDeptListDblClick(){
	
}
 
void CFMDoanhThudicvuTYCTrongVien::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMDoanhThudicvuTYCTrongVien::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMDoanhThudicvuTYCTrongVien::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMDoanhThudicvuTYCTrongVien::GetQueryString()
{
	...
	if (!m_szCondition.IsEmpty())
		...
		_T(" WHERE ") \
		_T(" fe.hfe_category <> 'Y'") \
		_T(" AND fe.hfe_deptid   <> 'PTTYC'") \
		_T(" AND fe.hfe_itemid   IN") \
		_T("   (") \
		_T("   SELECT hfl_feeid FROM hms_fee_list WHERE NVL(hfl_tyc,'XXX') ='TYC'") \
		_T("   )") \
		...
		_T("   ivf.hfe_date"), m_szFromDate, m_szToDate, szWhere);

	//_msg(_T("%s"),szSQL);
	return szSQL;
}

CString CFMDoanhThudicvuTYCTrongVien::GetQueryString1()
{
...
int CFMDoanhThudicvuTYCTrongVien::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMDoanhThudicvuTYCTrongVien::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMDoanhThudicvuTYCTrongVien::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMDoanhThudicvuTYCTrongVien::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
