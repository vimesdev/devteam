#include "stdafx.h"
#include "FMTotalIncomeByDoctor_UT.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel)
{
	((CFMTotalInComeByDoctorUT* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByDoctorUT* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByDoctorUT* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByDoctorUT* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMTotalInComeByDoctorUT*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorUT*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorUT*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMTotalInComeByDoctorUT*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorUT*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMTotalInComeByDoctorUT *pVw = (CFMTotalInComeByDoctorUT *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorUT*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorUT*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorUT*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorUT*)pWnd)->OnAllSelect();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorUT*)pWnd)->OnSODSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorUT*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorUT*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorUT*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorUT*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorUT*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMTotalInComeByDoctorUT*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorUT*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorUT*)pWnd)->OnListCheckAllTYC();
	return 0;
}

static long _OnDoctorLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnDoctorLoadData();
}
static long _OnRoomLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalInComeByDoctorUT *)pWnd)->OnRoomLoadData();
}
static int _OnListCheckAllBHABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorUT*)pWnd)->OnListCheckAllBHAB();
	return 0;
}
static int _OnListCheckAllDVABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorUT*)pWnd)->OnListCheckAllDVAB();
	return 0;
}

static int _OnListCheckAllQUANABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorUT*)pWnd)->OnListCheckAllQUANAB();
	return 0;
}
...
{
	 ((CFMTotalInComeByDoctorUT*)pWnd)->OnSoldierSelect();
}



CFMTotalInComeByDoctorUT::CFMTotalInComeByDoctorUT(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMTotalInComeByDoctorUT::~CFMTotalInComeByDoctorUT(){
}

void CFMTotalInComeByDoctorUT::OnCreateComponents()
{
	...
	m_wndAll.Create(this, _T("All"), 231, 504, 336, 529);
	m_wndSOD.Create(this, _T("SOD"), 371, 504, 476, 529);*/
	m_wndReportCondition.Create(this, _T("Report Condition"), 6, 5, 480, 535);
	m_wndYearLabel.Create(this, _T("Year"), 10, 29, 90, 54);
	m_wndYear.Create(this,95, 29, 225, 54); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 240, 29, 331, 54);
...
void CFMTotalInComeByDoctorUT::OnInitializeComponents(){
...
void CFMTotalInComeByDoctorUT::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByDoctorUT::OnDoDataExchange(CDataExchange* pDX){
...
void CFMTotalInComeByDoctorUT::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMTotalInComeByDoctorUT::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMTotalInComeByDoctorUT::SetDefaultValues(){
...
int CFMTotalInComeByDoctorUT::SetMode(int nMode){
...
/*void CFMTotalInComeByDoctorUT::OnYearChange(){
	
} */
/*void CFMTotalInComeByDoctorUT::OnYearSetfocus(){
	
} */
/*void CFMTotalInComeByDoctorUT::OnYearKillfocus(){
	
} */
int CFMTotalInComeByDoctorUT::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMTotalInComeByDoctorUT::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMTotalInComeByDoctorUT::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMTotalInComeByDoctorUT::OnReportPeriodSetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorUT::OnReportPeriodKillfocus(){
	
}*/
long CFMTotalInComeByDoctorUT::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMTotalInComeByDoctorUT::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMTotalInComeByDoctorUT::OnFromDateChange(){
	
} */
/*void CFMTotalInComeByDoctorUT::OnFromDateSetfocus(){
	
} */
/*void CFMTotalInComeByDoctorUT::OnFromDateKillfocus(){
	
} */
int CFMTotalInComeByDoctorUT::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMTotalInComeByDoctorUT::OnToDateChange(){
	
} */
/*void CFMTotalInComeByDoctorUT::OnToDateSetfocus(){
	
} */
/*void CFMTotalInComeByDoctorUT::OnToDateKillfocus(){
	
} */
int CFMTotalInComeByDoctorUT::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMTotalInComeByDoctorUT::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByDoctorUT::OnClerkSelendok(){
	 
}
int CFMTotalInComeByDoctorUT::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMTotalInComeByDoctorUT::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByDoctorUT::OnListCheckAllBHAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByDoctorUT::OnListCheckAllDVAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByDoctorUT::OnListCheckAllQUANAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMTotalInComeByDoctorUT::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}

/*void CFMTotalInComeByDoctorUT::OnClerkSetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorUT::OnClerkKillfocus(){
	
}*/
long CFMTotalInComeByDoctorUT::OnDoctorLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
long CFMTotalInComeByDoctorUT::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return 0;
}

/*void CFMTotalInComeByDoctorUT::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalInComeByDoctorUT::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByDoctorUT::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMTotalInComeByDoctorUT::OnStatusSetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorUT::OnStatusKillfocus(){
	
}*/
long CFMTotalInComeByDoctorUT::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalInComeByDoctorUT::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalInComeByDoctorUT::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByDoctorUT::OnOrderBySelendok(){
	 
}
/*void CFMTotalInComeByDoctorUT::OnOrderBySetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorUT::OnOrderByKillfocus(){
	
}*/
long CFMTotalInComeByDoctorUT::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalInComeByDoctorUT::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
long CFMTotalInComeByDoctorUT::OnRoomLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
long CFMTotalInComeByDoctorUT::OnDeptLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMTotalInComeByDoctorUT::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMTotalInComeByDoctorUT::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMTotalInComeByDoctorUT::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMTotalInComeByDoctorUT::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMTotalInComeByDoctorUT::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMTotalInComeByDoctorUT::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
	for( i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, TRUE);
	_msg(_T("Tổng số phiếu thu chi = %d"), i);
} 
void CFMTotalInComeByDoctorUT::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, FALSE);
}

void CFMTotalInComeByDoctorUT::OnInpatientSelect(){
	
}
void CFMTotalInComeByDoctorUT::OnOutpatientSelect(){
	
}
void CFMTotalInComeByDoctorUT::OnDepositSelect(){
	
}
void CFMTotalInComeByDoctorUT::OnAllSelect(){
	
}
 
void CFMTotalInComeByDoctorUT::OnSODSelect(){
	OnListLoadData();
}
void CFMTotalInComeByDoctorUT::OnSoldierSelect()
{
	OnListLoadData();
}
 
int CFMTotalInComeByDoctorUT::OnAddFMInsuranceReceiptSummary(){
...
int CFMTotalInComeByDoctorUT::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMTotalInComeByDoctorUT::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMTotalInComeByDoctorUT::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMTotalInComeByDoctorUT::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMTotalInComeByDoctorUT::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMTotalInComeByDoctorUT::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return;
	UpdateData(TRUE);
...
void CFMTotalInComeByDoctorUT::OnPrint1stver()
{
	return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
...
void CFMTotalInComeByDoctorUT::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMTotalInComeByDoctorUT"));
...
void CFMTotalInComeByDoctorUT::OnExportSelect()
{
	...
	TranslateString(_T("Export chi tiết doanh thu PK ung thư"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 1, tmpStr);
	TranslateString(_T("Export tổng hợp doanh thu PK ung thư"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 2, tmpStr);	
...
void CFMTotalInComeByDoctorUT::OnExportDetail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI_PK_UNGTHU.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI_PK_UNGTHU2.xls"));
}
void CFMTotalInComeByDoctorUT::OnExportTotal()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI_TONGHOP_PK_UNGTHU.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI_TONGHOP_PK_UNGTHU2.xls"));
}

void CFMTotalInComeByDoctorUT::OnPrint2ndver_(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
int CFMTotalInComeByDoctorUT::OnCheckBeforePrint(CReport* rpt, CRecord& rs){
	CString szSQL;
	szSQL = GetQueryString();
...
void CFMTotalInComeByDoctorUT::OnPrintOther(CReport* rpt){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByDoctorUT::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	//return;
...
void CFMTotalInComeByDoctorUT::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept){
	//return;
	CString tmpStr, szLabel;
	rs->GetValue(_T("posted_date"), tmpStr);
	bNewDate = tmpStr==m_szPrevDate?false:true;
...
void CFMTotalInComeByDoctorUT::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept, CReportSection* pDateGroup, CReportSection* pDeptGroup){
	//return;
...
void CFMTotalInComeByDoctorUT::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept){
	//return;
	CReportSection* rptGrp = NULL;
	CString szPos;
	if (bNewDept && m_nDeptSum[12] > 0){
...
void CFMTotalInComeByDoctorUT::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByDoctorUT::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReportSection* rptGroup = NULL;
	CString tmpStr;
	if (bNewDate){
...
void CFMTotalInComeByDoctorUT::OnPrintDetail(CReport* rpt, CRecord* rs)
{
...
void CFMTotalInComeByDoctorUT::OnPrintDetail(CReport* rpt, CReportSection* ppDetail, CRecord* rs){
...
void CFMTotalInComeByDoctorUT::OnCalcData(CRecord* rs, bool& bNewDate, bool& bNewDept)
{
	double nTmp = 0;
	for (int i = 0; i < 18; i++){
...
void CFMTotalInComeByDoctorUT::ResetVar(){
	for (int i = 0; i < 18; i++){
		m_nTotal[i] = 0;
		m_nDeptSum[i] = 0;
		m_nDaySum[i] = 0;
...
CString CFMTotalInComeByDoctorUT::GetQueryStringDetail()
{
	...
	if (!m_szDeptKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND dept_id = '%s'"), m_szDeptKey);	
			...
			_T("   GET_USERNAME(doctor)||'['||doctor||']'||'['||GET_DEPTNAME(doctor)||'] '||'['||roomname||']'											  AS doctorname, dept_id, roomid,") \
			...
			_T("   SUM(tienthuoc_vattu)                                                                                          AS tienthuoc_vattu,") \
			_T("   SUM(tien_xn+tien_cdha+tien_tdcn+tien_noi_soi+tien_pttt+tien_phikhac+tien_xn_mau+tienmau+tienthuoc_vattu)                      AS cong,") \
			_T("   SUM(tien_kham_dv+tien_kham_bh+tien_xn+tien_cdha+tien_tdcn+tien_noi_soi+tien_pttt+tien_phikhac+tien_xn_mau+tienmau+tienthuoc_vattu) AS tongcong") \
			_T(" FROM") \
			_T("   (SELECT Get_patientname(i.hfe_docno) AS patname,") \
			_T("     i.hfe_docno                        AS docno,") \
			_T("     doctor,roomname,dept_id, roomid,") \
			_T("     tien_kham_dv,") \
			_T("     tien_kham_bh,") \
			_T("     tien_xn,") \
			_T("     tien_cdha,") \
			...
			_T("      (SELECT hrl_name from hms_roomlist where hrl_deptid=hpo_deptid and hrl_id=hpo_roomid) as roomname, hpo_roomid as roomid,") \
			_T("       0 tien_kham_dv,") \
			_T("       0 tien_kham_bh,") \
			_T("       0 tien_xn,") \
			_T("       0 tien_cdha,") \
			...
			_T("       0 tien_phikhac,") \
			_T("       0 AS tienmau,") \
			_T("       hfe_cost AS tienthuoc_vattu") \
			_T("     FROM hms_fee") \
			...
			_T("     AND mp_org_id         in  ('PM' ,'MA') ") \
			_T("     AND hfe_category='N' ") \
			_T("     UNION ALL") \
			_T("     SELECT hfe_docno,") \
			_T("       hfe_invoiceno,") \
			_T("       hfe_deptid dept_id,") \
			_T("       NULL AS doctor, NULL as roomname, hpo_roomid as roomid,") \
			_T("       0 tien_kham_dv,") \
			_T("       0 tien_kham_bh,") \
			_T("       0 tien_xn,") \
			_T("       0 tien_cdha,") \
			...
			_T("        CASE") \
			_T("         WHEN hfe_type = 'E'") \
			_T("         THEN (SELECT hrl_name from hms_roomlist where hrl_deptid=he_deptid and hrl_id=he_roomid) ") \
			_T("         ELSE") \
			_T("           CASE") \
			_T("             WHEN hfe_type IN ('P', 'T')") \
			_T("             THEN (SELECT hrl_name from hms_roomlist where hrl_deptid=hpc_deptid and hrl_id=hpc_roomid) ") \
			_T("             ELSE (SELECT hrl_name from hms_roomlist where hrl_deptid=ho_deptid and hrl_id=ho_roomid)") \
			_T("           END") \
			_T("       END roomname, CASE WHEN hfe_type = 'E' THEN he_roomid ELSE CASE WHEN hfe_type IN ('P', 'T') THEN hpc_roomid ELSE ho_roomid END END roomid,") \
			_T("       CASE") \
			_T("         WHEN hfe_type = 'E'") \
			_T("         AND Hfe_Object=7") \
			_T("         THEN hfe_cost") \
			...
			_T("       CASE") \
			_T("         WHEN hfe_type  = 'E'") \
			_T("         AND Hfe_Object not in (1,3,7,8,13)") \
			_T("         THEN hfe_cost") \
			_T("         ELSE 0") \
			_T("       END tien_kham_bh,") \
			_T("       CASE") \
			_T("         WHEN hfe_type           IN ('T', 'P')") \
			_T("         AND SUBSTR(hfe_group,1,2)='B1'") \
			_T("         AND hfe_group           <> 'B1G00'") \
			_T("         THEN hfe_cost") \
			_T("         ELSE 0") \
			_T("       END tien_xn,") \
			_T("       CASE") \
			...
			_T("     WHERE hfe_type     IN ('E', 'T', 'P', 'O','X')") \
			_T("     AND hfe_status NOT IN ('O', 'C')") \
			_T("     AND hfe_category='N' ") \
			_T("     ) f ON (f.hfe_docno   = i.hfe_docno") \
			_T("   AND f.hfe_invoiceno     = i.hfe_invoiceno) AND ((dept_id='TYC' AND roomid =69) OR (dept_id='TTTVDT' AND roomid =1))") \
			_T("     %s") \
			_T("   )tbl") \
			_T(" GROUP BY doctor,dept_id, roomname,roomid,") \
			_T("   patname,") \
			_T("   docno") \
			_T("     ORDER BY doctor,roomname"), szWhere);
			//_msg(_T("%s"),szSQL);
			return szSQL;	
}
double CFMTotalInComeByDoctorUT::OnRound(double nToRound){
	nToRound += 0.5;
	return floor(nToRound);
}

CString CFMTotalInComeByDoctorUT::GetQueryStringTotal()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	if (!m_szDeptKey.IsEmpty())
		...
		_T("   GET_USERNAME(doctor)||'['||doctor||']'||'['||GET_DEPTNAME(doctor)||'] '														  AS doctorname,") \
		_T("   GET_DEPTNAME(doctor)||'['||roomname||']'																							  AS doctordept,") \
		_T("   doctor                                                                                                                   AS doctor,") \
		_T("   dept_id,examroom_doctor,                                                                                                                 ") \
		_T("(SELECT HMS_GETROOMNAME(GET_DEPTNAME(doctor),examroom_doctor) from dual) as roomname1, ") \
		_T(" roomname,") \
		...
		_T(" FROM") \
		_T("   (SELECT ") \
		_T("     doctor,dept_id,examroom_doctor,roomname,") \
		_T("     soluong_kham_dv,") \
		_T("     soluong_kham_bh,") \
		_T("     tien_kham_dv,") \
		_T("     tien_kham_bh,") \
		...
		_T("       hfe_invoiceno,") \
		_T("       hfe_deptid dept_id,") \
		_T("       NULL AS doctor,NULL AS examroom_doctor,NULL AS roomname, ") \
		_T("       0 as soluong_kham_dv,") \
		_T("       0 as soluong_kham_bh,") \
		_T("       0 tien_kham_dv,") \
		_T("       0 tien_kham_bh,") \
		...
		_T("     AND hfe_category    ='N'") \
		_T("     ) f ON (f.hfe_docno = i.hfe_docno") \
		_T("   AND f.hfe_invoiceno   = i.hfe_invoiceno) AND ((dept_id='TYC' AND examroom_doctor =69) OR (dept_id='TTTVDT' AND examroom_doctor =1))") \
		_T("   %s") \
		_T("   )tbl") \
		_T(" GROUP BY doctor, dept_id,examroom_doctor,roomname ") \
		_T("     ORDER BY doctor, examroom_doctor,roomname"), szWhere);
		//_msg(_T("%s"),szSQL);
		return szSQL;	
}
CString CFMTotalInComeByDoctorUT::GetQueryString()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	return szSQL;	
