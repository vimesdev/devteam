#ifndef FMSOMI131PaidSummary_H
#define FMSOMI131PaidSummary_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMSOMI131PaidSummary : public CGuiView
{
    protected:
...
public:
	...
	CFMSOMI131PaidSummary(CWnd *pWnd);
	~CFMSOMI131PaidSummary();
