#ifndef FMDEPOSITPATIENTLIST_H
#define FMDEPOSITPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDepositPatientList : public CGuiView{
protected:
public:
	...
	void			OnLockedSelect(); 
	CFMDepositPatientList(CWnd* pParent);
	~CFMDepositPatientList();
	...
	int OnAddFMDepositPatientList();
	int OnEditFMDepositPatientList();
	int OnDeleteFMDepositPatientList(); 
	int OnSaveFMDepositPatientList();
	int OnCancelFMDepositPatientList();
	int OnFMDepositPatientListListLoadData();
