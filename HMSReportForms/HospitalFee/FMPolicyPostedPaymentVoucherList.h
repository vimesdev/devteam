#ifndef FMPolicyPostedPaymentVoucherList_H
#define FMPolicyPostedPaymentVoucherList_H
...
class CFMPolicyPostedPaymentVoucherList : public CGuiView
{
protected:
...
public:
	...
	CFMPolicyPostedPaymentVoucherList(CWnd *pWnd);
	~CFMPolicyPostedPaymentVoucherList();
