#ifndef FMDeleteItemFeeList_H
#define FMDeleteItemFeeList_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDeleteFeePatientList : public CGuiView
{
...
public:
	...
	CFMDeleteFeePatientList(CWnd *pParent);
	~CFMDeleteFeePatientList();
