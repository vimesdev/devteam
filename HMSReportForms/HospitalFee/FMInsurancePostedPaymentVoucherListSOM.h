#ifndef FMInsurancePostedPaymentVoucherListSOM_H
#define FMInsurancePostedPaymentVoucherListSOM_H
...
class CFMInsurancePostedPaymentVoucherListSOM : public CGuiView
{
protected:
...
public:
	...
	CFMInsurancePostedPaymentVoucherListSOM(CWnd *pWnd);
	~CFMInsurancePostedPaymentVoucherListSOM();
