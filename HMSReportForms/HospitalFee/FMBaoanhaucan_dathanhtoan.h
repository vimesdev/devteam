#ifndef FMBAOANHAUCANDACAPAN_H
#define FMBAOANHAUCANDACAPAN_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMBaoanhaucan_dacapan : public CGuiView
{
...
public:
	...
	CFMBaoanhaucan_dacapan(CWnd *pParent);
	~CFMBaoanhaucan_dacapan();
