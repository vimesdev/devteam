#ifndef FMSERVICEINCOMELIST2_H
#define FMSERVICEINCOMELIST2_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceIncomeList2 : public CGuiView
{
...
public:
	...
	void			OnReceiptListSelectChange(int nOldItem, int nNewItem); 
	void			OnReceiptListDblClick(); 
	int			    OnReceiptListDeleteItem(); 
	...
	CFMServiceIncomeList2(CWnd *pParent);
	~CFMServiceIncomeList2();
