#include "stdafx.h"
#include "FMPolicyPostedReceiptVoucherList.h"
#include "HMSMainFrame.h"
#include "StringToken.h"
#include "FMFinancialDocumentPrinter.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptVoucherList* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptVoucherList* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptVoucherList* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedReceiptVoucherList* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList *)pWnd)->OnOrderByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMPolicyPostedReceiptVoucherList *pVw = (CFMPolicyPostedReceiptVoucherList *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static int _OnAddFMInsurancePostedReceiptVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnAddFMInsurancePostedReceiptVoucherList();
} 
static int _OnEditFMInsurancePostedReceiptVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnEditFMInsurancePostedReceiptVoucherList();
} 
static int _OnDeleteFMInsurancePostedReceiptVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnDeleteFMInsurancePostedReceiptVoucherList();
} 
static int _OnSaveFMInsurancePostedReceiptVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnSaveFMInsurancePostedReceiptVoucherList();
} 
static int _OnCancelFMInsurancePostedReceiptVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnCancelFMInsurancePostedReceiptVoucherList();
} 
static void _OnSODSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnSODSelect();
}
static void _OnServicePackageSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnServicePackageSelect();
}
static void _OnBHKhacSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnBHKhacSelect();
}
static void _OnBHQuanSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnBHQuanSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnABZoneSelect();
}
static void _OnATMCardSelectFnc(CWnd *pWnd)
{
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnATMCardSelect();
}

static int _OnListCheckAllCardTYCFnc(CWnd *pWnd){
	((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnListCheckAllCardTYC();
	return 0;
}
static void _OnAllInsSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnAllInsSelect();
}
static void _OnByMoneyTransferSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnByMoneyTransferSelect();
}
static void _OnTCKTSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedReceiptVoucherList*)pWnd)->OnTCKTSelect();
}

CFMPolicyPostedReceiptVoucherList::CFMPolicyPostedReceiptVoucherList(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
...
CFMPolicyPostedReceiptVoucherList::~CFMPolicyPostedReceiptVoucherList()
{
}
void CFMPolicyPostedReceiptVoucherList::OnCreateComponents()
	{
...
void CFMPolicyPostedReceiptVoucherList::OnInitializeComponents(){
...
void CFMPolicyPostedReceiptVoucherList::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPostedReceiptVoucherList::OnDoDataExchange(CDataExchange* pDX){
...
void CFMPolicyPostedReceiptVoucherList::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMPolicyPostedReceiptVoucherList::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMPolicyPostedReceiptVoucherList::SetDefaultValues(){
...
int CFMPolicyPostedReceiptVoucherList::SetMode(int nMode){
...
/*void CFMPolicyPostedReceiptVoucherList::OnYearChange(){
	
} */
/*void CFMPolicyPostedReceiptVoucherList::OnYearSetfocus(){
	
} */
/*void CFMPolicyPostedReceiptVoucherList::OnYearKillfocus(){
	
} */
int CFMPolicyPostedReceiptVoucherList::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMPolicyPostedReceiptVoucherList::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
void CFMPolicyPostedReceiptVoucherList::OnServicePackageSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();		
}

void CFMPolicyPostedReceiptVoucherList::OnTCKTSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
 
void CFMPolicyPostedReceiptVoucherList::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMPolicyPostedReceiptVoucherList::OnReportPeriodSetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptVoucherList::OnReportPeriodKillfocus(){
	
}*/
long CFMPolicyPostedReceiptVoucherList::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMPolicyPostedReceiptVoucherList::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMPolicyPostedReceiptVoucherList::OnFromDateChange(){
	
} */
/*void CFMPolicyPostedReceiptVoucherList::OnFromDateSetfocus(){
	
} */
/*void CFMPolicyPostedReceiptVoucherList::OnFromDateKillfocus(){
	
} */
int CFMPolicyPostedReceiptVoucherList::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMPolicyPostedReceiptVoucherList::OnToDateChange(){
	
} */
/*void CFMPolicyPostedReceiptVoucherList::OnToDateSetfocus(){
	
} */
/*void CFMPolicyPostedReceiptVoucherList::OnToDateKillfocus(){
	
} */
int CFMPolicyPostedReceiptVoucherList::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMPolicyPostedReceiptVoucherList::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedReceiptVoucherList::OnClerkSelendok(){
	 
}
/*void CFMPolicyPostedReceiptVoucherList::OnClerkSetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptVoucherList::OnClerkKillfocus(){
	
}*/
long CFMPolicyPostedReceiptVoucherList::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMPolicyPostedReceiptVoucherList::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedReceiptVoucherList::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedReceiptVoucherList::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMPolicyPostedReceiptVoucherList::OnStatusSetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptVoucherList::OnStatusKillfocus(){
	
}*/
long CFMPolicyPostedReceiptVoucherList::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedReceiptVoucherList::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedReceiptVoucherList::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedReceiptVoucherList::OnOrderBySelendok(){
	 
}
/*void CFMPolicyPostedReceiptVoucherList::OnOrderBySetfocus(){
	
}*/
/*void CFMPolicyPostedReceiptVoucherList::OnOrderByKillfocus(){
	
}*/
long CFMPolicyPostedReceiptVoucherList::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedReceiptVoucherList::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedReceiptVoucherList::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPostedReceiptVoucherList::OnListDblClick(){
...
void CFMPolicyPostedReceiptVoucherList::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMPolicyPostedReceiptVoucherList::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
void CFMPolicyPostedReceiptVoucherList::OnSODSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}

void CFMPolicyPostedReceiptVoucherList::OnABZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	OnListLoadData();
}

void CFMPolicyPostedReceiptVoucherList::OnATMCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	OnListLoadData();
}
void CFMPolicyPostedReceiptVoucherList::OnBHKhacSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPostedReceiptVoucherList::OnAllInsSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
	void CFMPolicyPostedReceiptVoucherList::OnBHQuanSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPostedReceiptVoucherList::OnByMoneyTransferSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
    }
long CFMPolicyPostedReceiptVoucherList::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T("SELECT fac_cash_id as idx, fac_invoiceno descr, fac_user_id as user_id, fac_locked stt, fac_invoicedate, fac_approveddate, fac_posteddate,FAC_CASHBOOK_ID as cashbook_id ") \
...
void CFMPolicyPostedReceiptVoucherList::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMPolicyPostedReceiptVoucherList::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPostedReceiptVoucherList::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	CGuiMenu menu(this);
	CString tmpStr;
...
int CFMPolicyPostedReceiptVoucherList::OnAddFMInsurancePostedReceiptVoucherList(){
...
int CFMPolicyPostedReceiptVoucherList::OnEditFMInsurancePostedReceiptVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMPolicyPostedReceiptVoucherList::OnDeleteFMInsurancePostedReceiptVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMPolicyPostedReceiptVoucherList::OnSaveFMInsurancePostedReceiptVoucherList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMPolicyPostedReceiptVoucherList::OnCancelFMInsurancePostedReceiptVoucherList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMPolicyPostedReceiptVoucherList::OnFMInsurancePostedReceiptVoucherListListLoadData(){
	return 0;
}

void CFMPolicyPostedReceiptVoucherList::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPostedReceiptVoucherList::OnPrint3rdver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	if (m_bABZone)	
	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOTHU_QUANCHINHSACH_1AB.RPT");
	else 
	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOTHU_QUANCHINHSACH_1.RPT");
...
void CFMPolicyPostedReceiptVoucherList::OnPrint4rdver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPostedReceiptVoucherList::OnExportSelect()
{
	/*CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
CString CFMPolicyPostedReceiptVoucherList::GetQueryString3()
{
	...
	if(m_bByMoneyTransfer)
		...
		_T(" FROM V_INSURANCEINCOMESUMMARY3X ") \
	...
	szSQL.Format(_T("SELECT * ") \
		_T(" FROM V_INSURANCEINCOMESUMMARY4X ") \
		_T(" WHERE cash_id > 0 AND (CONG_THU+TONG_VIEN_PHI)>0 AND cash_id not in (187030, 187532, 187248, 187404) %s ") \
		_T(" ORDER BY chindex %s"), szWhere, szOrderBy);
	else
	szSQL.Format(_T("SELECT * ") \
		_T(" FROM V_INSURANCEINCOMESUMMARY2X ") \
		_T(" WHERE cash_id > 0 AND (CONG_THU+TONG_VIEN_PHI)>0 AND cash_id not in (187030, 187532, 187248, 187404) %s ") \
		_T(" ORDER BY chindex %s"), szWhere, szOrderBy);
	return szSQL;
}
CString CFMPolicyPostedReceiptVoucherList::GetQueryString4()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
CString CFMPolicyPostedReceiptVoucherList::GetQueryString()
{
...
CString CFMPolicyPostedReceiptVoucherList::GetQueryString2(){
...
void CFMPolicyPostedReceiptVoucherList::OnPrintFooterUser(CReportSection* rptFooter)
{
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMPolicyPostedReceiptVoucherList::OnPrintSummaryReceipt(double nTotalAmount)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMPolicyPostedReceiptVoucherList::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedReceiptVoucherList::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedReceiptVoucherList::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedReceiptVoucherList::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedReceiptVoucherList::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedReceiptVoucherList::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPostedReceiptVoucherList::OnListCheckAllCardTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMPolicyPostedReceiptVoucherList::OnPrint3rdver_2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPostedReceiptVoucherList::PrintFinancialDocument()
{
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	_T("		SUM(cong-trich_tam_gui-THU_CHINH_SACH-MIEN_GIAM) AS vien_phi,") 
...
CString CFMPolicyPostedReceiptVoucherList::GetQueryString3_2()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
CString CFMPolicyPostedReceiptVoucherList::GetQueryString_check()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
...
void CFMPolicyPostedReceiptVoucherList::OnPrint5rdver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
CString CFMPolicyPostedReceiptVoucherList::GetQueryString5()
{
	CString szSQL, szWhere, szWhere1, szWhere2, szFeeType;
