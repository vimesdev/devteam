#include "stdafx.h"
#include "FMReturnPackageSummary.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMReturnPackageSummary* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMReturnPackageSummary *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMReturnPackageSummary *pVw = (CFMReturnPackageSummary *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMReturnPackageSummary*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMReturnPackageSummary*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMReturnPackageSummary*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMReturnPackageSummary*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMReturnPackageSummary*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMReturnPackageSummary*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMReturnPackageSummary*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMReturnPackageSummary*)pWnd)->OnPackageListLoadData();
}
static void _OnNotIncludeHomeStaySelectFnc(CWnd *pWnd){
	 ((CFMReturnPackageSummary*)pWnd)->OnNotIncludeHomeStaySelect();
}

CFMReturnPackageSummary::CFMReturnPackageSummary(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMReturnPackageSummary::~CFMReturnPackageSummary()
{
}
void CFMReturnPackageSummary::OnCreateComponents()
{
	...
	m_wndReportCondition.Create(this, _T("Report Condition"), 7, 5, 481, 501);
	m_wndYearLabel.Create(this, _T("Year"), 10, 30, 90, 55);
	m_wndYear.Create(this,95, 30, 240, 55); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 250, 30, 330, 55);
	m_wndReportPeriod.Create(this,335, 30, 476, 55); 
	...
	m_wndToDateLabel.Create(this, _T("To Date"), 250, 60, 330, 85);
	m_wndToDate.Create(this,335, 60, 476, 85); 
	m_wndByDate.Create(this, _T("By Date"), 5, 543, 85, 568);
	m_wndByDept.Create(this, _T("By Dept"), 90, 543, 170, 568);
	m_wndInsurance.Create(this, _T("Insurance"), 175, 543, 255, 568);
	m_wndPrint.Create(this, _T("&Print"), 310, 543, 390, 568);
	m_wndExport.Create(this, _T("&Export"), 395, 543, 475, 568);
	m_wndObjectList.Create(this,10, 90, 476, 202); 
	m_wndDeptList.Create(this,11, 206, 477, 352); 
	m_wndPackageList.Create(this,12, 357, 478, 502); 
	m_wndNotIncludeHomeStay.Create(this, _T("Khong tinh goi nha luu tru"), 5, 507, 478, 532);

}
void CFMReturnPackageSummary::OnInitializeComponents(){
...
void CFMReturnPackageSummary::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummary::OnDoDataExchange(CDataExchange* pDX){
...
void CFMReturnPackageSummary::SetDefaultValues(){
...
int CFMReturnPackageSummary::SetMode(int nMode){
...
/*void CFMReturnPackageSummary::OnYearChange(){
	
} */
/*void CFMReturnPackageSummary::OnYearSetfocus(){
	
} */
/*void CFMReturnPackageSummary::OnYearKillfocus(){
	
} */
int CFMReturnPackageSummary::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMReturnPackageSummary::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMReturnPackageSummary::OnNotIncludeHomeStaySelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMReturnPackageSummary::OnReportPeriodSelendok()
{
...
/*void CFMReturnPackageSummary::OnReportPeriodSetfocus(){
	
}*/
/*void CFMReturnPackageSummary::OnReportPeriodKillfocus(){
	
}*/
long CFMReturnPackageSummary::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMReturnPackageSummary::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMReturnPackageSummary::OnFromDateChange(){
	
} */
/*void CFMReturnPackageSummary::OnFromDateSetfocus(){
	
} */
/*void CFMReturnPackageSummary::OnFromDateKillfocus(){
	
} */
int CFMReturnPackageSummary::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMReturnPackageSummary::OnToDateChange(){
	
} */
/*void CFMReturnPackageSummary::OnToDateSetfocus(){
	
} */
/*void CFMReturnPackageSummary::OnToDateKillfocus(){
	
} */
int CFMReturnPackageSummary::OnToDateCheckValue(){
	return 0;
}
 
void CFMReturnPackageSummary::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMReturnPackageSummary::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMReturnPackageSummary::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
long CFMReturnPackageSummary::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMReturnPackageSummary::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_CHIGOI_TH.RPT")))
		return;
...
void CFMReturnPackageSummary::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummary::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMReturnPackageSummary::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMReturnPackageSummary::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMReturnPackageSummary::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMReturnPackageSummary::OnObjectListDblClick(){
	
}
 
void CFMReturnPackageSummary::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMReturnPackageSummary::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMReturnPackageSummary::OnObjectListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CFMReturnPackageSummary::OnDeptListDblClick(){
	
}
 
void CFMReturnPackageSummary::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMReturnPackageSummary::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMReturnPackageSummary::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMReturnPackageSummary::GetQueryString()
{
	...
	if (m_bNotIncludeHomeStay)
	{
		...
		szWhere.AppendFormat(_T(" and rfl.hfe_itemid in (SELECT ss_code FROM sys_sel WHERE ss_id ='HMS_SERVICE_PACKAGE' and NVL(ss_vndesc,'XXXX') <> 'GNLT') "));
	...
	_T("   rfl.hfe_cost    AS refundamount") \
	...
	_T(" ORDER BY itemid"), m_szFromDate, m_szToDate, szWhere, m_szFromDate, m_szToDate, szWhere);
	return szSQL;
}

CString CFMReturnPackageSummary::GetQueryString1()
{
...
int CFMReturnPackageSummary::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMReturnPackageSummary::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMReturnPackageSummary::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMReturnPackageSummary::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
