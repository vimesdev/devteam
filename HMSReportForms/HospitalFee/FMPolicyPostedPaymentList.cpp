#include "stdafx.h"
#include "FMPolicyPostedPaymentList.h"
#include "HMSMainFrame.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentList* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentList* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentList* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnStatusAddNew();
}*/
static void _OnGroupBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPostedPaymentList* )pWnd)->OnGroupBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupBySelendokFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnGroupBySelendok();
}
/*static void _OnGroupBySetfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnGroupByKillfocus();
}*/
/*static void _OnGroupByKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnGroupByKillfocus();
}*/
static long _OnGroupByLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList *)pWnd)->OnGroupByLoadData();
}
/*static void _OnGroupByAddNewFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList *)pWnd)->OnGroupByAddNew();
}*/
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedPaymentList*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPostedPaymentList*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMPolicyPostedPaymentList*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMPolicyPostedPaymentList*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentList*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMPolicyPostedPaymentList *pVw = (CFMPolicyPostedPaymentList *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static int _OnAddFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentList*)pWnd)->OnAddFMInsurancePostedPaymentVoucherList();
} 
static int _OnEditFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentList*)pWnd)->OnEditFMInsurancePostedPaymentVoucherList();
} 
static int _OnDeleteFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentList*)pWnd)->OnDeleteFMInsurancePostedPaymentVoucherList();
} 
static int _OnSaveFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentList*)pWnd)->OnSaveFMInsurancePostedPaymentVoucherList();
} 
static int _OnCancelFMInsurancePostedPaymentVoucherListFnc(CWnd *pWnd){
	 return ((CFMPolicyPostedPaymentList*)pWnd)->OnCancelFMInsurancePostedPaymentVoucherList();
}
static void _OnServicePackageSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPostedPaymentList*)pWnd)->OnServicePackageSelect();
}
static void _OnOtherFeeSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedPaymentList*)pWnd)->OnOtherFeeSelect();
}
static void _OnChichinhsachSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPostedPaymentList*)pWnd)->OnChichinhsachSelect();
}

CFMPolicyPostedPaymentList::CFMPolicyPostedPaymentList(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMPolicyPostedPaymentList::~CFMPolicyPostedPaymentList(){
}
void CFMPolicyPostedPaymentList::OnCreateComponents()
{
	/*m_wndReportCondition.Create(this, _T("Report Condition"), 5, 5, 430, 500);
	...
	m_wndMarkAll.Create(this, _T("Mark All"), 5, 537, 85, 562);
	m_wndUnMark.Create(this, _T("UnMark"), 90, 537, 170, 562);
	m_wndPrint.Create(this, _T("&Print"), 260, 537, 340, 562);
	m_wndExport.Create(this, _T("Export XLS"), 345, 537, 425, 562);
	m_wndServicePackage.Create(this, _T("ServicePackage"), 5, 504, 170, 529);
	m_wndOtherFee.Create(this, _T("OtherFee"), 260, 506, 425, 531);*/
	m_wndReportCondition.Create(this, _T("Report Condition"), 5, 5, 430, 500);
	m_wndYearLabel.Create(this, _T("Year"), 10, 30, 90, 55);
	m_wndYear.Create(this,95, 30, 215, 55); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 220, 30, 300, 55);
	...
	m_wndPrint.Create(this, _T("&Print"), 260, 537, 340, 562);
	m_wndExport.Create(this, _T("Export XLS"), 345, 537, 425, 562);
	m_wndServicePackage.Create(this, _T("ServicePackage"), 5, 504, 101, 529);
	m_wndOtherFee.Create(this, _T("OtherFee"), 165, 504, 253, 529);
	m_wndChichinhsach.Create(this, _T("Chi_chinh_sach"), 297, 504, 423, 529);

}
void CFMPolicyPostedPaymentList::OnInitializeComponents(){
...
void CFMPolicyPostedPaymentList::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
//	m_wndList.AddEvent(1, _T("Delete"), _OnListDeleteItemFnc, 0, VK_DELETE, 0);
	...
	m_wndChichinhsach.SetEvent(WE_CLICK, _OnChichinhsachSelectFnc);
/*
...
void CFMPolicyPostedPaymentList::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndChichinhsach.GetDlgCtrlID(), m_bChichinhsach);

}
void CFMPolicyPostedPaymentList::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMPolicyPostedPaymentList::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMPolicyPostedPaymentList::SetDefaultValues(){
	...
	m_bOtherFee=FALSE;
	m_bChichinhsach=FALSE;

}

int CFMPolicyPostedPaymentList::SetMode(int nMode){
...
/*void CFMPolicyPostedPaymentList::OnYearChange(){
	
} */
/*void CFMPolicyPostedPaymentList::OnYearSetfocus(){
	
} */
/*void CFMPolicyPostedPaymentList::OnYearKillfocus(){
	
} */
int CFMPolicyPostedPaymentList::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMPolicyPostedPaymentList::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMPolicyPostedPaymentList::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMPolicyPostedPaymentList::OnReportPeriodSetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentList::OnReportPeriodKillfocus(){
	
}*/
void CFMPolicyPostedPaymentList::OnChichinhsachSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
long CFMPolicyPostedPaymentList::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMPolicyPostedPaymentList::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMPolicyPostedPaymentList::OnFromDateChange(){
	
} */
/*void CFMPolicyPostedPaymentList::OnFromDateSetfocus(){
	
} */
/*void CFMPolicyPostedPaymentList::OnFromDateKillfocus(){
	
} */
int CFMPolicyPostedPaymentList::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMPolicyPostedPaymentList::OnToDateChange(){
	
} */
/*void CFMPolicyPostedPaymentList::OnToDateSetfocus(){
	
} */
/*void CFMPolicyPostedPaymentList::OnToDateKillfocus(){
	
} */
int CFMPolicyPostedPaymentList::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMPolicyPostedPaymentList::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedPaymentList::OnClerkSelendok(){
	 
}
/*void CFMPolicyPostedPaymentList::OnClerkSetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentList::OnClerkKillfocus(){
	
}*/
long CFMPolicyPostedPaymentList::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMPolicyPostedPaymentList::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedPaymentList::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedPaymentList::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMPolicyPostedPaymentList::OnStatusSetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentList::OnStatusKillfocus(){
	
}*/
long CFMPolicyPostedPaymentList::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedPaymentList::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPostedPaymentList::OnGroupBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPostedPaymentList::OnGroupBySelendok(){
	 
}
/*void CFMPolicyPostedPaymentList::OnGroupBySetfocus(){
	
}*/
/*void CFMPolicyPostedPaymentList::OnGroupByKillfocus(){
	
}*/
long CFMPolicyPostedPaymentList::OnGroupByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPostedPaymentList::OnGroupByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMPolicyPostedPaymentList::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMPolicyPostedPaymentList::OnServicePackageSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMPolicyPostedPaymentList::OnOtherFeeSelect()
	{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPostedPaymentList::OnListDblClick(){
...
void CFMPolicyPostedPaymentList::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMPolicyPostedPaymentList::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMPolicyPostedPaymentList::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMPolicyPostedPaymentList::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPostedPaymentList::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMPolicyPostedPaymentList::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMPolicyPostedPaymentList::OnAddFMInsurancePostedPaymentVoucherList(){
...
int CFMPolicyPostedPaymentList::OnEditFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMPolicyPostedPaymentList::OnDeleteFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMPolicyPostedPaymentList::OnSaveFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMPolicyPostedPaymentList::OnCancelFMInsurancePostedPaymentVoucherList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMPolicyPostedPaymentList::OnFMInsurancePostedPaymentVoucherListListLoadData(){
	return 0;
}


void CFMPolicyPostedPaymentList::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	/*Declaration Section*/
	...
	long double nGroupTotal1[17], nGroupTotal2[17], nGroupTotal3[17];

	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOCHIBNBDCS.RPT");
	if (m_bChichinhsach)
	szReportName = _T("Reports\\HMS\\HF_BANGKECHUNGTUGHISOCHIBNBDCSEX.RPT");
	...
	TCHAR *dat[] = {_T("ngay_dt"),_T("trich_tam_gui"), _T("phi_an"), _T("phi_ranggia"), _T("thu_khac"), _T("thu_goidv"), _T("phai_thu"), 
	...
	while (!rs.IsEOF())
	{
		...
		if (rptDetail)
		{
			...
			rptDetail->SetValue(_T("5"), rs.GetValue(_T("doc_no")));
...
void CFMPolicyPostedPaymentList::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
//Update ngày 15/09/2018 do thay đổi quy trình
/*CString CFMPolicyPostedPaymentList::GetQueryString(){
	...
	if (m_bOtherFee) szWhere.AppendFormat(_T(" HAVING SUM(phai_thu + 0 - phi_an - hfe_packageamount)>0"));
	...
	_T("           SUM(phai_thu + 0 - phi_ranggia - phi_an - hfe_packageamount) thu_khac, ") \
	...
	_T("					  0 phai_thu_,") \
	_T("					  0 phai_thu,") \
	_T("                      0 phi_an, 0 as phi_ranggia, 0 as hfe_packageamount,") \
	_T("					  0 ngay_dt,") \
	...
	_T("					  CASE WHEN l.hfe_itemid IN ('07', '08', '09', '17', '18', '19') THEN l.hfe_cost WHEN r.hfe_type='G' AND r.hfe_class='E' THEN r.hfe_amount ELSE 0 END chi_khac_,") \
	_T("					  0 hfe_freeamount") \
...
CString CFMPolicyPostedPaymentList::GetQueryString()
{
	...
	if (m_bServicePackage) szWhere.AppendFormat(_T(" HAVING SUM(hfe_packageamount)>0"));
	if (m_bOtherFee) szWhere.AppendFormat(_T(" HAVING SUM(phai_thu + 0 - phi_an - hfe_packageamount)>0"));
	if (m_bChichinhsach) szWhere.AppendFormat(_T(" HAVING SUM(chi_luong+chi_an+chi_letet+chi_tem+chi_tauxe+chi_khac+chi_khac_)>0"));
...
CString CFMPolicyPostedPaymentList::GetQueryString2(){
...
void CFMPolicyPostedPaymentList::OnPrintSummaryReceipt(double nTotalAmount)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CReportSection* rptDetail = NULL;
	CString tmpStr, tmpStr2, szReportName;

	szReportName = _T("Reports\\HMS\\HF_PHIEUCHI30BB_THQUAN.RPT");	
	if (m_bChichinhsach)
	szReportName = _T("Reports\\HMS\\HF_PHIEUCHI30BB_THQUANEX.RPT");
	if (!rpt.Init(szReportName))		
		return;
	rptDetail = rpt.AddDetail();
...
void CFMPolicyPostedPaymentList::OnPrintFooterUser(CReportSection* rptFooter){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
