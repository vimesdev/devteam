#include "stdafx.h"
#include "FMDetailPurchaseOrder.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDetailPurchaseOrder *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMDetailPurchaseOrder *)pWnd)->OnToDateCheckValue();
} 
static void _OnSupplierSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDetailPurchaseOrder* )pWnd)->OnSupplierSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSupplierSelendokFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnSupplierSelendok();
}
/*static void _OnSupplierSetfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnSupplierKillfocus();
}*/
/*static void _OnSupplierKillfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnSupplierKillfocus();
}*/
static long _OnSupplierLoadDataFnc(CWnd *pWnd){
	return ((CFMDetailPurchaseOrder *)pWnd)->OnSupplierLoadData();
}
/*static void _OnSupplierAddNewFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnSupplierAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDetailPurchaseOrder* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CFMDetailPurchaseOrder *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnTypeAddNew();
}*/
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDetailPurchaseOrder* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CFMDetailPurchaseOrder *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnStorageAddNew();
}*/
static void _OnItemSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMDetailPurchaseOrder* )pWnd)->OnItemSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemSelendokFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnItemSelendok();
}
/*static void _OnItemSetfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnItemKillfocus();
}*/
/*static void _OnItemKillfocusFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnItemKillfocus();
}*/
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CFMDetailPurchaseOrder *)pWnd)->OnItemLoadData();
}
/*static void _OnItemAddNewFnc(CWnd *pWnd){
	((CFMDetailPurchaseOrder *)pWnd)->OnItemAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMDetailPurchaseOrder *pVw = (CFMDetailPurchaseOrder *)pWnd;
...
static void _OnNonStockFlagSelectFnc(CWnd *pWnd){
	 ((CFMDetailPurchaseOrder*)pWnd)->OnNonStockFlagSelect();
}

CFMDetailPurchaseOrder::CFMDetailPurchaseOrder(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMDetailPurchaseOrder::~CFMDetailPurchaseOrder(){
}
void CFMDetailPurchaseOrder::OnCreateComponents()
{
	...
	m_wndReportCondition.Create(this, _T("Report Condition"), 5, 5, 489, 150);
	m_wndFromDateLabel.Create(this, _T("From Date"), 10, 30, 90, 55);
	m_wndFromDate.Create(this,95, 30, 242, 55); 
	m_wndToDateLabel.Create(this, _T("To Date"), 247, 30, 327, 55);
	m_wndToDate.Create(this,333, 30, 485, 55); 
	m_wndSupplierLabel.Create(this, _T("Supplier"), 10, 60, 90, 85);
	m_wndSupplier.Create(this,95, 60, 485, 85); 
	m_wndTypeLabel.Create(this, _T("Type"), 10, 90, 90, 115);
	m_wndType.Create(this,95, 90, 242, 115); 
	m_wndStorageLabel.Create(this, _T("Storage"), 247, 90, 327, 115);
	m_wndStorage.Create(this,333, 90, 485, 115); 
	m_wndItemLabel.Create(this, _T("Item"), 10, 120, 90, 145);
	m_wndItem.Create(this,95, 120, 485, 145); 
	m_wndPrintPreview.Create(this, _T("Print Pre&view"), 259, 155, 369, 180);
	m_wndExport.Create(this, _T("&Export"), 374, 155, 484, 180);
	m_wndNonStockFlag.Create(this, _T("HÐ không qua kho"), 10, 155, 160, 180);

}
void CFMDetailPurchaseOrder::OnInitializeComponents(){
...
void CFMDetailPurchaseOrder::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CFMDetailPurchaseOrder::OnDoDataExchange(CDataExchange* pDX){
...
void CFMDetailPurchaseOrder::SetDefaultValues(){
...
int CFMDetailPurchaseOrder::SetMode(int nMode){
...
/*void CFMDetailPurchaseOrder::OnFromDateChange(){
	
} */
/*void CFMDetailPurchaseOrder::OnFromDateSetfocus(){
	
} */
/*void CFMDetailPurchaseOrder::OnFromDateKillfocus(){
	
} */

void CFMDetailPurchaseOrder::OnNonStockFlagSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	AfxMessageBox(_T("Khi chọn chức năng này, bạn không cần chọn kho!"));		
}
int CFMDetailPurchaseOrder::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMDetailPurchaseOrder::OnToDateChange(){
	
} */
/*void CFMDetailPurchaseOrder::OnToDateSetfocus(){
	
} */
/*void CFMDetailPurchaseOrder::OnToDateKillfocus(){
	
} */
int CFMDetailPurchaseOrder::OnToDateCheckValue(){
	return 0;
}
 
void CFMDetailPurchaseOrder::OnSupplierSelectChange(int nOldItemSel, int nNewItemSel)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CFMDetailPurchaseOrder::OnSupplierSelendok(){
	 
}

/*void CFMDetailPurchaseOrder::OnSupplierSetfocus(){
	
}*/
/*void CFMDetailPurchaseOrder::OnSupplierKillfocus(){
	
}*/
long CFMDetailPurchaseOrder::OnSupplierLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMDetailPurchaseOrder::OnSupplierAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CFMDetailPurchaseOrder::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CFMDetailPurchaseOrder::OnTypeSelendok(){
	 
}

/*void CFMDetailPurchaseOrder::OnTypeSetfocus(){
	
}*/
/*void CFMDetailPurchaseOrder::OnTypeKillfocus(){
	
}*/
long CFMDetailPurchaseOrder::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CFMDetailPurchaseOrder::OnTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CFMDetailPurchaseOrder::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CFMDetailPurchaseOrder::OnStorageSelendok(){
}

/*void CFMDetailPurchaseOrder::OnStorageSetfocus(){
	
}*/
/*void CFMDetailPurchaseOrder::OnStorageKillfocus(){
	
}*/
long CFMDetailPurchaseOrder::OnStorageLoadData()
{
...
/*void CFMDetailPurchaseOrder::OnStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CFMDetailPurchaseOrder::OnItemSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CFMDetailPurchaseOrder::OnItemSelendok(){
	 
}
/*void CFMDetailPurchaseOrder::OnItemSetfocus(){
	
}*/
/*void CFMDetailPurchaseOrder::OnItemKillfocus(){
	
}*/
long CFMDetailPurchaseOrder::OnItemLoadData(){	
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	UpdateData(true);
...
/*void CFMDetailPurchaseOrder::OnItemAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CFMDetailPurchaseOrder::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CFMDetailPurchaseOrder::OnPrint(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	{
		if(!rpt.Init(_T("Reports/HMS/FM_BANGKENHAPKHOCHITIET.RPT"),true) )
			return;
	}
	else
	{
	...
	while (!rs.IsEOF())
	{
		...
		if (rptDetail)
		{
			...
			rptDetail->SetValue(_T("15"), rs.GetValue(_T("sohopdong")));
			rptDetail->SetValue(_T("16"), rs.GetValue(_T("ngayky")));
		}
		rs.MoveNext();
	}
	if (nTotal > 0)
...
void CFMDetailPurchaseOrder::OnPrintIMP(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CFMDetailPurchaseOrder::OnExportSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	xls.SetCellText(24, 4, _T("Số hóa đơn"), 4098, true);
	...
	while (!rs.IsEOF())
	{
		...
		xls.SetCellText(24, nRow, rs.GetValue(_T("sohoadon")), FMT_TEXT);
...
CString CFMDetailPurchaseOrder::GetQueryString(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	szWhere.AppendFormat(_T(" AND po_org_id = 'PM'"), pMF->GetModuleID());
	...
	szSQL.Format(_T(" SELECT po_approveddate import_date, ") \
				...
				_T(" LEFT JOIN ad_contract_package ON (PO_CONTRACTPKG_ID=adcp_contract_package_id)") \
				...
				_T(" WHERE 1=1 %s") \
				_T(" GROUP BY mp_code, mp_name, mpi_taxprice, po_partner_id, po_approveddate, ") \
				...
				_T("	adcp_quyetdinhpheduyet, adc_contract_no, po_invoiceno,ADC_SIGNEDDATE ") \
				_T(" ORDER BY po_orderno, partner_name, po_approveddate, mp_name"), szWhere);
	//_msg(_T("%s"), szSQL);
	return szSQL;
}
CString CFMDetailPurchaseOrder::GetQueryString72()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL, szWhere, szStorages;
	szWhere.Format(_T(" AND po_status = 'A' AND po_approveddate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') ")
