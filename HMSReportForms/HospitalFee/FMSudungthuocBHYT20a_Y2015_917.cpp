#include "stdafx.h"
#include "FMSudungthuocBHYT20a_Y2015_917.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015_917* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015_917* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnTypeAddNew();
}*/
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015_917* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMSudungthuocBHYT20a_Y2015_917* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnSourceAddNew();
}*/
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917 *)pWnd)->OnItemLoadData();
}
static void _OnDrugPTTTSelectFnc(CWnd *pWnd){
	 ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnDrugPTTTSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnAllSelect();
}
static void _OnInPatientSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnInPatientSelect();
}
static void _OnOutPatientSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnOutPatientSelect();
}
static void _OnOutInDeptSelectFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnOutInDeptSelect();
}
static void _OnOrderBySelectFnc(CWnd *pWnd){
	 ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnOrderBySelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMSudungthuocBHYT20a_Y2015_917 *pVw = (CFMSudungthuocBHYT20a_Y2015_917 *)pWnd;
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnListDeleteItem();
}
static int _OnAddFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnAddFMSudungthuocBHYT20a();
} 
static int _OnEditFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnEditFMSudungthuocBHYT20a();
} 
static int _OnDeleteFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnDeleteFMSudungthuocBHYT20a();
} 
static int _OnSaveFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnSaveFMSudungthuocBHYT20a();
} 
static int _OnCancelFMSudungthuocBHYT20aFnc(CWnd *pWnd){
	 return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnCancelFMSudungthuocBHYT20a();
}

static int _OnListCheckAllFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnListCheckAll();
}
static int _OnListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMSudungthuocBHYT20a_Y2015_917*)pWnd)->OnListUnCheckAll();
}

CFMSudungthuocBHYT20a_Y2015_917::CFMSudungthuocBHYT20a_Y2015_917(CWnd *pParent)
{
	m_nDlgWidth = 460;
	m_nDlgHeight = 495;
	SetDefaultValues();
}
CFMSudungthuocBHYT20a_Y2015_917::~CFMSudungthuocBHYT20a_Y2015_917()
{
}
void CFMSudungthuocBHYT20a_Y2015_917::OnCreateComponents()
{
...
void CFMSudungthuocBHYT20a_Y2015_917::OnInitializeComponents()
{
...
void CFMSudungthuocBHYT20a_Y2015_917::OnSetWindowEvents()
{
...
void CFMSudungthuocBHYT20a_Y2015_917::OnDoDataExchange(CDataExchange* pDX)
{
...
void CFMSudungthuocBHYT20a_Y2015_917::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMSudungthuocBHYT20a_Y2015_917::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMSudungthuocBHYT20a_Y2015_917::SetDefaultValues()
{
	m_szFromDate.Empty();
	m_szToDate.Empty();
	m_szStockKey.Empty();
...
int CFMSudungthuocBHYT20a_Y2015_917::SetMode(int nMode)
{
...
/*void CFMSudungthuocBHYT20a_Y2015_917::OnFromDateChange(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015_917::OnFromDateSetfocus(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015_917::OnFromDateKillfocus(){
	
} */
int CFMSudungthuocBHYT20a_Y2015_917::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMSudungthuocBHYT20a_Y2015_917::OnToDateChange(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015_917::OnToDateSetfocus(){
	
} */
/*void CFMSudungthuocBHYT20a_Y2015_917::OnToDateKillfocus(){
	
} */
int CFMSudungthuocBHYT20a_Y2015_917::OnToDateCheckValue(){
	return 0;
} 
void CFMSudungthuocBHYT20a_Y2015_917::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015_917::OnStockSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015_917::OnStockSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015_917::OnStockKillfocus(){
	
}*/

long CFMSudungthuocBHYT20a_Y2015_917::OnStockLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMSudungthuocBHYT20a_Y2015_917::OnStockAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungthuocBHYT20a_Y2015_917::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015_917::OnTypeSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015_917::OnTypeSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015_917::OnTypeKillfocus(){
	
}*/
long CFMSudungthuocBHYT20a_Y2015_917::OnTypeLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungthuocBHYT20a_Y2015_917::OnTypeAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungthuocBHYT20a_Y2015_917::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015_917::OnGroupSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015_917::OnGroupSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015_917::OnGroupKillfocus(){
	
}*/
long CFMSudungthuocBHYT20a_Y2015_917::OnGroupLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungthuocBHYT20a_Y2015_917::OnGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMSudungthuocBHYT20a_Y2015_917::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMSudungthuocBHYT20a_Y2015_917::OnSourceSelendok(){
	 
}
/*void CFMSudungthuocBHYT20a_Y2015_917::OnSourceSetfocus(){
	
}*/
/*void CFMSudungthuocBHYT20a_Y2015_917::OnSourceKillfocus(){
	
}*/
long CFMSudungthuocBHYT20a_Y2015_917::OnSourceLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMSudungthuocBHYT20a_Y2015_917::OnSourceAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMSudungthuocBHYT20a_Y2015_917::OnItemLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	void CFMSudungthuocBHYT20a_Y2015_917::OnDrugPTTTSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
	void CFMSudungthuocBHYT20a_Y2015_917::OnAllSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
	void CFMSudungthuocBHYT20a_Y2015_917::OnInPatientSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
	void CFMSudungthuocBHYT20a_Y2015_917::OnOutPatientSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
	void CFMSudungthuocBHYT20a_Y2015_917::OnOutInDeptSelect(){
		UpdateData(TRUE);
		OnListLoadData();
	}
void CFMSudungthuocBHYT20a_Y2015_917::OnOrderBySelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

void CFMSudungthuocBHYT20a_Y2015_917::OnPrintPreviewSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	BeginWaitCursor();
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT ma_thuoc,") \
		_T("   genericname,") \
		_T("   ten_thuoc,") \
		_T("   duong_dung,") \
		_T("   ham_luong,") \
		...
		_T("   ON(CAST(mpi_product_item_id AS NVARCHAR2(20)) = ma_thuoc_cs)") \
		...
		_T("   don_gia,") \
		_T("   tyle_tt") \
		_T(" ORDER BY ma_thuoc"), m_szFromDate, m_szToDate);
	_fmsg(_T("%s"), szSQL);
	rs.ExecSQL(szSQL);
	...
	while(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("duong_dung"), tmpStr);
	...
	EndWaitCursor();
	tmpStr.Format(_T("Exports\\20_%s%s_file20.xls"), m_szFromDate.Left(4), m_szFromDate.Mid(5,2));
	xls.Save(tmpStr);
}

void CFMSudungthuocBHYT20a_Y2015_917::OnPrintDetail(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	
}

void CFMSudungthuocBHYT20a_Y2015_917::OnExportSelect()
{	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CExcel xls;
	CRecord rs(&pMF->m_db);
	...
	int nCol = 0, nRow = 0, nItem = 1, nQty = 0;
	double nCost = 0;
	...
	while(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("qtynoi"), tmpStr);
		xls.SetCellText(8, nRow, tmpStr, FMT_INTEGER | FMT_WRAPING);

		rs.GetValue(_T("qtyngoai"), tmpStr);
		...
		nGrpCost += nCost;
		xls.SetCellText(11, nRow, double2str(nCost), FMT_NUMBER1 | FMT_WRAPING);
		nRow++;
		rs.MoveNext();
	}	
...
void CFMSudungthuocBHYT20a_Y2015_917::OnListDblClick(){
	
} 
void CFMSudungthuocBHYT20a_Y2015_917::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMSudungthuocBHYT20a_Y2015_917::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMSudungthuocBHYT20a_Y2015_917::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
int CFMSudungthuocBHYT20a_Y2015_917::OnAddFMSudungthuocBHYT20a(){
...
int CFMSudungthuocBHYT20a_Y2015_917::OnEditFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CFMSudungthuocBHYT20a_Y2015_917::OnDeleteFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CFMSudungthuocBHYT20a_Y2015_917::OnSaveFMSudungthuocBHYT20a(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CFMSudungthuocBHYT20a_Y2015_917::OnCancelFMSudungthuocBHYT20a(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CFMSudungthuocBHYT20a_Y2015_917::OnFMSudungthuocBHYT20aListLoadData(){
	return 0;
}

CString CFMSudungthuocBHYT20a_Y2015_917::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*)AfxGetMainWnd();
	...
	szSQL.Format(_T(" SELECT idx,") \
		...
		_T("     CASE") \
		_T("       WHEN mp_org_id IN ('PM')") \
		_T("       THEN mpei_ma_hoat_chat") \
		_T("       ELSE mp_atccode") \
		_T("     END AS ma_thuoc,") \
		_T("     mpei_hoat_chat,") \
		_T("     CASE") \
		_T("       WHEN LENGTH(mpei_ten_thuoc)>0") \
		_T("       THEN mpei_ten_thuoc") \
		_T("       ELSE mp_name") \
		_T("     END AS tenthuoc,") \
		_T("     mpei_duong_dung,") \
		_T("     mpei_ham_luong,") \
		_T("     mpei_so_dang_ky,") \
		_T("     mpei_don_vi_tinh,") \
		_T("     ROUND(fe.hfe_insprice, 2)      AS price,") \
		_T("     fe.hfe_quantity                AS qtynoi,") \
		_T("     0 AS qtyngoai,") \
		_T("     ROUND(fe.hfe_inspaid, 2)       AS amount") \
		_T("   FROM hms_pharmaorder_view_bh") \
		_T("   LEFT JOIN hms_pharmaorderline_view2_bh") \
		...
		_T("     ROUND(fe.hfe_insprice, 2)                   AS price,") \
		_T("     0 AS qtynoi,") \
		_T("     fe.hfe_quantity                             AS qtyngoai,") \
		_T("     ROUND(fe.hfe_quantity * fe.hfe_insprice, 2) AS amount") \
		...
		_T("   ON( fe.hfe_itemid = product_item_id)") \
		_T("   LEFT JOIN m_product_extra_info") \
		_T("   ON (mpei_id=PRODUCTEXTRA_ID)") \
		_T("   LEFT JOIN hms_object") \
		_T("   ON( fi.hfe_objectid = ho_id )") \
		_T("   LEFT JOIN hms_fee_group") \
		...
		_T("   AND fe.hfe_category <> 'Y'") \
		_T("   AND fe.hfe_type     IN ('D', 'M')") \
		_T("   AND product_org_id  IN ('PM','BB')") \
		_T("   AND fi.hfe_status    = 'P'") \
		...
		_T("   price") \
		_T(" ORDER BY idx,") \
		_T("   tenthuoc"), m_szFromDate, m_szToDate, szWhere, m_szFromDate, m_szToDate, szWhere2, m_szFromDate, m_szToDate, szWhere3);
	_fmsg(_T("%s"), szSQL);
	return szSQL;
}

int CFMSudungthuocBHYT20a_Y2015_917::OnListCheckAll()
{
...
int CFMSudungthuocBHYT20a_Y2015_917::OnListUnCheckAll()
{
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		if (m_wndList.GetCheck(i))
