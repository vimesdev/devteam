#include "stdafx.h"
#include "FMStatisticPaidPatientList2.h"
#include "HMSMainFrame.h"
#include "Excel.h"
#include "ReportDocument.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMStatisticPaidPatientList2 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMStatisticPaidPatientList2 *)pWnd)->OnToDateCheckValue();
} 
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CFMStatisticPaidPatientList2*)pWnd)->OnGroupLoadData();
} 
static void _OnGroupDblClickFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2*)pWnd)->OnGroupDblClick();
} 
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMStatisticPaidPatientList2*)pWnd)->OnGroupSelectChange(nOldItem, nNewItem);
} 
static int _OnGroupDeleteItemFnc(CWnd *pWnd){
	 return ((CFMStatisticPaidPatientList2*)pWnd)->OnGroupDeleteItem();
} 
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CFMStatisticPaidPatientList2*)pWnd)->OnItemLoadData();
} 
static void _OnItemDblClickFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2*)pWnd)->OnItemDblClick();
} 
static void _OnItemSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMStatisticPaidPatientList2*)pWnd)->OnItemSelectChange(nOldItem, nNewItem);
} 
static int _OnItemDeleteItemFnc(CWnd *pWnd){
	 return ((CFMStatisticPaidPatientList2*)pWnd)->OnItemDeleteItem();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMStatisticPaidPatientList2* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMStatisticPaidPatientList2 *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMStatisticPaidPatientList2 *)pWnd)->OnClerkAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CFMStatisticPaidPatientList2 *pVw = (CFMStatisticPaidPatientList2 *)pWnd;
...
static void _OnLockedSelectFnc(CWnd *pWnd){
	 ((CFMStatisticPaidPatientList2*)pWnd)->OnLockedSelect();
}
static int _OnAddFMStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CFMStatisticPaidPatientList2*)pWnd)->OnAddFMStatisticPaidPatientList2();
} 
static int _OnEditFMStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CFMStatisticPaidPatientList2*)pWnd)->OnEditFMStatisticPaidPatientList2();
} 
static int _OnDeleteFMStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CFMStatisticPaidPatientList2*)pWnd)->OnDeleteFMStatisticPaidPatientList2();
} 
static int _OnSaveFMStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CFMStatisticPaidPatientList2*)pWnd)->OnSaveFMStatisticPaidPatientList2();
} 
static int _OnCancelFMStatisticPaidPatientList2Fnc(CWnd *pWnd){
	 return ((CFMStatisticPaidPatientList2*)pWnd)->OnCancelFMStatisticPaidPatientList2();
} 
CFMStatisticPaidPatientList2::CFMStatisticPaidPatientList2(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CFMStatisticPaidPatientList2::~CFMStatisticPaidPatientList2(){
}
void CFMStatisticPaidPatientList2::OnCreateComponents(){
	...
	m_wndLocked.Create(this, L"", 0, 0, 0, 0);
	m_wndLocked.ShowWindow(SW_HIDE);
	m_wndLocked.EnableWindow(FALSE);
}
void CFMStatisticPaidPatientList2::OnInitializeComponents(){
...
void CFMStatisticPaidPatientList2::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMStatisticPaidPatientList2::OnDoDataExchange(CDataExchange* pDX){
...
void CFMStatisticPaidPatientList2::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMStatisticPaidPatientList2::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMStatisticPaidPatientList2::SetDefaultValues(){
...
int CFMStatisticPaidPatientList2::SetMode(int nMode){
...
/*void CFMStatisticPaidPatientList2::OnFromDateChange(){
	
} */
/*void CFMStatisticPaidPatientList2::OnFromDateSetfocus(){
	
} */
/*void CFMStatisticPaidPatientList2::OnFromDateKillfocus(){
	
} */
int CFMStatisticPaidPatientList2::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMStatisticPaidPatientList2::OnToDateChange(){
	
} */
/*void CFMStatisticPaidPatientList2::OnToDateSetfocus(){
	
} */
/*void CFMStatisticPaidPatientList2::OnToDateKillfocus(){
	
} */
int CFMStatisticPaidPatientList2::OnToDateCheckValue(){
	return 0;
} 
void CFMStatisticPaidPatientList2::OnGroupDblClick(){
	
} 
void CFMStatisticPaidPatientList2::OnGroupSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnItemLoadData();

} 
int CFMStatisticPaidPatientList2::OnGroupDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMStatisticPaidPatientList2::OnGroupLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMStatisticPaidPatientList2::OnItemDblClick(){
	
} 
void CFMStatisticPaidPatientList2::OnItemSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMStatisticPaidPatientList2::OnItemDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMStatisticPaidPatientList2::OnItemLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T("SELECT hfl_feeid as id, hfl_name as description ") \
		         _T("FROM hms_fee_list WHERE hfl_groupid IN (%s) AND hfl_active = 'Y'"), szGroups);
...
void CFMStatisticPaidPatientList2::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMStatisticPaidPatientList2::OnClerkSelendok(){
	 
}
/*void CFMStatisticPaidPatientList2::OnClerkSetfocus(){
	
}*/
/*void CFMStatisticPaidPatientList2::OnClerkKillfocus(){
	
}*/
long CFMStatisticPaidPatientList2::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CFMStatisticPaidPatientList2::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMStatisticPaidPatientList2::OnPrintPreviewSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMStatisticPaidPatientList2::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
	void CFMStatisticPaidPatientList2::OnLockedSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
int CFMStatisticPaidPatientList2::OnAddFMStatisticPaidPatientList2(){
...
int CFMStatisticPaidPatientList2::OnEditFMStatisticPaidPatientList2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMStatisticPaidPatientList2::OnDeleteFMStatisticPaidPatientList2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelFMStatisticPaidPatientList2();
 	}
	return 0;
}
int CFMStatisticPaidPatientList2::OnSaveFMStatisticPaidPatientList2(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnFMStatisticPaidPatientList2ListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CFMStatisticPaidPatientList2::OnCancelFMStatisticPaidPatientList2(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMStatisticPaidPatientList2::OnFMStatisticPaidPatientList2ListLoadData(){
	return 0;
}

CString CFMStatisticPaidPatientList2::GetQueryString()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
