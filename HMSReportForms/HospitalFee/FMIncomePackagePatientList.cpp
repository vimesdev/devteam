#include "stdafx.h"
#include "FMIncomePackagePatientList.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMIncomePackagePatientList* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMIncomePackagePatientList *pVw = (CFMIncomePackagePatientList *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackagePatientList*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackagePatientList*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackagePatientList*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackagePatientList*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackagePatientList*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackagePatientList*)pWnd)->OnDeptListUnCheckAll();
}
CFMIncomePackagePatientList::CFMIncomePackagePatientList(CWnd *pParent)
{
...
CFMIncomePackagePatientList::~CFMIncomePackagePatientList(){
}
void CFMIncomePackagePatientList::OnCreateComponents(){
...
void CFMIncomePackagePatientList::OnInitializeComponents(){
...
void CFMIncomePackagePatientList::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackagePatientList::OnDoDataExchange(CDataExchange* pDX){
...
void CFMIncomePackagePatientList::SetDefaultValues(){
...
int CFMIncomePackagePatientList::SetMode(int nMode){
...
/*void CFMIncomePackagePatientList::OnYearChange(){
	
} */
/*void CFMIncomePackagePatientList::OnYearSetfocus(){
	
} */
/*void CFMIncomePackagePatientList::OnYearKillfocus(){
	
} */
int CFMIncomePackagePatientList::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMIncomePackagePatientList::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMIncomePackagePatientList::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMIncomePackagePatientList::OnReportPeriodSetfocus(){
	
}*/
/*void CFMIncomePackagePatientList::OnReportPeriodKillfocus(){
	
}*/
long CFMIncomePackagePatientList::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMIncomePackagePatientList::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMIncomePackagePatientList::OnFromDateChange(){
	
} */
/*void CFMIncomePackagePatientList::OnFromDateSetfocus(){
	
} */
/*void CFMIncomePackagePatientList::OnFromDateKillfocus(){
	
} */
int CFMIncomePackagePatientList::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMIncomePackagePatientList::OnToDateChange(){
	
} */
/*void CFMIncomePackagePatientList::OnToDateSetfocus(){
	
} */
/*void CFMIncomePackagePatientList::OnToDateKillfocus(){
	
} */
int CFMIncomePackagePatientList::OnToDateCheckValue(){
	return 0;
}
 
void CFMIncomePackagePatientList::OnByDateSelect()
{
	m_szCondition = _T("hfe_date");
}
void CFMIncomePackagePatientList::OnByDeptSelect()
{
	m_szCondition = _T("hfe_deptid");
}

void CFMIncomePackagePatientList::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
void CFMIncomePackagePatientList::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_THUGOI.RPT")))
		return;
...
void CFMIncomePackagePatientList::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackagePatientList::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackagePatientList::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackagePatientList::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackagePatientList::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackagePatientList::OnObjectListDblClick(){
	
}
 
void CFMIncomePackagePatientList::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackagePatientList::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackagePatientList::OnObjectListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CFMIncomePackagePatientList::OnDeptListDblClick(){
	
}
 
void CFMIncomePackagePatientList::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackagePatientList::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackagePatientList::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMIncomePackagePatientList::GetQueryString()
{
	...
	//_T("   Get_departmentname(fe.hfe_deptid) dept,") \//
	_T("   ivf.hfe_date receiptdate,") \
	_T("   fe.hfe_desc  AS hfe_desc,fe.hfe_quantity as qty,") \
	...
	_T(" AND fac_posted         = 'Y'") \
	_T(" GROUP BY ivf.hfe_docno, fe.hfe_object, fe.hfe_deptid, fe.hfe_itemid, ivf.hfe_date, fe.hfe_desc,fe.hfe_quantity, fe.hfe_cost") \
	_T(" ORDER BY fe.hfe_deptid,ivf.hfe_date "), m_szFromDate, m_szToDate, szWhere);
	//_msg(_T("%s"),szSQL);
	return szSQL;
}

CString CFMIncomePackagePatientList::GetQueryString1()
{
...
int CFMIncomePackagePatientList::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMIncomePackagePatientList::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMIncomePackagePatientList::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMIncomePackagePatientList::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
