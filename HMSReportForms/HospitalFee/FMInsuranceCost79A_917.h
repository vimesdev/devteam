#ifndef FMInsuranceCost79A_917_H
#define FMInsuranceCost79A_917_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceCost79A_917 : public CGuiView{
protected:
...
public:
	...
	void			OnExportForInsNewOutPatientSelect();
	void			OnExportForInsNew2Select();
	void			OnExportForInsNewOutPatient2Select();
	/*long			OnListLoadData(); 
	...
	CFMInsuranceCost79A_917(CWnd *pParent);
	~CFMInsuranceCost79A_917();
	...
	int OnAddFMInsuranceCost79A_917(); 
	int OnEditFMInsuranceCost79A_917(); 
	int OnDeleteFMInsuranceCost79A_917(); 
	int OnSaveFMInsuranceCost79A_917(); 
	int OnCancelFMInsuranceCost79A_917(); 
	int OnFMInsuranceCost79A_917ListLoadData(); 
	...
	CString GetSQLString1();
	void InsuranceExport3();
