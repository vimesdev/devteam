#ifndef FMINCOMEPACKAGESUMMARYBYDEPTFORINS_H
#define FMINCOMEPACKAGESUMMARYBYDEPTFORINS_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMIncomePackageSummaryByDeptForIns : public CGuiView
{
protected:
...
public:
	...
	CFMIncomePackageSummaryByDeptForIns(CWnd *pParent);
	~CFMIncomePackageSummaryByDeptForIns();
