#ifndef FMINCOMEPACKAGESUMMARYEX_H
#define FMINCOMEPACKAGESUMMARYEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMIncomePackageSummaryEX : public CGuiView
{
...
public:
	...
	CFMIncomePackageSummaryEX(CWnd *pParent);
	~CFMIncomePackageSummaryEX();
