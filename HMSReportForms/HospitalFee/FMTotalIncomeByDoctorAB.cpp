#include "stdafx.h"
#include "FMTotalIncomeByDoctorAB.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel)
{
	((CFMTotalInComeByDoctorAB* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByDoctorAB* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByDoctorAB* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMTotalInComeByDoctorAB* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMTotalInComeByDoctorAB*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMTotalInComeByDoctorAB*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMTotalInComeByDoctorAB*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMTotalInComeByDoctorAB*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorAB*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CFMTotalInComeByDoctorAB *pVw = (CFMTotalInComeByDoctorAB *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorAB*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorAB*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorAB*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorAB*)pWnd)->OnAllSelect();
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMTotalInComeByDoctorAB*)pWnd)->OnSODSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorAB*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorAB*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorAB*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorAB*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMTotalInComeByDoctorAB*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMTotalInComeByDoctorAB*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorAB*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorAB*)pWnd)->OnListCheckAllTYC();
	return 0;
}

static long _OnDoctorLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnDoctorLoadData();
}
static long _OnRoomLoadDataFnc(CWnd *pWnd)
{
	return ((CFMTotalInComeByDoctorAB *)pWnd)->OnRoomLoadData();
}
static int _OnListCheckAllBHABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorAB*)pWnd)->OnListCheckAllBHAB();
	return 0;
}
static int _OnListCheckAllDVABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorAB*)pWnd)->OnListCheckAllDVAB();
	return 0;
}

static int _OnListCheckAllQUANABFnc(CWnd *pWnd)
{
	((CFMTotalInComeByDoctorAB*)pWnd)->OnListCheckAllQUANAB();
	return 0;
}
...
{
	 ((CFMTotalInComeByDoctorAB*)pWnd)->OnSoldierSelect();
}

static void _OnLoadAllSelectFnc(CWnd *pWnd)
{
	 ((CFMTotalInComeByDoctorAB*)pWnd)->OnLoadAllSelect();
}

static void _OnLoadCLCzoneSelectFnc(CWnd *pWnd)
{
	 ((CFMTotalInComeByDoctorAB*)pWnd)->OnLoadCLCzoneSelect();
}


CFMTotalInComeByDoctorAB::CFMTotalInComeByDoctorAB(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMTotalInComeByDoctorAB::~CFMTotalInComeByDoctorAB(){
}

void CFMTotalInComeByDoctorAB::OnCreateComponents()
{
...
void CFMTotalInComeByDoctorAB::OnInitializeComponents(){
...
void CFMTotalInComeByDoctorAB::OnSetWindowEvents()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByDoctorAB::OnDoDataExchange(CDataExchange* pDX){
...
void CFMTotalInComeByDoctorAB::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMTotalInComeByDoctorAB::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMTotalInComeByDoctorAB::SetDefaultValues(){
...
int CFMTotalInComeByDoctorAB::SetMode(int nMode){
...
/*void CFMTotalInComeByDoctorAB::OnYearChange(){
	
} */
/*void CFMTotalInComeByDoctorAB::OnYearSetfocus(){
	
} */
/*void CFMTotalInComeByDoctorAB::OnYearKillfocus(){
	
} */
int CFMTotalInComeByDoctorAB::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMTotalInComeByDoctorAB::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}

	void CFMTotalInComeByDoctorAB::OnLoadAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	OnListLoadData();
}

	void CFMTotalInComeByDoctorAB::OnLoadCLCzoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
 
void CFMTotalInComeByDoctorAB::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMTotalInComeByDoctorAB::OnReportPeriodSetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorAB::OnReportPeriodKillfocus(){
	
}*/
long CFMTotalInComeByDoctorAB::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMTotalInComeByDoctorAB::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMTotalInComeByDoctorAB::OnFromDateChange(){
	
} */
/*void CFMTotalInComeByDoctorAB::OnFromDateSetfocus(){
	
} */
/*void CFMTotalInComeByDoctorAB::OnFromDateKillfocus(){
	
} */
int CFMTotalInComeByDoctorAB::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMTotalInComeByDoctorAB::OnToDateChange(){
	
} */
/*void CFMTotalInComeByDoctorAB::OnToDateSetfocus(){
	
} */
/*void CFMTotalInComeByDoctorAB::OnToDateKillfocus(){
	
} */
int CFMTotalInComeByDoctorAB::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMTotalInComeByDoctorAB::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByDoctorAB::OnClerkSelendok(){
	 
}
int CFMTotalInComeByDoctorAB::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMTotalInComeByDoctorAB::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByDoctorAB::OnListCheckAllBHAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByDoctorAB::OnListCheckAllDVAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMTotalInComeByDoctorAB::OnListCheckAllQUANAB()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMTotalInComeByDoctorAB::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}

/*void CFMTotalInComeByDoctorAB::OnClerkSetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorAB::OnClerkKillfocus(){
	
}*/
long CFMTotalInComeByDoctorAB::OnDoctorLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
long CFMTotalInComeByDoctorAB::OnClerkLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return 0;
}

/*void CFMTotalInComeByDoctorAB::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalInComeByDoctorAB::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByDoctorAB::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMTotalInComeByDoctorAB::OnStatusSetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorAB::OnStatusKillfocus(){
	
}*/
long CFMTotalInComeByDoctorAB::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalInComeByDoctorAB::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMTotalInComeByDoctorAB::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMTotalInComeByDoctorAB::OnOrderBySelendok(){
	 
}
/*void CFMTotalInComeByDoctorAB::OnOrderBySetfocus(){
	
}*/
/*void CFMTotalInComeByDoctorAB::OnOrderByKillfocus(){
	
}*/
long CFMTotalInComeByDoctorAB::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMTotalInComeByDoctorAB::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
long CFMTotalInComeByDoctorAB::OnRoomLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
long CFMTotalInComeByDoctorAB::OnDeptLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMTotalInComeByDoctorAB::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMTotalInComeByDoctorAB::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMTotalInComeByDoctorAB::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMTotalInComeByDoctorAB::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMTotalInComeByDoctorAB::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMTotalInComeByDoctorAB::OnMarkAllSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
	for(i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, TRUE);
	_msg(_T("Tổng số phiếu thu chi = %d"), i);
} 
void CFMTotalInComeByDoctorAB::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++) m_wndList.SetCheck(i, FALSE);
}

void CFMTotalInComeByDoctorAB::OnInpatientSelect(){
	
}
void CFMTotalInComeByDoctorAB::OnOutpatientSelect(){
	
}
void CFMTotalInComeByDoctorAB::OnDepositSelect(){
	
}
void CFMTotalInComeByDoctorAB::OnAllSelect(){
	
}
 
void CFMTotalInComeByDoctorAB::OnSODSelect(){
	OnListLoadData();
}
void CFMTotalInComeByDoctorAB::OnSoldierSelect()
{
	OnListLoadData();
}
 
int CFMTotalInComeByDoctorAB::OnAddFMInsuranceReceiptSummary(){
...
int CFMTotalInComeByDoctorAB::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMTotalInComeByDoctorAB::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMTotalInComeByDoctorAB::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMTotalInComeByDoctorAB::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMTotalInComeByDoctorAB::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "FMInsurancePostedReceiptVoucherList.h"
void CFMTotalInComeByDoctorAB::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	return;
	UpdateData(TRUE);
...
void CFMTotalInComeByDoctorAB::OnPrint1stver()
{
	return;
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
...
void CFMTotalInComeByDoctorAB::OnPrint2ndver()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMTotalInComeByDoctorAB"));
...
void CFMTotalInComeByDoctorAB::OnExportSelect()
{
...
void CFMTotalInComeByDoctorAB::OnExportDetail()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI2.xls"));
}
void CFMTotalInComeByDoctorAB::OnExportTotal()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI_TONGHOP.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BANG_TONG_HOP_DOANH_THU_THEO_BAC_SI_TONGHOP2.xls"));
}

void CFMTotalInComeByDoctorAB::OnPrint2ndver_(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CReport rpt;
...
int CFMTotalInComeByDoctorAB::OnCheckBeforePrint(CReport* rpt, CRecord& rs){
	CString szSQL;
	szSQL = GetQueryString();
...
void CFMTotalInComeByDoctorAB::OnPrintOther(CReport* rpt){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByDoctorAB::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	//return;
...
void CFMTotalInComeByDoctorAB::IsNewGroup(CReport* rpt, CRecord* rs, bool& bNewDate, bool& bNewDept){
	//return;
	CString tmpStr, szLabel;
	rs->GetValue(_T("posted_date"), tmpStr);
	bNewDate = tmpStr==m_szPrevDate?false:true;
...
void CFMTotalInComeByDoctorAB::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept, CReportSection* pDateGroup, CReportSection* pDeptGroup){
	//return;
...
void CFMTotalInComeByDoctorAB::OnPrintGroupSummary(CReport* rpt, bool bNewDate, bool bNewDept){
	//return;
	CReportSection* rptGrp = NULL;
	CString szPos;
	if (bNewDept && m_nDeptSum[12] > 0){
...
void CFMTotalInComeByDoctorAB::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMTotalInComeByDoctorAB::OnPrintGroupDescr(CReport* rpt, CRecord* rs, bool bNewDate, bool bNewDept, CReportSection** ppDateGroup, CReportSection** ppDeptGroup){
	CHMSMainFrame* pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReportSection* rptGroup = NULL;
	CString tmpStr;
	if (bNewDate){
...
void CFMTotalInComeByDoctorAB::OnPrintDetail(CReport* rpt, CRecord* rs)
{
...
void CFMTotalInComeByDoctorAB::OnPrintDetail(CReport* rpt, CReportSection* ppDetail, CRecord* rs){
...
void CFMTotalInComeByDoctorAB::OnCalcData(CRecord* rs, bool& bNewDate, bool& bNewDept)
{
	double nTmp = 0;
	for (int i = 0; i < 18; i++){
...
void CFMTotalInComeByDoctorAB::ResetVar(){
	for (int i = 0; i < 18; i++){
		m_nTotal[i] = 0;
		m_nDeptSum[i] = 0;
		m_nDaySum[i] = 0;
...
CString CFMTotalInComeByDoctorAB::GetQueryStringDetail()
{
	...
	if (!m_szDeptKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND dept_id = '%s'"), m_szDeptKey);	
			...
			_T("   GET_USERNAME(doctor)||'['||doctor||']'||'['||GET_DEPTNAME(doctor)||'] '||'['||roomname||']'											  AS doctorname,") \
			...
			_T("       hfe_invoiceno,") \
			_T("       hfe_deptid dept_id,") \
			_T("       NULL AS doctor, NULL as roomname,") \
			_T("       0 tien_kham_dv,") \
			_T("       0 tien_kham_bh,") \
			_T("       0 tien_xn,") \
			_T("       0 tien_cdha,") \
			...
			_T("     WHERE hfe_type     IN ('E', 'T', 'P', 'O','X','F')") \
			...
			_T("       0 tien_noi_soi,") \
			_T("       0 tien_pttt,") \
			_T("       hfe_patpaid tien_phikhac,") \
			_T("       0 AS tienmau,") \
			_T("       0 AS tienthuoc_vattu") \
			_T("     FROM hms_fee_invoice    ") \
			_T("     WHERE hfe_status     IN ('P','R')") \
			_T("     AND hfe_type in ('O','S') AND Hfe_Serialno='PC'") \
...
double CFMTotalInComeByDoctorAB::OnRound(double nToRound){
	nToRound += 0.5;
	return floor(nToRound);
}

CString CFMTotalInComeByDoctorAB::GetQueryStringTotal()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	...
	if (!m_szDeptKey.IsEmpty())
		...
		_T(" FROM") \
		_T("   (SELECT ") \
		_T("     doctor,examroom_doctor,roomname,") \
		_T("     soluong_kham_dv,") \
		_T("     soluong_kham_bh,") \
		_T("     tien_kham_dv,") \
		_T("     tien_kham_bh,") \
		...
		_T("   %s") \
		_T("   )tbl") \
		_T(" GROUP BY doctor, examroom_doctor,roomname ") \
		_T("     ORDER BY doctor, examroom_doctor,roomname"), szWhere);
		//_msg(_T("%s"),szSQL);
		return szSQL;	
}
CString CFMTotalInComeByDoctorAB::GetQueryString()
{
	CString szSQL, szWhere, szWhere1, szWhere2;
	CString szOrderBy, szReceiptStr;
	return szSQL;	
