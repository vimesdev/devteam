#ifndef FMTESTCOVID19NGUOINHADATHANHTOAN_H
#define FMTESTCOVID19NGUOINHADATHANHTOAN_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTestCovid19Nguoinha_dathanhtoanReport : public CGuiView
{
protected:
public:
	...
	CGuiCheckBox	m_wndChitinhphongkhamxnnn;
	CGuiCheckBox	m_wndNguoinhakobenhnhan;
	...
	BOOL	m_bChitinhphongkhamxnnn;
	BOOL	m_bNguoinhakobenhnhan;
	...
	void			OnNoitruSelect(); 
	void			OnChitinhphongkhamxnnnSelect();
	void			OnNguoinhakobenhnhanSelect();
	CFMTestCovid19Nguoinha_dathanhtoanReport(CWnd* pParent);
	~CFMTestCovid19Nguoinha_dathanhtoanReport();
