#include "stdafx.h"
#include "FMHMSFoodReportHCKT.h"
#include "HMSMainFrame.h"
#include "Excel.h"
#include "StringToken.h"
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMHMSFoodReportHCKT* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMHMSFoodReportHCKT *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnDeptAddNew();
}*/
static void _OnRelationorSelectFnc(CWnd *pWnd){
	 ((CFMHMSFoodReportHCKT*)pWnd)->OnRelationorSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMHMSFoodReportHCKT *pVw = (CFMHMSFoodReportHCKT *)pWnd;
	pVw->OnPrintSelect();
} 
...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMHMSFoodReportHCKT *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMHMSFoodReportHCKT *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMHMSFoodReportHCKT *)pWnd)->OnToDateCheckValue();
} 
static int _OnAddHMSFoodReportHCKTFnc(CWnd *pWnd){
	 return ((CFMHMSFoodReportHCKT*)pWnd)->OnAddHMSFoodReportHCKT();
} 
static int _OnEditHMSFoodReportHCKTFnc(CWnd *pWnd){
	 return ((CFMHMSFoodReportHCKT*)pWnd)->OnEditHMSFoodReportHCKT();
} 
static int _OnDeleteHMSFoodReportHCKTFnc(CWnd *pWnd){
	 return ((CFMHMSFoodReportHCKT*)pWnd)->OnDeleteHMSFoodReportHCKT();
} 
static int _OnSaveHMSFoodReportHCKTFnc(CWnd *pWnd){
	 return ((CFMHMSFoodReportHCKT*)pWnd)->OnSaveHMSFoodReportHCKT();
} 
static int _OnCancelHMSFoodReportHCKTFnc(CWnd *pWnd){
	 return ((CFMHMSFoodReportHCKT*)pWnd)->OnCancelHMSFoodReportHCKT();
} 
CFMHMSFoodReportHCKT::CFMHMSFoodReportHCKT(CWnd *pParent)
{
...
CFMHMSFoodReportHCKT::~CFMHMSFoodReportHCKT(){
}
void CFMHMSFoodReportHCKT::OnCreateComponents()
{
	...
	m_wndRelationor.Create(this, _T("Người nhà"), 19, 96, 109, 121);
	//m_wndPrint.Create(this, _T("&Print"), 299, 96, 379, 121);
	m_wndPrint.Create(this, _T("&Print"), 0, 0, 0, 0);
	m_wndExport.Create(this, _T("&ExportXLS"), 384, 96, 464, 121);
...
void CFMHMSFoodReportHCKT::OnInitializeComponents()
{
...
void CFMHMSFoodReportHCKT::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMHMSFoodReportHCKT::OnDoDataExchange(CDataExchange* pDX){
...
void CFMHMSFoodReportHCKT::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CFMHMSFoodReportHCKT::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMHMSFoodReportHCKT::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMHMSFoodReportHCKT::SetDefaultValues(){
...
int CFMHMSFoodReportHCKT::SetMode(int nMode){
...
void CFMHMSFoodReportHCKT::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMHMSFoodReportHCKT::OnDeptSelendok(){
	 
}
/*void CFMHMSFoodReportHCKT::OnDeptSetfocus(){
	
}*/
/*void CFMHMSFoodReportHCKT::OnDeptKillfocus(){
	
}*/
long CFMHMSFoodReportHCKT::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
...
/*void CFMHMSFoodReportHCKT::OnDeptAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
	void CFMHMSFoodReportHCKT::OnRelationorSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMHMSFoodReportHCKT::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMHMSFoodReportHCKT::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bRelationor)
		OnExportRelationor();
...
/*void CFMHMSFoodReportHCKT::OnFromDateChange(){
	
} */
/*void CFMHMSFoodReportHCKT::OnFromDateSetfocus(){
	
} */
/*void CFMHMSFoodReportHCKT::OnFromDateKillfocus(){
	
} */
int CFMHMSFoodReportHCKT::OnFromDateCheckValue(){
	return 0;
} 
/*void CFMHMSFoodReportHCKT::OnToDateChange(){
	
} */
/*void CFMHMSFoodReportHCKT::OnToDateSetfocus(){
	
} */
/*void CFMHMSFoodReportHCKT::OnToDateKillfocus(){
	
} */
int CFMHMSFoodReportHCKT::OnToDateCheckValue(){
	return 0;
} 
int CFMHMSFoodReportHCKT::OnAddHMSFoodReportHCKT(){
...
int CFMHMSFoodReportHCKT::OnEditHMSFoodReportHCKT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMHMSFoodReportHCKT::OnDeleteHMSFoodReportHCKT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMHMSFoodReportHCKT::OnSaveHMSFoodReportHCKT(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMHMSFoodReportHCKT::OnCancelHMSFoodReportHCKT(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMHMSFoodReportHCKT::OnHMSFoodReportHCKTListLoadData(){
	return 0;
}

void CFMHMSFoodReportHCKT::OnExportRelationor(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT hfo_deptid,  ") \
				...
				_T("         hfl_deptid = 'HCKT'") \
				_T("     AND") \
				_T("         hfl_subgroup = 'NN' and hfe_refstatus <> 'C' ") \
				_T(" GROUP BY") \
				_T("     hfo_deptid,HFOL_UNITPRICE") \
				_T("     ORDER BY hfo_deptid") ,m_szFromDate, m_szToDate);
	...
	{	
		...
		rs.GetValue(_T("hfo_deptid"),tmpStr);
		xls.SetCellText(nCol ++, nRow,tmpStr , FMT_TEXT | FMT_CENTER | FMT_WRAPING, false);
...
void 	CFMHMSFoodReportHCKT::OnExportPatient(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CRecord rs1(&pMF->m_db);
	CString tmpStr;
	...
	szSQL.Format(_T("    SELECT   hfo_deptid,") \
				...
				_T(" 				   GROUP BY  ") \
				_T(" 				       hfo_deptid,HFOL_UNITPRICE ,hfol_type") \
				_T(" 				       ORDER BY hfo_deptid,nType") ,m_szFromDate, m_szToDate);
	// AND hfo_orderstatus = 'A'
	_fmsg(_T("%s"),szSQL);
	rs.ExecSQL(szSQL);
	if(rs.IsEOF())
