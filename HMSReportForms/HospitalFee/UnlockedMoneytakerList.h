#ifndef UNLOCKEDMONEYTAKERLIST_H
#define UNLOCKEDMONEYTAKERLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CUnlockedMoneytakerList : public CGuiView{
protected:
public:
	...
	void			OnExcelSelect(); 
	CUnlockedMoneytakerList(CWnd *pParent);
	~CUnlockedMoneytakerList();
