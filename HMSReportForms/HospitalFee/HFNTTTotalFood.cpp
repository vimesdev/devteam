#include "stdafx.h"
#include "HFNTTTotalFood.h"
#include "HMSMainFrame.h"
#include "Excel.h"
#include "StringToken.h"
/*static void _OnDateChangeFnc(CWnd *pWnd){
	((CHFNTTTotalFood *)pWnd)->OnDateChange();
} */
/*static void _OnDateSetfocusFnc(CWnd *pWnd){
	((CHFNTTTotalFood *)pWnd)->OnDateSetfocus();} */ 
/*static void _OnDateKillfocusFnc(CWnd *pWnd){
	((CHFNTTTotalFood *)pWnd)->OnDateKillfocus();
} */
static int _OnDateCheckValueFnc(CWnd *pWnd){
	return ((CHFNTTTotalFood *)pWnd)->OnDateCheckValue();
} 
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHFNTTTotalFood* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CHFNTTTotalFood *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CHFNTTTotalFood *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CHFNTTTotalFood *)pWnd)->OnDepartmentKillfocus();
}*/
static double _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CHFNTTTotalFood *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CHFNTTTotalFood *)pWnd)->OnDepartmentAddNew();
}*/
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CHFNTTTotalFood*)pWnd)->OnAllSelect();
}
static void _OnBreakfastSelectFnc(CWnd *pWnd){
	  ((CHFNTTTotalFood*)pWnd)->OnBreakfastSelect();
}
static void _OnLunchSelectFnc(CWnd *pWnd){
	  ((CHFNTTTotalFood*)pWnd)->OnLunchSelect();
}
static void _OnDinnerSelectFnc(CWnd *pWnd){
	  ((CHFNTTTotalFood*)pWnd)->OnDinnerSelect();
}
static void _OnExportSelectFnc(CWnd *pWnd){
	CHFNTTTotalFood *pVw = (CHFNTTTotalFood *)pWnd;
	pVw->OnExportSelect();
}
static void _Ontruoc10hSelectFnc(CWnd *pWnd){
	 ((CHFNTTTotalFood*)pWnd)->Ontruoc10hSelect();
}
static void _Onsau10hSelectFnc(CWnd *pWnd){
	 ((CHFNTTTotalFood*)pWnd)->Onsau10hSelect();
}
static void _OnbaocatSelectFnc(CWnd *pWnd){
	 ((CHFNTTTotalFood*)pWnd)->OnbaocatSelect();
}
static int _OnAddNTTTotalFoodFnc(CWnd *pWnd){
	 return ((CHFNTTTotalFood*)pWnd)->OnAddNTTTotalFood();
} 
static int _OnEditNTTTotalFoodFnc(CWnd *pWnd){
	 return ((CHFNTTTotalFood*)pWnd)->OnEditNTTTotalFood();
} 
static int _OnDeleteNTTTotalFoodFnc(CWnd *pWnd){
	 return ((CHFNTTTotalFood*)pWnd)->OnDeleteNTTTotalFood();
} 
static int _OnSaveNTTTotalFoodFnc(CWnd *pWnd){
	 return ((CHFNTTTotalFood*)pWnd)->OnSaveNTTTotalFood();
} 
static int _OnCancelNTTTotalFoodFnc(CWnd *pWnd){
	 return ((CHFNTTTotalFood*)pWnd)->OnCancelNTTTotalFood();
} 
CHFNTTTotalFood::CHFNTTTotalFood(CWnd *pParent)
{
...
CHFNTTTotalFood::~CHFNTTTotalFood(){
}
void CHFNTTTotalFood::OnCreateComponents(){
...
void CHFNTTTotalFood::OnInitializeComponents(){
...
void CHFNTTTotalFood::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CHFNTTTotalFood::OnDoDataExchange(CDataExchange* pDX){
...
void CHFNTTTotalFood::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHFNTTTotalFood::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CHFNTTTotalFood::SetDefaultValues(){
...
int CHFNTTTotalFood::SetMode(int nMode){
...
/*void CHFNTTTotalFood::OnDateChange(){
	
} */
/*void CHFNTTTotalFood::OnDateSetfocus(){
	
} */
/*void CHFNTTTotalFood::OnDateKillfocus(){
	
} */
int CHFNTTTotalFood::OnDateCheckValue(){
	return 0;
} 
void CHFNTTTotalFood::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CHFNTTTotalFood::OnDepartmentSelendok(){
	 
}
/*void CHFNTTTotalFood::OnDepartmentSetfocus(){
	
}*/
/*void CHFNTTTotalFood::OnDepartmentKillfocus(){
	
}*/
long CHFNTTTotalFood::OnDepartmentLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHFNTTTotalFood::OnDepartmentAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CHFNTTTotalFood::OnAllSelect(){
	
}
void CHFNTTTotalFood::OnBreakfastSelect(){
	
}
void CHFNTTTotalFood::OnLunchSelect(){
	
}
void CHFNTTTotalFood::OnDinnerSelect(){
	
}
void CHFNTTTotalFood::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(!m_bHauCan)
		OnExport_ALL();
...
void CHFNTTTotalFood::Ontruoc10hSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CHFNTTTotalFood::Onsau10hSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CHFNTTTotalFood::OnbaocatSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
CString CHFNTTTotalFood::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT sd_index,") \
		...
		_T("   GROUP BY deptid") \
		_T("   ) ON(deptid = sd_id)") \
		_T(" WHERE sd_type IN ('DT') AND sd_id NOT IN ('A11', 'A14', 'A22', 'B5', 'B10', 'B15', 'CYBERL', 'C6', 'C18', 'C15', 'KD1', 'B3')") \
		_T(" AND sd_index IS NOT NULL %s ") \
		_T(" GROUP BY sd_index,") \
		_T("   sd_id,") \
		_T("   deptid") \
		_T(" ORDER BY sd_index"), szSumField4, szSumField5, szSumField1, szSumField2, szField1, szField2, szWhere, szSubWhere);

	//_fmsg(_T("%s"), szSQL);
	return szSQL;
}

CString CHFNTTTotalFood::GetQueryStringItems(){
	...
	szSQL.Format(_T(" SELECT sd_index,") \
		...
		_T("       AND hfo_orderstatus = 'A' %s") \
		_T("       ) tb3") \
		_T("     WHERE UPPER(hfl_name2) IN('BT01', 'PK4')") \
...
CString CHFNTTTotalFood::GetQueryStringTotal(){
	CString szSQL, szWhere, szSubWhere, tmpStr, szTemp, szRoomID, szObjects;
	...
	szSQL.Format(_T(" SELECT sd_index,") \
		...
		_T("       AND hfo_orderstatus = 'A' %s ") \
		_T("       ) tbl") \
		_T("     WHERE (UPPER(hfl_name2) NOT IN('BT01', 'PK4')") \
		_T("     OR (UPPER(hfl_name2)        IN('BT01', 'PK4')") \
		_T("     AND deptid           IN('A1','A1-A','A1-C', 'A12', 'A16')))") \
		_T("     ) tb2") \
		_T("   GROUP BY deptid") \
		_T("   ) ON (deptid2 = sd_id)") \
...
CString CHFNTTTotalFood::GetQueryStringTotal10h(){
	...
	szSQL.Format(_T(" SELECT sd_index,") \
		...
		_T("   NVL(SUM(CASE WHEN sd_id NOT IN('A1','A1-A','A1-C', 'A12', 'A16') AND UPPER(hfl_name2) IN('BT01', 'PK4') THEN qtyTCom ELSE 0 END), 0) AS vientComTT,") \
		_T("   NVL(SUM(CASE WHEN sd_id IN('A1','A1-A','A1-C', 'A12', 'A16') THEN qtyTCom ELSE 0 END), 0) AS vientComA1A16,") \
		_T("   NVL(SUM(CASE WHEN sd_id NOT IN('A1','A1-A','A1-C', 'A12', 'A16') AND UPPER(hfl_name2) NOT IN('BT01', 'PK4') THEN qtyTCom ELSE 0 END), 0) AS vientComBL, ") \
		_T("   NVL(SUM(CASE WHEN sd_id NOT IN('A1','A1-A','A1-C', 'A12', 'A16') AND UPPER(hfl_name2) IN('BT01', 'PK4') THEN qtyCCom ELSE 0 END), 0) AS viencComTT,") \
		_T("   NVL(SUM(CASE WHEN sd_id IN('A1','A1-A','A1-C', 'A12', 'A16') THEN qtyCCom ELSE 0 END), 0) AS viencComA1A16,") \
		_T("   NVL(SUM(CASE WHEN sd_id NOT IN('A1','A1-A','A1-C', 'A12', 'A16') AND UPPER(hfl_name2) NOT IN('BT01', 'PK4') THEN qtyCCom ELSE 0 END), 0) AS viencComBL,") \
		...
		_T("     SUM(qtyTotal - qtyTotalC) AS qtyTotal, hfl_name2") \
		_T("   FROM") \
		_T("     (SELECT") \
		_T("       CASE") \
		_T("         WHEN hfo_depttype = 'DT'") \
		...
		_T("   sd_id,") \
		_T("   deptid") \
		_T(" ORDER BY sd_index"), szWhere, szWhere2, szSubWhere);
	_fmsg(_T("%s"), szSQL);
	return szSQL;
}

CString CHFNTTTotalFood::GetQueryStringCOMA1A16(){
...
CString CHFNTTTotalFood::GetQueryStringCOM(){
	CString szSQL, szWhere, szSubWhere, szRoomID;
	...
	szSQL.Format(_T(" SELECT DISTINCT") \
		...
		_T(" AND foodname2 NOT IN('BT01', 'PK4') %s"), szWhere, szSubWhere);
	_fmsg(_T("%s"), szSQL);
	return szSQL;
}
CString CHFNTTTotalFood::GetQueryStringCHAO(){
	CString szSQL, szWhere, szSubWhere, szRoomID;
...
CString CHFNTTTotalFood::GetQueryStringOT(){
	CString szSQL, szWhere, szSubWhere, szRoomID;
...
CString CHFNTTTotalFood::GetQueryStringSua(){
	CString szSQL, szWhere, szSubWhere, szRoomID;
...
void CHFNTTTotalFood::OnInitDataStringCOMA1A16(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
void CHFNTTTotalFood::OnInitDataStringCOM(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
void CHFNTTTotalFood::OnInitDataStringCHAO(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
void CHFNTTTotalFood::OnInitDataStringOT(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
void CHFNTTTotalFood::OnInitDataStringSua(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
int CHFNTTTotalFood::OnAddNTTTotalFood(){
...
int CHFNTTTotalFood::OnEditNTTTotalFood(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHFNTTTotalFood::OnDeleteNTTTotalFood(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CHFNTTTotalFood::OnSaveNTTTotalFood(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CHFNTTTotalFood::OnCancelNTTTotalFood(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHFNTTTotalFood::OnNTTTotalFoodListLoadData(){
	return 0;
}
void CHFNTTTotalFood::OnExport_ALL(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	xls.SetCellText(11, nRow, _T("BT01"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true);
	...
	while (!rs.IsEOF())
	{
		...
		xls.SetCellText(1, nRow, rs.GetValue(_T("sd_id")), FMT_TEXT);
		...
		xls.SetCellText(16, nRow, rs.GetValue(_T("sd_id")), FMT_TEXT);
		...
		xls.SetCellText(nCol++, nRow, double2str(nTmp), FMT_NUMBER1);
		i++;
		xls.SetCellText(nCol++, nRow, rs.GetValue(_T("sd_id")), FMT_TEXT);
...
void CHFNTTTotalFood::OnExportHCKT(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
CString CHFNTTTotalFood::GetQueryStringHCKT(){
	CString szSQL, szWhere, szSubWhere, tmpStr, szTemp, szRoomID, szObjects;
