#include "stdafx.h"
#include "FMIncomePackageSummaryEX.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMIncomePackageSummaryEX* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX *)pWnd)->OnToDateCheckValue();
} 
static void _OnByDateSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*) pWnd)->OnByDateSelect();
}
static void _OnByDeptSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*) pWnd)->OnByDeptSelect();
}
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*) pWnd)->OnInsuranceSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CFMIncomePackageSummaryEX *pVw = (CFMIncomePackageSummaryEX *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummaryEX*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummaryEX*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CFMIncomePackageSummaryEX*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMIncomePackageSummaryEX*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMIncomePackageSummaryEX*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CFMIncomePackageSummaryEX*)pWnd)->OnDeptListUnCheckAll();
}
static long _OnPackageListLoadDataFnc(CWnd *pWnd)
{
	return ((CFMIncomePackageSummaryEX*)pWnd)->OnPackageListLoadData();
}

CFMIncomePackageSummaryEX::CFMIncomePackageSummaryEX(CWnd *pParent)
{
	m_nDlgWidth = 585;
	m_nDlgHeight = 585;
	SetDefaultValues();
}
CFMIncomePackageSummaryEX::~CFMIncomePackageSummaryEX()
{
}
void CFMIncomePackageSummaryEX::OnCreateComponents()
{
...
void CFMIncomePackageSummaryEX::OnInitializeComponents(){
...
void CFMIncomePackageSummaryEX::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryEX::OnDoDataExchange(CDataExchange* pDX){
...
void CFMIncomePackageSummaryEX::SetDefaultValues(){
...
int CFMIncomePackageSummaryEX::SetMode(int nMode){
...
/*void CFMIncomePackageSummaryEX::OnYearChange(){
	
} */
/*void CFMIncomePackageSummaryEX::OnYearSetfocus(){
	
} */
/*void CFMIncomePackageSummaryEX::OnYearKillfocus(){
	
} */
int CFMIncomePackageSummaryEX::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMIncomePackageSummaryEX::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CFMIncomePackageSummaryEX::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMIncomePackageSummaryEX::OnReportPeriodSetfocus(){
	
}*/
/*void CFMIncomePackageSummaryEX::OnReportPeriodKillfocus(){
	
}*/
long CFMIncomePackageSummaryEX::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMIncomePackageSummaryEX::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMIncomePackageSummaryEX::OnFromDateChange(){
	
} */
/*void CFMIncomePackageSummaryEX::OnFromDateSetfocus(){
	
} */
/*void CFMIncomePackageSummaryEX::OnFromDateKillfocus(){
	
} */
int CFMIncomePackageSummaryEX::OnFromDateCheckValue(){
	return 0;
}
 
/*void CFMIncomePackageSummaryEX::OnToDateChange(){
	
} */
/*void CFMIncomePackageSummaryEX::OnToDateSetfocus(){
	
} */
/*void CFMIncomePackageSummaryEX::OnToDateKillfocus(){
	
} */
int CFMIncomePackageSummaryEX::OnToDateCheckValue(){
	return 0;
}
long CFMIncomePackageSummaryEX::OnPackageListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	szSQL.Format(_T("SELECT ss_code AS ID, ") \
		         _T("ss_desc AS Name ") \
		         _T("FROM sys_sel ") \
				 _T("WHERE ss_id ='HMS_SERVICE_PACKAGE' and ss_vndesc='GNLT' %s ") \
...
void CFMIncomePackageSummaryEX::OnByDateSelect()
{
	//m_szCondition = _T("hfe_date");
}
void CFMIncomePackageSummaryEX::OnByDeptSelect()
{
	//m_szCondition = _T("hfe_deptid");
}

void CFMIncomePackageSummaryEX::OnInsuranceSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if (!m_bInsurance)
...
void CFMIncomePackageSummaryEX::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	if (!rpt.Init(_T("Reports/HMS/HF_DANHSACHBENHNHAN_THUGOI_NHALUUTRU_TH.RPT")))
		return;
...
void CFMIncomePackageSummaryEX::OnPrintFormat1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryEX::OnPrintFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMIncomePackageSummaryEX::OnExportSelect()
{
	UpdateData(true);
...
void CFMIncomePackageSummaryEX::OnExportFormat1(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummaryEX::OnExportFormat2(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString tmpStr, szTemp;
...
void CFMIncomePackageSummaryEX::OnObjectListDblClick(){
	
}
 
void CFMIncomePackageSummaryEX::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummaryEX::OnObjectListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummaryEX::OnObjectListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMIncomePackageSummaryEX::OnDeptListDblClick(){
	
}
 
void CFMIncomePackageSummaryEX::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
int CFMIncomePackageSummaryEX::OnDeptListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
}
 
long CFMIncomePackageSummaryEX::OnDeptListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CFMIncomePackageSummaryEX::GetQueryString()
{
...
CString CFMIncomePackageSummaryEX::GetQueryString1()
{
...
int CFMIncomePackageSummaryEX::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummaryEX::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CFMIncomePackageSummaryEX::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CFMIncomePackageSummaryEX::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
void CFMIncomePackageSummaryEX::OnExportByDate()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMIncomePackageSummaryEX::OnExportByDept()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMIncomePackageSummaryEX::GetQueryStringbydept()
{
	CString szSQL, szWhere, szObjects, szDepts,szPackages, szOrderBy;
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
