#ifndef FMFEELOSSBYOBJECTREPORTVER1_H
#define FMFEELOSSBYOBJECTREPORTVER1_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFeeLossByObjectReportVer1 : public CGuiView
{
...
public:
	...
	void			OnPolicySelect(); 
	CFMFeeLossByObjectReportVer1(CWnd* pParent);
	~CFMFeeLossByObjectReportVer1();
