#include "stdafx.h"
#include "SOMReportConditionDialog.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CSOMReportConditionDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSefocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CSOMReportConditionDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CSOMReportConditionDialog* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CSOMReportConditionDialog *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CSOMReportConditionDialog* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CSOMReportConditionDialog *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnTypeAddNew();
}*/
static long _OnSupplierLoadDataFnc(CWnd *pWnd){
	return ((CSOMReportConditionDialog *)pWnd)->OnSupplierLoadData();
}
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CSOMReportConditionDialog* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CSOMReportConditionDialog *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CSOMReportConditionDialog* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CSOMReportConditionDialog *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CSOMReportConditionDialog *)pWnd)->OnSourceAddNew();
}*/
static void _OnSortByTypeSelectFnc(CWnd *pWnd){
	CSOMReportConditionDialog *pVw = (CSOMReportConditionDialog *)pWnd;
...
static void _OnPrintPreviewInsSelectFnc(CWnd *pWnd){
	((CSOMReportConditionDialog*)pWnd)->OnPrintPreviewInsSelect();
} 
...
static int _OnAddSOMReportConditionDialogFnc(CWnd *pWnd){
	 return ((CSOMReportConditionDialog*)pWnd)->OnAddSOMReportConditionDialog();
} 
static int _OnEditSOMReportConditionDialogFnc(CWnd *pWnd){
	 return ((CSOMReportConditionDialog*)pWnd)->OnEditSOMReportConditionDialog();
} 
static int _OnDeleteSOMReportConditionDialogFnc(CWnd *pWnd){
	 return ((CSOMReportConditionDialog*)pWnd)->OnDeleteSOMReportConditionDialog();
} 
static int _OnSaveSOMReportConditionDialogFnc(CWnd *pWnd){
	 return ((CSOMReportConditionDialog*)pWnd)->OnSaveSOMReportConditionDialog();
} 
static int _OnCancelSOMReportConditionDialogFnc(CWnd *pWnd){
	 return ((CSOMReportConditionDialog*)pWnd)->OnCancelSOMReportConditionDialog();
}
CSOMReportConditionDialog::CSOMReportConditionDialog(CWnd *pParent, int nType)
{
	m_nDlgWidth = 645;
	m_nDlgHeight = 485;
	m_nType = nType;
...
CSOMReportConditionDialog::~CSOMReportConditionDialog(){
}
void CSOMReportConditionDialog::OnCreateComponents(){
	...
	{
		m_wndBillPrice.Create(this, _T("Bill Price"), 5, 185, 85, 210);
		m_wndPrintPreviewIns.Create(this, _T("In v?t tu"), 305, 215, 425, 240);
		m_wndExportIns.Create(this, _T("Xu?t v?t tu"), 450, 215, 570, 240);
	}
 	m_wndPrintPreview.Create(this, _T("In du?c"), 305, 245, 425, 270);
 	m_wndExport.Create(this, _T("Xu?t du?c"), 450, 245, 570, 270);

}
void CSOMReportConditionDialog::OnInitializeComponents(){
...
void CSOMReportConditionDialog::OnSetWindowEvents(){
...
void CSOMReportConditionDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CSOMReportConditionDialog::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CSOMReportConditionDialog::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CSOMReportConditionDialog::SetDefaultValues(){
...
int CSOMReportConditionDialog::SetMode(int nMode){
...
/*void CSOMReportConditionDialog::OnFromDateChange(){
	
} */
/*void CSOMReportConditionDialog::OnFromDateSetfocus(){
	
} */
/*void CSOMReportConditionDialog::OnFromDateKillfocus(){
	
} */
int CSOMReportConditionDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void CSOMReportConditionDialog::OnToDateChange(){
	
} */
/*void CSOMReportConditionDialog::OnToDateSetfocus(){
	
} */
/*void CSOMReportConditionDialog::OnToDateKillfocus(){
	
} */
int CSOMReportConditionDialog::OnToDateCheckValue(){
	return 0;
} 
void CSOMReportConditionDialog::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CSOMReportConditionDialog::OnStockSelendok(){
	 
}
/*void CSOMReportConditionDialog::OnStockSetfocus(){
	
}*/
/*void CSOMReportConditionDialog::OnStockKillfocus(){
	
}*/
long CSOMReportConditionDialog::OnStockLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CSOMReportConditionDialog::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CSOMReportConditionDialog::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CSOMReportConditionDialog::OnTypeSelendok(){
	 
}
/*void CSOMReportConditionDialog::OnTypeSetfocus(){
	
}*/
/*void CSOMReportConditionDialog::OnTypeKillfocus(){
	
}*/
long CSOMReportConditionDialog::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	_T("                                              'A1170', 'A1180', 'A1190', 'A1400', 'A6000' ) THEN N'Thu?c' ") \
	_T("                ELSE mpt_name ") \
...
/*void CSOMReportConditionDialog::OnTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
long CSOMReportConditionDialog::OnSupplierLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadPartnerList(&m_wndSupplier, m_szSupplierKey);
}
void CSOMReportConditionDialog::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CSOMReportConditionDialog::OnGroupSelendok(){
	 
}
/*void CSOMReportConditionDialog::OnGroupSetfocus(){
	
}*/
/*void CSOMReportConditionDialog::OnGroupKillfocus(){
	
}*/
long CSOMReportConditionDialog::OnGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CSOMReportConditionDialog::OnGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CSOMReportConditionDialog::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CSOMReportConditionDialog::OnSourceSelendok(){
	 
}
/*void CSOMReportConditionDialog::OnSourceSetfocus(){
	
}*/
/*void CSOMReportConditionDialog::OnSourceKillfocus(){
	
}*/
long CSOMReportConditionDialog::OnSourceLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CSOMReportConditionDialog::OnSortByTypeSelect(){
	m_szSort = _T("T");
	_debug(_T("%s"), m_szSort);
}
void CSOMReportConditionDialog::OnCatSelect(){
	m_szSort = _T("C");
	_debug(_T("%s"), m_szSort);
}
/*void CSOMReportConditionDialog::OnSourceAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CSOMReportConditionDialog::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
...
void CSOMReportConditionDialog::OnExportInsSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(TRUE);
	...
	if(!szType.IsEmpty())	
		...
		szTypeName.Format(_T("T?t c? v?t tu"));
...
// 	}
	...
	tmpStr.Format(_T("T? ngày %s d?n ngày %s"), CDateTime::Convert(m_szFromDate, yyyymmdd|hhmm, ddmmyyyy|hhmm), CDateTime::Convert(m_szToDate, yyyymmdd|hhmm, ddmmyyyy|hhmm));
	...
	{
		nRow++;
		tmpStr.Format(_T("T? kho: %s"), m_wndStock.GetCurrent(1));
	...
	{
		nRow++;
		tmpStr.Format(_T("Lo?i: %s"), szTypeName);
		xls.SetCellMergedColumns(0, nRow, 12);
		xls.SetCellText(0, nRow, tmpStr, &cf);
	}
	if(!m_szGroupKey.IsEmpty())
	...
	{
		nRow++;
		tmpStr.Format(_T("Ngu?n: %s"), m_wndSource.GetCurrent(1));
		xls.SetCellMergedColumns(0, nRow, 12);
		xls.SetCellText(0, nRow, tmpStr, &cf);
	}
	nRow++;
	xls.SetCellText(0, nRow, _T("STT"));	
	xls.SetCellText(1, nRow, _T("Ho?t ch?t"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(2, nRow, _T("Tên thu?c/ HL"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(3, nRow, _T("Ðon v?"), FMT_TEXT|FMT_CENTER, true);
	xls.SetCellText(4, nRow, _T("Ðon giá"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(5, nRow, _T("T?n d?u k?"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(6, nRow, _T("S? ti?n"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(7, nRow, _T("Nh?p trong k?"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(8, nRow, _T("S? ti?n"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(9, nRow, _T("Xu?t trong k?"), FMT_TEXT|FMT_CENTER, true);	
	xls.SetCellText(10, nRow, _T("S? ti?n"), FMT_TEXT|FMT_CENTER, true);		
	xls.SetCellText(11, nRow, _T("T?n cu?i k?"), FMT_TEXT|FMT_CENTER, true);		
	xls.SetCellText(12, nRow, _T("S? ti?n"), FMT_TEXT|FMT_CENTER, true);
	xls.SetCellText(13, nRow, _T("Chênh l?ch"), FMT_TEXT|FMT_CENTER, true);
	...
	if (m_szSort != _T("N"))
		...
		xls.SetCellText(1, nRow, _T("Ngu?i l?p phi?u "), FMT_TEXT | FMT_CENTER, true, 11);
		xls.SetCellText(3, nRow, _T("Hành chính tru?ng"), FMT_TEXT | FMT_CENTER, true, 11);
		xls.SetCellText(6, nRow, _T("Ch? nhi?m khoa"), FMT_TEXT | FMT_CENTER, true, 11);
		xls.SetCellText(9, nRow, _T("Th? kho"), FMT_TEXT | FMT_CENTER, true, 11);
		xls.SetCellText(12, nRow, _T("Tru?ng phòng tài chính"), FMT_TEXT | FMT_CENTER, true, 11);


		xls.Save(_T("Exports\\TONGHOPNHAPXUATTONKHOTHEOTONGTIEN.XLS"));
		EndWaitCursor();
}
void CSOMReportConditionDialog::OnPrintPreviewInsSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(TRUE);
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	for (int i=0 ; i<= m_wndType.GetCount(); i++)
	 ...
	 if (!szStockName.IsEmpty())
		 ...
		 rpt.GetReportHeader()->SetValue(_T("StockName"), _T("Toàn b?"));
	...
	if (!m_szGroupKey.IsEmpty())
		...
		rpt.GetReportHeader()->SetValue(_T("Group"), _T("Toàn b?"));
	if (m_szSourceKey.IsEmpty())
...
void CSOMReportConditionDialog::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_szStockName = m_wndStock.GetCurrent(1);
	switch(m_nType)
...
void CSOMReportConditionDialog::OnExportSelect(){
...
void CSOMReportConditionDialog::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CSOMReportConditionDialog::OnAddSOMReportConditionDialog(){
...
int CSOMReportConditionDialog::OnEditSOMReportConditionDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CSOMReportConditionDialog::OnDeleteSOMReportConditionDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelSOMReportConditionDialog(); 
 	}
	return 0;
}
int CSOMReportConditionDialog::OnSaveSOMReportConditionDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
	...
	//_fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnSOMReportConditionDialogListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CSOMReportConditionDialog::OnCancelSOMReportConditionDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CSOMReportConditionDialog::OnSOMReportConditionDialogListLoadData(){
	return 0;
}
void CSOMReportConditionDialog::OnPrintImportExportReport(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
	...
	rpt.GetReportHeader()->SetValue(_T("Original"), m_wndSource.GetCurrent(1));
	 ...
	 if(!m_szTypeKey.IsEmpty())	
		...
		szTypeName.Format(_T("Tất cả thuốc và vật tư"));
...
------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnPrintImportExportAndInstockReport(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
...
------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnExcell_ImportExportAndInstockReport(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
...
//_fmsg(_T("%s"), szSQL);
	...
	xls.SetCellText(0, 3, _T("T?NG H?P NH?P XU?T T?N KHO"),FMT_TEXT|FMT_CENTER,true,14,0);
	...
	int nRow = 5;
		...
		if(!m_szTypeKey.IsEmpty())
		{
			tmpStr.Format(_T("Lo?i: %s"), m_wndType.GetCurrent(1));
			xls.SetCellText(0, nRow++, tmpStr,FMT_TEXT,true,12,0);
		}
		if(!m_szGroupKey.IsEmpty())
		{
	...
	xls.SetCellText(1, nRow, _T("Mã thu?c"), FMT_TEXT|FMT_CENTER, true);
...
/*------------------------------------------------------------------------------------------------------------------------------
	Export To Excell Bao cao tong hop nhap xuat ton kho
------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnExcell_ImportExportReport(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
	CString tmpStr,szObjects,m_szFacList,tmpStr2, szDate, szSysDate, szSQL,szName,szAmount,szFromDate,szToDate, szWhere;
	BeginWaitCursor();
...
//_fmsg(_T("%s"), szSQL);
	...
	xls.SetCellText(5, nRow, _T("Nh?p"), FMT_TEXT|FMT_CENTER, true);
	
	xls.SetCellText(6, nRow, _T("S? ti?n"), FMT_TEXT|FMT_CENTER, true);
	
	xls.SetCellText(7, nRow, _T("Xu?t"), FMT_TEXT|FMT_CENTER, true);
...
void CSOMReportConditionDialog::OnPrintImportExportAndInstockForDetailMoneyReport(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	if(!szType.IsEmpty())	
		...
		szTypeName.Format(_T("T?t c? thu?c"));
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnExcell_ImportExportAndInstockForDetailMoneyReport(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CString tmpStr, szOrderby, szWhere, szSQL, szTemp, szCondition, szPrice, szStockSel;
	CString szType, szTypeName, szStock, szStockName;
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnPrintInstockReport(bool bPreview){	
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	if (m_szStockKey.IsEmpty())
	{
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnExportInstockReport(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();	
	UpdateData(true);
	if (m_szStockKey.IsEmpty())
	{
	...
	xls.SetCellText(0, 2, _T("BÁO CÁO KI?M KÊ KHO THU?C VÂT TU"),FMT_TEXT|FMT_CENTER,true, 12);
	xls.SetCellMergedColumns(0,3,15);
	tmpStr.Format(_T("T? ngày %s d?n ngày %s"), CDateTime::Convert(m_szFromDate, yyyymmdd|hhmmss, ddmmyyyy|hhmmss), CDateTime::Convert(m_szToDate, yyyymmdd|hhmmss, ddmmyyyy|hhmmss));
	xls.SetCellText(0, 3, tmpStr, &df);
	

	int nRow = 4;
	tmpStr.Format(_T("T? kho: %s"), m_szStockName);
	...
	{
		nRow++;
		tmpStr.Format(_T("Ngu?n thu?c: %s"), m_wndSource.GetCurrent(1));
		xls.SetCellMergedColumns(0, nRow, 14);
		xls.SetCellText(0, nRow, tmpStr,&cf);
	}
	nRow++;
	xls.SetCellText(0, nRow, _T("STT"),FMT_TEXT,true);
	xls.SetCellText(1, nRow, _T("Tên thu?c-Hàm lu?ng"),FMT_TEXT,true);
	xls.SetCellText(2, nRow, _T("Tên ho?t ch?t"),FMT_TEXT,true);
	xls.SetCellText(3, nRow, _T("Ðon v?"),FMT_TEXT,true);
	xls.SetCellText(4, nRow, _T("Hãng SX"),FMT_TEXT,true);
	xls.SetCellText(5, nRow, _T("H?n dùng"),FMT_TEXT,true);
	xls.SetCellText(6, nRow, _T("Ðon giá"),FMT_TEXT,true);
	xls.SetCellText(7, nRow, _T("S? lu?ng"),FMT_TEXT,true);
	xls.SetCellText(8, nRow, _T("Thành ti?n"),FMT_TEXT,true);	
	xls.SetCellText(9, nRow, _T("SL Th?a"),FMT_TEXT,true);
	xls.SetCellText(10, nRow, _T("SL Thi?u"),FMT_TEXT,true);
	xls.SetCellText(11, nRow, _T("V? h?ng"),FMT_TEXT,true);
	xls.SetCellText(12, nRow, _T("Ghi chú"),FMT_TEXT,true);
	xls.SetCellText(13, nRow, _T("S? lô"),FMT_TEXT,true);
	xls.SetCellText(14, nRow, _T("Nu?c SX"),FMT_TEXT,true);
		...
		if (m_szSort == _T("C"))
		{
			...
			if(szNewLine != szOldLine && !szNewLine.IsEmpty()){	
				...
				{			
					CString szField, szAmount;
					nRow ++;
					TranslateString(_T("C?ng:"), szAmount);												
	...
	if(grpCost > 0){
		nRow++;
		TranslateString(_T("C?ng:"), tmpStr);		
		xls.SetCellMergedColumns(1,nRow,7);
...
void CSOMReportConditionDialog::OnPrintTonghopnhapxuattonchitiettheonghiepvu(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, szWhere;
	CString szType, szTypeName;
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnExcell_Baocaotonghopnhapxuattonchitiettheonghiepvu(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, szWhere;
	CString szType, szTypeName;
	...
	for (int i =0; i < 32; i++)
	{
		...
		xls.SetCellMergedColumns(0,3,12);	
		xls.SetCellText(0, 3, _T("CHI TI?T NH?P XU?T T?N KHOA THEO NGHI?P V?"),FMT_TEXT,true,16,0);
		xls.SetCellMergedColumns(0,4,12);
		tmpStr.Format(_T("T? ngyaf %s d?n ngày %s"), CDateTime::Convert(m_szFromDate, yyyymmdd|hhmmss, ddmmyyyy|hhmmss), CDateTime::Convert(m_szToDate, yyyymmdd|hhmmss, ddmmyyyy|hhmmss));
		...
		xls.SetCellText(2, nRow, _T("Tên thu?c/ Hàm lu?ng"),FMT_TEXT,TRUE);
		xls.SetCellText(3, nRow, _T("Ðon v?"),FMT_TEXT,TRUE);
		xls.SetCellText(4, nRow, _T("Ðon giá"),FMT_TEXT,TRUE);
		xls.SetCellText(5, nRow, _T("Nu?c SX"),FMT_TEXT,TRUE);

		//Ton dau ky
		xls.SetCellMergedColumns(6,nRow-1,2);
		xls.SetCellText(6, nRow-1, _T("T?n d?u k?"),FMT_TEXT,TRUE);		
		xls.SetCellText(6, nRow, _T("S? lu?ng"),FMT_TEXT,TRUE);
		xls.SetCellText(7, nRow, _T("S? ti?n"),FMT_TEXT,TRUE);
		//Nhap trong ky
		xls.SetCellMergedColumns(8,nRow-1,8);
		xls.SetCellText(8, nRow-1, _T("Nh?p trong k?"),FMT_TEXT,TRUE);		
		xls.SetCellText(8, nRow, _T("Nhà cung c?p"),FMT_TEXT,TRUE);
		xls.SetCellText(9, nRow, _T("HT T? tr?c"),FMT_TEXT,TRUE);
		xls.SetCellText(10, nRow, _T("HT T? khoa"),FMT_TEXT,TRUE);
		xls.SetCellText(11, nRow, _T("HT T? kho"),FMT_TEXT,TRUE);
		xls.SetCellText(12, nRow, _T("HT Phi?u linh"),FMT_TEXT,TRUE);
		xls.SetCellText(13, nRow, _T("Ði?u ch?nh"),FMT_TEXT,TRUE);
		xls.SetCellText(14, nRow, _T("T?ng"),FMT_TEXT,TRUE);
		xls.SetCellText(15, nRow, _T("S? ti?n"),FMT_TEXT,TRUE);
		//Xuat trong ky
		xls.SetCellMergedColumns(16,nRow-1,14);
		xls.SetCellText(16, nRow-1, _T("Xu?t trong k?"),FMT_TEXT,TRUE);
		xls.SetCellText(16, nRow, _T("Xã phu?ng"),FMT_TEXT,TRUE);
		xls.SetCellText(17, nRow, _T("D? trù"),FMT_TEXT,TRUE);
		xls.SetCellText(18, nRow, _T("T? tr?c"),FMT_TEXT,TRUE);
		xls.SetCellText(19, nRow, _T("Thanh lý"),FMT_TEXT,TRUE);
		xls.SetCellText(20, nRow, _T("H?t h?n"),FMT_TEXT,TRUE);
		xls.SetCellText(21, nRow, _T("H?ng v?"),FMT_TEXT,TRUE);
		xls.SetCellText(22, nRow, _T("Ði?u ch?nh"),FMT_TEXT,TRUE);	
		xls.SetCellText(23, nRow, _T("Xu?t khác"),FMT_TEXT,TRUE);
		xls.SetCellText(24, nRow, _T("Hoàn tr? t? kho"),FMT_TEXT,TRUE);
		xls.SetCellText(25, nRow, _T("Luu chuy?n"),FMT_TEXT,TRUE);
		xls.SetCellText(26, nRow, _T("Phi?u linh"),FMT_TEXT,TRUE);
		xls.SetCellText(27, nRow, _T("Ðon thu?c"),FMT_TEXT,TRUE);			
		xls.SetCellText(28, nRow, _T("T?ng"),FMT_TEXT,TRUE);
		xls.SetCellText(29, nRow, _T("S? ti?n"),FMT_TEXT,TRUE);	
		//Ton cuoi ky
		xls.SetCellMergedColumns(30,nRow-1,2);
		xls.SetCellText(30, nRow-1, _T("T?n cu?i k?"),FMT_TEXT,TRUE);
		xls.SetCellText(30, nRow, _T("S? lu?ng"),FMT_TEXT,TRUE);		
		xls.SetCellText(31, nRow, _T("S? ti?n"),FMT_TEXT,TRUE);
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnPrint_Danhsachthuochethan(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
	CReportSection* rptDetail;
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CSOMReportConditionDialog::OnExport_Danhsachthuochethan(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();	
...
void CSOMReportConditionDialog::OnPrintBaocaosudungthuoctheoquy(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
	...
	if(bPreview)
		...
		rpt.Print();
	EndWaitCursor();
}BEGIN_MESSAGE_MAP(CSOMReportConditionDialog, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CSOMReportConditionDialog::OnSetFocus(CWnd* pOldWnd)
{
