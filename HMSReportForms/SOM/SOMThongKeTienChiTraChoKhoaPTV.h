#ifndef SOMTHONGKETIENCHITRACHOKHOAPTV_H
#define SOMTHONGKETIENCHITRACHOKHOAPTV_H
...
#include "GuiView.h"
#include "DbField.h"
class CSOMThongKeTienChiTraChoKhoaPTV : public CGuiView{
protected:
public:
	...
	void			OnChuaTTSelect();
	void			OnExportSelect(); 
	CSOMThongKeTienChiTraChoKhoaPTV(CWnd *pWnd);
	~CSOMThongKeTienChiTraChoKhoaPTV();
	...
	int OnAddSOMThongKeTienChiTraChoKhoaPTV(); 
	int OnEditSOMThongKeTienChiTraChoKhoaPTV(); 
	int OnDeleteSOMThongKeTienChiTraChoKhoaPTV(); 
	int OnSaveSOMThongKeTienChiTraChoKhoaPTV(); 
	int OnCancelSOMThongKeTienChiTraChoKhoaPTV(); 
	int OnSOMThongKeTienChiTraChoKhoaPTVListLoadData(); 
