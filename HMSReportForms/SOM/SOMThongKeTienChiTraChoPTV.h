#ifndef SOMThongKeTienChiTraChoPTV_H
#define SOMThongKeTienChiTraChoPTV_H
...
#include "GuiView.h"
#include "DbField.h"
class CSOMThongKeTienChiTraChoPTV : public CGuiView{
protected:
public:
	...
	void			OnChuaTTSelect();
	void			OnExportSelect(); 
	CSOMThongKeTienChiTraChoPTV(CWnd *pWnd);
	~CSOMThongKeTienChiTraChoPTV();
	...
	int OnAddSOMThongKeTienChiTraChoPTV(); 
	int OnEditSOMThongKeTienChiTraChoPTV(); 
	int OnDeleteSOMThongKeTienChiTraChoPTV(); 
	int OnSaveSOMThongKeTienChiTraChoPTV(); 
	int OnCancelSOMThongKeTienChiTraChoPTV(); 
	int OnSOMThongKeTienChiTraChoPTVListLoadData(); 
