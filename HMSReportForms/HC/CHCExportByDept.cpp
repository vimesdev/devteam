...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CExportByDept *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CExportByDept *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CExportByDept* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CExportByDept *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CExportByDept *)pWnd)->OnStockAddNew();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CExportByDept *)pWnd)->OnTypeLoadData();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CExportByDept *pVw = (CExportByDept *)pWnd;
...
static int _OnAddExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDept*)pWnd)->OnAddExportByDept();
} 
static int _OnEditExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDept*)pWnd)->OnEditExportByDept();
} 
static int _OnDeleteExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDept*)pWnd)->OnDeleteExportByDept();
} 
static int _OnSaveExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDept*)pWnd)->OnSaveExportByDept();
} 
static int _OnCancelExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDept*)pWnd)->OnCancelExportByDept();
} 
CExportByDept::CExportByDept(CWnd *pParent)
{
	m_nDlgWidth = 440;
	m_nDlgHeight = 130;
	SetDefaultValues();
}
CExportByDept::~CExportByDept()
{
}
void CExportByDept::OnCreateComponents(){
...
void CExportByDept::OnInitializeComponents(){
...
void CExportByDept::OnSetWindowEvents(){
...
void CExportByDept::OnDoDataExchange(CDataExchange* pDX){
...
void CExportByDept::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CExportByDept::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CExportByDept::SetDefaultValues(){
...
int CExportByDept::SetMode(int nMode){
...
/*void CExportByDept::OnFromDateChange(){
	
} */
/*void CExportByDept::OnFromDateSetfocus(){
	
} */
/*void CExportByDept::OnFromDateKillfocus(){
	
} */
int CExportByDept::OnFromDateCheckValue(){
	return 0;
} 
/*void CExportByDept::OnToDateChange(){
	
} */
/*void CExportByDept::OnToDateSetfocus(){
	
} */
/*void CExportByDept::OnToDateKillfocus(){
	
} */
int CExportByDept::OnToDateCheckValue(){
	return 0;
} 
void CExportByDept::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CExportByDept::OnStockSelendok(){
	 
}
/*void CExportByDept::OnStockSetfocus(){
	
}*/
/*void CExportByDept::OnStockKillfocus(){
	
}*/

long CExportByDept::OnStockLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadStorageList(&m_wndStock, m_szStockKey);
}
/*void CExportByDept::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
long CExportByDept::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	int nCount = 0;
...
void CExportByDept::OnPrintPreviewSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
...
void CExportByDept::OnExportSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\BAOCAO_XUAT_CHOKHOA_PHIEU_PX.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BAOCAO_XUAT_CHOKHOA_PHIEU_PX2.xls"));
	
} 
int CExportByDept::OnAddExportByDept()
{
...
int CExportByDept::OnEditExportByDept()
{
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
...
int CExportByDept::OnDeleteExportByDept(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CExportByDept::OnSaveExportByDept(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CExportByDept::OnCancelExportByDept(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CExportByDept::OnExportByDeptListLoadData(){
	return 0;
}

CString CExportByDept::GetQueryString()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	...
	/*szSQL.Format(_T(" SELECT groupname, receiver,") \
				_T("   SUM(tong_muc_in)     AS tong_muc_in,") \
				_T("   SUM(tong_giay_in)    AS tong_giay_in,") \
				_T("   SUM(tong_vattu_khac) AS tong_vattu_khac,") \
				_T("   SUM(tong_muc_in+tong_giay_in+tong_vattu_khac)          AS totalamount") \
				_T(" FROM") \
				_T("   (SELECT SD_GROUPNAME_HC as groupname, mt_department_to_id AS receiver,") \
				_T("    SD_INDEXGROUP_HC reportgroupIdx,") \
				_T("    SD_INDEX_HC as DeptIdx,   ") \
				_T("     CASE") \
				_T("       WHEN PRODUCT_CATEGORYID =186") \
				_T("       THEN SUM(mtl_qtydelivery * product_vatprice)") \
				_T("       ELSE 0") \
				_T("     END AS tong_muc_in,") \
				_T("     CASE") \
				_T("       WHEN PRODUCT_CATEGORYID =185") \
				_T("       THEN SUM(mtl_qtydelivery * product_vatprice)") \
				_T("       ELSE 0") \
				_T("     END AS tong_giay_in,") \
				_T("     CASE") \
				_T("       WHEN PRODUCT_CATEGORYID NOT IN (185,186)") \
				_T("       THEN SUM(mtl_qtydelivery     * product_vatprice)") \
				_T("       ELSE 0") \
				_T("     END                                     AS tong_vattu_khac,") \
				...
				_T("   %s") \
				_T("   GROUP BY SD_INDEXGROUP_HC, SD_GROUPNAME_HC, SD_INDEX_HC, mt_department_to_id,") \
				_T("     PRODUCT_CATEGORYID,") \
				_T("     sd_type") \
				_T("   ORDER BY sd_type") \
				_T("   )") \
				_T(" GROUP BY reportgroupIdx, groupname, DeptIdx, receiver") \
				_T(" ORDER BY reportgroupIdx, groupname, DeptIdx"), szWhere);*/
...
CString CExportByDept::GetQueryString1()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
...
BEGIN_MESSAGE_MAP(CExportByDept, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CExportByDept::OnSetFocus(CWnd* pOldWnd)
{
