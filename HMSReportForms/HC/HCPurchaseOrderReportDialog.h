#ifndef HCSPURCHASEORDERREPORTDIALOG_H
#define HCSPURCHASEORDERREPORTDIALOG_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CHCSPurchaseOrderReportDialog : public CGuiView
{
protected:
public:
	...
	CHCSPurchaseOrderReportDialog(CWnd *pParent, int bDetail);
	~CHCSPurchaseOrderReportDialog();
	...
	void OnPrintTonghopphieunhapkho_pcnmt(bool bPreview);
	void OnExportTonghopphieunhapkho(bool bPreview);
	void OnPrintTonghopphieunhapkhotheonhacungcap(bool bPreview);
	void OnPrintTonghopphieunhapkhotheonhacungcap1(bool bPreview);
	...
	void OnPrintTonghopchitietphieunhapkho_khth(bool bPreview);
	...
	void OnPrintTonghopchitietphieunhapkho_pcnmt(bool bPreview);
	CString GetQueryTonghopphieunhapkho();
	CString GetQueryTonghopphieunhapkho_pcnmt();
	CString GetQueryTonghopphieunhapkhotheonhacungcap();
	CString GetQueryTonghopchitietphieunhapkho();
	CString GetQueryTonghopchitietphieunhapkho_khth();
	CString GetQueryTonghopchitietphieunhapkho_pcnmt();
