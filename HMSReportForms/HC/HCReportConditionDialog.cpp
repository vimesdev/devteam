#include "stdafx.h"
#include "HCReportConditionDialog.h"
...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CHCReportConditionDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSefocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CHCReportConditionDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHCReportConditionDialog* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CHCReportConditionDialog *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHCReportConditionDialog* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CHCReportConditionDialog *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnTypeAddNew();
}*/
static long _OnSupplierLoadDataFnc(CWnd *pWnd){
	return ((CHCReportConditionDialog *)pWnd)->OnSupplierLoadData();
}
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHCReportConditionDialog* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CHCReportConditionDialog *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHCReportConditionDialog* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CHCReportConditionDialog *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CHCReportConditionDialog *)pWnd)->OnSourceAddNew();
}*/
static void _OnSortByTypeSelectFnc(CWnd *pWnd){
	CHCReportConditionDialog *pVw = (CHCReportConditionDialog *)pWnd;
...
static void _OnPrintPreviewInsSelectFnc(CWnd *pWnd){
	((CHCReportConditionDialog*)pWnd)->OnPrintPreviewInsSelect();
} 
...
static int _OnAddPMSReportConditionDialogFnc(CWnd *pWnd){
	 return ((CHCReportConditionDialog*)pWnd)->OnAddPMSReportConditionDialog();
} 
static int _OnEditPMSReportConditionDialogFnc(CWnd *pWnd){
	 return ((CHCReportConditionDialog*)pWnd)->OnEditPMSReportConditionDialog();
} 
static int _OnDeletePMSReportConditionDialogFnc(CWnd *pWnd){
	 return ((CHCReportConditionDialog*)pWnd)->OnDeletePMSReportConditionDialog();
} 
static int _OnSavePMSReportConditionDialogFnc(CWnd *pWnd){
	 return ((CHCReportConditionDialog*)pWnd)->OnSavePMSReportConditionDialog();
} 
static int _OnCancelPMSReportConditionDialogFnc(CWnd *pWnd){
	 return ((CHCReportConditionDialog*)pWnd)->OnCancelPMSReportConditionDialog();
}

static void _OnNotincludeStocktransferSelectFnc(CWnd *pWnd)
{
	 ((CHCReportConditionDialog*)pWnd)->OnNotincludeStocktransferSelect();
}
...
CHCReportConditionDialog::CHCReportConditionDialog(CWnd *pParent, int nType)
{
	m_nDlgWidth = 645;
	m_nDlgHeight = 485;
	m_nType = nType;
...
CHCReportConditionDialog::~CHCReportConditionDialog()
{

}
void CHCReportConditionDialog::OnCreateComponents(){
	...
	m_wndNotincludeStocktransfer.Create(this, _T("Không tính điều chuyển"), 4, 246, 289, 271);
	m_wndPreviewV2.Create(this, _T("Preview(PCNMT)"), 305, 304, 570, 329);

}
void CHCReportConditionDialog::OnInitializeComponents(){
...
void CHCReportConditionDialog::OnSetWindowEvents(){
	...
	m_wndNotincludeStocktransfer.SetEvent(WE_CLICK, _OnNotincludeStocktransferSelectFnc);
...
void CHCReportConditionDialog::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndNotincludeStocktransfer.GetDlgCtrlID(), m_bNotincludeStocktransfer);
}
void CHCReportConditionDialog::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHCReportConditionDialog::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CHCReportConditionDialog::SetDefaultValues(){
	...
	m_bBillPrice = FALSE;
	m_bAvgPrice = FALSE;
	m_bNotincludeStocktransfer=FALSE;

}
int CHCReportConditionDialog::SetMode(int nMode){
...
/*void CHCReportConditionDialog::OnFromDateChange(){
	
} */
/*void CHCReportConditionDialog::OnFromDateSetfocus(){
	
} */
/*void CHCReportConditionDialog::OnFromDateKillfocus(){
	
} */
int CHCReportConditionDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void CHCReportConditionDialog::OnToDateChange(){
	
} */
/*void CHCReportConditionDialog::OnToDateSetfocus(){
	
} */
/*void CHCReportConditionDialog::OnToDateKillfocus(){
	
} */
int CHCReportConditionDialog::OnToDateCheckValue(){
	return 0;
} 
void CHCReportConditionDialog::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CHCReportConditionDialog::OnStockSelendok(){
	 
}
/*void CHCReportConditionDialog::OnStockSetfocus(){
	
}*/
/*void CHCReportConditionDialog::OnStockKillfocus(){
	
}*/
long CHCReportConditionDialog::OnStockLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CHCReportConditionDialog::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CHCReportConditionDialog::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CHCReportConditionDialog::OnTypeSelendok(){
	 
}
/*void CHCReportConditionDialog::OnTypeSetfocus(){
	
}*/
/*void CHCReportConditionDialog::OnTypeKillfocus(){
	
}*/
void CHCReportConditionDialog::OnNotincludeStocktransferSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CHCReportConditionDialog::OnPreviewV2Select()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();	
	UpdateData(TRUE);
	...
	switch(m_nType)
	{
		...
		case IMPORT_EXPORT_INSTOCK_DETAILFORMONEY:
			OnPrintImportExportAndInstockForDetailMoneyReportV2(true);
			break;
		case INSTOCK:
...
long CHCReportConditionDialog::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CHCReportConditionDialog::OnTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
long CHCReportConditionDialog::OnSupplierLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadPartnerList(&m_wndSupplier, m_szSupplierKey);
}
void CHCReportConditionDialog::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CHCReportConditionDialog::OnGroupSelendok(){
	 
}
/*void CHCReportConditionDialog::OnGroupSetfocus(){
	
}*/
/*void CHCReportConditionDialog::OnGroupKillfocus(){
	
}*/
long CHCReportConditionDialog::OnGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CHCReportConditionDialog::OnGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CHCReportConditionDialog::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CHCReportConditionDialog::OnSourceSelendok(){
	 
}
/*void CHCReportConditionDialog::OnSourceSetfocus(){
	
}*/
/*void CHCReportConditionDialog::OnSourceKillfocus(){
	
}*/
long CHCReportConditionDialog::OnSourceLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CHCReportConditionDialog::OnSortByTypeSelect(){
	m_szSort = _T("T");
	_debug(_T("%s"), m_szSort);
}
void CHCReportConditionDialog::OnCatSelect(){
	m_szSort = _T("C");
	_debug(_T("%s"), m_szSort);
}
/*void CHCReportConditionDialog::OnSourceAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CHCReportConditionDialog::OnPrintPreviewSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_szStockName = m_wndStock.GetCurrent(1);
...
void CHCReportConditionDialog::OnExportInsSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
...
void CHCReportConditionDialog::OnPrintPreviewInsSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
	CString tmpStr, szDate, szSysDate, szSQL, szWhere, szOrderby, szPrice, szCondition, szRptName, szStockSel, szReportTitle, szPath;
	...
	//	return;
	//}
	szReportTitle.Format(_T("%s_BAOCAOXUATNHAPCHUNG_BH"), pMF->GetModuleID());
...
void CHCReportConditionDialog::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_szStockName = m_wndStock.GetCurrent(1);
	switch(m_nType)
...
void CHCReportConditionDialog::OnPrint1Select(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, szWhere, szOrderby, szPrice, szCondition, szRptName, szStockSel, szReportTitle, szPath;
	...
	//	return;
	//}
	szReportTitle.Format(_T("%s_BAOCAOXUATNHAPCHUNG"), pMF->GetModuleID());
	...
	szSQL.Format(_T(" SELECT *") \
		_T(" FROM") \
		_T("   (SELECT product_categoryid                            AS idx1,") \
...
void CHCReportConditionDialog::OnExportSelect(){
...
void CHCReportConditionDialog::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CHCReportConditionDialog::OnAddPMSReportConditionDialog(){
...
int CHCReportConditionDialog::OnEditPMSReportConditionDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHCReportConditionDialog::OnDeletePMSReportConditionDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CHCReportConditionDialog::OnSavePMSReportConditionDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CHCReportConditionDialog::OnCancelPMSReportConditionDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHCReportConditionDialog::OnPMSReportConditionDialogListLoadData(){
	return 0;
}
void CHCReportConditionDialog::OnPrintImportExportReport(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
    CString tmpStr, szDate, szSysDate, szSQL, szWhere, szTypeName, szType, szReportTitle, szPath;
	
	//if(!rpt.Init(_T("Reports/HMS/PMS_GENERALIMPORTEXPORTREPORT.RPT"),true) )
	//{
	//	return;
	//}
	szReportTitle.Format(_T("%s_GENERALIMPORTEXPORTREPORT"), pMF->GetModuleID());
...
------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnPrintImportExportAndInstockReport(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, szWhere;
	CString szTypeName, szType, szReportName, szReportTitle, szPath;
	...
	//	return;
	//}
	szReportTitle.Format(_T("%s_GENERALIMPORTEXPORTINSTOCKREPORT"), pMF->GetModuleID());
...
------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnExcell_ImportExportAndInstockReport(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
/*------------------------------------------------------------------------------------------------------------------------------
	Export To Excell Bao cao tong hop nhap xuat ton kho
------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnExcell_ImportExportReport(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CString tmpStr,szObjects,m_szFacList,tmpStr2, szDate, szSysDate, szSQL,szName,szAmount,szFromDate,szToDate, szWhere;
...
void CHCReportConditionDialog::OnPrintImportExportAndInstockForDetailMoneyReport(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	//_msg(_T("Hi"));
	UpdateData(true);
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, szWhere, szOrderby, szPrice,szMoney, szCondition, szRptName, szStockSel, szReportTitle, szPath;
	//szRptName.Format(_T("Reports/HMS/PMS_SUMMARYIMPORTEXPORTINSTOCKFORMONEYREPORT.RPT"));
	//if (pMF->GetModuleID() == _T("PM"))
	//	if (m_szStockKey == _T("4"))
	//		szRptName.Format(_T("Reports/HMS/PM_BAOCAOXUATNHAPCHUNG_DONGY.RPT"));
	...
	//else
	//	szRptName.Format(_T("Reports/HMS/HC_BAOCAOXUATNHAPCHUNG.RPT"));
	//if(!rpt.Init(szRptName,true) )
	//{
	//	return;
	//}
	...
	{
		szReportTitle.Format(_T("%s_%s_BAOCAOXUATNHAPCHUNG"), pMF->GetModuleID(), szZoneOfUser);	
	}
	else
	{
		szReportTitle.Format(_T("%s_BAOCAOXUATNHAPCHUNG"), pMF->GetModuleID());
	...
	//szPath.Format(_T("Reports/HMS/%s.RPT"), szReportTitle);
	//	//if(!rpt.Init(szPath, true)) //In ra số trang//
	//	  if(!rpt.Init(szPath))
	//		return;
		
	BeginWaitCursor();
	CString szType, szTypeName, szStock, szStockName, szConditionStransfer;
	for (int i=0 ; i<= m_wndType.GetCount(); i++)
	{
		if(m_wndType.GetCheck(i)){
			m_wndType.SetCurSel(i);
	...
	if (m_bBillPrice)
		szCondition = _T("product_unitprice");
	szConditionStransfer = _T("MOV");

	if (m_bNotincludeStocktransfer)
	szConditionStransfer = _T("MOV");
	...
	{
	szSQL.Format(_T(" SELECT * FROM") \
				_T(" ( SELECT  product_categoryid as idx1, product_categoryname as groupname, product_code as id,        ") \
				_T("		   product_groupid as idx2, product_groupname as typename, product_classname as generic,") \
				_T("           product_name as name, get_uomname(product_uomid) as unit,       ") \
				_T("           %s as price,         ") \
				_T("           sum(periodqty) as periodqty,    ") \
				...
				_T("           sum(impqty*%s) as impamount,         ") \
				_T("           sum(expqty) as expqty,") \
				_T("           sum(expqty) *product_taxprice as expamount,        ") \
				...
				_T("       SELECT * FROM (    ") \
				_T("           SELECT impstockid as stockid, impdate as iodate, sitemid, 0 as periodqty, impqty, 0 as expqty") \
				_T("           FROM miv_hckt WHERE iotype <> 'MOV' ") \
				_T("           UNION ALL") \
				_T("           SELECT impstockid as stockid, impdate as iodate, sitemid, 0 as periodqty, impqty, 0 as expqty") \
				//_T("           FROM miv WHERE iotype = 'MOVL' AND expstockid NOT IN (%s) ") \//
				_T("           FROM miv_hckt WHERE iotype = '%s' AND expstockid NOT IN (%s) ") \
				_T("           UNION ALL") \
				_T("           SELECT expstockid, expdate, sitemid, 0, 0, expqty") \
				_T("           FROM mev_hckt WHERE iotype <> 'MOV' ") \
				_T("           UNION ALL") \
				_T("           SELECT expstockid, expdate, sitemid, 0, 0, expqty") \
				_T("           FROM mev_hckt WHERE iotype = '%s' AND impstockid NOT IN (%s) ") \
				_T("           ) iotbl ") \
				_T("       WHERE iodate between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') %s") \
				_T("       UNION ALL ") \
				_T("       SELECT stockid, iodate, sitemid, coalesce(impqty-expqty, 0), 0, 0") \
				...
				_T("     LEFT JOIN m_productitem_view3 ON(product_item_id=sitemid)") \
				_T("     WHERE sitemid > 0 %s") \
				 _T("     GROUP BY product_categoryid, product_categoryname, product_groupid, product_groupname, product_code,") \
				_T("			  product_name, product_uomid, product_classname, %s, product_saleprice1 ") \
				_T(" ) tbl ") \
				_T(" WHERE (periodqty + impqty + expqty > 0)  ") \
				_T(" %s"), szCondition, szCondition, szCondition, szCondition, szCondition, szConditionStransfer, szStock, szConditionStransfer, szStock,
				m_szFromDate, m_szToDate, szStockSel, m_szFromDate, szStockSel, szWhere, szCondition, szOrderby);
	}
	else
	{
		szSQL.Format(_T(" SELECT * FROM") \
				...
				_T("           SELECT impstockid as stockid, impdate as iodate, sitemid, 0 as periodqty, impqty, 0 as expqty") \
				//_T("           FROM miv WHERE iotype = 'MOVL' AND expstockid NOT IN (%s) ") \//
				_T("           FROM miv WHERE iotype = '%s' AND expstockid NOT IN (%s) ") \
				_T("           UNION ALL") \
				_T("           SELECT expstockid, expdate, sitemid, 0, 0, expqty") \
				_T("           FROM mev WHERE iotype <> 'MOV' ") \
				_T("           UNION ALL") \
				_T("           SELECT expstockid, expdate, sitemid, 0, 0, expqty") \
				_T("           FROM mev WHERE iotype = '%s' AND impstockid NOT IN (%s) ") \
				_T("           ) iotbl ") \
				_T("       WHERE iodate between TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') and TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') %s") \
				_T("       UNION ALL ") \
				_T("       SELECT stockid, iodate, sitemid, coalesce(impqty-expqty, 0), 0, 0") \
	...
	totalallmoney +=totalinstockamount;
	...
	szMoney.Format(_T("%.2f"), totalallmoney);
	//_msg(_T("%s"), szMoney);
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnExcell_ImportExportAndInstockForDetailMoneyReport(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CString tmpStr, szOrderby, szWhere, szSQL, szTemp, szCondition, szPrice, szStockSel;
	CString szType, szTypeName, szStock, szStockName;
	int nCol = 0;
	...
	//}
		szSQL.Format(_T(" SELECT * FROM") \
					...
					_T("     LEFT JOIN m_productitem_view3 ON(product_item_id=sitemid)") \
					_T("     WHERE sitemid > 0 %s") \
					_T("     GROUP BY product_rootid, product_rootname, product_producttype, product_typename, product_code, product_name, product_uomid, product_classname, %s, product_saleprice1 ") \
					_T(" ) tbl ") \
					_T(" WHERE (periodqty + impqty + expqty > 0)  ") \
					_T(" %s"), szCondition, szCondition, szCondition, szCondition, szCondition, szStock, szStock,
					m_szFromDate, m_szToDate, szStockSel, m_szFromDate, szStockSel, szWhere, szCondition, szOrderby);
	...
	nRow++;
	xls.SetCellText(0, nRow, _T("STT"));	
	xls.SetCellText(1, nRow, _T("Tên hàng"), FMT_TEXT|FMT_CENTER, true);	
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnPrintInstockReport(bool bPreview){	
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	if (m_szStockKey.IsEmpty())
	{
	...
	//		return;
	//}
	szReportTitle.Format(_T("%s_BIENBANKIEMKETHUOC"), pMF->GetModuleID());
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnExportInstockReport(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();	
	UpdateData(true);
	if (m_szStockKey.IsEmpty())
	{
...
void CHCReportConditionDialog::OnPrintTonghopnhapxuattonchitiettheonghiepvu(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, szWhere, szReportTitle, szPath;
	CString szType, szTypeName;
	...
	//	return;
	//}
	szReportTitle.Format(_T("%s_CHITIETTONGHOPNHAPXUATTONKHOTHEONGHIEPVU"), pMF->GetModuleID());
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnExcell_Baocaotonghopnhapxuattonchitiettheonghiepvu(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, szWhere;
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnPrint_Danhsachthuochethan(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CReportSection* rptDetail;
	...
	BeginWaitCursor();
	CString tmpStr,tmp, szDate, szSysDate, szSQL,szName,szAmount, szWhere, szReportTitle, szPath;
	...
	//	}
	//}
	szReportTitle.Format(_T("%s_DANHSACHVATTUHETHAN"), pMF->GetModuleID());
...
---------------------------------------------------------------------------------------------------------------------------------*/
void CHCReportConditionDialog::OnExport_Danhsachthuochethan(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();	
...
void CHCReportConditionDialog::OnPrintBaocaosudungthuoctheoquy(bool bPreview){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL,tmpStr2,szObjects,m_szFacList, szWhere;
	CString  m_szServiceFlag,m_szInsFlag,m_szChildFlag,m_szFreeFlag,m_szGroups, szReportTitle, szPath;
	
	//if(!rpt.Init(_T("Reports/HMS/PMS_THONGKETONGHOPSUDUNGTHUOC.RPT"),true) )
	//{
	//	return;
	//}
	szReportTitle.Format(_T("%s_THONGKETONGHOPSUDUNGTHUOC"), pMF->GetModuleID());
	...
	if(bPreview)
		...
		rpt.Print();
	EndWaitCursor();
}BEGIN_MESSAGE_MAP(CHCReportConditionDialog, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CHCReportConditionDialog::OnSetFocus(CWnd* pOldWnd)
{
...
void CHCReportConditionDialog::OnPrintImportExportAndInstockForDetailMoneyReportV2(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	//_msg(_T("Hi"));
	UpdateData(true);
	...
	if (!szStock.IsEmpty())
		szStockSel.Format(_T(" AND stockid IN (%s)"), szStock);
	szOrderby.Format(_T("ORDER BY v_nguonchi, name, unit"));
	if (m_szSort == _T("C"))
		szOrderby.Format(_T("ORDER BY idx1,name, unit"));
	else if (m_szSort == _T("T"))
		szOrderby.Format(_T("ORDER BY v_nguonchi, idx2,name, unit"));
	...
	//Report Detail
			...
			szSQL.Format(_T(" SELECT ") \
				...
				_T(" idx1, groupname, id, idx2, typename, generic, name, unit, price,") \
				_T(" periodqty, periodamount, impqty, impamount, expqty, expamount,  realprofit, ") \
				_T(" instockqty, instockamount") \
				_T(" FROM") \
				_T(" ( SELECT  product_categoryid as idx1, product_categoryname as groupname, product_code as id,        ") \
				_T(" CASE") \
				...
				_T("     WHERE sitemid > 0 %s") \
				 _T("     GROUP BY po_resource_id, product_categoryid, product_categoryname, product_groupid, product_groupname, product_code,") \
				_T("			  product_name, product_uomid, product_classname, %s, product_saleprice1 ") \
				_T(" ) tbl ") \
				_T(" WHERE (periodqty + impqty + expqty > 0)  ") \
				_T(" %s"), szCondition, szCondition, szCondition, szCondition, szCondition, szConditionStransfer, szStock, szConditionStransfer, szStock,
	...
	while(!rs.IsEOF())
	{
		if (1==1)
		{
			...
			rptDetail = rpt.AddDetail(rpt.GetGroupHeader(0));
			rs.GetValue(_T("v_nguonchi"), tmpStr);
