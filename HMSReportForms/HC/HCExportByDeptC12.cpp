...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CExportByDeptC12 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CExportByDeptC12 *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CExportByDeptC12* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CExportByDeptC12 *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CExportByDeptC12 *)pWnd)->OnStockAddNew();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CExportByDeptC12 *)pWnd)->OnTypeLoadData();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CExportByDeptC12 *pVw = (CExportByDeptC12 *)pWnd;
...
static int _OnAddExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDeptC12*)pWnd)->OnAddExportByDept();
} 
static int _OnEditExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDeptC12*)pWnd)->OnEditExportByDept();
} 
static int _OnDeleteExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDeptC12*)pWnd)->OnDeleteExportByDept();
} 
static int _OnSaveExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDeptC12*)pWnd)->OnSaveExportByDept();
} 
static int _OnCancelExportByDeptFnc(CWnd *pWnd){
	 return ((CExportByDeptC12*)pWnd)->OnCancelExportByDept();
} 
CExportByDeptC12::CExportByDeptC12(CWnd *pParent)
{
	m_nDlgWidth = 440;
	m_nDlgHeight = 130;
	SetDefaultValues();
}
CExportByDeptC12::~CExportByDeptC12()
{
}
void CExportByDeptC12::OnCreateComponents(){
...
void CExportByDeptC12::OnInitializeComponents(){
...
void CExportByDeptC12::OnSetWindowEvents(){
...
void CExportByDeptC12::OnDoDataExchange(CDataExchange* pDX){
...
void CExportByDeptC12::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CExportByDeptC12::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CExportByDeptC12::SetDefaultValues(){
...
int CExportByDeptC12::SetMode(int nMode){
...
/*void CExportByDeptC12::OnFromDateChange(){
	
} */
/*void CExportByDeptC12::OnFromDateSetfocus(){
	
} */
/*void CExportByDeptC12::OnFromDateKillfocus(){
	
} */
int CExportByDeptC12::OnFromDateCheckValue(){
	return 0;
} 
/*void CExportByDeptC12::OnToDateChange(){
	
} */
/*void CExportByDeptC12::OnToDateSetfocus(){
	
} */
/*void CExportByDeptC12::OnToDateKillfocus(){
	
} */
int CExportByDeptC12::OnToDateCheckValue(){
	return 0;
} 
void CExportByDeptC12::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CExportByDeptC12::OnStockSelendok(){
	 
}
/*void CExportByDeptC12::OnStockSetfocus(){
	
}*/
/*void CExportByDeptC12::OnStockKillfocus(){
	
}*/

long CExportByDeptC12::OnStockLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadStorageList(&m_wndStock, m_szStockKey);
}
/*void CExportByDeptC12::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
long CExportByDeptC12::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	int nCount = 0;
...
void CExportByDeptC12::OnPrintPreviewSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
...
void CExportByDeptC12::OnExportSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	CExcel xls;
	if (!xls.Load(_T("Exports\\Template\\BANGKEPHIEUXUAT_C12.xls"))) AfxMessageBox(_T("Load fail!"));
	...
	while(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("exportdate"), tmpStr);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\Template\\BANGKEPHIEUXUAT_C122.xls"));
	
} 
int CExportByDeptC12::OnAddExportByDept()
{
...
int CExportByDeptC12::OnEditExportByDept()
{
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
...
int CExportByDeptC12::OnDeleteExportByDept(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CExportByDeptC12::OnSaveExportByDept(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CExportByDeptC12::OnCancelExportByDept(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CExportByDeptC12::OnExportByDeptListLoadData(){
	return 0;
}

CString CExportByDeptC12::GetQueryString()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
...
szSQL.Format(_T(" WITH tbl AS") \
			...
			_T("    mt_orderno AS pname") \
			_T("   FROM m_transaction") \
			_T("   WHERE mt_status     = 'A'") \
			_T("   AND mt_doctype NOT IN ( 'DRO', 'CON', 'PRO', 'MRO', 'EXO' )") \
			_T("   %s") \
			_T("   )") \
			_T(" SELECT groupname,") \
			_T("   receiver,") \
			...
			_T("     to_char(mt_approveddate, 'DD/MM/YYYY') exportdate,") \
...
CString CExportByDeptC12::GetQueryString1()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
...
BEGIN_MESSAGE_MAP(CExportByDeptC12, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CExportByDeptC12::OnSetFocus(CWnd* pOldWnd)
{
