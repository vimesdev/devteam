#ifndef MAMATERIALUSAGEBYDISCHAREDEPT_H
#define MAMATERIALUSAGEBYDISCHAREDEPT_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAMaterialUsageByDischargeDept : public CGuiView{
protected:
public:
	...
	CMAMaterialUsageByDischargeDept(CWnd *pParent);
	~CMAMaterialUsageByDischargeDept();
