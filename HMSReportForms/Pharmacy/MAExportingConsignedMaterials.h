#ifndef MAEXPORTINGCONSIGNEDMATERIALS_H
#define MAEXPORTINGCONSIGNEDMATERIALS_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAExportingConsignedMaterials : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMAExportingConsignedMaterials(CWnd* pParent);
	~CMAExportingConsignedMaterials();
	...
	int OnAddMAExportingConsignedMaterials(); 
	int OnEditMAExportingConsignedMaterials(); 
	int OnDeleteMAExportingConsignedMaterials(); 
	int OnSaveMAExportingConsignedMaterials(); 
	int OnCancelMAExportingConsignedMaterials(); 
	int OnMAExportingConsignedMaterialsListLoadData();
