#ifndef RPTPMS108_BANGKENOPHAITRA_H
#define RPTPMS108_BANGKENOPHAITRA_H
...
#include "GuiView.h"
#include "DbField.h"
class CRptPMS108_BangKeNoPhaiTra : public CGuiView{
protected:
...
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CRptPMS108_BangKeNoPhaiTra(CWnd *pParent);
	~CRptPMS108_BangKeNoPhaiTra();
	...
	int OnAddRptPMS108_BangKeNoPhaiTra(); 
	int OnEditRptPMS108_BangKeNoPhaiTra(); 
	int OnDeleteRptPMS108_BangKeNoPhaiTra(); 
	int OnSaveRptPMS108_BangKeNoPhaiTra(); 
	int OnCancelRptPMS108_BangKeNoPhaiTra(); 
	int OnRptPMS108_BangKeNoPhaiTraListLoadData(); 
