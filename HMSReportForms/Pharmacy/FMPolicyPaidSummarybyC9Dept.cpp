#include "stdafx.h"
#include "FMPolicyPaidSummarybyC9Dept.h"
#include "HMSMainFrame.h"
#include "SearchPopup.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnYearKillfocus();
} */
static void _OnCreateDataSelectFnc(CWnd *pWnd)
{
	CFMPolicyPaidSummaryByC9Dept *pVw = (CFMPolicyPaidSummaryByC9Dept *)pWnd;
	pVw->OnCreateDataSelect();
} 

static void _OnObjectTypeSelendokFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnObjectTypeSelendok();
}

static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPaidSummaryByC9Dept* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnReportPeriodSelendok();
}
static int _OnListCheckAllInvoiceFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListCheckAllInvoice();
	return 0;
}
static int _OnListCheckAllRefundFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListCheckAllRefund();
	return 0;
}

/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnToDateCheckValue();
} 
static void _OnClerkSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPaidSummaryByC9Dept* )pWnd)->OnClerkSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnClerkSelendokFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnClerkSelendok();
}
/*static void _OnClerkSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnClerkKillfocus();
}*/
/*static void _OnClerkKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnClerkKillfocus();
}*/
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnClerkLoadData();
}
/*static void _OnClerkAddNewFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnClerkAddNew();
}*/
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPaidSummaryByC9Dept* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnStatusAddNew();
}*/
static void _OnOrderBySelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFMPolicyPaidSummaryByC9Dept* )pWnd)->OnOrderBySelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOrderBySelendokFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnOrderBySelendok();
}
/*static void _OnOrderBySetfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnOrderByKillfocus();
}*/
/*static void _OnOrderByKillfocusFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnOrderByKillfocus();
}*/
static long _OnOrderByLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnOrderByLoadData();
}
/*static void _OnOrderByAddNewFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnOrderByAddNew();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept*) pWnd)->OnDeptLoadData();
}
static void _OnWithoutGeneralSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnWithoutGeneralSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListDeleteItem();
} 
...
static void _OnInpatientSelectFnc(CWnd *pWnd){
	  ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	  ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnOutpatientSelect();
}
static void _OnDepositSelectFnc(CWnd *pWnd){
	  ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnDepositSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	  ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnAllSelect();
}
static int _OnAddFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnAddFMInsuranceReceiptSummary();
} 
static int _OnEditFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnEditFMInsuranceReceiptSummary();
} 
static int _OnDeleteFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnDeleteFMInsuranceReceiptSummary();
} 
static int _OnSaveFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnSaveFMInsuranceReceiptSummary();
} 
static int _OnCancelFMInsuranceReceiptSummaryFnc(CWnd *pWnd){
	 return ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnCancelFMInsuranceReceiptSummary();
}
static int _OnListSearchItemFnc(CWnd *pWnd){
	 ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListSearchItem();
	 return 0;
} 
static int _OnListCheckAllPTTYCFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListCheckAllPTTYC();
	return 0;
}

static int _OnListCheckAllTYCFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListCheckAllTYC();
	return 0;
}
static void _OnSODSelectFnc(CWnd *pWnd){
	  ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnSODSelect();
}

static int _OnListCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListCheckAllIns();
	return 0;
}
static int _OnListUnCheckAllInsInvoiceFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListUnCheckAllIns();
	return 0;
}

static int _OnListCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListCheckAllSolder();
	return 0;
}
static int _OnListUnCheckAllSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListUnCheckAllSolder();
	return 0;
}
static int _OnListCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListCheckAllInsSolder();
	return 0;
}
static int _OnListUnCheckAllInsSolderFnc(CWnd *pWnd)
{
	((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnListUnCheckAllInsSolder();
	return 0;
}
static void _OnSoldierWCardSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnSoldierWCardSelect();
}

static long _OnObjectTypeLoadDataFnc(CWnd *pWnd)
{
	return ((CFMPolicyPaidSummaryByC9Dept *)pWnd)->OnObjectTypeLoadData();
}
static void _OnABZoneSelectFnc(CWnd *pWnd)
{
	 ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnABZoneSelect();
}
static void _OnTCKTSelectFnc(CWnd *pWnd){
	 ((CFMPolicyPaidSummaryByC9Dept*)pWnd)->OnTCKTSelect();
}



CFMPolicyPaidSummaryByC9Dept::CFMPolicyPaidSummaryByC9Dept(CWnd *pParent)
{
	m_nDlgWidth = 435;
	m_nDlgHeight = 570;
	SetDefaultValues();
}
CFMPolicyPaidSummaryByC9Dept::~CFMPolicyPaidSummaryByC9Dept()
{
}
void CFMPolicyPaidSummaryByC9Dept::OnCreateComponents()
{
...
void CFMPolicyPaidSummaryByC9Dept::OnInitializeComponents()
{
...
void CFMPolicyPaidSummaryByC9Dept::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPaidSummaryByC9Dept::OnDoDataExchange(CDataExchange* pDX){
...
void CFMPolicyPaidSummaryByC9Dept::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFMPolicyPaidSummaryByC9Dept::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CFMPolicyPaidSummaryByC9Dept::SetDefaultValues(){
...
int CFMPolicyPaidSummaryByC9Dept::SetMode(int nMode){
...
/*void CFMPolicyPaidSummaryByC9Dept::OnYearChange(){
	
} */
/*void CFMPolicyPaidSummaryByC9Dept::OnYearSetfocus(){
	
} */
/*void CFMPolicyPaidSummaryByC9Dept::OnYearKillfocus(){
	
} */
int CFMPolicyPaidSummaryByC9Dept::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CFMPolicyPaidSummaryByC9Dept::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMPolicyPaidSummaryByC9Dept::OnTCKTSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
}
void CFMPolicyPaidSummaryByC9Dept::OnCreateDataSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPaidSummaryByC9Dept::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CFMPolicyPaidSummaryByC9Dept::OnReportPeriodSetfocus(){
	
}*/
/*void CFMPolicyPaidSummaryByC9Dept::OnReportPeriodKillfocus(){
	
}*/
long CFMPolicyPaidSummaryByC9Dept::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CFMPolicyPaidSummaryByC9Dept::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CFMPolicyPaidSummaryByC9Dept::OnFromDateChange(){
	
} */
/*void CFMPolicyPaidSummaryByC9Dept::OnFromDateSetfocus(){
	
} */
/*void CFMPolicyPaidSummaryByC9Dept::OnFromDateKillfocus(){
	
} */
int CFMPolicyPaidSummaryByC9Dept::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
/*void CFMPolicyPaidSummaryByC9Dept::OnToDateChange(){
	
} */
/*void CFMPolicyPaidSummaryByC9Dept::OnToDateSetfocus(){
	
} */
/*void CFMPolicyPaidSummaryByC9Dept::OnToDateKillfocus(){
	
} */
int CFMPolicyPaidSummaryByC9Dept::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
}
 
void CFMPolicyPaidSummaryByC9Dept::OnClerkSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

long CFMPolicyPaidSummaryByC9Dept::OnObjectTypeLoadData()
{
...
void CFMPolicyPaidSummaryByC9Dept::OnObjectTypeSelendok()
{
	OnListLoadData();
}
void CFMPolicyPaidSummaryByC9Dept::OnABZoneSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();
}
...
void CFMPolicyPaidSummaryByC9Dept::OnSoldierWCardSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}

void CFMPolicyPaidSummaryByC9Dept::OnClerkSelendok(){
	 
}
int CFMPolicyPaidSummaryByC9Dept::OnListCheckAllTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
...
int CFMPolicyPaidSummaryByC9Dept::OnListCheckAllPTTYC()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
void CFMPolicyPaidSummaryByC9Dept::OnListSearchItem(){
	CSearchPopup *newPopup = new CSearchPopup(&m_wndList);
	newPopup->ShowPopup(&m_wndList);
}
void CFMPolicyPaidSummaryByC9Dept::OnSODSelect(){
	OnListLoadData();
}
/*void CFMPolicyPaidSummaryByC9Dept::OnClerkSetfocus(){
	
}*/
/*void CFMPolicyPaidSummaryByC9Dept::OnClerkKillfocus(){
	
}*/
long CFMPolicyPaidSummaryByC9Dept::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CFMPolicyPaidSummaryByC9Dept::OnClerkAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPaidSummaryByC9Dept::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPaidSummaryByC9Dept::OnStatusSelendok(){
	 OnListLoadData();
}
/*void CFMPolicyPaidSummaryByC9Dept::OnStatusSetfocus(){
	
}*/
/*void CFMPolicyPaidSummaryByC9Dept::OnStatusKillfocus(){
	
}*/
long CFMPolicyPaidSummaryByC9Dept::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPaidSummaryByC9Dept::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CFMPolicyPaidSummaryByC9Dept::OnOrderBySelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CFMPolicyPaidSummaryByC9Dept::OnOrderBySelendok(){
	 
}
/*void CFMPolicyPaidSummaryByC9Dept::OnOrderBySetfocus(){
	
}*/
/*void CFMPolicyPaidSummaryByC9Dept::OnOrderByKillfocus(){
	
}*/
long CFMPolicyPaidSummaryByC9Dept::OnOrderByLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CFMPolicyPaidSummaryByC9Dept::OnOrderByAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

long CFMPolicyPaidSummaryByC9Dept::OnDeptLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CFMPolicyPaidSummaryByC9Dept::OnWithoutGeneralSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CFMPolicyPaidSummaryByC9Dept::OnListDblClick(){
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0) return;
	BOOL bCheck = m_wndList.GetCheck(nSel);
	m_wndList.SetCheck(nSel, bCheck);
} 
void CFMPolicyPaidSummaryByC9Dept::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CFMPolicyPaidSummaryByC9Dept::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CFMPolicyPaidSummaryByC9Dept::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPaidSummaryByC9Dept::OnMarkAllSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int i = 0;
...
void CFMPolicyPaidSummaryByC9Dept::OnUnMarkSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	for(int i = 0; i < m_wndList.GetItemCount(); i++)
	{
...
void CFMPolicyPaidSummaryByC9Dept::OnInpatientSelect(){
	
}
void CFMPolicyPaidSummaryByC9Dept::OnOutpatientSelect(){
	
}
void CFMPolicyPaidSummaryByC9Dept::OnDepositSelect(){
	
}
void CFMPolicyPaidSummaryByC9Dept::OnAllSelect(){
	
}
 
 
int CFMPolicyPaidSummaryByC9Dept::OnAddFMInsuranceReceiptSummary(){
...
int CFMPolicyPaidSummaryByC9Dept::OnEditFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CFMPolicyPaidSummaryByC9Dept::OnDeleteFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CFMPolicyPaidSummaryByC9Dept::OnSaveFMInsuranceReceiptSummary(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CFMPolicyPaidSummaryByC9Dept::OnCancelFMInsuranceReceiptSummary(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CFMPolicyPaidSummaryByC9Dept::OnFMInsuranceReceiptSummaryListLoadData(){
	return 0;
}


#include "../HospitalFee/FMInsurancePostedReceiptVoucherList.h"
void CFMPolicyPaidSummaryByC9Dept::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CFMPolicyPaidSummaryByC9Dept::OnPrint1stver(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPaidSummaryByC9Dept::OnPrint2ndver()
...
_tprintf(_T("\r\n5"));
	...
	rpt.GetReportHeader()->SetValue(_T("ClassName"), _T("CFMPolicyPaidSummaryByC9Dept"));
...
void CFMPolicyPaidSummaryByC9Dept::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	CGuiMenu menu(this);
	...
	TranslateString(_T("Xuất TH theo bệnh nhân, mỗi bệnh nhân 1 dòng"), tmpStr);
	...
	switch (nPos)
	{
		...
		case 6:
			OnExportDetailEXSelect();
			break;
	}
}
void CFMPolicyPaidSummaryByC9Dept::OnExportPatientList()
{	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPaidSummaryByC9Dept::OnExportDetailSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CFMPolicyPaidSummaryByC9Dept::OnExportTotalList(int nVersion)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
void CFMPolicyPaidSummaryByC9Dept::OnExportTotalList1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString()
{
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString2()
{
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString_check()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CFMPolicyPaidSummaryByC9Dept::OnListCheckAllInvoice()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnListCheckAllRefund()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnListCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnListUnCheckAllIns()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnListCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnListUnCheckAllSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnListCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnListUnCheckAllInsSolder()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szItemText;	
	for (int i=0; i<m_wndList.GetItemCount(); i++)	
...
int CFMPolicyPaidSummaryByC9Dept::OnDeleteDataBeforeInsert()
{
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL; 	
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString3()
{
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString_v2()
{
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString_check_v2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString_v3()
{
...
void CFMPolicyPaidSummaryByC9Dept::OnExportDetailEXSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, szTemp, szWhere, szOldDept, szNewDept;
...
CString CFMPolicyPaidSummaryByC9Dept::GetQueryString_v2_EX()
{
  ...
  szSQL4.Format(_T("     UNION ALL") \
				...
				_T("     AND F.Hfe_type       ='O'") \
				_T("     AND f.hfe_category  NOT IN ('Y')"), szWhere);
	//5.Phi thuoc ngoai tru, check ma kho 14 = "Nhà thuốc số 1"  //
  szSQL5.Format(_T("     UNION ALL     ") \
				_T("     SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
				_T("       f.hfe_invoiceno,") \
...
szSQL10.Format(_T("     UNION ALL") \
				...
				_T("     AND f.hfe_deptid = 'B5'") \
				_T("     AND (hfe_category NOT IN ('Y') OR (hfe_category='Y' AND HFE_TREAT_INPACKAGE='Y'))"), szWhere);
	//11.Phi mau tach rieng ra cho khoa C16//
 szSQL11.Format(_T("     UNION ALL") \
				_T("     SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
				_T("       f.hfe_invoiceno,") \
				...
				_T("     AND product_org_id NOT IN ('MA','PM', 'HC', 'PĐD')") \
				_T("     AND hfe_category       NOT IN ('Y')"), szWhere);
//12. Phi khac PTC nhap o tab phi khac//
 szSQL12.Format(_T("     UNION ALL") \
				_T("     SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
				_T("       f.hfe_invoiceno,") \
...
szSQL16.Format(_T("     UNION ALL") \
				...
				_T("     AND product_org_id NOT IN ('PM','BB')") \
				_T("     AND hfe_category     ='Y'"), szWhere);
//17.Phi thuoc trong goi, dung cho truong hop thu phi PTTT truoc sau do moi nhap thuoc trong goi o phong kham//
 szSQL17.Format(_T("     UNION ALL     ") \
				_T("       SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
				_T("       f.hfe_invoiceno,") \
				...
				_T("     AND product_org_id NOT IN ('MA','BB', 'HC', 'PĐD')") \
				_T("     AND hfe_category ='Y'"), szWhere);
//18.Phi tien vat tu trong goi, dung cho truong hop thu phi PTTT truoc nhap vat tu sau//
szSQL18.Format(_T("     UNION ALL") \
				_T("     SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
				_T("       f.hfe_invoiceno,") \
		...
		//19. Phi thu goi, them vao ngay 13/11/2018//
szSQL19.Format(_T("     UNION ALL") \
				_T("     SELECT f.hfe_docno,") \
				_T("       f.hfe_type,") \
				_T("       f.hfe_invoiceno,") \
