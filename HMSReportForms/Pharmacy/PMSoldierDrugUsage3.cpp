#include "stdafx.h"
#include "PMSoldierDrugUsage3.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsage3 *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSoldierDrugUsage3* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsage3 *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsage3 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsage3 *)pWnd)->OnToDateCheckValue();
} 
static void _OnExaminationSelectFnc(CWnd *pWnd){
	 ((CPMSoldierDrugUsage3*)pWnd)->OnExaminationSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	 ((CPMSoldierDrugUsage3*)pWnd)->OnOutpatientSelect();
}
static void _OnInwardSelectFnc(CWnd *pWnd){
	 ((CPMSoldierDrugUsage3*)pWnd)->OnInwardSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CPMSoldierDrugUsage3 *pVw = (CPMSoldierDrugUsage3 *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsage3*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPMSoldierDrugUsage3*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CPMSoldierDrugUsage3*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsage3*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CPMSoldierDrugUsage3*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPMSoldierDrugUsage3*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CPMSoldierDrugUsage3*)pWnd)->OnDeptListDeleteItem();
} 
CPMSoldierDrugUsage3::CPMSoldierDrugUsage3(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CPMSoldierDrugUsage3::~CPMSoldierDrugUsage3(){
}
void CPMSoldierDrugUsage3::OnCreateComponents(){
...
void CPMSoldierDrugUsage3::OnInitializeComponents(){
...
void CPMSoldierDrugUsage3::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CPMSoldierDrugUsage3::OnDoDataExchange(CDataExchange* pDX){
...
void CPMSoldierDrugUsage3::SetDefaultValues(){
...
int CPMSoldierDrugUsage3::SetMode(int nMode){
...
/*void CPMSoldierDrugUsage3::OnYearChange(){
	
} */
/*void CPMSoldierDrugUsage3::OnYearSetfocus(){
	
} */
/*void CPMSoldierDrugUsage3::OnYearKillfocus(){
	
} */
int CPMSoldierDrugUsage3::OnYearCheckValue(){
	return 0;
}
 
void CPMSoldierDrugUsage3::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CPMSoldierDrugUsage3::OnReportPeriodSelendok(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CDate dte;
	CString tmpStr;
...
/*void CPMSoldierDrugUsage3::OnReportPeriodSetfocus(){
	
}*/
/*void CPMSoldierDrugUsage3::OnReportPeriodKillfocus(){
	
}*/
long CPMSoldierDrugUsage3::OnReportPeriodLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CPMSoldierDrugUsage3::OnReportPeriodAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CPMSoldierDrugUsage3::OnFromDateChange(){
	
} */
/*void CPMSoldierDrugUsage3::OnFromDateSetfocus(){
	
} */
/*void CPMSoldierDrugUsage3::OnFromDateKillfocus(){
	
} */
int CPMSoldierDrugUsage3::OnFromDateCheckValue(){
	return 0;
}
 
/*void CPMSoldierDrugUsage3::OnToDateChange(){
	
} */
/*void CPMSoldierDrugUsage3::OnToDateSetfocus(){
	
} */
/*void CPMSoldierDrugUsage3::OnToDateKillfocus(){
	
} */
int CPMSoldierDrugUsage3::OnToDateCheckValue(){
	return 0;
}
 
void CPMSoldierDrugUsage3::OnExaminationSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	OnDeptListLoadData();
	if (m_bExamination)
...
void CPMSoldierDrugUsage3::OnOutpatientSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}

void CPMSoldierDrugUsage3::OnInwardSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}

void CPMSoldierDrugUsage3::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	/*Declaration Section*/
...
void CPMSoldierDrugUsage3::OnExportSelect(){
	CMainFrame_E10 *pMF	= (CMainFrame_E10*)	AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
...
void CPMSoldierDrugUsage3::OnExport(){
	CMainFrame_E10 *pMF	= (CMainFrame_E10*)	AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CRecord	rs(&pMF->m_db);
...
void CPMSoldierDrugUsage3::OnExport2(){
	CMainFrame_E10 *pMF	= (CMainFrame_E10*)	AfxGetMainWnd();
...
void CPMSoldierDrugUsage3::OnObjectListDblClick(){
	
}
 
void CPMSoldierDrugUsage3::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
int CPMSoldierDrugUsage3::OnObjectListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
}
 
long CPMSoldierDrugUsage3::OnObjectListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CPMSoldierDrugUsage3::OnDeptListDblClick(){
	
}
 
void CPMSoldierDrugUsage3::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
int CPMSoldierDrugUsage3::OnDeptListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
}
 
long CPMSoldierDrugUsage3::OnDeptListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
CString CPMSoldierDrugUsage3::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT    Get_patientname(doc_no) patient_name, ") \
				...
				_T("           WHERE     htr_outpatient = 'N' AND hcr_status = 'T' AND hcrf_acceptedfee IN ( 'Y', 'P' ) %s") \
				_T("           UNION ALL ") \
				_T("           SELECT hd_docno, ") \
				_T("                              htrf_invoicefee, ") \
				_T("                              htr_deptid, ") \
				...
				_T("           LEFT JOIN hms_treatment_record ON ( hcr_docno = htr_docno ) ") \
				_T("           LEFT JOIN hms_doc ON ( hcr_docno = hd_docno ) ") \
				_T("           WHERE     htr_outpatient = 'Y' AND htr_status = 'T' AND htrf_acceptedfee IN ( 'Y', 'P' ) %s)") \
...
CString CPMSoldierDrugUsage3::GetQueryString1(){
...
CString CPMSoldierDrugUsage3::GetQueryString2(){
	CString szSQL, szWhere, szWhereObject, szObjects, szDepts;
	szWhere.Format(_T(" AND discharge_date BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
...
CString CPMSoldierDrugUsage3::GetQueryString3(){
	CString szSQL, szWhere, szObjects, szDepts;
	szWhere.Format(_T(" AND hpo_approvedate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
	...
	szSQL.Format(_T(" SELECT") \
		...
		_T(" WHERE hd_suggestion NOT IN ('C', 'D')") \
		_T(" AND hpol_inoperation <> 'Y'") \
		_T(" AND mp_org_id       = 'PM'") \
		_T(" AND hpo_orderstatus NOT IN ('O', 'C') %s") \
		_T(" GROUP BY") \
		_T(" mp_serial, mp_name,") \
		_T(" hfg_level,") \
		_T(" mp_name2,") \
