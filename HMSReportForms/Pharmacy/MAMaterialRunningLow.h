#ifndef MAMATERIALRUNNINGLOW_H
#define MAMATERIALRUNNINGLOW_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAMaterialRunningLow : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMAMaterialRunningLow(CWnd *pParent);
	~CMAMaterialRunningLow();
	...
	int OnAddMAMaterialRunningLow(); 
	int OnEditMAMaterialRunningLow(); 
	int OnDeleteMAMaterialRunningLow(); 
	int OnSaveMAMaterialRunningLow(); 
	int OnCancelMAMaterialRunningLow(); 
	int OnMAMaterialRunningLowListLoadData();
