#ifndef PMSudungthuocBHYT20a_H
#define PMSudungthuocBHYT20a_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSudungthuocBHYT20a : public CGuiView{
protected:
...
public:
	...
	CGuiCheckBox	m_wndDischargedDateUnpaid;
	CGuiCheckBox	m_wndDischargedDatePaid;
	...
	BOOL	m_bDischargedDateUnpaid;
	BOOL	m_bDischargedDatePaid;
	...
	void			OnDischargedDateUnpaidSelect(); 
	void			OnDischargedDatePaidSelect(); 

	CPMSudungthuocBHYT20a(CWnd *pParent);
	~CPMSudungthuocBHYT20a();
	...
	int OnAddPMSudungthuocBHYT20a(); 
	int OnEditPMSudungthuocBHYT20a(); 
	int OnDeletePMSudungthuocBHYT20a(); 
	int OnSavePMSudungthuocBHYT20a(); 
	int OnCancelPMSudungthuocBHYT20a(); 
	int OnPMSudungthuocBHYT20aListLoadData(); 
