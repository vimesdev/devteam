#ifndef PMConfirmLiabilities2_H
#define PMConfirmLiabilities2_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMConfirmLiabilities2 : public CGuiView{
protected:
public:
	...
	CPMConfirmLiabilities2(CWnd *pParent);
	~CPMConfirmLiabilities2();
