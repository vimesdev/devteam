#ifndef PMSERVICEDRUGUSAGEDETAIL_DONGY_H
#define PMSERVICEDRUGUSAGEDETAIL_DONGY_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMServiceDrugUsageDetail_Dongy : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CPMServiceDrugUsageDetail_Dongy(CWnd *pWnd);
	~CPMServiceDrugUsageDetail_Dongy();
