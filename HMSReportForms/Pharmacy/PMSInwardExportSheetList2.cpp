#include "stdafx.h"
#include "PMSInwardExportSheetList2.h"
#include "MainFrame_E10.h"
#include "Excel.h"
#include "ReportDocument.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSInwardExportSheetList2 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSInwardExportSheetList2 *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSInwardExportSheetList2* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CPMSInwardExportSheetList2 *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CPMSInwardExportSheetList2 *)pWnd)->OnStockAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CPMSInwardExportSheetList2 *pVw = (CPMSInwardExportSheetList2 *)pWnd;
...
static int _OnAddPMSExportSheetListFnc(CWnd *pWnd){
	 return ((CPMSInwardExportSheetList2*)pWnd)->OnAddPMSExportSheetList();
} 
static int _OnEditPMSExportSheetListFnc(CWnd *pWnd){
	 return ((CPMSInwardExportSheetList2*)pWnd)->OnEditPMSExportSheetList();
} 
static int _OnDeletePMSExportSheetListFnc(CWnd *pWnd){
	 return ((CPMSInwardExportSheetList2*)pWnd)->OnDeletePMSExportSheetList();
} 
static int _OnSavePMSExportSheetListFnc(CWnd *pWnd){
	 return ((CPMSInwardExportSheetList2*)pWnd)->OnSavePMSExportSheetList();
} 
static int _OnCancelPMSExportSheetListFnc(CWnd *pWnd){
	 return ((CPMSInwardExportSheetList2*)pWnd)->OnCancelPMSExportSheetList();
} 
CPMSInwardExportSheetList2::CPMSInwardExportSheetList2(CWnd *pParent){

	m_nDlgWidth = 440;
	m_nDlgHeight = 130;
	SetDefaultValues();
}
CPMSInwardExportSheetList2::~CPMSInwardExportSheetList2(){
}
void CPMSInwardExportSheetList2::OnCreateComponents(){
...
void CPMSInwardExportSheetList2::OnInitializeComponents(){
...
void CPMSInwardExportSheetList2::OnSetWindowEvents(){
...
void CPMSInwardExportSheetList2::OnDoDataExchange(CDataExchange* pDX){
...
void CPMSInwardExportSheetList2::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CPMSInwardExportSheetList2::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CPMSInwardExportSheetList2::SetDefaultValues(){
...
int CPMSInwardExportSheetList2::SetMode(int nMode){
...
/*void CPMSInwardExportSheetList2::OnFromDateChange(){
	
} */
/*void CPMSInwardExportSheetList2::OnFromDateSetfocus(){
	
} */
/*void CPMSInwardExportSheetList2::OnFromDateKillfocus(){
	
} */
int CPMSInwardExportSheetList2::OnFromDateCheckValue(){
	return 0;
} 
/*void CPMSInwardExportSheetList2::OnToDateChange(){
	
} */
/*void CPMSInwardExportSheetList2::OnToDateSetfocus(){
	
} */
/*void CPMSInwardExportSheetList2::OnToDateKillfocus(){
	
} */
int CPMSInwardExportSheetList2::OnToDateCheckValue(){
	return 0;
} 
void CPMSInwardExportSheetList2::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMSInwardExportSheetList2::OnStockSelendok(){
	 
}
/*void CPMSInwardExportSheetList2::OnStockSetfocus(){
	
}*/
/*void CPMSInwardExportSheetList2::OnStockKillfocus(){
	
}*/

long CPMSInwardExportSheetList2::OnStockLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadStorageList(&m_wndStock, m_szStockKey);
}
/*void CPMSInwardExportSheetList2::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CPMSInwardExportSheetList2::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
...
void CPMSInwardExportSheetList2::OnPrint1(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
...
void CPMSInwardExportSheetList2::OnPrint2(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
...
void CPMSInwardExportSheetList2::OnExportSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
	menu.CreatePopupMenu();
...
void CPMSInwardExportSheetList2::OnExport1(){
...
void CPMSInwardExportSheetList2::OnExport2(){
	_debug(_T("%s"), CString(typeid(this).name()));
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
...
int CPMSInwardExportSheetList2::OnAddPMSExportSheetList(){
...
int CPMSInwardExportSheetList2::OnEditPMSExportSheetList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CPMSInwardExportSheetList2::OnDeletePMSExportSheetList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CPMSInwardExportSheetList2::OnSavePMSExportSheetList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CPMSInwardExportSheetList2::OnCancelPMSExportSheetList(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CPMSInwardExportSheetList2::OnPMSExportSheetListListLoadData(){
	return 0;
}

CString CPMSInwardExportSheetList2::GetQueryString(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
...
CString CPMSInwardExportSheetList2::GetQueryString2(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CString szSQL, szWhere, szCondition, szCondition2, szStock;
	szWhere.Format(_T(" AND order_status = 'A' AND expdate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);
	for (int i = 0; i < m_wndStock.GetItemCount(); i++)
...
BEGIN_MESSAGE_MAP(CPMSInwardExportSheetList2, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CPMSInwardExportSheetList2::OnSetFocus(CWnd* pOldWnd)
{
