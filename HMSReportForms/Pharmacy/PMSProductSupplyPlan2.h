#ifndef PMSProductSupplyPlan2_H
#define PMSProductSupplyPlan2_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSProductSupplyPlan2 : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CPMSProductSupplyPlan2(CWnd *pParent);
	~CPMSProductSupplyPlan2();
