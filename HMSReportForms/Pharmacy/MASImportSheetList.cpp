...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMASImportSheetList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMASImportSheetList *)pWnd)->OnToDateCheckValue();
} 
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASImportSheetList* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CMASImportSheetList *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnStorageAddNew();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CMASImportSheetList*)pWnd)->OnTypeLoadData();
}
static long _OnSupplierLoadDataFnc(CWnd *pWnd){
	return ((CMASImportSheetList *)pWnd)->OnSupplierLoadData();
}
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASImportSheetList* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CMASImportSheetList *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CMASImportSheetList *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnNonInvoiceImportSelectFnc(CWnd *pWnd){
	((CMASImportSheetList*)pWnd)->OnNonInvoiceImportSelect();
}
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CMASImportSheetList *pVw = (CMASImportSheetList *)pWnd;
...
static void _OnChitinhhoadonnhapSelectFnc(CWnd *pWnd){
	 ((CMASImportSheetList*)pWnd)->OnChitinhhoadonnhapSelect();
}

CMASImportSheetList::CMASImportSheetList(CWnd *pParent){

	m_nDlgWidth = 545;
	m_nDlgHeight = 155;
	SetDefaultValues();
}
CMASImportSheetList::~CMASImportSheetList(){
}
void CMASImportSheetList::OnCreateComponents(){
	...
	m_wndChitinhhoadonnhap.Create(this, _T("Chỉ tính hóa đơn nhập kho"), 5, 154, 260, 179);*/
	...
	m_wndToDate.Create(this,375, 30, 570, 55);
	m_wndStorage.SetCheckBox(true);
	m_wndGeneralDepartmentUsage.Create(this, _T("Import Sheet List"), 5, 4, 575, 148);
	m_wndStorageLabel.Create(this, _T("Storage"), 10, 60, 90, 85);
	m_wndStorage.Create(this,95, 60, 285, 85); 
	m_wndItemGroupLabel.Create(this, _T("Item Group"), 290, 60, 370, 85);
	m_wndItemGroup.Create(this,375, 60, 570, 85); 
	m_wndSupplierLabel.Create(this, _T("Supplier"), 10, 90, 90, 115);
	m_wndSupplier.Create(this,95, 90, 570, 115); 
	m_wndTypeLabel.Create(this, _T("Phân loại"), 10, 119, 90, 144);
	m_wndType.Create(this,95, 119, 570, 144); 
	m_wndNonInvoiceImport.Create(this, _T("NonInvoice Import"), 5, 154, 155, 179);
	m_wndGroupByType.Create(this, _T("Group by Type"), 160, 154, 260, 179);
	m_wndReturnImport.Create(this, _T("Return Import"), 265, 154, 365, 179);
	m_wndGroupByCompany.Create(this, _T("Group by Company"), 370, 154, 470, 179);
	m_wndChitinhhoadonnhap.Create(this, _T("Chỉ tính hóa đơn nhập kho"), 5, 183, 260, 208);
	m_wndPrintPreview.Create(this, _T("&Print Preview"), 380, 184, 490, 209);
	m_wndExport.Create(this, _T("&Export"), 495, 184, 575, 209);

}
void CMASImportSheetList::OnInitializeComponents(){
...
void CMASImportSheetList::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	m_wndChitinhhoadonnhap.SetEvent(WE_CLICK, _OnChitinhhoadonnhapSelectFnc);
...
void CMASImportSheetList::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndChitinhhoadonnhap.GetDlgCtrlID(), m_bChitinhhoadonnhap);
}
void CMASImportSheetList::SetDefaultValues(){
	...
	m_bChitinhhoadonnhap=FALSE;

}
int CMASImportSheetList::SetMode(int nMode){
...
/*void CMASImportSheetList::OnFromDateChange(){
	
} */
/*void CMASImportSheetList::OnFromDateSetfocus(){
	
} */
/*void CMASImportSheetList::OnFromDateKillfocus(){
	
} */
int CMASImportSheetList::OnFromDateCheckValue(){
	return 0;
} 
/*void CMASImportSheetList::OnToDateChange(){
	
} */
/*void CMASImportSheetList::OnToDateSetfocus(){
	
} */
/*void CMASImportSheetList::OnToDateKillfocus(){
	
} */
int CMASImportSheetList::OnToDateCheckValue(){
	return 0;
} 
void CMASImportSheetList::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASImportSheetList::OnStorageSelendok(){
	 
}
/*void CMASImportSheetList::OnStorageSetfocus(){
	
}*/
/*void CMASImportSheetList::OnStorageKillfocus(){
	
}*/
long CMASImportSheetList::OnStorageLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
long CMASImportSheetList::OnTypeLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	//return pMF->LoadPaymentResourceList(&m_wndSource, m_szSourceKey);
	m_wndType.AddItems(_T("I"), _T("N\x1ED9i \x62\x1ED9"), NULL);
	m_wndType.AddItems(_T("P"), _T("Th\x61nh to\xE1n"), NULL);
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CMASImportSheetList::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASImportSheetList::OnItemGroupSelendok(){
	 
}
/*void CMASImportSheetList::OnItemGroupSetfocus(){
	
}*/
/*void CMASImportSheetList::OnItemGroupKillfocus(){
	
}*/

void CMASImportSheetList::OnChitinhhoadonnhapSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
long CMASImportSheetList::OnItemGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	int nCount = 0;
...
/*void CMASImportSheetList::OnItemGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
long CMASImportSheetList::OnSupplierLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadPartnerList(&m_wndSupplier, m_szSupplierKey);
}
void CMASImportSheetList::OnNonInvoiceImportSelect(){
}
void CMASImportSheetList::OnPrintPreviewSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	int nIdx = 1, j = 0;
	if (!rpt.Init(_T("Reports\\HMS\\MA_BANGKEPHIEUNHAP.RPT")))
		return;
...
// 		rptHeader->SetValue(_T("Type"), tmpStr);
	...
	while (!rs.IsEOF())
	{
		...
		rptDetail->SetValue(_T("2"), rs.GetValue(_T("documentno")));
...
void CMASImportSheetList::OnExportSelect(){
	...
	xls.SetCellText(nCol+7, nRow, _T("Ngày hóa đơn"), FMT_TEXT | FMT_CENTER | FMT_VCENTER | FMT_WRAPING, true);
	xls.SetCellText(nCol+8, nRow, _T("Ghi \x63h\xFA"), FMT_TEXT | FMT_CENTER | FMT_VCENTER | FMT_WRAPING, true);
	xls.SetCellText(nCol + 9, nRow, _T("MST"), FMT_TEXT | FMT_CENTER | FMT_VCENTER | FMT_WRAPING, true);
	nRow = 6;
	while (!rs.IsEOF())
	{
		if (m_bGroupbyType)
		...
		if (szNewGroup != szOldGroup && !szNewGroup.IsEmpty())
		{
			...
			if (m_bGroupbyType)
				...
				tmpStr = szNewGroup;
				//tmpStr = szNewGroup + _T("   MST: ") + rs.GetValue(_T("taxcode"));
			xls.SetCellText(nCol, nRow, tmpStr, FMT_TEXT, true);
			xls.SetCellText(nCol + 9, nRow, rs.GetValue(_T("taxcode")), FMT_TEXT, true);
			szOldGroup = szNewGroup;
			nIdx = 1;
			nRow++;
		}
		...
		xls.SetCellText(nCol+7, nRow, rs.GetValue(_T("invoidate")), FMT_TEXT);
		xls.SetCellText(nCol+8, nRow, rs.GetValue(_T("ordno")), FMT_TEXT);
		nRow++;
		rs.MoveNext();
	}
	if (nGrpAmt > 0)
...
CString CMASImportSheetList::GetQueryString()
{
	CMainFrame_E10 * pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szType, szOnlyInvoices, szSQL, szTransactionWhere, szPurchaseWhere, szReturnWhere, szReturnWhere1, szStorages, szCondition, szReturnImport, szPrice, szPrice1, szPrice2, szDept;
	...
	if (m_bReturnImport)
	{
		szReturnImport.Format(_T("  UNION ALL") \
			...
			_T("     Get_departmentname(mt_department_id), Cast('' AS NVARCHAR2(1))  as taxcode,") \
			_T("     First_value(product_name) OVER ( partition BY mt_transaction_id ORDER BY product_name ASC),") \
			_T("     trunc(mt_approveddate),") \
			_T("     to_char(mt_orderdate, 'DD/MM/YYYY') as invoidate, ") \
			_T("     product_groupid,") \
			...
			_T("     Get_departmentname(hpo_deptid), Cast('' AS NVARCHAR2(1))  as taxcode,") \
			...
			_T("     to_char(hpo_approveddate, 'DD/MM/YYYY'),") \
			_T("     product_groupid,") \
			_T("     product_groupname,") \
	...
	if (m_bChitinhhoadonnhap)
		szOnlyInvoices = _T(" WHERE 1=1 AND doctype='POO' ");


	if (!m_szTypeKey.IsEmpty())
	{
		szType.AppendFormat(_T(" AND PO_SALEPERSON_ID = '%s'"), m_szTypeKey);	
	}
	...
	szSQL.Format(_T(" SELECT doctype, ") \
				...
				_T("					Cast ('' AS NVARCHAR2(1))  as taxcode,") \
				...
				_T("                   to_char(po_invoicedate, 'DD/MM/YYYY') as invoidate, ") \
				_T("				   product_groupid,") \
				_T("				   product_groupname,") \
				_T("                   %s") \
				...
				_T("         WHERE     po_status = 'A' %s %s %s) ") \
				_T(" %s GROUP BY doctype, ") \
				_T("          ordno, ") \
				_T("          documentno, ") \
				_T("          invno, ") \
				_T("          dept, taxcode, productname, ") \
				_T("		  %s") \
				_T("		  impdte, invoidate ") \
				_T(" ORDER  BY %s documentno, doctype, ordno,") \
				_T("		   %s") \
				_T("           impdte, productname "), szCondition, szPrice1, szTransactionWhere, szPrice, szPurchaseWhere, szReturnImport, szType, szOnlyInvoices, szCondition, szDept, szCondition);
	return szSQL;
}

CString CMASImportSheetList::GetQueryString1(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
BEGIN_MESSAGE_MAP(CMASImportSheetList, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CMASImportSheetList::OnSetFocus(CWnd* pOldWnd)
{
