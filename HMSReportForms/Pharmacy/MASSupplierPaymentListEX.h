#ifndef MASSupplierPaymentListEX_H
#define MASSupplierPaymentListEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASSupplierPaymentListEX : public CGuiView
{
...
public:
	...
	CMASSupplierPaymentListEX(CWnd *pParent);
	~CMASSupplierPaymentListEX();
