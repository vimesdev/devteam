#ifndef RPTPMS108_BANGKEPHIEUNHAP_H
#define RPTPMS108_BANGKEPHIEUNHAP_H
...
#include "GuiView.h"
#include "DbField.h"
class CRptPMS108_BangKePhieuNhap : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CRptPMS108_BangKePhieuNhap(CWnd *pParent);
	~CRptPMS108_BangKePhieuNhap();
	...
	int OnAddRptPMS108_BangKePhieuNhap(); 
	int OnEditRptPMS108_BangKePhieuNhap(); 
	int OnDeleteRptPMS108_BangKePhieuNhap(); 
	int OnSaveRptPMS108_BangKePhieuNhap(); 
	int OnCancelRptPMS108_BangKePhieuNhap(); 
	int OnRptPMS108_BangKePhieuNhapListLoadData();
