#include "stdafx.h"
#include "MASDepartmentUsageinDetail_108Old.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"
#include ".\pmsdepartmentusageindetail.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnToDateCheckValue();
} 
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASDepartmentUsageinDetail_108Old* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnStorageAddNew();
}*/
static int _OnStockSetCheckFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old*) pWnd)->OnStockSetCheck();
	return 0;
}
static int _OnDeptSetCheckFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old*) pWnd)->OnDeptSetCheck();
	return 0;
}
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	return ((CMASDepartmentUsageinDetail_108Old*)pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
}
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnDepartmentLoadData();
}
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnClerkLoadData();
}
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnTypeLoadData();
}
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASDepartmentUsageinDetail_108Old* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnExportTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASDepartmentUsageinDetail_108Old* )pWnd)->OnExportTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnExportTypeSelendokFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnExportTypeSelendok();
}
/*static void _OnExportTypeSetfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnExportTypeKillfocus();
}*/
/*static void _OnExportTypeKillfocusFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnExportTypeKillfocus();
}*/
static long _OnExportTypeLoadDataFnc(CWnd *pWnd){
	return ((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnExportTypeLoadData();
}
/*static void _OnExportTypeAddNewFnc(CWnd *pWnd){
	((CMASDepartmentUsageinDetail_108Old *)pWnd)->OnExportTypeAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CMASDepartmentUsageinDetail_108Old *pVw = (CMASDepartmentUsageinDetail_108Old *)pWnd;
...
CMASDepartmentUsageinDetail_108Old::CMASDepartmentUsageinDetail_108Old(CWnd* pParent){

	m_nDlgWidth = 545;
	m_nDlgHeight = 185;
	SetDefaultValues();
}
CMASDepartmentUsageinDetail_108Old::~CMASDepartmentUsageinDetail_108Old(){
}
void CMASDepartmentUsageinDetail_108Old::OnCreateComponents(){
...
void CMASDepartmentUsageinDetail_108Old::OnInitializeComponents(){
...
void CMASDepartmentUsageinDetail_108Old::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CMASDepartmentUsageinDetail_108Old::OnDoDataExchange(CDataExchange* pDX){
...
void CMASDepartmentUsageinDetail_108Old::SetDefaultValues(){
...
int CMASDepartmentUsageinDetail_108Old::SetMode(int nMode){
...
/*void CMASDepartmentUsageinDetail_108Old::OnFromDateChange(){
	
} */
/*void CMASDepartmentUsageinDetail_108Old::OnFromDateSetfocus(){
	
} */
/*void CMASDepartmentUsageinDetail_108Old::OnFromDateKillfocus(){
	
} */
int CMASDepartmentUsageinDetail_108Old::OnFromDateCheckValue(){
	return 0;
} 
/*void CMASDepartmentUsageinDetail_108Old::OnToDateChange(){
	
} */
/*void CMASDepartmentUsageinDetail_108Old::OnToDateSetfocus(){
	
} */
/*void CMASDepartmentUsageinDetail_108Old::OnToDateKillfocus(){
	
} */
int CMASDepartmentUsageinDetail_108Old::OnToDateCheckValue(){
	return 0;
} 
void CMASDepartmentUsageinDetail_108Old::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASDepartmentUsageinDetail_108Old::OnStorageSelendok(){
	 
}
/*void CMASDepartmentUsageinDetail_108Old::OnStorageSetfocus(){
	
}*/
/*void CMASDepartmentUsageinDetail_108Old::OnStorageKillfocus(){
	
}*/
long CMASDepartmentUsageinDetail_108Old::OnStorageLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CMASDepartmentUsageinDetail_108Old::OnStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASDepartmentUsageinDetail_108Old::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	
}
long CMASDepartmentUsageinDetail_108Old::OnDepartmentLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	int nCount = 0;
	szSQL.Format(_T(" select sd_id as id, sd_name as name from sys_dept where sd_type IN ('DT', 'KB', 'KD', 'XN') OR sd_id IN ('C10', 'C8', 'C7') order by  sd_name"));
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF()){ 
...
long CMASDepartmentUsageinDetail_108Old::OnClerkLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
long CMASDepartmentUsageinDetail_108Old::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	int nCount = 0;
...
void CMASDepartmentUsageinDetail_108Old::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

} 
void CMASDepartmentUsageinDetail_108Old::OnItemGroupSelendok(){
	 
}
/*void CMASDepartmentUsageinDetail_108Old::OnItemGroupSetfocus(){
	
}*/
/*void CMASDepartmentUsageinDetail_108Old::OnItemGroupKillfocus(){
	
}*/
long CMASDepartmentUsageinDetail_108Old::OnItemGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CMASDepartmentUsageinDetail_108Old::OnItemGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASDepartmentUsageinDetail_108Old::OnExportTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASDepartmentUsageinDetail_108Old::OnExportTypeSelendok(){
	 
}
/*void CMASDepartmentUsageinDetail_108Old::OnExportTypeSetfocus(){
	
}*/
/*void CMASDepartmentUsageinDetail_108Old::OnExportTypeKillfocus(){
	
}*/
long CMASDepartmentUsageinDetail_108Old::OnExportTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CMASDepartmentUsageinDetail_108Old::OnExportTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASDepartmentUsageinDetail_108Old::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
...
void CMASDepartmentUsageinDetail_108Old::OnExportSelect(){
	...
	xls.SetCellText(nCol, nRow + 3, _T("\x43HI TI\x1EBET S\x1EEC \x44\x1EE4NG TR\x41NG \x42\x1ECA T\x1EA0I \x110\x1A0N V\x1ECA"), FMT_TEXT | FMT_CENTER, true, 12);
	...
	xls.SetCellText(nCol+1, nRow, _T("T\xEAn v\x1EADt t\x1B0"));
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\CHITIETSUDUNGVATTUTAIDONVI.xls"));
} 

CString CMASDepartmentUsageinDetail_108Old::GetQueryString(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
CString CMASDepartmentUsageinDetail_108Old::GetQueryString1(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
BEGIN_MESSAGE_MAP(CMASDepartmentUsageinDetail_108Old, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CMASDepartmentUsageinDetail_108Old::OnSetFocus(CWnd* pOldWnd)
{
...
void CMASDepartmentUsageinDetail_108Old::OnStockSetCheck(){
	m_bStockCheck = !m_bStockCheck;
	for (int i = 0; i < m_wndStorageList.GetItemCount();i++)
		m_wndStorageList.SetCheck(i, m_bStockCheck);
}

void CMASDepartmentUsageinDetail_108Old::OnDeptSetCheck(){
