#ifndef MASReportConditionDialog_H
#define MASReportConditionDialog_H
...
class CMASReportConditionDialog : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CMASReportConditionDialog(CWnd *pParent, int nType);
	~CMASReportConditionDialog();
	...
	int OnAddMASReportConditionDialog(); 
	int OnEditMASReportConditionDialog(); 
	int OnDeleteMASReportConditionDialog(); 
	int OnSaveMASReportConditionDialog(); 
	int OnCancelMASReportConditionDialog(); 
	int OnMASReportConditionDialogListLoadData(); 
