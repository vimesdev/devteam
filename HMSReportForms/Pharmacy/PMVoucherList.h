...
public:
	...
	CPMVoucherList(CWnd *pParent, int bDetail);
	~CPMVoucherList();
	...
	void OnPMPrint(bool bPreview);
	void OnMAPrint(bool bPreview); 
	void OnPMExport(bool bPreview);
	void OnMAExport(bool bPreview);
