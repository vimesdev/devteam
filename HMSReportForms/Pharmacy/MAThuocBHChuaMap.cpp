#include "stdafx.h"
#include "MAThuocBHChuaMap.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMAThuocBHChuaMap *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMAThuocBHChuaMap *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMAThuocBHChuaMap* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CMAThuocBHChuaMap *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CMAThuocBHChuaMap *)pWnd)->OnStockAddNew();
}*/
static void _OnStorageSelectFnc(CWnd *pWnd){
	CMAThuocBHChuaMap *pVw = (CMAThuocBHChuaMap *)pWnd;
	pVw->OnStorageSelect();
} 
...
CMAThuocBHChuaMap::CMAThuocBHChuaMap(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CMAThuocBHChuaMap::~CMAThuocBHChuaMap(){
}
void CMAThuocBHChuaMap::OnCreateComponents(){
...
void CMAThuocBHChuaMap::OnInitializeComponents(){
...
void CMAThuocBHChuaMap::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CMAThuocBHChuaMap::OnDoDataExchange(CDataExchange* pDX){
...
void CMAThuocBHChuaMap::SetDefaultValues(){
...
int CMAThuocBHChuaMap::SetMode(int nMode){
...
/*void CMAThuocBHChuaMap::OnFromDateChange(){
	
} */
/*void CMAThuocBHChuaMap::OnFromDateSetfocus(){
	
} */
/*void CMAThuocBHChuaMap::OnFromDateKillfocus(){
	
} */
int CMAThuocBHChuaMap::OnFromDateCheckValue(){
	return 0;
} 
/*void CMAThuocBHChuaMap::OnToDateChange(){
	
} */
/*void CMAThuocBHChuaMap::OnToDateSetfocus(){
	
} */
/*void CMAThuocBHChuaMap::OnToDateKillfocus(){
	
} */
int CMAThuocBHChuaMap::OnToDateCheckValue(){
	return 0;
} 
void CMAThuocBHChuaMap::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMAThuocBHChuaMap::OnStockSelendok(){
	 
}
/*void CMAThuocBHChuaMap::OnStockSetfocus(){
	
}*/
/*void CMAThuocBHChuaMap::OnStockKillfocus(){
	
}*/
long CMAThuocBHChuaMap::OnStockLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadStorageList(&m_wndStock, m_szStockKey);

}
/*void CMAThuocBHChuaMap::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMAThuocBHChuaMap::OnStorageSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_bAll = FALSE;
	m_bError = FALSE;
...
void CMAThuocBHChuaMap::OnAllSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_bStorage = FALSE;
	m_bError = FALSE;
...
void CMAThuocBHChuaMap::OnErrorSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_bStorage = FALSE;
	m_bAll = FALSE;
...
void CMAThuocBHChuaMap::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

} 
void CMAThuocBHChuaMap::OnExportSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	if(m_bStorage)
		OnExport2();
...
void CMAThuocBHChuaMap::OnExport1(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	BeginWaitCursor();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	xls.SetCellText(nCol,nRow+3,_T("\x44\x61nh s\xE1\x63h v\x1EADt t\x1B0 \x63h\x1B0\x61 m\x61p"),FMT_TEXT|FMT_CENTER,true,12);
	...
	xls.SetCellText(nCol +1 ,nRow,_T("M\xE3 v\x1EADt t\x1B0 \x42V"),FMT_TEXT|FMT_CENTER,true,11);
	xls.SetCellText(nCol +2 ,nRow,_T("T\xEAn v\x1EADt t\x1B0 \x42V"),FMT_TEXT|FMT_CENTER,true,11);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\DANHSACHVATTUCHUAMAP.xls"));
} 
void CMAThuocBHChuaMap::OnExport2(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	BeginWaitCursor();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT DISTINCT mp_code,") \
		...
		_T(" LEFT JOIN m_product") \
		_T(" ON (mp_product_id = mpi_product_id)") \
		_T(" WHERE mp_atccode IS NULL") \
		_T(" AND mp_org_id = '%s' AND msl_qtyonhand > 0 %s") \
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\DANHSACHVATTUCHUAMAP_THEOKHO.xls"));
} 
void CMAThuocBHChuaMap::OnExport3(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	BeginWaitCursor();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CMAThuocBHChuaMap::OnExport4(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	BeginWaitCursor();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT DISTINCT mp_code,") \
		...
		_T(" AND b.hfe_discount    >0") \
		_T(" AND hfe_category      ='N'") \
		_T(" AND mpi_org_id        = 'PM' AND (mp_name <> mpei_ten_thuoc OR hfe_insprice <> mpei_don_gia)") \
		_T(" ORDER BY groupid, mpei_id"), m_szFromDate, m_szToDate);
	_fmsg(_T("%s"), szSQL);
	rs.ExecSQL(szSQL);
...
CString CMAThuocBHChuaMap::GetQueryString(){
