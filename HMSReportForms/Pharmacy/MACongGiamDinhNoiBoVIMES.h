#ifndef MACongGiamDinhNoiBoVIMES_H
#define MACongGiamDinhNoiBoVIMES_H
...
#include "GuiView.h"
#include "DbField.h"
class CMACongGiamDinhNoiBoVIMES : public CGuiView{
protected:
public:
	...
	void			OnExport1();
	void			OnExport2();
	CMACongGiamDinhNoiBoVIMES(CWnd *pParent);
	~CMACongGiamDinhNoiBoVIMES();
