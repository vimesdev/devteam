#ifndef PMSImportPaymentSheetList_H
#define PMSImportPaymentSheetList_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSImportPaymentSheetList : public CGuiView{
protected:
public:
	...
	void			OnExport();
	void			OnExport1();
	CPMSImportPaymentSheetList(CWnd *pParent);
	~CPMSImportPaymentSheetList();
	...
	int OnAddPMSImportPaymentSheetList(); 
	int OnEditPMSImportPaymentSheetList(); 
	int OnDeletePMSImportPaymentSheetList(); 
	int OnSavePMSImportPaymentSheetList(); 
	int OnCancelPMSImportPaymentSheetList(); 
	int OnPMSImportPaymentSheetListListLoadData();
