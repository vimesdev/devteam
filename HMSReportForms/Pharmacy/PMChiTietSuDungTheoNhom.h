#ifndef PMCHITIETSUDUNGTHEONHOM_H
#define PMCHITIETSUDUNGTHEONHOM_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMChiTietSuDungTheoNhom : public CGuiView{
protected:
public:
	...
	int OnAddPMChiTietSuDungTheoNhom(); 
	int OnEditPMChiTietSuDungTheoNhom(); 
	int OnDeletePMChiTietSuDungTheoNhom(); 
	int OnSavePMChiTietSuDungTheoNhom(); 
	int OnCancelPMChiTietSuDungTheoNhom(); 
	int OnPMChiTietSuDungTheoNhomListLoadData(); 
