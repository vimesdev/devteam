#ifndef MASInwardExportSheetList_H
#define MASInwardExportSheetList_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASInwardExportSheetList : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMASInwardExportSheetList(CWnd *pParent);
	~CMASInwardExportSheetList();
