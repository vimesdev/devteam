#include "stdafx.h"
#include "MADetailHightechMaterial2.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CMADetailHightechMaterial2 *)pWnd)->OnYearCheckValue();
} 
static void _OnPeriodReportSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMADetailHightechMaterial2* )pWnd)->OnPeriodReportSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPeriodReportSelendokFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnPeriodReportSelendok();
}
/*static void _OnPeriodReportSetfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnPeriodReportKillfocus();
}*/
/*static void _OnPeriodReportKillfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnPeriodReportKillfocus();
}*/
static long _OnPeriodReportLoadDataFnc(CWnd *pWnd){
	return ((CMADetailHightechMaterial2 *)pWnd)->OnPeriodReportLoadData();
}
/*static void _OnPeriodReportAddNewFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnPeriodReportAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMADetailHightechMaterial2 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMADetailHightechMaterial2 *)pWnd)->OnToDateCheckValue();
} 
static void _OnObjectSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMADetailHightechMaterial2* )pWnd)->OnObjectSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnObjectSelendokFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnObjectSelendok();
}
/*static void _OnObjectSetfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnObjectKillfocus();
}*/
/*static void _OnObjectKillfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnObjectKillfocus();
}*/
static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((CMADetailHightechMaterial2 *)pWnd)->OnObjectLoadData();
}
/*static void _OnObjectAddNewFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnObjectAddNew();
}*/
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMADetailHightechMaterial2* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnDepartmentKillfocus();
}*/
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CMADetailHightechMaterial2 *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2 *)pWnd)->OnDepartmentAddNew();
}*/
static void _OnReceiveDateSelectFnc(CWnd *pWnd){
	((CMADetailHightechMaterial2*)pWnd)->OnReceiveDateSelect();
}
static void _OnPreviewSelectFnc(CWnd *pWnd){
	CMADetailHightechMaterial2 *pVw = (CMADetailHightechMaterial2 *)pWnd;
	pVw->OnPreviewSelect();
} 
...
static int _OnAddMADetailHightechMaterialFnc(CWnd *pWnd){
	 return ((CMADetailHightechMaterial2*)pWnd)->OnAddMADetailHightechMaterial();
} 
static int _OnEditMADetailHightechMaterialFnc(CWnd *pWnd){
	 return ((CMADetailHightechMaterial2*)pWnd)->OnEditMADetailHightechMaterial();
} 
static int _OnDeleteMADetailHightechMaterialFnc(CWnd *pWnd){
	 return ((CMADetailHightechMaterial2*)pWnd)->OnDeleteMADetailHightechMaterial();
} 
static int _OnSaveMADetailHightechMaterialFnc(CWnd *pWnd){
	 return ((CMADetailHightechMaterial2*)pWnd)->OnSaveMADetailHightechMaterial();
} 
static int _OnCancelMADetailHightechMaterialFnc(CWnd *pWnd){
	 return ((CMADetailHightechMaterial2*)pWnd)->OnCancelMADetailHightechMaterial();
} 
CMADetailHightechMaterial2::CMADetailHightechMaterial2(CWnd *pParent){

	m_nDlgWidth = 605;
	m_nDlgHeight = 405;
	SetDefaultValues();
}
CMADetailHightechMaterial2::~CMADetailHightechMaterial2(){
}
void CMADetailHightechMaterial2::OnCreateComponents(){
...
void CMADetailHightechMaterial2::OnInitializeComponents(){
...
void CMADetailHightechMaterial2::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CMADetailHightechMaterial2::OnDoDataExchange(CDataExchange* pDX){
...
void CMADetailHightechMaterial2::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMADetailHightechMaterial2::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CMADetailHightechMaterial2::SetDefaultValues(){
...
int CMADetailHightechMaterial2::SetMode(int nMode){
...
/*void CMADetailHightechMaterial2::OnYearChange(){
	
} */
/*void CMADetailHightechMaterial2::OnYearSetfocus(){
	
} */
/*void CMADetailHightechMaterial2::OnYearKillfocus(){
	
} */
int CMADetailHightechMaterial2::OnYearCheckValue(){
	return 0;
} 
void CMADetailHightechMaterial2::OnPeriodReportSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMADetailHightechMaterial2::OnPeriodReportSelendok(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CDate dte;
	CString tmpStr;
...
/*void CMADetailHightechMaterial2::OnPeriodReportSetfocus(){
	
}*/
/*void CMADetailHightechMaterial2::OnPeriodReportKillfocus(){
	
}*/
long CMADetailHightechMaterial2::OnPeriodReportLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CMADetailHightechMaterial2::OnPeriodReportAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CMADetailHightechMaterial2::OnFromDateChange(){
	
} */
/*void CMADetailHightechMaterial2::OnFromDateSetfocus(){
	
} */
/*void CMADetailHightechMaterial2::OnFromDateKillfocus(){
	
} */
int CMADetailHightechMaterial2::OnFromDateCheckValue(){
	return 0;
} 
/*void CMADetailHightechMaterial2::OnToDateChange(){
	
} */
/*void CMADetailHightechMaterial2::OnToDateSetfocus(){
	
} */
/*void CMADetailHightechMaterial2::OnToDateKillfocus(){
	
} */
int CMADetailHightechMaterial2::OnToDateCheckValue(){
	return 0;
} 
void CMADetailHightechMaterial2::OnObjectSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMADetailHightechMaterial2::OnObjectSelendok(){
	 
}
/*void CMADetailHightechMaterial2::OnObjectSetfocus(){
	
}*/
/*void CMADetailHightechMaterial2::OnObjectKillfocus(){
	
}*/
long CMADetailHightechMaterial2::OnObjectLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CMADetailHightechMaterial2::OnObjectAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMADetailHightechMaterial2::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMADetailHightechMaterial2::OnDepartmentSelendok(){
	 
}
/*void CMADetailHightechMaterial2::OnDepartmentSetfocus(){
	
}*/
/*void CMADetailHightechMaterial2::OnDepartmentKillfocus(){
	
}*/
long CMADetailHightechMaterial2::OnDepartmentLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	pMF->LoadDepartmentList(&m_wndDepartment, m_szDepartmentKey);
	return 0;
}
/*void CMADetailHightechMaterial2::OnDepartmentAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMADetailHightechMaterial2::OnReceiveDateSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CMADetailHightechMaterial2::OnPreviewSelect(){
	CMainFrame_E10* pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
...
void CMADetailHightechMaterial2::OnExportSelect(){
	CMainFrame_E10* pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);	CString szSQL, tmpStr, szSysDate, szNewDept, szOldDept, szNewDoc, szOldDoc;
	int nIdx = 1;
...
int CMADetailHightechMaterial2::OnAddMADetailHightechMaterial(){
...
int CMADetailHightechMaterial2::OnEditMADetailHightechMaterial(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CMADetailHightechMaterial2::OnDeleteMADetailHightechMaterial(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
...
int CMADetailHightechMaterial2::OnSaveMADetailHightechMaterial(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CMADetailHightechMaterial2::OnCancelMADetailHightechMaterial(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CMADetailHightechMaterial2::OnMADetailHightechMaterialListLoadData(){
	return 0;
}
CString CMADetailHightechMaterial2::GetQueryString(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
