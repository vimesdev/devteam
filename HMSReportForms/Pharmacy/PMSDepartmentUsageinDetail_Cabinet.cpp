#include "stdafx.h"
#include "PMSDepartmentUsageinDetail_Cabinet.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"
#include ".\pmsdepartmentusageindetail.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnToDateCheckValue();
} 
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSDepartmentUsageinDetail_Cabinet* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnStorageAddNew();
}*/
static int _OnStockSetCheckFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet*) pWnd)->OnStockSetCheck();
	return 0;
}
static int _OnDeptSetCheckFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet*) pWnd)->OnDeptSetCheck();
	return 0;
}
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	return ((CPMSDepartmentUsageinDetail_Cabinet*)pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
}
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnDepartmentLoadData();
}
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnClerkLoadData();
}
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnTypeLoadData();
}
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSDepartmentUsageinDetail_Cabinet* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnExportTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSDepartmentUsageinDetail_Cabinet* )pWnd)->OnExportTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnExportTypeSelendokFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnExportTypeSelendok();
}
/*static void _OnExportTypeSetfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnExportTypeKillfocus();
}*/
/*static void _OnExportTypeKillfocusFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnExportTypeKillfocus();
}*/
static long _OnExportTypeLoadDataFnc(CWnd *pWnd){
	return ((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnExportTypeLoadData();
}
/*static void _OnExportTypeAddNewFnc(CWnd *pWnd){
	((CPMSDepartmentUsageinDetail_Cabinet *)pWnd)->OnExportTypeAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CPMSDepartmentUsageinDetail_Cabinet *pVw = (CPMSDepartmentUsageinDetail_Cabinet *)pWnd;
...
CPMSDepartmentUsageinDetail_Cabinet::CPMSDepartmentUsageinDetail_Cabinet(CWnd* pParent){

	m_nDlgWidth = 545;
	m_nDlgHeight = 185;
	SetDefaultValues();
}
CPMSDepartmentUsageinDetail_Cabinet::~CPMSDepartmentUsageinDetail_Cabinet(){
}
void CPMSDepartmentUsageinDetail_Cabinet::OnCreateComponents(){
	...
	m_wndDDODMO.Create(this, _T("Only DDO"), 215, 550, 365, 575);
	m_wndPrintPreview.Create(this, _T("&Print Preview"), 395, 550, 490, 575);
	m_wndExport.Create(this, _T("&Export"), 495, 550, 575, 575);
}
void CPMSDepartmentUsageinDetail_Cabinet::OnInitializeComponents(){
...
void CPMSDepartmentUsageinDetail_Cabinet::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CPMSDepartmentUsageinDetail_Cabinet::OnDoDataExchange(CDataExchange* pDX){
...
void CPMSDepartmentUsageinDetail_Cabinet::SetDefaultValues(){
...
int CPMSDepartmentUsageinDetail_Cabinet::SetMode(int nMode){
...
/*void CPMSDepartmentUsageinDetail_Cabinet::OnFromDateChange(){
	
} */
/*void CPMSDepartmentUsageinDetail_Cabinet::OnFromDateSetfocus(){
	
} */
/*void CPMSDepartmentUsageinDetail_Cabinet::OnFromDateKillfocus(){
	
} */
int CPMSDepartmentUsageinDetail_Cabinet::OnFromDateCheckValue(){
	return 0;
} 
/*void CPMSDepartmentUsageinDetail_Cabinet::OnToDateChange(){
	
} */
/*void CPMSDepartmentUsageinDetail_Cabinet::OnToDateSetfocus(){
	
} */
/*void CPMSDepartmentUsageinDetail_Cabinet::OnToDateKillfocus(){
	
} */
int CPMSDepartmentUsageinDetail_Cabinet::OnToDateCheckValue(){
	return 0;
} 
void CPMSDepartmentUsageinDetail_Cabinet::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMSDepartmentUsageinDetail_Cabinet::OnStorageSelendok(){
	 
}
/*void CPMSDepartmentUsageinDetail_Cabinet::OnStorageSetfocus(){
	
}*/
/*void CPMSDepartmentUsageinDetail_Cabinet::OnStorageKillfocus(){
	
}*/
long CPMSDepartmentUsageinDetail_Cabinet::OnStorageLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CPMSDepartmentUsageinDetail_Cabinet::OnStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CPMSDepartmentUsageinDetail_Cabinet::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	
}
long CPMSDepartmentUsageinDetail_Cabinet::OnDepartmentLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	int nCount = 0;
	szSQL.Format(_T(" select sd_id as id, sd_name as name from sys_dept where sd_type IN ('DT', 'KB', 'KD', 'XN') OR sd_id IN ('C10', 'C8', 'C7', 'C8-D') order by  sd_name"));
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF()){ 
...
long CPMSDepartmentUsageinDetail_Cabinet::OnClerkLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
long CPMSDepartmentUsageinDetail_Cabinet::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	int nCount = 0;
...
void CPMSDepartmentUsageinDetail_Cabinet::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

} 
void CPMSDepartmentUsageinDetail_Cabinet::OnItemGroupSelendok(){
	 
}
/*void CPMSDepartmentUsageinDetail_Cabinet::OnItemGroupSetfocus(){
	
}*/
/*void CPMSDepartmentUsageinDetail_Cabinet::OnItemGroupKillfocus(){
	
}*/
long CPMSDepartmentUsageinDetail_Cabinet::OnItemGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CPMSDepartmentUsageinDetail_Cabinet::OnItemGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CPMSDepartmentUsageinDetail_Cabinet::OnExportTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMSDepartmentUsageinDetail_Cabinet::OnExportTypeSelendok(){
	 
}
/*void CPMSDepartmentUsageinDetail_Cabinet::OnExportTypeSetfocus(){
	
}*/
/*void CPMSDepartmentUsageinDetail_Cabinet::OnExportTypeKillfocus(){
	
}*/
long CPMSDepartmentUsageinDetail_Cabinet::OnExportTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CPMSDepartmentUsageinDetail_Cabinet::OnExportTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CPMSDepartmentUsageinDetail_Cabinet::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
	...
	while (!rs.IsEOF())
	{
		...
		if (szNewType != szOldType)
		{
			...
			{
				if (szNewType == _T("1"))
					tmpStr = _T("Phi\x1EBFu l\x129nh \x64\xF9ng \x63hung");
				else if (szNewType == _T("2"))
					tmpStr = _T("Phi\x1EBFu l\x129nh PTTT");
				else
					tmpStr = _T("Tr\x1EA3 l\x1EA1i PTTT");
			}
			else
			{
				if (szNewType == _T("1"))
...
void CPMSDepartmentUsageinDetail_Cabinet::OnExportSelect(){
	...
	while (!rs.IsEOF())
	{
		...
		if (szNewType != szOldType)
		{
			...
			if (nTemp > 0)
			{
				xls.SetCellText(1, nRow, _T("T\x1ED5ng nh\xF3m:"), FMT_TEXT | FMT_CENTER, true);
				for (int i = 0; i < 7; i++)
				{
...
CString CPMSDepartmentUsageinDetail_Cabinet::GetQueryString(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	szIssueSQL.Format(_T(" SELECT    1 AS transaction_type, ") \
				...
				_T("           SUM(total_amt) total_amt, exporttype") \
				...
				_T("            AND mtl_qtyorder = mtl_qtydelivery ") \
				_T("            UNION ALL ") \
				_T("            SELECT    mt_department_to_id AS dept_id, ") \
				_T("                      Mt_storage_id, ") \
				_T("                      Mt_approveddate, ") \
				_T("                      mtl_saleprice, ") \
				_T("                      CASE WHEN Mt_storage_id = 8 THEN mtl_qtydelivery ELSE 0 END, ") \
				_T("                      0, ") \
				_T("                      0, ") \
				_T("                      CASE WHEN Mt_storage_id = 7 THEN mtl_qtydelivery ELSE 0 END, ") \
				_T("                      CASE WHEN Mt_storage_id = 14 THEN mtl_qtydelivery ELSE 0 END, ") \
				_T("                      CASE WHEN Mt_storage_id NOT IN(7, 8, 14) THEN mtl_qtydelivery ELSE 0 END, ") \
				_T("                      mtl_qtydelivery, ") \
				_T("                      CASE WHEN Mt_storage_id = 8 THEN mtl_qtydelivery * mtl_saleprice ELSE 0 END, ") \
				_T("                      0, ") \
				_T("                      0, ") \
				_T("                      CASE WHEN Mt_storage_id = 7 THEN mtl_qtydelivery * mtl_saleprice ELSE 0 END, ") \
				_T("                      CASE WHEN Mt_storage_id = 14 THEN mtl_qtydelivery * mtl_saleprice ELSE 0 END, ") \
				_T("                      CASE WHEN Mt_storage_id NOT IN(7, 8, 14) THEN mtl_qtydelivery * mtl_saleprice ELSE 0 END, ") \
				_T("                      mtl_qtydelivery * mtl_saleprice, ") \
				_T("                      mtl_product_item_id, ") \
				_T("					  mt_doctype,") \
				_T("                      mt_status, ") \
				...
				_T(" ) tbl_issue ") \
				_T(" LEFT JOIN m_productitem_view3 ON ( sitem_id = product_item_id ) %s") \
				_T(" WHERE     1 = 1 %s") \
				_T(" GROUP     BY %s product_id,product_uomname,unit_price,product_name, exporttype "), szField, szWhere1, szLeftJoin, szWhere, szGroupBy);
	...
	szReturnSQL.Format(_T(" SELECT    16 AS transaction_type, ") \
				...
				_T(" GROUP     BY %s product_id,product_name,unit_price,product_uomname, exporttype"), szField, szLeftJoin, szWhere, szGroupBy);

	szSQL.Format(_T("SELECT * FROM (") \
				_T(" %s") \
				_T(" UNION ALL") \
				_T(" %s) %s") \
				_T(" ORDER BY transaction_type, %s product_name"), szIssueSQL, szReturnSQL, szWhereET, szOrderBy);
	_fmsg(_T("%s"), szSQL);
	return szSQL;
}

CString CPMSDepartmentUsageinDetail_Cabinet::GetQueryString1(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL, szWhere, szTemp, szDept, szStorageStr, szField, szGroupBy, szOrderBy, szLeftJoin;
	CString szIssueSQL, szReturnSQL;
	for (int i = 0; i < m_wndDepartmentList.GetItemCount(); i++)
	{
		if (m_wndDepartmentList.GetCheck(i))
	...
	for (int i = 0; i < m_wndStorageList.GetItemCount();i++)
		...
		szSQL.Format(_T(" SELECT %s transaction_type,") \
			...
			_T(" AND hpo_ordertype            NOT IN('C', 'D')") \
			_T(" ) tbl_pharma") \
			_T(" UNION ALL") \
			...
			_T(" product_name"), szField, szLeftJoin, szWhere, szGroupBy, szOrderBy);
			
		return szSQL;
}

BEGIN_MESSAGE_MAP(CPMSDepartmentUsageinDetail_Cabinet, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CPMSDepartmentUsageinDetail_Cabinet::OnSetFocus(CWnd* pOldWnd)
{
...
void CPMSDepartmentUsageinDetail_Cabinet::OnStockSetCheck(){
	m_bStockCheck = !m_bStockCheck;
	for (int i = 0; i < m_wndStorageList.GetItemCount();i++)
		m_wndStorageList.SetCheck(i, m_bStockCheck);
}

void CPMSDepartmentUsageinDetail_Cabinet::OnDeptSetCheck(){
