...
public:
	...
	void	OnGroupbyDate(CReportSection* rpt, double& pGroupByDate, CString& pNewAcctDate);
	void SetGroupbyDateHeader(CReportSection* pMarkSection, CString pNewAcct);
	void	SetGroupbyDateFooter(CReportSection* pRptSection, double& pGroupbyDate);
