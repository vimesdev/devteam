#ifndef FMPolicyPaidSummaryByC9Dept_H
#define FMPolicyPaidSummaryByC9Dept_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyPaidSummaryByC9Dept : public CGuiView
{
...
public:
	...
	CString			GetQueryString_v2_EX();
	CString			GetQueryString_check_v2();
	

	CFMPolicyPaidSummaryByC9Dept(CWnd *pWnd);
	~CFMPolicyPaidSummaryByC9Dept();
