#ifndef MADETAILPURCHASEORDER_H
#define MADETAILPURCHASEORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class CMADetailPurchaseOrder : public CGuiView{
protected:
public:
	...
	CMADetailPurchaseOrder(CWnd *pParent, int bDetail);
	~CMADetailPurchaseOrder();
