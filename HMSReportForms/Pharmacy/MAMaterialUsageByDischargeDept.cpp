#include "stdafx.h"
#include "MAMaterialUsageByDischargeDept.h"
...
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMAMaterialUsageByDischargeDept* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintSelectFnc(CWnd *pWnd){
	CMAMaterialUsageByDischargeDept *pVw = (CMAMaterialUsageByDischargeDept *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnStorageListLoadDataFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnStorageListLoadData();
}
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CMAMaterialUsageByDischargeDept*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CMAMaterialUsageByDischargeDept*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CMAMaterialUsageByDischargeDept*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnDeptListDeleteItem();
} 
static int _OnObjectListCheckAllFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnObjectListCheckAll();
}
static int _OnObjectListUnCheckAllFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnObjectListUnCheckAll();
}
static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnDeptListUnCheckAll();
}
static int _OnStorageListCheckAllFnc(CWnd* pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnStorageListCheckAll();
}
static int _OnStorageListUnCheckAllFnc(CWnd *pWnd){
	return ((CMAMaterialUsageByDischargeDept*)pWnd)->OnStorageListUncheckAll();
}
CMAMaterialUsageByDischargeDept::CMAMaterialUsageByDischargeDept(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CMAMaterialUsageByDischargeDept::~CMAMaterialUsageByDischargeDept(){
}
void CMAMaterialUsageByDischargeDept::OnCreateComponents(){
...
void CMAMaterialUsageByDischargeDept::OnInitializeComponents(){
...
void CMAMaterialUsageByDischargeDept::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CMAMaterialUsageByDischargeDept::OnDoDataExchange(CDataExchange* pDX){
...
void CMAMaterialUsageByDischargeDept::SetDefaultValues(){
...
int CMAMaterialUsageByDischargeDept::SetMode(int nMode){
...
/*void CMAMaterialUsageByDischargeDept::OnYearChange(){
	
} */
/*void CMAMaterialUsageByDischargeDept::OnYearSetfocus(){
	
} */
/*void CMAMaterialUsageByDischargeDept::OnYearKillfocus(){
	
} */
int CMAMaterialUsageByDischargeDept::OnYearCheckValue(){
	return 0;
}
 
void CMAMaterialUsageByDischargeDept::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CMAMaterialUsageByDischargeDept::OnReportPeriodSelendok(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CDate dte;
	CString tmpStr;
...
/*void CMAMaterialUsageByDischargeDept::OnReportPeriodSetfocus(){
	
}*/
/*void CMAMaterialUsageByDischargeDept::OnReportPeriodKillfocus(){
	
}*/
long CMAMaterialUsageByDischargeDept::OnReportPeriodLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CMAMaterialUsageByDischargeDept::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CMAMaterialUsageByDischargeDept::OnFromDateChange(){
	
} */
/*void CMAMaterialUsageByDischargeDept::OnFromDateSetfocus(){
	
} */
/*void CMAMaterialUsageByDischargeDept::OnFromDateKillfocus(){
	
} */
int CMAMaterialUsageByDischargeDept::OnFromDateCheckValue(){
	return 0;
}
 
/*void CMAMaterialUsageByDischargeDept::OnToDateChange(){
	
} */
/*void CMAMaterialUsageByDischargeDept::OnToDateSetfocus(){
	
} */
/*void CMAMaterialUsageByDischargeDept::OnToDateKillfocus(){
	
} */
int CMAMaterialUsageByDischargeDept::OnToDateCheckValue(){
	return 0;
}
 
void CMAMaterialUsageByDischargeDept::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CMAMaterialUsageByDischargeDept::OnExportSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMAMaterialUsageByDischargeDept::OnObjectListDblClick(){
	
}
 
void CMAMaterialUsageByDischargeDept::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
int CMAMaterialUsageByDischargeDept::OnObjectListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
}

long CMAMaterialUsageByDischargeDept::OnStorageListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
long CMAMaterialUsageByDischargeDept::OnObjectListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CMAMaterialUsageByDischargeDept::OnDeptListDblClick(){
	
}
 
void CMAMaterialUsageByDischargeDept::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
int CMAMaterialUsageByDischargeDept::OnDeptListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
}
 
long CMAMaterialUsageByDischargeDept::OnDeptListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
CString CMAMaterialUsageByDischargeDept::GetQueryString(){
	CString szSQL, szWhere, szWhere1, szWhere2,szWhereDept;
	...
	if (!szDepts.IsEmpty())
	{
		szWhereDept.Format(_T(" and hcr_dischargedept in (%s) "),szDepts);
	...
	szSQL.Format(_T(" SELECT hpo_docno AS docno,") \
		...
		_T(" WHERE 1=1 %s ") \
		_T(" GROUP BY  hpo_docno, hp_rank, hcr_recordno, hp_workplace, hd_cardno,  ") \
		_T("	hd_admitdate, hcr_dischargedept, hp_birthdate ") \
		_T(" ORDER BY hcr_dischargedept,") \
		_T("   hpo_docno"), szWhere, szWhere, szWhere1, szWhere2,szWhereDept);
	_fmsg(_T("%s"), szSQL);
	return szSQL;
}

int CMAMaterialUsageByDischargeDept::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (!m_wndDeptList.GetCheck(i))
...
int CMAMaterialUsageByDischargeDept::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDeptList.GetItemCount(); i++)
	{
		if (m_wndDeptList.GetCheck(i))
...
int CMAMaterialUsageByDischargeDept::OnObjectListCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (!m_wndObjectList.GetCheck(i))
...
int CMAMaterialUsageByDischargeDept::OnObjectListUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
int CMAMaterialUsageByDischargeDept::OnStorageListCheckAll()
{
	for (int i = 0; i < m_wndStorageList.GetItemCount(); i++)
	{
		if (!m_wndStorageList.GetCheck(i))
...
int CMAMaterialUsageByDischargeDept::OnStorageListUncheckAll()
{
	for (int i = 0; i < m_wndStorageList.GetItemCount(); i++)
	{
		if (m_wndStorageList.GetCheck(i))
