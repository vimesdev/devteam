#ifndef MASSupplierPaymentList_H
#define MASSupplierPaymentList_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASSupplierPaymentList : public CGuiView
{
...
public:
	...
	CMASSupplierPaymentList(CWnd *pParent);
	~CMASSupplierPaymentList();
