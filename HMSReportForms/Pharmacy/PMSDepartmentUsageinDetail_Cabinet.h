#ifndef PMSDepartmentUsageinDetail_Cabinet_H
#define PMSDepartmentUsageinDetail_Cabinet_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSDepartmentUsageinDetail_Cabinet : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportTypeSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnExportTypeSelendok(); 
	//void			OnExportTypeSetfocus(); 
	//void			OnExportTypeKillfocus(); 
	long			OnExportTypeLoadData(); 
	//void			OnExportTypeAddNew(); 
	void			OnPrintPreviewSelect(); 
	void			OnExportSelect(); 
	CPMSDepartmentUsageinDetail_Cabinet(CWnd *pParent);
	~CPMSDepartmentUsageinDetail_Cabinet();
