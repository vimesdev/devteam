#ifndef MASGeneralStockImport_H
#define MASGeneralStockImport_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASGeneralStockImport : public CGuiView
{
protected:
public:
	...
	CMASGeneralStockImport(CWnd *pParent);
	~CMASGeneralStockImport();
