#ifndef MASDEPARTMENTUSAGEINDETAIL108OLD_H
#define MASDEPARTMENTUSAGEINDETAIL108OLD_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASDepartmentUsageinDetail_108Old : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportSelect(); 
	CMASDepartmentUsageinDetail_108Old(CWnd *pParent);
	~CMASDepartmentUsageinDetail_108Old();
