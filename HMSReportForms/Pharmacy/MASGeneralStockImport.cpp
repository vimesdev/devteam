#include "stdafx.h"
#include "MASGeneralStockImport.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMASGeneralStockImport *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMASGeneralStockImport *)pWnd)->OnToDateCheckValue();
} 
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASGeneralStockImport* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CMASGeneralStockImport *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnStorageAddNew();
}*/
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASGeneralStockImport* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CMASGeneralStockImport *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CMASGeneralStockImport *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CMASGeneralStockImport *pVw = (CMASGeneralStockImport *)pWnd;
...
static void _OnNonStockFlagSelectFnc(CWnd *pWnd){
	 ((CMASGeneralStockImport*)pWnd)->OnNonStockFlagSelect();
}

CMASGeneralStockImport::CMASGeneralStockImport(CWnd *pParent)
{
...
CMASGeneralStockImport::~CMASGeneralStockImport(){
}
void CMASGeneralStockImport::OnCreateComponents()
{
	...
	m_wndPrintPreview.Create(this, _T("&Print Preview"), 380, 125, 490, 150);
	m_wndExport.Create(this, _T("&Export"), 495, 125, 575, 150);
	m_wndNonStockFlag.Create(this, _T("HÐ không qua kho"), 5, 156, 135, 181);
}
void CMASGeneralStockImport::OnInitializeComponents(){
...
void CMASGeneralStockImport::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CMASGeneralStockImport::OnDoDataExchange(CDataExchange* pDX){
...
void CMASGeneralStockImport::SetDefaultValues(){
...
int CMASGeneralStockImport::SetMode(int nMode){
...
void CMASGeneralStockImport::OnNonStockFlagSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	AfxMessageBox(_T("Khi chọn chức năng này, bạn không cần chọn kho!"));
}

/*void CMASGeneralStockImport::OnFromDateChange(){
	
} */
/*void CMASGeneralStockImport::OnFromDateSetfocus(){
	
} */
/*void CMASGeneralStockImport::OnFromDateKillfocus(){
	
} */
int CMASGeneralStockImport::OnFromDateCheckValue(){
	return 0;
} 
/*void CMASGeneralStockImport::OnToDateChange(){
	
} */
/*void CMASGeneralStockImport::OnToDateSetfocus(){
	
} */
/*void CMASGeneralStockImport::OnToDateKillfocus(){
	
} */
int CMASGeneralStockImport::OnToDateCheckValue(){
	return 0;
} 
void CMASGeneralStockImport::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASGeneralStockImport::OnStorageSelendok(){
	 
}
/*void CMASGeneralStockImport::OnStorageSetfocus(){
	
}*/
/*void CMASGeneralStockImport::OnStorageKillfocus(){
	
}*/
long CMASGeneralStockImport::OnStorageLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CMASGeneralStockImport::OnStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASGeneralStockImport::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASGeneralStockImport::OnItemGroupSelendok(){
	 
}
/*void CMASGeneralStockImport::OnItemGroupSetfocus(){
	
}*/
/*void CMASGeneralStockImport::OnItemGroupKillfocus(){
	
}*/
long CMASGeneralStockImport::OnItemGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CMASGeneralStockImport::OnItemGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASGeneralStockImport::OnPrintPreviewSelect(){
	UpdateData(true);
...
void CMASGeneralStockImport::OnStdPrint(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
...
void CMASGeneralStockImport::OnCheckPrint(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
	...
	if(pMF->GetModuleID() == _T("PM"))
	{
		if(!rpt.Init(_T("Reports/HMS/PMS_BAOCAOTONGKETNHAPKHO_2.RPT"),true) )
			return;
	}
	else
	{
		if(!rpt.Init(_T("Reports/HMS/PMS_BAOCAOTONGKETNHAPKHO_2_MA.RPT"),true) )
			return;
	}	
...
void CMASGeneralStockImport::OnExportSelect(){
	UpdateData(true);
	if (m_bGroupBySupplier)
		OnCheckExport();
	else
...
void CMASGeneralStockImport::OnStdExport(){
...
void CMASGeneralStockImport::OnCheckExport(){
	_debug(_T("%s"), CString(typeid(this).name()));
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
...
CString CMASGeneralStockImport::GetQueryString(int nSort){
	CMainFrame_E10 * pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	if (m_bNonStockFlag)
	{
		szWhere.AppendFormat(_T(" AND i.storage_id = 0"));
		szWhere1.AppendFormat(_T(" AND mt_storage_to_id = 0"));
		szWhere2.AppendFormat(_T(" AND hpo_storage_id = 0"));
	}
	if (szStock == _T("15"))
	{
...
BEGIN_MESSAGE_MAP(CMASGeneralStockImport, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CMASGeneralStockImport::OnSetFocus(CWnd* pOldWnd)
{
