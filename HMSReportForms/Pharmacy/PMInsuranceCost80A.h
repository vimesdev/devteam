#ifndef PMInsuranceCost80A_H
#define PMInsuranceCost80A_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMInsuranceCost80A : public CGuiView{
protected:
	//xem 79A
...
public:
	...
	CPMInsuranceCost80A(CWnd* pParent);
	~CPMInsuranceCost80A();
	...
	int OnAddPMInsuranceCost80A(); 
	int OnEditPMInsuranceCost80A(); 
	int OnDeletePMInsuranceCost80A(); 
	int OnSavePMInsuranceCost80A(); 
	int OnCancelPMInsuranceCost80A(); 
	int OnPMInsuranceCost80AListLoadData();
