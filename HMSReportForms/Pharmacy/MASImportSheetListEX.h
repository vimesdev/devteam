#ifndef MASIMPORTSHEETLISTEX_H
#define MASIMPORTSHEETLISTEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASImportSheetListEX : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect(); 
	CMASImportSheetListEX(CWnd *pParent);
	~CMASImportSheetListEX();
