#ifndef PMCongGiamDinhNoiBoVIMES_H
#define PMCongGiamDinhNoiBoVIMES_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMCongGiamDinhNoiBoVIMES : public CGuiView{
protected:
public:
	...
	void			OnExport1();
	void			OnExport2();
	CPMCongGiamDinhNoiBoVIMES(CWnd *pParent);
	~CPMCongGiamDinhNoiBoVIMES();
