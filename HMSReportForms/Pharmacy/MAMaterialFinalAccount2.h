#ifndef MAMaterialFinalAccount2_H
#define MAMaterialFinalAccount2_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAMaterialFinalAccount2 : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMAMaterialFinalAccount2(CWnd *pParent);
	~CMAMaterialFinalAccount2();
