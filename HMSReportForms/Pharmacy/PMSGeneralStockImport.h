...
public:
	...
	CGuiLabel		m_wndItemTypeLabel;
	CGuiComboBox	m_wndItemType;
	CGuiLabel		m_wndImportTypeLabel;
	CGuiComboBox	m_wndImportType;
	CGuiLabel		m_wndVendorLabel;
	CGuiComboBox	m_wndVendor;
	CGuiLabel		m_wndItemGroupLabel;
	CGuiComboBox	m_wndItemGroup;
	CGuiCheckBox	m_wndByImportDate;
	...
	CString m_szItemTypeKey;
	CString m_szImportTypeKey;
	CString m_szVendorKey;
	BOOL	m_bGroupBySupplier;
	BOOL	m_bByImportDate;
