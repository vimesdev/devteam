#include "stdafx.h"
#include "PMSoldierDrugUsageOld.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include "Excel.h"
#include "StringToken.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsageOld *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSoldierDrugUsageOld* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsageOld *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsageOld *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsageOld *)pWnd)->OnToDateCheckValue();
} 
static void _OnExaminationSelectFnc(CWnd *pWnd){
	 ((CPMSoldierDrugUsageOld*)pWnd)->OnExaminationSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	 ((CPMSoldierDrugUsageOld*)pWnd)->OnOutpatientSelect();
}
static void _OnInwardSelectFnc(CWnd *pWnd){
	 ((CPMSoldierDrugUsageOld*)pWnd)->OnInwardSelect();
}
static void _OnPrintSelectFnc(CWnd *pWnd){
	CPMSoldierDrugUsageOld *pVw = (CPMSoldierDrugUsageOld *)pWnd;
	pVw->OnPrintSelect();
} 
...
static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsageOld*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPMSoldierDrugUsageOld*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CPMSoldierDrugUsageOld*)pWnd)->OnObjectListDeleteItem();
} 
static long _OnDeptListLoadDataFnc(CWnd *pWnd){
	return ((CPMSoldierDrugUsageOld*)pWnd)->OnDeptListLoadData();
} 
static void _OnDeptListDblClickFnc(CWnd *pWnd){
	((CPMSoldierDrugUsageOld*)pWnd)->OnDeptListDblClick();
} 
static void _OnDeptListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPMSoldierDrugUsageOld*)pWnd)->OnDeptListSelectChange(nOldItem, nNewItem);
} 
static int _OnDeptListDeleteItemFnc(CWnd *pWnd){
	 return ((CPMSoldierDrugUsageOld*)pWnd)->OnDeptListDeleteItem();
} 
CPMSoldierDrugUsageOld::CPMSoldierDrugUsageOld(CWnd *pParent){

	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
CPMSoldierDrugUsageOld::~CPMSoldierDrugUsageOld(){
}
void CPMSoldierDrugUsageOld::OnCreateComponents(){
...
void CPMSoldierDrugUsageOld::OnInitializeComponents(){
...
void CPMSoldierDrugUsageOld::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CPMSoldierDrugUsageOld::OnDoDataExchange(CDataExchange* pDX){
...
void CPMSoldierDrugUsageOld::SetDefaultValues(){
...
int CPMSoldierDrugUsageOld::SetMode(int nMode){
...
/*void CPMSoldierDrugUsageOld::OnYearChange(){
	
} */
/*void CPMSoldierDrugUsageOld::OnYearSetfocus(){
	
} */
/*void CPMSoldierDrugUsageOld::OnYearKillfocus(){
	
} */
int CPMSoldierDrugUsageOld::OnYearCheckValue(){
	return 0;
}
 
void CPMSoldierDrugUsageOld::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CPMSoldierDrugUsageOld::OnReportPeriodSelendok(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	CDate dte;
	CString tmpStr;
...
/*void CPMSoldierDrugUsageOld::OnReportPeriodSetfocus(){
	
}*/
/*void CPMSoldierDrugUsageOld::OnReportPeriodKillfocus(){
	
}*/
long CPMSoldierDrugUsageOld::OnReportPeriodLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CPMSoldierDrugUsageOld::OnReportPeriodAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CPMSoldierDrugUsageOld::OnFromDateChange(){
	
} */
/*void CPMSoldierDrugUsageOld::OnFromDateSetfocus(){
	
} */
/*void CPMSoldierDrugUsageOld::OnFromDateKillfocus(){
	
} */
int CPMSoldierDrugUsageOld::OnFromDateCheckValue(){
	return 0;
}
 
/*void CPMSoldierDrugUsageOld::OnToDateChange(){
	
} */
/*void CPMSoldierDrugUsageOld::OnToDateSetfocus(){
	
} */
/*void CPMSoldierDrugUsageOld::OnToDateKillfocus(){
	
} */
int CPMSoldierDrugUsageOld::OnToDateCheckValue(){
	return 0;
}
 
void CPMSoldierDrugUsageOld::OnExaminationSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	OnDeptListLoadData();
	if (m_bExamination)
...
void CPMSoldierDrugUsageOld::OnOutpatientSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}

void CPMSoldierDrugUsageOld::OnInwardSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}

void CPMSoldierDrugUsageOld::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	/*Declaration Section*/
	...
	long double nTotal = 0, nTotal2 = 0, nTtlAmt = 0, nTtlAmt2 = 0;
...
void CPMSoldierDrugUsageOld::OnExportSelect(){
	CMainFrame_E10 *pMF	= (CMainFrame_E10*)	AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
...
void CPMSoldierDrugUsageOld::OnExport(){
	CMainFrame_E10 *pMF	= (CMainFrame_E10*)	AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CRecord	rs(&pMF->m_db);
...
void CPMSoldierDrugUsageOld::OnExport2(){
	CMainFrame_E10 *pMF	= (CMainFrame_E10*)	AfxGetMainWnd();
...
void CPMSoldierDrugUsageOld::OnObjectListDblClick(){
	
}
 
void CPMSoldierDrugUsageOld::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
int CPMSoldierDrugUsageOld::OnObjectListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
}
 
long CPMSoldierDrugUsageOld::OnObjectListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CPMSoldierDrugUsageOld::OnDeptListDblClick(){
	
}
 
void CPMSoldierDrugUsageOld::OnDeptListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
int CPMSoldierDrugUsageOld::OnDeptListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
}
 
long CPMSoldierDrugUsageOld::OnDeptListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
CString CPMSoldierDrugUsageOld::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT    Get_patientname(doc_no) patient_name, ") \
				...
				_T("           WHERE     hd_outpatient = 'N' AND hcr_status = 'T' AND hcrf_acceptedfee IN ( 'Y', 'P' ) %s") \
				_T("           UNION ALL ") \
				_T("           SELECT hd_docno, ") \
				_T("                              htrf_invoicefee, ") \
				_T("                              htr_deptid, ") \
				...
				_T("           LEFT JOIN hms_doc ON ( hcr_docno = hd_docno ) ") \
				_T("           WHERE     hd_outpatient = 'Y' AND htr_status = 'T' AND htrf_acceptedfee IN ( 'Y', 'P' ) %s)") \
...
CString CPMSoldierDrugUsageOld::GetQueryString1(){
	...
	_T("		   CAST (' ' AS NVARCHAR2(1)) patient_id,") \
	...
	_T(" AND mp_org_id = 'PM' AND hpo_orderstatus IN ('A') %s ") \
...
CString CPMSoldierDrugUsageOld::GetQueryString2(){
	CString szSQL, szWhere, szWhereObject, szObjects, szDepts;
	szWhere.Format(_T(" AND discharge_date BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
...
CString CPMSoldierDrugUsageOld::GetQueryString3(){
	CString szSQL, szWhere, szObjects, szDepts;
	szWhere.Format(_T(" AND he_examdate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
