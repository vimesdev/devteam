#ifndef MADETAILHIGHTECHMATERIAL_H
#define MADETAILHIGHTECHMATERIAL_H
...
#include "GuiView.h"
#include "DbField.h"
class CMADetailHightechMaterial : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMADetailHightechMaterial(CWnd *pParent);
	~CMADetailHightechMaterial();
