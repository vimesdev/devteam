#include "stdafx.h"
#include "PMSUseDrugCabinet.h"
#include "MainFrame_E10.h"
#include "ReportDocument.h"
#include ".\PMSUseDrugCabinet.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSUseDrugCabinet* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnStockAddNew();
}*/
/*static void _OnNameChangeFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnNameChange();
} */
/*static void _OnNameSetfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnNameSetfocus();} */ 
/*static void _OnNameKillfocusFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet *)pWnd)->OnNameKillfocus();
} */
static int _OnNameCheckValueFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet *)pWnd)->OnNameCheckValue();
} 


static int _OnListSelectAllFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet*)pWnd)->OnListSelectAll();
} 
static int _OnListUnselectAllFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet*)pWnd)->OnListUnselectAll();
} 
static void _OnByProductLineSelectFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet*)pWnd)->OnByProductLineSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CPMSUseDrugCabinet*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPMSUseDrugCabinet*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CPMSUseDrugCabinet*)pWnd)->OnListDeleteItem();
} 
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CPMSUseDrugCabinet *pVw = (CPMSUseDrugCabinet *)pWnd;
...
static int _OnAddPMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CPMSUseDrugCabinet*)pWnd)->OnAddPMSStockCardReportDialog();
} 
static int _OnEditPMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CPMSUseDrugCabinet*)pWnd)->OnEditPMSStockCardReportDialog();
} 
static int _OnDeletePMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CPMSUseDrugCabinet*)pWnd)->OnDeletePMSStockCardReportDialog();
} 
static int _OnSavePMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CPMSUseDrugCabinet*)pWnd)->OnSavePMSStockCardReportDialog();
} 
static int _OnCancelPMSStockCardReportDialogFnc(CWnd *pWnd){
	 return ((CPMSUseDrugCabinet*)pWnd)->OnCancelPMSStockCardReportDialog();
} 
static void _OnduySelectFnc(CWnd *pWnd){
	((CPMSUseDrugCabinet*)pWnd)->OnduySelect();
}
CPMSUseDrugCabinet::CPMSUseDrugCabinet(CWnd *pParent)
	{
	m_nDlgWidth = 585;
	m_nDlgHeight = 590;
	SetDefaultValues();
...
CPMSUseDrugCabinet::~CPMSUseDrugCabinet(){
}
void CPMSUseDrugCabinet::OnCreateComponents(){
...
void CPMSUseDrugCabinet::OnInitializeComponents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CPMSUseDrugCabinet::OnSetWindowEvents(){
...
void CPMSUseDrugCabinet::OnDoDataExchange(CDataExchange* pDX){
...
void CPMSUseDrugCabinet::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CPMSUseDrugCabinet::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CPMSUseDrugCabinet::SetDefaultValues()
{
...
int CPMSUseDrugCabinet::SetMode(int nMode)
{
...
/*void CPMSUseDrugCabinet::OnFromDateChange(){
	
} */
/*void CPMSUseDrugCabinet::OnFromDateSetfocus(){
	
} */
/*void CPMSUseDrugCabinet::OnFromDateKillfocus(){
	
} */
int CPMSUseDrugCabinet::OnFromDateCheckValue(){
	return 0;
} 
/*void CPMSUseDrugCabinet::OnToDateChange(){
	
} */
/*void CPMSUseDrugCabinet::OnToDateSetfocus(){
	
} */
/*void CPMSUseDrugCabinet::OnToDateKillfocus(){
	
} */
int CPMSUseDrugCabinet::OnToDateCheckValue(){
	return 0;
} 
void CPMSUseDrugCabinet::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMSUseDrugCabinet::OnStockSelendok(){
	UpdateData(true);
	//OnListLoadData();
	 
}
/*void CPMSUseDrugCabinet::OnStockSetfocus(){
	
}*/
/*void CPMSUseDrugCabinet::OnStockKillfocus(){
	
}*/
long CPMSUseDrugCabinet::OnStockLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadStorageList(&m_wndStock, m_szStockKey);
}
/*void CPMSUseDrugCabinet::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CPMSUseDrugCabinet::OnNameChange(){
	
} */
/*void CPMSUseDrugCabinet::OnNameSetfocus(){
	
} */
/*void CPMSUseDrugCabinet::OnNameKillfocus(){
	
} */
int CPMSUseDrugCabinet::OnNameCheckValue(){
	OnListLoadData();
	return 1;
}


int CPMSUseDrugCabinet::OnListSelectAll(){
...
int CPMSUseDrugCabinet::OnListUnselectAll(){
	for (int i =0; i < m_wndList.GetItemCount(); i++)
	{
...
void CPMSUseDrugCabinet::OnListDblClick(){
	UpdateData(TRUE);
...
void CPMSUseDrugCabinet::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CPMSUseDrugCabinet::OnListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 
long CPMSUseDrugCabinet::OnListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CPMSUseDrugCabinet::OnByProductLineSelect(){
	OnListLoadData();
}
void CPMSUseDrugCabinet::OnduySelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CPMSUseDrugCabinet::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	switch (m_nPrintID)
	{
		case 1:
...
void CPMSUseDrugCabinet::OnPrintSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	switch (m_nPrintID)
	{
...
void CPMSUseDrugCabinet::OnExportSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	CString tmpStr;
	CGuiMenu menu(this);
...
void CPMSUseDrugCabinet::OnExport(bool bPreview){
	...
	szSQL.Format(_T(" select  product_name,sum(hpol_qtyissue) as qty, product_vatprice,product_vatprice* sum(hpol_qtyissue) as amount    ") \
				...
				_T(" where") \
				_T(" HPO_APPROVEDATE between  to_timestamp('%s','YYYY/MM/DD HH24:MI:SS') and to_timestamp('%s','YYYY/MM/DD HH24:MI:SS')") \
				_T(" and hpo_storage_id= %d ") \
				_T(" and hpo_orderstatus in ('A','I')") \
				_T(" UNION ALL") \
				_T(" select  hpol_product_item_id, hpol_qtyissue ") \
	...
	while (!rs.IsEOF())
	{
		...
		xls.SetCellText(1, nRow, rs.GetValue(_T("product_name")), 4098);
...
void CPMSUseDrugCabinet::OnExport2(bool bPreview){
_debug(_T("%s"), CString(typeid(this).name()));
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	szSQL.Format(_T(" select get_patientname(hpo_docno) as pname,") \
				...
				_T("	TO_CHAR(hpo_approvedate,'DD/MM/YYYY') as approvedate,hpo_doctor") \
				_T(" from hms_pharmaorder") \
				_T(" left join HMS_PHARMAORDERLINE ON (hpol_orderid = hpo_orderid)") \
	...
	while (!rs.IsEOF())
	{
		rs.GetValue(_T("hpo_docno"),szOrderNew);
		if(szOrderNew!= szOrderOld)
		{
			...
			xls.SetCellText(4, nRow, pMF->GetUserName(tmpStr),FMT_TEXT);
...
void CPMSUseDrugCabinet::OnExport3(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(TRUE);
	BeginWaitCursor();
...
void CPMSUseDrugCabinet::OnOrderExport(bool bPreview){
	_debug(_T("%s"), CString(typeid(this).name()));
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CPMSUseDrugCabinet::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CPMSUseDrugCabinet::OnAddPMSStockCardReportDialog(){
...
int CPMSUseDrugCabinet::OnEditPMSStockCardReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CPMSUseDrugCabinet::OnDeletePMSStockCardReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CPMSUseDrugCabinet::OnSavePMSStockCardReportDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CPMSUseDrugCabinet::OnCancelPMSStockCardReportDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CPMSUseDrugCabinet::OnPMSStockCardReportDialogListLoadData(){
	return 0;
}

void CPMSUseDrugCabinet::OnPrint(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CReport rpt;
...
void CPMSUseDrugCabinet::OnPrint2(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	UpdateData(true);
	BeginWaitCursor();
...
void CPMSUseDrugCabinet::OnOrderPrint(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
...
void CPMSUseDrugCabinet::OnOrderPrint2(bool bPreview)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	CReport rpt;
...
CString CPMSUseDrugCabinet::GetQueryString_FP(long nID){
	CString szSQL;
	
	return szSQL;
}

CString CPMSUseDrugCabinet::GetQueryString_IO(long nID){
	CString szSQL;

	return szSQL;
}

BEGIN_MESSAGE_MAP(CPMSUseDrugCabinet, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CPMSUseDrugCabinet::OnSetFocus(CWnd* pOldWnd)
{
