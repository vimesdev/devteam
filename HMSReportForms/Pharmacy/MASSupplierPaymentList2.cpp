#include "stdafx.h"
#include "MASSupplierPaymentList2.h"
...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList2 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList2 *)pWnd)->OnToDateCheckValue();
} 
static long _OnSupplierLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList2 *)pWnd)->OnSupplierLoadData();
}
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASSupplierPaymentList2* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList2 *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnStorageAddNew();
}*/
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASSupplierPaymentList2* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList2 *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASSupplierPaymentList2* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList2 *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CMASSupplierPaymentList2 *)pWnd)->OnSourceAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CMASSupplierPaymentList2 *pVw = (CMASSupplierPaymentList2 *)pWnd;
...
CMASSupplierPaymentList2::CMASSupplierPaymentList2(CWnd *pParent){

	m_nDlgWidth = 585;
	m_nDlgHeight = 359;
	SetDefaultValues();
}
CMASSupplierPaymentList2::~CMASSupplierPaymentList2(){
}
void CMASSupplierPaymentList2::OnCreateComponents(){
...
void CMASSupplierPaymentList2::OnInitializeComponents(){
...
void CMASSupplierPaymentList2::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CMASSupplierPaymentList2::OnDoDataExchange(CDataExchange* pDX){
...
void CMASSupplierPaymentList2::SetDefaultValues(){
...
int CMASSupplierPaymentList2::SetMode(int nMode){
...
/*void CMASSupplierPaymentList2::OnFromDateChange(){
	
} */
/*void CMASSupplierPaymentList2::OnFromDateSetfocus(){
	
} */
/*void CMASSupplierPaymentList2::OnFromDateKillfocus(){
	
} */
int CMASSupplierPaymentList2::OnFromDateCheckValue(){
	return 0;
} 
/*void CMASSupplierPaymentList2::OnToDateChange(){
	
} */
/*void CMASSupplierPaymentList2::OnToDateSetfocus(){
	
} */
/*void CMASSupplierPaymentList2::OnToDateKillfocus(){
	
} */
int CMASSupplierPaymentList2::OnToDateCheckValue(){
	return 0;
} 
long CMASSupplierPaymentList2::OnSupplierLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadPartnerList(&m_wndSupplier, m_szSupplierKey);
}
void CMASSupplierPaymentList2::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASSupplierPaymentList2::OnStorageSelendok(){
	 
}
long CMASSupplierPaymentList2::OnStorageLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CMASSupplierPaymentList2::OnStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASSupplierPaymentList2::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASSupplierPaymentList2::OnItemGroupSelendok(){
	 
}
/*void CMASSupplierPaymentList2::OnItemGroupSetfocus(){
	
}*/
/*void CMASSupplierPaymentList2::OnItemGroupKillfocus(){
	
}*/
long CMASSupplierPaymentList2::OnItemGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CMASSupplierPaymentList2::OnItemGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASSupplierPaymentList2::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASSupplierPaymentList2::OnSourceSelendok(){
	 
}
/*void CMASSupplierPaymentList2::OnSourceSetfocus(){
	
}*/
/*void CMASSupplierPaymentList2::OnSourceKillfocus(){
	
}*/
long CMASSupplierPaymentList2::OnSourceLoadData()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CMASSupplierPaymentList2::OnSourceAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASSupplierPaymentList2::OnPrintPreviewSelect(){
	/*
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CMASSupplierPaymentList2::OnExportSelect(){
...
CString CMASSupplierPaymentList2::GetQueryString1(){
...
CString CMASSupplierPaymentList2::GetQueryString2(){
	CString szSQL, szWhere, szStorages;
	szWhere.Format(_T("AND po_approveddate BETWEEN to_date('%s', 'yyyy/mm/dd hh24:mi:ss') AND to_date('%s', 'yyyy/mm/dd hh24:mi:ss')"), m_szFromDate, m_szToDate);
	if(!m_szSupplierKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND po_partner_id = '%s'"), m_szSupplierKey);
...
BEGIN_MESSAGE_MAP(CMASSupplierPaymentList2, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CMASSupplierPaymentList2::OnSetFocus(CWnd* pOldWnd)
{
