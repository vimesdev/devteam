#ifndef MASSupplierPaymentList2_H
#define MASSupplierPaymentList2_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASSupplierPaymentList2 : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMASSupplierPaymentList2(CWnd *pParent);
	~CMASSupplierPaymentList2();
