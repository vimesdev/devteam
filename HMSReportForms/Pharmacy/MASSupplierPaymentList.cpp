...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList *)pWnd)->OnToDateCheckValue();
} 
static long _OnSupplierLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList *)pWnd)->OnSupplierLoadData();
}
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASSupplierPaymentList* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnStorageAddNew();
}*/
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASSupplierPaymentList* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnSourceSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMASSupplierPaymentList* )pWnd)->OnSourceSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnSourceSelendokFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnSourceSelendok();
}
/*static void _OnSourceSetfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnSourceKillfocus();
}*/
/*static void _OnSourceKillfocusFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnSourceKillfocus();
}*/
static long _OnSourceLoadDataFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList *)pWnd)->OnSourceLoadData();
}
/*static void _OnSourceAddNewFnc(CWnd *pWnd){
	((CMASSupplierPaymentList *)pWnd)->OnSourceAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CMASSupplierPaymentList *pVw = (CMASSupplierPaymentList *)pWnd;
	pVw->OnPrintPreviewSelect();
}
static int _OnSophieuCheckValueFnc(CWnd *pWnd){
	return ((CMASSupplierPaymentList *)pWnd)->OnSophieuCheckValue();
} 
static void _OnExportSelectFnc(CWnd *pWnd){
	CMASSupplierPaymentList *pVw = (CMASSupplierPaymentList *)pWnd;
	pVw->OnExportSelect();
} 
CMASSupplierPaymentList::CMASSupplierPaymentList(CWnd *pParent)
{
...
CMASSupplierPaymentList::~CMASSupplierPaymentList(){
}
void CMASSupplierPaymentList::OnCreateComponents()
{
...
void CMASSupplierPaymentList::OnInitializeComponents(){
...
void CMASSupplierPaymentList::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CMASSupplierPaymentList::OnDoDataExchange(CDataExchange* pDX){
...
void CMASSupplierPaymentList::SetDefaultValues(){
...
int CMASSupplierPaymentList::SetMode(int nMode){
...
int CMASSupplierPaymentList::OnSophieuCheckValue()
{
	return 0;
} 
/*void CMASSupplierPaymentList::OnFromDateChange(){
	
} */
/*void CMASSupplierPaymentList::OnFromDateSetfocus(){
	
} */
/*void CMASSupplierPaymentList::OnFromDateKillfocus(){
	
} */
int CMASSupplierPaymentList::OnFromDateCheckValue(){
	return 0;
} 
/*void CMASSupplierPaymentList::OnToDateChange(){
	
} */
/*void CMASSupplierPaymentList::OnToDateSetfocus(){
	
} */
/*void CMASSupplierPaymentList::OnToDateKillfocus(){
	
} */
int CMASSupplierPaymentList::OnToDateCheckValue(){
	return 0;
} 
long CMASSupplierPaymentList::OnSupplierLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadPartnerList(&m_wndSupplier, m_szSupplierKey);
}
void CMASSupplierPaymentList::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASSupplierPaymentList::OnStorageSelendok(){
	 
}
long CMASSupplierPaymentList::OnStorageLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CMASSupplierPaymentList::OnStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASSupplierPaymentList::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASSupplierPaymentList::OnItemGroupSelendok(){
	 
}
/*void CMASSupplierPaymentList::OnItemGroupSetfocus(){
	
}*/
/*void CMASSupplierPaymentList::OnItemGroupKillfocus(){
	
}*/
long CMASSupplierPaymentList::OnItemGroupLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CMASSupplierPaymentList::OnItemGroupAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASSupplierPaymentList::OnSourceSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CMASSupplierPaymentList::OnSourceSelendok(){
	 
}
/*void CMASSupplierPaymentList::OnSourceSetfocus(){
	
}*/
/*void CMASSupplierPaymentList::OnSourceKillfocus(){
	
}*/
long CMASSupplierPaymentList::OnSourceLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CMASSupplierPaymentList::OnSourceAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CMASSupplierPaymentList::OnPrintPreviewSelect(){
	/*
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CMASSupplierPaymentList::OnExportSelect(){
	...
	while (!rs.IsEOF())
	{
		...
		xls.SetCellText(nCol + 2, nRow, rs.GetValue(_T("invoicedate")), FMT_TEXT);
		xls.SetCellText(nCol + 4, nRow, rs.GetValue(_T("importdate")), FMT_TEXT);
...
CString CMASSupplierPaymentList::GetQueryString1(){
...
CString CMASSupplierPaymentList::GetQueryString2(){
	CString szSQL, szWhere, szStorages, szSources;
	szWhere.Format(_T("AND pp_acctdate BETWEEN TO_TIMESTAMP('%s', 'yyyy/mm/dd hh24:mi:ss') AND TO_TIMESTAMP('%s', 'yyyy/mm/dd hh24:mi:ss')"), m_szFromDate, m_szToDate);
	if(!m_szSupplierKey.IsEmpty())
		szWhere.AppendFormat(_T(" AND po_partner_id = '%s'"), m_szSupplierKey);
...
BEGIN_MESSAGE_MAP(CMASSupplierPaymentList, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CMASSupplierPaymentList::OnSetFocus(CWnd* pOldWnd)
{
