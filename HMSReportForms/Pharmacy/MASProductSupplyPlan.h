#ifndef MASProductSupplyPlan_H
#define MASProductSupplyPlan_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASProductSupplyPlan : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMASProductSupplyPlan(CWnd *pParent);
	~CMASProductSupplyPlan();
