#ifndef PMSThuocBHChuaMap_H
#define PMSThuocBHChuaMap_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSThuocBHChuaMap : public CGuiView{
protected:
public:
	...
	CGuiCheckBox    m_wndStorage;
	CGuiCheckBox    m_wndAll;
	CGuiCheckBox    m_wndError;
	...
	void			OnExport3();
	void			OnExport4();
	CPMSThuocBHChuaMap(CWnd *pParent);
	~CPMSThuocBHChuaMap();
