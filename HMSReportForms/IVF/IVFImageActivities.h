#ifndef IVFIMAGEACTIVITIES_H
#define IVFIMAGEACTIVITIES_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CIVFImageActitivities : public CGuiView
{
protected:
...
public:
	...
	CIVFImageActitivities(CWnd *pParent);
	~CIVFImageActitivities();
