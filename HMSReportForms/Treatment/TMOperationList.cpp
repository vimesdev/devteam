#include "stdafx.h"
#include "TMOperationList.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CTMOperationList *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CTMOperationList* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CTMOperationList *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CTMOperationList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CTMOperationList *)pWnd)->OnToDateCheckValue();
} 
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CTMOperationList* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CTMOperationList *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CTMOperationList *)pWnd)->OnDeptAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CTMOperationList *pVw = (CTMOperationList *)pWnd;
	pVw->OnPrintSelect();
} 
...
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnPolicySelect();
}
static void _OnPaymentSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnPaymentSelect();
}
static void _OnPayment2SelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnPayment2Select();
}
static void _OnSurgerySelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnSurgerySelect();
}
static void _OnOperationSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnOperationSelect();
}
static void _OnParaclinicalSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnParaclinicalSelect();
}
static void _OnKPLSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnKPLSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnAllSelect();
}
static void _OnInpatientSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnOutpatientSelect();
}
static void _OnFromExamSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnFromExamSelect();
}
static void _OnBNTYCSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnBNTYCSelect();
}
static void _OnKBNTYCSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnKBNTYCSelect();
}
static void _OnGiamDauSelectFnc(CWnd *pWnd){
	((CTMOperationList*)pWnd)->OnGiamDauSelect();
}
static int _OnAddTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationList*)pWnd)->OnAddTMOperationList();
} 
static int _OnEditTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationList*)pWnd)->OnEditTMOperationList();
} 
static int _OnDeleteTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationList*)pWnd)->OnDeleteTMOperationList();
} 
static int _OnSaveTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationList*)pWnd)->OnSaveTMOperationList();
} 
static int _OnCancelTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationList*)pWnd)->OnCancelTMOperationList();
}
static void _OnDeptDblClickFnc(CWnd *pWnd)
{
	((CTMOperationList*)pWnd)->OnDeptDblClick();
}

static void _OnDichvu_TYCSelectFnc(CWnd *pWnd){
	 ((CTMOperationList*)pWnd)->OnDichvu_TYCSelect();
}

static void _OnOnlyPTVSelectFnc(CWnd *pWnd)
{
	 ((CTMOperationList*)pWnd)->OnOnlyPTVSelect();
}
static void _OnNotincludePTVSelectFnc(CWnd *pWnd)
{
	 ((CTMOperationList*)pWnd)->OnNotincludePTVSelect();
}

static void _OnLayCLSchuathuchienSelectFnc(CWnd *pWnd)
{
	 ((CTMOperationList*)pWnd)->OnLayCLSchuathuchienSelect();
}

CTMOperationList::CTMOperationList(CWnd* pParent)
{
...
CTMOperationList::~CTMOperationList()
{
}
void CTMOperationList::OnCreateComponents()
{
	
	m_wndReportFilter.Create(this, _T("Report Parameters"), 5, 5, 510, 526);
	m_wndYearLabel.Create(this, _T("Year"), 9, 32, 99, 57);
	m_wndYear.Create(this,104, 32, 254, 57); 
	m_wndReportPeriodLabel.Create(this, _T("Report Period"), 259, 32, 349, 57);
	m_wndReportPeriod.Create(this,354, 32, 504, 57); 
	m_wndFromDateLabel.Create(this, _T("From Date"), 9, 62, 99, 87);
	m_wndFromDate.Create(this,104, 62, 254, 87); 
	m_wndToDateLabel.Create(this, _T("To Date"), 259, 62, 349, 87);
	m_wndToDate.Create(this,354, 62, 504, 87); 
	m_wndDeptLabel.Create(this, _T("Dept"), 9, 92, 99, 117);
	m_wndDept.Create(this,10, 91, 505, 300);
	m_wndDept.SetCheckBox(true);
	m_wndInsurance.Create(this, _T("Insurance"), 9, 305, 99, 330);
	m_wndService.Create(this, _T("Service"), 104, 305, 194, 330);
	m_wndPolicy.Create(this, _T("Policies"), 199, 305, 279, 330);
	m_wndPayment.Create(this, _T("Chưa nộp quỹ"), 284, 305, 394, 330);
	m_wndPayment2.Create(this, _T("Ðã nộp quỹ"), 399, 305, 504, 330);
	m_wndSurgery.Create(this, _T("Surgery"), 9, 335, 99, 360);
	m_wndOperation.Create(this, _T("Operation"), 104, 335, 194, 360);
	m_wndParaclinical.Create(this, _T("Paraclinical"), 199, 335, 319, 360);
	m_wndAll.Create(this, _T("All"), 9, 364, 99, 389);
	m_wndInpatient.Create(this, _T("InPatient"), 104, 364, 194, 389);
	m_wndOutpatient.Create(this, _T("OutPatient"), 199, 364, 319, 389);
	m_wndFromExam.Create(this, _T("Từ phòng khám"), 324, 364, 444, 389);
	m_wndBNTYC.Create(this, _T("BN TYC"), 9, 395, 99, 420);
	m_wndKBNTYC.Create(this, _T("Bỏ BN TYC"), 104, 395, 194, 420);
	m_wndGiamDau.Create(this, _T("Gói giảm đau"), 199, 395, 319, 420);
	m_wndDichvu_TYC.Create(this, _T("Dichvu_TYC"), 9, 425, 319, 450);
	m_wndOnlyPTV.Create(this, _T("Chọn phẫu thuật viên"), 9, 456, 319, 481);
	m_wndNotincludePTV.Create(this, _T("Không tính chọn phẫu thuật viên"), 9, 486, 319, 511);
	m_wndLayCLSchuathuchien.Create(this, _T("Lấy thêm CLS chưa thực hiện"), 9, 517, 319, 542);
	m_wndExport.Create(this, _T("&ExportXLS"), 404, 517, 504, 542);

	m_wndKPL.Create(this, L"", 0, 0, 0, 0);
	m_wndKPL.ShowWindow(SW_HIDE);
	m_wndKPL.EnableWindow(FALSE);
}
void CTMOperationList::OnInitializeComponents(){
	...
	m_wndDept.InsertColumn(1, _T("Alias"), CFMT_TEXT, 80);
	m_wndDept.InsertColumn(2, _T("Name"), CFMT_TEXT, 400);

}
void CTMOperationList::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	m_wndDichvu_TYC.SetEvent(WE_CLICK, _OnDichvu_TYCSelectFnc);
	m_wndOnlyPTV.SetEvent(WE_CLICK, _OnOnlyPTVSelectFnc);
	m_wndNotincludePTV.SetEvent(WE_CLICK, _OnNotincludePTVSelectFnc);
	m_wndLayCLSchuathuchien.SetEvent(WE_CLICK, _OnLayCLSchuathuchienSelectFnc);
...
void CTMOperationList::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndDichvu_TYC.GetDlgCtrlID(), m_bDichvu_TYC);
	DDX_Check(pDX, m_wndOnlyPTV.GetDlgCtrlID(), m_bOnlyPTV);
	DDX_Check(pDX, m_wndNotincludePTV.GetDlgCtrlID(), m_bNotincludePTV);
	DDX_Check(pDX, m_wndLayCLSchuathuchien.GetDlgCtrlID(), m_bLayCLSchuathuchien);

}
void CTMOperationList::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CTMOperationList::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CTMOperationList::SetDefaultValues(){
	...
	m_bDichvu_TYC=FALSE;
	m_bOnlyPTV=FALSE;
	m_bNotincludePTV=FALSE;
	m_bLayCLSchuathuchien=FALSE;

}
int CTMOperationList::SetMode(int nMode){
...
/*void CTMOperationList::OnYearChange(){
	
} */
/*void CTMOperationList::OnYearSetfocus(){
	
} */
/*void CTMOperationList::OnYearKillfocus(){
	
} */
int CTMOperationList::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CTMOperationList::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CTMOperationList::OnDeptDblClick()
{
	
}

void CTMOperationList::OnOnlyPTVSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	
}
	void CTMOperationList::OnNotincludePTVSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	
}

void CTMOperationList::OnReportPeriodSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CTMOperationList::OnReportPeriodSetfocus(){
	
}*/
/*void CTMOperationList::OnReportPeriodKillfocus(){
	
}*/
long CTMOperationList::OnReportPeriodLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CTMOperationList::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CTMOperationList::OnFromDateChange(){
	
} */
/*void CTMOperationList::OnFromDateSetfocus(){
	
} */
/*void CTMOperationList::OnFromDateKillfocus(){
	
} */
int CTMOperationList::OnFromDateCheckValue(){
	return 0;
} 
/*void CTMOperationList::OnToDateChange(){
	
} */
/*void CTMOperationList::OnToDateSetfocus(){
	
} */
/*void CTMOperationList::OnToDateKillfocus(){
	
} */
int CTMOperationList::OnToDateCheckValue(){
	return 0;
} 
void CTMOperationList::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CTMOperationList::OnDeptSelendok(){
	 
}
/*void CTMOperationList::OnDeptSetfocus(){
	
}*/
/*void CTMOperationList::OnDeptKillfocus(){
	
}*/
long CTMOperationList::OnDeptLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;			
...
/*void CTMOperationList::OnDeptAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CTMOperationList::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
void CTMOperationList::OnDichvu_TYCSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CTMOperationList::OnLayCLSchuathuchienSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
void CTMOperationList::OnExportSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
...
void CTMOperationList::OnExport1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	double nAmount1 = 0, nTotalAmount1 = 0;
	double nAmount2 = 0, nTotalAmount2 = 0;
    ...
    xls.SetCellText(nCol + 10, nRow + 1, _T("Phụ 2"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
	xls.SetCellText(nCol+11,nRow+1,_T("Giúp việc"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+12,nRow,2);
	xls.SetCellText(nCol+12,nRow,_T("Số tiền"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+13,nRow,2);
	xls.SetCellText(nCol+13,nRow,_T("Trả kíp PT"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+14,nRow,2);
	xls.SetCellText(nCol+14,nRow,_T("Trả gây mê"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+15,nRow,2);
	xls.SetCellText(nCol+15,nRow,_T("Tên phẫu thuật theo phần mềm"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol + 16, nRow, 2);
    xls.SetCellText(nCol + 16, nRow, _T("Khoa chỉ định"),FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);

	xls.SetCellMergedRows(nCol+17,nRow,2);
	xls.SetCellText(nCol+17,nRow,_T("Ngày thực hiện"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+18,nRow,2);
	xls.SetCellText(nCol+18,nRow,_T("Đối tượng"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);
	...
	while (!rs.IsEOF())
	{
		...
		//tmpStr.Format(_T("%s - %s"), rs.GetValue(_T("anethetist")), rs.GetValue(_T("anethetist1")));
		//xls.SetCellText(11, nRow, tmpStr, FMT_TEXT|FMT_WRAPING);

		rs.GetValue(_T("am"), nAmount);
		nTotalAmount += nAmount;
		xls.SetCellText(12, nRow, double2str(nAmount), FMT_NUMBER1|FMT_WRAPING);
		
		rs.GetValue(_T("am1"), nAmount1);
		nTotalAmount1 += nAmount1;
		xls.SetCellText(13, nRow, double2str(nAmount1), FMT_NUMBER1|FMT_WRAPING);

		rs.GetValue(_T("am2"), nAmount2);
		nTotalAmount2 += nAmount2;
		xls.SetCellText(14, nRow, double2str(nAmount2), FMT_NUMBER1|FMT_WRAPING);		

		xls.SetCellText(15, nRow, rs.GetValue(_T("operation_name")), FMT_TEXT|FMT_WRAPING);

		xls.SetCellText(16, nRow, rs.GetValue(_T("deptid")), FMT_TEXT | FMT_WRAPING);
		rs.GetValue(_T("performdate"), tmpStr);
		xls.SetCellText(17, nRow, CDateTime::Convert(tmpStr, yyyymmdd|hhmmss, ddmmyyyy|hhmmss), FMT_TEXT|FMT_WRAPING);
		xls.SetCellText(18, nRow, rs.GetValue(_T("objectname")), FMT_TEXT|FMT_WRAPING);
		nRow++;
		rs.MoveNext();
	}
	...
	xls.SetCellText(12, nRow, double2str(nTotalAmount),FMT_NUMBER1|FMT_RIGHT|FMT_WRAPING, true);
	xls.SetCellText(13, nRow, double2str(nTotalAmount1),FMT_NUMBER1|FMT_RIGHT|FMT_WRAPING, true);
	xls.SetCellText(14, nRow, double2str(nTotalAmount2),FMT_NUMBER1|FMT_RIGHT|FMT_WRAPING, true);
	nRow++;
	nCol = 0;
	...
	xls.SetCellText(nCol+12, nRow, _T("TT kíp mổ"), FMT_TEXT, true, 10);
	xls.SetCellText(nCol+13, nRow, _T("TT gây mê"), FMT_TEXT, true, 10);	
...
void CTMOperationList::OnExport2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	//Lấy thêm 1 số CLS thực hiện tại khoa, trạng thái S, không nhập kết quả, ví dụ A2-A
	if (m_bLayCLSchuathuchien)
	{
		szSQL = GetQuerySring1_V2();
	}
	else
	{
    ...
    if (m_bKPL == TRUE)
        xls.SetCellText(nCol++, nRow, _T("KPL"),FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
    else
        xls.SetCellText(nCol++, nRow, _T("Đặc biệt"),FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);

    xls.SetCellText(nCol++, nRow, _T("Loại 1"),FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
    xls.SetCellText(nCol++, nRow, _T("Loại 2"),FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
    xls.SetCellText(nCol++, nRow, _T("Loại 3"),FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
	xls.SetCellText(nCol++, nRow,_T("Khoa chỉ định"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);
	...
	while (!rs.IsEOF())
	{
		...
		if (m_bKPL == TRUE)
        {
            rs.GetValue(_T("KPL"), nAM);
            tmpStr.Format(_T("%.2f"), nAM);
            xls.SetCellText(nCol++, nRow, tmpStr, FMT_NUMBER1 | FMT_WRAPING);
        }
        else
        {
            rs.GetValue(_T("LDB"), nAM);
            tmpStr.Format(_T("%.2f"), nAM);
            xls.SetCellText(nCol++, nRow, tmpStr, FMT_NUMBER1 | FMT_WRAPING);
        }
        nTotalGroup[0] += nAM;

        rs.GetValue(_T("L1"), nAM);
        tmpStr.Format(_T("%.2f"), nAM);
        xls.SetCellText(nCol++, nRow, tmpStr, FMT_NUMBER1 | FMT_WRAPING);
        nTotalGroup[1] += nAM;

        rs.GetValue(_T("L2"), nAM);
        tmpStr.Format(_T("%.2f"), nAM);
        xls.SetCellText(nCol++, nRow, tmpStr, FMT_NUMBER1 | FMT_WRAPING);
        nTotalGroup[2] += nAM;

        rs.GetValue(_T("L3"), nAM);
        tmpStr.Format(_T("%.2f"), nAM);
        xls.SetCellText(nCol++, nRow, tmpStr, FMT_NUMBER1 | FMT_WRAPING);
        nTotalGroup[3] += nAM;

		xls.SetCellText(nCol++, nRow, rs.GetValue(_T("deptid")), FMT_TEXT|FMT_WRAPING);
...
void CTMOperationList::OnInsuranceSelect(){
	
}
void CTMOperationList::OnServiceSelect(){
	
}
void CTMOperationList::OnPolicySelect(){
	
}
	void CTMOperationList::OnOperationSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bOperation)
	{
	...
	void CTMOperationList::OnSurgerySelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bSurgery)
	{
	...
	void CTMOperationList::OnParaclinicalSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bParaclinical)
	{
	...
	void CTMOperationList::OnPaymentSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bPayment)
		{
	...
	void CTMOperationList::OnPayment2Select(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bPayment2)
		{
	...
	void CTMOperationList::OnAllSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bAll)
		{
	...
	void CTMOperationList::OnInpatientSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bInpatient)
		{
	...
	void CTMOperationList::OnOutpatientSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bOutpatient)
		{
	...
	void CTMOperationList::OnFromExamSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bFromExam)
		{
	...
	void CTMOperationList::OnBNTYCSelect()
	{
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bBNTYC)
	...
	void CTMOperationList::OnKBNTYCSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bKBNTYC)
		{
	...
	void CTMOperationList::OnKPLSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

	}
	void CTMOperationList::OnGiamDauSelect(){
		CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

	}
int CTMOperationList::OnAddTMOperationList(){
...
int CTMOperationList::OnEditTMOperationList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CTMOperationList::OnDeleteTMOperationList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CTMOperationList::OnSaveTMOperationList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CTMOperationList::OnCancelTMOperationList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CTMOperationList::OnTMOperationListListLoadData()
{
	return 0;
}
CString CTMOperationList::GetQuerySring(){
	CHMSMainFrame * pMF =(CHMSMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	...
	if(!szDept.IsEmpty())
		{
			...
			if(szDept == _T("C6"))
				{
					...
					szWhere2.AppendFormat(_T("AND hpc_pdeptid in (%s) AND hpc_deptid NOT IN('TYC', 'PTTYC')"), szDept);
				}
            ...
            else if (szDept == _T("'A3-C'"))
			{
                szWhere1.AppendFormat(_T("AND (select su_deptid from sys_user where su_userid = ho_practitioner) = %s AND deptid IN ('A11', 'KB_A11') "),szDept);
                szWhere2.AppendFormat(_T("AND (select su_deptid from sys_user where su_userid = hpc_practitioner) = %s AND hpc_deptid IN ('A11', 'KB_A11') "),szDept);
			}
            else
			{
				szWhere1.AppendFormat(_T("AND pdeptid in (%s) AND deptid NOT IN('TYC', 'PTTYC')"), szDept);
				szWhere2.AppendFormat(_T("AND hpc_pdeptid in (%s) AND hpc_deptid NOT IN('TYC', 'PTTYC')"), szDept);
	...
	*/
	...
	if(m_bDichvu_TYC)
		{
			szWhere1.AppendFormat(_T(" AND NVL(hfl_tyc, 'XXX') = 'TYC' "));
			szWhere2.AppendFormat(_T(" AND NVL(hfl_tyc, 'XXX') = 'TYC' "));
		}

	if(m_bOnlyPTV)
		{
			szWhere1.AppendFormat(_T(" AND NVL(hfl_categoryid, 0) = '501' "));
			szWhere2.AppendFormat(_T(" AND NVL(hfl_categoryid, 0) = '501' "));
		}
	...
	szSQL.Format(_T(" SELECT docno, record_no, patient_name, yob, extra_info, operation_name, ") \
		_T(" operation_name1, sum(l1) as l1, sum(l2) as l2, sum(l3) as l3, sum(ldb) as ldb, sum(kpl) as kpl, ") \
		_T(" sum(amount) am, sum(amount1) am1, sum(amount2) am2, ") \
		_T(" practitioner, assistant, anethetist,anethetist1, objectname, performdate, deptid ") \
		_T(" FROM ( ") \
		_T(" SELECT ") \
		_T(" docno,") \
		...
		_T(" ELSE 0") \
		_T(" END AS KPL,") \
		_T(" amount, amount1, amount2, ") \
		_T(" practitioner,") \
		_T(" assistant,") \
		_T(" anethetist,") \
		_T(" anethetist1,") \
		_T(" ho_desc AS objectname,") \
		_T(" performdate, deptid") \
		_T(" FROM") \
		_T(" (") \
		...
		_T("   ho_qty*hfl_retprice1          AS amount1,") \
		_T("   ho_qty*hfl_retprice2          AS amount2,") \
		_T("   ho_invoiceno                  AS invoiceno,") \
		_T("   ho_performdate                AS performdate, deptid ") \
		_T(" FROM") \
		_T("   (SELECT ho_docno,") \
		_T("     ho_comment,") \
		_T("     ho_practitioner,") \
		...
		_T(" hpc_performdate AS performdate, hpc_deptid AS deptid ") \
		...
		_T(" WHERE 1 = 1 AND quantity > 0 %s ORDER BY performdate, docno ) ") \
		_T(" GROUP BY docno, record_no, patient_name, yob, extra_info, operation_name, ") \
		_T(" operation_name1, practitioner, assistant, anethetist,anethetist1, objectname, performdate, deptid "), szPTTYC, szWhere1, szWhere2, szWhere2, szWhere);
		_fmsg(_T("sring %s"), szSQL);
	return szSQL;

}
CString CTMOperationList::GetQuerySring1()
{
	CHMSMainFrame * pMF =(CHMSMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	CString szSQL, szWhere, szWhere1, szWhere2, szWhere3, szPTTYC, szTemp, szDept;
	for (int i = 0; i < m_wndDept.GetItemCount(); i++)
	{
		if (m_wndDept.GetCheck(i))
		{
	...
	if(!szDept.IsEmpty())
		{
            ...
            {
                szWhere1.AppendFormat(
                    _T("AND (select su_deptid from sys_user where su_userid = ho_practitioner) = %s AND deptid IN ('A11', 'KB_A11') "), szDept);
                szWhere2.AppendFormat(
                    _T("AND (select su_deptid from sys_user where su_userid = hpc_practitioner) = %s AND hpc_deptid IN ('A11', 'KB_A11') "),
                    szDept);
            }
			else
				{
	...
	szSQL.Format(_T(" SELECT") \
        ...
        _T(" END AS LDB,") \
        _T(" CASE") \
        _T(" WHEN groupid NOT IN ('B41', 'B45', 'B51', 'B42', 'B46', 'B52', ") \
        _T("'B43', 'B47', 'B53', 'B44', 'B54')") \
        _T(" THEN SUM(quantity)") \
        _T(" ELSE 0") \
        _T(" END AS KPL") \
		_T(" FROM") \
		...
		_T(" SELECT ho_docno                 AS docno,") \
		_T("   hfl_name                      AS operation_name,") \
		_T("   ho_comment                    AS operation_name1, deptid,") \
		...
		_T(" hpc_docno AS docno,") \
		_T(" hfl_name AS operation_name,") \
		_T(" CAST(' ' AS NVARCHAR2(1)) AS operation_name1,  hpc_deptid as deptid,") \
		...
		_T(" hd_cardno,") \
		_T(" operation_name,") \
		_T(" operation_name1, deptid, groupid,") \
		_T(" ho_desc") \
		_T(" ORDER BY docno"), szSum, szField, szWhere1, szField2, szWhere2, szField2, szWhere2, szWhere);
	_fmsg(_T("1 %s"), szSQL);
	return szSQL;
}
CString CTMOperationList::GetNameUser(CString UserName, CString LastName ){
...
CString CTMOperationList::GetItemAbbreviation(CString szItemName, CString szExtraWord)
{
	CStringArray arr;
	CString szTemp;
	CString szValue;
...
CString CTMOperationList::GetQuerySring1_V2()
{
	CHMSMainFrame * pMF =(CHMSMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	CString szSQL, szWhere, szWhere1, szWhere2, szWhere3, szPTTYC, szTemp, szDept;
	...
	else
	{
		...
		szWhere3.AppendFormat(_T(" AND hpc_orderdate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')") \
			_T(" AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS')"), m_szFromDate, m_szToDate);
	}
	...
	if(!szDept.IsEmpty())
		{
            ...
            else if (szDept == _T("'A3-C'"))
            {
			...
			else
				{
					szWhere1.AppendFormat(_T("AND pdeptid in (%s)"), szDept);
					szWhere2.AppendFormat(_T("AND hpc_pdeptid in (%s)"), szDept);
					szWhere3.AppendFormat(_T("AND hpc_deptid in (%s) AND hpc_pdeptid is null"), szDept);
				}
		}
	...
	while (iDate <= eDate)
	{
		...
		for (iDate; iDate <= eDate; iDate++)
		{
			...
			szField3.AppendFormat(_T("CASE WHEN TRUNC(hpc_orderdate) = TO_DATE('%s', 'YYYY-MM-DD') THEN hpcl_qty ELSE 0 END AS ngay%d, "), szTemp, i);
			szSum.AppendFormat(_T("SUM(ngay%d) AS ngay%d, "), i, i);
			i++;
		}
	}
	...
	szSQL.Format(_T(" SELECT") \
		...
		_T(" hd_cardno,") \
		_T(" operation_name,") \
		_T(" operation_name1, groupid,") \
		_T(" ho_desc") \
		_T(" ORDER BY docno"), szSum, szField, szWhere1, szField2, szWhere2, szField2, szWhere2, szField3, szWhere3, szWhere);
	_fmsg(_T("1v2 %s"), szSQL);
	return szSQL;
}
