...
public:
	...
	CGuiCheckBox	m_wndOnlyPTV;
	CGuiCheckBox	m_wndNotincludePTV;
	CGuiCheckBox	m_wndLayCLSchuathuchien;
	long	m_nYear;
	...
	BOOL	m_bDichvu_TYC;
	BOOL	m_bOnlyPTV;
	BOOL	m_bNotincludePTV;
	BOOL	m_bLayCLSchuathuchien;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	void			OnExport1(); 
	void			OnExport2();
	void			OnOnlyPTVSelect(); 
	void			OnNotincludePTVSelect();
	void			OnLayCLSchuathuchienSelect();
