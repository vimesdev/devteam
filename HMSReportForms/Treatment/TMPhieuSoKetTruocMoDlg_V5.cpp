#include "stdafx.h"
#include "TMPhieuSoKetTruocMoDlg_V5.h"
#include "HMSMainFrame.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnToDateCheckValue();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnListDeleteItem();
} 
static void _OnCLSTheoMauSelectFnc(CWnd *pWnd){
	CTMPhieuSoKetTruocMoDlg_V5 *pVw = (CTMPhieuSoKetTruocMoDlg_V5 *)pWnd;
...
static int _OnAddPhieuSoKetTruocMoDlgFnc(CWnd *pWnd){
	 return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnAddPhieuSoKetTruocMoDlg();
} 
static int _OnEditPhieuSoKetTruocMoDlgFnc(CWnd *pWnd){
	 return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnEditPhieuSoKetTruocMoDlg();
} 
static int _OnDeletePhieuSoKetTruocMoDlgFnc(CWnd *pWnd){
	 return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnDeletePhieuSoKetTruocMoDlg();
} 
static int _OnSavePhieuSoKetTruocMoDlgFnc(CWnd *pWnd){
	 return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnSavePhieuSoKetTruocMoDlg();
} 
static int _OnCancelPhieuSoKetTruocMoDlgFnc(CWnd *pWnd){
	 return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnCancelPhieuSoKetTruocMoDlg();
}
static int _OnListSelectAllFnc(CWnd *pWnd){
	return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnListSelectAll();
} 
static int _OnListUnselectAllFnc(CWnd *pWnd){
	return ((CTMPhieuSoKetTruocMoDlg_V5*)pWnd)->OnListUnselectAll();
}

static void _OnPatientListSelendokFnc(CWnd *pWnd)
{
	((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnPatientListSelendok();
}

static void _OnPatientListSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CTMPhieuSoKetTruocMoDlg_V5* )pWnd)->OnPatientListSelectChange(nOldItemSel, nNewItemSel);
} 

static long _OnPatientListLoadDataFnc(CWnd *pWnd)
{
	return ((CTMPhieuSoKetTruocMoDlg_V5 *)pWnd)->OnPatientListLoadData();
}

CTMPhieuSoKetTruocMoDlg_V5::CTMPhieuSoKetTruocMoDlg_V5(CWnd *pParent, int nMode, long nDocNo, int nRefIdx, long nOrderID):
	CGuiDialog(pParent)
{
...
CTMPhieuSoKetTruocMoDlg_V5::~CTMPhieuSoKetTruocMoDlg_V5(){
}
void CTMPhieuSoKetTruocMoDlg_V5::OnCreateComponents(){	

	m_wndParaclinicalInformation.Create(this, _T("Thông tin cận lâm sàng!"), 4, 5, 1014, 565);
	...
	m_wndList.Create(this,10, 60, 1010, 560);
	...
	m_wndSave.Create(this, _T("Save"), 844, 570, 924, 595);
	m_wndCancel.Create(this, _T("Cancel"), 929, 570, 1009, 595);

}
void CTMPhieuSoKetTruocMoDlg_V5::OnInitializeComponents(){
...
// 	m_wndToDate.SetCheckValue(true);
	...
	m_wndList.InsertColumn(2, _T("Group Name"), CFMT_TEXT, 200);
	m_wndList.InsertColumn(3, _T("Desc"), CFMT_TEXT, 300);
	m_wndList.InsertColumn(4, _T("Unit"), CFMT_TEXT, 50);
	m_wndList.InsertColumn(5, _T("Qty"), CFMT_TEXT, 30);
	m_wndList.InsertColumn(6, _T("Result"), CFMT_TEXT, 300);
	m_wndList.InsertColumn(7, _T("OrderlineCLS"), CFMT_TEXT, 100);
	m_wndList.InsertColumn(8, _T("Line"), CFMT_NUMBER, 0);
	m_wndList.InsertColumn(9, _T("ItemId"), CFMT_TEXT, 100);
...
void CTMPhieuSoKetTruocMoDlg_V5::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CTMPhieuSoKetTruocMoDlg_V5::OnDoDataExchange(CDataExchange* pDX){
...
void CTMPhieuSoKetTruocMoDlg_V5::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CTMPhieuSoKetTruocMoDlg_V5::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CTMPhieuSoKetTruocMoDlg_V5::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CTMPhieuSoKetTruocMoDlg_V5::SetDefaultValues(){
...
int CTMPhieuSoKetTruocMoDlg_V5::SetMode(int nMode){
...
/*void CTMPhieuSoKetTruocMoDlg_V5::OnFromDateChange(){
	
} */
/*void CTMPhieuSoKetTruocMoDlg_V5::OnFromDateSetfocus(){
	
} */
/*void CTMPhieuSoKetTruocMoDlg_V5::OnFromDateKillfocus(){
	
} */
int CTMPhieuSoKetTruocMoDlg_V5::OnFromDateCheckValue(){
	m_bFromToDate = TRUE;
	OnListLoadData();
	return 0;
} 
/*void CTMPhieuSoKetTruocMoDlg_V5::OnToDateChange(){
	
} */
/*void CTMPhieuSoKetTruocMoDlg_V5::OnToDateSetfocus(){
	
} */
/*void CTMPhieuSoKetTruocMoDlg_V5::OnToDateKillfocus(){
	
} */
int CTMPhieuSoKetTruocMoDlg_V5::OnToDateCheckValue(){
	m_bFromToDate = TRUE;
	OnListLoadData();
	return 0;
}
int CTMPhieuSoKetTruocMoDlg_V5::OnListSelectAll(){
...
int CTMPhieuSoKetTruocMoDlg_V5::OnListUnselectAll(){
	for (int i =0; i < m_wndList.GetItemCount(); i++)
	{
...
void CTMPhieuSoKetTruocMoDlg_V5::OnListDblClick(){

} 
void CTMPhieuSoKetTruocMoDlg_V5::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

} 
int CTMPhieuSoKetTruocMoDlg_V5::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 

long CTMPhieuSoKetTruocMoDlg_V5::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	CRecord rs(&pMF->m_db);
...
void CTMPhieuSoKetTruocMoDlg_V5::OnCLSTheoMauSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_bCLSTheoCTM = FALSE;
	UpdateData(FALSE);
...
void CTMPhieuSoKetTruocMoDlg_V5::OnCLSTheoCTMSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	m_bCLSTheoMau = FALSE;
	UpdateData(FALSE);
...
void CTMPhieuSoKetTruocMoDlg_V5::OnSaveSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CTMPhieuSoKetTruocMoDlg_V5::OnCancelSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
	
} 
int CTMPhieuSoKetTruocMoDlg_V5::OnAddPhieuSoKetTruocMoDlg(){
...
int CTMPhieuSoKetTruocMoDlg_V5::OnEditPhieuSoKetTruocMoDlg(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CTMPhieuSoKetTruocMoDlg_V5::OnDeletePhieuSoKetTruocMoDlg(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CTMPhieuSoKetTruocMoDlg_V5::OnSavePhieuSoKetTruocMoDlg()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	UpdateData(TRUE);
	CRecord rs(&pMF->m_db);
	...
	if (rs.GetIntValue() > 0 && !m_bIsAddTem)
	{
	...
	for (int i = 0; i < m_wndList.GetItemCount(); i++)
	{
		...
		{
			if (!m_wndList.GetItemText(i, 3).IsEmpty())
				szDesc = m_wndList.GetItemText(i, 3);
			else
				szDesc = _T("");
			if (!m_wndList.GetItemText(i, 6).IsEmpty())
				szResult = m_wndList.GetItemText(i, 6);
			else
				szResult = _T("");

			if (!m_wndList.GetItemText(i, 7).IsEmpty())
				szOrderlineCLS = m_wndList.GetItemText(i, 7);
			else
				szOrderlineCLS = _T("");

			if (!m_wndList.GetItemText(i, 8).IsEmpty())
				nType = str2int(m_wndList.GetItemText(i, 8));
			else
				nType = 30000;
...
int CTMPhieuSoKetTruocMoDlg_V5::OnCancelPhieuSoKetTruocMoDlg(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CTMPhieuSoKetTruocMoDlg_V5::OnPhieuSoKetTruocMoDlgListLoadData(){
	return 0;
}
void CTMPhieuSoKetTruocMoDlg_V5::ToKeepNewResult(){
	...
	for (int i = 0; i < m_wndList.GetItemCount(); i++){
		bAdded = false;
		szItemID = m_wndList.GetItemText(i, 9);
	...
	for (int i = 0; i < aItemID.GetCount(); i++){
		...
		for (int j = 0; j < m_wndList.GetItemCount(); j++)
			if (m_wndList.GetItemText(j, 9) == szItemID) aTmp.Add(j);
...
void CTMPhieuSoKetTruocMoDlg_V5::OnPatientListSelectChange(int nOldItemSel, int nNewItemSel)
{
	 CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();		

	//if (nNewItemSel >= 0)
 //       m_wndPatientList.SetCurSel(nNewItemSel);
	//
	//m_nDocumentNo = str2long(m_wndPatientList.GetCurrent(0)); // DOCNO
...
void CTMPhieuSoKetTruocMoDlg_V5::OnPatientListSelendok()
{
...
long CTMPhieuSoKetTruocMoDlg_V5::OnPatientListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	/*szSQL.Format(_T(" SELECT ") \
				...
				_T(" AND (") \
				_T("         EXISTS (SELECT 1 FROM hms_testorder  t WHERE t.hpc_docno = hd_docno)") \
				_T("         OR ") \
				_T("         EXISTS (SELECT 1 FROM hms_pacsorder p WHERE p.hpc_docno = hd_docno)") \
				_T("       )") \
				_T(" order by hd_docno desc"), pMF->m_nPatientNo, szWhere);*/


		szSQL.Format(_T(" SELECT docno, docno||'-'||treattime as docnokey, ngayvao, ngayra, ngayvao2, ngayra2, treattime, khoa, docstatus ") \
				_T(" FROM") \
				_T(" (") \
				_T(" SELECT ") \
				_T(" hd_docno as docno,") \
				...
				_T(" WHERE 1=1") \
				_T(" AND ( EXISTS") \
				_T("   (SELECT 1 FROM hms_testorder t WHERE t.hpc_docno = docno and t.hpc_treattime = treattime") \
				_T("   )") \
				_T(" OR EXISTS") \
				_T("   (SELECT 1 FROM hms_pacsorder p WHERE p.hpc_docno = docno and p.hpc_treattime = treattime") \
				_T("   ) )") \
				_T(" ORDER BY docno DESC, treattime desc"), pMF->m_nPatientNo,  pMF->m_nPatientNo);
