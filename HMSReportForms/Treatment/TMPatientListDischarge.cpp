...
static void _OnAllDeptSelectFnc(CWnd *pWnd){
	((CTMPatientListDischarge*)pWnd)->OnAllDeptSelect();
}
...
void CTMPatientListDischarge::OnExportSelect(){
	...
	xls.SetCellText(24, 6, _T("Khu điều trị"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 11);
...
void CTMPatientListDischarge::OnAllDeptSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
