#ifndef TMPHIEUSOKETTRUOCMODLG_H
#define TMPHIEUSOKETTRUOCMODLG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CTMPhieuSoKetTruocMoDlg : public CGuiDialog
{
	long			m_nDocumentNo;
	int				m_nRefIdx;
	long			m_nOrderID;
...
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CTMPhieuSoKetTruocMoDlg(CWnd *pParent, int nMode, long nDocNo, int nRefIdx, long nOrderID);
	~CTMPhieuSoKetTruocMoDlg();
