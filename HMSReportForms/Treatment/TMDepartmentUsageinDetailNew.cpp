#include "stdafx.h"
#include "TMDepartmentUsageinDetailNew.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"
//#include ".\pmsdepartmentusageindetail.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CTMDepartmentUsageinDetailNew *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CTMDepartmentUsageinDetailNew *)pWnd)->OnToDateCheckValue();
} 
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CTMDepartmentUsageinDetailNew* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CTMDepartmentUsageinDetailNew *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnStorageAddNew();
}*/
static int _OnStockSetCheckFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew*) pWnd)->OnStockSetCheck();
	return 0;
}
static int _OnDeptSetCheckFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew*) pWnd)->OnDeptSetCheck();
	return 0;
}
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	return ((CTMDepartmentUsageinDetailNew*)pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
}
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CTMDepartmentUsageinDetailNew *)pWnd)->OnDepartmentLoadData();
}
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CTMDepartmentUsageinDetailNew *)pWnd)->OnClerkLoadData();
}
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CTMDepartmentUsageinDetailNew *)pWnd)->OnTypeLoadData();
}
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CTMDepartmentUsageinDetailNew* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CTMDepartmentUsageinDetailNew *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CTMDepartmentUsageinDetailNew *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CTMDepartmentUsageinDetailNew *pVw = (CTMDepartmentUsageinDetailNew *)pWnd;
...
CTMDepartmentUsageinDetailNew::CTMDepartmentUsageinDetailNew(CWnd* pParent){

	m_nDlgWidth = 545;
	m_nDlgHeight = 185;
	SetDefaultValues();
}
CTMDepartmentUsageinDetailNew::~CTMDepartmentUsageinDetailNew(){
}
void CTMDepartmentUsageinDetailNew::OnCreateComponents(){
...
void CTMDepartmentUsageinDetailNew::OnInitializeComponents(){
...
void CTMDepartmentUsageinDetailNew::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CTMDepartmentUsageinDetailNew::OnDoDataExchange(CDataExchange* pDX){
...
void CTMDepartmentUsageinDetailNew::SetDefaultValues(){
...
int CTMDepartmentUsageinDetailNew::SetMode(int nMode){
...
/*void CTMDepartmentUsageinDetailNew::OnFromDateChange(){
	
} */
/*void CTMDepartmentUsageinDetailNew::OnFromDateSetfocus(){
	
} */
/*void CTMDepartmentUsageinDetailNew::OnFromDateKillfocus(){
	
} */
int CTMDepartmentUsageinDetailNew::OnFromDateCheckValue(){
	return 0;
} 
/*void CTMDepartmentUsageinDetailNew::OnToDateChange(){
	
} */
/*void CTMDepartmentUsageinDetailNew::OnToDateSetfocus(){
	
} */
/*void CTMDepartmentUsageinDetailNew::OnToDateKillfocus(){
	
} */
int CTMDepartmentUsageinDetailNew::OnToDateCheckValue(){
	return 0;
} 
void CTMDepartmentUsageinDetailNew::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CTMDepartmentUsageinDetailNew::OnStorageSelendok(){
	 
}
/*void CTMDepartmentUsageinDetailNew::OnStorageSetfocus(){
	
}*/
/*void CTMDepartmentUsageinDetailNew::OnStorageKillfocus(){
	
}*/
long CTMDepartmentUsageinDetailNew::OnStorageLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CTMDepartmentUsageinDetailNew::OnStorageAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CTMDepartmentUsageinDetailNew::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	
}
long CTMDepartmentUsageinDetailNew::OnDepartmentLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
long CTMDepartmentUsageinDetailNew::OnClerkLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
long CTMDepartmentUsageinDetailNew::OnTypeLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
// 	CRecord rs(&pMF->m_db);
// 	CString szSQL;
// 	int nCount = 0;
...
void CTMDepartmentUsageinDetailNew::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

} 
void CTMDepartmentUsageinDetailNew::OnItemGroupSelendok(){
	 
}
/*void CTMDepartmentUsageinDetailNew::OnItemGroupSetfocus(){
	
}*/
/*void CTMDepartmentUsageinDetailNew::OnItemGroupKillfocus(){
	
}*/
long CTMDepartmentUsageinDetailNew::OnItemGroupLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	// 	CString szFilter;
...
/*void CTMDepartmentUsageinDetailNew::OnItemGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CTMDepartmentUsageinDetailNew::OnPrintPreviewSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	...
	if(pMF->GetCurrentDepartmentID() == _T("C1.3"))
		{
			if (!rpt.Init(_T("Reports\\HMS\\PM_CHITIETTINHHINHSUDUNGTAIDONVIC13.RPT")))
			return;
		}
	else
		{
...
void CTMDepartmentUsageinDetailNew::OnExportSelect(){
...
CString CTMDepartmentUsageinDetailNew::GetQueryString(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL, szWhere, szWhere2, szTemp, szDept, szStorageStr, szField, szGroupBy, szOrderBy;
	...
	{
		if (m_szTypeKey == _T("B"))
			szWhere2.Format(_T(" and mt_doctype = 'DMO'"));
		if (m_szTypeKey == _T("C"))
			szWhere2.Format(_T(" and mt_doctype = 'CSO'"));
	}	
...
szSQL.Format(_T(" SELECT 1 AS transaction_type,") \
			 ...
			 _T("       mtl_saleprice AS unit_price,") \
			 _T("       mtl_qtysold AS sol_qty,") \
			 _T("       mtl_qtypolicy AS pol_qty,") \
			 _T("       mtl_qtysoldins AS solins_qty,") \
			 _T("       mtl_qtyotherins AS othins_qty,") \
			 _T("       mtl_qtyservice AS ser_qty,") \
			 _T("       mtl_qtyother AS other_qty,") \
			 _T("       mtl_qtyorder AS total_qty,") \
			 _T("       mtl_qtysold     * mtl_saleprice AS sol_amt,") \
			 _T("       mtl_qtypolicy   * mtl_saleprice AS pol_amt,") \
			 _T("       mtl_qtysoldins  * mtl_saleprice AS solins_amt,") \
			 _T("       mtl_qtyotherins * mtl_saleprice AS othins_amt,") \
			 _T("       mtl_qtyservice  * mtl_saleprice AS ser_amt,") \
			 _T("       mtl_qtyother    * mtl_saleprice AS other_amt,") \
			 _T("       mtl_qtyorder    * mtl_saleprice AS total_amt,") \
			 ...
			 _T("     AND NVL(mtl_client_id, 'X') <> 'REP' %s") \
			 _T("   UNION ALL") \
			 _T("   SELECT mt_department_to_id   AS dept_id,") \
			 _T("     mt_storage_to_id            AS storage_id,") \
			 _T("     mt_approveddate             AS approval_date,") \
			 _T("     mtl_saleprice               AS unit_price,") \
			 _T("     CASE WHEN msl_category = 'P' THEN mtl_qtyorder ELSE 0 END AS sol_qty,") \
			 _T("     0 AS pol_qty,") \
			 _T("     0 AS solins_qty,") \
			 _T("     CASE WHEN msl_category = 'I' THEN mtl_qtyorder ELSE 0 END AS othins_qty,") \
			 _T("     CASE WHEN msl_category = 'S' THEN mtl_qtyorder ELSE 0 END AS ser_qty,") \
			 _T("     CASE WHEN msl_category NOT IN ('I', 'P', 'S') THEN mtl_qtyorder ELSE 0 END AS other_qty,") \
			 _T("     mtl_qtyorder AS total_qty, ") \
			 _T("     CASE WHEN msl_category = 'P' THEN mtl_qtyorder * mtl_saleprice ELSE 0 END AS sol_amt,") \
			 _T("     0 AS pol_amt,") \
			 _T("     0 AS solins_amt,") \
			 _T("     CASE WHEN msl_category = 'I' THEN mtl_qtyorder * mtl_saleprice ELSE 0 END AS othins_amt,") \
			 _T("     CASE WHEN msl_category = 'S' THEN mtl_qtyorder * mtl_saleprice ELSE 0 END AS ser_amt,") \
			 _T("     CASE WHEN msl_category NOT IN ('I', 'P', 'S') THEN mtl_qtyorder * mtl_saleprice ELSE 0 END AS other_amt,") \
			 _T("     mtl_qtyorder * mtl_saleprice AS total_amt,") \
			 _T("     mtl_product_item_id sitem_id,") \
			 _T("     mt_status,") \
			 _T("     mt_approvedby") \
			 ...
			 _T("   ON ( mt_storage_to_id = msl_storage_id )") \
			 _T("   WHERE mt_status = 'A'") \
			 _T("   AND mtl_qtydelivery    > 0") \
			 _T("   AND NVL(mtl_client_id, 'X') = 'REP' %s") \
			 _T("     ) tbl_issue") \
			 ...
			 _T("   WHERE dept_id IS NOT NULL AND product_org_id IN ('PM', 'MA') %s") \
			 _T("   GROUP BY %s ") \
			 _T("   product_id,") \
			 _T("   product_uomname,") \
			 _T("   unit_price,") \
			 _T("   product_name") \
			 _T("   ORDER BY transaction_type, %s product_name"), szField, szWhere2, szWhere2, szWhere, szGroupBy, szOrderBy);
	return szSQL;
}

BEGIN_MESSAGE_MAP(CTMDepartmentUsageinDetailNew, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CTMDepartmentUsageinDetailNew::OnSetFocus(CWnd* pOldWnd)
{
...
void CTMDepartmentUsageinDetailNew::OnStockSetCheck(){
	m_bStockCheck = !m_bStockCheck;
	for (int i = 0; i < m_wndStorageList.GetItemCount();i++)
		m_wndStorageList.SetCheck(i, m_bStockCheck);
}

void CTMDepartmentUsageinDetailNew::OnDeptSetCheck(){
