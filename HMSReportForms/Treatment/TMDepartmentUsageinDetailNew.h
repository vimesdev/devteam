#ifndef TMDEPARTMENTUSAGEINDETAILNEW_H
#define TMDEPARTMENTUSAGEINDETAILNEW_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMDepartmentUsageinDetailNew : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportSelect(); 
	CTMDepartmentUsageinDetailNew(CWnd *pParent);
	~CTMDepartmentUsageinDetailNew();
