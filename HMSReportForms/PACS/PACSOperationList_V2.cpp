#include "PACSOperationList_V2.h"
...
/*static void _OnYearChangeFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnYearSetfocus();} */
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd)
{
    return ((CPACSOperationList_V2 *)pWnd)->OnYearCheckValue();
}
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel,
                                           int nNewItemSel)
{
    ((CPACSOperationList_V2 *)pWnd)
        ->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
}
static void _OnReportPeriodSelendokFnc(CWnd *pWnd)
{
    ((CPACSOperationList_V2 *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnReportPeriodKillfocus();
}*/
...
{
    return ((CPACSOperationList_V2 *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnFromDateSetfocus();} */
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd)
{
    return ((CPACSOperationList_V2 *)pWnd)->OnFromDateCheckValue();
}
/*static void _OnToDateChangeFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnToDateSetfocus();} */
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd)
{
    return ((CPACSOperationList_V2 *)pWnd)->OnToDateCheckValue();
}
...
{
    ((CPACSOperationList_V2 *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnDeptKillfocus();
}*/
...
{
    return ((CPACSOperationList_V2 *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnDeptAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel)
{
    ((CPACSOperationList_V2 *)pWnd)
        ->OnTypeSelectChange(nOldItemSel, nNewItemSel);
}
static void _OnTypeSelendokFnc(CWnd *pWnd)
{
    ((CPACSOperationList_V2 *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnTypeKillfocus();
}*/
...
{
    return ((CPACSOperationList_V2 *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
    ((CPACSOperationList_V2 *)pWnd)->OnTypeAddNew();
}*/
static void _OnInsuranceSelectFnc(CWnd *pWnd)
{
    ((CPACSOperationList_V2 *)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd)
{
    ((CPACSOperationList_V2 *)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd)
{
    ((CPACSOperationList_V2 *)pWnd)->OnPolicySelect();
}
static void _OnAllSelectFnc(CWnd *pWnd)
{
    ((CPACSOperationList_V2 *)pWnd)->OnAllSelect();
}
static void _OnExportSelectFnc(CWnd *pWnd)
{
    CPACSOperationList_V2 *pVw = (CPACSOperationList_V2 *)pWnd;
    pVw->OnExportSelect();
}
...
{
    return ((CPACSOperationList_V2 *)pWnd)->OnAddPACSOperationList();
}
static int _OnEditPACSOperationListFnc(CWnd *pWnd)
{
    return ((CPACSOperationList_V2 *)pWnd)->OnEditPACSOperationList();
}
static int _OnDeletePACSOperationListFnc(CWnd *pWnd)
{
    return ((CPACSOperationList_V2 *)pWnd)->OnDeletePACSOperationList();
}
static int _OnSavePACSOperationListFnc(CWnd *pWnd)
{
    return ((CPACSOperationList_V2 *)pWnd)->OnSavePACSOperationList();
}
static int _OnCancelPACSOperationListFnc(CWnd *pWnd)
{
    return ((CPACSOperationList_V2 *)pWnd)->OnCancelPACSOperationList();
}
CPACSOperationList_V2::CPACSOperationList_V2(CWnd *pParent)
{
...
CPACSOperationList_V2::~CPACSOperationList_V2() {}
void CPACSOperationList_V2::OnCreateComponents()
{
...
void CPACSOperationList_V2::OnInitializeComponents()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
...
void CPACSOperationList_V2::OnSetWindowEvents()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
...
void CPACSOperationList_V2::OnDoDataExchange(CDataExchange *pDX)
{
...
void CPACSOperationList_V2::GetDataToScreen()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    CRecord rs(&pMF->m_db);
    CString szSQL;
...
void CPACSOperationList_V2::GetScreenToData()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
}
void CPACSOperationList_V2::SetDefaultValues()
{
...
int CPACSOperationList_V2::SetMode(int nMode)
{
...
/*void CPACSOperationList_V2::OnYearChange(){

} */
/*void CPACSOperationList_V2::OnYearSetfocus(){

} */
/*void CPACSOperationList_V2::OnYearKillfocus(){

} */
int CPACSOperationList_V2::OnYearCheckValue()
{
    UpdateData(TRUE);
    if (m_nYear > 0)
    {
...
void CPACSOperationList_V2::OnReportPeriodSelectChange(int nOldItemSel,
                                                       int nNewItemSel)
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
}
void CPACSOperationList_V2::OnReportPeriodSelendok()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    CString tmpStr;
    CDate dte, date;
...
/*void CPACSOperationList_V2::OnReportPeriodSetfocus(){

}*/
/*void CPACSOperationList_V2::OnReportPeriodKillfocus(){

}*/
long CPACSOperationList_V2::OnReportPeriodLoadData()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    CRecord rs(&pMF->m_db);
...
/*void CPACSOperationList_V2::OnReportPeriodAddNew(){
    CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

} */
/*void CPACSOperationList_V2::OnFromDateChange(){

} */
/*void CPACSOperationList_V2::OnFromDateSetfocus(){

} */
/*void CPACSOperationList_V2::OnFromDateKillfocus(){

} */
int CPACSOperationList_V2::OnFromDateCheckValue() { return 0; }
/*void CPACSOperationList_V2::OnToDateChange(){

} */
/*void CPACSOperationList_V2::OnToDateSetfocus(){

} */
/*void CPACSOperationList_V2::OnToDateKillfocus(){

} */
int CPACSOperationList_V2::OnToDateCheckValue() { return 0; }
void CPACSOperationList_V2::OnDeptSelectChange(int nOldItemSel, int nNewItemSel)
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
}
void CPACSOperationList_V2::OnDeptSelendok() {}
/*void CPACSOperationList_V2::OnDeptSetfocus(){

}*/
/*void CPACSOperationList_V2::OnDeptKillfocus(){

}*/
long CPACSOperationList_V2::OnDeptLoadData()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
...
/*void CPACSOperationList_V2::OnDeptAddNew(){
    CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

} */
void CPACSOperationList_V2::OnTypeSelectChange(int nOldItemSel, int nNewItemSel)
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
}
void CPACSOperationList_V2::OnTypeSelendok()
{
    return;
    CString szCurrentValue;
    for (int i = 0; i < m_wndType.GetItemCount(); i++)
    {
        if (m_wndType.GetCheck(i))
        {
            m_wndType.SetCurSel(i);
            szCurrentValue = m_wndType.GetCurrent(i);

            if (!m_szTypes.IsEmpty())
                m_szTypes += _T(", ");
            m_szTypes += _T("'") + szCurrentValue + _T("'");
        }
    }
    _msg(L"%s", m_szTypes);
}
/*void CPACSOperationList_V2::OnTypeSetfocus(){

}*/
/*void CPACSOperationList_V2::OnTypeKillfocus(){

}*/
long CPACSOperationList_V2::OnTypeLoadData()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    CRecord rs(&pMF->m_db);
    CString szSQL, szWhere;
...
/*void CPACSOperationList_V2::OnTypeAddNew(){
    CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

} */
void CPACSOperationList_V2::OnInsuranceSelect() {}
void CPACSOperationList_V2::OnServiceSelect() {}
void CPACSOperationList_V2::OnPolicySelect() {}
void CPACSOperationList_V2::OnAllSelect() {}
void CPACSOperationList_V2::OnExportSelect()
{
    OnExport1();
    return;
...
void CPACSOperationList_V2::OnExport1()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    CRecord rs(&pMF->m_db);
    ...
    tmpStr.Format(_T("\x42\x1EC7nh nh\xE2n: %s %s"), szTemp, m_szTypes);
...
void CPACSOperationList_V2::OnExport2()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    CRecord rs(&pMF->m_db);
    CString szSQL, tmpStr, szTemp, szWhere, szTypes, szNewGroup, szOldGroup;
...
int CPACSOperationList_V2::OnAddPACSOperationList()
{
...
int CPACSOperationList_V2::OnEditPACSOperationList()
{
    if (GetMode() != VM_VIEW)
        return -1;
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
...
int CPACSOperationList_V2::OnDeletePACSOperationList()
{
    if (GetMode() != VM_VIEW)
        return -1;
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
...
int CPACSOperationList_V2::OnSavePACSOperationList()
{
    if (GetMode() != VM_ADD && GetMode() != VM_EDIT)
        return -1;
    if (!IsValidateData())
...
int CPACSOperationList_V2::OnCancelPACSOperationList()
{
    if (GetMode() == VM_EDIT)
    {
        SetMode(VM_VIEW);
...
int CPACSOperationList_V2::OnPACSOperationListListLoadData() { return 0; }
CString CPACSOperationList_V2::GetQuerySring()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    UpdateData(true);
    ...
    szSQL.Format(
        ...
        _T("    ss_desc                         AS pacsname,")
        _T("   SUBSTR(ss_vndesc,1,3) AS groupid,")
        _T("   CASE")
        ...
        _T("	CASE WHEN hpcl_staffid IS NOT NULL THEN ")
        _T("get_username(hpcl_staffid) WHEN opu_type = 'PM' THEN ")
        _T("get_username(opu_userid) ELSE null END AS assistant,")
        _T("	CASE WHEN opu_type = 'GV' THEN get_username(opu_userid) ELSE ")
        _T("null END AS helper, ")
        _T("   hpcl_qty                       AS quantity,")
        _T("   CASE ")
        _T("   WHEN ss_vndesc = 'B5100' THEN 51300 ")
        _T("   WHEN ss_vndesc = 'B5200' THEN 26100 ")
        _T("   WHEN ss_vndesc = 'B5300' THEN 17100 ")
        _T("   ELSE 0 END AS amount,")
        _T("   hpc_performdate                AS performdate")
        _T(" FROM hms_pacsorder")
        _T(" LEFT JOIN hms_pacsorderline")
        _T(" ON(hpc_orderid = hpcl_orderid)")
        _T(" LEFT JOIN hms_operation_user_setup ON(opu_operation_id = ")
        _T("hpcl_orderlineid) ")
        ...
        _T(" LEFT JOIN sys_sel ON(ss_id = 'pacs_line_category' AND ss_code = ")
        _T("hpcl_formid) ")
...
CString CPACSOperationList_V2::GetQuerySring1()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    UpdateData(true);
    CString szSQL, szWhere, szTypes;
    ...
    szSQL.Format(
        ...
        _T("   hpcl_qty                       AS quantity,")
        _T("   CASE ")
        _T("   WHEN hfl_opt_group = 'B5100' THEN 51300 ")
        _T("   WHEN hfl_opt_group = 'B5200' THEN 26100 ")
        _T("   WHEN hfl_opt_group = 'B5300' THEN 17100 ")
        _T("   ELSE 0 END AS amount,")
        _T("   hpc_performdate                AS performdate")
        _T(" FROM hms_pacsorder")
        _T(" LEFT JOIN hms_pacsorderline")
...
CString CPACSOperationList_V2::GetNameUser(CString UserName, CString LastName)
{
...
void CPACSOperationList_V2::OnClassifySelect()
{
    CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
    CUPDATEPTTT dlg(this);
    dlg.DoModal();
}
CString CPACSOperationList_V2::GetSelectedTypesString()
{
    CString szTypes;
