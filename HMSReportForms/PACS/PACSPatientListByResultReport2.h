#ifndef PACSPatientListByResultReport2_H
#define PACSPatientListByResultReport2_H
...
class CPACSPatientListByResultReport2 : public CGuiView{
protected:
public:
	...
	CPACSPatientListByResultReport2(CWnd* pParent);
	~CPACSPatientListByResultReport2();
	...
	int OnAddPACSPatientListByResultReport2(); 
	int OnEditPACSPatientListByResultReport2(); 
	int OnDeletePACSPatientListByResultReport2(); 
	int OnSavePACSPatientListByResultReport2(); 
	int OnCancelPACSPatientListByResultReport2(); 
	int OnPACSPatientListByResultReport2ListLoadData();
