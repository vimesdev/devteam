#include "stdafx.h"
#include "PACSFunctionalProbeListSumeryReportC8C.h"
#include "HMSMainFrame.h"
#include "ReportDocument.h"
#include "Excel.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPACSFunctionalProbeListSumeryReportC8C* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintSelectFnc(CWnd *pWnd){
	CPACSFunctionalProbeListSumeryReportC8C *pVw = (CPACSFunctionalProbeListSumeryReportC8C *)pWnd;
	pVw->OnPrintSelect();
} 
...
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPACSFunctionalProbeListSumeryReportC8C* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnGroupAddNew();
}*/
static void _OnPractitionerSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPACSFunctionalProbeListSumeryReportC8C* )pWnd)->OnPractitionerSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPractitionerSelendokFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnPractitionerSelendok();
}
/*static void _OnPractitionerSetfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnPractitionerKillfocus();
}*/
/*static void _OnPractitionerKillfocusFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnPractitionerKillfocus();
}*/
static long _OnPractitionerLoadDataFnc(CWnd *pWnd){
	return ((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnPractitionerLoadData();
}
/*static void _OnPractitionerAddNewFnc(CWnd *pWnd){
	((CPACSFunctionalProbeListSumeryReportC8C *)pWnd)->OnPractitionerAddNew();
}*/
static int _OnAddPACSFunctionalProbeListReportFnc(CWnd *pWnd){
	 return ((CPACSFunctionalProbeListSumeryReportC8C*)pWnd)->OnAddPACSFunctionalProbeListReport();
} 
static int _OnEditPACSFunctionalProbeListReportFnc(CWnd *pWnd){
	 return ((CPACSFunctionalProbeListSumeryReportC8C*)pWnd)->OnEditPACSFunctionalProbeListReport();
} 
static int _OnDeletePACSFunctionalProbeListReportFnc(CWnd *pWnd){
	 return ((CPACSFunctionalProbeListSumeryReportC8C*)pWnd)->OnDeletePACSFunctionalProbeListReport();
} 
static int _OnSavePACSFunctionalProbeListReportFnc(CWnd *pWnd){
	 return ((CPACSFunctionalProbeListSumeryReportC8C*)pWnd)->OnSavePACSFunctionalProbeListReport();
} 
static int _OnCancelPACSFunctionalProbeListReportFnc(CWnd *pWnd){
	 return ((CPACSFunctionalProbeListSumeryReportC8C*)pWnd)->OnCancelPACSFunctionalProbeListReport();
} 
static void _OnTYCSelectFnc(CWnd *pWnd){
	 ((CPACSFunctionalProbeListSumeryReportC8C*)pWnd)->OnTYCSelect();
}
CPACSFunctionalProbeListSumeryReportC8C::CPACSFunctionalProbeListSumeryReportC8C(CWnd* pParent)
{
	m_nDlgWidth = 475;
	m_nDlgHeight = 190;
	SetDefaultValues();
}
CPACSFunctionalProbeListSumeryReportC8C::~CPACSFunctionalProbeListSumeryReportC8C()
{

}
void CPACSFunctionalProbeListSumeryReportC8C::OnCreateComponents()
{
	...
	m_wndPractitionerLabel.Create(this, _T("Practitioner"), 10, 120, 115, 145);
	m_wndPractitioner.Create(this,120, 120, 460, 145); 
	m_wndPrint.Create(this, _T("&Print"), 260, 154, 360, 179);
	m_wndExport.Create(this, _T("&Export"), 365, 154, 465, 179);
	m_wndTYC.Create(this, _T("Khoa TYC"), 10, 154, 115, 179);

}
void CPACSFunctionalProbeListSumeryReportC8C::OnInitializeComponents()
{
...
void CPACSFunctionalProbeListSumeryReportC8C::OnSetWindowEvents(){
...
void CPACSFunctionalProbeListSumeryReportC8C::OnDoDataExchange(CDataExchange* pDX){
...
void CPACSFunctionalProbeListSumeryReportC8C::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CPACSFunctionalProbeListSumeryReportC8C::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CPACSFunctionalProbeListSumeryReportC8C::SetDefaultValues(){
...
int CPACSFunctionalProbeListSumeryReportC8C::SetMode(int nMode){
...
/*void CPACSFunctionalProbeListSumeryReportC8C::OnYearChange(){
	
} */
/*void CPACSFunctionalProbeListSumeryReportC8C::OnYearSetfocus(){
	
} */
/*void CPACSFunctionalProbeListSumeryReportC8C::OnYearKillfocus(){
	
} */


int CPACSFunctionalProbeListSumeryReportC8C::OnYearCheckValue()
{
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
...
void CPACSFunctionalProbeListSumeryReportC8C::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
void CPACSFunctionalProbeListSumeryReportC8C::OnTYCSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
void CPACSFunctionalProbeListSumeryReportC8C::OnReportPeriodSelendok()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CPACSFunctionalProbeListSumeryReportC8C::OnReportPeriodSetfocus(){
	
}*/
/*void CPACSFunctionalProbeListSumeryReportC8C::OnReportPeriodKillfocus(){
	
}*/
long CPACSFunctionalProbeListSumeryReportC8C::OnReportPeriodLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CPACSFunctionalProbeListSumeryReportC8C::OnReportPeriodAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CPACSFunctionalProbeListSumeryReportC8C::OnFromDateChange(){
	
} */
/*void CPACSFunctionalProbeListSumeryReportC8C::OnFromDateSetfocus(){
	
} */
/*void CPACSFunctionalProbeListSumeryReportC8C::OnFromDateKillfocus(){
	
} */
int CPACSFunctionalProbeListSumeryReportC8C::OnFromDateCheckValue(){
	return 0;
} 
/*void CPACSFunctionalProbeListSumeryReportC8C::OnToDateChange(){
	
} */
/*void CPACSFunctionalProbeListSumeryReportC8C::OnToDateSetfocus(){
	
} */
/*void CPACSFunctionalProbeListSumeryReportC8C::OnToDateKillfocus(){
	
} */
int CPACSFunctionalProbeListSumeryReportC8C::OnToDateCheckValue(){
	return 0;
}
void CPACSFunctionalProbeListSumeryReportC8C::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CPACSFunctionalProbeListSumeryReportC8C::OnGroupSelendok(){
	 
}
/*void CPACSFunctionalProbeListSumeryReportC8C::OnGroupSetfocus(){
	
}*/
/*void CPACSFunctionalProbeListSumeryReportC8C::OnGroupKillfocus(){
	
}*/
long CPACSFunctionalProbeListSumeryReportC8C::OnGroupLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CPACSFunctionalProbeListSumeryReportC8C::OnGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CPACSFunctionalProbeListSumeryReportC8C::OnPractitionerSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CPACSFunctionalProbeListSumeryReportC8C::OnPractitionerSelendok(){
	 
}
/*void CPACSFunctionalProbeListSumeryReportC8C::OnPractitionerSetfocus(){
	
}*/
/*void CPACSFunctionalProbeListSumeryReportC8C::OnPractitionerKillfocus(){
	
}*/
long CPACSFunctionalProbeListSumeryReportC8C::OnPractitionerLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	szSQL.Format(_T("SELECT su_userid as id, su_name as name, su_deptid as deptid ") \
		         _T("FROM sys_user ") \
				 _T("WHERE su_deptid in('C8-C', 'TYC') ") \
...
/*void CPACSFunctionalProbeListSumeryReportC8C::OnPractitionerAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CPACSFunctionalProbeListSumeryReportC8C::OnPrintSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	...
	{
		rptDetail = rpt.AddDetail(rpt.GetGroupFooter(1));
		tmpStr.Format(_T("Tổng cả khoa C8-C"));
...
void CPACSFunctionalProbeListSumeryReportC8C::OnExportSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
...
void CPACSFunctionalProbeListSumeryReportC8C::OnExport()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CPACSFunctionalProbeListSumeryReportC8C::OnExport2()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
int CPACSFunctionalProbeListSumeryReportC8C::OnAddPACSFunctionalProbeListReport(){
...
int CPACSFunctionalProbeListSumeryReportC8C::OnEditPACSFunctionalProbeListReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CPACSFunctionalProbeListSumeryReportC8C::OnDeletePACSFunctionalProbeListReport(){
 	if(GetMode() != VM_VIEW) 
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CPACSFunctionalProbeListSumeryReportC8C::OnSavePACSFunctionalProbeListReport(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CPACSFunctionalProbeListSumeryReportC8C::OnCancelPACSFunctionalProbeListReport(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CPACSFunctionalProbeListSumeryReportC8C::OnPACSFunctionalProbeListReportListLoadData(){
	return 0;
}

CString CPACSFunctionalProbeListSumeryReportC8C::GetQueryString1()
{
	CString szSQL, szWhere;
	szSQL.Empty();
	...
	{
		szWhere.AppendFormat(_T("and hrl_deptid IN ('TYC')"));
		szWhere.AppendFormat(_T("and 1=1"));
	
	}
	else
	{
	szWhere.AppendFormat(_T("and hrl_deptid IN ('C8-C', 'TYC')"));
	...
	szSQL.Format(_T(" select * from ") \
				...
				_T("				  left join hms_roomlist on(hrl_id=hpcl_proomid %s AND HRL_SECTION='HA')") \
				...
				_T(" FROM") \
				_T(" (") \
				_T(" select  distinct hfl_name,hfl_feeid,1 as qty , hpc_patientno") \
				_T("     from hms_pacsorder ") \
				_T(" 				  left join hms_pacsorderline on(hpcl_orderid=hpc_orderid and hpcl_docno=hpc_docno) ") \
				_T(" 				 left join hms_fee_list on(hfl_feeid=hpcl_itemid) ") \
				_T("				  left join hms_roomlist on(hrl_id=hpcl_proomid %s AND HRL_SECTION='HA')") \
				...
				szWhere, m_szFromDate, m_szToDate, szWhere, szWhere, m_szFromDate, m_szToDate, szWhere);

	return szSQL;
}

CString CPACSFunctionalProbeListSumeryReportC8C::GetQueryString()
{
	CString szSQL, szWhere;
	szSQL.Empty();
	...
	szSQL.Format(_T(" SELECT * from ( ") \
				...
				_T("		tbl3.hfl_name=tbl.hfl_name and tbl3.hfl_feeid=tbl.hfl_feeid) ") ,szWhere,m_szFromDate, m_szToDate, szWhere, szWhere,m_szFromDate, m_szToDate, szWhere);

	return szSQL;
}
CString CPACSFunctionalProbeListSumeryReportC8C::GetQueryString2()
{
	CString szSQL, szWhere;
	szSQL.Empty();
