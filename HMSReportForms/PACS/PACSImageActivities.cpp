...
{
	 ((CPACSImageActitivities*)pWnd)->OnViewHistorySelect();
}
...
/*void CPACSImageActitivities::OnGroupKillfocus(){
	...
	void CPACSImageActitivities::OnViewHistorySelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
}
...
void CPACSImageActitivities::OnExport1()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();	
	CRecord rs(&pMF->m_db);
...
CString CPACSImageActitivities::GetQueryString1()
{
	...
	szSQL.Format(_T(" SELECT ") \
				...
				_T("   ) AS vRemark, hfe_unitprice as price") \
				_T(" FROM HMS_PACSORDER_VIEW_GPB") \
				...
				_T(" LEFT JOIN HMS_PACS_TEST_VIEW_LINE_GPB") \
				_T(" ON ( hpc_orderid = hpcl_orderid )") \
				_T(" left join hms_fee ON (hpcl_docno = hpcl_docno AND hpcl_orderid=hfe_orderid AND hpcl_itemid=hfe_itemid)") \
...
CString CPACSImageActitivities::GetQueryString2()
{
	CString szSQL, szWhere, tmpStr;	
...
void CPACSImageActitivities::OnExport2()
{
