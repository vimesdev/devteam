#ifndef PACSPATIENTLISTBYRESULTREPORTC8C_H
#define PACSPATIENTLISTBYRESULTREPORTC8C_H
...
class CPACSPatientListByResultReportC8C : public CGuiView
{
protected:
public:
	...
	CPACSPatientListByResultReportC8C(CWnd* pParent);
	~CPACSPatientListByResultReportC8C();
