#ifndef PACSMaterialBalancesheet_H
#define PACSMaterialBalancesheet_H
...
#include "GuiView.h"
#include "DbField.h"
class CPACSMaterialBalancesheet : public CGuiView{
protected:
public:
	...
	int			OnCheckAll();
	int			OnUnCheckAll();
	CPACSMaterialBalancesheet(CWnd *pParent);
	~CPACSMaterialBalancesheet();
	...
	int OnAddPACSMaterialBalancesheet(); 
	int OnEditPACSMaterialBalancesheet(); 
	int OnDeletePACSMaterialBalancesheet(); 
	int OnSavePACSMaterialBalancesheet(); 
	int OnCancelPACSMaterialBalancesheet(); 
	int OnPACSMaterialBalancesheetListLoadData(); 
	DECLARE_MESSAGE_MAP()
