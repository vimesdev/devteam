...
void CHMSDailyFoodCancelPatientListDialog::OnCreateComponents(){
	...
	m_wndSheetLabel.Create(this, _T(""), 0, 0, 0, 0);
	m_wndSheetLabel.ShowWindow(SW_HIDE);
	m_wndSheetLabel.EnableWindow(FALSE);
	m_wndSheet.Create(this, 0, 0, 0, 0);
	m_wndSheet.ShowWindow(SW_HIDE);
	m_wndSheet.EnableWindow(FALSE);
	m_wndDescLabel.Create(this, _T(""), 0, 0, 0, 0);
	m_wndDescLabel.ShowWindow(SW_HIDE);
	m_wndDescLabel.EnableWindow(FALSE);
	m_wndDesc.Create(this, 0, 0, 0, 0);
	m_wndDesc.ShowWindow(SW_HIDE);
	m_wndDesc.EnableWindow(FALSE);
	m_wndMark.Create(this, _T(""), 0, 0, 0, 0);
	m_wndMark.ShowWindow(SW_HIDE);
	m_wndMark.EnableWindow(FALSE);
	m_wndUnMark.Create(this, _T(""), 0, 0, 0, 0);
	m_wndUnMark.ShowWindow(SW_HIDE);
	m_wndUnMark.EnableWindow(FALSE);
	m_wndAdd.Create(this, _T(""), 0, 0, 0, 0);
	m_wndAdd.ShowWindow(SW_HIDE);
	m_wndAdd.EnableWindow(FALSE);
	m_wndRemove.Create(this, _T(""), 0, 0, 0, 0);
	m_wndRemove.ShowWindow(SW_HIDE);
	m_wndRemove.EnableWindow(FALSE);
	m_wndAdmission.Create(this, _T(""), 0, 0, 0, 0);
	m_wndAdmission.ShowWindow(SW_HIDE);
	m_wndAdmission.EnableWindow(FALSE);
}
...
_T("   ON(hfoc_docno    =hd_docno AND hfo_orderid=HFOC_ORDERID)") \
_T("   WHERE (hfo_deptid   ='%s' OR hfo_deptid='C1.1P162') AND hfoc_status ='C'") \
_T("   ) tbl") \
