#ifndef HMSEXAMINEV2_H
#define HMSEXAMINEV2_H
...
class CHMSExamineV2 : public CGuiView
{
...
protected:
	...
	void InitCommPort();
	void CloseCommPort();
	void WriteDataToPLC(CSerial* serial, int nNumber, int nCtrl1, int nCtrl2, int nCtrl3, CString szPatientName);
	void callPatient();
	int		m_nBeep;
	bool	m_bDoctor;
	CString m_szOldICD;
public:
	...
	CGuiLabel		m_wndExamineV2Label;
	CGuiTextCtrl	m_wndExamineV2;
	...
	CGuiLabel		m_wndTietnieuLabel;
	CGuiTextCtrl	m_wndTietnieu;
	CGuiLabel		m_wndThankinhLabel;
	CGuiTextCtrl	m_wndThankinh;
	CGuiLabel		m_wndKhopLabel;
	CGuiTextCtrl	m_wndKhop;
	CGuiLabel		m_wndCoquankhacLabel;
	CGuiTextCtrl	m_wndCoquankhac;
	CGuiLabel		m_wndDinhduonglabel;
	CGuiTextCtrl	m_wndDinhduong;
	CGuiLabel		m_wndKehoachxnLabel;
	CGuiTextCtrl	m_wndKehoachxn;
	CGuiLabel		m_wndKehoachdieutrilabel;
	CGuiTextCtrl	m_wndKehoachdieutri;
	...
	CString	m_szThankinh;
	CString	m_szKhop;
	CString	m_szCoquankhac;
	CString	m_szDinhduong;
	CString	m_szKehoachxn;
	CString	m_szKehoachdieutri;
	...
	int			OnThankinhCheckValue();
	int			OnHohapCheckValue(); 
	int			OnKhopCheckValue(); 
	int			OnCoquankhacCheckValue();
	int			OnDinhduongCheckValue();
	int			OnKehoachxnCheckValue(); 
	int			OnKehoachdieutriCheckValue();
	...
	int	OnGeneralRankExamine();
	int	OnGeneralRankExamine2();
	//Phieu kham suc khoe thuong ta
	int	OnGeneralRankExamine3();
