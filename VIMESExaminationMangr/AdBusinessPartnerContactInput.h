#ifndef ADBUSINESSPARTNERCONTACTINPUT_H
#define ADBUSINESSPARTNERCONTACTINPUT_H
...
#include "GuiView.h"
#include "DbField.h"
class CAdBusinessPartnerContactInput : public CListItemEdit{
protected:
public:
	CWnd*	m_pWnd;
	...
	CAdBusinessPartnerContactInput();
	~CAdBusinessPartnerContactInput();
	...
	int OnAddAdBusinessPartnerContactInput(); 
	int OnEditAdBusinessPartnerContactInput(); 
	int OnDeleteAdBusinessPartnerContactInput(); 
	int OnSaveAdBusinessPartnerContactInput(); 
	int OnCancelAdBusinessPartnerContactInput(); 
	int OnAdBusinessPartnerContactInputListLoadData(); 
	int OnOK();
	void OnCancel();
	void ApplyToList();
};
