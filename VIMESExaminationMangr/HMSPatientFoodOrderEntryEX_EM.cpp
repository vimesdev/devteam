#include "HMSPatientFoodOrderEntryEX_EM.h"
#include "MainFrm.h"
#include "HMSDailyFoodOrder_EM.h"

static int _OnNameCheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNameCheckValue();
}


static int _OnName1CheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName1CheckValue();
}

static int _OnName2CheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName2CheckValue();
}

static void _OnMultipleDaySelectFnc(CWnd *pWnd){
	 ((CHMSPatientFoodOrderEntryEX*)pWnd)->OnMultipleDaySelect();
}
static void _OnDaysChangeFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnDaysChange();
} 

/*static void _OnDaysSetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnDaysSetfocus();} */ 
/*static void _OnDaysKillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnDaysKillfocus();
} */
static int _OnDaysCheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnDaysCheckValue();
} 
static void _OnPatientNameSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSPatientFoodOrderEntryEX* )pWnd)->OnPatientNameSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPatientNameSelendokFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnPatientNameSelendok();
}
/*static void _OnPatientNameSetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnPatientNameKillfocus();
}*/
/*static void _OnPatientNameKillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnPatientNameKillfocus();
}*/
static long _OnPatientNameLoadDataFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnPatientNameLoadData();
}
/*static void _OnPatientNameAddNewFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnPatientNameAddNew();
}*/
static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnOrderDateChange();
} 
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnOrderDateCheckValue();
} 
static void _OnNameSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSPatientFoodOrderEntryEX* )pWnd)->OnNameSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNameSelendokFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNameSelendok();
}
/*static void _OnNameSetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNameKillfocus();
}*/
/*static void _OnNameKillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNameKillfocus();
}*/
static long _OnNameLoadDataFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNameLoadData();
}
/*static void _OnNameAddNewFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNameAddNew();
}*/

static void _OnName2SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSPatientFoodOrderEntryEX* )pWnd)->OnName2SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnName2SelendokFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName2Selendok();
}
/*static void _OnName2SetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName2Killfocus();
}*/
/*static void _OnName2KillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName2Killfocus();
}*/
static long _OnName2LoadDataFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName2LoadData();
}
/*static void _OnName2AddNewFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName2AddNew();
}*/
static void _OnName1SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSPatientFoodOrderEntryEX* )pWnd)->OnName1SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnName1SelendokFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName1Selendok();
}
/*static void _OnName1SetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName1Killfocus();
}*/
/*static void _OnName1KillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName1Killfocus();
}*/
static long _OnName1LoadDataFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName1LoadData();
}
/*static void _OnName1AddNewFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnName1AddNew();
}*/
/*static void _OnQtyChangeFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQtyChange();
} */
/*static void _OnQtySetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQtySetfocus();} */ 
/*static void _OnQtyKillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQtyKillfocus();
} */
static int _OnQtyCheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQtyCheckValue();
} 
/*static void _OnQty2ChangeFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty2Change();
} */
/*static void _OnQty2SetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty2Setfocus();} */ 
/*static void _OnQty2KillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty2Killfocus();
} */
static int _OnQty2CheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty2CheckValue();
}  
static void _OnBreakfastRelativeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSPatientFoodOrderEntryEX* )pWnd)->OnBreakfastRelativeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnBreakfastRelativeSelendokFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnBreakfastRelativeSelendok();
}
/*static void _OnBreakfastRelativeSetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnBreakfastRelativeKillfocus();
}*/
/*static void _OnBreakfastRelativeKillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnBreakfastRelativeKillfocus();
}*/
static long _OnBreakfastRelativeLoadDataFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnBreakfastRelativeLoadData();
}
/*static void _OnBreakfastRelativeAddNewFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnBreakfastRelativeAddNew();
}*/
/*static void _OnQty3ChangeFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty3Change();
} */
/*static void _OnQty3SetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty3Setfocus();} */ 
/*static void _OnQty3KillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty3Killfocus();
} */
static int _OnQty3CheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnQty3CheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientFoodOrderEntryEX *)pWnd)->OnNoteCheckValue();
} 
static void _OnSaveSelectFnc(CWnd *pWnd){
	CHMSPatientFoodOrderEntryEX *pVw = (CHMSPatientFoodOrderEntryEX *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddHMSPatientFoodOrderEntryFnc(CWnd *pWnd){
	 return ((CHMSPatientFoodOrderEntryEX*)pWnd)->OnAddHMSPatientFoodOrderEntry();
} 
static int _OnEditHMSPatientFoodOrderEntryFnc(CWnd *pWnd){
	 return ((CHMSPatientFoodOrderEntryEX*)pWnd)->OnEditHMSPatientFoodOrderEntry();
} 
static int _OnDeleteHMSPatientFoodOrderEntryFnc(CWnd *pWnd){
	 return ((CHMSPatientFoodOrderEntryEX*)pWnd)->OnDeleteHMSPatientFoodOrderEntry();
} 
static int _OnSaveHMSPatientFoodOrderEntryFnc(CWnd *pWnd){
	 return ((CHMSPatientFoodOrderEntryEX*)pWnd)->OnSaveHMSPatientFoodOrderEntry();
} 
static int _OnCancelHMSPatientFoodOrderEntryFnc(CWnd *pWnd){
	 return ((CHMSPatientFoodOrderEntryEX*)pWnd)->OnCancelHMSPatientFoodOrderEntry();
} 
CHMSPatientFoodOrderEntryEX::CHMSPatientFoodOrderEntryEX(CWnd *pParent, int nMode, int nType):
CGuiPopup(pParent)

{
	...
	m_szFastFoodIDS_A16 = _T("'FF000132', 'FF000189','FF000207','FF000220','FF000221','FF000222','FF0001205', 'FF0001206', 'FF0001207'");
	m_szFastFoodIDS = _T("'FF000132','FF000220','FF000221','FF000222','FF000474', 'FF000475', 'FF0001035', 'FF0001036', 'FF0001205', 'FF0001206', 'FF0001207'");

}
CHMSPatientFoodOrderEntryEX::~CHMSPatientFoodOrderEntryEX()
{
}
void CHMSPatientFoodOrderEntryEX::OnCreateComponents(){
	...
	m_wndNameLabel.Create(this, _T("Lựa chọn 1"), 5, 65, 115, 90);
	...
	m_wndName1Label.Create(this, _T("Lựa chọn 2"), 5, 95, 115, 120);
	...
	m_wndName2Label.Create(this, _T("Lựa chọn 3"), 5, 125, 115, 150);
	...
	m_wndBreakfastRelativeLabel.Create(this, _T("Bữa sáng người nhà"), 5, 155, 115, 180);
...
void CHMSPatientFoodOrderEntryEX::OnInitializeComponents()
{
	...
	m_wndBreakfastRelative.InsertColumn(3, _T("Unit"), CFMT_TEXT|CFMT_CENTER, 80);
	...
	m_szFeeIDS.Format(_T("'FF000132', 'FF000189', 'FF000207','FF000132','FF000220','FF000221','FF0001205', 'FF0001206', 'FF0001207'"));

	
}
void CHMSPatientFoodOrderEntryEX::OnSetWindowEvents(){
...
void CHMSPatientFoodOrderEntryEX::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSPatientFoodOrderEntryEX::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSPatientFoodOrderEntryEX::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	m_hms_feefodorderTbl.SetValue(_T("hfo_docno"), str2long(m_szPatientNameKey));
	...
	//m_hms_feefodorderTbl.SetValue(_T("hfo_payment"), m_bHaucan?_T("Y"):_T("N"));
	m_hms_feefodorderTbl.SetValue(_T("hfo_payment"), _T("N"));
	m_hms_feefodorderTbl.SetValue(_T("hfo_isvip"), m_bIsVipA?_T("A"):_T(""));
...
void CHMSPatientFoodOrderEntryEX::SetDefaultValues(){
...
int CHMSPatientFoodOrderEntryEX::SetMode(int nMode){
...
void CHMSPatientFoodOrderEntryEX::OnMultipleDaySelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bMultipleDay){
...
void CHMSPatientFoodOrderEntryEX::OnDaysChange(){
	m_bAddOrder	= true;
} 
/*void CHMSPatientFoodOrderEntryEX::OnDaysSetfocus(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnDaysKillfocus(){
	
} */
int CHMSPatientFoodOrderEntryEX::OnDaysCheckValue(){
	UpdateData(true);
	if(m_nDays < 0 || m_nDays > 9)
		return -1;
	return 0;
} 
void CHMSPatientFoodOrderEntryEX::OnPatientNameSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
} 
void CHMSPatientFoodOrderEntryEX::OnPatientNameSelendok(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
	UpdateData(TRUE);
	CString szSQL;
		CRecord rs(&pMF->m_db);
...
//	m_szOrderDate = m_szCurrentOrderDate.Left(10);
	...
	_fmsg(_T("%s"), szSQL);		
		...
		szSQL.Format(_T("SELECT hfo_orderid as orderid ") \
			_T("FROM hms_feefood ") \
			_T("WHERE hfo_docno=%ld and hfo_reforder_id=%ld and hfo_orderstatus='O' and hfo_ordertype='D'"),
			m_nDocumentNo, m_nOID);
		rs.ExecSQL(szSQL);
		if(!rs.IsEOF())
		{
			((CHMSDailyFoodOrder_EM*)m_pWndOrder)->OnRationListLoadData();
		}
		else
		{
			
			((CHMSDailyFoodOrder_EM*) m_pWndOrder)->m_wndRationList.DeleteAllItems();
	...
	m_wndBreakfastRelative.EnableWindow(false);
	 if(m_nDocumentNo >0 && m_bHaucan)
	 {
		...
		szSQL.Format(_T(" select count(*) from hms_fee_extra ") \
							_T("	left join hms_fee_extraline ON (hfe_fee_extra_id = hfel_fee_extra_id) ") \
							_T("	LEFT JOIN hms_fee_list ON (hfl_feeid= hfel_itemid) ") \
							_T("	where hfe_status='I' and hfe_docno= %ld  and hfe_deptid='%s'   ") \
							_T("		and  nvl(hfl_subitem,'N') = 'VIP' and nvl(hfl_subgroup,'N') <> 'DVTC' "),m_nDocumentNo, pMF->m_szDept);
		...
		else
		{
			szSQL.Format(_T(" select count(*) from hms_fee_extra ") \
							...
							_T("	LEFT JOIN hms_fee_list ON (hfl_feeid= hfel_itemid) ") \
							_T("	where hfe_status='I' and hfe_docno= %ld  and hfe_deptid='%s'   ") \
							_T("		and  nvl(hfl_subitem,'N') = 'VIP'  and hfl_index2='A' and nvl(hfl_subgroup,'N') <> 'DVTC' "),m_nDocumentNo, pMF->m_szDept);
			rs.ExecSQL(szSQL);
			if (rs.GetIntValue() >0)
				m_bIsVipA= true;
		...
		szSQL.Format(_T(" select count(*) from VIMES.hms_fee_extra ") \
							...
							_T("	LEFT JOIN hms_fee_list ON (hfl_feeid= hfel_itemid) ") \
							_T("	where hfe_status='I' and hfe_docno= %ld  and hfe_deptid='%s'   ") \
							_T("		and  hfl_subitem = 'NN' AND hfl_servprice >0 "),m_nDocumentNo, pMF->m_szDept);
...
/*void CHMSPatientFoodOrderEntryEX::OnPatientNameSetfocus(){
	
}*/
/*void CHMSPatientFoodOrderEntryEX::OnPatientNameKillfocus(){
	
}*/
long CHMSPatientFoodOrderEntryEX::OnPatientNameLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*
	if(m_bHaucan)
	{
		...
		szWhere.AppendFormat(_T(" AND  ( select count(*) from VIMES.hms_fee_extra ") \
							_T("	left join hms_fee_extraline ON (hfe_fee_extra_id = hfel_fee_extra_id) ") \
							_T("	LEFT JOIN hms_fee_list ON (hfl_feeid= hfel_itemid) ") \
							_T("	where hfe_status='I' and hfe_docno= htr_docno  and hfe_deptid='%s'   ") \
							_T("		and  nvl(hfl_subitem,'N') in ('VIP','NN')  and hfel_quantity >0 and trunc_date(hfe_enddate)  >= trunc_date(sysdate) ) > 0 "), pMF->m_szDept);
	...
	else
	{
		szWhere.AppendFormat(_T(" AND  ( select count(*) from VIMES.hms_fee_extra ") \
							...
							_T("	LEFT JOIN hms_fee_list ON (hfl_feeid= hfel_itemid) ") \
							_T("	where hfe_status='I' and hfe_docno= htr_docno  and hfe_deptid='%s'   ") \
							_T("		and  nvl(hfl_subitem,'N') ='VIP' and hfel_quantity >0  and nvl(hfl_subgroup,'N') <> 'DVTC' and trunc_date(hfe_enddate)  >= trunc_date(sysdate) ) =0 "), pMF->m_szDept);
	}
	//else
...
_T(" ORDER BY pname"), pMF->m_szDept, szWhere);
_fmsg(_T("%s"), szSQL);
_tprintf(_T("%s"), szSQL); 
	...
	if (m_bHaucan)
	{
		...
		_T(" left join hms_fee_extraline ON ( hfe_fee_extra_id = hfel_fee_extra_id )") \
		_T(" LEFT JOIN hms_fee_list ON ( hfl_feeid = hfel_itemid )") \
		_T(" WHERE     hfe_status = 'I' AND hfe_deptid = '%s' and nvl(hfl_subgroup,'N') <> 'DVTC'  AND") \
		_T("                    Nvl(hfl_subitem, 'N') IN ( 'VIP', 'NN' ) AND hfel_quantity > 0 and hfel_unitprice >0  AND") \
		_T("          Trunc_date(hfe_enddate) >= Trunc_date(SYSDATE) "), pMF->m_szDept);
	}
	else
	{
		szSQL.Format(_T("SELECT    distinct hfe_docno as doc_no ") \
		...
		_T("          AND hfel_quantity > 0 AND Nvl(hfl_subgroup, 'N') <> 'DVTC'  ") \
		_T("         AND Trunc_date(hfe_enddate) >= Trunc_date(SYSDATE) "),pMF->m_szDept);
...
/*void CHMSPatientFoodOrderEntryEX::OnPatientNameAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSPatientFoodOrderEntryEX::OnOrderDateChange(){
	m_bAddOrder	= true;
} 
/*void CHMSPatientFoodOrderEntryEX::OnOrderDateSetfocus(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnOrderDateKillfocus(){
	
} */
int CHMSPatientFoodOrderEntryEX::OnOrderDateCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	UpdateData(true);
	...
	_tprintf(_T("\r\nn:%d, MaxDay:%d, NumberOrder:%d, %s, %s"), n, m_nMaxDays, nNumberOrderDate, m_szOrderDate, m_szCurrentOrderDate);
	if (n < 0  || m_nMaxDays < 0 || m_nMaxDays > nNumberOrderDate)	
		return -1;

	return 0;
} 
void CHMSPatientFoodOrderEntryEX::OnNameSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSPatientFoodOrderEntryEX::OnNameSelendok(){
	/*UpdateData(TRUE);
	OnNameCheckValue();*/
}
/*void CHMSPatientFoodOrderEntryEX::OnNameSetfocus(){
	
}*/
/*void CHMSPatientFoodOrderEntryEX::OnNameKillfocus(){
	
}*/
long CHMSPatientFoodOrderEntryEX::OnNameLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	if(m_wndName.IsSearchKey() && !m_szNameKey.IsEmpty())
	{
		...
		szWhere.AppendFormat(_T(" AND NVL(hfl_index1, 'N') = '212'"));
	...
	szSQL.Format(_T(" SELECT  hfl_idx,hfl_name2 as id,") \
				...
				_T(" ORDER BY hfl_idx, name, unit, unitprice "), szWhere );
					nCount = rs.ExecSQL(szSQL);
	//_msg(_T("%s"), szSQL);
	//_tprintf(_T("\r\nbbbbbbb:%s, %s, %s"), m_szNameKey, m_szName1Key, m_szName2Key);
...
/*void CHMSPatientFoodOrderEntryEX::OnNameAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

void CHMSPatientFoodOrderEntryEX::OnName2SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSPatientFoodOrderEntryEX::OnName2Selendok(){
	/*UpdateData(TRUE);
	OnName2CheckValue();*/

}
/*void CHMSPatientFoodOrderEntryEX::OnName2Setfocus(){
	
}*/
/*void CHMSPatientFoodOrderEntryEX::OnName2Killfocus(){
	
}*/
long CHMSPatientFoodOrderEntryEX::OnName2LoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSPatientFoodOrderEntryEX::OnName2AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

void CHMSPatientFoodOrderEntryEX::OnName1SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSPatientFoodOrderEntryEX::OnName1Selendok(){
	/*UpdateData(TRUE);
	OnName1CheckValue();*/
}
/*void CHMSPatientFoodOrderEntryEX::OnName1Setfocus(){
	
}*/
/*void CHMSPatientFoodOrderEntryEX::OnName1Killfocus(){
	
}*/
long CHMSPatientFoodOrderEntryEX::OnName1LoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSPatientFoodOrderEntryEX::OnName1AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQtyChange(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQtySetfocus(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQtyKillfocus(){
	
} */
int CHMSPatientFoodOrderEntryEX::OnQtyCheckValue(){
	return 0;
} 
/*void CHMSPatientFoodOrderEntryEX::OnQty2Change(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQty2Setfocus(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQty2Killfocus(){
	
} */
int CHMSPatientFoodOrderEntryEX::OnQty2CheckValue(){
	return 0;
} 


void CHMSPatientFoodOrderEntryEX::OnBreakfastRelativeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSPatientFoodOrderEntryEX::OnBreakfastRelativeSelendok(){
	 
}
/*void CHMSPatientFoodOrderEntryEX::OnBreakfastRelativeSetfocus(){
	
}*/
/*void CHMSPatientFoodOrderEntryEX::OnBreakfastRelativeKillfocus(){
	
}*/
long CHMSPatientFoodOrderEntryEX::OnBreakfastRelativeLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
_T(" ORDER BY hfl_idx, name, unit, unitprice "), szWhere );
	nCount = rs.ExecSQL(szSQL);
	//_tprintf(_T("\r\nbbbbbbb:%s, %s, %s"), m_szBreakfastRelativeKey, m_szBreakfastRelative1Key, m_szBreakfastRelative2Key);
...
/*void CHMSPatientFoodOrderEntryEX::OnBreakfastRelativeAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQty3Change(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQty3Setfocus(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnQty3Killfocus(){
	
} */
int CHMSPatientFoodOrderEntryEX::OnQty3CheckValue(){
	return 0;
} 
/*void CHMSPatientFoodOrderEntryEX::OnNoteChange(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnNoteSetfocus(){
	
} */
/*void CHMSPatientFoodOrderEntryEX::OnNoteKillfocus(){
	
} */
int CHMSPatientFoodOrderEntryEX::OnNoteCheckValue(){
	return 0;
} 


void CHMSPatientFoodOrderEntryEX::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveHMSPatientFoodOrderEntry();
} 
void CHMSPatientFoodOrderEntryEX::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	((CHMSDailyFoodOrder_EM*)m_pWndOrder)->GetDataToScreen();
	CGuiPopup::ClosePopup();
	
} 
int CHMSPatientFoodOrderEntryEX::OnAddHMSPatientFoodOrderEntry(){
...
int CHMSPatientFoodOrderEntryEX::OnEditHMSPatientFoodOrderEntry(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHMSPatientFoodOrderEntryEX::OnDeleteHMSPatientFoodOrderEntry(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CHMSPatientFoodOrderEntryEX::OnSaveHMSPatientFoodOrderEntry(){
	...
	if(m_szName1Key.IsEmpty() && m_szName2Key.IsEmpty() && m_szNameKey.IsEmpty() && m_szBreakfastRelativeKey.IsEmpty())
	{
		m_wndName.SetFocus();
		return -1;
	}
...
_tprintf(_T("\r\n%ld"), m_nOID);
	...
	for (int i=0; i < m_nDays; i++)
	{
		...
		szSQL.Format(_T("HMS_FOODORDER_CREATE(%s) "), m_hms_feefodorderTbl.FormatSQL());
		...
		if(!szFeeID.IsEmpty())
		{
			...
			szSQL.Format(_T("HMS_FOODORDER_ADDLINE(%s) "), m_hms_feefodorderlineTbl.FormatSQL());	
...
_tprintf(_T("%s:%d"), szSQL, ret);
		...
		if(m_bHaucan)
		{
			...
			{			
				...
				m_hms_feefodorderlineTbl.SetValue(_T("hfol_type"), _T("S"));
				m_hms_feefodorderlineTbl.SetValue(_T("hfol_level"), nLevel);
				m_hms_feefodorderlineTbl.SetValue(_T("hfol_groupid"), _T("NN000"));
				szSQL.Format(_T("HMS_FOODORDER_ADDLINE_EX(%s) "), m_hms_feefodorderlineTbl.FormatSQL());	
	...
	if(bAddFlag){
		...
		if(nOrderID > 0)
		{
			...
			((CHMSDailyFoodOrder_EM*)m_pWndOrder)->Refresh(0, nDocumentNo);
		}
...
int CHMSPatientFoodOrderEntryEX::OnCancelHMSPatientFoodOrderEntry(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSPatientFoodOrderEntryEX::OnHMSPatientFoodOrderEntryListLoadData(){
	return 0;
}

BOOL CHMSPatientFoodOrderEntryEX::PreTranslateMessage(MSG* pMsg){
...
int CHMSPatientFoodOrderEntryEX::OnNameCheckValue()
{
...
int CHMSPatientFoodOrderEntryEX::OnName1CheckValue()
{
...
int CHMSPatientFoodOrderEntryEX::OnName2CheckValue()
{
