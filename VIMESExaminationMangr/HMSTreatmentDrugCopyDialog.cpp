...
void CHMSTreatmentDrugCopyDialog::OnInitializeComponents(){
	...
	m_hms_ipharmaorderTbl.AddField(_T("src_treat_idx"), dfLong); 
...
void CHMSTreatmentDrugCopyDialog::OnApplySelect(){
	...
	for (int i =0; i < m_wndList.GetItemCount(); i++)
	{
		...
		m_hms_ipharmaorderTbl.SetValue(_T("hpol_speed"), m_wndList.GetItemText(i, 7));
        m_hms_ipharmaorderTbl.SetValue(_T("src_treat_idx"),
                                       m_nOldTreatIdx);
