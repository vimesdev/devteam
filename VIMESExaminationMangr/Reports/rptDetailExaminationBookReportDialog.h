#ifndef rptDetailExaminationBookReportDialog_H
#define rptDetailExaminationBookReportDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptDetailExaminationBookReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnExport();
	rptDetailExaminationBookReportDialog (CWnd *pParent);
	~rptDetailExaminationBookReportDialog ();
	...
	int OnAddrptDetailExaminationBookReportDialog (); 
	int OnEditrptDetailExaminationBookReportDialog (); 
	int OnDeleterptDetailExaminationBookReportDialog (); 
	int OnSaverptDetailExaminationBookReportDialog (); 
	int OnCancelrptDetailExaminationBookReportDialog (); 
	int OnrptDetailExaminationBookReportDialogListLoadData(); 
};
#endif
