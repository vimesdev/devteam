#ifndef rptOperationPatientReportDialog_H
#define rptOperationPatientReportDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptOperationPatientReportDialog : public CGuiDialog{
protected:
public:
	...
	rptOperationPatientReportDialog(CWnd *pParent);
	~rptOperationPatientReportDialog();
	...
	int OnAddrptOperationPatientReportDialog(); 
	int OnEditrptOperationPatientReportDialog(); 
	int OnDeleterptOperationPatientReportDialog(); 
	int OnSaverptOperationPatientReportDialog(); 
	int OnCancelrptOperationPatientReportDialog(); 
	int OnrptOperationPatientReportDialogListLoadData();
	void PrintOperationPatientListReport();
	int			OnListSelectAll(); 
