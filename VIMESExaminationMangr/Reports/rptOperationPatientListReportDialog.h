#ifndef rptOperationPatientListReportDialog_H
#define rptOperationPatientListReportDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptOperationPatientListReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnPrintSelect(); 
	void			OnCloseSelect(); 
	rptOperationPatientListReportDialog(CWnd *pParent);
	~rptOperationPatientListReportDialog();
	...
	int OnAddrptOperationPatientListReportDialog(); 
	int OnEditrptOperationPatientListReportDialog(); 
	int OnDeleterptOperationPatientListReportDialog(); 
	int OnSaverptOperationPatientListReportDialog(); 
	int OnCancelrptOperationPatientListReportDialog(); 
	int OnrptOperationPatientListReportDialogListLoadData(); 
};
#endif
