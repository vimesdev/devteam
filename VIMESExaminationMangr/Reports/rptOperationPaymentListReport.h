#ifndef RPTOPERATIONPAYMENTLISTREPORT_H
#define RPTOPERATIONPAYMENTLISTREPORT_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CrptOperationPaymentListReport : public CGuiDialog{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CrptOperationPaymentListReport(CWnd *pParent);
	~CrptOperationPaymentListReport();
	...
	int OnAddrptOperationPaymentListReport(); 
	int OnEditrptOperationPaymentListReport(); 
	int OnDeleterptOperationPaymentListReport(); 
	int OnSaverptOperationPaymentListReport(); 
	int OnCancelrptOperationPaymentListReport(); 
	int OnrptOperationPaymentListReportListLoadData(); 
};
#endif
