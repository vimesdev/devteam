#ifndef rptMedicalCabinetPatientExportReportDialog_H
#define rptMedicalCabinetPatientExportReportDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptMedicalCabinetPatientExportReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	rptMedicalCabinetPatientExportReportDialog(CWnd *pParent);
	~rptMedicalCabinetPatientExportReportDialog();
	...
	int OnAddrptMedicalCabinetPatientExportReportDialog(); 
	int OnEditrptMedicalCabinetPatientExportReportDialog(); 
	int OnDeleterptMedicalCabinetPatientExportReportDialog(); 
	int OnSaverptMedicalCabinetPatientExportReportDialog(); 
	int OnCancelrptMedicalCabinetPatientExportReportDialog(); 
	int OnrptMedicalCabinetPatientExportReportDialogListLoadData(); 
};
#endif
