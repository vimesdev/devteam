#ifndef rptExaminationBookReportDialog_H
#define rptExaminationBookReportDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptExaminationBookReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnExport();
	rptExaminationBookReportDialog (CWnd *pParent);
	~rptExaminationBookReportDialog ();
	...
	int OnAddrptExaminationBookReportDialog (); 
	int OnEditrptExaminationBookReportDialog (); 
	int OnDeleterptExaminationBookReportDialog (); 
	int OnSaverptExaminationBookReportDialog (); 
	int OnCancelrptExaminationBookReportDialog (); 
	int OnrptExaminationBookReportDialogListLoadData(); 
};
#endif
