...
#include "Excel.h"
#include "HMSPatientFoodOrderEntry_EM.h"
...
static long _OnOrderListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListLoadData();
} 
static void _OnOrderListDblClickFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListDblClick();
} 
static void _OnOrderListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListSelectChange(nOldItem, nNewItem);
} 
static int _OnOrderListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListDeleteItem();
} 

static int _OnOrderListPrintDeliveryRationFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListPrintDeliveryRation();
}

static int _OnOrderListAddFromServicePkgFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListAddFromServicePkg();
}
static int _OnOrderListAddFromServiceFamilyPkgFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListAddFromServiceFamilyPkg();
}
static int _OnOrderListPrintPhieuAnSangFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM*)pWnd)->OnPhieuAnMienPhi();
}

static int	_OnExportOrderDeliveryRationFnc(CWnd *pWnd){
	return	((CHMSDailyFoodOrder_EM*)pWnd)->OnExportOrderDeliveryRation();
}
static int _OnOrderListPrintSheetDateFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListPrintSheetDate();
}
static int _OnOrderListPrintSheetpublicityFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnOrderListPrintSheetPublicity();
}

static long _OnPatientListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM*)pWnd)->OnPatientListLoadData();
} 
static void _OnPatientListDblClickFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM*)pWnd)->OnPatientListDblClick();
} 
static void _OnPatientListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyFoodOrder_EM*)pWnd)->OnPatientListSelectChange(nOldItem, nNewItem);
} 

static int _OnPatientListIssueAllFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnPatientListIssueAll();
} 

static int _OnPatientListIssueFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnPatientListIssue();
} 

static int _OnPatientListRollbackFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnPatientListRollback();
} 

static int _OnPatientListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnPatientListDeleteItem();
} 
static long _OnRationListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM*)pWnd)->OnRationListLoadData();
} 
static void _OnRationListDblClickFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM*)pWnd)->OnRationListDblClick();
} 
static void _OnRationListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyFoodOrder_EM*)pWnd)->OnRationListSelectChange(nOldItem, nNewItem);
} 
static int _OnRationListAddEntryFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnRationListAddEntry();
} 

static int _OnRationListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnRationListDeleteItem();
} 
static int _OnRationListReturnFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnRationListReturnRation();
}


static int _OnChangeRationFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnChangeRation();
}

/*static void _OnOrderNoChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderNoChange();
} */
/*static void _OnOrderNoSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderNoSetfocus();} */ 
/*static void _OnOrderNoKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderNoKillfocus();
} */
static int _OnOrderNoCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderNoCheckValue();
} 
static void _OnFindSelectFnc(CWnd *pWnd){
	CHMSDailyFoodOrder_EM *pVw = (CHMSDailyFoodOrder_EM *)pWnd;
	pVw->OnFindSelect();
} 
/*static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderDateChange();
} */
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM *)pWnd)->OnOrderDateCheckValue();
} 
/*static void _OnIssueDateChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnIssueDateChange();
} */
/*static void _OnIssueDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnIssueDateSetfocus();} */ 
/*static void _OnIssueDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnIssueDateKillfocus();
} */
static int _OnIssueDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM *)pWnd)->OnIssueDateCheckValue();
} 
/*static void _OnStatusChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnStatusChange();
} */
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnStatusSetfocus();} */ 
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnStatusKillfocus();
} */
static int _OnStatusCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM *)pWnd)->OnStatusCheckValue();
} 
/*static void _OnPrintedChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnPrintedChange();
} */
/*static void _OnPrintedSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnPrintedSetfocus();} */ 
/*static void _OnPrintedKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnPrintedKillfocus();
} */
/*static void _OnPatientNameChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EMDialog *)pWnd)->OnPatientNameChange();
} */
/*static void _OnPatientNameSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EMDialog *)pWnd)->OnPatientNameSetfocus();} */ 
/*static void _OnPatientNameKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EMDialog *)pWnd)->OnPatientNameKillfocus();
} */
static int _OnPatientNameCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM *)pWnd)->OnPatientNameCheckValue();
} 
static int _OnPrintedCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM *)pWnd)->OnPrintedCheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrder_EM *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrder_EM *)pWnd)->OnNoteCheckValue();
} 
...
static int _OnAddHMSDailyFoodOrderFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnAddHMSDailyFoodOrder();
} 
static int _OnEditHMSDailyFoodOrderFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnEditHMSDailyFoodOrder();
} 
static int _OnDeleteHMSDailyFoodOrderFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnDeleteHMSDailyFoodOrder();
} 
static int _OnSaveHMSDailyFoodOrderFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnSaveHMSDailyFoodOrder();
} 
static int _OnCancelHMSDailyFoodOrderFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrder_EM*)pWnd)->OnCancelHMSDailyFoodOrder();
}
static void _OnBaoSuaSelectFnc(CWnd *pWnd){
	 ((CHMSDailyFoodOrder_EM*)pWnd)->OnBaoSuaSelect();
}
//CHMSDailyFoodOrder_EM::CHMSDailyFoodOrder_EM(CWnd *pParent)
CHMSDailyFoodOrder_EM::CHMSDailyFoodOrder_EM()
{
	m_nDlgWidth = 1024;
	m_nDlgHeight = 805;
	SetDefaultValues();
...
void CHMSDailyFoodOrder_EM::OnCreateComponents()
{	
	...
	m_wndOrderNoLabel.Create(this, _T("Order ID"), 8, 30, 98, 55);
	m_wndOrderNo.Create(this,106, 30, 222, 55); 
	m_wndStatusLabel.Create(this, _T("Status"), 227, 30, 297, 55);
	m_wndStatus.Create(this,303, 30, 412, 55); 
	m_wndOrderInformation.Create(this, _T("Order Information"), 7, 6, 501, 121);
	m_wndPrimary.Create(this, _T("Primary"), 417, 30, 501, 55);
	m_wndOrderDateLabel.Create(this, _T("Order Date"), 8, 59, 98, 84);
	m_wndOrderDate.Create(this,106, 59, 222, 84); 
	m_wndIssueDateLabel.Create(this, _T("Issue Date"), 227, 59, 297, 84);
	m_wndIssueDate.Create(this,303, 59, 412, 84); 
	m_wndHaucan.Create(this, _T("BA hậu cần"), 417, 59, 501, 84);
	m_wndNoteLabel.Create(this, _T("Note"), 8, 90, 98, 115);
	m_wndNote.Create(this,106, 90, 412, 115); 
	m_wndBaoSua.Create(this, _T("Báo Sữa"), 417, 90, 500, 115);

	m_wndHaucan.EnableWindow(FALSE);
	m_wndBaoSua.EnableWindow(FALSE);
	...
	m_wndPrintDeliveryRations.Create(this, _T(""), 0, 0, 0, 0);
	m_wndPrintDeliveryRations.ShowWindow(SW_HIDE);
	m_wndPrintDeliveryRations.EnableWindow(FALSE);
}
void CHMSDailyFoodOrder_EM::OnInitializeComponents()
{
...
//	m_wndOrderNo.ModifyStyle(0, ES_NUMBER);
	...
	m_wndOrderList.InsertColumn(3, _T("Bữa 1"), CFMT_MONEY, 50);	
	m_wndOrderList.InsertColumn(4, _T("Bữa 2"), CFMT_MONEY, 50);	
	m_wndOrderList.InsertColumn(5, _T("Bữa 3"), CFMT_MONEY, 50);	

	m_wndOrderList.InsertColumn(6, _T("Qty"), CFMT_MONEY, 30);	
	...
	m_feefoodTbl.AddField(_T("HFOS_MILK"), dfText, 4);
	

}
void CHMSDailyFoodOrder_EM::OnSetWindowEvents(){
	...
	*/
	...
	m_wndBaoSua.SetEvent(WE_CLICK, _OnBaoSuaSelectFnc);
...
void CHMSDailyFoodOrder_EM::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Check(pDX, m_wndBaoSua.GetDlgCtrlID(), m_bBaoSua);
}
void CHMSDailyFoodOrder_EM::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	szSQL.Format(_T("SELECT  ") \
		...
		_T("HFOS_ISPRIMARY as isprimary, HFOS_DEPTTYPE, HFOS_MILK ") \
	...
	if(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("HFOS_MILK"), tmpStr);
		m_bBaoSua = FALSE;
...
void CHMSDailyFoodOrder_EM::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szWhere;
	...
	m_feefoodTbl.SetValue(_T("HFOS_MILK"), m_bBaoSua?_T("MILK"):_T("N"));
	
}
void CHMSDailyFoodOrder_EM::SetDefaultValues(){
...
int CHMSDailyFoodOrder_EM::SetMode(int nMode){
...
void CHMSDailyFoodOrder_EM::OnOrderListDblClick(){
	
}
	void CHMSDailyFoodOrder_EM::OnBaoSuaSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}

void CHMSDailyFoodOrder_EM::OnOrderListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 
int CHMSDailyFoodOrder_EM::OnOrderListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSDailyFoodOrder_EM::OnOrderListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyFoodOrder_EM::OnPatientListDblClick(){
	
} 
void CHMSDailyFoodOrder_EM::OnPatientListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyFoodOrder_EM::OnPatientListIssueAll(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
...
int CHMSDailyFoodOrder_EM::OnPatientListIssue(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
int CHMSDailyFoodOrder_EM::OnPatientListRollback(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	if(m_szStatus != _T("A"))
		return -1;
...
int CHMSDailyFoodOrder_EM::OnPatientListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
 	CString szSQL;
...
long CHMSDailyFoodOrder_EM::OnPatientListLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyFoodOrder_EM::OnRationListDblClick(){
	
} 
void CHMSDailyFoodOrder_EM::OnRationListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 

int CHMSDailyFoodOrder_EM::OnRationListAddEntry()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
		return 0;
	if (m_bBaoSua)
	{
	CHMSPatientFoodOrderEntryEX* newPopup = new CHMSPatientFoodOrderEntryEX(this, VM_ADD);
...
int CHMSDailyFoodOrder_EM::OnRationListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
...
int CHMSDailyFoodOrder_EM::OnRationListReturnRation(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL, szItemID, szType, szStatus; 
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T("SELECT COUNT(*) FROM hms_doc WHERE hd_docno = %ld AND hd_status ='T' "), m_nDocumentNo);
	rs.ExecSQL(szSQL);
	if(rs.GetIntValue() > 0){
		ShowMessageBox(_T("Bệnh nhân đã kết thúc hồ sơ. Không thể cắt ăn"), MB_ICONERROR);
		return -1;
	}
	int nSel = m_wndRationList.GetCurSel();
	if(nSel < 0) return -1;
...
long CHMSDailyFoodOrder_EM::OnRationListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSDailyFoodOrder_EM::OnOrderNoChange(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnOrderNoSetfocus(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnOrderNoKillfocus(){
	
} */
int CHMSDailyFoodOrder_EM::OnOrderNoCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSDailyFoodOrder_EM::OnFindSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	static CString szFromDate, szToDate;
	OnOrderDateCheckValue();	
} 
/*void CHMSDailyFoodOrder_EMDialog::OnPatientNameChange(){
	
} */
/*void CHMSDailyFoodOrder_EMDialog::OnPatientNameSetfocus(){
	
} */
/*void CHMSDailyFoodOrder_EMDialog::OnPatientNameKillfocus(){
	
} */
int CHMSDailyFoodOrder_EM::OnPatientNameCheckValue(){
	OnPatientListLoadData();
	return 0;
} 

/*void CHMSDailyFoodOrder_EM::OnOrderDateChange(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnOrderDateSetfocus(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnOrderDateKillfocus(){
	
} */
int CHMSDailyFoodOrder_EM::OnOrderDateCheckValue(){
	UpdateData(true);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CHMSDailyFoodOrder_EM::OnIssueDateChange(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnIssueDateSetfocus(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnIssueDateKillfocus(){
	
} */
int CHMSDailyFoodOrder_EM::OnIssueDateCheckValue(){
	return 0;
} 

/*void CHMSDailyFoodOrder_EM::OnStatusChange(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnStatusSetfocus(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnStatusKillfocus(){
	
} */
int CHMSDailyFoodOrder_EM::OnStatusCheckValue(){
	return 0;
} 
/*void CHMSDailyFoodOrder_EM::OnPrintedChange(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnPrintedSetfocus(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnPrintedKillfocus(){
	
} */
int CHMSDailyFoodOrder_EM::OnPrintedCheckValue(){
	return 0;
} 
/*void CHMSDailyFoodOrder_EM::OnNoteChange(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnNoteSetfocus(){
	
} */
/*void CHMSDailyFoodOrder_EM::OnNoteKillfocus(){
	
} */
int CHMSDailyFoodOrder_EM::OnNoteCheckValue(){
	return 0;
} 
void CHMSDailyFoodOrder_EM::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnAddHMSDailyFoodOrder();
	
} 
void CHMSDailyFoodOrder_EM::OnEditSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnEditHMSDailyFoodOrder();
} 
void CHMSDailyFoodOrder_EM::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteHMSDailyFoodOrder();
} 
void CHMSDailyFoodOrder_EM::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveHMSDailyFoodOrder();
} 
void CHMSDailyFoodOrder_EM::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancelHMSDailyFoodOrder();
} 
void CHMSDailyFoodOrder_EM::OnSendSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyFoodOrder_EM::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
int CHMSDailyFoodOrder_EM::OnOrderListPrintSheetPublicity(){
	return 0;	
}
int CHMSDailyFoodOrder_EM::OnOrderListPrintSheetDate(){
	return 0;
}
int CHMSDailyFoodOrder_EM::OnAddHMSDailyFoodOrder(){
...
int CHMSDailyFoodOrder_EM::OnEditHMSDailyFoodOrder(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
...
int CHMSDailyFoodOrder_EM::OnDeleteHMSDailyFoodOrder(){
...
int CHMSDailyFoodOrder_EM::OnSaveHMSDailyFoodOrder(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
...
void CHMSDailyFoodOrder_EM::OnAddAutomaticSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyFoodOrder_EM::OnCancelHMSDailyFoodOrder(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSDailyFoodOrder_EM::OnHMSDailyFoodOrderListLoadData(){
	return 0;
}


void CHMSDailyFoodOrder_EM::RefreshData(){
	OnOrderListLoadData();
	OnPatientListLoadData();
}

void CHMSDailyFoodOrder_EM::LoadRationList(long nID){
	for (int i =0; i < m_wndPatientList.GetItemCount(); i++){
...
void CHMSDailyFoodOrder_EM::OnPrintDeliverySummery(long nTransactionID, LPCTSTR lpszOrderDate, bool bPreview){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;	
...
void CHMSDailyFoodOrder_EM::OnPrintDelivery(long nTransactionID, LPCTSTR lpszOrderDate, bool bPreview, bool bRelative){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;	
...
int CHMSDailyFoodOrder_EM::OnExportOrderDeliveryRation(){
	
	return 0;
}
int CHMSDailyFoodOrder_EM::OnOrderListPrintDeliveryRation()
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
#include "HMSServicePackageFoodOrderDialog_EM.h"
int CHMSDailyFoodOrder_EM::OnOrderListAddFromServicePkg()
{
	GetOrderStatus();
	if(!m_bHaucan)
		return -1;
...
#include "HMSServicePackageFamilyFoodOrderDialog_EM.h"
int CHMSDailyFoodOrder_EM::OnOrderListAddFromServiceFamilyPkg()
{
	//UpdateData(true);
	GetOrderStatus();
	if(!m_bHaucan)
...
void CHMSDailyFoodOrder_EM::OnAddRationSelect(){
	OnRationListAddEntry();
}

void CHMSDailyFoodOrder_EM::OnPrintDeliveryRationsSelect(){	

}

void CHMSDailyFoodOrder_EM::Refresh(long nTransactionID, long nDocumentNo){
...
long CHMSDailyFoodOrder_EM::GetTransactionID(int nStorageID)
{
...
int CHMSDailyFoodOrder_EM::OnChangeRation(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();	
	CString szSQL, szItemID, szType, szStatus; 
...
#include "TMDailyFoodPrintSheetDialog_EM.h"
int CHMSDailyFoodOrder_EM::OnPhieuAnMienPhi(){
...
void CHMSDailyFoodOrder_EM::GetOrderStatus()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	UpdateData(true);
