#ifndef ADBUSINESSPARTNERCONTRACTDTLView_H
#define ADBUSINESSPARTNERCONTRACTDTLView_H
...
#include "GuiView.h"
#include "DbField.h"
class CAdBusinessPartnerContractDtlView : public CGuiView{
protected:
public:
	...
	CGuiTextCtrl	m_wndContractDate;
	...
	CAdBusinessPartnerContractDtlView();
	~CAdBusinessPartnerContractDtlView();
	...
	int OnAddAdBusinessPartnerContractDtlView(); 
	int OnEditAdBusinessPartnerContractDtlView(); 
	int OnDeleteAdBusinessPartnerContractDtlView(); 
	int OnSaveAdBusinessPartnerContractDtlView(); 
	int OnCancelAdBusinessPartnerContractDtlView(); 
	int OnAdBusinessPartnerContractDtlViewListLoadData(); 
};
#endif
