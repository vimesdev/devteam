...
/*static void _OnDangDiVaDungChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDangDiVaDungChange();
} */
/*static void _OnDangDiVaDungSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDangDiVaDungSetfocus();} */ 
/*static void _OnDangDiVaDungKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDangDiVaDungKillfocus();
} */
static int _OnDangDiVaDungCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDangDiVaDungCheckValue();
} 
/*static void _OnTuTheTayChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheTayChange();
} */
/*static void _OnTuTheTaySetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheTaySetfocus();} */ 
/*static void _OnTuTheTayKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheTayKillfocus();
} */
static int _OnTuTheTayCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheTayCheckValue();
} 
/*static void _OnTuTheChanChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheChanChange();
} */
/*static void _OnTuTheChanSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheChanSetfocus();} */ 
/*static void _OnTuTheChanKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheChanKillfocus();
} */
static int _OnTuTheChanCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTuTheChanCheckValue();
} 
/*static void _OnTruongLucCoChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTruongLucCoChange();
} */
/*static void _OnTruongLucCoSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTruongLucCoSetfocus();} */ 
/*static void _OnTruongLucCoKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTruongLucCoKillfocus();
} */
static int _OnTruongLucCoCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTruongLucCoCheckValue();
} 
/*static void _OnVanDongBatThuongChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongBatThuongChange();
} */
/*static void _OnVanDongBatThuongSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongBatThuongSetfocus();} */ 
/*static void _OnVanDongBatThuongKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongBatThuongKillfocus();
} */
static int _OnVanDongBatThuongCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongBatThuongCheckValue();
} 
/*static void _OnDHcunggayChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHcunggayChange();
} */
/*static void _OnDHcunggaySetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHcunggaySetfocus();} */ 
/*static void _OnDHcunggayKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHcunggayKillfocus();
} */
static int _OnDHcunggayCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHcunggayCheckValue();
} 
/*static void _OnDHKernigChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKernigChange();
} */
/*static void _OnDHKernigSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKernigSetfocus();} */ 
/*static void _OnDHKernigKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKernigKillfocus();
} */
static int _OnDHKernigCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKernigCheckValue();
} 
/*static void _OnDHKhacChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKhacChange();
} */
/*static void _OnDHKhacSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKhacSetfocus();} */ 
/*static void _OnDHKhacKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKhacKillfocus();
} */
static int _OnDHKhacCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHKhacCheckValue();
} 
/*static void _OnMoTaThemChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnMoTaThemChange();
} */
/*static void _OnMoTaThemSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnMoTaThemSetfocus();} */ 
/*static void _OnMoTaThemKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnMoTaThemKillfocus();
} */
static int _OnMoTaThemCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnMoTaThemCheckValue();
} 
/*static void _OnKhamCamGiacSauChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacSauChange();
} */
/*static void _OnKhamCamGiacSauSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacSauSetfocus();} */ 
/*static void _OnKhamCamGiacSauKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacSauKillfocus();
} */
static int _OnKhamCamGiacSauCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacSauCheckValue();
} 
/*static void _OnKhamCamGiacNongChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacNongChange();
} */
/*static void _OnKhamCamGiacNongSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacNongSetfocus();} */ 
/*static void _OnKhamCamGiacNongKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacNongKillfocus();
} */
static int _OnKhamCamGiacNongCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKhamCamGiacNongCheckValue();
} 
/*static void _OnCoCungCoChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCoCungCoChange();
} */
/*static void _OnCoCungCoSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCoCungCoSetfocus();} */ 
/*static void _OnCoCungCoKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCoCungCoKillfocus();
} */
static int _OnCoCungCoCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCoCungCoCheckValue();
} 
/*static void _OnVanDongThuDongChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongThuDongChange();
} */
/*static void _OnVanDongThuDongSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongThuDongSetfocus();} */ 
/*static void _OnVanDongThuDongKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongThuDongKillfocus();
} */
static int _OnVanDongThuDongCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnVanDongThuDongCheckValue();
} 
/*static void _OnRoiLoanCamGiacDauCoVaiChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRoiLoanCamGiacDauCoVaiChange();
} */
/*static void _OnRoiLoanCamGiacDauCoVaiSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRoiLoanCamGiacDauCoVaiSetfocus();} */ 
/*static void _OnRoiLoanCamGiacDauCoVaiKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRoiLoanCamGiacDauCoVaiKillfocus();
} */
static int _OnRoiLoanCamGiacDauCoVaiCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRoiLoanCamGiacDauCoVaiCheckValue();
} 
/*static void _OnDiemDauCotSongChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCotSongChange();
} */
/*static void _OnDiemDauCotSongSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCotSongSetfocus();} */ 
/*static void _OnDiemDauCotSongKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCotSongKillfocus();
} */
static int _OnDiemDauCotSongCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCotSongCheckValue();
} 
/*static void _OnDiemDauCanhCotSongChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCanhCotSongChange();
} */
/*static void _OnDiemDauCanhCotSongSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCanhCotSongSetfocus();} */ 
/*static void _OnDiemDauCanhCotSongKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCanhCotSongKillfocus();
} */
static int _OnDiemDauCanhCotSongCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDiemDauCanhCotSongCheckValue();
} 
/*static void _OnLechVeoCotSongThatLungChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLechVeoCotSongThatLungChange();
} */
/*static void _OnLechVeoCotSongThatLungSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLechVeoCotSongThatLungSetfocus();} */ 
/*static void _OnLechVeoCotSongThatLungKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLechVeoCotSongThatLungKillfocus();
} */
static int _OnLechVeoCotSongThatLungCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLechVeoCotSongThatLungCheckValue();
} 
/*static void _OnDHSchoberChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHSchoberChange();
} */
/*static void _OnDHSchoberSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHSchoberSetfocus();} */ 
/*static void _OnDHSchoberKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHSchoberKillfocus();
} */
static int _OnDHSchoberCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDHSchoberCheckValue();
} 
/*static void _OnLThangPhaiChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangPhaiChange();
} */
/*static void _OnLThangPhaiSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangPhaiSetfocus();} */ 
/*static void _OnLThangPhaiKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangPhaiKillfocus();
} */
static int _OnLThangPhaiCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangPhaiCheckValue();
} 
/*static void _OnLThangTraiChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangTraiChange();
} */
/*static void _OnLThangTraiSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangTraiSetfocus();} */ 
/*static void _OnLThangTraiKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangTraiKillfocus();
} */
static int _OnLThangTraiCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLThangTraiCheckValue();
} 
/*static void _OnLCheoPhaiChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoPhaiChange();
} */
/*static void _OnLCheoPhaiSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoPhaiSetfocus();} */ 
/*static void _OnLCheoPhaiKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoPhaiKillfocus();
} */
static int _OnLCheoPhaiCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoPhaiCheckValue();
} 
/*static void _OnLCheoTraiChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoTraiChange();
} */
/*static void _OnLCheoTraiSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoTraiSetfocus();} */ 
/*static void _OnLCheoTraiKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoTraiKillfocus();
} */
static int _OnLCheoTraiCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnLCheoTraiCheckValue();
} 
/*static void _OnNCCPhaiChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCPhaiChange();
} */
/*static void _OnNCCPhaiSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCPhaiSetfocus();} */ 
/*static void _OnNCCPhaiKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCPhaiKillfocus();
} */
static int _OnNCCPhaiCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCPhaiCheckValue();
} 
/*static void _OnNCCTraiChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCTraiChange();
} */
/*static void _OnNCCTraiSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCTraiSetfocus();} */ 
/*static void _OnNCCTraiKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCTraiKillfocus();
} */
static int _OnNCCTraiCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNCCTraiCheckValue();
} 
/*static void _OnCacDauHieuKhacChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCacDauHieuKhacChange();
} */
/*static void _OnCacDauHieuKhacSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCacDauHieuKhacSetfocus();} */ 
/*static void _OnCacDauHieuKhacKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCacDauHieuKhacKillfocus();
} */
static int _OnCacDauHieuKhacCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnCacDauHieuKhacCheckValue();
} 
static void _OnSaveSelectFnc(CWnd *pWnd){
	CHMS_OBADTParkinsonDongKinh2 *pVw = (CHMS_OBADTParkinsonDongKinh2 *)pWnd;
	pVw->OnSaveSelect();
} 
...
/*static void _OnNhiDauRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauRChange();
} */
/*static void _OnNhiDauRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauRSetfocus();} */ 
/*static void _OnNhiDauRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauRKillfocus();
} */
static int _OnNhiDauRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauRCheckValue();
} 
/*static void _OnNhiDauLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauLChange();
} */
/*static void _OnNhiDauLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauLSetfocus();} */ 
/*static void _OnNhiDauLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauLKillfocus();
} */
static int _OnNhiDauLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNhiDauLCheckValue();
} 
/*static void _OnTamDauRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauRChange();
} */
/*static void _OnTamDauRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauRSetfocus();} */ 
/*static void _OnTamDauRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauRKillfocus();
} */
static int _OnTamDauRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauRCheckValue();
} 
/*static void _OnTamDauLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauLChange();
} */
/*static void _OnTamDauLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauLSetfocus();} */ 
/*static void _OnTamDauLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauLKillfocus();
} */
static int _OnTamDauLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnTamDauLCheckValue();
} 
/*static void _OnGoiRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiRChange();
} */
/*static void _OnGoiRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiRSetfocus();} */ 
/*static void _OnGoiRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiRKillfocus();
} */
static int _OnGoiRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiRCheckValue();
} 
/*static void _OnGotRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGotRChange();
} */
/*static void _OnGotRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGotRSetfocus();} */ 
/*static void _OnGotRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGotRKillfocus();
} */
static int _OnGotRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGotRCheckValue();
} 
/*static void _OnGOTLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGOTLChange();
} */
/*static void _OnGOTLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGOTLSetfocus();} */ 
/*static void _OnGOTLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGOTLKillfocus();
} */
static int _OnGOTLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGOTLCheckValue();
} 
/*static void _OnDaBungTrenRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenRChange();
} */
/*static void _OnDaBungTrenRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenRSetfocus();} */ 
/*static void _OnDaBungTrenRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenRKillfocus();
} */
static int _OnDaBungTrenRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenRCheckValue();
} 
/*static void _OnDaBungTrenLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenLChange();
} */
/*static void _OnDaBungTrenLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenLSetfocus();} */ 
/*static void _OnDaBungTrenLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenLKillfocus();
} */
static int _OnDaBungTrenLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungTrenLCheckValue();
} 
/*static void _OnBungGiuaRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaRChange();
} */
/*static void _OnBungGiuaRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaRSetfocus();} */ 
/*static void _OnBungGiuaRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaRKillfocus();
} */
static int _OnBungGiuaRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaRCheckValue();
} 
/*static void _OnBungGiuaLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaLChange();
} */
/*static void _OnBungGiuaLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaLSetfocus();} */ 
/*static void _OnBungGiuaLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaLKillfocus();
} */
static int _OnBungGiuaLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBungGiuaLCheckValue();
} 
/*static void _OnDaBungDuoiRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiRChange();
} */
/*static void _OnDaBungDuoiRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiRSetfocus();} */ 
/*static void _OnDaBungDuoiRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiRKillfocus();
} */
static int _OnDaBungDuoiRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiRCheckValue();
} 
/*static void _OnDaBungDuoiLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiLChange();
} */
/*static void _OnDaBungDuoiLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiLSetfocus();} */ 
/*static void _OnDaBungDuoiLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiLKillfocus();
} */
static int _OnDaBungDuoiLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnDaBungDuoiLCheckValue();
} 
/*static void _OnBiuDuiRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiRChange();
} */
/*static void _OnBiuDuiRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiRSetfocus();} */ 
/*static void _OnBiuDuiRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiRKillfocus();
} */
static int _OnBiuDuiRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiRCheckValue();
} 
/*static void _OnBiuDuiLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiLChange();
} */
/*static void _OnBiuDuiLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiLSetfocus();} */ 
/*static void _OnBiuDuiLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiLKillfocus();
} */
static int _OnBiuDuiLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBiuDuiLCheckValue();
} 
/*static void _OnHTRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTRChange();
} */
/*static void _OnHTRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTRSetfocus();} */ 
/*static void _OnHTRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTRKillfocus();
} */
static int _OnHTRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTRCheckValue();
} 
/*static void _OnHTLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTLChange();
} */
/*static void _OnHTLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTLSetfocus();} */ 
/*static void _OnHTLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTLKillfocus();
} */
static int _OnHTLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnHTLCheckValue();
} 
/*static void _OnBabinskiRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiRChange();
} */
/*static void _OnBabinskiRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiRSetfocus();} */ 
/*static void _OnBabinskiRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiRKillfocus();
} */
static int _OnBabinskiRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiRCheckValue();
} 
/*static void _OnBabinskiLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiLChange();
} */
/*static void _OnBabinskiLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiLSetfocus();} */ 
/*static void _OnBabinskiLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiLKillfocus();
} */
static int _OnBabinskiLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnBabinskiLCheckValue();
} 
/*static void _OnChiTrenRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenRChange();
} */
/*static void _OnChiTrenRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenRSetfocus();} */ 
/*static void _OnChiTrenRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenRKillfocus();
} */
static int _OnChiTrenRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenRCheckValue();
} 
/*static void _OnChiTrenLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenLChange();
} */
/*static void _OnChiTrenLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenLSetfocus();} */ 
/*static void _OnChiTrenLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenLKillfocus();
} */
static int _OnChiTrenLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiTrenLCheckValue();
} 
/*static void _OnChiDuoiRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiRChange();
} */
/*static void _OnChiDuoiRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiRSetfocus();} */ 
/*static void _OnChiDuoiRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiRKillfocus();
} */
static int _OnChiDuoiRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiRCheckValue();
} 
/*static void _OnChiDuoiLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiLChange();
} */
/*static void _OnChiDuoiLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiLSetfocus();} */ 
/*static void _OnChiDuoiLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiLKillfocus();
} */
static int _OnChiDuoiLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnChiDuoiLCheckValue();
} 
/*static void _OnNPtromuiRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiRChange();
} */
/*static void _OnNPtromuiRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiRSetfocus();} */ 
/*static void _OnNPtromuiRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiRKillfocus();
} */
static int _OnNPtromuiRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiRCheckValue();
} 
/*static void _OnNPLienDongRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongRChange();
} */
/*static void _OnNPLienDongRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongRSetfocus();} */ 
/*static void _OnNPLienDongRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongRKillfocus();
} */
static int _OnNPLienDongRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongRCheckValue();
} 
/*static void _OnNPGotGoiRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiRChange();
} */
/*static void _OnNPGotGoiRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiRSetfocus();} */ 
/*static void _OnNPGotGoiRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiRKillfocus();
} */
static int _OnNPGotGoiRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiRCheckValue();
} 
/*static void _OnNystamusRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusRChange();
} */
/*static void _OnNystamusRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusRSetfocus();} */ 
/*static void _OnNystamusRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusRKillfocus();
} */
static int _OnNystamusRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusRCheckValue();
} 
/*static void _OnRomberRChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberRChange();
} */
/*static void _OnRomberRSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberRSetfocus();} */ 
/*static void _OnRomberRKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberRKillfocus();
} */
static int _OnRomberRCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberRCheckValue();
} 
/*static void _OnNPtromuiLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiLChange();
} */
/*static void _OnNPtromuiLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiLSetfocus();} */ 
/*static void _OnNPtromuiLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiLKillfocus();
} */
static int _OnNPtromuiLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPtromuiLCheckValue();
} 
/*static void _OnNPLienDongLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongLChange();
} */
/*static void _OnNPLienDongLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongLSetfocus();} */ 
/*static void _OnNPLienDongLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongLKillfocus();
} */
static int _OnNPLienDongLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPLienDongLCheckValue();
} 
/*static void _OnNystamusLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusLChange();
} */
/*static void _OnNystamusLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusLSetfocus();} */ 
/*static void _OnNystamusLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusLKillfocus();
} */
static int _OnNystamusLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNystamusLCheckValue();
} 
/*static void _OnRomberLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberLChange();
} */
/*static void _OnRomberLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberLSetfocus();} */ 
/*static void _OnRomberLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberLKillfocus();
} */
static int _OnRomberLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnRomberLCheckValue();
} 
/*static void _OnNPGotGoiLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiLChange();
} */
/*static void _OnNPGotGoiLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiLSetfocus();} */ 
/*static void _OnNPGotGoiLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiLKillfocus();
} */
static int _OnNPGotGoiLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnNPGotGoiLCheckValue();
} 
/*static void _OnGoiLChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiLChange();
} */
/*static void _OnGoiLSetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiLSetfocus();} */ 
/*static void _OnGoiLKillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiLKillfocus();
} */
static int _OnGoiLCheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnGoiLCheckValue();
} 
/*static void _OnKham12ChangeFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKham12Change();
} */
/*static void _OnKham12SetfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKham12Setfocus();} */ 
/*static void _OnKham12KillfocusFnc(CWnd *pWnd){
	((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKham12Killfocus();
} */
static int _OnKham12CheckValueFnc(CWnd *pWnd){
	return ((CHMS_OBADTParkinsonDongKinh2 *)pWnd)->OnKham12CheckValue();
} 
static int _OnAddHMS_OBADTParkinsonDongKinh2Fnc(CWnd *pWnd){
	 return ((CHMS_OBADTParkinsonDongKinh2*)pWnd)->OnAddHMS_OBADTParkinsonDongKinh2();
} 
static int _OnEditHMS_OBADTParkinsonDongKinh2Fnc(CWnd *pWnd){
	 return ((CHMS_OBADTParkinsonDongKinh2*)pWnd)->OnEditHMS_OBADTParkinsonDongKinh2();
} 
static int _OnDeleteHMS_OBADTParkinsonDongKinh2Fnc(CWnd *pWnd){
	 return ((CHMS_OBADTParkinsonDongKinh2*)pWnd)->OnDeleteHMS_OBADTParkinsonDongKinh2();
} 
static int _OnSaveHMS_OBADTParkinsonDongKinh2Fnc(CWnd *pWnd){
	 return ((CHMS_OBADTParkinsonDongKinh2*)pWnd)->OnSaveHMS_OBADTParkinsonDongKinh2();
} 
static int _OnCancelHMS_OBADTParkinsonDongKinh2Fnc(CWnd *pWnd){
	 return ((CHMS_OBADTParkinsonDongKinh2*)pWnd)->OnCancelHMS_OBADTParkinsonDongKinh2();
} 
CHMS_OBADTParkinsonDongKinh2::CHMS_OBADTParkinsonDongKinh2(){

	m_nDlgWidth = 805;
	m_nDlgHeight = 955;
	SetDefaultValues();
	m_szRecordType = _T("OBA_PARKINSON");
	m_szRecordGroup = _T("DONGKINH2");
}
CHMS_OBADTParkinsonDongKinh2::~CHMS_OBADTParkinsonDongKinh2(){
}
void CHMS_OBADTParkinsonDongKinh2::OnCreateComponents(){
...
void CHMS_OBADTParkinsonDongKinh2::OnInitializeComponents(){
...
void CHMS_OBADTParkinsonDongKinh2::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMS_OBADTParkinsonDongKinh2::OnDoDataExchange(CDataExchange* pDX){
...
void CHMS_OBADTParkinsonDongKinh2::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CHMS_OBADTParkinsonDongKinh2::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMS_OBADTParkinsonDongKinh2::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateJson(TRUE);
}
void CHMS_OBADTParkinsonDongKinh2::SetDefaultValues(){
...
int CHMS_OBADTParkinsonDongKinh2::SetMode(int nMode){
...
/*void CHMS_OBADTParkinsonDongKinh2::OnDangDiVaDungChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDangDiVaDungSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDangDiVaDungKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDangDiVaDungCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnTuTheTayChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTuTheTaySetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTuTheTayKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnTuTheTayCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnTuTheChanChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTuTheChanSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTuTheChanKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnTuTheChanCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnTruongLucCoChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTruongLucCoSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTruongLucCoKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnTruongLucCoCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnVanDongBatThuongChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnVanDongBatThuongSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnVanDongBatThuongKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnVanDongBatThuongCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDHcunggayChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHcunggaySetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHcunggayKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDHcunggayCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDHKernigChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHKernigSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHKernigKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDHKernigCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDHKhacChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHKhacSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHKhacKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDHKhacCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnMoTaThemChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnMoTaThemSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnMoTaThemKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnMoTaThemCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacSauChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacSauSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacSauKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacSauCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacNongChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacNongSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacNongKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnKhamCamGiacNongCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnCoCungCoChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnCoCungCoSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnCoCungCoKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnCoCungCoCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnVanDongThuDongChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnVanDongThuDongSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnVanDongThuDongKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnVanDongThuDongCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnRoiLoanCamGiacDauCoVaiChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnRoiLoanCamGiacDauCoVaiSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnRoiLoanCamGiacDauCoVaiKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnRoiLoanCamGiacDauCoVaiCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDiemDauCotSongChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDiemDauCotSongSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDiemDauCotSongKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDiemDauCotSongCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDiemDauCanhCotSongChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDiemDauCanhCotSongSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDiemDauCanhCotSongKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDiemDauCanhCotSongCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnLechVeoCotSongThatLungChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLechVeoCotSongThatLungSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLechVeoCotSongThatLungKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnLechVeoCotSongThatLungCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDHSchoberChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHSchoberSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDHSchoberKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDHSchoberCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnLThangPhaiChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLThangPhaiSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLThangPhaiKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnLThangPhaiCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnLThangTraiChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLThangTraiSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLThangTraiKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnLThangTraiCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnLCheoPhaiChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLCheoPhaiSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLCheoPhaiKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnLCheoPhaiCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnLCheoTraiChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLCheoTraiSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnLCheoTraiKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnLCheoTraiCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNCCPhaiChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNCCPhaiSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNCCPhaiKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNCCPhaiCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNCCTraiChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNCCTraiSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNCCTraiKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNCCTraiCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnCacDauHieuKhacChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnCacDauHieuKhacSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnCacDauHieuKhacKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnCacDauHieuKhacCheckValue(){
	return 0;
} 
void CHMS_OBADTParkinsonDongKinh2::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveHMS_OBADTParkinsonDongKinh2();
} 
void CHMS_OBADTParkinsonDongKinh2::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CReport rpt;
	UpdateData(true);
	CRecord rs(&pMF->m_db);
...
void CHMS_OBADTParkinsonDongKinh2::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnEditHMS_OBADTParkinsonDongKinh2();
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNhiDauRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNhiDauRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNhiDauRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNhiDauRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNhiDauLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNhiDauLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNhiDauLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNhiDauLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnTamDauRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTamDauRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTamDauRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnTamDauRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnTamDauLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTamDauLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnTamDauLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnTamDauLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnGoiRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGoiRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGoiRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnGoiRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnGotRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGotRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGotRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnGotRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnGOTLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGOTLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGOTLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnGOTLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDaBungTrenLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnBungGiuaRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBungGiuaRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBungGiuaRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnBungGiuaRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnBungGiuaLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBungGiuaLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBungGiuaLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnBungGiuaLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnDaBungDuoiLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnBiuDuiRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBiuDuiRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBiuDuiRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnBiuDuiRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnBiuDuiLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBiuDuiLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBiuDuiLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnBiuDuiLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnHTRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnHTRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnHTRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnHTRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnHTLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnHTLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnHTLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnHTLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnBabinskiRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBabinskiRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBabinskiRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnBabinskiRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnBabinskiLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBabinskiLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnBabinskiLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnBabinskiLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnChiTrenRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiTrenRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiTrenRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnChiTrenRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnChiTrenLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiTrenLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiTrenLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnChiTrenLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnChiDuoiRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiDuoiRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiDuoiRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnChiDuoiRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnChiDuoiLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiDuoiLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnChiDuoiLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnChiDuoiLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNPtromuiRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPtromuiRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPtromuiRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNPtromuiRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNPLienDongRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPLienDongRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPLienDongRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNPLienDongRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNystamusRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNystamusRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNystamusRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNystamusRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnRomberRChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnRomberRSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnRomberRKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnRomberRCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNPtromuiLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPtromuiLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPtromuiLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNPtromuiLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNPLienDongLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPLienDongLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPLienDongLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNPLienDongLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNystamusLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNystamusLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNystamusLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNystamusLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnRomberLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnRomberLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnRomberLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnRomberLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnNPGotGoiLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnGoiLChange(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGoiLSetfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnGoiLKillfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnGoiLCheckValue(){
	return 0;
} 
/*void CHMS_OBADTParkinsonDongKinh2::OnKham12Change(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnKham12Setfocus(){
	
} */
/*void CHMS_OBADTParkinsonDongKinh2::OnKham12Killfocus(){
	
} */
int CHMS_OBADTParkinsonDongKinh2::OnKham12CheckValue(){
	return 0;
} 
int CHMS_OBADTParkinsonDongKinh2::OnAddHMS_OBADTParkinsonDongKinh2(){
...
int CHMS_OBADTParkinsonDongKinh2::OnEditHMS_OBADTParkinsonDongKinh2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMS_OBADTParkinsonDongKinh2::OnDeleteHMS_OBADTParkinsonDongKinh2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelHMS_OBADTParkinsonDongKinh2();
 	}
	return 0;
}
int CHMS_OBADTParkinsonDongKinh2::OnSaveHMS_OBADTParkinsonDongKinh2(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
	...
	for (int i =0; i < strList.GetCount();i++)
	{
		...
		szSQL.Format(_T("HMS_DOC_EMR_CREATE('%s', %ld, '%s', %d, %d, '%s', '%s', '%s') "),
			m_szRecordType,pMF->m_nDocNo, pMF->GetCurrentDepartmentID(), n++, 0, pMF->GetCurrentUser(), pMF->GetCurrentDepartmentID()+_T("Parkinson2"), tmpStr);
...
int CHMS_OBADTParkinsonDongKinh2::OnCancelHMS_OBADTParkinsonDongKinh2(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMS_OBADTParkinsonDongKinh2::OnHMS_OBADTParkinsonDongKinh2ListLoadData(){
	return 0;
}
