#ifndef HMSExamTestProfileDialog_H
#define HMSExamTestProfileDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSExamTestProfileDialog : public CGuiDialog
{
protected:
public:
...
//void			OnQtyChange(); 
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CHMSExamTestProfileDialog(CWnd *pParent);
	~CHMSExamTestProfileDialog();
	...
	int OnAddHMSExamTestProfileDialog(); 
	int OnEditHMSExamTestProfileDialog(); 
	int OnDeleteHMSExamTestProfileDialog(); 
	int OnSaveHMSExamTestProfileDialog(); 
	int OnCancelHMSExamTestProfileDialog(); 
	int OnHMSExamTestProfileDialogListLoadData(); 
};
#endif
