#ifndef CHMSTERMINATECOVIDDOCUMENT_H
#define CHMSTERMINATECOVIDDOCUMENT_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSTerminateCovidDocument : public CGuiDialog
{
protected:
public:
	...
	//void			OnICDKillfocus(); 
	int			OnICDCheckValue(); 
	CHMSTerminateCovidDocument(CWnd *pParent);
	~CHMSTerminateCovidDocument();
	...
	int OnAddCHMSTerminateCovidDocument(); 
	int OnEditCHMSTerminateCovidDocument(); 
	int OnDeleteCHMSTerminateCovidDocument(); 
	int OnSaveCHMSTerminateCovidDocument(); 
	int OnCancelCHMSTerminateCovidDocument(); 
	int OnCHMSTerminateCovidDocumentListLoadData(); 
};
#endif
