#ifndef HMS_OBADTBENHSUYTIM_H
#define HMS_OBADTBENHSUYTIM_H
...
class CHMS_OBADTBenhSuyTim : public CHMSBenhAnView{
protected:
public:
	...
	CHMS_OBADTBenhSuyTim(CWnd *pParent);
	~CHMS_OBADTBenhSuyTim();
	...
	int OnAddHMS_OBADTBenhSuyTim(); 
	int OnEditHMS_OBADTBenhSuyTim(); 
	int OnDeleteHMS_OBADTBenhSuyTim(); 
	int OnSaveHMS_OBADTBenhSuyTim(); 
	int OnCancelHMS_OBADTBenhSuyTim(); 
	int OnHMS_OBADTBenhSuyTimListLoadData(); 
};
#endif
