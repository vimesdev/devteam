...
#include "Excel.h"
#include "HMSDailyFoodCancelPatientListDialog_EM.h"


static long _OnOrderListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnOrderListLoadData();
} 
static void _OnOrderListDblClickFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnOrderListDblClick();
} 
static void _OnOrderListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnOrderListSelectChange(nOldItem, nNewItem);
} 
static int _OnOrderListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnOrderListDeleteItem();
} 

static int _OnOrderListPrintDeliveryRationFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnOrderListPrintDeliveryRation();
}
static int	_OnExportOrderDeliveryRationFnc(CWnd *pWnd){
	return	((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnExportOrderDeliveryRation();
}
static int _OnOrderListPrintSheetDateFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnOrderListPrintSheetDate();
}
static int _OnOrderListPrintSheetpublicityFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnOrderListPrintSheetPublicity();
}

static long _OnPatientListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnPatientListLoadData();
} 
static void _OnPatientListDblClickFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnPatientListDblClick();
} 
static void _OnPatientListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnPatientListSelectChange(nOldItem, nNewItem);
} 

static int _OnPatientListIssueAllFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnPatientListIssueAll();
} 

static int _OnPatientListIssueFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnPatientListIssue();
} 

static int _OnPatientListRollbackFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnPatientListRollback();
} 

static int _OnPatientListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnPatientListDeleteItem();
} 
static long _OnRationListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnRationListLoadData();
} 
static void _OnRationListDblClickFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnRationListDblClick();
} 
static void _OnRationListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnRationListSelectChange(nOldItem, nNewItem);
} 
static int _OnRationListAddEntryFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnRationListAddEntry();
} 

static int _OnRationListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnRationListDeleteItem();
} 
static int _OnRationListReturnFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnRationListReturnRation();
}


static int _OnChangeRationFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnChangeRation();
}

/*static void _OnOrderNoChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderNoChange();
} */
/*static void _OnOrderNoSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderNoSetfocus();} */ 
/*static void _OnOrderNoKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderNoKillfocus();
} */
static int _OnOrderNoCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderNoCheckValue();
} 
static void _OnFindSelectFnc(CWnd *pWnd){
	CHMSDailyFoodOrderCancel_EM *pVw = (CHMSDailyFoodOrderCancel_EM *)pWnd;
	pVw->OnFindSelect();
} 
/*static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderDateChange();
} */
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnOrderDateCheckValue();
} 
/*static void _OnIssueDateChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnIssueDateChange();
} */
/*static void _OnIssueDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnIssueDateSetfocus();} */ 
/*static void _OnIssueDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnIssueDateKillfocus();
} */
static int _OnIssueDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnIssueDateCheckValue();
} 
/*static void _OnStatusChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnStatusChange();
} */
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnStatusSetfocus();} */ 
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnStatusKillfocus();
} */
static int _OnStatusCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnStatusCheckValue();
} 
/*static void _OnPrintedChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnPrintedChange();
} */
/*static void _OnPrintedSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnPrintedSetfocus();} */ 
/*static void _OnPrintedKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnPrintedKillfocus();
} */
/*static void _OnPatientNameChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EMDialog *)pWnd)->OnPatientNameChange();
} */
/*static void _OnPatientNameSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EMDialog *)pWnd)->OnPatientNameSetfocus();} */ 
/*static void _OnPatientNameKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EMDialog *)pWnd)->OnPatientNameKillfocus();
} */
static int _OnPatientNameCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnPatientNameCheckValue();
} 
static int _OnPrintedCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnPrintedCheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyFoodOrderCancel_EM *)pWnd)->OnNoteCheckValue();
} 
...
static int _OnAddHMSDailyFoodOrderCancelFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnAddHMSDailyFoodOrderCancel();
} 
static int _OnEditHMSDailyFoodOrderCancelFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnEditHMSDailyFoodOrderCancel();
} 
static int _OnDeleteHMSDailyFoodOrderCancelFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnDeleteHMSDailyFoodOrderCancel();
} 
static int _OnSaveHMSDailyFoodOrderCancelFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnSaveHMSDailyFoodOrderCancel();
} 
static int _OnCancelHMSDailyFoodOrderCancelFnc(CWnd *pWnd){
	 return ((CHMSDailyFoodOrderCancel_EM*)pWnd)->OnCancelHMSDailyFoodOrderCancel();
} 
//CHMSDailyFoodOrderCancel_EM::CHMSDailyFoodOrderCancel_EM(CWnd *pParent)
CHMSDailyFoodOrderCancel_EM::CHMSDailyFoodOrderCancel_EM()
{
	m_nDlgWidth = 1024;
	m_nDlgHeight = 805;
	SetDefaultValues();
...
void CHMSDailyFoodOrderCancel_EM::OnCreateComponents(){	
...
void CHMSDailyFoodOrderCancel_EM::OnInitializeComponents(){
...
void CHMSDailyFoodOrderCancel_EM::OnSetWindowEvents(){
...
void CHMSDailyFoodOrderCancel_EM::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSDailyFoodOrderCancel_EM::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSDailyFoodOrderCancel_EM::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szWhere;
...
void CHMSDailyFoodOrderCancel_EM::SetDefaultValues(){
...
int CHMSDailyFoodOrderCancel_EM::SetMode(int nMode){
...
void CHMSDailyFoodOrderCancel_EM::OnOrderListDblClick(){
	
} 
void CHMSDailyFoodOrderCancel_EM::OnOrderListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 
int CHMSDailyFoodOrderCancel_EM::OnOrderListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSDailyFoodOrderCancel_EM::OnOrderListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyFoodOrderCancel_EM::OnPatientListDblClick(){
	
} 
void CHMSDailyFoodOrderCancel_EM::OnPatientListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyFoodOrderCancel_EM::OnPatientListIssueAll(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T("SELECT hfos_status as status ") \
		_T("FROM hms_feefoodsheet ") \
		_T("WHERE hfos_orderid=%ld and hfos_ordertype='T' "), m_nOID);
	rs.ExecSQL(szSQL);
	if(rs.IsEOF())
		return -1;
	rs.GetValue(_T("status"), m_szStatus);
...
int CHMSDailyFoodOrderCancel_EM::OnPatientListIssue(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
int CHMSDailyFoodOrderCancel_EM::OnPatientListRollback(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	if(m_szStatus != _T("A"))
		return -1;
...
int CHMSDailyFoodOrderCancel_EM::OnPatientListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
 	CString szSQL;
	...
	szSQL.Format(_T("SELECT hfos_status as status FROM hms_feefoodsheet WHERE hfos_orderid=%ld"), m_nOID);
	rs.ExecSQL(szSQL);
	if(rs.IsEOF())
		return -1;
	rs.GetValue(_T("status"), m_szStatus);
...
long CHMSDailyFoodOrderCancel_EM::OnPatientListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyFoodOrderCancel_EM::OnRationListDblClick(){
	
} 
void CHMSDailyFoodOrderCancel_EM::OnRationListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 

int CHMSDailyFoodOrderCancel_EM::OnRationListAddEntry(){
	/*CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
		return 0;
...
int CHMSDailyFoodOrderCancel_EM::OnRationListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
...
int CHMSDailyFoodOrderCancel_EM::OnRationListReturnRation(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL, szItemID, szType; 
	CRecord rs(&pMF->m_db);
...
long CHMSDailyFoodOrderCancel_EM::OnRationListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSDailyFoodOrderCancel_EM::OnOrderNoChange(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnOrderNoSetfocus(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnOrderNoKillfocus(){
	
} */
int CHMSDailyFoodOrderCancel_EM::OnOrderNoCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSDailyFoodOrderCancel_EM::OnFindSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	static CString szFromDate, szToDate;
	OnOrderDateCheckValue();	
} 
/*void CHMSDailyFoodOrderCancel_EMDialog::OnPatientNameChange(){
	
} */
/*void CHMSDailyFoodOrderCancel_EMDialog::OnPatientNameSetfocus(){
	
} */
/*void CHMSDailyFoodOrderCancel_EMDialog::OnPatientNameKillfocus(){
	
} */
int CHMSDailyFoodOrderCancel_EM::OnPatientNameCheckValue(){
	OnPatientListLoadData();
	return 0;
} 

/*void CHMSDailyFoodOrderCancel_EM::OnOrderDateChange(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnOrderDateSetfocus(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnOrderDateKillfocus(){
	
} */
int CHMSDailyFoodOrderCancel_EM::OnOrderDateCheckValue(){
	UpdateData(true);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CHMSDailyFoodOrderCancel_EM::OnIssueDateChange(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnIssueDateSetfocus(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnIssueDateKillfocus(){
	
} */
int CHMSDailyFoodOrderCancel_EM::OnIssueDateCheckValue(){
	return 0;
} 

/*void CHMSDailyFoodOrderCancel_EM::OnStatusChange(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnStatusSetfocus(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnStatusKillfocus(){
	
} */
int CHMSDailyFoodOrderCancel_EM::OnStatusCheckValue(){
	return 0;
} 
/*void CHMSDailyFoodOrderCancel_EM::OnPrintedChange(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnPrintedSetfocus(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnPrintedKillfocus(){
	
} */
int CHMSDailyFoodOrderCancel_EM::OnPrintedCheckValue(){
	return 0;
} 
/*void CHMSDailyFoodOrderCancel_EM::OnNoteChange(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnNoteSetfocus(){
	
} */
/*void CHMSDailyFoodOrderCancel_EM::OnNoteKillfocus(){
	
} */
int CHMSDailyFoodOrderCancel_EM::OnNoteCheckValue(){
	return 0;
} 
void CHMSDailyFoodOrderCancel_EM::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnAddHMSDailyFoodOrderCancel();
	
} 
void CHMSDailyFoodOrderCancel_EM::OnEditSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnEditHMSDailyFoodOrderCancel();
} 
void CHMSDailyFoodOrderCancel_EM::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteHMSDailyFoodOrderCancel();
} 
void CHMSDailyFoodOrderCancel_EM::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveHMSDailyFoodOrderCancel();
} 
void CHMSDailyFoodOrderCancel_EM::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancelHMSDailyFoodOrderCancel();
} 
void CHMSDailyFoodOrderCancel_EM::OnSendSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyFoodOrderCancel_EM::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
int CHMSDailyFoodOrderCancel_EM::OnOrderListPrintSheetPublicity(){
	return 0;
}
int CHMSDailyFoodOrderCancel_EM::OnOrderListPrintSheetDate(){
	return 0;
}
int CHMSDailyFoodOrderCancel_EM::OnAddHMSDailyFoodOrderCancel(){
...
int CHMSDailyFoodOrderCancel_EM::OnEditHMSDailyFoodOrderCancel(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
...
int CHMSDailyFoodOrderCancel_EM::OnDeleteHMSDailyFoodOrderCancel(){
...
int CHMSDailyFoodOrderCancel_EM::OnSaveHMSDailyFoodOrderCancel(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
...
void CHMSDailyFoodOrderCancel_EM::OnAddAutomaticSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyFoodOrderCancel_EM::OnCancelHMSDailyFoodOrderCancel(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSDailyFoodOrderCancel_EM::OnHMSDailyFoodOrderCancelListLoadData(){
	return 0;
}


void CHMSDailyFoodOrderCancel_EM::RefreshData(){
	OnOrderListLoadData();
	OnPatientListLoadData();
}

void CHMSDailyFoodOrderCancel_EM::LoadRationList(long nID){
	for (int i =0; i < m_wndPatientList.GetItemCount(); i++){
...
void CHMSDailyFoodOrderCancel_EM::OnPrintDeliverySummery(long nTransactionID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;	
...
void CHMSDailyFoodOrderCancel_EM::OnPrintDelivery(long nTransactionID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;	
	CString tmpStr, szSQL;
	CRecord rs(&pMF->m_db);
...
int CHMSDailyFoodOrderCancel_EM::OnExportOrderDeliveryRation(){
	return 0;
}
int CHMSDailyFoodOrderCancel_EM::OnOrderListPrintDeliveryRation()
{	
	return 0;
}

void CHMSDailyFoodOrderCancel_EM::OnAddRationSelect(){
	OnRationListAddEntry();
}

void CHMSDailyFoodOrderCancel_EM::OnPrintDeliveryRationsSelect(){
...
void CHMSDailyFoodOrderCancel_EM::Refresh(long nTransactionID, long nDocumentNo){
...
long CHMSDailyFoodOrderCancel_EM::GetTransactionID(int nStorageID)
{
...
int CHMSDailyFoodOrderCancel_EM::OnChangeRation(){	
