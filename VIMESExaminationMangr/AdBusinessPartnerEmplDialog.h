#ifndef AdBusinessPartnerEmplDialog_H
#define AdBusinessPartnerEmplDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CAdBusinessPartnerEmplDialog : public CGuiDialog{
protected:
public:
	
	CString			m_szPartnerId;
	CString			m_szPID;
	long			m_nPartnerEmplId;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CAdBusinessPartnerEmplDialog(CWnd *pParent, int nMode, CString szPartnerId);
	~CAdBusinessPartnerEmplDialog();
	...
	int OnAddAdBusinessPartnerEmplDialog(); 
	int OnEditAdBusinessPartnerEmplDialog(); 
	int OnDeleteAdBusinessPartnerEmplDialog(); 
	int OnSaveAdBusinessPartnerEmplDialog(); 
	int OnCancelAdBusinessPartnerEmplDialog(); 
	int OnAdBusinessPartnerEmplDialogListLoadData(); 
};
#endif
