#ifndef HMSDailyFoodOrderCancelEM_H
#define HMSDailyFoodOrderCancelEM_H
...
class CHMSDailyFoodOrderCancel_EM : public CGuiView
{
...
public:
	...
	int				OnChangeRation();
	//CHMSDailyFoodOrderCancel_EM(CWnd *pParent);
	CHMSDailyFoodOrderCancel_EM();
	~CHMSDailyFoodOrderCancel_EM();
	...
	int OnAddHMSDailyFoodOrderCancel(); 
	int OnEditHMSDailyFoodOrderCancel(); 
	int OnDeleteHMSDailyFoodOrderCancel(); 
	int OnSaveHMSDailyFoodOrderCancel(); 
	int OnCancelHMSDailyFoodOrderCancel(); 
	int OnHMSDailyFoodOrderCancelListLoadData(); 
