...
void CHMSDrugInformation::OnCreateComponents(){
	...
	m_wndPrescription.Create(this, _T(""), 0, 0, 0, 0);
...
//	m_wndToDate.SetCheckValue(true);
	...
	m_wndList.SetGridHeaderHeight(2);
	...
	m_wndList.InsertColumn(3, _T("Name /Cnt"), CFMT_TEXT, 250);
	m_wndList.InsertColumn(4, _T("Unit"), CFMT_TEXT, 50);
	m_wndList.InsertColumn(5, _T("SL"), CFMT_MONEY|CFMT_FIXSIZE, 70);
	m_wndList.InsertColumn(6, _T("SL cấp"), CFMT_MONEY|CFMT_FIXSIZE, 90);
