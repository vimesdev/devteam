#ifndef HMSEntertainTreatDialog_H
#define HMSEntertainTreatDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSEntertainTreatDialog : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CHMSEntertainTreatDialog(CWnd *pParent);
	~CHMSEntertainTreatDialog();
	...
	int OnAddHMSEntertainTreatDialog(); 
	int OnEditHMSEntertainTreatDialog(); 
	int OnDeleteHMSEntertainTreatDialog(); 
	int OnSaveHMSEntertainTreatDialog(); 
	int OnCancelHMSEntertainTreatDialog(); 
	int OnHMSEntertainTreatDialogListLoadData(); 
};
#endif
