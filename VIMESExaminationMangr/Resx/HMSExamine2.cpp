...
static void _OnHATDSelectFnc(CWnd *pWnd){
	 ((CHMSExamine2*)pWnd)->OnHATDSelect();
}
static int _OnAddHMSExamine2Fnc(CWnd *pWnd){
	 return ((CHMSExamine2*)pWnd)->OnAddHMSExamine2();
} 
static int _OnEditHMSExamine2Fnc(CWnd *pWnd){
	 return ((CHMSExamine2*)pWnd)->OnEditHMSExamine2();
} 
static int _OnDeleteHMSExamine2Fnc(CWnd *pWnd){
	 return ((CHMSExamine2*)pWnd)->OnDeleteHMSExamine2();
} 
static int _OnSaveHMSExamine2Fnc(CWnd *pWnd){
	 return ((CHMSExamine2*)pWnd)->OnSaveHMSExamine2();
} 
static int _OnCancelHMSExamine2Fnc(CWnd *pWnd){
	 return ((CHMSExamine2*)pWnd)->OnCancelHMSExamine2();
} 
CHMSExamine2::CHMSExamine2(){
...
void CHMSExamine2::OnCreateComponents(){
	...
	m_wndRelationDisease.Create(this,146, 430, 480, 455); 
...
void CHMSExamine2::OnInitializeComponents(){
...
void CHMSExamine2::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddHMSExamine2Fnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditHMSExamine2Fnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteHMSExamine2Fnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveHMSExamine2Fnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelHMSExamine2Fnc, 0, 'T', VK_CONTROL);
	SetMode(VM_NONE);

}
void CHMSExamine2::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSExamine2::UpdateJson(BOOL bSave){
	if(bSave)
	{
			
	m_jData[_T("Owner")] =  m_szOwner;
	m_jData[_T("Family")] =  m_szFamily;
	m_jData[_T("DrugAllergy")] =  m_szDrugAllergy;
	...
	m_jData[_T("PreDiagnostic")] =  m_szPreDiagnostic;
	m_jData[_T("RelationDisease")] =  m_szRelationDisease;
	m_jData[_T("ICDDiagnostic")] =  m_szICDDiagnosticKey;
	m_jData[_T("Conclusion")] =  m_szConclusion;
	m_jData[_T("HATD")] =  m_bHATD;
	}
	else
	{
			
	m_jData[_T("Owner")].GetValue(m_szOwner);
	m_jData[_T("Family")].GetValue(m_szFamily);
	m_jData[_T("DrugAllergy")].GetValue(m_szDrugAllergy);
	...
	m_jData[_T("PreDiagnostic")].GetValue(m_szPreDiagnostic);
	m_jData[_T("RelationDisease")].GetValue(m_szRelationDisease);
	m_jData[_T("ICDDiagnostic")].GetValue(m_szICDDiagnosticKey);
	m_jData[_T("Conclusion")].GetValue(m_szConclusion);
	m_jData[_T("HATD")].GetValue(m_bHATD);
	}

}
void CHMSExamine2::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSExamine2::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSExamine2::SetDefaultValues(){
...
int CHMSExamine2::SetMode(int nMode){
...
/*void CHMSExamine2::OnOwnerChange(){
	
} */
/*void CHMSExamine2::OnOwnerSetfocus(){
	
} */
/*void CHMSExamine2::OnOwnerKillfocus(){
	
} */
int CHMSExamine2::OnOwnerCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnFamilyChange(){
	
} */
/*void CHMSExamine2::OnFamilySetfocus(){
	
} */
/*void CHMSExamine2::OnFamilyKillfocus(){
	
} */
int CHMSExamine2::OnFamilyCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnDrugAllergyChange(){
	
} */
/*void CHMSExamine2::OnDrugAllergySetfocus(){
	
} */
/*void CHMSExamine2::OnDrugAllergyKillfocus(){
	
} */
int CHMSExamine2::OnDrugAllergyCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnDateChange(){
	
} */
/*void CHMSExamine2::OnDateSetfocus(){
	
} */
/*void CHMSExamine2::OnDateKillfocus(){
	
} */
int CHMSExamine2::OnDateCheckValue(){
	return 0;
} 
void CHMSExamine2::OnDoctorSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSExamine2::OnDoctorSelendok(){
	 
}
/*void CHMSExamine2::OnDoctorSetfocus(){
	
}*/
/*void CHMSExamine2::OnDoctorKillfocus(){
	
}*/
long CHMSExamine2::OnDoctorLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
...
/*void CHMSExamine2::OnDoctorAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSExamine2::OnPathologyProcessChange(){
	
} */
/*void CHMSExamine2::OnPathologyProcessSetfocus(){
	
} */
/*void CHMSExamine2::OnPathologyProcessKillfocus(){
	
} */
int CHMSExamine2::OnPathologyProcessCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnExamineChange(){
	
} */
/*void CHMSExamine2::OnExamineSetfocus(){
	
} */
/*void CHMSExamine2::OnExamineKillfocus(){
	
} */
int CHMSExamine2::OnExamineCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnPulseChange(){
	
} */
/*void CHMSExamine2::OnPulseSetfocus(){
	
} */
/*void CHMSExamine2::OnPulseKillfocus(){
	
} */
int CHMSExamine2::OnPulseCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnTemperatureChange(){
	
} */
/*void CHMSExamine2::OnTemperatureSetfocus(){
	
} */
/*void CHMSExamine2::OnTemperatureKillfocus(){
	
} */
int CHMSExamine2::OnTemperatureCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnBloodPressureChange(){
	
} */
/*void CHMSExamine2::OnBloodPressureSetfocus(){
	
} */
/*void CHMSExamine2::OnBloodPressureKillfocus(){
	
} */
int CHMSExamine2::OnBloodPressureCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnBloodPressurexChange(){
	
} */
/*void CHMSExamine2::OnBloodPressurexSetfocus(){
	
} */
/*void CHMSExamine2::OnBloodPressurexKillfocus(){
	
} */
int CHMSExamine2::OnBloodPressurexCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnBreathingIntervalChange(){
	
} */
/*void CHMSExamine2::OnBreathingIntervalSetfocus(){
	
} */
/*void CHMSExamine2::OnBreathingIntervalKillfocus(){
	
} */
int CHMSExamine2::OnBreathingIntervalCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnWeightChange(){
	
} */
/*void CHMSExamine2::OnWeightSetfocus(){
	
} */
/*void CHMSExamine2::OnWeightKillfocus(){
	
} */
int CHMSExamine2::OnWeightCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnHeightChange(){
	
} */
/*void CHMSExamine2::OnHeightSetfocus(){
	
} */
/*void CHMSExamine2::OnHeightKillfocus(){
	
} */
int CHMSExamine2::OnHeightCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnPreDiagnosticChange(){
	
} */
/*void CHMSExamine2::OnPreDiagnosticSetfocus(){
	
} */
/*void CHMSExamine2::OnPreDiagnosticKillfocus(){
	
} */
int CHMSExamine2::OnPreDiagnosticCheckValue(){
	return 0;
} 
/*void CHMSExamine2::OnRelationDiseaseChange(){
	
} */
/*void CHMSExamine2::OnRelationDiseaseSetfocus(){
	
} */
/*void CHMSExamine2::OnRelationDiseaseKillfocus(){
	
} */
int CHMSExamine2::OnRelationDiseaseCheckValue(){
	return 0;
} 
void CHMSExamine2::OnICDDiagnosticSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSExamine2::OnICDDiagnosticSelendok(){
	 
}
/*void CHMSExamine2::OnICDDiagnosticSetfocus(){
	
}*/
/*void CHMSExamine2::OnICDDiagnosticKillfocus(){
	
}*/
long CHMSExamine2::OnICDDiagnosticLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSExamine2::OnICDDiagnosticAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSExamine2::OnConclusionChange(){
	
} */
/*void CHMSExamine2::OnConclusionSetfocus(){
	
} */
/*void CHMSExamine2::OnConclusionKillfocus(){
	
} */
int CHMSExamine2::OnConclusionCheckValue(){
	return 0;
} 
void CHMSExamine2::OnPrehistorySelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSExamine2::OnReloadInfoSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSExamine2::OnUpdateSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSExamine2::OnTerminateSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSExamine2::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSExamine2::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
	void CHMSExamine2::OnHATDSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
int CHMSExamine2::OnAddHMSExamine2(){
...
int CHMSExamine2::OnEditHMSExamine2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSExamine2::OnDeleteHMSExamine2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CHMSExamine2::OnSaveHMSExamine2(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CHMSExamine2::OnCancelHMSExamine2(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSExamine2::OnHMSExamine2ListLoadData(){
	return 0;
}
