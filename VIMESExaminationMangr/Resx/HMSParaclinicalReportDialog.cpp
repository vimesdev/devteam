#include "HMSParaclinicalReportDialog.h"
#include "../MainFrm.h"
#include "ReportDocument.h"

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSParaclinicalReportDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSParaclinicalReportDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnRoomSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSParaclinicalReportDialog* )pWnd)->OnRoomSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnRoomSelendokFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnRoomSelendok();
}
/*static void _OnRoomSetfocusFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnRoomKillfocus();
}*/
/*static void _OnRoomKillfocusFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnRoomKillfocus();
}*/
static long _OnRoomLoadDataFnc(CWnd *pWnd){
	return ((CHMSParaclinicalReportDialog *)pWnd)->OnRoomLoadData();
}
/*static void _OnRoomAddNewFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog *)pWnd)->OnRoomAddNew();
}*/
static void _OnInputResultsSelectFnc(CWnd *pWnd){
	 ((CHMSParaclinicalReportDialog*)pWnd)->OnInputResultsSelect();
}
static void _OnFeeAcceptedSelectFnc(CWnd *pWnd){
	 ((CHMSParaclinicalReportDialog*)pWnd)->OnFeeAcceptedSelect();
}
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSParaclinicalReportDialog*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSParaclinicalReportDialog*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSParaclinicalReportDialog*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSParaclinicalReportDialog*)pWnd)->OnListDeleteItem();
} 
static void _OnRunSelectFnc(CWnd *pWnd){
	CHMSParaclinicalReportDialog *pVw = (CHMSParaclinicalReportDialog *)pWnd;
	pVw->OnRunSelect();
} 
...
static int _OnAddHMSParaclinicalReportDialogFnc(CWnd *pWnd){
	 return ((CHMSParaclinicalReportDialog*)pWnd)->OnAddHMSParaclinicalReportDialog();
} 
static int _OnEditHMSParaclinicalReportDialogFnc(CWnd *pWnd){
	 return ((CHMSParaclinicalReportDialog*)pWnd)->OnEditHMSParaclinicalReportDialog();
} 
static int _OnDeleteHMSParaclinicalReportDialogFnc(CWnd *pWnd){
	 return ((CHMSParaclinicalReportDialog*)pWnd)->OnDeleteHMSParaclinicalReportDialog();
} 
static int _OnSaveHMSParaclinicalReportDialogFnc(CWnd *pWnd){
	 return ((CHMSParaclinicalReportDialog*)pWnd)->OnSaveHMSParaclinicalReportDialog();
} 
static int _OnCancelHMSParaclinicalReportDialogFnc(CWnd *pWnd){
	 return ((CHMSParaclinicalReportDialog*)pWnd)->OnCancelHMSParaclinicalReportDialog();
} 
CHMSParaclinicalReportDialog::CHMSParaclinicalReportDialog(CWnd *pParent):
	CGuiDialog(pParent){
...
CHMSParaclinicalReportDialog::~CHMSParaclinicalReportDialog(){
}
void CHMSParaclinicalReportDialog::OnCreateComponents(){
...
void CHMSParaclinicalReportDialog::OnInitializeComponents(){
...
void CHMSParaclinicalReportDialog::OnSetWindowEvents(){
...
void CHMSParaclinicalReportDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSParaclinicalReportDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSParaclinicalReportDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CHMSParaclinicalReportDialog::SetDefaultValues(){
...
int CHMSParaclinicalReportDialog::SetMode(int nMode){
...
/*void CHMSParaclinicalReportDialog::OnFromDateChange(){
	
} */
/*void CHMSParaclinicalReportDialog::OnFromDateSetfocus(){
	
} */
/*void CHMSParaclinicalReportDialog::OnFromDateKillfocus(){
	
} */
int CHMSParaclinicalReportDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void CHMSParaclinicalReportDialog::OnToDateChange(){
	
} */
/*void CHMSParaclinicalReportDialog::OnToDateSetfocus(){
	
} */
/*void CHMSParaclinicalReportDialog::OnToDateKillfocus(){
	
} */
int CHMSParaclinicalReportDialog::OnToDateCheckValue(){
	return 0;
} 
void CHMSParaclinicalReportDialog::OnRoomSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSParaclinicalReportDialog::OnRoomSelendok(){
	 
}
/*void CHMSParaclinicalReportDialog::OnRoomSetfocus(){
	
}*/
/*void CHMSParaclinicalReportDialog::OnRoomKillfocus(){
	
}*/
long CHMSParaclinicalReportDialog::OnRoomLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSParaclinicalReportDialog::OnRoomAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
	void CHMSParaclinicalReportDialog::OnInputResultsSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
	void CHMSParaclinicalReportDialog::OnFeeAcceptedSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
void CHMSParaclinicalReportDialog::OnListDblClick(){
	
} 
void CHMSParaclinicalReportDialog::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CHMSParaclinicalReportDialog::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSParaclinicalReportDialog::OnListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	if(!m_bFeeAccepted && !m_bInputResults){
		szWhere.Format(_T(" and (pcmso_payment='Y' or pcmso_status='T') "));
	}
	//1: Nhom can lam sang
	szSQL.Format(_T("SELECT * FROM hms_feegroup WHERE substr(hfg_id, 1, 2) IN('B1','B2','B3') AND hfg_active='Y' ORDER BY hfg_id "));
	...
	while(!rs.IsEOF()){
		...
		if(ch == _T('0'))
		{
			nItem = m_wndList.AddItems(szCode, szName, NULL);
...
void CHMSParaclinicalReportDialog::OnRunSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSParaclinicalReportDialog::OnPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
} 
void CHMSParaclinicalReportDialog::OnExportXLSSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSParaclinicalReportDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();	
} 
int CHMSParaclinicalReportDialog::OnAddHMSParaclinicalReportDialog(){
...
int CHMSParaclinicalReportDialog::OnEditHMSParaclinicalReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHMSParaclinicalReportDialog::OnDeleteHMSParaclinicalReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelHMSParaclinicalReportDialog(); 
 	}
	return 0;
}
int CHMSParaclinicalReportDialog::OnSaveHMSParaclinicalReportDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnHMSParaclinicalReportDialogListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CHMSParaclinicalReportDialog::OnCancelHMSParaclinicalReportDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSParaclinicalReportDialog::OnHMSParaclinicalReportDialogListLoadData(){
	return 0;
}
