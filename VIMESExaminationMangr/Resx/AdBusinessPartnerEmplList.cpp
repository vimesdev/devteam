...
void CAdBusinessPartnerEmplList::OnInitializeComponents(){
	...
	m_wndList.InsertColumn(0, _T("Indnex"), CFMT_NUMBER, 40);
	m_wndList.InsertColumn(1, _T("Name"), CFMT_TEXT, 200);
	m_wndList.InsertColumn(2, _T("Birth Date"), CFMT_DATE, 100);
	m_wndList.InsertColumn(3, _T("Gender"), CFMT_TEXT, 40);
	m_wndList.InsertColumn(4, _T("Address"), CFMT_TEXT, 200);
