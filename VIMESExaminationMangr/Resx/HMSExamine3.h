#ifndef HMSEXAMINE3_H
#define HMSEXAMINE3_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSExamine3 : public CGuiView{
protected:
public:
	CGuiLabel		m_wndPatientLabel;
	CGuiNumberCtrl	m_wndPatient;
	...
	//void			OnPatientSetfocus(); 
	//void			OnPatientKillfocus(); 
	int			OnPatientCheckValue(); 
	...
	int OnAddHMSExamine3(); 
	int OnEditHMSExamine3(); 
	int OnDeleteHMSExamine3(); 
	int OnSaveHMSExamine3(); 
	int OnCancelHMSExamine3(); 
	int OnHMSExamine3ListLoadData(); 
};
#endif
