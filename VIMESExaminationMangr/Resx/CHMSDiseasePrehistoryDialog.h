#ifndef CHMSDISEASEPREHISTORYDIALOG_H
#define CHMSDISEASEPREHISTORYDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCHMSDiseasePrehistoryDialog : public CGuiDialog{
protected:
public:
	...
	void			OnUpdateSelect(); 
	void			OnCancelSelect(); 
	CCHMSDiseasePrehistoryDialog(CWnd *pParent);
	~CCHMSDiseasePrehistoryDialog();
	...
	int OnAddCHMSDiseasePrehistoryDialog(); 
	int OnEditCHMSDiseasePrehistoryDialog(); 
	int OnDeleteCHMSDiseasePrehistoryDialog(); 
	int OnSaveCHMSDiseasePrehistoryDialog(); 
	int OnCancelCHMSDiseasePrehistoryDialog(); 
	int OnCHMSDiseasePrehistoryDialogListLoadData(); 
};
#endif
