#ifndef HMSCONCLUSIONDIALOG_H
#define HMSCONCLUSIONDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSConclusionDialog : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CHMSConclusionDialog(CWnd *pParent);
	~CHMSConclusionDialog();
	...
	int OnAddHMSConclusionDialog(); 
	int OnEditHMSConclusionDialog(); 
	int OnDeleteHMSConclusionDialog(); 
	int OnSaveHMSConclusionDialog(); 
	int OnCancelHMSConclusionDialog(); 
	int OnHMSConclusionDialogListLoadData(); 
};
#endif
