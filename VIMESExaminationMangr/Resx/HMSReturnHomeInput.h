#ifndef HMSRETURNHOMEINPUT_H
#define HMSRETURNHOMEINPUT_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSReturnHomeInput : public CGuiView{
protected:
public:
	...
	int OnAddHMSReturnHomeInput(); 
	int OnEditHMSReturnHomeInput(); 
	int OnDeleteHMSReturnHomeInput(); 
	int OnSaveHMSReturnHomeInput(); 
	int OnCancelHMSReturnHomeInput(); 
	int OnHMSReturnHomeInputListLoadData(); 
};
#endif
