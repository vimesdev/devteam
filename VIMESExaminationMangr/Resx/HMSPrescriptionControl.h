#ifndef HMSPRESCRIPTIONCONTROL_H
#define HMSPRESCRIPTIONCONTROL_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSPrescriptionControl : public CGuiDialog{
protected:
public:
	...
	void			OnLockTabSelectChange(int nOld, int nNew); 
	CHMSPrescriptionControl(CWnd *pParent);
	~CHMSPrescriptionControl();
	...
	int OnAddHMSPrescriptionControl(); 
	int OnEditHMSPrescriptionControl(); 
	int OnDeleteHMSPrescriptionControl(); 
	int OnSaveHMSPrescriptionControl(); 
	int OnCancelHMSPrescriptionControl(); 
	int OnHMSPrescriptionControlListLoadData(); 
};
#endif
