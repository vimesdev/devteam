...
void CHMSParaclinicalOrder::OnCreateComponents(){
	m_wndParaclinicalInformation.Create(this, _T("Paraclinical Information"), 5, 5, 595, 525);
	...
	m_wndConclusion.Create(this,95, 390, 590, 440); 
	m_wndConclusionLabel.Create(this, _T("Conclusion"), 10, 390, 90, 415);
	m_wndResultLabel.Create(this, _T("Result"), 10, 445, 90, 470);
	m_wndResult.Create(this,95, 445, 590, 520); 
	m_wndAdd.Create(this, _T("&Add"), 175, 530, 255, 555);
	m_wndEdit.Create(this, _T("&Edit"), 260, 530, 340, 555);
	m_wndDelete.Create(this, _T("&Delete"), 345, 530, 425, 555);
	m_wndConfirm.Create(this, _T("&Confirm"), 430, 530, 510, 555);
...
void CHMSParaclinicalOrder::OnInitializeComponents(){
	...
	m_wndOrderList.InsertColumn(0, _T("Sheet No"), CFMT_NUMBER, 70);
	m_wndOrderList.InsertColumn(1, _T("Name"), CFMT_TEXT, 180);
	m_wndOrderList.InsertColumn(2, _T("Status"), CFMT_TEXT, 70);


	m_wndTestList.InsertColumn(0, _T("ID"), CFMT_NUMBER, 70);
