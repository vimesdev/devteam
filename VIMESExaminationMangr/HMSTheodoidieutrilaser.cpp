...
void CHMSThietLap_Thongtin_Vaccine::OnCreateComponents()
{
	...
	m_wndItemInformation.Create(this, _T("Drug Information"), 5, 5, 759, 446);
...
long CHMSThietLap_Thongtin_Vaccine::OnListLoadData()
{
	...
	szSQL.Format(_T("SELECT VC_CODE AS ID, VC_NAME AS Name, VC_LOT as Lot, to_char(VC_EXPIRE_DATE, 'DD/MM/YYYY') as ExpireDate,  VC_COUNTRY as Country,VC_ISACTIVE as Active ")\
