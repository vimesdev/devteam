#ifndef HMSSURGERYSTOCKINFORMATIONDIALOG_H
#define HMSSURGERYSTOCKINFORMATIONDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSSurgeryStockInformationDialog : public CGuiDialog{
protected:
public:
	...
	CHMSSurgeryStockInformationDialog(CWnd *pParent);
	~CHMSSurgeryStockInformationDialog();
	...
	int OnAddHMSSurgeryStockInformationDialog(); 
	int OnEditHMSSurgeryStockInformationDialog(); 
	int OnDeleteHMSSurgeryStockInformationDialog(); 
	int OnSaveHMSSurgeryStockInformationDialog(); 
	int OnCancelHMSSurgeryStockInformationDialog(); 
	int OnHMSSurgeryStockInformationDialogListLoadData(); 
};
#endif
