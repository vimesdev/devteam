#ifndef rptBaocaoquyettoanthuocDialog_H
#define rptBaocaoquyettoanthuocDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CrptBaocaoquyettoanthuocDialog : public CGuiDialog{
protected:
public:
	CGuiGroupBox	m_wndReportCondition;
	CGuiGroupBox	m_wndTypeInfo;
	...
	void		OnPrintBaocaoquyettoansudungthuoctheodoituong(bool bPreview);
	void		OnExportBaocaoquyettoansudungthuoctheodoituong();
	...
	CrptBaocaoquyettoanthuocDialog(CWnd *pParent);
	~CrptBaocaoquyettoanthuocDialog();
	...
	int OnAddrptBaocaoquyettoanthuocDialog(); 
	int OnEditrptBaocaoquyettoanthuocDialog(); 
	int OnDeleterptBaocaoquyettoanthuocDialog(); 
	int OnSaverptBaocaoquyettoanthuocDialog(); 
	int OnCancelrptBaocaoquyettoanthuocDialog(); 
	int OnrptBaocaoquyettoanthuocDialogListLoadData(); 
};
#endif
