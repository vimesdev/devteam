...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CrptGeneralDepartmentUsage *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CrptGeneralDepartmentUsage *)pWnd)->OnToDateCheckValue();
} 
static void _OnStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CrptGeneralDepartmentUsage* )pWnd)->OnStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStorageSelendokFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnStorageSelendok();
}
/*static void _OnStorageSetfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnStorageKillfocus();
}*/
/*static void _OnStorageKillfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnStorageKillfocus();
}*/
static long _OnStorageLoadDataFnc(CWnd *pWnd){
	return ((CrptGeneralDepartmentUsage *)pWnd)->OnStorageLoadData();
}
/*static void _OnStorageAddNewFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnStorageAddNew();
}*/
static int _OnStockSetCheckFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage*) pWnd)->OnStockSetCheck();
	return 0;
}
static int _OnDeptSetCheckFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage*) pWnd)->OnDeptSetCheck();
	return 0;
}
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	return ((CrptGeneralDepartmentUsage*)pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
}
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CrptGeneralDepartmentUsage *)pWnd)->OnDepartmentLoadData();
}
static long _OnClerkLoadDataFnc(CWnd *pWnd){
	return ((CrptGeneralDepartmentUsage *)pWnd)->OnClerkLoadData();
}
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CrptGeneralDepartmentUsage *)pWnd)->OnTypeLoadData();
}
static void _OnItemGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CrptGeneralDepartmentUsage* )pWnd)->OnItemGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemGroupSelendokFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnItemGroupSelendok();
}
/*static void _OnItemGroupSetfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnItemGroupKillfocus();
}*/
/*static void _OnItemGroupKillfocusFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnItemGroupKillfocus();
}*/
static long _OnItemGroupLoadDataFnc(CWnd *pWnd){
	return ((CrptGeneralDepartmentUsage *)pWnd)->OnItemGroupLoadData();
}
/*static void _OnItemGroupAddNewFnc(CWnd *pWnd){
	((CrptGeneralDepartmentUsage *)pWnd)->OnItemGroupAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CrptGeneralDepartmentUsage *pVw = (CrptGeneralDepartmentUsage *)pWnd;
...
CrptGeneralDepartmentUsage::CrptGeneralDepartmentUsage(CWnd* pParent):
CGuiDialog(pParent)
{
...
CrptGeneralDepartmentUsage::~CrptGeneralDepartmentUsage(){
}
void CrptGeneralDepartmentUsage::OnCreateComponents(){
...
void CrptGeneralDepartmentUsage::OnInitializeComponents(){
...
void CrptGeneralDepartmentUsage::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CrptGeneralDepartmentUsage::OnDoDataExchange(CDataExchange* pDX){
...
void CrptGeneralDepartmentUsage::SetDefaultValues(){
...
int CrptGeneralDepartmentUsage::SetMode(int nMode){
...
/*void CrptGeneralDepartmentUsage::OnFromDateChange(){
	
} */
/*void CrptGeneralDepartmentUsage::OnFromDateSetfocus(){
	
} */
/*void CrptGeneralDepartmentUsage::OnFromDateKillfocus(){
	
} */
int CrptGeneralDepartmentUsage::OnFromDateCheckValue(){
	return 0;
} 
/*void CrptGeneralDepartmentUsage::OnToDateChange(){
	
} */
/*void CrptGeneralDepartmentUsage::OnToDateSetfocus(){
	
} */
/*void CrptGeneralDepartmentUsage::OnToDateKillfocus(){
	
} */
int CrptGeneralDepartmentUsage::OnToDateCheckValue(){
	return 0;
} 
void CrptGeneralDepartmentUsage::OnStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptGeneralDepartmentUsage::OnStorageSelendok(){
	 
}
/*void CrptGeneralDepartmentUsage::OnStorageSetfocus(){
	
}*/
/*void CrptGeneralDepartmentUsage::OnStorageKillfocus(){
	
}*/
long CrptGeneralDepartmentUsage::OnStorageLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CrptGeneralDepartmentUsage::OnStorageAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptGeneralDepartmentUsage::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	
}
long CrptGeneralDepartmentUsage::OnDepartmentLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	...
	int nCount = 0;
	szSQL.Format(_T(" select sd_id as id, sd_name as name from sys_dept where sd_id in('B5','PTTYC') order by  sd_name"));
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF()){ 
...
long CrptGeneralDepartmentUsage::OnClerkLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
long CrptGeneralDepartmentUsage::OnTypeLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	int nCount = 0;
...
void CrptGeneralDepartmentUsage::OnItemGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

} 
void CrptGeneralDepartmentUsage::OnItemGroupSelendok(){
	 
}
/*void CrptGeneralDepartmentUsage::OnItemGroupSetfocus(){
	
}*/
/*void CrptGeneralDepartmentUsage::OnItemGroupKillfocus(){
	
}*/
long CrptGeneralDepartmentUsage::OnItemGroupLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
// 	CString szFilter;
...
// 	return pMF->LoadProductCategoryList(&m_wndItemGroup, m_szItemGroupKey, szFilter);
	...
	int nCount = 0;
	szSQL.Format(_T("SELECT mpc_code as id, mpc_name as name FROM m_product_category  WHERE 1=1 AND mpc_level = 1 %s ORDER BY id "), szWhere);
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF()){ 
...
/*void CrptGeneralDepartmentUsage::OnItemGroupAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptGeneralDepartmentUsage::OnPrintPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
...
void CrptGeneralDepartmentUsage::OnExportSelect(){
...
CString CrptGeneralDepartmentUsage::GetQueryString(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	szReturnSQL.Format(_T(" SELECT    16 AS transaction_type, ") \
				...
				_T("           unit_price, ") \
				_T("           product_uomname, ") \
				_T("           SUM(CASE WHEN object_id = 1 THEN line_qty ") \
				_T("               ELSE 0 ") \
				_T("               END) sol_qty, ") \
				_T("           SUM(CASE WHEN object_id = 3 THEN line_qty ") \
				_T("               ELSE 0 ") \
				_T("               END) pol_qty, ") \
				_T("           SUM(CASE WHEN object_id = 2 THEN line_qty ") \
				_T("               ELSE 0 ") \
				_T("               END) solins_qty, ") \
				_T("           SUM(CASE WHEN object_id = 4 THEN line_qty ") \
				_T("               ELSE 0 ") \
				_T("               END) othins_qty, ") \
				_T("           SUM(CASE WHEN object_id = 7 THEN line_qty ") \
				_T("               ELSE 0 ") \
				_T("               END) ser_qty, ") \
				_T("           SUM(CASE WHEN object_id IN ( 5, 6, 8, 9, ") \
				_T("                                   10, 11, 12 ) THEN line_qty ") \
				_T("               ELSE 0 ") \
				_T("               END) other_qty, ") \
				_T("           SUM(line_qty) total_qty, ") \
				_T("           SUM(CASE WHEN object_id = 1 THEN line_qty * unit_price ") \
				_T("               ELSE 0 ") \
				_T("               END) sol, ") \
				_T("           SUM(CASE WHEN object_id = 3 THEN line_qty * unit_price ") \
				_T("               ELSE 0 ") \
				_T("               END) pol, ") \
				_T("           SUM(CASE WHEN object_id = 2 THEN line_qty * unit_price ") \
				_T("               ELSE 0 ") \
				_T("               END) solins, ") \
				_T("           SUM(CASE WHEN object_id = 4 THEN line_qty * unit_price ") \
				_T("               ELSE 0 ") \
				_T("               END) othins, ") \
				_T("           SUM(CASE WHEN object_id = 7 THEN line_qty * unit_price ") \
				_T("               ELSE 0 ") \
				_T("               END) ser, ") \
				_T("           SUM(CASE WHEN object_id IN ( 5, 6, 8, 9, ") \
				_T("                                   10, 11, 12 ) THEN line_qty * unit_price ") \
				_T("               ELSE 0 ") \
				_T("               END) other, ") \
				_T("           SUM(line_qty * unit_price) total ") \
				...
				_T("            WHERE     hpol_qtyreverse > 0 AND mt_status = 'A') tbl_return ") \
				_T(" LEFT JOIN m_productitem_view3 ON ( sitem_id = product_item_id ) ") \
				_T(" WHERE     dept_id IS NOT NULL %s") \
...
BEGIN_MESSAGE_MAP(CrptGeneralDepartmentUsage, CGuiDialog)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CrptGeneralDepartmentUsage::OnSetFocus(CWnd* pOldWnd)
{
...
void CrptGeneralDepartmentUsage::OnStockSetCheck(){
	m_bStockCheck = !m_bStockCheck;
	for (int i = 0; i < m_wndStorageList.GetItemCount();i++)
		m_wndStorageList.SetCheck(i, m_bStockCheck);
}

void CrptGeneralDepartmentUsage::OnDeptSetCheck(){
