#ifndef HMSPATIENTSURGERYREPORTLISTDIALOGV2_H
#define HMSPATIENTSURGERYREPORTLISTDIALOGV2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSPatientSurgeryReportListDialog_V2 : public CGuiDialog
{
...
public:
	...
	void			OnThuThuatSelect();
	void			OnTYCSelect();

	CHMSPatientSurgeryReportListDialog_V2(CWnd *pParent);
	~CHMSPatientSurgeryReportListDialog_V2();
	...
	int OnDepartmentListCheckAll();
	int OnDepartmentListUnCheckAll();
