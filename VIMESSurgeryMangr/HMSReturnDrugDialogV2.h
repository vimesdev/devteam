#ifndef HMSRETURNDRUGV2DIALOG_H
#define HMSRETURNDRUGDV2IALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSReturnDrugDialogV2 : public CGuiDialog
{
protected:
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CHMSReturnDrugDialogV2(CWnd *pParent);
	~CHMSReturnDrugDialogV2();
