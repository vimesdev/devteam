...
static int _OnCheckAllFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnCheckAll();
} 
static int _OnUnCheckAllFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnUnCheckAll();
} 

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CrptBaocaoquyettoanthuocDialog* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CrptBaocaoquyettoanthuocDialog* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnTypeAddNew();
}*/
static void _OnObjectSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CrptBaocaoquyettoanthuocDialog* )pWnd)->OnObjectSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnObjectSelendokFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnObjectSelendok();
}
/*static void _OnObjectSetfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnObjectKillfocus();
}*/
/*static void _OnObjectKillfocusFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnObjectKillfocus();
}*/
static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnObjectLoadData();
}
/*static void _OnObjectAddNewFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog *)pWnd)->OnObjectAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CrptBaocaoquyettoanthuocDialog *pVw = (CrptBaocaoquyettoanthuocDialog *)pWnd;
...
static long _OnListFacLoadDataFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnListFacLoadData();
} 
static void _OnListFacDblClickFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnListFacDblClick();
} 
static void _OnListFacSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnListFacSelectChange(nOldItem, nNewItem);
} 
static int _OnListFacDeleteItemFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnListFacDeleteItem();
} 
static int _OnAddrptBaocaoquyettoanthuocDialogFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnAddrptBaocaoquyettoanthuocDialog();
} 
static int _OnEditrptBaocaoquyettoanthuocDialogFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnEditrptBaocaoquyettoanthuocDialog();
} 
static int _OnDeleterptBaocaoquyettoanthuocDialogFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnDeleterptBaocaoquyettoanthuocDialog();
} 
static int _OnSaverptBaocaoquyettoanthuocDialogFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnSaverptBaocaoquyettoanthuocDialog();
} 
static int _OnCancelrptBaocaoquyettoanthuocDialogFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnCancelrptBaocaoquyettoanthuocDialog();
}

static long _OnTypeListLoadDataFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnTypeListLoadData();
} 
static void _OnTypeListDblClickFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnTypeListDblClick();
} 
static void _OnTypeListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnTypeListSelectChange(nOldItem, nNewItem);
} 
static int _OnTypeListDeleteItemFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnTypeListDeleteItem();
}

static long _OnObjectListLoadDataFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnObjectListLoadData();
} 
static void _OnObjectListDblClickFnc(CWnd *pWnd){
	((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnObjectListDblClick();
} 
static void _OnObjectListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnObjectListSelectChange(nOldItem, nNewItem);
} 
static int _OnObjectListDeleteItemFnc(CWnd *pWnd){
	 return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnObjectListDeleteItem();
}

static int _OnObjectCheckAllFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnObjectCheckAll();
}

static int _OnObjectUnCheckAllFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnObjectUnCheckAll();
}

static int _OnTypeCheckAllFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnTypeCheckAll();
}

static int _OnTypeUnCheckAllFnc(CWnd *pWnd){
	return ((CrptBaocaoquyettoanthuocDialog*)pWnd)->OnTypeUnCheckAll();
}

CrptBaocaoquyettoanthuocDialog::CrptBaocaoquyettoanthuocDialog(CWnd *pParent):
	CGuiDialog(pParent)
{
	m_nDlgWidth = 460;
	m_nDlgHeight = 600;
...
CrptBaocaoquyettoanthuocDialog::~CrptBaocaoquyettoanthuocDialog()
{
}

void CrptBaocaoquyettoanthuocDialog::OnCreateComponents()
{
	/*m_wndTitle.Create(this, _T("\x42\xE1o \x63\xE1o quy\x1EBFt to\xE1n s\x1EED \x64\x1EE5ng thu\x1ED1\x63"), 5, 5, 450, 55);
...
void CrptBaocaoquyettoanthuocDialog::OnInitializeComponents()
{
...
void CrptBaocaoquyettoanthuocDialog::OnSetWindowEvents()
{
...
void CrptBaocaoquyettoanthuocDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CrptBaocaoquyettoanthuocDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CrptBaocaoquyettoanthuocDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CrptBaocaoquyettoanthuocDialog::SetDefaultValues(){
...
int CrptBaocaoquyettoanthuocDialog::SetMode(int nMode){
...
/*void CrptBaocaoquyettoanthuocDialog::OnFromDateChange(){
	
} */
/*void CrptBaocaoquyettoanthuocDialog::OnFromDateSetfocus(){
	
} */
/*void CrptBaocaoquyettoanthuocDialog::OnFromDateKillfocus(){
	
} */
int CrptBaocaoquyettoanthuocDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void CrptBaocaoquyettoanthuocDialog::OnToDateChange(){
	
} */
/*void CrptBaocaoquyettoanthuocDialog::OnToDateSetfocus(){
	
} */
/*void CrptBaocaoquyettoanthuocDialog::OnToDateKillfocus(){
	
} */
int CrptBaocaoquyettoanthuocDialog::OnToDateCheckValue(){
	return 0;
} 
void CrptBaocaoquyettoanthuocDialog::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptBaocaoquyettoanthuocDialog::OnStockSelendok(){
	 
}
/*void CrptBaocaoquyettoanthuocDialog::OnStockSetfocus(){
	
}*/
/*void CrptBaocaoquyettoanthuocDialog::OnStockKillfocus(){
	
}*/
long CrptBaocaoquyettoanthuocDialog::OnStockLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CrptBaocaoquyettoanthuocDialog::OnStockAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptBaocaoquyettoanthuocDialog::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptBaocaoquyettoanthuocDialog::OnTypeSelendok(){
	 
}
/*void CrptBaocaoquyettoanthuocDialog::OnTypeSetfocus(){
	
}*/
/*void CrptBaocaoquyettoanthuocDialog::OnTypeKillfocus(){
	
}*/
long CrptBaocaoquyettoanthuocDialog::OnTypeLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	int nCount = 0;
	//szSQL.Format(_T("SELECT hfg_id as id, hfg_name as name FROM hms_fee_group WHERE substr(hfg_id,1, 1)='A' and hfg_id not in('A3000','A9000') %s ORDER BY hfg_id "), szWhere);
	...
	szSQL.Format(_T(" select distinct mpt_product_type_id as id,") \
				...
				_T("       and mpt_product_type_id not in(%s)") \
...
/*void CrptBaocaoquyettoanthuocDialog::OnTypeAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptBaocaoquyettoanthuocDialog::OnObjectSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptBaocaoquyettoanthuocDialog::OnObjectSelendok(){
	 
}
/*void CrptBaocaoquyettoanthuocDialog::OnObjectSetfocus(){
	
}*/
/*void CrptBaocaoquyettoanthuocDialog::OnObjectKillfocus(){
	
}*/
long CrptBaocaoquyettoanthuocDialog::OnObjectLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CrptBaocaoquyettoanthuocDialog::OnObjectAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptBaocaoquyettoanthuocDialog::OnPrintPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnPrintBaocaoquyettoansudungthuoctheodoituong(true);
} 
void CrptBaocaoquyettoanthuocDialog::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnExportBaocaoquyettoansudungthuoctheodoituong();
} 
void CrptBaocaoquyettoanthuocDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
}

void CrptBaocaoquyettoanthuocDialog::OnTypeListDblClick(){
	
} 
void CrptBaocaoquyettoanthuocDialog::OnTypeListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CrptBaocaoquyettoanthuocDialog::OnTypeListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CrptBaocaoquyettoanthuocDialog::OnTypeListLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CrptBaocaoquyettoanthuocDialog::OnObjectListDblClick(){
	
} 
void CrptBaocaoquyettoanthuocDialog::OnObjectListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CrptBaocaoquyettoanthuocDialog::OnObjectListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CrptBaocaoquyettoanthuocDialog::OnObjectListLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CrptBaocaoquyettoanthuocDialog::OnListFacDblClick(){
	
} 
void CrptBaocaoquyettoanthuocDialog::OnListFacSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CrptBaocaoquyettoanthuocDialog::OnListFacDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
int CrptBaocaoquyettoanthuocDialog::OnCheckAll()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CrptBaocaoquyettoanthuocDialog::OnUnCheckAll()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	for (int i = 0; i< m_wndListFac.GetItemCount(); i++)
	{
...
int CrptBaocaoquyettoanthuocDialog::OnObjectCheckAll()
{
...
int CrptBaocaoquyettoanthuocDialog::OnObjectUnCheckAll()
{
	for (int i = 0; i < m_wndObjectList.GetItemCount(); i++)
	{
		if (m_wndObjectList.GetCheck(i))
...
int CrptBaocaoquyettoanthuocDialog::OnTypeCheckAll()
{
...
int CrptBaocaoquyettoanthuocDialog::OnTypeUnCheckAll()
{
	for (int i = 0; i < m_wndTypeList.GetItemCount(); i++)
	{
		if (m_wndTypeList.GetCheck(i))
...
long CrptBaocaoquyettoanthuocDialog::OnListFacLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CrptBaocaoquyettoanthuocDialog::OnAddrptBaocaoquyettoanthuocDialog(){
...
int CrptBaocaoquyettoanthuocDialog::OnEditrptBaocaoquyettoanthuocDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CrptBaocaoquyettoanthuocDialog::OnDeleterptBaocaoquyettoanthuocDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelrptBaocaoquyettoanthuocDialog(); 
 	}
	return 0;
}
int CrptBaocaoquyettoanthuocDialog::OnSaverptBaocaoquyettoanthuocDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnrptBaocaoquyettoanthuocDialogListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CrptBaocaoquyettoanthuocDialog::OnCancelrptBaocaoquyettoanthuocDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CrptBaocaoquyettoanthuocDialog::OnrptBaocaoquyettoanthuocDialogListLoadData(){
	return 0;
}
void CrptBaocaoquyettoanthuocDialog::OnPrintBaocaoquyettoansudungthuoctheodoituong(bool bPreview)
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;
	CString tmpStr, szDate, szSysDate, szSQL, tmpStr2, m_szFacList, szWhere;
	CString szObject, szObjectName, szType, szTypeName, szTableName;
	...
	{
		/*CString MsgReport;
		MsgReport.Format(_T("Mau bao cao [%s] chua co. Lien he voi Adminstrator"),
			             _T("QUYETTOANSUDUNGTHUOC-VTYT.RPT"));
	...
	//Report Detail
		...
		/*szSQL.Format(_T(" SELECT pname ,Age ,docno, deptid, cardno, sum(amount) as amount ") \
			...
			_T(" WHERE ho_pdeptid='%s' and hpo_stockid IN(%s) and ho_performdate between to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss') and to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss') ") \
			_T(" and ho_status IN('A','I','D') and substr(product_typeid,1,2) not in('A3','A9','A4','A5','A7') %s") \
			...
			_T(" ORDER BY deptid"), pMF->m_szDepartment, szStocks, m_szFromDate, m_szToDate, szWhere);*/
	    ...
	    /*szSQL.Format(_T(" SELECT pname,") \
					...
					_T("        and ho_status in('A','I','D') and substr(mp_producttype,1,2) not in('A3','A9','A4','A5','A7') %s") \
					_T(" GROUP BY hp_surname, hp_midname, hp_firstname, hd_admitdate, hp_birthdate, ho_docno, ho_deptid, ho_cardno, mp_producttype") \
					_T(" ) tblMain") \
					_T(" GROUP BY pname ,Age ,docno, deptid, cardno") \
					_T(" ORDER BY deptid"),
					pMF->m_szDepartment, szStocks, m_szFromDate, m_szToDate, szWhere);*/
		 ...
		 szSQL.Format(_T(" SELECT pname,") \
					...
					_T("  WHERE ho_pdeptid='%s' and hpo_storage_id in(%s)") \
					_T("        and ho_performdate between to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss') AND to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss')") \
					_T("        and ho_status in('A','I','D','T') and mp_producttype not in(%s) %s") \
					...
					_T("           ho_deptid, hd_cardno, mp_producttype, hp_rank, hp_workplace") \
					_T(" ) tblMain") \
					_T(" GROUP BY pname, age, docno, deptid, cardno") \
					_T(" ORDER BY deptid"),
					pMF->m_szDepartment, szStocks, m_szFromDate, m_szToDate, m_szGroups, szWhere,
					pMF->m_szDepartment, szStocks, m_szFromDate, m_szToDate, m_szGroups, szWhere
					);
...
void CrptBaocaoquyettoanthuocDialog::OnExportBaocaoquyettoansudungthuoctheodoituong()
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;
	...
	if (!bCheckOperationTable && !szGroups.IsEmpty())
	{
	   ...
	   /*szSQL.Format(_T(" SELECT pname,") \
					...
					_T("        and ho_status in('A','I','D') and substr(mp_producttype,1,2) not in('A3','A9','A4','A5','A7') %s") \
					_T(" GROUP BY hp_surname, hp_midname, hp_firstname, hd_admitdate, hp_birthdate, ho_docno, ") \
					_T("          ho_deptid, ho_cardno, mp_producttype, hp_rank, hp_workplace, hcr_recordno") \
					_T(" ) tblMain") \
	   ...
	   szSQL.Format(_T(" SELECT pname,") \
					...
					_T("        and ho_status in('A','I','D','T') and mp_producttype not in(%s) %s") \
					_T("  GROUP BY hp_surname, hp_midname, hp_firstname, hd_admitdate, hp_birthdate, ho_docno,") \
					_T("           ho_deptid, hd_cardno, mp_producttype, hp_rank, hp_workplace, hcr_recordno") \
					_T("  UNION ALL") \
					_T("  SELECT (SELECT distinct sd_name FROM sys_dept WHERE sd_id=ho_deptid) as deptid,") \
					_T("          trim(hp_surname||' '||hp_midname||' '||hp_firstname) as pname,") \
					_T("          ho_docno as docno,") \
	...
	xls.SetCellText(0, 3, _T("\x42\xC1O \x43\xC1O QUY\x1EBET TO\xC1N S\x1EEC \x44\x1EE4NG THU\x1ED0\x43"),FMT_TEXT,true,14,0);
	...
	//UpdateData(false);
	EndWaitCursor();
	xls.Save(_T("Exports\\Baocaoquyettoansudungthuoc.xls"));
