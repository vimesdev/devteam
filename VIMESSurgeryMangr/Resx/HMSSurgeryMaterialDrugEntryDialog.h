#ifndef HMSSURGERYMATERIALDRUGENTRYDIALOG_H
#define HMSSURGERYMATERIALDRUGENTRYDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSSurgeryMaterialDrugEntryDialog : public CGuiDialog{
protected:
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSSurgeryMaterialDrugEntryDialog(CWnd *pParent);
	~CHMSSurgeryMaterialDrugEntryDialog();
	...
	int OnAddHMSSurgeryMaterialDrugEntryDialog(); 
	int OnEditHMSSurgeryMaterialDrugEntryDialog(); 
	int OnDeleteHMSSurgeryMaterialDrugEntryDialog(); 
	int OnSaveHMSSurgeryMaterialDrugEntryDialog(); 
	int OnCancelHMSSurgeryMaterialDrugEntryDialog(); 
	int OnHMSSurgeryMaterialDrugEntryDialogListLoadData(); 
};
#endif
