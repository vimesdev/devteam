#ifndef RPTGeneralDepartmentUsage_H
#define RPTGeneralDepartmentUsage_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CrptGeneralDepartmentUsage : public CGuiDialog{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportSelect(); 
	CrptGeneralDepartmentUsage(CWnd *pParent);
	~CrptGeneralDepartmentUsage();
