#ifndef RPTBAOCAOQUYETTOANVTDIALOG_H
#define RPTBAOCAOQUYETTOANVTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CrptBaocaoquyettoanVTDialog : public CGuiDialog{
protected:
public:
	...
	CrptBaocaoquyettoanVTDialog(CWnd *pParent);
	~CrptBaocaoquyettoanVTDialog();
	...
	int OnAddrptBaocaoquyettoanVTDialog(); 
	int OnEditrptBaocaoquyettoanVTDialog(); 
	int OnDeleterptBaocaoquyettoanVTDialog(); 
	int OnSaverptBaocaoquyettoanVTDialog(); 
	int OnCancelrptBaocaoquyettoanVTDialog(); 
	int OnrptBaocaoquyettoanVTDialogListLoadData(); 
};
#endif
