...
class CrptBaocaoxuatthuocchokhoatheodoituong : public CGuiDialog
{
protected:
public:
	...
	CGuiRadioButton	m_wndOrderQty;
	CGuiRadioButton	m_wndIssueQty;
	CGuiRadioButton	m_wndRealSupplement;
	CGuiRadioButton	m_wndSLTreo;
	CGuiListCtrl	m_wndListPhieutrano;
	...
	void			OnObjectAddNew(); void			OnPrintPreviewSelect(); 
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	void			OnCloseSelect();
	...
	void OnPrintBaocaoxuathuocchokhoatheodoituong_V1();
	void OnPrintBaocaoxuathuocchokhoatheodoituong_V2();
	void OnPrintBaocaoxuathuocchokhoatheodoituong_V3();
	...
	CString GetZoneTable(CString szZone);
};
#endif