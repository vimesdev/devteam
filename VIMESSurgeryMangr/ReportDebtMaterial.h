#ifndef ReportDebtMaterial_H
#define ReportDebtMaterial_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CReportDebtMaterial : public CGuiDialog{
protected:
public:
	...
	void			OnExportSelect(); 
	CReportDebtMaterial(CWnd *pParent);
	~CReportDebtMaterial();
	...
	int OnAddReportDebtMaterial(); 
	int OnEditReportDebtMaterial(); 
	int OnDeleteReportDebtMaterial(); 
	int OnSaveReportDebtMaterial(); 
	int OnCancelReportDebtMaterial(); 
	int OnReportDebtMaterialListLoadData();
