...
public:
	...
	CGuiComboBox	m_wndAdmitDepartment;
	...
	CGuiComboBox	m_wndEndDepartment;
	...
	CGuiTextCtrl	m_wndRecordStatus;
	...
	void			OnAdmitDepartmentSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnAdmitDepartmentSelendok(); 
	//void			OnAdmitDepartmentSetfocus(); 
	//void			OnAdmitDepartmentKillfocus(); 
	long			OnAdmitDepartmentLoadData(); 
	void			OnAdmitDepartmentAddNew(); 
	...
	void			OnEndDepartmentSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnEndDepartmentSelendok(); 
	//void			OnEndDepartmentSetfocus(); 
	//void			OnEndDepartmentKillfocus(); 
	long			OnEndDepartmentLoadData(); 
	void			OnEndDepartmentAddNew(); 
