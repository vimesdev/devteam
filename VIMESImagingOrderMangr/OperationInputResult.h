#ifndef COperationInputResult_H
#define COperationInputResult_H
...
#include "GuiView.h"
#include "DbField.h"
class COperationInputResult : public CGuiView{
protected:
	bool	m_bCreated;
	bool	m_bInited;
public:
	...
	int OnAddCOperationInputResult(); 
	int OnEditCOperationInputResult(); 
	int OnDeleteCOperationInputResult(); 
	int OnSaveCOperationInputResult(); 
	int OnCancelCOperationInputResult(); 
	int OnCOperationInputResultListLoadData(); 
	DECLARE_MESSAGE_MAP()
