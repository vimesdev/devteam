#include "HMSRoomExaminationReportDialog.h"
#include "ReportDocument.h"
#include "MainFrm.h"
#include "Excel.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSRoomExaminationReportDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSRoomExaminationReportDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CHMSRoomExaminationReportDialog *pVw = (CHMSRoomExaminationReportDialog *)pWnd;
...
static void _OnPractitionerSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSRoomExaminationReportDialog* )pWnd)->OnPractitionerSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPractitionerSelendokFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnPractitionerSelendok();
}
/*static void _OnPractitionerSetfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnPractitionerKillfocus();
}*/
/*static void _OnPractitionerKillfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnPractitionerKillfocus();
}*/
static long _OnPractitionerLoadDataFnc(CWnd *pWnd){
	return ((CHMSRoomExaminationReportDialog *)pWnd)->OnPractitionerLoadData();
}
/*static void _OnPractitionerAddNewFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnPractitionerAddNew();
}*/
static void _OnObjectSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSRoomExaminationReportDialog* )pWnd)->OnObjectSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnObjectSelendokFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnObjectSelendok();
}
/*static void _OnObjectSetfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnObjectKillfocus();
}*/
/*static void _OnObjectKillfocusFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnObjectKillfocus();
}*/
static long _OnObjectLoadDataFnc(CWnd *pWnd){
	return ((CHMSRoomExaminationReportDialog *)pWnd)->OnObjectLoadData();
}
/*static void _OnObjectAddNewFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog *)pWnd)->OnObjectAddNew();
}*/
static void _OnOrderDateSelectFnc(CWnd *pWnd){
	  ((CHMSRoomExaminationReportDialog*)pWnd)->OnOrderDateSelect();
}
static void _OnPerformDateSelectFnc(CWnd *pWnd){
	  ((CHMSRoomExaminationReportDialog*)pWnd)->OnPerformDateSelect();
}
static long _OnListItemLoadDataFnc(CWnd *pWnd){
	return ((CHMSRoomExaminationReportDialog*)pWnd)->OnListItemLoadData();
} 
static void _OnListItemClickFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog*)pWnd)->OnListItemClick();	
} 
static void _OnListItemDblClickFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog*)pWnd)->OnListItemDblClick();
} 
static void _OnListItemSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSRoomExaminationReportDialog*)pWnd)->OnListItemSelectChange(nOldItem, nNewItem);
} 
static int _OnListCheckAllFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnListCheckAll();
} 
static int _OnListUnCheckAllFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnListUnCheckAll();
} 
static long _OnRoomListLoadDataFnc(CWnd *pWnd){
	return ((CHMSRoomExaminationReportDialog*)pWnd)->OnRoomListLoadData();
} 
static void _OnRoomListDblClickFnc(CWnd *pWnd){
	((CHMSRoomExaminationReportDialog*)pWnd)->OnRoomListDblClick();
} 
static void _OnRoomListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSRoomExaminationReportDialog*)pWnd)->OnRoomListSelectChange(nOldItem, nNewItem);
} 
static int _OnRoomCheckAllFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnRoomCheckAll();
} 
static int _OnRoomUnCheckAllFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnRoomUnCheckAll();
} 

static int _OnAddHMSRoomExaminationReportDialogFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnAddHMSRoomExaminationReportDialog();
} 
static int _OnEditHMSRoomExaminationReportDialogFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnEditHMSRoomExaminationReportDialog();
} 
static int _OnDeleteHMSRoomExaminationReportDialogFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnDeleteHMSRoomExaminationReportDialog();
} 
static int _OnSaveHMSRoomExaminationReportDialogFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnSaveHMSRoomExaminationReportDialog();
} 
static int _OnCancelHMSRoomExaminationReportDialogFnc(CWnd *pWnd){
	 return ((CHMSRoomExaminationReportDialog*)pWnd)->OnCancelHMSRoomExaminationReportDialog();
} 
static void _OnOutPatientSelectFnc(CWnd *pWnd){
	  ((CHMSRoomExaminationReportDialog*)pWnd)->OnOutPatientSelect();
}
static void _OnInPatientSelectFnc(CWnd *pWnd){
	  ((CHMSRoomExaminationReportDialog*)pWnd)->OnInPatientSelect();
}
static void _OnAllHospitalsSelectFnc(CWnd *pWnd){
	  ((CHMSRoomExaminationReportDialog*)pWnd)->OnAllHospitalsSelect();
}

CHMSRoomExaminationReportDialog::CHMSRoomExaminationReportDialog(CWnd *pParent):
	CGuiDialog(pParent){
...
CHMSRoomExaminationReportDialog::~CHMSRoomExaminationReportDialog(){
}
void CHMSRoomExaminationReportDialog::OnCreateComponents(){
...
void CHMSRoomExaminationReportDialog::OnInitializeComponents(){
...
void CHMSRoomExaminationReportDialog::OnSetWindowEvents(){
...
void CHMSRoomExaminationReportDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSRoomExaminationReportDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSRoomExaminationReportDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CHMSRoomExaminationReportDialog::SetDefaultValues(){
...
int CHMSRoomExaminationReportDialog::SetMode(int nMode){
...
/*void CHMSRoomExaminationReportDialog::OnFromDateChange(){
	
} */
/*void CHMSRoomExaminationReportDialog::OnFromDateSetfocus(){
	
} */
/*void CHMSRoomExaminationReportDialog::OnFromDateKillfocus(){
	
} */
int CHMSRoomExaminationReportDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void CHMSRoomExaminationReportDialog::OnToDateChange(){
	
} */
/*void CHMSRoomExaminationReportDialog::OnToDateSetfocus(){
	
} */
/*void CHMSRoomExaminationReportDialog::OnToDateKillfocus(){
	
} */
int CHMSRoomExaminationReportDialog::OnToDateCheckValue(){
	return 0;
} 
void CHMSRoomExaminationReportDialog::OnPrintPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	PrintTonghoptheotieuban(true);
	
} 
void CHMSRoomExaminationReportDialog::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	PrintTonghoptheotieuban(false);	
} 
void CHMSRoomExaminationReportDialog::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	ExportTonghoptheotieuban();
} 
void CHMSRoomExaminationReportDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
} 
void CHMSRoomExaminationReportDialog::OnPractitionerSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSRoomExaminationReportDialog::OnPractitionerSelendok(){
	 
}
/*void CHMSRoomExaminationReportDialog::OnPractitionerSetfocus(){
	
}*/
/*void CHMSRoomExaminationReportDialog::OnPractitionerKillfocus(){
	
}*/
long CHMSRoomExaminationReportDialog::OnPractitionerLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CHMSRoomExaminationReportDialog::OnPractitionerAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSRoomExaminationReportDialog::OnObjectSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSRoomExaminationReportDialog::OnObjectSelendok(){
	 
}
/*void CHMSRoomExaminationReportDialog::OnObjectSetfocus(){
	
}*/
/*void CHMSRoomExaminationReportDialog::OnObjectKillfocus(){
	
}*/
long CHMSRoomExaminationReportDialog::OnObjectLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSRoomExaminationReportDialog::OnObjectAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSRoomExaminationReportDialog::OnOrderDateSelect(){
	
}
void CHMSRoomExaminationReportDialog::OnPerformDateSelect(){
	
}
void CHMSRoomExaminationReportDialog::OnListItemDblClick(){
...
void CHMSRoomExaminationReportDialog::OnListItemClick(){
...
void CHMSRoomExaminationReportDialog::OnListItemSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CHMSRoomExaminationReportDialog::OnListItemDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSRoomExaminationReportDialog::OnListItemLoadData(){
CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
int CHMSRoomExaminationReportDialog::OnListCheckAll(){
	for (int i=0; i< m_wndListItem.GetItemCount(); i++){
		m_wndListItem.SetCheck(i, true);
	}
	return 0;
}
int CHMSRoomExaminationReportDialog::OnListUnCheckAll(){
	for (int i=0; i< m_wndListItem.GetItemCount(); i++){
		m_wndListItem.SetCheck(i, false);
	}
	return 0;
}
void CHMSRoomExaminationReportDialog::OnRoomListDblClick(){
	
} 
void CHMSRoomExaminationReportDialog::OnRoomListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CHMSRoomExaminationReportDialog::OnRoomCheckAll(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSRoomExaminationReportDialog::OnRoomUnCheckAll(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	for (int i=0; i< m_wndRoomList.GetItemCount(); i++){
...
long CHMSRoomExaminationReportDialog::OnRoomListLoadData(){	
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CHMSRoomExaminationReportDialog::OnAddHMSRoomExaminationReportDialog(){
...
int CHMSRoomExaminationReportDialog::OnEditHMSRoomExaminationReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHMSRoomExaminationReportDialog::OnDeleteHMSRoomExaminationReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CHMSRoomExaminationReportDialog::OnSaveHMSRoomExaminationReportDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CHMSRoomExaminationReportDialog::OnCancelHMSRoomExaminationReportDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSRoomExaminationReportDialog::OnHMSRoomExaminationReportDialogListLoadData(){
	return 0;
}

void CHMSRoomExaminationReportDialog::OnOutPatientSelect(){	
	UpdateData(true);
	if (m_nOutPatient==true){
		m_nOutPatient=1;
		m_nInPatient=0;
...
void CHMSRoomExaminationReportDialog::OnInPatientSelect(){
	UpdateData(true);
	if (m_nInPatient==true)
	{
		m_nOutPatient=0;
...
void CHMSRoomExaminationReportDialog::OnAllHospitalsSelect(){
	UpdateData(true);
	if (m_nAllHospitals==true){
		m_nOutPatient=0;
		m_nInPatient=0;
...
void CHMSRoomExaminationReportDialog::PrintTonghoptheotieuban(bool m_nPreview)
{	
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CReport rpt;
	CRecord rs(&pMF->m_db);
	...
	{
		CString MsgReport;
		MsgReport.Format(_T("Mau bao cao [%s] chua co. Lien he voi Adminstrator"),  _T("RPT_BAOCAOCLSTHEOTIEUBAN_CLS.RPT"));
	...
	if (m_nPerformDate==0)
		szWhere.Format(_T(" pcmso_performdate between '%s' and '%s'"), m_szFromDate, m_szToDate);
	else
		szWhere.Format(_T(" pcmso_orderdate between '%s' and '%s' "), m_szFromDate, m_szToDate);
...
void CHMSRoomExaminationReportDialog::ExportTonghoptheotieuban()
{	
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CReport rpt;
	CRecord rs(&pMF->m_db);
...
//_msg(_T("%s"), szSQL);
	...
	xls.SetCellText(0, 3, _T("BAO CAO TONG HOP CLS THEO TIEU BAN"),CELL_FORMAT_TEXT,true,18,0);
	...
	while(!rs.IsEOF())
	{
		...
		if(szNewLine != szOldLine && !szNewLine.IsEmpty()){
			...
			{	nRow++;
				...
				xls.SetCellText(0, nRow, tmpStr, CELL_FORMAT_TEXT, true);
				FormatCurrency(grpCost, tmpStr);
				xls.SetCellText(5, nRow, tmpStr, CELL_FORMAT_TEXT,true,10,0);
				ttlCost += grpCost;				
				grpCost = 0;
				nIndex=1;
			}
			...
			xls.SetCellText(0, nRow, tmpStr, CELL_FORMAT_TEXT,true,10,0);
			szOldLine = szNewLine;			
		}
		nRow++;
		rptDetail = rpt.AddDetail();
		...
		rs.GetValue(_T("soluong"), cost);		
		FormatCurrency(cost, tmpStr);
		xls.SetCellText(3, nRow, tmpStr, CELL_FORMAT_INTEGER);
		rs.GetValue(_T("servprice"), cost);		
		FormatCurrency(cost, tmpStr);
		xls.SetCellText(4, nRow, tmpStr, CELL_FORMAT_DECIMAL);
	...
	if(ttlCost > 0){
		...
		TranslateString(_T("Total Amount"), szAmount);	
		xls.SetCellMergedColumns(0,nRow,4);
		xls.SetCellText(0, nRow, szAmount, CELL_FORMAT_TEXT,true);
		FormatCurrency(ttlCost, tmpStr);
		xls.SetCellText(5, nRow, tmpStr, CELL_FORMAT_DECIMAL, true);		
	}
