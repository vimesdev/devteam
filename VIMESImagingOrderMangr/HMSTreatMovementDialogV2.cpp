...
/*static void _OnSendDepartmentChangeFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDepartmentChange();
} */
/*static void _OnSendDepartmentSetfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDepartmentSetfocus();} */ 
/*static void _OnSendDepartmentKillfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDepartmentKillfocus();
} */
static int _OnSendDepartmentCheckValueFnc(CWnd *pWnd){
	return ((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDepartmentCheckValue();
} 
static void _OnPerformDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSTreatMovementDialogV2* )pWnd)->OnPerformDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPerformDepartmentSelendokFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnPerformDepartmentSelendok();
}
/*static void _OnPerformDepartmentSetfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnPerformDepartmentKillfocus();
}*/
/*static void _OnPerformDepartmentKillfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnPerformDepartmentKillfocus();
}*/
static long _OnPerformDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CHMSTreatMovementDialogV2 *)pWnd)->OnPerformDepartmentLoadData();
}
/*static void _OnPerformDepartmentAddNewFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnPerformDepartmentAddNew();
}*/
/*static void _OnSendDateChangeFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDateChange();
} */
/*static void _OnSendDateSetfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDateSetfocus();} */ 
/*static void _OnSendDateKillfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDateKillfocus();
} */
static int _OnSendDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSTreatMovementDialogV2 *)pWnd)->OnSendDateCheckValue();
} 
/*static void _OnTerminatedDateChangeFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnTerminatedDateChange();
} */
/*static void _OnTerminatedDateSetfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnTerminatedDateSetfocus();} */ 
/*static void _OnTerminatedDateKillfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnTerminatedDateKillfocus();
} */
static int _OnTerminatedDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSTreatMovementDialogV2 *)pWnd)->OnTerminatedDateCheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSTreatMovementDialogV2 *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSTreatMovementDialogV2 *)pWnd)->OnNoteCheckValue();
} 
static void _OnSendSelectFnc(CWnd *pWnd){
	CHMSTreatMovementDialogV2 *pVw = (CHMSTreatMovementDialogV2 *)pWnd;
	pVw->OnSendSelect();
} 
static int _OnReturnDeptSelectFnc(CWnd *pWnd)
{
	return ((CHMSTreatMovementDialogV2*)pWnd)->OnReturnDeptSelect();
...
static int _OnAddHMSTreatMovementDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatMovementDialogV2*)pWnd)->OnAddHMSTreatMovementDialog();
} 
static int _OnEditHMSTreatMovementDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatMovementDialogV2*)pWnd)->OnEditHMSTreatMovementDialog();
} 
static int _OnDeleteHMSTreatMovementDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatMovementDialogV2*)pWnd)->OnDeleteHMSTreatMovementDialog();
} 
static int _OnSaveHMSTreatMovementDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatMovementDialogV2*)pWnd)->OnSaveHMSTreatMovementDialog();
} 
static int _OnCancelHMSTreatMovementDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatMovementDialogV2*)pWnd)->OnCancelHMSTreatMovementDialog();
}
static long _OnSendToDepartmentLoadDataFnc(CWnd *pWnd)
{
	return ((CHMSTreatMovementDialogV2*)pWnd)->OnSendToDepartmentLoadData();
}
...
CHMSTreatMovementDialogV2::CHMSTreatMovementDialogV2(CWnd *pParent):
	CGuiDialog(pParent){
...
CHMSTreatMovementDialogV2::~CHMSTreatMovementDialogV2()
{
}
void CHMSTreatMovementDialogV2::OnCreateComponents()
{
...
void CHMSTreatMovementDialogV2::OnInitializeComponents(){
...
void CHMSTreatMovementDialogV2::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSTreatMovementDialogV2::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSTreatMovementDialogV2::GetDataToScreen()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSTreatMovementDialogV2::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSTreatMovementDialogV2::SetDefaultValues(){
...
int CHMSTreatMovementDialogV2::SetMode(int nMode){
...
/*void CHMSTreatMovementDialogV2::OnSendDepartmentChange(){
	
} */
/*void CHMSTreatMovementDialogV2::OnSendDepartmentSetfocus(){
	
} */
/*void CHMSTreatMovementDialogV2::OnSendDepartmentKillfocus(){
	
} */
int CHMSTreatMovementDialogV2::OnSendDepartmentCheckValue()
{
	return 0;
} 
void CHMSTreatMovementDialogV2::OnPerformDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSTreatMovementDialogV2::OnPerformDepartmentSelendok()
{
	//_msg(_T("chào lộc"));
	//m_wndAdd.SetFocus();
	//UpdateData(FALSE);
}
/*void CHMSTreatMovementDialogV2::OnPerformDepartmentSetfocus(){
	
}*/
/*void CHMSTreatMovementDialogV2::OnPerformDepartmentKillfocus(){
	
}*/

long CHMSTreatMovementDialogV2::OnSendToDepartmentLoadData()
{
...
long CHMSTreatMovementDialogV2::OnPerformDepartmentLoadData()
{
	/*CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CHMSTreatMovementDialogV2::OnPerformDepartmentAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSTreatMovementDialogV2::OnSendDateChange(){
	
} */
/*void CHMSTreatMovementDialogV2::OnSendDateSetfocus(){
	
} */
/*void CHMSTreatMovementDialogV2::OnSendDateKillfocus(){
	
} */
int CHMSTreatMovementDialogV2::OnSendDateCheckValue(){
	return 0;
} 
/*void CHMSTreatMovementDialogV2::OnTerminatedDateChange(){
	
} */
/*void CHMSTreatMovementDialogV2::OnTerminatedDateSetfocus(){
	
} */
/*void CHMSTreatMovementDialogV2::OnTerminatedDateKillfocus(){
	
} */
int CHMSTreatMovementDialogV2::OnTerminatedDateCheckValue(){
	return 0;
} 
/*void CHMSTreatMovementDialogV2::OnNoteChange(){
	
} */
/*void CHMSTreatMovementDialogV2::OnNoteSetfocus(){
	
} */
/*void CHMSTreatMovementDialogV2::OnNoteKillfocus(){
	
} */

void CHMSTreatMovementDialogV2::OnAddSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
int CHMSTreatMovementDialogV2::OnNoteCheckValue(){
	return 0;
} 
void CHMSTreatMovementDialogV2::OnSendSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSTreatMovementDialogV2::OnReturnDeptSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	szSQL.Format(_T("UPDATE hms_treat_movement SET htm_status='T', htm_terminated_date=to_timestamp('%s', 'yyyy/mm/dd hh24:mi:ss') ") \
		_T("WHERE htm_docno=%ld and htm_status='O' %s "),
		m_szTerminatedDate, m_nDocumentNo, szWhere);
	int ret = pMF->ExecSQL(szSQL);
	//_msg(_T("%s"), szSQL);
...
void CHMSTreatMovementDialogV2::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();	
} 
int CHMSTreatMovementDialogV2::OnAddHMSTreatMovementDialog(){
...
int CHMSTreatMovementDialogV2::OnEditHMSTreatMovementDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSTreatMovementDialogV2::OnDeleteHMSTreatMovementDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CHMSTreatMovementDialogV2::OnSaveHMSTreatMovementDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CHMSTreatMovementDialogV2::OnCancelHMSTreatMovementDialog(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSTreatMovementDialogV2::OnHMSTreatMovementDialogListLoadData(){
	return 0;
}