#ifndef StorageDeliveryOrderView_H
#define StorageDeliveryOrderView_H
...
class CStorageDeliveryOrderView : public CGuiView{
protected:
public:
	CWnd*		m_wndList;
	bool		m_bRefresh;
	...
	CStorageDeliveryOrderLines	m_wndLines;
	...
	int OnAddStorageDeliveryOrderView(); 
	int OnEditStorageDeliveryOrderView(); 
	int OnDeleteStorageDeliveryOrderView(); 
	int OnSaveStorageDeliveryOrderView(); 
	int OnDiscardStorageDeliveryOrderView(); 
	int OnStorageDeliveryOrderViewListLoadData(); 
	CString GetOrderStatus();
	bool	IsAllowEdit();
	void	Load(long nTransaction_ID);
