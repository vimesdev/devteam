#include "AllocateMaterialOrderList.h"
#include "HMSMainFrame.h"
#include "AllocateMaterialOrder.h"

static void _CAllocateMaterialOrderListFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrderList* )pWnd)->OnTransactionTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTransactionTypeSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnTransactionTypeSelendok();
}
/*static void _OnTransactionTypeSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnTransactionTypeKillfocus();
}*/
/*static void _OnTransactionTypeKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnTransactionTypeKillfocus();
}*/
static long _OnTransactionTypeLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderList *)pWnd)->OnTransactionTypeLoadData();
}
/*static void _OnTransactionTypeAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnTransactionTypeAddNew();
}*/

static void _OnAllOrdersSelectFnc(CWnd *pWnd){
	 (( CAllocateMaterialOrderList*)pWnd)->OnAllOrdersSelect();
}
static void _OnOpeningSelectFnc(CWnd *pWnd){
	 (( CAllocateMaterialOrderList*)pWnd)->OnOpeningSelect();
}
static void _OnApprovedSelectFnc(CWnd *pWnd){
	 (( CAllocateMaterialOrderList*)pWnd)->OnApprovedSelect();
}
static void _OnSendingSelectFnc(CWnd *pWnd){
	 (( CAllocateMaterialOrderList*)pWnd)->OnSendingSelect();
}

/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderList *)pWnd)->OnToDateCheckValue();
} 
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrderList* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderList *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnStatusAddNew();
}*/
static void _OnFromStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrderList* )pWnd)->OnFromStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnFromStorageSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnFromStorageSelendok();
}
/*static void _OnFromStorageSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnFromStorageKillfocus();
}*/
/*static void _OnFromStorageKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnFromStorageKillfocus();
}*/
static long _OnFromStorageLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderList *)pWnd)->OnFromStorageLoadData();
}
/*static void _OnFromStorageAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnFromStorageAddNew();
}*/
static void _OnToStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrderList* )pWnd)->OnToStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnToStorageSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnToStorageSelendok();
}
/*static void _OnToStorageSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnToStorageKillfocus();
}*/
/*static void _OnToStorageKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnToStorageKillfocus();
}*/
static long _OnToStorageLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderList *)pWnd)->OnToStorageLoadData();
}
/*static void _OnToStorageAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList *)pWnd)->OnToStorageAddNew();
}*/
static void _OnRefreshSelectFnc(CWnd *pWnd){
	CAllocateMaterialOrderList *pVw = (CAllocateMaterialOrderList *)pWnd;
	pVw->OnRefreshSelect();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderList*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CAllocateMaterialOrderList*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CAllocateMaterialOrderList*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderList*)pWnd)->OnListDeleteItem();
}
...
static int _OnAddAllocateMaterialOrderListFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderList*)pWnd)->OnAddAllocateMaterialOrderList();
} 
static int _OnEditAllocateMaterialOrderListFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderList*)pWnd)->OnEditAllocateMaterialOrderList();
} 
static int _OnDeleteAllocateMaterialOrderListFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderList*)pWnd)->OnDeleteAllocateMaterialOrderList();
} 
static int _OnSaveAllocateMaterialOrderListFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderList*)pWnd)->OnSaveAllocateMaterialOrderList();
} 
static int _OnCancelAllocateMaterialOrderListFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderList*)pWnd)->OnCancelAllocateMaterialOrderList();
} 
CAllocateMaterialOrderList::CAllocateMaterialOrderList(){
...
void CAllocateMaterialOrderList::OnCreateComponents(){
...
void CAllocateMaterialOrderList::OnInitializeComponents(){
...
void CAllocateMaterialOrderList::OnSetWindowEvents(){
	...
	m_wndTransactionType.SetEvent(WE_SELCHANGE, _CAllocateMaterialOrderListFnc);
...
/*
	...
	*/
	...
	SetWindowName(_T("AllocateMaterialOrderList"));

	m_nStatus = 0;
	SetMode(VM_VIEW);
	OnListLoadData();
}
void CAllocateMaterialOrderList::OnDoDataExchange(CDataExchange* pDX){
...
void CAllocateMaterialOrderList::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CAllocateMaterialOrderList::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();

}
void CAllocateMaterialOrderList::SetDefaultValues(){
...
int CAllocateMaterialOrderList::SetMode(int nMode){
...
/*void CAllocateMaterialOrderList::OnFromDateChange(){
	
} */
/*void CAllocateMaterialOrderList::OnFromDateSetfocus(){
	
} */
/*void CAllocateMaterialOrderList::OnFromDateKillfocus(){
	
} */
int CAllocateMaterialOrderList::OnFromDateCheckValue(){
	OnListLoadData();
	return 0;
} 
/*void CAllocateMaterialOrderList::OnToDateChange(){
	
} */
/*void CAllocateMaterialOrderList::OnToDateSetfocus(){
	
} */
/*void CAllocateMaterialOrderList::OnToDateKillfocus(){
	
} */
int CAllocateMaterialOrderList::OnToDateCheckValue(){
	OnListLoadData();
	return 0;
} 
void CAllocateMaterialOrderList::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CAllocateMaterialOrderList::OnStatusSelendok(){
	 
}
/*void CAllocateMaterialOrderList::OnStatusSetfocus(){
	
}*/
/*void CAllocateMaterialOrderList::OnStatusKillfocus(){
	
}*/
long CAllocateMaterialOrderList::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CAllocateMaterialOrderList::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CAllocateMaterialOrderList::OnFromStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CAllocateMaterialOrderList::OnFromStorageSelendok(){
	 OnListLoadData();
}
/*void CAllocateMaterialOrderList::OnFromStorageSetfocus(){
	
}*/
/*void CAllocateMaterialOrderList::OnFromStorageKillfocus(){
	
}*/
long CAllocateMaterialOrderList::OnFromStorageLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szWhere;
...
/*void CAllocateMaterialOrderList::OnFromStorageAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CAllocateMaterialOrderList::OnToStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CAllocateMaterialOrderList::OnToStorageSelendok(){
	 OnListLoadData();
}
/*void CAllocateMaterialOrderList::OnToStorageSetfocus(){
	
}*/
/*void CAllocateMaterialOrderList::OnToStorageKillfocus(){
	
}*/
long CAllocateMaterialOrderList::OnToStorageLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szWhere;
...
/*void CAllocateMaterialOrderList::OnToStorageAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

void CAllocateMaterialOrderList::OnTransactionTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CAllocateMaterialOrderList::OnTransactionTypeSelendok(){
	 OnListLoadData();
}
/*void CAllocateMaterialOrderList::OnTransactionTypeSetfocus(){
	
}*/
/*void CAllocateMaterialOrderList::OnTransactionTypeKillfocus(){
	
}*/
long CAllocateMaterialOrderList::OnTransactionTypeLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CAllocateMaterialOrderList::OnTransactionTypeAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

void CAllocateMaterialOrderList::OnRefreshSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnListLoadData();	
} 
void CAllocateMaterialOrderList::OnListDblClick(){
	...
	((CAllocateMaterialOrder*)m_wndOrder)->m_nID = m_nID;
	((CAllocateMaterialOrder*)m_wndOrder)->GetDataToScreen();
	((CGuiTabCtrl*)GetParent())->SetCurSel(1);
} 
void CAllocateMaterialOrderList::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	if(nNewItem < 0)
		return;
...
int CAllocateMaterialOrderList::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CAllocateMaterialOrderList::OnListLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere, tmpStr;
	CString szDeptID;
...
void CAllocateMaterialOrderList::OnViewSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	int nSel = m_wndList.GetCurSel();
	if(nSel < 0)
	{
...
int CAllocateMaterialOrderList::OnAddAllocateMaterialOrderList(){
...
int CAllocateMaterialOrderList::OnEditAllocateMaterialOrderList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CAllocateMaterialOrderList::OnDeleteAllocateMaterialOrderList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelAllocateMaterialOrderList(); 
 	}
	return 0;
}
int CAllocateMaterialOrderList::OnSaveAllocateMaterialOrderList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 ////_fmsg_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnAllocateMaterialOrderListListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CAllocateMaterialOrderList::OnCancelAllocateMaterialOrderList(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CAllocateMaterialOrderList::OnAllocateMaterialOrderListListLoadData(){
	return 0;
}

void CAllocateMaterialOrderList::SetImportForm(bool bFlag){
	m_bImportType = bFlag;
}

void CAllocateMaterialOrderList::Refresh(){
	if(GetSafeHwnd()){
		OnListLoadData();
	}
}

void  CAllocateMaterialOrderList::OnAllOrdersSelect(){
	UpdateData(true);
	m_nStatus = 0;
	OnListLoadData();
}
void  CAllocateMaterialOrderList::OnOpeningSelect(){
	UpdateData(true);
	m_nStatus = 1;
	OnListLoadData();
}
void  CAllocateMaterialOrderList::OnApprovedSelect(){
	UpdateData(true);
	m_nStatus = 2;
	OnListLoadData();
}
void  CAllocateMaterialOrderList::OnSendingSelect(){
	UpdateData(true);
	m_nStatus = 3;
	OnListLoadData();
}
...
BEGIN_MESSAGE_MAP(CAllocateMaterialOrderList, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CAllocateMaterialOrderList::OnSetFocus(CWnd* pOldWnd)
{
