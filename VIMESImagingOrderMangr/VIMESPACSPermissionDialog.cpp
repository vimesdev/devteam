...
static void _OnUserNameSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CVIMESPACSPermissionDialog* )pWnd)->OnUserNameSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnUserNameSelendokFnc(CWnd *pWnd){
	((CVIMESPACSPermissionDialog *)pWnd)->OnUserNameSelendok();
}
/*static void _OnUserNameSetfocusFnc(CWnd *pWnd){
	((CVIMESPACSPermissionDialog *)pWnd)->OnUserNameKillfocus();
}*/
/*static void _OnUserNameKillfocusFnc(CWnd *pWnd){
	((CVIMESPACSPermissionDialog *)pWnd)->OnUserNameKillfocus();
}*/
static long _OnUserNameLoadDataFnc(CWnd *pWnd){
	return ((CVIMESPACSPermissionDialog *)pWnd)->OnUserNameLoadData();
}
/*static void _OnUserNameAddNewFnc(CWnd *pWnd){
	((CVIMESPACSPermissionDialog *)pWnd)->OnUserNameAddNew();
}*/
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CVIMESPACSPermissionDialog*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CVIMESPACSPermissionDialog*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CVIMESPACSPermissionDialog*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CVIMESPACSPermissionDialog*)pWnd)->OnListDeleteItem();
} 
static void _OnApplySelectFnc(CWnd *pWnd){
	CVIMESPACSPermissionDialog *pVw = (CVIMESPACSPermissionDialog *)pWnd;
	pVw->OnApplySelect();
} 
...
static int _OnAddHMSParaclinicalPermDialogFnc(CWnd *pWnd){
	 return ((CVIMESPACSPermissionDialog*)pWnd)->OnAddHMSParaclinicalPermDialog();
} 
static int _OnEditHMSParaclinicalPermDialogFnc(CWnd *pWnd){
	 return ((CVIMESPACSPermissionDialog*)pWnd)->OnEditHMSParaclinicalPermDialog();
} 
static int _OnDeleteHMSParaclinicalPermDialogFnc(CWnd *pWnd){
	 return ((CVIMESPACSPermissionDialog*)pWnd)->OnDeleteHMSParaclinicalPermDialog();
} 
static int _OnSaveHMSParaclinicalPermDialogFnc(CWnd *pWnd){
	 return ((CVIMESPACSPermissionDialog*)pWnd)->OnSaveHMSParaclinicalPermDialog();
} 
static int _OnCancelHMSParaclinicalPermDialogFnc(CWnd *pWnd){
	 return ((CVIMESPACSPermissionDialog*)pWnd)->OnCancelHMSParaclinicalPermDialog();
} 
CVIMESPACSPermissionDialog::CVIMESPACSPermissionDialog(CWnd *pParent):
	CGuiDialog(pParent)
{
	m_nDlgWidth = 405;
	m_nDlgHeight = 440;
...
CVIMESPACSPermissionDialog::~CVIMESPACSPermissionDialog(){
}
void CVIMESPACSPermissionDialog::OnCreateComponents(){
...
void CVIMESPACSPermissionDialog::OnInitializeComponents(){
...
void CVIMESPACSPermissionDialog::OnSetWindowEvents(){
...
void CVIMESPACSPermissionDialog::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndUserName.GetDlgCtrlID(), m_szUserNameKey);

}
void CVIMESPACSPermissionDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CVIMESPACSPermissionDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	m_hms_paraclinicalpermTbl.SetValue(_T("hpp_userid"), m_szUserNameKey);

}
void CVIMESPACSPermissionDialog::SetDefaultValues(){
	m_szUserNameKey.Empty();
}
int CVIMESPACSPermissionDialog::SetMode(int nMode){ 
...
void CVIMESPACSPermissionDialog::OnUserNameSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CVIMESPACSPermissionDialog::OnUserNameSelendok(){
	UpdateData(true);
	OnListLoadData();
}
/*void CVIMESPACSPermissionDialog::OnUserNameSetfocus(){
	
}*/
/*void CVIMESPACSPermissionDialog::OnUserNameKillfocus(){
	
}*/
long CVIMESPACSPermissionDialog::OnUserNameLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CVIMESPACSPermissionDialog::OnUserNameAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CVIMESPACSPermissionDialog::OnListDblClick(){
	
} 
void CVIMESPACSPermissionDialog::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CVIMESPACSPermissionDialog::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CVIMESPACSPermissionDialog::OnListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CVIMESPACSPermissionDialog::OnApplySelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szSQL;
...
void CVIMESPACSPermissionDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 

int CVIMESPACSPermissionDialog::OnAddHMSParaclinicalPermDialog(){
...
int CVIMESPACSPermissionDialog::OnEditHMSParaclinicalPermDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
...
int CVIMESPACSPermissionDialog::OnDeleteHMSParaclinicalPermDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CVIMESPACSPermissionDialog::OnSaveHMSParaclinicalPermDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CVIMESPACSPermissionDialog::OnCancelHMSParaclinicalPermDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CVIMESPACSPermissionDialog::OnHMSParaclinicalPermDialogListLoadData(){
	return 0;
}
