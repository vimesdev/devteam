#include "AllocateMaterialOrder.h"
#include "HMSMainFrame.h"
#include "HMSReportForms/PrintForms.h"

static void _OnFromStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnFromStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnFromStorageSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnFromStorageSelendok();
}
/*static void _OnFromStorageSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnFromStorageKillfocus();
}*/
/*static void _OnFromStorageKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnFromStorageKillfocus();
}*/
static long _OnFromStorageLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnFromStorageLoadData();
}
/*static void _OnFromStorageAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnFromStorageAddNew();
}*/
static void _OnToStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnToStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnToStorageSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnToStorageSelendok();
}
/*static void _OnToStorageSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnToStorageKillfocus();
}*/
/*static void _OnToStorageKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnToStorageKillfocus();
}*/
static long _OnToStorageLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnToStorageLoadData();
}
/*static void _OnToStorageAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnToStorageAddNew();
}*/
static void _OnDelivererSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnDelivererSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDelivererSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDelivererSelendok();
}
/*static void _OnDelivererSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDelivererKillfocus();
}*/
/*static void _OnDelivererKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDelivererKillfocus();
}*/
static long _OnDelivererLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnDelivererLoadData();
}
/*static void _OnDelivererAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDelivererAddNew();
}*/
static void _OnReceiverSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnReceiverSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReceiverSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnReceiverSelendok();
}
/*static void _OnReceiverSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnReceiverKillfocus();
}*/
/*static void _OnReceiverKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnReceiverKillfocus();
}*/
static long _OnReceiverLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnReceiverLoadData();
}
/*static void _OnReceiverAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnReceiverAddNew();
}*/
/*static void _OnDescriptionChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDescriptionChange();
} */
/*static void _OnDescriptionSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDescriptionSetfocus();} */ 
/*static void _OnDescriptionKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDescriptionKillfocus();
} */
static int _OnDescriptionCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnDescriptionCheckValue();
} 
/*static void _OnOrderNoChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnOrderNoChange();
} */
/*static void _OnOrderNoSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnOrderNoSetfocus();} */ 
/*static void _OnOrderNoKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnOrderNoKillfocus();
} */
static int _OnOrderNoCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnOrderNoCheckValue();
} 
/*static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnOrderDateChange();
} */
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnOrderDateCheckValue();
} 
/*static void _OnApprovedDateChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnApprovedDateChange();
} */
/*static void _OnApprovedDateSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnApprovedDateSetfocus();} */ 
/*static void _OnApprovedDateKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnApprovedDateKillfocus();
} */
static int _OnApprovedDateCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnApprovedDateCheckValue();
} 
static void _OnTransactionTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnTransactionTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTransactionTypeSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransactionTypeSelendok();
}
/*static void _OnTransactionTypeSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransactionTypeKillfocus();
}*/
static void _OnTransactionTypeKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransactionTypeKillfocus();
}
static long _OnTransactionTypeLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnTransactionTypeLoadData();
}
/*static void _OnTransactionTypeAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransactionTypeAddNew();
}*/

static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnStatusAddNew();
}*/

static void _OnTransportMethodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnTransportMethodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTransportMethodSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransportMethodSelendok();
}
/*static void _OnTransportMethodSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransportMethodKillfocus();
}*/
/*static void _OnTransportMethodKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransportMethodKillfocus();
}*/
static long _OnTransportMethodLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnTransportMethodLoadData();
}
/*static void _OnTransportMethodAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTransportMethodAddNew();
}*/
static void _OnDeliveryMethodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrder* )pWnd)->OnDeliveryMethodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeliveryMethodSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryMethodSelendok();
}
/*static void _OnDeliveryMethodSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryMethodKillfocus();
}*/
/*static void _OnDeliveryMethodKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryMethodKillfocus();
}*/
static long _OnDeliveryMethodLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnDeliveryMethodLoadData();
}
/*static void _OnDeliveryMethodAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryMethodAddNew();
}*/
/*static void _OnDeliveryDateChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryDateChange();
} */
/*static void _OnDeliveryDateSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryDateSetfocus();} */ 
/*static void _OnDeliveryDateKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryDateKillfocus();
} */
static int _OnDeliveryDateCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnDeliveryDateCheckValue();
} 
/*static void _OnDeliveryAddressChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryAddressChange();
} */
/*static void _OnDeliveryAddressSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryAddressSetfocus();} */ 
/*static void _OnDeliveryAddressKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnDeliveryAddressKillfocus();
} */
static int _OnDeliveryAddressCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnDeliveryAddressCheckValue();
} 


static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CAllocateMaterialOrder*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CAllocateMaterialOrder*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
}

static int _OnListAddItemFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnListAddItem();
}
static int _OnListEditItemFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnListEditItem();
}

static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnListDeleteItem();
} 

/*static void _OnTotalLineChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTotalLineChange();
} */
/*static void _OnTotalLineSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTotalLineSetfocus();} */ 
/*static void _OnTotalLineKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTotalLineKillfocus();
} */
static int _OnTotalLineCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnTotalLineCheckValue();
} 
/*static void _OnTotalAmountChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTotalAmountChange();
} */
/*static void _OnTotalAmountSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTotalAmountSetfocus();} */ 
/*static void _OnTotalAmountKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrder *)pWnd)->OnTotalAmountKillfocus();
} */
static int _OnTotalAmountCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrder *)pWnd)->OnTotalAmountCheckValue();
} 
static void _OnAddSelectFnc(CWnd *pWnd){
	CAllocateMaterialOrder *pVw = (CAllocateMaterialOrder *)pWnd;
	pVw->OnAddSelect();
} 
...
static void _OnTabSelectChangeFnc(CWnd *pWnd, int nOld, int nNew){
	((CAllocateMaterialOrder*)pWnd)->OnTabSelectChange(nOld, nNew);
} 
static int _OnAddAllocateMaterialOrderFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnAddAllocateMaterialOrder();
} 
static int _OnEditAllocateMaterialOrderFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnEditAllocateMaterialOrder();
} 
static int _OnDeleteAllocateMaterialOrderFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnDeleteAllocateMaterialOrder();
} 
static int _OnSaveAllocateMaterialOrderFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnSaveAllocateMaterialOrder();
} 
static int _OnDiscardAllocateMaterialOrderFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrder*)pWnd)->OnDiscardAllocateMaterialOrder();
} 
CAllocateMaterialOrder::CAllocateMaterialOrder()
{
	m_nDlgWidth = 1010;
	m_nDlgHeight = 605;
	SetDefaultValues();
	m_szTransactionTypeKey = _T("CSO");
	SetWindowName(_T("Medical AllocateMaterial Management"));
	m_bImport = false;
}
CAllocateMaterialOrder::~CAllocateMaterialOrder(){
	
}
void CAllocateMaterialOrder::OnCreateComponents(){
...
void CAllocateMaterialOrder::OnInitializeComponents(){
...
void CAllocateMaterialOrder::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CAllocateMaterialOrder::OnDoDataExchange(CDataExchange* pDX){
...
void CAllocateMaterialOrder::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CAllocateMaterialOrder::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szDeptID;
	szDeptID = pMF->m_UserInfo.su_deptid;
...
void CAllocateMaterialOrder::SetDefaultValues(){
...
int CAllocateMaterialOrder::SetMode(int nMode){
 		...
 		case VM_ADD: 
			...
			szSQL.Format(_T("AD_GETNEXTVAL('STORAGE_AllocateMaterial_NO','Y') "));
...
void CAllocateMaterialOrder::OnFromStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CAllocateMaterialOrder::OnFromStorageSelendok(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szCategory;
	CString szSQL;
...
/*void CAllocateMaterialOrder::OnFromStorageSetfocus(){
	
}*/
/*void CAllocateMaterialOrder::OnFromStorageKillfocus(){
	
}*/
long CAllocateMaterialOrder::OnFromStorageLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
	if(!m_bImport)
	{
...
/*void CAllocateMaterialOrder::OnFromStorageAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CAllocateMaterialOrder::OnToStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CAllocateMaterialOrder::OnToStorageSelendok(){
	 
}

/*void CAllocateMaterialOrder::OnToStorageSetfocus(){
	
}*/
/*void CAllocateMaterialOrder::OnToStorageKillfocus(){
	
}*/
long CAllocateMaterialOrder::OnToStorageLoadData(){	
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CAllocateMaterialOrder::OnToStorageAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CAllocateMaterialOrder::OnDelivererSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CAllocateMaterialOrder::OnDelivererSelendok(){
	 
}

/*void CAllocateMaterialOrder::OnDelivererSetfocus(){
	
}*/
/*void CAllocateMaterialOrder::OnDelivererKillfocus(){
	
}*/
long CAllocateMaterialOrder::OnDelivererLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CAllocateMaterialOrder::OnDelivererAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
void CAllocateMaterialOrder::OnReceiverSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
}
 
void CAllocateMaterialOrder::OnReceiverSelendok(){
	 
}

/*void CAllocateMaterialOrder::OnReceiverSetfocus(){
	
}*/
/*void CAllocateMaterialOrder::OnReceiverKillfocus(){
	
}*/
long CAllocateMaterialOrder::OnReceiverLoadData(){
...
/*void CAllocateMaterialOrder::OnReceiverAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CAllocateMaterialOrder::OnDescriptionChange(){
	
} */
/*void CAllocateMaterialOrder::OnDescriptionSetfocus(){
	
} */
/*void CAllocateMaterialOrder::OnDescriptionKillfocus(){
	
} */
int CAllocateMaterialOrder::OnDescriptionCheckValue(){
	return 0;
}
 
/*void CAllocateMaterialOrder::OnOrderNoChange(){
	
} */
/*void CAllocateMaterialOrder::OnOrderNoSetfocus(){
	
} */
/*void CAllocateMaterialOrder::OnOrderNoKillfocus(){
	
} */
int CAllocateMaterialOrder::OnOrderNoCheckValue(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	UpdateData(true);
...
/*void CAllocateMaterialOrder::OnOrderDateChange(){
	
} */
/*void CAllocateMaterialOrder::OnOrderDateSetfocus(){
	
} */
/*void CAllocateMaterialOrder::OnOrderDateKillfocus(){
	
} */
int CAllocateMaterialOrder::OnOrderDateCheckValue(){
	return 0;
}
 
/*void CAllocateMaterialOrder::OnApprovedDateChange(){
	
} */
/*void CAllocateMaterialOrder::OnApprovedDateSetfocus(){
	
} */
/*void CAllocateMaterialOrder::OnApprovedDateKillfocus(){
	
} */
int CAllocateMaterialOrder::OnApprovedDateCheckValue(){
	return 0;
} 
void CAllocateMaterialOrder::OnTransactionTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CAllocateMaterialOrder::OnTransactionTypeSelendok(){
	CString tmpStr;
	UpdateData(true);
...
/*void CAllocateMaterialOrder::OnTransactionTypeSetfocus(){
	
}*/
void CAllocateMaterialOrder::OnTransactionTypeKillfocus(){
	OnTransactionTypeSelendok();	
}
long CAllocateMaterialOrder::OnTransactionTypeLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CAllocateMaterialOrder::OnTransactionTypeAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
 

void CAllocateMaterialOrder::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CAllocateMaterialOrder::OnStatusSelendok(){
	 
}
/*void CAllocateMaterialOrder::OnStatusSetfocus(){
	
}*/
/*void CAllocateMaterialOrder::OnStatusKillfocus(){
	
}*/
long CAllocateMaterialOrder::OnStatusLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere, tmpStr;
...
/*void CAllocateMaterialOrder::OnStatusAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */


void CAllocateMaterialOrder::OnListDblClick(){
	OnPreviewDeliveryDetail();
} 
void CAllocateMaterialOrder::OnListSelectChange(int nOldItem, int nNewItem){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	if(nNewItem < 0)
		return;
...
#include "AllocateMaterialOrderLineInput.h"
int CAllocateMaterialOrder::OnListAddItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	CRect rect;
	GetWindowRect(&rect);
	CAllocateMaterialOrderLineInput* newPopup = new CAllocateMaterialOrderLineInput(this, VM_ADD);
...
int CAllocateMaterialOrder::OnListEditItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRect rect;
/*
	GetWindowRect(&rect);
...
int CAllocateMaterialOrder::OnListDeleteItem(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
...
long CAllocateMaterialOrder::OnListLoadData(){
...
/*void CAllocateMaterialOrder::OnTotalLineChange(){
	
} */
/*void CAllocateMaterialOrder::OnTotalLineSetfocus(){
	
} */
/*void CAllocateMaterialOrder::OnTotalLineKillfocus(){
	
} */
int CAllocateMaterialOrder::OnTotalLineCheckValue(){
	return 0;
} 
/*void CAllocateMaterialOrder::OnTotalAmountChange(){
	
} */
/*void CAllocateMaterialOrder::OnTotalAmountSetfocus(){
	
} */
/*void CAllocateMaterialOrder::OnTotalAmountKillfocus(){
	
} */
int CAllocateMaterialOrder::OnTotalAmountCheckValue(){
	return 0;
}
 
void CAllocateMaterialOrder::OnAddSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnAddAllocateMaterialOrder();
}
 
void CAllocateMaterialOrder::OnEditSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnEditAllocateMaterialOrder();

}
 
void CAllocateMaterialOrder::OnDeleteSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnDeleteAllocateMaterialOrder();
}
 
void CAllocateMaterialOrder::OnSaveSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnSaveAllocateMaterialOrder();
}
 
void CAllocateMaterialOrder::OnDiscardSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnDiscardAllocateMaterialOrder();
}
 
void CAllocateMaterialOrder::OnPrintSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CAllocateMaterialOrder::OnPostSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CString szSQL;
	m_szStatus = GetOrderStatus();
	if(m_szStatus != _T("O"))
...
void CAllocateMaterialOrder::OnCloseSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	((CAllocateMaterialDialog*)GetParent()->GetParent())->OnCancel();
} 
void CAllocateMaterialOrder::OnAddLineSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	if(!IsAllowEdit())
		return;
	if(m_szStatus != _T("O"))
...
void CAllocateMaterialOrder::OnTabSelectChange(int nOld, int nNew){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
int CAllocateMaterialOrder::OnAddAllocateMaterialOrder(){
	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
...
int CAllocateMaterialOrder::OnEditAllocateMaterialOrder(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
...
int CAllocateMaterialOrder::OnDeleteAllocateMaterialOrder(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CAllocateMaterialOrder::OnSaveAllocateMaterialOrder(){
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
...
int CAllocateMaterialOrder::OnDiscardAllocateMaterialOrder(){
...
int CAllocateMaterialOrder::OnAllocateMaterialOrderListLoadData(){
	return 0;
}


CString CAllocateMaterialOrder::GetOrderStatus(){
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
...
bool CAllocateMaterialOrder::IsAllowEdit(){
...
#include "HMSReportForms/PrintForms.h"
int CAllocateMaterialOrder::OnPreviewDeliveryDetail(){
