...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSAnestheticScheduleList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSAnestheticScheduleList *)pWnd)->OnToDateCheckValue();
} 
static long _OnOrderListLoadDataFnc(CWnd *pWnd){
	return ((CHMSAnestheticScheduleList*)pWnd)->OnOrderListLoadData();
} 
static void _OnOrderListDblClickFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList*)pWnd)->OnOrderListDblClick();
} 
static void _OnOrderListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSAnestheticScheduleList*)pWnd)->OnOrderListSelectChange(nOldItem, nNewItem);
} 
static int _OnOrderListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSAnestheticScheduleList*)pWnd)->OnOrderListDeleteItem();
}

static int _OnOrderListPrintItemFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList*)pWnd)->OnPrintSelect();
	 return 0;
}

static int _OnOrderListAddPatientOrderFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList*)pWnd)->OnAddPatientOrder();
	 return 0;
}
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSAnestheticScheduleList*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSAnestheticScheduleList*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSAnestheticScheduleList*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSAnestheticScheduleList*)pWnd)->OnListDeleteItem();
}


static int _OnListPrintItemFnc(CWnd *pWnd){
	 ((CHMSAnestheticScheduleList*)pWnd)->OnPrintMaterialOrder();
	 return 0;
}

static int _OnListExportItemFnc(CWnd *pWnd){
	 ((CHMSAnestheticScheduleList*)pWnd)->OnExportOperationOrder();
	 return 0;
}

static void _OnAddSelectFnc(CWnd *pWnd){
	CHMSAnestheticScheduleList *pVw = (CHMSAnestheticScheduleList *)pWnd;
	pVw->OnAddSelect();
} 
...
static int _OnAddHMSAnestheticScheduleListFnc(CWnd *pWnd){
	 return ((CHMSAnestheticScheduleList*)pWnd)->OnAddHMSAnestheticScheduleList();
} 
static int _OnEditHMSAnestheticScheduleListFnc(CWnd *pWnd){
	 return ((CHMSAnestheticScheduleList*)pWnd)->OnEditHMSAnestheticScheduleList();
} 
static int _OnDeleteHMSAnestheticScheduleListFnc(CWnd *pWnd){
	 return ((CHMSAnestheticScheduleList*)pWnd)->OnDeleteHMSAnestheticScheduleList();
} 
static int _OnSaveHMSAnestheticScheduleListFnc(CWnd *pWnd){
	 return ((CHMSAnestheticScheduleList*)pWnd)->OnSaveHMSAnestheticScheduleList();
} 
static int _OnCancelHMSAnestheticScheduleListFnc(CWnd *pWnd){
	 return ((CHMSAnestheticScheduleList*)pWnd)->OnCancelHMSAnestheticScheduleList();
} 
CHMSAnestheticScheduleList::CHMSAnestheticScheduleList(){
...
void CHMSAnestheticScheduleList::OnCreateComponents(){
	m_wndPatientListInfo.Create(this, _T("Patient List"), 5, 5, 450, 615);
	...
	m_wndAdd.Create(this, _T("&Create"), 4, 595, 89, 620);
	m_wndDelete.Create(this, _T("&Delete"), 94, 595, 179, 620);
	m_wndConfirm.Create(this, _T("&Confirm"), 184, 595, 269, 620);
	m_wndDiscard.Create(this, _T("&Disconfirm"), 274, 595, 359, 620);
	m_wndPrint.Create(this, _T("Print"), 364, 595, 449, 620);

}
void CHMSAnestheticScheduleList::OnInitializeComponents(){
	...
	m_wndOrderList.InsertColumn(1, _T("Order No"), CFMT_NUMBER, 80);
	m_wndOrderList.InsertColumn(2, _T("Order Date"), CFMT_DATE, 90);
...
void CHMSAnestheticScheduleList::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddHMSAnestheticScheduleListFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditHMSAnestheticScheduleListFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteHMSAnestheticScheduleListFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveHMSAnestheticScheduleListFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelHMSAnestheticScheduleListFnc, 0, 'T', VK_CONTROL);
	*/
...
void CHMSAnestheticScheduleList::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CHMSAnestheticScheduleList::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CHMSAnestheticScheduleDetail* pDtl = ((CHMSAnestheticScheduleDetail*)m_wndOrder);
	pDtl->m_nDocumentNo = m_nDocumentNo;
	pDtl->m_nOperationID = m_nOrderID;
	pDtl->m_szOrderDate = m_szOrderDate;
...
void CHMSAnestheticScheduleList::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}

void CHMSAnestheticScheduleList::SetDefaultValues(){
...
int CHMSAnestheticScheduleList::SetMode(int nMode){
...
/*void CHMSAnestheticScheduleList::OnFromDateChange(){
	
} */
/*void CHMSAnestheticScheduleList::OnFromDateSetfocus(){
	
} */
/*void CHMSAnestheticScheduleList::OnFromDateKillfocus(){
	
} */
int CHMSAnestheticScheduleList::OnFromDateCheckValue(){
	OnOrderListLoadData();
	return 1;
}
 
/*void CHMSAnestheticScheduleList::OnToDateChange(){
	
} */
/*void CHMSAnestheticScheduleList::OnToDateSetfocus(){
	
} */
/*void CHMSAnestheticScheduleList::OnToDateKillfocus(){
	
} */
int CHMSAnestheticScheduleList::OnToDateCheckValue(){
	OnOrderListLoadData();
	return 1;
} 
void CHMSAnestheticScheduleList::OnOrderListDblClick(){
	
} 
void CHMSAnestheticScheduleList::OnOrderListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(nNewItem < 0) return;
	m_nMatOID = str2long(m_wndOrderList.GetItemText(nNewItem, 1));
	m_szOrderDate = m_wndOrderList.GetItemText(nNewItem, 2);
	OnListLoadData();
	((CHMSAnestheticScheduleDetail*)m_wndOrder)->m_nMaterialOID = m_nMatOID;
	((CHMSAnestheticScheduleDetail*)m_wndOrder)->m_szOrderDate = m_wndOrderList.GetItemText(nNewItem, 2);
	((CHMSAnestheticScheduleDetail*)m_wndOrder)->m_szPerformDeptKey = m_wndOrderList.GetItemText(nNewItem, 3);
	((CHMSAnestheticScheduleDetail*)m_wndOrder)->PostMessage(WM_REFRESH, 0, -1);
	
} 
int CHMSAnestheticScheduleList::OnOrderListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteHMSAnestheticScheduleList();
	 return 0;
} 
long CHMSAnestheticScheduleList::OnOrderListLoadData(){

	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	
	szSQL.Format(_T("SELECT hom_op_material_id, hom_orderno, hom_orderdate, hom_status, hom_perform_deptid, hom_createdby ") \
		_T("FROM hms_op_material ") \
		_T("WHERE hom_order_deptid='%s' and hom_orderdate between to_date('%s', 'yyyy/mm/dd hh24:mi:ss') and to_date('%s', 'yyyy/mm/dd hh24:mi:ss') and hom_org_id = 'ANS'") \
...
void CHMSAnestheticScheduleList::OnListDblClick(){
	
} 
void CHMSAnestheticScheduleList::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(nNewItem < 0) return;
...
int CHMSAnestheticScheduleList::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMSAnestheticScheduleList::OnListLoadData(){
CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szWhere;
...
void CHMSAnestheticScheduleList::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CHMSAnestheticScheduleMaterialPopup dlg(this);
	if(dlg.DoModal() == IDOK){
		OnOrderListLoadData();
		m_wndOrderList.SetCurSel(m_wndOrderList.GetItemCount()-1);
	}
} 
void CHMSAnestheticScheduleList::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteHMSAnestheticScheduleList();
} 
void CHMSAnestheticScheduleList::OnConfirmSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szSQL;
...
void CHMSAnestheticScheduleList::OnDiscardSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szSQL;
...
void CHMSAnestheticScheduleList::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	TranslateString(_T("Phi\x1EBFu g\xE2y m\xEA (\x62\x61o g\x1ED3m \x64\x1EF1 tr\xF9 v\x1EADt t\x1B0)"), tmpStr);
	menu.AppendMenu(MF_BYPOSITION, 1, tmpStr);
	//menu.AppendMenu(MF_SEPARATOR, 0, _T("-"));
	TranslateString(_T("Phi\x1EBFu g\xE2y m\xEA kh\xF4ng \x62\x61o g\x1ED3m v\x1EADt t\x1B0"), tmpStr);
...
void CHMSAnestheticScheduleList::OnPrintMaterialOrder()
{
...
int CHMSAnestheticScheduleList::OnAddHMSAnestheticScheduleList(){
...
int CHMSAnestheticScheduleList::OnEditHMSAnestheticScheduleList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSAnestheticScheduleList::OnDeleteHMSAnestheticScheduleList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
	...
	if(nSel < 0 || m_wndList.GetItemCount() > 0)
		return 0;
...
int CHMSAnestheticScheduleList::OnSaveHMSAnestheticScheduleList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnHMSAnestheticScheduleListListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CHMSAnestheticScheduleList::OnCancelHMSAnestheticScheduleList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSAnestheticScheduleList::OnHMSAnestheticScheduleListListLoadData(){
	return 0;
}

LRESULT CHMSAnestheticScheduleList::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
...
void CHMSAnestheticScheduleList::PrintOperationOrder(bool bPrintAll, bool bPreview)
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	rpt.GetReportHeader()->SetValue(_T("ReportName"), _T("PHI\x1EBEU G\xC2Y M\xCA"));
...
void CHMSAnestheticScheduleList::PrintOperationOrder2(bool bPrintAll, bool bPreview)
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CRecord rss(&pMF->m_db);
...
void CHMSAnestheticScheduleList::PrintBBMaterial()
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CRecord rss(&pMF->m_db);
...
void CHMSAnestheticScheduleList::OnExportOperationOrder(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
...
CString CHMSAnestheticScheduleList::GetQueryString(bool bPrintAll)
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	...
	szSQL.Format(_T(" select ho_deptid as deptid,") \
				...
				_T("		(select hb_roomid from hms_bed where hb_docno = hd_docno and hb_status = 'O' AND hb_deptid = ho_deptid) room") \
				_T(" from hms_operation") \
				...
				_T(" left join sys_dept on(sd_id=ho_deptid)") \
				_T(" where ho_matorder_id=%ld") \
				_T(" order by ho_deptid, ho_opera_table, ho_opera_index "), m_nMatOID);

	return szSQL;
}

void CHMSAnestheticScheduleList::OnAddPatientOrder()
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	int nSel = m_wndOrderList.GetCurSel();
	if(nSel < 0)
	...
	CHMSAnestheticSchedulePatientListDialog dlg(this);
	dlg.m_nOID = m_nMatOID;
	dlg.m_szDeptId = pMF->m_szDept;
	dlg.m_szOrderDate = m_wndOrderList.GetItemText(nSel, 2);
