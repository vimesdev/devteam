#ifndef HMSPACSRESULTDIALOG_H
#define HMSPACSRESULTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSPACSResultDialog : public CGuiDialog{
protected:
public:
	...
	int OnAddHMSPACSResultDialog(); 
	int OnEditHMSPACSResultDialog(); 
	int OnDeleteHMSPACSResultDialog(); 
	int OnSaveHMSPACSResultDialog(); 
	int OnCancelHMSPACSResultDialog(); 
	int OnHMSPACSResultDialogListLoadData(); 
};
#endif
