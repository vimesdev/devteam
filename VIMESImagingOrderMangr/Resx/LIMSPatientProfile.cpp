...
void CLIMSPatientProfile::OnCreateComponents(){
	m_wndPatientProfile.Create(this, _T("Patient Profile"), 5, 5, 1020, 655);
	...
	m_wndBarcodeLabel.Create(this, _T("Barcode"), 205, 29, 290, 54);
	m_wndBarcode.Create(this,295, 29, 415, 54); 
	...
	m_wndTestList.Create(this,420, 30, 1015, 650); 
