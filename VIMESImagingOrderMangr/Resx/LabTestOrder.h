#ifndef LABTESTORDER_H
#define LABTESTORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class CLabTestOrder : public CGuiView{
protected:
public:
	...
	int OnAddLabTestOrder(); 
	int OnEditLabTestOrder(); 
	int OnDeleteLabTestOrder(); 
	int OnSaveLabTestOrder(); 
	int OnCancelLabTestOrder(); 
	int OnLabTestOrderListLoadData(); 
};
#endif
