#ifndef PCMSPATIENTPROFILE_H
#define PCMSPATIENTPROFILE_H
...
#include "GuiView.h"
#include "DbField.h"
class CPCMSPatientProfile : public CGuiView{
protected:
public:
	...
	int OnAddPCMSPatientProfile(); 
	int OnEditPCMSPatientProfile(); 
	int OnDeletePCMSPatientProfile(); 
	int OnSavePCMSPatientProfile(); 
	int OnCancelPCMSPatientProfile(); 
	int OnPCMSPatientProfileListLoadData(); 
};
#endif
