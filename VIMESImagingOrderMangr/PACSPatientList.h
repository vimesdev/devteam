...
protected:
public:
	CHMSPendingInfoView	m_wndPendingInfo;
	...
	CGuiCheckBox	m_wndLoadByPACSMap;
	int	m_nWaitting;
	int	m_nPerformed;
	...
	int			OnListCallPatient();
	int			OnListCancelPending();
	void			OnLoadByPACSMapSelect();
	void OnEmptyPerformRoom();
	int			OnExportPatientListSelect();

	int			OnListCheckAll();
	int			OnListUnCheckAll();
	int			OnChangePerformRoom();
