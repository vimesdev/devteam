#ifndef HMSTREATMOVEMENTDIALOGV2_H
#define HMSTREATMOVEMENTDIALOGV2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSTreatMovementDialogV2 : public CGuiDialog
{
...
public:
	...
	void			OnCloseSelect();
	void			OnAddSelect();
	CHMSTreatMovementDialogV2(CWnd *pParent);
	~CHMSTreatMovementDialogV2();
