#ifndef AllocateMaterialOrderList_H
#define AllocateMaterialOrderList_H
...
class CAllocateMaterialOrderList : public CGuiView{
protected:
public:
	CWnd*			m_wndOrder;
	bool			m_bImportType;
	...
	int OnAddAllocateMaterialOrderList(); 
	int OnEditAllocateMaterialOrderList(); 
	int OnDeleteAllocateMaterialOrderList(); 
	int OnSaveAllocateMaterialOrderList(); 
	int OnCancelAllocateMaterialOrderList(); 
	int OnAllocateMaterialOrderListListLoadData(); 
