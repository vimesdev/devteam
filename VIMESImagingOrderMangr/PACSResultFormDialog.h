...
class CPACSViewFrom: public CScrollView{
public:
	CPACSViewFrom(){};
	~CPACSViewFrom(){};
...
public:
	...
	CGuiLabel		m_wndMenuLabel;
	CGuiComboBox	m_wndMenu;
	...
	void			OnMenuSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnMenuSelendok(); 
	//void			OnMenuSetfocus(); 
	//void			OnMenuKillfocus(); 
	long			OnMenuLoadData(); 
	void			OnMenuAddNew(); 
