...
static void _OnProductSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CAllocateMaterialOrderLineInput* )pWnd)->OnProductSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnProductSelendokFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnProductSelendok();
}
/*static void _OnProductSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnProductKillfocus();
}*/
/*static void _OnProductKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnProductKillfocus();
}*/
static long _OnProductLoadDataFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnProductLoadData();
}
/*static void _OnProductAddNewFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnProductAddNew();
}*/
/*static void _OnUomChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnUomChange();
} */
/*static void _OnUomSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnUomSetfocus();} */ 
/*static void _OnUomKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnUomKillfocus();
} */
static int _OnUomCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnUomCheckValue();
} 
/*static void _OnSoldierChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierChange();
} */
/*static void _OnSoldierSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierSetfocus();} */ 
/*static void _OnSoldierKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierKillfocus();
} */
static int _OnSoldierCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierCheckValue();
} 
/*static void _OnPolicyChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnPolicyChange();
} */
/*static void _OnPolicySetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnPolicySetfocus();} */ 
/*static void _OnPolicyKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnPolicyKillfocus();
} */
static int _OnPolicyCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnPolicyCheckValue();
} 
/*static void _OnSoldierInsurnaceChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierInsurnaceChange();
} */
/*static void _OnSoldierInsurnaceSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierInsurnaceSetfocus();} */ 
/*static void _OnSoldierInsurnaceKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierInsurnaceKillfocus();
} */
static int _OnSoldierInsurnaceCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnSoldierInsurnaceCheckValue();
} 
/*static void _OnOnHandChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOnHandChange();
} */
/*static void _OnOnHandSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOnHandSetfocus();} */ 
/*static void _OnOnHandKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOnHandKillfocus();
} */
static int _OnOnHandCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnOnHandCheckValue();
} 
/*static void _OnOtherInsuranceChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherInsuranceChange();
} */
/*static void _OnOtherInsuranceSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherInsuranceSetfocus();} */ 
/*static void _OnOtherInsuranceKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherInsuranceKillfocus();
} */
static int _OnOtherInsuranceCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherInsuranceCheckValue();
} 
/*static void _OnServiceChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnServiceChange();
} */
/*static void _OnServiceSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnServiceSetfocus();} */ 
/*static void _OnServiceKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnServiceKillfocus();
} */
static int _OnServiceCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnServiceCheckValue();
} 
/*static void _OnOtherChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherChange();
} */
/*static void _OnOtherSetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherSetfocus();} */ 
/*static void _OnOtherKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherKillfocus();
} */
static int _OnOtherCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnOtherCheckValue();
} 
/*static void _OnSumQuantityChangeFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSumQuantityChange();
} */
/*static void _OnSumQuantitySetfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSumQuantitySetfocus();} */ 
/*static void _OnSumQuantityKillfocusFnc(CWnd *pWnd){
	((CAllocateMaterialOrderLineInput *)pWnd)->OnSumQuantityKillfocus();
} */
static int _OnSumQuantityCheckValueFnc(CWnd *pWnd){
	return ((CAllocateMaterialOrderLineInput *)pWnd)->OnSumQuantityCheckValue();
} 
static void _OnSaveSelectFnc(CWnd *pWnd){
	CAllocateMaterialOrderLineInput *pVw = (CAllocateMaterialOrderLineInput *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddStorageTransactionLineInputFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderLineInput*)pWnd)->OnAddStorageTransactionLineInput();
} 
static int _OnEditStorageTransactionLineInputFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderLineInput*)pWnd)->OnEditStorageTransactionLineInput();
} 
static int _OnDeleteStorageTransactionLineInputFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderLineInput*)pWnd)->OnDeleteStorageTransactionLineInput();
} 
static int _OnSaveStorageTransactionLineInputFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderLineInput*)pWnd)->OnSaveStorageTransactionLineInput();
} 
static int _OnCancelStorageTransactionLineInputFnc(CWnd *pWnd){
	 return ((CAllocateMaterialOrderLineInput*)pWnd)->OnCancelStorageTransactionLineInput();
} 
CAllocateMaterialOrderLineInput::CAllocateMaterialOrderLineInput(CWnd *pParent, int nMode):
	CGuiPopup(pParent){
...
CAllocateMaterialOrderLineInput::~CAllocateMaterialOrderLineInput(){
}
void CAllocateMaterialOrderLineInput::OnCreateComponents(){
...
void CAllocateMaterialOrderLineInput::OnInitializeComponents(){
...
void CAllocateMaterialOrderLineInput::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CAllocateMaterialOrderLineInput::OnDoDataExchange(CDataExchange* pDX){
...
void CAllocateMaterialOrderLineInput::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CAllocateMaterialOrderLineInput::GetScreenToData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CAllocateMaterialOrderLineInput::SetDefaultValues(){
...
int CAllocateMaterialOrderLineInput::SetMode(int nMode){
...
void CAllocateMaterialOrderLineInput::OnProductSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CAllocateMaterialOrderLineInput::OnProductSelendok(){
	UpdateData(TRUE);
	m_szUom = m_wndProduct.GetCurrent(4);
	m_nOnHand = str2long(m_wndProduct.GetCurrent(8));
	UpdateData(FALSE); 
}
/*void CAllocateMaterialOrderLineInput::OnProductSetfocus(){
	
}*/
/*void CAllocateMaterialOrderLineInput::OnProductKillfocus(){
	
}*/
long CAllocateMaterialOrderLineInput::OnProductLoadData(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CAllocateMaterialOrderLineInput::OnProductAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CAllocateMaterialOrderLineInput::OnUomChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnUomSetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnUomKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnUomCheckValue(){
	return 0;
} 
/*void CAllocateMaterialOrderLineInput::OnSoldierChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnSoldierSetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnSoldierKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnSoldierCheckValue(){
	if(CheckQuantity())
		return 0;
	return -1;
} 
/*void CAllocateMaterialOrderLineInput::OnPolicyChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnPolicySetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnPolicyKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnPolicyCheckValue(){
	if(CheckQuantity())
		return 0;
	return -1;
} 
/*void CAllocateMaterialOrderLineInput::OnSoldierInsurnaceChange(){

	
} */
/*void CAllocateMaterialOrderLineInput::OnSoldierInsurnaceSetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnSoldierInsurnaceKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnSoldierInsurnaceCheckValue(){
	if(CheckQuantity())
		return 0;
	return -1;
} 
/*void CAllocateMaterialOrderLineInput::OnOnHandChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnOnHandSetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnOnHandKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnOnHandCheckValue(){
	if(CheckQuantity())
		return 0;
	return -1;
} 
/*void CAllocateMaterialOrderLineInput::OnOtherInsuranceChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnOtherInsuranceSetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnOtherInsuranceKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnOtherInsuranceCheckValue(){
	if(CheckQuantity())
		return 0;
	return -1;
} 
/*void CAllocateMaterialOrderLineInput::OnServiceChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnServiceSetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnServiceKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnServiceCheckValue(){
	if(CheckQuantity())
		return 0;
	return -1;
} 
/*void CAllocateMaterialOrderLineInput::OnOtherChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnOtherSetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnOtherKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnOtherCheckValue(){
	if(CheckQuantity())
		return 0;
	return -1;
} 
/*void CAllocateMaterialOrderLineInput::OnSumQuantityChange(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnSumQuantitySetfocus(){
	
} */
/*void CAllocateMaterialOrderLineInput::OnSumQuantityKillfocus(){
	
} */
int CAllocateMaterialOrderLineInput::OnSumQuantityCheckValue(){
	return 0;
} 
void CAllocateMaterialOrderLineInput::OnSaveSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnSaveStorageTransactionLineInput();
} 
void CAllocateMaterialOrderLineInput::OnCloseSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiPopup::ClosePopup();
} 
int CAllocateMaterialOrderLineInput::OnAddStorageTransactionLineInput(){
...
int CAllocateMaterialOrderLineInput::OnEditStorageTransactionLineInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CAllocateMaterialOrderLineInput::OnDeleteStorageTransactionLineInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CAllocateMaterialOrderLineInput::OnSaveStorageTransactionLineInput(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
	...
	szSQL.Format(_T("M_TRANSACTION_C_CREATELINE(%s) "), m_transactionlineTbl.FormatSQL()); 
 	...
 	if(ret > 0)
 	{
		((CAllocateMaterialOrder*) m_pWndOrder)->OnListLoadData();
		if(GetMode() == VM_ADD)
			SetMode(VM_ADD);
		else
			CGuiPopup::ClosePopup();
...
int CAllocateMaterialOrderLineInput::OnCancelStorageTransactionLineInput(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CAllocateMaterialOrderLineInput::OnStorageTransactionLineInputListLoadData(){
	return 0;
}

bool CAllocateMaterialOrderLineInput::CheckQuantity(){
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CString szSQL;
	UpdateData(TRUE);
	m_nProductItemID = str2long(m_wndProduct.GetCurrent(0));
