#ifndef CTMDRUGCABINETUSEDREPORT_H
#define CTMDRUGCABINETUSEDREPORT_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CTMDrugCabinetUsedReport : public CGuiDialog{
protected:
public:
	...
	void			OnPrintLandscapeSelect();
	void			OnPrintPreviewSelect(); 
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CTMDrugCabinetUsedReport(CWnd *pParent);
	~CTMDrugCabinetUsedReport();
	...
	int OnAddCTMDrugCabinetUsedReport(); 
	int OnEditCTMDrugCabinetUsedReport(); 
	int OnDeleteCTMDrugCabinetUsedReport(); 
	int OnSaveCTMDrugCabinetUsedReport(); 
	int OnCancelCTMDrugCabinetUsedReport(); 
	int OnCTMDrugCabinetUsedReportListLoadData(); 
};
#endif
