#ifndef HMSROOMEXAMINATIONREPORTDIALOG_H
#define HMSROOMEXAMINATIONREPORTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSRoomExaminationReportDialog : public CGuiDialog{
protected:
public:
	...
	CHMSRoomExaminationReportDialog(CWnd *pParent);
	~CHMSRoomExaminationReportDialog();
	...
	int OnAddHMSRoomExaminationReportDialog(); 
	int OnEditHMSRoomExaminationReportDialog(); 
	int OnDeleteHMSRoomExaminationReportDialog(); 
	int OnSaveHMSRoomExaminationReportDialog(); 
	int OnCancelHMSRoomExaminationReportDialog(); 
	int OnHMSRoomExaminationReportDialogListLoadData(); 
	void PrintTonghoptheotieuban(bool m_bPreview);
	void ExportTonghoptheotieuban();
};
#endif
