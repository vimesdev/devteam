#ifndef PCMSCHANGEORDERDIALOG_H
#define PCMSCHANGEORDERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CPCMSChangeOrderDialog : public CGuiDialog
{
protected:
...
public:
	...
	void			OnApplySelect(); 
	void			OnCancelSelect(); 
	CPCMSChangeOrderDialog(CWnd *pParent);
	~CPCMSChangeOrderDialog();
