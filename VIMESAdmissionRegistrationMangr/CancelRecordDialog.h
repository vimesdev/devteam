#ifndef CANCELRECORDDIALOG_H
#define CANCELRECORDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCancelRecordDialog : public CGuiDialog{
protected:
public:
	CGuiGroupBox	m_wndCancelRecord;
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CCancelRecordDialog(CWnd *pParent);
	~CCancelRecordDialog();
	...
	int OnAddCancelRecordDialog(); 
	int OnEditCancelRecordDialog(); 
	int OnDeleteCancelRecordDialog(); 
	int OnSaveCancelRecordDialog(); 
	int OnCancelCancelRecordDialog(); 
	int OnCancelRecordDialogListLoadData(); 
};
#endif
