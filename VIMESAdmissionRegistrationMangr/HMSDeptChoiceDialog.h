#ifndef HMSDEPTCHOICEDIALOG_H
#define HMSDEPTCHOICEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSDeptChoiceDialog : public CGuiDialog{
protected:
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSDeptChoiceDialog(CWnd *pParent);
	~CHMSDeptChoiceDialog();
	...
	int OnAddHMSDeptChoiceDialog(); 
	int OnEditHMSDeptChoiceDialog(); 
	int OnDeleteHMSDeptChoiceDialog(); 
	int OnSaveHMSDeptChoiceDialog(); 
	int OnCancelHMSDeptChoiceDialog(); 
	int OnHMSDeptChoiceDialogListLoadData(); 
};
#endif
