#include "FABankStatementList.h"
#include "MainFrame_E10.h"
#include "FABankStatementDialog.h"
#include "HMSReportForms/PrintForms.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CFABankStatementList *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CFABankStatementList *)pWnd)->OnToDateCheckValue();
} 
static void _OnObjectTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CFABankStatementList* )pWnd)->OnObjectTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnObjectTypeSelendokFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnObjectTypeSelendok();
}
/*static void _OnObjectTypeSetfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnObjectTypeKillfocus();
}*/
/*static void _OnObjectTypeKillfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnObjectTypeKillfocus();
}*/
static long _OnObjectTypeLoadDataFnc(CWnd *pWnd){
	return ((CFABankStatementList *)pWnd)->OnObjectTypeLoadData();
}
/*static void _OnObjectTypeAddNewFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnObjectTypeAddNew();
}*/
/*static void _OnInvoiceNoChangeFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnInvoiceNoChange();
} */
/*static void _OnInvoiceNoSetfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnInvoiceNoSetfocus();} */ 
/*static void _OnInvoiceNoKillfocusFnc(CWnd *pWnd){
	((CFABankStatementList *)pWnd)->OnInvoiceNoKillfocus();
} */
static int _OnInvoiceNoCheckValueFnc(CWnd *pWnd){
	return ((CFABankStatementList *)pWnd)->OnInvoiceNoCheckValue();
} 
static void _OnReloadSelectFnc(CWnd *pWnd){
	CFABankStatementList *pVw = (CFABankStatementList *)pWnd;
	pVw->OnReloadSelect();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CFABankStatementList*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CFABankStatementList*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CFABankStatementList*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
}

static int _OnListAddItemFnc(CWnd *pWnd){
	 return ((CFABankStatementList*)pWnd)->OnListDeleteItem();
}
...
static int _OnAddFABankStatementListFnc(CWnd *pWnd){
	 return ((CFABankStatementList*)pWnd)->OnAddFABankStatementList();
} 
static int _OnEditFABankStatementListFnc(CWnd *pWnd){
	 return ((CFABankStatementList*)pWnd)->OnEditFABankStatementList();
} 
static int _OnDeleteFABankStatementListFnc(CWnd *pWnd){
	 return ((CFABankStatementList*)pWnd)->OnDeleteFABankStatementList();
} 
static int _OnSaveFABankStatementListFnc(CWnd *pWnd){
	 return ((CFABankStatementList*)pWnd)->OnSaveFABankStatementList();
} 
static int _OnCancelFABankStatementListFnc(CWnd *pWnd){
	 return ((CFABankStatementList*)pWnd)->OnCancelFABankStatementList();
} 
CFABankStatementList::CFABankStatementList(){
...
void CFABankStatementList::OnCreateComponents(){
...
void CFABankStatementList::OnInitializeComponents(){
...
void CFABankStatementList::OnSetWindowEvents(){
...
/*
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddFABankStatementListFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditFABankStatementListFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteFABankStatementListFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveFABankStatementListFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelFABankStatementListFnc, 0, 'T', VK_CONTROL);
*/
	SetMode(VM_NONE);
	OnListLoadData();
}
void CFABankStatementList::OnDoDataExchange(CDataExchange* pDX){
...
void CFABankStatementList::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CFABankStatementList::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CFABankStatementList::SetDefaultValues(){
...
int CFABankStatementList::SetMode(int nMode){
...
/*void CFABankStatementList::OnFromDateChange(){
	
} */
/*void CFABankStatementList::OnFromDateSetfocus(){
	
} */
/*void CFABankStatementList::OnFromDateKillfocus(){
	
} */
int CFABankStatementList::OnFromDateCheckValue(){
	return 0;
} 
/*void CFABankStatementList::OnToDateChange(){
	
} */
/*void CFABankStatementList::OnToDateSetfocus(){
	
} */
/*void CFABankStatementList::OnToDateKillfocus(){
	
} */
int CFABankStatementList::OnToDateCheckValue(){
	return 0;
...
void CFABankStatementList::OnObjectTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CFABankStatementList::OnObjectTypeSelendok(){
	 
}
/*void CFABankStatementList::OnObjectTypeSetfocus(){
	
}*/
/*void CFABankStatementList::OnObjectTypeKillfocus(){
	
}*/
long CFABankStatementList::OnObjectTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CFABankStatementList::OnObjectTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CFABankStatementList::OnInvoiceNoChange(){
	
} */
/*void CFABankStatementList::OnInvoiceNoSetfocus(){
	
} */
/*void CFABankStatementList::OnInvoiceNoKillfocus(){
	
} */
int CFABankStatementList::OnInvoiceNoCheckValue(){
	return 0;
} 
void CFABankStatementList::OnReloadSelect(){
	_debug(_T("%s"), CString(typeid(this).name()));
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
	OnListLoadData();
} 
void CFABankStatementList::OnListDblClick(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnViewSelect();

} 
void CFABankStatementList::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CFABankStatementList::OnListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDeleteFABankStatementList();
	 return 0;
} 
long CFABankStatementList::OnListLoadData(){
...
void CFABankStatementList::OnViewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	CFABankStatementDialog dlg(this, m_szDocType, m_nInvoiceID, VM_VIEW);
	if(dlg.DoModal() == IDOK){
	}
...
void CFABankStatementList::OnAddSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

	CFABankStatementDialog dlg(this, m_szDocType, m_nInvoiceID, VM_ADD);
	if(dlg.DoModal() == IDOK){
	}
	Refresh();
} 
void CFABankStatementList::OnEditSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CFABankStatementDialog dlg(this, m_szDocType, m_nInvoiceID, VM_EDIT);
	if(dlg.DoModal() == IDOK){
	}
	Refresh();
} 
void CFABankStatementList::OnDeleteSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	Refresh();
} 
int CFABankStatementList::OnAddFABankStatementList(){
...
int CFABankStatementList::OnEditFABankStatementList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CFABankStatementList::OnDeleteFABankStatementList(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
...
int CFABankStatementList::OnSaveFABankStatementList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnFABankStatementListListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CFABankStatementList::OnCancelFABankStatementList(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CFABankStatementList::OnFABankStatementListListLoadData(){
	return 0;
}

void CFABankStatementList::SetDocType(CString szType){
	m_szDocType =szType;
}
void CFABankStatementList::Refresh(){
	int nSel = m_wndList.GetCurSel();
	OnListLoadData();
	m_wndList.SetCurSel(nSel);
}
void CFABankStatementList::Print(){
	UpdateData(true);
	CPrintForms printer;
