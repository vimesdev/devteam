#ifndef FABankStatementINPUTENTRY_H
#define FABankStatementINPUTENTRY_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CFABankStatementInputEntry : public CGuiPopup{
protected:
public:
	...
	CFABankStatementInputEntry(CWnd *pParent, CString szDocType, long nInvoiceID, int nMode, BOOL bTaxIncluded = TRUE);
	~CFABankStatementInputEntry();
	...
	int OnAddFABankStatementInputEntry(); 
	int OnEditFABankStatementInputEntry(); 
	int OnDeleteFABankStatementInputEntry(); 
	int OnSaveFABankStatementInputEntry(); 
	int OnCancelFABankStatementInputEntry(); 
	int OnFABankStatementInputEntryListLoadData(); 
};
#endif
