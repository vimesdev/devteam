#ifndef POAUTOCREATEITEMDIALOG_V2_H
#define POAUTOCREATEITEMDIALOG_V2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CPOAutoCreateItemDialog_V2 : public CGuiDialog
{
protected:
public:
	CString			m_szOrderClass;
	CString			m_szParterID;
	int				m_nTemplateStorage_ID;
	...
	int			OnSelectedListEditQuantity(); 
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CPOAutoCreateItemDialog_V2(CWnd *pParent);
	~CPOAutoCreateItemDialog_V2();
