...
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMSPrescriptionOrder* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder *)pWnd)->OnDepartmentKillfocus();
}*/
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CPMSPrescriptionOrder *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder *)pWnd)->OnDepartmentAddNew();
}*/
...
static int _OnPatientListIssueFnc(CWnd *pWnd){
	 return ((CPMSPrescriptionOrder*)pWnd)->OnPatientListIssue();
} 

static int _OnPatientListRollbackFnc(CWnd *pWnd){
	 return ((CPMSPrescriptionOrder*)pWnd)->OnPatientListRollback();
}

static int _OnPatientListRollback2Fnc(CWnd *pWnd){
	 return ((CPMSPrescriptionOrder*)pWnd)->OnPatientListRollback2();
}

static int _OnPatientListResetPrintFnc(CWnd *pWnd){
	 return ((CPMSPrescriptionOrder*)pWnd)->OnPatientListResetPrint();
}

static int _OnPatientListPostNationalGateFnc(CWnd *pWnd){
	return ((CPMSPrescriptionOrder*)pWnd)->OnPatientListPostNationalGate();
}
static int _OnPatientListRecalcFnc(CWnd *pWnd){
	 ((CPMSPrescriptionOrder*)pWnd)->OnRecalcOrder();
	 return 0;
}
static int _OnPatientListCancelOrderFnc(CWnd *pWnd){
	 return ((CPMSPrescriptionOrder*)pWnd)->OnPatientListCancelOrder();
} 

static int _OnPatientListPrintFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder*)pWnd)->m_bPreview = false;
	 ((CPMSPrescriptionOrder*)pWnd)->OnPrintSelect();
	 return 0;
} 

static int _OnPatientListPrintPreviewFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder*)pWnd)->m_bPreview = true;
	 ((CPMSPrescriptionOrder*)pWnd)->OnPrintSelect();
	 return 0;
}
...
static int _OnPatientListReturnFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder*)pWnd)->m_bPreview = false;
	 ((CPMSPrescriptionOrder*)pWnd)->OnReturnSelect();
	 return 0;
}

static int _OnPatientListRefreshFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder*)pWnd)->OnPatientListLoadData();
	 return 0;
} 
...
static int _OnDrugListRollbackFnc(CWnd *pWnd){
	 return ((CPMSPrescriptionOrder*)pWnd)->OnDrugListRollback();
}
...
/*static void _OnTotalPaymentChangeFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder *)pWnd)->OnTotalPaymentChange();
} */
/*static void _OnTotalPaymentSetfocusFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder *)pWnd)->OnTotalPaymentSetfocus();} */ 
/*static void _OnTotalPaymentKillfocusFnc(CWnd *pWnd){
	((CPMSPrescriptionOrder *)pWnd)->OnTotalPaymentKillfocus();
} */
static int _OnTotalPaymentCheckValueFnc(CWnd *pWnd){
	return ((CPMSPrescriptionOrder *)pWnd)->OnTotalPaymentCheckValue();
} 
...
{
	return ((CPMSPrescriptionOrder*)pWnd)->ExportPatientListToExcel();
}
...
void CPMSPrescriptionOrder::OnInitializeComponents(){
	...
	m_wndPatientList.InsertColumn(3, _T("Approved Date"), CFMT_DATETIME, 90);
	...
	m_wndPatientList.InsertColumn(11, _T("Ngày thu"), CFMT_DATETIME, 90);
	m_wndPatientList.InsertColumn(12, _T("Ngày khóa sổ"), CFMT_DATETIME, 90);
	m_wndPatientList.InsertColumn(13, _T("Approved By"), CFMT_TEXT, 40);
	m_wndPatientList.InsertColumn(14, _T("Doctor"), CFMT_TEXT, 40);
	m_wndPatientList.InsertColumn(15, _T("Liên thông"), CFMT_TEXT, 50);
...
//	m_wndDrugList.InsertColumn(7, _T("Mfg Name"), CFMT_TEXT, 100);
	...
	m_wndDrugList.InsertColumn(12, _T("Trạng thái phí"), CFMT_TEXT|CFMT_CENTER, 80);
...
void CPMSPrescriptionOrder::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMSPrescriptionOrder::OnDepartmentSelendok(){
//	OnPatientListLoadData(); 
}
/*void CPMSPrescriptionOrder::OnDepartmentSetfocus(){
	
}*/
/*void CPMSPrescriptionOrder::OnDepartmentKillfocus(){
	
}*/
long CPMSPrescriptionOrder::OnDepartmentLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	szWhere.Empty();
...
/*void CPMSPrescriptionOrder::OnDepartmentAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CPMSPrescriptionOrder::OnPatientListIssue(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnIssueSelect();
	 return 0;
} 
int CPMSPrescriptionOrder::OnPatientListRollback(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnRollbackOrder();
	return 0;
} 

int CPMSPrescriptionOrder::OnPatientListRollback2()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CPMSPrescriptionOrder::OnDrugListRollback()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL, szEvent, szDesc;
	long nOrderID = 0, nDocNo = 0;
...
int CPMSPrescriptionOrder::OnPatientListResetPrint(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL, szEvent, szDesc;
	long nOrderID = 0, nDocNo = 0;
...
int CPMSPrescriptionOrder::OnPatientListCancelOrder(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnCancelSelect();
	 return 0;
}
...
long CPMSPrescriptionOrder::OnPatientListLoadData()
{
	...
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere, tmpStr, szOrderBy, szObjectType, szFromDate, szToDate;
	...
	m_wndDrugList.DeleteAllItems();
	szFromDate.Format(_T("%s 00:00:00"), m_szFromDate);
	szToDate.Format(_T("%s 23:59:00"), m_szToDate);
	...
	else
	{
		if(m_szStorageKey != _T("P"))
			...
			szWhere.AppendFormat(_T(" AND ((hpo_orderstatus NOT IN ('O', 'C')) or hpo_orderstatus = 'C')"));
		else
	...
	_T("   hlo_posted as post_status, NVL(hms_get_paid_drug(hpo_docno, hpo_orderid), 'N') as ispayment,") \
	...
	_T(" LEFT JOIN hms_lienthong_order ON (hlo_orderid = hpo_orderid and hlo_docno = hpo_docno)") \
...
void CPMSPrescriptionOrder::OnRollbackOrder(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CPMSPrescriptionOrder::OnRecalcOrder(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CPMSPrescriptionOrder::OnReturnSelect(){
	int nSel  = m_wndPatientList.GetCurSel();
	if(nSel < 0) return;
...
/*void CPMSPrescriptionOrder::OnTotalPaymentChange(){
	
} */
/*void CPMSPrescriptionOrder::OnTotalPaymentSetfocus(){
	
} */
/*void CPMSPrescriptionOrder::OnTotalPaymentKillfocus(){
	
} */
int CPMSPrescriptionOrder::OnTotalPaymentCheckValue(){
	return 0;
} 
...
CString CPMSPrescriptionOrder::GetCurrentStatus(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
	CString szSQL, szStatus;
...
void CPMSPrescriptionOrder::ShowDetail(bool bDetail){
	/*if(bDetail){
...
} BEGIN_MESSAGE_MAP(CPMSPrescriptionOrder, CGuiView)
ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CPMSPrescriptionOrder::OnSetFocus(CWnd* pOldWnd)
{
...
BOOL CPMSPrescriptionOrder::PreTranslateMessage(MSG* pMsg)
{
...
int CPMSPrescriptionOrder::OnPatientListPostNationalGate()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CPMSPrescriptionOrder::ExportPatientListToExcel()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData(true);
...
void CPMSPrescriptionOrder::FocusFirstRow()
{
    int count = m_wndPatientList.GetItemCount();
    if (count > 0)
    {
        m_wndPatientList.SetCurSel(0);
        m_wndPatientList.SetFocus();
    }
}

void CPMSPrescriptionOrder::OnResizeLayout()
{
