#ifndef STORAGEDELIVERYORDERLINEINPUT_H
#define STORAGEDELIVERYORDERLINEINPUT_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CStorageDeliveryOrderLineInput : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CStorageDeliveryOrderLineInput(CWnd *pParent, int nMode);
	~CStorageDeliveryOrderLineInput();
	...
	int OnAddStorageDeliveryOrderLineInput(); 
	int OnEditStorageDeliveryOrderLineInput(); 
	int OnDeleteStorageDeliveryOrderLineInput(); 
	int OnSaveStorageDeliveryOrderLineInput(); 
	int OnCancelStorageDeliveryOrderLineInput(); 
	int OnStorageDeliveryOrderLineInputListLoadData(); 
};
#endif
