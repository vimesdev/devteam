#ifndef STORAGETRANSACTIONLIST_H
#define STORAGETRANSACTIONLIST_H
...
class AFX_EXT_CLASS CStorageTransactionList : public CGuiView{
protected:
public:
	CWnd*			m_wndOrder;
	bool			m_bImportType;
	...
	int OnAddStorageTransactionList(); 
	int OnEditStorageTransactionList(); 
	int OnDeleteStorageTransactionList(); 
	int OnSaveStorageTransactionList(); 
	int OnCancelStorageTransactionList(); 
	int OnStorageTransactionListListLoadData(); 
