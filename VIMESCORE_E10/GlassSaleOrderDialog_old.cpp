...
static int _OnTypeCheckValueFnc(CWnd *pWnd){
	return ((CGlassSaleOrderDialog*)pWnd)->OnTypeCheckValue();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnTypeAddNew();
}*/
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CGlassSaleOrderDialog* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CGlassSaleOrderDialog *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnDeptAddNew();
}*/
...
/*static void _OnApprovedDateChangeFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnApprovedDateChange();
} */
/*static void _OnApprovedDateSetfocusFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnApprovedDateSetfocus();} */ 
/*static void _OnApprovedDateKillfocusFnc(CWnd *pWnd){
	((CGlassSaleOrderDialog *)pWnd)->OnApprovedDateKillfocus();
} */
static int _OnApprovedDateCheckValueFnc(CWnd *pWnd){
	return ((CGlassSaleOrderDialog *)pWnd)->OnApprovedDateCheckValue();
} 
...
static int _OnListAddItemFnc(CWnd *pWnd){
	 return ((CGlassSaleOrderDialog*)pWnd)->OnListAddItem();
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CGlassSaleOrderDialog*)pWnd)->OnListDeleteItem();
}
static int _OnListPostToDuocQGFnc(CWnd *pWnd){
	 return ((CGlassSaleOrderDialog*)pWnd)->OnListPostToDuocQG();
}

static int _OnListRefreshItemFnc(CWnd *pWnd){
	 return ((CGlassSaleOrderDialog*)pWnd)->OnListRefreshItem();
} 
static int _OnListPaymentFnc(CWnd *pWnd){
	return ((CGlassSaleOrderDialog*)pWnd)->OnListPayment();
} 
...
static int _OnDiscardGlassSaleOrderDialogFnc(CWnd *pWnd){
	 return ((CGlassSaleOrderDialog*)pWnd)->OnDiscardGlassSaleOrderDialog();
} 
CGlassSaleOrderDialog::CGlassSaleOrderDialog(CWnd *pParent, int nMode):
	CGuiDialog(pParent){
...
void CGlassSaleOrderDialog::OnCreateComponents(){
	...
	m_wndCustomerName.Create(this,115, 60, 365, 85); 
	...
	m_wndAdd.Create(this, _T("&Add"), 250, 575, 320, 600);
	m_wndEdit.Create(this, _T("&Edit"), 325, 575, 395, 600);
	m_wndDelete.Create(this, _T("&Delete"), 400, 575, 470, 600);
	m_wndSave.Create(this, _T("&Save"), 475, 575, 545, 600);
	m_wndDiscard.Create(this, _T("&Cancel"), 550, 575, 620, 600);
	m_wndConfirm.Create(this, _T("&Confirm"), 625, 575, 715, 600);
	m_wndApproval.Create(this, _T("&Approval"), 720, 575, 805, 600);
	m_wndPrint.Create(this, _T("&Print"), 810, 575, 880, 600);
...
void CGlassSaleOrderDialog::OnInitializeParameters(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CGlassSaleOrderDialog::OnTypeCheckValue(){
	return 0;
}
void CGlassSaleOrderDialog::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CGlassSaleOrderDialog::OnDeptSelendok(){
	 
}
/*void CGlassSaleOrderDialog::OnDeptSetfocus(){
	
}*/
/*void CGlassSaleOrderDialog::OnDeptKillfocus(){
	
}*/
long CGlassSaleOrderDialog::OnDeptLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CGlassSaleOrderDialog::OnDeptAddNew(){
...
/*void CGlassSaleOrderDialog::OnApprovedDateChange(){
	
} */
/*void CGlassSaleOrderDialog::OnApprovedDateSetfocus(){
	
} */
/*void CGlassSaleOrderDialog::OnApprovedDateKillfocus(){
	
} */
int CGlassSaleOrderDialog::OnApprovedDateCheckValue(){
	return 0;
} 
...
void CGlassSaleOrderDialog::OnAddSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnAddGlassSaleOrderDialog();
} 
void CGlassSaleOrderDialog::OnEditSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnEditGlassSaleOrderDialog();
} 
void CGlassSaleOrderDialog::OnDeleteSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDeleteGlassSaleOrderDialog();
} 
void CGlassSaleOrderDialog::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveGlassSaleOrderDialog();
} 
void CGlassSaleOrderDialog::OnDiscardSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDiscardGlassSaleOrderDialog();
}
void CGlassSaleOrderDialog::OnConfirmSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CGlassSaleOrderDialog::OnAddLineSelect(){
	OnListAddItem();
}
...
int CGlassSaleOrderDialog::OnListAddItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
		return -1;
...
int CGlassSaleOrderDialog::OnListRefreshItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
	 return 0;
} 

int CGlassSaleOrderDialog::OnListPayment(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
...
int CGlassSaleOrderDialog::OnListPostToDuocQG(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CGlassSaleOrderDialog::OnDiscardGlassSaleOrderDialog(){
...
void CGlassSaleOrderDialog::PrintDrugDelivery(long nOrderID, bool bPreview, bool bDirect){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
	CReport rpt;
	CString tmpStr;
