...
static void _OnProductSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageTransactionLineInputEx* )pWnd)->OnProductSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnProductSelendokFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnProductSelendok();
}
/*static void _OnProductSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnProductKillfocus();
}*/
/*static void _OnProductKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnProductKillfocus();
}*/
static long _OnProductLoadDataFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnProductLoadData();
}
/*static void _OnProductAddNewFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnProductAddNew();
}*/
/*static void _OnUomChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnUomChange();
} */
/*static void _OnUomSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnUomSetfocus();} */ 
/*static void _OnUomKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnUomKillfocus();
} */
static int _OnUomCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnUomCheckValue();
} 
static void _OnManufactureSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageTransactionLineInputEx* )pWnd)->OnManufactureSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnManufactureSelendokFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnManufactureSelendok();
}
/*static void _OnManufactureSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnManufactureKillfocus();
}*/
/*static void _OnManufactureKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnManufactureKillfocus();
}*/
static long _OnManufactureLoadDataFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnManufactureLoadData();
}
/*static void _OnManufactureAddNewFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnManufactureAddNew();
}*/
/*static void _OnLotNoChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnLotNoChange();
} */
/*static void _OnLotNoSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnLotNoSetfocus();} */ 
/*static void _OnLotNoKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnLotNoKillfocus();
} */
static int _OnLotNoCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnLotNoCheckValue();
} 
/*static void _OnExprDateChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnExprDateChange();
} */
/*static void _OnExprDateSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnExprDateSetfocus();} */ 
/*static void _OnExprDateKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnExprDateKillfocus();
} */
static int _OnExprDateCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnExprDateCheckValue();
} 
/*static void _OnQuantityChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnQuantityChange();
} */
/*static void _OnQuantitySetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnQuantitySetfocus();} */ 
/*static void _OnQuantityKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnQuantityKillfocus();
} */
static int _OnQuantityCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnQuantityCheckValue();
} 
/*static void _OnUnitPriceChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnUnitPriceChange();
} */
/*static void _OnUnitPriceSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnUnitPriceSetfocus();} */ 
/*static void _OnUnitPriceKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnUnitPriceKillfocus();
} */
static int _OnUnitPriceCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnUnitPriceCheckValue();
} 
/*static void _OnOnHandChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnOnHandChange();
} */
/*static void _OnOnHandSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnOnHandSetfocus();} */ 
/*static void _OnOnHandKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInputEx *)pWnd)->OnOnHandKillfocus();
} */
static int _OnOnHandCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInputEx *)pWnd)->OnOnHandCheckValue();
} 


static void _OnSaveSelectFnc(CWnd *pWnd){
	CStorageTransactionLineInputEx *pVw = (CStorageTransactionLineInputEx *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddStorageTransactionLineInputExFnc(CWnd *pWnd){
	 return ((CStorageTransactionLineInputEx*)pWnd)->OnAddStorageTransactionLineInputEx();
} 
static int _OnEditStorageTransactionLineInputExFnc(CWnd *pWnd){
	 return ((CStorageTransactionLineInputEx*)pWnd)->OnEditStorageTransactionLineInputEx();
} 
static int _OnDeleteStorageTransactionLineInputExFnc(CWnd *pWnd){
	 return ((CStorageTransactionLineInputEx*)pWnd)->OnDeleteStorageTransactionLineInputEx();
} 
static int _OnSaveStorageTransactionLineInputExFnc(CWnd *pWnd){
	 return ((CStorageTransactionLineInputEx*)pWnd)->OnSaveStorageTransactionLineInputEx();
} 
static int _OnCancelStorageTransactionLineInputExFnc(CWnd *pWnd){
	 return ((CStorageTransactionLineInputEx*)pWnd)->OnCancelStorageTransactionLineInputEx();
} 
CStorageTransactionLineInputEx::CStorageTransactionLineInputEx(CWnd *pParent, int nMode):
	CGuiPopup(pParent){
...
CStorageTransactionLineInputEx::~CStorageTransactionLineInputEx(){
}
void CStorageTransactionLineInputEx::OnCreateComponents(){
/*
...
void CStorageTransactionLineInputEx::OnInitializeComponents(){
...
void CStorageTransactionLineInputEx::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageTransactionLineInputEx::OnDoDataExchange(CDataExchange* pDX){
...
void CStorageTransactionLineInputEx::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CStorageTransactionLineInputEx::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageTransactionLineInputEx::SetDefaultValues(){
...
int CStorageTransactionLineInputEx::SetMode(int nMode){
...
void CStorageTransactionLineInputEx::OnProductSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(nNewItemSel < 0)
		return;
	CString szOnHand;
...
void CStorageTransactionLineInputEx::OnProductSelendok(){
	UpdateData(TRUE);
...
/*void CStorageTransactionLineInputEx::OnProductSetfocus(){
	
}*/
/*void CStorageTransactionLineInputEx::OnProductKillfocus(){
	
}*/
long CStorageTransactionLineInputEx::OnProductLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CStorageTransactionLineInputEx::OnProductAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageTransactionLineInputEx::OnUomChange(){
	
} */
/*void CStorageTransactionLineInputEx::OnUomSetfocus(){
	
} */
/*void CStorageTransactionLineInputEx::OnUomKillfocus(){
	
} */
int CStorageTransactionLineInputEx::OnUomCheckValue(){
	return 0;
} 

void CStorageTransactionLineInputEx::OnManufactureSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CStorageTransactionLineInputEx::OnManufactureSelendok(){
	 
}
/*void CStorageTransactionLineInputEx::OnManufactureSetfocus(){
	
}*/
/*void CStorageTransactionLineInputEx::OnManufactureKillfocus(){
	
}*/
long CStorageTransactionLineInputEx::OnManufactureLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CStorageTransactionLineInputEx::OnManufactureAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageTransactionLineInputEx::OnLotNoChange(){
	
} */
/*void CStorageTransactionLineInputEx::OnLotNoSetfocus(){
	
} */
/*void CStorageTransactionLineInputEx::OnLotNoKillfocus(){
	
} */
int CStorageTransactionLineInputEx::OnLotNoCheckValue(){
	return 0;
} 
/*void CStorageTransactionLineInputEx::OnExprDateChange(){
	
} */
/*void CStorageTransactionLineInputEx::OnExprDateSetfocus(){
	
} */
/*void CStorageTransactionLineInputEx::OnExprDateKillfocus(){
	
} */
int CStorageTransactionLineInputEx::OnExprDateCheckValue(){
	return 0;
} 
/*void CStorageTransactionLineInputEx::OnQuantityChange(){
	
} */
/*void CStorageTransactionLineInputEx::OnQuantitySetfocus(){
	
} */
/*void CStorageTransactionLineInputEx::OnQuantityKillfocus(){
	
} */
int CStorageTransactionLineInputEx::OnQuantityCheckValue(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
...
/*void CStorageTransactionLineInputEx::OnUnitPriceChange(){
	
} */
/*void CStorageTransactionLineInputEx::OnUnitPriceSetfocus(){
	
} */
/*void CStorageTransactionLineInputEx::OnUnitPriceKillfocus(){
	
} */
int CStorageTransactionLineInputEx::OnUnitPriceCheckValue(){
	if(m_nUnitPrice <= 0)
		return -1;
...
/*void CStorageTransactionLineInputEx::OnOnHandChange(){
	
} */
/*void CStorageTransactionLineInputEx::OnOnHandSetfocus(){
	
} */
/*void CStorageTransactionLineInputEx::OnOnHandKillfocus(){
	
} */
int CStorageTransactionLineInputEx::OnOnHandCheckValue(){
	return 0;
} 

void CStorageTransactionLineInputEx::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveStorageTransactionLineInputEx();
} 
void CStorageTransactionLineInputEx::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CGuiPopup::ClosePopup();
} 
int CStorageTransactionLineInputEx::OnAddStorageTransactionLineInputEx(){
...
int CStorageTransactionLineInputEx::OnEditStorageTransactionLineInputEx(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CStorageTransactionLineInputEx::OnDeleteStorageTransactionLineInputEx(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelStorageTransactionLineInputEx();
 	}
	return 0;
}
int CStorageTransactionLineInputEx::OnSaveStorageTransactionLineInputEx(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 //Notice(szSQL);
 	...
 	if(ret > 0)
 	{
		CStorageTransactionLines* pLines = (CStorageTransactionLines*) m_pWndLines;
...
int CStorageTransactionLineInputEx::OnCancelStorageTransactionLineInputEx(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CStorageTransactionLineInputEx::OnStorageTransactionLineInputExListLoadData(){
	return 0;
}
