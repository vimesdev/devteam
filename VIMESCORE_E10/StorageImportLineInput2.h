#ifndef STORAGEIMPORTLINEINPUT2_H
#define STORAGEIMPORTLINEINPUT2_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CStorageImportLineInput2 : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CStorageImportLineInput2(CWnd *pParent, int nMode);
	~CStorageImportLineInput2();
