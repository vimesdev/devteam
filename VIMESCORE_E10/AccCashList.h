#ifndef ACCCASHDLIST_H
#define ACCCASHDLIST_H
...
class AFX_EXT_CLASS CAccCashList : public CGuiView{
protected:
	CString			m_szCashID;
...
public:
	...
	int OnAddAccCashList(); 
	int OnEditAccCashList(); 
	int OnDeleteAccCashList(); 
	int OnSaveAccCashList(); 
	int OnCancelAccCashList(); 
	int OnAccCashListListLoadData(); 
