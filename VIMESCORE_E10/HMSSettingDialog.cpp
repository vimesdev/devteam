...
/*static void _OnSearchChangeFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnSearchChange();
} */
/*static void _OnSearchSetfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnSearchSetfocus();} */ 
/*static void _OnSearchKillfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnSearchKillfocus();
} */
static int _OnSearchCheckValueFnc(CWnd *pWnd){
	return ((CHMSSettingDialog *)pWnd)->OnSearchCheckValue();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSSettingDialog*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSSettingDialog*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSSettingDialog*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 

static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSSettingDialog*)pWnd)->OnListDeleteItem();
}
...
/*static void _OnIDChangeFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnIDChange();
} */
/*static void _OnIDSetfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnIDSetfocus();} */ 
/*static void _OnIDKillfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnIDKillfocus();
} */
static int _OnIDCheckValueFnc(CWnd *pWnd){
	return ((CHMSSettingDialog *)pWnd)->OnIDCheckValue();
} 
static void _OnParentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSettingDialog* )pWnd)->OnParentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnParentSelendokFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnParentSelendok();
}
/*static void _OnParentSetfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnParentKillfocus();
}*/
/*static void _OnParentKillfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnParentKillfocus();
}*/
static long _OnParentLoadDataFnc(CWnd *pWnd){
	return ((CHMSSettingDialog *)pWnd)->OnParentLoadData();
}
/*static void _OnParentAddNewFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnParentAddNew();
}*/
/*static void _OnDescriptionChangeFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnDescriptionChange();
} */
/*static void _OnDescriptionSetfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnDescriptionSetfocus();} */ 
/*static void _OnDescriptionKillfocusFnc(CWnd *pWnd){
	((CHMSSettingDialog *)pWnd)->OnDescriptionKillfocus();
} */
static int _OnDescriptionCheckValueFnc(CWnd *pWnd){
	return ((CHMSSettingDialog *)pWnd)->OnDescriptionCheckValue();
} 
static void _OnIsActiveSelectFnc(CWnd *pWnd){
	 ((CHMSSettingDialog*)pWnd)->OnIsActiveSelect();
}
static void _OnAddSelectFnc(CWnd *pWnd){
	CHMSSettingDialog *pVw = (CHMSSettingDialog *)pWnd;
	pVw->OnAddSelect();
} 
...
static int _OnAddCHMSSettingDialogFnc(CWnd *pWnd){
	 return ((CHMSSettingDialog*)pWnd)->OnAddHMSSettingDialog();
} 
static int _OnEditCHMSSettingDialogFnc(CWnd *pWnd){
	 return ((CHMSSettingDialog*)pWnd)->OnEditHMSSettingDialog();
} 
static int _OnDeleteCHMSSettingDialogFnc(CWnd *pWnd){
	 return ((CHMSSettingDialog*)pWnd)->OnDeleteHMSSettingDialog();
} 
static int _OnSaveCHMSSettingDialogFnc(CWnd *pWnd){
	 return ((CHMSSettingDialog*)pWnd)->OnSaveHMSSettingDialog();
} 
static int _OnCancelCHMSSettingDialogFnc(CWnd *pWnd){
	 return ((CHMSSettingDialog*)pWnd)->OnCancelHMSSettingDialog();
} 
CHMSSettingDialog::CHMSSettingDialog(CWnd *pParent, CString szTable, CString szParentTable, CString szTitle, BOOL bNumber):
CGuiDialog(pParent), m_szTable(szTable), m_szParentTable(szParentTable), m_bNumberID(bNumber)
	{
...
CHMSSettingDialog::~CHMSSettingDialog(){
}
void CHMSSettingDialog::OnCreateComponents(){
...
void CHMSSettingDialog::OnInitializeComponents(){
...
void CHMSSettingDialog::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CHMSSettingDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSSettingDialog::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CHMSSettingDialog::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSSettingDialog::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CHMSSettingDialog::SetDefaultValues(){
...
int CHMSSettingDialog::SetMode(int nMode){
 		...
 		case VM_ADD: 
			...
			if(m_bNumberID)
			{
				m_szID.Format(_T("%ld"), str2long(pMF->ExecDML(szSQL)));
			
			}
			else m_szID = pMF->ExecDML(szSQL);
 			break;
 		case VM_EDIT: 
 			EnableControls(TRUE);
 			EnableButtons(TRUE, 3, 4, -1);
...
/*void CHMSSettingDialog::OnSearchChange(){
	
} */
/*void CHMSSettingDialog::OnSearchSetfocus(){
	
} */
/*void CHMSSettingDialog::OnSearchKillfocus(){
	
} */
int CHMSSettingDialog::OnSearchCheckValue(){
	OnListLoadData();
	return 1;
} 
void CHMSSettingDialog::OnListDblClick(){
	
} 
void CHMSSettingDialog::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(nNewItem < 0)
		return;
...
int CHMSSettingDialog::OnListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDeleteHMSSettingDialog();
	 return 0;
} 
long CHMSSettingDialog::OnListLoadData(){
...
/*void CHMSSettingDialog::OnIDChange(){
	
} */
/*void CHMSSettingDialog::OnIDSetfocus(){
	
} */
/*void CHMSSettingDialog::OnIDKillfocus(){
	
} */
int CHMSSettingDialog::OnIDCheckValue(){
	if(GetMode() == VM_ADD)
	{
		CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
		CRecord rs(&pMF->m_db);
...
void CHMSSettingDialog::OnParentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CHMSSettingDialog::OnParentSelendok(){
	 
}
/*void CHMSSettingDialog::OnParentSetfocus(){
	
}*/
/*void CHMSSettingDialog::OnParentKillfocus(){
	
}*/
long CHMSSettingDialog::OnParentLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CHMSSettingDialog::OnParentAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CHMSSettingDialog::OnDescriptionChange(){
	
} */
/*void CHMSSettingDialog::OnDescriptionSetfocus(){
	
} */
/*void CHMSSettingDialog::OnDescriptionKillfocus(){
	
} */
int CHMSSettingDialog::OnDescriptionCheckValue(){
	return 0;
} 
	void CHMSSettingDialog::OnIsActiveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
void CHMSSettingDialog::OnAddSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnAddHMSSettingDialog();
} 
void CHMSSettingDialog::OnEditSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnEditHMSSettingDialog();
} 
void CHMSSettingDialog::OnDeleteSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDeleteHMSSettingDialog();
}
void CHMSSettingDialog::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveHMSSettingDialog();
}  
void CHMSSettingDialog::OnCancelSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnCancelHMSSettingDialog();
} 
void CHMSSettingDialog::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
int CHMSSettingDialog::OnAddHMSSettingDialog(){
...
int CHMSSettingDialog::OnEditHMSSettingDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSSettingDialog::OnDeleteHMSSettingDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
...
int CHMSSettingDialog::OnSaveHMSSettingDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 	...
 	if(GetMode() == VM_ADD){
 		...
 		szSQL = m_settingTbl.GetUpdateSQL(m_szKeyName);
 		szSQL += szWhere;
 	}
 _tprintf(_T("%s"), szSQL);
 	int ret = pMF->ExecSQL(szSQL);
...
int CHMSSettingDialog::OnCancelHMSSettingDialog(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSSettingDialog::OnHMSSettingDialogListLoadData(){
	return 0;
}
