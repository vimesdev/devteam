#ifndef ADPRODUCTPRICEINPUT_H
#define ADPRODUCTPRICEINPUT_H
...
#include "GuiView.h"
#include "DbField.h"
class CAdProductPriceInput : public CListItemEdit{
protected:
public:
	...
	int OnAddAdProductPriceInput(); 
	int OnEditAdProductPriceInput(); 
	int OnDeleteAdProductPriceInput(); 
	int OnSaveAdProductPriceInput(); 
	int OnCancelAdProductPriceInput(); 
	int OnAdProductPriceInputListLoadData(); 
	int	OnOK();
};
#endif
