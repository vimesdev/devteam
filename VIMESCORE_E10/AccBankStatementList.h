#ifndef BANKSTATEMENTLIST_H
#define BANKSTATEMENTLIST_H
...
class AFX_EXT_CLASS CAccBankStatementList : public CGuiView{
protected:
	CString		m_szID;
...
public:
	...
	int OnAddAccBankStatementList(); 
	int OnEditAccBankStatementList(); 
	int OnDeleteAccBankStatementList(); 
	int OnSaveAccBankStatementList(); 
	int OnCancelAccBankStatementList(); 
	int OnAccBankStatementListListLoadData(); 
	void	SetVoucherType(CString szType);
	void	Refresh();
};
#endif
