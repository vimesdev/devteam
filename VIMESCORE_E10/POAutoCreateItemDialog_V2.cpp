...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2 *)pWnd)->OnFromDateCheckValue();
}

/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2 *)pWnd)->OnToDateCheckValue();
} 
/*static void _OnDocumentNoChangeFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnDocumentNoChange();
} */
/*static void _OnDocumentNoSetfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnDocumentNoSetfocus();} */ 
/*static void _OnDocumentNoKillfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnDocumentNoKillfocus();
} */
static int _OnDocumentNoCheckValueFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2 *)pWnd)->OnDocumentNoCheckValue();
} 
/*static void _OnPatientNameChangeFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnPatientNameChange();
} */
/*static void _OnPatientNameSetfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnPatientNameSetfocus();} */ 
/*static void _OnPatientNameKillfocusFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2 *)pWnd)->OnPatientNameKillfocus();
} */
static int _OnPatientNameCheckValueFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2 *)pWnd)->OnPatientNameCheckValue();
}
static int _OnItemNameCheckValueFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2 *)pWnd)->OnItemNameCheckValue();
} 

static long _OnItemNameLoadDataFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2 *)pWnd)->OnItemNameLoadData();
} 
static long _OnPatientListLoadDataFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnPatientListLoadData();
} 
static void _OnPatientListDblClickFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2*)pWnd)->OnPatientListDblClick();
} 
static void _OnPatientListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPOAutoCreateItemDialog_V2*)pWnd)->OnPatientListSelectChange(nOldItem, nNewItem);
} 
static int _OnPatientListDeleteItemFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnPatientListDeleteItem();
} 

static int _OnPatientListAddCheckItemFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnPatientListAddCheckItem();
} 
static long _OnMaterialListLoadDataFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnMaterialListLoadData();
} 
static void _OnMaterialListDblClickFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2*)pWnd)->OnMaterialListDblClick();
} 
static void _OnMaterialListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPOAutoCreateItemDialog_V2*)pWnd)->OnMaterialListSelectChange(nOldItem, nNewItem);
} 
static int _OnMaterialListDeleteItemFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnMaterialListDeleteItem();
} 
static long _OnSelectedListLoadDataFnc(CWnd *pWnd){
	return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnSelectedListLoadData();
} 
static void _OnSelectedListDblClickFnc(CWnd *pWnd){
	((CPOAutoCreateItemDialog_V2*)pWnd)->OnSelectedListDblClick();
} 
static void _OnSelectedListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPOAutoCreateItemDialog_V2*)pWnd)->OnSelectedListSelectChange(nOldItem, nNewItem);
} 
static int _OnSelectedListDeleteItemFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnSelectedListDeleteItem();
} 


static int _OnSelectedListEditQuantityFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnSelectedListEditQuantity();
} 


static void _OnApplySelectFnc(CWnd *pWnd){
	CPOAutoCreateItemDialog_V2 *pVw = (CPOAutoCreateItemDialog_V2 *)pWnd;
	pVw->OnApplySelect();
} 
...
static int _OnAddPOAutoCreateItemDialogFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnAddPOAutoCreateItemDialog();
} 
static int _OnEditPOAutoCreateItemDialogFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnEditPOAutoCreateItemDialog();
} 
static int _OnDeletePOAutoCreateItemDialogFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnDeletePOAutoCreateItemDialog();
} 
static int _OnSavePOAutoCreateItemDialogFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnSavePOAutoCreateItemDialog();
} 
static int _OnCancelPOAutoCreateItemDialogFnc(CWnd *pWnd){
	 return ((CPOAutoCreateItemDialog_V2*)pWnd)->OnCancelPOAutoCreateItemDialog();
} 
CPOAutoCreateItemDialog_V2::CPOAutoCreateItemDialog_V2(CWnd *pParent):
	CGuiDialog(pParent){
...
CPOAutoCreateItemDialog_V2::~CPOAutoCreateItemDialog_V2(){
}
void CPOAutoCreateItemDialog_V2::OnCreateComponents(){
...
void CPOAutoCreateItemDialog_V2::OnInitializeComponents(){
	...
	m_wndItemName.InsertColumn(0, _T(""), CFMT_NUMBER, 0);//Id
	m_wndItemName.InsertColumn(1, _T("Code"), CFMT_TEXT, 80);
	m_wndItemName.InsertColumn(2, _T("Name"), CFMT_TEXT, 300);
	m_wndItemName.Format(3, 2); 
...
void CPOAutoCreateItemDialog_V2::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	m_wndPatientList.AddEvent(2, _T("Add Checked Item"), _OnPatientListAddCheckItemFnc);
...
void CPOAutoCreateItemDialog_V2::OnDoDataExchange(CDataExchange* pDX){
...
void CPOAutoCreateItemDialog_V2::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CPOAutoCreateItemDialog_V2::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

	

}
void CPOAutoCreateItemDialog_V2::SetDefaultValues(){
...
int CPOAutoCreateItemDialog_V2::SetMode(int nMode){
...
/*void CPOAutoCreateItemDialog_V2::OnFromDateChange(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnFromDateSetfocus(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnFromDateKillfocus(){
	
} */
int CPOAutoCreateItemDialog_V2::OnFromDateCheckValue(){
	UpdateData();
	OnPatientListLoadData();
	return 0;
} 
/*void CPOAutoCreateItemDialog_V2::OnToDateChange(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnToDateSetfocus(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnToDateKillfocus(){
	
} */
int CPOAutoCreateItemDialog_V2::OnToDateCheckValue(){
	UpdateData();
	OnPatientListLoadData();
	return 0;
} 
/*void CPOAutoCreateItemDialog_V2::OnDocumentNoChange(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnDocumentNoSetfocus(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnDocumentNoKillfocus(){
	
} */
int CPOAutoCreateItemDialog_V2::OnDocumentNoCheckValue(){
	return 0;
} 
/*void CPOAutoCreateItemDialog_V2::OnPatientNameChange(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnPatientNameSetfocus(){
	
} */
/*void CPOAutoCreateItemDialog_V2::OnPatientNameKillfocus(){
	
} */
int CPOAutoCreateItemDialog_V2::OnPatientNameCheckValue(){
	m_wndPatientList.Search(2, m_szPatientName, SEARCH_LIKE);
	return 0;
}
int CPOAutoCreateItemDialog_V2::OnItemNameCheckValue(){
	UpdateData();
	OnPatientListLoadData();
	return 0;
} 
void CPOAutoCreateItemDialog_V2::OnPatientListDblClick(){

} 
void CPOAutoCreateItemDialog_V2::OnPatientListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(nNewItem < 0)
		return;
...
int CPOAutoCreateItemDialog_V2::OnPatientListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 
long CPOAutoCreateItemDialog_V2::OnPatientListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	if(!m_szItemNameKey.IsEmpty())
		szWhere.Format(_T(" and mp_product_id = %ld "), str2long(m_szItemNameKey));
...
void CPOAutoCreateItemDialog_V2::OnMaterialListDblClick(){
...
void CPOAutoCreateItemDialog_V2::OnMaterialListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CPOAutoCreateItemDialog_V2::OnMaterialListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 
long CPOAutoCreateItemDialog_V2::OnMaterialListLoadData(){
...
_T("   '['||product_code||'] '||product_name as product_name,") \
_T("   product_uomname,") \
...
void CPOAutoCreateItemDialog_V2::OnSelectedListDblClick(){
...
void CPOAutoCreateItemDialog_V2::OnSelectedListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CPOAutoCreateItemDialog_V2::OnSelectedListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	int nSel = m_wndSelectedList.GetCurSel();
	if(nSel < 0) 
		return 0;
...
int CPOAutoCreateItemDialog_V2::OnSelectedListEditQuantity(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	int nSel = m_wndSelectedList.GetCurSel();
	if(nSel < 0)
		return 0;
...
long CPOAutoCreateItemDialog_V2::OnSelectedListLoadData(){
...
void CPOAutoCreateItemDialog_V2::OnApplySelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
	int uomrate = 0;
	int qty;
...
void CPOAutoCreateItemDialog_V2::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_wndSelectedList.GetItemCount() > 0){
...
int CPOAutoCreateItemDialog_V2::OnAddPOAutoCreateItemDialog(){
...
int CPOAutoCreateItemDialog_V2::OnEditPOAutoCreateItemDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CPOAutoCreateItemDialog_V2::OnDeletePOAutoCreateItemDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
...
int CPOAutoCreateItemDialog_V2::OnSavePOAutoCreateItemDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CPOAutoCreateItemDialog_V2::OnCancelPOAutoCreateItemDialog(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CPOAutoCreateItemDialog_V2::OnPOAutoCreateItemDialogListLoadData(){
	return 0;
}

BOOL CPOAutoCreateItemDialog_V2::PreTranslateMessage(MSG* pMsg)
{
...
BEGIN_MESSAGE_MAP(CPOAutoCreateItemDialog_V2, CGuiDialog)
	ON_WM_CLOSE()
END_MESSAGE_MAP()

void CPOAutoCreateItemDialog_V2::OnClose()
{
...
long CPOAutoCreateItemDialog_V2::OnItemNameLoadData()
{
	CMainFrame_E10 * pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	szSQL.Format(
	_T(" SELECT mp_product_id AS id,") \
	_T("        mp_code AS code,") \
	_T("        mp_name AS name") \
	_T(" FROM   m_product") \
	_T(" WHERE  1 = 1 AND mp_product_id IN (") \
	_T("	SELECT msl_product_id") \
	_T("    FROM   m_storageline") \
	_T("    WHERE  msl_storage_id IN (%d) AND msl_isactive = 'Y') ")
	, m_nTemplateStorage_ID);
	rs.ExecSQL(szSQL);
...
int CPOAutoCreateItemDialog_V2::OnPatientListAddCheckItem()
{
	CMainFrame_E10* pMF = (CMainFrame_E10*) AfxGetMainWnd();
	UpdateData();
	if (m_szItemNameKey.Trim().IsEmpty())
	{
		return 0;
	}
	CString szOrder_ids, szSQL;
	szOrder_ids.Empty();
	for (int i = 0; i < m_wndPatientList.GetItemCount(); i++)
	{
		if (m_wndPatientList.GetItemState(i, LVIS_SELECTED) != LVIS_SELECTED)
		{
			continue;
		}
		if (!szOrder_ids.IsEmpty())
		{
			szOrder_ids += _T(",");
		}
		szOrder_ids.AppendFormat(_T("%s"), m_wndPatientList.GetItemText(i, 0));
	}
	if (szOrder_ids.IsEmpty())
	{
		return 0;
	}
	szSQL.Format(_T("PURCHASE_ORDERLINE2_CREATE_V4(%ld, '%s', %ld)")
					, m_nPurchaseOrder_ID, szOrder_ids, str2long(m_szItemNameKey));
	long nRet = str2long(pMF->ExecDML(szSQL));
	if (nRet > 0)
	{
		OnPatientListLoadData();
		OnSelectedListLoadData();
		m_wndMaterialList.DeleteAllItems();
	}
	return nRet;
}