#ifndef PURCHASERETURNORDERLINEINPUT_H
#define PURCHASERETURNORDERLINEINPUT_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CPurchaseReturnOrderLineInput : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CPurchaseReturnOrderLineInput(CWnd *pParent, int nMode);
	~CPurchaseReturnOrderLineInput();
	...
	int OnAddPurchaseReturnOrderLineInput(); 
	int OnEditPurchaseReturnOrderLineInput(); 
	int OnDeletePurchaseReturnOrderLineInput(); 
	int OnSavePurchaseReturnOrderLineInput(); 
	int OnCancelPurchaseReturnOrderLineInput(); 
	int OnPurchaseReturnOrderLineInputListLoadData(); 
	long LoadProductItemList(CWnd* pWnd, CString szKey, CString szFilter);
};
#endif
