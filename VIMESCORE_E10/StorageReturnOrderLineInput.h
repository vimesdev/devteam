#ifndef StorageReturnOrderLINEINPUT_H
#define StorageReturnOrderLINEINPUT_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CStorageReturnOrderLineInput : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CStorageReturnOrderLineInput(CWnd *pParent, int nMode);
	~CStorageReturnOrderLineInput();
	...
	int OnAddStorageReturnOrderLineInput(); 
	int OnEditStorageReturnOrderLineInput(); 
	int OnDeleteStorageReturnOrderLineInput(); 
	int OnSaveStorageReturnOrderLineInput(); 
	int OnCancelStorageReturnOrderLineInput(); 
	int OnStorageReturnOrderLineInputListLoadData(); 
};
#endif
