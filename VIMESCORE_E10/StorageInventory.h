...
public:
	...
	CGuiCheckBox	m_wndDutyList;
	CGuiCheckBox	m_wndReachMinQty;
	CGuiLabel		m_wndSubTotalLabel;
	CGuiNumberCtrl	m_wndSubTotal;
	CGuiButton		m_wndSwitchDutyMode;
	CGuiCheckBox	m_wndSearchByGeneric;
	...
	BOOL	m_bDutyList;
	BOOL	m_bReachMinQty;
	BOOL	m_bSwitchDutyMode;
	BOOL	m_bSearchByGeneric;
	double	m_nSubTotal;
	...
	void			OnListDblClick(); 
	int			OnManipulateItem();
	int			OnPreorderQuantityItem();
	int			OnViewQuantityDifference();
	void		OnViewOrderDifference();
	void OnResizeLayout();
	int			OnSetupChest();
	int			OnAddItemtoChest();
	int			OnListDeleteItem(); 
	void		OnLoadInactiveSelect();
	void		OnReachMinQtySelect();
	...
	int			OnAdd_RemoveDutyList();
	void		OnLoadDutyList();
	void		OnSwitchDutyMode();
	void		OnSetDutyQuantity();
	void		OnSetMinQuantity();
	CStorageInventory();
	~CStorageInventory();
	...
	int OnPostInventoryToDuocQG();
	void	OnRecalcOrderQty();
	void	GetTotalAmounts();
	void	OnExportInventory();
	DECLARE_MESSAGE_MAP()
