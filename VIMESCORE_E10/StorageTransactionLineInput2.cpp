...
static void _OnManufactureSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageTransactionLineInput* )pWnd)->OnManufactureSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnManufactureSelendokFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnManufactureSelendok();
}
/*static void _OnManufactureSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnManufactureKillfocus();
}*/
/*static void _OnManufactureKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnManufactureKillfocus();
}*/
static long _OnManufactureLoadDataFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInput *)pWnd)->OnManufactureLoadData();
}
/*static void _OnManufactureAddNewFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnManufactureAddNew();
}*/
/*static void _OnLotNoChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnLotNoChange();
} */
/*static void _OnLotNoSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnLotNoSetfocus();} */ 
/*static void _OnLotNoKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnLotNoKillfocus();
} */
static int _OnLotNoCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInput *)pWnd)->OnLotNoCheckValue();
} 
/*static void _OnExprDateChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnExprDateChange();
} */
/*static void _OnExprDateSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnExprDateSetfocus();} */ 
/*static void _OnExprDateKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnExprDateKillfocus();
} */
static int _OnExprDateCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInput *)pWnd)->OnExprDateCheckValue();
} 
/*static void _OnQuantityChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnQuantityChange();
} */
/*static void _OnQuantitySetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnQuantitySetfocus();} */ 
/*static void _OnQuantityKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnQuantityKillfocus();
} */
static int _OnQuantityCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInput *)pWnd)->OnQuantityCheckValue();
} 
/*static void _OnUnitPriceChangeFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnUnitPriceChange();
} */
/*static void _OnUnitPriceSetfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnUnitPriceSetfocus();} */ 
/*static void _OnUnitPriceKillfocusFnc(CWnd *pWnd){
	((CStorageTransactionLineInput *)pWnd)->OnUnitPriceKillfocus();
} */
static int _OnUnitPriceCheckValueFnc(CWnd *pWnd){
	return ((CStorageTransactionLineInput *)pWnd)->OnUnitPriceCheckValue();
} 
...
CStorageTransactionLineInput::CStorageTransactionLineInput(CWnd *pParent, int nMode, int x, int y):
	CGuiDialog(pParent){
...
void CStorageTransactionLineInput::OnCreateComponents(){
	...
	*/
	...
	m_wndUomLabel.Create(this, _T("Unit of Measure"), 455, 5, 555, 30);
	m_wndUom.Create(this,560, 5, 675, 30); 
	m_wndQuantityLabel.Create(this, _T("Quantity"), 5, 35, 105, 60);
	m_wndQuantity.Create(this,110, 35, 225, 60); 
	m_wndUnitPriceLabel.Create(this, _T("Unit Price"), 230, 35, 330, 60);
	m_wndUnitPrice.Create(this,335, 35, 450, 60); 
	m_wndOnHandLabel.Create(this, _T("OnHand"), 455, 35, 555, 60);
	m_wndOnHand.Create(this,560, 35, 675, 60); 
	m_wndSave.Create(this, _T("&Save"), 490, 65, 580, 90);
	m_wndClose.Create(this, _T("&Close"), 585, 65, 675, 90);
...
//	m_wndExprDate.SetReadOnly(TRUE);
	...
	m_wndProduct.InsertColumn(3, _T("Name"), CFMT_TEXT, 200);
	m_wndProduct.InsertColumn(4, _T("Uom"), CFMT_TEXT, 70);
	m_wndProduct.InsertColumn(5, _T("Classcification"), CFMT_TEXT, 200);
	...
	m_wndProduct.InsertColumn(11, _T("Manufacture"), CFMT_TEXT, 80);
...
void CStorageTransactionLineInput::OnManufactureSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CStorageTransactionLineInput::OnManufactureSelendok(){
	 
}
/*void CStorageTransactionLineInput::OnManufactureSetfocus(){
	
}*/
/*void CStorageTransactionLineInput::OnManufactureKillfocus(){
	
}*/
long CStorageTransactionLineInput::OnManufactureLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CStorageTransactionLineInput::OnManufactureAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageTransactionLineInput::OnLotNoChange(){
	
} */
/*void CStorageTransactionLineInput::OnLotNoSetfocus(){
	
} */
/*void CStorageTransactionLineInput::OnLotNoKillfocus(){
	
} */
int CStorageTransactionLineInput::OnLotNoCheckValue(){
	return 0;
} 
/*void CStorageTransactionLineInput::OnExprDateChange(){
	
} */
/*void CStorageTransactionLineInput::OnExprDateSetfocus(){
	
} */
/*void CStorageTransactionLineInput::OnExprDateKillfocus(){
	
} */
int CStorageTransactionLineInput::OnExprDateCheckValue(){
	return 0;
} 
/*void CStorageTransactionLineInput::OnQuantityChange(){
	
} */
/*void CStorageTransactionLineInput::OnQuantitySetfocus(){
	
} */
/*void CStorageTransactionLineInput::OnQuantityKillfocus(){
	
} */
int CStorageTransactionLineInput::OnQuantityCheckValue(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
...
/*void CStorageTransactionLineInput::OnUnitPriceChange(){
	
} */
/*void CStorageTransactionLineInput::OnUnitPriceSetfocus(){
	
} */
/*void CStorageTransactionLineInput::OnUnitPriceKillfocus(){
	
} */
int CStorageTransactionLineInput::OnUnitPriceCheckValue(){
	if(m_nUnitPrice <= 0)
		return -1;
