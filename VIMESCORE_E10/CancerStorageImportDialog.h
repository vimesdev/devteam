#ifndef CANCERSTORAGEIMPORTDIALOG_H
#define CANCERSTORAGEIMPORTDIALOG_H
...
class CCancerStorageImportDialog : public CGuiDialog{
protected:
public:
	bool		m_bRefresh;
	long		m_nID;
	...
	CCancerStorageImportLines	m_wndLines;
	...
	void			OnPlusSelect();
	CCancerStorageImportDialog(CWnd *pParent, int nMode);
	~CCancerStorageImportDialog();
