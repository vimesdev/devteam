...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CStorageImportLines*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CStorageImportLines*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CStorageImportLines*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
}

static int _OnListAddItemFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnListAddItem();
}
static int _OnListEditItemFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnListEditItem();
}

static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnListDeleteItem();
} 
static int _OnAddStorageDeliveryOrderLinesFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnAddStorageDeliveryOrderLines();
} 
static int _OnEditStorageDeliveryOrderLinesFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnEditStorageDeliveryOrderLines();
} 
static int _OnDeleteStorageDeliveryOrderLinesFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnDeleteStorageDeliveryOrderLines();
} 
static int _OnSaveStorageDeliveryOrderLinesFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnSaveStorageDeliveryOrderLines();
} 
static int _OnCancelStorageDeliveryOrderLinesFnc(CWnd *pWnd){
	 return ((CStorageImportLines*)pWnd)->OnCancelStorageDeliveryOrderLines();
} 

CStorageImportLines::CStorageImportLines(){
...
void CStorageImportLines::OnCreateComponents(){
	m_wndList.SetAutoIndex(true);
	m_wndList.Create(this,5, 5, 990, 350); 

}
void CStorageImportLines::OnInitializeComponents(){
...
void CStorageImportLines::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageImportLines::OnDoDataExchange(CDataExchange* pDX){

}
void CStorageImportLines::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CStorageImportLines::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CStorageImportLines::SetDefaultValues(){


}
int CStorageImportLines::SetMode(int nMode){
...
void CStorageImportLines::OnListDblClick(){
	
} 
void CStorageImportLines::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(nNewItem < 0)
		return;
...
int CStorageImportLines::OnListAddItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRect rect;

	CStorageImportDialog* pPO = (CStorageImportDialog*) m_pWndOrder;
	...
	GetWindowRect(&rect);
	CStorageImportLineInput dlg(this);
	dlg.SetMode(VM_ADD);
	dlg.m_nOrderID = m_nOrderID;
	//dlg.m_nOrderLine = m_nOrderLine;
	//dlg.m_nStorageID = m_nStorageID;
	//dlg.m_nStorageToID = m_nStorageToID;
	dlg.m_szPartnerID = pPO->m_szDeliveryObjectKey;
	dlg.m_nStorageID = str2int(pPO->m_szFromStorageKey);
	dlg.DoModal();
	return 0;
}

int CStorageImportLines::OnListAddItem2(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRect rect;
	...
	GetWindowRect(&rect);
	CStorageImportLineInput2* newPopup = new CStorageImportLineInput2(this, VM_ADD);
	newPopup->m_nOrderID = m_nOrderID;
	//newPopup->m_nOrderLine = m_nOrderLine;
	//newPopup->m_nStorageID = m_nStorageID;
	newPopup->m_nStorageToID = str2int(pPO->m_szFromStorageKey);
	newPopup->ShowPopup(&m_wndList);
	return 0;
}

int CStorageImportLines::OnListEditItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRect rect;
...
int CStorageImportLines::OnListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDeleteStorageDeliveryOrderLines();
	 return 0;
} 
long CStorageImportLines::OnListLoadData(){
...
int CStorageImportLines::OnAddStorageDeliveryOrderLines(){
...
int CStorageImportLines::OnEditStorageDeliveryOrderLines(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CStorageImportLines::OnDeleteStorageDeliveryOrderLines(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
	CStorageImportDialog* pPO = (CStorageImportDialog*) m_pWndOrder;
	if(pPO && !pPO->IsAllowEdit())
	{
...
int CStorageImportLines::OnSaveStorageDeliveryOrderLines(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CStorageImportLines::OnCancelStorageDeliveryOrderLines(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CStorageImportLines::OnStorageDeliveryOrderLinesListLoadData(){
	return 0;
}

void CStorageImportLines::Refresh(long nOrderID){
	m_nOrderID = nOrderID;
	OnListLoadData();
}

CString CStorageImportLines::GetOrderStatus(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	CString szStatus;
...
int CStorageImportLines::OnPreviewDeliveryDetail(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
	int nSel = m_wndList.GetCurSel();
	if( nSel < 0 )
		return -1;
