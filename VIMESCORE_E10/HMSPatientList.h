...
#include "GuiView.h"
#include "DbField.h"
class CHMSPatientList : public CGuiView{
protected:
public:
	...
	int OnAddHMSPatientList(); 
	int OnEditHMSPatientList(); 
	int OnDeleteHMSPatientList(); 
	int OnSaveHMSPatientList(); 
	int OnCancelHMSPatientList(); 
	int OnHMSPatientListListLoadData(); 
};
#endif
