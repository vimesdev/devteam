#include "AdContactInput.h"
#include "MainFrame_E10.h"
//#include "AdBusinessPartnerContact.h"
static void _OnPrimarySelectFnc(CWnd *pWnd){
	 ((CAdContactInput*)pWnd)->OnPrimarySelect();
}
/*static void _OnTitleChangeFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnTitleChange();
} */
/*static void _OnTitleSetfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnTitleSetfocus();} */ 
/*static void _OnTitleKillfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnTitleKillfocus();
} */
static int _OnTitleCheckValueFnc(CWnd *pWnd){
	return ((CAdContactInput *)pWnd)->OnTitleCheckValue();
} 
/*static void _OnNameChangeFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnNameChange();
} */
/*static void _OnNameSetfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnNameSetfocus();} */ 
/*static void _OnNameKillfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnNameKillfocus();
} */
static int _OnNameCheckValueFnc(CWnd *pWnd){
	return ((CAdContactInput *)pWnd)->OnNameCheckValue();
} 
/*static void _OnPhoneChangeFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnPhoneChange();
} */
/*static void _OnPhoneSetfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnPhoneSetfocus();} */ 
/*static void _OnPhoneKillfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnPhoneKillfocus();
} */
static int _OnPhoneCheckValueFnc(CWnd *pWnd){
	return ((CAdContactInput *)pWnd)->OnPhoneCheckValue();
} 
/*static void _OnEmailChangeFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnEmailChange();
} */
/*static void _OnEmailSetfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnEmailSetfocus();} */ 
/*static void _OnEmailKillfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnEmailKillfocus();
} */
static int _OnEmailCheckValueFnc(CWnd *pWnd){
	return ((CAdContactInput *)pWnd)->OnEmailCheckValue();
} 
/*static void _OnPositionChangeFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnPositionChange();
} */
/*static void _OnPositionSetfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnPositionSetfocus();} */ 
/*static void _OnPositionKillfocusFnc(CWnd *pWnd){
	((CAdContactInput *)pWnd)->OnPositionKillfocus();
} */
static int _OnPositionCheckValueFnc(CWnd *pWnd){
	return ((CAdContactInput *)pWnd)->OnPositionCheckValue();
} 
static int _OnAddAdContactInputFnc(CWnd *pWnd){
	 return ((CAdContactInput*)pWnd)->OnAddAdContactInput();
} 
static int _OnEditAdContactInputFnc(CWnd *pWnd){
	 return ((CAdContactInput*)pWnd)->OnEditAdContactInput();
} 
static int _OnDeleteAdContactInputFnc(CWnd *pWnd){
	 return ((CAdContactInput*)pWnd)->OnDeleteAdContactInput();
} 
static int _OnSaveAdContactInputFnc(CWnd *pWnd){
	 return ((CAdContactInput*)pWnd)->OnSaveAdContactInput();
} 
static int _OnCancelAdContactInputFnc(CWnd *pWnd){
	 return ((CAdContactInput*)pWnd)->OnCancelAdContactInput();
} 
CAdContactInput::CAdContactInput(){
	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
	SetDefaultValues();
}
...
void CAdContactInput::OnCreateComponents(){
...
void CAdContactInput::OnInitializeComponents(){
...
void CAdContactInput::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CAdContactInput::OnDoDataExchange(CDataExchange* pDX){
...
void CAdContactInput::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CAdContactInput::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CAdContactInput::ApplyToList(){
	//CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CAdContactInput::SetDefaultValues(){
...
int CAdContactInput::SetMode(int nMode){
...
void CAdContactInput::OnPrimarySelect(){
}

/*void CAdContactInput::OnTitleChange(){
	
} */
/*void CAdContactInput::OnTitleSetfocus(){
	
} */
/*void CAdContactInput::OnTitleKillfocus(){
	
} */
int CAdContactInput::OnTitleCheckValue(){
	return 0;
}
 
/*void CAdContactInput::OnNameChange(){
	
} */
/*void CAdContactInput::OnNameSetfocus(){
	
} */
/*void CAdContactInput::OnNameKillfocus(){
	
} */
int CAdContactInput::OnNameCheckValue(){
	return 0;
}
 
/*void CAdContactInput::OnPhoneChange(){
	
} */
/*void CAdContactInput::OnPhoneSetfocus(){
	
} */
/*void CAdContactInput::OnPhoneKillfocus(){
	
} */
int CAdContactInput::OnPhoneCheckValue(){
	return 0;
}
 
/*void CAdContactInput::OnEmailChange(){
	
} */
/*void CAdContactInput::OnEmailSetfocus(){
	
} */
/*void CAdContactInput::OnEmailKillfocus(){
	
} */
int CAdContactInput::OnEmailCheckValue(){
	return 0;
}
 
/*void CAdContactInput::OnPositionChange(){
	
} */
/*void CAdContactInput::OnPositionSetfocus(){
	
} */
/*void CAdContactInput::OnPositionKillfocus(){
	
} */
int CAdContactInput::OnPositionCheckValue(){
	return 0;
} 
int CAdContactInput::OnAddAdContactInput(){
...
int CAdContactInput::OnEditAdContactInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CAdContactInput::OnDeleteAdContactInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelAdContactInput();
 	}
	return 0;
}
int CAdContactInput::OnOK(){
	return OnSaveAdContactInput();
}
void CAdContactInput::OnCancel(){
	CGuiListCtrl* pList = (CGuiListCtrl*) GetParent();
	pList->SetCurSel(GetRowIndex());
}
int CAdContactInput::OnSaveAdContactInput(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CAdContactInput::OnCancelAdContactInput(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	}
...
int CAdContactInput::OnAdContactInputListLoadData(){
	return 0;
}
