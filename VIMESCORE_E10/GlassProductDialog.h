...
////////////////////////////////////////
//mp_description: Mô tả sản phẩm
//mp_documentnote: Ghi chú
//mp_attributeset_id: Mã thuộc tính (Các thuộc tính, chất liệu, màu sắc, thuộc tính, lưu trong bảng m_product_attribute)
///////////////////////////////////////////
...
void			OnProductTypeSelectChange(int nOldItemSel, int nNewItemSel); 
	...
	void		OnAttributeSetClick();
	void		OnColorClick();
	void		OnGuaranteeClick();

	CGlassProductDialog(CWnd *pParent, int nMode);
	~CGlassProductDialog();
