#ifndef StorageReturnOrderDIALOG_H
#define StorageReturnOrderDIALOG_H
...
///////////////////////////////////////////////
//CStorageReturnOrder: Cac class lien quan den phieu tra lai thuoc, vat tu.
///////////////////////////////////////////////
class CStorageReturnOrderDialog : public CGuiDialog{
protected:
public:
	bool		m_bRefresh;
	...
	CStorageReturnOrderLines	m_wndLines;
	...
	CGuiLabel		m_wndReturnStorageLabel;
	CGuiComboBox	m_wndReturnStorage;
	...
	void			OnReturnStorageSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnReturnStorageSelendok(); 
	//void			OnReturnStorageSetfocus(); 
	//void			OnReturnStorageKillfocus(); 
	long			OnReturnStorageLoadData(); 
	//void			OnReturnStorageAddNew(); 
	...
	CStorageReturnOrderDialog(CWnd *pParent, int nMode);
	~CStorageReturnOrderDialog();
	...
	int OnAddStorageReturnOrderDialog(); 
	int OnEditStorageReturnOrderDialog(); 
	int OnDeleteStorageReturnOrderDialog(); 
	int OnSaveStorageReturnOrderDialog(); 
	int OnDiscardStorageReturnOrderDialog(); 
	int OnStorageReturnOrderDialogListLoadData(); 
	CString GetOrderStatus();
	bool	IsAllowEdit();
	int		OnDefineTransactionType(long nTransactionID);
};
#endif
