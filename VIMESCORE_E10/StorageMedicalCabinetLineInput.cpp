...
static void _OnProductSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageMedicalCabinetLineInput* )pWnd)->OnProductSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnProductSelendokFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnProductSelendok();
}
/*static void _OnProductSetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnProductKillfocus();
}*/
/*static void _OnProductKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnProductKillfocus();
}*/
static long _OnProductLoadDataFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnProductLoadData();
}
/*static void _OnProductAddNewFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnProductAddNew();
}*/
/*static void _OnUomChangeFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnUomChange();
} */
/*static void _OnUomSetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnUomSetfocus();} */ 
/*static void _OnUomKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnUomKillfocus();
} */
static int _OnUomCheckValueFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnUomCheckValue();
} 
static void _OnManufactureSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageMedicalCabinetLineInput* )pWnd)->OnManufactureSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnManufactureSelendokFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnManufactureSelendok();
}
/*static void _OnManufactureSetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnManufactureKillfocus();
}*/
/*static void _OnManufactureKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnManufactureKillfocus();
}*/
static long _OnManufactureLoadDataFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnManufactureLoadData();
}
/*static void _OnManufactureAddNewFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnManufactureAddNew();
}*/
/*static void _OnLotNoChangeFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnLotNoChange();
} */
/*static void _OnLotNoSetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnLotNoSetfocus();} */ 
/*static void _OnLotNoKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnLotNoKillfocus();
} */
static int _OnLotNoCheckValueFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnLotNoCheckValue();
} 
/*static void _OnExprDateChangeFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnExprDateChange();
} */
/*static void _OnExprDateSetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnExprDateSetfocus();} */ 
/*static void _OnExprDateKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnExprDateKillfocus();
} */
static int _OnExprDateCheckValueFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnExprDateCheckValue();
} 
/*static void _OnQuantityChangeFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnQuantityChange();
} */
/*static void _OnQuantitySetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnQuantitySetfocus();} */ 
/*static void _OnQuantityKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnQuantityKillfocus();
} */
static int _OnQuantityCheckValueFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnQuantityCheckValue();
} 
/*static void _OnUnitPriceChangeFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnUnitPriceChange();
} */
/*static void _OnUnitPriceSetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnUnitPriceSetfocus();} */ 
/*static void _OnUnitPriceKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnUnitPriceKillfocus();
} */
static int _OnUnitPriceCheckValueFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnUnitPriceCheckValue();
} 
/*static void _OnOnHandChangeFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnOnHandChange();
} */
/*static void _OnOnHandSetfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnOnHandSetfocus();} */ 
/*static void _OnOnHandKillfocusFnc(CWnd *pWnd){
	((CStorageMedicalCabinetLineInput *)pWnd)->OnOnHandKillfocus();
} */
static int _OnOnHandCheckValueFnc(CWnd *pWnd){
	return ((CStorageMedicalCabinetLineInput *)pWnd)->OnOnHandCheckValue();
} 


static void _OnSaveSelectFnc(CWnd *pWnd){
	CStorageMedicalCabinetLineInput *pVw = (CStorageMedicalCabinetLineInput *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddStorageMedicalCabinetLineInputFnc(CWnd *pWnd){
	 return ((CStorageMedicalCabinetLineInput*)pWnd)->OnAddStorageMedicalCabinetLineInput();
} 
static int _OnEditStorageMedicalCabinetLineInputFnc(CWnd *pWnd){
	 return ((CStorageMedicalCabinetLineInput*)pWnd)->OnEditStorageMedicalCabinetLineInput();
} 
static int _OnDeleteStorageMedicalCabinetLineInputFnc(CWnd *pWnd){
	 return ((CStorageMedicalCabinetLineInput*)pWnd)->OnDeleteStorageMedicalCabinetLineInput();
} 
static int _OnSaveStorageMedicalCabinetLineInputFnc(CWnd *pWnd){
	 return ((CStorageMedicalCabinetLineInput*)pWnd)->OnSaveStorageMedicalCabinetLineInput();
} 
static int _OnCancelStorageMedicalCabinetLineInputFnc(CWnd *pWnd){
	 return ((CStorageMedicalCabinetLineInput*)pWnd)->OnCancelStorageMedicalCabinetLineInput();
} 
CStorageMedicalCabinetLineInput::CStorageMedicalCabinetLineInput(CWnd *pParent, int nMode):
	CGuiPopup(pParent){
...
CStorageMedicalCabinetLineInput::~CStorageMedicalCabinetLineInput(){
}
void CStorageMedicalCabinetLineInput::OnCreateComponents(){
/*
...
void CStorageMedicalCabinetLineInput::OnInitializeComponents(){
...
//	m_wndUnitPrice.SetReadOnly(TRUE);
    ...
    m_wndProduct.InsertColumn(12, _T("X"), CFMT_TEXT, 50);
...
void CStorageMedicalCabinetLineInput::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageMedicalCabinetLineInput::OnDoDataExchange(CDataExchange* pDX){
...
void CStorageMedicalCabinetLineInput::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CStorageMedicalCabinetLineInput::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageMedicalCabinetLineInput::SetDefaultValues(){
...
int CStorageMedicalCabinetLineInput::SetMode(int nMode){
...
void CStorageMedicalCabinetLineInput::OnProductSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(nNewItemSel < 0)
		return;
	CString szOnHand;
...
void CStorageMedicalCabinetLineInput::OnProductSelendok(){
	UpdateData(TRUE);
...
/*void CStorageMedicalCabinetLineInput::OnProductSetfocus(){
	
}*/
/*void CStorageMedicalCabinetLineInput::OnProductKillfocus(){
	
}*/
long CStorageMedicalCabinetLineInput::OnProductLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CStorageMedicalCabinetLineInput::OnProductAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageMedicalCabinetLineInput::OnUomChange(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnUomSetfocus(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnUomKillfocus(){
	
} */
int CStorageMedicalCabinetLineInput::OnUomCheckValue(){
	return 0;
} 

void CStorageMedicalCabinetLineInput::OnManufactureSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CStorageMedicalCabinetLineInput::OnManufactureSelendok(){
	 
}
/*void CStorageMedicalCabinetLineInput::OnManufactureSetfocus(){
	
}*/
/*void CStorageMedicalCabinetLineInput::OnManufactureKillfocus(){
	
}*/
long CStorageMedicalCabinetLineInput::OnManufactureLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CStorageMedicalCabinetLineInput::OnManufactureAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageMedicalCabinetLineInput::OnLotNoChange(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnLotNoSetfocus(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnLotNoKillfocus(){
	
} */
int CStorageMedicalCabinetLineInput::OnLotNoCheckValue(){
	return 0;
} 
/*void CStorageMedicalCabinetLineInput::OnExprDateChange(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnExprDateSetfocus(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnExprDateKillfocus(){
	
} */
int CStorageMedicalCabinetLineInput::OnExprDateCheckValue(){
	return 0;
} 
/*void CStorageMedicalCabinetLineInput::OnQuantityChange(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnQuantitySetfocus(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnQuantityKillfocus(){
	
} */
int CStorageMedicalCabinetLineInput::OnQuantityCheckValue(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
...
/*void CStorageMedicalCabinetLineInput::OnUnitPriceChange(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnUnitPriceSetfocus(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnUnitPriceKillfocus(){
	
} */
int CStorageMedicalCabinetLineInput::OnUnitPriceCheckValue(){
	if(m_nUnitPrice <= 0)
		return -1;
...
/*void CStorageMedicalCabinetLineInput::OnOnHandChange(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnOnHandSetfocus(){
	
} */
/*void CStorageMedicalCabinetLineInput::OnOnHandKillfocus(){
	
} */
int CStorageMedicalCabinetLineInput::OnOnHandCheckValue(){
	return 0;
} 

void CStorageMedicalCabinetLineInput::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveStorageMedicalCabinetLineInput();
} 
void CStorageMedicalCabinetLineInput::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CGuiPopup::ClosePopup();
} 
int CStorageMedicalCabinetLineInput::OnAddStorageMedicalCabinetLineInput(){
...
int CStorageMedicalCabinetLineInput::OnEditStorageMedicalCabinetLineInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CStorageMedicalCabinetLineInput::OnDeleteStorageMedicalCabinetLineInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelStorageMedicalCabinetLineInput();
 	}
	return 0;
}
int CStorageMedicalCabinetLineInput::OnSaveStorageMedicalCabinetLineInput(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CStorageMedicalCabinetLineInput::OnCancelStorageMedicalCabinetLineInput(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CStorageMedicalCabinetLineInput::OnStorageMedicalCabinetLineInputListLoadData(){
	return 0;
}
