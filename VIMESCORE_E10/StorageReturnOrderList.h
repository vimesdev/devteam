#ifndef StorageReturnOrderLIST_H
#define StorageReturnOrderLIST_H
...
class AFX_EXT_CLASS CStorageReturnOrderList : public CGuiView{
protected:
public:
	CWnd*			m_wndOrder;
	bool			m_bImportType;
	...
	int OnAddStorageReturnOrderList(); 
	int OnEditStorageReturnOrderList(); 
	int OnDeleteStorageReturnOrderList(); 
	int OnSaveStorageReturnOrderList(); 
	int OnCancelStorageReturnOrderList(); 
	int OnStorageReturnOrderListListLoadData(); 
