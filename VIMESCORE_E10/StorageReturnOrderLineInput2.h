#ifndef StorageReturnOrderLineInput2_H
#define StorageReturnOrderLineInput2_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CStorageReturnOrderLineInput2 : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CStorageReturnOrderLineInput2(CWnd *pParent, int nMode);
	~CStorageReturnOrderLineInput2();
	...
	int OnAddStorageReturnOrderLineInput2(); 
	int OnEditStorageReturnOrderLineInput2(); 
	int OnDeleteStorageReturnOrderLineInput2(); 
	int OnSaveStorageReturnOrderLineInput2(); 
	int OnCancelStorageReturnOrderLineInput2(); 
	int OnStorageReturnOrderLineInput2ListLoadData(); 
};
#endif
