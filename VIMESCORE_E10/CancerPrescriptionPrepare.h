#ifndef HMSCancerPrescriptionPrepare_H
#define HMSCancerPrescriptionPrepare_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCancerPrescriptionPrepare : public CGuiDialog{
protected:
public:
	long			m_nOID;
	long			m_nOrderId;
	...
	CGuiLabel		m_wndPrepareLabel;
	CGuiComboBox	m_wndPrepare;
	CGuiLabel		m_wndPrepare2Label;
	CGuiComboBox	m_wndPrepare2;
	...
	CString	m_szNote;
	CString	m_szPrepareKey;
	CString	m_szPrepare2Key;
	CString m_szStatus;
...
//void			OnGFRChange(); 
	...
	void			OnPrepareSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnPrepareSelendok(); 
	//void			OnPrepareSetfocus(); 
	//void			OnPrepareKillfocus(); 
	long			OnPrepareLoadData(); 
	//void			OnPrepareAddNew(); 
	void			OnPrepare2SelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnPrepare2Selendok(); 
	//void			OnPrepare2Setfocus(); 
	//void			OnPrepare2Killfocus(); 
	long			OnPrepare2LoadData(); 
	//void			OnPrepare2AddNew(); 
	long			OnListLoadData(); 
	...
	void			InPhieudieuche();
	void			InNhanphache();
	CCancerPrescriptionPrepare(CWnd *pParent, int nMode);
	~CCancerPrescriptionPrepare();
	...
	int OnAddHMSCancerPrescriptionPrepare(); 
	int OnEditHMSCancerPrescriptionPrepare(); 
	int OnDeleteHMSCancerPrescriptionPrepare(); 
	int OnSaveHMSCancerPrescriptionPrepare(); 
	int OnCancelHMSCancerPrescriptionPrepare(); 
	int OnHMSCancerPrescriptionPrepareListLoadData(); 
