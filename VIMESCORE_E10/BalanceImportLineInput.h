#ifndef BALANCEIMPORTLINEINPUT_H
#define BALANCEIMPORTLINEINPUT_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CBalanceImportLineInput : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CBalanceImportLineInput(CWnd *pParent, int nMode);
	~CBalanceImportLineInput();
	...
	int OnAddBalanceImportLineInput(); 
	int OnEditBalanceImportLineInput(); 
	int OnDeleteBalanceImportLineInput(); 
	int OnSaveBalanceImportLineInput(); 
	int OnCancelBalanceImportLineInput(); 
	int OnBalanceImportLineInputListLoadData(); 
};
#endif
