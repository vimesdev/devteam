...
static void _OnFromStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageTransactionDialog* )pWnd)->OnFromStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnFromStorageSelendokFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnFromStorageSelendok();
}
/*static void _OnFromStorageSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnFromStorageKillfocus();
}*/
/*static void _OnFromStorageKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnFromStorageKillfocus();
}*/
static long _OnFromStorageLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnFromStorageLoadData();
}
/*static void _OnFromStorageAddNewFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnFromStorageAddNew();
}*/
static void _OnToDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageTransactionDialog* )pWnd)->OnToDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnToDepartmentSelendokFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnToDepartmentSelendok();
}
/*static void _OnToDepartmentSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnToDepartmentKillfocus();
}*/
/*static void _OnToDepartmentKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnToDepartmentKillfocus();
}*/
static long _OnToDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnToDepartmentLoadData();
}
/*static void _OnToDepartmentAddNewFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnToDepartmentAddNew();
}*/
static void _OnDelivererSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageTransactionDialog* )pWnd)->OnDelivererSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDelivererSelendokFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnDelivererSelendok();
}
/*static void _OnDelivererSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnDelivererKillfocus();
}*/
/*static void _OnDelivererKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnDelivererKillfocus();
}*/
static long _OnDelivererLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnDelivererLoadData();
}
/*static void _OnDelivererAddNewFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnDelivererAddNew();
}*/
static void _OnReceiverSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageTransactionDialog* )pWnd)->OnReceiverSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReceiverSelendokFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnReceiverSelendok();
}
/*static void _OnReceiverSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnReceiverKillfocus();
}*/
/*static void _OnReceiverKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnReceiverKillfocus();
}*/
static long _OnReceiverLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnReceiverLoadData();
}
/*static void _OnReceiverAddNewFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnReceiverAddNew();
}*/
/*static void _OnDescriptionChangeFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnDescriptionChange();
} */
/*static void _OnDescriptionSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnDescriptionSetfocus();} */ 
/*static void _OnDescriptionKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnDescriptionKillfocus();
} */
static int _OnDescriptionCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnDescriptionCheckValue();
} 
/*static void _OnOrderNoChangeFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnOrderNoChange();
} */
/*static void _OnOrderNoSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnOrderNoSetfocus();} */ 
/*static void _OnOrderNoKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnOrderNoKillfocus();
} */
static int _OnOrderNoCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnOrderNoCheckValue();
} 
/*static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnOrderDateChange();
} */
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnOrderDateCheckValue();
} 
/*static void _OnAccountingDateChangeFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnAccountingDateChange();
} */
/*static void _OnAccountingDateSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnAccountingDateSetfocus();} */ 
/*static void _OnAccountingDateKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnAccountingDateKillfocus();
} */
static int _OnAccountingDateCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnAccountingDateCheckValue();
} 
static void _OnTransactionTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageTransactionDialog* )pWnd)->OnTransactionTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTransactionTypeSelendokFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTransactionTypeSelendok();
}
/*static void _OnTransactionTypeSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTransactionTypeKillfocus();
}*/
/*static void _OnTransactionTypeKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTransactionTypeKillfocus();
}*/
static long _OnTransactionTypeLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnTransactionTypeLoadData();
}
/*static void _OnTransactionTypeAddNewFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTransactionTypeAddNew();
}*/
/*static void _OnTotalLinesChangeFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTotalLinesChange();
} */
/*static void _OnTotalLinesSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTotalLinesSetfocus();} */ 
/*static void _OnTotalLinesKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTotalLinesKillfocus();
} */
static int _OnTotalLinesCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnTotalLinesCheckValue();
} 
/*static void _OnTotalAmountChangeFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTotalAmountChange();
} */
/*static void _OnTotalAmountSetfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTotalAmountSetfocus();} */ 
/*static void _OnTotalAmountKillfocusFnc(CWnd *pWnd){
	((CCancerStorageTransactionDialog *)pWnd)->OnTotalAmountKillfocus();
} */
static int _OnTotalAmountCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageTransactionDialog *)pWnd)->OnTotalAmountCheckValue();
} 
static void _OnAddSelectFnc(CWnd *pWnd){
	CCancerStorageTransactionDialog *pVw = (CCancerStorageTransactionDialog *)pWnd;
	pVw->OnAddSelect();
} 
...
static void _OnTabSelectChangeFnc(CWnd *pWnd, int nOld, int nNew){
	((CCancerStorageTransactionDialog*)pWnd)->OnTabSelectChange(nOld, nNew);
} 
static int _OnAddCancerStorageTransactionDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageTransactionDialog*)pWnd)->OnAddCancerStorageTransactionDialog();
} 
static int _OnEditCancerStorageTransactionDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageTransactionDialog*)pWnd)->OnEditCancerStorageTransactionDialog();
} 
static int _OnDeleteCancerStorageTransactionDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageTransactionDialog*)pWnd)->OnDeleteCancerStorageTransactionDialog();
} 
static int _OnSaveCancerStorageTransactionDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageTransactionDialog*)pWnd)->OnSaveCancerStorageTransactionDialog();
} 
static int _OnDiscardCancerStorageTransactionDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageTransactionDialog*)pWnd)->OnDiscardCancerStorageTransactionDialog();
} 
CCancerStorageTransactionDialog::CCancerStorageTransactionDialog(CWnd *pParent, int nMode):
	CGuiDialog(pParent){
	...
	SetWindowName(_T("CancerStorageTransactionDialog"));
	m_bRefresh  = false;
	

}
CCancerStorageTransactionDialog::~CCancerStorageTransactionDialog(){
	
}
void CCancerStorageTransactionDialog::OnCreateComponents(){
...
void CCancerStorageTransactionDialog::OnInitializeComponents(){
...
void CCancerStorageTransactionDialog::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CCancerStorageTransactionDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CCancerStorageTransactionDialog::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CCancerStorageTransactionDialog::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(GetMode() == VM_EDIT)
	{
		CString szWhere;
...
void CCancerStorageTransactionDialog::SetDefaultValues(){
...
int CCancerStorageTransactionDialog::SetMode(int nMode){
...
void CCancerStorageTransactionDialog::OnFromStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CCancerStorageTransactionDialog::OnFromStorageSelendok(){
	 
}

/*void CCancerStorageTransactionDialog::OnFromStorageSetfocus(){
	
}*/
/*void CCancerStorageTransactionDialog::OnFromStorageKillfocus(){
	
}*/
long CCancerStorageTransactionDialog::OnFromStorageLoadData(){
...
/*void CCancerStorageTransactionDialog::OnFromStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CCancerStorageTransactionDialog::OnToDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CCancerStorageTransactionDialog::OnToDepartmentSelendok(){
	 
}

/*void CCancerStorageTransactionDialog::OnToDepartmentSetfocus(){
	
}*/
/*void CCancerStorageTransactionDialog::OnToDepartmentKillfocus(){
	
}*/
long CCancerStorageTransactionDialog::OnToDepartmentLoadData(){
...
/*void CCancerStorageTransactionDialog::OnToDepartmentAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CCancerStorageTransactionDialog::OnDelivererSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CCancerStorageTransactionDialog::OnDelivererSelendok(){
	 
}

/*void CCancerStorageTransactionDialog::OnDelivererSetfocus(){
	
}*/
/*void CCancerStorageTransactionDialog::OnDelivererKillfocus(){
	
}*/
long CCancerStorageTransactionDialog::OnDelivererLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadUserList(&m_wndDeliverer, m_szDelivererKey);
}

/*void CCancerStorageTransactionDialog::OnDelivererAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CCancerStorageTransactionDialog::OnReceiverSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CCancerStorageTransactionDialog::OnReceiverSelendok(){
	 
}

/*void CCancerStorageTransactionDialog::OnReceiverSetfocus(){
	
}*/
/*void CCancerStorageTransactionDialog::OnReceiverKillfocus(){
	
}*/
long CCancerStorageTransactionDialog::OnReceiverLoadData(){
	
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadUserList(&m_wndReceiver, m_szReceiverKey);
}

/*void CCancerStorageTransactionDialog::OnReceiverAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CCancerStorageTransactionDialog::OnDescriptionChange(){
	
} */
/*void CCancerStorageTransactionDialog::OnDescriptionSetfocus(){
	
} */
/*void CCancerStorageTransactionDialog::OnDescriptionKillfocus(){
	
} */
int CCancerStorageTransactionDialog::OnDescriptionCheckValue(){
	return 0;
}
 
/*void CCancerStorageTransactionDialog::OnOrderNoChange(){
	
} */
/*void CCancerStorageTransactionDialog::OnOrderNoSetfocus(){
	
} */
/*void CCancerStorageTransactionDialog::OnOrderNoKillfocus(){
	
} */
int CCancerStorageTransactionDialog::OnOrderNoCheckValue(){
	return 0;
} 
/*void CCancerStorageTransactionDialog::OnOrderDateChange(){
	
} */
/*void CCancerStorageTransactionDialog::OnOrderDateSetfocus(){
	
} */
/*void CCancerStorageTransactionDialog::OnOrderDateKillfocus(){
	
} */
int CCancerStorageTransactionDialog::OnOrderDateCheckValue(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
...
/*void CCancerStorageTransactionDialog::OnAccountingDateChange(){
	
} */
/*void CCancerStorageTransactionDialog::OnAccountingDateSetfocus(){
	
} */
/*void CCancerStorageTransactionDialog::OnAccountingDateKillfocus(){
	
} */
int CCancerStorageTransactionDialog::OnAccountingDateCheckValue(){
	return 0;
} 
void CCancerStorageTransactionDialog::OnTransactionTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CCancerStorageTransactionDialog::OnTransactionTypeSelendok(){
	 
}
/*void CCancerStorageTransactionDialog::OnTransactionTypeSetfocus(){
	
}*/
/*void CCancerStorageTransactionDialog::OnTransactionTypeKillfocus(){
	
}*/
long CCancerStorageTransactionDialog::OnTransactionTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CCancerStorageTransactionDialog::OnTransactionTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
 
/*void CCancerStorageTransactionDialog::OnTotalLinesChange(){
	
} */
/*void CCancerStorageTransactionDialog::OnTotalLinesSetfocus(){
	
} */
/*void CCancerStorageTransactionDialog::OnTotalLinesKillfocus(){
	
} */
int CCancerStorageTransactionDialog::OnTotalLinesCheckValue(){
	return 0;
} 
/*void CCancerStorageTransactionDialog::OnTotalAmountChange(){
	
} */
/*void CCancerStorageTransactionDialog::OnTotalAmountSetfocus(){
	
} */
/*void CCancerStorageTransactionDialog::OnTotalAmountKillfocus(){
	
} */
int CCancerStorageTransactionDialog::OnTotalAmountCheckValue(){
	return 0;
}
 
void CCancerStorageTransactionDialog::OnAddSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnAddCancerStorageTransactionDialog();
}
 
void CCancerStorageTransactionDialog::OnEditSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnEditCancerStorageTransactionDialog();

}
 
void CCancerStorageTransactionDialog::OnDeleteSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDeleteCancerStorageTransactionDialog();
}
 
void CCancerStorageTransactionDialog::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveCancerStorageTransactionDialog();
}
 
void CCancerStorageTransactionDialog::OnDiscardSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_szOrgID == pMF->GetModuleID())
		OnDiscardCancerStorageTransactionDialog();
	else
	{
		CString szSQL;
...
void CCancerStorageTransactionDialog::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CCancerStorageTransactionDialog::OnPostSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CCancerStorageTransactionDialog::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_bRefresh)
		CGuiDialog::OnOK();
	else
...
void CCancerStorageTransactionDialog::OnConfirmSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_szStatus != _T("S"))
	{
		ShowMessageBox(_T("Cannot process with current status"));
...
void CCancerStorageTransactionDialog::OnDisconfirmSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_szStatus != _T("S"))
	{
		ShowMessageBox(_T("Cannot process with current status"));
...
void CCancerStorageTransactionDialog::OnAddLineSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
	{
...
void CCancerStorageTransactionDialog::OnTabSelectChange(int nOld, int nNew){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CCancerStorageTransactionDialog::OnAddCancerStorageTransactionDialog(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
...
int CCancerStorageTransactionDialog::OnEditCancerStorageTransactionDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
	if(m_szStatus != _T("O")){
...
int CCancerStorageTransactionDialog::OnDeleteCancerStorageTransactionDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CCancerStorageTransactionDialog::OnSaveCancerStorageTransactionDialog(){
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
...
int CCancerStorageTransactionDialog::OnDiscardCancerStorageTransactionDialog(){
...
int CCancerStorageTransactionDialog::OnCancerStorageTransactionDialogListLoadData(){
	return 0;
}


CString CCancerStorageTransactionDialog::GetOrderStatus(){
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
...
bool CCancerStorageTransactionDialog::IsAllowEdit(){
...
void CCancerStorageTransactionDialog::LoadNotifications()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
