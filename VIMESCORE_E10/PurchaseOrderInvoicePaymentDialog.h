#ifndef PurchaseOrderInvoicePaymentDialog_H
#define PurchaseOrderInvoicePaymentDialog_H
...
class CPurchaseOrderInvoicePaymentDialog : public CGuiDialog
{
protected:
	bool	m_bRefresh;
...
public:
	...
	CPurchaseOrderInvoicePaymentDialog(CWnd *pParent, int nMode);
	~CPurchaseOrderInvoicePaymentDialog();
	...
	int OnAddPurchaseOrderInvoicePaymentDialog(); 
	int OnEditPurchaseOrderInvoicePaymentDialog(); 
	int OnDeletePurchaseOrderInvoicePaymentDialog(); 
	int OnSavePurchaseOrderInvoicePaymentDialog(); 
	int OnCancelPurchaseOrderInvoicePaymentDialog(); 
	int OnPurchaseOrderInvoicePaymentDialogListLoadData(); 
