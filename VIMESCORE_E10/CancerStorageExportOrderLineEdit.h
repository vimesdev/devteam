#ifndef CancerStorageExportOrderLineEdit_H
#define CancerStorageExportOrderLineEdit_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCancerStorageExportOrderLineEdit : public CGuiDialog{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CCancerStorageExportOrderLineEdit(CWnd *pParent, int nMode);
	~CCancerStorageExportOrderLineEdit();
	...
	int OnAddCancerStorageExportOrderLineEdit(); 
	int OnEditCancerStorageExportOrderLineEdit(); 
	int OnDeleteCancerStorageExportOrderLineEdit(); 
	int OnSaveCancerStorageExportOrderLineEdit(); 
	int OnCancelCancerStorageExportOrderLineEdit(); 
	int OnCancerStorageExportOrderLineEditListLoadData(); 
};
#endif
