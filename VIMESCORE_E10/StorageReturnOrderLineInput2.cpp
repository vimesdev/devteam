...
static void _OnProductSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageReturnOrderLineInput2* )pWnd)->OnProductSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnProductSelendokFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnProductSelendok();
}
/*static void _OnProductSetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnProductKillfocus();
}*/
/*static void _OnProductKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnProductKillfocus();
}*/
static long _OnProductLoadDataFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnProductLoadData();
}
/*static void _OnProductAddNewFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnProductAddNew();
}*/
/*static void _OnUomChangeFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnUomChange();
} */
/*static void _OnUomSetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnUomSetfocus();} */ 
/*static void _OnUomKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnUomKillfocus();
} */
static int _OnUomCheckValueFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnUomCheckValue();
} 
static void _OnManufactureSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageReturnOrderLineInput2* )pWnd)->OnManufactureSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnManufactureSelendokFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnManufactureSelendok();
}
/*static void _OnManufactureSetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnManufactureKillfocus();
}*/
/*static void _OnManufactureKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnManufactureKillfocus();
}*/
static long _OnManufactureLoadDataFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnManufactureLoadData();
}
/*static void _OnManufactureAddNewFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnManufactureAddNew();
}*/
/*static void _OnLotNoChangeFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnLotNoChange();
} */
/*static void _OnLotNoSetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnLotNoSetfocus();} */ 
/*static void _OnLotNoKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnLotNoKillfocus();
} */
static int _OnLotNoCheckValueFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnLotNoCheckValue();
} 
/*static void _OnExprDateChangeFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnExprDateChange();
} */
/*static void _OnExprDateSetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnExprDateSetfocus();} */ 
/*static void _OnExprDateKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnExprDateKillfocus();
} */
static int _OnExprDateCheckValueFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnExprDateCheckValue();
} 
/*static void _OnQuantityChangeFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnQuantityChange();
} */
/*static void _OnQuantitySetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnQuantitySetfocus();} */ 
/*static void _OnQuantityKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnQuantityKillfocus();
} */
static int _OnQuantityCheckValueFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnQuantityCheckValue();
} 
/*static void _OnUnitPriceChangeFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnUnitPriceChange();
} */
/*static void _OnUnitPriceSetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnUnitPriceSetfocus();} */ 
/*static void _OnUnitPriceKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnUnitPriceKillfocus();
} */
static int _OnUnitPriceCheckValueFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnUnitPriceCheckValue();
} 
/*static void _OnOnHandChangeFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnOnHandChange();
} */
/*static void _OnOnHandSetfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnOnHandSetfocus();} */ 
/*static void _OnOnHandKillfocusFnc(CWnd *pWnd){
	((CStorageReturnOrderLineInput2 *)pWnd)->OnOnHandKillfocus();
} */
static int _OnOnHandCheckValueFnc(CWnd *pWnd){
	return ((CStorageReturnOrderLineInput2 *)pWnd)->OnOnHandCheckValue();
} 


static void _OnSaveSelectFnc(CWnd *pWnd){
	CStorageReturnOrderLineInput2 *pVw = (CStorageReturnOrderLineInput2 *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddStorageReturnOrderLineInput2Fnc(CWnd *pWnd){
	 return ((CStorageReturnOrderLineInput2*)pWnd)->OnAddStorageReturnOrderLineInput2();
} 
static int _OnEditStorageReturnOrderLineInput2Fnc(CWnd *pWnd){
	 return ((CStorageReturnOrderLineInput2*)pWnd)->OnEditStorageReturnOrderLineInput2();
} 
static int _OnDeleteStorageReturnOrderLineInput2Fnc(CWnd *pWnd){
	 return ((CStorageReturnOrderLineInput2*)pWnd)->OnDeleteStorageReturnOrderLineInput2();
} 
static int _OnSaveStorageReturnOrderLineInput2Fnc(CWnd *pWnd){
	 return ((CStorageReturnOrderLineInput2*)pWnd)->OnSaveStorageReturnOrderLineInput2();
} 
static int _OnCancelStorageReturnOrderLineInput2Fnc(CWnd *pWnd){
	 return ((CStorageReturnOrderLineInput2*)pWnd)->OnCancelStorageReturnOrderLineInput2();
} 
CStorageReturnOrderLineInput2::CStorageReturnOrderLineInput2(CWnd *pParent, int nMode):
	CGuiPopup(pParent){
...
CStorageReturnOrderLineInput2::~CStorageReturnOrderLineInput2(){
}
void CStorageReturnOrderLineInput2::OnCreateComponents(){
/*
...
void CStorageReturnOrderLineInput2::OnInitializeComponents(){
...
void CStorageReturnOrderLineInput2::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageReturnOrderLineInput2::OnDoDataExchange(CDataExchange* pDX){
...
void CStorageReturnOrderLineInput2::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CStorageReturnOrderLineInput2::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageReturnOrderLineInput2::SetDefaultValues(){
...
int CStorageReturnOrderLineInput2::SetMode(int nMode){
...
void CStorageReturnOrderLineInput2::OnProductSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(nNewItemSel < 0)
		return;
	CString szOnHand;
...
void CStorageReturnOrderLineInput2::OnProductSelendok(){
	UpdateData(TRUE);
...
/*void CStorageReturnOrderLineInput2::OnProductSetfocus(){
	
}*/
/*void CStorageReturnOrderLineInput2::OnProductKillfocus(){
	
}*/
long CStorageReturnOrderLineInput2::OnProductLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CStorageReturnOrderLineInput2::OnProductAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageReturnOrderLineInput2::OnUomChange(){
	
} */
/*void CStorageReturnOrderLineInput2::OnUomSetfocus(){
	
} */
/*void CStorageReturnOrderLineInput2::OnUomKillfocus(){
	
} */
int CStorageReturnOrderLineInput2::OnUomCheckValue(){
	return 0;
} 

void CStorageReturnOrderLineInput2::OnManufactureSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CStorageReturnOrderLineInput2::OnManufactureSelendok(){
	 
}
/*void CStorageReturnOrderLineInput2::OnManufactureSetfocus(){
	
}*/
/*void CStorageReturnOrderLineInput2::OnManufactureKillfocus(){
	
}*/
long CStorageReturnOrderLineInput2::OnManufactureLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CStorageReturnOrderLineInput2::OnManufactureAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageReturnOrderLineInput2::OnLotNoChange(){
	
} */
/*void CStorageReturnOrderLineInput2::OnLotNoSetfocus(){
	
} */
/*void CStorageReturnOrderLineInput2::OnLotNoKillfocus(){
	
} */
int CStorageReturnOrderLineInput2::OnLotNoCheckValue(){
	return 0;
} 
/*void CStorageReturnOrderLineInput2::OnExprDateChange(){
	
} */
/*void CStorageReturnOrderLineInput2::OnExprDateSetfocus(){
	
} */
/*void CStorageReturnOrderLineInput2::OnExprDateKillfocus(){
	
} */
int CStorageReturnOrderLineInput2::OnExprDateCheckValue(){
	return 0;
} 
/*void CStorageReturnOrderLineInput2::OnQuantityChange(){
	
} */
/*void CStorageReturnOrderLineInput2::OnQuantitySetfocus(){
	
} */
/*void CStorageReturnOrderLineInput2::OnQuantityKillfocus(){
	
} */
int CStorageReturnOrderLineInput2::OnQuantityCheckValue(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
...
/*void CStorageReturnOrderLineInput2::OnUnitPriceChange(){
	
} */
/*void CStorageReturnOrderLineInput2::OnUnitPriceSetfocus(){
	
} */
/*void CStorageReturnOrderLineInput2::OnUnitPriceKillfocus(){
	
} */
int CStorageReturnOrderLineInput2::OnUnitPriceCheckValue(){
	if(m_nUnitPrice <= 0)
		return -1;
...
/*void CStorageReturnOrderLineInput2::OnOnHandChange(){
	
} */
/*void CStorageReturnOrderLineInput2::OnOnHandSetfocus(){
	
} */
/*void CStorageReturnOrderLineInput2::OnOnHandKillfocus(){
	
} */
int CStorageReturnOrderLineInput2::OnOnHandCheckValue(){
	return 0;
} 

void CStorageReturnOrderLineInput2::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveStorageReturnOrderLineInput2();
} 
void CStorageReturnOrderLineInput2::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CGuiPopup::ClosePopup();
} 
int CStorageReturnOrderLineInput2::OnAddStorageReturnOrderLineInput2(){
...
int CStorageReturnOrderLineInput2::OnEditStorageReturnOrderLineInput2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CStorageReturnOrderLineInput2::OnDeleteStorageReturnOrderLineInput2(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelStorageReturnOrderLineInput2();
 	}
	return 0;
}
int CStorageReturnOrderLineInput2::OnSaveStorageReturnOrderLineInput2(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CStorageReturnOrderLineInput2::OnCancelStorageReturnOrderLineInput2(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CStorageReturnOrderLineInput2::OnStorageReturnOrderLineInput2ListLoadData(){
	return 0;
}
