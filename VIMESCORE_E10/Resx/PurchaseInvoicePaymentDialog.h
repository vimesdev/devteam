#ifndef PURCHASEINVOICEPAYMENTDIALOG_H
#define PURCHASEINVOICEPAYMENTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CPurchaseInvoicePaymentDialog : public CGuiDialog{
protected:
public:
	...
	CPurchaseInvoicePaymentDialog(CWnd *pParent);
	~CPurchaseInvoicePaymentDialog();
	...
	int OnAddPurchaseInvoicePaymentDialog(); 
	int OnEditPurchaseInvoicePaymentDialog(); 
	int OnDeletePurchaseInvoicePaymentDialog(); 
	int OnSavePurchaseInvoicePaymentDialog(); 
	int OnCancelPurchaseInvoicePaymentDialog(); 
	int OnPurchaseInvoicePaymentDialogListLoadData(); 
};
#endif
