#ifndef ACCCASHINFO_H
#define ACCCASHINFO_H
...
#include "GuiView.h"
#include "DbField.h"
class CAccCashInfo : public CGuiView{
protected:
public:
	...
	int OnAddAccCashInfo(); 
	int OnEditAccCashInfo(); 
	int OnDeleteAccCashInfo(); 
	int OnSaveAccCashInfo(); 
	int OnCancelAccCashInfo(); 
	int OnAccCashInfoListLoadData(); 
};
#endif
