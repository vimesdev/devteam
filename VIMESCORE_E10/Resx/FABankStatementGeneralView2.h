#ifndef FABANKSTATEMENTGENERALVIEW2_H
#define FABANKSTATEMENTGENERALVIEW2_H
...
#include "GuiView.h"
#include "DbField.h"
class CFABankStatementGeneralView2 : public CGuiView{
protected:
public:
	...
	int OnAddFABankStatementGeneralView2(); 
	int OnEditFABankStatementGeneralView2(); 
	int OnDeleteFABankStatementGeneralView2(); 
	int OnSaveFABankStatementGeneralView2(); 
	int OnCancelFABankStatementGeneralView2(); 
	int OnFABankStatementGeneralView2ListLoadData(); 
};
#endif
