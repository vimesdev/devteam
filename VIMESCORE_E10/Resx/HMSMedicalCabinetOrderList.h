#ifndef HMSMEDICALCABINETORDERLIST_H
#define HMSMEDICALCABINETORDERLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSMedicalCabinetOrderList : public CGuiView{
protected:
public:
	...
	int OnAddHMSMedicalCabinetOrderList(); 
	int OnEditHMSMedicalCabinetOrderList(); 
	int OnDeleteHMSMedicalCabinetOrderList(); 
	int OnSaveHMSMedicalCabinetOrderList(); 
	int OnCancelHMSMedicalCabinetOrderList(); 
	int OnHMSMedicalCabinetOrderListListLoadData(); 
};
#endif
