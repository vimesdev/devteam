#ifndef ACCOBJECTINFO_H
#define ACCOBJECTINFO_H
...
#include "GuiView.h"
#include "DbField.h"
class CAccObjectInfo : public CGuiView{
protected:
public:
	...
	int OnAddAccObjectInfo(); 
	int OnEditAccObjectInfo(); 
	int OnDeleteAccObjectInfo(); 
	int OnSaveAccObjectInfo(); 
	int OnCancelAccObjectInfo(); 
	int OnAccObjectInfoListLoadData(); 
};
#endif
