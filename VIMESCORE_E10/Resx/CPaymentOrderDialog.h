#ifndef CPAYMENTORDERDIALOG_H
#define CPAYMENTORDERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCPaymentOrderDialog : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CCPaymentOrderDialog(CWnd *pParent);
	~CCPaymentOrderDialog();
	...
	int OnAddCPaymentOrderDialog(); 
	int OnEditCPaymentOrderDialog(); 
	int OnDeleteCPaymentOrderDialog(); 
	int OnSaveCPaymentOrderDialog(); 
	int OnCancelCPaymentOrderDialog(); 
	int OnCPaymentOrderDialogListLoadData(); 
};
#endif
