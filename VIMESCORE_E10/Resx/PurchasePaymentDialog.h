...
#include "GuiDialog.h"
#include "DbField.h"
class CPurchasePaymentDialog : public CGuiDialog{
protected:
public:
	CGuiLabel		m_wndPaymentMethodLabel;
	CGuiComboBox	m_wndPaymentMethod;
	CGuiLabel		m_wndDepositNumberLabel;
	CGuiTextCtrl	m_wndDepositNumber;
	...
	//void			OnDepositNumberChange(); 
	//void			OnDepositNumberSetfocus(); 
	//void			OnDepositNumberKillfocus(); 
	int			OnDepositNumberCheckValue(); 
	...
	CPurchasePaymentDialog(CWnd *pParent);
	~CPurchasePaymentDialog();
	...
	int OnAddPurchasePaymentDialog(); 
	int OnEditPurchasePaymentDialog(); 
	int OnDeletePurchasePaymentDialog(); 
	int OnSavePurchasePaymentDialog(); 
	int OnCancelPurchasePaymentDialog(); 
	int OnPurchasePaymentDialogListLoadData(); 
};
#endif
