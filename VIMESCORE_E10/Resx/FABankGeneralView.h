#ifndef FABANKGENERALVIEW_H
#define FABANKGENERALVIEW_H
...
#include "GuiView.h"
#include "DbField.h"
class CFABankGeneralView : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndVoucherInformation;
	CGuiGroupBox	m_wndParnterInformation;
	...
	CGuiLabel		m_wndPBankAccountLabel;
	CGuiTextCtrl	m_wndPBankAccount;
	CGuiTextCtrl	m_wndPBankName;
	...
	CString	m_szAddress;
	CString	m_szPBankAccount;
	CString	m_szPBankName;
	...
	//void			OnPBankAccountChange(); 
	//void			OnPBankAccountSetfocus(); 
	//void			OnPBankAccountKillfocus(); 
	int			OnPBankAccountCheckValue(); 
	//void			OnPBankNameChange(); 
	//void			OnPBankNameSetfocus(); 
	//void			OnPBankNameKillfocus(); 
	int			OnPBankNameCheckValue(); 
	...
	int OnAddFABankGeneralView(); 
	int OnEditFABankGeneralView(); 
	int OnDeleteFABankGeneralView(); 
	int OnSaveFABankGeneralView(); 
	int OnCancelFABankGeneralView(); 
	int OnFABankGeneralViewListLoadData(); 
};
#endif
