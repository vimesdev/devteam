...
#include "GuiDialog.h"
#include "DbField.h"
class CAccAccount : public CGuiDialog{
protected:
public:
	...
	int OnAddAccAccount(); 
	int OnEditAccAccount(); 
	int OnDeleteAccAccount(); 
	int OnSaveAccAccount(); 
	int OnCancelAccAccount(); 
	int OnAccAccountListLoadData(); 
};
#endif
