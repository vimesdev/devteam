...
public:
	...
	CGuiLabel		m_wndAcctDateLabel;
	CGuiDateCtrl	m_wndAcctDate;
	...
	//void			OnAcctDateChange(); 
	//void			OnAcctDateSetfocus(); 
	//void			OnAcctDateKillfocus(); 
	int			OnAcctDateCheckValue(); 
	...
	CGlassSaleOrderDialog(CWnd *pParent);
