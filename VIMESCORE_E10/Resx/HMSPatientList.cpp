...
/*static void _OnSearchNameChangeFnc(CWnd *pWnd){
	((CHMSPatientList *)pWnd)->OnSearchNameChange();
} */
/*static void _OnSearchNameSetfocusFnc(CWnd *pWnd){
	((CHMSPatientList *)pWnd)->OnSearchNameSetfocus();} */ 
/*static void _OnSearchNameKillfocusFnc(CWnd *pWnd){
	((CHMSPatientList *)pWnd)->OnSearchNameKillfocus();
} */
static int _OnSearchNameCheckValueFnc(CWnd *pWnd){
	return ((CHMSPatientList *)pWnd)->OnSearchNameCheckValue();
} 
...
void CHMSPatientList::OnCreateComponents(){
	...
	m_wndDepartment.Create(this,110, 6, 318, 31); 
	m_wndStatusLabel.Create(this, _T("Status"), 5, 36, 105, 61);
	m_wndStatus.Create(this,110, 36, 318, 61); 
	m_wndSearchNameLabel.Create(this, _T("Name#"), 5, 66, 105, 91);
	m_wndSearchName.Create(this,110, 66, 230, 91); 
	m_wndSearch.Create(this, _T("Search"), 235, 66, 315, 91);
	m_wndList.Create(this,5, 96, 315, 596); 
...
void CHMSPatientList::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
/*void CHMSPatientList::OnSearchNameChange(){
	
} */
/*void CHMSPatientList::OnSearchNameSetfocus(){
	
} */
/*void CHMSPatientList::OnSearchNameKillfocus(){
	
} */
int CHMSPatientList::OnSearchNameCheckValue(){
	return 0;
} 
