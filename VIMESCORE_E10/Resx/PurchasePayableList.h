...
#include "GuiView.h"
#include "DbField.h"
class CPurchasePayableList : public CGuiView{
protected:
public:
	...
	int OnAddPurchasePayableList(); 
	int OnEditPurchasePayableList(); 
	int OnDeletePurchasePayableList(); 
	int OnSavePurchasePayableList(); 
	int OnCancelPurchasePayableList(); 
	int OnPurchasePayableListListLoadData(); 
};
#endif
