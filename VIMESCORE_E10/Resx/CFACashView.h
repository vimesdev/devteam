#ifndef CFACASHVIEW_H
#define CFACASHVIEW_H
...
#include "GuiView.h"
#include "DbField.h"
class CCFACashView : public CGuiView{
protected:
public:
	...
	int OnAddCFACashView(); 
	int OnEditCFACashView(); 
	int OnDeleteCFACashView(); 
	int OnSaveCFACashView(); 
	int OnCancelCFACashView(); 
	int OnCFACashViewListLoadData(); 
};
#endif
