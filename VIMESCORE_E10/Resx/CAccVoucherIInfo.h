#ifndef CACCVOUCHERIINFO_H
#define CACCVOUCHERIINFO_H
...
#include "GuiView.h"
#include "DbField.h"
class CCAccVoucherIInfo : public CGuiView{
protected:
public:
	...
	int OnAddCAccVoucherIInfo(); 
	int OnEditCAccVoucherIInfo(); 
	int OnDeleteCAccVoucherIInfo(); 
	int OnSaveCAccVoucherIInfo(); 
	int OnCancelCAccVoucherIInfo(); 
	int OnCAccVoucherIInfoListLoadData(); 
};
#endif
