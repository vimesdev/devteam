#ifndef CPOAUTOCREATEITEMDIALOG_H
#define CPOAUTOCREATEITEMDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCPOAutoCreateItemDialog : public CGuiDialog{
protected:
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CCPOAutoCreateItemDialog(CWnd *pParent);
	~CCPOAutoCreateItemDialog();
	...
	int OnAddCPOAutoCreateItemDialog(); 
	int OnEditCPOAutoCreateItemDialog(); 
	int OnDeleteCPOAutoCreateItemDialog(); 
	int OnSaveCPOAutoCreateItemDialog(); 
	int OnCancelCPOAutoCreateItemDialog(); 
	int OnCPOAutoCreateItemDialogListLoadData(); 
};
#endif
