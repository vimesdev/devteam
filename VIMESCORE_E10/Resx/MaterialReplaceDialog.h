...
public:
	...
	CGuiLabel		m_wndQtyReplace2;
	CGuiNumberCtrl	m_wndQtyReplace2;
	CGuiLabel		m_wndNoteLabel;
	CGuiTextCtrl	m_wndNote;
	CGuiLabel		m_wndRemainQtyLabel;
	CGuiNumberCtrl	m_wndRemainQty;
	...
	//void			OnRemainQtyChange(); 
	//void			OnRemainQtySetfocus(); 
	//void			OnRemainQtyKillfocus(); 
	int			OnRemainQtyCheckValue(); 
	void			OnClearSelect(); 
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
