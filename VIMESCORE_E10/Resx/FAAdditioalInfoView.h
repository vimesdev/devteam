#ifndef FAADDITIOALINFOVIEW_H
#define FAADDITIOALINFOVIEW_H
...
#include "GuiView.h"
#include "DbField.h"
class CFAAdditioalInfoView : public CGuiView{
protected:
public:
	...
	int OnAddFAAdditioalInfoView(); 
	int OnEditFAAdditioalInfoView(); 
	int OnDeleteFAAdditioalInfoView(); 
	int OnSaveFAAdditioalInfoView(); 
	int OnCancelFAAdditioalInfoView(); 
	int OnFAAdditioalInfoViewListLoadData(); 
};
#endif
