#ifndef FABANKSTATEMENTGENERALVIEW_MOVE_H
#define FABANKSTATEMENTGENERALVIEW_MOVE_H
...
#include "GuiView.h"
#include "DbField.h"
class CFABankStatementGeneralView_MOVE : public CGuiView{
protected:
public:
	...
	CFABankStatementGeneralView_MOVE();
	~CFABankStatementGeneralView_MOVE();
	...
	int OnAddFABankStatementGeneralView_MOVE(); 
	int OnEditFABankStatementGeneralView_MOVE(); 
	int OnDeleteFABankStatementGeneralView_MOVE(); 
	int OnSaveFABankStatementGeneralView_MOVE(); 
	int OnCancelFABankStatementGeneralView_MOVE(); 
	int OnFABankStatementGeneralView_MOVEListLoadData(); 
};
#endif
