#include "StorageImportLineInput2.h"
#include "MainFrame_E10.h"
#include "StorageImportDialog.h"

static void _OnProductSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageImportLineInput2* )pWnd)->OnProductSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnProductSelendokFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnProductSelendok();
}
/*static void _OnProductSetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnProductKillfocus();
}*/
/*static void _OnProductKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnProductKillfocus();
}*/
static long _OnProductLoadDataFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnProductLoadData();
}
/*static void _OnProductAddNewFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnProductAddNew();
}*/
/*static void _OnUomChangeFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnUomChange();
} */
/*static void _OnUomSetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnUomSetfocus();} */ 
/*static void _OnUomKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnUomKillfocus();
} */
static int _OnUomCheckValueFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnUomCheckValue();
} 
static void _OnManufactureSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CStorageImportLineInput2* )pWnd)->OnManufactureSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnManufactureSelendokFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnManufactureSelendok();
}
/*static void _OnManufactureSetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnManufactureKillfocus();
}*/
/*static void _OnManufactureKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnManufactureKillfocus();
}*/
static long _OnManufactureLoadDataFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnManufactureLoadData();
}
/*static void _OnManufactureAddNewFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnManufactureAddNew();
}*/
/*static void _OnLotNoChangeFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnLotNoChange();
} */
/*static void _OnLotNoSetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnLotNoSetfocus();} */ 
/*static void _OnLotNoKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnLotNoKillfocus();
} */
static int _OnLotNoCheckValueFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnLotNoCheckValue();
} 
/*static void _OnExprDateChangeFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnExprDateChange();
} */
/*static void _OnExprDateSetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnExprDateSetfocus();} */ 
/*static void _OnExprDateKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnExprDateKillfocus();
} */
static int _OnExprDateCheckValueFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnExprDateCheckValue();
} 
/*static void _OnQuantityChangeFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnQuantityChange();
} */
/*static void _OnQuantitySetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnQuantitySetfocus();} */ 
/*static void _OnQuantityKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnQuantityKillfocus();
} */
static int _OnQuantityCheckValueFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnQuantityCheckValue();
} 
/*static void _OnUnitPriceChangeFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnUnitPriceChange();
} */
/*static void _OnUnitPriceSetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnUnitPriceSetfocus();} */ 
/*static void _OnUnitPriceKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnUnitPriceKillfocus();
} */
static int _OnUnitPriceCheckValueFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnUnitPriceCheckValue();
} 
/*static void _OnOnHandChangeFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnOnHandChange();
} */
/*static void _OnOnHandSetfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnOnHandSetfocus();} */ 
/*static void _OnOnHandKillfocusFnc(CWnd *pWnd){
	((CStorageImportLineInput2 *)pWnd)->OnOnHandKillfocus();
} */
static int _OnOnHandCheckValueFnc(CWnd *pWnd){
	return ((CStorageImportLineInput2 *)pWnd)->OnOnHandCheckValue();
} 


static void _OnSaveSelectFnc(CWnd *pWnd){
	CStorageImportLineInput2 *pVw = (CStorageImportLineInput2 *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddStorageDeliveryOrderLineInputFnc(CWnd *pWnd){
	 return ((CStorageImportLineInput2*)pWnd)->OnAddStorageDeliveryOrderLineInput();
} 
static int _OnEditStorageDeliveryOrderLineInputFnc(CWnd *pWnd){
	 return ((CStorageImportLineInput2*)pWnd)->OnEditStorageDeliveryOrderLineInput();
} 
static int _OnDeleteStorageDeliveryOrderLineInputFnc(CWnd *pWnd){
	 return ((CStorageImportLineInput2*)pWnd)->OnDeleteStorageDeliveryOrderLineInput();
} 
static int _OnSaveStorageDeliveryOrderLineInputFnc(CWnd *pWnd){
	 return ((CStorageImportLineInput2*)pWnd)->OnSaveStorageDeliveryOrderLineInput();
} 
static int _OnCancelStorageDeliveryOrderLineInputFnc(CWnd *pWnd){
	 return ((CStorageImportLineInput2*)pWnd)->OnCancelStorageDeliveryOrderLineInput();
} 
CStorageImportLineInput2::CStorageImportLineInput2(CWnd *pParent, int nMode):
	CGuiPopup(pParent){
...
CStorageImportLineInput2::~CStorageImportLineInput2(){
}
void CStorageImportLineInput2::OnCreateComponents(){
...
void CStorageImportLineInput2::OnInitializeComponents(){
...
void CStorageImportLineInput2::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	...
	CStorageImportDialog* pDlg = (CStorageImportDialog*) pMF->GetRefWindow(_T("StorageImportDialog"));
...
void CStorageImportLineInput2::OnDoDataExchange(CDataExchange* pDX){
...
void CStorageImportLineInput2::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CStorageImportLineInput2::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CStorageImportLineInput2::SetDefaultValues(){
...
int CStorageImportLineInput2::SetMode(int nMode){
...
void CStorageImportLineInput2::OnProductSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CStorageImportLineInput2::OnProductSelendok(){
	UpdateData(TRUE);
...
/*void CStorageImportLineInput2::OnProductSetfocus(){
	
}*/
/*void CStorageImportLineInput2::OnProductKillfocus(){
	
}*/
long CStorageImportLineInput2::OnProductLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
	szFilter.Format(_T(" and msl_storage_id=%ld"), m_nStorageToID);
...
/*void CStorageImportLineInput2::OnProductAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageImportLineInput2::OnUomChange(){
	
} */
/*void CStorageImportLineInput2::OnUomSetfocus(){
	
} */
/*void CStorageImportLineInput2::OnUomKillfocus(){
	
} */
int CStorageImportLineInput2::OnUomCheckValue(){
	return 0;
} 

void CStorageImportLineInput2::OnManufactureSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CStorageImportLineInput2::OnManufactureSelendok(){
	 
}
/*void CStorageImportLineInput2::OnManufactureSetfocus(){
	
}*/
/*void CStorageImportLineInput2::OnManufactureKillfocus(){
	
}*/
long CStorageImportLineInput2::OnManufactureLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CStorageImportLineInput2::OnManufactureAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CStorageImportLineInput2::OnLotNoChange(){
	
} */
/*void CStorageImportLineInput2::OnLotNoSetfocus(){
	
} */
/*void CStorageImportLineInput2::OnLotNoKillfocus(){
	
} */
int CStorageImportLineInput2::OnLotNoCheckValue(){
	return 0;
} 
/*void CStorageImportLineInput2::OnExprDateChange(){
	
} */
/*void CStorageImportLineInput2::OnExprDateSetfocus(){
	
} */
/*void CStorageImportLineInput2::OnExprDateKillfocus(){
	
} */
int CStorageImportLineInput2::OnExprDateCheckValue(){
	return 0;
} 
/*void CStorageImportLineInput2::OnQuantityChange(){
	
} */
/*void CStorageImportLineInput2::OnQuantitySetfocus(){
	
} */
/*void CStorageImportLineInput2::OnQuantityKillfocus(){
	
} */
int CStorageImportLineInput2::OnQuantityCheckValue(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szSQL;
	//szSQL.Format(_T("GET_QTYORDERONHAND(%ld, %ld) "), m_nStorageToID, str2long(m_szProductKey));
...
/*void CStorageImportLineInput2::OnUnitPriceChange(){
	
} */
/*void CStorageImportLineInput2::OnUnitPriceSetfocus(){
	
} */
/*void CStorageImportLineInput2::OnUnitPriceKillfocus(){
	
} */
int CStorageImportLineInput2::OnUnitPriceCheckValue(){
	if(m_nUnitPrice <= 0)
		return -1;
...
/*void CStorageImportLineInput2::OnOnHandChange(){
	
} */
/*void CStorageImportLineInput2::OnOnHandSetfocus(){
	
} */
/*void CStorageImportLineInput2::OnOnHandKillfocus(){
	
} */
int CStorageImportLineInput2::OnOnHandCheckValue(){
	return 0;
} 

void CStorageImportLineInput2::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveStorageDeliveryOrderLineInput();
} 
void CStorageImportLineInput2::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CGuiPopup::ClosePopup();
} 
int CStorageImportLineInput2::OnAddStorageDeliveryOrderLineInput(){
...
int CStorageImportLineInput2::OnEditStorageDeliveryOrderLineInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CStorageImportLineInput2::OnDeleteStorageDeliveryOrderLineInput(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
...
int CStorageImportLineInput2::OnSaveStorageDeliveryOrderLineInput(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
*/
 //Notice(szSQL);
	...
	_debug(_T("RES VALUE :%d"), ret);
 	if(ret > 0)
 	{
		CStorageImportLines* pLines = (CStorageImportLines*) m_pWndLines;
...
int CStorageImportLineInput2::OnCancelStorageDeliveryOrderLineInput(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CStorageImportLineInput2::OnStorageDeliveryOrderLineInputListLoadData(){
	return 0;
}
