#ifndef CancerStorageTransactionList_H
#define CancerStorageTransactionList_H
...
class AFX_EXT_CLASS CCancerStorageTransactionList : public CGuiView{
protected:
public:
	CWnd*			m_wndOrder;
	bool			m_bImportType;
	...
	int OnAddCancerStorageTransactionList(); 
	int OnEditCancerStorageTransactionList(); 
	int OnDeleteCancerStorageTransactionList(); 
	int OnSaveCancerStorageTransactionList(); 
	int OnCancelCancerStorageTransactionList(); 
	int OnCancerStorageTransactionListListLoadData(); 
