#ifndef PMSPRESCRIPTIONRETURNLIST_H
#define PMSPRESCRIPTIONRETURNLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CPMSPrescriptionReturnList : public CGuiView{
protected:
	long	m_nOrderID;
public:
	CGuiGroupBox	m_wndOrderListInformation;
	...
	int OnAddPMSPrescriptionReturnList(); 
	int OnEditPMSPrescriptionReturnList(); 
	int OnDeletePMSPrescriptionReturnList(); 
	int OnSavePMSPrescriptionReturnList(); 
	int OnCancelPMSPrescriptionReturnList(); 
	int OnPMSPrescriptionReturnListListLoadData(); 
	int PrintDrugReturn();
	int PrintSaleImport();
	int OnRollbackReturn();
	void OnResizeLayout();
};
#endif
