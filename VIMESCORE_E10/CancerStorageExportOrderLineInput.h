#ifndef CancerStorageExportOrderLineInput_H
#define CancerStorageExportOrderLineInput_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CCancerStorageExportOrderLineInput : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CCancerStorageExportOrderLineInput(CWnd *pParent, int nMode);
	~CCancerStorageExportOrderLineInput();
	...
	int OnAddCancerStorageExportOrderLineInput(); 
	int OnEditCancerStorageExportOrderLineInput(); 
	int OnDeleteCancerStorageExportOrderLineInput(); 
	int OnSaveCancerStorageExportOrderLineInput(); 
	int OnCancelCancerStorageExportOrderLineInput(); 
	int OnCancerStorageExportOrderLineInputListLoadData(); 
};
#endif
