...
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CProductExtraInfoSetup *)pWnd)->OnYearCheckValue();
} 
static void _OnContractSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CProductExtraInfoSetup* )pWnd)->OnContractSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnContractSelendokFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnContractSelendok();
}
/*static void _OnContractSetfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnContractKillfocus();
}*/
/*static void _OnContractKillfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnContractKillfocus();
}*/
static long _OnContractLoadDataFnc(CWnd *pWnd){
	return ((CProductExtraInfoSetup *)pWnd)->OnContractLoadData();
}
/*static void _OnContractAddNewFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnContractAddNew();
}*/
/*static void _OnTypeChangeFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnTypeChange();
} */
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnTypeSetfocus();} */ 
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnTypeKillfocus();
} */
static int _OnTypeCheckValueFnc(CWnd *pWnd){
	return ((CProductExtraInfoSetup *)pWnd)->OnTypeCheckValue();
} 
/*static void _OnGroupChangeFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnGroupChange();
} */
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnGroupSetfocus();} */ 
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CProductExtraInfoSetup *)pWnd)->OnGroupKillfocus();
} */
static int _OnGroupCheckValueFnc(CWnd *pWnd){
	return ((CProductExtraInfoSetup *)pWnd)->OnGroupCheckValue();
} 
...
static long _OnUnMapListLoadDataFnc(CWnd *pWnd){
	return ((CProductExtraInfoSetup*)pWnd)->OnUnMapListLoadData();
} 
static void _OnUnMapListDblClickFnc(CWnd *pWnd){
	((CProductExtraInfoSetup*)pWnd)->OnUnMapListDblClick();
} 
static void _OnUnMapListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CProductExtraInfoSetup*)pWnd)->OnUnMapListSelectChange(nOldItem, nNewItem);
} 
static int _OnUnMapListDeleteItemFnc(CWnd *pWnd){
	 return ((CProductExtraInfoSetup*)pWnd)->OnUnMapListDeleteItem();
}

static int _OnUnMapListAddFnc(CWnd *pWnd){
	((CProductExtraInfoSetup*)pWnd)->OnUnMapListDblClick();
	return 0;
}
static long _OnMapedListLoadDataFnc(CWnd *pWnd){
	return ((CProductExtraInfoSetup*)pWnd)->OnMapedListLoadData();
} 
static void _OnMapedListDblClickFnc(CWnd *pWnd){
	((CProductExtraInfoSetup*)pWnd)->OnMapedListDblClick();
} 
static void _OnMapedListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CProductExtraInfoSetup*)pWnd)->OnMapedListSelectChange(nOldItem, nNewItem);
} 
static int _OnMapedListDeleteItemFnc(CWnd *pWnd){
	 return ((CProductExtraInfoSetup*)pWnd)->OnMapedListDeleteItem();
} 
...
void CProductExtraInfoSetup::OnCreateComponents(){
	...
	m_wndItemList.Create(this, _T("Item List"), 5, 65, 960, 230);
	m_wndUnMap.Create(this, _T("Un map"), 5, 235, 480, 380);
	m_wndMaped.Create(this, _T("Maped"), 485, 235, 960, 380);
	m_wndCurrentInfo.Create(this, _T("Current Info"), 5, 386, 960, 561);
	m_wndAdditionalInfo.Create(this, _T("Additional Info"), 5, 565, 960, 680);
	m_wndYearLabel.Create(this, _T("Year"), 10, 29, 90, 54);
	m_wndYear.Create(this,95, 29, 155, 54); 
	m_wndContractLabel.Create(this, _T("Contract"), 160, 29, 240, 54);
	m_wndContract.Create(this,245, 29, 325, 54); 
	m_wndTypeLabel.Create(this, _T("Type"), 330, 29, 375, 54);
	m_wndType.Create(this,380, 29, 535, 54); 
	m_wndGroupLabel.Create(this, _T("Group"), 540, 29, 585, 54);
	m_wndGroup.Create(this,590, 29, 785, 54); 
	m_wndNameLabel.Create(this, _T("Name"), 790, 29, 835, 54);
	m_wndName.Create(this,840, 29, 930, 54); 
	m_wndSearch.Create(this, _T("@"), 935, 29, 955, 54);
	m_wndList.Create(this,10, 90, 955, 195);

	m_wndMapNameLabel.Create(this, _T("Map Name"), 330, 200, 375, 225);
	m_wndMapName.Create(this,380, 200, 535, 225); 

	m_wndUnMapList.Create(this,10, 260, 475, 375); 
	m_wndMapedList.Create(this,490, 260, 955, 375); 
	m_wndMahoatchatLabel.Create(this, _T("Ma_hoat_chat"), 10, 410, 110, 435);
	m_wndMahoatchat.Create(this,115, 410, 445, 435); 
	m_wndHoatchatLabel.Create(this, _T("Hoat_chat"), 450, 410, 530, 435);
	m_wndHoatchat.Create(this,535, 410, 955, 435); 
	m_wndDuongdungLabel.Create(this, _T("Duong_dung"), 10, 440, 110, 465);
	m_wndDuongdung.Create(this,115, 440, 225, 465); 
	m_wndHamluongLabel.Create(this, _T("Ham_luong"), 230, 440, 330, 465);
	m_wndHamluong.Create(this,335, 440, 445, 465); 
	m_wndTenthuocLabel.Create(this, _T("Ten_thuoc"), 450, 440, 530, 465);
	m_wndTenthuoc.Create(this,535, 440, 955, 465); 
	m_wndSodangkyLabel.Create(this, _T("So_dang_ky"), 10, 470, 110, 495);
	m_wndSodangky.Create(this,115, 470, 225, 495); 
	m_wndDonggoiLabel.Create(this, _T("Dong_goi"), 230, 470, 330, 495);
	m_wndDonggoi.Create(this,335, 470, 645, 495); 
	m_wndDonvitinhLabel.Create(this, _T("Don_vi_tinh"), 650, 470, 740, 495);
	m_wndDonvitinh.Create(this,745, 470, 955, 495); 
	m_wndDongiaLabel.Create(this, _T("Don_gia"), 10, 500, 110, 525);
	m_wndDongia.Create(this,115, 500, 225, 525); 
	m_wndDongiattLabel.Create(this, _T("Don_gia_tt"), 230, 500, 330, 525);
	m_wndDongiatt.Create(this,335, 500, 445, 525); 
	m_wndHangsxLabel.Create(this, _T("Hang_sx"), 450, 500, 530, 525);
	m_wndHangsx.Create(this,535, 500, 955, 525); 
	m_wndNuocsxLabel.Create(this, _T("Nuoc_sx"), 10, 530, 110, 555);
	m_wndNuocsx.Create(this,115, 530, 225, 555); 
	m_wndNhathauLabel.Create(this, _T("Nha_thau"), 230, 530, 330, 555);
	m_wndNhathau.Create(this,335, 530, 645, 555); 
	m_wndMathuocbvLabel.Create(this, _T("Ma_thuoc_bv"), 650, 530, 740, 555);
	m_wndMathuocbv.Create(this,745, 530, 955, 555); 
	m_wndMaduongdungLabel.Create(this, _T("Ma_duong_dung"), 10, 590, 110, 615);
	m_wndMaduongdung.Create(this,115, 590, 225, 615); 
	m_wndSoluongLabel.Create(this, _T("So_luong"), 230, 590, 330, 615);
	m_wndSoluong.Create(this,335, 590, 445, 615); 
	m_wndQuyetdinhLabel.Create(this, _T("Quyet_dinh"), 450, 590, 540, 615);
	m_wndQuyetdinh.Create(this,545, 590, 645, 615); 
	m_wndCongboLabel.Create(this, _T("Cong_bo"), 650, 590, 740, 615);
	m_wndCongbo.Create(this,745, 590, 855, 615); 
	m_wndManhomvtytLabel.Create(this, _T("Ma_nhom_vtyt"), 10, 620, 110, 645);
	m_wndManhomvtyt.Create(this,115, 620, 225, 645); 
	m_wndTennhomvtytLabel.Create(this, _T("Ten_nhom_vtyt"), 230, 620, 330, 645);
	m_wndTennhomvtyt.Create(this,335, 620, 645, 645); 
	m_wndMahieuLabel.Create(this, _T("Ma_hieu"), 650, 620, 740, 645);
	m_wndMahieu.Create(this,745, 620, 955, 645); 
	m_wndDinhmucLabel.Create(this, _T("Dinh_muc"), 10, 650, 110, 675);
	m_wndDinhmuc.Create(this,115, 650, 225, 675); 
	m_wndEdit.Create(this, _T("&Update"), 709, 650, 789, 675);
	m_wndSave.Create(this, _T("&Save"), 794, 650, 874, 675);
	m_wndCancel.Create(this, _T("&Cancel"), 879, 650, 959, 675);
...
//	m_wndContract.SetCheckValue(true);
	...
	m_wndType.SetLimitText(254);
	m_wndType.SetCheckValue(true);
	m_wndGroup.SetLimitText(254);
...
void CProductExtraInfoSetup::OnSetWindowEvents(){
	...
	//m_wndGroup.SetEvent(WE_CHANGE, _OnGroupChangeFnc);
	//m_wndGroup.SetEvent(WE_SETFOCUS, _OnGroupSetfocusFnc);
	//m_wndGroup.SetEvent(WE_KILLFOCUS, _OnGroupKillfocusFnc);
	m_wndGroup.SetEvent(WE_CHECKVALUE, _OnGroupCheckValueFnc);
	...
	m_wndUnMapList.AddEvent(1, _T("Add to map"), _OnUnMapListAddFnc);
...
void CProductExtraInfoSetup::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Text(pDX, m_wndGroup.GetDlgCtrlID(), m_szGroup);
...
void CProductExtraInfoSetup::GetDataToScreen(){
	...
	if (!rs.IsEOF()){
		...
		rs.GetValue(_T("DON_VI_TINH"), m_szDonvitinh);
		rs.GetValue(_T("DON_GIA"), m_nDongia);
		rs.GetValue(_T("DON_GIA_TT"), m_nDongiatt);
		rs.GetValue(_T("SO_LUONG"), m_nSoluong);
		rs.GetValue(_T("HANG_SX"), m_szHangsx);
		rs.GetValue(_T("NUOC_SX"), m_szNuocsx);
		rs.GetValue(_T("NHA_THAU"), m_szNhathau);
...
/*void CProductExtraInfoSetup::OnYearChange(){
	
} */
/*void CProductExtraInfoSetup::OnYearSetfocus(){
	
} */
/*void CProductExtraInfoSetup::OnYearKillfocus(){
	
} */
int CProductExtraInfoSetup::OnYearCheckValue(){
	return 0;
} 
void CProductExtraInfoSetup::OnContractSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CProductExtraInfoSetup::OnContractSelendok(){
	 
}
/*void CProductExtraInfoSetup::OnContractSetfocus(){
	
}*/
/*void CProductExtraInfoSetup::OnContractKillfocus(){
	
}*/
long CProductExtraInfoSetup::OnContractLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
...
/*void CProductExtraInfoSetup::OnContractAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CProductExtraInfoSetup::OnTypeChange(){
	
} */
/*void CProductExtraInfoSetup::OnTypeSetfocus(){
	
} */
/*void CProductExtraInfoSetup::OnTypeKillfocus(){
	
} */
int CProductExtraInfoSetup::OnTypeCheckValue(){
	return 0;
} 
/*void CProductExtraInfoSetup::OnGroupChange(){
...
int CProductExtraInfoSetup::OnGroupCheckValue(){
	return 0;
} 
...
int CProductExtraInfoSetup::OnListDeleteItem(){
	...
	CString szSQL;
	szSQL.Format(_T("SELECT count(*) FROM m_product_item WHERE mpi_product_id=%ld and mpi_productextra_id=%ld"),
		m_nProductID, m_nID);
	CRecord rs(&pMF->m_db);
	rs.ExecSQL(szSQL);
	if(rs.GetIntValue() > 0)
	{
		ShowMessageBox(_T("\x44\x61nh m\x1EE5\x63 \x111\xE3 \x111\x1B0\x1EE3\x63 m\x61p v\x1EDBi h\xE0ng nh\x1EADp kho. Kh\xF4ng \x63ho ph\xE9p \x78\xF3\x61"));
		return -1;
	}
	...
	szSQL.Format(_T("DELETE FROM m_product_extra_info WHERE mpei_id=%ld "), m_nID);
	int ret = pMF->ExecSQL(szSQL);
	if(ret > 0)
	{
		m_wndList.DeleteItem(m_nSelectedItem);
	}
	 return 0;
} 
...
void CProductExtraInfoSetup::OnUnMapListDblClick(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_nID <= 0)
	{
...
void CProductExtraInfoSetup::OnUnMapListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CProductExtraInfoSetup::OnUnMapListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 
long CProductExtraInfoSetup::OnUnMapListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CProductExtraInfoSetup::OnMapedListDblClick(){
	
} 
void CProductExtraInfoSetup::OnMapedListSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CProductExtraInfoSetup::OnMapedListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
long CProductExtraInfoSetup::OnMapedListLoadData(){
...
long CProductExtraInfoSetup::OnHoatchatLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadProductClassList(&m_wndHoatchat, m_szHoatchat);
}

long CProductExtraInfoSetup::OnNuocsxLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadCountryList(&m_wndNuocsx, m_szNuocsx);
}

long CProductExtraInfoSetup::OnHangsxLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadManufactureList(&m_wndHangsx, m_szHangsx);
}

long CProductExtraInfoSetup::OnNhathauLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadPartnerList(&m_wndNhathau, m_szNhathau);
}

long CProductExtraInfoSetup::OnDonvitinhLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadUomList(&m_wndDonvitinh, m_szDonvitinh);
}

long CProductExtraInfoSetup::OnMaduongdungLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	return pMF->LoadSelectionList(&m_wndMaduongdung, m_szMaduongdung, _T("hms_usage_way"));
}
