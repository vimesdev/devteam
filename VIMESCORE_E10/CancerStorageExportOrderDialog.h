#ifndef CancerStorageExportOrderDialog_H
#define CancerStorageExportOrderDialog_H
...
class CCancerStorageExportOrderDialog : public CGuiDialog{
protected:
public:
	bool		m_bRefresh;
	...
	CCancerStorageExportOrderLines	m_wndLines;
	...
	void			OnPlusSelect();
	CCancerStorageExportOrderDialog(CWnd *pParent, int nMode);
	~CCancerStorageExportOrderDialog();
	...
	int OnAddCancerStorageExportOrderDialog(); 
	int OnEditCancerStorageExportOrderDialog(); 
	int OnDeleteCancerStorageExportOrderDialog(); 
	int OnSaveCancerStorageExportOrderDialog(); 
	int OnDiscardCancerStorageExportOrderDialog(); 
	int OnCancerStorageExportOrderDialogListLoadData(); 
