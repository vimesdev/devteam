#ifndef FAInvoiceLine_H
#define FAInvoiceLine_H
...
class CFAInvoiceLine : public CGuiView{
protected:
	bool	m_bExchange;
public:
	long		m_nInvoiceID;
	...
	virtual int		OnListAddItem(); 
	virtual int		OnListEditItem(); 
	...
	int OnAddFAInvoiceLine(); 
	int OnEditFAInvoiceLine(); 
	int OnDeleteFAInvoiceLine(); 
	int OnSaveFAInvoiceLine(); 
	int OnCancelFAInvoiceLine(); 
	int OnFAInvoiceLineListLoadData(); 
