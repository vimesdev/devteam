...
void CFACashAdditionView::OnCreateComponents(){
	m_wndHeader.CreateEx(this, 5, 5, 800, 20);
...
void CFACashAdditionView::OnInitializeComponents(){
	...
	m_wndHeader.InsertColumn(0, _T("Currency"), 100, &m_wndCurrency);
	m_wndHeader.InsertColumn(1, _T("Exchange Rate"), 0, &m_wndExchageRate);
	m_wndHeader.InsertColumn(2, _T("Amount"), 90, &m_wndAmount);
	m_wndHeader.InsertColumn(3, _T("Exchange"), 0, &m_wndExchangeAmount);
	m_wndHeader.InsertColumn(4, _T("Invoice Type"), 100, &m_wndInvoiceType);
	m_wndHeader.InsertColumn(4, _T("Invoice Template No"), 90, &m_wndInvoiceTemplateNo);
	m_wndHeader.InsertColumn(4, _T("Invoice No"), 90, &m_wndInvoiceNo);
	m_wndHeader.InsertColumn(4, _T("Invoice Date"), 90, &m_wndInvoiceDate);
	m_wndHeader.InsertColumn(4, _T("Invoice Signed"), 90, &m_wndInvoiceSigned);
