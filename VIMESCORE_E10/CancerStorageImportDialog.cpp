...
static void _OnFromStorageSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageImportDialog* )pWnd)->OnFromStorageSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnFromStorageSelendokFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnFromStorageSelendok();
}
/*static void _OnFromStorageSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnFromStorageKillfocus();
}*/
/*static void _OnFromStorageKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnFromStorageKillfocus();
}*/
static long _OnFromStorageLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnFromStorageLoadData();
}
/*static void _OnFromStorageAddNewFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnFromStorageAddNew();
}*/
static void _OnToDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageImportDialog* )pWnd)->OnToDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnToDepartmentSelendokFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnToDepartmentSelendok();
}
/*static void _OnToDepartmentSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnToDepartmentKillfocus();
}*/
/*static void _OnToDepartmentKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnToDepartmentKillfocus();
}*/
static long _OnToDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnToDepartmentLoadData();
}
/*static void _OnToDepartmentAddNewFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnToDepartmentAddNew();
}*/
static void _OnDelivererSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageImportDialog* )pWnd)->OnDelivererSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDelivererSelendokFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDelivererSelendok();
}
/*static void _OnDelivererSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDelivererKillfocus();
}*/
/*static void _OnDelivererKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDelivererKillfocus();
}*/
static long _OnDelivererLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnDelivererLoadData();
}
/*static void _OnDelivererAddNewFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDelivererAddNew();
}*/
static void _OnReceiverSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageImportDialog* )pWnd)->OnReceiverSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReceiverSelendokFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnReceiverSelendok();
}
/*static void _OnReceiverSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnReceiverKillfocus();
}*/
/*static void _OnReceiverKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnReceiverKillfocus();
}*/
static long _OnReceiverLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnReceiverLoadData();
}
/*static void _OnReceiverAddNewFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnReceiverAddNew();
}*/
/*static void _OnDescriptionChangeFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDescriptionChange();
} */
/*static void _OnDescriptionSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDescriptionSetfocus();} */ 
/*static void _OnDescriptionKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDescriptionKillfocus();
} */
static int _OnDescriptionCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnDescriptionCheckValue();
} 
/*static void _OnOrderNoChangeFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnOrderNoChange();
} */
/*static void _OnOrderNoSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnOrderNoSetfocus();} */ 
/*static void _OnOrderNoKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnOrderNoKillfocus();
} */
static int _OnOrderNoCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnOrderNoCheckValue();
} 
/*static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnOrderDateChange();
} */
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnOrderDateCheckValue();
} 
/*static void _OnAccountingDateChangeFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnAccountingDateChange();
} */
/*static void _OnAccountingDateSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnAccountingDateSetfocus();} */ 
/*static void _OnAccountingDateKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnAccountingDateKillfocus();
} */
static int _OnAccountingDateCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnAccountingDateCheckValue();
}


static int _OnApprovedDateCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnApprovedDateCheckValue();
}

static void _OnTransactionTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageImportDialog* )pWnd)->OnTransactionTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTransactionTypeSelendokFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTransactionTypeSelendok();
}
/*static void _OnTransactionTypeSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTransactionTypeKillfocus();
}*/
/*static void _OnTransactionTypeKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTransactionTypeKillfocus();
}*/
static long _OnTransactionTypeLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnTransactionTypeLoadData();
}
/*static void _OnTransactionTypeAddNewFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTransactionTypeAddNew();
}*/

static void _OnReferenceLabelSelectFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnReferenceLabelSelect();
}
static void _OnDeliveryObjectSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CCancerStorageImportDialog* )pWnd)->OnDeliveryObjectSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeliveryObjectSelendokFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDeliveryObjectSelendok();
}
/*static void _OnDeliveryObjectSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDeliveryObjectKillfocus();
}*/
/*static void _OnDeliveryObjectKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDeliveryObjectKillfocus();
}*/
static long _OnDeliveryObjectLoadDataFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnDeliveryObjectLoadData();
}
/*static void _OnDeliveryObjectAddNewFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnDeliveryObjectAddNew();
}*/

/*static void _OnTotalLinesChangeFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTotalLinesChange();
} */
/*static void _OnTotalLinesSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTotalLinesSetfocus();} */ 
/*static void _OnTotalLinesKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTotalLinesKillfocus();
} */
static int _OnTotalLinesCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnTotalLinesCheckValue();
} 
/*static void _OnTotalAmountChangeFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTotalAmountChange();
} */
/*static void _OnTotalAmountSetfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTotalAmountSetfocus();} */ 
/*static void _OnTotalAmountKillfocusFnc(CWnd *pWnd){
	((CCancerStorageImportDialog *)pWnd)->OnTotalAmountKillfocus();
} */
static int _OnTotalAmountCheckValueFnc(CWnd *pWnd){
	return ((CCancerStorageImportDialog *)pWnd)->OnTotalAmountCheckValue();
} 
static void _OnAddSelectFnc(CWnd *pWnd){
	CCancerStorageImportDialog *pVw = (CCancerStorageImportDialog *)pWnd;
	pVw->OnAddSelect();
} 
...
static void _OnTabSelectChangeFnc(CWnd *pWnd, int nOld, int nNew){
	((CCancerStorageImportDialog*)pWnd)->OnTabSelectChange(nOld, nNew);
} 
static int _OnAddStorageDeliveryOrderDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageImportDialog*)pWnd)->OnAddStorageDeliveryOrderDialog();
} 
static int _OnEditStorageDeliveryOrderDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageImportDialog*)pWnd)->OnEditStorageDeliveryOrderDialog();
} 
static int _OnDeleteStorageDeliveryOrderDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageImportDialog*)pWnd)->OnDeleteStorageDeliveryOrderDialog();
} 
static int _OnSaveStorageDeliveryOrderDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageImportDialog*)pWnd)->OnSaveStorageDeliveryOrderDialog();
} 
static int _OnDiscardStorageDeliveryOrderDialogFnc(CWnd *pWnd){
	 return ((CCancerStorageImportDialog*)pWnd)->OnDiscardStorageDeliveryOrderDialog();
} 
CCancerStorageImportDialog::CCancerStorageImportDialog(CWnd *pParent, int nMode):
	CGuiDialog(pParent){
...
CCancerStorageImportDialog::~CCancerStorageImportDialog(){
	
}
void CCancerStorageImportDialog::OnCreateComponents(){
...
void CCancerStorageImportDialog::OnInitializeComponents(){
...
void CCancerStorageImportDialog::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
//	m_wndTab.SetEvent(WE_SELCHANGE, _OnTabSelectChangeFnc);
	...
	int nMode = GetMode();
	if(nMode == VM_ADD || nMode == VM_VIEW)
		GetDataToScreen();
	SetMode(nMode);

}
void CCancerStorageImportDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CCancerStorageImportDialog::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	{
		m_wndLines.SetMode(VM_ADD);		
		m_wndLines.Refresh(m_nID);		
	}

}

void CCancerStorageImportDialog::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(GetMode() == VM_EDIT)
	{
		CString szWhere;
...
void CCancerStorageImportDialog::SetDefaultValues(){
...
int CCancerStorageImportDialog::SetMode(int nMode){
...
void CCancerStorageImportDialog::OnFromStorageSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
 
void CCancerStorageImportDialog::OnFromStorageSelendok(){
	 
}

/*void CCancerStorageImportDialog::OnFromStorageSetfocus(){
	
}*/
/*void CCancerStorageImportDialog::OnFromStorageKillfocus(){
	
}*/
long CCancerStorageImportDialog::OnFromStorageLoadData(){
...
/*void CCancerStorageImportDialog::OnFromStorageAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CCancerStorageImportDialog::OnDescriptionChange(){
	
} */
/*void CCancerStorageImportDialog::OnDescriptionSetfocus(){
	
} */
/*void CCancerStorageImportDialog::OnDescriptionKillfocus(){
	
} */
int CCancerStorageImportDialog::OnDescriptionCheckValue(){
	return 0;
}
 
/*void CCancerStorageImportDialog::OnOrderNoChange(){
	
} */
/*void CCancerStorageImportDialog::OnOrderNoSetfocus(){
	
} */
/*void CCancerStorageImportDialog::OnOrderNoKillfocus(){
	
} */
int CCancerStorageImportDialog::OnOrderNoCheckValue(){
	return 0;
} 
/*void CCancerStorageImportDialog::OnOrderDateChange(){
	
} */
/*void CCancerStorageImportDialog::OnOrderDateSetfocus(){
	
} */
/*void CCancerStorageImportDialog::OnOrderDateKillfocus(){
	
} */
int CCancerStorageImportDialog::OnOrderDateCheckValue(){
	return 0;
}
 
/*void CCancerStorageImportDialog::OnAccountingDateChange(){
	
} */
/*void CCancerStorageImportDialog::OnAccountingDateSetfocus(){
	
} */
/*void CCancerStorageImportDialog::OnAccountingDateKillfocus(){
	
} */
int CCancerStorageImportDialog::OnAccountingDateCheckValue(){
	return 0;
}

int CCancerStorageImportDialog::OnApprovedDateCheckValue(){
	return 0;
}
void CCancerStorageImportDialog::OnTransactionTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CCancerStorageImportDialog::OnTransactionTypeSelendok(){
	 UpdateData(true);
...
/*void CCancerStorageImportDialog::OnTransactionTypeSetfocus(){
	
}*/
/*void CCancerStorageImportDialog::OnTransactionTypeKillfocus(){
	
}*/
long CCancerStorageImportDialog::OnTransactionTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CCancerStorageImportDialog::OnTransactionTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */

void CCancerStorageImportDialog::OnReferenceLabelSelect(){
...
void CCancerStorageImportDialog::OnDeliveryObjectSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CCancerStorageImportDialog::OnDeliveryObjectSelendok(){
	 
}
/*void CCancerStorageImportDialog::OnDeliveryObjectSetfocus(){
	
}*/
/*void CCancerStorageImportDialog::OnDeliveryObjectKillfocus(){
	
}*/
long CCancerStorageImportDialog::OnDeliveryObjectLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CString szFilter;
...
/*void CCancerStorageImportDialog::OnDeliveryObjectAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
 

/*void CCancerStorageImportDialog::OnTotalLinesChange(){
	
} */
/*void CCancerStorageImportDialog::OnTotalLinesSetfocus(){
	
} */
/*void CCancerStorageImportDialog::OnTotalLinesKillfocus(){
	
} */
int CCancerStorageImportDialog::OnTotalLinesCheckValue(){
	return 0;
} 
/*void CCancerStorageImportDialog::OnTotalAmountChange(){
	
} */
/*void CCancerStorageImportDialog::OnTotalAmountSetfocus(){
	
} */
/*void CCancerStorageImportDialog::OnTotalAmountKillfocus(){
	
} */
int CCancerStorageImportDialog::OnTotalAmountCheckValue(){
	return 0;
}
 
void CCancerStorageImportDialog::OnAddSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnAddStorageDeliveryOrderDialog();
}
 
void CCancerStorageImportDialog::OnEditSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnEditStorageDeliveryOrderDialog();

}
 
void CCancerStorageImportDialog::OnDeleteSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDeleteStorageDeliveryOrderDialog();
}
 
void CCancerStorageImportDialog::OnSaveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnSaveStorageDeliveryOrderDialog();
}
 
void CCancerStorageImportDialog::OnDiscardSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnDiscardStorageDeliveryOrderDialog();
}
 
void CCancerStorageImportDialog::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CCancerStorageImportDialog::OnPostSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CCancerStorageImportDialog::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_bRefresh)
		CGuiDialog::OnOK();
	else
...
void CCancerStorageImportDialog::OnAddLineSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	/*CGuiMenu menu(this);
...
void CCancerStorageImportDialog::OnAddExportedLine(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
	{
...
void CCancerStorageImportDialog::OnAddNewLine(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
	{
		ShowMessageBox(_T("Can not process with current status."));
...
void CCancerStorageImportDialog::OnTabSelectChange(int nOld, int nNew){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CCancerStorageImportDialog::OnAddStorageDeliveryOrderDialog(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
...
int CCancerStorageImportDialog::OnEditStorageDeliveryOrderDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
...
int CCancerStorageImportDialog::OnDeleteStorageDeliveryOrderDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
...
int CCancerStorageImportDialog::OnSaveStorageDeliveryOrderDialog(){
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 ...
 ////_fmsg_T("%s"), szSQL); 
 	...
 	{ 
		...
		else
		{
			...
			if(rec > 0){
				szSQL.Format(_T("UPDATE hms_cancer_order SET hco_status = 'P', hco_transaction_import_id =%ld WHERE hco_docno = %ld AND hco_treatidx =%ld"), m_nID, m_nDocNo, m_nTreatIdx);
				//_msg(_T("%s"), szSQL);
				pMF->ExecSQL(szSQL);
			}
			GetDataToScreen();
...
int CCancerStorageImportDialog::OnDiscardStorageDeliveryOrderDialog(){
...
int CCancerStorageImportDialog::OnStorageDeliveryOrderDialogListLoadData(){
	return 0;
}


CString CCancerStorageImportDialog::GetOrderStatus(){
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
...
bool CCancerStorageImportDialog::IsAllowEdit(){
...
int CCancerStorageImportDialog::InsertTransactionLine()
{	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
	CString szSQL,tmpStr;
	CRecord rs(&pMF->m_db);
	int nCount =0;
	szSQL.Format(_T(" SELECT hpol_orderid AS mtl_transactionline_id,") \
	_T("   hpol_product_id,") \
	_T("   hpol_product_item_id,") \
	_T("   hpol_productname AS product_name,") \
	_T("   hpol_productuom AS product_uomname,") \
	_T("   hpol_productcountry AS product_manufacturename,") \
	...
	while(!rs.IsEOF()){
		...
		m_transactionlineTbl.SetValue(_T("mtl_storage_to_id"), m_szFromStorageKey);

		rs.GetValue(_T("hpol_product_id"), tmpStr);
		m_transactionlineTbl.SetValue(_T("mtl_product_id"), tmpStr);
		rs.GetValue(_T("hpol_product_item_id"), tmpStr);
