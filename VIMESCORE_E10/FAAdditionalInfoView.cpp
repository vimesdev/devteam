...
void CFAAdditionalInfoView::OnCreateComponents(){
	...
	m_wndHdrTax.CreateEx(this, 5, 35, 795, 55);
	m_wndHdrSource.CreateEx(this, 5, 115, 795, 160);
	m_wndHdrStatistic.CreateEx(this, 5, 200, 795, 240);
	
	//Phan thue
	m_wndTaxAcct.Create(this,125, 25, 167, 50); 
	m_wndTaxrate.Create(this,10, 25, 69, 49); 
	m_wndTaxAmount.Create(this,74, 25, 120, 50); 
...
void CFAAdditionalInfoView::OnInitializeComponents(){
	...
	m_wndHdrTax.InsertColumn(0, _T("Tax Acct"), 80, &m_wndTaxAcct);
	m_wndHdrTax.InsertColumn(1, _T("Tax Rate"), 70, &m_wndTaxrate);
	m_wndHdrTax.InsertColumn(2, _T("Tax Amount"), 80, &m_wndTaxAmount);
	m_wndHdrTax.InsertColumn(3, _T("Invoice Type"), 120, &m_wndInvoiceType);
	m_wndHdrTax.InsertColumn(4, _T("Template No"), 90, &m_wndInvoiceTemplate);
	m_wndHdrTax.InsertColumn(5, _T("Invoice Date"), 80, &m_wndInvoiceDate);
	m_wndHdrTax.InsertColumn(6, _T("Invoice No"), 100, &m_wndInvoiceNo);
	m_wndHdrTax.InsertColumn(7, _T("Invoice Signed"), 80, &m_wndInvoiceSigned);
	m_wndHdrTax.InsertColumn(8, _T("Group Service Items"), 100, &m_wndGroupServiceItems);


	m_wndHdrTax.RecalcLayout();
