#ifndef ProductExtraInfoMAMapDialog_H
#define ProductExtraInfoMAMapDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CProductExtraInfoMAMapDialog : public CGuiDialog{
protected:
	long m_nID;
	long m_nProductID;
...
public:
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CProductExtraInfoMAMapDialog(CWnd *pParent);
	~CProductExtraInfoMAMapDialog();
	...
	int OnAddProductExtraInfoMAMapDialog(); 
	int OnEditProductExtraInfoMAMapDialog(); 
	int OnDeleteProductExtraInfoMAMapDialog(); 
	int OnSaveProductExtraInfoMAMapDialog(); 
	int OnCancelProductExtraInfoMAMapDialog(); 
	int OnProductExtraInfoMAMapDialogListLoadData(); 
	void OnListExport();
	void OnListCopyItem();
};
#endif
