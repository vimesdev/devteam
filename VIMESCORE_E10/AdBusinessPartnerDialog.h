...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CAdBusinessPartnerDialog : public CGuiDialog{
protected:
	CString m_szOldName;
...
public:
	...
	CGuiListCtrl	m_wndContracts;
	CGuiListCtrl	m_wndInvoices;
	CGuiListCtrl	m_wndBankAccounts;
	...
	//void			OnFinancialCodeChange(); 
	//void			OnFinancialCodeSetfocus(); 
	//void			OnFinancialCodeKillfocus(); 
	int			OnFinancialCodeCheckValue(); 
	//void			OnFinancialCode2Change(); 
	//void			OnFinancialCode2Setfocus(); 
	//void			OnFinancialCode2Killfocus(); 
	int			OnFinancialCode2CheckValue(); 
	...
	//void			OnCitasCodeChange(); 
	//void			OnCitasCodeSetfocus(); 
	//void			OnCitasCodeKillfocus(); 
	...
	long OnBankAccountsLoadData();
	void OnBankAccountsDblClick();
