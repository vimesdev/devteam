#ifndef APORDERDELIVERY_H
#define APORDERDELIVERY_H
...
#include "GuiView.h"
#include "DbField.h"
class CPurchaseOrderDelivery : public CGuiView{
protected:
public:
	...
	CGuiLabel		m_wndDeliveryNoteLabel;
	CGuiTextCtrl	m_wndDeliveryNote;
	...
	//void			OnDeliveryNoteChange(); 
	//void			OnDeliveryNoteSetfocus(); 
	//void			OnDeliveryNoteKillfocus(); 
	int			OnDeliveryNoteCheckValue(); 
	//void			OnDeliveryAddressChange(); 
	//void			OnDeliveryAddressSetfocus(); 
	//void			OnDeliveryAddressKillfocus(); 
	int			OnDeliveryAddressCheckValue(); 
	CPurchaseOrderDelivery();
	~CPurchaseOrderDelivery();
	...
	int OnAddPurchaseOrderDelivery(); 
	int OnEditPurchaseOrderDelivery(); 
	int OnDeletePurchaseOrderDelivery(); 
	int OnSavePurchaseOrderDelivery(); 
	int OnCancelPurchaseOrderDelivery(); 
	int OnPurchaseOrderDeliveryListLoadData(); 
};
#endif
