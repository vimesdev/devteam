...
static void _OnTerminatedSelectFnc(CWnd *pWnd){
	  ((CHMSDocApproveA11*)pWnd)->OnTerminatedSelect();
}
static void _OnApprovedFeesSelectFnc(CWnd *pWnd){
	  ((CHMSDocApproveA11*)pWnd)->OnApprovedFeesSelect();
}
static void _OnApprovedSelectFnc(CWnd *pWnd){
	  ((CHMSDocApproveA11*)pWnd)->OnApprovedSelect();
}
static void _OnCanceledSelectFnc(CWnd *pWnd){
	  ((CHMSDocApproveA11*)pWnd)->OnCanceledSelect();
}
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSDocApproveA11* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnDepartmentKillfocus();
}*/
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CHMSDocApproveA11 *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnDepartmentAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDocApproveA11 *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDocApproveA11 *)pWnd)->OnToDateCheckValue();
} 
/*static void _OnDocNoChangeFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnDocNoChange();
} */
/*static void _OnDocNoSetfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnDocNoSetfocus();} */ 
/*static void _OnDocNoKillfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnDocNoKillfocus();
} */
static int _OnDocNoCheckValueFnc(CWnd *pWnd){
	return ((CHMSDocApproveA11 *)pWnd)->OnDocNoCheckValue();
} 
/*static void _OnRecordNoChangeFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnRecordNoChange();
} */
/*static void _OnRecordNoSetfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnRecordNoSetfocus();} */ 
/*static void _OnRecordNoKillfocusFnc(CWnd *pWnd){
	((CHMSDocApproveA11 *)pWnd)->OnRecordNoKillfocus();
} */
static int _OnRecordNoCheckValueFnc(CWnd *pWnd){
	return ((CHMSDocApproveA11 *)pWnd)->OnRecordNoCheckValue();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDocApproveA11*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CHMSDocApproveA11*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDocApproveA11*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnListDeleteItem();
} 


static int _OnListPrintSummaryMaterialAndDrugFnc(CWnd *pWnd){
	 ((CHMSDocApproveA11*)pWnd)->OnPrintSummaryMaterialAndDrug();
	 return 0;
} 


static void _OnOutpatientSelectFnc(CWnd *pWnd){
	 ((CHMSDocApproveA11*)pWnd)->OnOutpatientSelect();
}
static void _OnInpatientSelectFnc(CWnd *pWnd){
	 ((CHMSDocApproveA11*)pWnd)->OnInpatientSelect();
}

static int _OnListApproveItemFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnListApproveItem();
} 


static int _OnListRefreshItemFnc(CWnd *pWnd){
	 return (int)((CHMSDocApproveA11*)pWnd)->OnListLoadData();
}

static int _OnListCancelItemFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnListCancelItem();
} 

static void _OnApproveSelectFnc(CWnd *pWnd){
	CHMSDocApproveA11 *pVw = (CHMSDocApproveA11 *)pWnd;
	pVw->OnApproveSelect();
} 
...
static int _OnAddHMSDocApproveFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnAddHMSDocApprove();
} 
static int _OnEditHMSDocApproveFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnEditHMSDocApprove();
} 
static int _OnDeleteHMSDocApproveFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnDeleteHMSDocApprove();
} 
static int _OnSaveHMSDocApproveFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnSaveHMSDocApprove();
} 
static int _OnCancelHMSDocApproveFnc(CWnd *pWnd){
	 return ((CHMSDocApproveA11*)pWnd)->OnCancelHMSDocApprove();
}
...
CHMSDocApproveA11::CHMSDocApproveA11(){
...
void CHMSDocApproveA11::OnCreateComponents()
{
	m_wndStatus.Create(this, _T("Status"), 5, 5, 234, 90);
	m_wndFilterInformation.Create(this, _T("Filter Information"), 240, 5, 799, 90);
	m_wndPatientList.Create(this, _T("Patient List"), 5, 95, 800, 570);
	m_wndTerminated.Create(this, _T("Terminated"), 9, 29, 99, 54);
	m_wndApprovedFees.Create(this, _T("Approved Fees"), 105, 29, 230, 54);
	m_wndApproved.Create(this, _T("_APPROVED_"), 9, 60, 99, 85);
	m_wndCanceled.Create(this, _T("Canceled"), 105, 60, 230, 85);
	m_wndDepartmentLabel.Create(this, _T("Department"), 244, 30, 324, 55);
	m_wndDepartment.Create(this,330, 30, 589, 55); 
	m_wndFromDateLabel.Create(this, _T("From Date"), 244, 60, 324, 85);
	m_wndFromDate.Create(this,329, 60, 414, 85); 
	m_wndToDateLabel.Create(this, _T("To Date"), 419, 60, 499, 85);
	m_wndToDate.Create(this,504, 60, 589, 85); 
	m_wndDocNoLabel.Create(this, _T("Doc No"), 594, 30, 674, 55);
	m_wndDocNo.Create(this,679, 30, 759, 55); 
	m_wndRecordNoLabel.Create(this, _T("Record No"), 594, 60, 674, 85);
	m_wndRecordNo.Create(this,679, 60, 759, 85); 
	...
	m_wndFind.Create(this, _T("$$"), 763, 30, 795, 83);
}
void CHMSDocApproveA11::OnInitializeComponents(){
...
void CHMSDocApproveA11::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CHMSDocApproveA11::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSDocApproveA11::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSDocApproveA11::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CHMSDocApproveA11::SetDefaultValues(){
...
int CHMSDocApproveA11::SetMode(int nMode){
...
void CHMSDocApproveA11::OnTerminatedSelect(){
	OnListLoadData();
}
void CHMSDocApproveA11::OnApprovedFeesSelect(){
	OnListLoadData();
}
void CHMSDocApproveA11::OnApprovedSelect(){
	OnListLoadData();
}
void CHMSDocApproveA11::OnCanceledSelect(){
	OnListLoadData();
}
void CHMSDocApproveA11::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CHMSDocApproveA11::OnDepartmentSelendok(){
	 
}
/*void CHMSDocApproveA11::OnDepartmentSetfocus(){
	
}*/
/*void CHMSDocApproveA11::OnDepartmentKillfocus(){
	
}*/
long CHMSDocApproveA11::OnDepartmentLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CHMSDocApproveA11::OnDepartmentAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
/*void CHMSDocApproveA11::OnFromDateChange(){
	
} */
/*void CHMSDocApproveA11::OnFromDateSetfocus(){
	
} */
/*void CHMSDocApproveA11::OnFromDateKillfocus(){
	
} */
int CHMSDocApproveA11::OnFromDateCheckValue(){
	return 0;
} 
/*void CHMSDocApproveA11::OnToDateChange(){
	
} */
/*void CHMSDocApproveA11::OnToDateSetfocus(){
	
} */
/*void CHMSDocApproveA11::OnToDateKillfocus(){
	
} */
int CHMSDocApproveA11::OnToDateCheckValue(){
	return 0;
} 
/*void CHMSDocApproveA11::OnDocNoChange(){
	
} */
/*void CHMSDocApproveA11::OnDocNoSetfocus(){
	
} */
/*void CHMSDocApproveA11::OnDocNoKillfocus(){
	
} */
int CHMSDocApproveA11::OnDocNoCheckValue(){
	OnListLoadData();
	return 1;
} 
/*void CHMSDocApproveA11::OnRecordNoChange(){
	
} */
/*void CHMSDocApproveA11::OnRecordNoSetfocus(){
	
} */
/*void CHMSDocApproveA11::OnRecordNoKillfocus(){
	
} */
int CHMSDocApproveA11::OnRecordNoCheckValue(){
	OnListLoadData();
	return 1;
} 
void CHMSDocApproveA11::OnListDblClick(){
	
} 
void CHMSDocApproveA11::OnListSelectChange(int nOldItem, int nNewItem)
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CHMSDocApproveA11::OnListDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
}

void CHMSDocApproveA11::OnFindSelect()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnListLoadData();
} 

long CHMSDocApproveA11::OnListLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
void CHMSDocApproveA11::OnOutpatientSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnListLoadData();
}
void CHMSDocApproveA11::OnInpatientSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnListLoadData();	
}
void CHMSDocApproveA11::OnApproveSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnListApproveItem();
} 
void CHMSDocApproveA11::OnCancelSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	OnListCancelItem();
} 
int CHMSDocApproveA11::OnAddHMSDocApprove(){
...
int CHMSDocApproveA11::OnEditHMSDocApprove(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSDocApproveA11::OnDeleteHMSDocApprove(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
 	CString szSQL;
...
int CHMSDocApproveA11::OnSaveHMSDocApprove(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CHMSDocApproveA11::OnCancelHMSDocApprove(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSDocApproveA11::OnHMSDocApproveListLoadData()
{
	return 0;
}
...
int CHMSDocApproveA11::OnListApproveItem()
{
	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd();
	CString szSQL;
	long nDocumentNo;
	...
	if(dlg.DoModal() == IDOK)
	{
		szSQL.Format(_T("HMS_DOC_CLINICAL_APPROVE_A11(%ld, '%s', '%s', '%s', %d) "),
...
int CHMSDocApproveA11::OnListCancelItem()
{
	...
	if(dlg.DoModal() == IDOK)
	{
		szSQL.Format(_T("HMS_DOC_CLINICAL_CANCEL_A11(%ld, '%s', '%s', '%s', %d) "),
			nDocumentNo, dlg.m_szApproveDate, dlg.m_szNote, pMF->GetCurrentUser(), nRefIdx);
...
void CHMSDocApproveA11::OnPrintSummaryMaterialAndDrug()
{
	CPrintForms printer;
	int nTreatTime = 0;
	int nRefIdx =0;
...
void CHMSDocApproveA11::OnResizeLayout()
{
	AddResize(&m_wndList, 100, 100);
	AddBottom(&m_wndApprove);
