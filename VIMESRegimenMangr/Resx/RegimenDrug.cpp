...
void CRegimenDrug::OnSetWindowEvents(){
	...
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddRegimenDrugFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditRegimenDrugFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteRegimenDrugFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveRegimenDrugFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelRegimenDrugFnc, 0, 'T', VK_CONTROL);
	SetMode(VM_NONE);
