#ifndef EDUTECHCATALOGLIST_H
#define EDUTECHCATALOGLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CEduTechCatalogList : public CGuiView{
protected:
public:
	...
	int OnAddEduTechCatalogList(); 
	int OnEditEduTechCatalogList(); 
	int OnDeleteEduTechCatalogList(); 
	int OnSaveEduTechCatalogList(); 
	int OnCancelEduTechCatalogList(); 
	int OnEduTechCatalogListListLoadData(); 
};
#endif
