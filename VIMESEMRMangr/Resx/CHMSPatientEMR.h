#ifndef CHMSPATIENTEMR_H
#define CHMSPATIENTEMR_H
...
#include "GuiView.h"
#include "DbField.h"
class CCHMSPatientEMR : public CGuiView{
protected:
public:
	...
	int OnAddCHMSPatientEMR(); 
	int OnEditCHMSPatientEMR(); 
	int OnDeleteCHMSPatientEMR(); 
	int OnSaveCHMSPatientEMR(); 
	int OnCancelCHMSPatientEMR(); 
	int OnCHMSPatientEMRListLoadData(); 
};
#endif
