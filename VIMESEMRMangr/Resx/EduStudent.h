...
#include "GuiDialog.h"
#include "DbField.h"
class CEduStudent : public CGuiDialog{
protected:
public:
	CGuiGroupBox	m_wndGroupInformation;
	CGuiLabel		m_wndPicture;
	...
	int OnAddEduStudent(); 
	int OnEditEduStudent(); 
	int OnDeleteEduStudent(); 
	int OnSaveEduStudent(); 
	int OnCancelEduStudent(); 
	int OnEduStudentListLoadData(); 
};
#endif
