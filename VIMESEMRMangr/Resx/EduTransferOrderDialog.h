#ifndef EDUTRANSFERORDERDIALOG_H
#define EDUTRANSFERORDERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CEduTransferOrderDialog : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CEduTransferOrderDialog(CWnd *pParent);
	~CEduTransferOrderDialog();
	...
	int OnAddEduTransferOrderDialog(); 
	int OnEditEduTransferOrderDialog(); 
	int OnDeleteEduTransferOrderDialog(); 
	int OnSaveEduTransferOrderDialog(); 
	int OnCancelEduTransferOrderDialog(); 
	int OnEduTransferOrderDialogListLoadData(); 
};
#endif
