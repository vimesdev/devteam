#ifndef HMSBackupEMRList_H
#define HMSBackupEMRList_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSBackupEMRList : public CGuiView{
protected:
public:
	...
	CGuiButton		m_wndOpenDir;
	CGuiButton		m_wndBackup;
	...
	void			OnSearchSelect(); 
	void			OnOpenDirSelect(); 
	bool			OnBackupDoccument(long nDocNo);
	void			OnBackupSelect(); 
	...
	int OnAddHMSBackupEMRList(); 
	int OnEditHMSBackupEMRList(); 
	int OnDeleteHMSBackupEMRList(); 
	int OnSaveHMSBackupEMRList(); 
	int OnCancelHMSBackupEMRList(); 
	int OnHMSBackupEMRListListLoadData(); 
};
#endif
