#ifndef HMSADDITIONFEESETUPDIALOG_NEW_H
#define HMSADDITIONFEESETUPDIALOG_NEW_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSAdditionFeeSetupDialog_new : public CGuiDialog{
protected:
public:
	CString			m_szFeeID;
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CHMSAdditionFeeSetupDialog_new(CWnd *pParent);
	~CHMSAdditionFeeSetupDialog_new();
