#ifndef CHMSUPDATECHILDDIALOG_H
#define CHMSUPDATECHILDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSUpdateChildItemDialog : public CGuiDialog
{
protected:
public:
	...
	CHMSUpdateChildItemDialog(CWnd *pParent);
	~CHMSUpdateChildItemDialog();
	...
	int OnAddCHMSUpdateChildItemDialog(); 
	int OnEditCHMSUpdateChildItemDialog(); 
	int OnDeleteCHMSUpdateChildItemDialog(); 
	int OnSaveCHMSUpdateChildItemDialog(); 
	int OnCancelCHMSUpdateChildItemDialog(); 
	int OnCHMSUpdateChildItemDialogListLoadData();
