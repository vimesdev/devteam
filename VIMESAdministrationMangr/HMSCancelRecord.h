#ifndef HMSCANCELRECORD_H
#define HMSCANCELRECORD_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSCancelRecord : public CGuiDialog{
protected:
	CString	m_szDept;
public:
	...
	int OnAddHMSCancelRecord(); 
	int OnEditHMSCancelRecord(); 
	int OnDeleteHMSCancelRecord(); 
	int OnSaveHMSCancelRecord(); 
	int OnCancelHMSCancelRecord(); 
	int OnHMSCancelRecordListLoadData(); 
