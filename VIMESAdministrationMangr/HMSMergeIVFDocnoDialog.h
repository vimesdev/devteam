#ifndef HMSMERGEIVFDOCNODIALOG_H
#define HMSMERGEIVFDOCNODIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSMergeIVFDocnoDialog : public CGuiDialog
{
protected:
public:
	...
	CHMSMergeIVFDocnoDialog(CWnd *pParent);
	~CHMSMergeIVFDocnoDialog();
