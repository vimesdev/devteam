#ifndef HMSPRICESCHEMALINESETUPDIALOG_H
#define HMSPRICESCHEMALINESETUPDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSPriceSchemaLineSetupDialog : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSPriceSchemaLineSetupDialog(CWnd *pParent, int nMode);
	~CHMSPriceSchemaLineSetupDialog();
	...
	int OnAddHMSPriceSchemaLineSetupDialog(); 
	int OnEditHMSPriceSchemaLineSetupDialog(); 
	int OnDeleteHMSPriceSchemaLineSetupDialog(); 
	int OnSaveHMSPriceSchemaLineSetupDialog(); 
	int OnCancelHMSPriceSchemaLineSetupDialog(); 
	int OnHMSPriceSchemaLineSetupDialogListLoadData(); 
};
#endif
