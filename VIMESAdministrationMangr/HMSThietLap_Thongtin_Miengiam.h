#ifndef HMSTHIETLAP_THONGTIN_MIENGIAM_H
#define HMSTHIETLAP_THONGTIN_MIENGIAM_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSThietLap_Thongtin_Miengiam : public CGuiDialog
{
protected:
public:
	...
	int		m_nIndex;
	BOOL	m_bActive;
	CDbfMap M_DISCOUNT_FEE_LIST_Tbl;
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CHMSThietLap_Thongtin_Miengiam(CWnd *pParent);
	~CHMSThietLap_Thongtin_Miengiam();
	...
	int OnAddCHMSThietLap_Thongtin_Miengiam(); 
	int OnEditCHMSThietLap_Thongtin_Miengiam(); 
	int OnDeleteCHMSThietLap_Thongtin_Miengiam(); 
	int OnSaveCHMSThietLap_Thongtin_Miengiam(); 
	int OnCancelCHMSThietLap_Thongtin_Miengiam(); 
	int OnCHMSThietLap_Thongtin_MiengiamListLoadData();
