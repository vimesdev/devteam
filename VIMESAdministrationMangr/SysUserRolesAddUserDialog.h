#ifndef SYSUSERROLESADDUSERDIALOG_H
#define SYSUSERROLESADDUSERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CSysUserRolesAddUserDialog : public CGuiDialog{
protected:
public:
	...
	void			OnApplySelect(); 
	CSysUserRolesAddUserDialog(CWnd *pParent);
	~CSysUserRolesAddUserDialog();
	...
	int OnAddSysUserRolesAddUserDialog(); 
	int OnEditSysUserRolesAddUserDialog(); 
	int OnDeleteSysUserRolesAddUserDialog(); 
	int OnSaveSysUserRolesAddUserDialog(); 
	int OnCancelSysUserRolesAddUserDialog(); 
	int OnSysUserRolesAddUserDialogListLoadData(); 
	CString GetQueryString_user(bool bExport = false);
	void ApplyPermListToUserList();
};
#endif
