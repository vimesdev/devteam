#ifndef HMSMachineSetupDialog_H
#define HMSMachineSetupDialog_H
...
class CHMSMachineSetupDialog : public CGuiDialog{
protected:
public:
	CGuiButton		m_wndAdd;
	...
	CHMSMachineSetupDialog(CWnd *pParent);
	~CHMSMachineSetupDialog();
	...
	int OnAddHMSMachineSetupDialog(); 
	int OnEditHMSMachineSetupDialog(); 
	int OnDeleteHMSMachineSetupDialog(); 
	int OnSaveHMSMachineSetupDialog(); 
	int OnCancelHMSMachineSetupDialog(); 
	int OnHMSMachineSetupDialogListLoadData(); 
};
