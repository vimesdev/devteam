#ifndef HMSCREATEUSER_H
#define HMSCREATEUSER_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSCreateUser : public CGuiDialog{
protected:
public:
	...
	int OnAddHMSCreateUser(); 
	int OnEditHMSCreateUser(); 
	int OnDeleteHMSCreateUser(); 
	int OnSaveHMSCreateUser(); 
	int OnCancelHMSCreateUser(); 
	int OnHMSCreateUserListLoadData(); 
};
#endif
