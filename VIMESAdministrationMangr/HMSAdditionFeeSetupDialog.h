...
public:
	...
	CGuiLabel		m_wndSubGroupLabel;
	CGuiTextCtrl	m_wndSubGroup;
	CGuiLabel		m_wndSubItemLabel;
	CGuiTextCtrl	m_wndSubItem;
	CGuiLabel		m_wndDeptLabel;
	CGuiTextCtrl	m_wndDept;
	CGuiLabel		m_wndMa_bh1_label;
	CGuiTextCtrl	m_wndMa_bh1;
	CGuiLabel		m_wndMa_bh2_label;
	CGuiTextCtrl	m_wndMa_bh2;
	CGuiLabel		m_wndNhomBHLabel;
	CGuiComboBox	m_wndNhomBH;
	CGuiLabel		m_wndFoodTypeLabel;
	CGuiNumberCtrl	m_wndFoodType;
	...
	//void			OnSubGroupChange(); 
	//void			OnSubGroupSetfocus(); 
	//void			OnSubGroupKillfocus(); 
	int			OnSubGroupCheckValue(); 
	//void			OnSubItemChange(); 
	//void			OnSubItemSetfocus(); 
	//void			OnSubItemKillfocus(); 
	int			OnSubItemCheckValue();
	int			OnDeptCheckValue(); 	
	int			OnFoodTypeCheckValue(); 
	void			OnHitechSelect(); 
	...
	int			OnMa_bh1CheckValue(); 	
	int			OnMa_bh2CheckValue();
	long			OnNhomBHLoadData();
	void			OnfeefoodnnSelect(); 
