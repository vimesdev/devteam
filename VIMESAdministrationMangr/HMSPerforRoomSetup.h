#ifndef HMSPERFORROOMSETUP_H
#define HMSPERFORROOMSETUP_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSPerforRoomSetup : public CGuiView{
protected:
public:
	...
	CGuiLabel		m_wndFreeGroupLabel;
	CGuiComboBox	m_wndFreeGroup;
	...
	void			OnFreeGroupSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnFreeGroupSelendok(); 
	//void			OnFreeGroupSetfocus(); 
	void			OnFreeGroupKillfocus(); 
	long			OnFreeGroupLoadData(); 
	//void			OnFreeGroupAddNew(); 
	...
	int OnAddHMSPerforRoomSetup(); 
	int OnEditHMSPerforRoomSetup(); 
	int OnDeleteHMSPerforRoomSetup(); 
	int OnSaveHMSPerforRoomSetup(); 
	int OnCancelHMSPerforRoomSetup(); 
	int OnHMSPerforRoomSetupListLoadData(); 
};
#endif
