#ifndef VIMESDEPARTMENTTEST_H
#define VIMESDEPARTMENTTEST_H
...
#include "GuiView.h"
#include "DbField.h"
class CVIMESDepartmentTest : public CGuiView{
protected:
public:
	...
	int OnAddVIMESDepartmentTest(); 
	int OnEditVIMESDepartmentTest(); 
	int OnDeleteVIMESDepartmentTest(); 
	int OnSaveVIMESDepartmentTest(); 
	int OnCancelVIMESDepartmentTest(); 
	int OnVIMESDepartmentTestListLoadData(); 
};
#endif
