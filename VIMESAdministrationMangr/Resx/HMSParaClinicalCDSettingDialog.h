#ifndef HMSPARACLINICALCDSETTINGDIALOG_H
#define HMSPARACLINICALCDSETTINGDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSParaClinicalCDSettingDialog : public CGuiDialog{
protected:
public:
	...
	void			OnRemoveSelect(); 
	void			OnCloseSelect(); 
	CHMSParaClinicalCDSettingDialog(CWnd *pParent);
	~CHMSParaClinicalCDSettingDialog();
	...
	int OnAddHMSParaClinicalCDSettingDialog(); 
	int OnEditHMSParaClinicalCDSettingDialog(); 
	int OnDeleteHMSParaClinicalCDSettingDialog(); 
	int OnSaveHMSParaClinicalCDSettingDialog(); 
	int OnCancelHMSParaClinicalCDSettingDialog(); 
	int OnHMSParaClinicalCDSettingDialogListLoadData(); 
};
#endif
