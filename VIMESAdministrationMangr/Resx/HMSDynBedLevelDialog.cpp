...
void CHMSDynBedLevelDialog::OnCreateComponents(){
	m_wndBedInformation.Create(this, _T("Bed Information"), 5, 5, 605, 181);
	m_wndLevel1Label.Create(this, _T("Level 1"), 10, 29, 90, 54);
	m_wndLevel1.Create(this,95, 29, 445, 54); 
	m_wndDays1Label.Create(this, _T("Days"), 450, 29, 530, 54);
	m_wndDays1.Create(this,535, 29, 600, 54); 
	m_wndLevel2Label.Create(this, _T("Level 2"), 10, 59, 90, 84);
	m_wndLevel2.Create(this,95, 59, 445, 84); 
	m_wndDays2Label.Create(this, _T("Days"), 450, 59, 530, 84);
	m_wndDays2.Create(this,535, 59, 600, 84); 
	m_wndLevel3Label.Create(this, _T("Level 3"), 10, 89, 90, 114);
	m_wndLevel3.Create(this,95, 89, 445, 114); 
	m_wndDays3Label.Create(this, _T("Days"), 450, 89, 530, 114);
	m_wndDays3.Create(this,535, 89, 600, 114); 
	m_wndLevel4Label.Create(this, _T("Level 4"), 10, 119, 90, 144);
	m_wndLevel4.Create(this,95, 119, 445, 144); 
	m_wndDays4Label.Create(this, _T("Days"), 450, 119, 530, 144);
	m_wndDays4.Create(this,535, 119, 600, 144); 
	m_wndLevel5Label.Create(this, _T("Level 5"), 10, 149, 90, 174);
	m_wndLevel5.Create(this,95, 149, 445, 174); 
	m_wndDays5Label.Create(this, _T("Days"), 450, 149, 530, 174);
	m_wndDays5.Create(this,535, 149, 600, 174); 
	m_wndApply.Create(this, _T("&Apply"), 440, 187, 520, 212);
	m_wndClose.Create(this, _T("&Close"), 525, 187, 605, 212);
