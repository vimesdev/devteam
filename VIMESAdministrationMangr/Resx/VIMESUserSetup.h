#ifndef VIMESUSERSETUP_H
#define VIMESUSERSETUP_H
...
#include "GuiView.h"
#include "DbField.h"
class CVIMESUserSetup : public CGuiView{
protected:
public:
	...
	int OnAddVIMESUserSetup(); 
	int OnEditVIMESUserSetup(); 
	int OnDeleteVIMESUserSetup(); 
	int OnSaveVIMESUserSetup(); 
	int OnCancelVIMESUserSetup(); 
	int OnVIMESUserSetupListLoadData(); 
};
#endif
