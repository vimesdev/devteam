...
public:
	...
	BOOL	LoadData(long nDocumentNo);
	...
	bool	LoadData();
	//Hàm load từ dữ liệu bệnh án chuyên khoa
	bool	LoadData_V2();
	dom::element Find(LPCTSTR lpszName);

	bool	PostAndPrintDocx();
