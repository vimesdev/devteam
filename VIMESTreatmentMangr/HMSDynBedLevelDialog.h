...
public:
	...
	CGuiLabel           m_wndFromDate1Label;
	CGuiDateCtrl	m_wndFromDate1;
	CGuiLabel		m_wndToDate1Label;
	CGuiDateCtrl	m_wndToDate1;
	
	CGuiLabel           m_wndFromDate2Label;
	CGuiDateCtrl	m_wndFromDate2;
	CGuiLabel		m_wndToDate2Label;
	CGuiDateCtrl	m_wndToDate2;
	
	CGuiLabel           m_wndFromDate3Label;
	CGuiDateCtrl	m_wndFromDate3;
	CGuiLabel		m_wndToDate3Label;
	CGuiDateCtrl	m_wndToDate3;

	CGuiLabel           m_wndFromDate4Label;
	CGuiDateCtrl	m_wndFromDate4;
	CGuiLabel		m_wndToDate4Label;
	CGuiDateCtrl	m_wndToDate4;
	
	CGuiLabel           m_wndFromDate5Label;
	CGuiDateCtrl	m_wndFromDate5;
	CGuiLabel		m_wndToDate5Label;
	CGuiDateCtrl	m_wndToDate5;
	...
	CString	m_szFromDate1;
	CString	m_szToDate1;

	CString	m_szFromDate2;
	CString	m_szToDate2;

	CString	m_szFromDate3;
	CString	m_szToDate3;

	CString	m_szFromDate4;
	CString	m_szToDate4;

	CString	m_szFromDate5;
	CString	m_szToDate5;
	...
	int			OnFromDate1CheckValue(); 	
	int			OnToDate1CheckValue(); 
	
	int			OnFromDate2CheckValue(); 	
	int			OnToDate2CheckValue(); 

	int			OnFromDate3CheckValue(); 	
	int			OnToDate3CheckValue(); 

	int			OnFromDate4CheckValue(); 	
	int			OnToDate4CheckValue(); 

	int			OnFromDate5CheckValue(); 	
	int			OnToDate5CheckValue(); 
	long		LoadDynBedList(CGuiComboBox* pCombo, CString szKey, CString szFilter=_T(""));
	...
	int CalcDaysBetween(CString szFrom, CString szTo);
};
#endif
