...
class CHMSInpatientPrescriptionPopup : public CGuiPopup{
protected:
public:		
	long	m_nOrderID;
	CString	m_szOrders;
	...
	CHMSInpatientPrescriptionPopup();
	CHMSInpatientPrescriptionPopup(CWnd *pParent, int nMode);
	~CHMSInpatientPrescriptionPopup();
	...
	int OnAddHMSInpatientPrescriptionPopup(); 
	int OnEditHMSInpatientPrescriptionPopup(); 
	int OnDeleteHMSInpatientPrescriptionPopup(); 
	int OnSaveHMSInpatientPrescriptionPopup(); 
	int OnCancelHMSInpatientPrescriptionPopup(); 
	int OnHMSInpatientPrescriptionPopupListLoadData(); 
