...
#include "GuiView.h"
#include "DbField.h"
class CHMSPatientMaterialOperationEntry : public CGuiView{
protected:
public:
	...
	int OnAddHMSPatientMaterialOperationEntry(); 
	int OnEditHMSPatientMaterialOperationEntry(); 
	int OnDeleteHMSPatientMaterialOperationEntry(); 
	int OnSaveHMSPatientMaterialOperationEntry(); 
	int OnCancelHMSPatientMaterialOperationEntry(); 
	int OnHMSPatientMaterialOperationEntryListLoadData(); 
};
#endif
