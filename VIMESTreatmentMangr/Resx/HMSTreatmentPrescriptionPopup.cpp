...
static void _OnCancerOptSelectFnc(CWnd *pWnd){
	 ((CHMSTreatmentPrescriptionPopup*)pWnd)->OnCancerOptSelect();
}
...
void CHMSTreatmentPrescriptionPopup::OnCreateComponents(){
	...
	m_wndServiceWarehouse.Create(this, _T("Kho d?ch v?"), 541, 5, 627, 30);
	m_wndOutPrescription.Create(this, _T("Ðon thu?c ra v?"), 632, 5, 776, 30);
	m_wndName.Create(this,131, 35, 461, 60); 
	m_wndUnitLabel.Create(this, _T("Unit"), 466, 35, 536, 60);
	m_wndUnit.Create(this,541, 35, 626, 60); 
	m_wndGenericSearch.Create(this, _T("Tìm theo tên ho?t ch?t"), 631, 35, 776, 60);
	m_wndNameLabel.Create(this, _T("Tên thu?c"), 6, 35, 126, 61);
	m_wndQuantityLabel.Create(this, _T("Quantity"), 5, 65, 125, 90);
	m_wndQty.Create(this,130, 65, 215, 90); 
	m_wndOnHand.Create(this, _T("On Hand"), 220, 65, 320, 90);
	m_wndMaxQuantity.Create(this,325, 65, 460, 90); 
	m_wndCancerOpt.Create(this, _T("Thu?c dùng pha ch?"), 631, 65, 776, 90);
	...
	m_wndSpeedLabel.Create(this, _T("T?c d?"), 5, 125, 125, 150);
...
int CHMSTreatmentPrescriptionPopup::OnMaxQuantityCheckValue(){
	...
	void CHMSTreatmentPrescriptionPopup::OnCancerOptSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
