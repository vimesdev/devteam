#ifndef CHMSTREATMENTQUEUE_H
#define CHMSTREATMENTQUEUE_H
...
#include "GuiView.h"
#include "DbField.h"
class CCHMSTreatmentQueue : public CGuiView{
protected:
public:
	...
	int OnAddCHMSTreatmentQueue(); 
	int OnEditCHMSTreatmentQueue(); 
	int OnDeleteCHMSTreatmentQueue(); 
	int OnSaveCHMSTreatmentQueue(); 
	int OnCancelCHMSTreatmentQueue(); 
	int OnCHMSTreatmentQueueListLoadData(); 
};
#endif
