#ifndef HMSPRESCRIPTIONDLG_H
#define HMSPRESCRIPTIONDLG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSPrescriptionDlg : public CGuiDialog{
protected:
public:
	...
	void			OnSendSelect(); 
	void			OnPrintSelect(); 
	CHMSPrescriptionDlg(CWnd *pParent);
	~CHMSPrescriptionDlg();
	...
	int OnAddHMSPrescriptionDlg(); 
	int OnEditHMSPrescriptionDlg(); 
	int OnDeleteHMSPrescriptionDlg(); 
	int OnSaveHMSPrescriptionDlg(); 
	int OnCancelHMSPrescriptionDlg(); 
	int OnHMSPrescriptionDlgListLoadData(); 
};
#endif
