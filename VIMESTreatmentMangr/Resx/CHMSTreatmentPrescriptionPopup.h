#ifndef CHMSTREATMENTPRESCRIPTIONPOPUP_H
#define CHMSTREATMENTPRESCRIPTIONPOPUP_H
...
#include "GuiView.h"
#include "DbField.h"
class CCHMSTreatmentPrescriptionPopup : public CGuiView{
protected:
public:
	...
	void			OnPaySourceSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnPaySourceSelendok(); 
	//void			OnPaySourceSetfocus(); 
	//void			OnPaySourceKillfocus(); 
	long			OnPaySourceLoadData(); 
	//void			OnPaySourceAddNew(); 
	void			OnDoseWarningSelect(); 
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CCHMSTreatmentPrescriptionPopup();
	~CCHMSTreatmentPrescriptionPopup();
	...
	int OnAddCHMSTreatmentPrescriptionPopup(); 
	int OnEditCHMSTreatmentPrescriptionPopup(); 
	int OnDeleteCHMSTreatmentPrescriptionPopup(); 
	int OnSaveCHMSTreatmentPrescriptionPopup(); 
	int OnCancelCHMSTreatmentPrescriptionPopup(); 
	int OnCHMSTreatmentPrescriptionPopupListLoadData(); 
};
#endif
