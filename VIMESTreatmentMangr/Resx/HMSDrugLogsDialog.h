...
public:
	...
	CGuiLabel		m_wndDrugNameCntLabel;
	CGuiComboBox	m_wndDrugNameCnt;
	CGuiLabel		m_wndQuantityLabel;
	CGuiNumberCtrl	m_wndQuantity;
	CGuiLabel		m_wndDay NumberLabel;
	CGuiNumberCtrl	m_wndDay Number;
	...
	void			OnDrugNameCntSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnDrugNameCntSelendok(); 
	//void			OnDrugNameCntSetfocus(); 
	//void			OnDrugNameCntKillfocus(); 
	long			OnDrugNameCntLoadData(); 
	//void			OnDrugNameCntAddNew(); 
	//void			OnQuantityChange(); 
	//void			OnQuantitySetfocus(); 
	//void			OnQuantityKillfocus(); 
	int			OnQuantityCheckValue(); 
	//void			OnDay NumberChange(); 
	//void			OnDay NumberSetfocus(); 
	//void			OnDay NumberKillfocus(); 
	int			OnDay NumberCheckValue(); 
