#ifndef HMSOPERATIONMATERIALDIALOG2_H
#define HMSOPERATIONMATERIALDIALOG2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSOperationMaterialDialog2 : public CGuiDialog{
protected:
public:
	...
	int OnAddHMSOperationMaterialDialog2(); 
	int OnEditHMSOperationMaterialDialog2(); 
	int OnDeleteHMSOperationMaterialDialog2(); 
	int OnSaveHMSOperationMaterialDialog2(); 
	int OnCancelHMSOperationMaterialDialog2(); 
	int OnHMSOperationMaterialDialog2ListLoadData(); 
};
#endif
