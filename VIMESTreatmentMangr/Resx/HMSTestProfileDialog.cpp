...
void CHMSTestProfileDialog::OnCreateComponents(){
	m_wndTestProfiles.Create(this, _T("Test Profiles"), 5, 5, 800, 571);
	m_wndItemList.Create(this,295, 30, 795, 505); 
	m_wndGroupLabel.Create(this, _T("Group"), 295, 510, 375, 535);
	m_wndGroup.Create(this,380, 510, 796, 535); 
	m_wndProfileList.Create(this,10, 30, 290, 565); 
	m_wndNameLabel.Create(this, _T("Name"), 295, 540, 375, 565);
	m_wndName.Create(this,380, 540, 695, 565); 
	m_wndQtyLabel.Create(this, _T("Qty"), 701, 540, 746, 565);
	m_wndQty.Create(this,751, 540, 796, 565); 
	m_wndAdd.Create(this, _T("&Add"), 380, 576, 460, 601);
	m_wndDelete.Create(this, _T("&Delete"), 465, 576, 545, 601);
	m_wndSave.Create(this, _T("&Save"), 550, 576, 630, 601);
	m_wndCancel.Create(this, _T("&Cancel"), 635, 576, 715, 601);
	m_wndClose.Create(this, _T("&Close"), 720, 576, 800, 601);
