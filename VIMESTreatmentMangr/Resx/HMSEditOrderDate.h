#ifndef HMSEDITORDERDATE_H
#define HMSEDITORDERDATE_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSEditOrderDate : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSEditOrderDate(CWnd *pParent);
	~CHMSEditOrderDate();
	...
	int OnAddHMSEditOrderDate(); 
	int OnEditHMSEditOrderDate(); 
	int OnDeleteHMSEditOrderDate(); 
	int OnSaveHMSEditOrderDate(); 
	int OnCancelHMSEditOrderDate(); 
	int OnHMSEditOrderDateListLoadData(); 
};
#endif
