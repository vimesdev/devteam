#ifndef HMSDailyOperationMaterialListDialog_H
#define HMSDailyOperationMaterialListDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSDailyOperationMaterialListDialog : public CGuiDialog{
protected:
public:
	long		m_nOID;
	CString		m_szOrderNo;
...
//	CString	m_szOrderNo;
	...
	CHMSDailyOperationMaterialListDialog(CWnd *pParent);
	~CHMSDailyOperationMaterialListDialog();
	...
	int OnAddHMSDailyOperationMaterialListDialog(); 
	int OnEditHMSDailyOperationMaterialListDialog(); 
	int OnDeleteHMSDailyOperationMaterialListDialog(); 
	int OnSaveHMSDailyOperationMaterialListDialog(); 
	int OnCancelHMSDailyOperationMaterialListDialog(); 
	int OnHMSDailyOperationMaterialListDialogListLoadData(); 
};
#endif
