...
#include "DbField.h"
//******************************************************
//Class nhap thong tin ra vien
//******************************************************
class CHMSDischarge : public CGuiView{
protected:
	bool	m_bLogDischarged;
public:
	CGuiGroupBox	m_wndDischargeInformation;
	CGuiLabel		m_wndEndDateLabel;
	CGuiDateTimeCtrl	m_wndEndDate;
	CGuiLabel		m_wndClosingDoctorLabel;
	CGuiComboBox	m_wndClosingDoctor;
	CGuiLabel		m_wndDischargeStatusLabel;
	CGuiComboBox	m_wndDischargeStatus;
	...
	CString	m_szComment;
	CString m_szDischargeStatusKey;

	CDbfMap	m_hms_treatmentTbl;
	...
	void			OnResultAddNew(); 
		void			OnDischargeStatusSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnDischargeStatusSelendok(); 
	//void			OnDischargeStatusSetfocus(); 
	//void			OnDischargeStatusKillfocus(); 
	long			OnDischargeStatusLoadData(); 
	void			OnDischargeStatusAddNew(); 
