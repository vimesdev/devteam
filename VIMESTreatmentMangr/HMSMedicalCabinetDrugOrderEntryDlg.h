#ifndef HMSMEDICALCABINETDRUGORDERENTRYDLG_H
#define HMSMEDICALCABINETDRUGORDERENTRYDLG_H
...
class CHMSMedicalCabinetDrugOrderEntryDlg : public CGuiDialog
{
protected:
	bool	m_bAddOrder;
	long	m_nOrderID;
...
public:
	...
	CGuiButton		m_wndDateButton;
	CGuiLabel		m_wndStockLabel;
	CGuiComboBox	m_wndStockList;
	...
	CHMSMedicalCabinetDrugOrderEntryDlg(CWnd *pParent, int nMode);
	~CHMSMedicalCabinetDrugOrderEntryDlg();
