#ifndef HMSTRACKINGPATIENTFEEVIEW_H
#define HMSTRACKINGPATIENTFEEVIEW_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSTrackingPatientFeeView : public CGuiView
{
protected:
public:
	...
	CGuiLabel		m_wndHanmucLabel;
	CGuiComboBox	m_wndHanmuc;
	CString	m_szDepartmentKey;

	long	m_nFromMoney;
	long	m_nToMoney;
	CString	m_szObjectKey;
	CString	m_szHanmucKey;
	long	m_nDocumentNo;
	long	m_nhanmuc;
	...
	void			OnHanmucSelendok();
	void			OnSearchSelect(); 
	long			OnListLoadData(); 
	void			OnListSelectChange(int nOldItem, int nNewItem); 
	void			OnListDblClick(); 
	int			OnListDeleteItem(); 
	CHMSTrackingPatientFeeView();
	~CHMSTrackingPatientFeeView();
