#ifndef HMSDailyFoodCancelPatientListDialog_H
#define HMSDailyFoodCancelPatientListDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSDailyFoodCancelPatientListDialog : public CGuiDialog{
protected:
	bool	m_bAddOrder;	
	long	m_nPatientNo;
	long	m_nDocumentNo;
...
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSDailyFoodCancelPatientListDialog(CWnd *pParent);
	~CHMSDailyFoodCancelPatientListDialog();
	...
	int OnAddHMSDailyFoodCancelPatientListDialog(); 
	int OnEditHMSDailyFoodCancelPatientListDialog(); 
	int OnDeleteHMSDailyFoodCancelPatientListDialog(); 
	int OnSaveHMSDailyFoodCancelPatientListDialog(); 
	int OnCancelHMSDailyFoodCancelPatientListDialog(); 
	int OnHMSDailyFoodCancelPatientListDialogListLoadData(); 
};
#endif
