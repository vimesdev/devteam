#include "HMSBedInformationDialog.h"
#include "MainFrm.h"
...
/*static void _OnAdmitDateChangeFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnAdmitDateChange();
} */
/*static void _OnAdmitDateSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnAdmitDateSetfocus();} */ 
/*static void _OnAdmitDateKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnAdmitDateKillfocus();
} */
static int _OnAdmitDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnAdmitDateCheckValue();
} 
/*static void _OnOutDateChangeFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnOutDateChange();
} */
/*static void _OnOutDateSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnOutDateSetfocus();} */ 
static void _OnOutDateKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnOutDateKillfocus();
} 
static int _OnOutDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnOutDateCheckValue();
} 
/*static void _OnDayOfTreatChangeFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnDayOfTreatChange();
} */
/*static void _OnDayOfTreatSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnDayOfTreatSetfocus();} */ 
/*
static void _OnDayOfTreatKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnDayOfTreatKillfocus();
}
*/
static int _OnDayOfTreatCheckValueFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnDayOfTreatCheckValue();
} 
static void _OnRoomSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSBedInformationDialog* )pWnd)->OnRoomSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnRoomSelendokFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnRoomSelendok();
}
/*static void _OnRoomSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnRoomKillfocus();
}*/
/*static void _OnRoomKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnRoomKillfocus();
}*/
static long _OnRoomLoadDataFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnRoomLoadData();
}
/*static void _OnRoomAddNewFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnRoomAddNew();
}*/
static void _OnBedSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSBedInformationDialog* )pWnd)->OnBedSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnBedSelendokFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnBedSelendok();
}
/*static void _OnBedSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnBedKillfocus();
}*/
/*static void _OnBedKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnBedKillfocus();
}*/
static long _OnBedLoadDataFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnBedLoadData();
}
/*static void _OnBedAddNewFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnBedAddNew();
}*/

static void _OnPriceBedSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSBedInformationDialog* )pWnd)->OnPriceBedSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnPriceBedSelendokFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnPriceBedSelendok();
}
/*static void _OnPriceBedSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnPriceBedKillfocus();
}*/
/*static void _OnPriceBedKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnPriceBedKillfocus();
}*/
static long _OnPriceBedLoadDataFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnPriceBedLoadData();
}
/*static void _OnPriceBedAddNewFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnPriceBedAddNew();
}*/


static void _OnRequestOptionSelectFnc(CWnd *pWnd){
	 ((CHMSBedInformationDialog*)pWnd)->OnRequestOptionSelect();
}
static void _OnDoctorSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSBedInformationDialog* )pWnd)->OnDoctorSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDoctorSelendokFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnDoctorSelendok();
}
/*static void _OnDoctorSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnDoctorKillfocus();
}*/
/*static void _OnDoctorKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnDoctorKillfocus();
}*/
static long _OnDoctorLoadDataFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnDoctorLoadData();
}
/*static void _OnDoctorAddNewFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnDoctorAddNew();
}*/
static void _OnNurseSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSBedInformationDialog* )pWnd)->OnNurseSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNurseSelendokFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnNurseSelendok();
}
/*static void _OnNurseSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnNurseKillfocus();
}*/
/*static void _OnNurseKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnNurseKillfocus();
}*/
static long _OnNurseLoadDataFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnNurseLoadData();
}
/*static void _OnNurseAddNewFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnNurseAddNew();
}*/
/*static void _OnServicePriceChangeFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnServicePriceChange();
} */
/*static void _OnServicePriceSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnServicePriceSetfocus();} */ 
/*static void _OnServicePriceKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnServicePriceKillfocus();
} */
static int _OnServicePriceCheckValueFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnServicePriceCheckValue();
} 
/*static void _OnInsurancePriceChangeFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnInsurancePriceChange();
} */
/*static void _OnInsurancePriceSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnInsurancePriceSetfocus();} */ 
/*static void _OnInsurancePriceKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnInsurancePriceKillfocus();
} */
static int _OnInsurancePriceCheckValueFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnInsurancePriceCheckValue();
} 
/*static void _OnPolicyPriceChangeFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnPolicyPriceChange();
} */
/*static void _OnPolicyPriceSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnPolicyPriceSetfocus();} */ 
/*static void _OnPolicyPriceKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnPolicyPriceKillfocus();
} */
static int _OnPolicyPriceCheckValueFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnPolicyPriceCheckValue();
} 
/*static void _OnRequestPriceChangeFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnRequestPriceChange();
} */
/*static void _OnRequestPriceSetfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnRequestPriceSetfocus();} */ 
/*static void _OnRequestPriceKillfocusFnc(CWnd *pWnd){
	((CHMSBedInformationDialog *)pWnd)->OnRequestPriceKillfocus();
} */
static int _OnRequestPriceCheckValueFnc(CWnd *pWnd){
	return ((CHMSBedInformationDialog *)pWnd)->OnRequestPriceCheckValue();
}

static void _OnBedDiagramSelectFnc(CWnd *pWnd){
	CHMSBedInformationDialog *pVw = (CHMSBedInformationDialog *)pWnd;
...
static int _OnAddHMSBedInformationDialogFnc(CWnd *pWnd){
	 return ((CHMSBedInformationDialog*)pWnd)->OnAddHMSBedInformationDialog();
} 
static int _OnEditHMSBedInformationDialogFnc(CWnd *pWnd){
	 return ((CHMSBedInformationDialog*)pWnd)->OnEditHMSBedInformationDialog();
} 
 
static int _OnSaveHMSBedInformationDialogFnc(CWnd *pWnd){
	 return ((CHMSBedInformationDialog*)pWnd)->OnSaveHMSBedInformationDialog();
} 
static int _OnCancelHMSBedInformationDialogFnc(CWnd *pWnd){
	 return ((CHMSBedInformationDialog*)pWnd)->OnCancelHMSBedInformationDialog();
}
static void _OnByTreatTimeSelectFnc(CWnd *pWnd)
{
	 ((CHMSBedInformationDialog*)pWnd)->OnByTreatTimeSelect();
}

static int _OnDynamicBedInformationViewFnc(CWnd *pWnd){
	 return ((CHMSBedInformationDialog*)pWnd)->OnDynamicBedInformationView();
} 

CHMSBedInformationDialog::CHMSBedInformationDialog(CWnd* pParent, int nMode): CGuiDialog(pParent){
...
CHMSBedInformationDialog::~CHMSBedInformationDialog(){
}
void CHMSBedInformationDialog::OnCreateComponents()
{
	m_wndBedInformation.Create(this, _T("Bed Information"), 5, 5, 620, 240);
	...
	m_wndPriceBedLabel.Create(this, _T("Type"), 10, 120, 90, 145);
	...
	m_wndSave.Create(this, _T("&Save"), 440, 210, 525, 235);
	m_wndCancel.Create(this, _T("&Cancel"), 530, 210, 615, 235);
	...
	m_wndByTreatTime.Create(this, _T("By TreatTime"), 430, 180, 615, 205);
	m_wndList.Create(this,10, 210, 615, 525);*/
}
void CHMSBedInformationDialog::OnInitializeComponents(){
...
//	m_wndServicePrice.SetCheckValue(true);
	...
	m_wndDoctor.InsertColumn(1, _T("Name"), CFMT_TEXT, 400);


	m_wndNurse.InsertColumn(0, _T("ID"), CFMT_TEXT, 100);
	m_wndNurse.InsertColumn(1, _T("Name"), CFMT_TEXT, 400);
	...
	m_hms_bedTbl.AddField(_T("hb_treattime"), dfInteger);
...
void CHMSBedInformationDialog::OnSetWindowEvents()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddHMSBedInformationDialogFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditHMSBedInformationDialogFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteHMSBedInformationDialogFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveHMSBedInformationDialogFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelHMSBedInformationDialogFnc, 0, 'T', VK_CONTROL);
*/
...
void CHMSBedInformationDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSBedInformationDialog::GetDataToScreen()
{
	...
	if(!rs.IsEOF())
	{
		...
		rs.GetValue(_T("HB_DEPTID"), m_szDeptID);
...
void CHMSBedInformationDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(GetMode() == VM_ADD){
		CRecord rs(&pMF->m_db);
		CString szSQL;
	...
	m_hms_bedTbl.SetValue(_T("hb_treattime"), pMF->GetTreatTime());
...
void CHMSBedInformationDialog::SetDefaultValues()
{
	...
	m_szStatus = L"O";
	//m_bByTreatTime = FALSE;
}
int CHMSBedInformationDialog::SetMode(int nMode){
...
/*void CHMSBedInformationDialog::OnAdmitDateChange(){
	
} */
/*void CHMSBedInformationDialog::OnAdmitDateSetfocus(){
	
} */
/*void CHMSBedInformationDialog::OnAdmitDateKillfocus(){
	
} */
int CHMSBedInformationDialog::OnAdmitDateCheckValue(){
	UpdateData(true);
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CHMSBedInformationDialog::OnOutDateChange(){
	
} */
/*void CHMSBedInformationDialog::OnOutDateSetfocus(){
	
} */
void CHMSBedInformationDialog::OnOutDateKillfocus(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	UpdateData(TRUE);
...
int CHMSBedInformationDialog::OnOutDateCheckValue(){
	UpdateData(true);
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CHMSBedInformationDialog::OnDayOfTreatChange(){
	
} */
/*void CHMSBedInformationDialog::OnDayOfTreatSetfocus(){
	
} */
void CHMSBedInformationDialog::OnDayOfTreatKillfocus(){
	
}
int CHMSBedInformationDialog::OnDayOfTreatCheckValue(){
...
void CHMSBedInformationDialog::OnRoomSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSBedInformationDialog::OnRoomSelendok()
{	
	m_wndBed.ResetContent();	
}
/*void CHMSBedInformationDialog::OnRoomSetfocus(){
	
}*/
/*void CHMSBedInformationDialog::OnRoomKillfocus(){
	
}*/
long CHMSBedInformationDialog::OnRoomLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	if (GetMode() == VM_VIEW)
	{
		m_szCurrentDeptID = m_szDeptID; 
	}
	else
		m_szCurrentDeptID = pMF->m_szDept;
	...
	int nCount = 0;	
	szSQL.Format(_T("SELECT * FROM hms_roomlist WHERE hrl_active ='Y' and hrl_deptid='%s' %s ORDER BY hrl_id"), m_szCurrentDeptID, szWhere);
...
/*void CHMSBedInformationDialog::OnRoomAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSBedInformationDialog::OnBedSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSBedInformationDialog::OnBedSelendok(){
	
}
/*void CHMSBedInformationDialog::OnBedSetfocus(){
	
}*/
/*void CHMSBedInformationDialog::OnBedKillfocus(){
	
}*/
long CHMSBedInformationDialog::OnBedLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	{
		szWhere.Format(_T(" AND hbl_deptid = '%s' and hbl_id=%d and hbl_roomid = %d"), m_szCurrentDeptID, ToInt(m_szBedKey), ToInt(m_szRoomKey));
	};
	...
	szSQL.Format(_T("SELECT hbl_id, hbl_name, hbl_reqpaid, ") \
				...
				_T(" FROM hms_bedlist WHERE hbl_active ='Y' and hbl_deptid='%s' AND hbl_roomid=%d %s ORDER BY hbl_id "),m_szCurrentDeptID, m_szCurrentDeptID, ToInt(m_szRoomKey), szWhere);
...
/*void CHMSBedInformationDialog::OnBedAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

void CHMSBedInformationDialog::OnPriceBedSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSBedInformationDialog::OnPriceBedSelendok(){
	 
}
/*void CHMSBedInformationDialog::OnPriceBedSetfocus(){
	
}*/
/*void CHMSBedInformationDialog::OnPriceBedKillfocus(){
	
}*/
long CHMSBedInformationDialog::OnPriceBedLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
	...
	int nCount = 0;
	szSQL.Format(_T("SELECT * FROM hms_dynbedlist WHERE hdbl_deptid='%s' and hdbl_active='Y'  %s ORDER BY hdbl_idx "), m_szCurrentDeptID, szWhere);
	nCount = rs.ExecSQL(szSQL);
	//_msg(_T("%s"), szSQL);
	while(!rs.IsEOF()){ 
...
/*void CHMSBedInformationDialog::OnPriceBedAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
	void CHMSBedInformationDialog::OnRequestOptionSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
void CHMSBedInformationDialog::OnDoctorSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSBedInformationDialog::OnDoctorSelendok(){
	 
}
/*void CHMSBedInformationDialog::OnDoctorSetfocus(){
	
}*/
/*void CHMSBedInformationDialog::OnDoctorKillfocus(){
	
}*/
long CHMSBedInformationDialog::OnDoctorLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CHMSBedInformationDialog::OnDoctorAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSBedInformationDialog::OnNurseSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSBedInformationDialog::OnNurseSelendok(){
	 
}
/*void CHMSBedInformationDialog::OnNurseSetfocus(){
	
}*/
/*void CHMSBedInformationDialog::OnNurseKillfocus(){
	
}*/
long CHMSBedInformationDialog::OnNurseLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szFilter;
...
/*void CHMSBedInformationDialog::OnNurseAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxsGetMainWnd();
	
} */
/*void CHMSBedInformationDialog::OnServicePriceChange(){
	
} */
/*void CHMSBedInformationDialog::OnServicePriceSetfocus(){
	
} */
/*void CHMSBedInformationDialog::OnServicePriceKillfocus(){
	
} */
int CHMSBedInformationDialog::OnServicePriceCheckValue(){
	return 0;
} 
/*void CHMSBedInformationDialog::OnInsurancePriceChange(){
	
} */
/*void CHMSBedInformationDialog::OnInsurancePriceSetfocus(){
	
} */
/*void CHMSBedInformationDialog::OnInsurancePriceKillfocus(){
	
} */
int CHMSBedInformationDialog::OnInsurancePriceCheckValue(){
	return 0;
} 
/*void CHMSBedInformationDialog::OnPolicyPriceChange(){
	
} */
/*void CHMSBedInformationDialog::OnPolicyPriceSetfocus(){
	
} */
/*void CHMSBedInformationDialog::OnPolicyPriceKillfocus(){
	
} */
int CHMSBedInformationDialog::OnPolicyPriceCheckValue(){
	return 0;
} 
/*void CHMSBedInformationDialog::OnRequestPriceChange(){
	
} */
/*void CHMSBedInformationDialog::OnRequestPriceSetfocus(){
	
} */
/*void CHMSBedInformationDialog::OnRequestPriceKillfocus(){
	
} */
int CHMSBedInformationDialog::OnRequestPriceCheckValue(){
	return 0;
}

void CHMSBedInformationDialog::OnBedDiagramSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSBedInformationDialog::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnAddHMSBedInformationDialog();	
} 
void CHMSBedInformationDialog::OnTerminateSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData();
	if (m_szPriceBedKey.IsEmpty() && (m_szDynPrice != _T("Y")))
	{
	...
	OnEditHMSBedInformationDialog();
} 
 
void CHMSBedInformationDialog::OnSaveSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if (OnSaveHMSBedInformationDialog())
	{
		CGuiDialog::OnOK();
	}
	
} 
void CHMSBedInformationDialog::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
int CHMSBedInformationDialog::OnAddHMSBedInformationDialog(){
	...
	if(!pMF->IsActiveDocument())
		return -1;
	if(pMF->m_szOutpatient == _T("Y") && pMF->m_UserInfo.su_groupid != _T("A"))
	{
		SetMode(VM_ADD);
	...
	if(!rs.IsEOF())
	{
		ShowMessageBox(_T("Có giường đang ở trạng thái O (đang mở), không thể tạo mới được!"), MB_OK);
		return -1;
	}
 	SetMode(VM_ADD);
	return 0; 
}
int CHMSBedInformationDialog::OnEditHMSBedInformationDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
...
int CHMSBedInformationDialog::OnSaveHMSBedInformationDialog(){
	...
	{ 
 		//Check bệnh án A17, nếu là bệnh án ban ngày mà thời gian sử dụng dịch vụ >=24h thì return luôn //
		//_msg(_T("%s"), m_szAdmitDate);
		//_msg(_T("%s"), m_szOutDate);
		
		szSQL.Format(_T("HMS_CHECK_TERMINATE_BED_TIME(%ld, '%s', %d, '%s', '%s')"), 
			pMF->m_nDocumentNo, pMF->m_szDept, pMF->m_nRefIndex, m_szAdmitDate, m_szOutDate);
			int nRet = str2int(pMF->ExecDML(szSQL));
		//_msg(_T("%s"), szSQL);

		if (nRet >=24)
		{
			ShowMessageBox(_T("Bệnh nhân điều trị ban ngày, thời gian không quá 24h tiếng, lưu ý chọn đúng thời gian!"), MB_ICONERROR);
			m_wndOutDate.SetFocus();
			return -1;
...
int CHMSBedInformationDialog::OnCancelHMSBedInformationDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSBedInformationDialog::OnHMSBedInformationDialogListLoadData(){
	return 0;
}


int	CHMSBedInformationDialog::OnListAddNewBed(){
	OnAddHMSBedInformationDialog();
	return 0;
}
int	CHMSBedInformationDialog::OnListEditBed()
{
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	if(pMF->IsDocumentReadOnly())
	{
...
int CHMSBedInformationDialog::OnDynamicBedInformationView()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CHMSDynamicBedInformation dlg(this);
	if(dlg.DoModal() == IDOK)
	{
...
void CHMSBedInformationDialog::OnResizeLayout()
{
	AddBottom(&m_wndSave);
