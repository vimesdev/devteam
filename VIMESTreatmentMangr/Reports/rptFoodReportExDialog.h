#ifndef rptFoodReportExDialog_H
#define rptFoodReportExDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptFoodReportExDialog : public CGuiDialog{
protected:
public:
	...
	CString m_szWardKey;
	bool	m_bPreview;
	void PrintFoodPatientListReport(CString szFromDate, CString szToDate, CString szDoctor, bool bPreview);
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	void			OnPrintSelect(); 
	void			OnCloseSelect(); 
	rptFoodReportExDialog(CWnd *pParent);
	~rptFoodReportExDialog();
	...
	int OnAddrptFoodReportExDialog(); 
	int OnEditrptFoodReportExDialog(); 
	int OnDeleterptFoodReportExDialog(); 
	int OnSaverptFoodReportExDialog(); 
	int OnCancelrptFoodReportExDialog(); 
	int OnrptFoodReportExDialogListLoadData();
};
#endif
