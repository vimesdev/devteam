#ifndef rptFoodReportDialog_H
#define rptFoodReportDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class rptFoodReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnPrintSelect(); 
	void			OnCloseSelect(); 
	rptFoodReportDialog(CWnd *pParent);
	~rptFoodReportDialog();
	...
	int OnAddrptFoodReportDialog(); 
	int OnEditrptFoodReportDialog(); 
	int OnDeleterptFoodReportDialog(); 
	int OnSaverptFoodReportDialog(); 
	int OnCancelrptFoodReportDialog(); 
	int OnrptFoodReportDialogListLoadData();
};
#endif
