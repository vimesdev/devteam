#ifndef TONGHOPTINHHINHTHANHQUYETTOAN_H
#define TONGHOPTINHHINHTHANHQUYETTOAN_H
...
class rptBaocaothanhquyettoantheotheodoituong : public CGuiDialog{
protected:
public:
	...
	rptBaocaothanhquyettoantheotheodoituong(CWnd *pParent);
	~rptBaocaothanhquyettoantheotheodoituong();
