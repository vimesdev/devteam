#include "rptHoatdongdieutri.h"
#include "ReportDocument.h"
#include "Excel.h"
#include "../MainFrm.h"
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((rptHoatdongdieutri *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptHoatdongdieutri* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((rptHoatdongdieutri *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((rptHoatdongdieutri *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((rptHoatdongdieutri *)pWnd)->OnToDateCheckValue();
} 
static void _OnDoctorSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptHoatdongdieutri* )pWnd)->OnDoctorSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDoctorSelendokFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnDoctorSelendok();
}
/*static void _OnDoctorSetfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnDoctorKillfocus();
}*/
/*static void _OnDoctorKillfocusFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnDoctorKillfocus();
}*/
static long _OnDoctorLoadDataFnc(CWnd *pWnd){
	return ((rptHoatdongdieutri *)pWnd)->OnDoctorLoadData();
}
/*static void _OnDoctorAddNewFnc(CWnd *pWnd){
	((rptHoatdongdieutri *)pWnd)->OnDoctorAddNew();
}*/
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	rptHoatdongdieutri *pVw = (rptHoatdongdieutri *)pWnd;
...
static int _OnAddrptHoatdongdieutriFnc(CWnd *pWnd){
	 return ((rptHoatdongdieutri*)pWnd)->OnAddrptHoatdongdieutri();
} 
static int _OnEditrptHoatdongdieutriFnc(CWnd *pWnd){
	 return ((rptHoatdongdieutri*)pWnd)->OnEditrptHoatdongdieutri();
} 
static int _OnDeleterptHoatdongdieutriFnc(CWnd *pWnd){
	 return ((rptHoatdongdieutri*)pWnd)->OnDeleterptHoatdongdieutri();
} 
static int _OnSaverptHoatdongdieutriFnc(CWnd *pWnd){
	 return ((rptHoatdongdieutri*)pWnd)->OnSaverptHoatdongdieutri();
} 
static int _OnCancelrptHoatdongdieutriFnc(CWnd *pWnd){
	 return ((rptHoatdongdieutri*)pWnd)->OnCancelrptHoatdongdieutri();
} 
rptHoatdongdieutri::rptHoatdongdieutri(CWnd *pParent):
	CGuiDialog(pParent){
...
rptHoatdongdieutri::~rptHoatdongdieutri(){
}
void rptHoatdongdieutri::OnCreateComponents(){
...
void rptHoatdongdieutri::OnInitializeComponents(){
...
void rptHoatdongdieutri::OnSetWindowEvents(){
...
void rptHoatdongdieutri::OnDoDataExchange(CDataExchange* pDX){
...
void rptHoatdongdieutri::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void rptHoatdongdieutri::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void rptHoatdongdieutri::SetDefaultValues(){
...
int rptHoatdongdieutri::SetMode(int nMode){
...
/*void rptHoatdongdieutri::OnYearChange(){
	
} */
/*void rptHoatdongdieutri::OnYearSetfocus(){
	
} */
/*void rptHoatdongdieutri::OnYearKillfocus(){
	
} */
int rptHoatdongdieutri::OnYearCheckValue(){
	return 0;
} 
void rptHoatdongdieutri::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptHoatdongdieutri::OnReportPeriodSelendok(){
	 CString tmpStr;
	CDate dte;
	UpdateData(true);
...
/*void rptHoatdongdieutri::OnReportPeriodSetfocus(){
	
}*/
/*void rptHoatdongdieutri::OnReportPeriodKillfocus(){
	
}*/
long rptHoatdongdieutri::OnReportPeriodLoadData(){
CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void rptHoatdongdieutri::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void rptHoatdongdieutri::OnFromDateChange(){
	
} */
/*void rptHoatdongdieutri::OnFromDateSetfocus(){
	
} */
/*void rptHoatdongdieutri::OnFromDateKillfocus(){
	
} */
int rptHoatdongdieutri::OnFromDateCheckValue(){
	return 0;
} 
/*void rptHoatdongdieutri::OnToDateChange(){
	
} */
/*void rptHoatdongdieutri::OnToDateSetfocus(){
	
} */
/*void rptHoatdongdieutri::OnToDateKillfocus(){
	
} */
int rptHoatdongdieutri::OnToDateCheckValue(){
	return 0;
} 
void rptHoatdongdieutri::OnDoctorSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptHoatdongdieutri::OnDoctorSelendok(){
	 
}
/*void rptHoatdongdieutri::OnDoctorSetfocus(){
	
}*/
/*void rptHoatdongdieutri::OnDoctorKillfocus(){
	
}*/
long rptHoatdongdieutri::OnDoctorLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void rptHoatdongdieutri::OnDoctorAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void rptHoatdongdieutri::OnPrintPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_bPreview = true;
...
void rptHoatdongdieutri::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_bPreview = false;
...
void rptHoatdongdieutri::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
int rptHoatdongdieutri::OnAddrptHoatdongdieutri(){
...
int rptHoatdongdieutri::OnEditrptHoatdongdieutri(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int rptHoatdongdieutri::OnDeleterptHoatdongdieutri(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelrptHoatdongdieutri(); 
 	}
	return 0;
}
int rptHoatdongdieutri::OnSaverptHoatdongdieutri(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnrptHoatdongdieutriListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int rptHoatdongdieutri::OnCancelrptHoatdongdieutri(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int rptHoatdongdieutri::OnrptHoatdongdieutriListLoadData(){
	return 0;
}
void rptHoatdongdieutri::PrintHoatdongdieutri(CString szFromDate, CString szToDate, CString szDoctor, bool bPreview){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void rptHoatdongdieutri::ExportHoatdongdieutri(CString szFromDate, CString szToDate, CString szDoctor)
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr, tmpStr1, szFromDateLabel, szToDateLabel, szWhere,szAmount, szOutpatient, m_szStatus;
