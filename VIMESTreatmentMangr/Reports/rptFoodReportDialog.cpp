#include "rptFoodReportDialog.h"
#include "ReportDocument.h"
#include "Excel.h"
#include "../MainFrm.h"

/*static void _OnYearChangeFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((rptFoodReportDialog *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptFoodReportDialog* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((rptFoodReportDialog *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((rptFoodReportDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((rptFoodReportDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnDoctorSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptFoodReportDialog* )pWnd)->OnDoctorSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDoctorSelendokFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnDoctorSelendok();
}
/*static void _OnDoctorSetfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnDoctorKillfocus();
}*/
/*static void _OnDoctorKillfocusFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnDoctorKillfocus();
}*/
static long _OnDoctorLoadDataFnc(CWnd *pWnd){
	return ((rptFoodReportDialog *)pWnd)->OnDoctorLoadData();
}
/*static void _OnDoctorAddNewFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnDoctorAddNew();
}*/

static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptFoodReportDialog* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnDeptSelendok();
}
...
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((rptFoodReportDialog *)pWnd)->OnDeptLoadData();
}
/*static void _OnDoctorAddNewFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnDoctorAddNew();
}*/
...
static void _OnWardSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((rptFoodReportDialog* )pWnd)->OnWardSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnWardSelendokFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnWardSelendok();
}
...
static long _OnWardLoadDataFnc(CWnd *pWnd){
	return ((rptFoodReportDialog *)pWnd)->OnWardLoadData();
}
/*static void _OnDoctorAddNewFnc(CWnd *pWnd){
	((rptFoodReportDialog *)pWnd)->OnDoctorAddNew();
}*/
...
static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	rptFoodReportDialog *pVw = (rptFoodReportDialog *)pWnd;
...
static int _OnAddrptFoodReportDialogFnc(CWnd *pWnd){
	 return ((rptFoodReportDialog*)pWnd)->OnAddrptFoodReportDialog();
} 
static int _OnEditrptFoodReportDialogFnc(CWnd *pWnd){
	 return ((rptFoodReportDialog*)pWnd)->OnEditrptFoodReportDialog();
} 
static int _OnDeleterptFoodReportDialogFnc(CWnd *pWnd){
	 return ((rptFoodReportDialog*)pWnd)->OnDeleterptFoodReportDialog();
} 
static int _OnSaverptFoodReportDialogFnc(CWnd *pWnd){
	 return ((rptFoodReportDialog*)pWnd)->OnSaverptFoodReportDialog();
} 
static int _OnCancelrptFoodReportDialogFnc(CWnd *pWnd){
	 return ((rptFoodReportDialog*)pWnd)->OnCancelrptFoodReportDialog();
} 
rptFoodReportDialog::rptFoodReportDialog(CWnd *pParent):
	CGuiDialog(pParent){
...
rptFoodReportDialog::~rptFoodReportDialog(){
}
void rptFoodReportDialog::OnCreateComponents(){
...
void rptFoodReportDialog::OnInitializeComponents(){
...
void rptFoodReportDialog::OnSetWindowEvents(){
...
void rptFoodReportDialog::OnDoDataExchange(CDataExchange* pDX){
...
void rptFoodReportDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void rptFoodReportDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void rptFoodReportDialog::SetDefaultValues(){
...
int rptFoodReportDialog::SetMode(int nMode){
...
/*void rptFoodReportDialog::OnYearChange(){
	
} */
/*void rptFoodReportDialog::OnYearSetfocus(){
	
} */
/*void rptFoodReportDialog::OnYearKillfocus(){
	
} */
int rptFoodReportDialog::OnYearCheckValue(){
	return 0;
} 
void rptFoodReportDialog::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptFoodReportDialog::OnReportPeriodSelendok(){
	 CString tmpStr;
	CDate dte;
	UpdateData(true);
...
/*void rptFoodReportDialog::OnReportPeriodSetfocus(){
	
}*/
/*void rptFoodReportDialog::OnReportPeriodKillfocus(){
	
}*/
long rptFoodReportDialog::OnReportPeriodLoadData(){
CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void rptFoodReportDialog::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void rptFoodReportDialog::OnFromDateChange(){
	
} */
/*void rptFoodReportDialog::OnFromDateSetfocus(){
	
} */
/*void rptFoodReportDialog::OnFromDateKillfocus(){
	
} */
int rptFoodReportDialog::OnFromDateCheckValue(){
	return 0;
} 
/*void rptFoodReportDialog::OnToDateChange(){
	
} */
/*void rptFoodReportDialog::OnToDateSetfocus(){
	
} */
/*void rptFoodReportDialog::OnToDateKillfocus(){
	
} */
int rptFoodReportDialog::OnToDateCheckValue(){
	return 0;
} 
void rptFoodReportDialog::OnDoctorSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptFoodReportDialog::OnDoctorSelendok(){
	 
}
/*void rptFoodReportDialog::OnDoctorSetfocus(){
	
}*/
/*void rptFoodReportDialog::OnDoctorKillfocus(){
	
}*/
long rptFoodReportDialog::OnDoctorLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
...
/*void rptFoodReportDialog::OnDoctorAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

void rptFoodReportDialog::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 

void rptFoodReportDialog::OnDeptSelendok(){
	 
}
/*void rptFoodReportDialog::OnDeptSetfocus(){
	
}*/
/*void rptFoodReportDialog::OnDeptKillfocus(){
	
}*/
long rptFoodReportDialog::OnDeptLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
...
/*void rptFoodReportDialog::OnDeptAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */


void rptFoodReportDialog::OnWardSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void rptFoodReportDialog::OnWardSelendok(){
	 
}
/*void rptFoodReportDialog::OnWardSetfocus(){
	
}*/
/*void rptFoodReportDialog::OnWardKillfocus(){
	
}*/
long rptFoodReportDialog::OnWardLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void rptFoodReportDialog::OnWardAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */

void rptFoodReportDialog::OnPrintPreviewSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_bPreview = true;
...
void rptFoodReportDialog::OnPrintSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	m_bPreview = false;
...
void rptFoodReportDialog::OnCloseSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
int rptFoodReportDialog::OnAddrptFoodReportDialog(){
...
int rptFoodReportDialog::OnEditrptFoodReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int rptFoodReportDialog::OnDeleterptFoodReportDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelrptFoodReportDialog(); 
 	}
	return 0;
}
int rptFoodReportDialog::OnSaverptFoodReportDialog()
{
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnrptFoodReportDialogListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int rptFoodReportDialog::OnCancelrptFoodReportDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int rptFoodReportDialog::OnrptFoodReportDialogListLoadData(){
	return 0;
}
void rptFoodReportDialog::PrintFoodPatientListReport(CString szFromDate, CString szToDate, CString szDoctor, bool bPreview)
{
	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd() ;
	CRecord rs(&pMF->m_db);
	...
	rs.ExecSQL(szSQL);
	if(!rpt.Init(_T("Reports/HMS/TM_DANHSACHBENHNHANDUOCHOTROTIENAN.RPT"))) return ;
	//Report Header
