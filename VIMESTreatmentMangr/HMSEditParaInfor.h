#ifndef HMSEDITPARAINFOR_H
#define HMSEDITPARAINFOR_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSEditParaInfor : public CGuiDialog
{
protected:
public:
	...
	CHMSEditParaInfor(CWnd *pParent);
	~CHMSEditParaInfor();
	...
	int OnAddEditParaInfor(); 
	int OnEditEditParaInfor(); 
	int OnDeleteEditParaInfor(); 
	int OnSaveEditParaInfor(); 
	int OnCancelEditParaInfor(); 
	int OnEditParaInforListLoadData(); 
};
#endif