#include "HMSSurgeryMatAddPopup.h"
#include "HMSOperationScheduleDetail.h"
#include "HMSMainFrame.h"

static void _OnItemNameSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSurgeryMatAddPopup* )pWnd)->OnItemNameSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemNameSelendokFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnItemNameSelendok();
}
/*static void _OnItemNameSetfocusFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnItemNameKillfocus();
}*/
/*static void _OnItemNameKillfocusFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnItemNameKillfocus();
}*/
static long _OnItemNameLoadDataFnc(CWnd *pWnd){
	return ((CHMSSurgeryMatAddPopup *)pWnd)->OnItemNameLoadData();
}
/*static void _OnItemNameAddNewFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnItemNameAddNew();
}*/
/*static void _OnQuantityChangeFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnQuantityChange();
} */
/*static void _OnQuantitySetfocusFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnQuantitySetfocus();} */ 
/*static void _OnQuantityKillfocusFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnQuantityKillfocus();
} */
static int _OnQuantityCheckValueFnc(CWnd *pWnd){
	return ((CHMSSurgeryMatAddPopup *)pWnd)->OnQuantityCheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSSurgeryMatAddPopup *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSSurgeryMatAddPopup *)pWnd)->OnNoteCheckValue();
} 
static void _OnSaveSelectFnc(CWnd *pWnd){
	CHMSSurgeryMatAddPopup *pVw = (CHMSSurgeryMatAddPopup *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddHMSSurgeryMatAddPopupFnc(CWnd *pWnd){
	 return ((CHMSSurgeryMatAddPopup*)pWnd)->OnAddHMSSurgeryMatAddPopup();
} 
static int _OnEditHMSSurgeryMatAddPopupFnc(CWnd *pWnd){
	 return ((CHMSSurgeryMatAddPopup*)pWnd)->OnEditHMSSurgeryMatAddPopup();
} 
static int _OnDeleteHMSSurgeryMatAddPopupFnc(CWnd *pWnd){
	 return ((CHMSSurgeryMatAddPopup*)pWnd)->OnDeleteHMSSurgeryMatAddPopup();
} 
static int _OnSaveHMSSurgeryMatAddPopupFnc(CWnd *pWnd){
	 return ((CHMSSurgeryMatAddPopup*)pWnd)->OnSaveHMSSurgeryMatAddPopup();
} 
static int _OnCancelHMSSurgeryMatAddPopupFnc(CWnd *pWnd){
	 return ((CHMSSurgeryMatAddPopup*)pWnd)->OnCancelHMSSurgeryMatAddPopup();
} 
CHMSSurgeryMatAddPopup::CHMSSurgeryMatAddPopup()
{
	m_nDlgWidth = 555;
	m_nDlgHeight = 100;
	SetDefaultValues();
...
CHMSSurgeryMatAddPopup::CHMSSurgeryMatAddPopup(CWnd *pParent, int nMode): CGuiPopup(pParent)
{
	m_nDlgWidth = 555;
	m_nDlgHeight = 100;
	SetDefaultValues();
...
void CHMSSurgeryMatAddPopup::OnCreateComponents()
{
...
void CHMSSurgeryMatAddPopup::OnInitializeComponents()
{
	...
	m_wndItemName.SetSearchStyle(SS_COMPARE);
...
void CHMSSurgeryMatAddPopup::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	/*AddEvent(1, _T("Add	Ctrl+A"), _OnAddHMSSurgeryMatAddPopupFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditHMSSurgeryMatAddPopupFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteHMSSurgeryMatAddPopupFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveHMSSurgeryMatAddPopupFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelHMSSurgeryMatAddPopupFnc, 0, 'T', VK_CONTROL);*/
	SetMode(VM_ADD);

}
void CHMSSurgeryMatAddPopup::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndItemName.GetDlgCtrlID(), m_szItemNameKey);
	DDX_Text(pDX, m_wndQuantity.GetDlgCtrlID(), m_nQuantity);
	DDX_Text(pDX, m_wndNote.GetDlgCtrlID(), m_szNote);

}
void CHMSSurgeryMatAddPopup::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSSurgeryMatAddPopup::GetScreenToData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CHMSSurgeryMatAddPopup::SetDefaultValues(){
...
int CHMSSurgeryMatAddPopup::SetMode(int nMode)
{
...
void CHMSSurgeryMatAddPopup::OnItemNameSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSurgeryMatAddPopup::OnItemNameSelendok()
{
	 UpdateData(TRUE);
	 ...
	 {
		 m_nUnitPrice = str2double(m_wndItemName.GetCurrent(4));
	 }

	 UpdateData(FALSE);
}
/*void CHMSSurgeryMatAddPopup::OnItemNameSetfocus(){
	
}*/
/*void CHMSSurgeryMatAddPopup::OnItemNameKillfocus(){
	
}*/
long CHMSSurgeryMatAddPopup::OnItemNameLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT product_id,") \
				...
				_T(" WHERE product_isactive='Y' and product_org_id IN('GL','MA') %s") \
...
/*void CHMSSurgeryMatAddPopup::OnItemNameAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSSurgeryMatAddPopup::OnQuantityChange(){
	
} */
/*void CHMSSurgeryMatAddPopup::OnQuantitySetfocus(){
	
} */
/*void CHMSSurgeryMatAddPopup::OnQuantityKillfocus(){
	
} */
int CHMSSurgeryMatAddPopup::OnQuantityCheckValue()
{
	UpdateData(TRUE);
...
/*void CHMSSurgeryMatAddPopup::OnNoteChange(){
	
} */
/*void CHMSSurgeryMatAddPopup::OnNoteSetfocus(){
	
} */
/*void CHMSSurgeryMatAddPopup::OnNoteKillfocus(){
	
} */
int CHMSSurgeryMatAddPopup::OnNoteCheckValue(){
	return 0;
} 
void CHMSSurgeryMatAddPopup::OnSaveSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnSaveHMSSurgeryMatAddPopup();
} 
void CHMSSurgeryMatAddPopup::OnCloseSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	ClosePopup();
} 
int CHMSSurgeryMatAddPopup::OnAddHMSSurgeryMatAddPopup(){
...
int CHMSSurgeryMatAddPopup::OnEditHMSSurgeryMatAddPopup(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSSurgeryMatAddPopup::OnDeleteHMSSurgeryMatAddPopup(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelHMSSurgeryMatAddPopup();
 	}
	return 0;
}
int CHMSSurgeryMatAddPopup::OnSaveHMSSurgeryMatAddPopup()
{
	...
	{
		SetMode(VM_ADDCHILD);
		((CHMSOperationScheduleDetail *)m_wndParent)->OnDrugListLoadData();
		
	}
	return nRet; 
}
int CHMSSurgeryMatAddPopup::OnCancelHMSSurgeryMatAddPopup(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSSurgeryMatAddPopup::OnHMSSurgeryMatAddPopupListLoadData(){
	return 0;
}

void CHMSSurgeryMatAddPopup::ShowPopup(CWnd *pWndRef, int nShow)
{
	CGuiPopup::ShowPopup(pWndRef, nShow);
} 
void CHMSSurgeryMatAddPopup::ClosePopup()
{
