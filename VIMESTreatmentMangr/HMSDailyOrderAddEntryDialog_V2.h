#ifndef HMSDailyOrderAddEntryDialog_V2_H
#define HMSDailyOrderAddEntryDialog_V2_H
...
#define MAX_DAYSORDER 45

class CHMSDailyOrderAddEntryDialog_V2 : public CGuiDialog{
protected:
	bool	m_bAddOrder;
	long	m_nID[MAX_DAYSORDER];
	long	m_nPatientNo;
	long	m_nDocumentNo;
	CString	m_szDept;
	int		m_nRoomID;
...
public:
	...
	CHMSDailyOrderAddEntryDialog_V2(CWnd *pParent, int nMode, int nType=0);
	~CHMSDailyOrderAddEntryDialog_V2();
