#ifndef HMSADDITIONALCARDDIALOG_H
#define HMSADDITIONALCARDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSAdditionalCardDialog : public CGuiDialog{
protected:
public:
	...
	CHMSAdditionalCardDialog(CWnd *pParent);
	~CHMSAdditionalCardDialog();
	...
	int OnAddHMSAdditionalCardDialog(); 
	int OnEditHMSAdditionalCardDialog(); 
	int OnDeleteHMSAdditionalCardDialog(); 
	int OnSaveHMSAdditionalCardDialog(); 
	int OnCancelHMSAdditionalCardDialog(); 
	int OnHMSAdditionalCardDialogListLoadData(); 
};
#endif
