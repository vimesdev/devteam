#include "HMSDailyDrugOrderView.h"
#include "MainFrm.h"
...
static long _OnOrderListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView*)pWnd)->OnOrderListLoadData();
} 
static void _OnOrderListDblClickFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView*)pWnd)->OnOrderListDblClick();
} 
static void _OnOrderListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyDrugOrderView*)pWnd)->OnOrderListSelectChange(nOldItem, nNewItem);
} 
static int _OnPreviewOrderDeviveryDetailFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView*)pWnd)->OnPreviewDeliveryDetail();
}
static int _OnOrderListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnOrderListDeleteItem();
} 

static int _OnOrderListPrintDeliveryDrugFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnOrderListPrintDeliveryDrug();
}
static int	_OnExportOrderDeliveryDrugFnc(CWnd *pWnd){
	return	((CHMSDailyDrugOrderView*)pWnd)->OnExportOrderDeliveryDrug();
}
static int _OnOrderListPrintSheetDateFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnOrderListPrintSheetDate();
}
static int _OnOrderListPrintSheetpublicityFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnOrderListPrintSheetPublicity();
}

static long _OnPatientListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView*)pWnd)->OnPatientListLoadData();
} 
static void _OnPatientListDblClickFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView*)pWnd)->OnPatientListDblClick();
} 
static void _OnPatientListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyDrugOrderView*)pWnd)->OnPatientListSelectChange(nOldItem, nNewItem);
} 

static int _OnPatientListIssueAllFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnPatientListIssueAll();
} 

static int _OnPatientListIssueFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnPatientListIssue();
} 

static int _OnPatientListRollbackFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnPatientListRollback();
} 

static int _OnPatientListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnPatientListDeleteItem();
} 
static long _OnDrugListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView*)pWnd)->OnDrugListLoadData();
} 
static void _OnDrugListDblClickFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView*)pWnd)->OnDrugListDblClick();
} 
static void _OnDrugListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyDrugOrderView*)pWnd)->OnDrugListSelectChange(nOldItem, nNewItem);
} 
static int _OnDrugListAddEntryFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnDrugListAddEntry();
} 

static int _OnDrugListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnDrugListDeleteItem();
} 
static int _OnDrugListReturnFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnDrugListReturnDrug();
} 

/*static void _OnOrderNoChangeFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnOrderNoChange();
} */
/*static void _OnOrderNoSetfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnOrderNoSetfocus();} */ 
/*static void _OnOrderNoKillfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnOrderNoKillfocus();
} */

static int _OnOrderNoCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView *)pWnd)->OnOrderNoCheckValue();
} 

/*static void _OnPatientNameSearchChangeFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnPatientNameSearchChange();
} */
/*static void _OnPatientNameSearchSetfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnPatientNameSearchSetfocus();} */ 
/*static void _OnPatientNameSearchKillfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnPatientNameSearchKillfocus();
} */

static int _OnPatientNameSearchCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView *)pWnd)->OnPatientNameSearchCheckValue();
}
static void _OnFindSelectFnc(CWnd *pWnd){
	CHMSDailyDrugOrderView *pVw = (CHMSDailyDrugOrderView *)pWnd;
	pVw->OnFindSelect();
} 
/*static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnOrderDateChange();
} */
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView *)pWnd)->OnOrderDateCheckValue();
} 
/*static void _OnIssueDateChangeFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnIssueDateChange();
} */
/*static void _OnIssueDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnIssueDateSetfocus();} */ 
/*static void _OnIssueDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnIssueDateKillfocus();
} */
static int _OnIssueDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView *)pWnd)->OnIssueDateCheckValue();
} 
/*static void _OnStatusChangeFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnStatusChange();
} */
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnStatusSetfocus();} */ 
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnStatusKillfocus();
} */
static int _OnStatusCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView *)pWnd)->OnStatusCheckValue();
} 
/*static void _OnPrintedChangeFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnPrintedChange();
} */
/*static void _OnPrintedSetfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnPrintedSetfocus();} */ 
/*static void _OnPrintedKillfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnPrintedKillfocus();
} */
static int _OnPrintedCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView *)pWnd)->OnPrintedCheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSDailyDrugOrderView *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyDrugOrderView *)pWnd)->OnNoteCheckValue();
} 
...
static int _OnAddHMSDailyDrugOrderViewFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnAddHMSDailyDrugOrderView();
} 
static int _OnEditHMSDailyDrugOrderViewFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnEditHMSDailyDrugOrderView();
} 
static int _OnDeleteHMSDailyDrugOrderViewFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnDeleteHMSDailyDrugOrderView();
} 
static int _OnSaveHMSDailyDrugOrderViewFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnSaveHMSDailyDrugOrderView();
} 
static int _OnCancelHMSDailyDrugOrderViewFnc(CWnd *pWnd){
	 return ((CHMSDailyDrugOrderView*)pWnd)->OnCancelHMSDailyDrugOrderView();
} 
//CHMSDailyDrugOrderView::CHMSDailyDrugOrderView(CWnd *pParent)
CHMSDailyDrugOrderView::CHMSDailyDrugOrderView()
{
//	CGuiDialog(pParent){
...
void CHMSDailyDrugOrderView::OnCreateComponents(){
	m_wndOrderInformation.Create(this, _T("Order Information"), 5, 5, 410, 585);
	m_wndPatientInformation.Create(this, _T("Patient Information"), 415, 5, 1005, 165);
	m_wndDrugInformation.Create(this, _T("Drug Informations"), 415, 205, 1005, 585);
	m_wndOrderList.Create(this,10, 150, 405, 580); 
	m_wndPatientList.Create(this,420, 30, 1000, 160); 
	m_wndDrugList.Create(this,420, 235, 1000, 580); 
	m_wndPatientCountLabel.Create(this, _T("Patient Count"), 415, 175, 520, 200);
	m_wndPatientCount.Create(this,525, 175, 570, 200);
	m_wndPatientNameSearchLabel.Create(this, _T("Patient Name"), 755, 175, 855, 200);
	m_wndPatientNameSearch.Create(this, 860, 175, 1005, 200);
...
void CHMSDailyDrugOrderView::OnInitializeComponents(){
...
//	m_wndOrderNo.ModifyStyle(0, ES_NUMBER);
	...
	m_wndPatientList.InsertColumn(5, _T("Status"), CFMT_TEXT|CFMT_CENTER, 80);
	...
	m_wndDrugList.InsertColumn(10, _T("Storage"), CFMT_TEXT|CFMT_CENTER, 60);
	m_wndDrugList.InsertColumn(11, _T("Created By"), CFMT_TEXT|CFMT_CENTER, 90);
...
void CHMSDailyDrugOrderView::OnSetWindowEvents(){
	...
	m_wndPatientList.AddEvent(2, _T("Delete Patient"), _OnPatientListDeleteItemFnc);
/*
...
//	m_wndDrugList.AddEvent(3, _T("Return Drug"), _OnDrugListReturnFnc);
	...
	//m_wndPatientNameSearch.SetEvent(WE_CHANGE, _OnPatientNameSearchChangeFnc);
	//m_wndPatientNameSearch.SetEvent(WE_SETFOCUS, _OnPatientNameSearchSetfocusFnc);
	//m_wndPatientNameSearch.SetEvent(WE_KILLFOCUS, _OnPatientNameSearchKillfocusFnc);
	m_wndPatientNameSearch.SetEvent(WE_CHECKVALUE, _OnPatientNameSearchCheckValueFnc);
...
void CHMSDailyDrugOrderView::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_Text(pDX, m_wndPatientNameSearch.GetDlgCtrlID(), m_szPaitentNameSearch);
	DDX_Text(pDX, m_wndPatientCount.GetDlgCtrlID(), m_nPatientCount);
}
void CHMSDailyDrugOrderView::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	szSQL.Format(_T("SELECT  ") \
		...
		_T("WHERE mtb_ordertype ='T' and mtb_transaction_batch_id=%ld and mtb_department_to_id='%s' "), 
...
void CHMSDailyDrugOrderView::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szWhere;
...
void CHMSDailyDrugOrderView::SetDefaultValues(){
...
int CHMSDailyDrugOrderView::SetMode(int nMode){
		...
		m_wndPatientNameSearch.EnableWindow(true);
 		UpdateData(FALSE); 
 		return nOldMode; 
}
void CHMSDailyDrugOrderView::OnOrderListDblClick(){
	OnPreviewDeliveryDetail();
} 
void CHMSDailyDrugOrderView::OnOrderListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 
int CHMSDailyDrugOrderView::OnOrderListDeleteItem(){
	return 0;
}
int CHMSDailyDrugOrderView::OnPreviewDeliveryDetail(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
long CHMSDailyDrugOrderView::OnOrderListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyDrugOrderView::OnPatientListDblClick(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnPatientListIssueAll();
} 
void CHMSDailyDrugOrderView::OnPatientListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	m_szOrderStatus = m_wndPatientList.GetItemText(nNewItem, 5);
	OnDrugListLoadData();
} 

int CHMSDailyDrugOrderView::OnPatientListIssueAll(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();	
...
int CHMSDailyDrugOrderView::OnPatientListIssue(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
int CHMSDailyDrugOrderView::OnPatientListRollback(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	if(m_szStatus != _T("A"))
		return -1;
...
int CHMSDailyDrugOrderView::OnPatientListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
	...
	if(nSel < 0) return -1;
	nReforderid = ToLong(m_wndPatientList.GetItemText(nSel, 6));
	nOrderid = ToLong(m_wndPatientList.GetItemText(nSel, 0));
	szDate = m_wndPatientList.GetItemText(nSel, 4);
...
long CHMSDailyDrugOrderView::OnPatientListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
//_msg(_T("%s"), szSQL);
	...
	if(!m_szPaitentNameSearch.IsEmpty())
	{
		StringLower(m_szPaitentNameSearch, szSearchName);
	...
	while(!rs.IsEOF()){
		...
		if(!m_szPaitentNameSearch.IsEmpty()){
				...
				if(szShortName != m_szPaitentNameSearch)
				{
...
void CHMSDailyDrugOrderView::OnDrugListDblClick(){
	
} 
void CHMSDailyDrugOrderView::OnDrugListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 

int CHMSDailyDrugOrderView::OnDrugListAddEntry(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
		return 0;
	m_szPaitentNameSearch.Empty();
	UpdateData(false);
	CHMSPatientDrugOrderEntry* newPopup = new CHMSPatientDrugOrderEntry(this, VM_ADD);
...
int CHMSDailyDrugOrderView::OnDrugListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
	long nProductID;
	long nOrderID;
...
int CHMSDailyDrugOrderView::OnDrugListReturnDrug(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
long CHMSDailyDrugOrderView::OnDrugListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT hpol_orderid, ") \
				...
				_T(" WHERE hpo_docno=%ld and hpol_batch_id=%ld  and trunc_date(hpo_orderdate)=cast_string2date('%s') and hpol_line > 0 and hpo_orderstatus='%s' ") \
				_T(" GROUP BY hpol_orderid, hpo_orderstatus, hpo_transaction_id, hpo_storage_id, hpo_createdby, hpol_line, product_id, product_name, product_uomname, hpol_unitprice, product_countryname ") \
				_T(" ORDER BY hpol_orderid, hpol_line, product_name, product_uomname ") , 
				m_nDocumentNo,  m_nOID, m_szPatientOrderDate,m_szOrderStatus);
_fmsg(_T("%s"), szSQL);
	nCount = rs.ExecSQL(szSQL);
	int nItem = 0;
...
/*void CHMSDailyDrugOrderView::OnOrderNoChange(){
	
} */
/*void CHMSDailyDrugOrderView::OnOrderNoSetfocus(){
	
} */
/*void CHMSDailyDrugOrderView::OnOrderNoKillfocus(){
	
} */
int CHMSDailyDrugOrderView::OnOrderNoCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
/*void CHMSDailyDrugOrderView::OnPatientNameSearchChange(){
	
} */
/*void CHMSDailyDrugOrderView::OnPatientNameSearchSetfocus(){
	
} */
/*void CHMSDailyDrugOrderView::OnPatientNameSearchKillfocus(){
	
} */
int CHMSDailyDrugOrderView::OnPatientNameSearchCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnPatientListLoadData();
	return 0;
}
void CHMSDailyDrugOrderView::OnFindSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CHMSDailyDrugOrderView::OnOrderDateChange(){
	
} */
/*void CHMSDailyDrugOrderView::OnOrderDateSetfocus(){
	
} */
/*void CHMSDailyDrugOrderView::OnOrderDateKillfocus(){
	
} */
int CHMSDailyDrugOrderView::OnOrderDateCheckValue(){
	UpdateData(true);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CHMSDailyDrugOrderView::OnIssueDateChange(){
	
} */
/*void CHMSDailyDrugOrderView::OnIssueDateSetfocus(){
	
} */
/*void CHMSDailyDrugOrderView::OnIssueDateKillfocus(){
	
} */
int CHMSDailyDrugOrderView::OnIssueDateCheckValue(){
	return 0;
} 

/*void CHMSDailyDrugOrderView::OnStatusChange(){
	
} */
/*void CHMSDailyDrugOrderView::OnStatusSetfocus(){
	
} */
/*void CHMSDailyDrugOrderView::OnStatusKillfocus(){
	
} */
int CHMSDailyDrugOrderView::OnStatusCheckValue(){
	return 0;
} 
/*void CHMSDailyDrugOrderView::OnPrintedChange(){
	
} */
/*void CHMSDailyDrugOrderView::OnPrintedSetfocus(){
	
} */
/*void CHMSDailyDrugOrderView::OnPrintedKillfocus(){
	
} */
int CHMSDailyDrugOrderView::OnPrintedCheckValue(){
	return 0;
} 
/*void CHMSDailyDrugOrderView::OnNoteChange(){
	
} */
/*void CHMSDailyDrugOrderView::OnNoteSetfocus(){
	
} */
/*void CHMSDailyDrugOrderView::OnNoteKillfocus(){
	
} */
int CHMSDailyDrugOrderView::OnNoteCheckValue(){
	return 0;
} 
void CHMSDailyDrugOrderView::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnAddHMSDailyDrugOrderView();
	
} 
void CHMSDailyDrugOrderView::OnEditSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnEditHMSDailyDrugOrderView();
} 
void CHMSDailyDrugOrderView::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteHMSDailyDrugOrderView();
} 
void CHMSDailyDrugOrderView::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveHMSDailyDrugOrderView();
} 
void CHMSDailyDrugOrderView::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancelHMSDailyDrugOrderView();
} 
void CHMSDailyDrugOrderView::OnSendSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr;
...
void CHMSDailyDrugOrderView::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
//	pMF->PrintDrugOrder(m_nOID);
	...
	szSQL.Format(_T("SELECT hc_pharma_newapprovemethod FROM hms_config"));
	rs.ExecSQL(szSQL);
	...
	for(int i =0; i < m_transaction_orders.GetCount(); i++)
	{
		...
		szSQL.Format(_T("SELECT mt_status, mt_isprinted FROM m_transaction ") \
...
int CHMSDailyDrugOrderView::OnOrderListPrintSheetPublicity(){
	CHMSDailyOrderDate dlg(this);
	dlg.m_nType =1;
	dlg.DoModal();
	return 0;	
}
int CHMSDailyDrugOrderView::OnOrderListPrintSheetDate(){
	CHMSDailyOrderDate dlg(this);
	dlg.m_nType = 2;
	dlg.DoModal();
...
int CHMSDailyDrugOrderView::OnAddHMSDailyDrugOrderView(){
...
int CHMSDailyDrugOrderView::OnEditHMSDailyDrugOrderView(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
...
int CHMSDailyDrugOrderView::OnDeleteHMSDailyDrugOrderView(){
...
int CHMSDailyDrugOrderView::OnSaveHMSDailyDrugOrderView(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
...
int CHMSDailyDrugOrderView::OnCancelHMSDailyDrugOrderView(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSDailyDrugOrderView::OnHMSDailyDrugOrderViewListLoadData(){
	return 0;
}


void CHMSDailyDrugOrderView::RefreshData(){
	OnOrderListLoadData();
	OnPatientListLoadData();
}

void CHMSDailyDrugOrderView::LoadDrugList(long nID){
...
void CHMSDailyDrugOrderView::OnPrintDelivery(CString szTransactionID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;	
	...
	if(m_szPrintType == _T("P")){
		...
		szSQL.Format(_T(" SELECT DISTINCT hpo_docno as docno, hpo_orderid as orderid, ") \
			...
			_T(" WHERE 	hpo_transaction_id IN(%s) and trunc_date(hpo_orderdate)= CAST_STRING2DATE('%s') ") \
...
void CHMSDailyDrugOrderView::OnExportDelivery_Lanscape(long nOID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CRecord rsl(&pMF->m_db);
	...
	if (nCount>0){
		for (int i = 0;i <= nCount; i++){
			nSubtotal[i]=0;
			xls.SetCellText(nCol+6+i, nRow+5, ors.GetValue(_T("drugname")), true, 10);
			ors.MoveNext();
		}
	}
...
void CHMSDailyDrugOrderView::OnExportDelivery_Portraid(long nOID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyDrugOrderView::OnExportOrderDeliveryDrug(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
int CHMSDailyDrugOrderView::OnOrderListPrintDeliveryDrug()
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSDailyDrugOrderView::OnAddDrugSelect(){
	OnDrugListAddEntry();
}

void CHMSDailyDrugOrderView::OnPrintDeliveryDrugsSelect(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szOrderNo, szOrderDate, tmpStr;
...
void CHMSDailyDrugOrderView::Refresh(long nTransactionID, long nDocumentNo){
...
long CHMSDailyDrugOrderView::GetTransactionID(int nStorageID, CString szObjectType)
{
...
void CHMSDailyDrugOrderView::OnPrintPatientSummeryDrug(int nDocumentNo, CString nRefeorder_ID)
{
...
//_fmsg(_T("%s"), szSQL);
	...
	for(int x = 1; x <= (m_array.GetSize()/31)+1; x++)
	{
		...
		szSQL.Format(_T(" SELECT distinct product_name as drugname,") \
					...
					_T(" 	%s ") \
					_T("    and trunc_date(hpo_orderdate) between CAST_STRING2DATE('%s') and CAST_STRING2DATE('%s')") \
...
CString CHMSDailyDrugOrderView::GetOrderStatus(long nTransactionID)
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
