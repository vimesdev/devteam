...
protected:
	...
	CString	m_szType;
public:
	//Co check xem mau la html hay winform
	bool	m_isHtml;
	CHTMLayoutCtrlEx * m_pHTMLForms;
	...
	CPhanKhamChuyenKhoaInput(CString szForm, long nDocumentNo, int nTreatTime, bool isHtml=false);
