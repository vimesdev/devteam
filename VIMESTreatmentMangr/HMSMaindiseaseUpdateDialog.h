#ifndef HMSMAINDISEASEUPDATEDIALOG_H
#define HMSMAINDISEASEUPDATEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSMainDiseaseUpdateDialog : public CGuiDialog
{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CHMSMainDiseaseUpdateDialog(CWnd *pParent);
	~CHMSMainDiseaseUpdateDialog();
