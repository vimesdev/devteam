...
void CHMSInpatientPrescriptionPopup::OnCreateComponents(){
	...
	m_wndInpatientPrescriptionInput.Create(this, _T(""), 0, 0, 0, 0);
	m_wndInpatientPrescriptionInput.ShowWindow(SW_HIDE);
	m_wndInpatientPrescriptionInput.EnableWindow(FALSE);
	m_wndDrugReplaced.Create(this, _T(""), 0, 0, 0, 0);
	m_wndDrugReplaced.ShowWindow(SW_HIDE);
	m_wndDrugReplaced.EnableWindow(FALSE);
	m_wndPrincipleActive.Create(this, _T(""), 0, 0, 0, 0);
	m_wndPrincipleActive.ShowWindow(SW_HIDE);
	m_wndPrincipleActive.EnableWindow(FALSE);
}
