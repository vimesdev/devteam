#include "HMSPatientFoodOrderEntryEX.h"
#include "MainFrm.h"
...
void CHMSPatientFoodOrderEntryEX::OnSetWindowEvents(){
	...
	MoveWindow(rect.left, rect.bottom-GetHeight()-30, GetWidth(), GetHeight()+30);
}
...
//	m_szOrderDate = m_szCurrentOrderDate.Left(10);
	...
	_fmsg(_T("%s"), szSQL);		
		...
		else
		{
			...
			((CHMSDailyFoodOrder*) m_pWndOrder)->m_wndRationList.DeleteAllItems();
