#ifndef TMTHONGTINHOICHAN_H
#define TMTHONGTINHOICHAN_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CTMThongTinHoiChan : public CGuiDialog{
protected:
	long	m_nDocumentNo;
...
public:
	...
	void			OnPrint3(); 
	void			OnCancelSelect(); 
	CTMThongTinHoiChan(CWnd *pParent, long nDocNo, CString szName, CString szDeptID);
	~CTMThongTinHoiChan();
