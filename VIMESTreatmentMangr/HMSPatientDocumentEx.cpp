...
void CHMSPatientDocumentEx::OnInitializeComponents(){
	...
	m_wndList.InsertColumn(0, _T("Index"), CFMT_NUMBER | CFMT_CENTER, 40);
...
long CHMSPatientDocumentEx::OnListLoadData(){
	...
	szWhere.AppendFormat(_T(" and (HO_DEPTID IN ('C1.1', 'C1.2', 'C1.3', 'AB', 'TYC', 'TTHTSS', 'TTTVDT') OR ho_depttype='E') "));
