...
public:
	...
	CGuiCheckBox	m_wndByTreatTime;

	
	CGuiListCtrl	m_wndDynList;
	...
	long			OnDynListLoadData();
	void			OnDynListSelectChange(int nOldItem, int nNewItem);
	void			OnDynListDblClick();
