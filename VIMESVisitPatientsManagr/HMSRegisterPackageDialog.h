...
public:
	...
	CGuiLabel		m_wndCardNumberExLabel;
	CGuiTextCtrl	m_wndCardNumberEx;
	...
	CGuiLabel		m_wndNoteEXLabel;
	CGuiTextCtrl	m_wndNoteEX;
	...
	int			OnNoteEXCheckValue(); 
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	int			OnCardNumberExCheckValue();
