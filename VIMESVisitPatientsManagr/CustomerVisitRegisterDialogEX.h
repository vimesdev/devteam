#ifndef CUSTOMERVISITREGISTERDIALOGEX_H
#define CUSTOMERVISITREGISTERDIALOGEX_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCustomerVisitRegisterDialogEX : public CGuiDialog
{
protected:
public:
	long	m_nUID;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CCustomerVisitRegisterDialogEX(CWnd *pParent, int nMode);
	~CCustomerVisitRegisterDialogEX();
