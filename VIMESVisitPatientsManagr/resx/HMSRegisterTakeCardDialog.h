#ifndef HMSREGISTERTAKECARDDIALOG_H
#define HMSREGISTERTAKECARDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSRegisterTakeCardDialog : public CGuiDialog{
protected:
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSRegisterTakeCardDialog(CWnd *pParent);
	~CHMSRegisterTakeCardDialog();
	...
	int OnAddHMSRegisterTakeCardDialog(); 
	int OnEditHMSRegisterTakeCardDialog(); 
	int OnDeleteHMSRegisterTakeCardDialog(); 
	int OnSaveHMSRegisterTakeCardDialog(); 
	int OnCancelHMSRegisterTakeCardDialog(); 
	int OnHMSRegisterTakeCardDialogListLoadData(); 
};
#endif
