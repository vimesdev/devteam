...
#include "GuiView.h"
#include "DbField.h"
class CPatientListView : public CGuiView{
protected:
public:
	...
	int OnAddPatientListView(); 
	int OnEditPatientListView(); 
	int OnDeletePatientListView(); 
	int OnSavePatientListView(); 
	int OnCancelPatientListView(); 
	int OnPatientListViewListLoadData(); 
};
#endif
