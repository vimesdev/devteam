...
public:
	...
	CGuiButton		m_wndSOS;
	CGuiRadioButton	m_wndWaitingOption;

	CGridListView	m_wndList;
	CGridListView	m_wndPackageList;
	CString	m_szPatientName;
	CString	m_szPhanloaidtKey;
	CString	m_szPhone;
	...
	int			OnPackageListRegisterItem(); 
	int			OnPackageListEditItem(); 
	int			OnPackageListDeleteItem(); 
	int			OnPackageListTerminateItem(); 
	int			OnPackageListPrintItem(); 
	int			OnPackageListRollbackItem(); 
	int			OnRegisterServicePackage(); 
	int			OnPackageListRevokeItem();
	int			OnPackageListViewHistory();
	int         OnPackageListLostCardConfirm();
	int			OnPackageListPrintReturnItem();
