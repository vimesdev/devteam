#ifndef WeelchairmanagementListView_H
#define WeelchairmanagementListView_H
...
class CWeelchairmanagementListView : public CGuiView
{
...
public:
	...
	CGuiLabel		m_wndWeelChairNoLabel;
	CGuiTextCtrl	m_wndWeelChairNo;
