#ifndef	WEELCHAIRREGISTERDIALOG_H
#define WEELCHAIRREGISTERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CWeelChairRegisterDialog : public CGuiDialog
{
...
public:
	...
	CGuiLabel		m_wndWeelChairTypeLabel;
	CGuiComboBox	m_wndWeelChairType;
	CGuiLabel		m_wndWeelChairLabel;
	CGuiTextCtrl	m_wndWeelChair;
	...
	CString	m_szWeelChairTypeKey;
	CString	m_szWeelChairNo;


	CDbfMap	m_hms_weelchair_manageTbl;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CWeelChairRegisterDialog(CWnd *pParent, int nMode);
	~CWeelChairRegisterDialog();
	...
	long			OnWeelChairTypeLoadData();
	int			OnWeelChairCheckValue();
