#ifndef MedicalCabinetOrderList_H
#define MedicalCabinetOrderList_H
...
class AFX_EXT_CLASS CWardMedicalCabinetOrderList : public CGuiView
{
protected:
public:
	CWnd*			m_wndOrder;
	...
	void			OnHaveLineSelect();

	CWardMedicalCabinetOrderList();
	~CWardMedicalCabinetOrderList();
	...
	int OnAddWardMedicalCabinetOrderList(); 
	int OnEditWardMedicalCabinetOrderList(); 
	int OnDeleteWardMedicalCabinetOrderList(); 
	int OnSaveWardMedicalCabinetOrderList(); 
	int OnCancelWardMedicalCabinetOrderList(); 
	int OnWardMedicalCabinetOrderListListLoadData(); 
