#ifndef CWardPatientMedicalUsageDialog_H
#define CWardPatientMedicalUsageDialog_H
...
class CWardPatientMedicalUsageDialog : public CGuiDialog
{
...
//void			OnFromDateChange(); 
	...
	CWardPatientMedicalUsageDialog(CWnd *pParent);
	~CWardPatientMedicalUsageDialog();
	...
	int OnAddCWardPatientMedicalUsageDialog(); 
	int OnEditCWardPatientMedicalUsageDialog(); 
	int OnDeleteCWardPatientMedicalUsageDialog(); 
	int OnSaveCWardPatientMedicalUsageDialog(); 
	int OnCancelCWardPatientMedicalUsageDialog(); 
	int OnCWardPatientMedicalUsageDialogListLoadData();
