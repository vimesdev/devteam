#ifndef WardMedicalCabinetOrder_H
#define WardMedicalCabinetOrder_H
...
class CWardMedicalCabinetOrder : public CGuiView{
protected:
public:
	CWnd*		m_wndOrder;
	long		m_nID;
	...
	int OnAddWardMedicalCabinetOrder(); 
	int OnEditWardMedicalCabinetOrder(); 
	int OnDeleteWardMedicalCabinetOrder(); 
	int OnSaveWardMedicalCabinetOrder(); 
	int OnDiscardWardMedicalCabinetOrder(); 
	int OnWardMedicalCabinetOrderListLoadData(); 
	int	OnPreviewDeliveryDetail();
	void	OnItemListSearch();
	void	OnExportListOrder();
	CString GetOrderStatus();
	CString GetQueryString_V1();
	bool	IsAllowEdit();
