#ifndef HMSPERFORROOMORDERSETUPDLG_H
#define HMSPERFORROOMORDERSETUPDLG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSPerforRoomOrderSetupDlg : public CGuiDialog{
protected:
public:
	...
	void OnResizeLayout();
	CHMSPerforRoomOrderSetupDlg(CWnd *pParent);
	~CHMSPerforRoomOrderSetupDlg();
	...
	int OnAddHMSPerforRoomOrderSetupDlg(); 
	int OnEditHMSPerforRoomOrderSetupDlg(); 
	int OnDeleteHMSPerforRoomOrderSetupDlg(); 
	int OnSaveHMSPerforRoomOrderSetupDlg(); 
	int OnCancelHMSPerforRoomOrderSetupDlg(); 
	int OnHMSPerforRoomOrderSetupDlgListLoadData(); 
};
#endif
