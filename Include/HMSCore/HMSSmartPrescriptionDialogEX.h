#ifndef HMSPRESCRIPTIONINTELLIGENTEXDIALOG_H
#define HMSPRESCRIPTIONINTELLIGENTEXDIALOG_H
...
class AFX_EXT_CLASS CHMSSmartPrescriptionDialogEX : public CGuiDialog
{
protected:
public:
	int		m_nID;
	...
	void			OnApplySelect(); 
	void			OnCancelSelect(); 
	CHMSSmartPrescriptionDialogEX(CWnd *pParent);
	~CHMSSmartPrescriptionDialogEX();
