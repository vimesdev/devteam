...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSOperationInfoBoardDlg : public CGuiDialog{
protected:
public:
	...
	CGuiLabel		m_wndConsciousTimeLabel;
	CGuiDateTimeCtrl	m_wndConsciousTime;
	...
	//void			OnConsciousTimeChange(); 
	//void			OnConsciousTimeSetfocus(); 
	//void			OnConsciousTimeKillfocus(); 
	int			OnConsciousTimeCheckValue();
