#ifndef HMSCARDINFOVIEW_H
#define HMSCARDINFOVIEW_H
...
class AFX_EXT_CLASS CHMSCardInfoView : public CGuiView{
protected:
public:
	...
	int OnAddHMSCardInfoView(); 
	int OnEditHMSCardInfoView(); 
	int OnDeleteHMSCardInfoView(); 
	int OnSaveHMSCardInfoView(); 
	int OnCancelHMSCardInfoView(); 
	int OnHMSCardInfoViewListLoadData(); 
	void LoadData(JSONVALUE jdata);
};
#endif
