#ifndef HMSSALEORDERDIALOG_H
#define HMSSALEORDERDIALOG_H
...
class CHMSSaleOrderDialog : public CGuiDialog
{
protected:
...
public:
	...
	CGuiLabel		m_wndPatientListLabel;
	CGuiComboBox	m_wndPatientList;
    CGuiLabel m_wndSourceLabel;
    CGuiComboBox m_wndPaymentSource;
    ...
    long OnPaymentSourceLoadData(); 
	void PrintDrugDelivery(long nOrderID, bool bPreview, bool bDirect);
	CHMSSaleOrderDialog(CWnd* pParent, int nMode);
	~CHMSSaleOrderDialog();
	...
	void OnCreateTemplatePrescription();
	void	 OnBankInvoiceInfo2();
    void CreateRefundQROnline2();
};
#endif
