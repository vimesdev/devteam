#ifndef IVFAdditionalInfoView_H
#define IVFAdditionalInfoView_H
...
//Thong tin benh an hiem muon mo rong
class CIVFAdditionalInfoView : public CGuiView{
protected:
	CString			m_szIDIssueDate;
	CString			m_szIDIssuePlace;
public:
	CGuiLabel		m_wndWifeNameLabel;
	CGuiTextCtrl	m_wndWifeName;
	CGuiLabel		m_wndWifeDOBLabel;
	CGuiDateCtrl	m_wndWifeDOB;
	...
	CGuiLabel		m_wndWifeIDNumLabel;
	CGuiTextCtrl	m_wndWifeIDNum;
	CGuiLabel		m_wndWIDIssueDateLabel;
	CGuiDateCtrl	m_wndWIDIssueDate;
	CGuiLabel		m_wndWIDIssuePlaceLabel;
	CGuiTextCtrl	m_wndWIDIssuePlace;
	CGuiLabel		m_wndWifePlaceOfOriginLabel;
	CGuiComboBox	m_wndWifePlaceOfOrigin;
	CGuiLabel		m_wndWifeEmailLabel;
	CGuiTextCtrl	m_wndWifeEmail;
	CGuiLabel		m_wndHusNameLabel;
	CGuiTextCtrl	m_wndHusName;
	CGuiLabel		m_wndHusDOBLabel;
	CGuiDateCtrl	m_wndHusDOB;
	...
	CGuiLabel		m_wndHusbandIDNumLabel;
	CGuiTextCtrl	m_wndHusbandIDNum;
	CGuiLabel		m_wndHIDIssueDateLabel;
	CGuiDateCtrl	m_wndHIDIssueDate;
	CGuiLabel		m_wndHIDIssuePlaceLabel;
	CGuiTextCtrl	m_wndHIDIssuePlace;
	...
	CGuiLabel		m_wndRegisterIDLabel;
	CGuiTextCtrl	m_wndRegisterID;
	CGuiLabel		m_wndRegisterDateLabel;
	CGuiDateCtrl	m_wndRegisterDate;
	CGuiLabel		m_wndRegisterPlaceLabel;
	CGuiTextCtrl	m_wndRegisterPlace;
	CGuiLabel		m_wndHusbandEmailLabel;
	CGuiTextCtrl	m_wndHusbandEmail;
	...
	CString	m_szAddress;
	CString	m_szPhone;
	CString	m_szRegisterID;
	CString	m_szRegisterDate;
	CString	m_szRegisterPlace;
	CString	m_szHusbandIDNum;
	CString	m_szHIDIssueDate;
	CString	m_szHIDIssuePlace;
	CString	m_szWifeIDNum;
	CString	m_szWIDIssueDate;
	CString	m_szWIDIssuePlace;
	CString	m_szWifeEmail;
	CString	m_szHusbandEmail;
	...
	int OnAddIVFAdditionalInfoView(); 
	int OnEditIVFAdditionalInfoView(); 
	int OnDeleteIVFAdditionalInfoView(); 
	int OnSaveIVFAdditionalInfoView(); 
	int OnCancelIVFAdditionalInfoView(); 
	int OnIVFAdditionalInfoViewListLoadData(); 
