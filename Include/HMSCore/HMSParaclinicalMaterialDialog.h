#ifndef HMSPACACLINICALMATERIALDIALOG_H
#define HMSPACACLINICALMATERIALDIALOG_H
...
class AFX_EXT_CLASS CHMSParaclinicalMaterialDialog : public CGuiDialog
{
protected:
	bool	m_bAddOrder;
...
public:
	...
	void			OnPrintSelect(); 
	void			OnAcceptSelect(); 
	CHMSParaclinicalMaterialDialog(CWnd *pParent, int x=0, int y=0);
	~CHMSParaclinicalMaterialDialog();
	...
	int OnAddHMSParaclinicalMaterialDialog(); 
	int OnEditHMSParaclinicalMaterialDialog(); 
	int OnDeleteHMSParaclinicalMaterialDialog(); 
	int OnSaveHMSParaclinicalMaterialDialog(); 
	int OnCancelHMSParaclinicalMaterialDialog(); 
	int OnHMSParaclinicalMaterialDialogListLoadData(); 
	DECLARE_MESSAGE_MAP()
