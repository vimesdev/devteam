...
// CEdgeBrowserDlg dialog
class CEdgeBrowserDlg : public CDialog
{
	// Construction
public:
	CEdgeBrowserDlg(CWnd* pParent = nullptr);	// standard constructor
...
template <class ComponentType, class... Args> void CEdgeBrowserDlg::NewComponent(Args&&... args)
{
	m_components.emplace_back(new ComponentType(std::forward<Args>(args)...));
}

template <class ComponentType> ComponentType* CEdgeBrowserDlg::GetComponent()
{
