#ifndef HMSPHOISINHCONTRONGOIDIALOG_H
#define HMSPHOISINHCONTRONGOIDIALOG_H
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSPhoiSinhConTronGoi : public CGuiDialog
{
protected:
public:
	long	m_nDocumentNo;
	...
	CGuiCheckBox	m_wndChitinhmucngansachkotra;
	int	m_nTatca;
	int	m_nPhikham;
	int	m_nPhiCLS;
	int	m_nPhithuoc;
	...
	BOOL	m_bLoccpbntra;
	BOOL	m_bChitinhmucngansachkotra;
	void			OnOKSelect(); 
	void			OnCloseSelect(); 
	long			OnListLoadData(); 
	...
	CHMSPhoiSinhConTronGoi(CWnd *pParent);
	~CHMSPhoiSinhConTronGoi();
	...
	void			OnChitinhmucngansachkotraSelect();
	int			OnMarkAllSelect();
	int			OnUnMarkSelect();
	int			OnMarkFoodFeeSelect();
	int			OnUnMarkA4FeeSelect();
	int SetMode(int nMode);
	int OnAddHMSPhoiSinhConTronGoi(); 
	int OnEditHMSPhoiSinhConTronGoi(); 
	int OnDeleteHMSPhoiSinhConTronGoi(); 
	int OnSaveHMSPhoiSinhConTronGoi(); 
	int OnCancelHMSPhoiSinhConTronGoi(); 
	int OnHMSPhoiSinhConTronGoiListLoadData(); 
};
#endif