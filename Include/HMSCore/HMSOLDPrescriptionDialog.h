#ifndef HMSPRESCRIPTIONOLDDIALOG_H
#define HMSPRESCRIPTIONOLDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSOLDPrescriptionDialog : public CGuiDialog{
protected:
public:
	int		m_nID;
	int		m_nOrderID;
	...
	void			OnApplySelect(); 
	void			OnCancelSelect(); 
	CHMSOLDPrescriptionDialog(CWnd *pParent);
	~CHMSOLDPrescriptionDialog();
