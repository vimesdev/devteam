#ifndef HMSDIAGNOSTICBYDOCTORUPDATEDIALOG_H
#define HMSDIAGNOSTICBYDOCTORUPDATEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSDoctorDiagnosticUpdateDialog : public CGuiDialog
{
protected:
public:
	...
	CDbfMap hms_treatment_record_Tbl;
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CHMSDoctorDiagnosticUpdateDialog(CWnd *pParent);
	~CHMSDoctorDiagnosticUpdateDialog();
