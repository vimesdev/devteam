#ifndef PHIEUSOKETTRUOCMO_H
#define PHIEUSOKETTRUOCMO_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CPhieuSoKetTruocMo : public CGuiDialog{
	long			m_nDocumentNo;
	int				m_nRefIdx;
	long			m_nOrderID;
protected:
public:
	...
	void			OnPrintSelect(); 
	void			OnCancelSelect(); 
	CPhieuSoKetTruocMo(CWnd *pParent, int nMode, long nDocNo, int nRefIdx, long nOrderID);
	~CPhieuSoKetTruocMo();
