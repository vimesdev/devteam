...
#include "GuiPopup.h"
#include "DbField.h"
class CWardDeliveryOrderLineInput : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CWardDeliveryOrderLineInput(CWnd *pParent, int nMode);
	~CWardDeliveryOrderLineInput();
	...
	int OnAddDeliveryOrderLineInput(); 
	int OnEditDeliveryOrderLineInput(); 
	int OnDeleteDeliveryOrderLineInput(); 
	int OnSaveDeliveryOrderLineInput(); 
	int OnCancelDeliveryOrderLineInput(); 
	int OnDeliveryOrderLineInputListLoadData(); 
};
#endif
