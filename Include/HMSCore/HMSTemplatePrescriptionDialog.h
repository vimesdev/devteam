#ifndef HMSTEMPLATEINTELLIGENTDIALOG_H
#define HMSTEMPLATEINTELLIGENTDIALOG_H
...
class AFX_EXT_CLASS CHMSTemplatePrescriptionDialog : public CGuiDialog
{
protected:
public:
	int		m_nID;
	...
	void			OnApplySelect(); 
	void			OnCancelSelect(); 
	CHMSTemplatePrescriptionDialog(CWnd *pParent);
	~CHMSTemplatePrescriptionDialog();
