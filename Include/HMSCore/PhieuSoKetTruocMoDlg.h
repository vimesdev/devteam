#ifndef PHIEUSOKETTRUOCMODLG_H
#define PHIEUSOKETTRUOCMODLG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CPhieuSoKetTruocMoDlg : public CGuiDialog{
	long			m_nDocumentNo;
	int				m_nRefIdx;
	long			m_nOrderID;
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CPhieuSoKetTruocMoDlg(CWnd *pParent, int nMode, long nDocNo, int nRefIdx, long nOrderID);
	~CPhieuSoKetTruocMoDlg();
