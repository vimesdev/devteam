...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSTreatmentCareInputDialog : public CGuiDialog
{
...
public:
	...
	CGuiLabel		m_wndDaitienLabel;
	CGuiTextCtrl	m_wndDaitien;
	CGuiLabel		m_wndTieutienLabel;
	CGuiTextCtrl	m_wndTieutien;
	...
	int	m_nNormal;
	CString	m_szDaitien;
	CString	m_szTieutien;
	int			OnDaitienCheckValue();
	int			OnTieutienCheckValue();
	//void			OnDateChange(); 
	//void			OnDateSetfocus(); 
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSTreatmentCareInputDialog(CWnd *pParent, int nMode, long nDocumentNo, long nUID=0);
