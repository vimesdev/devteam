#ifndef PMSMedicalCabinetOrderDIALOG_H
#define PMSMedicalCabinetOrderDIALOG_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CPMSMedicalCabinetOrderEntry : public CGuiView{
protected:
public:
	int			m_nFromStockID;
	CString		m_szID;
	...
	long	m_nMaxQuantity;
	long	m_nQuantity;
	CDbfMap	pms_stocktransfer_line;
	...
	int OnAddPMSMedicalCabinetOrderDialog(); 
	int OnEditPMSMedicalCabinetOrderDialog(); 
	int OnDeletePMSMedicalCabinetOrderDialog(); 
	int OnSavePMSMedicalCabinetOrderDialog(); 
	int OnCancelPMSMedicalCabinetOrderDialog(); 
	int OnPMSMedicalCabinetOrderDialogListLoadData(); 
