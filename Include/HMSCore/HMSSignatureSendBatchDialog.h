#ifndef HMSSignatureSendBatchDialog_H
#define HMSSignatureSendBatchDialog_H
...
class AFX_EXT_CLASS CHMSSignatureSendBatchDialog : public CGuiDialog{
protected:
public:
    long			m_nID;    
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSSignatureSendBatchDialog(CWnd *pParent, LPCTSTR lpszSignID, std::map<std::string, bool> signFields); 
	~CHMSSignatureSendBatchDialog();
	...
	int OnAddHMSSignatureSendBatchDialog(); 
	int OnEditHMSSignatureSendBatchDialog(); 
	int OnDeleteHMSSignatureSendBatchDialog(); 
	int OnSaveHMSSignatureSendBatchDialog(); 
	int OnCancelHMSSignatureSendBatchDialog(); 
	int OnHMSSignatureSendBatchDialogListLoadData(); 
};
#endif
