#ifndef HMSEXMEMPLOYEEDIALOG_H
#define HMSEXMEMPLOYEEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSExmEmployeeDialog : public CGuiDialog
{
protected:
public:
	long			m_nCompanyId;
	//CString			m_szCompany2Id;
	long			m_nContractId;
	int				m_nObjectId;
	long			m_nEmplId;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSExmEmployeeDialog(CWnd *pParent, int nMode);
	~CHMSExmEmployeeDialog();
