#ifndef WARDMATERIALDRUGORDERLIST_H
#define WARDMATERIALDRUGORDERLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CWardMaterialDrugOrderList : public CGuiView{
protected:
public:
	...
	int OnAddWardMaterialDrugOrderList(); 
	int OnEditWardMaterialDrugOrderList(); 
	int OnDeleteWardMaterialDrugOrderList(); 
	int OnSaveWardMaterialDrugOrderList(); 
	int OnCancelWardMaterialDrugOrderList(); 
	int OnWardMaterialDrugOrderListListLoadData(); 
};
#endif
