#ifndef VIMESGENERALSETUPDIALOG_H
#define VIMESGENERALSETUPDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CVIMESGeneralSetupDialog : public CGuiDialog{
protected:
public:
	...
	CVIMESGeneralSetupDialog(CWnd *pParent, LPCTSTR lpszTableName, LPCTSTR lpszIDName, LPCTSTR lpszDescName, bool bIsIDNumber = false);
	~CVIMESGeneralSetupDialog();
