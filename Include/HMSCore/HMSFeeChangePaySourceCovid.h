#ifndef HMSFEECHANGPAYSOURCECOVIDDIALOG_H
#define HMSFEECHANGPAYSOURCECOVIDDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSFeeChangePaySourceCovid : public CGuiDialog
{
protected:
public:
	CString			m_szType;
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSFeeChangePaySourceCovid(CWnd *pParent);
	~CHMSFeeChangePaySourceCovid();
