#ifndef HMSRELATIVEINFORDIALOG_H
#define HMSRELATIVEINFORDIALOG_H
...
#include "GuiDialog.h"
class AFX_EXT_CLASS CHMSRelativeInforDialog : public CGuiDialog
{
protected:
public:
	...
	CHMSRelativeInforDialog(CWnd *pParent);
	~CHMSRelativeInforDialog();
