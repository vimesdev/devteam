#ifndef HMSRETURNDRUGDIALOGV2_H
#define HMSRETURNDRUGDIALOGV2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSReturnDrugDialog_V2 : public CGuiDialog
{
...
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CHMSReturnDrugDialog_V2(CWnd *pParent);
	~CHMSReturnDrugDialog_V2();
