#ifndef HMSADDEXTRAFOODFEEDIALOG_H
#define HMSADDEXTRAFOODFEEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSAddExtraFoodFeeDialog : public CGuiDialog
{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSAddExtraFoodFeeDialog(CWnd *pParent);
	~CHMSAddExtraFoodFeeDialog();
