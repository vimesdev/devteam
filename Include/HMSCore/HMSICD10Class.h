#ifndef HMSICD10Class_H
#define HMSICD10Class_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSICD10Class : public CGuiDialog{
protected:
public:
	long m_nDocumentNo;
	long m_nPatientNo;
	...
	int OnAddHMSICD10Class(); 
	int OnEditHMSICD10Class(); 
	int OnDeleteHMSICD10Class(); 
	int OnSaveHMSICD10Class(); 
	int OnCancelHMSICD10Class(); 
	int OnHMSICD10ClassListLoadData();
	void	OnICDLoadData();
	void	OnICDSelendok();
