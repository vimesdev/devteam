#ifndef WARDMEDICALDEBTVIEW_H
#define WARDMEDICALDEBTVIEW_H
...
public:
	...
	int OnAddWardMedicalDebtView(); 
	int OnEditWardMedicalDebtView(); 
	int OnDeleteWardMedicalDebtView(); 
	int OnSaveWardMedicalDebtView(); 
	int OnCancelWardMedicalDebtView(); 
	int OnWardMedicalDebtViewListLoadData(); 
};
#endif
