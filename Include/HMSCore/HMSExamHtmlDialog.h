#ifndef HMSExamHtmlDIALOG_H
#define HMSExamHtmlDIALOG_H
...
class AFX_EXT_CLASS CHMSExamHtmlDialog : public CGuiDialog{
protected:
public:
	...
	CHMSExamHtmlDialog(CWnd *pParent, CString szType);
	~CHMSExamHtmlDialog();
