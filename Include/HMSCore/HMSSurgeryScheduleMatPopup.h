#ifndef HMSSurgeryScheduleMatPopup_H
#define HMSSurgeryScheduleMatPopup_H
...
class CHMSSurgeryScheduleMatPopup : public CGuiPopup
{
protected:
public:
	CWnd*			m_pParentRef;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSSurgeryScheduleMatPopup();
	CHMSSurgeryScheduleMatPopup(CWnd *pParent, int nMode, long nDocumentNo, long nOptIdx, CString szOrderDate);
	~CHMSSurgeryScheduleMatPopup();
	...
	int OnAddHMSSurgeryScheduleMatPopup(); 
	int OnEditHMSSurgeryScheduleMatPopup(); 
	int OnDeleteHMSSurgeryScheduleMatPopup(); 
	int OnSaveHMSSurgeryScheduleMatPopup(); 
	int OnCancelHMSSurgeryScheduleMatPopup(); 
	int OnHMSSurgeryScheduleMatPopupListLoadData();
