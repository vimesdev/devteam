#ifndef HMSCONFIRMMATERIALOPERATIONIVFDIALOG_H
#define HMSCONFIRMMATERIALOPERATIONIVFDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
//class Sua doi muc phi cua PTTT ky thuat cao
class CHMSConfirmMaterialOperationIVFDialog : public CGuiDialog
{
protected:
public:
	long			m_nDocumentNo;
	long			m_nOperationIdx;
	CString			m_szOldItemID;
	CString			m_szItemID;
	CString			m_szHitech;
	...
	int			OnListModifyStentItem(); 
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSConfirmMaterialOperationIVFDialog(CWnd *pParent);
	~CHMSConfirmMaterialOperationIVFDialog();
