#ifndef TM_ASSIGNPATHOLOGYWITHCELL_H
#define TM_ASSIGNPATHOLOGYWITHCELL_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CTM_AssignPathologywithcell : public CGuiDialog
{
protected:
public:
	...
	CGuiLabel		m_wndKetquaxntebaolantruocLabel;
	CGuiTextCtrl	m_wndKetquaxetnghiemtebaolantruoc;
	CGuiButton		m_wndKetquagpblabel;
	...
	CString	m_szKetquaxetnghiemtebaolantruoc;
	...
	//void			OnKetquaxetnghiemtebaolantruocChange(); 
	//void			OnKetquaxetnghiemtebaolantruocSetfocus(); 
	//void			OnKetquaxetnghiemtebaolantruocKillfocus(); 
	int			OnKetquaxetnghiemtebaolantruocCheckValue(); 
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	void			OnPrintSelect(); 
	CTM_AssignPathologywithcell(CWnd *pParent);
	~CTM_AssignPathologywithcell();
	...
	int OnAddTM_AssignPathologywithcell(); 
	int OnEditTM_AssignPathologywithcell(); 
	int OnDeleteTM_AssignPathologywithcell(); 
	int OnSaveTM_AssignPathologywithcell(); 
	int OnCancelTM_AssignPathologywithcell(); 
	int OnTM_AssignPathologywithcellListLoadData(); 
};
#endif