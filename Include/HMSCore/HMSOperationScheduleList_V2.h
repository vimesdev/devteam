#ifndef HMSOperationScheduleListV2_H
#define HMSOperationScheduleListV2_H
...
class CHMSOperationScheduleList_V2 : public CGuiView
{
...
public:
	...
	int OnAddHMSOperationScheduleList(); 
	int OnEditHMSOperationScheduleList(); 
	int OnDeleteHMSOperationScheduleList(); 
	int OnSaveHMSOperationScheduleList(); 
	int OnCancelHMSOperationScheduleList(); 
	int OnHMSOperationScheduleListListLoadData(); 
