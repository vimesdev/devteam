#ifndef HMSHCTEMPLATEDIALOG_H
#define HMSHCTEMPLATEDIALOG_H
...
class AFX_EXT_CLASS CHMSHCTemplateDialog : public CGuiDialog
{
protected:
public:
	int		m_nID;
	...
	void			OnApplySelect(); 
	void			OnCancelSelect(); 
	CHMSHCTemplateDialog(CWnd *pParent);
	~CHMSHCTemplateDialog();
	...
	int OnAddHMSHCTemplateDialog(); 
	int OnEditHMSHCTemplateDialog(); 
	int OnDeleteHMSHCTemplateDialog(); 
	int OnSaveHMSHCTemplateDialog(); 
	int OnCancelHMSHCTemplateDialog(); 
	int OnHMSHCTemplateDialogListLoadData();
