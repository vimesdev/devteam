#ifndef IVFSingleRecordInfoDialog_H
#define IVFSingleRecordInfoDialog_H
...
#include "IVFSingleAdditionalInfoView.h"
//Benh an hiem muon
class AFX_EXT_CLASS CIVFSingleRecordInfoDialog : public CGuiDialog{
protected:
	BOOL	m_bInitWife;
	BOOL	m_bInitHusband;
	BOOL	m_bInitSummary;
...
public:
	...
	CIVFSingleAdditionalInfoView m_wndInfertilityInfo;
	...
	long	m_nPatientNo;
	int		m_nTabID;
	CIVFSingleRecordInfoDialog(CWnd *pParent);
	~CIVFSingleRecordInfoDialog();
