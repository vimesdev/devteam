...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSOperationMaterialOrder : public CGuiView{
protected:
public:
	...
	CGuiButton		m_wndPrintPatientList;
	...
	//void			OnFindDocChange(); 
	//void			OnFindDocSetfocus(); 
	//void			OnFindDocKillfocus(); 
	int			OnFindDocCheckValue(); 
	...
	int OnRefreshPatientList();

	virtual BOOL PreTranslateMessage(MSG *pMsg);

	int OnSendOrder();

	int OnPatientListCheckAll();
	int OnPatientListUncheckAll();
	int OnPrintPatient();
	void OnPrint(bool bPrintAll = true, bool bPreview = true);
