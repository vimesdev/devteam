#ifndef HMSReturnDrugCabinetDialog_H
#define HMSReturnDrugCabinetDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSReturnDrugCabinetDialog : public CGuiDialog{
protected:
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CHMSReturnDrugCabinetDialog(CWnd *pParent);
	~CHMSReturnDrugCabinetDialog();
	...
	int OnAddHMSReturnDrugCabinetDialog(); 
	int OnEditHMSReturnDrugCabinetDialog(); 
	int OnDeleteHMSReturnDrugCabinetDialog(); 
	int OnSaveHMSReturnDrugCabinetDialog(); 
	int OnCancelHMSReturnDrugCabinetDialog(); 
	int OnHMSReturnDrugCabinetDialogListLoadData(); 
};
#endif
