#ifndef HMSSurgeryChargePopup_H
#define HMSSurgeryChargePopup_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CHMSSurgeryChargePopup : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nRefOptIdx;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSSurgeryChargePopup(CWnd *pParent, int nMode,  long nRefOptIdx, double nGrandAmount);
	~CHMSSurgeryChargePopup();
	...
	int OnAddHMSSurgeryChargePopup(); 
	int OnEditHMSSurgeryChargePopup(); 
	int OnDeleteHMSSurgeryChargePopup(); 
	int OnSaveHMSSurgeryChargePopup(); 
	int OnCancelHMSSurgeryChargePopup(); 
	int OnHMSSurgeryChargePopupListLoadData(); 
};
#endif
