#ifndef HMSSurgeryOperationItemSetupDialog_H
#define HMSSurgeryOperationItemSetupDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSSurgeryOperationItemSetupDialog : public CGuiDialog{
protected:
	int m_nLine;
	int m_nIndex;
public:
	...
	CHMSSurgeryOperationItemSetupDialog(CWnd *pParent);
	~CHMSSurgeryOperationItemSetupDialog();
