#ifndef PMSDAILYORDERDIALOG_H
#define PMSDAILYORDERDIALOG_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CPMSDailyDrugOrderEntry : public CGuiView{
protected:
public:
	int		m_nFromStockID;
	CString	m_szID;
	...
	int OnAddPMSDailyOrderDialog(); 
	int OnEditPMSDailyOrderDialog(); 
	int OnDeletePMSDailyOrderDialog(); 
	int OnSavePMSDailyOrderDialog(); 
	int OnCancelPMSDailyOrderDialog(); 
	int OnPMSDailyOrderDialogListLoadData(); 
