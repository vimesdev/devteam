#ifndef RPTSelectionDIALOG_H
#define RPTSelectionDIALOG_H
...
class AFX_EXT_CLASS CRPTSelectionListDialog : public CGuiDialog {
protected:
public:
	...
	BOOL			m_bSetCheckBox;
	CString			m_szSelectedDesc;
	CString			m_szArrSelectedStr;
	long			OnListLoadData();
	...
	void			OnApplySelect();
	void			OnCloseSelect();
	CRPTSelectionListDialog(CWnd* pParent, bool bIsSetCheckBox= true);
	~CRPTSelectionListDialog();
