#ifndef HMSPatientListRecord_H
#define HMSPatientListRecord_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSPatientListRecord : public CGuiView{
protected:
public:
    CWnd *m_pWndRef;
	...
	CGuiNumberCtrl	m_wndArchivalNo;
	...
	int OnAddHMSPatientListRecord(); 
	int OnEditHMSPatientListRecord(); 
	int OnDeleteHMSPatientListRecord(); 
	int OnSaveHMSPatientListRecord(); 
	int OnCancelHMSPatientListRecord(); 
	int OnHMSPatientListRecordListLoadData(); 
};
#endif
