...
class CHMSINOperationMaterialPopup : public CGuiPopup
{
protected:
public:		
	bool	m_bInpaient;
	...
	CHMSINOperationMaterialPopup();
	CHMSINOperationMaterialPopup(CWnd *pParent, int nMode);
	~CHMSINOperationMaterialPopup();
	...
	int OnAddHMSINOperationMaterialPopup(); 
	int OnEditHMSINOperationMaterialPopup(); 
	int OnDeleteHMSINOperationMaterialPopup(); 
	int OnSaveHMSINOperationMaterialPopup(); 
	int OnCancelHMSINOperationMaterialPopup(); 
	int OnHMSINOperationMaterialPopupListLoadData(); 
