#ifndef HMSINSURANCECODEDIALOG_H
#define HMSINSURANCECODEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSInsuranceCodeDialog : public CGuiDialog{
protected:
public:
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CHMSInsuranceCodeDialog(CWnd *pParent);
	~CHMSInsuranceCodeDialog();
