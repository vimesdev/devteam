#ifndef HMSDIAGNOSTICUPDATEDIALOG_H
#define HMSDIAGNOSTICUPDATEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSNurseDiagnosticUpdateDialog : public CGuiDialog
{
...
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CHMSNurseDiagnosticUpdateDialog(CWnd *pParent);
	~CHMSNurseDiagnosticUpdateDialog();
