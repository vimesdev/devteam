...
#define VM_EVAL	0x2000

class AFX_EXT_CLASS CHMSRegisterTakeCarePackageDialog : public CGuiDialog{
protected:
	CDbfMap			m_hms_fee_extraTbl;
	CDbfMap			m_hms_fee_extraTbl2;
public:
	long	m_nDocumentNo;
	long	m_nOrderId;
	long	m_nOrderLineId;
	...
	CHMSRegisterTakeCarePackageDialog(CWnd *pParent, int nMode);
