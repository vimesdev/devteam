#ifndef PurchaseInvoiceLIST_H
#define PurchaseInvoiceLIST_H
...
class AFX_EXT_CLASS CPurchaseInvoiceList : public CGuiView
...
public:
	...
	int OnAddPurchaseInvoiceList(); 
	int OnEditPurchaseInvoiceList(); 
	int OnDeletePurchaseInvoiceList(); 
	int OnSavePurchaseInvoiceList(); 
	int OnCancelPurchaseInvoiceList(); 
	int OnPurchaseInvoiceListListLoadData(); 
	int OnAddPurchaseInvoiceNonStock();
	void Refresh();
	DECLARE_MESSAGE_MAP()
