#ifndef HMSPatientInformationDialog_H
#define HMSPatientInformationDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSPatientInformationDialog : public CGuiDialog{
protected:
public:
	long	m_nPatientNo;
	long	m_nDocumentNo;
	...
	void			OnCancelSelect(); 
	void			OnPrintSelect(); 
	CHMSPatientInformationDialog(CWnd *pParent);
	~CHMSPatientInformationDialog();
	...
	int OnAddHMSPatientInformationDialog(); 
	int OnEditHMSPatientInformationDialog(); 
	int OnDeleteHMSPatientInformationDialog(); 
	int OnSaveHMSPatientInformationDialog(); 
	int OnCancelHMSPatientInformationDialog(); 
	int OnHMSPatientInformationDialogListLoadData(); 
