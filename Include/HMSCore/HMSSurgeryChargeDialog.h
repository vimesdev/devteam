#ifndef HMSSURGERYCHARGEDIALOG_H
#define HMSSURGERYCHARGEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSSurgeryChargeDialog : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSSurgeryChargeDialog(CWnd *pParent);
	~CHMSSurgeryChargeDialog();
	...
	int OnAddHMSSurgeryChargeDialog(); 
	int OnEditHMSSurgeryChargeDialog(); 
	int OnDeleteHMSSurgeryChargeDialog(); 
	int OnSaveHMSSurgeryChargeDialog(); 
	int OnCancelHMSSurgeryChargeDialog(); 
	int OnHMSSurgeryChargeDialogListLoadData(); 
};
#endif
