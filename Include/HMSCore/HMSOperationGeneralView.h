#ifndef HMSOPERATIONGENERALVIEW_H
#define HMSOPERATIONGENERALVIEW_H
...
class CHMSOperationGeneralView : public CGuiView{
protected:
	void	RefreshData();
...
public:
	...
	void			OnProceduresSelect();
	CHMSOperationGeneralView();
	~CHMSOperationGeneralView();
	...
	void	OnResizeLayout();
	bool	IsPaidFees();
	void	OnInphieuchungnhanphauthuat();
};
#endif
