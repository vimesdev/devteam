#ifndef HMSSURGERYMATADDPOPUP_H
#define HMSSURGERYMATADDPOPUP_H
...
class CHMSSurgeryMatAddPopup : public CGuiPopup
{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSSurgeryMatAddPopup();
	CHMSSurgeryMatAddPopup(CWnd *pParent, int nMode);
	~CHMSSurgeryMatAddPopup();
	...
	int OnAddHMSSurgeryMatAddPopup(); 
	int OnEditHMSSurgeryMatAddPopup(); 
	int OnDeleteHMSSurgeryMatAddPopup(); 
	int OnSaveHMSSurgeryMatAddPopup(); 
	int OnCancelHMSSurgeryMatAddPopup(); 
	int OnHMSSurgeryMatAddPopupListLoadData();
