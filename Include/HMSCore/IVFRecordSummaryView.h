#ifndef IVFRecordSummaryView_H
#define IVFRecordSummaryView_H
...
//Tom tat benh an hiem muon
class CIVFRecordSummaryView : public CGuiView{
protected:
public:
	...
	int OnAddIVFRecordSummaryView(); 
	int OnEditIVFRecordSummaryView(); 
	int OnDeleteIVFRecordSummaryView(); 
	int OnSaveIVFRecordSummaryView(); 
	int OnCancelIVFRecordSummaryView(); 
	int OnIVFRecordSummaryViewListLoadData(); 
