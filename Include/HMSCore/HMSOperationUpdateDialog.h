#ifndef HMSOPERATIONUPDATEDIALOG_H
#define HMSOPERATIONUPDATEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSOperationUpdateDialog : public CGuiDialog
{
...
public:
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CHMSOperationUpdateDialog(CWnd *pParent);
	~CHMSOperationUpdateDialog();
