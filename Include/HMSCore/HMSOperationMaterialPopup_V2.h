#ifndef HMSInpatientPrescriptionPOPUP_V2_H
#define HMSInpatientPrescriptionPOPUP_V2_H
...
class CHMSOperationMaterialPopup_V2 : public CGuiPopup{
protected:
public:		
	bool	m_bInpaient;
	long	m_nPatientNo;
	...
	CHMSOperationMaterialPopup_V2();
	CHMSOperationMaterialPopup_V2(CWnd *pParent, int nMode);
	~CHMSOperationMaterialPopup_V2();
	...
	int OnAddHMSOperationMaterialPopup_V2(); 
	int OnEditHMSOperationMaterialPopup_V2(); 
	int OnDeleteHMSOperationMaterialPopup_V2(); 
	int OnSaveHMSOperationMaterialPopup_V2(); 
	int OnCancelHMSOperationMaterialPopup_V2(); 
	int OnHMSOperationMaterialPopup_V2ListLoadData(); 
