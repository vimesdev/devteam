#ifndef HMSCANCERPrescriptionEntryPopup_H
#define HMSCANCERPrescriptionEntryPopup_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CHMSCancerPrescriptionEntryPopup : public CGuiPopup{
protected:
public:
	CWnd*	m_pPrescriptionOrder;
	long	m_nOrderId;
	long	m_nDiagrameId;
	int		m_nStorageId;
	long	m_nCancerOrderId;
	long	m_nCancerOrderLineId;
	long	m_nTreatIdx;
	...
	CGuiTextCtrl	m_wndExternalName;
	CGuiLabel		m_wndUnitLabel;
	CGuiTextCtrl	m_wndUnit;
	CGuiComboBox	m_wndExternalUnit;
	...
	CGuiCheckBox	m_wndIncludeServiceStorage;
	CGuiCheckBox	m_wndExternalSale;
	...
	CString	m_szUnit;
	CString	m_szExternalUnitKey;
	float	m_nQty;
	CString	m_szDousageKey;
	CString	m_szUsage;
	CString	m_szSpeed;
	BOOL	m_bGenericSearch;
	BOOL	m_bIncludeServiceStorage;
	BOOL	m_bExternalSale;
	CString	m_szExternalName;
	...
	int			OnExternalNameCheckValue(); 
	//void			OnUnitChange(); 
	//void			OnUnitSetfocus(); 
	//void			OnUnitKillfocus(); 
	int			OnUnitCheckValue(); 
	int			OnExternalUnitLoadData(); 
	//void			OnQtyChange(); 
	//void			OnQtySetfocus(); 
	//void			OnQtyKillfocus(); 
	int			OnQtyCheckValue(); 
	...
	void	OnExternalSaleSelect();
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSCancerPrescriptionEntryPopup(CWnd *pParent, int nMode);
	~CHMSCancerPrescriptionEntryPopup();
	...
	int OnAddHMSCancerPrescriptionEntryPopup(); 
	int OnEditHMSCancerPrescriptionEntryPopup(); 
	int OnDeleteHMSCancerPrescriptionEntryPopup(); 
	int OnSaveHMSCancerPrescriptionEntryPopup(); 
	int OnCancelHMSCancerPrescriptionEntryPopup(); 
	int OnHMSCancerPrescriptionEntryPopupListLoadData(); 
};
#endif
