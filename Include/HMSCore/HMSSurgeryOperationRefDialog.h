#ifndef HMSSURGERYOPERATIONREFDIALOG_H
#define HMSSURGERYOPERATIONREFDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSSurgeryOperationRefDialog : public CGuiDialog{
protected:
public:
	long		m_nOrderID;
	int			m_nQuantity;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSSurgeryOperationRefDialog(CWnd *pParent);
	~CHMSSurgeryOperationRefDialog();
	...
	int OnAddHMSSurgeryOperationRefDialog(); 
	int OnEditHMSSurgeryOperationRefDialog(); 
	int OnDeleteHMSSurgeryOperationRefDialog(); 
	int OnSaveHMSSurgeryOperationRefDialog(); 
	int OnCancelHMSSurgeryOperationRefDialog(); 
	int OnHMSSurgeryOperationRefDialogListLoadData(); 
};
#endif
