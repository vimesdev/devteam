...
#include "GuiPopup.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSOperationGroupPopup : public CGuiPopup
{
...
protected:
	...
	CString	m_szOldTycGroup;
public:
	CGuiGroupBox	m_wndDataInput;
	CGuiLabel		m_wndNameLabel;
	CGuiTextCtrl	m_wndName;
	CGuiNumberCtrl	m_wndboiduongkippt;
	CGuiNumberCtrl	m_wndboiduonggayme;
	CGuiLabel		m_wndReturnDeptLabel;
	CGuiNumberCtrl	m_wndReturnDept;
	CGuiComboBox	m_wndOperationGroup;
	CGuiLabel		m_wndbd_kip_pt_label;
	CGuiLabel		m_wndbd_gayme_label;
	CGuiLabel		m_wndOperationGroupLabel;
	CGuiLabel		m_wndTYCLabel;
	CGuiTextCtrl	m_wndTycGroup;
	
	CGuiButton		m_wndSave;
	CGuiButton		m_wndClose;
	CString	m_szName;
	CString	m_szTycGroup;
	long	m_nboiduongkippt;
	long	m_nboiduonggayme;
	long	m_nReturnDept;
	long	m_nReturnDept1;
	long	m_nReturnDept2;
	...
	//void			OnboiduongkipptChange(); 
	//void			OnboiduongkipptSetfocus(); 
	//void			OnboiduongkipptKillfocus(); 
	int			OnboiduongkipptCheckValue(); 
	//void			OnboiduonggaymeChange(); 
	//void			OnboiduonggaymeSetfocus(); 
	//void			OnboiduonggaymeKillfocus(); 
	int			OnboiduonggaymeCheckValue(); 
