...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CTMOperationMinutes : public CGuiDialog
{
...
public:
	...
	CGuiLabel		m_wndUseMaterialLabel;
	CGuiTextCtrl	m_wndUseMaterial;
	CGuiLabel		m_wndProcessLabel;
    CGuiComboBox	m_wndSequence;
	CGuiTextCtrl	m_wndProcess;
	CGuiTextCtrl	m_wndProcessEx;

	CGuiButton		m_wndAddSequence;
    CGuiButton		m_wndAddImage;
	...
	CString	m_szUseMaterial;
    CString m_szSequenceKey;
	CString	m_szProcess;
	CString	m_szProcessEx;
	...
	//void			OnUseMaterialChange(); 
	//void			OnUseMaterialSetfocus(); 
	//void			OnUseMaterialKillfocus(); 
	int			OnUseMaterialCheckValue(); 

	
    void OnSequenceSelectChange(int nOldItemSel, int nNewItemSel);
    void OnSequenceSelendok();
    // void			OnSequenceSetfocus();
    // void			OnSequenceKillfocus();
    long OnSequenceLoadData();
    // void			OnSequenceAddNew(); 
	// 
	//void			OnProcessChange(); 
	//void			OnProcessSetfocus(); 
	//void			OnProcessKillfocus(); 
	int			OnProcessCheckValue();
	int			OnProcessExCheckValue(); 
	void			OnAddSequenceSelect(); 
	void			OnAddImageSelect(); 
	void			OnUpdateSelect(); 
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	void			OnPrintSelect(); 
	...
	BOOL OnAddImage(CString szFile);
    BOOL OnEditImage(CString szFile);
    BOOL OnRemoveImage(CString szFile);
