#ifndef HMSSummaryInpatientFeeDialog_H
#define HMSSummaryInpatientFeeDialog_H
...
class CHMSSummaryInpatientFeeDialog : public CGuiDialog{
protected:
public:
	...
	void			OnCloseSelect(); 
	CHMSSummaryInpatientFeeDialog(CWnd *pParent);
	~CHMSSummaryInpatientFeeDialog();
	...
	int OnAddHMSSummaryInpatientFeeDialog(); 
	int OnEditHMSSummaryInpatientFeeDialog(); 
	int OnDeleteHMSSummaryInpatientFeeDialog(); 
	int OnSaveHMSSummaryInpatientFeeDialog(); 
	int OnCancelHMSSummaryInpatientFeeDialog(); 
	int OnHMSSummaryInpatientFeeDialogListLoadData(); 
