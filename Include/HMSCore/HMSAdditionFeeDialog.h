#ifndef HMSADDITIONFEEDIALOG_H
#define HMSADDITIONFEEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSAdditionFeeDialog : public CGuiDialog
{
protected:
public:
	...
	CGuiLabel	    m_wndPhauthuatlabel;
	CGuiComboBox	m_wndphauthuat;
	CGuiLabel		m_wndNguoigtlabel;
	CGuiTextCtrl	m_wndNguoigioithieu;
	...
	float	m_nQuantity;
	double	m_nAmount;
	CString	m_szphauthuatKey;
	CDbfMap	m_hms_other_feeTbl;
	...
	long			OnphauthuatLoadData();
	void			OnSaveSelect(); 
	void			OnCloseSelect();
	long			OnNguoigioithieuLoadData();
	int			OnNguoigioithieuCheckValue();
	long			OnDepartmentLoadData(); 
	int			OnPhoneCheckValue();
	int			OnNoteCheckValue(); 
	CHMSAdditionFeeDialog(CWnd *pParent);
	~CHMSAdditionFeeDialog();
	...
	int OnAddHMSAdditionFeeDialog(); 
	int OnEditHMSAdditionFeeDialog(); 
	int OnDeleteHMSAdditionFeeDialog(); 
	int OnSaveHMSAdditionFeeDialog(); 
	int OnCancelHMSAdditionFeeDialog(); 
	int OnHMSAdditionFeeDialogListLoadData(); 
};
#endif