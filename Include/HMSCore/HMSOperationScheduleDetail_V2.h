#ifndef HMSOperationScheduleDetail_V2_H
#define HMSOperationScheduleDetail_V2_H
...
class CHMSOperationScheduleDetail_V2 : public CGuiView
{
...
public:
	...
	CGuiLabel		m_wndStartAtLabel;
	CGuiDateTimeCtrl m_wndStartAt;
	CGuiLabel		m_wndEndAtLabel;
	CGuiDateTimeCtrl m_wndEndAt;
	CGuiLabel		m_wndExpectedTimeLabel;
	CGuiTextCtrl	m_wndExpectedTime;
	CGuiButton		m_wndAdd;
	...
	//void			OnStartAtChange(); 
	//void			OnStartAtSetfocus(); 
	//void			OnStartAtKillfocus(); 
	int			OnStartAtCheckValue(); 
	//void			OnEndAtChange(); 
	//void			OnEndAtSetfocus(); 
	//void			OnEndAtKillfocus(); 
	int			OnEndAtCheckValue(); 
	//void			OnExpectedTimeChange(); 
	//void			OnExpectedTimeSetfocus(); 
	//void			OnExpectedTimeKillfocus(); 
	int			OnExpectedTimeCheckValue(); 
	void			OnAddSelect(); 
	void			OnEditSelect(); 
	void			OnDeleteSelect(); 
	void			OnSaveSelect(); 
	...
	CHMSOperationScheduleDetail_V2();
	~CHMSOperationScheduleDetail_V2();
	...
	int OnAddHMSOperationScheduleDetail(); 
	int OnEditHMSOperationScheduleDetail(); 
	int OnDeleteHMSOperationScheduleDetail(); 
	int OnSaveHMSOperationScheduleDetail(); 
	int OnCancelHMSOperationScheduleDetail(); 
	int OnHMSOperationScheduleDetailListLoadData(); 
