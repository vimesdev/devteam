#ifndef HMSEXMCONTRACTDIALOGEX_H
#define HMSEXMCONTRACTDIALOGEX_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSExmContractDialogEX : public CGuiDialog
{
protected:
public:
	long	m_nContractId;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSExmContractDialogEX(CWnd *pParent, int nMode);
	~CHMSExmContractDialogEX();
