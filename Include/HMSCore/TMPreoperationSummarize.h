#ifndef TMPREOPERATIONSUMMARIZE_H
#define TMPREOPERATIONSUMMARIZE_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CTMPreoperationSummarize : public CGuiDialog{
protected:
...
public:
	...
	void			OnPrintSelect(); 
	void			OnCloseSelect(); 
	CTMPreoperationSummarize(CWnd *pParent, long nOperationIdx);
	~CTMPreoperationSummarize();
