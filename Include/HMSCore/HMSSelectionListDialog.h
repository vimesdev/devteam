#ifndef HMSSelectionDIALOG_H
#define HMSSelectionDIALOG_H
...
class AFX_EXT_CLASS CHMSSelectionListDialog : public CGuiDialog {
protected:
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSSelectionListDialog(CWnd *pParent);
	~CHMSSelectionListDialog();
