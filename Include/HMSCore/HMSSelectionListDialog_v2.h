#ifndef HMSSelectionDIALOGV2_H
#define HMSSelectionDIALOGV2_H
...
class AFX_EXT_CLASS CHMSSelectionListDialog_v2 : public CGuiDialog 
{
...
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSSelectionListDialog_v2(CWnd *pParent);
	~CHMSSelectionListDialog_v2();
