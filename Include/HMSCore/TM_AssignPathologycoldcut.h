#ifndef TM_ASSIGNPATHOLOGYCOLDCUT_H
#define TM_ASSIGNPATHOLOGYCOLDCUT_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CTM_AssignPathologycoldcut : public CGuiDialog
{
...
public:
	...
	CGuiButton		m_wndKetquaclssinhthietlantruoclabel;
	...
	void			OnKetquaclssinhthietlantruoclabelSelect();
	...
	void			OnCancelSelect(); 
	void			OnPrintSelect(); 
	CTM_AssignPathologycoldcut(CWnd *pParent);
	~CTM_AssignPathologycoldcut();
