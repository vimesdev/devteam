...
#include "HMSOperationSequenceView.h"


class AFX_EXT_CLASS CHMSOperationOrder : public CGuiView
{
protected:
	long	m_nOrderID;
	CString	m_szDoctor;
...
public:
    ...
    CHMSOperationSequenceView m_wndSequenceView;
	...
	void OnDescription();
	void OnOperation();	
	void OnUpdateOperationBoard();
	int OnCancelOperationBoard();
	void OnFollowLaserTreatment();
	void OnResizeLayout();
	void OnUpdateInfo();
};
#endif