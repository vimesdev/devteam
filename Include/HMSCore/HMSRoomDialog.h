#ifndef HMSROOMDIALOG_H
#define HMSROOMDIALOG_H
...
class AFX_EXT_CLASS CHMSRoomDialog: public CHMSSelectionListDialog{
public:
	CString m_szDept;
	CHMSRoomDialog(CWnd *pParent, LPCTSTR lpszDept);
	~CHMSRoomDialog();
};
