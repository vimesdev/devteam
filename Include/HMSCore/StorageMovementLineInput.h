...
#include "GuiDialog.h"
#include "DbField.h"
class CStorageMovementLineInput : public CGuiDialog{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CStorageMovementLineInput(CWnd *pParent, int nMode, int x, int y);
	~CStorageMovementLineInput();
	...
	int OnAddStorageMovementLineInput(); 
	int OnEditStorageMovementLineInput(); 
	int OnDeleteStorageMovementLineInput(); 
	int OnSaveStorageMovementLineInput(); 
	int OnCancelStorageMovementLineInput(); 
	int OnStorageMovementLineInputListLoadData(); 
};
#endif
