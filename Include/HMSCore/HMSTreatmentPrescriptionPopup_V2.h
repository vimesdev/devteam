#ifndef HMSTreatmentPrescriptionPopup_V2_H
#define HMSTreatmentPrescriptionPopup_V2_H
...
class CHMSTreatmentPrescriptionPopup_V2 : public CGuiPopup
{
protected:
public:	
	CWnd*	m_pParentOwner;
...
//	CHMSTreatmentPrescriptionPopup_V2();
	CHMSTreatmentPrescriptionPopup_V2(CWnd *pParent, int nMode=VM_ADD, int x=0, int y =0);
	~CHMSTreatmentPrescriptionPopup_V2();
