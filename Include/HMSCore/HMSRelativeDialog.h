#ifndef HMSRELATIVEDIALOG_H
#define HMSRELATIVEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSRelativeDialog : public CGuiDialog{
protected:
public:
	...
	CHMSRelativeDialog(CWnd *pParent);
	~CHMSRelativeDialog();
	...
	int OnAddHMSRelativeDialog(); 
	int OnEditHMSRelativeDialog(); 
	int OnDeleteHMSRelativeDialog(); 
	int OnSaveHMSRelativeDialog(); 
	int OnCancelHMSRelativeDialog(); 
	int OnHMSRelativeDialogListLoadData(); 
};
#endif
