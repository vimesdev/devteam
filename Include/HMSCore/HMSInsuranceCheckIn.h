...
#include "DbMap.h"
class AFX_EXT_CLASS CHMSInsuranceCheckIn : public CHttpClient{
protected:
	...
	CDbfMap		m_bh_xml1Tbl;
	CDbfMap		m_bh_xml2Tbl;
	CDbfMap		m_bh_xml3Tbl;
	CDbfMap		m_bh_xml4Tbl;
	CDbfMap		m_bh_xml5Tbl;
public:
