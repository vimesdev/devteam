#ifndef HMSSignaturePendingDialog_H
#define HMSSignaturePendingDialog_H
...
class AFX_EXT_CLASS CHMSSignaturePendingDialog : public CGuiDialog{
protected:
public:
    long			m_nID;    
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSSignaturePendingDialog(CWnd *pParent); 
	~CHMSSignaturePendingDialog();
	...
	int OnAddHMSSignaturePendingDialog(); 
	int OnEditHMSSignaturePendingDialog(); 
	int OnDeleteHMSSignaturePendingDialog(); 
	int OnSaveHMSSignaturePendingDialog(); 
	int OnCancelHMSSignaturePendingDialog(); 
	int OnHMSSignaturePendingDialogListLoadData(); 
};
#endif
