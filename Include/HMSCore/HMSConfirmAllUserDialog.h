#ifndef HMSCONFIRMALLUSERDIALOG_H
#define HMSCONFIRMALLUSERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSConfirmAllUserDialog : public CGuiDialog
{
...
public:
	...
	int OnAddHMSConfirmDialog(); 
	int OnEditHMSConfirmDialog(); 
	int OnDeleteHMSConfirmDialog(); 
	int OnSaveHMSConfirmDialog(); 
	int OnCancelHMSConfirmDialog(); 
	int OnHMSConfirmDialogListLoadData(); 
};
#endif
