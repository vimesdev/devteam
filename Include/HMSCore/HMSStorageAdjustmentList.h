#ifndef STORAGEAdjustmentLIST_H
#define STORAGEAdjustmentLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSStorageAdjustmentList : public CGuiView{
protected:
public:
	long	m_nID;
	...
	int OnAddStorageAdjustmentList(); 
	int OnEditStorageAdjustmentList(); 
	int OnDeleteStorageAdjustmentList(); 
	int OnSaveStorageAdjustmentList(); 
	int OnCancelStorageAdjustmentList(); 
	int OnStorageAdjustmentListListLoadData(); 
	DECLARE_MESSAGE_MAP()
