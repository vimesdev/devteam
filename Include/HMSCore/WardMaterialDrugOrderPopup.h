#ifndef WARDMATERIALDRUGORDERPOPUP_H
#define WARDMATERIALDRUGORDERPOPUP_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CWardMaterialDrugOrderPopup : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	CWardMaterialDrugOrderPopup(CWnd *pParent);
	~CWardMaterialDrugOrderPopup();
	...
	int OnAddWardMaterialDrugOrderPopup(); 
	int OnEditWardMaterialDrugOrderPopup(); 
	int OnDeleteWardMaterialDrugOrderPopup(); 
	int OnSaveWardMaterialDrugOrderPopup(); 
	int OnCancelWardMaterialDrugOrderPopup(); 
	int OnWardMaterialDrugOrderPopupListLoadData(); 
};
#endif
