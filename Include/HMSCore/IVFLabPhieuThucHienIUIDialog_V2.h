#ifndef IVFLABPHIEUTHUCHIENIUIDIALOG_V2_H
#define IVFLABPHIEUTHUCHIENIUIDIALOG_V2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CIVFLabPhieuThucHienIUIDialog_V2 : public CGuiDialog{
protected:
public:
	long	m_nOrder_id;
	...
	void			OnSaveSelect(); 
	void			OnCancelSelect(); 
	CIVFLabPhieuThucHienIUIDialog_V2();
	~CIVFLabPhieuThucHienIUIDialog_V2();
	...
	int OnAddIVFLabPhieuThucHienIUIDialog_V2(); 
	int OnEditIVFLabPhieuThucHienIUIDialog_V2(); 
	int OnDeleteIVFLabPhieuThucHienIUIDialog_V2(); 
	int OnSaveIVFLabPhieuThucHienIUIDialog_V2(); 
	int OnCancelIVFLabPhieuThucHienIUIDialog_V2(); 
	int OnIVFLabPhieuThucHienIUIDialog_V2ListLoadData(); 
};
#endif
