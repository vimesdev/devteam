#ifndef HMSFEEMODIFYITEMDIALOG_H
#define HMSFEEMODIFYITEMDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSFeeModifyItemDialog : public CGuiDialog
{
...
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CHMSFeeModifyItemDialog(CWnd *pParent);
	~CHMSFeeModifyItemDialog();
