#ifndef WardReturnOrderLIST_H
#define WardReturnOrderLIST_H
...
class AFX_EXT_CLASS CWardReturnOrderList : public CGuiView{
protected:
public:
	CWnd*			m_wndOrder;
	bool			m_bImportType;
	...
	int OnAddWardReturnOrderList(); 
	int OnEditWardReturnOrderList(); 
	int OnDeleteWardReturnOrderList(); 
	int OnSaveWardReturnOrderList(); 
	int OnCancelWardReturnOrderList(); 
	int OnWardReturnOrderListListLoadData(); 
