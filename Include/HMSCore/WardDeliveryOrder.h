#ifndef WardDeliveryOrder_H
#define WardDeliveryOrder_H
...
class CWardDeliveryOrder : public CGuiView{
protected:
	bool		m_bRefresh;
public:
	CWnd*	m_pWndOrder;
	...
	int OnAddWardDeliveryOrder(); 
	int OnEditWardDeliveryOrder(); 
	int OnDeleteWardDeliveryOrder(); 
	int OnSaveWardDeliveryOrder(); 
	int OnDiscardWardDeliveryOrder(); 
	int OnWardDeliveryOrderListLoadData(); 
	CString GetOrderStatus();
	bool	IsAllowEdit();
	int OnListSelectPurchase();
};
#endif
