...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSFeeDocument : public CGuiView{
protected:
public:
	...
	void			OnAddExtraFoodFee();
	int			OnChangExemFeeC13();
	void			OnApproveSelect();
	void			OnUnapprove();
	void			OnPrintInvoiceBankSelect();
	void		OnCreateRefund();
	void		OnRefundOrderSelect(); 
	...
	void OnFeeChangePaySourceSCTGEX();
