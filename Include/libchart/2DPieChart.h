// 2DPieChart.h: interface for the C2DPieChart class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_2DPieChart_H__59B0EDD5_E8F6_4B44_97CB_6FEAFB11AF9C__INCLUDED_)
#define AFX_2DPieChart_H__59B0EDD5_E8F6_4B44_97CB_6FEAFB11AF9C__INCLUDED_
...
struct _2DPieChartSegments
{
	int index;
	int percent;
	COLORREF color;
	CString text;
	struct _2DPieChartSegments* next;
};


class  AFX_EXT_CLASS C2DPieChart  
{
public:
	...
	C2DPieChart( CPoint g_position, CSize g_size );
	virtual ~C2DPieChart();
...
private:
	...
	struct _2DPieChartSegments* m_Segments;
};

#endif // !defined(AFX_2DPieChart_H__59B0EDD5_E8F6_4B44_97CB_6FEAFB11AF9C__INCLUDED_)
