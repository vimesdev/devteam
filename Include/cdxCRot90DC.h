...
// Notes:   This is an advanced version of the CDCMem class that has
 ...
 * Based on CDCMem by Keith Rule - you can find this DC on codeguru as well.
 *
...
public:
	cdxCRot90DC() : m_pDC(NULL), m_bFinished(true), m_pOldFont(NULL) {}
