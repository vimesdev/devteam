#ifndef TMTotalPatientListDischargeByDept_H
#define TMTotalPatientListDischargeByDept_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMTotalPatientListDischargeByDept : public CGuiView{
protected:
public:
	...
	CTMTotalPatientListDischargeByDept(CWnd *pWnd);
	~CTMTotalPatientListDischargeByDept();
