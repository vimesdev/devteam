#ifndef TMPatientListDischargeForCancerPatient_H
#define TMPatientListDischargeForCancerPatient_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMPatientListDischargeForCancerPatient : public CGuiView
{
protected:
public:
	...
	CTMPatientListDischargeForCancerPatient(CWnd *pWnd);
	~CTMPatientListDischargeForCancerPatient();
