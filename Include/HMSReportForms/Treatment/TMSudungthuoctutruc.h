#ifndef CTMSudungthuoctutruc_H
#define CTMSudungthuoctutruc_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMSudungthuoctutruc : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CTMSudungthuoctutruc(CWnd *pParent);
	~CTMSudungthuoctutruc();
	...
	int OnAddCTMSudungthuoctutruc(); 
	int OnEditCTMSudungthuoctutruc(); 
	int OnDeleteCTMSudungthuoctutruc(); 
	int OnSaveCTMSudungthuoctutruc(); 
	int OnCancelCTMSudungthuoctutruc(); 
	int OnCTMSudungthuoctutrucListLoadData(); 
};
#endif
