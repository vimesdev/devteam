#ifndef TMThuchienchitieu_H
#define TMThuchienchitieu_H
...
#include "GuiView.h"
#include "DbField.h"
class CTMThuchienchitieu : public CGuiView{
protected:
public:
	...
	int OnAddTMThuchienchitieu(); 
	int OnEditTMThuchienchitieu(); 
	int OnDeleteTMThuchienchitieu(); 
	int OnSaveTMThuchienchitieu(); 
	int OnCancelTMThuchienchitieu(); 
	int OnTMThuchienchitieuListLoadData(); 
