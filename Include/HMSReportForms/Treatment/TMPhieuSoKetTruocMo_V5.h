#ifndef TMPHIEUSOKETTRUOCMOV5_H
#define TMPHIEUSOKETTRUOCMOV5_H
...
class AFX_EXT_CLASS CTMPhieuSoKetTruocMo_V5 : public CGuiDialog
{	
	long			m_nDocumentNo;
	int				m_nRefIdx;
	long			m_nOrderID;
...
public:
	...
	CGuiLabel		m_wndChucdanhLabel;
	CGuiComboBox	m_wndSignLabel;
	...
	CTMPhieuSoKetTruocMo_V5(CWnd *pParent, int nMode, long nDocNo, int nRefIdx, long nOrderID);
	~CTMPhieuSoKetTruocMo_V5();
