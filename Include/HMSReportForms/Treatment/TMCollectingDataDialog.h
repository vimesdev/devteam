#ifndef TMCollectingDataDialog_H
#define TMCollectingDataDialog_H
...
class AFX_EXT_CLASS CTMCollectingDataDialog : public CGuiDialog
{
protected:
...
public:
    ...
    CArray<PARASUBITEM, PARASUBITEM &> m_arSubItems;
	bool		m_bHasApply;
	CString		m_szSample;
	CString		m_szNote;
    ...
    CGuiListCtrl m_wndTestListItem;
	...
	long OnTestListItemLoadData();
    void OnTestListItemSelectChange(int nOldItem, int nNewItem);
    void OnTestListItemDblClick();
    void OnTestListItemClick();
    void OnTestListItemAddItem();

    int OnTestListItemDeleteItem();
	...
	CTMCollectingDataDialog(CWnd* pParent);

	~CTMCollectingDataDialog();
    ...
    int OnAddTMCollectingDataDialog();
    int OnEditTMCollectingDataDialog();
    int OnDeleteTMCollectingDataDialog();
    int OnSaveTMCollectingDataDialog();
    int OnCancelTMCollectingDataDialog();
    int OnTMCollectingDataDialogListLoadData();
