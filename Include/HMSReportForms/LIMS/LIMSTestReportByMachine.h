#ifndef LIMSTESTREPORTBYMACHINE_H
#define LIMSTESTREPORTBYMACHINE_H
...
#include "GuiView.h"
#include "DbField.h"
class CLIMSTestReportByMachine : public CGuiView{
protected:
	CString	m_szDept;
public:
	...
	CLIMSTestReportByMachine(CWnd *pParent);
	~CLIMSTestReportByMachine();
