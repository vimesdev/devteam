#ifndef LIMSTESTMONEYBYPATIENT_H
#define LIMSTESTMONEYBYPATIENT_H
...
#include "GuiView.h"
#include "DbField.h"
class CLIMSTestMoneybyPatient : public CGuiView
{
...
public:
	...
	CGuiCheckBox	m_wndAddOtherRoom;
	int		m_nYear;
	...
	void			OnAddOtherRoomSelect(); 
	CLIMSTestMoneybyPatient(CWnd *pParent);
	~CLIMSTestMoneybyPatient();
