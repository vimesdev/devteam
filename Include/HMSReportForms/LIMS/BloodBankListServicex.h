#ifndef BLOODBANKLISTSERVICEX_H
#define BLOODBANKLISTSERVICEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CBloodBankListServicex : public CGuiView
{
protected:
public:
	...
	CBloodBankListServicex(CWnd *pParent);
	~CBloodBankListServicex();
