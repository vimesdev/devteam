#ifndef LIMSTESTCOVID19NGUOINHA_H
#define LIMSTESTCOVID19NGUOINHA_H
...
#include "GuiView.h"
#include "DbField.h"
class CLIMSTestCovid19NguoinhaReport : public CGuiView
{
...
public:
	...
	void			OnNoitruSelect(); 
	CLIMSTestCovid19NguoinhaReport(CWnd* pParent);
	~CLIMSTestCovid19NguoinhaReport();
