#ifndef LIMSQuanLyChatLuongCLS_H
#define LIMSQuanLyChatLuongCLS_H
...
#include "GuiView.h"
#include "DbField.h"
class CLIMSQuanLyChatLuongCLS : public CGuiView{
protected:
...
public:
	...
	void			OnExportSelect();
	void			OnPrintSelect();
	CLIMSQuanLyChatLuongCLS(CWnd *pParent);
	~CLIMSQuanLyChatLuongCLS();
