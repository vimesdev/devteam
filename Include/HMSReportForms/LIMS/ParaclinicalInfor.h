#ifndef PARACLINICALINFOR_H
#define PARACLINICALINFOR_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CParaclinicalInfor : public CGuiDialog
{
protected:
public:
	...
	CGuiCheckBox	m_wndPrintBoldItalic;
	CString m_szID;
	...
	void			OnPrintBoldItalicSelect();
	CParaclinicalInfor(CWnd *pParent);
	~CParaclinicalInfor();
