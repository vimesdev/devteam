#ifndef LIMSInwardListReport_H
#define LIMSInwardListReport_H
...
#include "GuiView.h"
#include "DbField.h"
class CLIMSInwardListReport : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CLIMSInwardListReport(CWnd *pParent);
	~CLIMSInwardListReport();
	...
	int OnAddLIMSInwardListReport(); 
	int OnEditLIMSInwardListReport(); 
	int OnDeleteLIMSInwardListReport(); 
	int OnSaveLIMSInwardListReport(); 
	int OnCancelLIMSInwardListReport(); 
	int OnLIMSInwardListReportListLoadData(); 
