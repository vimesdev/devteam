#ifndef HCSEXPORTSHEETLISTFORINSURANCE_H
#define HCSEXPORTSHEETLISTFORINSURANCE_H
...
#include "GuiView.h"
#include "DbField.h"
class CHCSExportSheetListForInsurance : public CGuiView
{
...
public:
	...
	void			OnExportSelect(); 
	CHCSExportSheetListForInsurance(CWnd *pParent);
	~CHCSExportSheetListForInsurance();
