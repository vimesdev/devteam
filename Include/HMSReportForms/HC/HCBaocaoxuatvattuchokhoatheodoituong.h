#ifndef HCBaocaoxuatvattuchokhoatheodoituong_H
#define HCBaocaoxuatvattuchokhoatheodoituong_H
...
#include "GuiView.h"
#include "DbField.h"
class CHCBaocaoxuatvattuchokhoatheodoituong : public CGuiView
{
protected:
public:
	...
	void			OnPreviewV2Select(); 

	int			OnListFacDeleteItem(); 
	int			OnCheckAll();
	int			OnUnCheckAll();
	CHCBaocaoxuatvattuchokhoatheodoituong(CWnd *pParent);
	~CHCBaocaoxuatvattuchokhoatheodoituong();
	...
	void OnPrintBaocaoxuathuocchokhoatheodoituong_khth();
	void OnPrintBaocaoxuathuocchokhoatheodoituong_pcnmt();
	int SetMode(int nMode);
	int OnAddMABaocaoxuatvattuchokhoatheodoituong(); 
	int OnEditMABaocaoxuatvattuchokhoatheodoituong(); 
	int OnDeleteMABaocaoxuatvattuchokhoatheodoituong(); 
	int OnSaveMABaocaoxuatvattuchokhoatheodoituong(); 
	int OnCancelMABaocaoxuatvattuchokhoatheodoituong(); 
	int OnMABaocaoxuatvattuchokhoatheodoituongListLoadData(); 
	DECLARE_MESSAGE_MAP()
