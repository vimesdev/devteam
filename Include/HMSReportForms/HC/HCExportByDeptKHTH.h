#ifndef HCExportByDeptKHTHKHTH_H
#define HCExportByDeptKHTHKHTH_H
...
#include "GuiView.h"
#include "DbField.h"
class CExportByDeptKHTH : public CGuiView
{
...
public:
	...
	void			OnExportSelect(); 
	CExportByDeptKHTH(CWnd *pParent);
	~CExportByDeptKHTH();
	...
	int OnAddExportByDept(); 
	int OnEditExportByDept(); 
	int OnDeleteExportByDept(); 
	int OnSaveExportByDept(); 
	int OnCancelExportByDept(); 
	int OnExportByDeptListLoadData(); 
