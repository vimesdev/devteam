#ifndef HCREPORTCONDITIONDIALOG_H
#define HCREPORTCONDITIONDIALOG_H
...
class AFX_EXT_CLASS CHCReportConditionDialog : public CGuiView
{
protected:
public:
	...
	CGuiCheckBox	m_wndNotincludeStocktransfer;
	...
	BOOL m_bAvgPrice;
	CString m_szSort;
	BOOL	m_bNotincludeStocktransfer;
	...
	void			OnExportSelect(); 
	void			OnCloseSelect();
	void			OnNotincludeStocktransferSelect();
	void			OnPreviewV2Select(); 
	CHCReportConditionDialog(CWnd *pParent, int nType);
	~CHCReportConditionDialog();
	...
	void	OnPrintImportExportAndInstockForDetailMoneyReportV2(bool bPreview);
