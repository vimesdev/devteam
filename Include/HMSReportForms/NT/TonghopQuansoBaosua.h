#ifndef TONGHOPQUANSOBAOSUA_H
#define TONGHOPQUANSOBAOSUA_H
...
#include "GuiView.h"
#include "DbField.h"
class CTonghopQuansoBaosua : public CGuiView
{
...
public:
	...
	CTonghopQuansoBaosua(CWnd *pParent);
	~CTonghopQuansoBaosua();
