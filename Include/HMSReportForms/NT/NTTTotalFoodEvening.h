#ifndef NTTTotalFoodEvening_H
#define NTTTotalFoodEvening_H
...
#include "GuiView.h"
#include "DbField.h"
class CNTTTotalFoodEvening : public CGuiView{
protected:
...
public:
	...
	void			OnDinnerSelect(); 
	void			OnExportSelect(); 
	CNTTTotalFoodEvening(CWnd *pParent);
	~CNTTTotalFoodEvening();
	...
	int OnAddNTTTotalFoodEvening(); 
	int OnEditNTTTotalFoodEvening(); 
	int OnDeleteNTTTotalFoodEvening(); 
	int OnSaveNTTTotalFoodEvening(); 
	int OnCancelNTTTotalFoodEvening(); 
	int OnNTTTotalFoodEveningListLoadData(); 
