#ifndef TONGHOPQUANSOBAOANNGUOINHA_H
#define TONGHOPQUANSOBAOANNGUOINHA_H
...
#include "GuiView.h"
#include "DbField.h"
class CTonghopQuansoBaoannguoinha : public CGuiView
{
...
public:
	...
	CTonghopQuansoBaoannguoinha(CWnd *pParent);
	~CTonghopQuansoBaoannguoinha();
