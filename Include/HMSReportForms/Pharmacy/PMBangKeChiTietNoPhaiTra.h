#ifndef RptPMS108_BangKeChiTietNoPhaiTra_H
#define RptPMS108_BangKeChiTietNoPhaiTra_H
...
#include "GuiView.h"
#include "DbField.h"
class CRptPMS108_BangKeChiTietNoPhaiTra : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CRptPMS108_BangKeChiTietNoPhaiTra(CWnd *pParent);
	~CRptPMS108_BangKeChiTietNoPhaiTra();
	...
	int OnAddRptPMS108_BangKeChiTietNoPhaiTra(); 
	int OnEditRptPMS108_BangKeChiTietNoPhaiTra(); 
	int OnDeleteRptPMS108_BangKeChiTietNoPhaiTra(); 
	int OnSaveRptPMS108_BangKeChiTietNoPhaiTra(); 
	int OnCancelRptPMS108_BangKeChiTietNoPhaiTra(); 
	int OnRptPMS108_BangKeChiTietNoPhaiTraListLoadData(); 
