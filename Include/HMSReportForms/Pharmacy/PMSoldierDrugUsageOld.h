#ifndef PMSoldierDrugUsageOld_H
#define PMSoldierDrugUsageOld_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSoldierDrugUsageOld : public CGuiView{
protected:
public:
	...
	CPMSoldierDrugUsageOld(CWnd *pParent);
	~CPMSoldierDrugUsageOld();
