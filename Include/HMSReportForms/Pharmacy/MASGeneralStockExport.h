#ifndef MASGeneralStockExport_H
#define MASGeneralStockExport_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASGeneralStockExport : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMASGeneralStockExport(CWnd *pParent);
	~CMASGeneralStockExport();
