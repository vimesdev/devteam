#ifndef MAConsignmentProductList2_H
#define MAConsignmentProductList2_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAConsignmentProductList2 : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMAConsignmentProductList2(CWnd *pWnd);
	~CMAConsignmentProductList2();
