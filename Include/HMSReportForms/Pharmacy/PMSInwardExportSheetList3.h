#ifndef PMSInwardExportSheetList3_H
#define PMSInwardExportSheetList3_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSInwardExportSheetList3 : public CGuiView{
protected:
public:
	...
	void			OnExport1();
	void			OnExport2();
	CPMSInwardExportSheetList3(CWnd *pParent);
	~CPMSInwardExportSheetList3();
