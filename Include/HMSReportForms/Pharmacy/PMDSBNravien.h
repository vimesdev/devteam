#ifndef PMDSBNravien_H
#define PMDSBNravien_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMDSBNravien : public CGuiView{
protected:
public:
	...
	int OnAddPMDSBNravien(); 
	int OnEditPMDSBNravien(); 
	int OnDeletePMDSBNravien(); 
	int OnSavePMDSBNravien(); 
	int OnCancelPMDSBNravien(); 
	int OnPMDSBNravienListLoadData(); 
