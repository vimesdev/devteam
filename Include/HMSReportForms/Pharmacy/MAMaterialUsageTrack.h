#ifndef MAMATERIALUSAGETRACK_H
#define MAMATERIALUSAGETRACK_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAMaterialUsageTrack : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMAMaterialUsageTrack(CWnd *pParent);
	~CMAMaterialUsageTrack();
	...
	int OnAddMAMaterialUsageTrack(); 
	int OnEditMAMaterialUsageTrack(); 
	int OnDeleteMAMaterialUsageTrack(); 
	int OnSaveMAMaterialUsageTrack(); 
	int OnCancelMAMaterialUsageTrack(); 
	int OnMAMaterialUsageTrackListLoadData();
