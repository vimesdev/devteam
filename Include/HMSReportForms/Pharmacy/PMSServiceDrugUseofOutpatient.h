#ifndef PMSSERVICEDRUGUSEOFOUTPATIENT_H
#define PMSSERVICEDRUGUSEOFOUTPATIENT_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CPMSServiceDrugUseofOutpatient : public CGuiView{
protected:
public:
	...
	CPMSServiceDrugUseofOutpatient(CWnd *pParent);
	~CPMSServiceDrugUseofOutpatient();
