#ifndef PMSoldierDrugUsage2_H
#define PMSoldierDrugUsage2_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSoldierDrugUsage2 : public CGuiView{
protected:
public:
	...
	CPMSoldierDrugUsage2(CWnd *pParent);
	~CPMSoldierDrugUsage2();
