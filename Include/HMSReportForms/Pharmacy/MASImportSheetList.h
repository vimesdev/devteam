#ifndef MASIMPORTSHEETLIST_H
#define MASIMPORTSHEETLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASImportSheetList : public CGuiView
{
protected:
public:
	...
	CGuiCheckBox	m_wndGroupByCompany;
	CGuiButton		m_wndPrintPreview;
	CGuiButton		m_wndExport;
	CGuiCheckBox	m_wndChitinhhoadonnhap;
	...
	BOOL	m_bGroupByCompany;
	BOOL	m_bChitinhhoadonnhap;
	...
	void			OnExportSelect();
	void			OnChitinhhoadonnhapSelect(); 
	CMASImportSheetList(CWnd *pParent);
	~CMASImportSheetList();
