#ifndef MASDepartmentUsageinDetail_H
#define MASDepartmentUsageinDetail_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASDepartmentUsageinDetail : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportSelect(); 
	CMASDepartmentUsageinDetail(CWnd *pParent);
	~CMASDepartmentUsageinDetail();
