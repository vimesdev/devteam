#ifndef RptPMS108_BangKeNoPhaiThu_H
#define RptPMS108_BangKeNoPhaiThu_H
...
#include "GuiView.h"
#include "DbField.h"
class CRptPMS108_BangKeNoPhaiThu : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CRptPMS108_BangKeNoPhaiThu(CWnd *pParent);
	~CRptPMS108_BangKeNoPhaiThu();
	...
	int OnAddRptPMS108_BangKeNoPhaiThu(); 
	int OnEditRptPMS108_BangKeNoPhaiThu(); 
	int OnDeleteRptPMS108_BangKeNoPhaiThu(); 
	int OnSaveRptPMS108_BangKeNoPhaiThu(); 
	int OnCancelRptPMS108_BangKeNoPhaiThu(); 
	int OnRptPMS108_BangKeNoPhaiThuListLoadData(); 
