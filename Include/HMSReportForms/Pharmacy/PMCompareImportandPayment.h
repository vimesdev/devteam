#ifndef PMCOMPAREIMPORTANDPAYMENT_H
#define PMCOMPAREIMPORTANDPAYMENT_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMCompareImportandPayment : public CGuiView{
protected:
public:
	...
	CPMCompareImportandPayment(CWnd *pParent);
	~CPMCompareImportandPayment();
	...
	int OnAddPMCompareImportandPayment(); 
	int OnEditPMCompareImportandPayment(); 
	int OnDeletePMCompareImportandPayment(); 
	int OnSavePMCompareImportandPayment(); 
	int OnCancelPMCompareImportandPayment(); 
	int OnPMCompareImportandPaymentListLoadData();
