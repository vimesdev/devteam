#ifndef MASEXPORTSHEETLISTFORINSURANCE_H
#define MASEXPORTSHEETLISTFORINSURANCE_H
...
#include "GuiView.h"
#include "DbField.h"
class CMASExportSheetListForInsurance : public CGuiView
{
...
public:
	...
	void			OnPrintPreviewSelect_V1();
	void			OnPrintPreviewSelect_V2();
	void			OnExportSelect();
	void			OnExportSelect_V1();
	void			OnExportSelect_V2();
	long			OnExportTypeLoadData(); 
	CMASExportSheetListForInsurance(CWnd *pParent);
	~CMASExportSheetListForInsurance();
