#ifndef PMSPRODUCTSUPPLYPLAN_H
#define PMSPRODUCTSUPPLYPLAN_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSProductSupplyPlan : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CPMSProductSupplyPlan(CWnd *pParent);
	~CPMSProductSupplyPlan();
