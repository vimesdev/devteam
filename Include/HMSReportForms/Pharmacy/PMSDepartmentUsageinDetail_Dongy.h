#ifndef PMSDEPARTMENTUSAGEINDETAIL_DONGY_H
#define PMSDEPARTMENTUSAGEINDETAIL_DONGY_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSDepartmentUsageinDetail_Dongy : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
	CString m_szDept_id;
public:
	...
	CGuiRadioButton	m_wndngoaitru;
	CGuiRadioButton	m_wndnoitru;
	...
	void			OnExportSelect(); 
	CPMSDepartmentUsageinDetail_Dongy(CWnd *pParent);
	~CPMSDepartmentUsageinDetail_Dongy();
	...
	void OnDeptSetCheck();
	void OnDeptSetCheck_V1();
	void OnDeptSetCheck_V2();
	void OnDeptSetCheck_All();
