#ifndef PMSDEPARTMENTUSAGEINDETAIL3108OLD_H
#define PMSDEPARTMENTUSAGEINDETAIL3108OLD_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSDepartmentUsageinDetail3_108Old : public CGuiView{
protected:
	BOOL	m_bStockCheck;
	BOOL	m_bDeptCheck;
public:
	...
	void			OnExportSelect(); 
	CPMSDepartmentUsageinDetail3_108Old(CWnd *pParent);
	~CPMSDepartmentUsageinDetail3_108Old();
