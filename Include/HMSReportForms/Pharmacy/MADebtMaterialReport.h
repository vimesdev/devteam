#ifndef MADEBTMATERIALREPORT_H
#define MADEBTMATERIALREPORT_H
...
#include "GuiView.h"
#include "DbField.h"
class CMADebtMaterialReport : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMADebtMaterialReport(CWnd *pParent);
	~CMADebtMaterialReport();
	...
	int OnAddMADebtMaterialReport(); 
	int OnEditMADebtMaterialReport(); 
	int OnDeleteMADebtMaterialReport(); 
	int OnSaveMADebtMaterialReport(); 
	int OnCancelMADebtMaterialReport(); 
	int OnMADebtMaterialReportListLoadData();
	CString GetQueryString();
	void			OnDepartmentCheckAll();
	void			OnDepartmentUncheckAll();
};
#endif
