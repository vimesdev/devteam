#ifndef MAPaymentForCompany_H
#define MAPaymentForCompany_H
...
#include "GuiView.h"
#include "DbField.h"
class CMAPaymentForCompany : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMAPaymentForCompany(CWnd *pParent);
	~CMAPaymentForCompany();
