#ifndef PMServiceDrugUsageDetail_DongY2_H
#define PMServiceDrugUsageDetail_DongY2_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMServiceDrugUsageDetail_DongY2 : public CGuiView{
protected:
	CString		m_szDept_id;
public:
	...
	void			OnExportSelect(); 
	CPMServiceDrugUsageDetail_DongY2(CWnd *pWnd);
	~CPMServiceDrugUsageDetail_DongY2();
