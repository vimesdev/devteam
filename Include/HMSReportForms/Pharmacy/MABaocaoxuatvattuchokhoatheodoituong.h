#ifndef MABaocaoxuatvattuchokhoatheodoituong_H
#define MABaocaoxuatvattuchokhoatheodoituong_H
...
#include "GuiView.h"
#include "DbField.h"
class CMABaocaoxuatvattuchokhoatheodoituong : public CGuiView{
protected:
public:
	...
	int			OnCheckAll();
	int			OnUnCheckAll();
	CMABaocaoxuatvattuchokhoatheodoituong(CWnd *pParent);
	~CMABaocaoxuatvattuchokhoatheodoituong();
	...
	void OnExportBaocaoxuathuocchokhoatheodoituong2();
