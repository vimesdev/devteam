#ifndef PMSReportConditionDialog_Dongy_H
#define PMSReportConditionDialog_Dongy_H
...
class CPMSReportConditionDialog_Dongy : public CGuiView{
protected:
	CString		m_szDept_id;
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CPMSReportConditionDialog_Dongy(CWnd *pParent, int nType);
	~CPMSReportConditionDialog_Dongy();
	...
	int OnAddPMSReportConditionDialog_Dongy(); 
	int OnEditPMSReportConditionDialog_Dongy(); 
	int OnDeletePMSReportConditionDialog_Dongy(); 
	int OnSavePMSReportConditionDialog_Dongy(); 
	int OnCancelPMSReportConditionDialog_Dongy(); 
	int OnPMSReportConditionDialog_DongyListLoadData(); 
