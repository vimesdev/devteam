#ifndef PMMaterialFinalAccount_H
#define PMMaterialFinalAccount_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMMaterialFinalAccount : public CGuiView{
protected:
public:
	...
	CPMMaterialFinalAccount(CWnd *pParent);
	~CPMMaterialFinalAccount();
