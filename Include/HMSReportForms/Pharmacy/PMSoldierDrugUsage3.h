#ifndef PMSoldierDrugUsage3_H
#define PMSoldierDrugUsage3_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMSoldierDrugUsage3 : public CGuiView{
protected:
public:
	...
	CPMSoldierDrugUsage3(CWnd *pParent);
	~CPMSoldierDrugUsage3();
