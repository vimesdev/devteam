#ifndef MADETAILHIGHTECHMATERIAL2_H
#define MADETAILHIGHTECHMATERIAL2_H
...
#include "GuiView.h"
#include "DbField.h"
class CMADetailHightechMaterial2 : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CMADetailHightechMaterial2(CWnd *pParent);
	~CMADetailHightechMaterial2();
