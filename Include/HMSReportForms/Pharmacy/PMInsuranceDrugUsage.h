#ifndef PMINSURANCEDRUGUSAGE_H
#define PMINSURANCEDRUGUSAGE_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMInsuranceDrugUsage : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CPMInsuranceDrugUsage(CWnd *pParent);
	~CPMInsuranceDrugUsage();
