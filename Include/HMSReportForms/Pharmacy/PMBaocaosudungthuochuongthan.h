#ifndef PMBaocaosudungthuochuongthan_H
#define PMBaocaosudungthuochuongthan_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMBaocaosudungthuochuongthan : public CGuiView{
protected:
public:
	...
	void			OnObjectAddNew(); 
	CPMBaocaosudungthuochuongthan(CWnd *pParent);
	~CPMBaocaosudungthuochuongthan();
	...
	int OnAddPMBaocaosudungthuochuongthan(); 
	int OnEditPMBaocaosudungthuochuongthan(); 
	int OnDeletePMBaocaosudungthuochuongthan(); 
	int OnSavePMBaocaosudungthuochuongthan(); 
	int OnCancelPMBaocaosudungthuochuongthan(); 
	int OnPMBaocaosudungthuochuongthanListLoadData(); 
	int			OnListSelectAll(); 
