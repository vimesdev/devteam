#ifndef BLOODBANKLISTSERVICEUNPAID_H
#define BLOODBANKLISTSERVICEUNPAID_H
...
#include "GuiView.h"
#include "DbField.h"
class CBloodBankListServiceUnPaid : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CBloodBankListServiceUnPaid(CWnd *pParent);
	~CBloodBankListServiceUnPaid();
