...
public:
	...
	CGuiCheckBox	m_wndImportDate;
	CGuiDateTimeCtrl	m_wndimpFromDate;
	CGuiLabel		m_wndImportToDateLabel;
	CGuiDateTimeCtrl	m_wndimpToDate;
	...
	CString	m_szToDate;
	BOOL	m_bImportDate;
	CString	m_szimpFromDate;
	CString	m_szimpToDate;
	...
	void			OnImportDateSelect(); 
	//void			OnimpFromDateChange(); 
	//void			OnimpFromDateSetfocus(); 
	//void			OnimpFromDateKillfocus(); 
	int			OnimpFromDateCheckValue(); 
	//void			OnimpToDateChange(); 
	//void			OnimpToDateSetfocus(); 
	//void			OnimpToDateKillfocus(); 
	int			OnimpToDateCheckValue(); 
