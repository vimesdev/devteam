#ifndef PMCONFIRMLIABILITIES_H
#define PMCONFIRMLIABILITIES_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMConfirmLiabilities : public CGuiView{
protected:
public:
	...
	void			OnContractSelectChange(int nOldItem, int nNewItem); 
	void			OnContractDblClick(); 
	int			OnContractDeleteItem(); 
	CPMConfirmLiabilities();
	~CPMConfirmLiabilities();
