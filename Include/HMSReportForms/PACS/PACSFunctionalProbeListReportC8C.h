#ifndef PACSFUNCTIONALPROBELISTREPORTC8C_H
#define PACSFUNCTIONALPROBELISTREPORTC8C_H
...
#include "GuiView.h"
#include "DbField.h"
class CPACSFunctionalProbeListReportC8C : public CGuiView
{
...
public:
	...
	void			OnExportSelect();
	void			OnExport();
	void			OnExport_V2(BOOL bDetail=TRUE);
	void			OnKhamsuckhoe_TYCSelect(); 

	CPACSFunctionalProbeListReportC8C(CWnd* pParent);
	~CPACSFunctionalProbeListReportC8C();
	...
	CString GetQueryString(BOOL bDetail = TRUE);
