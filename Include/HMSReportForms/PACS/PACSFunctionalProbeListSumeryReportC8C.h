#ifndef PACSFUNCTIONALPROBELISTSUMERYREPORTC8C_H
#define PACSFUNCTIONALPROBELISTSUMERYREPORTC8C_H
...
#include "GuiView.h"
#include "DbField.h"
class CPACSFunctionalProbeListSumeryReportC8C : public CGuiView
{
...
public:
	...
	CPACSFunctionalProbeListSumeryReportC8C(CWnd* pParent);
	~CPACSFunctionalProbeListSumeryReportC8C();
