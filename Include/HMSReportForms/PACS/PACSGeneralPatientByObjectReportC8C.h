#ifndef PACSGENERALPATIENTBYOBJECTREPORTC8C_H
#define PACSGENERALPATIENTBYOBJECTREPORTC8C_H
...
class CPACSGeneralPatientByObjectReportC8C : public CGuiView
{
protected:
public:
	...
	CPACSGeneralPatientByObjectReportC8C(CWnd* pParent);
	~CPACSGeneralPatientByObjectReportC8C();
