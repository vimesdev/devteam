#ifndef PACSWAITINGREPORTC8C_H
#define PACSWAITINGREPORTC8C_H
...
#include "GuiView.h"
#include "DbField.h"
class CPACSWaitingReportC8C : public CGuiView
{
protected:
public:
	...
	CPACSWaitingReportC8C(CWnd* pParent);
	~CPACSWaitingReportC8C();
