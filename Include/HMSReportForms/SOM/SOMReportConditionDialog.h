#ifndef SOMReportConditionDialog_H
#define SOMReportConditionDialog_H
...
class CSOMReportConditionDialog : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CSOMReportConditionDialog(CWnd *pParent, int nType);
	~CSOMReportConditionDialog();
	...
	int OnAddSOMReportConditionDialog(); 
	int OnEditSOMReportConditionDialog(); 
	int OnDeleteSOMReportConditionDialog(); 
	int OnSaveSOMReportConditionDialog(); 
	int OnCancelSOMReportConditionDialog(); 
	int OnSOMReportConditionDialogListLoadData(); 
