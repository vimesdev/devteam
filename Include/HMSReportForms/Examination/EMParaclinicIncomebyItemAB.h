#ifndef EMPARACLINICINCOMEBYITEMAB_H
#define EMPARACLINICINCOMEBYITEMAB_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMParaclinicIncomebyItemAB : public CGuiView
{
protected:
public:
	...
	CEMParaclinicIncomebyItemAB(CWnd *pParent);
	~CEMParaclinicIncomebyItemAB();
