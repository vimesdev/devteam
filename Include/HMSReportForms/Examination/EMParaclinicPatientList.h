#ifndef EMPARACLINICPATIENTLIST_H
#define EMPARACLINICPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMParaclinicPatientList : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CEMParaclinicPatientList(CWnd* pParent);
	~CEMParaclinicPatientList();
