#ifndef EMSPRESCRIPTIONLISTREPORTDIALOG_H
#define EMSPRESCRIPTIONLISTREPORTDIALOG_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMSPrescriptionListReportDialog : public CGuiView{
protected:
public:
	...
	void			OnObjectAddNew(); 
	CEMSPrescriptionListReportDialog(CWnd *pParent);
