#ifndef EMGENERALINSURANCEEXPENSE_H
#define EMGENERALINSURANCEEXPENSE_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMGeneralInsuranceExpense : public CGuiView{
protected:
public:
	...
	//void			OnDoctorAddNew(); 
	void			OnExportSelect(); 
	CEMGeneralInsuranceExpense(CWnd *pWnd);
	~CEMGeneralInsuranceExpense();
