#ifndef EMTESTMONEYBYPATIENT_H
#define EMTESTMONEYBYPATIENT_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMTestMoneybyPatient : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CEMTestMoneybyPatient(CWnd *pParent);
	~CEMTestMoneybyPatient();
