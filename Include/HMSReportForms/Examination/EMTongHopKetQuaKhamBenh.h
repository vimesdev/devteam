#ifndef EMTongHopKetQuaKhamBenh_H
#define EMTongHopKetQuaKhamBenh_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CEMTongHopKetQuaKhamBenh : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CEMTongHopKetQuaKhamBenh(CWnd *pParent);
	~CEMTongHopKetQuaKhamBenh();
	CEMTongHopKetQuaKhamBenh &operator=(const CEMTongHopKetQuaKhamBenh& rpt);
