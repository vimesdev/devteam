#ifndef EMTotalTestIncomeHightech_H
#define EMTotalTestIncomeHightech_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMTotalTestIncomeHightech : public CGuiView{
protected:
public:
	...
	//void			OnDoctorAddNew(); 
	void			OnExportSelect(); 
	CEMTotalTestIncomeHightech(CWnd *pWnd);
	~CEMTotalTestIncomeHightech();
