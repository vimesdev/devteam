#ifndef RPTBCHANGTHANGKHOAKHAMAB_H
#define RPTBCHANGTHANGKHOAKHAMAB_H
...
#include "GuiView.h"
#include "DbField.h"
class CRptBCHangThangKhoaKhamAB : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CRptBCHangThangKhoaKhamAB(CWnd *pParent);
	~CRptBCHangThangKhoaKhamAB();
