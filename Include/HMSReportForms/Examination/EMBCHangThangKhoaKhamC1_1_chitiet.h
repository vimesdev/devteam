#ifndef RPTBCHANGTHANGKHOAKHAMC1_1_CHITIET_H
#define RPTBCHANGTHANGKHOAKHAMC1_1_CHITIET_H
...
#include "GuiView.h"
#include "DbField.h"
class CRptBCHangThangKhoaKhamC1_1_Chitiet : public CGuiView
{
protected:
public:
	...
	CGuiRadioButton	m_wndPatient;
	CGuiRadioButton	m_wndTurn;
	CGuiRadioButton	m_wndDrugOrder;
	CGuiRadioButton	m_wndGoDept;
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CRptBCHangThangKhoaKhamC1_1_Chitiet(CWnd *pParent);
	~CRptBCHangThangKhoaKhamC1_1_Chitiet();
