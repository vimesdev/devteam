...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CEMToothB10 : public CGuiView
{
protected:
public:
	...
	int OnAddEMToothB10(); 
	int OnEditEMToothB10(); 
	int OnDeleteEMToothB10(); 
	int OnSaveEMToothB10(); 
	int OnCancelEMToothB10(); 
	int OnEMToothB10ListLoadData(); 
