#ifndef EMQUANSOTRUNGTAMDITRUYEN_H
#define EMQUANSOTRUNGTAMDITRUYEN_H
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "GuiView.h"
#include "DbField.h"
class CEMQuanSoTrungTamDiTruyen : public CGuiView
{
protected:
...
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CEMQuanSoTrungTamDiTruyen(CWnd *pParent);
	~CEMQuanSoTrungTamDiTruyen();
