#ifndef EMPARACLINICINCOMEBYITEM_H
#define EMPARACLINICINCOMEBYITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class CEMParaclinicIncomebyItem : public CGuiView{
protected:
public:
	...
	CEMParaclinicIncomebyItem(CWnd *pParent);
	~CEMParaclinicIncomebyItem();
