#ifndef LASERTHAMMYREPORTS_H
#define LASERTHAMMYREPORTS_H
...
class CEMDieutrilaserthammy : public CGuiView
{
...
public:
	...
	int OnAddEMDieutrilaserthammy(); 
	int OnEditEMDieutrilaserthammy(); 
	int OnDeleteEMDieutrilaserthammy(); 
	int OnSaveEMDieutrilaserthammy(); 
	int OnCancelEMDieutrilaserthammy(); 
	int OnEMDieutrilaserthammyListLoadData(); 
