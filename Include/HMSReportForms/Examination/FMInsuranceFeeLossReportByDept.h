#ifndef FMINSURANCEFEELOSSREPORTBYDEPT_H
#define FMINSURANCEFEELOSSREPORTBYDEPT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceFeeLossReportByDept : public CGuiView
{
protected:
public:
	...
	void			OnPrintSelect(); 
	void			OnExportSelect(); 
	CFMInsuranceFeeLossReportByDept(CWnd* pParent);
	~CFMInsuranceFeeLossReportByDept();
