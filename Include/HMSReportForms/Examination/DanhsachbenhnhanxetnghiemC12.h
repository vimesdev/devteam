#ifndef DANHSACHBENHNHANXETNGHIEMC12_H
#define DANHSACHBENHNHANXETNGHIEMC12_H
...
#include "GuiView.h"
#include "DbField.h"
class CDanhsachbenhnhanxetnghiemC12 : public CGuiView
{
...
public:
	...
	CDanhsachbenhnhanxetnghiemC12(CWnd *pParent);
	~CDanhsachbenhnhanxetnghiemC12();
	...
	int OnAddLIMSTestPatientList(); 
	int OnEditLIMSTestPatientList(); 
	int OnDeleteLIMSTestPatientList(); 
	int OnSaveLIMSTestPatientList(); 
	int OnCancelLIMSTestPatientList(); 
	int OnLIMSTestPatientListListLoadData();
