#ifndef IVFGeneralStockExport_H
#define IVFGeneralStockExport_H
...
#include "GuiView.h"
#include "DbField.h"
class CIVFGeneralStockExport : public CGuiView
...
public:
	...
	void			OnExportSelect(); 
	CIVFGeneralStockExport(CWnd *pParent);
	~CIVFGeneralStockExport();
