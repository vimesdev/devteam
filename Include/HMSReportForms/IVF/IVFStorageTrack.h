#ifndef IVFSTORAGETRACK_H
#define IVFSTORAGETRACK_H
...
#include "GuiView.h"
#include "DbField.h"
class CIVFStorageTrack : public CGuiView{
protected:
public:
	...
	int OnAddIVFStorageTrack(); 
	int OnEditIVFStorageTrack(); 
	int OnDeleteIVFStorageTrack(); 
	int OnSaveIVFStorageTrack(); 
	int OnCancelIVFStorageTrack(); 
	int OnIVFStorageTrackListLoadData(); 
