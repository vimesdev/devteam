#ifndef IVFPRESCRIPTIONLISTREPORTDIALOG_H
#define IVFPRESCRIPTIONLISTREPORTDIALOG_H
...
#include "GuiView.h"
#include "DbField.h"
class IVFPrescriptionListReportDialog : public CGuiView
...
public:
	...
	void			OnObjectAddNew(); 
	IVFPrescriptionListReportDialog(CWnd *pParent);
	~IVFPrescriptionListReportDialog();
