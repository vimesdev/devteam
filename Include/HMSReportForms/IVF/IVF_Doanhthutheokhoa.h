#ifndef IVF_DOANHTHUTHEOKHOA_H
#define IVF_DOANHTHUTHEOKHOA_H
...
#include "GuiView.h"
#include "DbField.h"
class CIVFDoanhthutheokhoa : public CGuiView
{
...
public:
	...
	CIVFDoanhthutheokhoa(CWnd *pWnd);
	~CIVFDoanhthutheokhoa();
