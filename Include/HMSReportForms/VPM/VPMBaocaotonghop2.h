#ifndef VPMBAOCAOTONGHOP2_H
#define VPMBAOCAOTONGHOP2_H
...
#include "GuiView.h"
#include "DbField.h"
class CVPMBaocaotonghop2 : public CGuiView{
protected:
public:
	...
	void			OnLoadSelect(); 
	void			OnExportSelect(); 
	CVPMBaocaotonghop2(CWnd *pParent);
	~CVPMBaocaotonghop2();
	...
	int OnAddVPMBaocaotonghop2(); 
	int OnEditVPMBaocaotonghop2(); 
	int OnDeleteVPMBaocaotonghop2(); 
	int OnSaveVPMBaocaotonghop2(); 
	int OnCancelVPMBaocaotonghop2(); 
	int OnVPMBaocaotonghop2ListLoadData();
