#ifndef SRMThuthapthongtinsudungthuoc_H
#define SRMThuthapthongtinsudungthuoc_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMThuthapthongtinsudungthuoc : public CGuiView{
protected:
public:
	...
	int			OnCheckAll();
	int			OnUnCheckAll();
	CSRMThuthapthongtinsudungthuoc(CWnd *pParent);
	~CSRMThuthapthongtinsudungthuoc();
	...
	int OnAddSRMThuthapthongtinsudungthuoc(); 
	int OnEditSRMThuthapthongtinsudungthuoc(); 
	int OnDeleteSRMThuthapthongtinsudungthuoc(); 
	int OnSaveSRMThuthapthongtinsudungthuoc(); 
	int OnCancelSRMThuthapthongtinsudungthuoc(); 
	int OnSRMThuthapthongtinsudungthuocListLoadData(); 
	DECLARE_MESSAGE_MAP()
