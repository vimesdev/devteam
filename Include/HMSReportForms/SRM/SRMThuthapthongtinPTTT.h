#ifndef SRMThuthapthongtinPTTT_H
#define SRMThuthapthongtinPTTT_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMThuthapthongtinPTTT : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndReportCondition;
	CGuiGroupBox	m_wndDepartment;
	...
	CSRMThuthapthongtinPTTT(CWnd *pParent);
	~CSRMThuthapthongtinPTTT();
	...
	int OnAddSRMThuthapthongtinPTTT(); 
	int OnEditSRMThuthapthongtinPTTT(); 
	int OnDeleteSRMThuthapthongtinPTTT(); 
	int OnSaveSRMThuthapthongtinPTTT(); 
	int OnCancelSRMThuthapthongtinPTTT(); 
	int OnSRMThuthapthongtinPTTTListLoadData();
	int OnSelectAll();
	int OnUnSelectAll();
};
#endif
