#ifndef SRMTHUTHAPTHONGTINCLS_H
#define SRMTHUTHAPTHONGTINCLS_H
...
#include "GuiView.h"
#include "DbField.h"
class CSRMThuthapthongtinCLS: public CGuiView{
protected:
public:
	...
	CSRMThuthapthongtinCLS(CWnd *pParent);
	~CSRMThuthapthongtinCLS();
