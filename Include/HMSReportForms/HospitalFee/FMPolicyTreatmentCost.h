#ifndef FMPOLICYTREATMENTCOST_H
#define FMPOLICYTREATMENTCOST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyTreatmentCost : public CGuiView
{
...
public:
	...
	CFMPolicyTreatmentCost(CWnd* pParent);
	~CFMPolicyTreatmentCost();
