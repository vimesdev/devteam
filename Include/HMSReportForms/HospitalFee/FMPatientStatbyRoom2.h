#ifndef FMPATIENTSTATBYROOM2_H
#define FMPATIENTSTATBYROOM2_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CFMPatientStatbyRoom2 : public CGuiView
{
protected:
	CString m_szDeptID;
public:
	...
	void			OnExportDetail();
	void			OnExportTotal();
	void			OnExportTotalByPatient();
	void			OnExportDetailBydocno();
	void			OnSODSelect();
	CFMPatientStatbyRoom2(CWnd *pParent);
	~CFMPatientStatbyRoom2();
	...
	int OnAddEMPatientStatbyRoom2(); 
	int OnEditEMPatientStatbyRoom2(); 
	int OnDeleteEMPatientStatbyRoom2(); 
	int OnSaveEMPatientStatbyRoom2(); 
	int OnCancelEMPatientStatbyRoom2(); 
	int OnEMPatientStatbyRoom2ListLoadData();
	CString GetQueryStringDetail();
	CString GetQueryStringTotal();
	CString GetQueryStringTotalByPatient();
	CString GetQueryStringBydocno();
