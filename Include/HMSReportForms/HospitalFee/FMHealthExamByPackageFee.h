#ifndef FMHealthExamByPackageFee_H
#define FMHealthExamByPackageFee_H
...
class CFMHealthExamByPackageFee : public CGuiView
{
...
public:
	...
	CFMHealthExamByPackageFee(CWnd *pWnd);
	~CFMHealthExamByPackageFee();
	...
	int OnAddFMHealthExamByPackageFee(); 
	int OnEditFMHealthExamByPackageFee(); 
	int OnDeleteFMHealthExamByPackageFee(); 
	int OnSaveFMHealthExamByPackageFee(); 
	int OnCancelFMHealthExamByPackageFee(); 
	int OnFMHealthExamByPackageFeeListLoadData(); 
