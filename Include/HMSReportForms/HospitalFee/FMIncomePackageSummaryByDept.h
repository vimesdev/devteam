#ifndef FMINCOMEPACKAGESUMMARYBYDEPT_H
#define FMINCOMEPACKAGESUMMARYBYDEPT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMIncomePackageSummaryByDept : public CGuiView
{
protected:
...
public:
	...
	CFMIncomePackageSummaryByDept(CWnd *pParent);
	~CFMIncomePackageSummaryByDept();
