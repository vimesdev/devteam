#ifndef FMPAIDTREATMENTCOSTSUMMARY_H
#define FMPAIDTREATMENTCOSTSUMMARY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPaidTreatmentCostSummary : public CGuiView{
protected:
public:
	...
	CFMPaidTreatmentCostSummary(CWnd *pParent);
	~CFMPaidTreatmentCostSummary();
