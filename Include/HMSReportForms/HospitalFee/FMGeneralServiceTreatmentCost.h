#ifndef FMGENERALSERVICETREATMENTCOST_H
#define FMGENERALSERVICETREATMENTCOST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMGeneralServiceTreatmentCost : public CGuiView
{
protected:
public:
	...
	void			OnLockedSelect(); 
	CFMGeneralServiceTreatmentCost(CWnd* pParent);
	~CFMGeneralServiceTreatmentCost();
	...
	int OnAddFMGeneralServiceTreatmentCost(); 
	int OnEditFMGeneralServiceTreatmentCost(); 
	int OnDeleteFMGeneralServiceTreatmentCost(); 
	int OnSaveFMGeneralServiceTreatmentCost(); 
	int OnCancelFMGeneralServiceTreatmentCost(); 
	int OnFMGeneralServiceTreatmentCostListLoadData();
