#ifndef FMGENERALINSURANCEINCOMELIST_H
#define FMGENERALINSURANCEINCOMELIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMGeneralInsuranceIncomeList : public CGuiView{
protected:
public:
	...
	void			OnLockedSelect(); 
	CFMGeneralInsuranceIncomeList(CWnd *pParent);
	~CFMGeneralInsuranceIncomeList();
