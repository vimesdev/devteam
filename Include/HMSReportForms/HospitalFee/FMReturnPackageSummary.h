#ifndef FMRETURNPACKAGESUMMARY_H
#define FMRETURNPACKAGESUMMARY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMReturnPackageSummary : public CGuiView
{
protected:
...
public:
	...
	CFMReturnPackageSummary(CWnd *pParent);
	~CFMReturnPackageSummary();
