#ifndef FMBookEntriesRegisterTableReport_H
#define FMBookEntriesRegisterTableReport_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS FMBookEntriesRegisterTableReport : public CGuiView{
protected:
public:	
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	FMBookEntriesRegisterTableReport(CWnd *pParent);
