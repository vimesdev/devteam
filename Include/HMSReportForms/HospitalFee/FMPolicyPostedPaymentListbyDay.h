#ifndef FMPolicyPostedPaymentListByDay_H
#define FMPolicyPostedPaymentListByDay_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyPostedPaymentListbyDay : public CGuiView{
protected:
...
public:
	...
	CFMPolicyPostedPaymentListbyDay(CWnd *pWnd);
	~CFMPolicyPostedPaymentListbyDay();
