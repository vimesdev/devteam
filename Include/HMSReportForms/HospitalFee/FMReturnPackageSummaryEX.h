#ifndef FMRETURNPACKAGESUMMARYEX_H
#define FMRETURNPACKAGESUMMARYEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMReturnPackageSummaryEX : public CGuiView
{
protected:
...
public:
	...
	CFMReturnPackageSummaryEX(CWnd *pParent);
	~CFMReturnPackageSummaryEX();
