#ifndef FMFEEFOODLIST_H
#define FMFEEFOODLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFeeFoodList : public CGuiView{
protected:
public:
	...
	int OnAddFMFeeFoodList(); 
	int OnEditFMFeeFoodList(); 
	int OnDeleteFMFeeFoodList(); 
	int OnSaveFMFeeFoodList(); 
	int OnCancelFMFeeFoodList(); 
	int OnFMFeeFoodListListLoadData();
