#ifndef FMINSURANCEDEPOSITLISTCANCEL_H
#define FMINSURANCEDEPOSITLISTCANCEL_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceDepositListCancel : public CGuiView
{
protected:
public:
	...
	CGuiCheckBox	m_wndLockedNotPosted;
	long	m_nYear;
	CString	m_szReportPeriodKey;
	CString	m_szFromDate;
	CString	m_szToDate;
	CString	m_szClerkKey;
	BOOL	m_bLockedNotPosted;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	CFMInsuranceDepositListCancel(CWnd* pParent);
	~CFMInsuranceDepositListCancel();
