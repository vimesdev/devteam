#ifndef FMPOLICYUNPAIDDEPOSITLIST_H
#define FMPOLICYUNPAIDDEPOSITLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyUnpaidDepositList : public CGuiView
{
protected:
public:
	...
	CFMPolicyUnpaidDepositList(CWnd* pParent);
	~CFMPolicyUnpaidDepositList();
