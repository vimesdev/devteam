#ifndef FMPolicyPostedPaymentList_H
#define FMPolicyPostedPaymentList_H
...
class CFMPolicyPostedPaymentList : public CGuiView
{
protected:
...
public:
	...
	CGuiCheckBox	m_wndChichinhsach;
	long	m_nYear;
	...
	CFMPolicyPostedPaymentList(CWnd *pWnd);
	~CFMPolicyPostedPaymentList();
