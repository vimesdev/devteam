#ifndef FMInsurancePostedPaymentVoucherList_H
#define FMInsurancePostedPaymentVoucherList_H
...
class CFMInsurancePostedPaymentVoucherList : public CGuiView
{
...
public:
	...
	CFMInsurancePostedPaymentVoucherList(CWnd *pWnd);
	~CFMInsurancePostedPaymentVoucherList();
