#ifndef FMFMChiTietTheoDanhMuc_2024_H
#define FMFMChiTietTheoDanhMuc_2024_H
...
class CFMChiTietTheoDanhMuc_2024 : public CGuiView
{

protected:
	CMap<CString, LPCTSTR, CString, LPCTSTR> m_mIndex;
	CString		m_szCashQuery;
	void		InitGroupInfo(CRecord* pRs, GROUP_INFO2 (*grp_info)[2], int& nDepth, int& nColNum);
public:
	CString		m_szCashIDS;
	...
	CFMChiTietTheoDanhMuc_2024(CWnd *pWnd);
	~CFMChiTietTheoDanhMuc_2024();
