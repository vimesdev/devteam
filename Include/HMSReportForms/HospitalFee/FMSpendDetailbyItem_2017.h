#ifndef FMSpendDetailbyItem_2017H
#define FMSpendDetailbyItem_2017H
...
#include "GuiView.h"
#include "DbField.h"
class CFMSpendDetailByItem_2017 : public CGuiView
{
protected:
...
public:
	...
	CFMSpendDetailByItem_2017(CWnd *pWnd);
	~CFMSpendDetailByItem_2017();
	...
	int OnListCheckAllDVCLC();
	int OnListUnCheckAllDVCLC();
};
#endif
