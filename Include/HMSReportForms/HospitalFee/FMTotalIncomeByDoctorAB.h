#ifndef FMTotalInComeByDoctorAB_H
#define FMTotalInComeByDoctorAB_H
...
class CFMTotalInComeByDoctorAB : public CGuiView
{
protected:
...
public:
	...
	CFMTotalInComeByDoctorAB(CWnd *pWnd);
	~CFMTotalInComeByDoctorAB();
