#ifndef FMEINVOICEPOSTFAIL_H
#define FMEINVOICEPOSTFAIL_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMEinvoicepostfailReport : public CGuiView
{
...
public:
	...
	CGuiCheckBox	m_wndHoadonbihuy;
	CGuiCheckBox	m_wndNodata;
	...
	void			OnPolicySelect();
	void			OnHoadonbihuySelect();
	void			OnNodataSelect();
	void			OnPostedSelect();
	CFMEinvoicepostfailReport(CWnd* pParent);
	~CFMEinvoicepostfailReport();
