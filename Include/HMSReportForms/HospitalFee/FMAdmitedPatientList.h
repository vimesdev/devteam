#ifndef FMADMITEDPATIENTLIST_H
#define FMADMITEDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMAdmitedPatientList : public CGuiView
{
protected:
public:
	...
	CFMAdmitedPatientList(CWnd* pParent);
	~CFMAdmitedPatientList();
	...
	int OnAddFMAdmitedPatientList(); 
	int OnEditFMAdmitedPatientList(); 
	int OnDeleteFMAdmitedPatientList(); 
	int OnSaveFMAdmitedPatientList(); 
	int OnCancelFMAdmitedPatientList(); 
	int OnFMAdmitedPatientListListLoadData();
