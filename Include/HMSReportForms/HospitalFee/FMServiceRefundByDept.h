#ifndef FMSERVICEREFUNDBYDEPT_H
#define FMSERVICEREFUNDBYDEPT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceRefundByDept : public CGuiView{
protected:
	CString		m_szWhere;
public:
	CString		m_szCashIDS;
	...
	CFMServiceRefundByDept(CWnd *pParent);
	~CFMServiceRefundByDept();
