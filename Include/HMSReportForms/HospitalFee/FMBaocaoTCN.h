#ifndef FMBAOCAOTPCN_H
#define FMBAOCAOTPCN_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMBaocaoTPCN : public CGuiView
{
protected:
public:
	...
	CGuiCheckBox	m_wndkotinhyeucau;
	long	m_nYear;
