#ifndef FMServiceMedicalIncomingOutgoingReport_H
#define FMServiceMedicalIncomingOutgoingReport_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS FMServiceMedicalIncomingOutgoingReport : public CGuiView{
protected:
public:	
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	FMServiceMedicalIncomingOutgoingReport(CWnd *pParent);
	~FMServiceMedicalIncomingOutgoingReport();
