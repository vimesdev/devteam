#ifndef FMINCOMEPACKAGEPATIENTLIST_H
#define FMINCOMEPACKAGEPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMIncomePackagePatientList : public CGuiView
{
protected:
...
public:
	...
	CFMIncomePackagePatientList(CWnd *pParent);
	~CFMIncomePackagePatientList();
