#ifndef FMTotalRefundByFeeTypeAB_H
#define FMTotalRefundByFeeTypeAB_H
...
class CFMTotalRefundByFeeTypeAB : public CGuiView
{
protected:
...
public:
	...
	CFMTotalRefundByFeeTypeAB(CWnd *pWnd);
	~CFMTotalRefundByFeeTypeAB();
