#ifndef FMSERVICEINCOMELIST3_H
#define FMSERVICEINCOMELIST3_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceIncomeList3 : public CGuiView
{
protected:
public:
	...
	CFMServiceIncomeList3(CWnd *pParent);
	~CFMServiceIncomeList3();
