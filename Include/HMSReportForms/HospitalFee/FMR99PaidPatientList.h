#ifndef FMR99PAIDPATIENTLIST_H
#define FMR99PAIDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMR99PaidPatientList : public CGuiView{
protected:
public:
	...
	void			OnExportSelect(); 
	CFMR99PaidPatientList(CWnd *pParent);
	~CFMR99PaidPatientList();
