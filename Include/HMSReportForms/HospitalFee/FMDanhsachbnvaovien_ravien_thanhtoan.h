#ifndef FMDANHSACHVAOVIENRAVIENTHANHTOAN_H
#define FMDANHSACHVAOVIENRAVIENTHANHTOAN_H
...
#include "DbField.h"
#include "Excel.h"
class AFX_EXT_CLASS CFMDanhsachbnvaovienravienthanhtoan : public CGuiView
{
...
public:
	...
	CFMDanhsachbnvaovienravienthanhtoan(CWnd* pParent);
	~CFMDanhsachbnvaovienravienthanhtoan();
	...
	int OnAddFMDischargeDepositUnpaidReport(); 
	int OnEditFMDischargeDepositUnpaidReport(); 
	int OnDeleteFMDischargeDepositUnpaidReport(); 
	int OnSaveFMDischargeDepositUnpaidReport(); 
	int OnCancelFMDischargeDepositUnpaidReport(); 
	int OnFMDischargeDepositUnpaidReportListLoadData();
	...
	void OnMergeMultiCell(CExcel *xls, int arrCols[], int nArrSize, int nRow, CString szType, int nQty);
};
#endif
