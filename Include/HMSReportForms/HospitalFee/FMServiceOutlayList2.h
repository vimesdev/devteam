#ifndef FMSERVICEOUTLAYLIST2_H
#define FMSERVICEOUTLAYLIST2_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceOutlayList2 : public CGuiView
{
protected:
public:
	...
	CFMServiceOutlayList2(CWnd *pParent);
	~CFMServiceOutlayList2();
