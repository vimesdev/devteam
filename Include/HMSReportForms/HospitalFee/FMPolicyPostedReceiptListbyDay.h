#ifndef FMPolicyPostedReceiptListByDay_H
#define FMPolicyPostedReceiptListByDay_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyPostedReceiptListbyDay : public CGuiView{
protected:
...
public:
	...
	CFMPolicyPostedReceiptListbyDay(CWnd *pWnd);
	~CFMPolicyPostedReceiptListbyDay();
