#ifndef FMRETURNPACKAGESUMMARYBYDEPT_H
#define FMRETURNPACKAGESUMMARYBYDEPT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMReturnPackageSummaryByDept : public CGuiView
{
...
public:
	...
	CFMReturnPackageSummaryByDept(CWnd *pParent);
	~CFMReturnPackageSummaryByDept();
