#ifndef FMPOLICYDEPOSITLIST_H
#define FMPOLICYDEPOSITLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMPolicyDepositList : public CGuiView
{
protected:
public:
	...
	CFMPolicyDepositList(CWnd* pParent);
	~CFMPolicyDepositList();
