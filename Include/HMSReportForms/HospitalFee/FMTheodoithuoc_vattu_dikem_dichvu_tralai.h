#ifndef FMDANHSACHTHUOCVATTUDIKEMDICHVU_H
#define FMDANHSACHTHUOCVATTUDIKEMDICHVU_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDanhsachthuoc_vattu_dikem_dichvu_tralai : public CGuiView
{
...
public:
	...
	CFMDanhsachthuoc_vattu_dikem_dichvu_tralai(CWnd* pParent);
	~CFMDanhsachthuoc_vattu_dikem_dichvu_tralai();
