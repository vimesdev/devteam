#ifndef FMSERVICETREATMENTCOSTBYDAY_H
#define FMSERVICETREATMENTCOSTBYDAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceTreatmentCostByDay : public CGuiView
{
protected:
public:
	...
	CFMServiceTreatmentCostByDay(CWnd* pParent);
	~CFMServiceTreatmentCostByDay();
	...
	int OnAddFMServiceTreatmentCostByDay(); 
	int OnEditFMServiceTreatmentCostByDay(); 
	int OnDeleteFMServiceTreatmentCostByDay(); 
	int OnSaveFMServiceTreatmentCostByDay(); 
	int OnCancelFMServiceTreatmentCostByDay(); 
	int OnFMServiceTreatmentCostByDayListLoadData();
