#ifndef FMSOMFoodPaidSummary_H
#define FMSOMFoodPaidSummary_H
...
class CFMSOMFoodPaidSummary : public CGuiView
{
protected:
...
public:
	...
	CFMSOMFoodPaidSummary(CWnd *pWnd);
	~CFMSOMFoodPaidSummary();
	...
	int OnAddFMSOMFoodPaidSummary(); 
	int OnEditFMSOMFoodPaidSummary(); 
	int OnDeleteFMSOMFoodPaidSummary(); 
	int OnSaveFMSOMFoodPaidSummary(); 
	int OnCancelFMSOMFoodPaidSummary(); 
	int OnFMSOMFoodPaidSummaryListLoadData(); 
