#ifndef FMFEECANCELPATIENTLIST_H
#define FMFEECANCELPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFeeCancelPatientList : public CGuiView
{
protected:
public:
	...
	CFMFeeCancelPatientList(CWnd* pParent);
	~CFMFeeCancelPatientList();
