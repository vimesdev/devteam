#ifndef FMInsuranceReceiptSummary_H
#define FMInsuranceReceiptSummary_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceReceiptSummary : public CGuiView
{
protected:
...
public:
	...
	CFMInsuranceReceiptSummary(CWnd *pWnd);
	~CFMInsuranceReceiptSummary();
