#ifndef FMHEALTHEXAMLIST_H
#define FMHEALTHEXAMLIST_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CFMHealthExamList : public CGuiDialog{
protected:
public:
	CGuiGroupBox	m_wndHealthExamList;
	...
	void			OnExportSelect(); 
	void			OnPrintSelect(); 
	CFMHealthExamList(CWnd *pParent);
	~CFMHealthExamList();
