#ifndef FMInsurancePostedReceiptVoucherListSOM_H
#define FMInsurancePostedReceiptVoucherListSOM_H
...
class CFMInsurancePostedReceiptVoucherListSOM : public CGuiView
{
protected:
...
public:
	...
	CFMInsurancePostedReceiptVoucherListSOM(CWnd *pWnd);
	~CFMInsurancePostedReceiptVoucherListSOM();
