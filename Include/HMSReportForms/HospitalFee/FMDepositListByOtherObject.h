#ifndef FMDepositListByOtherObject_H
#define FMDepositListByOtherObject_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDepositListByOtherObject : public CGuiView
{
protected:
public:
	...
	CFMDepositListByOtherObject(CWnd *pParent);
	~CFMDepositListByOtherObject();
