#ifndef FMADMITEDPATIENTLISTBYDAY_H
#define FMADMITEDPATIENTLISTBYDAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMAdmitedPatientListByDay : public CGuiView
{
protected:
public:
	...
	CFMAdmitedPatientListByDay(CWnd* pParent);
	~CFMAdmitedPatientListByDay();
	...
	int OnAddFMAdmitedPatientListByDay(); 
	int OnEditFMAdmitedPatientListByDay(); 
	int OnDeleteFMAdmitedPatientListByDay(); 
	int OnSaveFMAdmitedPatientListByDay(); 
	int OnCancelFMAdmitedPatientListByDay(); 
	int OnFMAdmitedPatientListByDayListLoadData();
