#ifndef FMServicePaidSummaryByDeptEX_H
#define FMServicePaidSummaryByDeptEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServicePaidSummaryByDeptEX : public CGuiView
{
protected:
...
public:
	...
	CGuiCheckBox	m_wndServiceZone;	
	CGuiCheckBox	m_wndInsuranceZone;

	CGuiRadioButton	m_wndGoiLuuTruLabel;
	CGuiRadioButton	m_wndGoiDichVuLabel;
	...
	BOOL	m_bServiceZone;
	BOOL	m_bAllZone;
	BOOL	m_bInsuranceZone;
	int		m_nPatientType;
	int	m_nGoiLuuTruLabel;
	int	m_nGoiDichVuLabel;
	int	m_nAllLabel;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	void			OnServiceZoneSelect(); 	
	void			OnInsuranceZoneSelect(); 
	...
	CFMServicePaidSummaryByDeptEX(CWnd *pWnd);
	~CFMServicePaidSummaryByDeptEX();
	...
	void			OnGoiLuuTruLabelSelect(); 
	void			OnGoiDichVuLabelSelect(); 
