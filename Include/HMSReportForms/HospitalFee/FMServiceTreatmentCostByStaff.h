#ifndef FMSERVICETREATMENTCOSTBYSTAFF_H
#define FMSERVICETREATMENTCOSTBYSTAFF_H
...
class CFMServiceTreatmentCostByStaff : public CGuiView{
protected:
public:
	...
	CFMServiceTreatmentCostByStaff(CWnd* pParent);
	~CFMServiceTreatmentCostByStaff();
	...
	int OnAddFMServiceTreatmentCostByStaff(); 
	int OnEditFMServiceTreatmentCostByStaff(); 
	int OnDeleteFMServiceTreatmentCostByStaff(); 
	int OnSaveFMServiceTreatmentCostByStaff(); 
	int OnCancelFMServiceTreatmentCostByStaff(); 
	int OnFMServiceTreatmentCostByStaffListLoadData();
