#ifndef FMSOLDERINSURANCEINCOMEOUTLAY_H
#define FMSOLDERINSURANCEINCOMEOUTLAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMSolderInsuranceIncomeOutlay : public CGuiView
{
...
public:
	...
	void			OnSODSelect();
	CFMSolderInsuranceIncomeOutlay(CWnd *pParent);
	~CFMSolderInsuranceIncomeOutlay();
