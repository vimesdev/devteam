#ifndef FMSupplierPaymentList2_H
#define FMSupplierPaymentList2_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMSupplierPaymentList2 : public CGuiView
{
protected:
public:
	...
	void			OnExportSelect(); 
	CFMSupplierPaymentList2(CWnd *pParent);
	~CFMSupplierPaymentList2();
