#ifndef FMDISCHARGEDPAIDPATIENTLIST_H
#define FMDISCHARGEDPAIDPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDischargedPaidPatientList : public CGuiView
{
protected:
public:
	...
	CFMDischargedPaidPatientList(CWnd* pParent);
	~CFMDischargedPaidPatientList();
	...
	int OnAddFMDischargedPaidPatientList(); 
	int OnEditFMDischargedPaidPatientList(); 
	int OnDeleteFMDischargedPaidPatientList(); 
	int OnSaveFMDischargedPaidPatientList(); 
	int OnCancelFMDischargedPaidPatientList(); 
