#ifndef FMInsuranceDiffPayment_H
#define FMInsuranceDiffPayment_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceDiffPayment : public CGuiView
{
protected:
...
public:
	...
	CFMInsuranceDiffPayment(CWnd *pWnd);
	~CFMInsuranceDiffPayment();
	...
	int OnAddFMInsuranceDiffPayment(); 
	int OnEditFMInsuranceDiffPayment(); 
	int OnDeleteFMInsuranceDiffPayment(); 
	int OnSaveFMInsuranceDiffPayment(); 
	int OnCancelFMInsuranceDiffPayment(); 
	int OnFMInsuranceDiffPaymentListLoadData();
