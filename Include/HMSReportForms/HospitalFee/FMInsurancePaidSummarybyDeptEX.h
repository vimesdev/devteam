#ifndef FMInsurancePaidSummaryByDeptEX_H
#define FMInsurancePaidSummaryByDeptEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsurancePaidSummaryByDeptEX : public CGuiView
{
   protected:
...
public:
	...
	CFMInsurancePaidSummaryByDeptEX(CWnd *pWnd);
	~CFMInsurancePaidSummaryByDeptEX();
