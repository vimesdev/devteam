#ifndef FMDETAILPURCHASEORDER_H
#define FMDETAILPURCHASEORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDetailPurchaseOrder : public CGuiView
{
protected:
public:
	...
	CFMDetailPurchaseOrder(CWnd *pParent);
	~CFMDetailPurchaseOrder();
