#ifndef FMTotalInComeByFeeTypeAllHospital_H
#define FMTotalInComeByFeeTypeAllHospital_H
...
class CFMTotalInComeByFeeTypeAllHospital : public CGuiView
{
...
public:
	...
	CFMTotalInComeByFeeTypeAllHospital(CWnd *pWnd);
	~CFMTotalInComeByFeeTypeAllHospital();
