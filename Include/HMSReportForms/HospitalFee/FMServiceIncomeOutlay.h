#ifndef FMSERVICEINCOMEOUTLAY_H
#define FMSERVICEINCOMEOUTLAY_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMServiceIncomeOutlay : public CGuiView{
protected:
...
public:
	...
	void			OnSODSelect(); 
	CFMServiceIncomeOutlay(CWnd *pParent);
	~CFMServiceIncomeOutlay();
