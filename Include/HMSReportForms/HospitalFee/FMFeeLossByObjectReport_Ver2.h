#ifndef FMFEELOSSBYOBJECTREPORTVER2_H
#define FMFEELOSSBYOBJECTREPORTVER2_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMFeeLossByObjectReportVer2 : public CGuiView
{
protected:
public:
	...
	CGuiListCtrl	m_wndConditionList;
	long	m_nYear;
	...
	void			OnPolicySelect();
	long			OnConditionListLoadData();
	CFMFeeLossByObjectReportVer2(CWnd* pParent);
	~CFMFeeLossByObjectReportVer2();
