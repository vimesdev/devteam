#ifndef FMInsurancePaidSummaryByDeptByDate_H
#define FMInsurancePaidSummaryByDeptByDate_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsurancePaidSummaryByDeptByDate : public CGuiView
{
protected:
...
public:
	...
	CFMInsurancePaidSummaryByDeptByDate(CWnd *pWnd);
	~CFMInsurancePaidSummaryByDeptByDate();
