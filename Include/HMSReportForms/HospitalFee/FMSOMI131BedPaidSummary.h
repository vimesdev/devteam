#ifndef CFMSOMI131BedPaidSummary_H
#define CFMSOMI131BedPaidSummary_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMSOMI131BedPaidSummary : public CGuiView
{
    protected:
...
public:
	...
	CString			GetQueryString_check2();

	

	CFMSOMI131BedPaidSummary(CWnd *pWnd);
	~CFMSOMI131BedPaidSummary();
	...
	int OnAddFMSOMI131PaidSummary(); 
	int OnEditFMSOMI131PaidSummary(); 
	int OnDeleteFMSOMI131PaidSummary(); 
	int OnSaveFMSOMI131PaidSummary(); 
	int OnCancelFMSOMI131PaidSummary(); 
	int OnFMSOMI131PaidSummaryListLoadData();
