#ifndef FMINSURANCEDEPOSITLIST_H
#define FMINSURANCEDEPOSITLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMInsuranceDepositList : public CGuiView
{
protected:
public:
	...
	CFMInsuranceDepositList(CWnd* pParent);
	~CFMInsuranceDepositList();
