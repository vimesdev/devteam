#ifndef FMUNPAIDADVANCEPATIENTLIST_H
#define FMUNPAIDADVANCEPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMUnpaidAdvancePatientList : public CGuiView{
protected:
public:
	...
	CFMUnpaidAdvancePatientList(CWnd *pParent);
	~CFMUnpaidAdvancePatientList();
