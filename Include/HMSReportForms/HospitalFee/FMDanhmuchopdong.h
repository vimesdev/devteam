#ifndef FMDANHMUCHOPDONG_H
#define FMDANHMUCHOPDONG_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMDanhmuchopdong : public CGuiView
...
public:
	...
	CGuiRadioButton	m_wndThanhtoanhoadon;
	CGuiRadioButton	m_wndThanhtoanhopdong;
	...
	CString	m_szToDate;
	BOOL	m_bInsurance;
	int	m_nThanhtoanhoadon;
	int	m_nThanhtoanhopdong;
	int	m_nTatca;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	//void			OnYearKillfocus(); 
	int			OnYearCheckValue();
	int			OnListSearchItem();
	...
	void			OnThanhtoanhoadonSelect(); 
	void			OnThanhtoanhopdongSelect();
	void			OnTatcaSelect(); 
	CFMDanhmuchopdong(CWnd *pParent);
	~CFMDanhmuchopdong();
