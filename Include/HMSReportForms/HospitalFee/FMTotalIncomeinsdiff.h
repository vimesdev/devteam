#ifndef FMTOTALINCOMEINSDIFF_H
#define FMTOTALINCOMEINSDIFF_H
...
#include "GuiView.h"
#include "DbField.h"
class CFMTotalIncomeinsdiff : public CGuiView
{
...
public:
	...
	CFMTotalIncomeinsdiff(CWnd *pWnd);
	~CFMTotalIncomeinsdiff();
	...
	int OnAddFMTotalIncomeinsdiff(); 
	int OnEditFMTotalIncomeinsdiff(); 
	int OnDeleteFMTotalIncomeinsdiff(); 
	int OnSaveFMTotalIncomeinsdiff(); 
	int OnCancelFMTotalIncomeinsdiff(); 
	int OnFMTotalIncomeinsdiffListLoadData();
