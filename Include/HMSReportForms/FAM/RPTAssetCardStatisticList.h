#ifndef RPTASSETCARDSTATISTICLIST_H
#define RPTASSETCARDSTATISTICLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTAssetCardStatisticList : public CGuiView{
protected:
public:
	...
	CRPTAssetCardStatisticList(CWnd *pParent);
	~CRPTAssetCardStatisticList();
	...
	int OnAddRPTAssetCardStatisticList(); 
	int OnEditRPTAssetCardStatisticList(); 
	int OnDeleteRPTAssetCardStatisticList(); 
	int OnSaveRPTAssetCardStatisticList(); 
	int OnCancelRPTAssetCardStatisticList(); 
	int OnRPTAssetCardStatisticListListLoadData(); 
};
#endif
