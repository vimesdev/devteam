// 2DBarChart.h: interface for the C2DBarChart class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_2DBarChart_H__62AE2E10_96DE_4410_87A1_2D2CDE38A601__INCLUDED_)
#define AFX_2DBarChart_H__62AE2E10_96DE_4410_87A1_2D2CDE38A601__INCLUDED_
...
struct _2DBarChartValues
{
	int index;
	int value;
	struct _2DBarChartValues* next;
};

struct _2DBarChartSeries
{
	int index;
	COLORREF color;
	CString text;
	struct _2DBarChartValues* values;
	struct _2DBarChartSeries* next;
};

struct _2DBarChartSegments
{
	int index;
	CString text;
	struct _2DBarChartSegments* next;
};

class AFX_EXT_CLASS C2DBarChart  
{
public:
	...
	void ClearGraph();
	C2DBarChart( CPoint g_position, CSize g_size );
	virtual ~C2DBarChart();
...
private:
	...
	CSize m_Size;
	CPoint m_Position;
	struct _2DBarChartSeries* m_Series;
	struct _2DBarChartSegments* m_Segments;
};

#endif // !defined(AFX_2DBarChart_H__62AE2E10_96DE_4410_87A1_2D2CDE38A601__INCLUDED_)
