...
/////////////////////////////////////////////////////////////////////////////
 ...
 //
 ///////////////////////////////////////////////////////////////////////
class  AFX_EXT_CLASS CChartBase
{
protected:
 ...
 //
 ///////////////////////////////////////////////////////////////////////
class  AFX_EXT_CLASS CChartTip : public CWnd, CChartBase
{
// Construction
public:
	CChartTip();
...
/*----------------------------------------------------------*
	 ...
	 |															|
	 *----------------------------------------------------------*/
	class  AFX_EXT_CLASS CChartData
	{
		struct data
		{
			CString m_szLabel;
	...
	/*-----------------------------------------------------------*
	 ...
	 |															 |
	 *-----------------------------------------------------------*/
	class  AFX_EXT_CLASS CChartBar : public CChartBase
	{
 ...
 //
 ///////////////////////////////////////////////////////////////////////
class  AFX_EXT_CLASS  CBarChartWnd : public CWnd, CChartBase
{
// Construction
public:
	CBarChartWnd();
...
protected:
	 ...
	 |															 |
	 *----------------------------------------------------------*/
	class CChartPrinter : public CChartBase
	{
	protected:
		CDC		*m_pMemDC;
		CRect	m_rcMemPic;
...
public:
	...
	virtual ~CBarChartWnd();

	// Generated message map functions
protected:
	//{{AFX_MSG(CBarChartWnd)
	afx_msg BOOL OnEraseBkgnd(CDC* pDC);
	afx_msg void OnPaint();
