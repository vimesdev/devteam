#ifndef StorageMedicalCabinetDIALOG_H
#define StorageMedicalCabinetDIALOG_H
...
///////////////////////////////////////////////
//CStorageMedicalCabinet: Cac class lien quan den phieu tu truc.
///////////////////////////////////////////////

class CStorageMedicalCabinetDialog : public CGuiDialog{
protected:
...
public:
	...
	bool		m_bImport;
	bool		m_bRefresh;
	CString		m_szDepartmentto_ID;
	BOOL		m_bDebtResolve;
	CString		m_szCategory;

	CStorageMedicalCabinetLines	m_wndLines;
	CHMSPatientListDrugMedicalCabinetView m_wndPatientList;
	...
	CStorageMedicalCabinetDialog(CWnd *pParent, int nMode);
	~CStorageMedicalCabinetDialog();
	...
	int OnAddStorageMedicalCabinetDialog(); 
	int OnEditStorageMedicalCabinetDialog(); 
	int OnDeleteStorageMedicalCabinetDialog(); 
	int OnSaveStorageMedicalCabinetDialog(); 
	int OnDiscardStorageMedicalCabinetDialog(); 
	int OnStorageMedicalCabinetDialogListLoadData(); 
