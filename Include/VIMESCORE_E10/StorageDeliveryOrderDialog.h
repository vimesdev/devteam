#ifndef STORAGEDELIVERYORDERDIALOG_H
#define STORAGEDELIVERYORDERDIALOG_H
...
class CStorageDeliveryOrderDialog : public CGuiDialog{
protected:
public:
	bool		m_bRefresh;
	...
	void			OnPlusSelect();
	CStorageDeliveryOrderDialog(CWnd *pParent, int nMode);
	~CStorageDeliveryOrderDialog();
