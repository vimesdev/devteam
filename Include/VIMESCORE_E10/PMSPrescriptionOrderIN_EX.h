#ifndef PMSPRESCRIPTIONORDERINEX_H
#define PMSPRESCRIPTIONORDERINEX_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CPMSPrescriptionOrderINEX : public CGuiView
{
