#ifndef PRODUCTMINQTYSETUP_H
#define PRODUCTMINQTYSETUP_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CProductMinQtySetup : public CGuiDialog{
protected:
public:
	CGuiGroupBox	m_wndMinimumQuantitySetup;
	...
	void			OnMultiSetSelect(); 
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CProductMinQtySetup(CWnd *pParent);
	~CProductMinQtySetup();
