#ifndef BANKSTATEMENTINPUT_H
#define BANKSTATEMENTINPUT_H
...
#include "GuiView.h"
#include "DbField.h"
class CAccBankStatementInput : public CListItemEdit{
protected:
...
public:
	...
	CDbfMap	m_fa_bankstatementlineTbl;
	...
	int OnAddAccBankStatementInput(); 
	int OnEditAccBankStatementInput(); 
	int OnDeleteAccBankStatementInput(); 
	int OnSaveAccBankStatementInput(); 
	int OnCancelAccBankStatementInput(); 
	int OnAccBankStatementInputListLoadData();
	int OnOK();
	void ApplyToList();
	void OnCancel();
	void SetReference(CString szInvoiceType, CString szID, CString szLineID);
