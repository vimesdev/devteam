#ifndef PRODUCTTENDERLIST_H
#define PRODUCTTENDERLIST_H
...
class AFX_EXT_CLASS CProductTenderList : public CGuiView{
protected:
public:
	...
	int OnAddProductTenderList(); 
	int OnEditProductTenderList(); 
	int OnDeleteProductTenderList(); 
	int OnSaveProductTenderList(); 
	int OnCancelProductTenderList(); 
	int OnProductTenderListListLoadData();
	void OnResizeLayout();
	void	OnPExtraInfoSelect();
