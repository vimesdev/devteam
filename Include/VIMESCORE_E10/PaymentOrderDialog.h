...
public:
	...
	double	m_nAmount;
	double	m_nApprovalAmount;
	CString	m_szReference;
	CString m_szPaymentMethodKey;
	double	m_nChi_truc_tiep;
	double	m_nChi_mua_vat_tu_hang_hoa;
	double	m_nChi_mua_tscd_khong_qua_lap_dat;
	double	m_nChi_mua_tscd_phai_qua_lap_dat;
	CString m_szStatus;
	CDbfMap	m_c_orderTbl;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CPaymentOrderDialog(CWnd *pParent, int nMode, long nId);
	~CPaymentOrderDialog();
