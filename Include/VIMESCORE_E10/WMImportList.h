#ifndef ACCWMIMPORTLIST_H
#define ACCWMIMPORTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CWMImportList : public CGuiView{
protected:
public:
	...
	int OnAddAccWMImportList(); 
	int OnEditAccWMImportList(); 
	int OnDeleteAccWMImportList(); 
	int OnSaveAccWMImportList(); 
	int OnCancelAccWMImportList(); 
	int OnAccWMImportListListLoadData(); 
};
#endif
