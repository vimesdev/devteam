...
#include "GuiDialog.h"
#include "DbField.h"
class CProductPriceSetupDialog : public CGuiDialog{
protected:
public:
	...
	void			OnOKSelect(); 
	void			OnCancelSelect(); 
	CProductPriceSetupDialog(CWnd *pParent);
	~CProductPriceSetupDialog();
	...
	int OnAddProductPriceSetupDialog(); 
	int OnEditProductPriceSetupDialog(); 
	int OnDeleteProductPriceSetupDialog(); 
	int OnSaveProductPriceSetupDialog(); 
	int OnCancelProductPriceSetupDialog(); 
	int OnProductPriceSetupDialogListLoadData(); 
};
#endif
