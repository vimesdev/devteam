#ifndef PMSPRESCRIPTIONCLEARORDER_H
#define PMSPRESCRIPTIONCLEARORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CPMSPrescriptionClearOrder : public CGuiView
{
protected:	
	long	m_nOrderID;
	CString	m_szIsPaid;
