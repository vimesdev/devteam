#ifndef FACASHDLIST_H
#define FACASHDLIST_H
...
class AFX_EXT_CLASS CFACashList : public CGuiView{
protected:
	long			m_nInvoiceID;
	CString			m_szDocType;
public:
	...
	int OnAddFACashList(); 
	int OnEditFACashList(); 
	int OnDeleteFACashList(); 
	int OnSaveFACashList(); 
	int OnCancelFACashList(); 
	int OnFACashListListLoadData(); 
