#ifndef STORAGEMOVEMENTDIALOG_H
#define STORAGEMOVEMENTDIALOG_H
...
///////////////////////////////////////////////
//CStorageMovement: Cac class lien quan den phieu dieu chuyen kho
///////////////////////////////////////////////
class CStorageMovementDialog : public CGuiDialog{
protected:
public:
	long		m_nID;
	...
	CStorageMovementLines	m_wndLines;
	...
	CStorageMovementDialog(CWnd *pParent, int nMode);
	~CStorageMovementDialog();
	...
	int OnAddStorageMovementDialog(); 
	int OnEditStorageMovementDialog(); 
	int OnDeleteStorageMovementDialog(); 
	int OnSaveStorageMovementDialog(); 
	int OnDiscardStorageMovementDialog(); 
	int OnStorageMovementDialogListLoadData(); 
