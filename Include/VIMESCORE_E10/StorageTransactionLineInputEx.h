...
#include "GuiPopup.h"
#include "DbField.h"
class CStorageTransactionLineInputEx : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CStorageTransactionLineInputEx(CWnd *pParent, int nMode);
	~CStorageTransactionLineInputEx();
	...
	int OnAddStorageTransactionLineInputEx(); 
	int OnEditStorageTransactionLineInputEx(); 
	int OnDeleteStorageTransactionLineInputEx(); 
	int OnSaveStorageTransactionLineInputEx(); 
	int OnCancelStorageTransactionLineInputEx(); 
	int OnStorageTransactionLineInputExListLoadData(); 
};
#endif
