#ifndef PRODUCTCLASSDIALOG_V2_H
#define PRODUCTCLASSDIALOG_V2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CProductClassDialog_v2 : public CGuiDialog{
protected:
	void RecalcValue(CString& szEffectGroup, CString& szName);
public:
	...
	CGuiLabel		m_wndIngredientLabel;
	CGuiComboBox	m_wndIngredient;
	CGuiButton		m_wndAdd;
	...
	CProductClassDialog_v2(CWnd *pParent, int nMode);
	~CProductClassDialog_v2();
