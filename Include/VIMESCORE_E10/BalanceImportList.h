#ifndef BALANCEIMPORTLIST_H
#define BALANCEIMPORTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CBalanceImportList : public CGuiView{
protected:
public:
	long	m_nID;
	...
	int OnAddBalanceImportList(); 
	int OnEditBalanceImportList(); 
	int OnDeleteBalanceImportList(); 
	int OnSaveBalanceImportList(); 
	int OnCancelBalanceImportList(); 
	int OnBalanceImportListListLoadData(); 
	DECLARE_MESSAGE_MAP()
