#ifndef APORDERMEMO_H
#define APORDERMEMO_H
...
#include "GuiView.h"
#include "DbField.h"
class CPurchaseOrderMemo : public CGuiView{
protected:
public:
	...
	int OnAddPurchaseOrderMemo(); 
	int OnEditPurchaseOrderMemo(); 
	int OnDeletePurchaseOrderMemo(); 
	int OnSavePurchaseOrderMemo(); 
	int OnCancelPurchaseOrderMemo(); 
	int OnPurchaseOrderMemoListLoadData(); 
};
#endif
