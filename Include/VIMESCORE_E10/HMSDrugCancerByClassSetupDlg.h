#ifndef HMSDRUGCANCERBYCLASSSETUPDLG_H
#define HMSDRUGCANCERBYCLASSSETUPDLG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSDrugCancerByClassSetupDlg : public CGuiDialog{
protected:
...
public:
	...
	CGuiButton		m_wndRemoveICD;
	CGuiListCtrl	m_wndIcdList;
	...
	CDbfMap	m_Product_cancel_classTbl;
	long			OnListLoadData(); 
	...
	CHMSDrugCancerByClassSetupDlg(CWnd *pParent);
	~CHMSDrugCancerByClassSetupDlg();
