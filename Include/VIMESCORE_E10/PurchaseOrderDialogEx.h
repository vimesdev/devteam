#ifndef PURCHASEORDERDIALOGEX_H
#define PURCHASEORDERDIALOGEX_H
...
class CPurchaseOrderDialogEx : public CGuiDialog
{
protected:
	bool	m_bRefresh;
	bool	m_bNonStock;
...
public:
	...
	bool		IsConsign();
	CPurchaseOrderDialogEx(CWnd *pParent, int nMode, bool bNonStock=false);
	~CPurchaseOrderDialogEx();
