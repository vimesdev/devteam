#ifndef ACCARSaleOrderList_H
#define ACCARSaleOrderList_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CARSaleOrderList : public CGuiView
{
protected:
public:
	...
	int OnAddAccARSaleOrderList(); 
	int OnEditAccARSaleOrderList(); 
	int OnDeleteAccARSaleOrderList(); 
	int OnSaveAccARSaleOrderList(); 
	int OnCancelAccARSaleOrderList(); 
	int OnAccARSaleOrderListListLoadData(); 
};
#endif
