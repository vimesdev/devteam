#ifndef STORAGEIMPORTLINEINPUT_H
#define STORAGEIMPORTLINEINPUT_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CStorageImportLineInput : public CGuiDialog{
protected:
public:
	...
	CStorageImportLineInput(CWnd *pParent);
	~CStorageImportLineInput();
	...
	int OnAddStorageImportLineInput(); 
	int OnEditStorageImportLineInput(); 
	int OnDeleteStorageImportLineInput(); 
	int OnSaveStorageImportLineInput(); 
	int OnCancelStorageImportLineInput(); 
	int OnStorageImportLineInputListLoadData(); 
};
#endif
