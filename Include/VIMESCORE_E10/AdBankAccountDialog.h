#ifndef ADBANKACCOUNTDIALOG_H
#define ADBANKACCOUNTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CAdBankAccountDialog : public CGuiDialog{
protected:
public:
	CWnd*	m_pParent;
	...
	void			OnSaveSelect(); 
	CAdBankAccountDialog(CWnd *pParent);
	~CAdBankAccountDialog();
	...
	int OnAddAdBankAccountPopup(); 
	int OnEditAdBankAccountPopup(); 
	int OnDeleteAdBankAccountPopup(); 
	int OnSaveAdBankAccountPopup(); 
	int OnCancelAdBankAccountPopup(); 
	int OnAdBankAccountPopupListLoadData();
};
#endif
