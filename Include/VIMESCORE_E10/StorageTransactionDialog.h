#ifndef STORAGETRANSACTIONDIALOG_H
#define STORAGETRANSACTIONDIALOG_H
...
class CStorageTransactionDialog : public CGuiDialog{
protected:
	bool		m_bRefresh;
public:
	long		m_nID;
	...
	CStorageTransactionLines	m_wndLines;
	...
	CStorageTransactionDialog(CWnd *pParent, int nMode);
	~CStorageTransactionDialog();
	...
	int OnAddStorageTransactionDialog(); 
	int OnEditStorageTransactionDialog(); 
	int OnDeleteStorageTransactionDialog(); 
	int OnSaveStorageTransactionDialog(); 
	int OnDiscardStorageTransactionDialog(); 
	int OnStorageTransactionDialogListLoadData(); 
