#ifndef PaymentOrderAddDialog_H
#define PaymentOrderAddDialog_H
...
/////////////////////////////////////
//CLASS THÊM HỢP ĐỒNG, PHIẾU NHẬP KHO VÀO PHIẾU ĐỀ NGHỊ THANH TOÁN
////////////////////////////////////


class CPaymentOrderAddDialog : public CGuiDialog{
protected:
public:
	long	m_nID;
	...
	CPaymentOrderAddDialog(CWnd *pParent);
	~CPaymentOrderAddDialog();
	...
	int OnAddPaymentOrderAddDialog(); 
	int OnEditPaymentOrderAddDialog(); 
	int OnDeletePaymentOrderAddDialog(); 
	int OnSavePaymentOrderAddDialog(); 
	int OnCancelPaymentOrderAddDialog(); 
	int OnPaymentOrderAddDialogListLoadData(); 
};
#endif
