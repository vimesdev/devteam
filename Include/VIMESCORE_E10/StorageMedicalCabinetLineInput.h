#ifndef StorageMedicalCabinetLINEINPUT_H
#define StorageMedicalCabinetLINEINPUT_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CStorageMedicalCabinetLineInput : public CGuiPopup{
protected:
public:
	long	m_nOrderID;
	long	m_nOrderLine;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CStorageMedicalCabinetLineInput(CWnd *pParent, int nMode);
	~CStorageMedicalCabinetLineInput();
	...
	int OnAddStorageMedicalCabinetLineInput(); 
	int OnEditStorageMedicalCabinetLineInput(); 
	int OnDeleteStorageMedicalCabinetLineInput(); 
	int OnSaveStorageMedicalCabinetLineInput(); 
	int OnCancelStorageMedicalCabinetLineInput(); 
	int OnStorageMedicalCabinetLineInputListLoadData(); 
};
#endif
