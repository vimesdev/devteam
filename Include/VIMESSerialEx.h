...
#ifndef __VIMESSERIAL_EX_H
#define __VIMESSERIAL_EX_H
...
//////////////////////////////////////////////////////////////////////
//
// CVIMESSerialEx - Win32 message-based wrapper for serial communications
//
...
class AFX_EXT_CLASS CVIMESSerialEx : public CSerial
{
// Construction
public:
	CVIMESSerialEx();
...
public:
	...
	virtual LONG Open (LPCTSTR lpszDevice, DWORD dwInQueue = 0, DWORD dwOutQueue = 0, bool fStartListener = true);
