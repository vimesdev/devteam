#ifndef HMSAdviseOrder_H
#define HMSAdviseOrder_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CHMSAdviseOrder : public CGuiView{
protected:
public:
	long	m_nOrderId;
	...
	CGuiRadioButton	m_wndPending;
	CGuiRadioButton	m_wndAdvised;
	...
	void			OnPendingFeesSelect(); 
	void			OnPendingSelect(); 
	void			OnAdvisedSelect(); 
	...
	int OnAddHMSAdviseOrder(); 
	int OnEditHMSAdviseOrder(); 
	int OnDeleteHMSAdviseOrder(); 
	int OnSaveHMSAdviseOrder(); 
	int OnCancelHMSAdviseOrder(); 
	int OnHMSAdviseOrderListLoadData(); 
};
#endif
