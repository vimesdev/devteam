#ifndef GUIDATECTRL_H
#define GUIDATECTRL_H
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#include "GuiMonthCalendarCtrl.h"

class AFX_EXT_CLASS CGuiDateCtrl : public CGuiMaskCtrl{
protected:
	CDate	m_dMin, m_dMax;
	BOOL	m_bHasMin;
	BOOL	m_bHasMax;
...
public:
	...
	~CGuiDateCtrl();
	int		IsValidateData();
	void	SetMinMax(CDate dMin, CDate mMax);
	void	SetMinMax(LPCTSTR lpszMin, LPCTSTR lpszMax);
	void	SetMin(CDate& dMin);
	void	SetMax(CDate& dMax);
	void	SetMin(CString lpszMin);
	void	SetMax(CString lpszMax);
	BOOL	CreateCalendar();
	void	EnableCalendar(bool bFlag=true);
