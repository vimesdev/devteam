#ifndef RPTPURCHASEDETAILBYCLERKSUPPLIER_H
#define RPTPURCHASEDETAILBYCLERKSUPPLIER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDetailbyClerkSupplier : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseDetailbyClerkSupplier();
	~AP_PurchaseDetailbyClerkSupplier();
