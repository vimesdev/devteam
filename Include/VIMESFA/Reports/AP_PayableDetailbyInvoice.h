#ifndef RPTPAYABLEDETAILBYINVOICE_H
#define RPTPAYABLEDETAILBYINVOICE_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PayableDetailbyInvoice : public CGuiView{
protected:
public:
