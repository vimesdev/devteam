#ifndef RPTPURCHASEDISCOUNTRETURNREDUCTIONSYNTHESISBYCLERKITEM_H
#define RPTPURCHASEDISCOUNTRETURNREDUCTIONSYNTHESISBYCLERKITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDiscountReturnReductionSynthesisbyClerkItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseDiscountReturnReductionSynthesisbyClerkItem();
	~AP_PurchaseDiscountReturnReductionSynthesisbyClerkItem();
