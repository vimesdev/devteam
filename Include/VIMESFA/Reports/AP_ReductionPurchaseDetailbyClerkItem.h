#ifndef RPTREDUCTIONPURCHASEDETAILBYCLERKITEM_H
#define RPTREDUCTIONPURCHASEDETAILBYCLERKITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ReductionPurchaseDetailbyClerkItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_ReductionPurchaseDetailbyClerkItem();
	~AP_ReductionPurchaseDetailbyClerkItem();
