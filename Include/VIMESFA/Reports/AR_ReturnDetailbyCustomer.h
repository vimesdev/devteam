#ifndef RPTRETURNDETAILBYCUSTOMER_H
#define RPTRETURNDETAILBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReturnDetailbyCustomer : public CGuiView{
protected:
public:
