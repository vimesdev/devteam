#ifndef RPTARSYNTHESISBYFC_H
#define RPTARSYNTHESISBYFC_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ARSynthesisbyFC : public CGuiView{
protected:
public:
