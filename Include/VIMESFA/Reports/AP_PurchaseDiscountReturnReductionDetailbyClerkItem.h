#ifndef RPTPURCHASEDISCOUNTRETURNREDUCTIONDETAILBYCLERKITEM_H
#define RPTPURCHASEDISCOUNTRETURNREDUCTIONDETAILBYCLERKITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDiscountReturnReductionDetailbyClerkItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseDiscountReturnReductionDetailbyClerkItem();
	~AP_PurchaseDiscountReturnReductionDetailbyClerkItem();
