#ifndef RPTPAYMENTSYNTHESISBYCLERKCUSTOMER_H
#define RPTPAYMENTSYNTHESISBYCLERKCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_PaymentSynthesisbyClerkCustomer : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_PaymentSynthesisbyClerkCustomer();
	~AR_PaymentSynthesisbyClerkCustomer();
