#ifndef RPTSALESYNTHESISBYCUSTOMERITEM01_H
#define RPTSALESYNTHESISBYCUSTOMERITEM01_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleSynthesisbyCustomerItem01 : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_SaleSynthesisbyCustomerItem01();
	~AR_SaleSynthesisbyCustomerItem01();
