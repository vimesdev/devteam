#ifndef RPTGENERALLIABILITYOFSUPPLIERBYOVERDUEDEBT_H
#define RPTGENERALLIABILITYOFSUPPLIERBYOVERDUEDEBT_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_GeneralLiabilityofSupplierbyOverdueDebt : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_GeneralLiabilityofSupplierbyOverdueDebt();
	~AP_GeneralLiabilityofSupplierbyOverdueDebt();
