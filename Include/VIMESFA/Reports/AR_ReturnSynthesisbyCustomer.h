#ifndef RPTRETURNSYNTHESISBYCUSTOMER_H
#define RPTRETURNSYNTHESISBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReturnSynthesisbyCustomer : public CGuiView{
protected:
public:
