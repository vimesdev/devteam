#ifndef RPTREDUCTIONDETAILBYITEMCUSTOMER_H
#define RPTREDUCTIONDETAILBYITEMCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReductionDetailbyItemCustomer : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_ReductionDetailbyItemCustomer();
	~AR_ReductionDetailbyItemCustomer();
