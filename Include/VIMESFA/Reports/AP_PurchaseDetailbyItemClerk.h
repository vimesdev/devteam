#ifndef RPTPURCHASEDETAILBYITEMCLERK_H
#define RPTPURCHASEDETAILBYITEMCLERK_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDetailbyItemClerk : public CGuiView{
protected:
public:
