#ifndef RPTREDUCTIONSYNTHESISBYSUPPLIERITEM_H
#define RPTREDUCTIONSYNTHESISBYSUPPLIERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ReductionSynthesisbySupplierItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_ReductionSynthesisbySupplierItem();
	~AP_ReductionSynthesisbySupplierItem();
