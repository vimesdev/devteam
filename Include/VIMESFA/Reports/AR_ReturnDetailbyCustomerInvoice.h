#ifndef RPTRETURNDETAILBYCUSTOMERINVOICE_H
#define RPTRETURNDETAILBYCUSTOMERINVOICE_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReturnDetailbyCustomerInvoice : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_ReturnDetailbyCustomerInvoice();
	~AR_ReturnDetailbyCustomerInvoice();
