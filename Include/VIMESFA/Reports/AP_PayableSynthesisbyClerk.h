#ifndef RPTPAYABLESYNTHESISBYCLERK_H
#define RPTPAYABLESYNTHESISBYCLERK_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PayableSynthesisbyClerk : public CGuiView{
protected:
public:
