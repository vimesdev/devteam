#ifndef RPTRETURNSYNTHESISBYCUSTOMERITEM_H
#define RPTRETURNSYNTHESISBYCUSTOMERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReturnSynthesisbyCustomerItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_ReturnSynthesisbyCustomerItem();
	~AR_ReturnSynthesisbyCustomerItem();
