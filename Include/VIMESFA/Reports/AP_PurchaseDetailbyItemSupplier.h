#ifndef RPTPURCHASEDETAILBYITEMSUPPLIER_H
#define RPTPURCHASEDETAILBYITEMSUPPLIER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDetailbyItemSupplier : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseDetailbyItemSupplier();
	~AP_PurchaseDetailbyItemSupplier();
