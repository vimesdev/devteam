#ifndef RPTARDETAILBYCLERK_H
#define RPTARDETAILBYCLERK_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ARDetailbyClerk : public CGuiView{
protected:
public:
	...
	CGuiCheckBox	m_wndDetailByInvoice;
