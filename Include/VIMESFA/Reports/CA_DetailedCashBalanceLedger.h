#ifndef RPTDetailedCashBalanceLedger_H
#define RPTDetailedCashBalanceLedger_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CA_DetailedCashBalanceLedger : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	CA_DetailedCashBalanceLedger();
	CA_DetailedCashBalanceLedger(CWnd* pParent, int nRpt);
	~CA_DetailedCashBalanceLedger();
	...
	CString GetQueryString(LPCTSTR szAccID, int nGrade);
	void FillList();
};
#endif
