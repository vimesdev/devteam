#ifndef RPTPURCHASESYNTHESISBYORDER_H
#define RPTPURCHASESYNTHESISBYORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseSynthesisbyOrder : public CGuiView{
protected:
public:
