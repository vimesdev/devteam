#ifndef RPTPURCHASESYNTHESISBYITEMCLERK_H
#define RPTPURCHASESYNTHESISBYITEMCLERK_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseSynthesisbyItemClerk : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	AP_PurchaseSynthesisbyItemClerk();
	~AP_PurchaseSynthesisbyItemClerk();
