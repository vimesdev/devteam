#ifndef RPTPURCHASEDETAILBYSUPPLIERITEM_H
#define RPTPURCHASEDETAILBYSUPPLIERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDetailbySupplierItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseDetailbySupplierItem();
	~AP_PurchaseDetailbySupplierItem();
