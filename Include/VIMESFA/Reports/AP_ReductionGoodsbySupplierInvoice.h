#ifndef RPTREDUCTIONGOODSBYSUPPLIERINVOICE_H
#define RPTREDUCTIONGOODSBYSUPPLIERINVOICE_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ReductionGoodsbySupplierInvoice : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_ReductionGoodsbySupplierInvoice();
	~AP_ReductionGoodsbySupplierInvoice();
