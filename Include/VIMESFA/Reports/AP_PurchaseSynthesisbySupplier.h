#ifndef RPTPURCHASESYNTHESISBYSUPPLIER_H
#define RPTPURCHASESYNTHESISBYSUPPLIER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseSynthesisbySupplier : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseSynthesisbySupplier();
	~AP_PurchaseSynthesisbySupplier();
