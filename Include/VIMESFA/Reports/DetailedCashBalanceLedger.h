#ifndef ACCRPTDetailedCashBalanceLedger_H
#define ACCRPTDetailedCashBalanceLedger_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTDetailedCashBalanceLedger : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	CRPTDetailedCashBalanceLedger();
	CRPTDetailedCashBalanceLedger(CWnd* pParent, int nRpt);
	~CRPTDetailedCashBalanceLedger();
