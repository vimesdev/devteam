#ifndef RPTPURCHASESYNTHESISBYSUPPLIERITEM_H
#define RPTPURCHASESYNTHESISBYSUPPLIERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseSynthesisbySupplierItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseSynthesisbySupplierItem();
	~AP_PurchaseSynthesisbySupplierItem();
