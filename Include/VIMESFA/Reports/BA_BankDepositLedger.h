#ifndef ACBA_BankDepositLedger_H
#define ACBA_BankDepositLedger_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS BA_BankDepositLedger : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	void	FillList();
	BA_BankDepositLedger();
	BA_BankDepositLedger(CWnd* pParent, int nRpt);
	~BA_BankDepositLedger();
