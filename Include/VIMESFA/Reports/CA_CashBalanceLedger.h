#ifndef RPTCashBalanceLedger_H
#define RPTCashBalanceLedger_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS CA_CashBalanceLedger : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	void	FillList();
	CA_CashBalanceLedger();
	CA_CashBalanceLedger(CWnd* pParent, int nRpt);
	~CA_CashBalanceLedger();
