#ifndef RPTSALESYNTHESISBYCUSTOMER_H
#define RPTSALESYNTHESISBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleSynthesisbyCustomer : public CGuiView{
protected:
public:
