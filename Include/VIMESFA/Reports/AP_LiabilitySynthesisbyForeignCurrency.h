#ifndef RPTLIABILITYSYNTHESISBYFOREIGNCURRENCY_H
#define RPTLIABILITYSYNTHESISBYFOREIGNCURRENCY_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_LiabilitySynthesisbyForeignCurrency : public CGuiView{
protected:
public:
	...
	void	FillList(); 
	void			OnCheckSelect(); 
	AP_LiabilitySynthesisbyForeignCurrency();
	~AP_LiabilitySynthesisbyForeignCurrency();
