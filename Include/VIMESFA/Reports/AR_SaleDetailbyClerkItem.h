#ifndef RPTSALEDETAILBYCLERKITEM_H
#define RPTSALEDETAILBYCLERKITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleDetailbyClerkItem : public CGuiView{
protected:
public:
