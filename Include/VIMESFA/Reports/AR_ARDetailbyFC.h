#ifndef RPTARDETAILBYFC_H
#define RPTARDETAILBYFC_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ARDetailbyFC : public CGuiView{
protected:
public:
	...
	CGuiCheckBox	m_wndDetailByItem;
