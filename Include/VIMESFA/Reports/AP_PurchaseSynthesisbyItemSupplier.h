#ifndef RPTPURCHASESYNTHESISBYITEMSUPPLIER_H
#define RPTPURCHASESYNTHESISBYITEMSUPPLIER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseSynthesisbyItemSupplier : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseSynthesisbyItemSupplier();
	~AP_PurchaseSynthesisbyItemSupplier();
