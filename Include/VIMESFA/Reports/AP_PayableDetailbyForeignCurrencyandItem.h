#ifndef RPTPAYABLEDETAILBYFOREIGNCURRENCYANDITEM_H
#define RPTPAYABLEDETAILBYFOREIGNCURRENCYANDITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PayableDetailbyForeignCurrencyandItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PayableDetailbyForeignCurrencyandItem();
	~AP_PayableDetailbyForeignCurrencyandItem();
