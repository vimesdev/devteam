#ifndef RPTRETURNEDGOODSBYSUPPLIERINVOICE_H
#define RPTRETURNEDGOODSBYSUPPLIERINVOICE_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ReturnedGoodsbySupplierInvoice : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_ReturnedGoodsbySupplierInvoice();
	~AP_ReturnedGoodsbySupplierInvoice();
