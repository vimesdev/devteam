#ifndef RPTARISINGPAYABLEBALANCESHEET_H
#define RPTARISINGPAYABLEBALANCESHEET_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ArisingPayableBalanceSheet : public CGuiView{
protected:
public:
