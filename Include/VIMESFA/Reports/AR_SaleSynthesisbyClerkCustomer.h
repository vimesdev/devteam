#ifndef RPTSALESYNTHESISBYCLERKCUSTOMER_H
#define RPTSALESYNTHESISBYCLERKCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleSynthesisbyClerkCustomer : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_SaleSynthesisbyClerkCustomer();
	~AR_SaleSynthesisbyClerkCustomer();
