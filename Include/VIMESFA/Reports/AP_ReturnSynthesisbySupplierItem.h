#ifndef RPTRETURNSYNTHESISBYSUPPLIERITEM_H
#define RPTRETURNSYNTHESISBYSUPPLIERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ReturnSynthesisbySupplierItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_ReturnSynthesisbySupplierItem();
	~AP_ReturnSynthesisbySupplierItem();
