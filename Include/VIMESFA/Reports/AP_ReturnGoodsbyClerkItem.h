#ifndef RPTRETURNGOODSBYCLERKITEM_H
#define RPTRETURNGOODSBYCLERKITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ReturnGoodsbyClerkItem : public CGuiView{
protected:
public:
