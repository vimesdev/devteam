#ifndef RPTLIABILITYSYNTHESISBYGROUP_H
#define RPTLIABILITYSYNTHESISBYGROUP_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_LiabilitySynthesisbyGroup: public CGuiView{
protected:
public:
