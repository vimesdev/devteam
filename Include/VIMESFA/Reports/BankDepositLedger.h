#ifndef ACCRPTBankDepositLedger_H
#define ACCRPTBankDepositLedger_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTBankDepositLedger : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	void	FillList();
	CRPTBankDepositLedger();
	CRPTBankDepositLedger(CWnd* pParent, int nRpt);
	~CRPTBankDepositLedger();
