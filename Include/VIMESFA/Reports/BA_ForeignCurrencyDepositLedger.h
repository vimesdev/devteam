#ifndef ACBA_ForeignCurrencyDepositLedger_H
#define ACBA_ForeignCurrencyDepositLedger_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS BA_ForeignCurrencyDepositLedger : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	void	FillList();
	BA_ForeignCurrencyDepositLedger();
	BA_ForeignCurrencyDepositLedger(CWnd* pParent, int nRpt);
	~BA_ForeignCurrencyDepositLedger();
