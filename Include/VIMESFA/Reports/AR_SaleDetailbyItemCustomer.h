#ifndef RPTSALEDETAILBYITEMCUSTOMER_H
#define RPTSALEDETAILBYITEMCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleDetailbyItemCustomer : public CGuiView{
protected:
public:
