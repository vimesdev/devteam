#ifndef RPTPAYABLEDETAILBYFOREIGNCURRENCY_H
#define RPTPAYABLEDETAILBYFOREIGNCURRENCY_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PayableDetailbyForeignCurrency : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PayableDetailbyForeignCurrency();
	~AP_PayableDetailbyForeignCurrency();
