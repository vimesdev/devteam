#ifndef ACCBANKCOLLATIONSHEET_H
#define ACCBANKCOLLATIONSHEET_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS BA_BankCollationSheet : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	void	FillList();
	BA_BankCollationSheet();
	BA_BankCollationSheet(CWnd* pParent, int nRpt);
	~BA_BankCollationSheet();
