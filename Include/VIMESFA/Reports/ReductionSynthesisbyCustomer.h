#ifndef RPTREDUCTIONSYNTHESISBYCUSTOMER_H
#define RPTREDUCTIONSYNTHESISBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTReductionSynthesisbyCustomer : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	CRPTReductionSynthesisbyCustomer();
	~CRPTReductionSynthesisbyCustomer();
