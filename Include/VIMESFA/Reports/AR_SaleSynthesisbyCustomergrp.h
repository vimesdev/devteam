#ifndef RPTSALESYNTHESISBYCUSTOMERGRP_H
#define RPTSALESYNTHESISBYCUSTOMERGRP_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleSynthesisbyCustomergrp : public CGuiView{
protected:
public:
