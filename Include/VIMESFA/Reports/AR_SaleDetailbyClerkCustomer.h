#ifndef RPTSALEDETAILBYCLERKCUSTOMER_H
#define RPTSALEDETAILBYCLERKCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleDetailbyClerkCustomer : public CGuiView{
protected:
public:
