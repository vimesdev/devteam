#ifndef RPTSALEDETAILBYCUSTOMERITEM_H
#define RPTSALEDETAILBYCUSTOMERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleDetailbyCustomerItem : public CGuiView{
protected:
public:
