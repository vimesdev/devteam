#ifndef RPTSALEDETAILBYITEMCLERK_H
#define RPTSALEDETAILBYITEMCLERK_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleDetailbyItemClerk : public CGuiView{
protected:
public:
