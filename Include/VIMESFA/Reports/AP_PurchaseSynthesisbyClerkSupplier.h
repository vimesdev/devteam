#ifndef RPTPURCHASESYNTHESISBYCLERKSUPPLIER_H
#define RPTPURCHASESYNTHESISBYCLERKSUPPLIER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseSynthesisbyClerkSupplier : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_PurchaseSynthesisbyClerkSupplier();
	~AP_PurchaseSynthesisbyClerkSupplier();
