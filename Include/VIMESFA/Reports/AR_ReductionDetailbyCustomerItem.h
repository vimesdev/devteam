#ifndef RPTREDUCTIONDETAILBYCUSTOMERITEM_H
#define RPTREDUCTIONDETAILBYCUSTOMERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReductionDetailbyCustomerItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_ReductionDetailbyCustomerItem();
	~AR_ReductionDetailbyCustomerItem();
