#ifndef ACCRPTForeignCurrencyDepositLedger_H
#define ACCRPTForeignCurrencyDepositLedger_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTForeignCurrencyDepositLedger : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	void	FillList();
	CRPTForeignCurrencyDepositLedger();
	CRPTForeignCurrencyDepositLedger(CWnd* pParent, int nRpt);
	~CRPTForeignCurrencyDepositLedger();
