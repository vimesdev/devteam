#ifndef RPTPURCHASEDETAILBYSUPPLIER_H
#define RPTPURCHASEDETAILBYSUPPLIER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDetailbySupplier : public CGuiView{
protected:
public:
