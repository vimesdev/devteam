#ifndef RPTORDERIMPLEMENTATIONBYCUSTOMER_H
#define RPTORDERIMPLEMENTATIONBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_OrderImplementationbyCustomer : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AR_OrderImplementationbyCustomer();
	~AR_OrderImplementationbyCustomer();
