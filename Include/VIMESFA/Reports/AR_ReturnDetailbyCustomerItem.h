#ifndef RPTRETURNDETAILBYCUSTOMERITEM_H
#define RPTRETURNDETAILBYCUSTOMERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReturnDetailbyCustomerItem : public CGuiView{
protected:
public:
