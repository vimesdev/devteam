#ifndef RPTARDETAILBYINVOICEITEMTAX_H
#define RPTARDETAILBYINVOICEITEMTAX_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ARDetailbyInvoiceItemTax : public CGuiView{
protected:
public:
