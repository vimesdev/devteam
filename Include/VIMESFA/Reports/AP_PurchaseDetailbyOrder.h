#ifndef RPTPURCHASEDETAILBYORDER_H
#define RPTPURCHASEDETAILBYORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_PurchaseDetailbyOrder : public CGuiView{
protected:
public:
