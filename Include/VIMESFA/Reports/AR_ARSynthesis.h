#ifndef RPTARSYNTHESIS_H
#define RPTARSYNTHESIS_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ARSynthesis : public CGuiView{
protected:
public:
	...
	CGuiCheckBox	m_wndSimplify;
	CGuiButton		m_wndPrint;
	CGuiCheckBox	m_wndGroupon;
	...
	void			OnSimplifySelect(); 
	void			OnPrintSelect();
	void	FillList(); 
	void			OnGrouponSelect(); 
	AR_ARSynthesis();
	~AR_ARSynthesis();
