#ifndef RPTARMINUTES_H
#define RPTARMINUTES_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ARminutes : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	void			OnAccountNoSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnAccountNoSelendok(); 
	//void			OnAccountNoSetfocus(); 
	//void			OnAccountNoKillfocus(); 
	long			OnAccountNoLoadData(); 
	void			OnAccountNoAddNew(); 
	AR_ARminutes();
	~AR_ARminutes();
