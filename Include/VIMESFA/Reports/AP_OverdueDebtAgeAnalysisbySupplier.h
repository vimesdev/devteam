#ifndef RPTOVERDUEDEBTAGEANALYSISBYSUPPLIER_H
#define RPTOVERDUEDEBTAGEANALYSISBYSUPPLIER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_OverdueDebtAgeAnalysisbySupplier : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_OverdueDebtAgeAnalysisbySupplier();
	~AP_OverdueDebtAgeAnalysisbySupplier();
