#ifndef RPTREDUCTIONGOODSBYSUPPLIERITEM_H
#define RPTREDUCTIONGOODSBYSUPPLIERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_ReductionGoodsbySupplierItem : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_ReductionGoodsbySupplierItem();
	~AP_ReductionGoodsbySupplierItem();
