#ifndef RPTGENERALLIABILITYOFSUPPLIERBYAGEDEBT_H
#define RPTGENERALLIABILITYOFSUPPLIERBYAGEDEBT_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AP_GeneralLiabilityofSupplierbyAgeDebt : public CGuiView{
protected:
public:
	...
	void			OnPrintSelect();
	void	FillList(); 
	AP_GeneralLiabilityofSupplierbyAgeDebt();
	~AP_GeneralLiabilityofSupplierbyAgeDebt();
