#ifndef ACCRPTBankBalanceSheet_H
#define ACCRPTBankBalanceSheet_H
...
#include "GuiView.h"
#include "DbField.h"
class CRPTBankBalanceSheet : public CGuiView{
protected:
public:
	...
	void			OnCloseSelect(); 
	void	FillList();
	CRPTBankBalanceSheet();
	CRPTBankBalanceSheet(CWnd* pParent, int nRpt);
	~CRPTBankBalanceSheet();
