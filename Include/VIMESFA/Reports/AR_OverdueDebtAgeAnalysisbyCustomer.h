#ifndef RPTOVERDUEDEBTAGEANALYSISBYCUSTOMER_H
#define RPTOVERDUEDEBTAGEANALYSISBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_OverdueDebtAgeAnalysisbyCustomer : public CGuiView{
protected:
public:
	...
	long			OnTypeLoadData(); 
	void			OnTypeAddNew(); 
	AR_OverdueDebtAgeAnalysisbyCustomer();
	~AR_OverdueDebtAgeAnalysisbyCustomer();
