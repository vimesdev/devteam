#ifndef RPTORDERDETAILBYCUSTOMER_H
#define RPTORDERDETAILBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_OrderDetailbyCustomer : public CGuiView{
protected:
public:
