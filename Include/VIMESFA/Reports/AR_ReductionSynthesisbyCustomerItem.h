#ifndef RPTREDUCTIONSYNTHESISBYCUSTOMERITEM_H
#define RPTREDUCTIONSYNTHESISBYCUSTOMERITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ReductionSynthesisbyCustomerItem : public CGuiView{
protected:
public:
	...
	CGuiListCtrl	m_wndCustomerList;
	...
	void			OnGroupAddNew(); 
	long			OnCustomerListLoadData(); 
	void			OnCustomerListSelectChange(int nOldItem, int nNewItem); 
	void			OnCustomerListDblClick(); 
	int			OnCustomerListDeleteItem(); 
	void			OnPrintSelect();
	void	FillList(); 
	...
	AR_ReductionSynthesisbyCustomerItem();
	~AR_ReductionSynthesisbyCustomerItem();
