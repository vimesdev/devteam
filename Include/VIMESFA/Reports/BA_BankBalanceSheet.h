#ifndef ACBA_BankBalanceSheet_H
#define ACBA_BankBalanceSheet_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS BA_BankBalanceSheet : public CGuiView{
protected:
public:
	...
	void	FillList();
	BA_BankBalanceSheet();
	BA_BankBalanceSheet(CWnd* pParent, int nRpt);
	~BA_BankBalanceSheet();
