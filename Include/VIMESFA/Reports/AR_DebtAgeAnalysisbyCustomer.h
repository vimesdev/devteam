#ifndef RPTDEBTAGEANALYSISBYCUSTOMER_H
#define RPTDEBTAGEANALYSISBYCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_DebtAgeAnalysisbyCustomer : public CGuiView{
protected:
public:
