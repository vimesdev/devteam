#ifndef RPTARSYNTHESISBYCLERKCUSTOMER_H
#define RPTARSYNTHESISBYCLERKCUSTOMER_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_ARSynthesisbyClerkCustomer : public CGuiView{
protected:
public:
