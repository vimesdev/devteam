#ifndef RPTSALESYNTHESISBYCLERKITEM_H
#define RPTSALESYNTHESISBYCLERKITEM_H
...
#include "GuiView.h"
#include "DbField.h"
class AFX_EXT_CLASS AR_SaleSynthesisbyClerkItem : public CGuiView{
protected:
public:
