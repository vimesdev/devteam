...
//#pragma warning( suppress:4127 ) //  warning C4127: conditional expression is constant
    ...
    {
        pod::buffer<uchar>* _bos;
        html_selection_params():TEXT_SELECTION_PARAMS(true),_bos(0){}
    public:
        static BOOL CALLBACK ctl(html_selection_params* prms, UINT data ) { prms->_bos->push(uchar(data));  return 1; }
        html_selection_params(pod::buffer<uchar>& bos): TEXT_SELECTION_PARAMS(true), _bos(&bos)  { outs = (OutputStreamProc*)ctl; }
    };
    ...
    class editbox: public element
    {
      ...
      public: 
        ...
        void get_selected_html(pod::buffer<uchar>& bos)
        {
