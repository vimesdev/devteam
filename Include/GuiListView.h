...
class CGuiListView : public CGuiView{
protected:
public:
	CGuiGroupBox	m_wndListInformation;
	...
	int OnAddGuiListView(); 
	int OnEditGuiListView(); 
	int OnDeleteGuiListView(); 
	int OnSaveGuiListView(); 
	int OnCancelGuiListView(); 
	int OnGuiListViewListLoadData(); 
};
#endif
