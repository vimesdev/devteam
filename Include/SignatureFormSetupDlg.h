#ifndef SignatureFormSetupDlg_H
#define SignatureFormSetupDlg_H
...
#include "GuiDialog.h"
#include "DbField.h"
class AFX_EXT_CLASS CSignatureFormSetupDlg : public CGuiDialog{
protected:
public:
	...
	void			OnCloseSelect(); 
	void OnListSwapItem();
	CSignatureFormSetupDlg(CWnd *pParent);
	~CSignatureFormSetupDlg();
	...
	int OnAddSignatureFormSetupDlg(); 
	int OnEditSignatureFormSetupDlg(); 
	int OnDeleteSignatureFormSetupDlg(); 
	int OnSaveSignatureFormSetupDlg(); 
	int OnCancelSignatureFormSetupDlg(); 
	int OnSignatureFormSetupDlgListLoadData(); 
};
#endif
