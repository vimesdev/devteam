...
void CDrugDetail::OnCreateComponents(){
	...
	m_wndcontrol_1.InsertColumn(10, _T("Mã thu?c"), CFMT_TEXT, 100);
...
long CDrugDetail::Oncontrol_1LoadData(){
	...
	szSQL.Format(_T("select ma_thuoc,ten_thuoc,don_vi_tinh,ham_luong,sum(so_luong) as so_luong,don_gia,thanh_tien,ma_nhom,tt_thau, ma_thuoc_cs ") \
				_T("	from BH_BANG_CTTHUOC where ma_lk='%s' ") \
				_T("	GROUP BY ma_thuoc,ten_thuoc,don_vi_tinh,ham_luong,don_gia,thanh_tien,ma_nhom,tt_thau,ma_thuoc_cs ") \
