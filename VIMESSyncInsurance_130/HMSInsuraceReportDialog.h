...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSInsuraceReportDialog : public CGuiDialog{
protected:
public:
	...
	CGuiCheckBox	m_wndHasDatePayment;
	long	m_nYear;
	...
	BOOL	m_bOutPatient;
	BOOL	m_bInPatient;
	BOOL	m_bHasDatePayment;
	CString	m_szGroupInsuranceKey;
	CString m_szArrayDocs;
	//void			OnYearChange(); 
	//void			OnYearSetfocus(); 
	...
	CString GetSQLString7980();
		void OnPrint7980_TT102();
	int OnExport7980_FromPrint(bool bUseICD10 =false);
	CString GetSQLString_print7980(bool bUseICD10 =false);
};
#endif
