...
void CSysInsuranceView::OnInitializeComponents(){
	...
	m_wndListPatient.InsertColumn(9, _T("t_bhtt"), CFMT_MONEY, 100);
	m_wndListPatient.InsertColumn(10, _T("t_bntt"), CFMT_MONEY, 100);
	m_wndListPatient.InsertColumn(11, _T("Sended"), CFMT_TEXT, 50);
	m_wndListPatient.InsertColumn(12, _T("Invoiceno"), CFMT_TEXT, 80);
	m_wndListPatient.InsertColumn(13, _T("ma_lk"), CFMT_TEXT, 80);
...
void CSysInsuranceView::OnSetWindowEvents(){
	...
	m_wndListPatient.AddEvent(5,_T("Xóa Dữ liệu"), _OnDeleteDaTaFnc);
...
int CSysInsuranceView::OnExport4210(){
	...
	for(int i =0;i<m_wndListPatient.GetItemCount();i++)
	{
		...
		{	
			...
			pMF->OnWriteCheckOut4210(tmpStr);	
			tmp++;
		}
