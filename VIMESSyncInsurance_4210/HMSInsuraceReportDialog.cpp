...
CString CHMSInsuraceReportDialog::GetSQLString7980()
{
	...
	UpdateData(true);
		...
		if((m_bOutPatient && m_bInPatient) || (!m_bOutPatient && !m_bInPatient  ) )
			szWhere.Format(_T(" and ma_loai_kcb in (1,2,3) and substr(ma_the,4,2) <>'97' "));
		
			szSQL.Format(_T(" SELECT ma_bn as docno,ma_lk, ") \
	_T(" 	ho_ten as pname,") \
	...
	_T(" 		case when ma_nhom not in ('1','2','3','4','5','6','7','8','10','11','12','13','14','17','18') then thanh_tien else 0 end as  otherfee,") \
