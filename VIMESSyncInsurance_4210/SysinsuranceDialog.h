#ifndef SYSINSURANCEDIALOG_H
#define SYSINSURANCEDIALOG_H
...
class CSysinsuranceDialog : public CGuiView{
protected:
public:
	...
	int OnAddSysinsuranceDialog(); 
	int OnEditSysinsuranceDialog(); 
	int OnDeleteSysinsuranceDialog(); 
	int OnSaveSysinsuranceDialog(); 
	int OnCancelSysinsuranceDialog(); 
	int OnSysinsuranceDialogListLoadData();
