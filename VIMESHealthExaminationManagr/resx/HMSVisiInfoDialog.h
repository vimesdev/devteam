#ifndef HMSVISIINFODIALOG_H
#define HMSVISIINFODIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSVisiInfoDialog : public CGuiDialog{
protected:
public:
	CGuiLabel		m_wndPatientInfo;
	...
	void			On&ApplySelect(); 
	void			OnCloseSelect(); 
	CHMSVisiInfoDialog(CWnd *pParent);
	~CHMSVisiInfoDialog();
	...
	int OnAddHMSVisiInfoDialog(); 
	int OnEditHMSVisiInfoDialog(); 
	int OnDeleteHMSVisiInfoDialog(); 
	int OnSaveHMSVisiInfoDialog(); 
	int OnCancelHMSVisiInfoDialog(); 
	int OnHMSVisiInfoDialogListLoadData(); 
};
#endif
