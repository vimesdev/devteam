...
void CVisitPatientListView::OnInitializeComponents(){
	...
	m_wndList.InsertColumn(8, _T("Visit Count"), CFMT_TEXT, 80);
	m_wndList.InsertColumn(9, _T("Patient No"), CFMT_TEXT, 90);
	m_wndList.InsertColumn(10, _T(""), CFMT_TEXT, 0);


	m_wndVisitList.InsertColumn(0, _T("Id"), CFMT_TEXT, 30);
	m_wndVisitList.InsertColumn(1, _T("Visit Card Id"), CFMT_TEXT, 100);
	m_wndVisitList.InsertColumn(2, _T("Time to visit"), CFMT_TEXT, 130);
	m_wndVisitList.InsertColumn(3, _T("Time out"), CFMT_TEXT, 130);
	...
	m_wndVisitList.InsertColumn(7, _T("Consignment Note"), CFMT_TEXT, 120);
	m_wndVisitList.InsertColumn(8, _T("Note"), CFMT_TEXT, 100);
	m_wndVisitList.InsertColumn(9, _T("T.Thái"), CFMT_TEXT|CFMT_CENTER, 40);
...
long CVisitPatientListView::OnVisitListLoadData(){
	...
	int nCount = 0;
	szSQL.Format(_T("SELECT * FROM hms_visitinfo WHERE hvi_docno=%ld ORDER BY hvi_visitinfo_id "), m_nCurDoc);
	...
	m_wndVisitList.SetCurSel(nItem);
	return nCount;
