#ifndef HMS_DOC_NOTE_H
#define HMS_DOC_NOTE_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMS_Doc_Note : public CGuiDialog
{
...
public:
	...
	CHMS_Doc_Note(CWnd *pParent,  bool bViewHistory = false);
	~CHMS_Doc_Note();
	...
	int OnAddCHMS_Doc_Note(); 
	int OnEditCHMS_Doc_Note(); 
	int OnDeleteCHMS_Doc_Note(); 
	int OnSaveCHMS_Doc_Note(); 
	int OnCancelCHMS_Doc_Note(); 
	int OnCHMS_Doc_NoteListLoadData();
