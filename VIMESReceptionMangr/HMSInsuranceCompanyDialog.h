#ifndef HMSINSURANCECOMPANYDIALOG_H
#define HMSINSURANCECOMPANYDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSInsuranceCompanyDialog : public CGuiDialog{
protected:
public:
	...
	CDbfMap	m_hms_insurance_companyTbl;
	long			OnListLoadData(); 
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CHMSInsuranceCompanyDialog(CWnd *pParent);
	~CHMSInsuranceCompanyDialog();
	...
	int OnAddHMSInsuranceCompanyDialog(); 
	int OnEditHMSInsuranceCompanyDialog(); 
	int OnDeleteHMSInsuranceCompanyDialog(); 
	int OnSaveHMSInsuranceCompanyDialog(); 
	int OnCancelHMSInsuranceCompanyDialog(); 
	int OnHMSInsuranceCompanyDialogListLoadData(); 
};
#endif
