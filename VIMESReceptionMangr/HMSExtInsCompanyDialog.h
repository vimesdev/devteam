#ifndef HMSExtInsCompanyDialog_H
#define HMSExtInsCompanyDialog_H
...
class CHMSExtInsCompanyDialog : public CGuiDialog{
protected:
public:
	CHMSExtInsUnpaidView	m_wndUnpaidView;
	...
	CDbfMap	m_hms_extins_companyTbl;
	long			OnListLoadData(); 
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CHMSExtInsCompanyDialog(CWnd *pParent);
	~CHMSExtInsCompanyDialog();
	...
	int OnAddHMSExtInsCompanyDialog(); 
	int OnEditHMSExtInsCompanyDialog(); 
	int OnDeleteHMSExtInsCompanyDialog(); 
	int OnSaveHMSExtInsCompanyDialog(); 
	int OnCancelHMSExtInsCompanyDialog(); 
	int OnHMSExtInsCompanyDialogListLoadData(); 
};
#endif
