#ifndef HMSTHIETLAPDIACHIVACCINE_H
#define HMSTHIETLAPDIACHIVACCINE_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSThietLap_Diachi_Vaccine : public CGuiDialog
{
protected:	
public:
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect();
	void			OnOutMilitarySelect(); 
	CHMSThietLap_Diachi_Vaccine(CWnd *pParent,long nOrderId=0);
	~CHMSThietLap_Diachi_Vaccine();
