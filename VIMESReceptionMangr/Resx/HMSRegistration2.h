#ifndef HMSREGISTRATION2_H
#define HMSREGISTRATION2_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSRegistration2 : public CGuiView{
protected:
public:
	...
	int OnAddHMSRegistration2(); 
	int OnEditHMSRegistration2(); 
	int OnDeleteHMSRegistration2(); 
	int OnSaveHMSRegistration2(); 
	int OnCancelHMSRegistration2(); 
	int OnHMSRegistration2ListLoadData(); 
};
#endif
