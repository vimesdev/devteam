...
void CHMSPriorityDialog::OnCreateComponents(){
	...
	m_wndLevel1.Create(this, _T("Level 1 (Emergency)"), 10, 30, 160, 55);
	m_wndLevel2.Create(this, _T("Level 2"), 10, 60, 160, 85);
	m_wndLevel3.Create(this, _T("Level 3"), 10, 90, 160, 115);
...
void CHMSPriorityDialog::OnDoDataExchange(CDataExchange* pDX){
	DDX_Radio(pDX, m_wndLevel1.GetDlgCtrlID(), m_nLevel);
}
