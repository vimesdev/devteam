#ifndef HMSRoomSetupDialogV2_H
#define HMSRoomSetupDialogV2_H
...
class CHMSRoomSetupDialog_V2 : public CGuiDialog
{
protected:
...
public:
	...
	CHMSRoomSetupDialog_V2(CWnd *pParent);
	~CHMSRoomSetupDialog_V2();
