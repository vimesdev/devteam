#ifndef HMSTHIETLAPTHONGTINVATTU_H
#define HMSTHIETLAPTHONGTINVATTU_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSThietLap_Thongtin_Vattu : public CGuiDialog
{
...
public:
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CHMSThietLap_Thongtin_Vattu(CWnd *pParent,long nOrderId=0);
	~CHMSThietLap_Thongtin_Vattu();
	...
	int OnAddHMSThietLap_Thongtin_Vattu(); 
	int OnEditHMSThietLap_Thongtin_Vattu(); 
	int OnDeleteHMSThietLap_Thongtin_Vattu(); 
	int OnSaveHMSThietLap_Thongtin_Vattu(); 
	int OnCancelHMSThietLap_Thongtin_Vattu(); 
	int OnHMSThietLap_Thongtin_VattuListLoadData();
