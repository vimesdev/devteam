...
static void _OnSearchByNameChangeFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnSearchByNameChange();
}
/*static void _OnSearchByNameSetfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnSearchByNameSetfocus();} */ 
/*static void _OnSearchByNameKillfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnSearchByNameKillfocus();
} */
static int _OnSearchByNameCheckValueFnc(CWnd *pWnd){
	return ((CHMS_Doc_Note *)pWnd)->OnSearchByNameCheckValue();
} 
static long _OnListLoadDataFnc(CWnd *pWnd)
{
	return ((CHMS_Doc_Note*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd)
{
	((CHMS_Doc_Note*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMS_Doc_Note*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMS_Doc_Note*)pWnd)->OnListDeleteItem();
} 
/*static void _OnIDChangeFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnIDChange();
} */
/*static void _OnIDSetfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnIDSetfocus();} */ 
/*static void _OnIDKillfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnIDKillfocus();
} */
static int _OnIDCheckValueFnc(CWnd *pWnd){
	return ((CHMS_Doc_Note *)pWnd)->OnIDCheckValue();
} 
/*static void _OnNameChangeFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnNameChange();
} */
/*static void _OnNameSetfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnNameSetfocus();} */ 
/*static void _OnNameKillfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnNameKillfocus();
} */
static int _OnNameCheckValueFnc(CWnd *pWnd){
	return ((CHMS_Doc_Note *)pWnd)->OnNameCheckValue();
} 
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMS_Doc_Note* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CHMS_Doc_Note *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnGroupAddNew();
}*/
static void _OnItemSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMS_Doc_Note* )pWnd)->OnItemSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemSelendokFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnItemSelendok();
}
/*static void _OnItemSetfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnItemKillfocus();
}*/
/*static void _OnItemKillfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnItemKillfocus();
}*/
static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CHMS_Doc_Note *)pWnd)->OnItemLoadData();
}
/*static void _OnItemAddNewFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnItemAddNew();
}*/
/*static void _OnDiscountPercentageChangeFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnDiscountPercentageChange();
} */
/*static void _OnDiscountPercentageSetfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnDiscountPercentageSetfocus();} */ 
/*static void _OnDiscountPercentageKillfocusFnc(CWnd *pWnd){
	((CHMS_Doc_Note *)pWnd)->OnDiscountPercentageKillfocus();
} */
static void _OnActiveSelectFnc(CWnd *pWnd){
	 ((CHMS_Doc_Note*)pWnd)->OnActiveSelect();
}
static void _OnAddSelectFnc(CWnd *pWnd){
	CHMS_Doc_Note *pVw = (CHMS_Doc_Note *)pWnd;
	pVw->OnAddSelect();
} 
...
static int _OnAddCHMS_Doc_NoteFnc(CWnd *pWnd){
	 return ((CHMS_Doc_Note*)pWnd)->OnAddCHMS_Doc_Note();
} 
static int _OnEditCHMS_Doc_NoteFnc(CWnd *pWnd){
	 return ((CHMS_Doc_Note*)pWnd)->OnEditCHMS_Doc_Note();
} 
static int _OnDeleteCHMS_Doc_NoteFnc(CWnd *pWnd){
	 return ((CHMS_Doc_Note*)pWnd)->OnDeleteCHMS_Doc_Note();
} 
static int _OnSaveCHMS_Doc_NoteFnc(CWnd *pWnd){
	 return ((CHMS_Doc_Note*)pWnd)->OnSaveCHMS_Doc_Note();
} 
static int _OnCancelCHMS_Doc_NoteFnc(CWnd *pWnd){
	 return ((CHMS_Doc_Note*)pWnd)->OnCancelCHMS_Doc_Note();
}
static int _OnOrderIDCheckValueFnc(CWnd *pWnd){
	return ((CHMS_Doc_Note *)pWnd)->OnOrderIDCheckValue();
}

static void _OnViewHistorySelectFnc(CWnd *pWnd)
{
	 ((CHMS_Doc_Note*)pWnd)->OnViewHistorySelect();
}

CHMS_Doc_Note::CHMS_Doc_Note(CWnd *pParent, bool bViewHistory):
	CGuiDialog(pParent)
{
	m_nDlgWidth = 1029;
	m_nDlgHeight = 773;
...
CHMS_Doc_Note::~CHMS_Doc_Note()
{
}
void CHMS_Doc_Note::OnCreateComponents()
{
	...
	m_wndViewHistory.Create(this, _T("View History Note"), 0, 0, 0, 0);
...
void CHMS_Doc_Note::OnInitializeComponents(){
...
void CHMS_Doc_Note::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMS_Doc_Note::OnDoDataExchange(CDataExchange* pDX)
{
...
void CHMS_Doc_Note::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CHMS_Doc_Note::GetDataToScreen()
{
...
void CHMS_Doc_Note::GetScreenToData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMS_Doc_Note::SetDefaultValues(){
...
int CHMS_Doc_Note::SetMode(int nMode)
{
	...
	szSQL.Format(_T("RM_CHECK_BEFORE_ADD_EDIT(%ld)"), pMF->m_nDocumentNo);
	int res = str2int(pMF->ExecDML(szSQL));
	

	if(res < 0 && pMF->m_UserInfo.su_groupid != _T("A"))
		{
...
void CHMS_Doc_Note::OnSearchByNameChange()
{
	UpdateData(TRUE);
	OnListLoadData();
}
/*void CHMS_Doc_Note::OnSearchByNameSetfocus(){
	
} */
/*void CHMS_Doc_Note::OnSearchByNameKillfocus(){
	
} */
int CHMS_Doc_Note::OnSearchByNameCheckValue()
{
	UpdateData(TRUE);
	OnListLoadData();
	return 0;
}
int CHMS_Doc_Note::OnContentCheckValue()
{
	return 0;
} 
void CHMS_Doc_Note::OnListDblClick()
{
	
}

int CHMS_Doc_Note::OnOrderIDCheckValue()
{
	return 0;
} 

void CHMS_Doc_Note::OnListSelectChange(int nOldItem, int nNewItem)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	if (nNewItem < 0)
		return;
...
int CHMS_Doc_Note::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CHMS_Doc_Note::OnListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMS_Doc_Note::OnIDChange(){
	
} */
/*void CHMS_Doc_Note::OnIDSetfocus(){
	
} */
/*void CHMS_Doc_Note::OnIDKillfocus(){
	
} */
int CHMS_Doc_Note::OnIDCheckValue(){
	return 0;
} 
/*void CHMS_Doc_Note::OnNameChange(){
	
} */
/*void CHMS_Doc_Note::OnNameSetfocus(){
	
} */
/*void CHMS_Doc_Note::OnNameKillfocus(){
	
} */
int CHMS_Doc_Note::OnNameCheckValue(){
	return 0;
} 
void CHMS_Doc_Note::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMS_Doc_Note::OnGroupSelendok(){
	 
}
/*void CHMS_Doc_Note::OnGroupSetfocus(){
	
}*/
/*void CHMS_Doc_Note::OnGroupKillfocus(){
	
}*/
long CHMS_Doc_Note::OnGroupLoadData()
{
	return 0;
}
/*void CHMS_Doc_Note::OnGroupAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMS_Doc_Note::OnItemSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMS_Doc_Note::OnItemSelendok(){
	 
}
/*void CHMS_Doc_Note::OnItemSetfocus(){
	
}*/
/*void CHMS_Doc_Note::OnItemKillfocus(){
	
}*/
long CHMS_Doc_Note::OnItemLoadData()
{
	return 0;
}
/*void CHMS_Doc_Note::OnItemAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMS_Doc_Note::OnDiscountPercentageChange(){
	
} */
/*void CHMS_Doc_Note::OnDiscountPercentageSetfocus(){
	
} */
/*void CHMS_Doc_Note::OnDiscountPercentageKillfocus(){
	
} */
	void CHMS_Doc_Note::OnActiveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
void CHMS_Doc_Note::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnAddCHMS_Doc_Note();
	
} 
void CHMS_Doc_Note::OnEditSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnEditCHMS_Doc_Note();
	
} 
void CHMS_Doc_Note::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteCHMS_Doc_Note();
	
} 
void CHMS_Doc_Note::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveCHMS_Doc_Note();
	
} 
void CHMS_Doc_Note::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancelCHMS_Doc_Note();
	
} 
void CHMS_Doc_Note::OnCloseSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
	
} 
void CHMS_Doc_Note::OnViewHistorySelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnListLoadData();
...
int CHMS_Doc_Note::OnAddCHMS_Doc_Note()
{
...
int CHMS_Doc_Note::OnEditCHMS_Doc_Note()
{
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
...
int CHMS_Doc_Note::OnDeleteCHMS_Doc_Note()
{
...
int CHMS_Doc_Note::OnSaveCHMS_Doc_Note()
{
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
...
int CHMS_Doc_Note::OnCancelCHMS_Doc_Note()
{
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
...
int CHMS_Doc_Note::OnCHMS_Doc_NoteListLoadData(){
	return 0;
}
void CHMS_Doc_Note::SetItemSel(CGuiListCtrl *pList, CString szID, int nIndex)
{
	if (GetMode() == VM_ADD)
	{
