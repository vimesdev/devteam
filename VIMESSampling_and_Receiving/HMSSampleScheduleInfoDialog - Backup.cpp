...
static void _OnDoctorSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog* )pWnd)->OnDoctorSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDoctorSelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctorSelendok();
}
/*static void _OnDoctorSetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctorKillfocus();
}*/
/*static void _OnDoctorKillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctorKillfocus();
}*/
static long _OnDoctorLoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctorLoadData();
}
/*static void _OnDoctorAddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctorAddNew();
}*/
static void _OnDoctor1SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog* )pWnd)->OnDoctor1SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDoctor1SelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctor1Selendok();
}
/*static void _OnDoctor1SetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctor1Killfocus();
}*/
/*static void _OnDoctor1KillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctor1Killfocus();
}*/
static long _OnDoctor1LoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctor1LoadData();
}
/*static void _OnDoctor1AddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnDoctor1AddNew();
}*/
static void _OnNurses1SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog* )pWnd)->OnNurses1SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNurses1SelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses1Selendok();
}
/*static void _OnNurses1SetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses1Killfocus();
}*/
/*static void _OnNurses1KillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses1Killfocus();
}*/
static long _OnNurses1LoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses1LoadData();
}
/*static void _OnNurses1AddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses1AddNew();
}*/
static void _OnNurses2SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog* )pWnd)->OnNurses2SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNurses2SelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses2Selendok();
}
/*static void _OnNurses2SetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses2Killfocus();
}*/
/*static void _OnNurses2KillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses2Killfocus();
}*/
static long _OnNurses2LoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses2LoadData();
}
/*static void _OnNurses2AddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses2AddNew();
}*/
static void _OnNurses3SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog* )pWnd)->OnNurses3SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNurses3SelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses3Selendok();
}
/*static void _OnNurses3SetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses3Killfocus();
}*/
/*static void _OnNurses3KillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses3Killfocus();
}*/
static long _OnNurses3LoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses3LoadData();
}
/*static void _OnNurses3AddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses3AddNew();
}*/
static void _OnNurses4SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog* )pWnd)->OnNurses4SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNurses4SelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses4Selendok();
}
/*static void _OnNurses4SetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses4Killfocus();
}*/
/*static void _OnNurses4KillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses4Killfocus();
}*/
static long _OnNurses4LoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses4LoadData();
}
/*static void _OnNurses4AddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses4AddNew();
}*/
static void _OnNurses5SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog* )pWnd)->OnNurses5SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNurses5SelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses5Selendok();
}
/*static void _OnNurses5SetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses5Killfocus();
}*/
/*static void _OnNurses5KillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses5Killfocus();
}*/
static long _OnNurses5LoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses5LoadData();
}
/*static void _OnNurses5AddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses5AddNew();
}*/
static void _OnNurses6SelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses6SelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNurses6SelendokFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses6Selendok();
}
/*static void _OnNurses6SetfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses6Killfocus();
}*/
/*static void _OnNurses6KillfocusFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses6Killfocus();
}*/
static long _OnNurses6LoadDataFnc(CWnd *pWnd){
	return ((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses6LoadData();
}
/*static void _OnNurses6AddNewFnc(CWnd *pWnd){
	((CHMSSampleScheduleInfoDialog *)pWnd)->OnNurses6AddNew();
}*/
...
static int _OnAddHMSSurgeryScheduleInfoDialogFnc(CWnd *pWnd){
	 return ((CHMSSampleScheduleInfoDialog*)pWnd)->OnAddHMSSurgeryScheduleInfoDialog();
} 
static int _OnEditHMSSurgeryScheduleInfoDialogFnc(CWnd *pWnd){
	 return ((CHMSSampleScheduleInfoDialog*)pWnd)->OnEditHMSSurgeryScheduleInfoDialog();
} 
static int _OnDeleteHMSSurgeryScheduleInfoDialogFnc(CWnd *pWnd){
	 return ((CHMSSampleScheduleInfoDialog*)pWnd)->OnDeleteHMSSurgeryScheduleInfoDialog();
} 
static int _OnSaveHMSSurgeryScheduleInfoDialogFnc(CWnd *pWnd){
	 return ((CHMSSampleScheduleInfoDialog*)pWnd)->OnSaveHMSSurgeryScheduleInfoDialog();
} 
static int _OnCancelHMSSurgeryScheduleInfoDialogFnc(CWnd *pWnd){
	 return ((CHMSSampleScheduleInfoDialog*)pWnd)->OnCancelHMSSurgeryScheduleInfoDialog();
} 
...
void CHMSSampleScheduleInfoDialog::OnInitializeComponents(){
	...
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_doctor"), dfText, 15);
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_doctor1"), dfText, 15);
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_nurse1"), dfText, 15);
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_nurse2"), dfText, 15);
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_nurse3"), dfText, 15);
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_nurse4"), dfText, 15);
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_nurse5"), dfText, 15);
	m_hms_sample_schedule_lineTbl.AddField(_T("hssl_nurse6"), dfText, 15);
}
...
void CHMSSampleScheduleInfoDialog::GetScreenToData()
{
	...
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_doctor"), m_szDoctorKey);
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_doctor1"), m_szDoctor1Key);
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_nurse1"), m_szNurses1Key);
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_nurse2"), m_szNurses2Key);
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_nurse3"), m_szNurses3Key);
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_nurse4"), m_szNurses4Key);
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_nurse5"), m_szNurses5Key);
	m_hms_sample_schedule_lineTbl.SetValue(_T("hssl_nurse6"), m_szNurses6Key);
}
...
void CHMSSampleScheduleInfoDialog::OnDoctorSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnDoctorSelendok(){
	 
}
/*void CHMSSampleScheduleInfoDialog::OnDoctorSetfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnDoctorKillfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnDoctorLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSSampleScheduleInfoDialog::OnDoctorAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSSampleScheduleInfoDialog::OnDoctor1SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnDoctor1Selendok(){
	 
}
/*void CHMSSampleScheduleInfoDialog::OnDoctor1Setfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnDoctor1Killfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnDoctor1LoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSSampleScheduleInfoDialog::OnDoctor1AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSSampleScheduleInfoDialog::OnNurses1SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnNurses1Selendok(){
	 
}
/*void CHMSSampleScheduleInfoDialog::OnNurses1Setfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnNurses1Killfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnNurses1LoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSSampleScheduleInfoDialog::OnNurses1AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSSampleScheduleInfoDialog::OnNurses2SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnNurses2Selendok(){
	 
}
/*void CHMSSampleScheduleInfoDialog::OnNurses2Setfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnNurses2Killfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnNurses2LoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSSampleScheduleInfoDialog::OnNurses2AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSSampleScheduleInfoDialog::OnNurses3SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnNurses3Selendok(){
	 
}
/*void CHMSSampleScheduleInfoDialog::OnNurses3Setfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnNurses3Killfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnNurses3LoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSSampleScheduleInfoDialog::OnNurses3AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSSampleScheduleInfoDialog::OnNurses4SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnNurses4Selendok(){
	 
}
/*void CHMSSampleScheduleInfoDialog::OnNurses4Setfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnNurses4Killfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnNurses4LoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSSampleScheduleInfoDialog::OnNurses4AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSSampleScheduleInfoDialog::OnNurses5SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnNurses5Selendok(){
	 
}
/*void CHMSSampleScheduleInfoDialog::OnNurses5Setfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnNurses5Killfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnNurses5LoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSSampleScheduleInfoDialog::OnNurses5AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSSampleScheduleInfoDialog::OnNurses6SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSSampleScheduleInfoDialog::OnNurses6Selendok()
{
	 
}
/*void CHMSSampleScheduleInfoDialog::OnNurses6Setfocus(){
	
}*/
/*void CHMSSampleScheduleInfoDialog::OnNurses6Killfocus(){
	
}*/
long CHMSSampleScheduleInfoDialog::OnNurses6LoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSSampleScheduleInfoDialog::OnNurses6AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSSampleScheduleInfoDialog::OnAddHMSSurgeryScheduleInfoDialog(){
...
int CHMSSampleScheduleInfoDialog::OnEditHMSSurgeryScheduleInfoDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHMSSampleScheduleInfoDialog::OnDeleteHMSSurgeryScheduleInfoDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL; 
...
int CHMSSampleScheduleInfoDialog::OnSaveHMSSurgeryScheduleInfoDialog()
{
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
...
int CHMSSampleScheduleInfoDialog::OnCancelHMSSurgeryScheduleInfoDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSSampleScheduleInfoDialog::OnHMSSurgeryScheduleInfoDialogListLoadData(){
	return 0;
}
