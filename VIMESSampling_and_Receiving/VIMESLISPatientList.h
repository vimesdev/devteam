#ifndef LABPATIENTLIST_H
#define LABPATIENTLIST_H
...
#include "GuiView.h"
#include "DbField.h"
class CVIMESLISPatientList : public CGuiView{
protected:
public:
	...
	int OnAddLabPatientList(); 
	int OnEditLabPatientList(); 
	int OnDeleteLabPatientList(); 
	int OnSaveLabPatientList(); 
	int OnCancelLabPatientList(); 
	int OnLabPatientListListLoadData(); 
