...
static int _OnResListRefreshItemFnc(CWnd *pWnd){
	 return ((CLIMSMergeResultDialog*)pWnd)->OnResListRefresh();
} 
...
void CLIMSMergeResultDialog::OnCreateComponents(){
	m_wndOrderInformation.Create(this, _T("Order Information"), 5, 5, 640, 600);
	m_wndSIDLabel.Create(this, _T("SID"), 10, 30, 90, 55);
	m_wndSID.Create(this,95, 30, 215, 55); 
	m_wndPatientList.Create(this,10, 60, 635, 190); 
	m_wndResList.Create(this,10, 195, 635, 595); 
	m_wndApply.Create(this, _T("&Accept"), 475, 605, 555, 630);
	m_wndClose.Create(this, _T("&Close"), 560, 605, 640, 630);	
...
void CLIMSMergeResultDialog::OnSetWindowEvents(){
	...
	m_wndPatientList.AddEvent(1, _T("&Accept"), _OnResListDeleteItemFnc);
	m_wndPatientList.AddEvent(0, _T("-"));
	m_wndPatientList.AddEvent(2, _T("&Refresh"), _OnResListRefreshItemFnc);
...
int CLIMSMergeResultDialog::OnResListRefresh(){
	OnPatientListLoadData();
	return 0;
}
