...
#include "GuiDialog.h"
#include "DbField.h"
class CImageEditor : public CGuiDialog{
protected:
public:
	...
	int OnAddImageEditor(); 
	int OnEditImageEditor(); 
	int OnDeleteImageEditor(); 
	int OnSaveImageEditor(); 
	int OnCancelImageEditor(); 
	int OnImageEditorListLoadData(); 
};
#endif
