#ifndef PACSRESULTINPUT_H
#define PACSRESULTINPUT_H
...
#include "GuiView.h"
#include "DbField.h"
class CPACSResultInput : public CGuiView{
protected:
public:
	...
	int OnAddPACSResultInput(); 
	int OnEditPACSResultInput(); 
	int OnDeletePACSResultInput(); 
	int OnSavePACSResultInput(); 
	int OnCancelPACSResultInput(); 
	int OnPACSResultInputListLoadData(); 
};
#endif
