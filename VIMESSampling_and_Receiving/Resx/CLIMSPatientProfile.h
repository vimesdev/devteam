#ifndef CLIMSPATIENTPROFILE_H
#define CLIMSPATIENTPROFILE_H
...
#include "GuiView.h"
#include "DbField.h"
class CCLIMSPatientProfile : public CGuiView{
protected:
public:
	...
	int OnAddCLIMSPatientProfile(); 
	int OnEditCLIMSPatientProfile(); 
	int OnDeleteCLIMSPatientProfile(); 
	int OnSaveCLIMSPatientProfile(); 
	int OnCancelCLIMSPatientProfile(); 
	int OnCLIMSPatientProfileListLoadData(); 
};
#endif
