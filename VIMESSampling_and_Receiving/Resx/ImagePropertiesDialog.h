...
#include "GuiDialog.h"
#include "DbField.h"
class CImagePropertiesDialog : public CGuiDialog{
protected:
public:
	CGuiGroupBox	m_wndImageProperties;
	CGuiTabCtrl	m_wndImage;
	...
	int OnAddImagePropertiesDialog(); 
	int OnEditImagePropertiesDialog(); 
	int OnDeleteImagePropertiesDialog(); 
	int OnSaveImagePropertiesDialog(); 
	int OnCancelImagePropertiesDialog(); 
	int OnImagePropertiesDialogListLoadData(); 
};
#endif
