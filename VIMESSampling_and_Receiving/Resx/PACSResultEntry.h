#ifndef RISRESULTENTRY_H
#define RISRESULTENTRY_H
...
#include "GuiView.h"
#include "DbField.h"
class CRISResultEntry : public CGuiView{
protected:
public:
	...
	int OnAddRISResultEntry(); 
	int OnEditRISResultEntry(); 
	int OnDeleteRISResultEntry(); 
	int OnSaveRISResultEntry(); 
	int OnCancelRISResultEntry(); 
	int OnRISResultEntryListLoadData(); 
};
#endif
