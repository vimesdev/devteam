#ifndef CabinetOrder_H
#define CabinetOrder_H
...
class CCabinetOrder : public CGuiView{
protected:
public:
	CWnd*		m_wndOrder;
	long		m_nID;
	...
	int OnAddCabinetOrder(); 
	int OnEditCabinetOrder(); 
	int OnDeleteCabinetOrder(); 
	int OnSaveCabinetOrder(); 
	int OnDiscardCabinetOrder(); 
	int OnCabinetOrderListLoadData(); 
