#ifndef HMSINSTRUMENTDATASETUP_H
#define HMSINSTRUMENTDATASETUP_H
...
#include "GuiView.h"
#include "DbField.h"
class CVIMESLISInstrumentDataSetup : public CGuiView{
protected:
public:
	int				m_nInstrumentID;
	...
	int OnAddHMSInstrumentDataSetup(); 
	int OnEditHMSInstrumentDataSetup(); 
	int OnDeleteHMSInstrumentDataSetup(); 
	int OnSaveHMSInstrumentDataSetup(); 
	int OnCancelHMSInstrumentDataSetup(); 
	int OnHMSInstrumentDataSetupListLoadData(); 
};
#endif
