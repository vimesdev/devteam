#ifndef HMSROOMEXAMINATIONREPORTDIALOG1_H
#define HMSROOMEXAMINATIONREPORTDIALOG1_H
...
#include "GuiDialog.h"
#include "DbField.h"
class HMSTonghopCLSReportDialog: public CGuiDialog{
protected:
public:
	...
	HMSTonghopCLSReportDialog(CWnd *pParent);
	~HMSTonghopCLSReportDialog();
