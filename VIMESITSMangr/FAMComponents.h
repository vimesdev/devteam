#ifndef FAMCOMPONENTS_H
#define FAMCOMPONENTS_H
...
#include "GuiView.h"
#include "DbField.h"
class CFAMComponents : public CGuiView{
protected:
public:
	...
	int OnAddFAMComponents(); 
	int OnEditFAMComponents(); 
	int OnDeleteFAMComponents(); 
	int OnSaveFAMComponents(); 
	int OnCancelFAMComponents(); 
	int OnFAMComponentsListLoadData(); 
};
#endif
