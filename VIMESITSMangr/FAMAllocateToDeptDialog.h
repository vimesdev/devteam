#ifndef FAMALLOCATETODEPTDIALOG_H
#define FAMALLOCATETODEPTDIALOG_H
...
class CFAMAllocateToDeptDialog : public CGuiDialog{
protected:
public:
	...
	CFAMAllocateToDeptLine m_wndTTDL;
	CFAMReceiptOrderLine m_wndROL;
	CDbfMap m_tbl_Allocate;
	...
	void			OnImportSelect(); 
	void			OnCloseSelect(); 
	CFAMAllocateToDeptDialog(CWnd *pParent);
	~CFAMAllocateToDeptDialog();
	...
	int OnAddFAMAllocateToDeptDialog(); 
	int OnEditFAMAllocateToDeptDialog(); 
	int OnDeleteFAMAllocateToDeptDialog(); 
	int OnSaveFAMAllocateToDeptDialog(); 
	int OnCancelFAMAllocateToDeptDialog(); 
	int OnFAMAllocateToDeptDialogListLoadData(); 
};
#endif
