#ifndef FAMOTHERTRANSACTION_H
#define FAMOTHERTRANSACTION_H
...
#include "GuiView.h"
#include "DbField.h"
class CFAMOtherTransaction : public CGuiView{
protected:
public:
	...
	int OnAddFAMOtherTransaction(); 
	int OnEditFAMOtherTransaction(); 
	int OnDeleteFAMOtherTransaction(); 
	int OnSaveFAMOtherTransaction(); 
	int OnCancelFAMOtherTransaction(); 
	int OnFAMOtherTransactionListLoadData(); 
};
#endif
