#ifndef FAMLIQUIDATED_H
#define FAMLIQUIDATED_H
...
#include "GuiView.h"
#include "DbField.h"
class CFAMLiquidated : public CGuiView{
protected:
public:
	...
	int OnAddFAMLiquidated(); 
	int OnEditFAMLiquidated(); 
	int OnDeleteFAMLiquidated(); 
	int OnSaveFAMLiquidated(); 
	int OnCancelFAMLiquidated(); 
	int OnFAMLiquidatedListLoadData(); 
};
#endif
