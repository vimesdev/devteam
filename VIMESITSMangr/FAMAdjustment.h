#ifndef FAMADJUSTMENT_H
#define FAMADJUSTMENT_H
...
#include "GuiView.h"
#include "DbField.h"
class CFAMAdjustment : public CGuiView{
protected:
public:
	...
	int OnAddFAMAdjustment(); 
	int OnEditFAMAdjustment(); 
	int OnDeleteFAMAdjustment(); 
	int OnSaveFAMAdjustment(); 
	int OnCancelFAMAdjustment(); 
	int OnFAMAdjustmentListLoadData(); 
};
#endif
