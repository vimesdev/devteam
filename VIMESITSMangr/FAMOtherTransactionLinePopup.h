#ifndef FAMOTHERTRANSACTIONLINEPOPUP_H
#define FAMOTHERTRANSACTIONLINEPOPUP_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CFAMOtherTransactionLinePopup : public CGuiPopup{
protected:
	CWnd*			m_pParentWnd;
public:
	...
	CFAMOtherTransactionLinePopup(CWnd *pParent, int nMode);
	~CFAMOtherTransactionLinePopup();
	...
	int OnAddFAMOtherTransactionLinePopup(); 
	int OnEditFAMOtherTransactionLinePopup(); 
	int OnDeleteFAMOtherTransactionLinePopup(); 
	int OnSaveFAMOtherTransactionLinePopup(); 
	int OnCancelFAMOtherTransactionLinePopup(); 
	int OnFAMOtherTransactionLinePopupListLoadData(); 
};
#endif
