...
void CFAMTransactionOrderLine::OnInitializeComponents(){
	...
	m_wndItemList.InsertColumn(9, _T("Intended Use"), CFMT_TEXT, 50);
	m_wndItemList.InsertColumn(10, _T("TransactionID"), CFMT_TEXT, 0);
...
void CFAMTransactionOrderLine::OnItemListSelectChange(int nOldItem, int nNewItem){
	...
	m_szTranLineID = m_wndItemList.GetItemText(nNewItem, 10);
...
int CFAMTransactionOrderLine::OnItemListDeleteItem(){
	...
	if(nSel < 0)
		return 0;
	CString szLine = m_wndItemList.GetItemText(nSel, 10);
