#ifndef FAMRECEIPTORDER_H
#define FAMRECEIPTORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class CFAMReceiptOrder : public CGuiView{
protected:
public:
	...
	int OnAddFAMReceiptOrder(); 
	int OnEditFAMReceiptOrder(); 
	int OnDeleteFAMReceiptOrder(); 
	int OnSaveFAMReceiptOrder(); 
	int OnCancelFAMReceiptOrder(); 
	int OnFAMReceiptOrderListLoadData();
	int OnRecoverOrder();
};
#endif
