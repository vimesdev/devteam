...
void CFAMTransactionOrderLinePopup::OnInitializeComponents(){
	...
	m_wndItemName.InsertColumn(0, _T("Item No"), CFMT_TEXT, 100);
	m_wndItemName.InsertColumn(1, _T("Item Name"), CFMT_TEXT, 300);
...
long CFAMTransactionOrderLinePopup::OnItemNameLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	return pMF->LoadItemList(&m_wndItemName, m_szItemNameKey);
