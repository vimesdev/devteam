#ifndef FAMMAINTENANCEREPAIR_H
#define FAMMAINTENANCEREPAIR_H
...
#include "GuiView.h"
#include "DbField.h"
class CFAMMaintenanceRepair : public CGuiView{
protected:
public:
	...
	int OnAddFAMMaintenanceRepair(); 
	int OnEditFAMMaintenanceRepair(); 
	int OnDeleteFAMMaintenanceRepair(); 
	int OnSaveFAMMaintenanceRepair(); 
	int OnCancelFAMMaintenanceRepair(); 
	int OnFAMMaintenanceRepairListLoadData(); 
};
#endif
