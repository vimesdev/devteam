...
static void _OnSearchChangeFnc(CWnd *pWnd){
	((CVIMESGeneralSetupDialog *)pWnd)->OnSearchChange();
}
/*static void _OnSearchSetfocusFnc(CWnd *pWnd){
	((CVIMESGeneralSetupDialog *)pWnd)->OnSearchSetfocus();} */ 
/*static void _OnSearchKillfocusFnc(CWnd *pWnd){
	((CVIMESGeneralSetupDialog *)pWnd)->OnSearchKillfocus();
} */
static int _OnSearchCheckValueFnc(CWnd *pWnd){
	return ((CVIMESGeneralSetupDialog *)pWnd)->OnSearchCheckValue();
} 
...
void CVIMESGeneralSetupDialog::OnCreateComponents(){
	m_wndGeneralInformation.Create(this, _T("General Information"), 5, 5, 485, 505);
	...
	m_wndAdd.Create(this, _T("&Add"), 7, 475, 82, 500);
	m_wndEdit.Create(this, _T("&Edit"), 87, 475, 162, 500);
	m_wndDelete.Create(this, _T("&Delete"), 167, 475, 242, 500);
	m_wndSave.Create(this, _T("&Save"), 247, 475, 322, 500);
	m_wndCancel.Create(this, _T("&Cancel"), 327, 475, 402, 500);
	m_wndClose.Create(this, _T("&Close"), 407, 475, 482, 500);
	m_wndSearchLabel.Create(this, _T("Search By Name"), 10, 30, 120, 55);
	m_wndSearch.Create(this,125, 30, 365, 55);
}
...
void CVIMESGeneralSetupDialog::OnSearchChange()
{
	
}
/*void CVIMESGeneralSetupDialog::OnSearchSetfocus(){
	
} */
/*void CVIMESGeneralSetupDialog::OnSearchKillfocus(){
	
} */
int CVIMESGeneralSetupDialog::OnSearchCheckValue(){
	return 0;
} 
