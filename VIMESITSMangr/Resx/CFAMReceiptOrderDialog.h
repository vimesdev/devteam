#ifndef CFAMRECEIPTORDERDIALOG_H
#define CFAMRECEIPTORDERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCFAMReceiptOrderDialog : public CGuiDialog{
protected:
public:
	...
	void			OnImportSelect(); 
	void			OnCloseSelect(); 
	CCFAMReceiptOrderDialog(CWnd *pParent);
	~CCFAMReceiptOrderDialog();
	...
	int OnAddCFAMReceiptOrderDialog(); 
	int OnEditCFAMReceiptOrderDialog(); 
	int OnDeleteCFAMReceiptOrderDialog(); 
	int OnSaveCFAMReceiptOrderDialog(); 
	int OnCancelCFAMReceiptOrderDialog(); 
	int OnCFAMReceiptOrderDialogListLoadData(); 
};
#endif
