#ifndef FAMTRANSFERTODEPTDIALOG_H
#define FAMTRANSFERTODEPTDIALOG_H
...
class CFAMTransferToDeptDialog : public CGuiDialog{
protected:
public:
	...
	CString szStatusDlg;
	CFAMTransferToDeptLine m_wndTTDL;
	CDbfMap m_tbl_transfer;
	...
	void			OnImportSelect(); 
	void			OnCloseSelect(); 
	CFAMTransferToDeptDialog(CWnd *pParent);
	~CFAMTransferToDeptDialog();
	...
	int OnAddFAMTransferToDeptDialog(); 
	int OnEditFAMTransferToDeptDialog(); 
	int OnDeleteFAMTransferToDeptDialog(); 
	int OnSaveFAMTransferToDeptDialog(); 
	int OnCancelFAMTransferToDeptDialog(); 
	int OnFAMTransferToDeptDialogListLoadData(); 
};
#endif
