#include "PRParaclinicResultDialog.h"
#include "GuiMainFrame.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPRParaclinicResultDialog *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPRParaclinicResultDialog *)pWnd)->OnToDateCheckValue();
} 
static void _OnSpecialFilterSelectFnc(CWnd *pWnd){
	 ((CPRParaclinicResultDialog*)pWnd)->OnSpecialFilterSelect();
}

static void _OnAllDeptSelectFnc(CWnd *pWnd){
	 ((CPRParaclinicResultDialog*)pWnd)->OnAllDeptSelect();
}

static long _OnItemLoadDataFnc(CWnd *pWnd){
	return ((CPRParaclinicResultDialog*)pWnd)->OnItemLoadData();
} 
static void _OnItemDblClickFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog*)pWnd)->OnItemDblClick();
} 
static void _OnItemSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPRParaclinicResultDialog*)pWnd)->OnItemSelectChange(nOldItem, nNewItem);
} 
static int _OnItemDeleteItemFnc(CWnd *pWnd){
	 return ((CPRParaclinicResultDialog*)pWnd)->OnItemDeleteItem();
} 
/*static void _OnDescriptionChangeFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnDescriptionChange();
} */
/*static void _OnDescriptionSetfocusFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnDescriptionSetfocus();} */ 
/*static void _OnDescriptionKillfocusFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog *)pWnd)->OnDescriptionKillfocus();
} */
static int _OnDescriptionCheckValueFnc(CWnd *pWnd){
	return ((CPRParaclinicResultDialog *)pWnd)->OnDescriptionCheckValue();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CPRParaclinicResultDialog*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CPRParaclinicResultDialog*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPRParaclinicResultDialog*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CPRParaclinicResultDialog*)pWnd)->OnListDeleteItem();
} 
static void _OnMarkAllSelectFnc(CWnd *pWnd){
	CPRParaclinicResultDialog *pVw = (CPRParaclinicResultDialog *)pWnd;
	pVw->OnMarkAllSelect();
} 
...
static int _OnAddHMSParaclinicResultDialogFnc(CWnd *pWnd){
	 return ((CPRParaclinicResultDialog*)pWnd)->OnAddHMSParaclinicResultDialog();
} 
static int _OnEditHMSParaclinicResultDialogFnc(CWnd *pWnd){
	 return ((CPRParaclinicResultDialog*)pWnd)->OnEditHMSParaclinicResultDialog();
} 
static int _OnDeleteHMSParaclinicResultDialogFnc(CWnd *pWnd){
	 return ((CPRParaclinicResultDialog*)pWnd)->OnDeleteHMSParaclinicResultDialog();
} 
static int _OnSaveHMSParaclinicResultDialogFnc(CWnd *pWnd){
	 return ((CPRParaclinicResultDialog*)pWnd)->OnSaveHMSParaclinicResultDialog();
} 
static int _OnCancelHMSParaclinicResultDialogFnc(CWnd *pWnd){
	 return ((CPRParaclinicResultDialog*)pWnd)->OnCancelHMSParaclinicResultDialog();
} 
CPRParaclinicResultDialog::CPRParaclinicResultDialog(CWnd *pParent, long nDocumentNo, bool bAllDept):
	CGuiDialog(pParent){
...
CPRParaclinicResultDialog::~CPRParaclinicResultDialog(){
}
void CPRParaclinicResultDialog::OnCreateComponents(){
...
void CPRParaclinicResultDialog::OnInitializeComponents(){
...
void CPRParaclinicResultDialog::OnSetWindowEvents(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
...
void CPRParaclinicResultDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CPRParaclinicResultDialog::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CPRParaclinicResultDialog::GetDataToScreen(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CPRParaclinicResultDialog::GetScreenToData(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();

}
void CPRParaclinicResultDialog::SetDefaultValues(){
...
int CPRParaclinicResultDialog::SetMode(int nMode){
...
/*void CPRParaclinicResultDialog::OnFromDateChange(){
	
} */
/*void CPRParaclinicResultDialog::OnFromDateSetfocus(){
	
} */
/*void CPRParaclinicResultDialog::OnFromDateKillfocus(){
	
} */
int CPRParaclinicResultDialog::OnFromDateCheckValue(){
	OnItemLoadData();
	return 0;
} 
/*void CPRParaclinicResultDialog::OnToDateChange(){
	
} */
/*void CPRParaclinicResultDialog::OnToDateSetfocus(){
	
} */
/*void CPRParaclinicResultDialog::OnToDateKillfocus(){
	
} */
int CPRParaclinicResultDialog::OnToDateCheckValue(){
	OnItemLoadData();
	return 0;
} 
void CPRParaclinicResultDialog::OnSpecialFilterSelect(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnItemLoadData();
	UpdateData(FALSE);
...
void CPRParaclinicResultDialog::OnAllDeptSelect(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	UpdateData(TRUE);
	OnItemLoadData();
	UpdateData(FALSE);
}
void CPRParaclinicResultDialog::OnItemDblClick(){
...
void CPRParaclinicResultDialog::OnItemSelectChange(int nOldItem, int nNewItem){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	if(nNewItem < 0)
		return;
...
int CPRParaclinicResultDialog::OnItemDeleteItem(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CPRParaclinicResultDialog::OnItemLoadData(){
...
/*void CPRParaclinicResultDialog::OnDescriptionChange(){
	
} */
/*void CPRParaclinicResultDialog::OnDescriptionSetfocus(){
	
} */
/*void CPRParaclinicResultDialog::OnDescriptionKillfocus(){
	
} */
int CPRParaclinicResultDialog::OnDescriptionCheckValue(){
	return 0;
} 
void CPRParaclinicResultDialog::OnListDblClick(){
	
} 
void CPRParaclinicResultDialog::OnListSelectChange(int nOldItem, int nNewItem){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	
} 
int CPRParaclinicResultDialog::OnListDeleteItem(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CPRParaclinicResultDialog::OnListLoadData(){
...
void CPRParaclinicResultDialog::OnMarkAllSelect(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	for (int i=0; i < m_wndItem.GetItemCount(); i++)
	{
		m_wndItem.SetCheck(i, TRUE);
...
void CPRParaclinicResultDialog::OnUnMarkSelect(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	for (int i=0; i < m_wndItem.GetItemCount(); i++)
	{
...
void CPRParaclinicResultDialog::OnApplySelect(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	m_szData.Empty();
...
void CPRParaclinicResultDialog::OnCloseSelect(){
	CGuiMainFrame *pMF = (CGuiMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
int CPRParaclinicResultDialog::OnAddHMSParaclinicResultDialog(){
...
int CPRParaclinicResultDialog::OnEditHMSParaclinicResultDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CGuiMainFrame *pMF = (CGuiMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CPRParaclinicResultDialog::OnDeleteHMSParaclinicResultDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CGuiMainFrame *pMF = (CGuiMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CPRParaclinicResultDialog::OnSaveHMSParaclinicResultDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CPRParaclinicResultDialog::OnCancelHMSParaclinicResultDialog(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CPRParaclinicResultDialog::OnHMSParaclinicResultDialogListLoadData(){
	return 0;
}
