#ifndef HMSExmImportExcelDialogEx_H
#define HMSExmImportExcelDialogEx_H
...
class AFX_EXT_CLASS CHMSExmImportExcelDialogEx : public CGuiDialog
{
...
public:
	...
	CHMSExmImportExcelDialogEx(CWnd *pParent);
	~CHMSExmImportExcelDialogEx();
