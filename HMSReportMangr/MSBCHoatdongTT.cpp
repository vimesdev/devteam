...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongTT *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongTT *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongTT *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongTT *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongTT *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongTT *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongTT *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongTT *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CMSBCHoatdongTT *pVw = (CMSBCHoatdongTT *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CMSBCHoatdongTT*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CMSBCHoatdongTT*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CMSBCHoatdongTT*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongTT*)pWnd)->OnListDeleteItem();
} 
static int _OnAddMSBCHoatdongTTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongTT*)pWnd)->OnAddMSBCHoatdongTT();
} 
static int _OnEditMSBCHoatdongTTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongTT*)pWnd)->OnEditMSBCHoatdongTT();
} 
static int _OnDeleteMSBCHoatdongTTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongTT*)pWnd)->OnDeleteMSBCHoatdongTT();
} 
static int _OnSaveMSBCHoatdongTTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongTT*)pWnd)->OnSaveMSBCHoatdongTT();
} 
static int _OnCancelMSBCHoatdongTTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongTT*)pWnd)->OnCancelMSBCHoatdongTT();
} 
CMSBCHoatdongTT::CMSBCHoatdongTT(){
...
void CMSBCHoatdongTT::OnCreateComponents(){
	...
	m_wndList.InsertColumn(46, _T("T\x1ED5ng \x43\x1ED9ng"), CFMT_NUMBER, 50);

}
void CMSBCHoatdongTT::OnInitializeComponents(){
...
void CMSBCHoatdongTT::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CMSBCHoatdongTT::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CMSBCHoatdongTT::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMSBCHoatdongTT::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CMSBCHoatdongTT::SetDefaultValues(){

	m_szFromDate.Empty();
	m_szToDate.Empty();

}
int CMSBCHoatdongTT::SetMode(int nMode){
...
/*void CMSBCHoatdongTT::OnFromDateChange(){
	
} */
/*void CMSBCHoatdongTT::OnFromDateSetfocus(){
	
} */
/*void CMSBCHoatdongTT::OnFromDateKillfocus(){
	
} */
int CMSBCHoatdongTT::OnFromDateCheckValue(){
	return 0;
} 
/*void CMSBCHoatdongTT::OnToDateChange(){
	
} */
/*void CMSBCHoatdongTT::OnToDateSetfocus(){
	
} */
/*void CMSBCHoatdongTT::OnToDateKillfocus(){
	
} */
int CMSBCHoatdongTT::OnToDateCheckValue(){
	return 0;
} 
void CMSBCHoatdongTT::OnLoadSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnListLoadData();
} 
void CMSBCHoatdongTT::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	...
	if(!rpt.Init(_T("Reports/HMS/BCHOATDONGTT.rpt")) )
		return ;
...
void CMSBCHoatdongTT::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CReport rpt; 
	CRecord rs(&pMF->m_db); 
	UpdateData(true);
...
int CMSBCHoatdongTT::OnAddMSBCHoatdongTT(){
...
int CMSBCHoatdongTT::OnEditMSBCHoatdongTT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CMSBCHoatdongTT::OnDeleteMSBCHoatdongTT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelMSBCHoatdongTT();
 	}
	return 0;
}
int CMSBCHoatdongTT::OnSaveMSBCHoatdongTT(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CMSBCHoatdongTT::OnCancelMSBCHoatdongTT(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CMSBCHoatdongTT::OnMSBCHoatdongTTListLoadData(){
	return 0;
}
CString CMSBCHoatdongTT::GetQueryString(){
	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd();
