#include "BCTHUTHUAT.h"
#include "MainFrm.h"
#include "ReportDocument.h"
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CBCTHUTHUAT *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CBCTHUTHUAT *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CBCTHUTHUAT *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTHUTHUAT *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CBCTHUTHUAT *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CBCTHUTHUAT *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CBCTHUTHUAT *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTHUTHUAT *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CBCTHUTHUAT *pVw = (CBCTHUTHUAT *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CBCTHUTHUAT*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CBCTHUTHUAT*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBCTHUTHUAT*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CBCTHUTHUAT*)pWnd)->OnListDeleteItem();
} 
static int _OnAddBCTHUTHUATFnc(CWnd *pWnd){
	 return ((CBCTHUTHUAT*)pWnd)->OnAddBCTHUTHUAT();
} 
static int _OnEditBCTHUTHUATFnc(CWnd *pWnd){
	 return ((CBCTHUTHUAT*)pWnd)->OnEditBCTHUTHUAT();
} 
static int _OnDeleteBCTHUTHUATFnc(CWnd *pWnd){
	 return ((CBCTHUTHUAT*)pWnd)->OnDeleteBCTHUTHUAT();
} 
static int _OnSaveBCTHUTHUATFnc(CWnd *pWnd){
	 return ((CBCTHUTHUAT*)pWnd)->OnSaveBCTHUTHUAT();
} 
static int _OnCancelBCTHUTHUATFnc(CWnd *pWnd){
	 return ((CBCTHUTHUAT*)pWnd)->OnCancelBCTHUTHUAT();
} 
CBCTHUTHUAT::CBCTHUTHUAT(){
...
void CBCTHUTHUAT::OnCreateComponents(){
...
void CBCTHUTHUAT::OnInitializeComponents(){
...
void CBCTHUTHUAT::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CBCTHUTHUAT::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CBCTHUTHUAT::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBCTHUTHUAT::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CBCTHUTHUAT::SetDefaultValues(){

	m_szFromDate.Empty();
	m_szToDate.Empty();

}
int CBCTHUTHUAT::SetMode(int nMode){
...
/*void CBCTHUTHUAT::OnFromDateChange(){
	
} */
/*void CBCTHUTHUAT::OnFromDateSetfocus(){
	
} */
/*void CBCTHUTHUAT::OnFromDateKillfocus(){
	
} */
int CBCTHUTHUAT::OnFromDateCheckValue(){
	return 0;
} 
/*void CBCTHUTHUAT::OnToDateChange(){
	
} */
/*void CBCTHUTHUAT::OnToDateSetfocus(){
	
} */
/*void CBCTHUTHUAT::OnToDateKillfocus(){
	
} */
int CBCTHUTHUAT::OnToDateCheckValue(){
	return 0;
} 
void CBCTHUTHUAT::OnLoadSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnListLoadData();
} 
void CBCTHUTHUAT::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CBCTHUTHUAT::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CReport rpt; 
	CRecord rs(&pMF->m_db); 
	UpdateData(true);
...
void CBCTHUTHUAT::OnListDblClick(){
	
} 
void CBCTHUTHUAT::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CBCTHUTHUAT::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CBCTHUTHUAT::OnListLoadData(){
	UpdateData(TRUE);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	m_wndList.BeginLoad(); 
...
int CBCTHUTHUAT::OnAddBCTHUTHUAT(){
...
int CBCTHUTHUAT::OnEditBCTHUTHUAT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CBCTHUTHUAT::OnDeleteBCTHUTHUAT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CBCTHUTHUAT::OnSaveBCTHUTHUAT(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CBCTHUTHUAT::OnCancelBCTHUTHUAT(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CBCTHUTHUAT::OnBCTHUTHUATListLoadData(){
	return 0;
}
CString CBCTHUTHUAT::GetQueryString(){
	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd();
