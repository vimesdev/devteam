#ifndef CBCDANHSACHBENHNHANRAVIEN_H
#define CBCDANHSACHBENHNHANRAVIEN_H
...
#include "GuiView.h"
#include "DbField.h"
class CCBCDANHSACHBENHNHANRAVIEN : public CGuiView
{
protected:
public:
	...
	CGuiCheckBox	m_wndExam;
	CGuiListCtrl	m_wndList;
	CGuiLabel		m_wndZones;
	...
	int OnAddCBCDANHSACHBENHNHANRAVIEN(); 
	int OnEditCBCDANHSACHBENHNHANRAVIEN(); 
	int OnDeleteCBCDANHSACHBENHNHANRAVIEN(); 
	int OnSaveCBCDANHSACHBENHNHANRAVIEN(); 
	int OnCancelCBCDANHSACHBENHNHANRAVIEN(); 
	int OnCBCDANHSACHBENHNHANRAVIENListLoadData(); 
