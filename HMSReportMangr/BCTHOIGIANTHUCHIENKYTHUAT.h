#ifndef BCTHOIGIANTHUCHIENKYTHUAT_H
#define BCTHOIGIANTHUCHIENKYTHUAT_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCTHOIGIANTHUCHIENKYTHUAT : public CGuiView
{
protected:
public:
	...
	int OnAddCBCTHOIGIANTHUCHIENKYTHUAT(); 
	int OnEditCBCTHOIGIANTHUCHIENKYTHUAT(); 
	int OnDeleteCBCTHOIGIANTHUCHIENKYTHUAT(); 
	int OnSaveCBCTHOIGIANTHUCHIENKYTHUAT(); 
	int OnCancelCBCTHOIGIANTHUCHIENKYTHUAT(); 
	int OnCBCTHOIGIANTHUCHIENKYTHUATListLoadData(); 
