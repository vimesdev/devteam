#ifndef BCSOLUONGGIADICHVUKYTHUATEX_H
#define BCSOLUONGGIADICHVUKYTHUATEX_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCSOLUONGVAGIA_DICHVUKYTHUATEX : public CGuiView
{
protected:
public:
	...
	void			OnExport1();
	void			OnExport2();
	CBCSOLUONGVAGIA_DICHVUKYTHUATEX();
	~CBCSOLUONGVAGIA_DICHVUKYTHUATEX();
	...
	int OnAddCBCSOLUONGVAGIA_DICHVUKYTHUATEX(); 
	int OnEditCBCSOLUONGVAGIA_DICHVUKYTHUATEX(); 
	int OnDeleteCBCSOLUONGVAGIA_DICHVUKYTHUATEX(); 
	int OnSaveCBCSOLUONGVAGIA_DICHVUKYTHUATEX(); 
	int OnCancelCBCSOLUONGVAGIA_DICHVUKYTHUATEX(); 
	int OnCBCSOLUONGVAGIA_DICHVUKYTHUATEXListLoadData(); 
