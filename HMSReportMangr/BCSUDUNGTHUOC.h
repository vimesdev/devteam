#ifndef BCSUDUNGTHUOC_H
#define BCSUDUNGTHUOC_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCSUDUNGTHUOC : public CGuiView{
protected:
public:
	...
	int OnAddBCSUDUNGTHUOC(); 
	int OnEditBCSUDUNGTHUOC(); 
	int OnDeleteBCSUDUNGTHUOC(); 
	int OnSaveBCSUDUNGTHUOC(); 
	int OnCancelBCSUDUNGTHUOC(); 
	int OnBCSUDUNGTHUOCListLoadData();
