#ifndef BCSOLUONGGIADICHVUKYTHUAT_H
#define BCSOLUONGGIADICHVUKYTHUAT_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCSOLUONGVAGIA_DICHVUKYTHUAT : public CGuiView
{
protected:
public:
	...
	int OnAddCBCSOLUONGVAGIA_DICHVUKYTHUAT(); 
	int OnEditCBCSOLUONGVAGIA_DICHVUKYTHUAT(); 
	int OnDeleteCBCSOLUONGVAGIA_DICHVUKYTHUAT(); 
	int OnSaveCBCSOLUONGVAGIA_DICHVUKYTHUAT(); 
	int OnCancelCBCSOLUONGVAGIA_DICHVUKYTHUAT(); 
	int OnCBCSOLUONGVAGIA_DICHVUKYTHUATListLoadData(); 
