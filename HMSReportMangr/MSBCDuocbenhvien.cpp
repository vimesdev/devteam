...
static int _OnCheckAllFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnCheckAll();
} 
static int _OnUnCheckAllFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnUnCheckAll();
} 
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCDuocbenhvien *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCDuocbenhvien *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMSBCDuocbenhvien* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CMSBCDuocbenhvien *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMSBCDuocbenhvien* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CMSBCDuocbenhvien *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnTypeAddNew();
}*/

static void _OnOriginalSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMSBCDuocbenhvien* )pWnd)->OnOriginalSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOriginalSelendokFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnOriginalSelendok();
}
/*static void _OnOriginalSetfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnOriginalKillfocus();
}*/
/*static void _OnOriginalKillfocusFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnOriginalKillfocus();
}*/
static long _OnOriginalLoadDataFnc(CWnd *pWnd){
	return ((CMSBCDuocbenhvien *)pWnd)->OnOriginalLoadData();
}
/*static void _OnOriginalAddNewFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien *)pWnd)->OnOriginalAddNew();
}*/


static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CMSBCDuocbenhvien *pVw = (CMSBCDuocbenhvien *)pWnd;
...
static long _OnListFacLoadDataFnc(CWnd *pWnd){
	return ((CMSBCDuocbenhvien*)pWnd)->OnListFacLoadData();
} 
static void _OnListFacDblClickFnc(CWnd *pWnd){
	((CMSBCDuocbenhvien*)pWnd)->OnListFacDblClick();
} 
static void _OnListFacSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CMSBCDuocbenhvien*)pWnd)->OnListFacSelectChange(nOldItem, nNewItem);
} 
static int _OnListFacDeleteItemFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnListFacDeleteItem();
} 
static int _OnAddMSBCDuocbenhvienFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnAddMSBCDuocbenhvien();
} 
static int _OnEditMSBCDuocbenhvienFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnEditMSBCDuocbenhvien();
} 
static int _OnDeleteMSBCDuocbenhvienFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnDeleteMSBCDuocbenhvien();
} 
static int _OnSaveMSBCDuocbenhvienFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnSaveMSBCDuocbenhvien();
} 
static int _OnCancelMSBCDuocbenhvienFnc(CWnd *pWnd){
	 return ((CMSBCDuocbenhvien*)pWnd)->OnCancelMSBCDuocbenhvien();
} 
CMSBCDuocbenhvien::CMSBCDuocbenhvien()
	{
...
void CMSBCDuocbenhvien::OnCreateComponents(){
...
void CMSBCDuocbenhvien::OnInitializeComponents(){
...
void CMSBCDuocbenhvien::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CMSBCDuocbenhvien::OnDoDataExchange(CDataExchange* pDX){
...
void CMSBCDuocbenhvien::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMSBCDuocbenhvien::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CMSBCDuocbenhvien::SetDefaultValues(){
...
int CMSBCDuocbenhvien::SetMode(int nMode){
...
/*void CMSBCDuocbenhvien::OnFromDateChange(){
	
} */
/*void CMSBCDuocbenhvien::OnFromDateSetfocus(){
	
} */
/*void CMSBCDuocbenhvien::OnFromDateKillfocus(){
	
} */
int CMSBCDuocbenhvien::OnFromDateCheckValue(){
	return 0;
} 
/*void CMSBCDuocbenhvien::OnToDateChange(){
	
} */
/*void CMSBCDuocbenhvien::OnToDateSetfocus(){
	
} */
/*void CMSBCDuocbenhvien::OnToDateKillfocus(){
	
} */
int CMSBCDuocbenhvien::OnToDateCheckValue(){
	return 0;
} 
void CMSBCDuocbenhvien::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CMSBCDuocbenhvien::OnStockSelendok(){
	 
}
/*void CMSBCDuocbenhvien::OnStockSetfocus(){
	
}*/
/*void CMSBCDuocbenhvien::OnStockKillfocus(){
	
}*/
long CMSBCDuocbenhvien::OnStockLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	int nCount = 0;
	szSQL.Format(_T("SELECT msl_storage_id as id, msl_name as name FROM m_storagelist WHERE msl_org_id = 'PM' %s ORDER BY msl_type, msl_storage_id"), szWhere);
...
/*void CMSBCDuocbenhvien::OnStockAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CMSBCDuocbenhvien::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CMSBCDuocbenhvien::OnTypeSelendok(){
	 
}
/*void CMSBCDuocbenhvien::OnTypeSetfocus(){
	
}*/
/*void CMSBCDuocbenhvien::OnTypeKillfocus(){
	
}*/
long CMSBCDuocbenhvien::OnTypeLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CMSBCDuocbenhvien::OnTypeAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CMSBCDuocbenhvien::OnOriginalSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CMSBCDuocbenhvien::OnOriginalSelendok(){
	 
}
/*void CMSBCDuocbenhvien::OnOriginalSetfocus(){
	
}*/
/*void CMSBCDuocbenhvien::OnOriginalKillfocus(){
	
}*/
long CMSBCDuocbenhvien::OnOriginalLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*
void CMSBCDuocbenhvien::OnOriginalAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
*/
void CMSBCDuocbenhvien::OnPrintPreviewSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	//UpdateData(true);
	OnPrintBaocaoxuathuocchokhoatheodoituong();
	//UpdateData(false);
} 
void CMSBCDuocbenhvien::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	//UpdateData(true);
	OnExportBaocaoxuathuocchokhoatheodoituong();
	//UpdateData(false);
} 
void CMSBCDuocbenhvien::OnExportSelect(){
...
void CMSBCDuocbenhvien::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

} 

int CMSBCDuocbenhvien::OnCheckAll(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CMSBCDuocbenhvien::OnUnCheckAll(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	for (int i=0; i< m_wndListFac.GetItemCount(); i++){
...
void CMSBCDuocbenhvien::OnListFacDblClick(){
	
} 
void CMSBCDuocbenhvien::OnListFacSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CMSBCDuocbenhvien::OnListFacDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 

long CMSBCDuocbenhvien::OnListFacLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CMSBCDuocbenhvien::OnAddMSBCDuocbenhvien(){
...
int CMSBCDuocbenhvien::OnEditMSBCDuocbenhvien(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CMSBCDuocbenhvien::OnDeleteMSBCDuocbenhvien(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
 	...
 	if(ret >= 0){ 
 		SetMode(VM_NONE); 
 		OnCancelMSBCDuocbenhvien(); 
 	}
	return 0;
}
int CMSBCDuocbenhvien::OnSaveMSBCDuocbenhvien(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
 ...
 _fmsg(_T("%s"), szSQL); 
 	...
 	if(ret > 0) 
 	{ 
 		//OnMSBCDuocbenhvienListLoadData(); 
 		SetMode(VM_VIEW); 
 	} 
 	else 
 	{ 
...
int CMSBCDuocbenhvien::OnCancelMSBCDuocbenhvien(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CMSBCDuocbenhvien::OnMSBCDuocbenhvienListLoadData(){
	return 0;
}

void CMSBCDuocbenhvien::OnPrintBaocaoxuathuocchokhoatheodoituong(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
	...
	if(!rpt.Init(_T("Reports/HMS/BCDUOCBENHVIEN.RPT"),true) )
	{
		return;
	}
	szWhere.Empty();
...
void CMSBCDuocbenhvien::OnExportBaocaoxuathuocchokhoatheodoituong(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	TranslateString(_T("\x42\xE1o \x63\xE1o \x64\x1B0\x1EE3\x63 \x62\x1EC7nh vi\x1EC7n"), szTemp);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\MSBCDuocbenhvien.xls"));
}
BEGIN_MESSAGE_MAP(CMSBCDuocbenhvien, CGuiView)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()

void CMSBCDuocbenhvien::OnSetFocus(CWnd* pOldWnd)
{
