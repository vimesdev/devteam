#ifndef MSBCDuocbenhvien_H
#define MSBCDuocbenhvien_H
...
#include "GuiView.h"
#include "DbField.h"
class CMSBCDuocbenhvien : public CGuiView{
protected:
public:
	...
	int OnAddMSBCDuocbenhvien(); 
	int OnEditMSBCDuocbenhvien(); 
	int OnDeleteMSBCDuocbenhvien(); 
	int OnSaveMSBCDuocbenhvien(); 
	int OnCancelMSBCDuocbenhvien(); 
	int OnMSBCDuocbenhvienListLoadData(); 
	DECLARE_MESSAGE_MAP()
