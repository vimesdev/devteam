#ifndef MSBCthongkeDSBNchuyendi_H
#define MSBCthongkeDSBNchuyendi_H
...
#include "GuiView.h"
#include "DbField.h"
class CMSBCthongkeDSBNchuyendi : public CGuiView{
protected:
public:
	...
	int OnAddMSBCthongkeDSBNchuyendi(); 
	int OnEditMSBCthongkeDSBNchuyendi(); 
	int OnDeleteMSBCthongkeDSBNchuyendi(); 
	int OnSaveMSBCthongkeDSBNchuyendi(); 
	int OnCancelMSBCthongkeDSBNchuyendi(); 
	int OnMSBCthongkeDSBNchuyendiListLoadData(); 
