#ifndef CPMBaocaoxuatthuockhangsinhtheokhoa_H
#define CPMBaocaoxuatthuockhangsinhtheokhoa_H
...
#include "GuiView.h"
#include "DbField.h"
class CPMBaocaoxuatthuockhangsinhtheokhoa : public CGuiView{
protected:
public:
	...
	int			OnCheckAll();
	int			OnUnCheckAll();
	CPMBaocaoxuatthuockhangsinhtheokhoa(CWnd *pParent);
	~CPMBaocaoxuatthuockhangsinhtheokhoa();
