...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CBCTHONGKEHOATDONGCANLAMSANG *pVw = (CBCTHONGKEHOATDONGCANLAMSANG *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnListDeleteItem();
} 
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CBCTHONGKEHOATDONGCANLAMSANG* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnStatusAddNew();
}*/
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CBCTHONGKEHOATDONGCANLAMSANG* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnDepartmentKillfocus();
}*/
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CBCTHONGKEHOATDONGCANLAMSANG *)pWnd)->OnDepartmentAddNew();
}*/
static int _OnAddBCTHONGKEHOATDONGCANLAMSANGFnc(CWnd *pWnd){
	 return ((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnAddBCTHONGKEHOATDONGCANLAMSANG();
} 
static int _OnEditBCTHONGKEHOATDONGCANLAMSANGFnc(CWnd *pWnd){
	 return ((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnEditBCTHONGKEHOATDONGCANLAMSANG();
} 
static int _OnDeleteBCTHONGKEHOATDONGCANLAMSANGFnc(CWnd *pWnd){
	 return ((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnDeleteBCTHONGKEHOATDONGCANLAMSANG();
} 
static int _OnSaveBCTHONGKEHOATDONGCANLAMSANGFnc(CWnd *pWnd){
	 return ((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnSaveBCTHONGKEHOATDONGCANLAMSANG();
} 
static int _OnCancelBCTHONGKEHOATDONGCANLAMSANGFnc(CWnd *pWnd){
	 return ((CBCTHONGKEHOATDONGCANLAMSANG*)pWnd)->OnCancelBCTHONGKEHOATDONGCANLAMSANG();
} 
CBCTHONGKEHOATDONGCANLAMSANG::CBCTHONGKEHOATDONGCANLAMSANG(){
...
void CBCTHONGKEHOATDONGCANLAMSANG::OnCreateComponents(){
	...
	m_wndStatusLabel.Create(this, _T("Status"), 401, 30, 481, 55);
	m_wndStatus.Create(this,486, 30, 581, 55); 
	...
	m_wndList.InsertColumn(1, _T("Th\xF4ng tin \x63\x1EADn l\xE2m s\xE0ng"), CFMT_NUMBER, 150);
...
void CBCTHONGKEHOATDONGCANLAMSANG::OnInitializeComponents(){
...
void CBCTHONGKEHOATDONGCANLAMSANG::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CBCTHONGKEHOATDONGCANLAMSANG::OnDoDataExchange(CDataExchange* pDX){
...
void CBCTHONGKEHOATDONGCANLAMSANG::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBCTHONGKEHOATDONGCANLAMSANG::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CBCTHONGKEHOATDONGCANLAMSANG::SetDefaultValues(){
...
int CBCTHONGKEHOATDONGCANLAMSANG::SetMode(int nMode){
...
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnFromDateChange(){
	
} */
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnFromDateSetfocus(){
	
} */
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnFromDateKillfocus(){
	
} */
int CBCTHONGKEHOATDONGCANLAMSANG::OnFromDateCheckValue(){
	return 0;
} 
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnToDateChange(){
	
} */
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnToDateSetfocus(){
	
} */
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnToDateKillfocus(){
	
} */
int CBCTHONGKEHOATDONGCANLAMSANG::OnToDateCheckValue(){
	return 0;
} 
void CBCTHONGKEHOATDONGCANLAMSANG::OnLoadSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CBCTHONGKEHOATDONGCANLAMSANG::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
...
void CBCTHONGKEHOATDONGCANLAMSANG::OnListDblClick(){
	
} 
void CBCTHONGKEHOATDONGCANLAMSANG::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CBCTHONGKEHOATDONGCANLAMSANG::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CBCTHONGKEHOATDONGCANLAMSANG::OnListLoadData(){
/*
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBCTHONGKEHOATDONGCANLAMSANG::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CBCTHONGKEHOATDONGCANLAMSANG::OnStatusSelendok(){
	 
}
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnStatusSetfocus(){
	
}*/
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnStatusKillfocus(){
	
}*/
long CBCTHONGKEHOATDONGCANLAMSANG::OnStatusLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnStatusAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CBCTHONGKEHOATDONGCANLAMSANG::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CBCTHONGKEHOATDONGCANLAMSANG::OnDepartmentSelendok(){
	 
}
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnDepartmentSetfocus(){
	
}*/
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnDepartmentKillfocus(){
	
}*/
long CBCTHONGKEHOATDONGCANLAMSANG::OnDepartmentLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CBCTHONGKEHOATDONGCANLAMSANG::OnDepartmentAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
int CBCTHONGKEHOATDONGCANLAMSANG::OnAddBCTHONGKEHOATDONGCANLAMSANG(){
...
int CBCTHONGKEHOATDONGCANLAMSANG::OnEditBCTHONGKEHOATDONGCANLAMSANG(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CBCTHONGKEHOATDONGCANLAMSANG::OnDeleteBCTHONGKEHOATDONGCANLAMSANG(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelBCTHONGKEHOATDONGCANLAMSANG();
 	}
	return 0;
}
int CBCTHONGKEHOATDONGCANLAMSANG::OnSaveBCTHONGKEHOATDONGCANLAMSANG(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnBCTHONGKEHOATDONGCANLAMSANGListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CBCTHONGKEHOATDONGCANLAMSANG::OnCancelBCTHONGKEHOATDONGCANLAMSANG(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CBCTHONGKEHOATDONGCANLAMSANG::OnBCTHONGKEHOATDONGCANLAMSANGListLoadData(){
	return 0;
}

CString CBCTHONGKEHOATDONGCANLAMSANG::GetQueryString(){
	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd();
...
_T(" FROM(SELECT HPC_DOCNO,HPC_DEPTID,HPC_CLASS,HPC_OBJECT,HPC_GROUPID,HPCL_QTY") \
_T(" FROM HMS_TESTORDER") \
_T(" LEFT JOIN HMS_TESTORDERLINE ON(HPCL_DOCNO=HPC_DOCNO AND HPC_ORDERID=HPCL_ORDERID)") \
_T(" WHERE 1=1 %s %s %s))") \
