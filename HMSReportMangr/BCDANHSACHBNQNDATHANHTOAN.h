#ifndef BCDANHSACHBNQNDATHANHTOAN_H
#define BCDANHSACHBNQNDATHANHTOAN_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCDANHSACHBNQNDATHANHTOAN : public CGuiView{
protected:
public:
	...
	int OnAddBCDANHSACHBNQNDATHANHTOAN(); 
	int OnEditBCDANHSACHBNQNDATHANHTOAN(); 
	int OnDeleteBCDANHSACHBNQNDATHANHTOAN(); 
	int OnSaveBCDANHSACHBNQNDATHANHTOAN(); 
	int OnCancelBCDANHSACHBNQNDATHANHTOAN(); 
	int OnBCDANHSACHBNQNDATHANHTOANListLoadData(); 
