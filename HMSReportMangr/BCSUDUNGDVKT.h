#ifndef BCSUDUNGDVKT_H
#define BCSUDUNGDVKT_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCSUDUNGDVKT : public CGuiView
{
protected:
	bool GetEMRData(long nDocNo, int nTreatTime, int nRefIdx, CString szType, CString& szData);
	CString GetDiseaseHist(long nDocNo, int nTreatTime, int nRefIdx);
public:
	...
	int OnAddBCSUDUNGDVKT(); 
	int OnEditBCSUDUNGDVKT(); 
	int OnDeleteBCSUDUNGDVKT(); 
	int OnSaveBCSUDUNGDVKT(); 
	int OnCancelBCSUDUNGDVKT(); 
	int OnBCSUDUNGDVKTListLoadData();
