#ifndef HMSPatientSurgeryFeeReport_H
#define HMSPatientSurgeryFeeReport_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSPatientSurgeryFeeReport : public CGuiView{
protected:
public:
	...
	CGuiLabel		m_wndSurgeryTypeLabel;
	CGuiComboBox	m_wndSurgeryType;
	...
	void			OnSurgeryTypeSelectChange(int nOldItemSel, int nNewItemSel); 
	void			OnSurgeryTypeSelendok(); 
	//void			OnSurgeryTypeSetfocus(); 
	//void			OnSurgeryTypeKillfocus(); 
	long			OnSurgeryTypeLoadData(); 
	void			OnSurgeryTypeAddNew(); 
	...
	int OnAddHMSPatientSurgeryFeeReport(); 
	int OnEditHMSPatientSurgeryFeeReport(); 
	int OnDeleteHMSPatientSurgeryFeeReport(); 
	int OnSaveHMSPatientSurgeryFeeReport();
	int OnCancelHMSPatientSurgeryFeeReport();
	int OnHMSPatientSurgeryFeeReportListLoadData();

	int OnObjectListCheckAll();
	int OnObjectListUnCheckAll();

	CString GetQueryString();
	CString GetDoctorName(CString UserName, CString LastName =_T(""));
};
#endif
