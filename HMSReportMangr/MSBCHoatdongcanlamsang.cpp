...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongcanlamsang *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongcanlamsang *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CMSBCHoatdongcanlamsang *pVw = (CMSBCHoatdongcanlamsang *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CMSBCHoatdongcanlamsang*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CMSBCHoatdongcanlamsang*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongcanlamsang*)pWnd)->OnListDeleteItem();
} 
static void _OnStatusSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMSBCHoatdongcanlamsang* )pWnd)->OnStatusSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStatusSelendokFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnStatusSelendok();
}
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnStatusKillfocus();
}*/
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnStatusKillfocus();
}*/
static long _OnStatusLoadDataFnc(CWnd *pWnd){
	return ((CMSBCHoatdongcanlamsang *)pWnd)->OnStatusLoadData();
}
/*static void _OnStatusAddNewFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnStatusAddNew();
}*/
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMSBCHoatdongcanlamsang* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnDepartmentKillfocus();
}*/
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CMSBCHoatdongcanlamsang *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CMSBCHoatdongcanlamsang *)pWnd)->OnDepartmentAddNew();
}*/
static int _OnAddMSBCHoatdongcanlamsangFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongcanlamsang*)pWnd)->OnAddMSBCHoatdongcanlamsang();
} 
static int _OnEditMSBCHoatdongcanlamsangFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongcanlamsang*)pWnd)->OnEditMSBCHoatdongcanlamsang();
} 
static int _OnDeleteMSBCHoatdongcanlamsangFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongcanlamsang*)pWnd)->OnDeleteMSBCHoatdongcanlamsang();
} 
static int _OnSaveMSBCHoatdongcanlamsangFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongcanlamsang*)pWnd)->OnSaveMSBCHoatdongcanlamsang();
} 
static int _OnCancelMSBCHoatdongcanlamsangFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongcanlamsang*)pWnd)->OnCancelMSBCHoatdongcanlamsang();
} 
CMSBCHoatdongcanlamsang::CMSBCHoatdongcanlamsang(){
...
void CMSBCHoatdongcanlamsang::OnCreateComponents(){
...
void CMSBCHoatdongcanlamsang::OnInitializeComponents(){
...
void CMSBCHoatdongcanlamsang::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CMSBCHoatdongcanlamsang::OnDoDataExchange(CDataExchange* pDX){
...
void CMSBCHoatdongcanlamsang::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMSBCHoatdongcanlamsang::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CMSBCHoatdongcanlamsang::SetDefaultValues(){
...
int CMSBCHoatdongcanlamsang::SetMode(int nMode){
...
/*void CMSBCHoatdongcanlamsang::OnFromDateChange(){
	
} */
/*void CMSBCHoatdongcanlamsang::OnFromDateSetfocus(){
	
} */
/*void CMSBCHoatdongcanlamsang::OnFromDateKillfocus(){
	
} */
int CMSBCHoatdongcanlamsang::OnFromDateCheckValue(){
	return 0;
} 
/*void CMSBCHoatdongcanlamsang::OnToDateChange(){
	
} */
/*void CMSBCHoatdongcanlamsang::OnToDateSetfocus(){
	
} */
/*void CMSBCHoatdongcanlamsang::OnToDateKillfocus(){
	
} */
int CMSBCHoatdongcanlamsang::OnToDateCheckValue(){
	return 0;
} 
void CMSBCHoatdongcanlamsang::OnLoadSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CMSBCHoatdongcanlamsang::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	...
	if(!rpt.Init(_T("Reports/HMS/BCHOATDONGCLS.RPT")) )
		return ;
...
void CMSBCHoatdongcanlamsang::OnListDblClick(){
	
} 
void CMSBCHoatdongcanlamsang::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CMSBCHoatdongcanlamsang::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CMSBCHoatdongcanlamsang::OnListLoadData(){
/*
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMSBCHoatdongcanlamsang::OnStatusSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CMSBCHoatdongcanlamsang::OnStatusSelendok(){
	 
}
/*void CMSBCHoatdongcanlamsang::OnStatusSetfocus(){
	
}*/
/*void CMSBCHoatdongcanlamsang::OnStatusKillfocus(){
	
}*/
long CMSBCHoatdongcanlamsang::OnStatusLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CMSBCHoatdongcanlamsang::OnStatusAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CMSBCHoatdongcanlamsang::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CMSBCHoatdongcanlamsang::OnDepartmentSelendok(){
	 
}
/*void CMSBCHoatdongcanlamsang::OnDepartmentSetfocus(){
	
}*/
/*void CMSBCHoatdongcanlamsang::OnDepartmentKillfocus(){
	
}*/
long CMSBCHoatdongcanlamsang::OnDepartmentLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CMSBCHoatdongcanlamsang::OnDepartmentAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
int CMSBCHoatdongcanlamsang::OnAddMSBCHoatdongcanlamsang(){
...
int CMSBCHoatdongcanlamsang::OnEditMSBCHoatdongcanlamsang(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CMSBCHoatdongcanlamsang::OnDeleteMSBCHoatdongcanlamsang(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelMSBCHoatdongcanlamsang();
 	}
	return 0;
}
int CMSBCHoatdongcanlamsang::OnSaveMSBCHoatdongcanlamsang(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnMSBCHoatdongcanlamsangListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CMSBCHoatdongcanlamsang::OnCancelMSBCHoatdongcanlamsang(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CMSBCHoatdongcanlamsang::OnMSBCHoatdongcanlamsangListLoadData(){
	return 0;
}
CString CMSBCHoatdongcanlamsang::GetQueryString(){
	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd();
