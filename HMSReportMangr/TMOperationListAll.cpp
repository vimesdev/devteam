...
/*static void _OnYearChangeFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnYearChange();
} */
/*static void _OnYearSetfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnYearSetfocus();} */ 
/*static void _OnYearKillfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnYearKillfocus();
} */
static int _OnYearCheckValueFnc(CWnd *pWnd){
	return ((CTMOperationListAll *)pWnd)->OnYearCheckValue();
} 
static void _OnReportPeriodSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CTMOperationListAll* )pWnd)->OnReportPeriodSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnReportPeriodSelendokFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnReportPeriodSelendok();
}
/*static void _OnReportPeriodSetfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnReportPeriodKillfocus();
}*/
/*static void _OnReportPeriodKillfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnReportPeriodKillfocus();
}*/
static long _OnReportPeriodLoadDataFnc(CWnd *pWnd){
	return ((CTMOperationListAll *)pWnd)->OnReportPeriodLoadData();
}
/*static void _OnReportPeriodAddNewFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnReportPeriodAddNew();
}*/
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CTMOperationListAll *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CTMOperationListAll *)pWnd)->OnToDateCheckValue();
} 
static void _OnDeptSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CTMOperationListAll* )pWnd)->OnDeptSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDeptSelendokFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnDeptSelendok();
}
/*static void _OnDeptSetfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnDeptKillfocus();
}*/
/*static void _OnDeptKillfocusFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnDeptKillfocus();
}*/
static long _OnDeptLoadDataFnc(CWnd *pWnd){
	return ((CTMOperationListAll *)pWnd)->OnDeptLoadData();
}
/*static void _OnDeptAddNewFnc(CWnd *pWnd){
	((CTMOperationListAll *)pWnd)->OnDeptAddNew();
}*/
static void _OnPrintSelectFnc(CWnd *pWnd){
	CTMOperationListAll *pVw = (CTMOperationListAll *)pWnd;
	pVw->OnPrintSelect();
} 
...
static void _OnInsuranceSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnInsuranceSelect();
}
static void _OnServiceSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnServiceSelect();
}
static void _OnPolicySelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnPolicySelect();
}
static void _OnPaymentSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnPaymentSelect();
}
static void _OnPayment2SelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnPayment2Select();
}
static void _OnSurgerySelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnSurgerySelect();
}
static void _OnOperationSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnOperationSelect();
}
static void _OnParaclinicalSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnParaclinicalSelect();
}
static void _OnKPLSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnKPLSelect();
}
static void _OnAllSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnAllSelect();
}
static void _OnInpatientSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnInpatientSelect();
}
static void _OnOutpatientSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnOutpatientSelect();
}
static void _OnFromExamSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnFromExamSelect();
}
static void _OnBNTYCSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnBNTYCSelect();
}
static void _OnKBNTYCSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnKBNTYCSelect();
}
static void _OnGiamDauSelectFnc(CWnd *pWnd){
	((CTMOperationListAll*)pWnd)->OnGiamDauSelect();
}
static int _OnAddTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationListAll*)pWnd)->OnAddTMOperationList();
} 
static int _OnEditTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationListAll*)pWnd)->OnEditTMOperationList();
} 
static int _OnDeleteTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationListAll*)pWnd)->OnDeleteTMOperationList();
} 
static int _OnSaveTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationListAll*)pWnd)->OnSaveTMOperationList();
} 
static int _OnCancelTMOperationListFnc(CWnd *pWnd){
	 return ((CTMOperationListAll*)pWnd)->OnCancelTMOperationList();
}
static void _OnDeptDblClickFnc(CWnd *pWnd)
{
	((CTMOperationListAll*)pWnd)->OnDeptDblClick();
}

static void _OnDichvu_TYCSelectFnc(CWnd *pWnd){
	 ((CTMOperationListAll*)pWnd)->OnDichvu_TYCSelect();
}

static void _OnOnlyPTVSelectFnc(CWnd *pWnd)
{
	 ((CTMOperationListAll*)pWnd)->OnOnlyPTVSelect();
}
static void _OnNotincludePTVSelectFnc(CWnd *pWnd)
{
	 ((CTMOperationListAll*)pWnd)->OnNotincludePTVSelect();
}

static int _OnDeptListCheckAllFnc(CWnd *pWnd){
	return ((CTMOperationListAll*)pWnd)->OnDeptListCheckAll();
}
static int _OnDeptListUnCheckAllFnc(CWnd *pWnd){
	return ((CTMOperationListAll*)pWnd)->OnDeptListUnCheckAll();
}

CTMOperationListAll::CTMOperationListAll()
{
...
void CTMOperationListAll::OnCreateComponents(){
	...
	m_wndDeptLabel.Create(this, _T(""), 0, 0, 0, 0);
	...
	m_wndExport.Create(this, _T("&ExportXLS"), 404, 497, 504, 522);

	m_wndKPL.Create(this, _T(""), 0, 0, 0, 0);
	m_wndKPL.ShowWindow(SW_HIDE);
	m_wndKPL.EnableWindow(FALSE);
}
void CTMOperationListAll::OnInitializeComponents(){
...
void CTMOperationListAll::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	m_wndDept.AddEvent(1, _T("Check All"), _OnDeptListCheckAllFnc);
	m_wndDept.AddEvent(2, _T("UnCheck All"), _OnDeptListUnCheckAllFnc);
...
void CTMOperationListAll::OnDoDataExchange(CDataExchange* pDX){
...
void CTMOperationListAll::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CTMOperationListAll::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CTMOperationListAll::SetDefaultValues(){
...
int CTMOperationListAll::SetMode(int nMode){
...
/*void CTMOperationListAll::OnYearChange(){
	
} */
/*void CTMOperationListAll::OnYearSetfocus(){
	
} */
/*void CTMOperationListAll::OnYearKillfocus(){
	
} */
int CTMOperationListAll::OnYearCheckValue(){
	UpdateData(TRUE);
	if (m_nYear > 0)
	{
		CDateTime dt;
...
void CTMOperationListAll::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
void CTMOperationListAll::OnDeptDblClick()
{
	
}

void CTMOperationListAll::OnOnlyPTVSelect(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	
}
	void CTMOperationListAll::OnNotincludePTVSelect(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	
}

void CTMOperationListAll::OnReportPeriodSelendok(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CTMOperationListAll::OnReportPeriodSetfocus(){
	
}*/
/*void CTMOperationListAll::OnReportPeriodKillfocus(){
	
}*/
long CTMOperationListAll::OnReportPeriodLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CTMOperationListAll::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CTMOperationListAll::OnFromDateChange(){
	
} */
/*void CTMOperationListAll::OnFromDateSetfocus(){
	
} */
/*void CTMOperationListAll::OnFromDateKillfocus(){
	
} */
int CTMOperationListAll::OnFromDateCheckValue(){
	return 0;
} 
/*void CTMOperationListAll::OnToDateChange(){
	
} */
/*void CTMOperationListAll::OnToDateSetfocus(){
	
} */
/*void CTMOperationListAll::OnToDateKillfocus(){
	
} */
int CTMOperationListAll::OnToDateCheckValue(){
	return 0;
} 
void CTMOperationListAll::OnDeptSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CTMOperationListAll::OnDeptSelendok(){
	 
}
/*void CTMOperationListAll::OnDeptSetfocus(){
	
}*/
/*void CTMOperationListAll::OnDeptKillfocus(){
	
}*/
long CTMOperationListAll::OnDeptLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;			
	...
	szSQL.Format(_T(" select sd_id as id, SD_ID_ALIAS as aliasid, sd_name as name from sys_dept where 1=1 ") \
				 _T(" and sd_isactive='Y' order by sd_id"));
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF())
	{ 
		m_wndDept.AddItems(
...
/*void CTMOperationListAll::OnDeptAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CTMOperationListAll::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();	
}
void CTMOperationListAll::OnDichvu_TYCSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
void CTMOperationListAll::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiMenu menu(this);
	CString tmpStr;
...
void CTMOperationListAll::OnExport1()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	xls.SetCellText(nCol+12,nRow,_T("Trả kíp PT"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+13,nRow,2);
	xls.SetCellText(nCol+13,nRow,_T("Trả gây mê"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+14,nRow,2);
	xls.SetCellText(nCol+14,nRow,_T("Tên phẫu thuật theo phần mềm"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+15,nRow,2);
	xls.SetCellText(nCol+15,nRow,_T("Ngày thực hiện"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);

	xls.SetCellMergedRows(nCol+16,nRow,2);
	xls.SetCellText(nCol+16,nRow,_T("Đối tượng"),FMT_TEXT|FMT_CENTER|FMT_WRAPING,true,10);
	...
	while (!rs.IsEOF())
	{
		...
		rs.GetValue(_T("amount1"), nAmount1);
		nTotalAmount1 += nAmount1;
		xls.SetCellText(12, nRow, double2str(nAmount1), FMT_NUMBER1|FMT_WRAPING);

		rs.GetValue(_T("amount2"), nAmount2);
		nTotalAmount2 += nAmount2;
		xls.SetCellText(13, nRow, double2str(nAmount2), FMT_NUMBER1|FMT_WRAPING);		

		xls.SetCellText(14, nRow, rs.GetValue(_T("operation_name")), FMT_TEXT|FMT_WRAPING);
		rs.GetValue(_T("performdate"), tmpStr);
		xls.SetCellText(15, nRow, CDateTime::Convert(tmpStr, yyyymmdd|hhmmss, ddmmyyyy|hhmmss), FMT_TEXT|FMT_WRAPING);
		xls.SetCellText(16, nRow, rs.GetValue(_T("objectname")), FMT_TEXT|FMT_WRAPING);
		nRow++;
		rs.MoveNext();
	}
	...
	xls.SetCellText(12, nRow, double2str(nTotalAmount1),FMT_NUMBER1|FMT_RIGHT|FMT_WRAPING, true);
	xls.SetCellText(13, nRow, double2str(nTotalAmount2),FMT_NUMBER1|FMT_RIGHT|FMT_WRAPING, true);
	nRow++;
	nCol = 0;
...
void CTMOperationListAll::OnExport2()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	xls.SetCellText(nCol++, nRow, _T("Khoa thực hiện"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
	xls.SetCellText(nCol++, nRow, _T("Phòng thực hiện"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
	xls.SetCellText(nCol++, nRow, _T("khoa yêu cầu"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 10);
	...
	while (!rs.IsEOF())
	{
		...
		xls.SetCellText(nCol++, nRow, rs.GetValue(_T("proomid")), FMT_TEXT | FMT_WRAPING);
...
void CTMOperationListAll::OnInsuranceSelect(){
	
}
void CTMOperationListAll::OnServiceSelect(){
	
}
void CTMOperationListAll::OnPolicySelect(){
	
}
	void CTMOperationListAll::OnOperationSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bOperation)
	{
	...
	void CTMOperationListAll::OnSurgerySelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bSurgery)
	{
	...
	void CTMOperationListAll::OnParaclinicalSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	if(m_bParaclinical)
	{
	...
	void CTMOperationListAll::OnPaymentSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bPayment)
		{
	...
	void CTMOperationListAll::OnPayment2Select(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bPayment2)
		{
	...
	void CTMOperationListAll::OnAllSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bAll)
		{
	...
	void CTMOperationListAll::OnInpatientSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bInpatient)
		{
	...
	void CTMOperationListAll::OnOutpatientSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bOutpatient)
		{
	...
	void CTMOperationListAll::OnFromExamSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bFromExam)
		{
	...
	void CTMOperationListAll::OnBNTYCSelect()
	{
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bBNTYC)
	...
	void CTMOperationListAll::OnKBNTYCSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		UpdateData(true);
		if(m_bKBNTYC)
		{
	...
	void CTMOperationListAll::OnKPLSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

	}
	void CTMOperationListAll::OnGiamDauSelect(){
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

	}
int CTMOperationListAll::OnAddTMOperationList(){
...
int CTMOperationListAll::OnEditTMOperationList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CTMOperationListAll::OnDeleteTMOperationList(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CTMOperationListAll::OnSaveTMOperationList(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CTMOperationListAll::OnCancelTMOperationList(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CTMOperationListAll::OnTMOperationListListLoadData()
{
	return 0;
}
CString CTMOperationListAll::GetQuerySring(){
	CMainFrame * pMF =(CMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	...
	if (m_bSurgery == TRUE)
	...
	else if (m_bOperation == TRUE)
		{
			...
			szWhere1.AppendFormat(_T(" AND hfl_groupid IN ('B5100', 'B5200', 'B5300', 'B5400') "));
			szWhere2.AppendFormat(_T(" AND substr(hfl_opt_group,1,2)IN('00') "));
		}
	else if (m_bParaclinical == TRUE)
		{
			szWhere1.AppendFormat(_T(" AND substr(hfl_groupid,1,2)='00' "));
			szWhere2.AppendFormat(_T(" AND substr(hfl_opt_group,1,2)IN('B3','B4', 'B5') "));
		}
	...
	if(!szDept.IsEmpty())
		{
			...
			else if(szDept == _T("'C1.2'"))
			{
				...
				szWhere2.AppendFormat(_T("AND (hpc_pdeptid in (%s) OR (hpc_deptid = 'C1.2' AND hpc_proomid IN ('10', '16') AND hpc_pdeptid = 'C8-C'))"), szDept);				
			}

			else if(szDept == _T("'A20'"))
			{
				szWhere1.AppendFormat(_T("AND pdeptid in (%s)"), szDept);
				szWhere2.AppendFormat(_T("AND (hpc_pdeptid in (%s) OR (hpc_proomid IN ('11', '12') AND hpc_pdeptid = 'A20'))"), szDept);				
			}
			
			else if(szDept == _T("'C7'"))
			{
				szWhere1.AppendFormat(_T("AND pdeptid in (%s)"), szDept);
				szWhere2.AppendFormat(_T("AND (hpc_pdeptid in (%s) OR (hpc_proomid IN ('15', '22' ,'35') AND hpc_pdeptid = 'C7'))"), szDept);				
			}
			else if (szDept == _T("'C5'"))
			{
				szWhere1.AppendFormat(_T("AND pdeptid in (%s)"), szDept);
				szWhere2.AppendFormat(_T("AND (hpc_pdeptid in (%s) OR (su_deptid = 'C5'))"), szDept);
			}
	...
	if (szDept != _T("'TYC'") && szDept != _T("'PTTYC'") && szDept != _T("'C5'") && szDept != _T("C7"))
	{
		szWhere1.AppendFormat(_T("AND deptid not in ('TYC', 'PTTYC')"));
		szWhere2.AppendFormat(_T("AND hpc_deptid not in ('TYC', 'PTTYC')"));
	}
	...
	*/
	...
	szSQL.Format(_T(" SELECT") \
		...
		_T("  LEFT JOIN sys_user ON (hpc_practitioner = su_userid)") \
		_T(" WHERE hpcl_status <> 'O'") \
		_T(" AND (hfl_opt_group IS NOT NULL OR substr(hfl_opt_group, 1, 1) = 'B' OR (hpc_groupid='B1E00' and hfl_opt_group is null)) %s") \
		_T(" UNION ALL") \
		_T(" SELECT") \
		_T(" hpc_docno AS docno,") \
		_T(" hfl_name AS operation_name,") \
		...
		_T(" WHERE 1 = 1 AND quantity > 0 %s ORDER BY performdate, docno"), szPTTYC, szWhere1, szWhere2, szWhere2, szWhere);
		_fmsg(_T("%s"), szSQL);
	return szSQL;

}
CString CTMOperationListAll::GetQuerySring1()
{
	CMainFrame * pMF =(CMainFrame *) AfxGetMainWnd();
	UpdateData(true);
	CString szSQL, szWhere, szWhere1, szWhere2, szPTTYC, szTemp, szDept;
	...
	if(!szDept.IsEmpty())
		{
			...
			else if (szDept == _T("'C8'"))
			{
				szWhere1.AppendFormat(_T("AND pdeptid in (%s)"), szDept);
				szWhere2.AppendFormat(_T("AND HPCL_PERFORM_DEPTID in (%s)"), szDept);
	...
	szSQL.Format(_T(" SELECT") \
		...
		_T(" operation_name,") \
		_T(" operation_name1, pdeptid, HMS_GETROOMNAME(pdeptid, proomid) as proomid, deptid, %s") \
		...
		_T("   ho_invoiceno                  AS invoiceno,") \
		_T("   ho_performdate                AS orderdate, pdeptid, proomid, deptid ") \
		_T(" FROM") \
		_T("   (SELECT ho_docno,") \
		_T("     ho_comment,") \
		_T("     ho_practitioner,") \
		...
		_T("     END AS pdeptid,") \
		_T("     ho_deptid AS deptid,") \
		_T("     ho_roomid AS roomid, ho_proomid as proomid ") \
		_T("   FROM hms_operation") \
		_T("   WHERE ho_status IN ('S', 'T') ") \
		_T("   ) tbl1") \
		_T(" LEFT JOIN hms_fee_list") \
		...
		_T(" hpcl_qty * hfl_retprice AS amount,") \
		_T(" hpc_invoiceno AS invoiceno,") \
		_T(" hpc_performdate AS orderdate, hpc_pdeptid as pdeptid, hpc_proomid as proomid, hpc_deptid as deptid ") \
		_T(" FROM hms_testorder") \
		_T(" LEFT JOIN hms_testorderline") \
		_T(" ON(hpc_orderid = hpcl_orderid)") \
		_T(" LEFT JOIN hms_fee_list") \
		...
		_T(" hpcl_qty * hfl_retprice AS amount,") \
		_T(" hpc_invoiceno AS invoiceno,") \
		_T(" hpc_performdate AS orderdate, hpc_pdeptid as pdeptid, hpcl_proomid as proomid, hpc_deptid as deptid ") \
		_T(" FROM hms_pacsorder") \
		_T(" LEFT JOIN hms_pacsorderline") \
		_T(" ON(hpc_orderid = hpcl_orderid)") \
		_T(" LEFT JOIN hms_fee_list") \
		...
		_T("  LEFT JOIN sys_user ON (hpc_practitioner = su_userid)") \
		_T(" WHERE hpcl_status <> 'O'") \
		_T(" AND (hfl_opt_group IS NOT NULL OR substr(hfl_opt_group, 1, 1) = 'B' OR (hpc_groupid IN('B3200', 'B3300', 'B3400', 'B3410', 'B3500', 'B3600', 'B3100') and hfl_opt_group is null)) %s") \
		//_T(" AND (hfl_opt_group IS NOT NULL OR substr(hfl_opt_group, 1, 1) = 'B' OR (hpc_groupid='B1E00' and hfl_opt_group is null)) %s") \
		//szWhere2
		_T(" ) tbl") \
		_T(" LEFT JOIN hms_doc") \
		...
		_T(" operation_name,") \
		_T(" operation_name1,") \
		_T(" ho_desc, pdeptid, proomid, deptid ") \
		_T(" ORDER BY docno"), szSum, szField, szWhere1, szField2, szWhere2, szField2, szWhere2, szWhere);
	_fmsg(_T("%s"), szSQL);
	return szSQL;
}
CString CTMOperationListAll::GetNameUser(CString UserName, CString LastName ){
...
CString CTMOperationListAll::GetItemAbbreviation(CString szItemName, CString szExtraWord)
{
	CStringArray arr;
	CString szTemp;
	CString szValue;
...
int CTMOperationListAll::OnDeptListCheckAll()
{
	for (int i = 0; i < m_wndDept.GetItemCount(); i++)
	{
		if (!m_wndDept.GetCheck(i))
...
int CTMOperationListAll::OnDeptListUnCheckAll()
{
	for (int i = 0; i < m_wndDept.GetItemCount(); i++)
	{
		if (m_wndDept.GetCheck(i))
