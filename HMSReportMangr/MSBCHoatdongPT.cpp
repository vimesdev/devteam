...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongPT *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongPT *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CMSBCHoatdongPT *pVw = (CMSBCHoatdongPT *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CMSBCHoatdongPT*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CMSBCHoatdongPT*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CMSBCHoatdongPT*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongPT*)pWnd)->OnListDeleteItem();
} 
static void _OnDepartmentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CMSBCHoatdongPT* )pWnd)->OnDepartmentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnDepartmentSelendokFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnDepartmentSelendok();
}
/*static void _OnDepartmentSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnDepartmentKillfocus();
}*/
/*static void _OnDepartmentKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnDepartmentKillfocus();
}*/
static long _OnDepartmentLoadDataFnc(CWnd *pWnd){
	return ((CMSBCHoatdongPT *)pWnd)->OnDepartmentLoadData();
}
/*static void _OnDepartmentAddNewFnc(CWnd *pWnd){
	((CMSBCHoatdongPT *)pWnd)->OnDepartmentAddNew();
}*/
static int _OnAddMSBCHoatdongPTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongPT*)pWnd)->OnAddMSBCHoatdongPT();
} 
static int _OnEditMSBCHoatdongPTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongPT*)pWnd)->OnEditMSBCHoatdongPT();
} 
static int _OnDeleteMSBCHoatdongPTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongPT*)pWnd)->OnDeleteMSBCHoatdongPT();
} 
static int _OnSaveMSBCHoatdongPTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongPT*)pWnd)->OnSaveMSBCHoatdongPT();
} 
static int _OnCancelMSBCHoatdongPTFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongPT*)pWnd)->OnCancelMSBCHoatdongPT();
} 
CMSBCHoatdongPT::CMSBCHoatdongPT(){
...
void CMSBCHoatdongPT::OnCreateComponents(){
...
void CMSBCHoatdongPT::OnInitializeComponents(){
...
void CMSBCHoatdongPT::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CMSBCHoatdongPT::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);
	DDX_TextEx(pDX, m_wndDepartment.GetDlgCtrlID(), m_szDepartmentKey);

}
void CMSBCHoatdongPT::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMSBCHoatdongPT::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CMSBCHoatdongPT::SetDefaultValues(){
...
int CMSBCHoatdongPT::SetMode(int nMode){
...
/*void CMSBCHoatdongPT::OnFromDateChange(){
	
} */
/*void CMSBCHoatdongPT::OnFromDateSetfocus(){
	
} */
/*void CMSBCHoatdongPT::OnFromDateKillfocus(){
	
} */
int CMSBCHoatdongPT::OnFromDateCheckValue(){
	return 0;
} 
/*void CMSBCHoatdongPT::OnToDateChange(){
	
} */
/*void CMSBCHoatdongPT::OnToDateSetfocus(){
	
} */
/*void CMSBCHoatdongPT::OnToDateKillfocus(){
	
} */
int CMSBCHoatdongPT::OnToDateCheckValue(){
	return 0;
} 
void CMSBCHoatdongPT::OnLoadSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnListLoadData();
} 
void CMSBCHoatdongPT::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere, szObject, szDept, tmpStr, szNewGroup, szOldGroup;
	if (!rpt.Init(_T("Reports\\HMS\\BCHOATDONGPT.RPT")))
		return;
...
void CMSBCHoatdongPT::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CReport rpt; 
	CRecord rs(&pMF->m_db); 
	UpdateData(true);
	...
	xls.SetCellText(0, 2, _T("\x42\xE1o \x63\xE1o ho\x1EA1t \x111\x1ED9ng PTTT (Ph\x1EABu Thu\x1EADt)"), FMT_TEXT | FMT_CENTER | FMT_WRAPING, true, 12);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\MSBCHoatdongPT.xls"));
	
} 
void CMSBCHoatdongPT::OnListDblClick(){
	
} 
void CMSBCHoatdongPT::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CMSBCHoatdongPT::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CMSBCHoatdongPT::OnListLoadData(){
	UpdateData(TRUE);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	m_wndList.BeginLoad(); 
...
void CMSBCHoatdongPT::OnDepartmentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CMSBCHoatdongPT::OnDepartmentSelendok(){
	 
}
/*void CMSBCHoatdongPT::OnDepartmentSetfocus(){
	
}*/
/*void CMSBCHoatdongPT::OnDepartmentKillfocus(){
	
}*/
long CMSBCHoatdongPT::OnDepartmentLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CMSBCHoatdongPT::OnDepartmentAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
int CMSBCHoatdongPT::OnAddMSBCHoatdongPT(){
...
int CMSBCHoatdongPT::OnEditMSBCHoatdongPT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CMSBCHoatdongPT::OnDeleteMSBCHoatdongPT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelMSBCHoatdongPT();
 	}
	return 0;
}
int CMSBCHoatdongPT::OnSaveMSBCHoatdongPT(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CMSBCHoatdongPT::OnCancelMSBCHoatdongPT(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CMSBCHoatdongPT::OnMSBCHoatdongPTListLoadData(){
	return 0;
}
CString CMSBCHoatdongPT::GetQueryString(){
	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd();
...
_T("        CASE WHEN HO_OBJECT=1 AND HFL_GROUPID='B4400' THEN HO_QTY END QUAN,") \
_T("        CASE WHEN HO_OBJECT=11 AND HFL_GROUPID='B4400' THEN HO_QTY END QUANTN,") \
_T("        CASE WHEN HO_OBJECT=2 AND HFL_GROUPID='B4400' THEN HO_QTY END BHQH,") \
_T("        CASE WHEN HO_OBJECT=10 AND HFL_GROUPID='B4400' THEN HO_QTY END BHQD,") \
_T("        CASE WHEN HO_OBJECT=8 AND HFL_GROUPID='B4400' THEN HO_QTY END BAN,") \
_T("        CASE WHEN HO_OBJECT IN (9,6) AND HFL_GROUPID='B4400' THEN HO_QTY END TED6T,") \
_T("        CASE WHEN HO_OBJECT=3 AND HFL_GROUPID='B4400' THEN HO_QTY END CS,") \
_T("        CASE WHEN HO_OBJECT=7 AND HFL_GROUPID='B4400' THEN HO_QTY END DV,") \
_T("        CASE WHEN HO_OBJECT=4 AND HFL_GROUPID='B4400' THEN HO_QTY END BHK,") \
_T("        CASE WHEN HO_OBJECT=5 AND HFL_GROUPID='B4400' THEN HO_QTY END BHTN,") \
_T("        CASE WHEN HO_OBJECT=1 AND HFL_GROUPID='B4100' THEN HO_QTY END QUAN1,") \
_T("        CASE WHEN HO_OBJECT=11 AND HFL_GROUPID='B4100' THEN HO_QTY END QUANTN1,") \
_T("        CASE WHEN HO_OBJECT=2 AND HFL_GROUPID='B4100' THEN HO_QTY END BHQH1,") \
_T("        CASE WHEN HO_OBJECT=10 AND HFL_GROUPID='B4100' THEN HO_QTY END BHQD1,") \
_T("        CASE WHEN HO_OBJECT=8 AND HFL_GROUPID='B4100' THEN HO_QTY END BAN1,") \
_T("        CASE WHEN HO_OBJECT IN (9,6) AND HFL_GROUPID='B4100' THEN HO_QTY END TED6T1,") \
_T("        CASE WHEN HO_OBJECT=3 AND HFL_GROUPID='B4100' THEN HO_QTY END CS1,") \
_T("        CASE WHEN HO_OBJECT=7 AND HFL_GROUPID='B4100' THEN HO_QTY END DV1,") \
_T("        CASE WHEN HO_OBJECT=4 AND HFL_GROUPID='B4100' THEN HO_QTY END BHK1,") \
_T("        CASE WHEN HO_OBJECT=5 AND HFL_GROUPID='B4100' THEN HO_QTY END BHTN1,") \
_T("        CASE WHEN HO_OBJECT=1 AND HFL_GROUPID='B4200' THEN HO_QTY END QUAN2,") \
_T("        CASE WHEN HO_OBJECT=11 AND HFL_GROUPID='B4200' THEN HO_QTY END QUANTN2,") \
_T("        CASE WHEN HO_OBJECT=2 AND HFL_GROUPID='B4200' THEN HO_QTY END BHQH2,") \
_T("        CASE WHEN HO_OBJECT=10 AND HFL_GROUPID='B4200' THEN HO_QTY END BHQD2,") \
_T("        CASE WHEN HO_OBJECT=8 AND HFL_GROUPID='B4200' THEN HO_QTY END BAN2,") \
_T("        CASE WHEN HO_OBJECT IN (9,6) AND HFL_GROUPID='B4200' THEN HO_QTY END TED6T2,") \
_T("        CASE WHEN HO_OBJECT=3 AND HFL_GROUPID='B4200' THEN HO_QTY END CS2,") \
_T("        CASE WHEN HO_OBJECT=7 AND HFL_GROUPID='B4200' THEN HO_QTY END DV2,") \
_T("        CASE WHEN HO_OBJECT=4 AND HFL_GROUPID='B4200' THEN HO_QTY END BHK2,") \
_T("        CASE WHEN HO_OBJECT=5 AND HFL_GROUPID='B4200' THEN HO_QTY END BHTN2,") \
_T("        CASE WHEN HO_OBJECT=1 AND HFL_GROUPID='B4300' THEN HO_QTY END QUAN3,") \
_T("        CASE WHEN HO_OBJECT=11 AND HFL_GROUPID='B4300' THEN HO_QTY END QUANTN3,") \
_T("        CASE WHEN HO_OBJECT=2 AND HFL_GROUPID='B4300' THEN HO_QTY END BHQH3,") \
_T("        CASE WHEN HO_OBJECT=10 AND HFL_GROUPID='B4300' THEN HO_QTY END BHQD3,") \
_T("        CASE WHEN HO_OBJECT=8 AND HFL_GROUPID='B4300' THEN HO_QTY END BAN3,") \
_T("        CASE WHEN HO_OBJECT IN (9,6) AND HFL_GROUPID='B4300' THEN HO_QTY END TED6T3,") \
_T("        CASE WHEN HO_OBJECT=3 AND HFL_GROUPID='B4300' THEN HO_QTY END CS3,") \
_T("        CASE WHEN HO_OBJECT=7 AND HFL_GROUPID='B4300' THEN HO_QTY END DV3,") \
_T("        CASE WHEN HO_OBJECT=4 AND HFL_GROUPID='B4300' THEN HO_QTY END BHK3,") \
_T("        CASE WHEN HO_OBJECT=5 AND HFL_GROUPID='B4300' THEN HO_QTY END BHTN3") \
