#ifndef MSBCThongkeDSBNravien_H
#define MSBCThongkeDSBNravien_H
...
#include "GuiView.h"
#include "DbField.h"
class CMSBCThongkeDSBNravien : public CGuiView{
protected:
public:
	...
	int OnAddMSBCThongkeDSBNravien(); 
	int OnEditMSBCThongkeDSBNravien(); 
	int OnDeleteMSBCThongkeDSBNravien(); 
	int OnSaveMSBCThongkeDSBNravien(); 
	int OnCancelMSBCThongkeDSBNravien(); 
	int OnMSBCThongkeDSBNravienListLoadData(); 
