#ifndef MSBChoatdongtaichinhInputDialog_H
#define MSBChoatdongtaichinhInputDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CMSBChoatdongtaichinhInputDialog : public CGuiDialog{
protected:
public:
	...
	bool m_bIsEmpty;
	CDbfMap m_financial_report_Tbl;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CMSBChoatdongtaichinhInputDialog(CWnd *pParent);
	~CMSBChoatdongtaichinhInputDialog();
	...
	int OnAddMSBChoatdongtaichinhInputDialog(); 
	int OnEditMSBChoatdongtaichinhInputDialog(); 
	int OnDeleteMSBChoatdongtaichinhInputDialog(); 
	int OnSaveMSBChoatdongtaichinhInputDialog(); 
	int OnCancelMSBChoatdongtaichinhInputDialog(); 
	int OnMSBChoatdongtaichinhInputDialogListLoadData();
