#ifndef EMsoluongkhambenhkedonKEDON_H
#define EMsoluongkhambenhkedonKEDON_H
...
class EMsoluongkhambenhkedon : public CGuiView
{
...
public:
	...
	int OnAddEMsoluongkhambenhkedon(); 
	int OnEditEMsoluongkhambenhkedon(); 
	int OnDeleteEMsoluongkhambenhkedon(); 
	int OnSaveEMsoluongkhambenhkedon(); 
	int OnCancelEMsoluongkhambenhkedon(); 
	int OnEMsoluongkhambenhkedonListLoadData(); 
