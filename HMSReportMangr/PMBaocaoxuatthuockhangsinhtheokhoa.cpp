...
static int _OnCheckAllFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnCheckAll();
} 
static int _OnUnCheckAllFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnUnCheckAll();
} 
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnToDateCheckValue();
} 
static void _OnStockSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMBaocaoxuatthuockhangsinhtheokhoa* )pWnd)->OnStockSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnStockSelendokFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnStockSelendok();
}
/*static void _OnStockSetfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnStockKillfocus();
}*/
/*static void _OnStockKillfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnStockKillfocus();
}*/
static long _OnStockLoadDataFnc(CWnd *pWnd){
	return ((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnStockLoadData();
}
/*static void _OnStockAddNewFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnStockAddNew();
}*/
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMBaocaoxuatthuockhangsinhtheokhoa* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnTypeAddNew();
}*/

static void _OnOriginalSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CPMBaocaoxuatthuockhangsinhtheokhoa* )pWnd)->OnOriginalSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnOriginalSelendokFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnOriginalSelendok();
}
/*static void _OnOriginalSetfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnOriginalKillfocus();
}*/
/*static void _OnOriginalKillfocusFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnOriginalKillfocus();
}*/
static long _OnOriginalLoadDataFnc(CWnd *pWnd){
	return ((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnOriginalLoadData();
}
/*static void _OnOriginalAddNewFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd)->OnOriginalAddNew();
}*/


static void _OnPrintPreviewSelectFnc(CWnd *pWnd){
	CPMBaocaoxuatthuockhangsinhtheokhoa *pVw = (CPMBaocaoxuatthuockhangsinhtheokhoa *)pWnd;
...
static long _OnListFacLoadDataFnc(CWnd *pWnd){
	return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnListFacLoadData();
} 
static void _OnListFacDblClickFnc(CWnd *pWnd){
	((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnListFacDblClick();
} 
static void _OnListFacSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnListFacSelectChange(nOldItem, nNewItem);
} 
static int _OnListFacDeleteItemFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnListFacDeleteItem();
} 
static int _OnAddrptBaocaoxuatthuocchokhoatheodoituongFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnAddrptBaocaoxuatthuocchokhoatheodoituong();
} 
static int _OnEditrptBaocaoxuatthuocchokhoatheodoituongFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnEditrptBaocaoxuatthuocchokhoatheodoituong();
} 
static int _OnDeleterptBaocaoxuatthuocchokhoatheodoituongFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnDeleterptBaocaoxuatthuocchokhoatheodoituong();
} 
static int _OnSaverptBaocaoxuatthuocchokhoatheodoituongFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnSaverptBaocaoxuatthuocchokhoatheodoituong();
} 
static int _OnCancelrptBaocaoxuatthuocchokhoatheodoituongFnc(CWnd *pWnd){
	 return ((CPMBaocaoxuatthuockhangsinhtheokhoa*)pWnd)->OnCancelrptBaocaoxuatthuocchokhoatheodoituong();
} 
CPMBaocaoxuatthuockhangsinhtheokhoa::CPMBaocaoxuatthuockhangsinhtheokhoa(CWnd *pParent)
	{
...
CPMBaocaoxuatthuockhangsinhtheokhoa::~CPMBaocaoxuatthuockhangsinhtheokhoa(){
}
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnCreateComponents(){
	...
	m_wndTypeLabel.Create(this, _T("Invoice Type"), 10, 90, 90, 115);
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnInitializeComponents(){
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnSetWindowEvents(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnDoDataExchange(CDataExchange* pDX){
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::GetDataToScreen(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::GetScreenToData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

}
void CPMBaocaoxuatthuockhangsinhtheokhoa::SetDefaultValues(){
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::SetMode(int nMode){
...
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnFromDateChange(){
	
} */
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnFromDateSetfocus(){
	
} */
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnFromDateKillfocus(){
	
} */
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnFromDateCheckValue(){
	return 0;
} 
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnToDateChange(){
	
} */
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnToDateSetfocus(){
	
} */
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnToDateKillfocus(){
	
} */
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnToDateCheckValue(){
	return 0;
} 
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnStockSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnStockSelendok(){
	 
}
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnStockSetfocus(){
	
}*/
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnStockKillfocus(){
	
}*/
long CPMBaocaoxuatthuockhangsinhtheokhoa::OnStockLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnStockAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnTypeSelendok(){
	 
}
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnTypeSetfocus(){
	
}*/
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnTypeKillfocus(){
	
}*/
long CPMBaocaoxuatthuockhangsinhtheokhoa::OnTypeLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnTypeAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} */
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnOriginalSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnOriginalSelendok(){
	 
}
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnOriginalSetfocus(){
	
}*/
/*void CPMBaocaoxuatthuockhangsinhtheokhoa::OnOriginalKillfocus(){
	
}*/
long CPMBaocaoxuatthuockhangsinhtheokhoa::OnOriginalLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
/*
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnOriginalAddNew(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
}
*/
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnPrintPreviewSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	//UpdateData(true);
	OnPrintBaocaoxuathuocchokhoatheodoituong();
	//UpdateData(false);
} 
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnPrintSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	//UpdateData(true);
	OnExportBaocaoxuathuocchokhoatheodoituong();
	//UpdateData(false);
} 
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnExportSelect(){
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnCloseSelect(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();

} 

int CPMBaocaoxuatthuockhangsinhtheokhoa::OnCheckAll(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnUnCheckAll(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	for (int i=0; i< m_wndListFac.GetItemCount(); i++){
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnListFacDblClick(){
	
} 
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnListFacSelectChange(int nOldItem, int nNewItem){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	
} 
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnListFacDeleteItem(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	 return 0;
} 

long CPMBaocaoxuatthuockhangsinhtheokhoa::OnListFacLoadData(){
	CMainFrame_E10 *pMF = (CMainFrame_E10*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnAddrptBaocaoxuatthuocchokhoatheodoituong(){
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnEditrptBaocaoxuatthuocchokhoatheodoituong(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnDeleterptBaocaoxuatthuocchokhoatheodoituong(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame_E10 *pMF = (CMainFrame_E10 *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnSaverptBaocaoxuatthuocchokhoatheodoituong(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnCancelrptBaocaoxuatthuocchokhoatheodoituong(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CPMBaocaoxuatthuockhangsinhtheokhoa::OnrptBaocaoxuatthuocchokhoatheodoituongListLoadData(){
	return 0;
}

void CPMBaocaoxuatthuockhangsinhtheokhoa::OnPrintBaocaoxuathuocchokhoatheodoituong(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	CReport rpt;
	...
	if (!m_szFacList.IsEmpty())
		if (m_szFacList.Find(',') > 0)
			rpt.GetReportHeader()->SetValue(_T("Department"), _T("Nhiều khoa"));
		else
			rpt.GetReportHeader()->SetValue(_T("Department"), m_szFacList);
	else
		rpt.GetReportHeader()->SetValue(_T("Department"), _T("Toàn bộ"));
	...
	_T(" 	LEFT JOIN m_product_category ON(mpc_product_category_id = product_categoryid)") \
	...
	_T(" 	AND SUBSTR(mpc_code,1,3) = '6.2') tbl") \
...
void CPMBaocaoxuatthuockhangsinhtheokhoa::OnExportBaocaoxuathuocchokhoatheodoituong(){
	CMainFrame_E10 *pMF = (CMainFrame_E10 *) AfxGetMainWnd();
	UpdateData(true);
	BeginWaitCursor();
	...
	szSQL.Format(_T(" SELECT idx,groupname,id, name,unit,price,classname, %s,%s, %s FROM (") \
	_T(" 	SELECT product_categoryid as idx, product_categoryname as groupname,product_code as id, product_name as name,product_uomname as unit,") \
	_T("	product_vatprice as price, product_classname AS classname,") \
	_T("	%s") \
	_T(" 	FROM mev ") \
	_T(" 	LEFT JOIN m_productitem_view ON(product_item_id=sitemid)") \
	_T(" 	LEFT JOIN m_product_category ON(mpc_product_category_id = product_categoryid)") \
	_T(" 	WHERE expqty > 0 and deptid in(%s) and expdate BETWEEN TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') AND TO_TIMESTAMP('%s', 'YYYY-MM-DD HH24:MI:SS') %s ") \
	_T(" 	AND SUBSTR(mpc_code,1,3) = '6.2') tbl") \
	_T(" GROUP BY idx,groupname,id, name,unit,price,classname") \
	...
	xls.SetCellText(6+m_nCountList+1, nRow, tmpStr,&hf);
	TranslateString(_T("Total Amount"), tmpStr);
	xls.SetCellText(6+m_nCountList+2, nRow, tmpStr,&hf);	
	...
	while(!rs.IsEOF())
	{
		if (m_bCheck)
		{
			...
			if(szNewLine != szOldLine && !szNewLine.IsEmpty()){	
				...
				{			
					...
					xls.SetCellMergedColumns(1,nRow,6+m_nCountList);
					xls.SetCellText(1, nRow, szAmount, FMT_TEXT,true,11,0);
					tmpStr.Format(_T("%.2f"), grpCost);
					xls.SetCellText(6+m_nCountList+2, nRow, tmpStr, FMT_NUMBER1,true,11,0);
					nRow++;
					ttlCost += grpCost;
					grpCost = 0;
					nItem=1;
				}			
				xls.SetCellMergedColumns(1,nRow,6+m_nCountList +2);	
				tmpStr.Format(_T("%s) %s"), szNewLine, rs.GetValue(_T("groupname")));
		...
		xls.SetCellText(6+ m_nCountList+1,nRow,tmpStr, FMT_NUMBER1);				
		rs.GetValue(_T("totalAmount"), cost);				
		tmpStr.Format(_T("%.2f"), cost);
		grpCost+=cost;
		xls.SetCellText(6+ m_nCountList+2,nRow,tmpStr, FMT_NUMBER1);		
		nRow++;
		rs.MoveNext();
	}
	ttlCost += grpCost;
	if (m_bCheck)
	{
		if(grpCost > 0){
			...
			xls.SetCellMergedColumns(1,nRow,6+m_nCountList+1);
