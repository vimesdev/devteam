#ifndef MSBCThongkeDSBNhiendien_H
#define MSBCThongkeDSBNhiendien_H
...
#include "GuiView.h"
#include "DbField.h"
class CMSBCThongkeDSBNhiendien : public CGuiView{
protected:
public:
	...
	int OnAddMSBCThongkeDSBNhiendien(); 
	int OnEditMSBCThongkeDSBNhiendien(); 
	int OnDeleteMSBCThongkeDSBNhiendien(); 
	int OnSaveMSBCThongkeDSBNhiendien(); 
	int OnCancelMSBCThongkeDSBNhiendien(); 
	int OnMSBCThongkeDSBNhiendienListLoadData(); 
