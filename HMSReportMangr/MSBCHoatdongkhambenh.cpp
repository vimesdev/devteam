...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongkhambenh *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongkhambenh *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongkhambenh *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongkhambenh *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CMSBCHoatdongkhambenh *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongkhambenh *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CMSBCHoatdongkhambenh *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CMSBCHoatdongkhambenh *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CMSBCHoatdongkhambenh *pVw = (CMSBCHoatdongkhambenh *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CMSBCHoatdongkhambenh*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CMSBCHoatdongkhambenh*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CMSBCHoatdongkhambenh*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongkhambenh*)pWnd)->OnListDeleteItem();
} 
static int _OnAddMSBCHoatdongkhambenhFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongkhambenh*)pWnd)->OnAddMSBCHoatdongkhambenh();
} 
static int _OnEditMSBCHoatdongkhambenhFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongkhambenh*)pWnd)->OnEditMSBCHoatdongkhambenh();
} 
static int _OnDeleteMSBCHoatdongkhambenhFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongkhambenh*)pWnd)->OnDeleteMSBCHoatdongkhambenh();
} 
static int _OnSaveMSBCHoatdongkhambenhFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongkhambenh*)pWnd)->OnSaveMSBCHoatdongkhambenh();
} 
static int _OnCancelMSBCHoatdongkhambenhFnc(CWnd *pWnd){
	 return ((CMSBCHoatdongkhambenh*)pWnd)->OnCancelMSBCHoatdongkhambenh();
} 
CMSBCHoatdongkhambenh::CMSBCHoatdongkhambenh(){
...
void CMSBCHoatdongkhambenh::OnCreateComponents(){
	...
	m_wndList.InsertColumn(12, _T("BH N\x1EE3 th\x1EBB"), CFMT_MONEY, 70);
	m_wndList.InsertColumn(13, _T("T\x1ED5ng s\x1ED1"), CFMT_MONEY, 70);
}
void CMSBCHoatdongkhambenh::OnInitializeComponents(){
...
void CMSBCHoatdongkhambenh::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CMSBCHoatdongkhambenh::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CMSBCHoatdongkhambenh::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CMSBCHoatdongkhambenh::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CMSBCHoatdongkhambenh::SetDefaultValues(){

	m_szFromDate.Empty();
	m_szToDate.Empty();

}
int CMSBCHoatdongkhambenh::SetMode(int nMode){
...
void CMSBCHoatdongkhambenh::OnExportSelect(){
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\BCHoatdongkhambenh.xls"));	
	
} 
void CMSBCHoatdongkhambenh::OnListDblClick(){
	
} 
void CMSBCHoatdongkhambenh::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CMSBCHoatdongkhambenh::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CMSBCHoatdongkhambenh::OnListLoadData(){
	UpdateData(TRUE);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	m_wndList.BeginLoad(); 
...
int CMSBCHoatdongkhambenh::OnAddMSBCHoatdongkhambenh(){
...
int CMSBCHoatdongkhambenh::OnEditMSBCHoatdongkhambenh(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CMSBCHoatdongkhambenh::OnDeleteMSBCHoatdongkhambenh(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelMSBCHoatdongkhambenh();
 	}
	return 0;
}
int CMSBCHoatdongkhambenh::OnSaveMSBCHoatdongkhambenh(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnMSBCHoatdongkhambenhListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CMSBCHoatdongkhambenh::OnCancelMSBCHoatdongkhambenh(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CMSBCHoatdongkhambenh::OnMSBCHoatdongkhambenhListLoadData(){
	return 0;
}
//CString CMSBCHoatdongkhambenh::GetQueryString(){
//	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd();
