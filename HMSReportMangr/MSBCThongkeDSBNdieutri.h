#ifndef MSBCThongkeDSBNdieutri_H
#define MSBCThongkeDSBNdieutri_H
...
#include "GuiView.h"
#include "DbField.h"
class CMSBCThongkeDSBNdieutri : public CGuiView{
protected:
public:
	...
	int OnAddMSBCThongkeDSBNdieutri(); 
	int OnEditMSBCThongkeDSBNdieutri(); 
	int OnDeleteMSBCThongkeDSBNdieutri(); 
	int OnSaveMSBCThongkeDSBNdieutri(); 
	int OnCancelMSBCThongkeDSBNdieutri(); 
	int OnMSBCThongkeDSBNdieutriListLoadData(); 
