...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CBCTINHHINHPHAUTHUAT *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CBCTINHHINHPHAUTHUAT *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CBCTINHHINHPHAUTHUAT *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTINHHINHPHAUTHUAT *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CBCTINHHINHPHAUTHUAT *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CBCTINHHINHPHAUTHUAT *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CBCTINHHINHPHAUTHUAT *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTINHHINHPHAUTHUAT *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CBCTINHHINHPHAUTHUAT *pVw = (CBCTINHHINHPHAUTHUAT *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CBCTINHHINHPHAUTHUAT*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CBCTINHHINHPHAUTHUAT*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBCTINHHINHPHAUTHUAT*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CBCTINHHINHPHAUTHUAT*)pWnd)->OnListDeleteItem();
} 
static int _OnAddBCTINHHINHPHAUTHUATFnc(CWnd *pWnd){
	 return ((CBCTINHHINHPHAUTHUAT*)pWnd)->OnAddBCTINHHINHPHAUTHUAT();
} 
static int _OnEditBCTINHHINHPHAUTHUATFnc(CWnd *pWnd){
	 return ((CBCTINHHINHPHAUTHUAT*)pWnd)->OnEditBCTINHHINHPHAUTHUAT();
} 
static int _OnDeleteBCTINHHINHPHAUTHUATFnc(CWnd *pWnd){
	 return ((CBCTINHHINHPHAUTHUAT*)pWnd)->OnDeleteBCTINHHINHPHAUTHUAT();
} 
static int _OnSaveBCTINHHINHPHAUTHUATFnc(CWnd *pWnd){
	 return ((CBCTINHHINHPHAUTHUAT*)pWnd)->OnSaveBCTINHHINHPHAUTHUAT();
} 
static int _OnCancelBCTINHHINHPHAUTHUATFnc(CWnd *pWnd){
	 return ((CBCTINHHINHPHAUTHUAT*)pWnd)->OnCancelBCTINHHINHPHAUTHUAT();
} 
CBCTINHHINHPHAUTHUAT::CBCTINHHINHPHAUTHUAT(){
...
void CBCTINHHINHPHAUTHUAT::OnCreateComponents(){
...
void CBCTINHHINHPHAUTHUAT::OnInitializeComponents(){
...
void CBCTINHHINHPHAUTHUAT::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CBCTINHHINHPHAUTHUAT::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CBCTINHHINHPHAUTHUAT::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBCTINHHINHPHAUTHUAT::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CBCTINHHINHPHAUTHUAT::SetDefaultValues(){

	m_szFromDate.Empty();
	m_szToDate.Empty();

}
int CBCTINHHINHPHAUTHUAT::SetMode(int nMode){
...
/*void CBCTINHHINHPHAUTHUAT::OnFromDateChange(){
	
} */
/*void CBCTINHHINHPHAUTHUAT::OnFromDateSetfocus(){
	
} */
/*void CBCTINHHINHPHAUTHUAT::OnFromDateKillfocus(){
	
} */
int CBCTINHHINHPHAUTHUAT::OnFromDateCheckValue(){
	return 0;
} 
/*void CBCTINHHINHPHAUTHUAT::OnToDateChange(){
	
} */
/*void CBCTINHHINHPHAUTHUAT::OnToDateSetfocus(){
	
} */
/*void CBCTINHHINHPHAUTHUAT::OnToDateKillfocus(){
	
} */
int CBCTINHHINHPHAUTHUAT::OnToDateCheckValue(){
	return 0;
} 
void CBCTINHHINHPHAUTHUAT::OnLoadSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnListLoadData();
} 
void CBCTINHHINHPHAUTHUAT::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CBCTINHHINHPHAUTHUAT::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CReport rpt; 
	CRecord rs(&pMF->m_db); 
	UpdateData(true);
	...
	EndWaitCursor();
	xls.Save(_T("Exports\\TINH HINH PHAU THUAT.xls"));	
} 
void CBCTINHHINHPHAUTHUAT::OnListDblClick(){
	
} 
void CBCTINHHINHPHAUTHUAT::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CBCTINHHINHPHAUTHUAT::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CBCTINHHINHPHAUTHUAT::OnListLoadData(){
	UpdateData(TRUE);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	m_wndList.BeginLoad(); 
...
int CBCTINHHINHPHAUTHUAT::OnAddBCTINHHINHPHAUTHUAT(){
...
int CBCTINHHINHPHAUTHUAT::OnEditBCTINHHINHPHAUTHUAT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CBCTINHHINHPHAUTHUAT::OnDeleteBCTINHHINHPHAUTHUAT(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelBCTINHHINHPHAUTHUAT();
 	}
	return 0;
}
int CBCTINHHINHPHAUTHUAT::OnSaveBCTINHHINHPHAUTHUAT(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnBCTINHHINHPHAUTHUATListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CBCTINHHINHPHAUTHUAT::OnCancelBCTINHHINHPHAUTHUAT(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CBCTINHHINHPHAUTHUAT::OnBCTINHHINHPHAUTHUATListLoadData(){
	return 0;
}
CString CBCTINHHINHPHAUTHUAT::GetQueryString(){
	CMainFrame *pMF = (CMainFrame*)AfxGetMainWnd();
