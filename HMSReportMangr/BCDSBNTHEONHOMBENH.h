#ifndef BCDSBNTHEONHOMBENH_H
#define BCDSBNTHEONHOMBENH_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCDSBNTHEONHOMBENH : public CGuiView{
protected:
public:
	...
	int OnAddBCDSBNTHEONHOMBENH(); 
	int OnEditBCDSBNTHEONHOMBENH(); 
	int OnDeleteBCDSBNTHEONHOMBENH(); 
	int OnSaveBCDSBNTHEONHOMBENH(); 
	int OnCancelBCDSBNTHEONHOMBENH(); 
	int OnBCDSBNTHEONHOMBENHListLoadData(); 
