#ifndef MSBChoatdongtaichinh_H
#define MSBChoatdongtaichinh_H
...
#include "GuiView.h"
#include "DbField.h"
class CMSBChoatdongtaichinh : public CGuiView{
protected:
public:
	...
	int OnAddMSBChoatdongtaichinh(); 
	int OnEditMSBChoatdongtaichinh(); 
	int OnDeleteMSBChoatdongtaichinh(); 
	int OnSaveMSBChoatdongtaichinh(); 
	int OnCancelMSBChoatdongtaichinh(); 
	int OnMSBChoatdongtaichinhListLoadData();
	int OnLoadInputData();
	void OnFormLoad();
};
#endif
