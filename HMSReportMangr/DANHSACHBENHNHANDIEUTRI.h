#ifndef DANHSACHBENHNHANDIEUTRI_H
#define DANHSACHBENHNHANDIEUTRI_H
...
#include "GuiView.h"
#include "DbField.h"
class CDANHSACHBENHNHANDIEUTRI : public CGuiView{
protected:
public:
	...
	int OnAddDANHSACHBENHNHANDIEUTRI(); 
	int OnEditDANHSACHBENHNHANDIEUTRI(); 
	int OnDeleteDANHSACHBENHNHANDIEUTRI(); 
	int OnSaveDANHSACHBENHNHANDIEUTRI(); 
	int OnCancelDANHSACHBENHNHANDIEUTRI(); 
	int OnDANHSACHBENHNHANDIEUTRIListLoadData(); 
