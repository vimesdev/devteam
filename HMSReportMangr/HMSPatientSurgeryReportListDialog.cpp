...
void CHMSPatientSurgeryReportListDialog::OnCreateComponents()
{
	...
	m_wndSurgeryTypeLabel.Create(this, _T("Operation Type"), 10, 180, 130, 205);
	m_wndSurgeryType.Create(this,135, 180, 395, 205); 
	...
	m_wndLoadReport.Create(this, _T("&Load Report"), 175, 430, 265, 455);
	m_wndExport.Create(this, _T("&Export XLS"), 270, 430, 360, 455);
	m_wndClose.Create(this, _T("&Close"), 365, 430, 455, 455);
...
void CHMSPatientSurgeryReportListDialog::OnLoadReportSelect()
{
	...
	while (!rs.IsEOF())
	{
		...
		rptDetail->SetValue(_T("6"), GetDoctorName(tmpStr, true));

		rs.GetValue(_T("anaesthetist1"), tmpStr);
		rptDetail->SetValue(_T("7"), GetDoctorName(tmpStr, true));

		rs.GetValue(_T("user5"), tmpStr);
		rptDetail->SetValue(_T("8"), GetDoctorName(tmpStr, true));
...
void CHMSPatientSurgeryReportListDialog::OnExportSelect()
{
	...
	xls.SetColumnWidth(13, 18);
	xls.SetColumnWidth(14, 18);
	xls.SetColumnWidth(15, 18);

	xls.SetColumnWidth(16, 18);
	xls.SetColumnWidth(17, 18);
	xls.SetColumnWidth(18, 18);
	xls.SetColumnWidth(19, 18);
	xls.SetColumnWidth(20, 18);
	xls.SetColumnWidth(21, 18);
	xls.SetColumnWidth(22, 18);
	xls.SetColumnWidth(23, 18);

	xls.SetColumnWidth(24, 18);
	xls.SetColumnWidth(25, 18);
	xls.SetColumnWidth(26, 18);
	xls.SetColumnWidth(27, 18);
	xls.SetColumnWidth(28, 18);
	xls.SetColumnWidth(29, 18);
	xls.SetColumnWidth(30, 18);
	xls.SetColumnWidth(31, 18);
	...
	xls.SetCellText(10, 4, _T("V\xF4 tr\xF9ng"), 4098, true);
	xls.SetCellText(11, 4, _T("Lo\x1EA1i PT"), 4098, true);
	xls.SetCellText(12, 4, _T("S\x1ED1 ti\x1EC1n"), 4098, true);
	xls.SetCellText(13, 4, _T("Ng\xE0y ti\x1EBFp \x111\xF3n"), 4098, true);
	xls.SetCellText(14, 4, _T("Ng\xE0y t\x1EA1o \x62\x1EC7nh \xE1n"), 4098, true);
	xls.SetCellText(15, 4, _T("Ng\xE0y th\x1EF1\x63 hi\x1EC7n"), 4098, true);

	xls.SetCellText(16, 4, _T("Ng\xE0y yêu cầu huyết học"), 4098, true);
	xls.SetCellText(17, 4, _T("Ng\xE0y kết quả huyết học"), 4098, true);
	xls.SetCellText(18, 4, _T("Ng\xE0y yêu cầu sinh hóa"), 4098, true);
	xls.SetCellText(19, 4, _T("Ng\xE0y kết quả sinh hóa"), 4098, true);
	xls.SetCellText(20, 4, _T("Ng\xE0y yêu cầu miễn dịch"), 4098, true);
	xls.SetCellText(21, 4, _T("Ng\xE0y kết quả miễn dịch"), 4098, true);
	xls.SetCellText(22, 4, _T("Ng\xE0y yêu cầu SH phân tử"), 4098, true);
	xls.SetCellText(23, 4, _T("Ng\xE0y kết quả SH phân tử"), 4098, true);

	xls.SetCellText(24, 4, _T("Ng\xE0y yêu cầu siêu âm"), 4098, true);
	xls.SetCellText(25, 4, _T("Ng\xE0y kết quả siêu âm"), 4098, true);
	xls.SetCellText(26, 4, _T("Ng\xE0y yêu cầu XQuang"), 4098, true);
	xls.SetCellText(27, 4, _T("Ng\xE0y kết quả XQuang"), 4098, true);
	xls.SetCellText(28, 4, _T("Ng\xE0y yêu cầu CT"), 4098, true);
	xls.SetCellText(29, 4, _T("Ng\xE0y kết quả CT"), 4098, true);
	xls.SetCellText(30, 4, _T("Ng\xE0y yêu cầu MRI"), 4098, true);
	xls.SetCellText(31, 4, _T("Ng\xE0y kết quả MRI"), 4098, true);
	nRow = 6;
	while (!rs.IsEOF())
	{
		...
		xls.SetCellText(7, nRow, GetDoctorName(tmpStr, true), FMT_TEXT);
		rs.GetValue(_T("anaesthetist1"), tmpStr);
		xls.SetCellText(8, nRow, GetDoctorName(tmpStr, true), FMT_TEXT);
		rs.GetValue(_T("anaesthetist"), tmpStr);
		xls.SetCellText(9, nRow, GetDoctorName(tmpStr, true), FMT_TEXT);
		rs.GetValue(_T("user5"), tmpStr);
		xls.SetCellText(10, nRow, GetDoctorName(tmpStr, true), FMT_TEXT);
		...
		rs.GetValue(_T("receptiondate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(13, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("recorddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		...
		if(!tmpStr.IsEmpty())
		xls.SetCellText(15, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("hhoddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(16, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("hhprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(17, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("shoddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(18, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("shprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(19, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("mdoddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(20, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("mdprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(21, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("shptoddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(22, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("shptprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(23, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("saoddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(24, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("saprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(25, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("xqoddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(26, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("xqprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(27, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("ctoddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(28, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("ctprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(29, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);

		rs.GetValue(_T("mrioddate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(30, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		rs.GetValue(_T("mriprdate"), tmpStr);
		if(!tmpStr.IsEmpty())
		xls.SetCellText(31, nRow, CDateTime::Convert(tmpStr, yyyymmdd | hhmmss, ddmmyyyy | hhmmss), FMT_TEXT);
		nRow++;
		rs.MoveNext();
	}
	if (nTotal > 0)
...
CString CHMSPatientSurgeryReportListDialog::GetQueryString(){
	...
	szSQL.Format(_T(" SELECT ") \
			...
			_T("   hd_admitdate AS receptiondate,") \
			_T("   hcr_admitdate AS recorddate,") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1100' AND hpc_docno = hd_docno) AS hhoddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1100' AND hpc_docno = hd_docno) AS hhprdate,") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1200' AND hpc_docno = hd_docno) AS shoddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1200' AND hpc_docno = hd_docno) AS shprdate,") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1400' AND hpc_docno = hd_docno) AS mdoddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1400' AND hpc_docno = hd_docno) AS mdprdate,") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1B00' AND hpc_docno = hd_docno) AS shptoddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_testorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B1B00' AND hpc_docno = hd_docno) AS shptprdate,") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B3200' AND hpc_docno = hd_docno) AS saoddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B3200' AND hpc_docno = hd_docno) AS saprdate,") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B2100' AND hpc_docno = hd_docno) AS xqoddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B2100' AND hpc_docno = hd_docno) AS xqprdate,") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B2200' AND hpc_docno = hd_docno) AS ctoddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B2200' AND hpc_docno = hd_docno) AS ctprdate,  ") \
			_T("   (SELECT MIN(hpc_orderdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B2300' AND hpc_docno = hd_docno) AS mrioddate,") \
			_T("   (SELECT MIN(hpc_performdate) FROM hms_pacsorder WHERE hpc_deptid = 'C1.3' AND hpc_groupid = 'B2300' AND hpc_docno = hd_docno) AS mriprdate") \
			...
			_T(" WHERE ho_performdate BETWEEN to_timestamp('%s', 'YYYY-MM-DD HH24:MI:SS') AND to_timestamp('%s', 'YYYY-MM-DD HH24:MI:SS') AND ho_status = 'T'") \
			_T(" AND ho_pdeptid='B5' %s ORDER BY ho_performdate"), m_szFromDate, m_szToDate, szWhere);
	_fmsg(_T("%s"), szSQL);
	return szSQL;
}

CString CHMSPatientSurgeryReportListDialog::GetDoctorName(CString szUserId, bool bFirstName)
{
	CMainFrame* pMF = (CMainFrame*) AfxGetMainWnd();
