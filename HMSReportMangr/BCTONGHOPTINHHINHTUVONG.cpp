...
/*static void _OnFromDateChangeFnc(CWnd *pWnd){
	((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnFromDateChange();
} */
/*static void _OnFromDateSetfocusFnc(CWnd *pWnd){
	((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnFromDateSetfocus();} */ 
/*static void _OnFromDateKillfocusFnc(CWnd *pWnd){
	((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnFromDateKillfocus();
} */
static int _OnFromDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnFromDateCheckValue();
} 
/*static void _OnToDateChangeFnc(CWnd *pWnd){
	((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnToDateChange();
} */
/*static void _OnToDateSetfocusFnc(CWnd *pWnd){
	((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnToDateSetfocus();} */ 
/*static void _OnToDateKillfocusFnc(CWnd *pWnd){
	((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnToDateKillfocus();
} */
static int _OnToDateCheckValueFnc(CWnd *pWnd){
	return ((CBCTONGHOPTINHHINHTUVONG *)pWnd)->OnToDateCheckValue();
} 
static void _OnLoadSelectFnc(CWnd *pWnd){
	CBCTONGHOPTINHHINHTUVONG *pVw = (CBCTONGHOPTINHHINHTUVONG *)pWnd;
	pVw->OnLoadSelect();
} 
...
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 
static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnListDeleteItem();
} 
static int _OnAddBCTONGHOPTINHHINHTUVONGFnc(CWnd *pWnd){
	 return ((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnAddBCTONGHOPTINHHINHTUVONG();
} 
static int _OnEditBCTONGHOPTINHHINHTUVONGFnc(CWnd *pWnd){
	 return ((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnEditBCTONGHOPTINHHINHTUVONG();
} 
static int _OnDeleteBCTONGHOPTINHHINHTUVONGFnc(CWnd *pWnd){
	 return ((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnDeleteBCTONGHOPTINHHINHTUVONG();
} 
static int _OnSaveBCTONGHOPTINHHINHTUVONGFnc(CWnd *pWnd){
	 return ((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnSaveBCTONGHOPTINHHINHTUVONG();
} 
static int _OnCancelBCTONGHOPTINHHINHTUVONGFnc(CWnd *pWnd){
	 return ((CBCTONGHOPTINHHINHTUVONG*)pWnd)->OnCancelBCTONGHOPTINHHINHTUVONG();
} 
CBCTONGHOPTINHHINHTUVONG::CBCTONGHOPTINHHINHTUVONG(){
...
void CBCTONGHOPTINHHINHTUVONG::OnCreateComponents(){
...
void CBCTONGHOPTINHHINHTUVONG::OnInitializeComponents(){
...
void CBCTONGHOPTINHHINHTUVONG::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CBCTONGHOPTINHHINHTUVONG::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndFromDate.GetDlgCtrlID(), m_szFromDate);
	DDX_TextEx(pDX, m_wndToDate.GetDlgCtrlID(), m_szToDate);

}
void CBCTONGHOPTINHHINHTUVONG::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CBCTONGHOPTINHHINHTUVONG::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CBCTONGHOPTINHHINHTUVONG::SetDefaultValues(){

	m_szFromDate.Empty();
	m_szToDate.Empty();

}
int CBCTONGHOPTINHHINHTUVONG::SetMode(int nMode){
...
/*void CBCTONGHOPTINHHINHTUVONG::OnFromDateChange(){
	
} */
/*void CBCTONGHOPTINHHINHTUVONG::OnFromDateSetfocus(){
	
} */
/*void CBCTONGHOPTINHHINHTUVONG::OnFromDateKillfocus(){
	
} */
int CBCTONGHOPTINHHINHTUVONG::OnFromDateCheckValue(){
	return 0;
} 
/*void CBCTONGHOPTINHHINHTUVONG::OnToDateChange(){
	
} */
/*void CBCTONGHOPTINHHINHTUVONG::OnToDateSetfocus(){
	
} */
/*void CBCTONGHOPTINHHINHTUVONG::OnToDateKillfocus(){
	
} */
int CBCTONGHOPTINHHINHTUVONG::OnToDateCheckValue(){
	return 0;
} 
void CBCTONGHOPTINHHINHTUVONG::OnLoadSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnListLoadData();
} 
void CBCTONGHOPTINHHINHTUVONG::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	UpdateData(true);
	CReport rpt;
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere, tmpStr, szNewGroup, szOldGroup;
	if (!rpt.Init(_T("Reports\\HMS\\BCTONGHOPTINHHINHTUVONGCUACANBOCAOCAP.RPT")))
		return;
	szWhere.Format(_T(" HD_ADMITDATE BETWEEN cast_string2timestamp('%s') AND cast_string2timestamp('%s')"), m_szFromDate, m_szToDate);
...
void CBCTONGHOPTINHHINHTUVONG::OnExportSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CBCTONGHOPTINHHINHTUVONG::OnListDblClick(){
	
} 
void CBCTONGHOPTINHHINHTUVONG::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CBCTONGHOPTINHHINHTUVONG::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	 return 0;
} 
long CBCTONGHOPTINHHINHTUVONG::OnListLoadData(){
	UpdateData(TRUE);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	m_wndList.BeginLoad(); 
...
int CBCTONGHOPTINHHINHTUVONG::OnAddBCTONGHOPTINHHINHTUVONG(){
...
int CBCTONGHOPTINHHINHTUVONG::OnEditBCTONGHOPTINHHINHTUVONG(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CBCTONGHOPTINHHINHTUVONG::OnDeleteBCTONGHOPTINHHINHTUVONG(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelBCTONGHOPTINHHINHTUVONG();
 	}
	return 0;
}
int CBCTONGHOPTINHHINHTUVONG::OnSaveBCTONGHOPTINHHINHTUVONG(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnBCTONGHOPTINHHINHTUVONGListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CBCTONGHOPTINHHINHTUVONG::OnCancelBCTONGHOPTINHHINHTUVONG(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CBCTONGHOPTINHHINHTUVONG::OnBCTONGHOPTINHHINHTUVONGListLoadData(){
	return 0;
}
