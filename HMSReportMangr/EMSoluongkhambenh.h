#ifndef EMSOLUONGKHAMBENH_H
#define EMSOLUONGKHAMBENH_H
...
class EMsoluongkhambenh : public CGuiView
{
protected:
public:
	...
	int OnAddEMsoluongkhambenh(); 
	int OnEditEMsoluongkhambenh(); 
	int OnDeleteEMsoluongkhambenh(); 
	int OnSaveEMsoluongkhambenh(); 
	int OnCancelEMsoluongkhambenh(); 
	int OnEMsoluongkhambenhListLoadData(); 
