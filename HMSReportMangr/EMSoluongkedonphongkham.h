#ifndef EMSOLUONGKEDONPHONGKHAM_H
#define EMSOLUONGKEDONPHONGKHAM_H
...
class EMsoluongkedonphongkham : public CGuiView
{
protected:
public:
	...
	int OnAddEMsoluongkedonphongkham(); 
	int OnEditEMsoluongkedonphongkham(); 
	int OnDeleteEMsoluongkedonphongkham(); 
	int OnSaveEMsoluongkedonphongkham(); 
	int OnCancelEMsoluongkedonphongkham(); 
	int OnEMsoluongkedonphongkhamListLoadData(); 
