#ifndef BCDANHSACHBENHNHANVAOVIEN_H
#define BCDANHSACHBENHNHANVAOVIEN_H
...
#include "GuiView.h"
#include "DbField.h"
class CBCDANHSACHBENHNHANVAOVIEN : public CGuiView{
protected:
public:
	...
	int OnAddBCDANHSACHBENHNHANVAOVIEN(); 
	int OnEditBCDANHSACHBENHNHANVAOVIEN(); 
	int OnDeleteBCDANHSACHBENHNHANVAOVIEN(); 
	int OnSaveBCDANHSACHBENHNHANVAOVIEN(); 
	int OnCancelBCDANHSACHBENHNHANVAOVIEN(); 
	int OnBCDANHSACHBENHNHANVAOVIENListLoadData(); 
