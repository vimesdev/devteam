#ifndef HMSTreatmentDOCUMENT_H
#define HMSTreatmentDOCUMENT_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSTreatmentDocument : public CGuiView{
protected:
public:
	...
	int OnAddHMSTreatmentDocument(); 
	int OnEditHMSTreatmentDocument(); 
	int OnDeleteHMSTreatmentDocument(); 
	int OnSaveHMSTreatmentDocument(); 
	int OnCancelHMSTreatmentDocument(); 
	int OnHMSTreatmentDocumentListLoadData(); 
};
#endif
