#ifndef HMSDailyFoodOrderCancel_H
#define HMSDailyFoodOrderCancel_H
...
class CHMSDailyFoodOrderCancel : public CGuiView{
protected:
public:
	...
	int				OnChangeRation();
	//CHMSDailyFoodOrderCancel(CWnd *pParent);
	CHMSDailyFoodOrderCancel();
	~CHMSDailyFoodOrderCancel();
