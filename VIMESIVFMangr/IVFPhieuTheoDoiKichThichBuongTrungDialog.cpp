...
CIVFPhieuTheoDoiKichThichBuongTrungDialog::CIVFPhieuTheoDoiKichThichBuongTrungDialog(CWnd* pParent):
CGuiDialog(pParent)
{
...
void CIVFPhieuTheoDoiKichThichBuongTrungDialog::OnCreateComponents(){
	...
	m_wndCancel.Create(this, _T("&Cancel"), 550, 570, 630, 595);
...
void CIVFPhieuTheoDoiKichThichBuongTrungDialog::OnInitializeComponents(){
	...
	m_wndList.InsertColumn(0, _T("Ngày"), CFMT_DATE, 80);
	m_wndList.InsertColumn(1, _T("Ngày CK"), CFMT_DATE, 80);
	m_wndList.InsertColumn(2, _T("CC"), CFMT_TEXT, 70);
	m_wndList.InsertColumn(3, _T("FSH"), CFMT_TEXT, 70);
	m_wndList.InsertColumn(4, _T("GmRHa"), CFMT_TEXT, 70);
	m_wndList.InsertColumn(5, _T("BT(P)"), CFMT_TEXT, 100);
	m_wndList.InsertColumn(6, _T("BT(T)"), CFMT_TEXT, 100);
	m_wndList.InsertColumn(7, _T("NMTC"), CFMT_TEXT, 70);
	m_wndList.InsertColumn(8, _T("BS_SA"), CFMT_TEXT, 150);
...
void CIVFPhieuTheoDoiKichThichBuongTrungDialog::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
