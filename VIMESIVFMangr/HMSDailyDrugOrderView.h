#ifndef HMSDailyDrugOrderView_H
#define HMSDailyDrugOrderView_H
...
class CHMSDailyDrugOrderView : public CGuiView{
protected:
public:
	...
	CGuiTextCtrl	m_wndPatientNameSearch;
	CGuiLabel		m_wndPatientCountLabel;
	CGuiNumberCtrl	m_wndPatientCount;
	...
	//void		OnPatientNameSearchChange(); 
	//void		OnPatientNameSearchSetfocus(); 
	//void		OnPatientNameSearchKillfocus(); 
	int			OnPatientNameSearchCheckValue(); 
	...
	//CHMSDailyDrugOrderView(CWnd *pParent);
	CHMSDailyDrugOrderView();
	~CHMSDailyDrugOrderView();
	...
	int OnAddHMSDailyDrugOrderView(); 
	int OnEditHMSDailyDrugOrderView(); 
	int OnDeleteHMSDailyDrugOrderView(); 
	int OnSaveHMSDailyDrugOrderView(); 
	int OnCancelHMSDailyDrugOrderView(); 
	int OnHMSDailyDrugOrderViewListLoadData(); 
