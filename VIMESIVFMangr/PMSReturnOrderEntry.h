...
public:
	...
	int OnAddPMSReturnOrderEntry(); 
	int OnEditPMSReturnOrderEntry(); 
	int OnDeletePMSReturnOrderEntry(); 
	int OnSavePMSReturnOrderEntry(); 
	int OnCancelPMSReturnOrderEntry(); 
	int OnPMSReturnOrderEntryListLoadData(); 
