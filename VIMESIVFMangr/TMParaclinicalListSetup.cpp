#include "TMParaclinicalListSetup.h"
//#include "stdafx.h"
#include "MainFrm.h"
...
static int _OnParaclinicalListLoadDataFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnParaclinicalListLoadData();
} 
static int _OnParaclinicalListDblClickFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnParaclinicalListDblClick();
} 
static int _OnParaclinicalListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnParaclinicalListSelectChange(nOldItem, nNewItem);
} 
static int _OnParaclinicalListDeleteItemFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnParaclinicalListDeleteItem();
} 
static int _OnFeeListLoadDataFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnFeeListLoadData();
} 
static int _OnFeeListDblClickFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnFeeListDblClick();
} 
static int _OnFeeListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnFeeListSelectChange(nOldItem, nNewItem);
} 
static int _OnFeeListDeleteItemFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnFeeListDeleteItem();
} 

static int _OnFeeListSortIndexFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnFeeListSortIndex();
} 
static int _OnListShowLogItemFnc(CWnd *pWnd){
	return ((CTMParaclinicalListSetup*)pWnd)->OnListShowLogItem();
}
static int _OnFindChangeFnc(CWnd *pWnd){
	return ((CTMParaclinicalListSetup *)pWnd)->OnFindChange();
}

static int _OnSetSubGroupFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnSetSubGroup();
} 
static int _OnSetSubItemFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnSetSubItem();
} 


static int _OnFilterSelectFnc(CWnd *pWnd){
	CTMParaclinicalListSetup *pVw = (CTMParaclinicalListSetup *)pWnd;
...
static int _OnAddHMSParaclinicalListSetupFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnAddHMSParaclinicalListSetup();
} 
static int _OnEditHMSParaclinicalListSetupFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnEditHMSParaclinicalListSetup();
} 
static int _OnDeleteHMSParaclinicalListSetupFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnDeleteHMSParaclinicalListSetup();
} 
static int _OnSaveHMSParaclinicalListSetupFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnSaveHMSParaclinicalListSetup();
} 
static int _OnCancelHMSParaclinicalListSetupFnc(CWnd *pWnd){
	 return ((CTMParaclinicalListSetup*)pWnd)->OnCancelHMSParaclinicalListSetup();
} 
CTMParaclinicalListSetup::CTMParaclinicalListSetup(){
...
void CTMParaclinicalListSetup::OnCreateComponents(){
	m_wndParaclinicalList.Create(this,5, 5, 255, 585); 
	m_wndFeeList.Create(this,260, 5, 805, 430); 
	...
	m_wndMapCircular.Create(this, CRect(260, 435, 805, 555));
}
void CTMParaclinicalListSetup::OnInitializeComponents(){
...
//	m_wndFind.SetCheckValue(true);
	...
	m_wndFeeList.InsertColumn(6, _T("Return Dept"), CFMT_MONEY, 60);
	m_wndFeeList.InsertColumn(7, _T("Dept ID"), CFMT_TEXT, 50);
	m_wndFeeList.InsertColumn(8, _T("Operation Group"), CFMT_TEXT, 60);
	m_wndFeeList.SetAllowDrag(true);
	m_wndFeeList.ModifyStyle(LVS_SINGLESEL, 0);
	m_wndMapCircular.OnInitDialog();
}
void CTMParaclinicalListSetup::OnSetWindowEvents(){
...
void CTMParaclinicalListSetup::OnDoDataExchange(CDataExchange* pDX){
	DDX_Text(pDX, m_wndFind.GetDlgCtrlID(), m_szFind);
}
void CTMParaclinicalListSetup::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 

}
void CTMParaclinicalListSetup::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 

}
void CTMParaclinicalListSetup::SetDefaultValues(){


}
int CTMParaclinicalListSetup::SetMode(int nMode){ 
...
int CTMParaclinicalListSetup::OnParaclinicalListDblClick(){
	 return 0;
} 
int CTMParaclinicalListSetup::OnParaclinicalListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
...
int CTMParaclinicalListSetup::OnParaclinicalListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	 return 0;
} 
int CTMParaclinicalListSetup::OnParaclinicalListLoadData(){
/*
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CTMParaclinicalListSetup::OnFeeListDblClick(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	...
	//	OnFeeListLoadData();
	//}
	CHMSOperationGroupPopup *newPopup = new CHMSOperationGroupPopup(&m_wndFeeList, _T("T"));
	newPopup->m_szID = szID;
	newPopup->m_pWnd = this;
	newPopup->ShowPopup(&m_wndFeeList);

	return 0;
} 
int CTMParaclinicalListSetup::OnFeeListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	int nSel = m_wndFeeList.GetCurSel();
	if(nSel < 0)
		return -1;
...
int CTMParaclinicalListSetup::OnFeeListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	OnDeleteHMSParaclinicalListSetup();
	return 0;
} 
int CTMParaclinicalListSetup::OnFeeListSortIndex(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CString szSQL, szID;
...
int CTMParaclinicalListSetup::OnFeeListLoadData(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
...
int CTMParaclinicalListSetup::OnSetSubGroup(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	int nSel;
...
int CTMParaclinicalListSetup::OnSetSubItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	int nSel;
	nSel = m_wndFeeList.GetCurSel();
	if(nSel < 0) return 0;
...
int CTMParaclinicalListSetup::OnFilterSelect(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRect rect;
...
int CTMParaclinicalListSetup::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	OnAddHMSParaclinicalListSetup();
	 return 0;
} 
int CTMParaclinicalListSetup::OnEditSelect(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	//OnEditHMSParaclinicalListSetup();
	OnFeeListDblClick();
	return 0;
} 
int CTMParaclinicalListSetup::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	OnDeleteHMSParaclinicalListSetup();
	 return 0;
} 
int CTMParaclinicalListSetup::OnAddHMSParaclinicalListSetup(){
...
int CTMParaclinicalListSetup::OnEditHMSParaclinicalListSetup(){
	if(m_szCode.IsEmpty())
		return -1;
...
int CTMParaclinicalListSetup::OnDeleteHMSParaclinicalListSetup(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd(); 
...
int CTMParaclinicalListSetup::OnSaveHMSParaclinicalListSetup(){
...
int CTMParaclinicalListSetup::OnCancelHMSParaclinicalListSetup(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CTMParaclinicalListSetup::OnHMSParaclinicalListSetupListLoadData(){
	return 0;
}

int CTMParaclinicalListSetup::OnFindChange(){
...
int CTMParaclinicalListSetup::OnListShowLogItem(){
