#ifndef HMSPATIENTDRUGORDERENTRY_H
#define HMSPATIENTDRUGORDERENTRY_H
...
class CHMSPatientDrugOrderEntry : public CGuiPopup{
protected:
	bool	m_bAddOrder;
...
public:
	...
	CHMSPatientDrugOrderEntry(CWnd *pParent, int nMode, int nType=0);
	~CHMSPatientDrugOrderEntry();
	...
	int OnAddHMSPatientDrugOrderEntry(); 
	int OnEditHMSPatientDrugOrderEntry(); 
	int OnDeleteHMSPatientDrugOrderEntry(); 
	int OnSaveHMSPatientDrugOrderEntry(); 
	int OnCancelHMSPatientDrugOrderEntry(); 
	int OnHMSPatientDrugOrderEntryListLoadData(); 
