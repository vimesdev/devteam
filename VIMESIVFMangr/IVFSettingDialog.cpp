...
static void _OnParentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CIVFSettingDialog* )pWnd)->OnParentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnParentSelendokFnc(CWnd *pWnd){
	((CIVFSettingDialog *)pWnd)->OnParentSelendok();
}
/*static void _OnParentSetfocusFnc(CWnd *pWnd){
	((CIVFSettingDialog *)pWnd)->OnParentKillfocus();
}*/
/*static void _OnParentKillfocusFnc(CWnd *pWnd){
	((CIVFSettingDialog *)pWnd)->OnParentKillfocus();
}*/
static long _OnParentLoadDataFnc(CWnd *pWnd){
	return ((CIVFSettingDialog *)pWnd)->OnParentLoadData();
}
/*static void _OnParentAddNewFnc(CWnd *pWnd){
	((CIVFSettingDialog *)pWnd)->OnParentAddNew();
}*/
...
CIVFSettingDialog::CIVFSettingDialog(CWnd *pParent, CString szTable, CString szParentTable, CString szTitle):
...
void CIVFSettingDialog::OnParentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFSettingDialog::OnParentSelendok(){
	 
}
/*void CIVFSettingDialog::OnParentSetfocus(){
	
}*/
/*void CIVFSettingDialog::OnParentKillfocus(){
	
}*/
long CIVFSettingDialog::OnParentLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CIVFSettingDialog::OnParentAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
