...
/*static void _OnNgayChangeFnc(CWnd *pWnd){
	((CIVFTDKichthichBuongTrungPopup *)pWnd)->OnNgayChange();
} */
/*static void _OnNgaySetfocusFnc(CWnd *pWnd){
	((CIVFTDKichthichBuongTrungPopup *)pWnd)->OnNgaySetfocus();} */ 
/*static void _OnNgayKillfocusFnc(CWnd *pWnd){
	((CIVFTDKichthichBuongTrungPopup *)pWnd)->OnNgayKillfocus();
} */
static int _OnNgayCheckValueFnc(CWnd *pWnd){
	return ((CIVFTDKichthichBuongTrungPopup *)pWnd)->OnNgayCheckValue();
} 
...
CIVFTDKichthichBuongTrungPopup::CIVFTDKichthichBuongTrungPopup(CWnd *pParent, int nMode):
	CGuiPopup(pParent){
...
void CIVFTDKichthichBuongTrungPopup::OnCreateComponents(){
	m_wndNgayCKLabel.Create(this, _T("Ngay_CK"), 5, 5, 105, 30);
	m_wndNgayCK.Create(this,110, 5, 210, 30); 
	m_wndNgayLabel.Create(this, _T("ngay"), 215, 5, 315, 30);
	m_wndNgay.Create(this,320, 5, 420, 30); 
...
void CIVFTDKichthichBuongTrungPopup::OnInitializeComponents(){
	...
	m_wndNgay.SetMax(CDate(pMF->GetSysDate()));
	m_wndNgay.SetCheckValue(true);
	m_wndQuyetDinh.SetLimitText(15);
	m_wndQuyetDinh.SetCheckValue(false);
	m_wndCC.SetLimitText(15);
	m_wndCC.SetCheckValue(false);
	m_wndFSH.SetLimitText(15);
	m_wndFSH.SetCheckValue(false);
	m_wndGNRHA.SetLimitText(15);
	m_wndGNRHA.SetCheckValue(false);
	m_wndBTP.SetLimitText(15);
	m_wndBTP.SetCheckValue(false);
	m_wndBTT.SetLimitText(15);
	m_wndBTT.SetCheckValue(false);
	m_wndNMTC.SetLimitText(15);
	m_wndNMTC.SetCheckValue(false);
	m_wndBSSA.SetCheckValue(false);
	m_wndBSSA.LimitText(65);
...
void CIVFTDKichthichBuongTrungPopup::OnSetWindowEvents(){
	...
	//m_wndNgay.SetEvent(WE_CHANGE, _OnNgayChangeFnc);
	//m_wndNgay.SetEvent(WE_SETFOCUS, _OnNgaySetfocusFnc);
	//m_wndNgay.SetEvent(WE_KILLFOCUS, _OnNgayKillfocusFnc);
	m_wndNgay.SetEvent(WE_CHECKVALUE, _OnNgayCheckValueFnc);
...
void CIVFTDKichthichBuongTrungPopup::OnDoDataExchange(CDataExchange* pDX){
	...
	DDX_TextEx(pDX, m_wndNgay.GetDlgCtrlID(), m_szNgay);
...
void CIVFTDKichthichBuongTrungPopup::UpdateJson(BOOL bSave){
	...
	m_jData[_T("Ngay")].GetValue(m_szNgay);
...
void CIVFTDKichthichBuongTrungPopup::GetDataToScreen(){
	...
	rs.GetValue(_T("NGAYTHEODOI"), m_szNgay);
...
void CIVFTDKichthichBuongTrungPopup::GetScreenToData(){
	...
	m_ivf_nangnoanTbl.SetValue(_T("NGAYTHEODOI"), m_szNgay);
...
/*void CIVFTDKichthichBuongTrungPopup::OnNgayChange(){
	
} */
/*void CIVFTDKichthichBuongTrungPopup::OnNgaySetfocus(){
	
} */
/*void CIVFTDKichthichBuongTrungPopup::OnNgayKillfocus(){
	
} */
int CIVFTDKichthichBuongTrungPopup::OnNgayCheckValue(){
	return 0;
} 
