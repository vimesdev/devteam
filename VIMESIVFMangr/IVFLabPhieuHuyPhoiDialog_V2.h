#ifndef IVFLABPHIEUHUYPHOIDIALOG_H
#define IVFLABPHIEUHUYPHOIDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CIVFLabPhieuHuyPhoiDialog : public CGuiDialog{
protected:
public:
	long			m_nOrderID;
	...
	CIVFLabPhieuHuyPhoiDialog(CWnd *pParent);
	~CIVFLabPhieuHuyPhoiDialog();
