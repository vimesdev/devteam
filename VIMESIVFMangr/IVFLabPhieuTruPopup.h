#ifndef IVFLABPHIEUTRUPOPUP_H
#define IVFLABPHIEUTRUPOPUP_H
...
#include "GuiPopup.h"
#include "DbField.h"
class CIVFLabPhieuTruPopup : public CGuiPopup{
protected:
public:
	CWnd*	m_pWndOrder;
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CIVFLabPhieuTruPopup(CWnd *pParent, int nMode);
	~CIVFLabPhieuTruPopup();
