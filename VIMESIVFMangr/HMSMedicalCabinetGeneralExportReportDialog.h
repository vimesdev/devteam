#ifndef HMSMEDICALCABINETGENERALEXPORTREPORTDIALOG_H
#define HMSMEDICALCABINETGENERALEXPORTREPORTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSMedicalCabinetGeneralExportReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CHMSMedicalCabinetGeneralExportReportDialog(CWnd *pParent);
	~CHMSMedicalCabinetGeneralExportReportDialog();
	...
	int OnAddHMSMedicalCabinetGeneralExportReportDialog(); 
	int OnEditHMSMedicalCabinetGeneralExportReportDialog(); 
	int OnDeleteHMSMedicalCabinetGeneralExportReportDialog(); 
	int OnSaveHMSMedicalCabinetGeneralExportReportDialog(); 
	int OnCancelHMSMedicalCabinetGeneralExportReportDialog(); 
	int OnHMSMedicalCabinetGeneralExportReportDialogListLoadData(); 
};
#endif
