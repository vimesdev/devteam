#ifndef HMSTransferFloor_H
#define HMSTransferFloor_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSTransferFloor: public CGuiView{
protected:
public:
	...
	int OnAddHMSTransferFloor(); 
	int OnEditHMSTransferFloor(); 
	int OnDeleteHMSTransferFloor(); 
	int OnSaveHMSTransferFloor(); 
	int OnCancelHMSTransferFloor(); 
	int OnHMSTransferFloorListLoadData(); 
};
#endif
