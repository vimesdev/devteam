...
static void _OnItemNameSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSOperationScheduleAddEntryPopup* )pWnd)->OnItemNameSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnItemNameSelendokFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnItemNameSelendok();
}
/*static void _OnItemNameSetfocusFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnItemNameKillfocus();
}*/
/*static void _OnItemNameKillfocusFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnItemNameKillfocus();
}*/
static long _OnItemNameLoadDataFnc(CWnd *pWnd){
	return ((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnItemNameLoadData();
}
/*static void _OnItemNameAddNewFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnItemNameAddNew();
}*/
/*static void _OnQuantityChangeFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnQuantityChange();
} */
/*static void _OnQuantitySetfocusFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnQuantitySetfocus();} */ 
/*static void _OnQuantityKillfocusFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnQuantityKillfocus();
} */
static int _OnQuantityCheckValueFnc(CWnd *pWnd){
	return ((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnQuantityCheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSOperationScheduleAddEntryPopup *)pWnd)->OnNoteCheckValue();
} 
static void _OnSaveSelectFnc(CWnd *pWnd){
	CHMSOperationScheduleAddEntryPopup *pVw = (CHMSOperationScheduleAddEntryPopup *)pWnd;
	pVw->OnSaveSelect();
} 
...
static int _OnAddHMSOperationScheduleAddEntryPopupFnc(CWnd *pWnd){
	 return ((CHMSOperationScheduleAddEntryPopup*)pWnd)->OnAddHMSOperationScheduleAddEntryPopup();
} 
static int _OnEditHMSOperationScheduleAddEntryPopupFnc(CWnd *pWnd){
	 return ((CHMSOperationScheduleAddEntryPopup*)pWnd)->OnEditHMSOperationScheduleAddEntryPopup();
} 
static int _OnDeleteHMSOperationScheduleAddEntryPopupFnc(CWnd *pWnd){
	 return ((CHMSOperationScheduleAddEntryPopup*)pWnd)->OnDeleteHMSOperationScheduleAddEntryPopup();
} 
static int _OnSaveHMSOperationScheduleAddEntryPopupFnc(CWnd *pWnd){
	 return ((CHMSOperationScheduleAddEntryPopup*)pWnd)->OnSaveHMSOperationScheduleAddEntryPopup();
} 
static int _OnCancelHMSOperationScheduleAddEntryPopupFnc(CWnd *pWnd){
	 return ((CHMSOperationScheduleAddEntryPopup*)pWnd)->OnCancelHMSOperationScheduleAddEntryPopup();
} 
CHMSOperationScheduleAddEntryPopup::CHMSOperationScheduleAddEntryPopup()
{
	m_nDlgWidth = 555;
	m_nDlgHeight = 100;
	SetDefaultValues();
...
CHMSOperationScheduleAddEntryPopup::CHMSOperationScheduleAddEntryPopup(CWnd *pParent, int nMode): CGuiPopup(pParent)
{
	m_nDlgWidth = 555;
	m_nDlgHeight = 100;
	SetDefaultValues();
...
void CHMSOperationScheduleAddEntryPopup::OnCreateComponents()
{
...
void CHMSOperationScheduleAddEntryPopup::OnInitializeComponents()
{
...
void CHMSOperationScheduleAddEntryPopup::OnSetWindowEvents(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	...
	/*AddEvent(1, _T("Add	Ctrl+A"), _OnAddHMSOperationScheduleAddEntryPopupFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditHMSOperationScheduleAddEntryPopupFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteHMSOperationScheduleAddEntryPopupFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveHMSOperationScheduleAddEntryPopupFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelHMSOperationScheduleAddEntryPopupFnc, 0, 'T', VK_CONTROL);*/
	SetMode(VM_ADD);

}
void CHMSOperationScheduleAddEntryPopup::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndItemName.GetDlgCtrlID(), m_szItemNameKey);
	DDX_Text(pDX, m_wndQuantity.GetDlgCtrlID(), m_nQuantity);
	DDX_Text(pDX, m_wndNote.GetDlgCtrlID(), m_szNote);

}
void CHMSOperationScheduleAddEntryPopup::GetDataToScreen(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSOperationScheduleAddEntryPopup::GetScreenToData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CHMSOperationScheduleAddEntryPopup::SetDefaultValues(){
...
int CHMSOperationScheduleAddEntryPopup::SetMode(int nMode)
{
...
void CHMSOperationScheduleAddEntryPopup::OnItemNameSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CHMSOperationScheduleAddEntryPopup::OnItemNameSelendok()
{
	 UpdateData(TRUE);
...
/*void CHMSOperationScheduleAddEntryPopup::OnItemNameSetfocus(){
	
}*/
/*void CHMSOperationScheduleAddEntryPopup::OnItemNameKillfocus(){
	
}*/
long CHMSOperationScheduleAddEntryPopup::OnItemNameLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSOperationScheduleAddEntryPopup::OnItemNameAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */
/*void CHMSOperationScheduleAddEntryPopup::OnQuantityChange(){
	
} */
/*void CHMSOperationScheduleAddEntryPopup::OnQuantitySetfocus(){
	
} */
/*void CHMSOperationScheduleAddEntryPopup::OnQuantityKillfocus(){
	
} */
int CHMSOperationScheduleAddEntryPopup::OnQuantityCheckValue()
{
	UpdateData(TRUE);
...
/*void CHMSOperationScheduleAddEntryPopup::OnNoteChange(){
	
} */
/*void CHMSOperationScheduleAddEntryPopup::OnNoteSetfocus(){
	
} */
/*void CHMSOperationScheduleAddEntryPopup::OnNoteKillfocus(){
	
} */
int CHMSOperationScheduleAddEntryPopup::OnNoteCheckValue(){
	return 0;
} 
void CHMSOperationScheduleAddEntryPopup::OnSaveSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnSaveHMSOperationScheduleAddEntryPopup();
} 
void CHMSOperationScheduleAddEntryPopup::OnCloseSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	ClosePopup();
} 
int CHMSOperationScheduleAddEntryPopup::OnAddHMSOperationScheduleAddEntryPopup(){
...
int CHMSOperationScheduleAddEntryPopup::OnEditHMSOperationScheduleAddEntryPopup(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CHMSOperationScheduleAddEntryPopup::OnDeleteHMSOperationScheduleAddEntryPopup(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelHMSOperationScheduleAddEntryPopup();
 	}
	return 0;
}
int CHMSOperationScheduleAddEntryPopup::OnSaveHMSOperationScheduleAddEntryPopup()
{
...
int CHMSOperationScheduleAddEntryPopup::OnCancelHMSOperationScheduleAddEntryPopup(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CHMSOperationScheduleAddEntryPopup::OnHMSOperationScheduleAddEntryPopupListLoadData(){
	return 0;
}

void CHMSOperationScheduleAddEntryPopup::ShowPopup(CWnd *pWndRef, int nShow)
{
	CGuiPopup::ShowPopup(pWndRef, nShow);
} 
void CHMSOperationScheduleAddEntryPopup::ClosePopup()
{
