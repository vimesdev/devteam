...
static long _OnProfileListLoadDataFnc(CWnd *pWnd){
	return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnProfileListLoadData();
} 
static void _OnProfileListDblClickFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog*)pWnd)->OnProfileListDblClick();
} 
static void _OnProfileListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSTreatmentTestProfileDialog*)pWnd)->OnProfileListSelectChange(nOldItem, nNewItem);
}
static int _OnProfileListAddItemFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnProfileListAddItem();
}
static int _OnProfileListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnProfileListDeleteItem();
} 
static long _OnItemListLoadDataFnc(CWnd *pWnd){
	return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnItemListLoadData();
} 
static void _OnItemListDblClickFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog*)pWnd)->OnItemListDblClick();
} 
static void _OnItemListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSTreatmentTestProfileDialog*)pWnd)->OnItemListSelectChange(nOldItem, nNewItem);
} 
static int _OnItemListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnItemListDeleteItem();
} 
static void _OnGroupSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSTreatmentTestProfileDialog* )pWnd)->OnGroupSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnGroupSelendokFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnGroupSelendok();
}
/*static void _OnGroupSetfocusFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnGroupKillfocus();
}*/
/*static void _OnGroupKillfocusFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnGroupKillfocus();
}*/
static long _OnGroupLoadDataFnc(CWnd *pWnd){
	return ((CHMSTreatmentTestProfileDialog *)pWnd)->OnGroupLoadData();
}
/*static void _OnGroupAddNewFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnGroupAddNew();
}*/
static void _OnNameSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSTreatmentTestProfileDialog* )pWnd)->OnNameSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnNameSelendokFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnNameSelendok();
}
/*static void _OnNameSetfocusFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnNameKillfocus();
}*/
/*static void _OnNameKillfocusFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnNameKillfocus();
}*/
static long _OnNameLoadDataFnc(CWnd *pWnd){
	return ((CHMSTreatmentTestProfileDialog *)pWnd)->OnNameLoadData();
}
/*static void _OnNameAddNewFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnNameAddNew();
}*/
/*static void _OnQtyChangeFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnQtyChange();
} */
/*static void _OnQtySetfocusFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnQtySetfocus();} */ 
/*static void _OnQtyKillfocusFnc(CWnd *pWnd){
	((CHMSTreatmentTestProfileDialog *)pWnd)->OnQtyKillfocus();
} */
static int _OnQtyCheckValueFnc(CWnd *pWnd){
	return ((CHMSTreatmentTestProfileDialog *)pWnd)->OnQtyCheckValue();
} 
static void _OnAddSelectFnc(CWnd *pWnd){
	CHMSTreatmentTestProfileDialog *pVw = (CHMSTreatmentTestProfileDialog *)pWnd;
	pVw->OnAddSelect();
} 
...
static int _OnAddHMSTreatmentTestProfileDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnAddHMSTreatmentTestProfileDialog();
} 
static int _OnEditHMSTreatmentTestProfileDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnEditHMSTreatmentTestProfileDialog();
} 
static int _OnDeleteHMSTreatmentTestProfileDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnDeleteHMSTreatmentTestProfileDialog();
} 
static int _OnSaveHMSTreatmentTestProfileDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnSaveHMSTreatmentTestProfileDialog();
} 
static int _OnCancelHMSTreatmentTestProfileDialogFnc(CWnd *pWnd){
	 return ((CHMSTreatmentTestProfileDialog*)pWnd)->OnCancelHMSTreatmentTestProfileDialog();
} 
CHMSTreatmentTestProfileDialog::CHMSTreatmentTestProfileDialog(CWnd *pParent):
	CGuiDialog(pParent){
...
CHMSTreatmentTestProfileDialog::~CHMSTreatmentTestProfileDialog(){
}
void CHMSTreatmentTestProfileDialog::OnCreateComponents(){
...
void CHMSTreatmentTestProfileDialog::OnInitializeComponents(){
...
void CHMSTreatmentTestProfileDialog::OnSetWindowEvents()
{
...
void CHMSTreatmentTestProfileDialog::OnDoDataExchange(CDataExchange* pDX){
	DDX_TextEx(pDX, m_wndGroup.GetDlgCtrlID(), m_szGroupKey);
	DDX_TextEx(pDX, m_wndName.GetDlgCtrlID(), m_szNameKey);
	DDX_Text(pDX, m_wndQty.GetDlgCtrlID(), m_nQty);

}
void CHMSTreatmentTestProfileDialog::GetDataToScreen()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSTreatmentTestProfileDialog::GetScreenToData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
void CHMSTreatmentTestProfileDialog::SetDefaultValues(){
	m_szNameKey.Empty();
	m_nQty = 1;

}
int CHMSTreatmentTestProfileDialog::SetMode(int nMode){
...
void CHMSTreatmentTestProfileDialog::OnProfileListDblClick()
{	
} 
void CHMSTreatmentTestProfileDialog::OnProfileListSelectChange(int nOldItem, int nNewItem)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CHMSTreatmentTestProfileDialog::OnProfileListAddItem()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
int CHMSTreatmentTestProfileDialog::OnProfileListDeleteItem()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
long CHMSTreatmentTestProfileDialog::OnProfileListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSTreatmentTestProfileDialog::OnItemListDblClick()
{	
} 
void CHMSTreatmentTestProfileDialog::OnItemListSelectChange(int nOldItem, int nNewItem)
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CHMSTreatmentTestProfileDialog::OnItemListDeleteItem()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnDeleteHMSTreatmentTestProfileDialog();
	return 0;
} 
long CHMSTreatmentTestProfileDialog::OnItemListLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT hfl_groupid, hfl_feeid as testid,") \
				...
				_T(" 	hfl_insprice as insprice, coalesce(htp_qty, 1) as qty, TO_CHAR(hfl_applydate) as applydate ") \
...
void CHMSTreatmentTestProfileDialog::OnGroupSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CHMSTreatmentTestProfileDialog::OnGroupSelendok(){
	 
}
/*void CHMSTreatmentTestProfileDialog::OnGroupSetfocus(){
	
}*/
/*void CHMSTreatmentTestProfileDialog::OnGroupKillfocus(){
	
}*/
long CHMSTreatmentTestProfileDialog::OnGroupLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
...
/*void CHMSTreatmentTestProfileDialog::OnGroupAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

void CHMSTreatmentTestProfileDialog::OnNameSelectChange(int nOldItemSel, int nNewItemSel){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} 
void CHMSTreatmentTestProfileDialog::OnNameSelendok(){
	 
}
/*void CHMSTreatmentTestProfileDialog::OnNameSetfocus(){
	
}*/
/*void CHMSTreatmentTestProfileDialog::OnNameKillfocus(){
	
}*/
long CHMSTreatmentTestProfileDialog::OnNameLoadData()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSTreatmentTestProfileDialog::OnNameAddNew(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	
} */

/*void CHMSTreatmentTestProfileDialog::OnQtyChange(){
	
} */
/*void CHMSTreatmentTestProfileDialog::OnQtySetfocus(){
	
} */
/*void CHMSTreatmentTestProfileDialog::OnQtyKillfocus(){
	
} */
int CHMSTreatmentTestProfileDialog::OnQtyCheckValue(){
	if(m_nQty < 0 )
		return -1;
	return 0;
} 
void CHMSTreatmentTestProfileDialog::OnAddSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnAddHMSTreatmentTestProfileDialog();
} 
void CHMSTreatmentTestProfileDialog::OnDeleteSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnDeleteHMSTreatmentTestProfileDialog();
} 
void CHMSTreatmentTestProfileDialog::OnSaveSelect()
{
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnSaveHMSTreatmentTestProfileDialog();
} 
void CHMSTreatmentTestProfileDialog::OnCancelSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	OnCancelHMSTreatmentTestProfileDialog();
} 
void CHMSTreatmentTestProfileDialog::OnCloseSelect(){
	CHMSMainFrame *pMF = (CHMSMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();

} 
int CHMSTreatmentTestProfileDialog::OnAddHMSTreatmentTestProfileDialog(){
...
int CHMSTreatmentTestProfileDialog::OnEditHMSTreatmentTestProfileDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CHMSMainFrame *pMF = (CHMSMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CHMSTreatmentTestProfileDialog::OnDeleteHMSTreatmentTestProfileDialog()
{
 	/*if(GetMode() != VM_VIEW) 
	{
 		return -1;
	...
	szItemID = m_wndItemList.GetItemText(nSel, 4);
 	...
 	szSQL.Format(_T("DELETE FROM hms_testprofile WHERE htp_profileid='%s' and htp_itemid='%s' and htp_profileid in(select ss_code from sys_sel where ss_id='hms_testprofile' and ss_default='%s')  "), m_szProfileID, szItemID, pMF->GetCurrentUser() ); 
...
int CHMSTreatmentTestProfileDialog::OnSaveHMSTreatmentTestProfileDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CHMSTreatmentTestProfileDialog::OnCancelHMSTreatmentTestProfileDialog()
{
	CHMSMainFrame *pMF = (CHMSMainFrame *)AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
int CHMSTreatmentTestProfileDialog::OnHMSTreatmentTestProfileDialogListLoadData(){
	return 0;
}
