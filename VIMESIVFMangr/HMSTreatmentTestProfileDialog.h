#ifndef HMSTREATMENTTESTPROFILEDIALOG_H
#define HMSTREATMENTTESTPROFILEDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSTreatmentTestProfileDialog : public CGuiDialog{
protected:
public:
...
//void			OnQtyChange(); 
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CHMSTreatmentTestProfileDialog(CWnd *pParent);
	~CHMSTreatmentTestProfileDialog();
	...
	int OnAddHMSTreatmentTestProfileDialog(); 
	int OnEditHMSTreatmentTestProfileDialog(); 
	int OnDeleteHMSTreatmentTestProfileDialog(); 
	int OnSaveHMSTreatmentTestProfileDialog(); 
	int OnCancelHMSTreatmentTestProfileDialog(); 
	int OnHMSTreatmentTestProfileDialogListLoadData(); 
};
#endif
