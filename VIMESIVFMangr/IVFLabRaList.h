#ifndef IVFLabRaList_H
#define IVFLabRaList_H
...
class CIVFLabRaList : public CGuiView{
protected:
	long		m_nId;
public:
	...
	int OnAddIVFLabRaList(); 
	int OnEditIVFLabRaList(); 
	int OnDeleteIVFLabRaList(); 
	int OnSaveIVFLabRaList(); 
	int OnCancelIVFLabRaList(); 
	int OnIVFLabRaListListLoadData(); 
	void OnResizeLayout();
	void OnCreateCooldownOrder();
	void OnCreateWashOrder();
};
#endif
