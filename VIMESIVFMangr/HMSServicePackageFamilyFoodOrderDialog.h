#ifndef HMSSERVICEPACKAGEFAMILYFOODORDERDIALOG_H
#define HMSSERVICEPACKAGEFAMILYFOODORDERDIALOG_H
...
class CHMSServicePackageFamilyFoodOrderDialog : public CGuiDialog{
protected:
public:
	long	m_nOID;

	CArray<long, long>	m_arDocuments;
	...
	CGridListView	m_wndSelectedList;
	...
	CGuiButton		m_wndShowPatient;
	CGuiCheckBox	m_wndIsNotPatient;
	CString	m_szBreakfastKey;
	CString	m_szLunchKey;
	CString	m_szDinnerKey;
	CString	m_szOrderDate;
	BOOL	m_bIsNotPatient;
	...
	void			OnApplySelect(); 
	void			OnCloseSelect();
	void			OnIsNotPatientSelect(); 
	void			OnShowPatientSelect();
	CHMSServicePackageFamilyFoodOrderDialog(CWnd *pParent);
	~CHMSServicePackageFamilyFoodOrderDialog();
