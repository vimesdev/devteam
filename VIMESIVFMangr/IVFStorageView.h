...
class CIVFStorageView : public CGuiView{
protected:
public:
	...
	CGridListView	m_wndTTList;
	CGridListView	m_wndNoanList;
	CGridListView	m_wndPhoiList;
	...
	int OnAddIVFStorageView(); 
	int OnEditIVFStorageView(); 
	int OnDeleteIVFStorageView(); 
	int OnSaveIVFStorageView(); 
	int OnCancelIVFStorageView(); 
	int OnIVFStorageViewListLoadData(); 

	int CreateItem(CGridListView* pList, CString szDesc, int nDungcu, int nControng, int nVitrichua, int nVitritrong);
