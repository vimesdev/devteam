#ifndef IVFLabPhieuRaDialog_V2_H
#define IVFLabPhieuRaDialog_V2_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CIVFLabPhieuRaDialog_V2 : public CGuiDialog{
protected:
...
public:
	...
	long		OnListLoadData(int nVersion=1);
	...
	int			OnListEditQuality();
	CIVFLabPhieuRaDialog_V2(CWnd *pParent, long nDocumentNo, long nId, bool bAccepted=false);
	~CIVFLabPhieuRaDialog_V2();
