...
public:
	CString		m_szTable;
	//Bang chua thong tin vi tri luu tru
	CString		m_szLocationTable;
	CString		m_szCategoryTable;
	CString		m_szKeyName;
	CString		m_szPrefix;
	bool		m_bHasParent;
	...
	void			OnCancelSelect(); 
	void			OnCloseSelect(); 
	CIVFSettingThungDialog(CWnd *pParent, CString szTable, CString szParentTable=_T(""));
