#ifndef HMSDailyDrugMaterialOrderListBedDialog_H
#define HMSDailyDrugMaterialOrderListBedDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSDailyDrugMaterialOrderListBedDialog : public CGuiDialog{
protected:
public:
	long		m_nOID;
	CString		m_szOrderNo;
...
//	CString	m_szOrderNo;
	...
	CHMSDailyDrugMaterialOrderListBedDialog(CWnd *pParent);
	~CHMSDailyDrugMaterialOrderListBedDialog();
	...
	int OnAddHMSDailyDrugMaterialOrderListBedDialog(); 
	int OnEditHMSDailyDrugMaterialOrderListBedDialog(); 
	int OnDeleteHMSDailyDrugMaterialOrderListBedDialog(); 
	int OnSaveHMSDailyDrugMaterialOrderListBedDialog(); 
	int OnCancelHMSDailyDrugMaterialOrderListBedDialog(); 
	int OnHMSDailyDrugMaterialOrderListBedDialogListLoadData(); 
};
#endif
