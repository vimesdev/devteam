#ifndef HMSPatientMaterialOperationEntry_H
#define HMSPatientMaterialOperationEntry_H
...
class CHMSPatientMaterialOperationEntry : public CGuiPopup{
protected:
	bool	m_bAddOrder;	
	long	m_nPatientNo;
	long	m_nDocumentNo;
...
public:
	...
	CHMSPatientMaterialOperationEntry(CWnd *pParent, int nMode, int nType=0);
	~CHMSPatientMaterialOperationEntry();
	...
	int OnAddHMSPatientDrugMaterialOperationEntry(); 
	int OnEditHMSPatientDrugMaterialOperationEntry(); 
	int OnDeleteHMSPatientDrugMaterialOperationEntry(); 
	int OnSaveHMSPatientDrugMaterialOperationEntry(); 
	int OnCancelHMSPatientDrugMaterialOperationEntry(); 
	int OnHMSPatientDrugMaterialOperationEntryListLoadData(); 
