...
CHMSReasonDialog::CHMSReasonDialog(CWnd *pParent, CString szLabel):
	CGuiDialog(pParent){
...
void CHMSReasonDialog::OnCreateComponents(){
	CString szLabel = _T("Reason");
	if(!m_szLabel.IsEmpty())
	{
		szLabel = m_szLabel;
	}
	m_wndReasonGroup.Create(this, szLabel, 5, 5, 360, 130);
	m_wndReason.Create(this,10, 30, 355, 125, TRUE, FALSE, TRUE); 
