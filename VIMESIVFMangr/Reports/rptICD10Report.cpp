...
static int _OnAddrptICD10ReportFnc(CWnd *pWnd){
	 return ((CrptICD10Report*)pWnd)->OnAddrptICD10Report();
} 
static int _OnEditrptICD10ReportFnc(CWnd *pWnd){
	 return ((CrptICD10Report*)pWnd)->OnEditrptICD10Report();
} 
static int _OnDeleterptICD10ReportFnc(CWnd *pWnd){
	 return ((CrptICD10Report*)pWnd)->OnDeleterptICD10Report();
} 
static int _OnSaverptICD10ReportFnc(CWnd *pWnd){
	 return ((CrptICD10Report*)pWnd)->OnSaverptICD10Report();
} 
static int _OnCancelrptICD10ReportFnc(CWnd *pWnd){
	 return ((CrptICD10Report*)pWnd)->OnCancelrptICD10Report();
} 
CrptICD10Report::CrptICD10Report(CWnd *pParent):
	CGuiDialog(pParent){
...
CrptICD10Report::~CrptICD10Report()
{
	if (m_rs != NULL) delete m_rs;
}
void CrptICD10Report::OnCreateComponents()
{
...
void CrptICD10Report::OnInitializeComponents()
{
...
void CrptICD10Report::OnSetWindowEvents()
{
...
void CrptICD10Report::OnDoDataExchange(CDataExchange* pDX)
{
...
void CrptICD10Report::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CrptICD10Report::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();

}
void CrptICD10Report::SetDefaultValues(){
...
int CrptICD10Report::SetMode(int nMode){
...
void CrptICD10Report::OnReportPeriodSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnReportPeriodSelendok()
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString tmpStr;
	CDate dte, date;
...
/*void CrptICD10Report::OnReportPeriodSetfocus(){
	
}*/
/*void CrptICD10Report::OnReportPeriodKillfocus(){
	
}*/
long CrptICD10Report::OnReportPeriodLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CrptICD10Report::OnReportPeriodAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CrptICD10Report::OnFromDateChange(){
	
} */
/*void CrptICD10Report::OnFromDateSetfocus(){
	
} */
/*void CrptICD10Report::OnFromDateKillfocus(){
	
} */
int CrptICD10Report::OnFromDateCheckValue(){
	return 0;
} 
/*void CrptICD10Report::OnToDateChange(){
	
} */
/*void CrptICD10Report::OnToDateSetfocus(){
	
} */
/*void CrptICD10Report::OnToDateKillfocus(){
	
} */
int CrptICD10Report::OnToDateCheckValue(){
	return 0;
} 
/*void CrptICD10Report::OnAgeChange(){
	
} */
/*void CrptICD10Report::OnAgeSetfocus(){
	
} */
/*void CrptICD10Report::OnAgeKillfocus(){
	
} */
int CrptICD10Report::OnAgeCheckValue(){
	return 0;
} 
/*void CrptICD10Report::OnAge1Change(){
	
} */
/*void CrptICD10Report::OnAge1Setfocus(){
	
} */
/*void CrptICD10Report::OnAge1Killfocus(){
	
} */
int CrptICD10Report::OnAge1CheckValue(){
	return 0;
} 
void CrptICD10Report::OnOccupationSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnOccupationSelendok(){
	 
}
/*void CrptICD10Report::OnOccupationSetfocus(){
	
}*/
/*void CrptICD10Report::OnOccupationKillfocus(){
	
}*/
long CrptICD10Report::OnOccupationLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CrptICD10Report::OnOccupationAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnEthnicSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnEthnicSelendok(){
	 
}
/*void CrptICD10Report::OnEthnicSetfocus(){
	
}*/
/*void CrptICD10Report::OnEthnicKillfocus(){
	
}*/
long CrptICD10Report::OnEthnicLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CrptICD10Report::OnEthnicAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnProvinceSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnProvinceSelendok(){
	 
}
/*void CrptICD10Report::OnProvinceSetfocus(){
	
}*/
/*void CrptICD10Report::OnProvinceKillfocus(){
	
}*/
long CrptICD10Report::OnProvinceLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CrptICD10Report::OnProvinceAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnDistrictSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnDistrictSelendok(){
	 
}
/*void CrptICD10Report::OnDistrictSetfocus(){
	
}*/
/*void CrptICD10Report::OnDistrictKillfocus(){
	
}*/
long CrptICD10Report::OnDistrictLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CrptICD10Report::OnDistrictAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnVillSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnVillSelendok(){
	 
}
/*void CrptICD10Report::OnVillSetfocus(){
	
}*/
/*void CrptICD10Report::OnVillKillfocus(){
	
}*/
long CrptICD10Report::OnVillLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CrptICD10Report::OnVillAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnChapterSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnChapterSelendok(){
	 
}
/*void CrptICD10Report::OnChapterSetfocus(){
	
}*/
/*void CrptICD10Report::OnChapterKillfocus(){
	
}*/
long CrptICD10Report::OnChapterLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CrptICD10Report::OnChapterAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnGroupsSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnGroupsSelendok(){
	 
}
/*void CrptICD10Report::OnGroupsSetfocus(){
	
}*/
/*void CrptICD10Report::OnGroupsKillfocus(){
	
}*/
long CrptICD10Report::OnGroupsLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CrptICD10Report::OnGroupsAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnICDSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CrptICD10Report::OnICDSelendok(){
	 
}
/*void CrptICD10Report::OnICDSetfocus(){
	
}*/
/*void CrptICD10Report::OnICDKillfocus(){
	
}*/
long CrptICD10Report::OnICDLoadData()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CrptICD10Report::OnICDAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CrptICD10Report::OnPrintSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CReport rpt; 
	...
	szSQL.Format(_T(" SELECT Docno, patientname, hp_ethnic, ethnic, agemale, agefemale, address, ") \
		...
		_T(" WHERE status = 'T' AND date(admitdate) BETWEEN date('%s') and date('%s') %s ") \
...
void CrptICD10Report::OnExportSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CrptICD10Report::OnLoadSelect()
{
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancel();
} 
int CrptICD10Report::OnAddrptICD10Report(){
...
int CrptICD10Report::OnEditrptICD10Report(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd(); 
 	SetMode(VM_EDIT);
...
int CrptICD10Report::OnDeleterptICD10Report(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
...
int CrptICD10Report::OnSaverptICD10Report(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
 	if(!IsValidateData()) 
 		return -1; 
...
int CrptICD10Report::OnCancelrptICD10Report(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CrptICD10Report::OnrptICD10ReportListLoadData(){
	return 0;
}
