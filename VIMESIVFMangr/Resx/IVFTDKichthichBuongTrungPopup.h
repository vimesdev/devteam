...
#include "GuiDialog.h"
#include "DbField.h"
class CIVFTDKichthichBuongTrungPopup : public CGuiDialog{
protected:
public:
	CGuiLabel		m_wndNgayCKLabel;
	CGuiDateCtrl	m_wndNgayCK;
	CGuiLabel		m_wndNgayLabel;
	CGuiDateCtrl	m_wndNgày;
	...
	//void			OnNgàyChange(); 
	//void			OnNgàySetfocus(); 
	//void			OnNgàyKillfocus(); 
	int			OnNgàyCheckValue(); 
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CIVFTDKichthichBuongTrungPopup(CWnd *pParent);
