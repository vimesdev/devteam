...
static void _OnTypeSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CHMSOperationOrder* )pWnd)->OnTypeSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnTypeSelendokFnc(CWnd *pWnd){
	((CHMSOperationOrder *)pWnd)->OnTypeSelendok();
}
/*static void _OnTypeSetfocusFnc(CWnd *pWnd){
	((CHMSOperationOrder *)pWnd)->OnTypeKillfocus();
}*/
/*static void _OnTypeKillfocusFnc(CWnd *pWnd){
	((CHMSOperationOrder *)pWnd)->OnTypeKillfocus();
}*/
static long _OnTypeLoadDataFnc(CWnd *pWnd){
	return ((CHMSOperationOrder *)pWnd)->OnTypeLoadData();
}
/*static void _OnTypeAddNewFnc(CWnd *pWnd){
	((CHMSOperationOrder *)pWnd)->OnTypeAddNew();
}*/
...
void CHMSOperationOrder::OnCreateComponents(){
	m_wndOperationInformation.Create(this, _T("Operation Information"), 5, 5, 595, 550);
	m_wndOrderList.Create(this,10, 29, 590, 139); 
	m_wndGroupLabel.Create(this, _T("Group"), 10, 144, 130, 169);
	m_wndGroup.Create(this,135, 144, 335, 169); 
	m_wndOrderDateLabel.Create(this, _T("Order Date"), 340, 144, 445, 169);
	m_wndOrderDate.Create(this,450, 144, 590, 169); 
	m_wndNameLabel.Create(this, _T("Name"), 10, 174, 130, 199);
	m_wndName.Create(this,135, 174, 590, 199); 
	m_wndPerformDeptLabel.Create(this, _T("Perform Dept"), 10, 204, 130, 229);
	m_wndPerformDept.Create(this,135, 204, 275, 229); 
	m_wndQuantityLabel.Create(this, _T("Quantity"), 280, 204, 340, 229);
	m_wndQuantity.Create(this,345, 204, 375, 229); 
	m_wndInsensibleMethodLabel.Create(this, _T("Insensible Method"), 10, 234, 130, 284);
	m_wndInsensibleMethod.Create(this,135, 234, 591, 284); 
	m_wndAfterOperationLabel.Create(this, _T("After Operation"), 10, 344, 130, 369);
	m_wndBeforeOperation.Create(this,134, 289, 590, 339); 
	m_wndBeforeOperationLabel.Create(this, _T("Before Operation"), 9, 289, 129, 314);
	m_wndAfterOperation.Create(this,135, 344, 591, 394); 
	m_wndPractitionerLabel.Create(this, _T("Practitioner"), 10, 399, 130, 424);
	m_wndPractitioner.Create(this,135, 399, 335, 424); 
	m_wndPerformDateLabel.Create(this, _T("Perform Date"), 340, 399, 445, 424);
	m_wndPerformDate.Create(this,450, 399, 590, 424); 
	m_wndAnesthetistLabel.Create(this, _T("Anesthetist"), 10, 429, 130, 454);
	m_wndAnesthetist.Create(this,135, 429, 335, 454); 
	m_wndAssistantLabel.Create(this, _T("Assistant"), 340, 429, 445, 454);
	m_wndAssistant.Create(this,450, 429, 590, 454); 
	m_wndUser4Label.Create(this, _T("User4"), 10, 459, 130, 484);
	m_wndUser4.Create(this,135, 459, 335, 484); 
	m_wndUser5Label.Create(this, _T("User5"), 340, 459, 445, 484);
	m_wndUser5.Create(this,450, 459, 590, 484); 
	m_wndUser6Label.Create(this, _T("User6"), 10, 489, 130, 514);
	m_wndUser6.Create(this,135, 489, 335, 514); 
	m_wndUser7Label.Create(this, _T("User7"), 340, 489, 445, 514);
	m_wndUser7.Create(this,450, 489, 590, 514); 
	m_wndNoteLabel.Create(this, _T("Note"), 11, 519, 131, 544);
	m_wndNote.Create(this,136, 519, 592, 544); 
	m_wndAdd.Create(this, _T("&Add"), 22, 557, 97, 582);
	m_wndEdit.Create(this, _T("&Edit"), 101, 555, 176, 580);
	m_wndDelete.Create(this, _T("&Delete"), 181, 555, 261, 580);
	m_wndSave.Create(this, _T("&Save"), 266, 555, 346, 580);
	m_wndCancel.Create(this, _T("&Cancel"), 351, 555, 431, 580);
	m_wndConfirm.Create(this, _T("&Confirm"), 436, 555, 511, 580);
	m_wndPrint.Create(this, _T("&Print"), 516, 555, 596, 580);
	m_wndTypeLabel.Create(this, _T("Type"), 380, 204, 460, 229);
	m_wndType.Create(this,465, 204, 590, 229); 
...
void CHMSOperationOrder::OnInitializeComponents(){
	...
	m_wndUser4.InsertColumn(1, _T("Description"), CFMT_TEXT, 150);


	m_wndUser5.InsertColumn(0, _T("ID"), CFMT_NUMBER, 50);
	m_wndUser5.InsertColumn(1, _T("Description"), CFMT_TEXT, 150);


	m_wndUser6.InsertColumn(0, _T("ID"), CFMT_NUMBER, 50);
	m_wndUser6.InsertColumn(1, _T("Description"), CFMT_TEXT, 150);


	m_wndUser7.InsertColumn(0, _T("ID"), CFMT_NUMBER, 50);
	m_wndUser7.InsertColumn(1, _T("Description"), CFMT_TEXT, 150);
...
void CHMSOperationOrder::OnUser4SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSOperationOrder::OnUser4Selendok(){
	 
}
/*void CHMSOperationOrder::OnUser4Setfocus(){
	
}*/
/*void CHMSOperationOrder::OnUser4Killfocus(){
	
}*/
long CHMSOperationOrder::OnUser4LoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSOperationOrder::OnUser4AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSOperationOrder::OnUser5SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSOperationOrder::OnUser5Selendok(){
	 
}
/*void CHMSOperationOrder::OnUser5Setfocus(){
	
}*/
/*void CHMSOperationOrder::OnUser5Killfocus(){
	
}*/
long CHMSOperationOrder::OnUser5LoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSOperationOrder::OnUser5AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSOperationOrder::OnUser6SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSOperationOrder::OnUser6Selendok(){
	 
}
/*void CHMSOperationOrder::OnUser6Setfocus(){
	
}*/
/*void CHMSOperationOrder::OnUser6Killfocus(){
	
}*/
long CHMSOperationOrder::OnUser6LoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSOperationOrder::OnUser6AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CHMSOperationOrder::OnUser7SelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSOperationOrder::OnUser7Selendok(){
	 
}
/*void CHMSOperationOrder::OnUser7Setfocus(){
	
}*/
/*void CHMSOperationOrder::OnUser7Killfocus(){
	
}*/
long CHMSOperationOrder::OnUser7LoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSOperationOrder::OnUser7AddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSOperationOrder::OnTypeSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CHMSOperationOrder::OnTypeSelendok(){
	 
}
/*void CHMSOperationOrder::OnTypeSetfocus(){
	
}*/
/*void CHMSOperationOrder::OnTypeKillfocus(){
	
}*/
long CHMSOperationOrder::OnTypeLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CHMSOperationOrder::OnTypeAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
