...
void CHMSPatientCareDlg::OnSetWindowEvents(){
	...
	AddEvent(1, _T("Add	Ctrl+A"), _OnAddHMSPatientCareDlgFnc, 0, 'A', VK_CONTROL);
	AddEvent(2, _T("Edit	Ctrl+E"), _OnEditHMSPatientCareDlgFnc, 0, 'E', VK_CONTROL);
	AddEvent(3, _T("Delete	Ctrl+D"), _OnDeleteHMSPatientCareDlgFnc, 0, 'D', VK_CONTROL);
	AddEvent(4, _T("Save	Ctrl+S"), _OnSaveHMSPatientCareDlgFnc, 0, 'S', VK_CONTROL);
	AddEvent(0, _T("-"));
	AddEvent(5, _T("Cancel	Ctrl+T"), _OnCancelHMSPatientCareDlgFnc, 0, 'T', VK_CONTROL);
