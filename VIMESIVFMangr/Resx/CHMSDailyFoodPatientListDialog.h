#ifndef CHMSDAILYFOODPATIENTLISTDIALOG_H
#define CHMSDAILYFOODPATIENTLISTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CCHMSDailyFoodPatientListDialog : public CGuiDialog{
protected:
public:
	...
	void			OnApplySelect(); 
	void			OnCloseSelect(); 
	CCHMSDailyFoodPatientListDialog(CWnd *pParent);
	~CCHMSDailyFoodPatientListDialog();
	...
	int OnAddCHMSDailyFoodPatientListDialog(); 
	int OnEditCHMSDailyFoodPatientListDialog(); 
	int OnDeleteCHMSDailyFoodPatientListDialog(); 
	int OnSaveCHMSDailyFoodPatientListDialog(); 
	int OnCancelCHMSDailyFoodPatientListDialog(); 
	int OnCHMSDailyFoodPatientListDialogListLoadData(); 
};
#endif
