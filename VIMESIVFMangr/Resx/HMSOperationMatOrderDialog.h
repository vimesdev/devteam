#ifndef HMSOPERATIONMATORDERDIALOG_H
#define HMSOPERATIONMATORDERDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSOperationMatOrderDialog : public CGuiDialog{
protected:
public:
	...
	void			OnSaveSelect(); 
	void			OnCloseSelect(); 
	CHMSOperationMatOrderDialog(CWnd *pParent);
	~CHMSOperationMatOrderDialog();
	...
	int OnAddHMSOperationMatOrderDialog(); 
	int OnEditHMSOperationMatOrderDialog(); 
	int OnDeleteHMSOperationMatOrderDialog(); 
	int OnSaveHMSOperationMatOrderDialog(); 
	int OnCancelHMSOperationMatOrderDialog(); 
	int OnHMSOperationMatOrderDialogListLoadData(); 
};
#endif
