...
static int _OnAddIVFPhieuRaDialogFnc(CWnd *pWnd){
	 return ((CIVFPhieuRaDialog*)pWnd)->OnAddIVFPhieuRaDialog();
} 
static int _OnEditIVFPhieuRaDialogFnc(CWnd *pWnd){
	 return ((CIVFPhieuRaDialog*)pWnd)->OnEditIVFPhieuRaDialog();
} 
static int _OnDeleteIVFPhieuRaDialogFnc(CWnd *pWnd){
	 return ((CIVFPhieuRaDialog*)pWnd)->OnDeleteIVFPhieuRaDialog();
} 
static int _OnSaveIVFPhieuRaDialogFnc(CWnd *pWnd){
	 return ((CIVFPhieuRaDialog*)pWnd)->OnSaveIVFPhieuRaDialog();
} 
static int _OnCancelIVFPhieuRaDialogFnc(CWnd *pWnd){
	 return ((CIVFPhieuRaDialog*)pWnd)->OnCancelIVFPhieuRaDialog();
} 
CIVFPhieuRaDialog::CIVFPhieuRaDialog(CWnd *pParent):
	CGuiDialog(pParent){
...
CIVFPhieuRaDialog::~CIVFPhieuRaDialog(){
}
void CIVFPhieuRaDialog::OnCreateComponents(){
	m_wndIdLabel.Create(this, _T("id"), 5, 4, 125, 29);
	m_wndId.Create(this,130, 4, 280, 29); 
	m_wndSophieuLabel.Create(this, _T("so_phieu"), 286, 5, 406, 30);
	m_wndSophieu.Create(this,411, 5, 531, 30); 
...
void CIVFPhieuRaDialog::OnInitializeComponents(){
...
void CIVFPhieuRaDialog::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CIVFPhieuRaDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CIVFPhieuRaDialog::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CIVFPhieuRaDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CIVFPhieuRaDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	m_ivf_phieuraTbl.SetValue(_T("ID_MAPHIEU"), m_nId);
	m_ivf_phieuraTbl.SetValue(_T("SO_PHIEU"), m_szSophieu);
	...
	m_ivf_phieuraTbl.SetValue(_T("TOP"), m_nTop);
...
void CIVFPhieuRaDialog::SetDefaultValues(){
...
int CIVFPhieuRaDialog::SetMode(int nMode){
...
/*void CIVFPhieuRaDialog::OnIdChange(){
	
} */
/*void CIVFPhieuRaDialog::OnIdSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnIdKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnIdCheckValue(){
	return 0;
} 
/*void CIVFPhieuRaDialog::OnSophieuChange(){
	
} */
/*void CIVFPhieuRaDialog::OnSophieuSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnSophieuKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnSophieuCheckValue(){
	return 0;
} 
/*void CIVFPhieuRaDialog::OnSohosoChange(){
	
} */
/*void CIVFPhieuRaDialog::OnSohosoSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnSohosoKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnSohosoCheckValue(){
	return 0;
} 
/*void CIVFPhieuRaDialog::OnMabenhnhanChange(){
	
} */
/*void CIVFPhieuRaDialog::OnMabenhnhanSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnMabenhnhanKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnMabenhnhanCheckValue(){
	return 0;
} 
/*void CIVFPhieuRaDialog::OnHovatenChange(){
	
} */
/*void CIVFPhieuRaDialog::OnHovatenSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnHovatenKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnHovatenCheckValue(){
	return 0;
} 
/*void CIVFPhieuRaDialog::OnNgaysinhChange(){
	
} */
/*void CIVFPhieuRaDialog::OnNgaysinhSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnNgaysinhKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnNgaysinhCheckValue(){
	return 0;
} 
void CIVFPhieuRaDialog::OnThungSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnThungSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnThungSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnThungKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnThungLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
...
/*void CIVFPhieuRaDialog::OnThungAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CIVFPhieuRaDialog::OnGiaSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnGiaSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnGiaSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnGiaKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnGiaLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CIVFPhieuRaDialog::OnGiaAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CIVFPhieuRaDialog::OnCassetteSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnCassetteSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnCassetteSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnCassetteKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnCassetteLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CIVFPhieuRaDialog::OnCassetteAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CIVFPhieuRaDialog::OnTopChange(){
	
} */
/*void CIVFPhieuRaDialog::OnTopSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnTopKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnTopCheckValue(){
	return 0;
} 
void CIVFPhieuRaDialog::OnNguoithuchienSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnNguoithuchienSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnNguoithuchienSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnNguoithuchienKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnNguoithuchienLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CIVFPhieuRaDialog::OnNguoithuchienAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CIVFPhieuRaDialog::OnTgthuchienChange(){
	
} */
/*void CIVFPhieuRaDialog::OnTgthuchienSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnTgthuchienKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnTgthuchienCheckValue(){
	return 0;
} 
void CIVFPhieuRaDialog::OnNguoichecklistSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnNguoichecklistSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnNguoichecklistSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnNguoichecklistKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnNguoichecklistLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CIVFPhieuRaDialog::OnNguoichecklistAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CIVFPhieuRaDialog::OnTgchecklistChange(){
	
} */
/*void CIVFPhieuRaDialog::OnTgchecklistSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnTgchecklistKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnTgchecklistCheckValue(){
	return 0;
} 
void CIVFPhieuRaDialog::OnMoitruongraSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnMoitruongraSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnMoitruongraSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnMoitruongraKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnMoitruongraLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CIVFPhieuRaDialog::OnMoitruongraAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CIVFPhieuRaDialog::OnPhuongphapraSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnPhuongphapraSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnPhuongphapraSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnPhuongphapraKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnPhuongphapraLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CIVFPhieuRaDialog::OnPhuongphapraAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
void CIVFPhieuRaDialog::OnChatluongphoiSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnChatluongphoiSelendok(){
	 
}
/*void CIVFPhieuRaDialog::OnChatluongphoiSetfocus(){
	
}*/
/*void CIVFPhieuRaDialog::OnChatluongphoiKillfocus(){
	
}*/
long CIVFPhieuRaDialog::OnChatluongphoiLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
/*
	CRecord rs(&pMF->m_db);
	CString szSQL, szWhere;
...
/*void CIVFPhieuRaDialog::OnChatluongphoiAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
	void CIVFPhieuRaDialog::OnAHSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
/*void CIVFPhieuRaDialog::OnGhichuChange(){
	
} */
/*void CIVFPhieuRaDialog::OnGhichuSetfocus(){
	
} */
/*void CIVFPhieuRaDialog::OnGhichuKillfocus(){
	
} */
int CIVFPhieuRaDialog::OnGhichuCheckValue(){
	return 0;
} 
void CIVFPhieuRaDialog::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFPhieuRaDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
int CIVFPhieuRaDialog::OnAddIVFPhieuRaDialog(){
...
int CIVFPhieuRaDialog::OnEditIVFPhieuRaDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CIVFPhieuRaDialog::OnDeleteIVFPhieuRaDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
 	...
 	if(ret >= 0){
 		SetMode(VM_NONE);
 		OnCancelIVFPhieuRaDialog();
 	}
	return 0;
}
int CIVFPhieuRaDialog::OnSaveIVFPhieuRaDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
 ...
 _fmsg(_T("%s"), szSQL);
 	...
 	if(ret > 0)
 	{
 		//OnIVFPhieuRaDialogListLoadData();
 		SetMode(VM_VIEW);
 	}
 	else
 	{
...
int CIVFPhieuRaDialog::OnCancelIVFPhieuRaDialog(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CIVFPhieuRaDialog::OnIVFPhieuRaDialogListLoadData(){
	return 0;
}
