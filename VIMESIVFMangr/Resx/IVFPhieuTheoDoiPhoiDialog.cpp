...
void CIVFPhieuTheoDoiPhoiDialog::OnCreateComponents(){
	m_wndXinTrung.Create(this, _T("Xin trung"), 4, 6, 84, 31);
	m_wndKyThuat.Create(this, _T("Ky thuat"), 89, 6, 169, 31);
	...
	m_wndNgayChocHutLabel.Create(this, _T("Ngay choc hut"), 612, 6, 692, 31);
	m_wndNgayChocHut.Create(this,697, 6, 787, 31); 
	m_wndTinhTrung.Create(this, _T("Tinh trung"), 4, 36, 84, 61);
	m_wndTuoi.Create(this, _T("Tuoi"), 89, 36, 169, 61);
	m_wndTru.Create(this, _T("Tru"), 174, 36, 254, 61);
	m_wndPESA.Create(this, _T("PESA"), 259, 36, 351, 61);
	m_wndTESE.Create(this, _T("TESE"), 356, 36, 448, 61);
	m_wndBSChocHutLabel.Create(this, _T("BS choc hut"), 612, 36, 692, 61);
	...
	m_wnd10^6ml.Create(this, _T("10^6ml"), 308, 66, 351, 91);
	...
	m_wndGioHCGLabel.Create(this, _T("Gio hCG"), 602, 66, 682, 91);
	m_wndGioHCG.Create(this,687, 66, 757, 91); 
	m_wndGioChocHutLabel.Create(this, _T("Gio choc hut"), 762, 66, 842, 91);
	m_wndGioChocHut.Create(this,847, 66, 917, 91); 
	m_wndList.Create(this,5, 96, 959, 361); 
	m_wndDanhgiachatluongtrungLabel.Create(this, _T("Danhgiachatluongtrung"), 5, 366, 165, 391);
	m_wndDanhgiachatluongtrung.Create(this,170, 366, 450, 391); 
	m_wndNhanXetLabel.Create(this, _T("Nhan xet"), 455, 366, 535, 391);
	m_wndNhanXet.Create(this,540, 366, 960, 391); 
	m_wndDanhgiachatluongtinhtrungLabel.Create(this, _T("Danhgiachatluongtinhtrung"), 5, 396, 165, 421);
	m_wndDanhgiachatluongtinhtrung.Create(this,170, 396, 450, 421); 
	m_wndTongSoTrungLabel.Create(this, _T("Tong so trung"), 455, 396, 535, 421);
	m_wndTongSoTrung.Create(this,540, 396, 620, 421); 
	m_wndSoTrungICSILabel.Create(this, _T("So trung ICSI"), 625, 396, 705, 421);
	m_wndSoTrungICSI.Create(this,710, 396, 790, 421); 
	m_wndThuTinhLabel.Create(this, _T("Thu tinh"), 795, 396, 875, 421);
	m_wndThuTinh.Create(this,880, 396, 960, 421); 
	m_wndDanhGiaChatLuongPhoiLabel.Create(this, _T("Danh gia chat luong phoi"), 5, 426, 165, 451);
	m_wndDanhGiaChatLuongPhoi.Create(this,170, 426, 450, 451); 
	m_wndTongSoPhoiLabel.Create(this, _T("Tong so phoi"), 455, 426, 535, 451);
	m_wndTongSoPhoi.Create(this,540, 426, 620, 451); 
	m_wndSoPhoiChuyenLabel.Create(this, _T("So phoi chuyen"), 625, 426, 705, 451);
	m_wndSoPhoiChuyen.Create(this,710, 426, 790, 451); 
	m_wndSoPhoiTruLabel.Create(this, _T("So phoi tru"), 795, 426, 875, 451);
	m_wndSoPhoiTru.Create(this,880, 426, 960, 451); 
	m_wndLanLabel.Create(this, _T("Lan"), 5, 456, 165, 481);
	m_wndLan.Create(this,170, 456, 251, 481); 
	m_wndChuyenPhoiLabel.Create(this, _T("Chuyen phoi"), 455, 456, 535, 481);
	m_wndDe.Create(this, _T("De"), 540, 456, 620, 481);
	m_wndChuyenPhoi_Kho.Create(this, _T("Kho"), 625, 456, 705, 481);
	...
	m_wndSotPhoiLabel.Create(this, _T("Sot phoi"), 455, 486, 535, 511);
	m_wndSotPhoi.Create(this,540, 486, 620, 511); 
	m_wndChuyenLan.Create(this, _T("chuyen lan 2"), 625, 486, 705, 511);
	m_wndSach.Create(this, _T("Sach"), 710, 486, 790, 511);
	m_wndNhay.Create(this, _T("Nhay"), 795, 486, 875, 511);
	m_wndMau.Create(this, _T("Mau"), 880, 486, 960, 511);
	m_wndPARALabel.Create(this, _T("PARA"), 5, 516, 165, 541);
	m_wndPARA.Create(this,170, 516, 251, 541); 
	m_wndGioAHLabel.Create(this, _T("Gio AH"), 455, 516, 535, 541);
	m_wndGioAH.Create(this,540, 516, 620, 541); 
	m_wndNguoiAHLabel.Create(this, _T("Nguoi AH"), 625, 516, 705, 541);
	m_wndNguoiAH.Create(this,710, 516, 790, 541); 
	m_wndChiDinhLabel.Create(this, _T("Chi dinh"), 5, 546, 165, 571);
	m_wndChiDinh.Create(this,170, 546, 251, 571); 
	m_wndGioCPLabel.Create(this, _T("Gio CP"), 455, 546, 535, 571);
	m_wndGioCP.Create(this,540, 546, 620, 571); 
	m_wndNguoiLoadLabel.Create(this, _T("Nguoi Load"), 625, 546, 705, 571);
	m_wndNguoiLoad.Create(this,710, 546, 790, 571); 
	m_wndBacsiCPLabel.Create(this, _T("BacsiCP"), 795, 546, 875, 571);
...
void CIVFPhieuTheoDoiPhoiDialog::OnInitializeComponents(){
	...
	m_wndList.InsertColumn(1, _T("Ngay 0"), CFMT_TEXT, 100);
	m_wndList.InsertColumn(2, _T("Ngay 1"), CFMT_TEXT, 150);
	m_wndList.InsertColumn(3, _T("Ngay 2"), CFMT_TEXT, 150);
	m_wndList.InsertColumn(4, _T("Ngay 3"), CFMT_TEXT, 150);
	m_wndList.InsertColumn(5, _T("Ngay 4"), CFMT_TEXT, 150);
	m_wndList.InsertColumn(6, _T("Ngay 5"), CFMT_TEXT, 150);
	m_wndList.InsertColumn(7, _T("Ngay 6"), CFMT_TEXT, 150);
