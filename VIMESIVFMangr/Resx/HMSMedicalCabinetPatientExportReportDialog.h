#ifndef HMSMEDICALCABINETPATIENTEXPORTREPORTDIALOG_H
#define HMSMEDICALCABINETPATIENTEXPORTREPORTDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CHMSMedicalCabinetPatientExportReportDialog : public CGuiDialog{
protected:
public:
	...
	void			OnExportSelect(); 
	void			OnCloseSelect(); 
	CHMSMedicalCabinetPatientExportReportDialog(CWnd *pParent);
	~CHMSMedicalCabinetPatientExportReportDialog();
	...
	int OnAddHMSMedicalCabinetPatientExportReportDialog(); 
	int OnEditHMSMedicalCabinetPatientExportReportDialog(); 
	int OnDeleteHMSMedicalCabinetPatientExportReportDialog(); 
	int OnSaveHMSMedicalCabinetPatientExportReportDialog(); 
	int OnCancelHMSMedicalCabinetPatientExportReportDialog(); 
	int OnHMSMedicalCabinetPatientExportReportDialogListLoadData(); 
};
#endif
