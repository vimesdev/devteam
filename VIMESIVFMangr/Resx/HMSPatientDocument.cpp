...
static void _OnTabSelectChangeFnc(CWnd *pWnd, int nOld, int nNew){
	((CHMSPatientDocument*)pWnd)->OnTabSelectChange(nOld, nNew);
} 
...
static void _OnTheodoidieutriSelectFnc(CWnd *pWnd){
	CHMSPatientDocument *pVw = (CHMSPatientDocument *)pWnd;
	pVw->OnTheodoidieutriSelect();
} 
...
void CHMSPatientDocument::OnCreateComponents(){
	...
	m_wndTab.Create(this,0, 0, 25, 25); 
	m_wndDetailAddress.Create(this,0, 0, 25, 25); 
	m_wndDetailAddrlLabel.Create(this, _T(""), 0, 0, 25, 25);
	...
	m_wndMainDiseaseDiagnosticLabel.Create(this, _T("CÐ"), 0, 10, 385, 110);
	...
	m_wndAntibioticUse.Create(this, _T("HDSD Kháng sinh"), 5, 385, 113, 410);
	m_wndMainDiseaseDiagnostic.Create(this,115, 385, 375, 435); 
	m_wndRelationDiseaseLabel.Create(this, _T("B?nh kèm theo"), 10, 440, 110, 465);
	...
	m_wndClinicalRecord.Create(this, _T("B?nh án"), 385, 605, 470, 635);
	m_wndElectronicRecord.Create(this, _T("M?u bi?u chuyên môn"), 472, 605, 607, 635);
	m_wndTheodoidieutri.Create(this, _T("Theo dõi di?u tr?"), 609, 605, 719, 635);
	m_wndTreatmentTracking.Create(this, _T("B?nh trình di?u tr?"), 721, 605, 831, 635);
	m_wndPatientCare.Create(this, _T("Phi?u cham sóc"), 833, 605, 943, 635);
	m_wndExtButton.Create(this, _T("Gói d?ch v?"), 944, 605, 1024, 635);
...
void CHMSPatientDocument::OnSetWindowEvents(){
	...
	m_wndTheodoidieutri.SetEvent(WE_CLICK, _OnTheodoidieutriSelectFnc);
...
void CHMSPatientDocument::OnTabSelectChange(int nOld, int nNew){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CHMSPatientDocument::OnTheodoidieutriSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
