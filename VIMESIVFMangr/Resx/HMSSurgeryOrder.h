#ifndef HMSSURGERYORDER_H
#define HMSSURGERYORDER_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSSurgeryOrder : public CGuiView{
protected:
public:
	...
	int OnAddHMSSurgeryOrder(); 
	int OnEditHMSSurgeryOrder(); 
	int OnDeleteHMSSurgeryOrder(); 
	int OnSaveHMSSurgeryOrder(); 
	int OnCancelHMSSurgeryOrder(); 
	int OnHMSSurgeryOrderListLoadData(); 
};
#endif
