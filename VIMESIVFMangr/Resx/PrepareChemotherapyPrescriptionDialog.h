#ifndef PREPARECHEMOTHERAPYPRESCRIPTIONDIALOG_H
#define PREPARECHEMOTHERAPYPRESCRIPTIONDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CPrepareChemotherapyPrescriptionDialog : public CGuiDialog{
protected:
public:
	...
	void			OnCloseSelect(); 
	void			OnSendSelect(); 
	CPrepareChemotherapyPrescriptionDialog(CWnd *pParent);
	~CPrepareChemotherapyPrescriptionDialog();
	...
	int OnAddPrepareChemotherapyPrescriptionDialog(); 
	int OnEditPrepareChemotherapyPrescriptionDialog(); 
	int OnDeletePrepareChemotherapyPrescriptionDialog(); 
	int OnSavePrepareChemotherapyPrescriptionDialog(); 
	int OnCancelPrepareChemotherapyPrescriptionDialog(); 
	int OnPrepareChemotherapyPrescriptionDialogListLoadData(); 
};
#endif
