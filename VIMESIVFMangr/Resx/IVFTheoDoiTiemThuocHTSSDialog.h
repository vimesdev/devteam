#ifndef IVFTHEODOITIEMTHUOCHTSSDIALOG_H
#define IVFTHEODOITIEMTHUOCHTSSDIALOG_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CIVFTheoDoiTiemThuocHTSSDialog : public CGuiDialog{
protected:
public:
	...
	CIVFTheoDoiTiemThuocHTSSDialog(CWnd *pParent);
	~CIVFTheoDoiTiemThuocHTSSDialog();
	...
	int OnAddIVFTheoDoiTiemThuocHTSSDialog(); 
	int OnEditIVFTheoDoiTiemThuocHTSSDialog(); 
	int OnDeleteIVFTheoDoiTiemThuocHTSSDialog(); 
	int OnSaveIVFTheoDoiTiemThuocHTSSDialog(); 
	int OnCancelIVFTheoDoiTiemThuocHTSSDialog(); 
	int OnIVFTheoDoiTiemThuocHTSSDialogListLoadData(); 
};
#endif
