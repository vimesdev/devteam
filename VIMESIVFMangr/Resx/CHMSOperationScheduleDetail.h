#ifndef CHMSOPERATIONSCHEDULEDETAIL_H
#define CHMSOPERATIONSCHEDULEDETAIL_H
...
#include "GuiView.h"
#include "DbField.h"
class CCHMSOperationScheduleDetail : public CGuiView{
protected:
public:
	...
	int OnAddCHMSOperationScheduleDetail(); 
	int OnEditCHMSOperationScheduleDetail(); 
	int OnDeleteCHMSOperationScheduleDetail(); 
	int OnSaveCHMSOperationScheduleDetail(); 
	int OnCancelCHMSOperationScheduleDetail(); 
	int OnCHMSOperationScheduleDetailListLoadData(); 
};
#endif
