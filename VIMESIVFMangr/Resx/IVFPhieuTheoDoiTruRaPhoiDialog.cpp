...
void CIVFPhieuTheoDoiTruRaPhoiDialog::OnCreateComponents(){
	m_wndNgayChocHutLabel.Create(this, _T("Ngay choc hut"), 5, 5, 105, 30);
	m_wndNgayChocHut.Create(this,110, 5, 210, 30); 
	m_wndSoPhoiTruLabel.Create(this, _T("So phoi tru"), 215, 5, 315, 30);
	m_wndSoPhoiTru.Create(this,320, 5, 420, 30); 
	m_wndNguoiTruLabel.Create(this, _T("Nguoi tru"), 425, 5, 525, 30);
	m_wndNguoiTru.Create(this,530, 5, 840, 30); 
	m_wndThungLabel.Create(this, _T("THUNG"), 110, 35, 210, 60);
	...
	m_wndGiaLabel.Create(this, _T("GIA"), 320, 35, 420, 60);
...
void CIVFPhieuTheoDoiTruRaPhoiDialog::OnInitializeComponents(){
	...
	m_wndList.InsertColumn(0, _T("Dien giai"), CFMT_TEXT, 150);
	m_wndList.InsertColumn(1, _T("Tru phoi"), CFMT_TEXT, 100);
	m_wndList.InsertColumn(2, _T("Ra phoi"), CFMT_TEXT, 100);
	m_wndList.InsertColumn(3, _T("Nuoi cay"), CFMT_TEXT, 100);
	m_wndList.InsertColumn(4, _T("Nhan xet"), CFMT_TEXT, 300);
