#ifndef HMSDailyDrugMaterialOrderBedDialog_H
#define HMSDailyDrugMaterialOrderBedDialog_H
...
class CHMSDailyDrugMaterialOrderBedDialog : public CGuiDialog{
protected:
public:
	...
	CHMSDailyDrugMaterialOrderBedDialog(CWnd *pParent);	
	~CHMSDailyDrugMaterialOrderBedDialog();
	...
	int OnAddHMSDailyDrugMaterialOrderBedDialog(); 
	int OnEditHMSDailyDrugMaterialOrderBedDialog(); 
	int OnDeleteHMSDailyDrugMaterialOrderBedDialog(); 
	int OnSaveHMSDailyDrugMaterialOrderBedDialog(); 
	int OnCancelHMSDailyDrugMaterialOrderBedDialog(); 
	int OnHMSDailyDrugMaterialOrderBedDialogListLoadData(); 
