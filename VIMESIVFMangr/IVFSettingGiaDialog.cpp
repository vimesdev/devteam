...
/*static void _OnSearchChangeFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnSearchChange();
} */
/*static void _OnSearchSetfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnSearchSetfocus();} */ 
/*static void _OnSearchKillfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnSearchKillfocus();
} */
static int _OnSearchCheckValueFnc(CWnd *pWnd){
	return ((CIVFSettingGiaDialog *)pWnd)->OnSearchCheckValue();
} 
static long _OnListLoadDataFnc(CWnd *pWnd){
	return ((CIVFSettingGiaDialog*)pWnd)->OnListLoadData();
} 
static void _OnListDblClickFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog*)pWnd)->OnListDblClick();
} 
static void _OnListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CIVFSettingGiaDialog*)pWnd)->OnListSelectChange(nOldItem, nNewItem);
} 

static int _OnListDeleteItemFnc(CWnd *pWnd){
	 return ((CIVFSettingGiaDialog*)pWnd)->OnListDeleteItem();
}
...
static int _OnListGenChildItemFnc(CWnd *pWnd){
	return ((CIVFSettingGiaDialog*)pWnd)->OnListGenChildItem();
}
/*static void _OnIDChangeFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnIDChange();
} */
/*static void _OnIDSetfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnIDSetfocus();} */ 
/*static void _OnIDKillfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnIDKillfocus();
} */
static int _OnIDCheckValueFnc(CWnd *pWnd){
	return ((CIVFSettingGiaDialog *)pWnd)->OnIDCheckValue();
} 
static void _OnParentSelectChangeFnc(CWnd *pWnd, int nOldItemSel, int nNewItemSel){
	((CIVFSettingGiaDialog* )pWnd)->OnParentSelectChange(nOldItemSel, nNewItemSel);
} 
static void _OnParentSelendokFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnParentSelendok();
}
/*static void _OnParentSetfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnParentKillfocus();
}*/
/*static void _OnParentKillfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnParentKillfocus();
}*/
static long _OnParentLoadDataFnc(CWnd *pWnd){
	return ((CIVFSettingGiaDialog *)pWnd)->OnParentLoadData();
}
/*static void _OnParentAddNewFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnParentAddNew();
}*/
/*static void _OnDescriptionChangeFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnDescriptionChange();
} */
/*static void _OnDescriptionSetfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnDescriptionSetfocus();} */ 
/*static void _OnDescriptionKillfocusFnc(CWnd *pWnd){
	((CIVFSettingGiaDialog *)pWnd)->OnDescriptionKillfocus();
} */
static int _OnDescriptionCheckValueFnc(CWnd *pWnd){
	return ((CIVFSettingGiaDialog *)pWnd)->OnDescriptionCheckValue();
} 
static void _OnIsActiveSelectFnc(CWnd *pWnd){
	 ((CIVFSettingGiaDialog*)pWnd)->OnIsActiveSelect();
}
static void _OnAddSelectFnc(CWnd *pWnd){
	CIVFSettingGiaDialog *pVw = (CIVFSettingGiaDialog *)pWnd;
	pVw->OnAddSelect();
} 
...
static int _OnAddIVFSettingDialogFnc(CWnd *pWnd){
	 return ((CIVFSettingGiaDialog*)pWnd)->OnAddIVFSettingDialog();
} 
static int _OnEditIVFSettingDialogFnc(CWnd *pWnd){
	 return ((CIVFSettingGiaDialog*)pWnd)->OnEditIVFSettingDialog();
} 
static int _OnDeleteIVFSettingDialogFnc(CWnd *pWnd){
	 return ((CIVFSettingGiaDialog*)pWnd)->OnDeleteIVFSettingDialog();
} 
static int _OnSaveIVFSettingDialogFnc(CWnd *pWnd){
	 return ((CIVFSettingGiaDialog*)pWnd)->OnSaveIVFSettingDialog();
} 
static int _OnCancelIVFSettingDialogFnc(CWnd *pWnd){
	 return ((CIVFSettingGiaDialog*)pWnd)->OnCancelIVFSettingDialog();
} 
CIVFSettingGiaDialog::CIVFSettingGiaDialog(CWnd *pParent, CString szTable, CString szParentTable):
	...
	m_szPrefix = _T("");
	m_szTitle = _T("Danh mục giá");
}
CIVFSettingGiaDialog::~CIVFSettingGiaDialog(){
}
void CIVFSettingGiaDialog::OnCreateComponents(){
	...
	m_wndMaxCapacityLabel.Create(this, _T("Max Capacity"), 5, 425, 85, 450);
	m_wndMaxCapacity.Create(this,90, 425, 170, 450); 
	m_wndDescription.Create(this,260, 425, 605, 450); 
	m_wndDescriptionLabel.Create(this, _T("Description"), 175, 426, 255, 451);
...
void CIVFSettingGiaDialog::OnInitializeComponents(){
	...
	if(!m_szParentTable.IsEmpty())
	{
		...
		m_wndList.InsertColumn(2, _T("Group"), CFMT_TEXT, 200);
	}
	else
	{
	...
	if (rs.GetIntValue() == 0)
	{
		...
		_T("     PRIMARY KEY (%s_id),") \
		_T("	 FOREIGN KEY (parent_id) REFERENCES %s(%s_id)") \
		_T(" )"), m_szTable, m_szTable, m_szTable, m_szParentTable, m_szParentTable); 

		pMF->ExecSQL(szSQL);
	}
}
void CIVFSettingGiaDialog::OnSetWindowEvents(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CIVFSettingGiaDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CIVFSettingGiaDialog::UpdateJson(BOOL bSave){
	if(bSave)
	{
...
void CIVFSettingGiaDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CIVFSettingGiaDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
void CIVFSettingGiaDialog::SetDefaultValues(){
	m_nMaxCapacity = 0;
	m_szSearch.Empty();
	m_szID.Empty();
	m_szParentKey.Empty();
...
int CIVFSettingGiaDialog::SetMode(int nMode){
...
/*void CIVFSettingGiaDialog::OnSearchChange(){
	
} */
/*void CIVFSettingGiaDialog::OnSearchSetfocus(){
	
} */
/*void CIVFSettingGiaDialog::OnSearchKillfocus(){
	
} */
int CIVFSettingGiaDialog::OnSearchCheckValue(){
	OnListLoadData();
	return 1;
} 
void CIVFSettingGiaDialog::OnListDblClick(){
	
} 
void CIVFSettingGiaDialog::OnListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(nNewItem < 0)
		return;
...
int CIVFSettingGiaDialog::OnListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteIVFSettingDialog();
	 return 0;
} 
long CIVFSettingGiaDialog::OnListLoadData(){
	...
	if(!m_szParentTable.IsEmpty())
	{
		szSQL.Format(_T("SELECT t1.%s as id, t1.code, t1.description, t2.description as parent_desc ") \
			...
			_T(" WHERE t1.isactive='Y' %s ORDER BY t1.%s "), m_szKeyName, m_szTable,m_szParentTable, m_szParentTable, szWhere, m_szKeyName);
	}
	else
	{
...
/*void CIVFSettingGiaDialog::OnIDChange(){
	
} */
/*void CIVFSettingGiaDialog::OnIDSetfocus(){
	
} */
/*void CIVFSettingGiaDialog::OnIDKillfocus(){
	
} */
int CIVFSettingGiaDialog::OnIDCheckValue(){
	if(GetMode() == VM_ADD)
	{
		CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
		CRecord rs(&pMF->m_db);
...
void CIVFSettingGiaDialog::OnParentSelectChange(int nOldItemSel, int nNewItemSel){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} 
void CIVFSettingGiaDialog::OnParentSelendok(){
	 
}
/*void CIVFSettingGiaDialog::OnParentSetfocus(){
	
}*/
/*void CIVFSettingGiaDialog::OnParentKillfocus(){
	
}*/
long CIVFSettingGiaDialog::OnParentLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	int nCount = 0;
	szSQL.Format(_T("SELECT %s_id as id, description FROM %s WHERE isactive='Y' %s ORDER BY %s_id "), m_szParentTable, m_szParentTable, szWhere, m_szParentTable);
	nCount = rs.ExecSQL(szSQL);
	while(!rs.IsEOF()){ 
...
/*void CIVFSettingGiaDialog::OnParentAddNew(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
} */
/*void CIVFSettingGiaDialog::OnDescriptionChange(){
	
} */
/*void CIVFSettingGiaDialog::OnDescriptionSetfocus(){
	
} */
/*void CIVFSettingGiaDialog::OnDescriptionKillfocus(){
	
} */
int CIVFSettingGiaDialog::OnDescriptionCheckValue(){
	return 0;
} 
	void CIVFSettingGiaDialog::OnIsActiveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	
}
void CIVFSettingGiaDialog::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnAddIVFSettingDialog();
} 
void CIVFSettingGiaDialog::OnEditSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnEditIVFSettingDialog();
} 
void CIVFSettingGiaDialog::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteIVFSettingDialog();
}
void CIVFSettingGiaDialog::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveIVFSettingDialog();
}  
void CIVFSettingGiaDialog::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancelIVFSettingDialog();
} 
void CIVFSettingGiaDialog::OnCloseSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CGuiDialog::OnCancel();
} 
int CIVFSettingGiaDialog::OnAddIVFSettingDialog(){
...
int CIVFSettingGiaDialog::OnEditIVFSettingDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
 	SetMode(VM_EDIT);
...
int CIVFSettingGiaDialog::OnDeleteIVFSettingDialog(){
 	if(GetMode() != VM_VIEW)
 		return -1;
 	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd();
 	CString szSQL;
...
int CIVFSettingGiaDialog::OnSaveIVFSettingDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT)
 		return -1;
 	if(!IsValidateData())
 		return -1;
...
int CIVFSettingGiaDialog::OnCancelIVFSettingDialog(){
 	if(GetMode() == VM_EDIT)
 	{
 		SetMode(VM_VIEW);
 	} 
...
int CIVFSettingGiaDialog::OnIVFSettingDialogListLoadData(){
	return 0;
}

int CIVFSettingGiaDialog::OnListGenChildItem()
{
	CMainFrame* pMF = (CMainFrame*) AfxGetMainWnd();
	CString szSQL;
	szSQL.Format(_T("IVF_AUTOGEN_CASSETTE('%s')"), m_szID);
