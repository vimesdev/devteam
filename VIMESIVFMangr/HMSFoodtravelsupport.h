...
public:
	/*
		...
		V: Tien ve
		P: Tien an du an
		N: Tien an ngan sach cap
		C: Tien an ho tro cho doi tuong tre em
	*/
	...
	int			OnPatientRefresh();
	int			OnListItemDeleteItem(); 
	int			OnPatientListIssue(); 
	int			OnPatientListCancel(); 

	void			OnIssueSelect(); 
	void			OnRefreshSelect();
	void			OnPrintDailySelect();
	void			OnCancelPatientSelect();
