#ifndef HMSOPERATIONQUEUE_H
#define HMSOPERATIONQUEUE_H
...
#include "GuiView.h"
#include "DbField.h"
class CHMSOperationQueue : public CGuiView{
protected:
public:
	CWnd*	m_wndOrder;
	...
	int OnAddHMSOperationQueue(); 
	int OnEditHMSOperationQueue(); 
	int OnDeleteHMSOperationQueue(); 
	int OnSaveHMSOperationQueue(); 
	int OnCancelHMSOperationQueue(); 
	int OnHMSOperationQueueListLoadData(); 
};
#endif
