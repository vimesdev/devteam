...
static long _OnOrderListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnOrderListLoadData();
} 
static void _OnOrderListDblClickFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog*)pWnd)->OnOrderListDblClick();
} 
static void _OnOrderListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyOperationMaterialDialog*)pWnd)->OnOrderListSelectChange(nOldItem, nNewItem);
} 
static int _OnOrderListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnOrderListDeleteItem();
} 

static int _OnOrderListPrintDeliveryDrugFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnOrderListPrintDeliveryDrug();
}
static int	_OnExportOrderDeliveryDrugFnc(CWnd *pWnd){
	return	((CHMSDailyOperationMaterialDialog*)pWnd)->OnExportOrderDeliveryDrug();
}
static int _OnOrderListPrintSheetDateFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnOrderListPrintSheetDate();
}
static int _OnOrderListPrintSheetpublicityFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnOrderListPrintSheetPublicity();
}

static long _OnPatientListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnPatientListLoadData();
} 
static void _OnPatientListDblClickFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog*)pWnd)->OnPatientListDblClick();
} 
static void _OnPatientListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyOperationMaterialDialog*)pWnd)->OnPatientListSelectChange(nOldItem, nNewItem);
} 

static int _OnPatientListIssueAllFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnPatientListIssueAll();
} 

static int _OnPatientListIssueFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnPatientListIssue();
} 

static int _OnPatientListRollbackFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnPatientListRollback();
} 

static int _OnPatientListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnPatientListDeleteItem();
} 
static long _OnDrugListLoadDataFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnDrugListLoadData();
} 
static void _OnDrugListDblClickFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog*)pWnd)->OnDrugListDblClick();
} 
static void _OnDrugListSelectChangeFnc(CWnd *pWnd, int nOldItem, int nNewItem){
	((CHMSDailyOperationMaterialDialog*)pWnd)->OnDrugListSelectChange(nOldItem, nNewItem);
} 
static int _OnDrugListAddEntryFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnDrugListAddEntry();
} 

static int _OnDrugListDeleteItemFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnDrugListDeleteItem();
} 
static int _OnDrugListReturnFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnDrugListReturnDrug();
} 

/*static void _OnOrderNoChangeFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderNoChange();
} */
/*static void _OnOrderNoSetfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderNoSetfocus();} */ 
/*static void _OnOrderNoKillfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderNoKillfocus();
} */
static int _OnOrderNoCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderNoCheckValue();
} 
static void _OnFindSelectFnc(CWnd *pWnd){
	CHMSDailyOperationMaterialDialog *pVw = (CHMSDailyOperationMaterialDialog *)pWnd;
	pVw->OnFindSelect();
} 
/*static void _OnOrderDateChangeFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderDateChange();
} */
/*static void _OnOrderDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderDateSetfocus();} */ 
/*static void _OnOrderDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderDateKillfocus();
} */
static int _OnOrderDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog *)pWnd)->OnOrderDateCheckValue();
} 
/*static void _OnIssueDateChangeFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnIssueDateChange();
} */
/*static void _OnIssueDateSetfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnIssueDateSetfocus();} */ 
/*static void _OnIssueDateKillfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnIssueDateKillfocus();
} */
static int _OnIssueDateCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog *)pWnd)->OnIssueDateCheckValue();
} 
/*static void _OnStatusChangeFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnStatusChange();
} */
/*static void _OnStatusSetfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnStatusSetfocus();} */ 
/*static void _OnStatusKillfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnStatusKillfocus();
} */
static int _OnStatusCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog *)pWnd)->OnStatusCheckValue();
} 
/*static void _OnPrintedChangeFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnPrintedChange();
} */
/*static void _OnPrintedSetfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnPrintedSetfocus();} */ 
/*static void _OnPrintedKillfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnPrintedKillfocus();
} */
static int _OnPrintedCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog *)pWnd)->OnPrintedCheckValue();
} 
/*static void _OnNoteChangeFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnNoteChange();
} */
/*static void _OnNoteSetfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnNoteSetfocus();} */ 
/*static void _OnNoteKillfocusFnc(CWnd *pWnd){
	((CHMSDailyOperationMaterialDialog *)pWnd)->OnNoteKillfocus();
} */
static int _OnNoteCheckValueFnc(CWnd *pWnd){
	return ((CHMSDailyOperationMaterialDialog *)pWnd)->OnNoteCheckValue();
} 
...
static int _OnAddHMSDailyOperationMaterialDialogFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnAddHMSDailyOperationMaterialDialog();
} 
static int _OnEditHMSDailyOperationMaterialDialogFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnEditHMSDailyOperationMaterialDialog();
} 
static int _OnDeleteHMSDailyOperationMaterialDialogFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnDeleteHMSDailyOperationMaterialDialog();
} 
static int _OnSaveHMSDailyOperationMaterialDialogFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnSaveHMSDailyOperationMaterialDialog();
} 
static int _OnCancelHMSDailyOperationMaterialDialogFnc(CWnd *pWnd){
	 return ((CHMSDailyOperationMaterialDialog*)pWnd)->OnCancelHMSDailyOperationMaterialDialog();
} 

CHMSDailyOperationMaterialDialog::CHMSDailyOperationMaterialDialog(CWnd *pParent):
	CGuiDialog(pParent)
{
	m_nDlgWidth = 985;
	m_nDlgHeight = 605;
...
CHMSDailyOperationMaterialDialog::~CHMSDailyOperationMaterialDialog(){
} 
void CHMSDailyOperationMaterialDialog::OnCreateComponents(){
...
void CHMSDailyOperationMaterialDialog::OnInitializeComponents(){
...
void CHMSDailyOperationMaterialDialog::OnSetWindowEvents(){
...
void CHMSDailyOperationMaterialDialog::OnDoDataExchange(CDataExchange* pDX){
...
void CHMSDailyOperationMaterialDialog::GetDataToScreen(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
	szSQL.Format(_T("SELECT  ") \
		...
		_T("WHERE mtb_transaction_batch_id=%ld and mtb_department_to_id='%s' and mtb_ordertype ='M' "), 
	...
	if(!rs.IsEOF())
	{
		...
		szSQL.Format(_T("SELECT mt_transaction_id, mt_storage_id ") \
			_T("FROM m_transaction WHERE mt_orderno='%s' and mt_transaction_id > %ld and mt_ordertype = 'M'"),
			m_szBatchNo, m_nOID);
		rsx.ExecSQL(szSQL);
		while(!rsx.IsEOF())
		{
...
void CHMSDailyOperationMaterialDialog::GetScreenToData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CString szWhere;
	...
	m_transactionTbl.SetValue(_T("mt_ordertype"), _T("M"));
...
void CHMSDailyOperationMaterialDialog::SetDefaultValues(){
	...
	m_nPrinted=0;
	m_szNote.Empty();
	m_szTitle = _T("Daily drug - material order operation");

}
int CHMSDailyOperationMaterialDialog::SetMode(int nMode){
...
void CHMSDailyOperationMaterialDialog::OnOrderListDblClick(){
	OnPreviewDeliveryDetail();
} 
void CHMSDailyOperationMaterialDialog::OnOrderListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 
int CHMSDailyOperationMaterialDialog::OnOrderListDeleteItem(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnPreviewDeliveryDetail();
	 return 0;
} 
long CHMSDailyOperationMaterialDialog::OnOrderListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	...
	szSQL.Format(_T(" SELECT hpo_storage_id as storage_id, product_id, product_name as product_name, ") \
				...
				_T(" WHERE hpo_ordertype ='M' and hpo_transaction_id in(%s)  %s ") \
...
void CHMSDailyOperationMaterialDialog::OnPatientListDblClick(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
void CHMSDailyOperationMaterialDialog::OnPatientListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyOperationMaterialDialog::OnPatientListIssueAll(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();	
	CRecord rs(&pMF->m_db);
	CString szSQL, szOrderNo, szOrderDate, tmpStr;
...
int CHMSDailyOperationMaterialDialog::OnPatientListIssue(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	CRecord rs(&pMF->m_db);
...
int CHMSDailyOperationMaterialDialog::OnPatientListRollback(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CString szSQL;
	if(m_szStatus != _T("A"))
		return -1;
...
int CHMSDailyOperationMaterialDialog::OnPatientListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
	CRecord rs(&pMF->m_db);
 	CString szSQL;
...
long CHMSDailyOperationMaterialDialog::OnPatientListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
_T(" WHERE hpo_ordertype ='M' %s ORDER BY docno,orderdate "), szWhere);
	_fmsg(_T("%s"), szSQL);
	nCount = rs.ExecSQL(szSQL);
	long nDocumentNo;
	int n = -1;
...
void CHMSDailyOperationMaterialDialog::OnDrugListDblClick(){
	
} 
void CHMSDailyOperationMaterialDialog::OnDrugListSelectChange(int nOldItem, int nNewItem){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
} 

int CHMSDailyOperationMaterialDialog::OnDrugListAddEntry(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	if(m_szStatus != _T("O"))
		return 0;
	CHMSPatientMaterialOperationEntry* newPopup = new CHMSPatientMaterialOperationEntry(this, VM_ADD);
...
int CHMSDailyOperationMaterialDialog::OnDrugListDeleteItem(){
	CMainFrame *pMF = (CMainFrame *)AfxGetMainWnd(); 
 	CString szSQL; 
	long nProductID;
	long nOrderID;
...
int CHMSDailyOperationMaterialDialog::OnDrugListReturnDrug(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
long CHMSDailyOperationMaterialDialog::OnDrugListLoadData(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
/*void CHMSDailyOperationMaterialDialog::OnOrderNoChange(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnOrderNoSetfocus(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnOrderNoKillfocus(){
	
} */
int CHMSDailyOperationMaterialDialog::OnOrderNoCheckValue(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSDailyOperationMaterialDialog::OnFindSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	static CString szFromDate, szToDate;
	CHMSDailyOperationMaterialListDialog dlg(this);
...
/*void CHMSDailyOperationMaterialDialog::OnOrderDateChange(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnOrderDateSetfocus(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnOrderDateKillfocus(){
	
} */
int CHMSDailyOperationMaterialDialog::OnOrderDateCheckValue(){
	UpdateData(true);
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
/*void CHMSDailyOperationMaterialDialog::OnIssueDateChange(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnIssueDateSetfocus(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnIssueDateKillfocus(){
	
} */
int CHMSDailyOperationMaterialDialog::OnIssueDateCheckValue(){
	return 0;
} 

/*void CHMSDailyOperationMaterialDialog::OnStatusChange(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnStatusSetfocus(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnStatusKillfocus(){
	
} */
int CHMSDailyOperationMaterialDialog::OnStatusCheckValue(){
	return 0;
} 
/*void CHMSDailyOperationMaterialDialog::OnPrintedChange(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnPrintedSetfocus(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnPrintedKillfocus(){
	
} */
int CHMSDailyOperationMaterialDialog::OnPrintedCheckValue(){
	return 0;
} 
/*void CHMSDailyOperationMaterialDialog::OnNoteChange(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnNoteSetfocus(){
	
} */
/*void CHMSDailyOperationMaterialDialog::OnNoteKillfocus(){
	
} */
int CHMSDailyOperationMaterialDialog::OnNoteCheckValue(){
	return 0;
} 
void CHMSDailyOperationMaterialDialog::OnAddSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnAddHMSDailyOperationMaterialDialog();
	
} 
void CHMSDailyOperationMaterialDialog::OnEditSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnEditHMSDailyOperationMaterialDialog();
} 
void CHMSDailyOperationMaterialDialog::OnDeleteSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnDeleteHMSDailyOperationMaterialDialog();
} 
void CHMSDailyOperationMaterialDialog::OnSaveSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnSaveHMSDailyOperationMaterialDialog();
} 
void CHMSDailyOperationMaterialDialog::OnCancelSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	OnCancelHMSDailyOperationMaterialDialog();
} 
void CHMSDailyOperationMaterialDialog::OnSendSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, tmpStr;
...
int CHMSDailyOperationMaterialDialog::OnPreviewDeliveryDetail(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	...
	printer.OnPrintDailyViewDetail(m_szOrderNo, szOrderDate, szOrderNo, nProduct_id, 0, _T("'M'"), nStorage_ID);
	return 0;
} 

void CHMSDailyOperationMaterialDialog::OnPrintSelect(){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyOperationMaterialDialog::OnOrderListPrintSheetPublicity(){
	CHMSDailyOrderDate dlg(this);
	dlg.m_nType =1;
	dlg.DoModal();
	return 0;	
}
int CHMSDailyOperationMaterialDialog::OnOrderListPrintSheetDate(){
	CHMSDailyOrderDate dlg(this);
	dlg.m_nType = 2;
	dlg.DoModal();
...
int CHMSDailyOperationMaterialDialog::OnAddHMSDailyOperationMaterialDialog(){
...
int CHMSDailyOperationMaterialDialog::OnEditHMSDailyOperationMaterialDialog(){
 	if(GetMode() != VM_VIEW) 
 		return -1; 
...
int CHMSDailyOperationMaterialDialog::OnDeleteHMSDailyOperationMaterialDialog(){
...
int CHMSDailyOperationMaterialDialog::OnSaveHMSDailyOperationMaterialDialog(){
 	if(GetMode() != VM_ADD && GetMode() != VM_EDIT) 
 		return -1; 
	...
	CRecord rs(&pMF->m_db);
 	CString szSQL; 
 	if(GetMode() == VM_ADD){ 
		szSQL.Format(_T("AD_GETNEXTVAL('STORAGEDAILYORDEROPERATION_NO','Y') "));
...
int CHMSDailyOperationMaterialDialog::OnCancelHMSDailyOperationMaterialDialog(){
 	if(GetMode() == VM_EDIT) 
 	{ 
 		SetMode(VM_VIEW); 
 	} 
...
int CHMSDailyOperationMaterialDialog::OnHMSDailyOperationMaterialDialogListLoadData(){
	return 0;
}


void CHMSDailyOperationMaterialDialog::RefreshData(){
	OnOrderListLoadData();
	OnPatientListLoadData();
}

void CHMSDailyOperationMaterialDialog::LoadDrugList(long nID){
...
void CHMSDailyOperationMaterialDialog::OnPrintDelivery(CString szTransactionID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CReport rpt;	
...
void CHMSDailyOperationMaterialDialog::OnExportDelivery_Lanscape(long nOID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CRecord rsl(&pMF->m_db);
...
void CHMSDailyOperationMaterialDialog::OnExportDelivery_Portraid(long nOID, LPCTSTR lpszOrderDate){
	CMainFrame *pMF = (CMainFrame*) AfxGetMainWnd();
...
int CHMSDailyOperationMaterialDialog::OnExportOrderDeliveryDrug(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
...
int CHMSDailyOperationMaterialDialog::OnOrderListPrintDeliveryDrug()
{
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL;
...
void CHMSDailyOperationMaterialDialog::OnAddDrugSelect(){
	OnDrugListAddEntry();
}

void CHMSDailyOperationMaterialDialog::OnPrintDeliveryDrugsSelect(){
	CMainFrame *pMF = (CMainFrame *) AfxGetMainWnd();
	CRecord rs(&pMF->m_db);
	CString szSQL, szOrderNo, szOrderDate, tmpStr;
...
void CHMSDailyOperationMaterialDialog::Refresh(long nTransactionID, long nDocumentNo){
...
long CHMSDailyOperationMaterialDialog::GetTransactionID(int nStorageID)
{
...
void CHMSDailyOperationMaterialDialog::OnPrintPatientSummeryDrug(int nDocumentNo, CString nRefeorder_ID)
{
