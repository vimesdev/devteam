#ifndef PMSReturnOrderListDialog_H
#define PMSReturnOrderListDialog_H
...
#include "GuiDialog.h"
#include "DbField.h"
class CPMSReturnOrderListDialog : public CGuiDialog{
protected:
public:
	CString		m_szType;
	CString		m_szID;
	...
	void			OnPrintSelect(); 
	void			OnCancelSelect(); 
	CPMSReturnOrderListDialog(CWnd *pParent);
	~CPMSReturnOrderListDialog();
	...
	int OnAddPMSReturnOrderListDialog(); 
	int OnEditPMSReturnOrderListDialog(); 
	int OnDeletePMSReturnOrderListDialog(); 
	int OnSavePMSReturnOrderListDialog(); 
	int OnCancelPMSReturnOrderListDialog(); 
	int OnPMSReturnOrderListDialogListLoadData(); 
};
#endif
