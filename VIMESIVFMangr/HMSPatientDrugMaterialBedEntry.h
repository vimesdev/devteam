#ifndef HMSPatientDrugMaterialBedEntry_H
#define HMSPatientDrugMaterialBedEntry_H
...
class CHMSPatientDrugMaterialBedEntry : public CGuiPopup{
protected:
	bool	m_bAddOrder;
...
public:
	...
	CHMSPatientDrugMaterialBedEntry(CWnd *pParent, int nMode, int nType=0);
	~CHMSPatientDrugMaterialBedEntry();
	...
	int OnAddHMSPatientDrugMaterialBedEntry(); 
	int OnEditHMSPatientDrugMaterialBedEntry(); 
	int OnDeleteHMSPatientDrugMaterialBedEntry(); 
	int OnSaveHMSPatientDrugMaterialBedEntry(); 
	int OnCancelHMSPatientDrugMaterialBedEntry(); 
	int OnHMSPatientDrugMaterialBedEntryListLoadData(); 
