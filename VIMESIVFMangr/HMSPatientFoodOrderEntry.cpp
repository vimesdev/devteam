...
void CHMSPatientFoodOrderEntry::OnCreateComponents(){
	...
	m_wndBreakfastRelativeLabel.Create(this, _T("\x102n s\xE1ng ng\x1B0\x1EDDi nh\xE0"), 5, 155, 115, 180);
...
long CHMSPatientFoodOrderEntry::OnNameLoadData(){
	...
	else
	{
		if(pMF->m_szDept == _T("A16")){		
			szWhere.AppendFormat(_T(" and hfl_feeid IN('FF000132', 'FF000189','FF000207','FF000220','FF000221','FF000222','FF000474', 'FF000475', 'FF0001205', 'FF0001206', 'FF0001207') "));
		}
		else
			szWhere.AppendFormat(_T(" and hfl_feeid IN('FF000132','FF000220','FF000221','FF000222','FF000474', 'FF000475', 'FF0001035', 'FF0001036', 'FF0001205', 'FF0001206', 'FF0001207') "));
...
long CHMSPatientFoodOrderEntry::OnName2LoadData(){
	...
	if(m_bHaucan)
	{
		szWhere.AppendFormat(_T(" and NVL(hfl_deptid,'XX') = 'HCKT' and nvl(hfl_index2,'XX') <> 'sang' "));
	}
	else
	{
//		if(pMF->m_szDept == _T("A16")){
			...
			if(pMF->m_szDept == _T("A16")){
				if(m_szObjectID == _T("8"))
					szWhere.AppendFormat(_T(" and hfl_feeid NOT IN('FF000132', 'FF000189','FF000207','FF000220','FF000221','FF000222', 'FF0001205', 'FF0001206', 'FF0001207') AND COALESCE(hfl_categoryid, 0) > 0"));
				else
					szWhere.AppendFormat(_T(" and hfl_feeid NOT IN('FF000132', 'FF000189','FF000207','FF000220','FF000221','FF000222', 'FF0001205', 'FF0001206', 'FF0001207') AND COALESCE(hfl_categoryid, 0) <> 1"));
			}
			else
				szWhere.AppendFormat(_T(" and hfl_feeid NOT IN('FF000132', 'FF000189','FF000207','FF000220','FF000221','FF000222','FF000474', 'FF000475', 'FF0001205', 'FF0001206', 'FF0001207') AND COALESCE(hfl_categoryid, 0) <= 0"));

		
//		}
//		else
//			szWhere.AppendFormat(_T(" and hfl_feeid NOT IN(%s) AND COALESCE(hfl_categoryid, 0) <= 0"), m_szFastFoodIDS);
